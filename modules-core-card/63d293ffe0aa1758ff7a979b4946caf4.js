/*! For license information please see 63d293ffe0aa1758ff7a979b4946caf4.js.LICENSE.txt */ ! function() {
  try {
    ...
    5992: (e, a, t) => {
      ...
      const f = e => {
          ...
          const [x, k] = (0, d.useSearchParams)(), y = (0, s.useRef)(null), [, w] = (0, l.useModal)(), {
            ...
            v && "button" !== e.target.type || "linkout" !== i && (e.preventDefault(), e.stopPropagation(), a ? k({
              info: a
            }) : j(), _({
              event: "card_click",
              event_category: "card",
...
//# sourceMappingURL=63d293ffe0aa1758ff7a979b4946caf4.js.map