! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "a0e13938-1e83-4f80-9785-7713534c75d1", e._sentryDebugIdIdentifier = "sentry-dbid-a0e13938-1e83-4f80-9785-7713534c75d1")
  } catch (e) {}
}();
    ...
    9040: (e, t, a) => {
      ...
      const P = (0, x.withTranslations)((e => {
          ...
          const w = (0, T.useIntl)(),
            ...
            Re = (0, m.useMemo)((() => Ie?.foreignTitle), [Ie]),
            [Ge, He] = (0, m.useState)(0),
            [Fe, Ae] = (0, m.useState)(0),
            ...
            dt = () => {
              Z(!0), He(0), Ae(0), Xe(!1), Je(0), N(0)
            };
          return (0, m.useEffect)((() => {
            let e = ee;
            R ? e = 0 : s && !d && (e = ee), F(e)
          }), [R, d, s, A, Y, ae, re, U, ee]), (0, m.useEffect)((() => {
            G(!(!s || !d))
          }), [s, d]), (0, m.useEffect)((() => {
            s && t && P({
          ...
          }), [s, d, A, U]), (0, m.useEffect)((() => {
            const e = .5 * A,
              t = me - le - 3 * re;
            K(A - (e < t ? e : t))
          }), [A, re, me]), (0, m.useEffect)((() => {
            ...
            onMouseEnter: () => {
              s || G(!0), s || d || (clearTimeout(ie), de(setTimeout((() => {
                P({
        ...
        O = e => {
          const {
          ...
          })(), [c, i] = (0, m.useState)([]), [d, l] = (0, m.useState)(null), [u, f] = (0, m.useState)(0), [b, _] = (0, m.useState)(window.devicePixelRatio || window.screen.availWidth / document.documentElement.clientWidth), [T, M] = (0, m.useState)(!1), C = (0, m.createRef)(), [j, I] = (0, m.useState)(null), L = (0, m.createRef)(), O = (0, m.createRef)(), [W, z] = (0, m.useState)([]), [R, G] = (0, m.useState)(!0), [H, F] = (0, m.useState)(!1), [A, V] = (0, m.useState)([]), [U, q] = (0, m.useState)(404), [Y, Q] = (0, m.useState)(808), [X, K] = (0, m.useState)(672), [J, Z] = (0, m.useState)(336), [ee, te] = (0, m.useState)(0), [ae, ne] = (0, m.useState)(0), [re, se] = (0, m.useState)(0), [oe, ce] = (0, m.useState)(0), [ie, de] = (0, m.useState)(0), [le, ue] = (0, m.useState)(!1), [me, fe] = (0, m.useState)(window.innerWidth), [pe, ve] = (0, m.useState)(0), [be, ge] = (0, m.useState)(0), [ye, he] = (0, m.useState)(0), [xe, ke] = (0, m.useState)(0), [_e, Se] = (0, m.useState)(0), [Ne, we] = (0, m.useState)(0), [Te, Me] = (0, m.useState)(0), [Ce, Ee] = (0, m.useState)(-1e3), [$e, je] = (0, m.useState)(0), [De, Ie] = (0, m.useState)(50), [Pe, Le] = (0, m.useState)(0), [Be, Oe] = (0, m.useState)(!1), [We, ze] = (0, m.useState)(768), [Re, Ge] = (0, m.useState)(!1), [He, Fe] = (0, m.useState)(!1), [Ae, Ve] = (0, m.useState)(!1), [Ue, qe] = (0, m.useState)(!1), [Ye, Qe] = (0, m.useState)(!1), [Xe, Ke] = (0, m.useState)(1e3), [Je, Ze] = (0, m.useState)(1.2), [et, tt] = (0, m.useState)(0), [at, nt] = (0, m.useState)(!1), [rt, st] = (0, m.useState)(!1), [ot, ct] = (0, m.useState)(!0), [it, dt] = (0, m.useState)(!1), [lt, ut] = (0, m.useState)(!1), [mt, ft] = (0, m.useState)(null), [pt, vt] = (0, m.useState)(100), [bt, gt] = (0, m.useState)(!1), [yt, ht] = (0, m.useState)({}), [xt, kt] = (0, m.useState)(""), [_t, St] = (0, m.useState)(0), [Nt, wt] = (0, m.useState)(!1), [Tt, Mt] = (0, m.useState)(!1), [Ct, Et] = (0, m.useState)(0), [$t, jt] = (0, m.useState)(0), [Dt, It] = (0, m.useState)(100), [Pt, Lt] = (0, m.useState)(!1), [Bt, Ot] = (0, m.useState)(!1), Wt = () => me * pe + De, zt = () => !1 === Be ? Je : 1, Rt = e => e === _e - 1 || e === _e + 1, Gt = () => -1 * xe, Ht = function(e) {
            ...
            -1 === t && (F(!1), G(!0)), F(!1 === a && e >= t || !0 === a && e + 1 === t), G(e <= 0)
          }, Vt = function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            if (lt || it) return;
            ...
            function() {
              ...
              n({
              ...
              }), At(_e + 1, c.length, !0), Be ? Be && z(W.map((e => {
                ...
                ...e.styles,
                transform: `translate3d(${Ft(e,-1)}px, ${Ht(e)}px, 0) scale(${zt()})`
              }), e)))), Se(_e + 1)
            }(t);
            const r = ye + 1;
            if (!(r > ie))
              if (n({
                ...
                let e = r * J * -1;
                e < Ce && (e = Ce, F(!0), G(!1), he(ie)), he(r), z(W.map((t => (t.styles = {
                  ...t.styles,
                  transform: `translate3d(${e}px, 0, 0)`
                }, t))))
              } else {
                let e = xe - ae;
                0 === xe && (e = -1 * X), he(r), e < Ce && (e = Ce, F(!0), G(!1), he(ie)), ke(e)
              }
          }, Ut = function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            if (lt || it) return;
            ...
            function() {
              ...
              n({
                ...
                source_content_id: W[_e - 1].source_content_id,
                source_content_name: W[_e - 1].source_content_name
              }), At(_e - 1, c.length, !0), Be || z(W.map((e => (e.itemNumber === _e + 1 ? e.upNext = !1 : e.itemNumber === _e - 2 ? e.upNext = !0 : e.itemNumber === _e ? (e.upNext = !0, e.active = !1, e.styles = {
                ...e.styles,
                transform: `translate3d(${Ft(e,1)}px, ${Ht(e)}px, 0) scale(${zt()})`
            ...
            if (!(r < 0))
              if (n({
                ...
                let e = r * J * -1;
                e > 0 && (e = 0, G(!0), F(!1), he(0)), he(r), z(W.map((t => (t.styles = {
                  ...t.styles,
                  transform: `translate3d(${e}px, 0, 0)`
                }, t))))
              } else {
                let e = xe + ae;
                he(r), (e > 0 || 0 === e || -1 * e < Y) && (e = 0, G(!0), F(!1), he(0)), ke(e), z(W.map((t => (t.styles = {
                  ...t.styles,
                  transform: `translate3d(${e}px, 0, 0)`
                }, t))))
              }
            ...
            if (n({
              ...
              let e = _e * J * -1;
              e < Ce && (e = Ce, F(!0), G(!1), he(ie)), he(_e), At(_e, ie, !1), z(Jt(c, "cardClose", `translate3d(${e}px, 0, 0)`))
            } else {
              z(Jt(c, "cardClose"));
              const e = Math.ceil((W[_e].columnNumber + 1) / ee) - 1;
              he(e);
              let t = e * ae * -1;
              Pe < be ? (t = 0, G(!0), F(!0), he(0)) : t < Ce ? (t = Ce, G(!1), F(!0), he(ie)) : At(e, ie, !1), ke(t), Se(0)
            }
            L.current.style.transform = "translateY(0px)", L.current.style.transition = "all var(--eventDeck-transitionCardClose)", nt(!1), qe(!1), ue(!1), Fe(!1), Ge(!1), Qe(!1), setTimeout((() => {
              Ve(!0)
            }), Xe)
          };
          (0, m.useEffect)((() => {
            !1 !== Ae && (Ve(!1), nt(!1), j.style.zIndex = null, z(W.map((e => (e.transitionStyle = "", e)))))
          }), [Ae]);
          const ea = e => {
            setTimeout((() => {
              ht(e), gt(!0)
          ...
          (0, m.useEffect)((() => {
            if (!bt) return;
            if (gt(!1), lt) return;
            Se(Number(yt.target.dataset.itemPosition)), Fe(!0), dt(!0), ot && ct(!1);
            ...
            }))), j.style.zIndex = "var(--eventDeck-zIndexOverlay)", nt(!0), L.current && (L.current.style.transition = "all var(--eventDeck-transitionCardOpen)", L.current.style.transform = `translateY(${e}px)`), qe(!0), setTimeout((() => {
              Ge(!0)
            }), 1)
          }), [He]);
          const ta = () => {
            z(W.map(((e, t) => {
              e.active = t === _e, e.inModalMode = !0, e.transitionStyle = "cardOpen", Be && (e.upNext = Rt(e.itemNumber));
              const a = !Be;
              let n = 0;
              if (Be) {
                const e = Ne + 5 * u;
              ...
              return e.itemNumber < _e ? e.styles = {
                ...e.styles,
                height: Be ? `${n}px` : null,
                transform: `translate3d(${Ft(e,-1,a)}px, ${et}px, 0) scale(${zt()})`
          ...
          (0, m.useEffect)((() => {
            !1 !== Re && !0 !== le && (ue(!0), Ge(!1), At(_e, W.length, !0), L.current && (L.current.style.transition = "all var(--eventDeck-transitionCardOpen)", L.current.style.transform = `translateY(${et}px)`), ta(), Be ? (ke(0), dt(!1), st(!0)) : Qe(!0))
          }), [Re]), (0, m.useEffect)((() => {
          ...
          const aa = function() {
            let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
            z(W.map((t => {
              if (t.upNext = Rt(t.itemNumber), t.itemNumber !== _e) {
                let e = Ft(t, 1);
                t.itemNumber < _e && (e = Ft(t, -1)), t.styles = {
                  ...t.styles,
          ...
          (0, m.useEffect)((() => {
            ...
            Be && (e = W.length - 1), e < 0 && (e = 1), At(0, e, !1), le && Zt()
          }), [Be]), (0, m.useEffect)((() => {
            ...
            Pe < pe * me && 0 === ye ? (ke(0), F(!0), G(!0)) : xe < Ce ? (F(!0), G(!1), he(ie), ke(Ce)) : xe < 0 && (F(!1), he(ie - 1)), Pe > pe * me && H && F(!1)
          }), [Ce]), (0, m.useEffect)((() => {
            if (C.current) {
              I(C.current);
      ...
      const h = {
        ...
        x = e => {
          ...
          return (0, v.jsx)(y.NavLink, {
            to: t,
            className: [h.cardWideContainer, n].join(" "),
...
//# sourceMappingURL=440412064041800d5ba663cb402fca81.js.map