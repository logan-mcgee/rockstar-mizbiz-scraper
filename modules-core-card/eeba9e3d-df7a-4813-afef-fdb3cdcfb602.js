! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "eeba9e3d-df7a-4813-afef-fdb3cdcfb602", e._sentryDebugIdIdentifier = "sentry-dbid-eeba9e3d-df7a-4813-afef-fdb3cdcfb602")
  } catch (e) {}
}();
    ...
    4186: (e, a, t) => {
      ...
      const u = {
        ...
        h = e => {
          ...
          const i = (0, s.createRef)();
          return (0, s.useEffect)((() => {
            const e = () => {
              i.current && null !== c && c(i.current.clientHeight)
            };
      ...
      const p = "modal-context",
        ...
        u = e => {
          ...
          const [v, k] = (0, d.useSearchParams)(), y = (0, s.useRef)(null), [, w] = (0, s.useContext)(g), {
            ...
            x && "button" !== e.target.type || "linkout" !== c && (e.preventDefault(), e.stopPropagation(), a ? k({
              info: a
            }) : j(), _({
              event: "card_click",
              event_category: "card",
