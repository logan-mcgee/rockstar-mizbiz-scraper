    ...
    1498: (e, a, n) => {
      ...
      const b = {
        ...
        h = e => {
          ...
          return (0, f.jsx)(m.Z, {
            ...
            prod: C,
            modalProps: {
              className: b.clrCardModal,
              contentClassName: b.clrCardModalContent
            },
            variants: y.plainCard,
            payload: {
              content: n
            },
            expandedCardContents: (0, f.jsx)(s.MultiSourceImage, {
              ...S
            }),
      ...
      function N(e, a) {
        ...
        return r().forOwn(e, ((e, i) => {
          ...
          } else r().isObject(e) && !r().isArray(e) ? N(e, a) : r().isArray(e) && (n[i] = e.map((e => r().isObject(e) ? N(e, a) : e)))
        })), n || []
      }
      const C = e => {
        let {
      ...
      const T = {
        ...
        M = e => {
          ...
          const v = (0, o.useTinaPayload)(),
            b = p?.payload?.meta?.cdn ?? v?.meta?.prod ?? !1,
            [y, h] = (0, d.useState)(c?.size ?? t),
            {
              learnMoreUrl: g,
              body: x
            } = v.content[0]._memoq;
          return (0, d.useEffect)((() => {
            ...
            expandedCardContents: (0, f.jsx)(S.Z, {
              images: l,
              prod: b,
              expandedView: !0
            }),
