      ...
      const g = e => {
        ...
        const n = (0, l.useTinaComponents)(),
          ...
          c = (() => {
            const {
              data: e
            } = (0, f.useQuery)(b.TinaModulesList, {
              variables: {
                type: "clr-card",
                locale: "en_us",
                orderDirection: "desc",
          ...
          v = (0, r.useMemo)((() => c ? c.reduce(((e, a) => {
            if (a) {
              ...
              const s = r?.payload,
                ...
                y = o?.content ?? [];
              "release" === v && e.push((0, p.jsx)(l.TinaParser, {
                components: i,
                tina: r,
                componentProps: {
                  id: d,
      ...
      const j = {
        ...
        w = e => {
          ...
          return v.content && (D = v?.content[0]?._memoq ? v?.content[0]?._memoq?.body : null), (0, r.useEffect)((() => {
            ...
            expandedCardContents: (0, p.jsx)(C.c, {
              images: m,
              prod: y,
              expandedView: !0
            }),
...
//# sourceMappingURL=edacc30f05a268b21dc52c7dff778012.js.map