    ...
    9228: (e, t, n) => {
      ...
      const C = (0, y.withTranslations)((e => {
          ...
          const {
            ...
            prod: $e
          }), Ie = Le?.src?.mobile ?? !1, Be = (0, d.useMemo)((() => Ce?.foreignId), [Ce]), Oe = (0, d.useMemo)((() => Ce?.foreignTitle), [Ce]), [We, He] = (0, d.useState)(0), [ze, Re] = (0, d.useState)(0), [Fe, Ge] = (0, d.useState)(0), [Ze, Ae] = (0, d.useState)(0), [Ve, Ue] = (0, d.useState)(!1), [qe, Ye] = (0, d.useState)(0), [Qe, Xe] = (0, d.useState)(20), [Je, Ke] = (0, d.useState)(null), [et, tt] = (0, d.useState)(!1), nt = (0, d.useCallback)((e => {
          ...
          return (0, d.useEffect)((() => {
            let e = X;
            O ? e = 0 : s && !l && (e = X), z(e)
          }), [O, l, s, R, A, K, te, G, X]), (0, d.useEffect)((() => {
            W(!(!s || !l))
          }), [s, l]), (0, d.useEffect)((() => {
            s && t && j({
            ...
            const e = m()(((e, t) => {
              ...
              if (e?.documentElement && (n = w(e?.documentElement, "--root-font-size")), le !== t.innerHeight && de(t.innerHeight), u?.current) {
                ...
                const e = n * w(u?.current, "--eventDeck-modalGutters"),
                  a = t?.innerWidth,
                  r = a - 2 * e;
                F(r), I.current && l && Z(r), V(w(u.current, "--eventDeck-itemSize") * n), me(w(u.current, "--eventDeck-phaseOneTransitionDuration"));
            ...
            if (null !== n?.transform) {
              e = n.transform.split(",");
              const r = e[0].split("(");
              t = Number(r[1].replace("px", "")), Ge(t), a = Number(e[1].replace("px", "")), Ae(a)
            }
          }), [n]), (0, d.useEffect)((() => {
            if (!Y) return;
            clearTimeout(ge);
            ...
            style: {
              ...n,
              transform: s && t && !l ? `translate3d(${Fe+qe}px, ${Ze}px, 0)` : l && !s ? `translate3d(${Fe+k}px, ${Ze}px, 0)` : n?.transform
            },
            onClick: e => {
        ...
        P = e => {
          const {
          ...
          })(), [o, c] = (0, d.useState)([]), [l, u] = (0, d.useState)(null), [p, x] = (0, d.useState)(0), [_, E] = (0, d.useState)(window.devicePixelRatio || window.screen.availWidth / document.documentElement.clientWidth), [M, j] = (0, d.useState)(!1), P = (0, d.createRef)(), [L, I] = (0, d.useState)(null), B = (0, d.createRef)(), O = (0, d.createRef)(), [W, H] = (0, d.useState)([]), [z, R] = (0, d.useState)(!0), [F, G] = (0, d.useState)(!1), [Z, A] = (0, d.useState)([]), [V, U] = (0, d.useState)(404), [q, Y] = (0, d.useState)(808), [Q, X] = (0, d.useState)(672), [J, K] = (0, d.useState)(336), [ee, te] = (0, d.useState)(0), [ne, ae] = (0, d.useState)(0), [re, se] = (0, d.useState)(0), [ie, oe] = (0, d.useState)(0), [ce, le] = (0, d.useState)(0), [de, ue] = (0, d.useState)(!1), [me, fe] = (0, d.useState)(window.innerWidth), [pe, ve] = (0, d.useState)(0), [be, ge] = (0, d.useState)(0), [ye, he] = (0, d.useState)(0), [xe, Se] = (0, d.useState)(0), [Ne, ke] = (0, d.useState)(0), [_e, we] = (0, d.useState)(0), [Te, Ee] = (0, d.useState)(0), [$e, Me] = (0, d.useState)(-1e3), [Ce, je] = (0, d.useState)(0), [De, Pe] = (0, d.useState)(50), [Le, Ie] = (0, d.useState)(0), [Be, Oe] = (0, d.useState)(!1), [We, He] = (0, d.useState)(768), [ze, Re] = (0, d.useState)(!1), [Fe, Ge] = (0, d.useState)(!1), [Ze, Ae] = (0, d.useState)(!1), [Ve, Ue] = (0, d.useState)(!1), [qe, Ye] = (0, d.useState)(!1), [Qe, Xe] = (0, d.useState)(1e3), [Je, Ke] = (0, d.useState)(1.2), [et, tt] = (0, d.useState)(0), [nt, at] = (0, d.useState)(!1), [rt, st] = (0, d.useState)(!1), [it, ot] = (0, d.useState)(!0), [ct, lt] = (0, d.useState)(!1), [dt, ut] = (0, d.useState)(!1), [mt, ft] = (0, d.useState)(null), [pt, vt] = (0, d.useState)(100), [bt, gt] = (0, d.useState)(!1), [yt, ht] = (0, d.useState)({}), [xt, St] = (0, d.useState)(""), [Nt, kt] = (0, d.useState)(0), [_t, wt] = (0, d.useState)(!1), [Tt, Et] = (0, d.useState)(!1), [$t, Mt] = (0, d.useState)(0), [Ct, jt] = (0, d.useState)(0), [Dt, Pt] = (0, d.useState)(100), [Lt, It] = (0, d.useState)(!1), [Bt, Ot] = (0, d.useState)(!1), Wt = () => me * pe + De, Ht = () => !1 === Be ? Je : 1, zt = e => e === Ne - 1 || e === Ne + 1, Rt = () => -1 * xe, Ft = function(e) {
            ...
            -1 === t && (G(!1), R(!0)), G(!1 === n && e >= t || !0 === n && e + 1 === t), R(e <= 0)
          }, At = function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            if (dt || ct) return;
            ...
            function() {
              ...
              a({
              ...
              }), Zt(Ne + 1, o.length, !0), Be ? Be && H(W.map((e => {
                ...
                ...e.styles,
                transform: `translate3d(${Gt(e,-1)}px, ${Ft(e)}px, 0) scale(${Ht()})`
              }), e)))), ke(Ne + 1)
            }(t);
            const r = ye + 1;
            if (!(r > ce))
              if (a({
                ...
                let e = r * J * -1;
                e < $e && (e = $e, G(!0), R(!1), he(ce)), he(r), H(W.map((t => (t.styles = {
                  ...t.styles,
                  transform: `translate3d(${e}px, 0, 0)`
                }, t))))
              } else {
                let e = xe - ne;
                0 === xe && (e = -1 * Q), he(r), e < $e && (e = $e, G(!0), R(!1), he(ce)), Se(e)
              }
          }, Vt = function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            if (dt || ct) return;
            ...
            function() {
              ...
              a({
                ...
                source_content_id: W[Ne - 1].source_content_id,
                source_content_name: W[Ne - 1].source_content_name
              }), Zt(Ne - 1, o.length, !0), Be || H(W.map((e => (e.itemNumber === Ne + 1 ? e.upNext = !1 : e.itemNumber === Ne - 2 ? e.upNext = !0 : e.itemNumber === Ne ? (e.upNext = !0, e.active = !1, e.styles = {
                ...e.styles,
                transform: `translate3d(${Gt(e,1)}px, ${Ft(e)}px, 0) scale(${Ht()})`
            ...
            if (!(r < 0))
              if (a({
                ...
                let e = r * J * -1;
                e > 0 && (e = 0, R(!0), G(!1), he(0)), he(r), H(W.map((t => (t.styles = {
                  ...t.styles,
                  transform: `translate3d(${e}px, 0, 0)`
                }, t))))
              } else {
                let e = xe + ne;
                he(r), (e > 0 || 0 === e || -1 * e < q) && (e = 0, R(!0), G(!1), he(0)), Se(e), H(W.map((t => (t.styles = {
                  ...t.styles,
                  transform: `translate3d(${e}px, 0, 0)`
                }, t))))
              }
            ...
            if (a({
              ...
              let e = Ne * J * -1;
              e < $e && (e = $e, G(!0), R(!1), he(ce)), he(Ne), Zt(Ne, ce, !1), H(Jt(o, "cardClose", `translate3d(${e}px, 0, 0)`))
            } else {
              H(Jt(o, "cardClose"));
              const e = Math.ceil((W[Ne].columnNumber + 1) / ee) - 1;
              he(e);
              let t = e * ne * -1;
              Le < be ? (t = 0, R(!0), G(!0), he(0)) : t < $e ? (t = $e, R(!1), G(!0), he(ce)) : Zt(e, ce, !1), Se(t), ke(0)
            }
            B.current.style.transform = "translateY(0px)", B.current.style.transition = "all var(--eventDeck-transitionCardClose)", at(!1), Ue(!1), ue(!1), Ge(!1), Re(!1), Ye(!1), setTimeout((() => {
              Ae(!0)
            }), Qe)
          };
          (0, d.useEffect)((() => {
            !1 !== Ze && (Ae(!1), at(!1), L.style.zIndex = null, H(W.map((e => (e.transitionStyle = "", e)))))
          }), [Ze]);
          const en = e => {
            setTimeout((() => {
              ht(e), gt(!0)
          ...
          (0, d.useEffect)((() => {
            if (!bt) return;
            if (gt(!1), dt) return;
            ke(Number(yt.target.dataset.itemPosition)), Ge(!0), lt(!0), it && ot(!1);
          ...
          const tn = () => {
            H(W.map(((e, t) => {
              ...
              return e.itemNumber < Ne ? e.styles = {
                ...e.styles,
                height: Be ? `${a}px` : null,
                transform: `translate3d(${Gt(e,-1,n)}px, ${et}px, 0) scale(${Ht()})`
              } : e.itemNumber > Ne ? e.styles = {
                ...e.styles,
                height: Be ? `${a}px` : null,
                transform: `translate3d(${Gt(e,1,n)}px, ${et}px, 0) scale(1)`
          ...
          (0, d.useEffect)((() => {
            !1 !== ze && !0 !== de && (ue(!0), Re(!1), Zt(Ne, W.length, !0), B.current && (B.current.style.transition = "all var(--eventDeck-transitionCardOpen)", B.current.style.transform = `translateY(${et}px)`), tn(), Be ? (Se(0), lt(!1), st(!0)) : Ye(!0))
          }), [ze]), (0, d.useEffect)((() => {
          ...
          const nn = function() {
            ...
            H(W.map((t => {
              if (t.upNext = zt(t.itemNumber), t.itemNumber !== Ne) {
                let e = Gt(t, 1);
                t.itemNumber < Ne && (e = Gt(t, -1)), t.styles = {
                  ...t.styles,
                  transform: `translate3d(${e}px, ${Ft(t)}px, 0) scale(${Ht()})`
                }
          ...
          (0, d.useEffect)((() => {
            ...
            Le < pe * me && 0 === ye ? (Se(0), G(!0), R(!0)) : xe < $e ? (G(!0), R(!1), he(ce), Se($e)) : xe < 0 && (G(!1), he(ce - 1)), Le > pe * me && F && G(!1)
          }), [$e]), (0, d.useEffect)((() => {
            if (P.current) {
              I(P.current);
      ...
      const T = (0, w.defineMessages)({
        ...
        C = e => {
          ...
          const h = (0, d.useTinaPayload)(),
            ...
            k = h?.content[0]?._memoq ? h?.content[0]?._memoq?.body : null;
          return (0, r.useEffect)((() => {
            ...
            textOverlayProps: o,
            modalProps: {
              className: E.customModal,
              contentClassName: E.customModalContent
            },
            expandedCardContents: (0, f.jsx)(g.Z, {
              images: c,
              prod: x,
            ...
            children: (0, f.jsx)(b.Z, {
              ...
              children: (0, f.jsxs)("div", {
                ...
                children: [(0, f.jsx)("img", {
                  ...
                  type: "button",
                  children: (0, f.jsx)(w.FormattedMessage, {
                    ...T.card_learn_more
                  })
                })]
              })
