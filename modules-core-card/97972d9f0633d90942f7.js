    ...
    7184: (e, t, a) => {
      ...
      const b = e => {
          ...
          const x = (0, c.createRef)(),
            ...
            z = (e, t) => {
              const a = (e?.documentElement ? F(e?.documentElement, "--root-font-size") : 0) * (g?.current ? F(g?.current, "--eventDeck-modalGuttersMobile") : 0);
              T((t?.innerWidth || 0) - 2 * a)
            };
          return (0, c.useEffect)((() => {
            if (!0 === v && !1 === p) S(0), 1 === o && console.log("setting slide distance", 0);
            else if (h.current) {
            ...
            N.current && N?.current?.clientHeight > 0 && M(N?.current?.clientHeight)
          }), [N]), (0, c.useEffect)((() => {}), [C, R]), (0, c.useEffect)((() => {
            H(!1 !== p ? !1 !== d ? {
              height: `${R}px`,
              width: `${R}px`
            } : {
        ...
        L = () => {
          ...
          const s = (0, c.createRef)(),
            ...
            We = e => e.map(((e, t) => {
              let a = t * H,
                i = t;
              return !1 === fe && (i = Math.ceil(.5 * t) + 1, t > 0 && (a = 2 === i ? T : T + H * (i - 2))), {
                ...e,
                mobileMode: fe,
                itemNumber: t,
                columnNumber: i,
          ...
          }), [Ne]), (0, c.useEffect)((() => (document.addEventListener("keydown", He), () => {
