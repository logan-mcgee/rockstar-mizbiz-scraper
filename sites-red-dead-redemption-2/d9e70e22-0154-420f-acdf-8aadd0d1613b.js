    ...
    84853: (e, a, s) => {
      ...
      const g = (0, r.withIntl)((e => {
        ...
        const f = (0, i.useRef)(null),
          ...
          b = /^#/.test(s),
          h = g?.target ?? (n ? "_blank" : "_self");
        let {
          ...j
        } = g, v = "";
        if ("aria-label" in j && j["aria-label"] && (v = "_blank" === h ? `${j["aria-label"]} ${u.formatMessage(m.aria_label_open_new_window)}` : j["aria-label"]), (0, i.useEffect)((() => {
          ...
          return (0, _.jsxs)("a", {
            ...
            "aria-label": v,
            ref: f,
            children: [a, "_blank" === h && !v && (0, _.jsx)("span", {
              className: p,
              children: u.formatMessage(m.aria_label_open_new_window)
            })]
          })
        }
        if (k) return (0, _.jsxs)(l.NavLink, {
          title: o,
          to: s,
          onClick: c,
          ...j,
