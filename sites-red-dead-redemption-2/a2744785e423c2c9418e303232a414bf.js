! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "d8ec8feb-96e4-4a1b-96c4-1f7b372818b9", e._sentryDebugIdIdentifier = "sentry-dbid-d8ec8feb-96e4-4a1b-96c4-1f7b372818b9")
  } catch (e) {}
}();
  ...
  [108, 240], {
    99576: (e, a, t) => {
      ...
      function d(e, a, t) {
        var s, r = {},
          d = null,
          n = null;
        for (s in void 0 !== t && (d = "" + t), void 0 !== a.key && (d = "" + a.key), void 0 !== a.ref && (n = a.ref), a) m.call(a, s) && !i.hasOwnProperty(s) && (r[s] = a[s]);
        if (e && e.defaultProps)
    ...
    29108: (e, a, t) => {
      ...
      var s = t(33052),
        ...
        m = t(45792),
        c = t(41272);
      const i = JSON.parse('{"us":{"rdr2_download_android":"Get Red Dead Redemption 2 Official Companion App on Google Play.","rdr2_download_ios":"Download Red Dead Redemption 2 Official Companion App on the App Store.","rdr2_download_label":"Download {name} image in {size} size.","rdr2_download_pixels_label":"Download {name} image of {size1} pixels by {size2} pixels."},"de":{"rdr2_download_label":"Herunterladen: Bild {name}, Größe: {size}","rdr2_download_pixels_label":"Herunterladen: Bild {name}, Größe: {size1} Pixel mal {size2} Pixel"},"es":{"rdr2_download_label":"Descargar la imagen «{name}» en tamaño {size}.","rdr2_download_pixels_label":"Descargar imagen {name} de {size1} por {size2} píxeles."},"mx":{"rdr2_download_label":"Descarga la imagen {name} con la siguiente resolución: {size}.","rdr2_download_pixels_label":"Descarga la imagen {name} de {size1} píxeles por {size2} píxeles."},"fr":{"rdr2_download_label":"Téléchargez l\'image {name} en taille {size}.","rdr2_download_pixels_label":"Téléchargez l\'image {name} en {size1}x{size2}."},"it":{"rdr2_download_label":"Scarica l’immagine “{name}” in formato {size}.","rdr2_download_pixels_label":"Scarica l’immagine “{name}” in formato {size1} pixel x {size2} pixel."},"jp":{"rdr2_download_label":"{size}サイズでイメージ「{name}」をダウンロード","rdr2_download_pixels_label":"{size1}ピクセルｘ{size2}ピクセルのイメージ{name}をダウンロード"},"kr":{"rdr2_download_label":"{size} 크기의 {name} 이미지 다운로드.","rdr2_download_pixels_label":"{size1} x {size2} 픽셀의 {name} 이미지 다운로드."},"pl":{"rdr2_download_label":"Pobierz obraz: {name} w rozdzielczości: {size}.","rdr2_download_pixels_label":"Pobierz obraz: {name} w rozdzielczości {size1} pikseli na {size2} pikseli."},"br":{"rdr2_download_label":"Baixe a imagem {name} no tamanho {size}.","rdr2_download_pixels_label":"Baixe a imagem {name} com {size1} x {size2} pixels."},"ru":{"rdr2_download_label":"Загрузить изображение \\"{name}\\" в размере \\"{size}\\".","rdr2_download_pixels_label":"Загрузить изображение \\"{name}\\" в размере {size1} на {size2} пикселей."},"hans":{"rdr2_download_label":"下载 {name} 图片，{size} 大小。","rdr2_download_pixels_label":"下载 {name} 图片，{size1} 个像素点 x {size2} 个像素点大小。"},"tw":{"rdr2_download_label":"下載 {size} 大小的「{name}」圖片。","rdr2_download_pixels_label":"下載 {size1}x{size2} 像素的「{name}」圖片。"}}');
      var d = t(95240);
      const n = () => {
      ...
      const u = {
            ...
            children: [(0, d.jsx)("div", {
              ...
              children: t.items.filter((e => {
                ...
                return (0, d.jsx)(o.A, {
                  ...
                  onClick: r,
                  download: !0,
                  "aria-label": s.formatMessage(l.rdr2_download_label, {
                    name: t.label,
                    size: a(m)
                  }),
                  children: a(m)
                }, `wallpaper_${t.label}_${m}`)
              }))
            })]
          })
        },
          ...
          return (0, d.jsxs)("div", {
            ...
            children: [(0, d.jsx)("div", {
              ...
              children: t.items.filter((e => {
                ...
                const i = a(m).toLowerCase().split("x");
                return (0, d.jsx)(o.A, {
                  to: c,
                  onClick: r,
                  download: !0,
                  "aria-label": s.formatMessage(l.rdr2_download_pixels_label, {
                    name: t.label,
                    size1: i[0],
                    size2: i[1]
                  }),
        ...
        k = (0, m.withTranslations)((e => {
          ...
          const t = (0, c.useIntl)(),
            {
              data: r
            } = (0, s.useQuery)(f.downloads);
          if (!r) return null;
          const m = r?.art?.series?.[0]?.groups ?? [],
            i = r?.avatars?.series?.[0]?.groups;
          return (0, d.jsxs)("div", {
                ...
                children: [(0, d.jsxs)("div", {
                  ...
                  children: [(0, d.jsx)("div", {
                    ...
                    children: [(0, d.jsx)(o.A, {
                      ...
                      "aria-label": t.formatMessage(l.rdr2_download_ios)
                    }), (0, d.jsx)(o.A, {
                      to: a("downloads-companion_google_href"),
                      target: "_blank",
                      className: u.companionLinkGoogle,
                      "aria-label": t.formatMessage(l.rdr2_download_android)
                    }), (0, d.jsx)("p", {
        ...
        h = () => {
          ...
          return _.includes(e) ? e : (0, d.jsx)(o.Wasted, {})
        },
        x = (0, m.withTranslations)((e => {
          let {
            children: a,
            p: t,
            t: s,
        ...
        y = e => {
          ...
          return (0, d.jsxs)("div", {
            ...
            children: [(0, d.jsx)("div", {
              ...
              children: [(0, d.jsx)(o.A, {
                to: w(a, "showcase-1-full"),
                target: "_blank",
                "aria-label": `${a} 1`
              }), (0, d.jsx)(o.A, {
                to: w(a, "showcase-2-full"),
                target: "_blank",
                "aria-label": `${a} 2`
              })]
            })]
      ...
      const O = [{
        ...
        E = e => {
          ...
          return (0, d.jsxs)("section", {
            className: S.albumSection,
            children: [(0, d.jsx)("h2", {
              children: c(s)
            }), (0, d.jsx)("span", {
              className: [S.albumDesc, S.readable].join(" "),
              dangerouslySetInnerHTML: {
                __html: c(o)
              }
            }), (0, d.jsxs)("div", {
      ...
      const M = e => {
        ...
        A = (0, m.withTranslations)((e => {
          ...
          return i ? (0, d.jsx)(o.A, {
            to: t(28300)(`./${i}`),
            target: "_blank",
            children: n
          }) : n
        }), "rdr2"),
        C = (0, m.withTranslations)((e => {
          let {
            children: a,
            t,
            title: s
          ...
          return (0, d.jsxs)("section", {
            ...
            children: [s && (0, d.jsx)("h2", {
              children: t(s)
            }), a]
          })
        }), "rdr2");
      var $ = t(93956);
      const U = (0, m.withTranslations)((() => {
        const {
          data: e
        } = (0, s.useQuery)($.rdr2FeaturesItems);
        if (!e) return null;
        const a = L().groupBy(e.rdr2FeaturesItems, "section");
        return (0, d.jsxs)(v, {
          children: [(0, d.jsx)(x, {
            p: "feature-sc-desc",
            children: (0, d.jsx)("div", {
            ...
            children: a.unlocks?.map((e => (0, d.jsx)(A, {
              h3: e.title,
            ...
            children: a.catalogue?.map((e => (0, d.jsx)(A, {
              h3: e.title,
              imgPath: `features-items/${e.id}.jpg`,
              p: e.description
            }, e.id)))
            ...
            children: a.progress?.map((e => (0, d.jsx)(A, {
              h3: e.title,
              imgPath: `features-items/${e.id}.jpg`,
              p: e.description
            }, e.id)))
            ...
            children: a.cam?.map((e => (0, d.jsx)(A, {
              h3: e.title,
              imgPath: `features-items/${e.id}.jpg`,
              p: e.description
            }, e.id)))
      ...
      const W = ["revolver", "face", "snow", "double"],
        R = ["shot", "mark", "vital", "fire"],
      ...
      const Q = (e, a) => `${t(51796)(`./${e}-full.jpg`)}?im=Resize=${a}`,
        ...
        Y = e => {
          ...
          return (0, d.jsx)("div", {
            ...
            children: a.map((e => (0, d.jsx)(X, {
              id: e.id
            }, e.id)))
          })
        },
        K = ["coyote", "buck", "vulture", "eagle", "alligator", "walker", "bear", "sturgeon", "monster", "horse"],
        Z = ["butcher", "snow", "bow", "fishing"],
        ee = ["walking", "stable", "swamp", "snow"],
        ae = {
          FrontiersCitiesAndTowns: N,
          Music: F,
          SocialClub: U,
          VanderlindeGang: () => {
            const {
              data: e
            } = (0, s.useQuery)(P.rdr2GangMembers);
            return e ? (0, d.jsxs)(v, {
              children: [(0, d.jsx)(x, {
                ...
                children: e?.rdr2GangMembers?.map((e => (0, d.jsx)(V, {
                  member: e
                }, e.name_slug)))
              })]
            }) : null
          ...
          Wildlife: (0, m.withTranslations)((e => {
            ...
            const {
              data: t
            } = (0, s.useQuery)(B.rdr2Screenshots);
            return t ? (0, d.jsxs)(v, {
              children: [(0, d.jsx)(x, {
                h1: "Wildlife",
                p: "features-wildlife-desc"
              }), (0, d.jsx)(C, {
                children: K.map((e => (0, d.jsx)(A, {
                  imgPath: `zoo-${e}.jpg`,
                  imgAspect: "1",
                  t: a
                }, e)))
      ...
      const se = e => {
        ...
        oe = (0, m.withTranslations)((e => {
          let {
            t: a
          } = e;
          const {
            data: o
          } = (0, s.useQuery)(te.rdr2Home), r = (0, m.useLocale)();
          return o ? (0, d.jsxs)("div", {
            children: [(0, d.jsx)("section", {
              ...
              children: o?.rdr2HomeFeatures?.map((e => (0, d.jsx)(se, {
                feature: e
              }, e.id)))
            }), (0, d.jsx)("section", {
      ...
      const re = (0, m.withTranslations)((e => {
          let {
            t: a
          } = e;
        ...
        me = () => (0, d.jsx)("div", {
          ...
          children: (0, d.jsx)(o.NewswireList, {
            tagId: 716,
      ...
      const ne = e => {
          ...
          return (0, d.jsxs)("div", {
            className: [de.screen, s].join(" "),
            children: [(0, d.jsx)("div", {
              className: de.screenImg,
              style: {
                "--bg-img": `url(${t(9364)(`./${o}.jpg`)})`
              }
            }), (0, d.jsx)("p", {
              className: de.screenCaption,
              children: a
            })]
          })
        },
        pe = (0, m.withTranslations)((e => {
          let {
            t: a
          } = e;
          return (0, d.jsxs)("div", {
            ...
            children: [(0, d.jsx)("section", {
              ...
              children: [(0, d.jsx)(ne, {
                ...
                className: [de.allCols, de.specs].join(" "),
                children: [(0, d.jsx)("h2", {
                  children: a("pc-specs")
                }), (0, d.jsx)("p", {
                  className: de.allCols,
      ...
      const le = () => {
        const {
          data: e
        } = (0, s.useQuery)(ge.rdr2Screenshots);
        return e ? (0, d.jsx)(Y, {
      ...
      const je = {
        ...
        be = e => {
          ...
          return (0, d.jsxs)(o.A, {
            className: [je.video, a === t ? je.activeVideo : ""].join(" "),
            to: `?id=${t}`,
            children: [(0, d.jsx)("div", {
              className: je.screencap,
              style: {
                "--bg-img": `url(${s})`
              }
            }), (0, d.jsx)("h3", {
        ...
        ke = () => {
          const [e] = (0, g.useSearchParams)(), {
            data: a
          } = (0, s.useQuery)(ue.videos), {
            refetch: t
          } = (0, s.useQuery)(ue.video, {
            skip: !0
          }), [o, r] = (0, fe.useState)(null), [m, c] = (0, fe.useState)(null);
          return (0, fe.useEffect)((() => {
            const t = e.get("id") ?? a?.videos?.results?.[0]?.id ?? null;
            t && r(Number(t))
          }), [a, e.get("id")]), (0, fe.useEffect)((() => {
            ...
            className: je.videos,
            children: [(0, d.jsxs)("section", {
              className: je.currentVideo,
              children: [(0, d.jsx)(ie(), {
                autoplay: !0,
                id: e.get("id") ?? a?.videos?.results?.[0]?.id,
                resolution: "1080p"
              }), (0, d.jsxs)("div", {
                className: je.currentVideoInfo,
                children: [(0, d.jsx)("h3", {
                  children: m.title
                }), (0, d.jsx)("p", {
                  dangerouslySetInnerHTML: {
              ...
              className: je.screencaps,
              children: a?.videos?.results?.map((e => (0, d.jsx)(be, {
                currentVideoId: m.id,
                video: e
              }, e.id)))
            })]
        ...
        _e = [{
          ...
          element: (0, d.jsx)(ae.VanderlindeGang, {})
        }, {
          path: "features/frontiercitiesandtowns",
          element: (0, d.jsx)(ae.FrontiersCitiesAndTowns, {})
        }, {
          path: "features/music",
          element: (0, d.jsx)(ae.Music, {})
        }, {
          path: "features/socialclub",
          element: (0, d.jsx)(ae.SocialClub, {})
        }, {
          path: "features/weaponry",
          element: (0, d.jsx)(ae.Weaponry, {})
        }, {
          path: "features/wildlife",
          element: (0, d.jsx)(ae.Wildlife, {})
        }, {
          ...
          path: "*",
          element: (0, d.jsx)(o.Wasted, {
            error: {
              code: window?.env?.responseStatusCode ?? 398
            }
          })
        }],
        he = (0, o.withSimpleErrorBoundary)((() => (0, g.useRoutes)(_e))),
        xe = {
        ...
        ve = (0, c.withIntl)((0, m.withTranslations)((e => {
          let {
            t: a
          } = e;
          const {
          ...
          let m = !1;
          return m = !0, (0, r.useAgegated)()((0, d.jsxs)("div", {
            className: xe.gameSite,
            children: [!1, (0, d.jsx)("div", {
              className: [xe.gameSiteContent, t ? xe.navOpen : ""].join(" "),
              children: (0, d.jsx)(he, {})
            }), (0, d.jsxs)("footer", {
              className: [xe.footer, t ? xe.navOpen : ""].join(" "),
              children: [(0, d.jsx)("div", {
                className: xe.date,
                children: a("date")
              }), (0, d.jsx)("div", {
                className: xe.rating,
                children: (0, d.jsx)(o.Rating, {
