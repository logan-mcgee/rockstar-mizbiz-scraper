      ...
      const r = (e, o) => {
        ...
        p = () => {
          const {
            ...
            return i && !s || r(e, o), [i, (d = e, e => {
              r(d, e)
            })];
            var d
          }(`rockstarweb_lang.${o.cookieIdentifier}`, s ?? void 0);
          let d = t;
          return d = o.currentSite?.site === l.U.www ? b.find((e => e.subdomaincom === n)) || b.find((e => e.subdomaincom === s)) || t : b.find((e => e.iso === a)) || t, [d, i]
        };
      var f = s(95240);
      const w = e => {
        let {
...
//# sourceMappingURL=55ba28f3cc8d760b34612b41aa9aeacd.js.map