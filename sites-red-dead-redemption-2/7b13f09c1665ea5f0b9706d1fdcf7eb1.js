! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "a5a8b97a-095c-4ffd-8808-440330af8148", e._sentryDebugIdIdentifier = "sentry-dbid-a5a8b97a-095c-4ffd-8808-440330af8148")
  } catch (e) {}
}();
  ...
  [376, 240], {
    ...
    56376: (e, a, t) => {
      ...
      const A = (0, m.withTranslations)((() => {
        ...
        return (0, c.jsxs)(h, {
          children: [(0, c.jsx)(k, {
            ...
            children: a.unlocks?.map((e => (0, c.jsx)(L, {
              h3: e.title,
            ...
            children: a.catalogue?.map((e => (0, c.jsx)(L, {
              h3: e.title,
              imgPath: `features-items/${e.id}.jpg`,
              p: e.description
            }, e.id)))
            ...
            children: a.progress?.map((e => (0, c.jsx)(L, {
              h3: e.title,
              imgPath: `features-items/${e.id}.jpg`,
              p: e.description
            }, e.id)))
            ...
            children: a.cam?.map((e => (0, c.jsx)(L, {
              h3: e.title,
              imgPath: `features-items/${e.id}.jpg`,
              p: e.description
            }, e.id)))
      ...
      const U = ["revolver", "face", "snow", "double"],
        ...
        V = ["bolt", "carbine", "cattleman", "shotgun"],
        W = [1, 2, 3, 4, 5, 6, 7],
        q = e => {
          let {
            slug: a,
      ...
      const G = (e, a) => `${t(51796)(`./${e}-full.jpg`)}?im=Resize=${a}`,
        ...
        B = ["coyote", "buck", "vulture", "eagle", "alligator", "walker", "bear", "sturgeon", "monster", "horse"],
        X = ["butcher", "snow", "bow", "fishing"],
        Y = ["walking", "stable", "swamp", "snow"],
        K = {
      ...
      const fe = {
        ...
        le = e => {
          ...
          return (0, c.jsxs)(o.A, {
            className: [fe.video, a === t ? fe.activeVideo : ""].join(" "),
            to: `?id=${t}`,
            children: [(0, c.jsx)("div", {
              className: fe.screencap,
              style: {
                "--bg-img": `url(${s})`
              }
            }), (0, c.jsx)("h3", {
        ...
        ue = () => {
          ...
          return (0, pe.useEffect)((() => {
            ...
            className: fe.videos,
            children: [(0, c.jsxs)("section", {
              className: fe.currentVideo,
              children: [(0, c.jsx)(re(), {
                autoplay: !0,
                id: e.get("id") ?? a?.videos?.results?.[0]?.id,
                resolution: "1080p"
              }), (0, c.jsxs)("div", {
                className: fe.currentVideoInfo,
                children: [(0, c.jsx)("h3", {
                  children: m.title
                }), (0, c.jsx)("p", {
                  dangerouslySetInnerHTML: {
              ...
              className: fe.screencaps,
              children: a?.videos?.results?.map((e => (0, c.jsx)(le, {
                currentVideoId: m.id,
                video: e
              }, e.id)))
            })]
        ...
        je = [{
          ...
          element: (0, c.jsx)(K.VanderlindeGang, {})
        }, {
          path: "features/frontiercitiesandtowns",
          element: (0, c.jsx)(K.FrontiersCitiesAndTowns, {})
        }, {
          path: "features/music",
          element: (0, c.jsx)(K.Music, {})
        }, {
          path: "features/socialclub",
          element: (0, c.jsx)(K.SocialClub, {})
        }, {
          path: "features/weaponry",
          element: (0, c.jsx)(K.Weaponry, {})
        }, {
          path: "features/wildlife",
          element: (0, c.jsx)(K.Wildlife, {})
        }, {
