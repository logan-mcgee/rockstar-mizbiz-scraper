! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "32a5b894-5052-4eb3-8323-8afcd639ba25", e._sentryDebugIdIdentifier = "sentry-dbid-32a5b894-5052-4eb3-8323-8afcd639ba25")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [108, 240], {
    99576: (e, a, t) => {
      ...
      function c(e, a, t) {
        var s, r = {},
          c = null,
          n = null;
        for (s in void 0 !== t && (c = "" + t), void 0 !== a.key && (c = "" + a.key), void 0 !== a.ref && (n = a.ref), a) m.call(a, s) && !d.hasOwnProperty(s) && (r[s] = a[s]);
        if (e && e.defaultProps)
    ...
    29108: (e, a, t) => {
      ...
      const u = {
            ...
            children: [(0, c.jsx)("div", {
              ...
              children: t.items.filter((e => {
                ...
                return (0, c.jsx)(o.A, {
                  ...
                  download: !0,
                  "aria-label": s.formatMessage(g.rdr2_download_label, {
                    name: t.label,
                    size: a(r)
                  }),
                  children: a(r)
          ...
          return (0, c.jsxs)("div", {
            ...
            children: [(0, c.jsx)("div", {
              ...
              children: t.items.filter((e => {
                ...
                const d = a(r).toLowerCase().split("x");
                return (0, c.jsx)(o.A, {
                  to: i,
                  onClick: m.downloadFile,
                  download: !0,
                  "aria-label": s.formatMessage(g.rdr2_download_pixels_label, {
                    name: t.label,
                    size1: d[0],
                    size2: d[1]
                  }),
                ...
                children: [(0, c.jsxs)("div", {
                  ...
                  children: [(0, c.jsx)("div", {
                    ...
                    children: [(0, c.jsx)(o.A, {
                      ...
                      "aria-label": t.formatMessage(g.rdr2_download_ios)
                    }), (0, c.jsx)(o.A, {
                      to: a("downloads-companion_google_href"),
                      target: "_blank",
                      className: u.companionLinkGoogle,
                      "aria-label": t.formatMessage(g.rdr2_download_android)
                    }), (0, c.jsx)("p", {
        ...
        h = () => {
          ...
          return _.includes(e) ? e : (0, c.jsx)(o.Wasted, {})
        },
        x = (0, m.withTranslations)((e => {
          ...
          const m = ["rockstargames-sites-red-dead-redemption-2a133025b71fc515c267b8dd5b23f5ba8"];
          return a || m.push("rockstargames-sites-red-dead-redemption-2fcf70cc91638b2f976519b6505af0cb9"), (0, c.jsxs)("div", {
            className: m.join(" "),
      ...
      const $ = (0, m.withTranslations)((() => {
        const {
          data: e
        } = (0, s.useQuery)(R.rdr2FeaturesItems);
        if (!e) return null;
        const a = A().groupBy(e.rdr2FeaturesItems, "section");
        return (0, c.jsxs)(v, {
          children: [(0, c.jsx)(x, {
            p: "feature-sc-desc",
            children: (0, c.jsx)("div", {
      ...
      const G = ["revolver", "face", "snow", "double"],
        V = ["shot", "mark", "vital", "fire"],
        W = ["bolt", "carbine", "cattleman", "shotgun"],
        q = [1, 2, 3, 4, 5, 6, 7],
        H = e => {
          let {
            slug: a,
          ...
          VanderlindeGang: () => {
            ...
            return e ? (0, c.jsxs)(v, {
              children: [(0, c.jsx)(x, {
                ...
                children: e?.rdr2GangMembers?.map((e => (0, c.jsx)(U, {
                  member: e
                }, e.name_slug)))
              })]
            }) : null
        ...
        oe = (0, m.withTranslations)((e => {
          ...
          return o ? (0, c.jsxs)("div", {
            children: [(0, c.jsx)("section", {
              ...
              children: o?.rdr2HomeFeatures?.map((e => (0, c.jsx)(se, {
                feature: e
              }, e.id)))
            }), (0, c.jsx)("section", {
      ...
      const ne = e => {
          ...
          return (0, c.jsxs)("div", {
            className: [ce.screen, s].join(" "),
            children: [(0, c.jsx)("div", {
              className: ce.screenImg,
              style: {
                "--bg-img": `url(${t(9364)(`./${o}.jpg`)})`
              }
            }), (0, c.jsx)("p", {
              className: ce.screenCaption,
              children: a
            })]
          })
        },
          ...
          return (0, c.jsxs)("div", {
            ...
            children: [(0, c.jsx)("section", {
              ...
              children: [(0, c.jsx)(ne, {
                ...
                className: [ce.allCols, ce.specs].join(" "),
                children: [(0, c.jsx)("h2", {
                  children: a("pc-specs")
                }), (0, c.jsx)("p", {
                  className: ce.allCols,
      ...
      const ge = () => {
        const {
          data: e
        } = (0, s.useQuery)(le.rdr2Screenshots);
        return e ? (0, c.jsx)(Y, {
      ...
      const je = {
        ...
        ke = () => {
          const [e] = (0, l.useSearchParams)(), {
            data: a
          } = (0, s.useQuery)(ue.videos), {
            refetch: t
          } = (0, s.useQuery)(ue.video, {
            skip: !0
          }), [o, r] = (0, fe.useState)(null), [m, i] = (0, fe.useState)(null);
          return (0, fe.useEffect)((() => {
            ...
            children: [(0, c.jsxs)("section", {
              ...
              children: a?.videos?.results?.map((e => (0, c.jsx)(be, {
                currentVideoId: m.id,
                video: e
              }, e.id)))
            })]
        ...
        _e = [{
          ...
          element: (0, c.jsx)(ae.VanderlindeGang, {})
        }, {
          path: "features/frontiercitiesandtowns",
          element: (0, c.jsx)(ae.FrontiersCitiesAndTowns, {})
        }, {
          path: "features/music",
          element: (0, c.jsx)(ae.Music, {})
        }, {
          path: "features/socialclub",
          element: (0, c.jsx)(ae.SocialClub, {})
        }, {
          path: "features/weaponry",
          element: (0, c.jsx)(ae.Weaponry, {})
        }, {
          path: "features/wildlife",
          element: (0, c.jsx)(ae.Wildlife, {})
        }, {
        ...
        he = (0, o.withSimpleErrorBoundary)((() => (0, l.useRoutes)(_e))),
        xe = {
        ...
        ve = (0, i.withIntl)((0, m.withTranslations)((e => {
          let {
            t: a
          } = e;
          const {
    ...
    20900: (e, a, t) => {
      ...
      })), e.exports = s, e.exports.videos = d(s, "videos"), e.exports.video = d(s, "video")
    },
    88440: (e, a, t) => {
      var s = {
