...
_global.SENTRY_RELEASE = {
  ...
  [832], {
    24: (e, a, t) => {
      ...
      var i = t(95240);
      const f = (0, d.withTranslations)((e => {
          let {
            agegateValue: a,
            options: t = {},
            t: s
          ...
          const {
            mutateLSSettings: r
          } = (0, d.useRockstarWebLSSettings)(), [f, u] = (0, n.useState)(null), g = (0, n.createRef)(), c = (0, n.createRef)(), b = (0, n.createRef)(), {
            style: p
          } = t;
          return !1 === a ? (0, i.jsxs)("div", {
            ...
            children: [t?.header, (0, i.jsx)("div", {
              ...
              onSubmit: async e => {
                e.preventDefault();
                const a = `${b.current.value}-${g.current.value.padStart(2,0)}-${c.current.value.padStart(2,0)}`,
