  ...
  return Object.defineProperty(r, "__esModule", {
    ...
    execute: function() {
      e((() => {
        var e, s, l, u, c = {
            79344: (e, t, r) => {
              ...
              function w(e, t, r) {
                ...
                let a = null;
                for (let e = 0; null == a && e < o.length; ++e) a = j(o[e], O(n));
                return a
              }
              ...
              function T(e, t) {
                let r = e.split("/"),
                  n = r.length;
                return r.some(P) && (n += L), t && (n += C), r.filter((e => !P(e))).reduce(((e, t) => e + (x.test(t) ? _ : "" === t ? k : D)), n)
              }
              ...
              function fe(e) {
                ...
                let k, D, L = !(_.some((e => e.route.lazy)) || _.some((e => e.route.loader)) && null == e.hydrationData),
                  P = {
                ...
                return k = {
                  ...
                  fetch: function(t, r, n, d) {
                    ...
                    j = !0 === (d && d.preventScrollReset), g && Ae(g.formMethod) ? async function(t, r, n, o, d, h) {
                      ...
                      let _ = Fe(h, g.data);
                      P.fetchers.set(t, _);
                      let [C, k] = me(e.history, P, R, h, b, I, B, F, K, q, S, f, {
                        [o.route.id]: g.data
                      }, void 0);
                      ...
                      let {
                        loaderData: U,
                        errors: N
                      } = Re(P, P.matches, C, A, void 0, k, M, V);
                      if (P.fetchers.has(t)) {
                        let e = $e(g.data);
                        P.fetchers.set(t, e)
                      }
            ...
            47461: (e, t, r) => {
              "use strict";
              var n = {
                  "./index": () => Promise.all([r.e(52), r.e(832)]).then((() => () => r(31832)))
                },
        ...
        return f.m = c, f.c = d, f.y = t, f.n = e => {
        ...
        }(), f.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = {}, s = "@rockstargames/sites-red-dead-redemption-2:", f.l = (t, r, n, o) => {
          if (e[t]) e[t].push(r);
          else {
            var a, i;
            if (void 0 !== n)
        ...
        }, f.nmd = e => (e.paths = [], e.children || (e.children = []), e), l = {
          832: [3061, 16660, 21668, 33052, 45792, 67308, 84644]
        }, u = {
          3061: ["default", "./hooks", 9344],
          16660: ["default", "./index", 25430],
          21668: ["default", "./index", 18856],
          ...
          f.I = (r, n) => {
            ...
            if (o || (o = t[r] = {}), !(n.indexOf(o) >= 0)) {
              ...
              var a = f.S[r],
                ...
                u = [];
              return "default" === r && (s("lodash", "4.17.21", (() => f.e(648).then((() => () => f(25648))))), s("react-router-dom", "6.17.0", (() => () => f(79344)), 1), s("react", "18.2.0", (() => () => f(38188)), 1), l(18856), l(33864), l(25430), l(14472), l(9344)), u.length ? e[r] = Promise.all(u).then((() => e[r] = 1)) : e[r] = 1
            }
          }
        })(), (() => {
          var e;
          ...
          var e = e => {
            ...
            o = {},
            a = {
              1320: () => n("default", "react-router-dom", [1, 6, 11, 2], (() => () => f(79344))),
              73660: () => n("default", "lodash", [1, 4, 17, 21], (() => f.e(648).then((() => () => f(25648))))),
              88200: () => n("default", "react", [1, 18, 2, 0], (() => () => f(38188)))
            };
          [88200].forEach((e => {
            f.m[e] = t => {
              o[e] = 0, delete f.c[e];
