! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      n = (new Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "94b6e8b8-66b3-43f1-8048-61cc3c2626ad", e._sentryDebugIdIdentifier = "sentry-dbid-94b6e8b8-66b3-43f1-8048-61cc3c2626ad")
  } catch (e) {}
}();
  ...
  [721], {
    50721: (e, n, r) => {
      ...
      A.absoluteValue = A.abs = function() {
        ...
        var r, t = this,
          i = t.constructor;
        return void 0 === e ? r = _(t, !0) : (I(e, 0, a), void 0 === n ? n = i.rounding : I(n, 0, 8), r = _(t = k(new i(t), e + 1, n), !0, e + 1)), t.isNeg() && !t.isZero() ? "-" + r : r
      }, A.toFixed = function(e, n) {
        var r, t, i = this,
          u = i.constructor;
        return void 0 === e ? r = _(i) : (I(e, 0, a), void 0 === n ? n = u.rounding : I(n, 0, 8), r = _(t = k(new u(i), e + i.e + 1, n), !1, e + t.e + 1)), i.isNeg() && !i.isZero() ? "-" + r : r
        ...
        var r, t = this,
          i = t.constructor;
        return void 0 === e ? r = _(t, t.e <= i.toExpNeg || t.e >= i.toExpPos) : (I(e, 1, a), void 0 === n ? n = i.rounding : I(n, 0, 8), r = _(t = k(new i(t), e, n), e <= t.e || t.e <= i.toExpNeg, e)), t.isNeg() && !t.isZero() ? "-" + r : r
      ...
      var P = function() {
        ...
        return function(t, i, o, s, a, c) {
          var l, f, d, g, m, p, h, v, y, w, b, F, E, N, x, T, A, O, I, M, B = t.constructor,
            ...
            _ = t.d,
            j = i.d;
          if (!(_ && _[0] && j && j[0])) return new B(t.s && i.s && (_ ? !j || _[0] != j[0] : j) ? _ && 0 == _[0] || !j ? 0 * P : P / 0 : NaN);
          for (c ? (m = 1, f = t.e - i.e) : (c = C, m = S, f = D(t.e / m) - D(i.e / m)), I = j.length, A = _.length, w = (y = new B(P)).d = [], d = 0; j[d] == (_[d] || 0); d++);
          if (j[d] > (_[d] || 0) && f--, null == o ? (N = o = B.precision, s = B.rounding) : N = a ? o + (t.e - i.e) + 1 : o, N < 0) w.push(1), p = !0;
          else {
            if (N = N / m + 2 | 0, d = 0, 1 == I) {
              for (g = 0, j = j[0], N++;
                (d < A || g) && N--; d++) x = g * c + (_[d] || 0), w[d] = x / j | 0, g = x % j | 0;
              p = g || d < A
            } else {
              for ((g = c / (j[0] + 1) | 0) > 1 && (j = e(j, g, c), _ = e(_, g, c), I = j.length, A = _.length), T = I, F = (b = _.slice(0, I)).length; F < I;) b[F++] = 0;
              (M = j.slice()).unshift(0), O = j[0], j[1] >= c / 2 && ++O;
              do {
                g = 0, (l = n(j, b, I, F)) < 0 ? (E = b[0], I != F && (E = E * c + (b[1] || 0)), (g = E / O | 0) > 1 ? (g >= c && (g = c - 1), 1 == (l = n(h = e(j, g, c), b, v = h.length, F = b.length)) && (g--, r(h, I < v ? M : j, v, c))) : (0 == g && (l = g = 1), h = j.slice()), (v = h.length) < F && h.unshift(0), r(b, h, F, c), -1 == l && (l = n(j, b, I, F = b.length)) < 1 && (g++, r(b, I < F ? M : j, F, c)), F = b.length) : 0 === l && (g++, b = [0]), w[d++] = g, l && b[0] ? b[F++] = _[T] || 0 : (b = [_[T]], F = 1)
      ...
      function Y(e, n) {
        ...
        return u < 0 ? new t(0 * e.s) : (e.e = j(c, l), e.d = c, g = !1, o && (e = P(e, i, 4 * s)), a && (e = e.times(Math.abs(a) < 54 ? w(2, a) : Ze.pow(2, a))), g = !0, e)
      }
      ...
      function X(e, n, r, t) {
        ...
        if (v ? (I(r, 1, a), void 0 === t ? t = h.rounding : I(t, 0, 8)) : (r = h.precision, t = h.rounding), e.isFinite()) {
          for (v ? (i = 2, 16 == n ? r = 4 * r - 3 : 8 == n && (r = 3 * r - 2)) : i = n, (s = (g = _(e)).indexOf(".")) >= 0 && (g = g.replace(".", ""), (p = new h(1)).e = g.length - s, p.d = B(_(p), 10, i), p.e = p.d.length), o = f = (m = B(g, 10, i)).length; 0 == m[--f];) m.pop();
          if (m[0]) {
          ...
          case "unit":
            ...
            if (S = void 0, B) S = Er(r, e.roundedNumber.times(Ue.pow(10, a)).toNumber(), n.units.simple[I][M]);
              ...
              var P = I.split("-per-"),
                ...
                _ = P[1];
              B = n.units.simple[k];
              var j = Er(r, e.roundedNumber.times(Ue.pow(10, a)).toNumber(), n.units.simple[k][M]),
