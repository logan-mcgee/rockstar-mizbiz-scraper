! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "c089cdbf-3ca8-445a-9643-861c2216c348", e._sentryDebugIdIdentifier = "sentry-dbid-c089cdbf-3ca8-445a-9643-861c2216c348")
  } catch (e) {}
}();
  ...
  [676], {
    54720: (e, t, a) => {
      ...
      let s, r, i, n, d, o, c, l, m, p, u, f = {
        ...
        de = (e, t, a) => (a = e[t]) && S(a) ? e[t]() : T(a) && e.getAttribute && e.getAttribute(t) || a,
        ...
        We = [].slice,
        Xe = (e, t) => e && C(e) && "length" in e && (!t && !e.length || e.length - 1 in e && C(e[0])) && !e.nodeType && e !== d,
        ...
        et = (e, t) => {
          let a, s, r = P(e);
          return !r && C(e) && (a = r = e.radius || _, e.values ? (e = Ye(e.values), (s = !j(e[0])) && (a *= a)) : e = Je(e.increment)), Ge(t, r ? S(e) ? t => (s = e(t), Math.abs(s - t) <= a ? s : t) : t => {
      ...
      let Bt, Rt, Ft = function(e, t, a, s, r, i, n) {
        ...
        Ut = (e, t, a) => {
          let i, d, o, c, l, m, p, u, f, k, b, v, x, y = e.vars,
            ...
            V = e.timeline;
          if (V && (!P || !w) && (w = "none"), e._ease = It(w, g.ease), e._yEase = L ? Ct(It(!0 === L ? w : L, g.ease)) : 0, L && e._yoyo && !e._repeat && (L = e._yEase, e._yEase = e._ease, e._ease = L), e._from = !V && !!y.runBackwards, !V || P && !y.stagger) {
          ...
          e._onUpdate = T, e._initted = (!e._op || e._pt) && !x, P && t <= 0 && V.render(_, !0, !0)
        },
        Gt = (e, t, a, s) => {
      ...
      class Xt extends At {
        constructor(e, t, a, r) {
          ...
          !0 !== b || s || (Bt = this, n.killTweensOf(S), Bt = 0), Oe(N, this, a), t.reversed && this.reverse(), t.paused && this.paused(!0), (h || !g && !v && this._start === le(N._time) && M(h) && Te(this) && "nested" !== N.data) && (this._tTime = -1e-8, this.render(Math.max(0, -_) || 0)), y && ze(this, y)
        }
        render(e, t, a) {
      ...
      const ir = {
        ...
        getSetter(e, t, a) {
          let s = as[t];
          return s && s.indexOf(",") < 0 && (t = s), t in Ya && t !== _s && (e._gsap.x || zs(e, "x")) ? a && qa === a ? "scale" === t ? ps : ms : (qa = a || {}) && ("scale" === t ? us : fs) : e.style && !T(e.style[t]) ? cs : ~t.indexOf("-") ? ls : Jt(e, t)
        },
        core: {
          _removeProperty: Is,
          _getMatrix: Hs
    ...
    77444: (e, t, a) => {
      ...
      const v = {
        ...
        N = e => {
          ...
          return (0, o.useEffect)((() => {
            const e = "audio",
              t = t => {
                t?.data?.rockstarAudioPlayerPlayTrackId && (d(t.data.rockstarAudioPlayerPlayTrackId), T(!1), g(!0)), u && t?.data?.attentionBlurredElsewhere && t?.data?.from !== e && g(!1)
              };
      ...
      const nt = function(e) {
        ...
        ot = nt((e => {
          ...
          const {
            track: g
          } = (0, $.useGtmTrack)(), _ = (0, o.useRef)(null), h = (0, o.useRef)(null), k = (0, o.useRef)(null), [b, v] = (0, o.useState)(null), [x, y] = (0, o.useState)(!1), [w, N] = (0, o.useState)(null), [S, j] = (0, o.useState)(), [T, C] = (0, o.useState)(), {
            ref: I,
            inView: E
          } = (0, W.cD)({
            threshold: .6
        ...
        _a = e => {
          ...
          const d = (0, c.useIntl)(),
            ...
            j = (0, o.useCallback)(((e, t) => {
              S.current && S.current.slideTo(e), _(e), T(`Career Progress Nav > ${t}`)
            }), [l]),
            T = (e, t) => {
              l({
      ...
      var Pa = a(92104);
      const Oa = (0, k.makeVarNamespace)("@rockstargames/components/profile-switcher"),
      ...
      const Ya = {
        ...
        Qa = e => {
          ...
          const {
            track: g
          } = (0, $.useGtmTrack)(), _ = (0, kt.c)(), h = (0, c.useIntl)();
          let k = s;
          ...
          return (0, f.jsxs)(p.Link, {
            className: d ? "rockstargames-sites-red-dead-redemption-2fdaa918acc06706cbe191dedd40974af" : "rockstargames-sites-red-dead-redemption-2cbc80932118c48d8ec14448d8913d068",
            ...
            children: [t, o && (0, f.jsx)("div", {
              ...
              children: (0, f.jsx)("span", {
                ...
                children: h.formatMessage(Ia.nofications_new)
              })
            })]
          })
        },
        Za = e => {
          ...
          const {
            ...
            navOpen: v
          } = (0, $.useRockstarUserState)(), x = (0, o.useRef)(null), [y, w] = (0, o.useState)(0), [N, S] = (0, o.useState)(0), [j, T] = (0, o.useState)(!0);
          return (0, o.useEffect)((() => {
            m !== t && !1 === j && T(!0), m === t && T(!1)
          }), [m]), (0, o.useEffect)((() => {
            if (!x.current) return;
        ...
        Ja = e => {
          ...
          const {
            ...
            return e
          }), [r, y, w, N]), [j, T] = (0, o.useState)(0), C = (0, o.createRef)(), M = () => {
            if (C.current) {
              const {
                current: e
        ...
        as = e => {
          ...
          const {
            ...
            track: i
          } = (0, $.useGtmTrack)(), n = (0, c.useIntl)(), [d, l] = (0, o.useState)([]), [m, p] = (0, o.useState)(null), [u, g] = (0, o.useState)(null), [_, h] = (0, o.useState)(!1), [k, b] = (0, o.useState)(-1), [v, x] = (0, o.useState)([]), [y, w] = (0, o.useState)(0), N = a(71084), [S, j] = (0, o.useState)("0"), [T, C] = (0, o.useState)("0"), M = e => parseInt(e, 10).toLocaleString("en-US", {
        ...
        ns = (0, V.withTranslations)((e => {
          ...
          const {
            ...
            scNavOpened: N,
            setScNavOpened: S
          } = Ha(), [j, T] = (0, o.useState)(""), C = (0, p.useLocation)(), {
            lsSettings: M
          ...
          return (0, o.useEffect)((() => {
            ...
            le.currentSite?.site === kt.U.socialClub && (e = encodeURIComponent("/")), T(e)
          }), [C]), (0, o.useEffect)((() => {
            ne(L.characters[O] ?? [])
          }), [L, O]), (0, o.useEffect)((() => {
            L && U(L)
        ...
        os = (0, c.withIntl)((() => {
          const {
            ...
            track: y
          } = (0, $.useGtmTrack)(), [w, N] = (0, o.useState)(!1), S = (0, k.useReactiveVar)($.scConfig), j = (0, o.useRef)(), [T, C] = (0, o.useState)(0), M = (0, o.createRef)(), [I, E] = (0, o.useState)(!1), [L, P] = (0, o.useState)(0), [O, z] = (0, o.useState)(!1), {
            mutateLSSettings: A,
            lsSettings: D
          ...
          return (0, o.useEffect)((() => {
            ...
            n && (s && r(!1), l || B(!0))
          }), [n]), null === _ ? null : (0, f.jsxs)(Pa.c, {
            enabled: !!b,
            removeScrollBar: !1,
            children: [(0, f.jsxs)("div", {
              className: [ds.scMenu, b ? ds.navOpen : ""].join(" "),
              "data-logged-in": _,
              "data-mac-browser": O,
              "data-scroll-mode": p,
              ref: M,
              ...
              className: [ds.scOverlay, b ? ds.navOpen : ""].join(" "),
              "data-logged-in": _
            })]
          })
        }), l),
        ...
        ms = (0, c.withIntl)((e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            "data-img-set": k,
            "aria-label": a.formatMessage(n ? Ia.sc_menu_close : Ia.sc_menu_open),
            "aria-expanded": n,
            type: "button",
            onClick: y,
        ...
        us = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            children: (0, f.jsx)("div", {
              className: ps.promoModuleWrapper,
              children: (0, f.jsxs)(Re.q.div, {
