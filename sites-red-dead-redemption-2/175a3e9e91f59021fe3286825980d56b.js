! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "83fdd1d8-eba7-4461-9002-fae20287a812", e._sentryDebugIdIdentifier = "sentry-dbid-83fdd1d8-eba7-4461-9002-fae20287a812")
  } catch (e) {}
}();
  ...
  [376, 584], {
    79584: (e, a, t) => {
      ...
      var s = t(45052),
        ...
        i = t(53592);
      const d = (e, a) => {
          e && a ? document.cookie = `${e}=${a}; domain=${n()}; path=/;` : console.log(`Couldn't set cookie (${e}) to value (${a})`)
        },
        n = () => {
        ...
        f = () => {
          const {
            ...
            const a = g.map((e => e.subdomaincom)),
            ...
            return a?.split("=")[1]
          })(e), o = l, [r, m] = function(e, a) {
            let t = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const s = document.cookie.split("; "),
              o = `${e}=`,
              r = s.find((e => e.startsWith(o))),
              m = r?.substring(o.length, r.length);
            return m && !t || d(e, a), [m, (c = e, e => {
              d(c, e)
            })];
            var c
          }(`rockstarweb_lang.${a.cookieIdentifier}`, t ?? void 0);
          let c = o;
          return c = a.currentSite?.site === i.U.www ? g.find((e => e.subdomaincom === s)) || g.find((e => e.subdomaincom === t)) || o : g.find((e => e.iso === r)) || o, [c, m]
        };
      var u = t(95240);
      const j = e => {
        let {
        ...
        const o = (0, m.useMemo)((() => function(e) {
            let [a, t] = e.split(/[-_]/);
            return t = t?.toLowerCase(), "cn" === t && (t = "hans"), a && t || (a = "en", t = "us"), [a, t]
          }(t)), [t]),
          r = (0, m.useMemo)((() => function(e, a) {
            return e?.[a] ?? {}
          }(a, o[1])), [t, a]);
        return (0, u.jsx)(c.c, {
          messages: r,
    ...
    53592: (e, a, t) => {
      ...
      const s = {
        ...
        r = () => {
          ...
          const {
            location: a
          } = window, t = a.hostname.substring(0, a.hostname.indexOf(".rockstargames.com")), s = o.findIndex((a => Object.entries(a.sites).findIndex((a => {
            let [s, o] = a;
            return o === t && (e = {
              site: s,
              subDomain: o
    ...
    56376: (e, a, t) => {
      ...
      const j = [{
        ...
        b = () => {
          ...
          return j.includes(e) ? e : (0, c.jsx)(o.Wasted, {})
        },
        ...
        _ = ["valentine", "annesburg", "saintdenis", "mounthagen", "rhodes", "strawberry", "lagras"];
      (0, m.importAll)(t(60352));
      const x = (e, a) => t(71980)(`./${e}-${a}.jpg`),
        v = e => {
          let {
            location: a,
            t: s
      ...
      const y = [{
        ...
        S = e => {
          ...
          return (0, c.jsxs)("section", {
            className: w.albumSection,
            children: [(0, c.jsx)("h2", {
              children: i(s)
            }), (0, c.jsx)("span", {
              className: [w.albumDesc, w.readable].join(" "),
              dangerouslySetInnerHTML: {
                __html: i(o)
              }
            }), (0, c.jsxs)("div", {
        ...
        O = (0, m.withTranslations)((e => {
          let {
            t: a
          } = e;
          return (0, c.jsxs)(h, {
            children: [(0, c.jsx)(i, {}), (0, c.jsx)(S, {
              h2: "soundtrack",
      ...
      var I = t(93956);
      const A = (0, m.withTranslations)((() => {
        const {
          data: e
        } = (0, s.useQuery)(I.rdr2FeaturesItems);
        if (!e) return null;
        const a = E().groupBy(e.rdr2FeaturesItems, "section");
        return (0, c.jsxs)(h, {
          children: [(0, c.jsx)(k, {
            p: "feature-sc-desc",
            children: (0, c.jsx)("div", {
            ...
            children: a.unlocks?.map((e => (0, c.jsx)(M, {
              h3: e.title,
            ...
            children: a.catalogue?.map((e => (0, c.jsx)(M, {
              h3: e.title,
              imgPath: `features-items/${e.id}.jpg`,
              p: e.description
            }, e.id)))
            ...
            children: a.progress?.map((e => (0, c.jsx)(M, {
              h3: e.title,
              imgPath: `features-items/${e.id}.jpg`,
              p: e.description
            }, e.id)))
            ...
            children: a.cam?.map((e => (0, c.jsx)(M, {
              h3: e.title,
              imgPath: `features-items/${e.id}.jpg`,
              p: e.description
            }, e.id)))
      ...
      const U = ["revolver", "face", "snow", "double"],
        P = ["shot", "mark", "vital", "fire"],
      ...
      const G = (e, a) => `${t(51796)(`./${e}-full.jpg`)}?im=Resize=${a}`,
        J = e => {
          let {
            id: a
          } = e;
        ...
        B = e => {
          ...
          return (0, c.jsx)("div", {
            ...
            children: a.map((e => (0, c.jsx)(J, {
              id: e.id
            }, e.id)))
          })
        },
        Q = ["coyote", "buck", "vulture", "eagle", "alligator", "walker", "bear", "sturgeon", "monster", "horse"],
        X = ["butcher", "snow", "bow", "fishing"],
        K = ["walking", "stable", "swamp", "snow"],
        Y = {
          FrontiersCitiesAndTowns: z,
          Music: O,
          SocialClub: A,
          VanderlindeGang: () => {
            const {
              data: e
            } = (0, s.useQuery)(C.rdr2GangMembers);
            return e ? (0, c.jsxs)(h, {
              children: [(0, c.jsx)(k, {
                ...
                children: e?.rdr2GangMembers?.map((e => (0, c.jsx)($, {
                  member: e
                }, e.name_slug)))
              })]
            }) : null
          ...
          Wildlife: (0, m.withTranslations)((e => {
            ...
            const {
              data: t
            } = (0, s.useQuery)(R.rdr2Screenshots);
            return t ? (0, c.jsxs)(h, {
              children: [(0, c.jsx)(k, {
                h1: "Wildlife",
                p: "features-wildlife-desc"
              }), (0, c.jsx)(L, {
                children: Q.map((e => (0, c.jsx)(M, {
                  imgPath: `zoo-${e}.jpg`,
                  imgAspect: "1",
                  t: a
                }, e)))
      ...
      const ee = e => {
        ...
        ae = (0, m.withTranslations)((e => {
          let {
            t: a
          } = e;
          const {
            data: o
          } = (0, s.useQuery)(Z.rdr2Home), r = (0, m.useLocale)();
          return o ? (0, c.jsxs)("div", {
            children: [(0, c.jsx)("section", {
              ...
              children: o?.rdr2HomeFeatures?.map((e => (0, c.jsx)(ee, {
                feature: e
              }, e.id)))
            }), (0, c.jsx)("section", {
      ...
      const te = (0, m.withTranslations)((e => {
          let {
            t: a
          } = e;
      ...
      const ce = e => {
          ...
          return (0, c.jsxs)("div", {
            className: [me.screen, s].join(" "),
            children: [(0, c.jsx)("div", {
              className: me.screenImg,
              style: {
                "--bg-img": `url(${t(9364)(`./${o}.jpg`)})`
              }
            }), (0, c.jsx)("p", {
              className: me.screenCaption,
              children: a
            })]
          })
        },
        ie = (0, m.withTranslations)((e => {
          let {
            t: a
          } = e;
          return (0, c.jsxs)("div", {
            ...
            children: [(0, c.jsx)("section", {
              ...
              children: [(0, c.jsx)(ce, {
                ...
                className: [me.allCols, me.specs].join(" "),
                children: [(0, c.jsx)("h2", {
                  children: a("pc-specs")
                }), (0, c.jsx)("p", {
                  className: me.allCols,
      ...
      const ne = () => {
        const {
          data: e
        } = (0, s.useQuery)(de.rdr2Screenshots);
        return e ? (0, c.jsx)(B, {
      ...
      const le = {
        ...
        ue = () => {
          const [e] = (0, n.useSearchParams)(), {
            data: a
          } = (0, s.useQuery)(ge.videos), {
            refetch: t
          } = (0, s.useQuery)(ge.video, {
            skip: !0
          }), [o, r] = (0, pe.useState)(null), [m, i] = (0, pe.useState)(null);
          return (0, pe.useEffect)((() => {
            const t = e.get("id") ?? a?.videos?.results?.[0]?.id ?? null;
            t && r(Number(t))
          }), [a, e.get("id")]), (0, pe.useEffect)((() => {
            ...
            children: [(0, c.jsxs)("section", {
              ...
              children: a?.videos?.results?.map((e => (0, c.jsx)(fe, {
                currentVideoId: m.id,
                video: e
              }, e.id)))
            })]
        ...
        je = [{
          ...
          element: (0, c.jsx)(Y.VanderlindeGang, {})
        }, {
          path: "features/frontiercitiesandtowns",
          element: (0, c.jsx)(Y.FrontiersCitiesAndTowns, {})
        }, {
          path: "features/music",
          element: (0, c.jsx)(Y.Music, {})
        }, {
          path: "features/socialclub",
          element: (0, c.jsx)(Y.SocialClub, {})
        }, {
          path: "features/weaponry",
          element: (0, c.jsx)(Y.Weaponry, {})
        }, {
          path: "features/wildlife",
          element: (0, c.jsx)(Y.Wildlife, {})
        }, {
        ...
        be = (0, o.withSimpleErrorBoundary)((() => (0, n.useRoutes)(je))),
        ke = {
        ...
        he = (0, m.withTranslations)((e => {
          ...
          return m = !0, (0, r.useAgegated)()((0, c.jsxs)("div", {
            className: ke.gameSite,
            children: [!1, (0, c.jsx)("div", {
              className: [ke.gameSiteContent, t ? ke.navOpen : ""].join(" "),
              children: (0, c.jsx)(be, {})
            }), (0, c.jsxs)("footer", {
              className: [ke.footer, t ? ke.navOpen : ""].join(" "),
              children: [(0, c.jsx)("div", {
                className: ke.date,
                children: a("date")
              }), (0, c.jsx)("div", {
...
//# sourceMappingURL=175a3e9e91f59021fe3286825980d56b.js.map