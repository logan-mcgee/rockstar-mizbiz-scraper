  ...
  [452, 240, 832], {
    99576: (e, a, t) => {
      ...
      function i(e, a, t) {
        var s, n = {},
          i = null,
          c = null;
        for (s in void 0 !== t && (i = "" + t), void 0 !== a.key && (i = "" + a.key), void 0 !== a.ref && (c = a.ref), a) d.call(a, s) && !o.hasOwnProperty(s) && (n[s] = a[s]);
        if (e && e.defaultProps)
    ...
    24: (e, a, t) => {
      ...
      const c = (0, r.withTranslations)((e => {
          ...
          const {
            mutateLSSettings: d
          } = (0, r.useRockstarWebLSSettings)(), [c, u] = (0, n.useState)(null), f = (0, n.createRef)(), g = (0, n.createRef)(), b = (0, n.createRef)(), {
            style: p
          } = t;
