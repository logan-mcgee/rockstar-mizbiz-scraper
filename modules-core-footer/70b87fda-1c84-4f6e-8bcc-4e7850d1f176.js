try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "70b87fda-1c84-4f6e-8bcc-4e7850d1f176", e._sentryDebugIdIdentifier = "sentry-dbid-70b87fda-1c84-4f6e-8bcc-4e7850d1f176")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [3304], {
    ...
    85302: (e, a, t) => {
      ...
      const g = m((e => {
        ...
        return (0, s.useEffect)((() => {
        ...
        }), [C]), "function" != typeof _ ? null : (0, u.jsxs)(u.Fragment, {
          children: [M && "sc-menu" === a && (0, u.jsx)("div", {
            ...
            children: (0, u.jsx)("div", {
              ...
              children: (0, u.jsxs)("select", {
                ...
                children: [(0, u.jsx)("option", {
                  ...
                  children: o.locales.find((e => e.subdomaincom === k.subdomaincom))?.label ?? (0, u.jsx)(o.FormattedMessage, {
          ...
          }), (!M || "sc-menu" !== a) && "footer" !== a && (0, u.jsxs)("div", {
            className: [d.languageSelector, v ? d.open : ""].join(" "),
            "data-theme": a,
            "data-testid": `${g}-language-selector`,
            ...p,
          ...
          }), "footer" === a && (0, u.jsxs)("div", {
            className: d.dropdownContainer,
            "data-testid": `${g}-language-selector`,
            ...p,
            children: [(0, u.jsx)(c.qz, {
              size: "MD",
              label: ""
            }), (0, u.jsx)(r.Dropdown, {
      ...
      const T = {
        ...
        H = e => {
          ...
          const {
            track: p
          } = (0, l.useGtmTrack)(), h = (0, L.A)(), b = (0, o.useIntl)();
          let k = s;
        ...
        O = e => {
          ...
          }), [N, v, x]), f.length > 0 ? (0, u.jsxs)(u.Fragment, {
            children: [(0, u.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), C(n), m === a ? (g(-1), _(0)) : (g(a), _(M + y + y))
              },
              children: [(0, u.jsx)("span", {
              ...
              children: f.map((e => (0, s.createElement)(H, {
                ...e,
                isSubLink: !0,
                key: e.text,
                tabIndex: I || !S ? -1 : 0,
        ...
        $ = e => {
          ...
          const {
            windowWidth: c,
            windowHeight: n
          } = (0, p.useWindowResize)(), i = (0, o.useIntl)(), {
            ...
            navOpen: v
          } = (0, l.useRockstarUserState)(), x = (0, p.useLocale)(), C = (0, p.toScLocaleString)(x), [S, N] = (0, s.useState)(""), M = `${a.login}?returnUrl=${S}&lang=${C}`, w = `${a.signup}&returnUrl=${S}&lang=${C}`, I = (0, s.useMemo)((() => (0, L.A)()), []), T = (0, s.useMemo)((() => {
            const e = ((e, a, t) => [{
            ...
            return e
          }), [i, M, w, I]), [R, H] = (0, s.useState)(0), $ = (0, s.createRef)(), B = () => {
            if ($.current) {
              const {
                current: e
          ...
          return (0, s.useEffect)((() => {
            ...
            children: [(0, u.jsx)("nav", {
              ...
              children: (0, u.jsx)("div", {
                ...
                children: T.map((e => (0, s.createElement)(O, {
                  ...e,
                  activeSubNavId: m,
                  setActiveSubNavId: _,
                  setSubNavExtraHeight: b,
      ...
      const W = e => e < 100 ? "#2d6eb9" : e > 99 && e < 500 ? "#b48261" : e > 499 && e < 750 ? "#9699a1" : "#D6B563",
        A = (0, s.forwardRef)((function(e, a) {
          ...
          const l = W(t),
            i = (0, D.v6)(n, {
              className: z()("rockstargames-modules-core-footerf54750ef62f8600000c94f0caba85986", r),
              "data-testid": o
            });
          return (0, u.jsxs)("div", {
            "data-size": s,
      ...
      const Q = "ProfileCard:characterName",
        ...
        se = e => {
          ...
          const {
            ...
            track: c
          } = (0, l.useGtmTrack)(), n = (0, o.useIntl)(), [i, d] = (0, s.useState)([]), [f, m] = (0, s.useState)(null), [g, _] = (0, s.useState)(null), [p, h] = (0, s.useState)(!1), [b, k] = (0, s.useState)(-1), [v, x] = (0, s.useState)([]), [C, S] = (0, s.useState)(0), N = t(5931), {
            platform: M
          ...
          (0, s.useEffect)((() => {
            ...
            i && i.forEach((e => {
              !0 === e.isPrimary && (m(e.crewTag), _(e.crewColour), k(e.rankOrder), h(!1), !0 === Object.prototype.hasOwnProperty.call(e, "crewType") && "rockstar" === e.crewType && h(!0))
            }))
          }), [i]), (0, s.useEffect)((() => {
            const e = [];
            if (!p && b > -1)
      ...
      let re = "rockstargames-modules-core-footerb794a0e12537ad5fd506353133b9d60a",
        ce = "rockstargames-modules-core-footerc1e8d8d5b52081b34283a5ac0d377362",
        oe = "rockstargames-modules-core-footerdd4bcd955436c8a6982ee16756f7fd8b",
        ne = "rockstargames-modules-core-footere8e5249dac92a2bc76788d0fe7d7dfb7",
        le = "rockstargames-modules-core-footerf64d91c845a3931140b8b2c6a47da81f";
      const ie = e => {
          let {
            dragThreshold: a = 80,
          ...
          const d = (0, s.createRef)(),
            ...
            [k, v] = (0, s.useState)(0),
            [x, C] = (0, s.useState)([r]),
            [S, N] = (0, s.useState)(x[0]),
            [M, w] = (0, s.useState)(252),
            [y, j] = (0, s.useState)(0),
            [I, E] = (0, s.useState)([]),
            [L, T] = (0, s.useState)([]),
            [P, R] = (0, s.useState)(!1),
            ...
            O = e => {
              ...
              r > a ? (s > 0 ? (() => {
                ...
                if (!0 === m) return;
                g(!0);
                let e = h + 1 >= x.length ? x.length - 1 : h + 1;
                e < 0 && (e = 0), b(e), N(x[e]), c && c(e)
              })(), v(0)) : N(x[h] + r * s)
            },
            $ = () => {
              !0 !== m && !0 !== i && (g(!0), !0 !== m && (N(x[h]), v(0)), p(!1))
            };
          return (0, s.useEffect)((() => {
            const e = [];
            n.forEach((() => {
            ...
            C(n.map(((e, a) => (e => {
              let a = 0;
              const t = n.length;
              return 1 === t ? .5 * f - .5 * M - 2 * r + y : (0 === e && (a = r - e * M), e === t - 1 && t > 1 && (a = t * M * -1 + (f - (r - y))), e > 0 && e < t - 1 && (a = e * M * -1 + (.5 * f - .5 * M + .5 * y)), a)
            })(a)))), 1 === n.length ? R(!0) : R(!1)
            ...
            children: [(0, u.jsx)("div", {
              ...
              children: (0, u.jsx)("div", {
                ...
                "data-single-item": P,
                style: {
                  transform: P ? null : `translateX(${S}px)`
                },
        ...
        fe = e => {
          ...
          const {
            windowWidth: b,
            windowHeight: k
          } = (0, p.useWindowResize)(), v = (0, o.useIntl)(), {
            ...
            track: U
          } = (0, l.useGtmTrack)(), z = (0, p.useRockstarTokenPing)(), {
            data: W,
            loggedIn: A
          } = (0, l.useRockstarUser)(), {
            charactersNeeded: F,
            ...
            setSelectedCharacterTuple: K,
            setUserData: q
          } = (0, l.useRockstarUserState)(), [Q, ee] = (0, s.useState)(null), [ae, te] = (0, s.useState)(!1), [re, ce] = (0, s.useState)(!1), [oe, ne] = (0, s.useState)(0), le = (0, s.createRef)(), fe = (0, B.ri)(le, !1), me = (0, s.createRef)(), [ue, ge] = (0, s.useState)(0), [_e, pe] = (0, s.useState)([]), [he, be] = (0, s.useState)(244), ke = (0, s.useRef)(null), ve = (0, s.useMemo)((() => (0, L.A)()), []), xe = (0, s.useMemo)((() => ((e, a, t, s, r) => [{
          ...
          }])(v, a, W, X, H, window)), [v, a, W, X, H, ve]), Ce = () => {
            ce(n + he * oe < fe)
          }, Se = () => {
            if (me.current) {
              const {
          ...
          return (0, s.useEffect)((() => {
            ...
            if (null !== A && !e.length) return void K(!1);
          ...
          }), [_e, D]), (0, u.jsxs)(u.Fragment, {
            children: [null !== Q && "gtao" === F && (0, u.jsxs)("div", {
              ...
              children: [(0, u.jsx)("button", {
                ...
                ref: me,
                style: {
                  "--navWrap-max-height": `${ue+M}px`
                },
                children: xe.map(((e, a) => (0, s.createElement)(O, {
                  ...e,
                  id: a,
                  activeSubNavId: S,
                  setActiveSubNavId: N,
        ...
        ge = m((e => {
          ...
          const {
            windowHeight: c
          } = (0, p.useWindowResize)(), n = (0, o.useIntl)(), {
            ...
            track: I
          } = (0, l.useGtmTrack)(), [E, L] = (0, s.useState)(!1), T = (0, s.useRef)(), [P, R] = (0, s.useState)(0), H = (0, s.createRef)(), [O, B] = (0, s.useState)(!1), [D, U] = (0, s.useState)(0), [z, W] = (0, s.useState)(!1), {
            mutateWebSettings: A,
            webSettings: F
          ...
          return (0, s.useEffect)((() => {
            ...
            const e = () => {
              ...
              a = a => {
                const t = H?.current && a?.composedPath().includes(H.current);
                N && !t && e()
              },
              t = a => {
                "Escape" === a.code && e()
            ...
            m && (i && d(!1), h || V(!0))
          }), [m]), void 0 === C ? null : (0, u.jsxs)(_.A, {
            enabled: !!N,
            removeScrollBar: !1,
            children: [(0, u.jsxs)("div", {
              className: [me.menu, N ? me.navOpen : ""].join(" "),
              "data-logged-in": C,
              "data-mac-browser": z,
              "data-scroll-mode": k,
              ref: H,
              ...
              className: [me.scOverlay, N ? me.navOpen : ""].join(" "),
              "data-logged-in": C
            })]
          })
        })),
        _e = m((e => {
          ...
          const x = (0, s.useCallback)((e => {
            e.stopPropagation(), m(!f), 1 == !f && a(null), g({
              event: "account_menu_click",
              element_placement: "account menu",
              text: f ? "close" : "open"
            })
      ...
      const he = {
        ...
        be = () => {
          ...
          (0, s.useEffect)((() => {
            ...
            a && (r(a), _.length > 1 ? m(!0) : m(!1))
          }), [I, _]), (0, s.useEffect)((() => {
            h(N?.characters?.[w] ?? [])
          }), [N, w]), (0, s.useEffect)((() => {
            P()
          }), [b, c, x, v, _]), (0, s.useEffect)((() => {
            C(v < 1024)
          }), [v]);
          const P = () => {
              d(b * c < S)
            ...
            R = e => {
              ...
              E(t[e].index), a({
                ...
                text: he[t[e].platform],
                position: t[e].index
              })
            };
          return null !== t && "gtao" === w && M ? (0, u.jsxs)("div", {
            tabIndex: -1,
            ...
            children: [(0, u.jsx)(se, {
              ...
              children: [(0, u.jsx)("button", {
                ...
                "aria-hidden": L,
                children: _.filter(((e, a) => a !== I)).map(((e, a) => (0, u.jsx)(Y, {
                  tabIndex: L ? -1 : 0,
                  onClick: () => R(a),
                  characterData: e,
