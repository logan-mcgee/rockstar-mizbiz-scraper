try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "11b28e3b-7b85-44d9-8ce4-9e28f3b64333", e._sentryDebugIdIdentifier = "sentry-dbid-11b28e3b-7b85-44d9-8ce4-9e28f3b64333")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [3736], {
    ...
    10131: (e, t, r) => {
      ...
      let Oe = globalThis.AbortController,
      ...
      class _e {
        ...
        constructor(e) {
          ...
          if (!this.ttlAutopurge && !this.#t && !this.#r) {
            ...
            (e => !Ce.has(e))(e) && (Ce.add(e), xe("TTL caching without ttlAutopurge, max, or maxSize can result in unbounded memory consumption.", "UnboundedCacheWarning", e, _e))
          }
        }
        getRemainingTTL(e) {
        ...
        set(e, t, r = {}) {
          ...
          if (0 === i || this.#b || this.#F(), this.#b && (l || this.#_(h, i, n), a && this.#j(a, h)), !o && this.#C && this.#g) {
            const e = this.#g;
            let t;
        ...
        #B(e) {
          const t = this.#p,
            r = this.#h[t],
            i = this.#u[t];
          return this.#S && this.#A(i) ? i.__abortController.abort(new Error("evicted")) : (this.#k || this.#C) && (this.#k && this.#i?.(i, r, "evict"), this.#C && this.#g?.push([i, r, "evict"])), this.#P(t), e && (this.#h[t] = void 0, this.#u[t] = void 0, this.#v.push(t)), 1 === this.#a ? (this.#p = this.#m = 0, this.#v.length = 0) : this.#p = this.#d[t], this.#c.delete(r), this.#a--, t
        }
        has(e, t = {}) {
          const {
          ...
          if (void 0 !== n) {
            ...
            if (!this.#T(n)) return r && this.#M(n), i && (i.has = "hit", this.#j(i, n)), !0;
        ...
        #A(e) {
          if (!this.#S) return !1;
          const t = e;
          return !!t && t instanceof Promise && t.hasOwnProperty("__staleWhileFetching") && t.__abortController instanceof Oe
        }
        async fetch(e, t = {}) {
          const {
            allowStale: r = this.allowStale,
          ...
          if (void 0 === w) {
            ...
            const n = this.#T(w);
            if (!m && !n) return v && (v.fetch = "hit"), this.#O(w), i && this.#M(w), v && this.#j(v, w), t;
        ...
        get(e, t = {}) {
          ...
          if (void 0 !== s) {
            const t = this.#u[s],
              a = this.#A(t);
            return o && this.#j(o, s), this.#T(s) ? (o && (o.get = "stale"), a ? (o && r && void 0 !== t.__staleWhileFetching && (o.returnedStale = !0), r ? t.__staleWhileFetching : void 0) : (n || this.#R(e, "expire"), o && r && (o.returnedStale = !0), r ? t : void 0)) : (o && (o.get = "hit"), a ? t.__staleWhileFetching : (this.#O(s), i && this.#M(s), t))
          }
          o && (o.get = "miss")
        }
        #N(e, t) {
          ...
          if (0 !== this.#a) {
            ...
            if (void 0 !== i)
              if (r = !0, 1 === this.#a) this.#U(t);
                ...
                this.#P(i);
                const r = this.#u[i];
                if (this.#A(r) ? r.__abortController.abort(new Error("deleted")) : (this.#k || this.#C) && (this.#k && this.#i?.(r, e, t), this.#C && this.#g?.push([r, e, t])), this.#c.delete(e), this.#h[i] = void 0, this.#u[i] = void 0, i === this.#m) this.#m = this.#f[i];
    ...
    22673: (e, t, r) => {
      ...
      const n = "__FOUNDRY_ACCENT__",
        o = (e, t) => i.X ? t() : (window[n] || (window[n] = new Map), window[n].has(e) || window[n].set(e, t()), window[n].get(e));
      var s;
    ...
    33736: (e, t, r) => {
      ...
      function f(e, {
        ...
        const i = e => d.X || !window.matchMedia ? t : window.matchMedia(e).matches,
      ...
      var v = r(22673);
      const g = () => v.X3 ? null : document.body,
        y = (0, o.forwardRef)((({
          children: e,
          className: t,
          container: r = g(),
          ...
          const A = (0, o.useRef)(null),
            ...
            }),
            {
              ...
              const n = f("(prefers-color-scheme: light)"),
                a = f("(prefers-color-scheme: dark)"),
                l = f("(prefers-contrast: more)"),
          ...
          return ((e, t, r, i, n) => {
            const a = p(n),
              l = p(e.current);
            (0, o.useEffect)((() => {
              e.current?.classList.contains(s.X6) || e.current?.classList.add(s.X6), e.current?.classList.add(r), e.current?.classList.remove(...i), a && n && e.current?.classList.contains(a) ? e.current?.classList.replace(a, n) : a && !n && e.current?.classList.contains(a) ? e.current?.classList.remove(a) : n && e.current?.classList.add(n)
            }), [r, n]), (0, o.useEffect)((() => {
              e.current?.style.setProperty(s.HZ, t.toString())
            }), [t]), (0, o.useEffect)((() => {
              l?.classList.remove(s.X6), l?.classList.remove(r), l?.style.removeProperty(s.HZ), n && l?.classList.remove(n)
            }), [l])
          })(l ? A : O, L, T, z, t), (0, i.jsx)(a.Provider, {
            value: {
              locale: S,
              defaultColorScheme: h,
              colorScheme: F,
