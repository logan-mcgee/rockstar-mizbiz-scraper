try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    l = (new e.Error).stack;
  l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "c29f370f-f262-4abc-8b61-c83a4d24b0f3", e._sentryDebugIdIdentifier = "sentry-dbid-c29f370f-f262-4abc-8b61-c83a4d24b0f3")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [8745], {
    ...
    83613: (e, l, a) => {
      a.r(l), a.d(l, {
        ...
        ChevronUp: () => Mr,
        ChevronsDownUp: () => Jr,
        ChevronsLeftRight: () => it,
        ChevronsUpDown: () => Rt,
        Circle: () => xc,
        CircleCheck: () => Wc,
        CircleCheckFilled: () => dh,
        CircleDollarSign: () => Yf,
        CircleHelp: () => te,
        CircleMinus: () => Ih,
        CircleMinusFilled: () => Uh,
        CirclePerson: () => Oe,
        CircleSlash: () => ol,
        CircleX: () => Xh,
        Clipboard: () => Jd,
      ...
      function y(...e) {
        ...
        for (let a = 1; a < e.length; a++) {
          ...
          for (const e in r) {
            const a = l[e],
              t = r[e];
            "function" == typeof a && "function" == typeof t && "o" === e[0] && "n" === e[1] && e.charCodeAt(2) >= 65 && e.charCodeAt(2) <= 90 ? l[e] = R(a, t) : "className" !== e && "UNSAFE_className" !== e || "string" != typeof a || "string" != typeof t ? "id" === e && a && t ? l.id = M(a, t) : l[e] = void 0 !== t ? t : a : l[e] = (0, j.$)(a, t)
          }
        }
        return l
      }
      ...
      function H(e) {
        for (var l = 1; l < arguments.length; l++) {
          ...
          l % 2 ? C(Object(a), !0).forEach(function(l) {
            var r, t, o;
            r = e, t = l, o = a[l], (t = L(t)) in r ? Object.defineProperty(r, t, {
              value: o,
              enumerable: !0,
              configurable: !0,
              writable: !0
      ...
      var V, B, I = (e, l, a) => {
        ...
        S = (V = {
          ...
          for (var r in a) {
            var t, o = null !== (t = a[r]) && void 0 !== t ? t : V.defaultVariants[r];
            if (null != o) {
              var s = o;
              "boolean" == typeof s && (s = !0 === s ? "true" : "false");
              var d = V.variantClassNames[r][s];
              d && (l += " " + d)
            }
          }
          for (var [i, n] of V.compoundVariants) I(i, a, V.defaultVariants) && (l += " " + n);
          return l
        }).variants = () => Object.keys(V.variantClassNames), B.classNames = {
          get base() {
            return V.defaultClassName.split(" ")[0]
          },
          get variants() {
            return A(V.variantClassNames, e => A(e, e => e.split(" ")[0]))
          }
        }, B);
      ...
      G.displayName = "Moon", G.categories = ["accessibility"], G.tags = ["dark", "night", "lightness", "theme", "brightness"], G.SM = q, G.LG = N, G.MD = D, G.XL = X;
      ...
      E.displayName = "Eye", E.categories = ["accessibility", "photography", "design", "security"], E.tags = ["view", "watch", "see", "show", "expose", "reveal", "display", "visible", "visibility", "vision", "preview", "read", "password", "sign", "vision", "look"], E.SM = k, E.LG = F, E.MD = _, E.XL = P;
      ...
      $.displayName = "EyeClosed", $.categories = ["accessibility", "photography", "design", "security"], $.tags = ["view", "watch", "see", "hide", "conceal", "mask", "hidden", "visibility", "vision"], $.SM = O, $.LG = T, $.MD = W, $.XL = U;
      ...
      Q.displayName = "EyeOff", Q.categories = ["accessibility", "photography", "design", "security"], Q.tags = ["view", "watch", "see", "hide", "conceal", "mask", "hidden", "visibility", "vision", "lock", "password", "private", "invisible"], Q.SM = Y, Q.LG = Z, Q.MD = K, Q.XL = J;
      ...
      ne.displayName = "Sun", ne.categories = ["accessibility", "weather", "seasons", "sustainability"], ne.tags = ["brightness", "weather", "light", "summer", "day", "lightness", "theme", "brightness"], ne.SM = oe, ne.LG = se, ne.MD = de, ne.XL = ie;
      ...
      we.displayName = "Info", we.categories = ["accessibility", "notifications"], we.tags = ["help", "info", "information", "support"], we.SM = ce, we.LG = he, we.MD = fe, we.XL = ve;
      ...
      me.displayName = "ZoomIn", me.categories = ["accessibility", "layout", "design", "text", "photography"], me.tags = ["magnifying glass", "plus", "zoom", "view", "see", "more", "closer"], me.SM = ge, me.LG = xe, me.MD = ue, me.XL = pe;
      ...
      ye.displayName = "ZoomOut", ye.categories = ["accessibility", "layout", "design", "text", "photography"], ye.tags = ["magnifying glass", "plus", "zoom", "view", "see", "less", "further"], ye.SM = je, ye.LG = be, ye.MD = Me, ye.XL = Re;
      ...
      Ae.displayName = "Bug", Ae.categories = ["development", "animals"], Ae.tags = ["issue", "report", "debug", "code", "insect"], Ae.SM = ze, Ae.LG = Le, Ae.MD = Ce, Ae.XL = He;
      ...
      qe.displayName = "BugOff", qe.categories = ["development", "animals"], qe.tags = ["issue", "report", "debug", "code", "insect"], qe.SM = Ve, qe.LG = Be, qe.XL = Ie, qe.MD = Se;
      ...
      ke.displayName = "Person", ke.categories = ["account"], ke.tags = ["person", "account", "contact", "profile", "avatar", "user", "people", "human"], ke.SM = Ne, ke.LG = De, ke.MD = Xe, ke.XL = Ge;
      ...
      Oe.displayName = "CirclePerson", Oe.categories = ["account"], Oe.tags = ["person", "account", "contact"], Oe.SM = Fe, Oe.LG = _e, Oe.MD = Pe, Oe.XL = Ee;
      ...
      Ye.displayName = "Flag", Ye.categories = ["account", "social"], Ye.tags = ["report"], Ye.SM = Te, Ye.LG = We, Ye.XL = Ue, Ye.MD = $e;
      const Ze = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      el.displayName = "FlagOff", el.categories = ["account", "social"], el.tags = ["unflag"], el.SM = Ze, el.LG = Ke, el.XL = Je, el.MD = Qe;
      ...
      ol.displayName = "CircleSlash", ol.categories = ["account"], ol.tags = ["cancel", "no", "stop", "forbidden", "prohibited", "error", "incorrect", "mistake", "wrong", "failure", "circle", "slash", "null", "void", "ban", "Blocked", "Restricted", "Denied", "Unavailable", "Stop", "Alert"], ol.SM = ll, ol.LG = al, ol.XL = rl, ol.MD = tl;
      ...
      cl.displayName = "ThumbsUp", cl.categories = ["account", "social", "emoji"], cl.tags = ["like", "good", "emotion", "rate", "social", "review", "feedback", "positive"], cl.SM = sl, cl.LG = dl, cl.XL = il, cl.MD = nl;
      ...
      gl.displayName = "ThumbsDown", gl.categories = ["account", "social", "emoji"], gl.tags = ["dislike", "bad", "emotion", "rate", "social", "review", "feedback", "negative"], gl.SM = hl, gl.LG = fl, gl.MD = vl, gl.XL = wl;
      ...
      jl.displayName = "Link", jl.categories = ["text", "account"], jl.tags = ["chain", "url", "links", "hyperlink"], jl.SM = xl, jl.LG = ul, jl.XL = pl, jl.MD = ml;
      ...
      zl.displayName = "ShieldAlert", zl.categories = ["account", "security", "development", "notifications", "gaming"], zl.tags = ["unshielded", "cybersecurity", "insecure", "unsecured", "safety", "unsafe", "protection", "unprotected", "guardian", "unguarded", "unarmored", "unarmoured", "defenseless", "defenceless", "undefended", "defender", "blocked", "stopped", "intercepted", "interception", "saved", "thwarted", "threat", "prevention", "unprevented", "antivirus", "vigilance", "vigilant", "detection", "detected", "scanned", "found", "exploit", "vulnerability", "vulnerable", "weakness", "infection", "infected", "comprimised", "data leak", "audited", "admin", "verification", "unverified", "uncertified", "warning", "emergency", "attention", "urgent", "alarm", "crest", "bravery", "strength", "tough", "attacked", "damaged", "injured", "hit", "expired", "disabled", "inactive", "error", "exclamation mark", "!"], zl.SM = bl, zl.LG = Ml, zl.XL = Rl, zl.MD = yl;
      const Ll = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Vl.displayName = "PersonPlus", Vl.categories = ["account"], Vl.tags = ["new", "add", "create", "follow", "subscribe"], Vl.SM = Ll, Vl.LG = Cl, Vl.XL = Hl, Vl.MD = Al;
      const Bl = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Nl.displayName = "Envelope", Nl.categories = ["text", "account", "mail"], Nl.tags = ["email", "message", "letter", "unread", "inbox", "chat", "letter", "invitation"], Nl.SM = Bl, Nl.LG = Il, Nl.XL = Sl, Nl.MD = ql;
      ...
      Fl.displayName = "MapPin", Fl.categories = ["navigation", "travel", "account"], Fl.tags = ["location", "waypoint", "marker", "drop"], Fl.SM = Dl, Fl.LG = Xl, Fl.XL = Gl, Fl.MD = kl;
      ...
      Tl.displayName = "ShieldCheck", Tl.categories = ["account", "security", "development", "gaming"], Tl.tags = ["cybersecurity", "secured", "safety", "protection", "protected", "guardian", "guarded", "armored", "armoured", "defense", "defence", "defended", "blocked", "threat", "prevention", "prevented", "antivirus", "vigilance", "vigilant", "active", "activated", "enabled", "detection", "scanned", "found", "strength", "strong", "tough", "invincible", "invincibility", "invulnerable", "undamaged", "audited", "admin", "verification", "verified", "certification", "certified", "tested", "passed", "qualified", "cleared", "cleaned", "disinfected", "uninfected", "task", "completed", "todo", "done", "ticked", "checked", "crest", "bravery"], Tl.SM = _l, Tl.LG = Pl, Tl.MD = El, Tl.XL = Ol;
      ...
      Zl.displayName = "Wrench", Zl.categories = ["account", "development", "tools"], Zl.tags = ["account", "settings", "spanner", "diy", "toolbox", "build", "construction"], Zl.SM = Wl, Zl.LG = Ul, Zl.XL = $l, Zl.MD = Yl;
      ...
      la.displayName = "Gear", la.categories = ["account"], la.tags = ["Cog", "Settings", "Preferences", "Options", "Custom", "Customize"], la.LG = Kl, la.SM = Jl, la.XL = Ql, la.MD = ea;
      ...
      sa.displayName = "Handshake", sa.categories = ["account", "social", "communication", "finance", "security"], sa.tags = ["agreement", "partnership", "deal", "business", "assistance", "cooperation", "friendship", "union", "terms"], sa.SM = aa, sa.LG = ra, sa.XL = ta, sa.MD = oa;
      ...
      ha.displayName = "PersonMinus", ha.categories = ["account"], ha.tags = ["delete", "remove", "unfollow", "unsubscribe"], ha.SM = da, ha.LG = ia, ha.XL = na, ha.MD = ca;
      ...
      xa.displayName = "Star", xa.categories = ["account", "social", "shapes", "multimedia", "weather", "emoji", "gaming"], xa.tags = ["bookmark", "favorite", "like", "review", "rating"], xa.SM = fa, xa.LG = va, xa.XL = wa, xa.MD = ga;
      ...
      ba.displayName = "PersonBlock", ba.categories = ["account"], ba.tags = ["ban", "block", "delete", "remove", "report"], ba.SM = ua, ba.LG = pa, ba.MD = ma, ba.XL = ja;
      ...
      La.displayName = "TwoPeople", La.categories = ["account"], La.tags = ["group", "people"], La.SM = Ma, La.LG = Ra, La.XL = ya, La.MD = za;
      ...
      Ba.displayName = "Menu", Ba.categories = ["layout", "account"], Ba.tags = ["bars", "navigation", "hamburger", "options", "side nav", "triple bar", "item"], Ba.SM = Ca, Ba.LG = Ha, Ba.XL = Aa, Ba.MD = Va;
      ...
      Da.displayName = "Activity", Da.categories = ["account"], Da.tags = ["pulse", "action", "motion", "movement", "exercise", "fitness", "healthcare", "heart rate monitor", "vital signs", "vitals", "shockwave", "audio", "waveform", "synthesizer", "synthesiser", "music"], Da.SM = Ia, Da.MD = Sa, Da.LG = qa, Da.XL = Na;
      ...
      _a.displayName = "LogOut", _a.categories = ["account"], _a.tags = ["sign out", "arrow", "exit", "auth", "log", "out"], _a.SM = Xa, _a.MD = Ga, _a.LG = ka, _a.XL = Fa;
      ...
      Wa.displayName = "UserCouple", Wa.categories = ["account"], Wa.tags = ["person", "account", "contact", "profile", "avatar", "user", "users", "people", "human", "couple", "two", "group", "partner", "dual", "duo"], Wa.SM = Pa, Wa.MD = Ea, Wa.LG = Oa, Wa.XL = Ta;
      const Ua = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ka.displayName = "UserGroup", Ka.categories = ["account"], Ka.tags = ["person", "account", "contact", "profile", "avatar", "user", "users", "people", "human", "couple", "three", "group", "crowd", "team"], Ka.SM = Ua, Ka.MD = $a, Ka.LG = Ya, Ka.XL = Za;
      ...
      ar.displayName = "ArrowUp", ar.categories = ["arrows", "navigation"], ar.tags = ["forward", "direction", "north", "increase"], ar.SM = Ja, ar.LG = Qa, ar.MD = er, ar.XL = lr;
      ...
      dr.displayName = "ArrowLeft", dr.categories = ["arrows", "navigation"], dr.tags = ["previous", "back", "direction", "west", "<-", "Left", "Navigation", "Back"], dr.SM = rr, dr.LG = tr, dr.MD = or, dr.XL = sr;
      ...
      fr.displayName = "ArrowUpDown", fr.categories = ["arrows", "navigation"], fr.tags = ["bidirectional", "two-way", "2-way", "swap", "switch", "network", "mobile data", "internet", "sort", "reorder", "move", "Sortable", "Control", "Filter", "Sort"], fr.SM = ir, fr.LG = nr, fr.MD = cr, fr.XL = hr;
      ...
      ur.displayName = "ArrowRightLeft", ur.categories = ["arrows", "navigation"], ur.tags = ["bidirectional", "two-way", "2-way", "swap", "switch", "transaction", "reorder", "move", "<-", "->"], ur.SM = vr, ur.LG = wr, ur.MD = gr, ur.XL = xr;
      ...
      Mr.displayName = "ChevronUp", Mr.categories = ["arrows", "navigation", "math", "gaming"], Mr.tags = ["caret", "keyboard", "mac", "control", "ctrl", "superscript", "exponential", "power", "ahead", "fast", "^", "dropdown", "up", "direction", "top"], Mr.SM = pr, Mr.LG = mr, Mr.MD = jr, Mr.XL = br;
      const Rr = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Cr.displayName = "ArrowDown", Cr.categories = ["arrows", "navigation"], Cr.tags = ["backwards", "reverse", "direction", "south", "Down", "Navigation", "Decrease"], Cr.SM = Rr, Cr.LG = yr, Cr.MD = zr, Cr.XL = Lr;
      ...
      Ir.displayName = "ArrowRight", Ir.categories = ["arrows", "navigation"], Ir.tags = ["forward", "next", "direction", "east", "->"], Ir.SM = Hr, Ir.LG = Ar, Ir.MD = Vr, Ir.XL = Br;
      ...
      Xr.displayName = "ChevronDown", Xr.categories = ["arrows", "navigation", "gaming"], Xr.tags = ["backwards", "reverse", "slow", "dropdown", "down", "direction", "bottom"], Xr.SM = Sr, Xr.LG = qr, Xr.MD = Nr, Xr.XL = Dr;
      ...
      Pr.displayName = "ChevronLeft", Pr.categories = ["arrows", "navigation"], Pr.tags = ["back", "previous", "less than", "fewer", "menu", "left", "direction", "side"], Pr.SM = Gr, Pr.LG = kr, Pr.MD = Fr, Pr.XL = _r;
      ...
      Ur.displayName = "ChevronRight", Ur.categories = ["arrows", "navigation", "math", "development"], Ur.tags = ["forward", "next", "more than", "greater", "menu", "code", "coding", "command line", "terminal", "prompt", "shell", "right", "direction", "side"], Ur.SM = Er, Ur.LG = Or, Ur.MD = Tr, Ur.XL = Wr;
      ...
      Jr.displayName = "ChevronsDownUp", Jr.categories = ["arrows"], Jr.tags = ["collapse", "fold", "vertical"], Jr.SM = $r, Jr.LG = Yr, Jr.MD = Zr, Jr.XL = Kr;
      ...
      rt.displayName = "CloudUpload", rt.categories = ["arrows", "files"], rt.tags = ["file"], rt.SM = Qr, rt.LG = et, rt.MD = lt, rt.XL = at;
      ...
      it.displayName = "ChevronsLeftRight", it.categories = ["arrows"], it.tags = ["expand", "horizontal", "unfold"], it.SM = tt, it.LG = ot, it.MD = st, it.XL = dt;
      ...
      vt.displayName = "ChevronFirst", vt.categories = ["arrows", "multimedia"], vt.tags = ["previous", "music"], vt.SM = nt, vt.LG = ct, vt.MD = ht, vt.XL = ft;
      ...
      pt.displayName = "ChevronLast", pt.categories = ["arrows", "multimedia"], pt.tags = ["skip", "next", "music"], pt.SM = wt, pt.LG = gt, pt.MD = xt, pt.XL = ut;
      ...
      Rt.displayName = "ChevronsUpDown", Rt.categories = ["arrows"], Rt.tags = ["expand", "unfold", "vertical"], Rt.SM = mt, Rt.LG = jt, Rt.MD = bt, Rt.XL = Mt;
      ...
      Ht.displayName = "CloudDownload", Ht.categories = ["arrows", "files"], Ht.tags = ["import"], Ht.SM = yt, Ht.LG = zt, Ht.MD = Lt, Ht.XL = Ct;
      ...
      St.displayName = "Maximize2", St.categories = ["arrows", "layout", "design"], St.tags = ["fullscreen", "arrows", "expand"], St.SM = At, St.LG = Vt, St.MD = Bt, St.XL = It;
      ...
      Gt.displayName = "Upload", Gt.categories = ["arrows", "files"], Gt.tags = ["file", "up", "file", "share"], Gt.SM = qt, Gt.LG = Nt, Gt.MD = Dt, Gt.XL = Xt;
      ...
      Et.displayName = "Download", Et.categories = ["arrows", "files"], Et.tags = ["import", "export", "save", "down"], Et.SM = kt, Et.LG = Ft, Et.MD = _t, Et.XL = Pt;
      ...
      $t.displayName = "ExternalLink", $t.categories = ["arrows", "text", "social"], $t.tags = ["outbound", "share", "link", "new tab", "new window", "open", "URL", "hyperlink", "external"], $t.SM = Ot, $t.LG = Tt, $t.MD = Wt, $t.XL = Ut;
      const Yt = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Qt.displayName = "RefreshCw", Qt.categories = ["arrows"], Qt.tags = ["rotate", "reload", "rerun", "synchronise", "synchronize", "arrows", "circular", "cycle", "loop", "repeat", "sync", "update", "reset", "restore", "clockwise"], Qt.SM = Yt, Qt.LG = Zt, Qt.MD = Kt, Qt.XL = Jt;
      ...
      to.displayName = "Replay", to.categories = ["arrows", "design", "photography"], to.tags = ["arrow", "right", "clockwise", "refresh", "reload", "rerun", "redo"], to.SM = eo, to.LG = lo, to.MD = ao, to.XL = ro;
      ...
      co.displayName = "Undo", co.categories = ["text", "arrows"], co.tags = ["redo", "rerun", "history", "back", "return", "reverse", "revert", "direction", "u-turn", "undo", "arrow", "navigation"], co.SM = oo, co.LG = so, co.MD = io, co.XL = no;
      ...
      go.displayName = "RefreshCwOff", go.categories = ["arrows"], go.tags = ["rotate", "reload", "rerun", "synchronise", "synchronize", "arrows", "circular", "cycle", "cancel", "no", "stop", "error", "disconnect", "ignore", "reset", "clockwise"], go.SM = ho, go.LG = fo, go.MD = vo, go.XL = wo;
      ...
      jo.displayName = "Minimize2", jo.categories = ["arrows", "layout", "design"], jo.tags = ["exit fullscreen", "arrows", "close", "shrink"], jo.SM = xo, jo.LG = uo, jo.MD = po, jo.XL = mo;
      ...
      zo.displayName = "RefreshCcw", zo.categories = ["arrows"], zo.tags = ["arrows", "rotate", "reload", "rerun", "synchronise", "synchronize", "circular", "cycle", "loop", "repeat", "sync", "update", "reset", "restore", "counter clockwise"], zo.SM = bo, zo.MD = Mo, zo.LG = Ro, zo.XL = yo;
      ...
      Vo.displayName = "House", Vo.categories = ["buildings", "home"], Vo.tags = ["home", "living", "building", "residence", "architecture", "property", "homepage", "city"], Vo.SM = Lo, Vo.LG = Co, Vo.MD = Ho, Vo.XL = Ao;
      const Bo = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      No.displayName = "Property", No.categories = ["account", "buildings"], No.tags = ["organization", "building", "house", "city", "GTAO", "structure"], No.SM = Bo, No.LG = Io, No.MD = So, No.XL = qo;
      ...
      Fo.displayName = "Store", Fo.categories = ["buildings", "navigation", "shopping"], Fo.tags = ["shop", "supermarket", "stand", "boutique", "building"], Fo.SM = Do, Fo.LG = Xo, Fo.MD = Go, Fo.XL = ko;
      ...
      To.displayName = "ChartSpline", To.categories = ["charts"], To.tags = ["statistics", "analytics", "diagram", "graph", "curve", "continuous", "smooth", "polynomial", "quadratic", "function", "interpolation"], To.SM = _o, To.LG = Po, To.MD = Eo, To.XL = Oo;
      ...
      Zo.displayName = "PaperPlane", Zo.categories = ["mail", "communication", "connectivity"], Zo.tags = ["email", "message", "mail", "paper airplane", "paper aeroplane", "submit", "send"], Zo.SM = Wo, Zo.LG = Uo, Zo.MD = $o, Zo.XL = Yo;
      ...
      ls.displayName = "Volume", ls.categories = ["connectivity", "communication", "multimedia"], ls.tags = ["music", "sound", "mute", "speaker"], ls.SM = Ko, ls.LG = Jo, ls.MD = Qo, ls.XL = es;
      ...
      ss.displayName = "Volume1", ss.categories = ["connectivity", "communication", "multimedia"], ss.tags = ["music", "sound", "speaker", "control", "volume", "low"], ss.SM = as, ss.LG = rs, ss.MD = ts, ss.XL = os;
      ...
      hs.displayName = "Volume2", hs.categories = ["connectivity", "communication", "multimedia"], hs.tags = ["music", "sound", "speaker", "control", "volume", "high"], hs.SM = ds, hs.LG = is, hs.MD = ns, hs.XL = cs;
      ...
      xs.displayName = "VolumeX", xs.categories = ["connectivity", "communication", "multimedia"], xs.tags = ["music", "sound", "mute", "speaker", "control", "volume"], xs.SM = fs, xs.LG = vs, xs.MD = ws, xs.XL = gs;
      ...
      bs.displayName = "Mic", bs.categories = ["communication"], bs.tags = ["record", "sound", "listen", "radio", "podcast", "microphone", "audio", "voice"], bs.SM = us, bs.MD = ps, bs.LG = ms, bs.XL = js;
      ...
      Ls.displayName = "MicFilled", Ls.categories = [], Ls.tags = [], Ls.SM = Ms, Ls.MD = Rs, Ls.LG = ys, Ls.XL = zs;
      ...
      Bs.displayName = "Headset", Bs.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], Bs.tags = ["music", "audio", "sound", "gaming", "headphones", "headset", "call", "center", "phone", "telephone", "voip", "video"], Bs.SM = Cs, Bs.LG = Hs, Bs.MD = As, Bs.XL = Vs;
      ...
      Ds.displayName = "Power", Ds.categories = ["connectivity"], Ds.tags = ["on", "off", "device", "switch", "toggle", "binary", "boolean", "reboot", "restart", "button", "keyboard", "troubleshoot"], Ds.SM = Is, Ds.LG = Ss, Ds.MD = qs, Ds.XL = Ns;
      ...
      _s.displayName = "Wifi", _s.categories = ["connectivity", "devices"], _s.tags = ["connection", "signal", "wireless", "internet", "technology", "network"], _s.SM = Xs, _s.LG = Gs, _s.MD = ks, _s.XL = Fs;
      ...
      Ws.displayName = "WifiOff", Ws.categories = ["connectivity", "devices"], Ws.tags = ["disabled", "connection", "internet", "wireless", "technology", "network", "signal", "no", "off"], Ws.SM = Ps, Ws.LG = Es, Ws.MD = Os, Ws.XL = Ts;
      const Us = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ks.displayName = "Monitor", Ks.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], Ks.tags = ["tv", "computer", "screen", "display", "virtual machine"], Ks.SM = Us, Ks.MD = $s, Ks.LG = Ys, Ks.XL = Zs;
      ...
      ad.displayName = "Pencil", ad.categories = ["design", "cursors", "tools", "text"], ad.tags = ["rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist", "update", "correct", "modify", "note"], ad.SM = Js, ad.LG = Qs, ad.MD = ed, ad.XL = ld;
      ...
      dd.displayName = "PencilOff", dd.categories = ["design", "cursors", "tools", "text"], dd.tags = ["disabled", "inactive", "non-editable", "locked", "read-only", "unmodifiable", "frozen", "restricted", "rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist"], dd.SM = rd, dd.LG = td, dd.MD = od, dd.XL = sd;
      ...
      fd.displayName = "Plus", fd.categories = ["math", "tools", "development", "text", "cursors", "gaming"], fd.tags = ["add", "new", "increase", "increment", "positive", "calculate", "toolbar", "crosshair", "aim", "target", "scope", "sight", "reticule", "maximum", "upgrade", "extra", "+", "more", "create", "navigation"], fd.SM = id, fd.LG = nd, fd.MD = cd, fd.XL = hd;
      ...
      ud.displayName = "LayoutGrid", ud.categories = ["design", "layout"], ud.tags = ["app", "home", "start", "squares", "hub", "menu", "blocks", "options", "items", "gallery"], ud.SM = vd, ud.LG = wd, ud.MD = gd, ud.XL = xd;
      ...
      Md.displayName = "Maximize", Md.categories = ["layout", "design"], Md.tags = ["full screen", "expand", "dashed", "maximum", "big", "large"], Md.SM = pd, Md.LG = md, Md.MD = jd, Md.XL = bd;
      const Rd = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Cd.displayName = "Minimize", Cd.categories = ["layout", "design"], Cd.tags = ["exit", "full screen", "close", "shrink", "window", "reduce", "video playback"], Cd.SM = Rd, Cd.LG = yd, Cd.MD = zd, Cd.XL = Ld;
      ...
      Id.displayName = "Cpu", Id.categories = ["devices"], Id.tags = ["processor", "cores", "technology", "computer", "chip", "circuit", "memory", "ram", "specs", "gigahertz", "ghz"], Id.SM = Hd, Id.MD = Ad, Id.LG = Vd, Id.XL = Bd;
      ...
      Xd.displayName = "Calendar", Xd.categories = ["time"], Xd.tags = ["date", "month", "year", "event", "birthday", "birthdate"], Xd.SM = Sd, Xd.LG = qd, Xd.MD = Nd, Xd.XL = Dd;
      ...
      Pd.displayName = "CalendarOff", Pd.categories = ["time"], Pd.tags = ["date", "day", "month", "year", "event", "delete", "remove"], Pd.SM = Gd, Pd.LG = kd, Pd.MD = Fd, Pd.XL = _d;
      ...
      Ud.displayName = "Clock", Ud.categories = ["time"], Ud.tags = ["time", "watch", "alarm", "hour", "minute", "second", "planned", "watch"], Ud.SM = Ed, Ud.LG = Od, Ud.MD = Td, Ud.XL = Wd;
      ...
      Jd.displayName = "Clipboard", Jd.categories = ["text"], Jd.tags = ["copy", "paste"], Jd.SM = $d, Jd.LG = Yd, Jd.MD = Zd, Jd.XL = Kd;
      ...
      ri.displayName = "Copy", ri.categories = ["text"], ri.tags = ["clone", "duplicate", "multiple"], ri.SM = Qd, ri.LG = ei, ri.MD = li, ri.XL = ai;
      ...
      ii.displayName = "List", ii.categories = ["text"], ii.tags = ["options", "index", "table of contents", "menu", "side nav", "navigation", "bullet", "to do"], ii.SM = ti, ii.LG = oi, ii.MD = si, ii.XL = di;
      ...
      vi.displayName = "ListFilter", vi.categories = ["text"], vi.tags = ["options"], vi.SM = ni, vi.LG = ci, vi.MD = hi, vi.XL = fi;
      ...
      pi.displayName = "Unlink", pi.categories = ["text"], pi.tags = ["url", "unchain"], pi.SM = wi, pi.LG = gi, pi.MD = xi, pi.XL = ui;
      ...
      Ri.displayName = "Trophy", Ri.categories = ["sports", "gaming"], Ri.tags = ["prize", "sports", "winner", "achievement", "award", "champion", "celebration", "victory"], Ri.SM = mi, Ri.LG = ji, Ri.MD = bi, Ri.XL = Mi;
      ...
      Hi.displayName = "Discord", Hi.categories = ["brands", "social"], Hi.tags = ["Social media", "Video", "Player", "Game", "Community", "App", "Share", "Logo"], Hi.SM = yi, Hi.LG = zi, Hi.MD = Li, Hi.XL = Ci;
      ...
      Si.displayName = "Instagram", Si.categories = ["brands", "social", "photography"], Si.tags = ["logo", "camera", "social media", "photo", "camera", "app", "share"], Si.SM = Ai, Si.LG = Vi, Si.MD = Bi, Si.XL = Ii;
      ...
      Gi.displayName = "Facebook", Gi.categories = ["social", "brands"], Gi.tags = ["logo", "social media", "profile", "feed", "app", "share"], Gi.SM = qi, Gi.LG = Ni, Gi.MD = Di, Gi.XL = Xi;
      ...
      Ei.displayName = "Twitch", Ei.categories = ["brands", "social", "account", "gaming"], Ei.tags = ["logo", "social", "social media", "streaming", "game", "app", "share"], Ei.SM = ki, Ei.LG = Fi, Ei.MD = _i, Ei.XL = Pi;
      ...
      $i.displayName = "Youtube", $i.categories = ["multimedia", "social", "brands"], $i.tags = ["logo", "social", "video", "play", "video", "player", "app", "share"], $i.SM = Oi, $i.LG = Ti, $i.MD = Wi, $i.XL = Ui;
      const Yi = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Qi.displayName = "Twitter", Qi.categories = ["brands", "social", "account"], Qi.tags = ["logo", "social", "social media", "twitter", "tweet", "app", "share", "x"], Qi.SM = Yi, Qi.LG = Zi, Qi.MD = Ki, Qi.XL = Ji;
      ...
      tn.displayName = "Tiktok", tn.categories = ["brands", "social"], tn.tags = ["Social media", "video", "player", "game", "community", "app", "share", "logo", "photo", "camera"], tn.SM = en, tn.MD = ln, tn.LG = an, tn.XL = rn;
      ...
      cn.displayName = "Reddit", cn.categories = ["social", "brands"], cn.tags = ["logo", "social media", "profile", "feed", "app", "share", "forum", "community"], cn.SM = on, cn.MD = sn, cn.LG = dn, cn.XL = nn;
      ...
      gn.displayName = "EpicGames", gn.categories = ["platform"], gn.tags = ["games", "gaming", "social", "brand", "third party"], gn.SM = hn, gn.MD = fn, gn.LG = vn, gn.XL = wn;
      ...
      jn.displayName = "Steam", jn.categories = ["platform"], jn.tags = ["games", "gaming", "social", "brand", "third party"], jn.SM = xn, jn.MD = un, jn.LG = pn, jn.XL = mn;
      ...
      zn.displayName = "Xbox", zn.categories = ["platform"], zn.tags = ["games", "gaming", "social", "brand", "third party"], zn.SM = bn, zn.MD = Mn, zn.LG = Rn, zn.XL = yn;
      ...
      Vn.displayName = "Playstation", Vn.categories = ["platform"], Vn.tags = ["games", "gaming", "social", "brand", "third party"], Vn.SM = Ln, Vn.MD = Cn, Vn.LG = Hn, Vn.XL = An;
      const Bn = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Nn.displayName = "NintendoSwitch", Nn.categories = ["platform"], Nn.tags = ["games", "gaming", "social", "brand", "third party"], Nn.SM = Bn, Nn.MD = In, Nn.LG = Sn, Nn.XL = qn;
      ...
      Fn.displayName = "Car", Fn.categories = ["transportation"], Fn.tags = ["vehicle", "drive", "trip", "journey", "automobile", "GTAO", "transport"], Fn.SM = Dn, Fn.LG = Xn, Fn.MD = Gn, Fn.XL = kn;
      const _n = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      Tn.displayName = "CarSide", Tn.categories = ["transportation"], Tn.tags = ["vehicle", "drive", "trip", "journey"], Tn.SM = _n, Tn.LG = Pn, Tn.MD = En, Tn.XL = On;
      ...
      Zn.displayName = "ShoppingBag", Zn.categories = ["shopping"], Zn.tags = ["ecommerce", "cart", "purchase", "store", "bag", "shop", "shopping", "tote"], Zn.SM = Wn, Zn.MD = Un, Zn.LG = $n, Zn.XL = Yn;
      ...
      lc.displayName = "MessageSquareText", lc.categories = ["social"], lc.tags = ["comment", "chat", "conversation", "dialog", "feedback", "speech bubble", "clear", "close", "delete", "remove", "cancel", "silence", "mute", "moderate"], lc.SM = Kn, lc.LG = Jn, lc.MD = Qn, lc.XL = ec;
      ...
      sc.displayName = "Search", sc.categories = ["text", "social"], sc.tags = ["find", "scan", "magnifier", "magnifying glass", "look", "view"], sc.SM = ac, sc.LG = rc, sc.MD = tc, sc.XL = oc;
      ...
      hc.displayName = "PartialCircle", hc.categories = ["shapes"], hc.tags = ["Partial", "Half", "Middle", "Split"], hc.SM = dc, hc.LG = ic, hc.MD = nc, hc.XL = cc;
      ...
      xc.displayName = "Circle", xc.categories = ["shapes"], xc.tags = ["Off", "Zero", "Record", "Shape", "Round", "Outline"], xc.SM = fc, xc.MD = vc, xc.LG = wc, xc.XL = gc;
      ...
      bc.displayName = "LockKeyhole", bc.categories = ["security"], bc.tags = ["security", "password", "secure", "admin", "lock", "safe", "protection", "security", "latch"], bc.SM = uc, bc.LG = pc, bc.MD = mc, bc.XL = jc;
      ...
      Lc.displayName = "LockPassword", Lc.categories = ["security"], Lc.tags = ["security", "password", "secure", "admin"], Lc.SM = Mc, Lc.LG = Rc, Lc.MD = yc, Lc.XL = zc;
      ...
      Bc.displayName = "Image", Bc.categories = ["photography", "text", "multimedia", "files"], Bc.tags = ["picture", "photo"], Bc.SM = Cc, Bc.LG = Hc, Bc.MD = Ac, Bc.XL = Vc;
      ...
      Dc.displayName = "Lightbulb", Dc.categories = ["photography"], Dc.tags = ["idea", "bright", "lights"], Dc.SM = Ic, Dc.LG = Sc, Dc.MD = qc, Dc.XL = Nc;
      ...
      _c.displayName = "Check", _c.categories = ["notifications"], _c.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "success", "accept"], _c.SM = Xc, _c.LG = Gc, _c.MD = kc, _c.XL = Fc;
      ...
      Wc.displayName = "CircleCheck", Wc.categories = ["notifications"], Wc.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], Wc.SM = Pc, Wc.LG = Ec, Wc.MD = Oc, Wc.XL = Tc;
      const Uc = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Kc.displayName = "TriangleAlert", Kc.categories = ["notifications", "shapes", "development"], Kc.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], Kc.SM = Uc, Kc.LG = $c, Kc.MD = Yc, Kc.XL = Zc;
      ...
      ah.displayName = "X", ah.categories = ["notifications", "math"], ah.tags = ["cancel", "close", "delete", "remove", "times", "clear", "math", "multiply", "multiplication", "error", "remove", "clean", "erase", "navigation", "cross", "times"], ah.SM = Jc, ah.LG = Qc, ah.MD = eh, ah.XL = lh;
      ...
      dh.displayName = "CircleCheckFilled", dh.categories = ["notifications"], dh.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success", "filled"], dh.SM = rh, dh.MD = th, dh.LG = oh, dh.XL = sh;
      ...
      fh.displayName = "Globe", fh.categories = ["navigation"], fh.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], fh.SM = ih, fh.LG = nh, fh.MD = ch, fh.XL = hh;
      ...
      uh.displayName = "Pin", uh.categories = ["navigation"], uh.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point"], uh.SM = vh, uh.MD = wh, uh.LG = gh, uh.XL = xh;
      ...
      Mh.displayName = "PinFilled", Mh.categories = ["navigation"], Mh.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point", "filled"], Mh.SM = ph, Mh.MD = mh, Mh.LG = jh, Mh.XL = bh;
      const Rh = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ch.displayName = "HeartPulse", Ch.categories = ["medical"], Ch.tags = ["heartbeat", "pulse", "health", "medical", "blood pressure", "cardiac", "systole", "diastole"], Ch.SM = Rh, Ch.LG = yh, Ch.MD = zh, Ch.XL = Lh;
      ...
      Ih.displayName = "CircleMinus", Ih.categories = ["math"], Ih.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete"], Ih.SM = Hh, Ih.LG = Ah, Ih.MD = Vh, Ih.XL = Bh;
      ...
      Xh.displayName = "CircleX", Xh.categories = ["math", "development"], Xh.tags = ["cancel", "close", "delete", "remove", "times", "clear", "error", "incorrect", "wrong", "mistake", "failure", "linter", "multiply", "multiplication", "clean", "erase", "deprecate", "delete", "navigation"], Xh.SM = Sh, Xh.LG = qh, Xh.MD = Nh, Xh.XL = Dh;
      ...
      Ph.displayName = "Minus", Ph.categories = ["math", "development", "text", "tools"], Ph.tags = ["subtract", "remove", "decrease", "decrement", "reduce", "negative", "calculate", "line", "divider", "separator", "horizontal rule", "hr", "html", "markup", "markdown", "---", "toolbar", "operator", "code", "coding", "minimum", "downgrade", "less", "delete", "navigation", "minimize"], Ph.SM = Gh, Ph.LG = kh, Ph.MD = Fh, Ph.XL = _h;
      ...
      Uh.displayName = "CircleMinusFilled", Uh.categories = ["math"], Uh.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete", "filled"], Uh.SM = Eh, Uh.MD = Oh, Uh.LG = Th, Uh.XL = Wh;
      ...
      Jh.displayName = "EnvelopeOpen", Jh.categories = ["mail"], Jh.tags = ["email", "message", "letter", "read"], Jh.SM = $h, Jh.LG = Yh, Jh.MD = Zh, Jh.XL = Kh;
      ...
      rf.displayName = "Paperclip", rf.categories = ["text", "design", "files", "mail"], rf.tags = ["attachment", "file", "attach", "clip", "document", "paper"], rf.SM = Qh, rf.LG = ef, rf.MD = lf, rf.XL = af;
      ...
      nf.displayName = "Trash", nf.categories = ["files", "mail"], nf.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], nf.SM = tf, nf.LG = of, nf.MD = sf, nf.XL = df;
      const cf = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      wf.displayName = "EllipsisVertical", wf.categories = ["layout"], wf.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], wf.SM = cf, wf.LG = hf, wf.MD = ff, wf.XL = vf;
      const gf = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      mf.displayName = "Filter", mf.categories = ["layout"], mf.tags = ["funnel", "hopper"], mf.SM = gf, mf.LG = xf, mf.MD = uf, mf.XL = pf;
      ...
      yf.displayName = "Weapon", yf.categories = ["gaming"], yf.tags = ["gun", "pistol", "GTAO", "fire", "shoot", "death", "danger"], yf.SM = jf, yf.LG = bf, yf.MD = Mf, yf.XL = Rf;
      ...
      Af.displayName = "Heart", Af.categories = ["medical", "social", "multimedia", "emoji", "gaming", "shapes"], Af.tags = ["like", "love", "emotion", "suit", "playing", "cards"], Af.SM = zf, Af.LG = Lf, Af.MD = Cf, Af.XL = Hf;
      ...
      qf.displayName = "FileText", qf.categories = ["files", "text"], qf.tags = ["data", "txt", "pdf", "document"], qf.SM = Vf, qf.LG = Bf, qf.MD = If, qf.XL = Sf;
      ...
      kf.displayName = "Files", kf.categories = ["files"], kf.tags = ["multiple", "copy", "documents", "data", "file", "folder", "restore"], kf.SM = Nf, kf.LG = Df, kf.MD = Xf, kf.XL = Gf;
      ...
      Of.displayName = "Save", Of.categories = ["files"], Of.tags = ["floppy disk", "download", "backup", "storage", "disk", "document", "computer", "archive"], Of.SM = Ff, Of.MD = _f, Of.LG = Pf, Of.XL = Ef;
      const Tf = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Yf.displayName = "CircleDollarSign", Yf.categories = ["finance"], Yf.tags = ["monetization", "marketing", "currency", "money", "payment"], Yf.SM = Tf, Yf.LG = Wf, Yf.MD = Uf, Yf.XL = $f;
      const Zf = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ev.displayName = "DollarSign", ev.categories = ["finance"], ev.tags = ["currency", "money", "payment"], ev.SM = Zf, ev.LG = Kf, ev.MD = Jf, ev.XL = Qf;
      ...
      ov.displayName = "FastForward", ov.categories = ["multimedia", "arrows"], ov.tags = ["music", "audio", "video", "control", "player", "media"], ov.SM = lv, ov.LG = av, ov.MD = rv, ov.XL = tv;
      const sv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      cv.displayName = "Pause", cv.categories = ["multimedia"], cv.tags = ["music", "audio", "video", "stop", "pause", "control", "player", "media"], cv.SM = sv, cv.LG = dv, cv.MD = iv, cv.XL = nv;
      const hv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      gv.displayName = "Play", gv.categories = ["arrows", "multimedia"], gv.tags = ["music", "audio", "video", "start", "run", "play", "continue", "control", "player", "media"], gv.SM = hv, gv.LG = fv, gv.MD = vv, gv.XL = wv;
      const xv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      jv.displayName = "Rewind", jv.categories = ["arrows", "multimedia"], jv.tags = ["music", "audio", "video", "control", "player", "previous", "back", "reverse", "media"], jv.SM = xv, jv.LG = uv, jv.MD = pv, jv.XL = mv;
      const bv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      zv.displayName = "SkipBack", zv.categories = ["multimedia", "arrows"], zv.tags = ["music", "audio", "video", "arrow", "previous", "back", "rewind", "reverse", "control", "player", "media"], zv.SM = bv, zv.LG = Mv, zv.MD = Rv, zv.XL = yv;
      const Lv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Vv.displayName = "SkipForward", Vv.categories = ["multimedia", "arrows"], Vv.tags = ["music", "audio", "video", "arrow", "skip", "next", "forward", "control", "player", "media"], Vv.SM = Lv, Vv.LG = Cv, Vv.MD = Hv, Vv.XL = Av;
      const Bv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Nv.displayName = "StarOff", Nv.categories = ["multimedia", "social"], Nv.tags = ["dislike", "unlike", "remove", "unrate"], Nv.SM = Bv, Nv.LG = Iv, Nv.MD = Sv, Nv.XL = qv;
      ...
      Fv.displayName = "Stop", Fv.categories = ["multimedia"], Fv.tags = ["music", "audio", "video", "control", "player", "stop", "media"], Fv.SM = Dv, Fv.LG = Xv, Fv.MD = Gv, Fv.XL = kv;
      const _v = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      Tv.displayName = "ListMusic", Tv.categories = ["multimedia"], Tv.tags = ["playlist", "music", "audio", "control", "player", "media", "queue", "playback", "play", "list"], Tv.SM = _v, Tv.MD = Pv, Tv.LG = Ev, Tv.XL = Ov;
      const Wv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      Zv.displayName = "Book", Zv.categories = ["text", "gaming"], Zv.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], Zv.SM = Wv, Zv.LG = Uv, Zv.MD = $v, Zv.XL = Yv;
      const Kv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      lw.displayName = "CloudAlert", lw.categories = ["development"], lw.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], lw.SM = Kv, lw.LG = Jv, lw.MD = Qv, lw.XL = ew;
      ...
      sw.displayName = "CodeXml", sw.categories = ["text", "development"], sw.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], sw.SM = aw, sw.LG = rw, sw.MD = tw, sw.XL = ow;
      ...
      hw.displayName = "Database", hw.categories = ["devices", "development"], hw.tags = ["storage", "memory", "container", "tin", "pot", "bytes", "servers"], hw.SM = dw, hw.LG = iw, hw.MD = nw, hw.XL = cw;
      ...
      xw.displayName = "Server", xw.categories = ["development", "devices"], xw.tags = ["cloud", "storage"], xw.SM = fw, xw.LG = vw, xw.MD = ww, xw.XL = gw
    },
    93715: (e, l, a) => {
      a.d(l, {
        DI: () => t,
