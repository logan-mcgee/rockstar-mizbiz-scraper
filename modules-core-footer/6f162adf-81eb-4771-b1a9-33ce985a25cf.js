try {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    o = (new a.Error).stack;
  o && (a._sentryDebugIds = a._sentryDebugIds || {}, a._sentryDebugIds[o] = "6f162adf-81eb-4771-b1a9-33ce985a25cf", a._sentryDebugIdIdentifier = "sentry-dbid-6f162adf-81eb-4771-b1a9-33ce985a25cf")
} catch (a) {} {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [5848], {
    ...
    35328(a, o, r) {
      ...
      var s = function(a) {
          ...
          return o.options = (0, e.Cl)({
            async: !0,
            ssr: !1
          }, a), o
        }(),
        u = function() {},
        b = n.forwardRef(function(a, o) {
          var r = n.useRef(null),
            l = n.useState({
              onScrollCapture: u,
              onWheelCapture: u,
            ...
            q = void 0 === x ? "div" : x,
            E = a.gapMode,
            S = (0, e.Tt)(a, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]),
            L = h,
            O = function(a, o) {
              var r, e, l, t = (r = o || null, e = function(o) {
                ...
                return {
                  ...
                  facade: {
                    ...
                    set current(a) {
                      var o = l.value;
                      o !== a && (l.value = a, l.callback(a, o))
                    }
                  }
                }
              })[0]).callback = e, l.facade);
              return c(function() {
                var o = i.get(t);
                if (o) {
                  var r = new Set(o),
            ...
            N = (0, e.Cl)((0, e.Cl)({}, S), t);
          return n.createElement(n.Fragment, null, p && n.createElement(L, {
            sideCar: s,
            removeScrollBar: y,
            shards: m,
            noRelative: w,
            ...
            lockRef: r,
            gapMode: E
          }), b ? n.cloneElement(n.Children.only(g), (0, e.Cl)((0, e.Cl)({}, N), {
            ref: O
          })) : n.createElement(q, (0, e.Cl)({}, N, {
            className: v,
            ref: O
          }), g))
        });
      ...
      var g = function(a) {
        ...
        return n.createElement(l, (0, e.Cl)({}, r))
      };
      g.isSideCarExport = !0;
      var v = function() {
          var a = 0,
          ...
          return {
            add: function(e) {
              ...
              }()) && (l = e, (n = o).styleSheet ? n.styleSheet.cssText = l : n.appendChild(document.createTextNode(l)), function(a) {
            ...
            return function(a) {
              ...
              var o = function(a) {
                  var o = window.getComputedStyle(document.body),
                    ...
                    n = o["padding" === a ? "paddingRight" : "marginRight"];
                  return [m(r), m(e), m(n)]
                }(a),
      ...
      var E = !!x && {
        ...
        L = function(a, o) {
          var r = o.ownerDocument,
            e = o;
          do {
            if ("undefined" != typeof ShadowRoot && e instanceof ShadowRoot && (e = e.host), O(a, e)) {
              var n = N(a, e);
              if (n[1] > n[2]) return !0
            }
            e = e.parentNode
        ...
        O = function(a, o) {
          return "v" === a ? function(a) {
            return S(a, "overflowY")
          }(o) : function(a) {
            return S(a, "overflowX")
          }(o)
        },
        N = function(a, o) {
      ...
      const X = (D = function(a) {
        ...
        n.useEffect(function() {
          ...
          if (a.inert) {
            ...
            var o = (0, e.fX)([a.lockRef.current], (a.shards || []).map(T), !0).filter(Boolean);
        ...
        var i = n.useCallback(function(a, o) {
            if ("touches" in a && 2 === a.touches.length || "wheel" === a.type && a.ctrlKey) return !c.current.allowPinchZoom;
            var e, n = j(a),
              t = r.current,
              d = "deltaX" in a ? a.deltaX : t[0] - n[0],
              i = "deltaY" in a ? a.deltaY : t[1] - n[1],
              f = a.target,
              s = Math.abs(d) > Math.abs(i) ? "h" : "v";
            if ("touches" in a && "h" === s && "range" === f.type) return !1;
            var u = window.getSelection(),
              b = u && u.anchorNode;
            if (b && (b === f || b.contains(f))) return !1;
            var g = L(s, f);
            if (!g) return !0;
            if (g ? e = s : (e = "v" === s ? "h" : "v", g = L(s, f)), !g) return !1;
            if (!l.current && "changedTouches" in a && (d || i) && (l.current = e), !e) return !0;
            var v = l.current || e;
            return function(a, o, r, e) {
              ...
              do {
                ...
                (b || g) && O(a, t) && (f += g, s += b);
                var v = t.parentNode;
                t = v && v.nodeType === Node.DOCUMENT_FRAGMENT_NODE ? v.host : v
              } while (!d && t !== document.body || d && (o.contains(t) || o === t));
              return (i && (Math.abs(f) < 1 || !1) || !i && (Math.abs(s) < 1 || !1)) && (c = !0), c
            }(v, o, a, "h" === v ? d : i)
          }, []),
          f = n.useCallback(function(a) {
            var r = a;
            if (R.length && R[R.length - 1] === d) {
              var e = "deltaY" in r ? z(r) : j(r),
                n = o.current.filter(function(a) {
                  return a.name === r.type && (a.target === r.target || r.target === a.shadowParent) && (o = a.delta, n = e, o[0] === n[0] && o[1] === n[1]);
                  var o, n
                })[0];
              if (n && n.should) r.cancelable && r.preventDefault();
              else if (!n) {
                var l = (c.current.shards || []).map(T).filter(Boolean).filter(function(a) {
                  return a.contains(r.target)
                });
                (l.length > 0 ? i(r, l[0]) : !c.current.noIsolation) && r.cancelable && r.preventDefault()
              }
            }
          }, []),
          s = n.useCallback(function(a, r, e, n) {
            var l = {
              name: a,
              delta: r,
              target: e,
          ...
          u = n.useCallback(function(a) {
            r.current = j(a), l.current = void 0
          }, []),
          b = n.useCallback(function(o) {
            s(o.type, z(o), o.target, i(o, a.lockRef.current))
          }, []),
          g = n.useCallback(function(o) {
            s(o.type, j(o), o.target, i(o, a.lockRef.current))
          }, []);
        n.useEffect(function() {
          return R.push(d), a.setCallbacks({
              onScrollCapture: b,
              onWheelCapture: b,
              onTouchMoveCapture: g
            }), document.addEventListener("wheel", f, E), document.addEventListener("touchmove", f, E), document.addEventListener("touchstart", u, E),
            function() {
              R = R.filter(function(a) {
                return a !== d
              }), document.removeEventListener("wheel", f, E), document.removeEventListener("touchmove", f, E), document.removeEventListener("touchstart", u, E)
            }
        }, []);
        var v = a.removeScrollBar,
          p = a.inert;
        return n.createElement(n.Fragment, null, p ? n.createElement(d, {
          styles: M(t)
        }) : null, v ? n.createElement(k, {
          noRelative: a.noRelative,
          gapMode: a.gapMode
        }) : null)
      }, s.useMedium(D), g);
      var D, A = n.forwardRef(function(a, o) {
        return n.createElement(b, (0, e.Cl)({}, a, {
          ref: o,
          sideCar: X
        }))
      });
    ...
    46077(a, o, r) {
      ...
      function l(a) {
        for (var o = 1; o < arguments.length; o++) {
          ...
          o % 2 ? n(Object(r), !0).forEach(function(o) {
            var n, l, t;
            n = a, l = o, t = r[o], (l = e(l)) in n ? Object.defineProperty(n, l, {
              value: t,
              enumerable: !0,
              configurable: !0,
              writable: !0
            }) : n[l] = t
          }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(r)) : n(Object(r)).forEach(function(o) {
      ...
      var d = (a, o, r) => {
          for (var e of Object.keys(a)) {
            var n;
            if (a[e] !== (null !== (n = o[e]) && void 0 !== n ? n : r[e])) return !1
          }
          return !0
        },
        c = a => {
          var o = o => {
            var r = a.defaultClassName,
              e = l(l({}, a.defaultVariants), o);
            for (var n in e) {
              var t, c = null !== (t = e[n]) && void 0 !== t ? t : a.defaultVariants[n];
              if (null != c) {
                var i = c;
                "boolean" == typeof i && (i = !0 === i ? "true" : "false");
                var f = a.variantClassNames[n][i];
                f && (r += " " + f)
              }
            }
            for (var [s, u] of a.compoundVariants) d(s, e, a.defaultVariants) && (r += " " + u);
            return r
          };
    ...
    69218(a, o, r) {
      ...
      const d = "__FOUNDRY_ACCENT__",
        c = (a, o) => e.X ? o() : (window[d] || (window[d] = new Map), window[d].has(a) || window[d].set(a, o()), window[d].get(a));
      r(68309);
      var i, f = r(15963);
      ...
      r(54028), r(74143), r(88584), r(73892), r(54389),
        function(a) {
          a.Pending = "pending", a.Fulfilled = "fulfilled", a.Rejected = "rejected"
        }(i || (i = {})), Symbol.toStringTag;
      const u = (...a) => a.filter(a => a).join(" ")
    },
    22878(a, o, r) {
      r.d(o, {
        DX: () => e.DX,
    ...
    91350(a, o, r) {
      ...
      function l(a, o) {
        if (a === o) return a;
        const r = n.get(a);
        if (r) return r.forEach(a => a(o)), o;
        const e = n.get(o);
        return e ? (e.forEach(o => o(a)), a) : o
      }

      function t(...a) {
        return (...o) => {
          for (const r of a) "function" == typeof r && r(...o)
        }
      }
      ...
      function d(...a) {
        ...
        for (let r = 1; r < a.length; r++) {
          ...
          for (const a in n) {
            const r = o[a],
              d = n[a];
            "function" == typeof r && "function" == typeof d && "o" === a[0] && "n" === a[1] && a.charCodeAt(2) >= 65 && a.charCodeAt(2) <= 90 ? o[a] = t(r, d) : "className" !== a && "UNSAFE_className" !== a || "string" != typeof r || "string" != typeof d ? "id" === a && r && d ? o.id = l(r, d) : o[a] = void 0 !== d ? d : r : o[a] = (0, e.$)(r, d)
          }
        }
        return o
      }
    ...
    20972(a, o, r) {
      ...
      var e = r(4637),
        n = (r(84017), r(38957)),
        l = r(39793),
        t = ["a", "button", "div", "form", "h2", "h3", "img", "input", "label", "li", "nav", "ol", "p", "select", "span", "svg", "ul"].reduce((a, o) => {
          const r = (0, n.TL)(`Primitive.${o}`),
            t = e.forwardRef((a, e) => {
              const {
                asChild: n,
                ...t
              } = a, d = n ? r : o;
              return "undefined" != typeof window && (window[Symbol.for("radix-ui")] = !0), (0, l.jsx)(d, {
                ...t,
                ref: e
              })
            });
    ...
    3541(a, o, r) {
      ...
      var e = r(4637),
        ...
        d = e.forwardRef((a, o) => (0, l.jsx)(n.sG.span, {
          ...a,
          ref: o,
          style: {
            ...t,
    ...
    51177(a, o, r) {
      ...
      function n(a, o) {
        ...
        e(a, o), a.prototype = null === o ? Object.create(o) : (r.prototype = o.prototype, new r)
      }
      var l = function() {
        return l = Object.assign || function(a) {
          for (var o, r = 1, e = arguments.length; r < e; r++)
            for (var n in o = arguments[r]) Object.prototype.hasOwnProperty.call(o, n) && (a[n] = o[n]);
          return a
      ...
      function t(a, o) {
        var r = {};
        for (var e in a) Object.prototype.hasOwnProperty.call(a, e) && o.indexOf(e) < 0 && (r[e] = a[e]);
        if (null != a && "function" == typeof Object.getOwnPropertySymbols) {
          var n = 0;
          for (e = Object.getOwnPropertySymbols(a); n < e.length; n++) o.indexOf(e[n]) < 0 && Object.prototype.propertyIsEnumerable.call(a, e[n]) && (r[e[n]] = a[e[n]])
        }
        return r
      }
      ...
      function d(a, o, r, e) {
        return new(r || (r = Promise))(function(n, l) {
          ...
          function c(a) {
            var o;
            a.done ? n(a.value) : (o = a.value, o instanceof r ? o : new r(function(a) {
              a(o)
            })).then(t, d)
          }
          c((e = e.apply(a, o || [])).next())
        })
      }
      ...
      function c(a, o) {
        var r, e, n, l = {
          ...
          t = Object.create(("function" == typeof Iterator ? Iterator : Object).prototype);
        return t.next = d(0), t.throw = d(1), t.return = d(2), "function" == typeof Symbol && (t[Symbol.iterator] = function() {
          return this
        }), t;
        ...
        function d(d) {
          return function(c) {
            return function(d) {
              ...
              for (; t && (t = 0, d[0] && (l = 0)), l;) try {
                if (r = 1, e && (n = 2 & d[0] ? e.return : d[0] ? e.throw || ((n = e.return) && n.call(e), 0) : e.next) && !(n = n.call(e, d[1])).done) return n;
                switch (e = 0, n && (d = [2 & d[0], n.value]), d[0]) {
                  case 0:
                  case 1:
                    n = d;
                    break;
                  ...
                  case 7:
                    ...
                    continue;
                  default:
                    if (!((n = (n = l.trys).length > 0 && n[n.length - 1]) || 6 !== d[0] && 2 !== d[0])) {
                      l = 0;
                      continue
                    }
                    ...
                    if (6 === d[0] && l.label < n[1]) {
                      l.label = n[1], n = d;
                      break
                    }
                    if (n && l.label < n[2]) {
                      l.label = n[2], l.ops.push(d);
                      break
                    }
      ...
      function i(a, o, r) {
        if (r || 2 === arguments.length)
          for (var e, n = 0, l = o.length; n < l; n++) !e && n in o || (e || (e = Array.prototype.slice.call(o, 0, n)), e[n] = o[n]);
        return a.concat(e || Array.prototype.slice.call(o))
      }
