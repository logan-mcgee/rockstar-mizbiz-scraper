try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    l = (new e.Error).stack;
  l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "ffaa1d51-56a9-4651-9f06-830884d72087", e._sentryDebugIdIdentifier = "sentry-dbid-ffaa1d51-56a9-4651-9f06-830884d72087")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [3892], {
    ...
    10439: (e, l, a) => {
      function r(e) {
        ...
        if ("string" == typeof e || "number" == typeof e) t += e;
          ...
          if (Array.isArray(e)) {
            var o = e.length;
            for (l = 0; l < o; l++) e[l] && (a = r(e[l])) && (t && (t += " "), t += a)
          } else
      ...
      function t() {
        for (var e, l, a = 0, t = "", o = arguments.length; a < o; a++)(e = arguments[a]) && (l = r(e)) && (t && (t += " "), t += l);
        return t
      }
      a.d(l, {
        $: () => t,
      ...
      function i(...e) {
        ...
        for (let a = 1; a < e.length; a++) {
          ...
          for (const e in r) {
            const a = l[e],
              o = r[e];
            "function" == typeof a && "function" == typeof o && "o" === e[0] && "n" === e[1] && e.charCodeAt(2) >= 65 && e.charCodeAt(2) <= 90 ? l[e] = d(a, o) : "className" !== e && "UNSAFE_className" !== e || "string" != typeof a || "string" != typeof o ? "id" === e && a && o ? l.id = s(a, o) : l[e] = void 0 !== o ? o : a : l[e] = (0, t.$)(a, o)
          }
        }
        return l
      }
      ...
      var h = function(e) {
        ...
        v = t.forwardRef(function(e, l) {
          ...
          return t.createElement(t.Fragment, null, u && t.createElement(H, {
            ...
            ref: A
          })) : t.createElement(z, (0, r.__assign)({}, V, {
            className: g,
            ref: A
          }), w))
        });
    ...
    99520: (e, l, a) => {
      a.r(l), a.d(l, {
        ...
        ChevronsUpDown: () => ut,
        CircleCheck: () => Nc,
        CircleCheckFilled: () => Zc,
        CircleDollarSign: () => Gf,
        CircleHelp: () => J,
        CircleMinus: () => bh,
        CircleMinusFilled: () => Dh,
        CirclePerson: () => Ge,
        CircleSlash: () => Qe,
        CircleX: () => Lh,
        Clipboard: () => Wd,
      ...
      var y, z, L = (e, l, a) => {
        ...
        C = (y = {
          ...
          var l = y.defaultClassName,
            a = M(M({}, y.defaultVariants), e);
          for (var r in a) {
            var t, o = null !== (t = a[r]) && void 0 !== t ? t : y.defaultVariants[r];
            if (null != o) {
              var s = o;
              "boolean" == typeof s && (s = !0 === s ? "true" : "false");
              var d = y.variantClassNames[r][s];
              d && (l += " " + d)
            }
          }
          for (var [i, n] of y.compoundVariants) L(i, a, y.defaultVariants) && (l += " " + n);
          return l
        }).variants = () => Object.keys(y.variantClassNames), z.classNames = {
          get base() {
            return y.defaultClassName.split(" ")[0]
          },
          get variants() {
            return R(y.variantClassNames, e => R(e, e => e.split(" ")[0]))
          }
        }, z);
      ...
      J.displayName = "CircleHelp", J.categories = ["accessibility", "text", "notifications"], J.tags = ["question mark", "help", "support", "assistance", "doubt", "FAQ", "tooltip"], J.SM = $, J.LG = Y, J.MD = Z, J.XL = K;
      ...
      He.displayName = "BugOff", He.categories = ["development", "animals"], He.tags = ["issue", "report", "debug", "code", "insect"], He.SM = ye, He.LG = ze, He.XL = Le, He.MD = Ce;
      ...
      $e.displayName = "FlagOff", $e.categories = ["account", "social"], $e.tags = ["unflag"], $e.SM = Oe, $e.LG = Te, $e.XL = We, $e.MD = Ue;
      const Ye = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Qe.displayName = "CircleSlash", Qe.categories = ["account"], Qe.tags = ["cancel", "no", "stop", "forbidden", "prohibited", "error", "incorrect", "mistake", "wrong", "failure", "circle", "slash", "null", "void", "ban", "Blocked", "Restricted", "Denied", "Unavailable", "Stop", "Alert"], Qe.SM = Ye, Qe.LG = Ze, Qe.XL = Ke, Qe.MD = Je;
      ...
      yl.displayName = "PersonPlus", yl.categories = ["account"], yl.tags = ["new", "add", "create", "follow", "subscribe"], yl.SM = jl, yl.LG = bl, yl.XL = Ml, yl.MD = Rl;
      ...
      Al.displayName = "Envelope", Al.categories = ["text", "account", "mail"], Al.tags = ["email", "message", "letter", "unread", "inbox", "chat", "letter", "invitation"], Al.SM = zl, Al.LG = Ll, Al.XL = Cl, Al.MD = Hl;
      ...
      Yl.displayName = "Gear", Yl.categories = ["account"], Yl.tags = ["Cog", "Settings", "Preferences", "Options", "Custom", "Customize"], Yl.LG = Tl, Yl.SM = Wl, Yl.XL = Ul, Yl.MD = $l;
      const Zl = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ea.displayName = "Handshake", ea.categories = ["account", "social", "communication", "finance", "security"], ea.tags = ["agreement", "partnership", "deal", "business", "assistance", "cooperation", "friendship", "union", "terms"], ea.SM = Zl, ea.LG = Kl, ea.XL = Jl, ea.MD = Ql;
      ...
      za.displayName = "Menu", za.categories = ["layout", "account"], za.tags = ["bars", "navigation", "hamburger", "options", "side nav", "triple bar", "item"], za.SM = ba, za.LG = Ma, za.XL = Ra, za.MD = ya;
      const La = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Za.displayName = "ArrowUp", Za.categories = ["arrows", "navigation"], Za.tags = ["forward", "direction", "north", "increase"], Za.SM = Wa, Za.LG = Ua, Za.MD = $a, Za.XL = Ya;
      ...
      Lr.displayName = "ArrowRight", Lr.categories = ["arrows", "navigation"], Lr.tags = ["forward", "next", "direction", "east", "->"], Lr.SM = Mr, Lr.LG = Rr, Lr.MD = yr, Lr.XL = zr;
      ...
      Kr.displayName = "CloudUpload", Kr.categories = ["arrows", "files"], Kr.tags = ["file"], Kr.SM = Ur, Kr.LG = $r, Kr.MD = Yr, Kr.XL = Zr;
      ...
      Ct.displayName = "Maximize2", Ct.categories = ["arrows", "layout", "design"], Ct.tags = ["fullscreen", "arrows", "expand"], Ct.SM = Rt, Ct.LG = yt, Ct.MD = zt, Ct.XL = Lt;
      ...
      Jt.displayName = "Replay", Jt.categories = ["arrows", "design", "photography"], Jt.tags = ["arrow", "right", "clockwise", "refresh", "reload", "rerun", "redo"], Jt.SM = $t, Jt.LG = Yt, Jt.MD = Zt, Jt.XL = Kt;
      ...
      yo.displayName = "House", yo.categories = ["buildings", "home"], yo.tags = ["home", "living", "building", "residence", "architecture", "property", "homepage", "city"], yo.SM = jo, yo.LG = bo, yo.MD = Mo, yo.XL = Ro;
      ...
      Ao.displayName = "Property", Ao.categories = ["account", "buildings"], Ao.tags = ["organization", "building", "house", "city", "GTAO", "structure"], Ao.SM = zo, Ao.LG = Lo, Ao.MD = Co, Ao.XL = Ho;
      ...
      Yo.displayName = "Volume", Yo.categories = ["connectivity", "communication", "multimedia"], Yo.tags = ["music", "sound", "mute", "speaker"], Yo.SM = To, Yo.LG = Wo, Yo.MD = Uo, Yo.XL = $o;
      const Zo = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      es.displayName = "Volume1", es.categories = ["connectivity", "communication", "multimedia"], es.tags = ["music", "sound", "speaker", "control", "volume", "low"], es.SM = Zo, es.LG = Ko, es.MD = Jo, es.XL = Qo;
      ...
      zs.displayName = "Headset", zs.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], zs.tags = ["music", "audio", "sound", "gaming", "headphones", "headset", "call", "center", "phone", "telephone", "voip", "video"], zs.SM = bs, zs.LG = Ms, zs.MD = Rs, zs.XL = ys;
      const Ls = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Zs.displayName = "Pencil", Zs.categories = ["design", "cursors", "tools", "text"], Zs.tags = ["rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist", "update", "correct", "modify", "note"], Zs.SM = Ws, Zs.LG = Us, Zs.MD = $s, Zs.XL = Ys;
      ...
      Ld.displayName = "Cpu", Ld.categories = ["devices"], Ld.tags = ["processor", "cores", "technology", "computer", "chip", "circuit", "memory", "ram", "specs", "gigahertz", "ghz"], Ld.SM = Md, Ld.MD = Rd, Ld.LG = yd, Ld.XL = zd;
      ...
      Kd.displayName = "Copy", Kd.categories = ["text"], Kd.tags = ["clone", "duplicate", "multiple"], Kd.SM = Ud, Kd.LG = $d, Kd.MD = Yd, Kd.XL = Zd;
      ...
      Ci.displayName = "Instagram", Ci.categories = ["brands", "social", "photography"], Ci.tags = ["logo", "camera", "social media", "photo", "camera", "app", "share"], Ci.SM = Ri, Ci.LG = yi, Ci.MD = zi, Ci.XL = Li;
      ...
      Ji.displayName = "Tiktok", Ji.categories = ["brands", "social"], Ji.tags = ["Social media", "video", "player", "game", "community", "app", "share", "logo", "photo", "camera"], Ji.SM = $i, Ji.MD = Yi, Ji.LG = Zi, Ji.XL = Ki;
      ...
      yn.displayName = "Playstation", yn.categories = ["platform"], yn.tags = ["games", "gaming", "social", "brand", "third party"], yn.SM = jn, yn.MD = bn, yn.LG = Mn, yn.XL = Rn;
      ...
      An.displayName = "NintendoSwitch", An.categories = ["platform"], An.tags = ["games", "gaming", "social", "brand", "third party"], An.SM = zn, An.MD = Ln, An.LG = Cn, An.XL = Hn;
      ...
      Yn.displayName = "MessageSquareText", Yn.categories = ["social"], Yn.tags = ["comment", "chat", "conversation", "dialog", "feedback", "speech bubble", "clear", "close", "delete", "remove", "cancel", "silence", "mute", "moderate"], Yn.SM = Tn, Yn.LG = Wn, Yn.MD = Un, Yn.XL = $n;
      const Zn = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ec.displayName = "Search", ec.categories = ["text", "social"], ec.tags = ["find", "scan", "magnifier", "magnifying glass", "look", "view"], ec.SM = Zn, ec.LG = Kn, ec.MD = Jn, ec.XL = Qn;
      ...
      cc.displayName = "LockKeyhole", cc.categories = ["security"], cc.tags = ["security", "password", "secure", "admin", "lock", "safe", "protection", "security", "latch"], cc.SM = sc, cc.LG = dc, cc.MD = ic, cc.XL = nc;
      ...
      gc.displayName = "LockPassword", gc.categories = ["security"], gc.tags = ["security", "password", "secure", "admin"], gc.SM = hc, gc.LG = fc, gc.MD = vc, gc.XL = wc;
      ...
      jc.displayName = "Image", jc.categories = ["photography", "text", "multimedia", "files"], jc.tags = ["picture", "photo"], jc.SM = xc, jc.LG = uc, jc.MD = pc, jc.XL = mc;
      ...
      zc.displayName = "Lightbulb", zc.categories = ["photography"], zc.tags = ["idea", "bright", "lights"], zc.SM = bc, zc.LG = Mc, zc.MD = Rc, zc.XL = yc;
      const Lc = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Vc.displayName = "Check", Vc.categories = ["notifications"], Vc.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "success", "accept"], Vc.SM = Lc, Vc.LG = Cc, Vc.MD = Hc, Vc.XL = Ac;
      const Bc = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Nc.displayName = "CircleCheck", Nc.categories = ["notifications"], Nc.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], Nc.SM = Bc, Nc.LG = Ic, Nc.MD = Sc, Nc.XL = qc;
      ...
      Fc.displayName = "TriangleAlert", Fc.categories = ["notifications", "shapes", "development"], Fc.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], Fc.SM = Dc, Fc.LG = Xc, Fc.MD = Gc, Fc.XL = kc;
      ...
      Tc.displayName = "X", Tc.categories = ["notifications", "math"], Tc.tags = ["cancel", "close", "delete", "remove", "times", "clear", "math", "multiply", "multiplication", "error", "remove", "clean", "erase", "navigation", "cross", "times"], Tc.SM = _c, Tc.LG = Pc, Tc.MD = Ec, Tc.XL = Oc;
      ...
      Zc.displayName = "CircleCheckFilled", Zc.categories = ["notifications"], Zc.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success", "filled"], Zc.SM = Wc, Zc.MD = Uc, Zc.LG = $c, Zc.XL = Yc;
      ...
      lh.displayName = "Globe", lh.categories = ["navigation"], lh.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], lh.SM = Kc, lh.LG = Jc, lh.MD = Qc, lh.XL = eh;
      ...
      sh.displayName = "Pin", sh.categories = ["navigation"], sh.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point"], sh.SM = ah, sh.MD = rh, sh.LG = th, sh.XL = oh;
      ...
      hh.displayName = "PinFilled", hh.categories = ["navigation"], hh.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point", "filled"], hh.SM = dh, hh.MD = ih, hh.LG = nh, hh.XL = ch;
      ...
      xh.displayName = "HeartPulse", xh.categories = ["medical"], xh.tags = ["heartbeat", "pulse", "health", "medical", "blood pressure", "cardiac", "systole", "diastole"], xh.SM = fh, xh.LG = vh, xh.MD = wh, xh.XL = gh;
      ...
      bh.displayName = "CircleMinus", bh.categories = ["math"], bh.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete"], bh.SM = uh, bh.LG = ph, bh.MD = mh, bh.XL = jh;
      ...
      Lh.displayName = "CircleX", Lh.categories = ["math", "development"], Lh.tags = ["cancel", "close", "delete", "remove", "times", "clear", "error", "incorrect", "wrong", "mistake", "failure", "linter", "multiply", "multiplication", "clean", "erase", "deprecate", "delete", "navigation"], Lh.SM = Mh, Lh.LG = Rh, Lh.MD = yh, Lh.XL = zh;
      ...
      Bh.displayName = "Minus", Bh.categories = ["math", "development", "text", "tools"], Bh.tags = ["subtract", "remove", "decrease", "decrement", "reduce", "negative", "calculate", "line", "divider", "separator", "horizontal rule", "hr", "html", "markup", "markdown", "---", "toolbar", "operator", "code", "coding", "minimum", "downgrade", "less", "delete", "navigation", "minimize"], Bh.SM = Ch, Bh.LG = Hh, Bh.MD = Ah, Bh.XL = Vh;
      ...
      Dh.displayName = "CircleMinusFilled", Dh.categories = ["math"], Dh.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete", "filled"], Dh.SM = Ih, Dh.MD = Sh, Dh.LG = qh, Dh.XL = Nh;
      ...
      _h.displayName = "EnvelopeOpen", _h.categories = ["mail"], _h.tags = ["email", "message", "letter", "read"], _h.SM = Xh, _h.LG = Gh, _h.MD = kh, _h.XL = Fh;
      ...
      Wh.displayName = "Paperclip", Wh.categories = ["text", "design", "files", "mail"], Wh.tags = ["attachment", "file", "attach", "clip", "document", "paper"], Wh.SM = Ph, Wh.LG = Eh, Wh.MD = Oh, Wh.XL = Th;
      const Uh = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Kh.displayName = "Trash", Kh.categories = ["files", "mail"], Kh.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], Kh.SM = Uh, Kh.LG = $h, Kh.MD = Yh, Kh.XL = Zh;
      ...
      af.displayName = "EllipsisVertical", af.categories = ["layout"], af.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], af.SM = Jh, af.LG = Qh, af.MD = ef, af.XL = lf;
      ...
      df.displayName = "Filter", df.categories = ["layout"], df.tags = ["funnel", "hopper"], df.SM = rf, df.LG = tf, df.MD = of, df.XL = sf;
      ...
      vf.displayName = "Weapon", vf.categories = ["gaming"], vf.tags = ["gun", "pistol", "GTAO", "fire", "shoot", "death", "danger"], vf.SM = nf, vf.LG = cf, vf.MD = hf, vf.XL = ff;
      ...
      pf.displayName = "Heart", pf.categories = ["medical", "social", "multimedia", "emoji", "gaming", "shapes"], pf.tags = ["like", "love", "emotion", "suit", "playing", "cards"], pf.SM = wf, pf.LG = gf, pf.MD = xf, pf.XL = uf;
      ...
      Rf.displayName = "FileText", Rf.categories = ["files", "text"], Rf.tags = ["data", "txt", "pdf", "document"], Rf.SM = mf, Rf.LG = jf, Rf.MD = bf, Rf.XL = Mf;
      ...
      Hf.displayName = "Files", Hf.categories = ["files"], Hf.tags = ["multiple", "copy", "documents", "data", "file", "folder", "restore"], Hf.SM = yf, Hf.LG = zf, Hf.MD = Lf, Hf.XL = Cf;
      ...
      Sf.displayName = "Save", Sf.categories = ["files"], Sf.tags = ["floppy disk", "download", "backup", "storage", "disk", "document", "computer", "archive"], Sf.SM = Af, Sf.MD = Vf, Sf.LG = Bf, Sf.XL = If;
      ...
      Gf.displayName = "CircleDollarSign", Gf.categories = ["finance"], Gf.tags = ["monetization", "marketing", "currency", "money", "payment"], Gf.SM = qf, Gf.LG = Nf, Gf.MD = Df, Gf.XL = Xf;
      ...
      Ef.displayName = "DollarSign", Ef.categories = ["finance"], Ef.tags = ["currency", "money", "payment"], Ef.SM = kf, Ef.LG = Ff, Ef.MD = _f, Ef.XL = Pf;
      ...
      $f.displayName = "FastForward", $f.categories = ["multimedia", "arrows"], $f.tags = ["music", "audio", "video", "control", "player", "media"], $f.SM = Of, $f.LG = Tf, $f.MD = Wf, $f.XL = Uf;
      const Yf = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Qf.displayName = "Pause", Qf.categories = ["multimedia"], Qf.tags = ["music", "audio", "video", "stop", "pause", "control", "player", "media"], Qf.SM = Yf, Qf.LG = Zf, Qf.MD = Kf, Qf.XL = Jf;
      ...
      tv.displayName = "Play", tv.categories = ["arrows", "multimedia"], tv.tags = ["music", "audio", "video", "start", "run", "play", "continue", "control", "player", "media"], tv.SM = ev, tv.LG = lv, tv.MD = av, tv.XL = rv;
      ...
      nv.displayName = "Rewind", nv.categories = ["arrows", "multimedia"], nv.tags = ["music", "audio", "video", "control", "player", "previous", "back", "reverse", "media"], nv.SM = ov, nv.LG = sv, nv.MD = dv, nv.XL = iv;
      ...
      wv.displayName = "SkipBack", wv.categories = ["multimedia", "arrows"], wv.tags = ["music", "audio", "video", "arrow", "previous", "back", "rewind", "reverse", "control", "player", "media"], wv.SM = cv, wv.LG = hv, wv.MD = fv, wv.XL = vv;
      ...
      mv.displayName = "SkipForward", mv.categories = ["multimedia", "arrows"], mv.tags = ["music", "audio", "video", "arrow", "skip", "next", "forward", "control", "player", "media"], mv.SM = gv, mv.LG = xv, mv.MD = uv, mv.XL = pv;
      ...
      yv.displayName = "StarOff", yv.categories = ["multimedia", "social"], yv.tags = ["dislike", "unlike", "remove", "unrate"], yv.SM = jv, yv.LG = bv, yv.MD = Mv, yv.XL = Rv;
      const zv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      Av.displayName = "Stop", Av.categories = ["multimedia"], Av.tags = ["music", "audio", "video", "control", "player", "stop", "media"], Av.SM = zv, Av.LG = Lv, Av.MD = Cv, Av.XL = Hv;
      ...
      qv.displayName = "ListMusic", qv.categories = ["multimedia"], qv.tags = ["playlist", "music", "audio", "control", "player", "media", "queue", "playback", "play", "list"], qv.SM = Vv, qv.MD = Bv, qv.LG = Iv, qv.XL = Sv;
      ...
      kv.displayName = "Book", kv.categories = ["text", "gaming"], kv.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], kv.SM = Nv, kv.LG = Dv, kv.MD = Xv, kv.XL = Gv;
      ...
      Ov.displayName = "CloudAlert", Ov.categories = ["development"], Ov.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], Ov.SM = Fv, Ov.LG = _v, Ov.MD = Pv, Ov.XL = Ev;
      ...
      Yv.displayName = "CodeXml", Yv.categories = ["text", "development"], Yv.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], Yv.SM = Tv, Yv.LG = Wv, Yv.MD = Uv, Yv.XL = $v;
      const Zv = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ew.displayName = "Database", ew.categories = ["devices", "development"], ew.tags = ["storage", "memory", "container", "tin", "pot", "bytes", "servers"], ew.SM = Zv, ew.LG = Kv, ew.MD = Jv, ew.XL = Qv;
      ...
      ow.displayName = "Server", ow.categories = ["development", "devices"], ow.tags = ["cloud", "storage"], ow.SM = lw, ow.LG = aw, ow.MD = rw, ow.XL = tw
    }
  }
]);