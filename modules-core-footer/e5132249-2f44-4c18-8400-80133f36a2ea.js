! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "e5132249-2f44-4c18-8400-80133f36a2ea", e._sentryDebugIdIdentifier = "sentry-dbid-e5132249-2f44-4c18-8400-80133f36a2ea")
  } catch (e) {}
}();
  ...
  [4079], {
    25922: (e, a, t) => {
      ...
      const g = u((e => {
        ...
        const {
          track: h
        } = (0, l.useGtmTrack)(), b = (0, o.useIntl)(), [k] = (0, o.getLocale)(), [v, x] = (0, s.useState)(!1), C = (0, s.useRef)(null), [S, M] = (0, s.useState)(0), N = "ontouchstart" in window || navigator?.maxTouchPoints > 0 || navigator?.msMaxTouchPoints > 0, w = e => {
        ...
        return (0, s.useEffect)((() => {
          ...
          children: [N && "sc-menu" === a && (0, m.jsx)("div", {
            ...
            className: [d.languageSelector, v ? d.open : ""].join(" "),
            "data-theme": a,
            "data-testid": `${g||a}-language-selector`,
            ...p,
                ...
                children: o.locales.map((e => {
                  ...
                  return (0, m.jsx)(s.Fragment, {
                    children: (0, m.jsx)(n.A, {
                      ...
                      tabIndex: v ? 0 : -1,
                      "data-testid": `${g||a}-language-selector-${t}`,
                      children: r
                    })
                  }, r)
                }))
      ...
      const T = {
        ...
        H = e => {
          ...
          const {
            ...
            navOpen: S
          } = (0, l.useRockstarUserState)(), M = (0, s.useRef)(null), [N, w] = (0, s.useState)(0), [y, j] = (0, s.useState)(0), [I, E] = (0, s.useState)(!0);
          return (0, s.useEffect)((() => {
            u !== a && !1 === I && E(!0), u === a && E(!1)
          }), [u]), (0, s.useEffect)((() => {
            if (!M.current) return;
            ...
            children: [(0, m.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), C(n), u === a ? (g(-1), _(0)) : (g(a), _(N + y + y))
              },
              children: [(0, m.jsx)("span", {
        ...
        D = e => {
          ...
          const {
            ...
            navOpen: v
          } = (0, l.useRockstarUserState)(), x = (0, p.useLocale)(), C = (0, p.toScLocaleString)(x), [S, M] = (0, s.useState)(""), N = `${a.login}?returnUrl=${S}&lang=${C}`, w = `${a.signup}&returnUrl=${S}&lang=${C}`, I = (0, s.useMemo)((() => (0, L.A)()), []), T = (0, s.useMemo)((() => {
            const e = ((e, a, t) => [{
            ...
            return e
          }), [i, N, w, I]), [R, O] = (0, s.useState)(0), D = (0, s.createRef)(), $ = () => {
            if (D.current) {
              const {
                current: e
      ...
      const K = {
        ...
        oe = e => {
          ...
          const {
            ...
            track: c
          } = (0, l.useGtmTrack)(), n = (0, o.useIntl)(), [i, d] = (0, s.useState)([]), [f, u] = (0, s.useState)(null), [g, _] = (0, s.useState)(null), [p, h] = (0, s.useState)(!1), [b, k] = (0, s.useState)(-1), [v, x] = (0, s.useState)([]), [C, S] = (0, s.useState)(0), M = t(5931), {
            platform: N
        ...
        ie = e => {
          ...
          const {
            ...
            setUserData: K
          } = (0, l.useRockstarUserState)(), [q, Q] = (0, s.useState)(null), [ae, te] = (0, s.useState)(!1), [se, re] = (0, s.useState)(!1), [ce, ie] = (0, s.useState)(0), de = (0, s.createRef)(), fe = (0, $.ri)(de, !1), ue = (0, s.createRef)(), [me, ge] = (0, s.useState)(0), [_e, pe] = (0, s.useState)([]), [he, be] = (0, s.useState)(244), ke = (0, s.useRef)(null), ve = (0, s.useMemo)((() => (0, L.A)()), []), xe = (0, s.useMemo)((() => ((e, a, t, s, r) => [{
          ...
          }])(v, a, W, G, O, window)), [v, a, W, G, O, ve]), Ce = () => {
            re(n + he * ce < fe)
          }, Se = () => {
            if (ue.current) {
              const {
        ...
        ue = u((e => {
          ...
          const {
            ...
            track: I
          } = (0, l.useGtmTrack)(), [E, L] = (0, s.useState)(!1), T = (0, s.useRef)(), [P, R] = (0, s.useState)(0), O = (0, s.createRef)(), [H, $] = (0, s.useState)(!1), [U, B] = (0, s.useState)(0), [A, W] = (0, s.useState)(!1), {
            mutateWebSettings: z,
            webSettings: F
