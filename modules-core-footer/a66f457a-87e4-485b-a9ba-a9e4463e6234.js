try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "a66f457a-87e4-485b-a9ba-a9e4463e6234", e._sentryDebugIdIdentifier = "sentry-dbid-a66f457a-87e4-485b-a9ba-a9e4463e6234")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [3002], {
        ...
        m = function(e, t) {
          var n, i = (null == t ? void 0 : t.document) || document,
            ...
            E = function() {
              ...
              if (void 0 === e || e && !(0, o.isFocusable)(e, m.tabbableOptions))
                if (T(i.activeElement) >= 0) e = i.activeElement;
                else {
            ...
            S = function() {
              if (g.containerGroups = g.containers.map(function(e) {
                ...
                }), g.tabbableGroups.length <= 0 && !O("fallbackFocus")) throw new Error("Your focus-trap must have at least one container with at least one tabbable node in it at all times");
            ...
            N = function(e) {
              var t = h(e);
              T(t, e) >= 0 || (b(m.clickOutsideDeactivates, e) ? n.deactivate({
            ...
            C = function(e) {
              var t = h(e);
              T(t, e) >= 0 || b(m.clickOutsideDeactivates, e) || b(m.allowOutsideClick, e) || (e.preventDefault(), e.stopImmediatePropagation())
            },
            _ = function() {
              if (g.active) return l.activateTrap(u, n), g.delayInitialFocusTimer = m.delayInitialFocus ? v(function() {
                ...
                capture: !0,
                passive: !1
              }), i.addEventListener("keydown", A), n
            },
            x = function() {
              if (g.active) return i.removeEventListener("focusin", R, !0), i.removeEventListener("mousedown", N, !0), i.removeEventListener("touchstart", N, !0), i.removeEventListener("click", C, !0), i.removeEventListener("keydown", I, !0), i.removeEventListener("keydown", A), n
            },
            j = "undefined" != typeof window && "MutationObserver" in window ? new MutationObserver(function(e) {
              e.some(function(e) {
            ...
            L = function() {
              j && (j.disconnect(), g.active && !g.paused && g.containers.map(function(e) {
                j.observe(e, {
                  subtree: !0,
                  childList: !0
                })
          ...
          return n = {
            ...
            deactivate: function(e) {
              ...
              clearTimeout(g.delayInitialFocusTimer), g.delayInitialFocusTimer = void 0, g.paused || n._setSubtreeIsolation(!1), g.alreadySilent.clear(), x(), g.active = !1, g.paused = !1, L(), l.deactivateTrap(u, n);
            ...
            _setPausedState: {
              value: function(e, t) {
                ...
                if (g.paused = e, e) {
                  var o = w(t, "onPause"),
                    r = w(t, "onPostPause");
                  null == o || o(), x(), L(), n._setSubtreeIsolation(!1), null == r || r()
                } else {
                  var a = w(t, "onUnpause"),
                    i = w(t, "onPostUnpause");
    ...
    79098(e, t, n) {
      ...
      const v = function(e) {
        ...
        e = s(e);
        var n = d.test(e);
        return n || f.test(e) ? p(e.slice(2), n ? 2 : 8) : l.test(e) ? NaN : +e
      };
      var b = Math.max,
        h = Math.min;
      const y = function(e, t, n) {
        ...
        function m(t) {
          var n = r,
            o = i;
          return r = i = void 0, d = t, s = e.apply(o, n)
        }

        function g(e) {
          var n = e - l;
          return void 0 === l || n >= t || n < 0 || p && e - d >= u
        }
        ...
        function w() {
          ...
          c = setTimeout(w, function(e) {
            var n = t - (e - l);
            return p ? h(n, u - (e - d)) : n
          }(e))
        }

        function T(e) {
          return c = void 0, y && r ? m(e) : (r = i = void 0, s)
        }
        ...
        function O() {
          ...
          if (r = arguments, i = this, l = e, n) {
            if (void 0 === c) return function(e) {
              return d = e, c = setTimeout(w, t), f ? m(e) : s
            }(l);
            if (p) return clearTimeout(c), c = setTimeout(w, t), m(l)
          }
          return void 0 === c && (c = setTimeout(w, t)), s
        }
        return t = v(t) || 0, (0, o.A)(n) && (f = !!n.leading, u = (p = "maxWait" in n) ? b(v(n.maxWait) || 0, t) : u, y = "trailing" in n ? !!n.trailing : y), O.cancel = function() {
          void 0 !== c && clearTimeout(c), d = 0, r = l = i = c = void 0
        }, O.flush = function() {
          return void 0 === c ? s : T(a())
        }, O
      }
    }
  }
