try {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    o = (new a.Error).stack;
  o && (a._sentryDebugIds = a._sentryDebugIds || {}, a._sentryDebugIds[o] = "2fa90cb7-cd8d-4033-924e-970a21cfca6b", a._sentryDebugIdIdentifier = "sentry-dbid-2fa90cb7-cd8d-4033-924e-970a21cfca6b")
} catch (a) {} {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const X = (D = function(a) {
        ...
        n.useEffect(function() {
          ...
          if (a.inert) {
            ...
            var o = (0, e.fX)([a.lockRef.current], (a.shards || []).map(M), !0).filter(Boolean);
        ...
        var i = n.useCallback(function(a, o) {
          ...
          f = n.useCallback(function(a) {
            ...
            if (R.length && R[R.length - 1] === d) {
              ...
              if (n && n.should) r.cancelable && r.preventDefault();
                ...
                var l = (c.current.shards || []).map(M).filter(Boolean).filter(function(a) {
          ...
          b = n.useCallback(function(o) {
            s(o.type, T(o), o.target, i(o, a.lockRef.current))
          }, []),
