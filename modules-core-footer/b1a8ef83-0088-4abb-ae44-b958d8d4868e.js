try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    l = (new e.Error).stack;
  l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "b1a8ef83-0088-4abb-ae44-b958d8d4868e", e._sentryDebugIdIdentifier = "sentry-dbid-b1a8ef83-0088-4abb-ae44-b958d8d4868e")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [2321], {
    52321(e, l, a) {
      ...
      F.displayName = "CircleHelp", F.categories = ["accessibility", "text", "notifications"], F.tags = ["question mark", "help", "support", "assistance", "doubt", "FAQ", "tooltip"], F.SM = G, F.LG = N, F.MD = X, F.XL = q;
      ...
      ke.displayName = "CircleSlash", ke.categories = ["account"], ke.tags = ["cancel", "no", "stop", "forbidden", "prohibited", "error", "incorrect", "mistake", "wrong", "failure", "circle", "slash", "null", "void", "ban", "Blocked", "Restricted", "Denied", "Unavailable", "Stop", "Alert"], ke.SM = Ne, ke.LG = Xe, ke.XL = qe, ke.MD = Fe;
      ...
      Ue.displayName = "ThumbsUp", Ue.categories = ["account", "social", "emoji"], Ue.tags = ["like", "good", "emotion", "rate", "social", "review", "feedback", "positive"], Ue.SM = Pe, Ue.LG = Oe, Ue.XL = Te, Ue.MD = Ee;
      ...
      Ft.displayName = "Replay", Ft.categories = ["arrows", "design", "photography"], Ft.tags = ["arrow", "right", "clockwise", "refresh", "reload", "rerun", "redo"], Ft.SM = Gt, Ft.LG = Nt, Ft.MD = Xt, Ft.XL = qt;
      ...
      ks.displayName = "Volume1", ks.categories = ["connectivity", "communication", "multimedia"], ks.tags = ["music", "sound", "speaker", "control", "volume", "low"], ks.SM = Ns, ks.LG = Xs, ks.MD = qs, ks.XL = Fs;
      ...
      Us.displayName = "Volume2", Us.categories = ["connectivity", "communication", "multimedia"], Us.tags = ["music", "sound", "speaker", "control", "volume", "high"], Us.SM = Ps, Us.LG = Os, Us.MD = Ts, Us.XL = Es;
      ...
      li.displayName = "Mic", li.categories = ["communication"], li.tags = ["record", "sound", "listen", "radio", "podcast", "microphone", "audio", "voice"], li.SM = Qs, li.MD = Js, li.LG = $s, li.XL = ei;
      ...
      Ii.displayName = "Monitor", Ii.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], Ii.tags = ["tv", "computer", "screen", "display", "virtual machine"], Ii.SM = Hi, Ii.MD = Ai, Ii.LG = Vi, Ii.XL = Bi;
      ...
      Ni.displayName = "Pencil", Ni.categories = ["design", "cursors", "tools", "text"], Ni.tags = ["rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist", "update", "correct", "modify", "note"], Ni.SM = Si, Ni.LG = yi, Ni.MD = Di, Ni.XL = Gi;
      ...
      _i.displayName = "Plus", _i.categories = ["math", "tools", "development", "text", "cursors", "gaming"], _i.tags = ["add", "new", "increase", "increment", "positive", "calculate", "toolbar", "crosshair", "aim", "target", "scope", "sight", "reticule", "maximum", "upgrade", "extra", "+", "more", "create", "navigation"], _i.SM = Oi, _i.LG = Ti, _i.MD = Ei, _i.XL = Ui;
      ...
      Qi.displayName = "LayoutGrid", Qi.categories = ["design", "layout"], Qi.tags = ["app", "home", "start", "squares", "hub", "menu", "blocks", "options", "items", "gallery"], Qi.SM = Wi, Qi.LG = Zi, Qi.MD = Yi, Qi.XL = Ki;
      const Ji = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ad.displayName = "Maximize", ad.categories = ["layout", "design"], ad.tags = ["full screen", "expand", "dashed", "maximum", "big", "large"], ad.SM = Ji, ad.LG = $i, ad.MD = ed, ad.XL = ld;
      ...
      Sd.displayName = "Clipboard", Sd.categories = ["text"], Sd.tags = ["copy", "paste"], Sd.SM = Ad, Sd.LG = Vd, Sd.MD = Bd, Sd.XL = Id;
      ...
      Xd.displayName = "Copy", Xd.categories = ["text"], Xd.tags = ["clone", "duplicate", "multiple"], Xd.SM = yd, Xd.LG = Dd, Xd.MD = Gd, Xd.XL = Nd;
      ...
      Wd.displayName = "ListFilter", Wd.categories = ["text"], Wd.tags = ["options"], Wd.SM = Td, Wd.LG = Ed, Wd.MD = Ud, Wd.XL = _d;
      ...
      Jd.displayName = "Unlink", Jd.categories = ["text"], Jd.tags = ["url", "unchain"], Jd.SM = Zd, Jd.LG = Yd, Jd.MD = Kd, Jd.XL = Qd;
      ...
      ro.displayName = "Trophy", ro.categories = ["sports", "gaming"], ro.tags = ["prize", "sports", "winner", "achievement", "award", "champion", "celebration", "victory"], ro.SM = $d, ro.LG = eo, ro.MD = lo, ro.XL = ao;
      ...
      Do.displayName = "Twitter", Do.categories = ["brands", "social", "account"], Do.tags = ["logo", "social", "social media", "twitter", "tweet", "app", "share", "x"], Do.SM = Bo, Do.LG = Io, Do.MD = So, Do.XL = yo;
      ...
      Fo.displayName = "Tiktok", Fo.categories = ["brands", "social"], Fo.tags = ["Social media", "video", "player", "game", "community", "app", "share", "logo", "photo", "camera"], Fo.SM = Go, Fo.MD = No, Fo.LG = Xo, Fo.XL = qo;
      ...
      Yo.displayName = "EpicGames", Yo.categories = ["platform"], Yo.tags = ["games", "gaming", "social", "brand", "third party"], Yo.SM = Uo, Yo.MD = _o, Yo.LG = Wo, Yo.XL = Zo;
      const Ko = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      eh.displayName = "Steam", eh.categories = ["platform"], eh.tags = ["games", "gaming", "social", "brand", "third party"], eh.SM = Ko, eh.MD = Qo, eh.LG = Jo, eh.XL = $o;
      ...
      Bh.displayName = "Truck", Bh.categories = ["transportation"], Bh.tags = ["vehicle", "drive", "trip", "journey", "lorry", "delivery", "van"], Bh.SM = Ch, Bh.MD = Hh, Bh.LG = Ah, Bh.XL = Vh;
      const Ih = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Gh.displayName = "ShoppingBag", Gh.categories = ["shopping"], Gh.tags = ["ecommerce", "cart", "purchase", "store", "bag", "shop", "shopping", "tote"], Gh.SM = Ih, Gh.MD = Sh, Gh.LG = yh, Gh.XL = Dh;
      ...
      kh.displayName = "MessageSquareText", kh.categories = ["social"], kh.tags = ["comment", "chat", "conversation", "dialog", "feedback", "speech bubble", "clear", "close", "delete", "remove", "cancel", "silence", "mute", "moderate"], kh.SM = Nh, kh.LG = Xh, kh.MD = qh, kh.XL = Fh;
      ...
      Uh.displayName = "Search", Uh.categories = ["text", "social"], Uh.tags = ["find", "scan", "magnifier", "magnifying glass", "look", "view"], Uh.SM = Ph, Uh.LG = Oh, Uh.MD = Th, Uh.XL = Eh;
      ...
      Kh.displayName = "PartialCircle", Kh.categories = ["shapes"], Kh.tags = ["Partial", "Half", "Middle", "Split"], Kh.SM = _h, Kh.LG = Wh, Kh.MD = Zh, Kh.XL = Yh;
      ...
      ln.displayName = "Circle", ln.categories = ["shapes"], ln.tags = ["Off", "Zero", "Record", "Shape", "Round", "Outline"], ln.SM = Qh, ln.MD = Jh, ln.LG = $h, ln.XL = en;
      ...
      Sn.displayName = "CircleCheck", Sn.categories = ["notifications"], Sn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], Sn.SM = An, Sn.LG = Vn, Sn.MD = Bn, Sn.XL = In;
      ...
      Xn.displayName = "TriangleAlert", Xn.categories = ["notifications", "shapes", "development"], Xn.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], Xn.SM = yn, Xn.LG = Dn, Xn.MD = Gn, Xn.XL = Nn;
      ...
      Wn.displayName = "CircleCheckFilled", Wn.categories = ["notifications"], Wn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success", "filled"], Wn.SM = Tn, Wn.MD = En, Wn.LG = Un, Wn.XL = _n;
      ...
      Jn.displayName = "Globe", Jn.categories = ["navigation"], Jn.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], Jn.SM = Zn, Jn.LG = Yn, Jn.MD = Kn, Jn.XL = Qn;
      ...
      yc.displayName = "CircleMinusFilled", yc.categories = ["math"], yc.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete", "filled"], yc.SM = Vc, yc.MD = Bc, yc.LG = Ic, yc.XL = Sc;
      ...
      qc.displayName = "EnvelopeOpen", qc.categories = ["mail"], qc.tags = ["email", "message", "letter", "read"], qc.SM = Dc, qc.LG = Gc, qc.MD = Nc, qc.XL = Xc;
      ...
      Zc.displayName = "Trash", Zc.categories = ["files", "mail"], Zc.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], Zc.SM = Ec, Zc.LG = Uc, Zc.MD = _c, Zc.XL = Wc;
      ...
      $c.displayName = "EllipsisVertical", $c.categories = ["layout"], $c.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], $c.SM = Yc, $c.LG = Kc, $c.MD = Qc, $c.XL = Jc;
      ...
      Bf.displayName = "Save", Bf.categories = ["files"], Bf.tags = ["floppy disk", "download", "backup", "storage", "disk", "document", "computer", "archive"], Bf.SM = Cf, Bf.MD = Hf, Bf.LG = Af, Bf.XL = Vf;
      ...
      Gf.displayName = "CircleDollarSign", Gf.categories = ["finance"], Gf.tags = ["monetization", "marketing", "currency", "money", "payment"], Gf.SM = If, Gf.LG = Sf, Gf.MD = yf, Gf.XL = Df;
      ...
      kf.displayName = "DollarSign", kf.categories = ["finance"], kf.tags = ["currency", "money", "payment"], kf.SM = Nf, kf.LG = Xf, kf.MD = qf, kf.XL = Ff;
      ...
      Uf.displayName = "CreditCard", Uf.categories = ["finance"], Uf.tags = ["currency", "money", "payment", "bank", "card", "purchase"], Uf.SM = Pf, Uf.MD = Of, Uf.LG = Tf, Uf.XL = Ef;
      ...
      Kf.displayName = "Wallet", Kf.categories = ["finance"], Kf.tags = ["money", "payment", "bank", "purchase", "pocket", "cash", "card", "savings", "checkout"], Kf.SM = _f, Kf.MD = Wf, Kf.LG = Zf, Kf.XL = Yf;
      ...
      lw.displayName = "FastForward", lw.categories = ["multimedia", "arrows"], lw.tags = ["music", "audio", "video", "control", "player", "media"], lw.SM = Qf, lw.LG = Jf, lw.MD = $f, lw.XL = ew;
      ...
      Iw.displayName = "StarOff", Iw.categories = ["multimedia", "social"], Iw.tags = ["dislike", "unlike", "remove", "unrate"], Iw.SM = Hw, Iw.LG = Aw, Iw.MD = Vw, Iw.XL = Bw;
      ...
      Nw.displayName = "Stop", Nw.categories = ["multimedia"], Nw.tags = ["music", "audio", "video", "control", "player", "stop", "media"], Nw.SM = Sw, Nw.LG = yw, Nw.MD = Dw, Nw.XL = Gw;
      ...
      _w.displayName = "Book", _w.categories = ["text", "gaming"], _w.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], _w.SM = Ow, _w.LG = Tw, _w.MD = Ew, _w.XL = Uw;
      ...
      Qw.displayName = "CloudAlert", Qw.categories = ["development"], Qw.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], Qw.SM = Ww, Qw.LG = Zw, Qw.MD = Yw, Qw.XL = Kw;
      const Jw = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      av.displayName = "CodeXml", av.categories = ["text", "development"], av.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], av.SM = Jw, av.LG = $w, av.MD = ev, av.XL = lv;
