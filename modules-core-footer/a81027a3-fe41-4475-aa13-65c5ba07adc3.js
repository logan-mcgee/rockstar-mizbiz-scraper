try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "a81027a3-fe41-4475-aa13-65c5ba07adc3", e._sentryDebugIdIdentifier = "sentry-dbid-a81027a3-fe41-4475-aa13-65c5ba07adc3")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [6583], {
    94141(e, t, n) {
      ...
      function p(e, t) {
        ...
        switch (c = [0, 0], s = [0, 0], r) {
          ...
          case 9:
            s = d(s = h(s, [0, e.charCodeAt(n + 8)]), p), i = h(i, s = d(s = f(s, 33), l));
          case 8:
          ...
          case 1:
            c = d(c = h(c, [0, e.charCodeAt(n)]), l), o = h(o, c = d(c = f(c, 31), p))
        }
      ...
      function L() {
        var e = window,
          t = navigator;
        return w(["msWriteProfilerMark" in e, "MSStream" in e, "msLaunchUri" in t, "msSaveBlob" in t]) >= 3 && !_()
      }
      ...
      var W, G, D = ["monospace", "sans-serif", "serif"],
      ...
      function Z() {
        ...
        return function() {
            if (void 0 === G) {
              var e = function() {
                var t = j();
                Y(t) ? G = setTimeout(e, 2500) : (W = t, G = void 0)
              };
              e()
            }
          }(),
          function() {
            return (0, r.sH)(e, void 0, void 0, function() {
              ...
              return (0, r.YH)(this, function(t) {
                switch (t.label) {
                  case 0:
                    return Y(e = j()) ? W ? [2, (0, r.fX)([], W, !0)] : k() ? [4, (n = document, (n.exitFullscreen || n.msExitFullscreen || n.mozCancelFullScreen || n.webkitExitFullscreen).call(n))] : [3, 2] : [3, 2];
                  case 1:
      ...
      function B(e) {
        ...
        return (0, r.sH)(this, void 0, void 0, function() {
          ...
          return (0, r.YH)(this, function(r) {
            switch (r.label) {
              case 0:
                for (n = document, a = n.createElement("div"), i = new Array(e.length), c = {}, U(a), u = 0; u < e.length; ++u) "DIALOG" === (s = O(e[u])).tagName && s.show(), U(l = n.createElement("div")), l.appendChild(s), a.appendChild(l), i[u] = s;
                r.label = 1;
              case 1:
        ...
        ne = {
          fonts: function() {
            return V(function(e, t) {
              ...
              r.appendChild(a);
              for (var u = 0; u < D.length; u++) o[D[u]] = s[u].offsetWidth, i[D[u]] = s[u].offsetHeight;
              return X.filter(function(e) {
                return t = l[e], D.some(function(e, n) {
              ...
              return (0, r.YH)(this, function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    }, n = Object.keys(e), [4, B((i = []).concat.apply(i, n.map(function(t) {
                      return e[t]
                    })))]) : [2, void 0];
                  case 1:
          ...
          fontPreferences: function() {
            return void 0 === e && (e = 4e3), V(function(t, n) {
              ...
              return c.textContent = (0, r.fX)([], Array(e / 20 | 0), !0).map(function() {
                  return "word"
                ...
                function(e, t) {
                  ...
                  for (var v = 0, b = Object.keys(te); v < b.length; v++) r[i = b[v]] = n[i].getBoundingClientRect().width;
                  return r
                }(a, o)
          ...
          canvas: function() {
            ...
            if (function(e, t) {
              ...
              var i = N(a);
              i !== N(a) ? e = t = "unstable" : (t = i, function(e, t) {
    ...
    77033(e, t, n) {
      ...
      function w() {
        let e = ["monospace", "sans-serif", "serif"],
          ...
          l = function(t) {
            ...
            for (let r = 0; r < e.length; r++)
              if (n = t[r].offsetWidth !== o[e[r]] || t[r].offsetHeight !== i[e[r]], n) return n;
            return n
          },
          u = function() {
            let t = [];
            for (let n = 0, a = e.length; n < a; n++) {
              let a = c();
              a.style.fontFamily = e[n], r.appendChild(a), t.push(a)
            }
            return t
          }();
        n.appendChild(r);
        for (let t = 0, n = e.length; t < n; t++) o[e[t]] = u[t].offsetWidth, i[e[t]] = u[t].offsetHeight;
        let d = function() {
          let n = {};
        ...
        n.appendChild(a);
        let f = [];
        for (let e = 0, n = t.length; e < n; e++) l(d[t[e]]) && f.push(t[e]);
        return n.removeChild(a), n.removeChild(r), f
      }
    ...
    37295(e, t, n) {
      ...
      function a(e, t) {
        return "function" == typeof e ? e(t) : e && "object" == typeof e && r in e ? e[r](t) : e instanceof Date ? new e.constructor(t) : new Date(t)
      }
      ...
      function o(e, t, n) {
        ...
        return (c = n?.roundingMethod, e => {
          const t = (c ? Math[c] : Math.trunc)(e);
          return 0 === t ? 0 : t
        })(i);
        var c
      }
