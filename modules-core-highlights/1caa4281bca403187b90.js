/*! For license information please see 1caa4281bca403187b90.js.LICENSE.txt */
"use strict";
(self.webpackChunk_rockstargames_modules_core_highlights = self.webpackChunk_rockstargames_modules_core_highlights || []).push([
  [738], {
    5217: (e, t, s) => {
      ...
      var l = function(e) {
        var t = (0, a.Z)(),
          s = e.value,
          n = e.children,
          i = (0, r._T)(e, ["value", "children"]);
        return n(t.formatNumberToParts(s, i))
      };
      ...
      function c(e) {
        var t = function(t) {
          ...
          return i("formatDate" === e ? s.formatDateToParts(l, o) : s.formatTimeToParts(l, o))
        };
      ...
      function d(e) {
        var t = function(t) {
          ...
          var d = s.textComponent || o.Fragment;
      ...
      l.displayName = "FormattedNumberParts", l.displayName = "FormattedNumberParts", d("formatDate"), d("formatTime"), d("formatNumber"), d("formatList"), d("formatDisplayName"), c("formatDate"), c("formatTime")
    },
    4029: (e, t, s) => {
      s.d(t, {
        Z: () => l
    ...
    4547: (e, t, s) => {
      ...
      function G(e, t, s) {
        for (const n in t) D(t[n]) || O(n, s) || (e[n] = t[n])
      }
      ...
      function W(e, t, s) {
        const i = {},
          r = function(e, t, s) {
            const i = {};
            return G(i, e.style || {}, e), Object.assign(i, function({
              transformTemplate: e
            }, t, s) {
              return (0, n.useMemo)((() => {
                const n = N();
      ...
      let Y = e => !U(e);
      try {
        (q = require("@emotion/is-prop-valid").default) && (Y = e => e.startsWith("on") ? !U(e) : q(e))
      } catch (e) {}
      var q;

      function X(e, t, s) {
        return "string" == typeof e ? e : F.px.transform(t + s * e)
      }
      const Z = {
      ...
      function ae(e, t) {
        ...
        for (const i in s)(D(s[i]) || t.style && D(t.style[i]) || O(i, e)) && (n[i] = s[i]);
        return n
      }

      function le(e, t) {
        const s = ae(e, t);
        for (const n in e)(D(e[n]) || D(t[n])) && (s[-1 !== L.indexOf(n) ? "attr" + n.charAt(0).toUpperCase() + n.substring(1) : n] = e[n]);
        return s
      }
      ...
      function De(e, t) {
        ...
        return Te(e.current, s, ((s, i) => {
          if ("touch" === s.type || Le()) return;
          const r = e.getProps();
          e.animationState && r.whileHover && e.animationState.setActive("whileHover", t), r[n] && Oe.Wi.update((() => r[n](s, i)))
        }), {
              ...
              startObserver() {
                ...
                return function(e, t, s) {
                  const n = function({
                    ...
                    const n = je.get(s),
                      i = JSON.stringify(t);
                    return n[i] || (n[i] = new IntersectionObserver(ze, {
                      root: e,
                      ...t
                    })), n[i]
                  }(t);
          ...
          tap: {
            Feature: class extends ke {
              ...
              startPress(e, t) {
                ...
                n && this.node.animationState && this.node.animationState.setActive("whileTap", !0), s && Oe.Wi.update((() => s(e, t)))
              }
              checkPressEnd() {
                return this.removeEndListeners(), this.isPressing = !1, this.node.getProps().whileTap && this.node.animationState && this.node.animationState.setActive("whileTap", !1), !Le()
              }
              cancelPress(e, t) {
                if (!this.checkPressEnd()) return;
                const {
      ...
      const We = "data-" + ne("framerAppearId");
      var He = s(7e3);
      const Ue = e => 1e3 * e,
        Ye = e => e / 1e3,
        qe = e => Array.isArray(e) && "number" == typeof e[0];

      function Xe(e) {
        return Boolean(!e || "string" == typeof e && Ke[e] || qe(e) || Array.isArray(e) && e.every(Xe))
      }
      ...
      function Je(e) {
        if (e) return qe(e) ? Ze(e) : Array.isArray(e) ? e.map(Je) : Ke[e]
      }
          ...
          },
          {
            ...
            if (!Ot(e, kt) && Ot(e, Lt)) {
              const s = function({
                ...
                let o = 1 - t;
                o = (0, wt.u)(Pt, Ct, o), e = (0, wt.u)(Tt, Et, Ye(e)), o < 1 ? (i = t => {
                  const n = t * o,
                    i = n * e,
                    r = n - s,
                    a = At(t, o),
      ...
      function Vt({
        ...
        const S = e => {
          var t;
          t = p.value, (void 0 !== a && t < a || void 0 !== l && t > l) && (b = e, w = Dt({
      ...
      const It = e => {
          ...
          return {
            start: () => Oe.Wi.update(t, !0),
            stop: () => (0, Oe.Pn)(t),
            now: () => Oe.frameData.isProcessing ? Oe.frameData.timestamp : performance.now()
          }
        },
        Rt = 2e4;
      ...
      function Ft({
        ...
        const B = {
          ...
          set time(e) {
            e = Ue(e), k = e, null === E && y && 0 !== f ? P = y.now() - e / f : E = e
          },
          get duration() {
      ...
      var Yt = s(2943);
      const qt = new Set(["brightness", "contrast", "saturate", "opacity"]);
      ...
      const rs = (e, t, s, n = {}) => i => {
        ...
        if (t.owner && t.owner.current instanceof HTMLElement && !t.owner.getProps().onUpdate) {
          const s = function(e, t, {
            ...
            if (!zt() || !$t.has(t) || i.repeatDelay || "mirror" === i.repeatType || 0 === i.damping || "inertia" === i.type) return !1;
            let r, o, a = !1;
            const l = () => {
              o = new Promise((e => {
                r = e
            ...
            if (((e, t) => "spring" === t.type || "backgroundColor" === e || !Xe(t.ease))(t, i)) {
              const e = Ft({
                ...i,
                repeat: 0,
                delay: 0
      ...
      const ls = e => t => t.test(e),
        cs = [j.Rx, F.px, F.aQ, F.RW, F.vw, F.vh, {
          test: e => "auto" === e,
          parse: e => e
        }],
        ds = e => cs.find(ls(e)),
      ...
      function fs(e, t, {
        ...
        for (const t in a) {
          ...
          if (window.HandoffAppearAnimations && !n.hasAnimated) {
            const s = e.getProps()[We];
            s && (o.elapsed = window.HandoffAppearAnimations(s, t, n, Oe.Wi))
          }
        ...
        const r = n ? () => Promise.all(fs(e, n, s)) : () => Promise.resolve(),
          o = e.variantChildren && e.variantChildren.size ? (n = 0) => {
            ...
            return function(e, t, s = 0, n = 0, i = 1, r) {
              ...
              return Array.from(e.variantChildren).sort(vs).forEach(((e, n) => {
                e.notify("AnimationStart", t), o.push(gs(e, t, {
                  ...r,
                  delay: s + l(n)
        ...
        let t = function(e) {
          return t => Promise.all(t.map((({
            ...
            if (e.notify("AnimationStart", t), Array.isArray(t)) {
              const i = t.map((t => gs(e, t, s)));
              n = Promise.all(i)
            } else if ("string" == typeof t) n = gs(e, t, s);
            else {
              const i = "function" == typeof t ? Ge(e, t, s.custom) : t;
      ...
      const Ts = {
          animation: {
            Feature: class extends ke {
              constructor(e) {
                super(e), e.animationState || (e.animationState = bs(e))
              }
      ...
      class Ps {
        constructor(e, t, {
          ...
          if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.updatePoint = () => {
              ...
              this.lastMoveEvent = e, this.lastMoveEventInfo = Cs(t, this.transformPagePoint), Oe.Wi.update(this.updatePoint, !0)
          ...
          const n = Cs(we(e), this.transformPagePoint),
            {
              point: i
            } = n,
            {
        ...
        updateHandlers(e) {
          ...
          this.removeListeners && this.removeListeners(), (0, Oe.Pn)(this.updatePoint)
        }
      }
      ...
      function Rs(e, t = 0, s = .01) {
        return Math.abs(e - t) <= s
      }

      function Bs(e, t, s, n = .5) {
        e.origin = n, e.originPoint = (0, Vs.C)(t.min, t.max, e.origin), e.scale = Is(s) / Is(t), (Rs(e.scale, 1, 1e-4) || isNaN(e.scale)) && (e.scale = 1), e.translate = (0, Vs.C)(s.min, s.max, e.origin) - e.originPoint, (Rs(e.translate) || isNaN(e.translate)) && (e.translate = 0)
      }
      ...
      function Fs(e, t, s) {
        e.min = s.min + t.min, e.max = e.min + Is(t)
      }

      function zs(e, t, s) {
        e.min = t.min - s.min, e.max = e.min + Is(t)
      }

      function $s(e, t, s) {
        zs(e.x, t.x, s.x), zs(e.y, t.y, s.y)
      }
      ...
      class mn {
        ...
        start(e, {
          ...
          s && !1 === s.isPresent || (this.panSession = new Ps(e, {
            onSessionStart: e => {
              this.stopAnimation(), t && this.snapToCursor(we(e, "page").point)
            },
            onStart: (e, t) => {
              const {
                drag: s,
              ...
              this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), qs((e => {
                ...
                if (F.aQ.test(t)) {
                  ...
                  if (s && s.layout) {
                    ...
                    n && (t = Is(n) * (parseFloat(t) / 100))
                  }
                }
                this.originPoint[e] = t
              })), i && Oe.Wi.update((() => i(e, t)), !1, !0);
              const {
                animationState: r
              } = this.visualElement;
        ...
        updateAxis(e, t, s) {
          ...
          this.constraints && this.constraints[e] && (r = function(e, {
            ...
            return void 0 !== t && e < t ? e = n ? (0, Vs.C)(t, e, n.min) : Math.max(e, t) : void 0 !== s && e > s && (e = n ? (0, Vs.C)(s, e, n.max) : Math.min(e, s)), e
        ...
        resolveConstraints() {
          ...
          }(t), n !== this.constraints && s && this.constraints && !this.hasMutatedConstraints && qs((e => {
        ...
        resolveRefConstraints() {
          ...
          if (t) {
            ...
            this.hasMutatedConstraints = !!e, e && (r = Xs(e))
          }
          return r
        }
        startAnimation(e) {
          ...
          } = this.getProps(), a = this.constraints || {}, l = qs((o => {
        ...
        scalePositionWithinConstraints() {
          ...
          this.visualElement.current.style.transform = i ? i({}, "") : "none", s.root && s.root.updateScroll(), s.updateLayout(), this.resolveConstraints(), qs((t => {
      ...
      class wn extends n.Component {
        ...
        getSnapshotBeforeUpdate(e) {
          ...
          return r ? (r.isPresent = i, n || e.layoutDependency !== t || void 0 === t ? r.willUpdate() : this.safeToRemove(), e.isPresent !== i && (i ? r.promote() : r.relegate() || Oe.Wi.postRender((() => {
            const e = r.getStack();
      ...
      const Pn = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
        ...
        An = e => "number" == typeof e || F.px.test(e);
      ...
      function Bn(e, t, [s, n, i], r, o) {
        ! function(e, t = 0, s = 1, n = .5, i, r = e, o = e) {
          if (F.aQ.test(t) && (t = parseFloat(t), t = (0, Vs.C)(o.min, o.max, t / 100) - o.min), "number" != typeof t) return;
          let a = (0, Vs.C)(r.min, r.max, n);
          e === r && (a -= t), e.min = Rn(e.min, t, s, a, i), e.max = Rn(e.max, t, s, a, i)
      ...
      function zn(e, t, s, n) {
        Bn(e.x, t, jn, s ? s.x : void 0, n ? n.x : void 0), Bn(e.y, t, Fn, s ? s.y : void 0, n ? n.y : void 0)
      }
      ...
      class Hn {
        ...
        add(e) {
          (0, Wn.y4)(this.members, e), e.scheduleRender()
        }
        remove(e) {
          if ((0, Wn.cl)(this.members, e), e === this.prevLead && (this.prevLead = void 0), e === this.lead) {
      ...
      class qn {
        ...
        add(e) {
          (0, Wn.y4)(this.children, e), this.isDirty = !0
        }
        remove(e) {
          (0, Wn.cl)(this.children, e), this.isDirty = !0
        }
        forEach(e) {
      ...
      function Jn({
        ...
        return class {
          ...
          mount(t, s = this.root.hasTreeAnimated) {
                ...
                this.root.updateBlockedByResize = !0, s && s(), s = function(e, t) {
                  const s = performance.now(),
                    n = ({
                      ...
                      const i = t - s;
                      i >= 250 && ((0, Oe.Pn)(n), e(i - 250))
                    };
                  return Oe.Wi.read(n, !0), () => (0, Oe.Pn)(n)
                }(n), vn.hasAnimatedSinceResize && (vn.hasAnimatedSinceResize = !1, this.nodes.forEach(ai))
              }))
            }
            i && this.root.registerSharedNode(i, this), !1 !== this.options.animate && o && (i || r) && this.addEventListener("didUpdate", (({
              ...
              const i = this.options.transition || o.getDefaultTransition() || fi,
                ...
                l = !this.targetLayout || !Nn(this.targetLayout, n) || s,
                c = !t && s;
          ...
          unmount() {
            ...
            e && e.remove(this), this.parent && this.parent.children.delete(this), this.instance = void 0, (0, Oe.Pn)(this.updateProjection)
          }
          blockUpdate() {
          ...
          update() {
            ...
            Oe.frameData.delta = (0, wt.u)(0, 1e3 / 60, e - Oe.frameData.timestamp), Oe.frameData.timestamp = e, Oe.frameData.isProcessing = !0, Oe.S6.update.process(Oe.frameData), Oe.S6.preRender.process(Oe.frameData), Oe.S6.render.process(Oe.frameData), Oe.frameData.isProcessing = !1
          }
          didUpdate() {
          ...
          scheduleUpdateProjection() {
            Oe.Wi.preRender(this.updateProjection, !1, !0)
          }
          ...
          resetTransform() {
            ...
            const e = this.isLayoutDirty || this.shouldResetTransform,
              t = this.projectionDelta && !_n(this.projectionDelta),
          ...
          removeTransform(e) {
            ...
            for (let e = 0; e < this.path.length; e++) {
              ...
              const n = Ys();
              In(n, s.measurePageBox()), zn(t, s.latestValues, s.snapshot ? s.snapshot.layoutBox : void 0, n)
            }
            return Js(this.latestValues) && zn(t, this.latestValues), t
          }
          setTargetDelta(e) {
          ...
          forceRelativeParentToResolveTarget() {
            this.relativeParent && this.relativeParent.resolvedRelativeTargetAt !== Oe.frameData.timestamp && this.relativeParent.resolveTargetDelta(!0)
          }
          resolveTargetDelta(e = !1) {
            ...
            if (this.layout && (i || r)) {
              if (this.resolvedRelativeTargetAt = Oe.frameData.timestamp, !this.targetDelta && !this.relativeTarget) {
                const e = this.getClosestProjectingParent();
                e && e.layout && 1 !== this.animationProgress ? (this.relativeParent = e, this.forceRelativeParentToResolveTarget(), this.relativeTarget = Ys(), this.relativeTargetOrigin = Ys(), $s(this.relativeTargetOrigin, this.layout.layoutBox, e.layout.layoutBox), In(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
              }
              if (this.relativeTarget || this.targetDelta) {
                var o, a, l;
                if (this.target || (this.target = Ys(), this.targetWithTransforms = Ys()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), o = this.target, a = this.relativeTarget, l = this.relativeParent.target, Fs(o.x, a.x, l.x), Fs(o.y, a.y, l.y)) : this.targetDelta ? (Boolean(this.resumingFrom) ? this.target = this.applyTransform(this.layout.layoutBox) : In(this.target, this.layout.layoutBox), rn(this.target, this.targetDelta)) : In(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget) {
                  this.attemptToResolveRelativeTarget = !1;
                  const e = this.getClosestProjectingParent();
                  e && Boolean(e.resumingFrom) === Boolean(this.resumingFrom) && !e.options.layoutScroll && e.target && 1 !== this.animationProgress ? (this.relativeParent = e, this.forceRelativeParentToResolveTarget(), this.relativeTarget = Ys(), this.relativeTargetOrigin = Ys(), $s(this.relativeTargetOrigin, this.target, e.target), In(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                }
          ...
          calcProjection() {
            ...
            let n = !0;
            if ((this.isProjectionDirty || (null === (e = this.parent) || void 0 === e ? void 0 : e.isProjectionDirty)) && (n = !1), s && (this.isSharedProjectionDirty || this.isTransformDirty) && (n = !1), this.resolvedRelativeTargetAt === Oe.frameData.timestamp && (n = !1), n) return;
            const {
              layout: i,
              layoutId: r
            } = this.options;
          ...
          setAnimationOrigin(e, t = !1) {
            ...
            this.animationProgress = 0, this.mixTargetDelta = t => {
              const s = t / 1e3;
              var l, p, h, m, f, g;
              pi(r.x, e.x, s), pi(r.y, e.y, s), this.setTargetDelta(r), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && ($s(o, this.layout.layoutBox, this.relativeParent.layout.layoutBox), h = this.relativeTarget, m = this.relativeTargetOrigin, f = o, g = s, hi(h.x, m.x, f.x, g), hi(h.y, m.y, f.y, g), u && (l = this.relativeTarget, p = u, l.x.min === p.x.min && l.x.max === p.x.max && l.y.min === p.y.min && l.y.max === p.y.max) && (this.isProjectionDirty = !1), u || (u = Ys()), In(u, this.relativeTarget)), a && (this.animationValues = i, function(e, t, s, n, i, r) {
                i ? (e.opacity = (0, Vs.C)(0, void 0 !== s.opacity ? s.opacity : 1, kn(n)), e.opacityExit = (0, Vs.C)(void 0 !== t.opacity ? t.opacity : 1, 0, On(n))) : r && (e.opacity = (0, Vs.C)(void 0 !== t.opacity ? t.opacity : 1, void 0 !== s.opacity ? s.opacity : 1, n));
                for (let i = 0; i < Cn; i++) {
                  const r = `border${Pn[i]}Radius`;
                  let o = Ln(t, r),
                    a = Ln(s, r);
                  void 0 === o && void 0 === a || (o || (o = 0), a || (a = 0), 0 === o || 0 === a || An(o) === An(a) ? (e[r] = Math.max((0, Vs.C)(Mn(o), Mn(a), n), 0), (F.aQ.test(a) || F.aQ.test(o)) && (e[r] += "%")) : e[r] = a)
                }(t.rotate || s.rotate) && (e.rotate = (0, Vs.C)(t.rotate || 0, s.rotate || 0, n))
              }(i, n, this.latestValues, s, d, c)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = s
            }, this.mixTargetDelta(this.options.layoutRoot ? 1e3 : 0)
          }
          startAnimation(e) {
            this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && ((0, Oe.Pn)(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = Oe.Wi.update((() => {
              vn.hasAnimatedSinceResize = !0, this.currentAnimation = function(e, t, s) {
          ...
          applyTransformsToTarget() {
            ...
            if (t && s && n) {
              if (this !== e && this.layout && n && xi(this.options.animationType, this.layout.layoutBox, n.layoutBox)) {
                ...
                const n = Is(this.layout.layoutBox.y);
                s.y.min = e.target.y.min, s.y.max = s.y.min + n
              }
              In(t, s), un(t, i), js(this.projectionDeltaWithTransform, this.layoutCorrected, t, i)
            }
          }
        ...
        if (e.isLead() && e.layout && s && e.hasListeners("didUpdate")) {
          ...
          if (!e.resumeFrom) {
            ...
            if (n && !n.resumeFrom) {
              ...
              if (i && r) {
                const o = Ys();
                $s(o, s.layoutBox, i.layoutBox);
                const a = Ys();
                $s(a, t, r.layoutBox), Nn(o, a) || (c = !0), n.options.layoutRoot && (e.relativeTarget = a, e.relativeTargetOrigin = o, e.relativeParent = n)
              }
            }
          }
      ...
      function pi(e, t, s) {
        e.translate = (0, Vs.C)(t.translate, 0, s), e.scale = (0, Vs.C)(t.scale, 1, s), e.origin = t.origin, e.originPoint = t.originPoint
      }

      function hi(e, t, s, n) {
        e.min = (0, Vs.C)(t.min, s.min, n), e.max = (0, Vs.C)(t.max, s.max, n)
      }
      ...
      const fi = {
        ...
        gi = e => "undefined" != typeof navigator && navigator.userAgent.toLowerCase().includes(e),
        vi = gi("applewebkit/") && !gi("chrome/") ? Math.round : Ie.Z;
      ...
      function xi(e, t, s) {
        return "position" === e || "preserve-aspect" === e && !Rs(Gn(t), Gn(s), .2)
      }
      const bi = Jn({
        ...
        Ti = {
            ...
            Feature: class extends ke {
              ...
              createPanHandlers() {
                ...
                return {
                  ...
                  onMove: s,
                  onEnd: (e, t) => {
                    delete this.session, n && Oe.Wi.update((() => n(e, t)))
                  }
                }
              }
              mount() {
          ...
          drag: {
            Feature: class extends ke {
              constructor(e) {
                super(e), this.removeGroupControls = Ie.Z, this.removeListeners = Ie.Z, this.controls = new mn(e)
              }
              mount() {
                const {
                  dragControls: e
      ...
      class Ni {
        constructor({
          ...
          }, this.scheduleRender = () => Oe.Wi.render(this.render, !1, !0);
          const {
            latestValues: o,
            renderState: a
          } = i;
        ...
        unmount() {
          ji.delete(this.current), this.projection && this.projection.unmount(), (0, Oe.Pn)(this.notifyUpdate), (0, Oe.Pn)(this.render), this.valueSubscriptions.forEach((e => e())), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this);
        ...
        bindToMotionValue(e, t) {
          const s = k.has(e),
            n = t.on("change", (t => {
              this.latestValues[e] = t, this.props.onUpdate && Oe.Wi.update(this.notifyUpdate, !1, !0), s && this.projection && (this.projection.isTransformDirty = !0)
            })),
        ...
        makeTargetAnimatableFromInstance({
          ...
          if (n && (t && (t = n(t)), s && (s = n(s)), r && (r = n(r))), i) {
            ...
            const e = ((e, t, s, n) => {
              ...
              return Ii(e, t = i.target, s, n = i.transitionEnd)
            })(this, s, r, t);
    ...
    4104: (e, t, s) => {
      ...
      var n = s(289);
      const i = s(8214).j ? n.useLayoutEffect : n.useEffect
    },
    4045: (e, t, s) => {
      function n(e, t) {
        return t ? e * (1e3 / t) : 0
      ...
      function I(e, {
        ...
        if (n.add(r), !k.has(t)) {
          ...
          window.addEventListener("resize", r, {
            passive: !0
          }), t !== document.documentElement && O.set(t, (l = r, "function" == typeof(a = t) ? (o = a, p.add(o), h || (h = () => {
            const e = {
        ...
        return L.Wi.read(c, !1, !0), () => {
          ...
          const n = k.get(t);
          k.delete(t), n && (V(t).removeEventListener("scroll", n), null === (e = O.get(t)) || void 0 === e || e(), window.removeEventListener("resize", n))
        }
      }
      var R = s(4104);
    ...
    9770: (e, t, s) => {
      ...
      function o(e) {
        ...
        n("init", (() => {
          ...
          e = o(e), s = o(s), [...e, ...s].filter((e => !!e)).forEach((e => e.classList[t.enabled ? "remove" : "add"](t.params.navigation.lockClass)))
        })), n("click", ((e, s) => {
          let {
            nextEl: n,
            prevEl: r
      ...
      function l(e) {
        ...
        function m(e) {
          ...
          if (t.params.loop) {
            ...
            const e = t.getSlideIndexByData(n),
        ...
        function y() {
          ...
          s && (s = u(s), s.forEach((s => {
            s.classList.remove(e.hiddenClass), s.classList.remove(e.modifierClass + e.type), s.classList.remove(t.isHorizontal() ? e.horizontalClass : e.verticalClass), e.clickable && s.removeEventListener("click", m)
    ...
    4304: (e, t, s) => {
      ...
      var m = {
        ...
        updateActiveIndex: function(e) {
          ...
          u = t.virtual && i.virtual.enabled && i.loop ? d(c) : t.slides[c] ? parseInt(t.slides[c].getAttribute("data-swiper-slide-index") || c, 10) : c, Object.assign(t, {
            ...
            previousIndex: r,
            activeIndex: c
          }), t.initialized && h(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), o !== u && t.emit("realIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && t.emit("slideChange")
        },
      ...
      function y(e) {
        ...
        let w;
        n.isMoved && x !== s.touchesDirection && b && Math.abs(v) >= 1 && (s.loopFix({
          direction: s.swipeDirection,
          setTranslate: !0
        }), w = !0), s.emit("sliderMove", d), n.isMoved = !0, n.currentTranslate = v + n.startTranslate;
        let S = !0,
          T = o.resistanceRatio;
        if (o.touchReleaseOnEdges && (T = 0), v > 0 ? (b && !w && n.currentTranslate > (o.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
          }), n.currentTranslate > s.minTranslate() && (S = !1, o.resistance && (n.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + n.startTranslate + v) ** T))) : v < 0 && (b && !w && n.currentTranslate < (o.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({
            direction: "next",
            setTranslate: !0,
            activeSlideIndex: s.slides.length - ("auto" === o.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(o.slidesPerView, 10)))
          }), n.currentTranslate < s.maxTranslate() && (S = !1, o.resistance && (n.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - n.startTranslate - v) ** T))), S && (d.preventedByNestedSwiper = !0), !s.allowSlideNext && "next" === s.swipeDirection && n.currentTranslate < n.startTranslate && (n.currentTranslate = n.startTranslate), !s.allowSlidePrev && "prev" === s.swipeDirection && n.currentTranslate > n.startTranslate && (n.currentTranslate = n.startTranslate), s.allowSlidePrev || s.allowSlideNext || (n.currentTranslate = n.startTranslate), o.threshold > 0) {
      ...
      function x(e) {
        ...
        if (t.allowClick) {
          ...
          t.updateClickedSlide(e && e[0] || d.target), t.emit("tap click", d), p < 300 && u - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)
        }
      ...
      const k = {
          ...
          breakpoints: {
            setBreakpoint: function() {
              ...
              }), u && !m ? e.disable() : !u && m && e.enable(), e.currentBreakpoint = a, e.emit("_beforeBreakpoint", l), h && s && (e.loopDestroy(), e.loopCreate(t), e.updateSlides()), e.emit("breakpoint", l)
            },
      ...
      class D {
        constructor() {
          ...
          const m = (0, r.q)({}, A, h);
          return u.params = (0, r.q)({}, m, O, t), u.originalParams = (0, r.q)({}, u.params), u.passedParams = (0, r.q)({}, t), u.params && u.params.on && Object.keys(u.params.on).forEach((e => {
      ...
      function G(e) {
        ...
        return n.Children.toArray(e).forEach((e => {
          N(e) ? t.push(e) : e.props && e.props.children && G(e.props.children).forEach((e => t.push(e)))
        })), t
      }
      ...
      const U = (0, n.createContext)(null),
        ...
        q = (0, n.forwardRef)((function(e, t) {
          ...
          const G = () => {
            ...
            if (delete e.wrapperClass, y.current = new D(e), y.current.virtual && y.current.params.virtual.enabled) {
          ...
          return v.current || G(), y.current && y.current.on("_beforeBreakpoint", N), (0, n.useEffect)((() => () => {
            y.current && y.current.off("_beforeBreakpoint", N)
          })), (0, n.useEffect)((() => {
            !g.current && y.current && (y.current.emitSlidesClasses(), g.current = !0)
          })), H((() => {
            if (t && (t.current = v.current), v.current) return y.current.destroyed && G(),
              function(e, t) {
                let {
                  el: s,
                  nextEl: n,
                ...
                B(t) && n && i && (a.params.navigation.nextEl = n, a.originalParams.navigation.nextEl = n, a.params.navigation.prevEl = i, a.originalParams.navigation.prevEl = i), j(t) && r && (a.params.pagination.el = r, a.originalParams.pagination.el = r), F(t) && o && (a.params.scrollbar.el = o, a.originalParams.scrollbar.el = o), a.init(s)
              }({
                el: v.current,
                nextEl: w.current,
                prevEl: S.current,
            ...
            swiper: y.current,
            swiperSlideIndex: t
          }))), O["wrapper-end"]), B(P) && n.createElement(n.Fragment, null, n.createElement("div", {
            ref: S,
      ...
      const X = (0, n.forwardRef)((function(e, t) {
        let {
          tag: s = "div",
          children: i,
          className: r = "",
        ...
        }, u), a && n.createElement(U.Provider, {
          value: y
        }, n.createElement("div", {
...
//# sourceMappingURL=1caa4281bca403187b90.js.map