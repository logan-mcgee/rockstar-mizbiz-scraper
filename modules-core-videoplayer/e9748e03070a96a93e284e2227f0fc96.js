/*! For license information please see e9748e03070a96a93e284e2227f0fc96.js.LICENSE.txt */ ! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "287b57f4-c971-4825-8a59-55e95412438c", e._sentryDebugIdIdentifier = "sentry-dbid-287b57f4-c971-4825-8a59-55e95412438c")
  } catch (e) {}
}();
    ...
    1996: (e, a, t) => {
      ...
      function o(e, a, t) {
        var n, i = {},
          o = null,
          c = null;
        for (n in void 0 !== t && (o = "" + t), void 0 !== a.key && (o = "" + a.key), void 0 !== a.ref && (c = a.ref), a) l.call(a, n) && !d.hasOwnProperty(n) && (i[n] = a[n]);
        if (e && e.defaultProps)
    ...
    216: (e, a, t) => {
      ...
      const x = {
        ...
        T = () => {
          const {
            ...
            playerEnded: r,
            playing: i
          } = e, l = i ? C.playPausePlaying : C.playPausePaused, s = () => {
      ...
      const M = () => {
          ...
          if ((0, n.useEffect)((() => {
            ...
            }), [l, m, f.duration, d]), (0, n.useEffect)((() => {
              const e = v.current;
              if (null === e) return;
              ...
              for (let e = 0; e < r.length; e += 1) {
                const i = r.start(e),
                  ...
                  s = i * n,
                  d = l * n;
                i <= f.current && f.current <= l && a.fillRect(s, 0, d - s, t.height)
              }
        ...
        K = () => {
          ...
          return (0, n.useEffect)((() => {
            ...
            return e.addEventListener("loadeddata", n), e.addEventListener("loadedmetadata", t), e.addEventListener("timeupdate", r), e.addEventListener("volumechange", i), e.addEventListener("progress", s), e.addEventListener("webkitendfullscreen", l), () => {
              e.removeEventListener("loadeddata", n), e.removeEventListener("loadedmetadata", t), e.removeEventListener("timeupdate", r), e.removeEventListener("volumechange", i), e.removeEventListener("progress", s), e.removeEventListener("webkitendfullscreen", l)
            }
            ...
            onClick: () => {
              (0, o.iY)() || (t(2, "Video clicked"), m || d || a("playing", !f))
            },
            onEnded: () => {
        ...
        Y = (0, s.withLocale)((() => {
          ...
          return (0, n.useEffect)((() => {
            ...
            s ? _() && !E() ? r() : n && !t && g.current.webkitEnterFullscreen() : _() && E() ? r() : n && t && g.current.webkitExitFullscreen()
          }), [s, S, g]), (0, n.useEffect)((() => {
            const e = () => {
        ...
        X = e => {
          ...
          const {
            ...
            loading: F,
            video: I
          } = T, M = (0, d.useGtmTrack)(), $ = (0, l.useAgegated)(), R = (0, r.useNavigate)();
          return (0, n.useEffect)((() => {
            S("onVideoComplete", g)
          }), [g]), (0, n.useEffect)((() => {
            if (!I) return;
            ...
            const e = t || E || !1;
            _(1, "Video started"), S("controlsActive", !0), S("currentTime", 0), S("fullscreen", !1), S("idle", !1), S("meta", null), S("playerEnded", !1), S("playing", e), S("progressBarState", {}), S("settingsMenuOpen", !1), S("shareOpen", !1), S("videoId", s), I && (M.track({
              event: "video_started",
              video_id: s,
              video_title: I.title,
              video_type: I.group_type,
              video_language: b
            }), e && _(1, `Autoplay video with id: [${s}]`, `autoplay[videoId: ${s}]`))
          }), [s]), (0, n.useEffect)((() => {
        ...
        q = (0, s.withGtmTracking)((0, i.withSimpleErrorBoundary)((e => (0, c.jsx)(o.Yv, {
          children: (0, c.jsx)(X, {
            ...e
          })
...
//# sourceMappingURL=e9748e03070a96a93e284e2227f0fc96.js.map