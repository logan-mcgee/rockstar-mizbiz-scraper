! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "45364f07-12d1-45d2-94df-92686a14d407", e._sentryDebugIdIdentifier = "sentry-dbid-45364f07-12d1-45d2-94df-92686a14d407")
  } catch (e) {}
}();
  ...
  [1552], {
    41552: (e, t, s) => {
      ...
      const _ = (d = e => {
        ...
        let h = "";
        if ("aria-label" in y && y["aria-label"] && (h = "_blank" === v ? `${y["aria-label"]} ${p.formatMessage(n.aria_label_open_new_window)}` : y["aria-label"]), (0, a.useEffect)((() => {
          ...
          return (0, c.jsxs)("a", {
            ...
            "aria-label": h,
            ref: f,
            children: [t, "_blank" === v && !h && (0, c.jsx)("span", {
              className: o,
        ...
        const w = Object.keys(y).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
          ...e,
          [t]: b[t]
        })), {});
      ...
      const G = R,
          ...
          return (0, a.useEffect)((() => {
            ...
            children: [(0, c.jsx)("h4", {
              ...
              onScroll: e => {
                ...
                0 === t ? v(!0) : t + a === s ? x(!0) : (v(!1), x(!1))
              },
              children: i.map(((e, t) => (0, c.jsx)(G, {
                ref: e.id === p ? m : null,
                title: e.title,
        ...
        P = (0, i.withIntl)((e => {
          ...
          return (0, a.useEffect)((() => {
            ...
            className: [E.videoWithPlaylistContainer, t ?? ""].filter((e => e)).join(" "),
            id: i ?? "",
            ...
            children: [(0, c.jsx)(b.A, {
              ...
              onVideoItemClick: e => {
                if (m) k({
                  ...
                  const t = G.findIndex((t => t.id === e)); - 1 !== t ? j(t) : console.warn("Video ID not found in results.")
                }
              },
              isModal: m
            })]
