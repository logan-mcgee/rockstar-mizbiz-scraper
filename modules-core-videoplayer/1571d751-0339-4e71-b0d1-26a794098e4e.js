try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "1571d751-0339-4e71-b0d1-26a794098e4e", e._sentryDebugIdIdentifier = "sentry-dbid-1571d751-0339-4e71-b0d1-26a794098e4e")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    1030: (e, t, s) => {
      ...
      const o = (0, n.defineMessages)({
        ...
        _ = (d = ({
          ...
          let v = "";
          if ("aria-label" in w && w["aria-label"] && (v = "_blank" === h ? `${w["aria-label"]} ${p.formatMessage(o.aria_label_open_new_window)}` : w["aria-label"]), (0, r.useEffect)(() => {
            ...
            return (0, a.jsxs)("a", {
              ...
              ref: f,
              role: d,
              children: [e, "_blank" === h && !v && (0, a.jsx)("span", {
                className: l,
                children: p.formatMessage(o.aria_label_open_new_window)
              })]
            })
          }
          if (g) return (0, a.jsxs)(i.NavLink, {
            title: c,
            to: t,
            onClick: u,
            ...w,
          ...
          const y = Object.keys(w).filter(e => !["activeClassName", "key", "end"].includes(e)).reduce((e, t) => ({
            ...e,
            [t]: b[t]
          }), {});
          return "function" == typeof y?.className && delete y.className, (0, a.jsxs)("a", {
            href: t,
            title: c,
            onClick: u,
            target: h,
      ...
      const g = {
        ...
        k = (0, n.withIntl)(({
          ...
          const {
            ...
            id: s
          }), [c] = (0, i.useSearchParams)(), d = Number(c.get("start") ?? 0);
          return !l || o ? (0, a.jsx)(m.A, {
            hero: !0,
            titleCrop: n,
      ...
      const N = {
        ...
        G = (0, r.forwardRef)(({
          ...
          return (0, a.jsxs)("button", {
            ref: o,
            className: [N.itemContainer, s ? N.active : ""].filter(e => e).join(" "),
            onClick: r,
            type: "button",
      ...
      const R = G,
        ...
        C = ({
          ...
          const l = (0, i.useLocation)(),
            ...
            x = (0, r.useCallback)((e, t) => () => {
              o && o(e, t), p(e), c({
                ...
                video_id: e,
                video_title: s[t].title,
                video_type: s[t].groupType,
                video_language: _,
          ...
          return (0, r.useEffect)(() => {
            ...
            children: [(0, a.jsx)("h4", {
              ...
              ref: d,
              className: [S.videos, g ? "" : S.userNotScrolledToTopOfList, h ? "" : S.userNotScrolledToBottomOfList].filter(e => e).join(" "),
              onScroll: ({
                target: {
                  scrollTop: e,
                  scrollHeight: t,
                ...
                0 === e ? k(!0) : e + s === t ? w(!0) : (k(!1), w(!1))
              },
              children: s.map((e, t) => (0, a.jsx)(R, {
                ref: e.id === f ? u : null,
                title: e.title,
        ...
        E = (0, n.withIntl)(({
          ...
          const {
            ...
            tagIds: n,
            locale: t
          }, [p, g] = (0, i.useSearchParams)(), k = Number(p.get("start") ?? 0), [h, z] = (0, r.useState)(0), {
            loading: j,
            data: N
            ...
            children: [(0, a.jsx)(b.A, {
              ...
              onVideoItemClick: e => {
                if (d) g({
                  ...
                  const t = G.findIndex(t => t.id === e); - 1 !== t ? z(t) : console.warn("Video ID not found in results.")
                }
              },
              isModal: d
            })]
