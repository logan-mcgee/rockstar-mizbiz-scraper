try {
  ...
  [8517], {
    ...
    2484: (e, a, l) => {
      ...
      const t = (0, l(1788).defineMessages)({
    ...
    8517: (e, a, l) => {
      ...
      var m = l(8308);
      const b = "rockstargames-modules-core-videoplayerd8d9ad003eb5b094a636f36119a162cf",
        y = () => {
          const {
            state: e,
            setState: a,
            ...
            playing: i,
            controlsActive: n
          } = e, [s, d] = (0, o.useState)(null), y = (0, o.useRef)(null), {
            formatMessage: f
          } = (0, c.useIntl)();
          return (0, o.useEffect)(() => {
            d((e => {
            ...
            const e = u.gsap.context(() => {
              y?.current && (i && u.gsap.to(y?.current, {
                autoAlpha: 0,
                delay: .8,
                duration: .2
              }), n || u.gsap.to(y?.current, {
                autoAlpha: 0
              }))
            });
            return () => e.revert()
          }, [y?.current, n]), (0, t.jsx)("button", {
            "aria-label": f(i ? _.videoplayer_pause_button_label : _.videoplayer_play_button_label),
        ...
        C = () => {
          ...
          let c, u;
          return "clr" === l ? (u = (0, t.jsx)(f, {
            className: [g.brand, g[l]].join(" ")
          }), c = "https://circolocorecords.com") : (u = (0, t.jsx)(h, {
            className: [g.brand, g[l]].join(" ")
          }), c = `https://${s?.subDomain??"www"}.rockstargames.com/`), n?.title ? (0, t.jsxs)("div", {
            role: "paragraph",
            className: g.title,
            children: [(0, t.jsx)("a", {
              href: o?.brandUrl,
        ...
        k = () => {
          ...
          return n ? (0, t.jsx)("div", {
            className: [g.info, a ? g.hidden : "", s ? g.isPreview : ""].join(" "),
            children: (0, t.jsx)(C, {})
          }) : null
        },
        w = () => {
        ...
        x = () => (0, t.jsxs)("div", {
          ...
          children: [(0, t.jsx)(k, {}), (0, t.jsx)(w, {}), (0, t.jsx)(y, {})]
        });
      var j = l(4805),
        N = l(4257),
        M = l(4572),
        L = l.n(M);
      const S = (0, c.defineMessages)({
          videoplayer_fullscreen_button_label: {
      ...
      const z = (0, c.defineMessages)({
        ...
        G = () => {
          const e = (0, o.useRef)(null),
            ...
            R = e => {
              ...
              let t = (e.clientX - l.left) / l.width * S.duration;
              t = Math.min(S.duration, Math.max(0, t)), v(t)
            };
          return (0, o.useEffect)(() => {
            const e = () => {
              v(null)
          ...
          }, [d, M?.percent, S?.current, S?.duration]), (0, o.useEffect)(() => {
            const e = L?.current,
              a = () => {
                ...
                const a = {
                  ...
                  l = e.duration,
                  t = e.currentTime,
                  o = Math.floor(t / l * 100),
                  d = Math.floor(l),
                  c = e => h("video_threshold", d, e);
                o > n && (!a[90] && o >= 90 ? (c(90), a[90] = !0) : !a[75] && o >= 75 && o < 90 ? (c(75), a[75] = !0) : !a[50] && o >= 50 && o < 75 ? (c(50), a[50] = !0) : !a[25] && o >= 25 && o < 50 && (c(25), a[25] = !0), i(a), s(o))
              };
            return e?.addEventListener("timeupdate", a), () => {
              e?.removeEventListener("timeupdate", a)
            }
          }, [L, r, n]), (0, o.useEffect)(() => {
            x || M.percent || !j || f("controlsActive", !w)
          }, [w, x, M.percent, j]), (0, o.useEffect)(() => {
            const e = M.percent ? M.percent * S.duration : k;
            f("currentTime", e)
          }, [M.percent, S.duration]), (0, o.useEffect)(() => {
            const a = e?.current;
            if (!a) return;
            ...
            const o = t.width / S.duration;
            for (let e = 0; e < C.length; e += 1) {
              const a = C.start(e),
                r = C.end(e),
                i = a * o,
                n = r * o;
              a <= S.current && S.current <= r && l.fillRect(i, 0, n - i, t.height)
            }
          }, [C, e, S.duration, S.current]), (0, o.useEffect)(() => {
            if (!a.current) return;
            const e = new(Z())(a.current),
              l = e => {
                u(!0), !x && N?.current?.contains(e.srcEvent.target) ? (E({
                  centerX: e.center.x
                }), R(e.srcEvent)) : E()
              },
              t = () => {
              ...
              o = e => {
                !x && N?.current?.contains(e.srcEvent.target) ? (E({
                  centerX: e.center.x
                }), R(e.srcEvent)) : E()
              };
          ...
          }, [N?.current, a?.current, x, S?.duration]), x ? null : (0, t.jsx)("div", {
            ref: a,
            role: "slider",
            ...
            children: (0, t.jsxs)("div", {
              ...
              children: [(0, t.jsx)("canvas", {
                ...
                style: {
                  "--left-position": _ / (L?.current?.duration ?? 1)
                },
                className: $.timestamp,
                children: ((e = 0) => {
        ...
        K = () => {
          const {
            state: e
          } = (0, p.Tc)(), [a, l] = (0, o.useState)(0), [r, i] = (0, o.useState)(0), {
            brand: n,
            videoRef: s
          } = e;
          return (0, o.useEffect)(() => {
        ...
        ee = () => {
          const {
            formatMessage: e
          } = (0, c.useIntl)(), [a, l] = (0, o.useState)(!1), [r, i] = (0, o.useState)(1), [n, s] = (0, o.useState)(1), [d, u] = (0, o.useState)(!1), _ = (0, o.useRef)(null), {
            state: v,
            setState: m
          } = (0, p.Tc)(), {
            volume: b
          ...
          return (0, o.useEffect)(() => (window.addEventListener("pointerup", C), window.addEventListener("pointercancel", C), () => {
            ...
            children: [(0, t.jsx)(B, {
              ...
              onKeyDown: e => {
                Q(e.target) || (e.preventDefault(), b > 0 && i(b), m("volume", b > 0 ? 0 : r))
              },
              "aria-label": e(X.videoplayer_volume_toggle_button_label),
              className: Y.button,
              children: 0 === b ? (0, t.jsx)(J, {
                type: "muted",
                className: Y.icon
              }) : (0, t.jsx)(J, {
                type: "up",
      ...
      const le = () => (0, t.jsx)("span", {
        ...
        ne = ({
          ...
          return (0, t.jsx)(B, {
            tooltipLabel: l(oe.videoplayer_downloads_menu_header),
            "data-testid": "download-menu-btn",
            "aria-label": l(oe.videoplayer_downloads_button_label),
            onClick: () => {
              o({
            ...
            children: (0, t.jsxs)("span", {
              ...
              children: [(0, t.jsx)(te, {
                ...
                children: l(oe.videoplayer_downloads_menu_header)
              })]
            })
          })
        },
        se = ({
          ...
          return (0, o.useEffect)(() => {
            ...
            s([...e])
          }, [h]), v?.isDownloadMenuOpen ? (0, t.jsxs)(t.Fragment, {
            children: [(0, t.jsx)("header", {
              ...
              children: (0, t.jsxs)("div", {
                ...
                children: [e ? (0, t.jsx)("div", {
                  ...
                  "aria-label": d(oe.videoplayer_downloads_menu_back_button_label),
                  onClick: () => {
                    "function" == typeof a && a()
                  },
                  onKeyUp: () => {
                  ...
                  tabIndex: 0,
                  children: (0, t.jsx)(le, {})
                }) : (0, t.jsx)(te, {}), d(oe.videoplayer_downloads_menu_header)]
              })
            }), (0, t.jsx)("section", {
                ...
                onClick: () => (async e => {
                  ...
                  if (a) {
                    ...
                    try {
                      ...
                      o.href = t, o.download = `rockstar-games-${h.game.title?.toLowerCase().replace(/\s+/g,"-")}-${h.title?.toLowerCase().replace(/\s+/g,"-")}-${a.resolution}.mp4`, document.body.appendChild(o), o.click(), document.body.removeChild(o)
                    } catch (e) {
        ...
        ye = ({
          ...
          return (0, o.useEffect)(() => {
            m && r(be(m.files[_]?.resolution))
          }, [_, m?.files]), (0, t.jsxs)(B, {
            ...
            children: [(0, t.jsxs)("span", {
              ...
              children: [(0, t.jsxs)("span", {
                ...
                children: [(0, t.jsx)(ce, {
                  className: L()(me.icon, l ? me.labeledIcon : ""),
                  label: l
                }), l && (0, t.jsx)(ue, {
                  accentColor: u,
            ...
            children: [(0, t.jsxs)("header", {
              ...
              children: [(0, t.jsxs)("div", {
                ...
                children: [e ? (0, t.jsx)("div", {
                  ...
                  tabIndex: 0,
                  children: (0, t.jsx)(le, {})
                }) : (0, t.jsx)(ce, {}), d(ve.videoplayer_quality_settings_menu_header)]
                ...
                return (0, t.jsxs)("button", {
                  ...
                  onClick: () => (e => {
                    ...
                    m({
                      event: "video_quality",
                      text: a.resolution
                    }), _("savedTime", f?.current?.currentTime), _("fileIndex", t), "function" == typeof l && l()
                  })(e),
                  children: [(0, t.jsxs)("span", {
          ...
          return (0, o.useEffect)(() => {
            ...
            const e = v.map((e, a) => {
              ...
              return {
                ...
                label: `${(0,d.getLanguageLabel)(l)} ${t?n(Ce.videoplayer_captions_menu_subtitles_label):""}`.trim(),
                value: a
              }
            });
            i([...e])
          }, [v]), _?.isCaptionsMenuOpen ? (0, t.jsxs)(t.Fragment, {
            children: [(0, t.jsx)("header", {
              className: ke.header,
              children: (0, t.jsxs)("div", {
                ...
                children: [e ? (0, t.jsx)("div", {
                  ...
                  tabIndex: 0,
                  children: (0, t.jsx)(le, {})
                }) : (0, t.jsx)(he, {}), n(Ce.videoplayer_captions_menu_header)]
              })
            }), (0, t.jsx)("section", {
      ...
      u.gsap.registerPlugin(ae.useGSAP);
      const Te = ({
          collapsed: e = !1,
          onClick: a
        }) => {
        ...
        Be = ({
          ...
          const {
            ...
            name: "embed",
            template: y.embed,
            actionText: _(Ve.videoplayer_share_time_copied)
          }], w = () => Math.floor(f?.current?.currentTime), x = e => {
            let a = "?";
            return e.includes("?") && (a = "&"), `${e}${l?`${a}start=${w()}`:""}`
          }, j = (0, t.jsxs)(t.Fragment, {
            children: [_(Ve.videoplayer_share_copy), (0, t.jsx)(Re, {
              className: Ae.copyLinkIcon,
              fill: "black"
            })]
          }), N = (0, t.jsxs)(t.Fragment, {
            children: [_(Ve.videoplayer_share_time_copied), (0, t.jsx)(Ee, {
              className: Ae.copyLinkIcon,
              stroke: "black"
            })]
          }), M = d(e => {
            e && u.gsap.fromTo(`button[name="${e}"] span`, {
              autoAlpha: 0
            }, {
              autoAlpha: 1,
              onComplete: () => {
                u.gsap.to(`button[name="${e}"] span`, {
                  delay: 2,
                  autoAlpha: 0
                })
              }
            ...
            children: [(0, t.jsx)("header", {
              ...
              children: (0, t.jsxs)("div", {
                ...
                children: [e ? (0, t.jsx)("div", {
                  ...
                  "aria-label": _(Ve.videoplayer_share_menu_header),
                  onClick: () => {
                    a?.()
                  },
                  onKeyUp: () => {
                  ...
                  tabIndex: 0,
                  children: (0, t.jsx)(le, {})
                }) : (0, t.jsx)(je, {}), _(Ve.videoplayer_share_menu_header)]
              })
            }), (0, t.jsxs)("section", {
              ...
              children: [(0, t.jsxs)("div", {
                ...
                children: [C.map(({
                  ...
                  "aria-label": _(Ve.videoplayer_share_link_button_label, {
                    name: e
                  }),
                  className: L()(Ae.buttonLink, Ae[e]),
                  ...
                  children: k.map(({
                    ...
                    children: [l && (0, t.jsx)("span", {
                      className: L()(Ae.buttonActionIndicator, e),
                      children: l
                    }), a]
                  }, e))
                })]
                ...
                children: [(0, t.jsx)("div", {
                  className: L()(Ae.checkbox, l ? Ae.selected : ""),
                  ...
                  htmlFor: "shareTime",
                  children: [(0, t.jsx)(c.FormattedMessage, {
      ...
      const qe = ({
        ...
        Ze = () => {
          const [e, a] = (0, o.useState)([]), [l, r] = (0, o.useState)([]), [i, n] = (0, o.useState)([]), [s, _] = (0, o.useState)(), v = (0, o.useRef)(null), {
            formatMessage: m
          } = (0, c.useIntl)(), {
            windowWidth: b
          } = (0, d.useWindowResize)(), {
        ...
        ze = () => {
          ...
          return (0, o.useEffect)(() => (document.addEventListener("focusin", s), document.addEventListener("focusout", s), () => {
            ...
            className: L()("rockstargames-modules-core-videoplayerdc593c045ad6b5f437206948b73eca15", !r && i ? "rockstargames-modules-core-videoplayera523729bef294342658080805393357c" : ""),
            style: {
              "--controls-bg-height": n ? "3.2rem" : "7rem"
            },
            ref: e,
            children: [(0, t.jsx)(G, {}), (0, t.jsxs)("div", {
        ...
        Qe = () => {
          const {
            ...
            video: g
          } = f, [C, k] = (0, o.useState)(null), w = (0, o.useRef)(null), [x, j] = (0, o.useState)(!1), {
            isMobile: N
          } = (0, d.useWindowResize)(), M = (0, o.useRef)(null), [L, S] = (0, o.useState)("");
          (0, o.useEffect)(() => {
            const e = g?.files?.[_]?.src ?? null;
            e && k(e)
          }, [_, g]), (0, o.useEffect)(() => {
            a("videoRef", w), N && !x && a("volume", 0)
          }, [w]), (0, o.useEffect)(() => {
            c && w.current && (w.current.currentTime = c, a("currentTime", null))
          }, [c, w?.current]), (0, o.useEffect)(() => {
            const e = w?.current;
            if (!e) return;
            const t = () => {
          ...
          const E = () => {
            a("isVideoClicked", !0), r("isAnyMenuOpen", !1), m || ((0, p.CN)() ? (a("controlsActive", !u), a("playing", !0)) : (a("controlsActive", b), a("playing", !b)))
          };
          return (0, o.useEffect)(() => {
            const e = e => {
              const l = w?.current;
              ...
              if (Object.values(t).includes(e.code) && (e.preventDefault(), l && !m)) switch (e.code) {
                case t.space:
          ...
          }, [w?.current, b, m]), (0, t.jsxs)(t.Fragment, {
        ...
        Xe = () => {
          ...
          return a && r?.results.length ? (0, t.jsx)("div", {
        ...
        Ye = () => {
          const {
            ...
            videoRef: y,
            volume: f
          } = e, [h, g] = (0, o.useState)(!1), C = (0, o.useRef)(), w = (0, o.useRef)(), x = () => document?.fullscreenEnabled ?? !1, j = () => "string" == typeof document.fullscreenElement?.nodeName, N = () => {
            C.current && clearInterval(C?.current)
          }, M = () => {
            _ && (N(), a("idle", !1), C.current = setTimeout(() => {
              h || a("idle", !0)
            }, 3e3))
          };
          return (0, o.useEffect)(() => {
          ...
          }, [v, l?.isAnyMenuOpen, m]), (0, o.useEffect)(() => {
            a("playerRef", w)
          }, [w]), (0, o.useEffect)(() => {
            ...
            u ? x() && !j() ? o() : t && !l && y.current.webkitEnterFullscreen() : x() && j() ? o() : t && l && y.current.webkitExitFullscreen()
          }, [u, w, y]), (0, o.useEffect)(() => {
            const e = () => {
              M(), a("fullscreen", j()), i({
          ...
          }, [n, m, y?.current]), (0, o.useEffect)(() => {
            c && y?.current && (y.current.currentTime = c)
          }, [c, y?.current]), (0, o.useEffect)(() => {
            ...
            const e = e => {
              w.current && !w.current.contains(e.target) && r("isAnyMenuOpen", !1)
            };
            ...
            ref: w,
            "data-context": s,
            className: [Je.videoplayer, v ? Je.videoplayerEnded : "", b ? "" : Je.videoplayerNotRunning].join(" "),
            onMouseLeave: () => {
            ...
            onTouchEnd: N,
            onTouchStart: N,
            children: [(0, t.jsx)(We, {}), (0, t.jsx)(k, {}), (0, t.jsx)(Qe, {}), (0, t.jsx)(ze, {}), v && (0, t.jsx)(Xe, {})]
          })
        },
        ea = (0, o.forwardRef)(function({
          ...
          const {
            isMobile: l
          } = (0, d.useWindowResize)(), o = new URL(`https://www.youtube.com/embed/${e}?autoplay=1&enablejsapi=1`);
          return l && o.searchParams.append("mute", "1"), (0, t.jsx)("iframe", {
            ref: a,
      ...
      var aa = l(2484),
        ...
        oa = l(7634);
      const ra = document.getElementsByTagName("html")[0].lang ?? "en_us",
        ia = ({
          aspectRatio: e = 16 / 9,
          autoplay: a = !1,
          context: l = "site",
          ...
          return (0, o.useEffect)(() => {
            ...
            }(a, B(Ce.videoplayer_captions_menu_off_label))), g("accentColor", (0, p.q8)(A?.game?.title_slug ?? ""))
          }, [u, A]), (0, o.useEffect)(() => {
            if (!A) return;
            let e, a, l = b.split("_")[1] ?? "";
            "hans" === l && (l = "zh");
            const t = "en_us" !== b && l ? `${l}/` : "";
            "clr" === L ? (e = "https://circolocorecords.com", a = e) : (a = `https://${P?.subDomain??"www"}.rockstargames.com`, e = `${a}/${t}videos/${A.id}?resolution=${A.files[S]?.resolution}&embed`);
            const o = `${A.game.title}: ${A.title}`,
              r = {
                allow: "autoplay; fullscreen; picture-in-picture; clipboard-read; clipboard-write;",
                src: `https://${P?.subDomain}.rockstargames.com/videoplayer/?id=${A.id}&locale=${b}&resolution=${A.files[S]?.resolution}&embed`,
            ...
            g("videoChangeCallback", v || (e => {
              T(`../videos/${e}`)
            }))
          }, [v]), (0, o.useEffect)(() => {
            const e = k.get("start") ?? 0;
            g("currentTime", Number(e))
          }, [n, k.get("start")]), (0, o.useEffect)(() => {
            E && g("autoplay", !0)
          }, [E]), (0, o.useEffect)(() => {
            const {
              video: e
            ...
            const l = a || M || !1;
            g("controlsActive", !0), g("fullscreen", !1), g("idle", !1), g("meta", null), g("playerEnded", !1), g("playing", l), g("progressBarState", {}), g("isAnyMenuOpen", !1), g("shareOpen", !1), g("videoId", n), g("cued", !0), l && (g("autoplay", !0), g("running", !0)), g("videoData", w)
          }, [JSON.stringify(w)]), (0, o.useEffect)(() => {
            M && !V && A && A.id === n && C({
              event: "video_play_auto"
            })
          }, [M, V, A, n]), (0, o.useEffect)(() => {
            g("aspectRatio", e)
          }, [e]), (0, o.useEffect)(() => {
            g("context", l)
          }, [l]), (0, o.useEffect)(() => {
          ...
          }) : ["gtaosession", "gtaostream", "community"].includes(A.groupType) || A.youtubeOnly ? A.agegated ? (0, t.jsx)(s.AgeGate, {
            children: (0, t.jsx)(ea, {
              ref: f,
              id: A.youtubeId
            })
            ...
            ref: f,
            id: A.youtubeId
          }) : M || E ? A.agegated ? (0, t.jsx)(N.A, {
            hero: d,
            wrapper: _,
            titleCrop: y,
            children: (0, t.jsx)(s.AgeGate, {
              options: {
                bgImg: A.screencap
              },
              ga: {
        ...
        na = (0, t.jsx)(c.FormattedMessage, {
          ...aa.A.videoplayer_error
        }),
        sa = (0, c.withIntl)((0, d.withGtmTracking)(((e, a = null, l = !1) => function(o) {
          return (0, t.jsx)(n, {
            header: a,
            hidden: l,
            children: (0, t.jsx)(e, {
    ...
    9867: (e, a, l) => {
      ...
      const t = {
        ...
        r = () => {
          ...
          const {
            location: a
          } = window, l = a.hostname.substring(0, a.hostname.indexOf(".rockstargames.com")), t = o.findIndex(a => Object.entries(a.sites).findIndex(([a, t]) => t === l && (e = {
            site: a,
            subDomain: t
          }, !0)) >= 0), r = o[t >= 0 ? t : 0];
          return e || (e = {
