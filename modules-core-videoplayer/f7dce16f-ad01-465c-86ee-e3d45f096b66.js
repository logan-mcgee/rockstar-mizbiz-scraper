try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "f7dce16f-ad01-465c-86ee-e3d45f096b66", e._sentryDebugIdIdentifier = "sentry-dbid-f7dce16f-ad01-465c-86ee-e3d45f096b66")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    4994: (e, a, l) => {
      ...
      const $ = (0, c.defineMessages)({
        ...
        U = () => {
          const e = (0, t.useRef)(null),
            ...
            R = e => {
              ...
              let o = (e.clientX - l.left) / l.width * L.duration;
              o = Math.min(L.duration, Math.max(0, o)), v(o)
            };
          return (0, t.useEffect)((() => {
            const e = () => {
              v(null)
            ...
            d && M?.percent ? b(M.percent) : L?.current && L?.duration && b(L.current / L.duration)
            ...
            const t = o.width / L.duration;
            for (let e = 0; e < C.length; e += 1) {
              const a = C.start(e),
                r = C.end(e),
                i = a * t,
                n = r * t;
              a <= L.current && L.current <= r && l.fillRect(i, 0, n - i, o.height)
            }
          ...
          }), [N?.current, a?.current, w, L?.duration]), w ? null : (0, o.jsx)("div", {
            ref: a,
            role: "slider",
            ...
            children: (0, o.jsxs)("div", {
              ...
              children: [(0, o.jsx)("canvas", {
                ...
                style: {
                  "--left-position": p / (S?.current?.duration ?? 1)
                },
        ...
        Q = () => {
          ...
          return (0, o.jsx)("div", {
            className: [K.time, K[a]].join(" ").trim(),
            children: `${W(t)} / ${W(r)}`
          })
        },
      ...
      const Ze = ({
        ...
        We = () => {
          ...
          return (0, o.jsxs)("div", {
            className: Ke.playPauseOverlay,
            children: [(0, o.jsx)("div", {
              className: [Ke.iconWrapper, Ke.animated, `${a?Ke.show:""}`].join(" "),
              children: (0, o.jsx)(Ue, {
                className: Ke.icon,
                height: "40",
                width: "40"
        ...
        Xe = () => {
          ...
          (0, t.useEffect)((() => {
            ...
            const o = e => {
              ...
              d = () => {
                ...
                }), a("playing", !1), p ? p?.() : a("playerEnded", !0)
              },
              c = () => {
            ...
            return e.addEventListener("webkitplaybacktargetavailabilitychanged", _), e.addEventListener("loadeddata", t), e.addEventListener("loadedmetadata", o), e.addEventListener("timeupdate", r), e.addEventListener("volumechange", i), e.addEventListener("seeked", s), e.addEventListener("ended", d), e.addEventListener("progress", u), e.addEventListener("webkitendfullscreen", c), () => {
              e.removeEventListener("webkitplaybacktargetavailabilitychanged", _), e.removeEventListener("loadeddata", t), e.removeEventListener("loadedmetadata", o), e.removeEventListener("timeupdate", r), e.removeEventListener("volumechange", i), e.removeEventListener("seeked", s), e.removeEventListener("ended", d), e.removeEventListener("progress", u), e.removeEventListener("webkitendfullscreen", c)
            }
          ...
          const N = () => {
            a("isVideoClicked", !0), r("isAnyMenuOpen", !1), v || ((0, _.CN)() ? (a("controlsActive", !c), a("playing", !0)) : (a("controlsActive", m), a("playing", !m)))
          };
          return (0, t.useEffect)((() => {
            const e = e => {
              const l = k?.current;
              ...
              if (Object.values(o).includes(e.code) && (e.preventDefault(), l && !v)) switch (e.code) {
                case o.space:
                  v || X(document.activeElement) || a("playing", !m);
                  break;
                case o.arrowRight:
                  l.currentTime += 5;
                  break;
          ...
          }), [k?.current, m, v]), (0, o.jsxs)(o.Fragment, {
            children: [(0, o.jsxs)("video", {
              ...
              ref: x,
              className: [Qe.customCaptions, c ? "" : Qe.controlsInactive].join(" "),
              children: (0, o.jsx)("div", {
        ...
        ea = () => {
          ...
          return (0, t.useEffect)((() => {
            ...
            onTouchEnd: N,
            onTouchStart: N,
            children: [(0, o.jsx)(We, {}), (0, o.jsx)(x, {}), (0, o.jsx)(Xe, {}), (0, o.jsx)($e, {}), v && (0, o.jsx)(Je, {})]
          })
        },
        aa = ({
          id: e
