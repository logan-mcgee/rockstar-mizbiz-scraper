    ...
    4872: (e, a, i) => {
      ...
      const g = {
        ...
        x = e => {
          ...
          const {
            track: d
          } = (0, k.useGtmTrack)(), l = (0, f.useRef)(null), s = (0, f.createRef)(), [o, c] = (0, f.useState)(null), [u, m] = (0, f.useState)(i), [v, p] = (0, f.useState)(!0), [b, h] = (0, f.useState)(!1);
        ...
        j = e => {
          ...
          const {
            ...
            tagIds: d,
            locale: i
          }, N = (0, p.uriForGraphEnv)(T ?? window.env.graphEnv), [j, I] = (0, u.useSearchParams)(), [C, V] = (0, f.useState)(0), {
            loading: _,
            data: E
          ...
          return (0, f.useEffect)((() => {
            const e = Number(j.get("video"));
            if (!w || !e) return;
            const a = v().findIndex(w, (a => {
              let {
                id: i
              } = a;
              return i === e
