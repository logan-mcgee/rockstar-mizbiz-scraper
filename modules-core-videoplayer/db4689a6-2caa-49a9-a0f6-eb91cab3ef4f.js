try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "db4689a6-2caa-49a9-a0f6-eb91cab3ef4f", e._sentryDebugIdIdentifier = "sentry-dbid-db4689a6-2caa-49a9-a0f6-eb91cab3ef4f")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [8517], {
    ...
    22484: (e, a, l) => {
      ...
      const t = (0, l(56990).defineMessages)({
    ...
    68517: (e, a, l) => {
      ...
      const y = "rockstargames-modules-core-videoplayerd8d9ad003eb5b094a636f36119a162cf",
        ...
        k = () => {
          ...
          let c, u;
          return "clr" === l ? (u = (0, t.jsx)(h, {
            className: [C.brand, C[l]].join(" ")
          }), c = "https://circolocorecords.com") : (u = (0, t.jsx)(g, {
            className: [C.brand, C[l]].join(" ")
          }), c = `https://${s?.subDomain??"www"}.rockstargames.com/`), i?.title ? (0, t.jsxs)("div", {
            role: "paragraph",
            className: C.title,
            children: [(0, t.jsx)("a", {
              href: o?.brandUrl,
      ...
      const T = {
        ...
        H = () => {
          ...
          return (0, t.jsx)(B, {
            tooltipLabel: e(o ? E.videoplayer_windowed_hover_label : E.videoplayer_fullscreen_hover_label),
      ...
      const z = (0, u.defineMessages)({
        ...
        G = () => {
          ...
          const E = ({
              ...
              let o = (e - l) / t;
              o = Math.min(1, Math.max(0, o)), h("currentTime", o * b.duration)
            },
            R = e => {
          ...
          }, [d, L?.percent, b?.current, b?.duration]), (0, o.useEffect)(() => {
            const e = S?.current,
              a = () => {
          ...
          }, [S?.current, r, n]), (0, o.useEffect)(() => {
            j || L.percent || !N || h("controlsActive", !x)
          }, [x, j, L.percent, N]), (0, o.useEffect)(() => {
            const a = e?.current;
            if (!a) return;
          ...
          }, [k, e, b.duration, b.current]), (0, o.useEffect)(() => {
            if (!a.current) return;
          ...
          }, [M?.current, a?.current, j, b?.duration]), j ? null : (0, t.jsx)("div", {
            ref: a,
            role: "slider",
          ...
          return (0, o.useEffect)(() => {
            ...
            const e = v.map((e, a) => {
              ...
              return {
                ...
                label: `${(0,c.getLanguageLabel)(l)} ${t?n(Ce.videoplayer_captions_menu_subtitles_label):""}`.trim(),
                value: a
              }
            });
            i([...e])
      ...
      const Te = ({
        ...
        Be = ({
          ...
          const {
            ...
            children: [c(Ve.videoplayer_share_copy), (0, t.jsx)(Re, {
              className: Ae.copyLinkIcon,
              fill: "black"
            })]
          }), N = (0, t.jsxs)(t.Fragment, {
            children: [c(Ve.videoplayer_share_time_copied), (0, t.jsx)(Ee, {
              className: Ae.copyLinkIcon,
              stroke: "black"
            })]
          }), M = d(e => {
            ...
            children: [(0, t.jsx)("header", {
              ...
              children: (0, t.jsxs)("div", {
                ...
                children: [e ? (0, t.jsx)("div", {
                  ...
                  tabIndex: 0,
                  children: (0, t.jsx)(le, {})
                }) : (0, t.jsx)(je, {}), c(Ve.videoplayer_share_menu_header)]
              })
            }), (0, t.jsxs)("section", {
      ...
      const qe = ({
        ...
        Ye = () => {
          ...
          return (0, o.useEffect)(() => {
            ...
            onTouchEnd: j,
            onTouchStart: j,
            children: [(0, t.jsx)(We, {}), (0, t.jsx)(w, {}), (0, t.jsx)(Qe, {}), (0, t.jsx)(ze, {}), p && (0, t.jsx)(Xe, {})]
          })
        },
      ...
      const oa = document.getElementsByTagName("html")[0].lang ?? "en_us",
        ra = ({
          aspectRatio: e = 16 / 9,
          autoplay: a = !1,
          context: l = "site",
          ...
          return (0, o.useEffect)(() => {
            ...
            "hans" === l && (l = "zh");
            const t = "en_us" !== y && l ? `${l}/` : "";
            "clr" === E ? (e = "https://circolocorecords.com", a = e) : (a = `https://${I?.subDomain??"www"}.rockstargames.com`, e = `${a}/${t}videos/${B.id}?resolution=${B.files[R]?.resolution}&embed`);
