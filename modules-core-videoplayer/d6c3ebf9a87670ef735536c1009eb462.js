  ...
  [132, 512], {
    41512: (e, t, i) => {
        ...
        const {
          ...
          let t = function(e) {
              return Object.keys(e).sort().filter((t => void 0 !== e[t])).map((t => {
                return `${t}_${"root"===t?(i=e.root,i?(l.has(i)||(a+=1,l.set(i,a.toString())),l.get(i)):"0"):e[t]}`;
                var i
              })).toString()
            }(e),
            i = s.get(t);
      ...
      function f({
        ...
        }), [Array.isArray(e) ? e.toString() : e, f, o, r, s, l, i, d, t]);
        const v = null == (u = g.entry) ? void 0 : u.target,
          w = n.useRef();
        f || !v || s || l || w.current === v || (w.current = v, y({
          inView: !!a,
          entry: void 0
        }));
