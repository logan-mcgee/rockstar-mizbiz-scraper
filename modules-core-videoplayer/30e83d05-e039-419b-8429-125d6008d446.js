! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      s = (new Error).stack;
    s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "30e83d05-e039-419b-8429-125d6008d446", e._sentryDebugIdIdentifier = "sentry-dbid-30e83d05-e039-419b-8429-125d6008d446")
  } catch (e) {}
}();
  ...
  [1552], {
    41552: (e, s, t) => {
      ...
      const _ = (d = e => {
        ...
        let w = "";
        if ("aria-label" in y && y["aria-label"] && (w = "_blank" === v ? `${y["aria-label"]} ${p.formatMessage(n.aria_label_open_new_window)}` : y["aria-label"]), (0, a.useEffect)((() => {
        ...
        if (g) return (0, c.jsxs)(r.NavLink, {
          title: _,
          to: t,
          onClick: u,
          ...y,
      ...
      const N = {
        ...
        R = (0, a.forwardRef)(((e, s) => {
          ...
          return (0, c.jsxs)("button", {
            ref: s,
            className: [N.itemContainer, n ? N.active : ""].filter((e => e)).join(" "),
            onClick: o,
            type: "button",
      ...
      const G = R,
        ...
        C = e => {
          ...
          return (0, a.useEffect)((() => {
            ...
            children: [(0, c.jsx)("h4", {
              ...
              ref: u,
              className: [S.videos, k ? "" : S.userNotScrolledToTopOfList, y ? "" : S.userNotScrolledToBottomOfList].filter((e => e)).join(" "),
              onScroll: e => {
                let {
                  target: {
                    scrollTop: s,
        ...
        I = (0, i.withIntl)((e => {
          ...
          const {
            ...
            tagIds: n,
            locale: t
          }, [g, k] = (0, r.useSearchParams)(), v = Number(g.get("start") ?? 0), [z, j] = (0, a.useState)(0), {
            loading: N,
            data: R
          } = (0, h.useQuery)(x.videos, {
            variables: p
          }), G = R?.videos?.results;
          return (0, a.useEffect)((() => {
            const e = g.get("video");
            if (!G || !e) return;
            const s = y().findIndex(G, (s => {
              let {
                id: t
              } = s;
              return t === e
          ...
          }), [G]), !N && R && G ? (0, c.jsxs)("section", {
            className: [E.videoWithPlaylistContainer, s ?? ""].filter((e => e)).join(" "),
            id: i ?? "",
            ...
            children: [(0, c.jsx)(b.A, {
              ...
              onVideoItemClick: e => {
                if (m) k({
                  ...
                  const s = G.findIndex((s => s.id === e)); - 1 !== s ? j(s) : console.warn("Video ID not found in results.")
                }
              },
              isModal: m
            })]
