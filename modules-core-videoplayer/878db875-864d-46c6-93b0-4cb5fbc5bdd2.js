try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "878db875-864d-46c6-93b0-4cb5fbc5bdd2", e._sentryDebugIdIdentifier = "sentry-dbid-878db875-864d-46c6-93b0-4cb5fbc5bdd2")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [3659], {
    ...
    53659(e, t, i) {
        ...
        $e = function(e) {
          ...
          return Ce(t, e), Object.defineProperty(t.prototype, "parentNode", {
            ...
            var i, a = this.props.scale || 1,
              ...
              b = h || 0,
              v = u || 0;
            return De("right", s) && (m = d.width + (e - d.x) * n / a, c && (g = (m - v) / this.ratio + b)), De("left", s) && (m = d.width - (e - d.x) * n / a, c && (g = (m - v) / this.ratio + b)), De("bottom", s) && (g = d.height + (t - d.y) * l / a, c && (m = (g - b) * this.ratio + v)), De("top", s) && (g = d.height - (t - d.y) * l / a, c && (m = (g - b) * this.ratio + v)), {
              newWidth: m,
              newHeight: g
            }
            ...
            if (this.state.isResizing && this.resizable && this.window) {
              ...
              this.props.snap && this.props.snap.x && (f = Ge(f, this.props.snap.x, this.props.snapGap)), this.props.snap && this.props.snap.y && (v = Ge(v, this.props.snap.y, this.props.snapGap));
              ...
              if (f = x.newWidth, v = x.newHeight, this.props.grid) {
                var w = Ie(f, this.props.grid[0], this.props.gridGap ? this.props.gridGap[0] : 0),
                  S = Ie(v, this.props.grid[1], this.props.gridGap ? this.props.gridGap[1] : 0),
              ...
              if (this.delta = k, h && "string" == typeof h)
                ...
                var N = f / this.window.innerHeight * 100;
                f = "".concat(N, "vh")
              }
              u && "string" == typeof u && (u.endsWith("%") ? (M = v / m.height * 100, v = "".concat(M, "%")) : u.endsWith("vw") ? (R = v / this.window.innerWidth * 100, v = "".concat(R, "vw")) : u.endsWith("vh") && (N = v / this.window.innerHeight * 100, v = "".concat(N, "vh")));
              var B = {
      ...
      ze("Background Image Gradient"), ((e = "Label") => {
