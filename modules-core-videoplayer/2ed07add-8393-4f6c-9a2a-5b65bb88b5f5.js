try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "2ed07add-8393-4f6c-9a2a-5b65bb88b5f5", e._sentryDebugIdIdentifier = "sentry-dbid-2ed07add-8393-4f6c-9a2a-5b65bb88b5f5")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [8517], {
    ...
    22484: (e, a, l) => {
      ...
      const o = (0, l(56990).defineMessages)({
    ...
    68517: (e, a, l) => {
      ...
      const y = "rockstargames-modules-core-videoplayerd8d9ad003eb5b094a636f36119a162cf",
        f = () => {
          const {
            ...
            playing: i,
            controlsActive: n
          } = e, [s, d] = (0, t.useState)(null), c = (0, t.useRef)(null), {
            formatMessage: f
          } = (0, u.useIntl)();
          return (0, t.useEffect)(() => {
            d((e => {
        ...
        k = () => {
          ...
          let c, u;
          return "clr" === l ? (u = (0, o.jsx)(h, {
            className: [C.brand, C[l]].join(" ")
          }), c = "https://circolocorecords.com") : (u = (0, o.jsx)(g, {
            className: [C.brand, C[l]].join(" ")
          }), c = `https://${s?.subDomain??"www"}.rockstargames.com/`), i?.title ? (0, o.jsxs)("div", {
            role: "paragraph",
            className: C.title,
            children: [(0, o.jsx)("a", {
              href: t?.brandUrl,
        ...
        j = () => (0, o.jsxs)("div", {
          ...
          children: [(0, o.jsx)(w, {}), (0, o.jsx)(x, {}), (0, o.jsx)(f, {})]
        });
      var N = l(64805),
        M = l(94257),
        L = l(1556),
        S = l.n(L);
      const E = (0, u.defineMessages)({
          videoplayer_fullscreen_button_label: {
      ...
      const T = {
        ...
        F = () => {
          ...
          return (0, o.jsx)(B, {
            tooltipLabel: e(n ? P.videoplayer_replay_hover_label : s ? P.videoplayer_pause_hover_label : P.videoplayer_play_hover_label),
            "aria-label": e(P.videoplayer_play_pause_button_label),
            onMouseDown: () => {
      ...
      const z = (0, u.defineMessages)({
        ...
        G = () => {
          ...
          (0, t.useEffect)(() => {
            setInterval(() => {
              y({
                current: S.current?.currentTime ?? 0,
                duration: S.current?.duration ?? 0
              })
            }, 200)
          }, [S.current]);
          const E = ({
              ...
              let t = (e - l) / o;
              t = Math.min(1, Math.max(0, t)), h("currentTime", t * b.duration)
            },
            R = e => {
              if (!a?.current || !S?.current || !b?.duration) return;
              const l = a.current.getBoundingClientRect();
              let o = (e.clientX - l.left) / l.width * b.duration;
              o = Math.min(b.duration, Math.max(0, o)), v(o)
            };
          return (0, t.useEffect)(() => {
            const e = () => {
              v(null)
            ...
            d && L?.percent ? m.current = L.percent : b?.current && b?.duration && (m.current = b.current / b.duration)
          }, [d, L?.percent, b?.current, b?.duration]), (0, t.useEffect)(() => {
            const e = S?.current,
              a = () => {
          ...
          }, [S?.current, r, n]), (0, t.useEffect)(() => {
            j || L.percent || !N || h("controlsActive", !x)
          }, [x, j, L.percent, N]), (0, t.useEffect)(() => {
            const a = e?.current;
            if (!a) return;
            const l = a.getContext("2d"),
              o = a.getBoundingClientRect();
            if (a.width = o.width, a.height = o.height, l.clearRect(0, 0, o.width, o.height), l.fillStyle = "rgba(255, 255, 255, 0.5)", !k || !k.length) return;
            const t = o.width / b.duration;
            for (let e = 0; e < k.length; e += 1) {
              const a = k.start(e),
                r = k.end(e),
                i = a * t,
                n = r * t;
              a <= b.current && b.current <= r && l.fillRect(i, 0, n - i, o.height)
            }
          }, [k, e, b.duration, b.current]), (0, t.useEffect)(() => {
            if (!a.current) return;
            const e = new(Z())(a.current),
              l = e => {
                c(!0), !j && M?.current?.contains(e.srcEvent.target) ? (E({
                  centerX: e.center.x
                }), R(e.srcEvent)) : E()
              },
              o = () => {
              ...
              t = e => {
                !j && M?.current?.contains(e.srcEvent.target) ? (E({
                  centerX: e.center.x
                }), R(e.srcEvent)) : E()
              };
          ...
          }, [M?.current, a?.current, j, b?.duration]), j ? null : (0, o.jsx)("div", {
            ref: a,
            role: "slider",
            "aria-valuenow": L?.percent ?? 0,
            tabIndex: 0,
            "aria-label": l(z.videoplayer_progress_bar_label),
            className: [$.progressBar, d ? $.isDragging : ""].join(" "),
            ...
            children: (0, o.jsxs)("div", {
              ...
              children: [(0, o.jsx)("canvas", {
                ...
                style: {
                  "--accent-color": C,
                  "--percent-current": m.current
                }
              }), null !== p && (0, o.jsx)("div", {
                style: {
                  "--left-position": p / (b.duration ?? 1)
                },
                className: $.timestamp,
                children: ((e = 0) => {
        ...
        K = () => {
          ...
          return (0, t.useEffect)(() => {
            ...
            className: [U.time, U[n]].join(" ").trim(),
            children: `${W(a)} / ${W(r)}`
          })
        },
        Q = e => !!e && ["button", "a", "input", "select", "textarea", "label", "[tabindex]"].some(a => e.matches(a)),
        J = ({
          alt: e = "",
          className: a = "",
          clipRule: l = "evenodd",
        ...
        ee = () => {
          const {
            formatMessage: e
          } = (0, u.useIntl)(), [a, l] = (0, t.useState)(!1), [r, i] = (0, t.useState)(1), [n, s] = (0, t.useState)(!1), d = (0, t.useRef)(null), {
            state: c,
            setState: p
          } = (0, _.Tc)(), {
            volume: v
          ...
          return (0, t.useEffect)(() => (window.addEventListener("pointerup", h), window.addEventListener("pointercancel", h), () => {
            ...
            children: [(0, o.jsx)(B, {
              ...
              onKeyDown: e => {
                Q(e.target) || (e.preventDefault(), v > 0 && i(v), p("volume", v > 0 ? 0 : r))
              },
              ...
              "aria-valuemax": 1,
              "aria-valuemin": 0,
              className: [Y.volumeBar, a || n ? Y.expand : ""].join(" ").trim(),
              tabIndex: 0,
              ref: d,
              role: "slider",
              onMouseDown: e => {
      ...
      const le = () => (0, o.jsx)("span", {
        ...
        se = ({
          ...
          return (0, t.useEffect)(() => {
            ...
            const e = y.files.map(e => ({
              label: e.resolution,
              subtext: ie(e.resolution),
              value: e.resolution
            }));
            s([...e])
          }, [y]), p?.isDownloadMenuOpen ? (0, o.jsxs)(o.Fragment, {
            children: [(0, o.jsx)("header", {
              className: re.header,
              children: (0, o.jsxs)("div", {
                className: re.menuLabel,
                children: [e ? (0, o.jsx)("div", {
                  role: "button",
                  className: re.backButton,
                  ...
                  tabIndex: 0,
                  children: (0, o.jsx)(le, {})
                }) : (0, o.jsx)(oe, {}), d(te.videoplayer_downloads_menu_header)]
              })
            }), (0, o.jsx)("section", {
              ...
              children: n && n.map((e, a) => (0, o.jsxs)("button", {
                type: "button",
                "aria-label": e.label,
                className: [re.button, r === a ? re.selected : ""].join(" ").trim(),
                onClick: () => (async e => {
                  if (!y?.files) return;
                  ...
                  if (a) {
                    try {
                      ...
                      t.href = o, t.download = `rockstar-games-${y.game.title?.toLowerCase().replace(/\s+/g,"-")}-${y.title?.toLowerCase().replace(/\s+/g,"-")}-${a.resolution}.mp4`, document.body.appendChild(t), t.click(), document.body.removeChild(t)
                    } catch (e) {
                ...
                children: [(0, o.jsxs)("span", {
                  className: re.buttonLabel,
                  children: [e.label, e.subtext && (0, o.jsx)("sup", {
                    className: re.subtext,
                    children: e.subtext
                  })]
                }), (0, o.jsx)("div", {
                  className: re.hoverIcon,
                  children: (0, o.jsx)(oe, {
                    className: re.icon
                  })
                })]
        ...
        ye = ({
          ...
          return (0, t.useEffect)(() => {
            m && r(be(m.files[p]?.resolution))
          }, [p, m?.files]), (0, o.jsxs)(B, {
            tooltipLabel: i(ve.videoplayer_quality_settings_menu_header),
            "aria-label": i(_e.videoplayer_quality_settings_button_label),
            onClick: () => {
              s({
                event: "video_quality"
              }), a()
            ...
            children: [(0, o.jsxs)("span", {
              className: me.label,
              children: [(0, o.jsxs)("span", {
                className: me.iconAndLabelContainer,
                children: [(0, o.jsx)(ce, {
                  className: S()(me.icon, l ? me.labeledIcon : ""),
                  label: l
                }), l && (0, o.jsx)(ue, {
                  accentColor: c,
                  className: me.iconLabel,
                  label: l
                })]
              }), e && (0, o.jsx)("span", {
                className: me.labelText,
                children: i(ve.videoplayer_quality_settings_menu_header)
              })]
            }), e && (0, o.jsx)(de, {})]
          })
        },
        fe = ({
          ...
          return (0, t.useEffect)(() => {
            ...
            const e = h.files.map(e => ({
              label: e.resolution,
              subtext: be(e.resolution),
              value: e.resolution
            }));
            s([...e])
          }, [h]), v?.isQualityMenuOpen ? (0, o.jsxs)(o.Fragment, {
            children: [(0, o.jsxs)("header", {
              ...
              children: [(0, o.jsxs)("div", {
                ...
                children: [e ? (0, o.jsx)("div", {
                  role: "button",
                  className: me.backButton,
                  "aria-label": d(ve.videoplayer_quality_menu_back_button_label),
                  onClick: () => {
                    "function" == typeof a && a()
                  },
                  onKeyUp: () => {
                  ...
                  tabIndex: 0,
                  children: (0, o.jsx)(le, {})
                }) : (0, o.jsx)(ce, {}), d(ve.videoplayer_quality_settings_menu_header)]
              }), Number.isInteger(r) && n?.length && (0, o.jsx)("div", {
                className: me.selectedValue,
                children: n[r]?.label
              })]
            }), (0, o.jsx)("section", {
              ...
              children: n && n.map((e, a) => {
                ...
                return (0, o.jsxs)("button", {
                  type: "button",
                  "aria-label": t,
                  className: [me.button, r === a ? me.selected : ""].join(" ").trim(),
                  onClick: () => (e => {
                    if (!h?.files) return;
                    const a = h.files.find(a => a.resolution === e.value);
                    if (!a) return;
                    const o = h.files.indexOf(a);
                    m({
                      event: "video_quality",
                      text: a.resolution
                    }), p("savedTime", f?.current?.currentTime), p("fileIndex", o), "function" == typeof l && l()
                  })(e),
                  children: [(0, o.jsxs)("span", {
                    className: me.buttonLabel,
                    children: [e.label, e.subtext && (0, o.jsx)("sup", {
        ...
        we = ({
          ...
          return (0, o.jsxs)(B, {
            tooltipLabel: l(Ce.videoplayer_captions_menu_header),
            "aria-label": l(Ce.videoplayer_captions_button_label),
            onClick: () => {
              t({
                event: "video_caption"
              }), a()
            ...
            children: [(0, o.jsxs)("span", {
              ...
              children: [(0, o.jsx)(he, {
                ...
                className: ke.underline,
                fill: n
              }), e && (0, o.jsx)("span", {
                className: ke.labelText,
                children: l(Ce.videoplayer_captions_menu_header)
              })]
            }), e && (0, o.jsx)(de, {})]
          })
        },
          ...
          return (0, t.useEffect)(() => {
            ...
            const e = v.map((e, a) => {
              ...
              return {
                ...
                label: `${(0,c.getLanguageLabel)(l)} ${o?n(Ce.videoplayer_captions_menu_subtitles_label):""}`.trim(),
                value: a
              }
            });
            i([...e])
            ...
            children: [(0, o.jsx)("header", {
              ...
              children: (0, o.jsxs)("div", {
                ...
                children: [e ? (0, o.jsx)("div", {
                  role: "button",
                  className: ke.backButton,
                  "aria-label": n(Ce.videoplayer_captions_menu_back_button_label),
                  onClick: () => {
                    "function" == typeof a && a()
                  },
                  onKeyUp: () => {
                  ...
                  tabIndex: 0,
                  children: (0, o.jsx)(le, {})
                }) : (0, o.jsx)(he, {}), n(Ce.videoplayer_captions_menu_header)]
              })
            }), (0, o.jsx)("section", {
              ...
              children: r && r.map((e, a) => (0, o.jsxs)("button", {
                type: "button",
                "aria-label": e.label,
                className: [ke.button, a === m ? ke.selected : ""].join(" ").trim(),
                onClick: () => (e => {
                  const a = e.value;
                  d("showCaptions", !m === a), d("activeCaption", m === a ? 0 : a), "function" == typeof l && l()
                })(e),
                children: [(0, o.jsx)("span", {
                  className: ke.buttonLabel,
                  children: e.label
                }), m === e.value && (0, o.jsx)(pe, {
                  className: ke.checkmark
                })]
              }, e.label))
            })]
          }) : null
      ...
      p.gsap.registerPlugin(ae.useGSAP);
      const Te = ({
          collapsed: e = !1,
          onClick: a
        }) => {
          ...
          return n ? (0, o.jsx)(B, {
            tooltipLabel: l(Ve.videoplayer_share_menu_header),
            "aria-label": l(Ve.videoplayer_share_menu_button_label),
            type: "button",
            onClick: async () => {
              r({
                event: "video_share"
            ...
            children: (0, o.jsxs)("span", {
              ...
              children: [(0, o.jsx)(je, {
                ...
                className: Ae.labelText,
                children: l(Ve.videoplayer_share_menu_header)
              })]
            })
          }) : null
        },
        Be = ({
          ...
          const {
            ...
            icon: (0, o.jsx)(Se, {
              className: Ae.embedIcon
            }),
            name: "embed",
            template: y.embed,
            actionText: c(Ve.videoplayer_share_time_copied)
          }], w = () => Math.floor(f?.current?.currentTime), x = e => {
            let a = "?";
            return e.includes("?") && (a = "&"), `${e}${l?`${a}start=${w()}`:""}`
          }, j = (0, o.jsxs)(o.Fragment, {
            children: [c(Ve.videoplayer_share_copy), (0, o.jsx)(Re, {
              className: Ae.copyLinkIcon,
              fill: "black"
            })]
          }), N = (0, o.jsxs)(o.Fragment, {
            children: [c(Ve.videoplayer_share_time_copied), (0, o.jsx)(Ee, {
              className: Ae.copyLinkIcon,
              stroke: "black"
            })]
          }), M = d(e => {
          ...
          return b?.isShareMenuOpen ? (0, o.jsxs)(o.Fragment, {
            children: [(0, o.jsx)("header", {
              className: Ae.header,
              children: (0, o.jsxs)("div", {
                className: Ae.menuLabel,
                children: [e ? (0, o.jsx)("div", {
                  role: "button",
                  className: Ae.backButton,
                  "aria-label": c(Ve.videoplayer_share_menu_header),
                  onClick: () => {
                    a?.()
                  },
                  onKeyUp: () => {
                  ...
                  tabIndex: 0,
                  children: (0, o.jsx)(le, {})
                }) : (0, o.jsx)(je, {}), c(Ve.videoplayer_share_menu_header)]
              })
            }), (0, o.jsxs)("section", {
              className: Ae.content,
              children: [(0, o.jsxs)("div", {
                className: Ae.socialIcons,
                children: [C.map(({
                  name: e,
                  icon: a,
                  template: l
                }) => (0, o.jsx)("a", {
                  "aria-label": c(Ve.videoplayer_share_link_button_label, {
                    name: e
                  }),
                  className: S()(Ae.buttonLink, Ae[e]),
                  ...
                  children: k.map(({
                    ...
                    children: [l && (0, o.jsx)("span", {
                      className: S()(Ae.buttonActionIndicator, e),
                      children: l
                    }), a]
                  }, e))
                })]
              }), (0, o.jsxs)("div", {
                className: Ae.copyLink,
                ...
                children: [(0, o.jsx)("div", {
                  className: S()(Ae.checkbox, l ? Ae.selected : ""),
                  ...
                  htmlFor: "shareTime",
                  children: [(0, o.jsx)(u.FormattedMessage, {
                    ...Ve.videoplayer_share_time_copy
                  }), (0, o.jsx)("span", {
                    className: [Ae.timestamp, l ? Ae.selected : ""].join(" ").trim(),
                    children: (() => {
                      const e = w(),
                        a = e % 60;
        ...
        Fe = "rockstargames-modules-core-videoplayere553b94795a0b079d20d0d77beaee659";
      p.gsap.registerPlugin(ae.useGSAP);
      const qe = ({
          onClick: e
        }) => {
        ...
        Ze = () => {
          const [e, a] = (0, t.useState)([]), [l, r] = (0, t.useState)([]), [i, n] = (0, t.useState)([]), [s, d] = (0, t.useState)(), v = (0, t.useRef)(null), {
            formatMessage: m
          } = (0, u.useIntl)(), {
            windowWidth: b
          } = (0, c.useWindowResize)(), {
            ...
            contextSafe: N
          } = (0, ae.useGSAP)(), M = x?.current ? .5 * x.current.clientHeight : "200", L = ["downloads", "share", "airplay", "quality", "captions"], S = ["captions", "quality", "downloads", "share", "airplay"], E = N(e => {
            const a = .125,
              l = "none";
          ...
          return (0, t.useEffect)(() => {
            ...
            return () => e.revert()
          }, [i, b, k?.current, s, h?.isEllipsisMenuOpen, h?.isCaptionsMenuOpen, h?.isQualityMenuOpen, h?.isDownloadMenuOpen, h?.isShareMenuOpen, h?.isAirPlayMenuOpen]), (0, o.jsxs)(o.Fragment, {
            children: [(0, o.jsxs)("dialog", {
              ...
              children: [l.concat(e).map(e => e.content), e.length > 0 && h?.isEllipsisMenuOpen && (0, o.jsxs)("div", {
                children: [(0, o.jsx)("header", {
        ...
        ze = () => {
          ...
          return (0, t.useEffect)(() => (document.addEventListener("focusin", s), document.addEventListener("focusout", s), () => {
            ...
            ref: e,
            children: [(0, o.jsx)(G, {}), (0, o.jsxs)("div", {
        ...
        We = () => {
          ...
          return (0, o.jsxs)("div", {
            className: Ue.playPauseOverlay,
            children: [(0, o.jsx)("div", {
              className: [Ue.iconWrapper, Ue.animated, `${a?Ue.show:""}`].join(" "),
              children: (0, o.jsx)(Ge, {
                className: Ue.icon,
                height: "40",
                width: "40"
        ...
        Qe = () => {
          const {
            ...
            video: C
          } = f, [k, w] = (0, t.useState)(), [x, j] = (0, t.useState)(!1), {
            isMobile: N
          } = (0, c.useWindowResize)(), M = (0, t.useRef)(null), [L, S] = (0, t.useState)("");
          (0, t.useEffect)(() => {
          ...
          return (0, t.useEffect)(() => {
            const e = e => {
              ...
              if (Object.values(l).includes(e.code) && (e.preventDefault(), !m)) switch (e.code) {
                case l.space:
                  m || Q(document.activeElement) || a("playing", !b);
                  break;
                case l.arrowRight:
          ...
          }, [h?.current, b, m]), k ? (0, o.jsxs)(o.Fragment, {
            children: [(0, o.jsx)("video", {
              ...
              ref: M,
              className: [Ke.customCaptions, u ? "" : Ke.controlsInactive].join(" "),
              children: (0, o.jsx)("div", {
        ...
        Xe = () => {
          ...
          return t && n?.results.length ? (0, o.jsx)("div", {
              ...
              children: n.results.map(e => {
                return (0, o.jsx)("button", {
                  ...
                  onKeyDown: o => (({
                    ...
                    "Enter" === e && r?.(o, a, s?.files[l]?.resolution)
                  })(o, e.id),
                  type: "button",
                  children: (0, o.jsx)("div", {
        ...
        Ye = () => {
          const {
            ...
            videoRef: b,
            volume: y
          } = e, [f, h] = (0, t.useState)(!1), g = (0, t.useRef)(), C = (0, t.useRef)(), k = () => document?.fullscreenEnabled ?? !1, x = () => "string" == typeof document.fullscreenElement?.nodeName, j = () => {
          ...
          return (0, t.useEffect)(() => {
            ...
            c ? k() && !x() ? o() : l && !a && b.current.webkitEnterFullscreen?.() : k() && x() ? o() : l && a && b.current.webkitExitFullscreen()
          }, [c, C, b]), (0, t.useEffect)(() => {
            const e = () => {
              N(), a("fullscreen", x()), i({
            ...
            ref: C,
            "data-context": s,
            className: [Je.videoplayer, p ? Je.videoplayerEnded : "", m ? "" : Je.videoplayerNotRunning].join(" "),
            onMouseLeave: () => {
            ...
            onTouchEnd: j,
            onTouchStart: j,
            children: [(0, o.jsx)(We, {}), (0, o.jsx)(w, {}), (0, o.jsx)(Qe, {}), (0, o.jsx)(ze, {}), p && (0, o.jsx)(Xe, {})]
          })
        },
        ea = (0, t.forwardRef)(function({
          ...
          return t && r.searchParams.append("mute", "1"), (0, o.jsx)("iframe", {
            ref: l,
      ...
      const ta = document.getElementsByTagName("html")[0].lang ?? "en_us",
        ra = ({
          ...
          (({
            ...
            (0, t.useEffect)(() => {
              const a = a => {
                  ...
                  switch (o.event) {
                    case "command":
                      if (e.current) e.current.contentWindow?.postMessage(JSON.stringify(o), "*");
                      else switch (o.func) {
                        case "playVideo":
              ...
              return window.addEventListener("message", a), e.current?.addEventListener("load", o), () => {
                window.removeEventListener("message", a), e.current?.removeEventListener("load", o)
              }
            }, [e.current]), (0, t.useEffect)(() => {
              if (e.current) return;
              let a;
              a = c || r ? c ? n ? oa.Ended : s ? oa.Playing : oa.Paused : oa.VideoCued : oa.Unstarted;
              const l = {
                event: "rsInfoDelivery",
                info: {
                  playerState: a,
          ...
          return (0, t.useEffect)(() => {
            ...
            const {
              files: e,
              tracks: a
            } = B, l = e.findIndex(e => e.resolution === p), o = e.findIndex(e => e.default);
            w("fileIndex", -1 !== l ? l : -1 !== o ? o : 0), w("captions", function(e, a) {
            ...
            }(a, H(Ce.videoplayer_captions_menu_off_label))), w("accentColor", (0, _.q8)(B?.game?.title_slug ?? ""))
          }, [p, B]), (0, t.useEffect)(() => {
            if (!B) return;
            let e, a, l = y.split("_")[1] ?? "";
            "hans" === l && (l = "zh");
            const o = "en_us" !== y && l ? `${l}/` : "";
            "clr" === E ? (e = "https://circolocorecords.com", a = e) : (a = `https://${I?.subDomain??"www"}.rockstargames.com`, e = `${a}/${o}videos/${B.id}?resolution=${B.files[R]?.resolution}&embed`);
            const t = `${B.game.title}: ${B.title}`,
              r = {
                allow: "autoplay; fullscreen; picture-in-picture; clipboard-read; clipboard-write;",
                src: `https://${I?.subDomain}.rockstargames.com/videoplayer/?id=${B.id}&locale=${y}&resolution=${B.files[R]?.resolution}&embed`,
          ...
          }, [JSON.stringify(L)]), (0, t.useEffect)(() => {
            S && !T && B && B.id === s && x({
              event: "video_play_auto"
            })
          }, [S, T, B, s]), (0, t.useEffect)(() => {
            w("aspectRatio", e)
          }, [e]), (0, t.useEffect)(() => {
            w("context", l)
          }, [l]), (0, t.useEffect)(() => {
          ...
          }) : ["gtaosession", "gtaostream", "community"].includes(B.groupType) || B.youtubeOnly ? B.agegated ? (0, o.jsx)(d.AgeGate, {
            ...g,
            children: (0, o.jsx)(ea, {
              ref: C,
              id: B.youtubeId
            ...
            id: B.youtubeId,
            ...g
          }) : S || V ? B.agegated ? (0, o.jsx)(M.A, {
            hero: c,
            wrapper: v,
            titleCrop: f,
            ...g,
            children: (0, o.jsx)(d.AgeGate, {
              options: {
                bgImg: B.screencap
              },
              ga: {
        ...
        ia = (0, o.jsx)(u.FormattedMessage, {
          ...aa.A.videoplayer_error
        }),
        na = (0, u.withIntl)((0, c.withGtmTracking)(((e, a = null, l = !1) => {
          const t = t => (0, o.jsx)(s, {
            header: a,
            hidden: l,
            children: (0, o.jsx)(e, {
    ...
    79867: (e, a, l) => {
      ...
      const n = {
        ...
        d = () => {
          ...
          const {
            location: a
          } = window, l = a.hostname.substring(0, a.hostname.indexOf(".rockstargames.com")), o = s.findIndex(a => Object.entries(a.sites).findIndex(([a, o]) => o === l && (e = {
            site: a,
            subDomain: o
          }, !0)) >= 0), r = s[o >= 0 ? o : 0], n = s.find(e => e.id === r.fallbackEnvironment);
          return e || (e = {
            site: "www",
            subDomain: "local"
          }), i()(t()({}, n, {
