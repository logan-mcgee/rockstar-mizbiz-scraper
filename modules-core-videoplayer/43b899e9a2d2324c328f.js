  ...
  [610], {
    9878: (e, a, t) => {
      ...
      const s = e => {
        ...
        const i = (0, r.useMemo)((() => function(e) {
            const a = e.split(/[-_]/);
            return a[a.length - 1] = a[a.length - 1].toLowerCase(), a
          }(t)), [t]),
          s = (0, r.useMemo)((() => function(e, a) {
            return e?.[a] ?? {}
          }(a, i[1])), [t, a]);
        return (0, d.jsx)(l.Z, {
          messages: s,
    ...
    610: (e, a, t) => {
      ...
      const m = () => {
        ...
        p = () => {
          ...
          let l, d, o;
          return "clr" === t ? (d = "CircoLoco Records", l = "https://circolocorecords.com", o = l) : (d = "Rockstar Games", l = "https://www.rockstargames.com/", o = `${document.location.origin}/videos/${i.id}`), (0, c.jsxs)(c.Fragment, {
            children: [(0, c.jsx)("a", {
        ...
        b = () => {
          const {
            ...
            windowHeight: t,
            windowWidth: i
          } = (0, d.useWindowResize)(), [r, l] = (0, n.useState)(), [o, u] = (0, n.useState)(), b = (0, n.useRef)(null), {
            controlsActive: k,
            idle: g,
            muteMessageNeeded: h,
            playerEnded: y,
          ...
          return (0, n.useEffect)((() => {
            l(N?.current?.clientHeight), u(b?.current?.clientHeight)
      ...
      const y = {
        ...
        S = () => {
          const {
            ...
            playerEnded: i,
            playing: r
          } = e, l = r ? x.playPausePlaying : x.playPausePaused, d = () => {
            i ? (n(2, "Replay clicked"), t()) : (n(2, "Toggle play/pause clicked"), a("playing", !r))
          };
          return (0, c.jsx)("div", {
            className: [x.playPause, i ? x.playPauseReplay : l].join(" "),
            onClick: d,
            onKeyUp: e => {
              d()
            },
      ...
      const w = () => {
          ...
          if ((0, n.useEffect)((() => {
              d || f.pct || !o || a("controlsActive", !r)
            }), [r, d, f.pct, o]), (0, n.useEffect)((() => {
              ...
              t ? (n && (null === l && a("lastPlayingState", o), a("playing", !1)), e && a("progressBarState", {})) : null !== l && (a("playing", l), a("lastPlayingState", null))
            }), [l, f, m.duration, o]), (0, n.useEffect)((() => {
              const e = v.current;
              if (null === e) return;
              ...
              for (let e = 0; e < i.length; e += 1) {
                const r = i.start(e),
                  ...
                  d = r * n,
                  s = l * n;
                r <= m.current && m.current <= l && a.fillRect(d, 0, s - d, t.height)
              }
            }), [i, v, m.duration, m.current]), (0, n.useEffect)((() => {
              if (!p.current) return;
              const e = new(j())(p.current),
                a = e => {
                  !d && u.current.contains(e.srcEvent.target) ? b(e.srcEvent.offsetX, !0) : b()
                },
                t = () => {
                  b()
                };
          ...
          return (0, c.jsx)("div", {
            ...
            children: (0, c.jsx)("div", {
              ...
              children: o?.files?.map(((e, i) => (0, c.jsx)("button", {
                ...
                onClick: n => {
                  t(2, `Resolution changed to ${e.resolution}`), a("savedTime", d?.current?.currentTime), a("fileIndex", i), a("settingsMenuOpen", !1), n.stopPropagation()
                },
                type: "button",
        ...
        V = () => {
          ...
          return (0, c.jsx)("div", {
            ...
            className: [I.volumen, 0 === i ? I.volumeMuted : I.volumeMax, n ? I.disabledControlItem : ""].join(" ")
          })
        },
        R = {
        ...
        M = () => {
          ...
          return (0, c.jsxs)("div", {
            className: [R.controls, a ? "" : R.controlsInactive].join(" "),
            children: [(0, c.jsx)(w, {}), (0, c.jsxs)("div", {
              className: R.controlsBottom,
              children: [(0, c.jsx)(S, {}), (0, c.jsx)(V, {}), (0, c.jsx)($, {}), (0, c.jsx)(C, {}), (0, c.jsx)(F, {}), (0, c.jsx)(N, {})]
            })]
          })
        },
        L = {
        ...
        D = () => {
          ...
          return (0, n.useEffect)((() => {
            ...
            return e.addEventListener("loadeddata", i), e.addEventListener("loadedmetadata", n), e.addEventListener("timeupdate", r), e.addEventListener("volumechange", l), e.addEventListener("ended", d), e.addEventListener("progress", c), e.addEventListener("webkitendfullscreen", s), () => {
              e.removeEventListener("loadeddata", i), e.removeEventListener("loadedmetadata", n), e.removeEventListener("timeupdate", r), e.removeEventListener("volumechange", l), e.removeEventListener("ended", d), e.removeEventListener("progress", c), e.removeEventListener("webkitendfullscreen", s)
            }
            ...
            playsInline: !0,
            onTouchEnd: () => {
              t(2, "Video tapped"), u || d || a("controlsActive", !i)
            },
            onClick: () => {
              (0, s.b1)() || (t(2, "Video clicked"), u || d || a("playing", !f))
            }
          })
        },
        A = {
        ...
        B = (0, d.withLocale)((() => {
          const {
            ...
            videoRef: g,
            volume: h
          } = e, [y, N] = (0, n.useState)(!1), x = (0, n.useRef)(null), S = (0, n.useRef)(null), E = () => document?.fullscreenEnabled ?? !1, j = () => "string" == typeof document.fullscreenElement?.nodeName ?? !1, w = () => {
          ...
          return (0, n.useEffect)((() => {
            ...
            d ? E() && !j() ? i() : n && !t && g.current.webkitEnterFullscreen() : E() && j() ? i() : n && t && g.current.webkitExitFullscreen()
          }), [d, S, g]), (0, n.useEffect)((() => {
            const e = () => {
                _(), a("fullscreen", j()), t(1, j() ? "Fullscreen entered" : "Fullscreen exited")
              },
              n = e => {
            ...
            onTouchEnd: w,
            onTouchStart: w,
            children: [(0, c.jsx)(D, {}), (0, c.jsx)(b, {}), (0, c.jsx)(P, {}), (0, c.jsx)(M, {})]
          })
        })),
        U = e => {
          let {
        ...
        K = e => {
          ...
          const {
            ...
            loading: F,
            video: O
          } = C, T = (0, l.useAgegated)(), $ = (0, i.useNavigate)();
          return (0, n.useEffect)((() => {
            x("onVideoComplete", b)
          }), [b]), (0, n.useEffect)((() => {
            if (!O) return;
            const {
              files: e
            } = O, a = e.findIndex((e => e.resolution === f)), t = e.findIndex((e => e.default));
            ...
            const a = {
              ...
              text: O.description,
              url: e,
              embed: `<iframe src="https://www.rockstargames.com/videoplayer/?id=${O.id}&locale=en_us&resolution=${O.files[w]?.resolution}&embed" allowfullscreen style="width:640px; height:360px; border:none;"title="Rockstar Games Video: ${O.title}"></iframe>`
            };
            x("shareData", a)
          }), [j, w, O]), (0, n.useEffect)((() => {
            _ && (x("autoplay", !0), x("running", !0), S({
              event: "trackEvent",
              event_category: "video_modal",
              event_action: `Autoplay video with id: [${d}]`,
              event_label: "autoplay"
            }))
          }), [_]), (0, n.useEffect)((() => {
            const e = t || E || !1;
            S(1, "Video started"), x("controlsActive", !0), x("currentTime", 0), x("fullscreen", !1), x("idle", !1), x("meta", null), x("playerEnded", !1), x("playing", e), x("progressBarState", {}), x("settingsMenuOpen", !1), x("shareOpen", !1), x("videoId", d), e && S(1, `Autoplay video with id: [${d}]`, `autoplay[videoId: ${d}]`)
          }), [d]), (0, n.useEffect)((() => {
          ...
          }) : ["gtaosession", "gtaostream", "community"].includes(O.group_type) ? O.agegated ? T((0, c.jsx)(U, {
            id: O.youtube_id
          })) : (0, c.jsx)(U, {
            id: O.youtube_id
          }) : E ? O.agegated ? (0, c.jsx)(h.Z, {
            hero: o,
            wrapper: m,
            children: T((0, c.jsx)(B, {}), {
              bgImg: O.screencap
            })
          }) : (0, c.jsx)(h.Z, {
            hero: o,
        ...
        Z = (0, d.withGtmTracking)((0, r.withSimpleErrorBoundary)((e => (0, c.jsx)(s.tl, {
          children: (0, c.jsx)(K, {
            ...e
          })
    ...
    8590: (e, a, t) => {
      ...
      const b = e => {
          ...
          const [n, r] = (0, i.useState)({}), [d, s] = (0, i.useState)(null), [c, o] = (0, i.useState)(null), {
            data: u,
            loading: f
...
//# sourceMappingURL=43b899e9a2d2324c328f.js.map