  ...
  [2657], {
    2657: (e, n, t) => {
      ...
      const g = function(e, n, t) {
          ...
          const g = i - p + (d - y) / 1e4;
          if (g < 0 && void 0 === e.clockseq && (a = a + 1 & 16383), (g < 0 || i > p) && void 0 === e.nsecs && (d = 0), d >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
          p = i, y = d, u = a, i += 122192928e5;
