try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "f63e131c-9e5e-4ed5-8a3b-267a847ee3f4", e._sentryDebugIdIdentifier = "sentry-dbid-f63e131c-9e5e-4ed5-8a3b-267a847ee3f4")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    8517: (e, a, l) => {
      ...
      const qe = ({
        ...
        ea = (0, t.forwardRef)(function({
          ...
          return l && t.searchParams.append("mute", "1"), (0, o.jsx)("iframe", {
            ref: a,
        ...
        ra = ({
          ...
          return (0, t.useEffect)(() => {
            ...
            const {
              files: e,
              tracks: a
            } = T, l = e.findIndex(e => e.resolution === p), o = e.findIndex(e => e.default);
            k("fileIndex", -1 !== l ? l : -1 !== o ? o : 0), k("captions", function(e, a) {
            ...
            }(a, D(Ce.videoplayer_captions_menu_off_label))), k("accentColor", (0, _.q8)(T?.game?.title_slug ?? ""))
          }, [p, T]), (0, t.useEffect)(() => {
            if (!T) return;
            let e, a, l = y.split("_")[1] ?? "";
            "hans" === l && (l = "zh");
            const o = "en_us" !== y && l ? `${l}/` : "";
            "clr" === S ? (e = "https://circolocorecords.com", a = e) : (a = `https://${H?.subDomain??"www"}.rockstargames.com`, e = `${a}/${o}videos/${T.id}?resolution=${T.files[E]?.resolution}&embed`);
            const t = `${T.game.title}: ${T.title}`,
              r = {
                allow: "autoplay; fullscreen; picture-in-picture; clipboard-read; clipboard-write;",
                src: `https://${H?.subDomain}.rockstargames.com/videoplayer/?id=${T.id}&locale=${y}&resolution=${T.files[E]?.resolution}&embed`,
            ...
            const l = a || L || !1;
            k("controlsActive", !0), k("fullscreen", !1), k("idle", !1), k("meta", null), k("playerEnded", !1), k("playing", l), k("progressBarState", {}), k("isAnyMenuOpen", !1), k("shareOpen", !1), k("videoId", s), k("cued", !0), k("savedTime", 0), l && (k("autoplay", !0), k("running", !0)), k("videoData", x)
          }, [JSON.stringify(x)]), (0, t.useEffect)(() => {
            L && !A && T && T.id === s && w({
              event: "video_play_auto"
            })
          }, [L, A, T, s]), (0, t.useEffect)(() => {
            k("aspectRatio", e)
          }, [e]), (0, t.useEffect)(() => {
            k("context", l)
          }, [l]), (0, t.useEffect)(() => {
          ...
          }) : ["gtaosession", "gtaostream", "community"].includes(T.groupType) || T.youtubeOnly ? T.agegated ? (0, o.jsx)(d.AgeGate, {
            children: (0, o.jsx)(ea, {
              ref: g,
              id: T.youtubeId
            })
