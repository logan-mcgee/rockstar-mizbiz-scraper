! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "d7eeef09-c997-4369-b358-27af439a6e2d", e._sentryDebugIdIdentifier = "sentry-dbid-d7eeef09-c997-4369-b358-27af439a6e2d")
  } catch (e) {}
}();
  ...
  [889], {
    6889: (e, i, n) => {
      ...
      const r = (0, _.withIntl)((e => {
        ...
        if ("aria-label" in b && b["aria-label"] && (y = "_blank" === v ? `${b["aria-label"]} ${k.formatMessage(l.aria_label_open_new_window)}` : b["aria-label"]), (0, s.useEffect)((() => {
      ...
      const j = {
        ...
        P = (0, s.forwardRef)(((e, i) => {
          ...
          return (0, t.jsxs)("button", {
            ref: i,
            className: [j.itemContainer, a ? j.active : ""].filter((e => e)).join(" "),
            onClick: o,
            type: "button",
      ...
      i.definitions.forEach((function(e) {
        ...
        for (a.forEach((function(e) {
          ...
          o = new Set, c.forEach((function(e) {
            l.has(e) || (l.add(e), (s[e] || new Set).forEach((function(e) {
              o.add(e)
            })))
          }))
        }
