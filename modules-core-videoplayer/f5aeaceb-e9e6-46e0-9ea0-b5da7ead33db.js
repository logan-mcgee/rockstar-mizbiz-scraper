  ...
  [6022], {
    46022: (e, n, t) => {
      ...
      const g = function(e, n, t) {
          ...
          const g = l - p + (d - y) / 1e4;
          if (g < 0 && void 0 === e.clockseq && (c = c + 1 & 16383), (g < 0 || l > p) && void 0 === e.nsecs && (d = 0), d >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
          p = l, y = d, u = c, l += 122192928e5;
