  ...
  [8699], {
    8699: (e, n, t) => {
      ...
      const g = function(e, n, t) {
          ...
          const g = i - p + (l - y) / 1e4;
          if (g < 0 && void 0 === e.clockseq && (a = a + 1 & 16383), (g < 0 || i > p) && void 0 === e.nsecs && (l = 0), l >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
          p = i, y = l, u = a, i += 122192928e5;
          ...
          for (let e = 0; e < o; ++e) {
            ...
            for (let e = 0; e < 80; ++e) {
              const t = Math.floor(e / 20),
                s = T(o, 5) + M(t, c, a, i) + d + n[t] + r[e] >>> 0;
              d = i, i = a, a = T(c, 30) >>> 0, c = o, o = s
            }
            t[0] = t[0] + o >>> 0, t[1] = t[1] + c >>> 0, t[2] = t[2] + a >>> 0, t[3] = t[3] + i >>> 0, t[4] = t[4] + d >>> 0
          }
