  ...
  [832], {
    24: (e, a, t) => {
      ...
      const i = (0, l.withTranslations)((e => {
          ...
          const {
            mutateLSSettings: n
          } = (0, l.useRockstarWebLSSettings)(), [i, u] = (0, r.useState)(null), g = (0, r.createRef)(), b = (0, r.createRef)(), f = (0, r.createRef)(), {
            style: p
          } = t;
          return !1 === a ? (0, c.jsxs)("div", {
            ...
            children: [t?.header, (0, c.jsx)("div", {
              ...
              onSubmit: async e => {
                e.preventDefault();
                const a = `${f.current.value}-${g.current.value.padStart(2,0)}-${b.current.value.padStart(2,0)}`,
