  ...
  [610], {
      ...
      const j = () => {
        ...
        G = e => {
          ...
          return (0, n.useEffect)((() => {
            ...
            const {
              files: e
            } = O, a = e.findIndex((e => e.resolution === m)), t = e.findIndex((e => e.default));
            ...
            E(1, "Video started"), S("controlsActive", !0), S("currentTime", 0), S("fullscreen", !1), S("idle", !1), S("meta", null), S("playerEnded", !1), S("playing", t || w || !1), S("progressBarState", {}), S("settingsMenuOpen", !1), S("shareOpen", !1), S("videoId", o)
          }), [o]), (0, n.useEffect)((() => {
            S("videoChangeCallback", b || (e => {
              V(`../videos/${e}`)
            }))
          }), [b]), (0, n.useEffect)((() => {
            S("currentTime", p)
    ...
    8590: (e, a, t) => {
      ...
      const b = e => {
          ...
          (0, d.uriForGraphEnv)(t ?? window.env.graphEnv);
          const [r, l] = (0, i.useState)({}), [s, c] = (0, i.useState)(null), [o, u] = (0, i.useState)(null), {
            data: f,
            loading: m
          ...
          return (0, i.useEffect)((() => {
            ...
            f?.video && c(f.video), f?.related && u(f.related)
          }), [f]), {
            loading: m,
            related: o,
            video: s
