    ...
    9206(e, n, t) {
      ...
      const u = (e, n = s) => {
        ...
        const {
          scope: a,
          revertOnUpdate: u
        } = t, i = (0, d.useRef)(!1), b = (0, d.useRef)(l.context(() => {}, a)), c = (0, d.useRef)(e => b.current.add(null, e)), y = n && n.length && !u;
        return y && r(() => (i.current = !0, () => b.current.revert()), s), r(() => {
          if (e && b.current.add(e, a), !y || !i.current) return () => b.current.revert()
        }, n), {
          context: b.current,
