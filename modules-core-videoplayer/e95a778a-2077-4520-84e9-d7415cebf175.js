! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "e95a778a-2077-4520-84e9-d7415cebf175", e._sentryDebugIdIdentifier = "sentry-dbid-e95a778a-2077-4520-84e9-d7415cebf175")
  } catch (e) {}
}();
            ...
            children: [(0, u.jsxs)("div", {
              ...
              children: [(0, u.jsx)("div", {
                ...
                children: o && (0, u.jsx)("span", {
                  ...
                  children: r(l.cJ.videoplayer_playlist_active_badge)
                })
              })]
            }), (0, u.jsx)("div", {
      ...
      const S = x,
        ...
        I = e => {
          ...
          return (0, m.useEffect)((() => {
            if (!c) return;
            const e = c.offsetTop - s.current.offsetTop;
            s.current.scroll({
              top: e,
              behavior: "smooth"
            })
            ...
            children: [(0, u.jsx)("h2", {
              ...
              ref: s,
              className: [T.videos, k ? "" : T.userNotScrolledToTopOfList, _ ? "" : T.userNotScrolledToBottomOfList].filter((e => e)).join(" "),
              onScroll: e => {
                let {
                  target: {
                    scrollTop: a,
        ...
        w = (0, n.withIntl)((e => {
          ...
          const {
            ...
            loading: w,
            data: E
          } = (0, k.useQuery)(g.videos, {
            variables: h
          }), C = E?.videos?.results;
          return (0, m.useEffect)((() => {
            const e = _.get("video");
            if (!C || !e) return;
            const a = y().findIndex(C, (a => {
              let {
                id: i
              } = a;
              return i === e
