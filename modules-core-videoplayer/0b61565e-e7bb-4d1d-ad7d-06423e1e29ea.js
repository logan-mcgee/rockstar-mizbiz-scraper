! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "0b61565e-e7bb-4d1d-ad7d-06423e1e29ea", e._sentryDebugIdIdentifier = "sentry-dbid-0b61565e-e7bb-4d1d-ad7d-06423e1e29ea")
  } catch (e) {}
}();
  ...
  [889], {
    6889: (e, i, n) => {
      ...
      const r = (0, s.withIntl)((e => {
        ...
        if ("aria-label" in b && b["aria-label"] && (y = "_blank" === v ? `${b["aria-label"]} ${k.formatMessage(a.aria_label_open_new_window)}` : b["aria-label"]), (0, _.useEffect)((() => {
            ...
            children: [(0, t.jsxs)("div", {
              ...
              children: [(0, t.jsx)("div", {
                ...
                children: l && (0, t.jsx)("span", {
                  ...
                  children: o(k.DZ.videoplayer_playlist_active_badge)
                })
              })]
            }), (0, t.jsx)("div", {
      ...
      S.displayName = "VideoPlaylistItem";
      const P = S,
        x = {
        ...
        I = e => {
          ...
          const a = (0, o.useLocation)(),
            ...
            d = (0, _.useRef)(null),
            p = (0, _.createRef)(),
            [m, u] = (0, _.useState)(null),
            [k, f] = (0, _.useState)(n),
            [g, v] = (0, _.useState)(!0),
            [b, y] = (0, _.useState)(!1),
            w = (0, _.useCallback)(((e, i) => () => {
              l && l(e, i), f(e), c({
                event: "video_thumbnail_click",
                link_url: `${a.pathname}?video=${e}`,
                video_id: e,
                video_title: s[i].title,
                video_type: s[i].groupType,
                video_language: r,
          ...
          return (0, _.useEffect)((() => {
            ...
            children: [(0, t.jsx)("h2", {
              ...
              ref: d,
              className: [x.videos, g ? "" : x.userNotScrolledToTopOfList, b ? "" : x.userNotScrolledToBottomOfList].filter((e => e)).join(" "),
              onScroll: e => {
                let {
                  target: {
                    scrollTop: i,
                ...
                0 === i ? v(!0) : i + _ === n ? y(!0) : (v(!1), y(!1))
              },
              children: s.map(((e, i) => (0, t.jsx)(P, {
                ref: e.id === k ? p : null,
                title: e.title,
        ...
        z = (0, s.withIntl)((e => {
          ...
          const {
            ...
            tagIds: l,
            locale: n
          }, [g, v] = (0, o.useSearchParams)(), C = Number(g.get("start") ?? 0), [N, j] = (0, _.useState)(0), {
            loading: S,
            data: P
    ...
    6091: e => {
      ...
      function n(e, i) {
        if ("FragmentSpread" === e.kind) i.add(e.name.value);
          ...
          var _ = e.type;
          "NamedType" === _.kind && i.add(_.name.value)
        }
      ...
      function s(e, i) {
        for (var n = 0; n < e.definitions.length; n++) {
          var _ = e.definitions[n];
          if (_.name && _.name.value == i) return _
        }
      }
      i.definitions.forEach((function(e) {
        if (e.name) {
          var i = new Set;
          n(e, i), _[e.name.value] = i
        }
        ...
        for (l.forEach((function(e) {
          ...
          o = new Set, c.forEach((function(e) {
            a.has(e) || (a.add(e), (_[e] || new Set).forEach((function(e) {
              o.add(e)
            })))
          }))
        }
