! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "3f90d4a6-4691-4b4b-bd8a-0a9379caa17e", e._sentryDebugIdIdentifier = "sentry-dbid-3f90d4a6-4691-4b4b-bd8a-0a9379caa17e")
  } catch (e) {}
}();
  ...
  [4444], {
    4444: (e, t, s) => {
      ...
      const _ = (d = e => {
        ...
        let y = "";
        if ("aria-label" in w && w["aria-label"] && (y = "_blank" === h ? `${w["aria-label"]} ${g.formatMessage(r.aria_label_open_new_window)}` : w["aria-label"]), (0, a.useEffect)((() => {
          ...
          return (0, c.jsxs)("a", {
            ...
            ref: p,
            role: u,
            children: [t, "_blank" === h && !y && (0, c.jsx)("span", {
              className: o,
      ...
      const R = G,
        ...
        C = e => {
          ...
          return (0, a.useEffect)((() => {
            ...
            children: [(0, c.jsx)("h4", {
              ...
              ref: u,
              className: [S.videos, k ? "" : S.userNotScrolledToTopOfList, h ? "" : S.userNotScrolledToBottomOfList].filter((e => e)).join(" "),
              onScroll: e => {
                let {
                  target: {
                    scrollTop: t,
        ...
        E = (0, i.withIntl)((e => {
          ...
          const {
            ...
            tagIds: r,
            locale: s
          }, [g, k] = (0, n.useSearchParams)(), v = Number(g.get("start") ?? 0), [z, j] = (0, a.useState)(0), {
            loading: N,
            data: G
