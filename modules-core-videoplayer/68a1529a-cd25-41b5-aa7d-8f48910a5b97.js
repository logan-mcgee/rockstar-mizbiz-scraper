! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "68a1529a-cd25-41b5-aa7d-8f48910a5b97", e._sentryDebugIdIdentifier = "sentry-dbid-68a1529a-cd25-41b5-aa7d-8f48910a5b97")
  } catch (e) {}
}();
  ...
  [889], {
    6889: (e, i, s) => {
      ...
      const c = (0, a.withIntl)((e => {
        ...
        if ("aria-label" in y && y["aria-label"] && (h = "_blank" === v ? `${y["aria-label"]} ${k.formatMessage(r.aria_label_open_new_window)}` : y["aria-label"]), (0, n.useEffect)((() => {
          ...
          return (0, l.jsxs)("a", {
            ...
            "aria-label": h,
            ref: p,
            children: [i, "_blank" === v && !h && (0, l.jsx)("span", {
              className: _,
        ...
        const w = Object.keys(y).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, i) => ({
          ...e,
          [i]: f[i]
        })), {});
