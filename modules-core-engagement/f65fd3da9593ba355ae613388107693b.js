/*! For license information please see f65fd3da9593ba355ae613388107693b.js.LICENSE.txt */
(self.webpackChunk_rockstargames_modules_core_engagement = self.webpackChunk_rockstargames_modules_core_engagement || []).push([
  [175], {
      ...
      const N = (e, t) => {
        ...
        F = {
          attachEvents: function() {
            ...
            e.onTouchStart = V.bind(e), e.onTouchMove = D.bind(e), e.onTouchEnd = $.bind(e), n.cssMode && (e.onScroll = B.bind(e)), e.onClick = R.bind(e), i.touch && !j && (t.addEventListener("touchstart", _), j = !0), N(e, "on")
          },
    ...
    681: (e, t, n) => {
      ...
      const _ = (e, t) => t && "number" == typeof e ? t.transform(e) : e,
      ...
      function st(e, t, n) {
        return (i, s) => {
          je(i) && !it() && (e.animationState && e.animationState.setActive(Ie.Hover, t), n && n(i, s))
        }
      }
      ...
      class Nt {
        ...
        add(e) {
          return jt(this.subscriptions, e), () => _t(this.subscriptions, e)
        }
        notify(e, t, n) {
      ...
      const _n = (e, t) => {
        ...
        Nn = (e, t) => {
          const n = {
            ...
            i = {};
          for (const s in n) void 0 !== e[s] && void 0 !== t[s] && (i[s] = jn(e[s], t[s]));
          return e => {
        ...
        Fn = (e, t) => {
          const n = sn.createTransformer(t),
            i = Qt(e),
            s = Qt(t);
          return i.numColors === s.numColors && i.numNumbers >= s.numNumbers ? lt(_n(i.values, s.values), n) : (En(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), n => `${n>0?t:e}`)
        },
        zn = (e, t, n) => {
          const i = t - e;
          return 0 === i ? 1 : (n - e) / i
      ...
      function Un(e, t, {
        ...
        const o = function(e, t, n) {
            const i = [],
              s = n || ("number" == typeof(r = e[0]) ? Gn : "string" == typeof r ? Zt.test(r) ? Bn : Fn : Array.isArray(r) ? _n : "object" == typeof r ? Nn : Gn);
            var r;
            const o = e.length - 1;
            for (let n = 0; n < o; n++) {
              let r = s(e[n], e[n + 1]);
        ...
        let t = function(e) {
          return t => Promise.all(t.map((({
            ...
            if (e.notify("AnimationStart", t), Array.isArray(t)) {
              const s = t.map((t => _i(e, t, n)));
              i = Promise.all(s)
            } else if ("string" == typeof t) i = _i(e, t, n);
            else {
      ...
      class Zi {
        constructor(e, t, {
          ...
          if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.updatePoint = () => {
              ...
              this.lastMoveEvent = e, this.lastMoveEventInfo = Ki(t, this.transformPagePoint), je(e) && 0 === e.buttons ? this.handlePointerUp(e, t) : Vt.update(this.updatePoint, !0)
            ...
            }, _e(e) && e.touches.length > 1) return;
      ...
      function Fs(e, t, n = 1) {
        ...
        return r ? r.trim() : _s(s) ? Fs(s, t, n + 1) : s
      }
      ...
      class Br {
        ...
        add(e) {
          jt(this.members, e), e.scheduleRender()
        }
        remove(e) {
          if (_t(this.members, e), e === this.prevLead && (this.prevLead = void 0), e === this.lead) {
      ...
      class Nr {
        ...
        forEach(e) {
          this.isDirty && this.children.sort(_r), this.isDirty = !1, this.children.forEach(e)
        }
      }
      const Fr = ["", "X", "Y", "Z"];
      let zr = 0;
      ...
      function Gr({
        ...
        return class {
          ...
          calcProjection() {
            ...
            os(this.projectionDelta, this.layoutCorrected, l, this.latestValues), this.projectionTransform = jr(this.projectionDelta, this.treeScale), this.projectionTransform === d && this.treeScale.x === c && this.treeScale.y === u || (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", l))
          }
          hide() {
            this.isVisible = !1
          }
          ...
          getProjectionStyles(e = {}) {
            ...
            this.applyTransformsToTarget(), s.transform = jr(this.projectionDeltaWithTransform, this.treeScale, a), r && (s.transform = r(a, s.transform));
            const {
              x: l,
              y: c
