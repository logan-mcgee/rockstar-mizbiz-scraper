  ...
  [648], {
    ...
    8648: (e, a, t) => {
      ...
      const za = He((e => {
          ...
          return (0, o.jsxs)("div", {
            className: [Da.rating, x ? Da.withDescriptors : Da.withOutDescriptors, m || ""].join(" "),
            style: (0, D.safeStyles)(c),
            children: [(0, o.jsx)(l, {
              to: p.url_rating,
              target: "_blank",
              children: (0, o.jsx)("img", {
                alt: h.formatMessage($a.components_ratings_link_alt, {
      ...
      const bt = {
        ...
        yt = e => {
          ...
          return (0, o.jsx)("div", {
            ...
            style: {
              background: `url(${a.screencap}?im=Resize=640) center/cover`
            }
          })
        },
        Nt = e => {
