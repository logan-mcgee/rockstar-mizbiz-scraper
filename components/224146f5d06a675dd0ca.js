    ...
    3699: (e, a, t) => {
      ...
      const Aa = e => {
        ...
        Pa = e => {
          ...
          return a ? (0, d.jsx)("div", {
            className: [Oa.skeleton, Oa[a]].join(" ")
          }) : null
        },
        Ga = "a3203eaeb7aa17a50d1d",
        Ha = "da5aca5b612ae73726aa",
        qa = {
          0: {
            spaceBetween: 8
          },
      ...
      const za = e => {
          ...
          const s = t ?? [a],
            {
              data: r
            } = (0, g.useQuery)(Wa.TinaModulesInfo, {
              variables: {
                ids: s,
                sync: n
              },
      ...
      const Ya = {
        ...
        Za = e => {
          ...
          const {
            ...
            refetch: c
          } = (0, g.useQuery)(Xa.UserGetVote, {
            skip: !0
          }), [m] = (0, g.useMutation)(Xa.UserCastVote), [u, v] = (0, o.useState)(null), f = (0, o.useCallback)((async e => {
            s({
              event_action: e ? "like" : "dislike",
              event_category: "cta",
              event: "cta_" + (e ? "like" : "dislike"),
          ...
          return (0, o.useEffect)((async () => {
            ...
            className: Ya.userVote,
            children: (0, d.jsxs)("div", {
              className: Ya.voteContent,
              children: [(0, d.jsxs)("div", {
                className: Ya.info,
                children: [(0, d.jsx)("h3", {
                  children: n
                ...
                className: [Ya.voteButtons, l ? "" : Ya.loggedOutButtons].join(" "),
                children: [(0, d.jsx)("button", {
                  onClick: () => f(!0),
                  className: [Ya.upVote, u ? Ya.voteButtonActive : ""].join(" ")
                }), (0, d.jsx)("button", {
                  className: [Ya.downVote, !1 === u ? Ya.voteButtonActive : ""].join(" "),
                  onClick: () => f(!1)
                })]
              })]
            })
          ...
          return (0, o.useEffect)((() => {
            if (m.current && g.current) {
              ...
              const a = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
                ...
                d = e => {
                  l(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !g.current?.classList.contains(Ka.dragging) || a() && (document.body.style.overflowY = "hidden")
                },
                c = () => {
                  a() && (document.body.style.overflowY = "scroll"), l(0)
                },
                o = e => {
                  "press" === e.type && m.current?.classList.add(`${Ka.disableClick}`), "tap" === e.type && (m.current?.classList.remove(`${Ka.disableClick}`), document.elementFromPoint(e.center.x, e.center.y).click())
                },
                v = () => {
                  a() && (document.body.style.overflowY = "scroll"), m.current && m.current.classList.remove(`${Ka.disableClick}`)
                },
                f = () => {
            ...
            children: [(0, d.jsx)("div", {
              ...
              ref: m,
              children: (0, d.jsx)("div", {
                className: `${Ka.items} ${0!==r?Ka.dragging:""}`,
                ref: g,
                style: {
              ...
              children: [(0, d.jsx)("div", {
                ...
                children: i.map(((e, i) => (0, d.jsx)(c, {
                  ...
                  title: e.title,
                  children: (0, d.jsxs)("div", {
                    className: [Ka.info, i === n ? Ka.active : ""].join(" "),
                    children: [(0, d.jsxs)("div", {
                      className: Ka.title,
                      children: [(0, d.jsx)("div", {
        ...
        at = (0, E.withTranslations)((e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            children: a.map((e => (0, d.jsx)(st, {
              video: e,
              gameTitleNecessary: n
            }, e.id)))
          }), (0, d.jsxs)("section", {
            className: et.videoList,
            children: [(0, d.jsxs)("h3", {
              className: et.sectionHeader,
              children: [i, (0, d.jsxs)("div", {
                className: et.arrowNav,
                children: [(0, d.jsx)("div", {
                  className: [et.arrow, et.previous, 0 === g ? et.disabled : ""].join(" "),
                  onClick: () => f(g - 1)
                }), (0, d.jsx)("div", {
                  className: [et.arrow, et.next, g === Math.ceil(r.length / c) - 1 ? et.disabled : ""].join(" "),
                  onClick: () => f(g + 1)
                })]
              })]
            }), (0, d.jsx)("div", {
              className: et.items,
              children: (0, d.jsx)("div", {
                className: et.trackWrapper,
                children: (0, d.jsx)("div", {
                  className: [et.track, 0 !== p ? et.dragging : ""].join(" "),
                  ref: l,
                  style: {
      ...
      class rt extends o.Component {
        ...
        render() {
          return null !== this.state.error.code ? (0, d.jsx)(tt, {
      ...
      const mt = e => {
        ...
        ht = function() {
          ...
          return bt[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "imageMask"][e]
        }
    },
    6079: e => {
      var a = {
