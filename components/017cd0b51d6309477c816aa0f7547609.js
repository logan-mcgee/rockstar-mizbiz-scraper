/*! For license information please see 017cd0b51d6309477c816aa0f7547609.js.LICENSE.txt */
    ...
    9885: function(e) {
      e.exports = function() {
        ...
        var g, y = x(Array.prototype.forEach),
          ...
          S = x(String.prototype.trim),
          _ = x(RegExp.prototype.test),
        ...
        return function t() {
          ...
          var he, ge, ye = G,
            ...
            we = K,
            Se = null,
            _e = L({}, [].concat(r(D), r(R), r(M), r(F), r(H))),
            ke = null,
          ...
          var yt = function(e) {
            ...
            At = function(e) {
              ...
              if (Et("uponSanitizeElement", e, {
                  tagName: r,
                  allowedTags: Se
                }), e.hasChildNodes() && !Nt(e.firstElementChild) && (!Nt(e.content) || !Nt(e.content.firstElementChild)) && _(/<[/\w]/g, e.innerHTML) && _(/<[/\w]/g, e.textContent)) return yt(e), !0;
              if ("select" === r && _(/<template/i, e.innerHTML)) return yt(e), !0;
              if (!Se[r] || Oe[r]) {
                if (!Oe[r] && St(r)) {
                  if (Le.tagNameCheck instanceof RegExp && _(Le.tagNameCheck, r)) return !1;
            ...
            wt = function(e, t, n) {
              ...
              if (Re && !Ce[t] && _(Te, t));
                ...
                if (!(St(e) && (Le.tagNameCheck instanceof RegExp && _(Le.tagNameCheck, e) || Le.tagNameCheck instanceof Function && Le.tagNameCheck(e)) && (Le.attributeNameCheck instanceof RegExp && _(Le.attributeNameCheck, t) || Le.attributeNameCheck instanceof Function && Le.attributeNameCheck(t)) || "is" === t && Le.allowCustomizedBuiltInElements && (Le.tagNameCheck instanceof RegExp && _(Le.tagNameCheck, n) || Le.tagNameCheck instanceof Function && Le.tagNameCheck(n)))) return !1
              } else if (Je[t]);
              else if (_(we, A(n, Ae, "")));
              ...
              if (l) {
                ...
                for (i = l.length; i--;) {
                  var s = n = l[i],
                    u = s.name,
                    m = s.namespaceURI;
                  if (r = "value" === u ? n.value : S(n.value), a = ge(u), c.attrName = a, c.attrValue = r, c.keepAttr = !0, c.forceKeepAttr = void 0, Et("uponSanitizeAttribute", t, c), r = c.attrValue, !c.forceKeepAttr && (bt(u, t), c.keepAttr))
                    if (Ie || !_(/\/>/i, r)) {
            ...
            kt = function e(t) {
              var n, r = Tt(t);
              for (Et("beforeSanitizeShadowDOM", t, null); n = r.nextNode();) Et("uponSanitizeShadowNode", n, null), At(n) || (n.content instanceof l && e(n.content), _t(n));
          ...
          return o.sanitize = function(t) {
            ...
            if (He || mt(f), o.removed = [], "string" == typeof t && (Ye = !1), Ye) {
              if (t.nodeName) {
                var p = ge(t.nodeName);
                if (!Se[p] || Oe[p]) throw k("root node is forbidden and cannot be sanitized in-place")
              }
            ...
            for (var d = Tt(Ye ? t : r); c = d.nextNode();) 3 === c.nodeType && c === u || At(c) || (c.content instanceof l && kt(c.content), _t(c), u = c);
            ...
            return Ue && Se["!doctype"] && r.ownerDocument && r.ownerDocument.doctype && r.ownerDocument.doctype.name && _(Z, r.ownerDocument.doctype.name) && (h = "<!DOCTYPE " + r.ownerDocument.doctype.name + ">\n" + h), Fe && (h = A(h, ye, " "), h = A(h, be, " "), h = A(h, ve, " ")), ae && je ? ae.createHTML(h) : h
