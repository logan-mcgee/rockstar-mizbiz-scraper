    ...
    3482: (e, a, t) => {
      ...
      const f = {
        ...
        k = e => {
          ...
          }), [n, s] = (0, o.useState)(), [r, l] = (0, o.useState)(), [c, m] = (0, o.useState)(), [u, k] = (0, o.useState)(!1), [x, y] = (0, o.useState)(!1), [N, _] = (0, o.useState)(new HTMLAudioElement), [j, S] = (0, o.useState)({
            current: 0,
            duration: 0
          }), [w, T] = (0, o.useState)(!0);
          return (0, o.useEffect)((() => {
            const e = "audio",
              a = a => {
                a?.data?.rockstarAudioPlayerPlayTrackId && (l(a.data.rockstarAudioPlayerPlayTrackId), T(!1), y(!0)), x && a?.data?.attentionBlurredElsewhere && a?.data?.from !== e && y(!1)
              };
            ...
            N && (x ? N.play() : N.pause(), k(!1))
          }), [x, N, c?.id]), (0, o.useEffect)((() => {
            if (!r) return;
            const {
              tracks: e
      ...
      const Le = function(e) {
        ...
        Ie = Le((e => {
          ...
          const {
            track: u
          } = (0, L.useGtmTrack)(), g = (0, o.useRef)(null), v = (0, o.useRef)(null), f = (0, o.useRef)(null), [p, b] = (0, o.useState)(null), [h, k] = (0, o.useState)(null), [, x] = (0, o.useState)({}), [y, N] = (0, o.useState)(), S = {
            0: {
              spaceBetween: r ?? 16
            },
            1024: {
      ...
      const Ye = e => {
        ...
        Xe = e => {
          ...
          return n && (i["--border-image-source"] = `url(${(0,_.useGetCdnSource)(n)})`), (0, d.jsx)("div", {
            className: (0, _.classList)(Qe.border, t),
            style: {
              ...i
            }
          })
        ...
        Ze = e => e?.images ? (0, d.jsx)("div", {
          className: (0, _.classList)(Qe.layeredImage, Qe[e?.variantClass], Qe[e?.wrapperSizeClass]),
          style: {
            ...e?.style ?? {}
          },
          children: (0, d.jsxs)("div", {
            className: Qe.layersWrapper,
            children: [e?.images?.map(((e, a) => {
              ...
              return (0, d.jsx)(W, {
                ...
                imageStyle: m,
                className: (0, _.classList)(o, g, Qe.imageLayer, Qe[i], Qe[n], Qe[s], Qe[r], Qe[l]),
                alt: u
              }, c ?? ++a)
            })), e?.borderImage && (0, d.jsx)(Xe, {
              style: e?.borderImage,
      ...
      const _a = Le((e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            className: `${Na.rating} ${u.rating_descriptors?Na.withDescriptors:""} ${m||""}`,
            ...
            children: [(0, d.jsx)(c, {
              ...
              className: Na.descriptors,
              dangerouslySetInnerHTML: {
                __html: u.rating_descriptors
              }
            }), u.rating_footer && (0, d.jsx)("p", {
              className: Na.interactiveElement,
              dangerouslySetInnerHTML: {
        ...
        Da = (0, o.forwardRef)(((e, a) => {
          const {
            ...
            track: s
          } = (0, L.useGtmTrack)(), [r, l] = (0, o.useState)(a?.current);
          return (0, o.useEffect)((() => {
            ...
            (0, o.useEffect)((() => {
              ...
              const e = t ?? window,
                r = () => e.removeEventListener("scroll", l),
                l = () => {
                  const e = document.documentElement,
                    l = document.body,
                    d = t?.scrollTop || e.scrollTop || l.scrollTop,
                    c = t?.scrollHeight || e.scrollHeight || l.scrollHeight,
                    {
                      clientHeight: o
                    } = e,
                    m = d / (c - o) * 100;
              ...
              return e.addEventListener("scroll", l), r
            }), [s, r, i, t])
          })(t, (e => {
            let {
              scrollY: a
        ...
        Oa = e => {
          ...
          return a ? (0, d.jsx)("div", {
            className: [Ma.skeleton, Ma[a]].join(" ")
          }) : null
        },
        Pa = "a3203eaeb7aa17a50d1d",
        Ga = "da5aca5b612ae73726aa",
        Ha = {
          0: {
            spaceBetween: 8
          },
      ...
      const Wa = e => {
          ...
          const s = t ?? [a],
            {
              data: r
            } = (0, g.useQuery)(Ua.TinaModulesInfo, {
              variables: {
                ids: s,
                sync: n
              },
      ...
      const Qa = {
        ...
        Xa = e => {
          ...
          const {
            ...
            refetch: c
          } = (0, g.useQuery)(Ya.UserGetVote, {
            skip: !0
          }), [m] = (0, g.useMutation)(Ya.UserCastVote), [u, v] = (0, o.useState)(null), f = (0, o.useCallback)((async e => {
            s({
              event_action: e ? "like" : "dislike",
              event_category: "cta",
              event: "cta_" + (e ? "like" : "dislike"),
          ...
          return (0, o.useEffect)((() => {
            if (m.current && g.current) {
              ...
              const a = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
                ...
                d = e => {
                  l(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !g.current?.classList.contains(Za.dragging) || a() && (document.body.style.overflowY = "hidden")
                },
                c = () => {
                  a() && (document.body.style.overflowY = "scroll"), l(0)
                },
                o = e => {
                  "press" === e.type && m.current?.classList.add(`${Za.disableClick}`), "tap" === e.type && (m.current?.classList.remove(`${Za.disableClick}`), document.elementFromPoint(e.center.x, e.center.y).click())
                },
                v = () => {
                  a() && (document.body.style.overflowY = "scroll"), m.current && m.current.classList.remove(`${Za.disableClick}`)
                },
                f = () => {
            ...
            children: [(0, d.jsx)("div", {
              ...
              ref: m,
              children: (0, d.jsx)("div", {
                className: `${Za.items} ${0!==r?Za.dragging:""}`,
                ref: g,
                style: {
              ...
              children: [(0, d.jsx)("div", {
                ...
                children: i.map(((e, i) => (0, d.jsx)(c, {
                  ...
                  title: e.title,
                  children: (0, d.jsxs)("div", {
                    className: [Za.info, i === n ? Za.active : ""].join(" "),
                    children: [(0, d.jsxs)("div", {
                      className: Za.title,
                      children: [(0, d.jsx)("div", {
          ...
          return (0, o.useEffect)((() => {
            ...
            children: [(0, d.jsxs)("h3", {
              ...
              children: [i, (0, d.jsxs)("div", {
                ...
                children: [(0, d.jsx)("div", {
                  className: [Ja.arrow, Ja.previous, 0 === g ? Ja.disabled : ""].join(" "),
                  onClick: () => f(g - 1)
                }), (0, d.jsx)("div", {
                  className: [Ja.arrow, Ja.next, g === Math.ceil(r.length / c) - 1 ? Ja.disabled : ""].join(" "),
                  onClick: () => f(g + 1)
                })]
              })]
            }), (0, d.jsx)("div", {
              ...
              children: (0, d.jsx)("div", {
                ...
                children: (0, d.jsx)("div", {
                  className: [Ja.track, 0 !== p ? Ja.dragging : ""].join(" "),
                  ref: l,
                  style: {
        ...
        it = e => {
          ...
          return (0, d.jsx)("div", {
            className: [tt.screencap, t ? tt.screencapLoaded : ""].join(" "),
            style: {
      ...
      const ot = (0, o.forwardRef)(((e, a) => {
        ...
        bt = function() {
          ...
          return pt[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "imageMask"][e]
        }
    },
    6079: e => {
      var a = {
