/*! For license information please see 9a055bc1d085f3471bc9.js.LICENSE.txt */
(self.webpackChunk_rockstargames_components = self.webpackChunk_rockstargames_components || []).push([
  [709], {
    ...
    4709: (e, l, a) => {
      ...
      console.log("ConditionalBlockField", f);
      const v = e => {
        let {
      ...
      console.log("ConditionalBlockTemplate", v);
      const g = v,
        h = e => {
          let {
            parent: l = null
      ...
      const P = function() {
          ...
          return {
            ...
            itemProps: e => (0, t.itemPropsWithKey)(e, {
              label: (0, T.stripHTML)(`${e?.name??e?.[t.TINA_MEMOQ_PREFIX]?.content??"New"} [List Item]`)
            })
          }
        },
        L = e => {
        ...
        G = {
          ...
          Component: e => {
            ...
            const {
              ...
              data: i
            } = (0, B.useQuery)(D.TinaModulesList, {
              variables: n
            });
            if (!i) return null;
            const o = [{
