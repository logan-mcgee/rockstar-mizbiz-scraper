/*! For license information please see 7025890c28cc1c619082.js.LICENSE.txt */
      ...
      e.exports = function() {
        ...
        return function t() {
          ...
          var ie = ee(y, a),
            ...
            de = {};
          try {
            de = C(i).documentMode ? i.documentMode : {}
          } catch (e) {}
          var he = {};
          ...
          var ge, ye, be = W,
            ...
            Se = V,
            ke = null,
            _e = D({}, [].concat(o(R), o(M), o(I), o(U), o(z))),
            xe = null,
            Oe = D({}, [].concat(o(P), o(B), o(j), o(G))),
            ...
            pt = function(t) {
              ut && ut === t || (t && "object" === e(t) || (t = {}), t = C(t), ge = ge = -1 === ct.indexOf(t.PARSER_MEDIA_TYPE) ? st : t.PARSER_MEDIA_TYPE, ye = "application/xhtml+xml" === ge ? A : N, ke = "ALLOWED_TAGS" in t ? D({}, t.ALLOWED_TAGS, ye) : _e, xe = "ALLOWED_ATTR" in t ? D({}, t.ALLOWED_ATTR, ye) : Oe, it = "ALLOWED_NAMESPACES" in t ? D({}, t.ALLOWED_NAMESPACES, A) : lt, Qe = "ADD_URI_SAFE_ATTR" in t ? D(C(et), t.ADD_URI_SAFE_ATTR, ye) : et, Ze = "ADD_DATA_URI_TAGS" in t ? D(C(Je), t.ADD_DATA_URI_TAGS, ye) : Je, Ve = "FORBID_CONTENTS" in t ? D({}, t.FORBID_CONTENTS, ye) : Xe, Ce = "FORBID_TAGS" in t ? D({}, t.FORBID_TAGS, ye) : {}, Le = "FORBID_ATTR" in t ? D({}, t.FORBID_ATTR, ye) : {}, Ke = "USE_PROFILES" in t && t.USE_PROFILES, Re = !1 !== t.ALLOW_ARIA_ATTR, Me = !1 !== t.ALLOW_DATA_ATTR, Ie = t.ALLOW_UNKNOWN_PROTOCOLS || !1, Fe = t.SAFE_FOR_TEMPLATES || !1, Ue = t.WHOLE_DOCUMENT || !1, Pe = t.RETURN_DOM || !1, Be = t.RETURN_DOM_FRAGMENT || !1, je = t.RETURN_TRUSTED_TYPE || !1, ze = t.FORCE_BODY || !1, Ge = !1 !== t.SANITIZE_DOM, We = t.SANITIZE_NAMED_PROPS || !1, Ye = !1 !== t.KEEP_CONTENT, $e = t.IN_PLACE || !1, Se = t.ALLOWED_URI_REGEXP || Se, ot = t.NAMESPACE || rt, t.CUSTOM_ELEMENT_HANDLING && ft(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (De.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck), t.CUSTOM_ELEMENT_HANDLING && ft(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (De.attributeNameCheck = t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), t.CUSTOM_ELEMENT_HANDLING && "boolean" == typeof t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && (De.allowCustomizedBuiltInElements = t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), Fe && (Me = !1), Be && (Pe = !0), Ke && (ke = D({}, o(z)), xe = [], !0 === Ke.html && (D(ke, R), D(xe, P)), !0 === Ke.svg && (D(ke, M), D(xe, B), D(xe, G)), !0 === Ke.svgFilters && (D(ke, I), D(xe, B), D(xe, G)), !0 === Ke.mathMl && (D(ke, U), D(xe, j), D(xe, G))), t.ADD_TAGS && (ke === _e && (ke = C(ke)), D(ke, t.ADD_TAGS, ye)), t.ADD_ATTR && (xe === Oe && (xe = C(xe)), D(xe, t.ADD_ATTR, ye)), t.ADD_URI_SAFE_ATTR && D(Qe, t.ADD_URI_SAFE_ATTR, ye), t.FORBID_CONTENTS && (Ve === Xe && (Ve = C(Ve)), D(Ve, t.FORBID_CONTENTS, ye)), Ye && (ke["#text"] = !0), Ue && D(ke, ["html", "head", "body"]), ke.table && (D(ke, ["tbody"]), delete Ce.tbody), m && m(t), ut = t)
            },
          ...
          var vt = function(e) {
            ...
            _t = function(e) {
              var t;
              if (kt("beforeSanitizeElements", e, null), wt(e)) return Tt(e), !0;
              ...
              return e instanceof u && !vt(e) ? (Tt(e), !0) : "noscript" !== n && "noembed" !== n || !_(/<\/no(script|embed)/i, e.innerHTML) ? (Fe && 3 === e.nodeType && (t = e.textContent, t = w(t, be, " "), t = w(t, ve, " "), t = w(t, Te, " "), e.textContent !== t && (T(r.removed, {
                element: e.cloneNode()
              }), e.textContent = t)), kt("afterSanitizeElements", e, null), !1) : (Tt(e), !0)
            },
            xt = function(e, t, n) {
              ...
              if (l) {
                ...
                for (i = l.length; i--;) {
                  var s = n = l[i],
                    u = s.name,
                    m = s.namespaceURI;
                  if (o = "value" === u ? n.value : k(n.value), a = ye(u), c.attrName = a, c.attrValue = o, c.keepAttr = !0, c.forceKeepAttr = void 0, kt("uponSanitizeAttribute", t, c), o = c.attrValue, !c.forceKeepAttr && (Nt(u, t), c.keepAttr))
                    if (_(/\/>/i, o)) Nt(u, t);
                    else {
            ...
            Ct = function e(t) {
              var n, r = Et(t);
              for (kt("beforeSanitizeShadowDOM", t, null); n = r.nextNode();) kt("uponSanitizeShadowNode", n, null), _t(n) || (n.content instanceof l && e(n.content), Dt(n));
          ...
          return r.sanitize = function(t) {
            ...
            if (He || pt(f), r.removed = [], "string" == typeof t && ($e = !1), $e) {
              if (t.nodeName) {
                var p = ye(t.nodeName);
                if (!ke[p] || Ce[p]) throw x("root node is forbidden and cannot be sanitized in-place")
              }
            } else if (t instanceof s) 1 === (i = (o = At("\x3c!----\x3e")).ownerDocument.importNode(t, !0)).nodeType && "BODY" === i.nodeName || "HTML" === i.nodeName ? o = i : o.appendChild(i);
            else {
              if (!Pe && !Fe && !Ue && -1 === t.indexOf("<")) return ie && je ? ie.createHTML(t) : t;
              if (!(o = At(t))) return Pe ? null : je ? le : ""
            }
            o && ze && Tt(o.firstChild);
            for (var d = Et($e ? t : o); c = d.nextNode();) 3 === c.nodeType && c === u || _t(c) || (c.content instanceof l && Ct(c.content), Dt(c), u = c);
            ...
            return Ue && ke["!doctype"] && o.ownerDocument && o.ownerDocument.doctype && o.ownerDocument.doctype.name && _(J, o.ownerDocument.doctype.name) && (h = "<!DOCTYPE " + o.ownerDocument.doctype.name + ">\n" + h), Fe && (h = w(h, be, " "), h = w(h, ve, " "), h = w(h, Te, " ")), ie && je ? ie.createHTML(h) : h
