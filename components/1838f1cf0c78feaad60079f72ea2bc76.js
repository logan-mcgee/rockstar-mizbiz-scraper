/*! For license information please see 1838f1cf0c78feaad60079f72ea2bc76.js.LICENSE.txt */ ! function() {
  try {
    ...
    8931: (e, t, s) => {
      ...
      e.exports = function(e, t, s) {
        ...
        function w(t) {
          var s = o,
            i = d;
          return o = d = void 0, f = t, p = e.apply(i, s)
        }

        function b(e) {
          var s = e - m;
          return void 0 === m || s >= t || s < 0 || v && e - f >= c
        }
        ...
        function T() {
          var e = r(),
            s = b(e);
          if (o = arguments, d = this, m = e, s) {
            if (void 0 === u) return function(e) {
              return f = e, u = setTimeout(y, t), h ? w(e) : p
            }(m);
            if (v) return clearTimeout(u), u = setTimeout(y, t), w(m)
          }
        ...
        return t = n(t) || 0, i(s) && (h = !!s.leading, c = (v = "maxWait" in s) ? a(n(s.maxWait) || 0, t) : c, g = "trailing" in s ? !!s.trailing : g), T.cancel = function() {
          void 0 !== u && clearTimeout(u), f = 0, o = m = d = u = void 0
        }, T.flush = function() {
...
//# sourceMappingURL=1838f1cf0c78feaad60079f72ea2bc76.js.map