/*! For license information please see bb5a106e838200dbe853.js.LICENSE.txt */
      ...
      e.exports = function() {
        ...
        return function t() {
          ...
          var ie = Q(x, a),
            ...
            de = {};
          try {
            de = O(i).documentMode ? i.documentMode : {}
          } catch (e) {}
          var he = {};
          ...
          var ge, ye, be = G,
            ...
            Se = K,
            _e = null,
            ke = L({}, [].concat(r(D), r(R), r(M), r(F), r(H))),
            xe = null,
            Le = L({}, [].concat(r(z), r(P), r(B), r(j))),
            ...
            Ke = {},
            Ve = null,
            Xe = L({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]),
            Ze = null,
            Je = L({}, ["audio", "video", "img", "source", "image", "track"]),
            Qe = null,
            et = L({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
          ...
          var bt = function(e) {
            ...
            wt = function(e) {
              ...
              if (_(/[\u0080-\uFFFF]/, e.nodeName)) return bt(e), !0;
              var r = ye(e.nodeName);
              if (At("uponSanitizeElement", e, {
                  tagName: r,
                  allowedTags: _e
                }), e.hasChildNodes() && !Et(e.firstElementChild) && (!Et(e.content) || !Et(e.content.firstElementChild)) && _(/<[/\w]/g, e.innerHTML) && _(/<[/\w]/g, e.textContent)) return bt(e), !0;
              if ("select" === r && _(/<template/i, e.innerHTML)) return bt(e), !0;
              if (!_e[r] || Ce[r]) {
                if (!Ce[r] && _t(r)) {
                  if (Oe.tagNameCheck instanceof RegExp && _(Oe.tagNameCheck, r)) return !1;
              ...
              }(e) ? (bt(e), !0) : "noscript" !== r && "noembed" !== r || !_(/<\/no(script|embed)/i, e.innerHTML) ? (Ue && 3 === e.nodeType && (t = e.textContent, t = A(t, be, " "), t = A(t, ve, " "), t = A(t, Te, " "), e.textContent !== t && (v(o.removed, {
                element: e.cloneNode()
            ...
            St = function(e, t, n) {
              ...
              if (Me && !De[t] && _(Ne, t));
                ...
                if (!(_t(e) && (Oe.tagNameCheck instanceof RegExp && _(Oe.tagNameCheck, e) || Oe.tagNameCheck instanceof Function && Oe.tagNameCheck(e)) && (Oe.attributeNameCheck instanceof RegExp && _(Oe.attributeNameCheck, t) || Oe.attributeNameCheck instanceof Function && Oe.attributeNameCheck(t)) || "is" === t && Oe.allowCustomizedBuiltInElements && (Oe.tagNameCheck instanceof RegExp && _(Oe.tagNameCheck, n) || Oe.tagNameCheck instanceof Function && Oe.tagNameCheck(n)))) return !1
              } else if (Qe[t]);
              else if (_(Se, A(n, we, "")));
              ...
              if (l) {
                ...
                for (i = l.length; i--;) {
                  var s = n = l[i],
                    u = s.name,
                    m = s.namespaceURI;
                  if (r = "value" === u ? n.value : S(n.value), a = ye(u), c.attrName = a, c.attrValue = r, c.keepAttr = !0, c.forceKeepAttr = void 0, At("uponSanitizeAttribute", t, c), r = c.attrValue, !c.forceKeepAttr && (vt(u, t), c.keepAttr))
                    if (Fe || !_(/\/>/i, r)) {
            ...
            xt = function e(t) {
              var n, r = Nt(t);
              for (At("beforeSanitizeShadowDOM", t, null); n = r.nextNode();) At("uponSanitizeShadowNode", n, null), wt(n) || (n.content instanceof l && e(n.content), kt(n));
          ...
          return o.sanitize = function(t) {
            ...
            if (ze || ft(f), o.removed = [], "string" == typeof t && ($e = !1), $e) {
              if (t.nodeName) {
                var p = ye(t.nodeName);
                if (!_e[p] || Ce[p]) throw k("root node is forbidden and cannot be sanitized in-place")
              }
              ...
              if (!Be && !Ue && !He && -1 === t.indexOf("<")) return ie && Ge ? ie.createHTML(t) : t;
              if (!(r = Tt(t))) return Be ? null : Ge ? le : ""
            }
            r && Pe && bt(r.firstChild);
            for (var d = Nt($e ? t : r); c = d.nextNode();) 3 === c.nodeType && c === u || wt(c) || (c.content instanceof l && xt(c.content), kt(c), u = c);
            ...
            return He && _e["!doctype"] && r.ownerDocument && r.ownerDocument.doctype && r.ownerDocument.doctype.name && _(Z, r.ownerDocument.doctype.name) && (h = "<!DOCTYPE " + r.ownerDocument.doctype.name + ">\n" + h), Ue && (h = A(h, be, " "), h = A(h, ve, " "), h = A(h, Te, " ")), ie && Ge ? ie.createHTML(h) : h
