      ...
      const {
        ...
        return (0, t.useEffect)((() => {
          ...
          children: (0, l.jsx)("ol", {
            ...
            className: (0, c.classList)(n.itemList, n.noImg, n[r], n[u]),
          ...
          style: (0, i.safeStyles)(o),
          className: (0, c.classList)(n.itemList, n.custom, f ? n.noImg : "", r ? n[r] : "", u ? n[u] : "", m ?? ""),
    ...
    1752: (e, a, s) => {
      ...
      const f = "www",
        ...
        y = () => {
          const {
            ...
            return a?.split("=")[1]
          })(e), r = x, [o, c] = function(e, a) {
            let s = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const t = document.cookie.split("; "),
              r = `${e}=`,
              o = t.find((e => e.startsWith(r))),
              c = o?.substring(r.length, o.length);
            return c && !s || k(e, a), [c, (i = e, e => {
              k(i, e)
            })];
            var i
          }(`rockstarweb_lang.${a.cookieIdentifier}`, s ?? void 0);
          let i = r;
          return i = a.currentSite?.site === f ? v.find((e => e.subdomaincom === t)) || v.find((e => e.subdomaincom === s)) || r : v.find((e => e.iso === o)) || r, [i, c]
        };
      var N = s(5240);
      const j = e => {
        let {
      ...
      const P = {
        ...
        $ = e => {
          ...
          return (0, n.useEffect)((() => {
            ...
            return s.on("panstart", c), s.on("panleft", r), s.on("panright", r), s.on("panend", o), s.on("tap", r), () => {
              s.off("panstart", c), s.off("panleft", r), s.off("panright", r), s.off("panend", o), s.off("tap", r)
            }
        ...
        D = e => {
          ...
          }), [r, o] = (0, n.useState)(), [c, i] = (0, n.useState)(), [l, d] = (0, n.useState)(), [m, u] = (0, n.useState)(!1), [f, g] = (0, n.useState)(!1), [_, p] = (0, n.useState)(new HTMLAudioElement), [k, b] = (0, n.useState)({
            current: 0,
            duration: 0
          }), [h, v] = (0, n.useState)(!0);
          return (0, n.useEffect)((() => {
            const e = "audio",
              a = a => {
                a?.data?.rockstarAudioPlayerPlayTrackId && (i(a.data.rockstarAudioPlayerPlayTrackId), v(!1), g(!0)), f && a?.data?.attentionBlurredElsewhere && a?.data?.from !== e && g(!1)
              };
      ...
      const Q = {
        ...
        ee = e => {
          ...
          return (0, N.jsxs)("div", {
            className: (0, G.classList)(Q.deprecatedCarousel, Q[c], Q[`infinite_${!r}`], a ? Q.renderedWithChildren : "", o),
            style: t,
            ...
            }), (i?.title || i?.description) && (0, N.jsx)(Oe, {
              item: i
            })]
          })
        };
      ...
      const le = e => {
        ...
        me = e => {
          ...
          const {
            ...
            skip: !0
          }), [o] = (0, E.useMutation)(ne.UserCastVote), [c, i] = (0, n.useState)(null), l = (0, n.useCallback)((e => {
            (async () => {
      ...
      const be = e => {
          ...
          const [o, c] = (0, n.useState)(""), i = (0, n.useMemo)((() => ke()().getData()), []);
      ...
      const je = {
        ...
        Ie = e => {
          ...
          }), [f, s, k]), y = () => c ? (0, N.jsx)("span", {
            className: [we.icon, `icon-${i}`].join(" "),
            style: l,
      ...
      const Me = "rockstargames-modules-core-heroeb64520e04e486931cd65dc5b3fa61e8",
        ...
        Be = e => {
          ...
          const [c, i] = (0, ae.usePreloadImg)(r);
          let n = r;
          !1 === c && (t === Ee && (n = s(1820)), n = s(3976));
          const {
            width: l,
            height: d
          } = i, m = {
        ...
        Ue = e => {
          ...
          return 2 == c.length && c[1].length < 4 && "off" !== c[1].toLowerCase() && 45, (0, N.jsxs)(He, {
            ...
            children: [(0, N.jsx)(N.Fragment, {
              ...
              children: c.shift() && o && c.length >= 1 && (0, N.jsx)(Re, {
                min: 8,
                max: 1e3,
                mode: "single",
      ...
      const sa = {
        ...
        na = e => {
          ...
          const i = o ?? (t.startsWith(document.location.origin) ? "_self" : "_blank"),
            n = [ia.platformButton, ia[r]].join(" "),
        ...
        la = e => {
          ...
          return (0, N.jsxs)("div", {
            className: (0, G.classList)(ia.container, t),
            children: [(0, N.jsx)(aa.motion.div, {
              ...
              children: [(0, N.jsx)(aa.motion.div, {
                ...
                className: ia.expandedArea,
                animate: m ? "open" : "closed",
                variants: oa,
                initial: !1,
                children: [(0, N.jsx)("img", {
                  className: ia.closeButton,
                  onClick: () => u(!1),
                  onKeyDown: e => {
                    u(!1)
                  },
        ...
        pa = e => {
          ...
          const [c, i] = (0, n.useState)(!1), l = (0, E.useMutateState)(), {
            navHidden: d
          } = (0, E.useState)();
          return (0, n.useEffect)((() => {
            l({
      ...
      const ha = function(e) {
        ...
        Ca = e => {
          ...
          }), s), s.length ? c.length ? (0, N.jsx)(aa.motion.div, {
              ...
              return Object.entries(e).forEach((e => {
                ...
                if (s.has(t)) {
                  ...
                  Object.entries(r).forEach((r => {
                    ...
                    if (s.has(t) && s.has(o)) {
                      const t = `${s.get(o)}${e}`;
                      a[t] = "imageWidth" !== o ? c ? `${c}px` : "0px" : c ? `${c}vw` : "100vw"
                    }
                  }))
                }
              })), a
      ...
      const Ea = e => {
          ...
          children: (0, N.jsxs)("div", {
            ...
            children: [e?.images?.map(((e, a) => {
              ...
              return (0, N.jsx)(Pe, {
                ...
                imageStyle: d,
                className: (0, G.classList)(l, u, Va.imageLayer, Va[t], Va[r], Va[o], Va[c], Va[i]),
                alt: m
              }, n ?? ++a)
        ...
        Fa = e => {
          ...
          return (0, N.jsx)(Oa, {
            ...
            children: (0, N.jsx)("figure", {
              children: (0, N.jsxs)("div", {
                className: (0, G.classList)("rockstargames-modules-core-herocab262c98c7f5bb3e982d9b075b3c2a8", d ? "rockstargames-modules-core-herocefd6d8859aeec1057caed28caa160c3" : "", n?.hiddenMobile ? "hiddenMobile" : "", n?.hiddenLarge ? "hiddenLarge" : "", n?.className, i),
        ...
        qa = e => {
          ...
          const [o] = (0, C.useSearchParams)(), c = s.preview_images_parsed.newswire_block, i = {
      ...
      const Ya = (0, ae.withTranslations)((e => {
          ...
          const [o] = (0, C.useSearchParams)(), {
            tagId: c = null
          } = (0, C.useParams)(), [i, l] = (0, n.useState)(c ?? s ?? o.get("tag_id")), [d, m] = (0, n.useState)(1), [u, f] = (0, n.useState)([]), [g, _] = (0, n.useState)(null), {
            data: p
          } = (0, E.useQuery)(Ka(), {
            variables: {
              tagId: Number(i),
      ...
      const ss = (e, a) => {
        ...
        is = e => {
          ...
          return (0, ae.usePreloadImg)(_, (() => g(!0))), (0, N.jsx)(C.NavLink, {
            className: [cs.packCard, r, m ? cs.packCompleted : ""].join(" "),
            to: s,
            onClick: c,
            children: (0, N.jsxs)("div", {
              className: [cs.packCardImageBox, f ? cs.packCardImageLoaded : ""].join(" "),
              style: {
      ...
      const ks = e => n.createElement("svg", ps({
        ...
        ys = e => {
          let {
            ...
            isOpen: r,
            isHeaderVisible: o,
            menuClass: c = xs.navMenu,
            menuContainerClass: i = xs.navMenuMain,
      ...
      const Js = {
        ...
        st = e => {
          ...
          return (0, N.jsxs)(C.Link, {
            className: i ? at.scSubLink : at.scLink,
        ...
        tt = e => {
          ...
          return (0, n.useEffect)((() => {
            ...
            children: [(0, N.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), b(c), m === a ? (u(-1), f(0)) : (u(a), f(x + j + j))
              },
              children: [(0, N.jsx)("span", {
        ...
        it = e => {
          ...
          const {
            ...
            track: o
          } = (0, se.useGtmTrack)(), c = (0, m.c)(), [i, l] = (0, n.useState)([]), [d, u] = (0, n.useState)(null), [f, g] = (0, n.useState)(null), [_, p] = (0, n.useState)(!1), [k, b] = (0, n.useState)(-1), [h, v] = (0, n.useState)([]), [x, y] = (0, n.useState)(0), j = s(1084), [S, w] = (0, n.useState)("0"), [C, I] = (0, n.useState)("0"), T = e => parseInt(e, 10).toLocaleString("en-US", {
            minimumFractionDigits: 0
          }), M = () => {
            E((0, N.jsx)("img", {
              src: j,
              alt: c.formatMessage(zs.profile_selector_mugshot, {
                userName: r.nickname
              })
            }))
          }, [L, E] = (0, n.useState)((0, N.jsx)("img", {
            className: ct.scAvatarImg,
            src: a.mugshotUrl,
            alt: c.formatMessage(zs.profile_selector_mugshot, {
              userName: r.nickname
            }),
          ...
          (0, n.useEffect)((() => {
            ...
            if (!_ && k > -1)
              for (let a = 5; a > k; a -= 1) e.push((0, N.jsx)("div", {
                className: ct.scCrewRankBarItem,
                style: {
          ...
          return (0, N.jsxs)("div", {
            className: ct.scProfileDetails,
            onClick: B,
            onKeyUp: B,
            role: "button",
            tabIndex: -1,
            children: [(0, N.jsxs)("div", {
              className: ct.scAvatar,
              children: [L, (0, N.jsx)("div", {
                className: ct.scAvatarPlatform,
              ...
              className: ct.scProfileStats,
              children: [(0, N.jsx)("div", {
                className: ct.scNames,
                children: (0, N.jsxs)("div", {
                  className: ct.scTagsNames,
                  children: [(0, N.jsx)("span", {
                    className: ct.scUserName,
                    children: a.platformUsername
                  }), d && (0, N.jsxs)("span", {
                    className: ct.scCrewName,
                    "data-arrow-tag": _,
                    children: [d, !_ && (0, N.jsx)("div", {
                      className: ct.scCrewRankBar,
                      children: h
                    })]
                  })]
                })
              }), (0, N.jsxs)("div", {
                className: ct.scProgress,
                children: [(0, N.jsxs)("div", {
                  className: ct.scRpLevel,
                  children: [(0, N.jsx)("img", {
                    className: ct.scRpIcon,
                    src: Ps(x),
                    alt: c.formatMessage(zs.profile_selector_rp_icon)
                  }), (0, N.jsx)("span", {
                    children: a.stats.overview.rank.value
                  })]
                }), (0, N.jsxs)("div", {
                  className: ct.scMoney,
        ...
        mt = (0, ae.withTranslations)((e => {
          ...
          const {
            ...
            setUserData: H
          } = (0, se.useRockstarUserState)(), [U, W] = (0, n.useState)(null), [q, X] = (0, n.useState)(null), [K, Y] = (0, n.useState)(!1), [Q, Z] = (0, n.useState)(!1), [J, ee] = (0, n.useState)(0), te = (0, n.createRef)(), re = nt(te, !1), oe = (0, n.createRef)(), [ce, ie] = (0, n.useState)(0), [ne, le] = (0, n.useState)([]), [de, me] = (0, n.useState)(244), ue = (0, n.useMemo)((() => p()), []), fe = (0, n.useMemo)((() => ((e, a, s, t, r) => [{
        ...
        ft = S((() => {
          ...
          return (0, n.useEffect)((() => {
            ...
            c && (t && r(!1), l || A(!0))
          }), [c]), null === p ? null : (0, N.jsxs)(N.Fragment, {
            children: [(0, N.jsxs)("div", {
        ...
        bt = e => {
          ...
          return (0, n.useEffect)((() => {
            ...
            ref: f,
            children: [(0, N.jsx)("div", {
              className: [kt.promoModuleImage, c ? kt.gradient : "", "left" === l ? kt.left : kt.right].join(" ")
            }), (0, N.jsxs)("div", {
      ...
      const yt = ha(S((e => {
        ...
        It = e => {
          ...
          return void 0 !== s && (c.gridTemplateColumns = `repeat(${s}, 1fr)`), void 0 !== r && (c.gridTemplateRows = `repeat(${r}, 1fr)`), (0, N.jsx)("div", {
        ...
        Et = e => {
          ...
          const [c, i] = (0, ae.usePreloadImg)(a);
          return c ? (o.backgroundImage = `url(${a})`, (0, N.jsx)("div", {
            role: "img",
        ...
        Vt = (0, n.forwardRef)(((e, a) => {
          const {
            ...
            track: c
          } = (0, se.useGtmTrack)(o), [i, l] = (0, n.useState)(a?.current);
          return (0, n.useEffect)((() => {
      ...
      const er = {
          ...
          return (0, n.useEffect)((() => {
            ...
            children: (0, N.jsxs)("div", {
              ...
              children: [(0, N.jsxs)("div", {
                ...
                className: [er.voteButtons, c ? "" : er.loggedOutButtons].join(" "),
                children: [(0, N.jsx)("button", {
                  onClick: () => u(!0),
        ...
        tr = (0, ae.withLocale)((e => {
          ...
          } = (0, ae.useBodyScrollable)(), [o, c] = (0, n.useState)(0), [i, l] = (0, n.useState)(0), d = (0, n.useRef)(null), m = (0, n.useRef)(null);
          return (0, n.useEffect)((() => {
            ...
            children: [(0, N.jsx)("div", {
              ...
              ref: d,
              children: (0, N.jsx)("div", {
                className: `${sr.items} ${0!==i?sr.dragging:""}`,
                ref: m,
                style: {
        ...
        cr = S((e => {
          ...
          return (0, n.useEffect)((() => {
            ...
            return {}
          }), [l.current, f]), b = "games" === c ? (0, N.jsx)(N.Fragment, {
            ...
            children: [(0, N.jsxs)("h3", {
              ...
              children: [t, (0, N.jsxs)("div", {
                ...
                children: [(0, N.jsx)("button", {
                  ...
                  className: [or.arrow, or.next, f === Math.ceil(i.length / d) - 1 ? or.disabled : ""].join(" "),
                  onClick: () => _(f + 1),
                  type: "button",
                  "aria-label": `${f===Math.ceil(i.length/d)-1?o.formatMessage(rr.disabled_label)+", ":""}${o.formatMessage(rr.next_button_label)}`
                })]
              })]
            }), (0, N.jsx)("div", {
              className: or.items,
      ...
      class mr extends n.Component {
        ...
        render() {
          return null !== this.state.error.code ? (0, N.jsx)(ir, {
