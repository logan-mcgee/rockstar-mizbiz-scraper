/*! For license information please see 12947a600f619ac09f8306728237d9d1.js.LICENSE.txt */ ! function() {
  try {
  ...
  [520], {
    ...
    520: (e, a, t) => {
      ...
      const u = (0, r.withTranslations)((e => {
          ...
          const {
            mutateLSSettings: l
          } = (0, r.useRockstarWebLSSettings)(), [u, g] = (0, n.useState)(null), i = (0, n.createRef)(), f = (0, n.createRef)(), b = (0, n.createRef)(), {
            style: p
          } = t;
          return !1 === a ? (0, c.jsxs)("div", {
            ...
            children: [t?.header, (0, c.jsx)("div", {
              ...
              onSubmit: async e => {
                e.preventDefault();
                const a = `${b.current.value}-${i.current.value.padStart(2,0)}-${f.current.value.padStart(2,0)}`,
...
//# sourceMappingURL=12947a600f619ac09f8306728237d9d1.js.map