/*! For license information please see cf1cb48fa3c492b9a0a8.js.LICENSE.txt */
"use strict";
    ...
    881: (e, t, s) => {
        ...
        for (let i = 1; i < arguments.length; i += 1) {
          ...
          if (null != n && (s = n, !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
            ...
            for (let t = 0, i = s.length; t < i; t += 1) {
              ...
              void 0 !== r && r.enumerable && (x(e[i]) && x(n[i]) ? n[i].__swiper__ ? e[i] = n[i] : P(e[i], n[i]) : !x(e[i]) && x(n[i]) ? (e[i] = {}, n[i].__swiper__ ? e[i] = n[i] : P(e[i], n[i])) : e[i] = n[i])
            }
          }
        }
        var s;
        ...
        z = {
          ...
          updateSlides: function() {
            ...
            if (Object.assign(e, {
              ...
              k(e.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"), k(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
      ...
      const W = (e, t) => {
        ...
        q = {
          attachEvents: function() {
            ...
            e.onTouchStart = D.bind(e), e.onTouchMove = G.bind(e), e.onTouchEnd = j.bind(e), s.cssMode && (e.onScroll = H.bind(e)), e.onClick = R.bind(e), i.touch && !V && (t.addEventListener("touchstart", F), V = !0), W(e, "on")
          },
      ...
      const K = {
          ...
          transition: {
            ...
            transitionStart: function() {
              ...
              i.cssMode || (i.autoHeight && s.updateAutoHeight(), N({
                swiper: s,
                runCallbacks: e,
                direction: t,
                step: "Start"
            ...
            transitionEnd: function() {
              ...
              s.animating = !1, i.cssMode || (s.setTransition(0), N({
                swiper: s,
                runCallbacks: e,
                direction: t,
                step: "End"
      ...
      class Q {
        constructor() {
          ...
          if (1 === i.length && i[0].constructor && "Object" === Object.prototype.toString.call(i[0]).slice(8, -1) ? t = i[0] : [e, t] = i, t || (t = {}), t = P({}, t), e && !t.el && (t.el = e), t.el && T(t.el).length > 1) {
            const e = [];
          ...
          }()), _), r.eventsListeners = {}, r.eventsAnyListeners = [], r.modules = [...r.__modules__], t.modules && Array.isArray(t.modules) && r.modules.push(...t.modules);
          const a = {};
          r.modules.forEach((e => {
            e({
              swiper: r,
          ...
          const l = P({}, U, a);
          return r.params = P({}, l, J, t), r.originalParams = P({}, r.params), r.passedParams = P({}, t), r.params && r.params.on && Object.keys(r.params.on).forEach((e => {
