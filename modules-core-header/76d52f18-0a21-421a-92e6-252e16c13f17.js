try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "76d52f18-0a21-421a-92e6-252e16c13f17", e._sentryDebugIdIdentifier = "sentry-dbid-76d52f18-0a21-421a-92e6-252e16c13f17")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [5973], {
    12919: (e, t, s) => {
      ...
      function n(e, {
        ...
        const n = e => r.X || !window.matchMedia ? t : window.matchMedia(e).matches,
          [a, o] = (0, i.useState)((() => s ? n(e) : t));
    ...
    32654: (e, t, s) => {
      ...
      var A = {
        ...
        updateSlides: function() {
          ...
          for (let r = 0; r < p; r += 1) {
            let i;
            if (O = 0, c[r] && (i = c[r]), C && e.grid.updateSlide(r, i, c), !c[r] || "none" !== b(i, "display")) {
              ...
              c[r] && (c[r].swiperSlideSize = O), h.push(O), s.centeredSlides ? (x = x + O / 2 + M / 2 + E, 0 === M && 0 !== r && (x = x - n / 2 - E), 0 === r && (x = x - n / 2 - E), Math.abs(x) < .001 && (x = 0), s.roundLengths && (x = Math.floor(x)), P % s.slidesPerGroup == 0 && u.push(x), f.push(x)) : (s.roundLengths && (x = Math.floor(x)), (P - Math.min(e.params.slidesPerGroupSkip, P)) % e.params.slidesPerGroup == 0 && u.push(x), f.push(x), x = x + O + E), e.virtualSize += O + E, M = O, P += 1
            }
          }
        ...
        updateSlidesProgress: function(e) {
          ...
          for (let e = 0; e < r.length; e += 1) {
            ...
            h && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), k(l, h, s.slideVisibleClass), k(l, m, s.slideFullyVisibleClass), l.progress = i ? -c : c, l.originalProgress = i ? -p : p
          }
        },
        ...
        updateSlidesClasses: function() {
          ...
          l && (a || (c = function(e, t) {
            ...
            _(e, e === l, s.slideActiveClass), _(e, e === c, s.slideNextClass), _(e, e === d, s.slidePrevClass)
          })), e.emitSlidesClasses()
        },
        ...
        D = {
          ...
          loopFix: function(e) {
            ...
            if (I < S) {
              ...
              _ = Math.max(I - (x - 2 * S), b), M && (_ = Math.max(_, w - x + v + 1));
              for (let e = 0; e < _; e += 1) {
                const t = e - Math.floor(e / x) * x;
                y ? c.forEach(((e, s) => {
                  e.column === t && E.push(s)
            ...
            if (d.__preventObserver__ = !0, requestAnimationFrame((() => {
              ...
              })), "cards" === d.params.effect && c.length < w + 2 * S && (E.includes(n) && E.splice(E.indexOf(n), 1), T.includes(n) && T.splice(T.indexOf(n), 1)), O && T.forEach((e => {
              ...
              })), d.recalcSlides(), "auto" === m.slidesPerView ? d.updateSlides() : y && (T.length > 0 && O || E.length > 0 && C) && d.slides.forEach(((e, t) => {
      ...
      function j(e) {
        ...
        if ("touchstart" === r.type) return void V(t, r, r.targetTouches[0].pageX);
        const {
          params: n,
          touches: a,
          enabled: l
      ...
      const q = (e, t) => {
          ...
          i && "string" != typeof i && (s[d]("touchstart", e.onDocumentTouchStart, {
            ...
            passive: !0
          }), (r.preventClicks || r.preventClicksPropagation) && i[d]("click", e.onClick, !0), r.cssMode && n[d]("scroll", e.onScroll), r.updateOnWindowResize ? e[c](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[c]("observerUpdate", R, !0), i[d]("load", e.onLoad, {
            capture: !0
          }))
        },
      ...
      const Z = {
          ...
          events: {
            attachEvents: function() {
              ...
              e.onTouchStart = j.bind(e), e.onTouchMove = B.bind(e), e.onTouchEnd = F.bind(e), e.onDocumentTouchStart = X.bind(e), t.cssMode && (e.onScroll = H.bind(e)), e.onClick = $.bind(e), e.onLoad = W.bind(e), q(e, "on")
            },
      ...
      const fe = (0, r.createContext)(null),
        ...
        he = (0, r.forwardRef)((function(e, t) {
          ...
          return g.current || L(), w.current && w.current.on("_beforeBreakpoint", I), (0, r.useEffect)((() => () => {
            ...
            value: w.current
          }, _["container-start"], r.createElement(n, {
            className: oe(M.wrapperClass)
          }, _["wrapper-start"], M.virtual ? function(e, t, s) {
            if (!s) return null;
            const i = e => {
                let s = e;
            ...
            swiper: w.current,
            swiperSlideIndex: t
          }))), _["wrapper-end"]), re(M) && r.createElement(r.Fragment, null, r.createElement("div", {
            ref: T,
      ...
      function o(...e) {
        ...
        for (let s = 1; s < e.length; s++) {
          ...
          for (const e in i) {
            const s = t[e],
              o = i[e];
            "function" == typeof s && "function" == typeof o && "o" === e[0] && "n" === e[1] && e.charCodeAt(2) >= 65 && e.charCodeAt(2) <= 90 ? t[e] = a(s, o) : "className" !== e && "UNSAFE_className" !== e || "string" != typeof s || "string" != typeof o ? "id" === e && s && o ? t.id = n(s, o) : t[e] = void 0 !== o ? o : s : t[e] = (0, r.clsx)(s, o)
          }
        }
        return t
      }
