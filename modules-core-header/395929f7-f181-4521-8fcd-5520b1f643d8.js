! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "395929f7-f181-4521-8fcd-5520b1f643d8", t._sentryDebugIdIdentifier = "sentry-dbid-395929f7-f181-4521-8fcd-5520b1f643d8")
  } catch (t) {}
}();
    ...
    19235: (t, e, n) => {
      ...
      function C({
        ...
        const y = (0, o.forwardRef)((function(y, w) {
          ...
          }(D, k.visualElement, w), D, V, k.visualElement)))
        }));
        return y[V] = g, y
      }
      ...
      function ct(t, e, n) {
        for (const o in e) j(e[o]) || I(o, n) || (t[o] = e[o])
      }
      ...
      function Mt(t) {
        ...
        for (const o in e)(j(e[o]) || I(o, t)) && (n[o] = e[o]);
        return n
      }
      ...
      const Ue = ["read", "update", "preRender", "render", "postRender"],
        ...
        Ye = t => {
          je = !1, Le.delta = Ie ? _e : Math.max(Math.min(t - Le.timestamp, 40), 1), Le.timestamp = t, Fe = !0, Ue.forEach(He), Fe = !1, je && (Ie = !1, Be(Ye))
        },
        Xe = () => {
          je = !0, Ie = !0, Fe || Be(Ye)
        };
      ...
      const co = t => 1 - Math.sin(Math.acos(t)),
        ...
        yo = t => {
          ...
          return "string" == typeof t ? (Un(void 0 !== vo[t], `Invalid easing type '${t}'`), vo[t]) : t
        };
          ...
          },
          {
            ...
            if (!Mo(t, Co) && Mo(t, Vo)) {
              const n = function({
                ...
                let s = 1 - e;
                s = W(So, Po, s), t = W(bo, Eo, t / 1e3), s < 1 ? (r = e => {
                  const o = e * s,
                    r = o * t,
                    i = o - n,
                    a = Ao(e, s),
      ...
      function Bo({
        ...
        let v, y, x, w = 0,
          ...
          E = !1,
          S = !0;
        const P = Lo[s.length > 2 ? "keyframes" : f],
          T = s[0],
          A = s[s.length - 1];
        ...
        return a && (l && l(), v = e((function(t) {
          ...
          }(n, b, i, S)) : (n = _o(n, b, i), "mirror" === r && V.flipTarget()), E = !1, h && h()) : (v.stop(), c && c()))
        })), v.start()), {
          stop: () => {
            u && u(), v.stop()
          },
      ...
      function Fo(t) {
        if (t) return Array.isArray(t) ? Io(t) : jo[t]
      }
      ...
      class ni {
        constructor(t) {
          this.openGlobalLock = null, this.isDragging = !1, this.currentDirection = null, this.originPoint = {
            x: 0,
            y: 0
          }, this.constraints = !1, this.hasMutatedConstraints = !1, this.elastic = Br(), this.visualElement = t
        }
        start(t, {
          snapToCursor: e = !1
        } = {}) {
          ...
          if (r.forEach((r => {
              ...
              if (Dt(h)) {
                const t = h.length,
                  e = null === h[0] ? 1 : 0;
                u = h[e], c = Pn(u);
                for (let n = e; n < t; n++) d ? Un(Pn(h[n]) === d, "All keyframes must be of the same type") : (d = Pn(h[n]), Un(d === c || hi(c) && hi(d), "Keyframes must be of the same dimension as the current value"))
              } else d = Pn(h);
              if (c !== d)
                if (hi(c) && hi(d)) {
                  const t = l.get();
      ...
      class Ti {
        constructor({
          ...
          for (const t in l) {
            const e = l[t];
            void 0 !== i[t] && j(e) && (e.set(i[t], !1), _n(a) && a.add(t))
          }
        }
        scrapeMotionValuesFromProps(t) {
          return {}
        ...
        setProps(t) {
          ...
          this.prevMotionValues = function(t, e, n) {
            ...
            for (const r in e) {
              const i = e[r],
                s = n[r];
              if (j(i)) t.addValue(r, i), _n(o) && o.add(r);
      ...
      class ki extends Ci {
        ...
        readValueFromInstance(t, e) {
          var n;
          return B.has(e) ? (null === (n = wn(e)) || void 0 === n ? void 0 : n.default) || 0 : (e = Vt.has(e) ? e : Tt(e), t.getAttribute(e))
        }
      ...
      function hs({
        ...
        return class {
          ...
          didUpdate() {
            ...
            this.isUpdating && (this.isUpdating = !1, this.potentialNodes.size && (this.potentialNodes.forEach(Vs), this.potentialNodes.clear()), this.nodes.forEach(vs), this.nodes.forEach(ds), this.nodes.forEach(fs), this.clearAllSnapshots(), We.update(), We.preRender(), We.render())
          }
          clearAllSnapshots() {
          ...
          updateLayout() {
            ...
            const e = this.layout;
            this.layout = this.measure(!1), this.layoutCorrected = Br(), this.isLayoutDirty = !1, this.projectionDelta = void 0, this.notifyListeners("measure", this.layout.layoutBox), null === (t = this.options.visualElement) || void 0 === t || t.notify("LayoutMeasure", this.layout.layoutBox, null == e ? void 0 : e.layoutBox)
          }
          ...
          resolveTargetDelta() {
            ...
            if (this.layout && (n || o)) {
              if (!this.targetDelta && !this.relativeTarget) {
                ...
                t && t.layout ? (this.relativeParent = t, this.relativeTarget = Br(), this.relativeTargetOrigin = Br(), Mr(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox), qi(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
              }
              var r, i, s;
              if ((this.relativeTarget || this.targetDelta) && (this.target || (this.target = Br(), this.targetWithTransforms = Br()), this.relativeTarget && this.relativeTargetOrigin && (null === (t = this.relativeParent) || void 0 === t ? void 0 : t.target) ? (r = this.target, i = this.relativeTarget, s = this.relativeParent.target, Vr(r.x, i.x, s.x), Vr(r.y, i.y, s.y)) : this.targetDelta ? (Boolean(this.resumingFrom) ? this.target = this.applyTransform(this.layout.layoutBox) : qi(this.target, this.layout.layoutBox), Xr(this.target, this.targetDelta)) : qi(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget)) {
                this.attemptToResolveRelativeTarget = !1;
                const t = this.getClosestProjectingParent();
                t && Boolean(t.resumingFrom) === Boolean(this.resumingFrom) && !t.options.layoutScroll && t.target ? (this.relativeParent = t, this.relativeTarget = Br(), this.relativeTargetOrigin = Br(), Mr(this.relativeTargetOrigin, this.target, t.target), qi(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
              }
            }
          }
      ...
      const $s = t => t.key || "",
        Ws = ({
          ...
          if (u((() => {
            ...
            })), v.current) return o.createElement(o.Fragment, null, f.map((t => o.createElement(Ns, {
            key: $s(t),
            isPresent: !0,
            initial: !!n && void 0,
            presenceAffectsLayout: s,
      ...
      function va(t, e = {}) {
        ...
        return (0, o.useMemo)((() => s.attach(((t, o) => n ? o(t) : (i.current && i.current.stop(), i.current = Bo({
            keyframes: [s.get(), t],
      ...
      function Ga(t, e, n) {
        ...
        c && (e[i].interpolate = function(t) {
          let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Ba(t.length),
            n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : La;
          const o = t.length,
            r = o - e.length;
          return r > 0 && Oa(e, r), r => {
            let i = 0;
            for (; i < o - 2 && !(r < e[i + 1]); i++);
            let s = Ua(0, 1, Ca(e[i], e[i + 1], r));
            const a = function(t, e) {
              return ja(t) ? t[Fa(0, t.length, e)] : t
            }(n, i);
            return s = a(s), _a(t[i], t[i + 1], s)
          }
        }(Ba(h), e[i].offset), e[i].interpolatorOffsets = [...e[i].offset]), e[i].progress = e[i].interpolate(e[i].current)
      }
          ...
          s = function(t, e, n) {
            ...
            return {
              ...
              notify: Va(e) ? () => e(n) : (i = e, s = n[r], i.pause(), i.forEachNative(((t, e) => {
                ...
                var o, r;
                if (t.updateDuration) n || (t.easing = La), t.updateDuration(1);
                else {
                  const e = {
                    duration: 1e3
                  };
      ...
      class sl extends Je {
        ...
        add(t) {
          let e;
          B.has(t) ? (this.transforms.add(t), e = "transform") : t.startsWith("origin") || z(t) || "willChange" === t || (e = Tt(t)), e && (Ge(this.members, e), this.update())
        }
        remove(t) {
      ...
      function Rl(t) {
        const [e, n] = (0, o.useState)(t), r = kl({}, !1), i = b((() => new Ml({
          props: {},
          visualState: r
        }, {
          initialState: t
