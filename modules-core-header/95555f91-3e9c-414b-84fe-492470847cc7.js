! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      l = (new e.Error).stack;
    l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "95555f91-3e9c-414b-84fe-492470847cc7", e._sentryDebugIdIdentifier = "sentry-dbid-95555f91-3e9c-414b-84fe-492470847cc7")
  } catch (e) {}
}();
    ...
    34548: (e, l, a) => {
      ...
      function f(...e) {
        ...
        for (let a = 1; a < e.length; a++) {
          ...
          for (const e in r) {
            const a = l[e],
              t = r[e];
            "function" == typeof a && "function" == typeof t && "o" === e[0] && "n" === e[1] && e.charCodeAt(2) >= 65 && e.charCodeAt(2) <= 90 ? l[e] = h(a, t) : "className" !== e && "UNSAFE_className" !== e || "string" != typeof a || "string" != typeof t ? "id" === e && a && t ? l.id = c(a, t) : l[e] = void 0 !== t ? t : a : l[e] = (0, o.A)(a, t)
          }
        }
        return l
      }
      ...
      function g(e) {
        for (var l = 1; l < arguments.length; l++) {
          ...
          l % 2 ? x(Object(a), !0).forEach((function(l) {
            var r, t, s;
            r = e, t = l, s = a[l], (t = v(t)) in r ? Object.defineProperty(r, t, {
              value: s,
              enumerable: !0,
              configurable: !0,
              writable: !0
            }) : r[t] = s
          })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(a)) : x(Object(a)).forEach((function(l) {
      ...
      var u, p, m = (e, l, a) => {
        ...
        R = (u = {
          ...
          var l = u.defaultClassName,
            a = g(g({}, u.defaultVariants), e);
          for (var r in a) {
            var t, s = null !== (t = a[r]) && void 0 !== t ? t : u.defaultVariants[r];
            if (null != s) {
              var d = s;
              "boolean" == typeof d && (d = !0 === d ? "true" : "false");
              var i = u.variantClassNames[r][d];
              i && (l += " " + i)
            }
          }
          for (var [o, n] of u.compoundVariants) m(o, a, u.defaultVariants) && (l += " " + n);
          return l
        }).variants = () => Object.keys(u.variantClassNames), p.classNames = {
          get base() {
            return u.defaultClassName.split(" ")[0]
          },
          get variants() {
            return j(u.variantClassNames, (e => j(e, (e => e.split(" ")[0]))))
          }
        }, p);
      ...
      z.displayName = "Discord", z.categories = ["brands", "social"], z.tags = ["Social media", "Video", "Player", "Game", "Community", "App", "Share", "Logo"], z.MD = M, z.LG = b, z.XL = L;
      ...
      D.displayName = "Instagram", D.categories = ["brands", "social", "photography"], D.tags = ["logo", "camera", "social media", "photo", "camera", "app", "share"], D.MD = C, D.LG = A, D.XL = H;
      ...
      y.displayName = "Facebook", y.categories = ["social", "brands"], y.tags = ["logo", "social media", "profile", "feed", "app", "share"], y.MD = V, y.LG = I, y.XL = B;
      ...
      q.displayName = "Twitch", q.categories = ["brands", "social", "account", "gaming"], q.tags = ["logo", "social", "social media", "streaming", "game", "app", "share"], q.MD = G, q.LG = N, q.XL = X;
      ...
      P.displayName = "Youtube", P.categories = ["multimedia", "social", "brands"], P.tags = ["logo", "social", "video", "play", "video", "player", "app", "share"], P.MD = k, P.LG = F, P.XL = S;
      ...
      E.displayName = "Twitter", E.categories = ["brands", "social", "account"], E.tags = ["logo", "social", "social media", "twitter", "tweet", "app", "share", "x"], E.MD = O, E.LG = _, E.XL = T;
      ...
      Q.displayName = "Copy", Q.categories = ["text"], Q.tags = ["clone", "duplicate", "multiple"], Q.MD = U, Q.LG = W, Q.XL = Z;
      ...
      $.displayName = "Clipboard", $.categories = ["text"], $.tags = ["copy", "paste"], $.MD = Y, $.LG = K, $.XL = J;
      ...
      re.displayName = "ListFilter", re.categories = ["text"], re.tags = ["options"], re.MD = ee, re.LG = le, re.XL = ae;
      ...
      ie.displayName = "Unlink", ie.categories = ["text"], ie.tags = ["url", "unchain"], ie.MD = te, ie.LG = se, ie.XL = de;
      ...
      he.displayName = "List", he.categories = ["text"], he.tags = ["options", "index", "table of contents", "menu", "side nav", "navigation", "bullet", "to do"], he.MD = oe, he.LG = ne, he.XL = ce;
      ...
      xe.displayName = "MessageSquareText", xe.categories = ["social"], xe.tags = ["comment", "chat", "conversation", "dialog", "feedback", "speech bubble", "clear", "close", "delete", "remove", "cancel", "silence", "mute", "moderate"], xe.MD = fe, xe.LG = we, xe.XL = ve;
      ...
      pe.displayName = "Search", pe.categories = ["text", "social"], pe.tags = ["find", "scan", "magnifier", "magnifying glass", "look", "view"], pe.MD = ge, pe.LG = je, pe.XL = ue;
      ...
      be.displayName = "Globe", be.categories = ["navigation"], be.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], be.MD = me, be.LG = Re, be.XL = Me;
      ...
      Ae.displayName = "EllipsisVertical", Ae.categories = ["layout"], Ae.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], Ae.MD = Le, Ae.LG = ze, Ae.XL = Ce;
      ...
      Ie.displayName = "Filter", Ie.categories = ["layout"], Ie.tags = ["funnel", "hopper"], Ie.MD = He, Ie.LG = De, Ie.XL = Ve;
      ...
      Ne.displayName = "StarOff", Ne.categories = ["multimedia", "social"], Ne.tags = ["dislike", "unlike", "remove", "unrate"], Ne.MD = Be, Ne.LG = ye, Ne.XL = Ge;
      ...
      Fe.displayName = "SkipBack", Fe.categories = ["multimedia", "arrows"], Fe.tags = ["music", "audio", "video", "arrow", "previous", "back", "rewind", "reverse", "control", "player"], Fe.MD = Xe, Fe.LG = qe, Fe.XL = ke;
      ...
      _e.displayName = "SkipForward", _e.categories = ["multimedia", "arrows"], _e.tags = ["music", "audio", "video", "arrow", "skip", "next", "forward", "control", "player"], _e.MD = Se, _e.LG = Pe, _e.XL = Oe;
      const Te = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      We.displayName = "Pause", We.categories = ["multimedia"], We.tags = ["music", "audio", "video", "stop", "pause", "control", "player"], We.MD = Te, We.LG = Ee, We.XL = Ue;
      ...
      Ke.displayName = "Rewind", Ke.categories = ["arrows", "multimedia"], Ke.tags = ["music", "audio", "video", "control", "player", "previous", "back", "reverse"], Ke.MD = Ze, Ke.LG = Qe, Ke.XL = Ye;
      ...
      ll.displayName = "FastForward", ll.categories = ["multimedia", "arrows"], ll.tags = ["music", "audio", "video", "control", "player"], ll.MD = Je, ll.XL = $e, ll.LG = el;
      ...
      sl.displayName = "Stop", sl.categories = ["multimedia"], sl.tags = ["music", "audio", "video", "control", "player", "stop"], sl.MD = al, sl.LG = rl, sl.XL = tl;
      ...
      nl.displayName = "Play", nl.categories = ["arrows", "multimedia"], nl.tags = ["music", "audio", "video", "start", "run", "play", "continue", "control", "player"], nl.MD = dl, nl.LG = il, nl.XL = ol;
      ...
      wl.displayName = "Weapon", wl.categories = ["gaming"], wl.tags = ["gun", "pistol", "GTAO", "fire", "shoot", "death", "danger"], wl.MD = cl, wl.LG = hl, wl.XL = fl;
      ...
      jl.displayName = "FileText", jl.categories = ["files", "text"], jl.tags = ["data", "txt", "pdf", "document"], jl.MD = vl, jl.LG = xl, jl.XL = gl;
      ...
      Rl.displayName = "Files", Rl.categories = ["files"], Rl.tags = ["multiple", "copy", "documents", "data", "file", "folder", "restore"], Rl.MD = ul, Rl.LG = pl, Rl.XL = ml;
      ...
      zl.displayName = "CarSide", zl.categories = ["transportation"], zl.tags = ["vehicle", "drive", "trip", "journey"], zl.MD = Ml, zl.LG = bl, zl.XL = Ll;
      const Cl = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Dl.displayName = "Car", Dl.categories = ["transportation"], Dl.tags = ["vehicle", "drive", "trip", "journey", "automobile", "GTAO", "transport"], Dl.MD = Cl, Dl.LG = Al, Dl.XL = Hl;
      const Vl = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yl.displayName = "CalendarOff", yl.categories = ["time"], yl.tags = ["date", "day", "month", "year", "event", "delete", "remove"], yl.MD = Vl, yl.LG = Il, yl.XL = Bl;
      ...
      ql.displayName = "Calendar", ql.categories = ["time"], ql.tags = ["date", "month", "year", "event", "birthday", "birthdate"], ql.MD = Gl, ql.LG = Nl, ql.XL = Xl;
      ...
      Pl.displayName = "Clock", Pl.categories = ["time"], Pl.tags = ["time", "watch", "alarm", "hour", "minute", "second", "planned", "watch"], Pl.MD = kl, Pl.LG = Fl, Pl.XL = Sl;
      ...
      El.displayName = "Book", El.categories = ["text", "gaming"], El.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], El.MD = Ol, El.LG = _l, El.XL = Tl;
      const Ul = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ql.displayName = "Database", Ql.categories = ["devices", "development"], Ql.tags = ["storage", "memory", "container", "tin", "pot", "bytes", "servers"], Ql.MD = Ul, Ql.LG = Wl, Ql.XL = Zl;
      ...
      $l.displayName = "CloudAlert", $l.categories = ["development"], $l.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], $l.MD = Yl, $l.LG = Kl, $l.XL = Jl;
      ...
      ra.displayName = "Server", ra.categories = ["development", "devices"], ra.tags = ["cloud", "storage"], ra.MD = ea, ra.LG = la, ra.XL = aa;
      ...
      ia.displayName = "CodeXml", ia.categories = ["text", "development"], ia.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], ia.MD = ta, ia.LG = sa, ia.XL = da;
      ...
      ha.displayName = "Maximize", ha.categories = ["layout", "design"], ha.tags = ["full screen", "expand", "dashed", "maximum", "big", "large"], ha.MD = oa, ha.LG = na, ha.XL = ca;
      ...
      xa.displayName = "Minimize", xa.categories = ["layout", "design"], xa.tags = ["exit", "full screen", "close", "shrink", "window", "reduce", "video playback"], xa.MD = fa, xa.LG = wa, xa.XL = va;
      ...
      pa.displayName = "LayoutGrid", pa.categories = ["design", "layout"], pa.tags = ["app", "home", "start", "squares", "hub", "menu", "blocks", "options", "items", "gallery"], pa.MD = ga, pa.LG = ja, pa.XL = ua;
      ...
      ba.displayName = "Trophy", ba.categories = ["sports", "gaming"], ba.tags = ["prize", "sports", "winner", "achievement", "award", "champion", "celebration", "victory"], ba.MD = ma, ba.LG = Ra, ba.XL = Ma;
      ...
      Aa.displayName = "PartialCircle", Aa.categories = ["shapes"], Aa.tags = ["Partial", "Half", "Middle", "Split"], Aa.MD = La, Aa.LG = za, Aa.XL = Ca;
      ...
      Ia.displayName = "LockKeyhole", Ia.categories = ["security"], Ia.tags = ["security", "password", "secure", "admin", "lock", "safe", "protection", "security", "latch"], Ia.MD = Ha, Ia.LG = Da, Ia.XL = Va;
      ...
      Na.displayName = "LockPassword", Na.categories = ["security"], Na.tags = ["security", "password", "secure", "admin"], Na.MD = Ba, Na.LG = ya, Na.XL = Ga;
      ...
      Fa.displayName = "Image", Fa.categories = ["photography", "text", "multimedia", "files"], Fa.tags = ["picture", "photo"], Fa.MD = Xa, Fa.LG = qa, Fa.XL = ka;
      ...
      _a.displayName = "Lightbulb", _a.categories = ["photography"], _a.tags = ["idea", "bright", "lights"], _a.MD = Sa, _a.LG = Pa, _a.XL = Oa;
      const Ta = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Wa.displayName = "CircleX", Wa.categories = ["math", "development"], Wa.tags = ["cancel", "close", "delete", "remove", "times", "clear", "error", "incorrect", "wrong", "mistake", "failure", "linter", "multiply", "multiplication", "clean", "erase", "deprecate", "delete", "navigation"], Wa.MD = Ta, Wa.LG = Ea, Wa.XL = Ua;
      ...
      Ka.displayName = "Minus", Ka.categories = ["math", "development", "text", "tools"], Ka.tags = ["subtract", "remove", "decrease", "decrement", "reduce", "negative", "calculate", "line", "divider", "separator", "horizontal rule", "hr", "html", "markup", "markdown", "---", "toolbar", "operator", "code", "coding", "minimum", "downgrade", "less", "delete", "navigation", "minimize"], Ka.MD = Za, Ka.LG = Qa, Ka.XL = Ya;
      ...
      lr.displayName = "CircleMinus", lr.categories = ["math"], lr.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete"], lr.MD = Ja, lr.LG = $a, lr.XL = er;
      ...
      sr.displayName = "CircleCheck", sr.categories = ["notifications"], sr.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], sr.MD = ar, sr.LG = rr, sr.XL = tr;
      ...
      nr.displayName = "TriangleAlert", nr.categories = ["notifications", "shapes", "development"], nr.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], nr.MD = dr, nr.LG = ir, nr.XL = or;
      ...
      wr.displayName = "X", wr.categories = ["notifications", "math"], wr.tags = ["cancel", "close", "delete", "remove", "times", "clear", "math", "multiply", "multiplication", "error", "remove", "clean", "erase", "navigation", "cross", "times"], wr.MD = cr, wr.LG = hr, wr.XL = fr;
      ...
      jr.displayName = "Check", jr.categories = ["notifications"], jr.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "success", "accept"], jr.MD = vr, jr.LG = xr, jr.XL = gr;
      ...
      Rr.displayName = "HeartPulse", Rr.categories = ["medical"], Rr.tags = ["heartbeat", "pulse", "health", "medical", "blood pressure", "cardiac", "systole", "diastole"], Rr.MD = ur, Rr.LG = pr, Rr.XL = mr;
      ...
      zr.displayName = "EnvelopeOpen", zr.categories = ["mail"], zr.tags = ["email", "message", "letter", "read"], zr.MD = Mr, zr.LG = br, zr.XL = Lr;
      const Cr = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Dr.displayName = "Trash", Dr.categories = ["files", "mail"], Dr.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], Dr.MD = Cr, Dr.LG = Ar, Dr.XL = Hr;
      const Vr = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yr.displayName = "Paperclip", yr.categories = ["text", "design", "files", "mail"], yr.tags = ["attachment", "file", "attach", "clip", "document", "paper"], yr.MD = Vr, yr.LG = Ir, yr.XL = Br;
      ...
      qr.displayName = "CircleDollarSign", qr.categories = ["finance"], qr.tags = ["monetization", "marketing", "currency", "money", "payment"], qr.MD = Gr, qr.LG = Nr, qr.XL = Xr;
      ...
      Pr.displayName = "DollarSign", Pr.categories = ["finance"], Pr.tags = ["currency", "money", "payment"], Pr.MD = kr, Pr.LG = Fr, Pr.XL = Sr;
      ...
      Er.displayName = "Heart", Er.categories = ["medical", "social", "multimedia", "emoji", "gaming", "shapes"], Er.tags = ["like", "love", "emotion", "suit", "playing", "cards"], Er.MD = Or, Er.LG = _r, Er.XL = Tr;
      const Ur = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Qr.displayName = "PencilOff", Qr.categories = ["design", "cursors", "tools", "text"], Qr.tags = ["disabled", "inactive", "non-editable", "locked", "read-only", "unmodifiable", "frozen", "restricted", "rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist"], Qr.MD = Ur, Qr.LG = Wr, Qr.XL = Zr;
      ...
      $r.displayName = "Pencil", $r.categories = ["design", "cursors", "tools", "text"], $r.tags = ["rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist", "update", "correct", "modify", "note"], $r.MD = Yr, $r.LG = Kr, $r.XL = Jr;
      ...
      rt.displayName = "Plus", rt.categories = ["math", "tools", "development", "text", "cursors", "gaming"], rt.tags = ["add", "new", "increase", "increment", "positive", "calculate", "toolbar", "crosshair", "aim", "target", "scope", "sight", "reticule", "maximum", "upgrade", "extra", "+", "more", "create", "navigation"], rt.MD = et, rt.LG = lt, rt.XL = at;
      ...
      it.displayName = "Headset", it.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], it.tags = ["music", "audio", "sound", "gaming", "headphones", "headset", "call", "center", "phone", "telephone", "voip", "video"], it.MD = tt, it.LG = st, it.XL = dt;
      ...
      ht.displayName = "Power", ht.categories = ["connectivity"], ht.tags = ["on", "off", "device", "switch", "toggle", "binary", "boolean", "reboot", "restart", "button", "keyboard", "troubleshoot"], ht.MD = ot, ht.LG = nt, ht.XL = ct;
      ...
      xt.displayName = "Wifi", xt.categories = ["connectivity", "devices"], xt.tags = ["connection", "signal", "wireless", "internet", "technology", "network"], xt.MD = ft, xt.LG = wt, xt.XL = vt;
      ...
      pt.displayName = "WifiOff", pt.categories = ["connectivity", "devices"], pt.tags = ["disabled", "connection", "internet", "wireless", "technology", "network", "signal", "no", "off"], pt.MD = gt, pt.LG = jt, pt.XL = ut;
      ...
      bt.displayName = "PaperPlane", bt.categories = ["mail", "communication", "connectivity"], bt.tags = ["email", "message", "mail", "paper airplane", "paper aeroplane", "submit", "send"], bt.MD = mt, bt.LG = Rt, bt.XL = Mt;
      ...
      At.displayName = "Volume", At.categories = ["connectivity", "communication", "multimedia"], At.tags = ["music", "sound", "mute", "speaker"], At.MD = Lt, At.LG = zt, At.XL = Ct;
      ...
      It.displayName = "VolumeOff", It.categories = ["connectivity", "communication", "multimedia"], It.tags = ["music", "sound", "mute", "speaker"], It.MD = Ht, It.LG = Dt, It.XL = Vt;
      ...
      Nt.displayName = "VolumeX", Nt.categories = ["connectivity", "communication", "multimedia"], Nt.tags = ["music", "sound", "mute", "speaker", "control", "volume"], Nt.MD = Bt, Nt.LG = yt, Nt.XL = Gt;
      ...
      Ft.displayName = "Volume2", Ft.categories = ["connectivity", "communication", "multimedia"], Ft.tags = ["music", "sound", "speaker", "control", "volume", "high"], Ft.MD = Xt, Ft.LG = qt, Ft.XL = kt;
      ...
      _t.displayName = "Volume1", _t.categories = ["connectivity", "communication", "multimedia"], _t.tags = ["music", "sound", "speaker", "control", "volume", "low"], _t.MD = St, _t.LG = Pt, _t.XL = Ot;
      const Tt = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Wt.displayName = "ChartSpline", Wt.categories = ["charts"], Wt.tags = ["statistics", "analytics", "diagram", "graph", "curve", "continuous", "smooth", "polynomial", "quadratic", "function", "interpolation"], Wt.MD = Tt, Wt.LG = Et, Wt.XL = Ut;
      ...
      Kt.displayName = "Store", Kt.categories = ["buildings", "navigation", "shopping"], Kt.tags = ["shop", "supermarket", "stand", "boutique", "building"], Kt.MD = Zt, Kt.LG = Qt, Kt.XL = Yt;
      ...
      ls.displayName = "House", ls.categories = ["buildings", "home"], ls.tags = ["home", "living", "building", "residence", "architecture", "property", "homepage", "city"], ls.MD = Jt, ls.LG = $t, ls.XL = es;
      ...
      ss.displayName = "Property", ss.categories = ["account", "buildings"], ss.tags = ["organization", "building", "house", "city", "GTAO", "structure"], ss.MD = as, ss.LG = rs, ss.XL = ts;
      ...
      ns.displayName = "ArrowRightLeft", ns.categories = ["arrows", "navigation"], ns.tags = ["bidirectional", "two-way", "2-way", "swap", "switch", "transaction", "reorder", "move", "<-", "->"], ns.MD = ds, ns.LG = is, ns.XL = os;
      ...
      ws.displayName = "ChevronFirst", ws.categories = ["arrows", "multimedia"], ws.tags = ["previous", "music"], ws.MD = cs, ws.LG = hs, ws.XL = fs;
      ...
      js.displayName = "ChevronLast", js.categories = ["arrows", "multimedia"], js.tags = ["skip", "next", "music"], js.MD = vs, js.LG = xs, js.XL = gs;
      ...
      Rs.displayName = "ChevronsDownUp", Rs.categories = ["arrows"], Rs.tags = ["collapse", "fold", "vertical"], Rs.MD = us, Rs.LG = ps, Rs.XL = ms;
      ...
      zs.displayName = "ChevronsUpDown", zs.categories = ["arrows"], zs.tags = ["expand", "unfold", "vertical"], zs.MD = Ms, zs.LG = bs, zs.XL = Ls;
      const Cs = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ds.displayName = "CloudDownload", Ds.categories = ["arrows", "files"], Ds.tags = ["import"], Ds.MD = Cs, Ds.LG = As, Ds.XL = Hs;
      const Vs = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ys.displayName = "CloudUpload", ys.categories = ["arrows", "files"], ys.tags = ["file"], ys.MD = Vs, ys.LG = Is, ys.XL = Bs;
      ...
      qs.displayName = "Maximize2", qs.categories = ["arrows", "layout", "design"], qs.tags = ["fullscreen", "arrows", "expand"], qs.MD = Gs, qs.LG = Ns, qs.XL = Xs;
      ...
      Ps.displayName = "Minimize2", Ps.categories = ["arrows", "layout", "design"], Ps.tags = ["exit fullscreen", "arrows", "close", "shrink"], Ps.MD = ks, Ps.LG = Fs, Ps.XL = Ss;
      ...
      Es.displayName = "RefreshCwOff", Es.categories = ["arrows"], Es.tags = ["rotate", "reload", "rerun", "synchronise", "synchronize", "arrows", "circular", "cycle", "cancel", "no", "stop", "error", "disconnect", "ignore"], Es.MD = Os, Es.LG = _s, Es.XL = Ts;
      const Us = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Qs.displayName = "Replay", Qs.categories = ["arrows", "design", "photography"], Qs.tags = ["arrow", "right", "clockwise", "refresh", "reload", "rerun", "redo"], Qs.MD = Us, Qs.LG = Ws, Qs.XL = Zs;
      ...
      $s.displayName = "ArrowUp", $s.categories = ["arrows", "navigation"], $s.tags = ["forward", "direction", "north", "increase"], $s.MD = Ys, $s.LG = Ks, $s.XL = Js;
      ...
      rd.displayName = "ArrowDown", rd.categories = ["arrows", "navigation"], rd.tags = ["backwards", "reverse", "direction", "south", "Down", "Navigation", "Decrease"], rd.MD = ed, rd.LG = ld, rd.XL = ad;
      ...
      id.displayName = "ArrowLeft", id.categories = ["arrows", "navigation"], id.tags = ["previous", "back", "direction", "west", "<-", "Left", "Navigation", "Back"], id.MD = td, id.LG = sd, id.XL = dd;
      ...
      hd.displayName = "ArrowRight", hd.categories = ["arrows", "navigation"], hd.tags = ["forward", "next", "direction", "east", "->"], hd.MD = od, hd.LG = nd, hd.XL = cd;
      ...
      xd.displayName = "ArrowUpDown", xd.categories = ["arrows", "navigation"], xd.tags = ["bidirectional", "two-way", "2-way", "swap", "switch", "network", "mobile data", "internet", "sort", "reorder", "move", "Sortable", "Control", "Filter", "Sort"], xd.MD = fd, xd.LG = wd, xd.XL = vd;
      ...
      pd.displayName = "ChevronUp", pd.categories = ["arrows", "navigation", "math", "gaming"], pd.tags = ["caret", "keyboard", "mac", "control", "ctrl", "superscript", "exponential", "power", "ahead", "fast", "^", "dropdown", "up", "direction", "top"], pd.MD = gd, pd.LG = jd, pd.XL = ud;
      ...
      bd.displayName = "ChevronDown", bd.categories = ["arrows", "navigation", "gaming"], bd.tags = ["backwards", "reverse", "slow", "dropdown", "down", "direction", "bottom"], bd.MD = md, bd.LG = Rd, bd.XL = Md;
      ...
      Ad.displayName = "ChevronLeft", Ad.categories = ["arrows", "navigation"], Ad.tags = ["back", "previous", "less than", "fewer", "menu", "left", "direction", "side"], Ad.MD = Ld, Ad.LG = zd, Ad.XL = Cd;
      ...
      Id.displayName = "ChevronRight", Id.categories = ["arrows", "navigation", "math", "development"], Id.tags = ["forward", "next", "more than", "greater", "menu", "code", "coding", "command line", "terminal", "prompt", "shell", "right", "direction", "side"], Id.MD = Hd, Id.LG = Dd, Id.XL = Vd;
      ...
      Nd.displayName = "Undo", Nd.categories = ["text", "arrows"], Nd.tags = ["redo", "rerun", "history", "back", "return", "reverse", "revert", "direction", "u-turn", "undo", "arrow", "navigation"], Nd.MD = Bd, Nd.LG = yd, Nd.XL = Gd;
      ...
      Fd.displayName = "Upload", Fd.categories = ["arrows", "files"], Fd.tags = ["file", "up", "file", "share"], Fd.MD = Xd, Fd.LG = qd, Fd.XL = kd;
      ...
      _d.displayName = "Download", _d.categories = ["arrows", "files"], _d.tags = ["import", "export", "save", "down"], _d.MD = Sd, _d.LG = Pd, _d.XL = Od;
      const Td = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Wd.displayName = "ExternalLink", Wd.categories = ["arrows", "text", "social"], Wd.tags = ["outbound", "share", "link", "new tab", "new window", "open", "URL", "hyperlink", "external"], Wd.MD = Td, Wd.LG = Ed, Wd.XL = Ud;
      ...
      Kd.displayName = "RefreshCw", Kd.categories = ["arrows"], Kd.tags = ["rotate", "reload", "rerun", "synchronise", "synchronize", "arrows", "circular", "cycle", "loop", "repeat", "sync", "update", "reset", "restore"], Kd.MD = Zd, Kd.LG = Qd, Kd.XL = Yd;
      ...
      li.displayName = "CirclePerson", li.categories = ["account"], li.tags = ["person", "account", "contact"], li.MD = Jd, li.LG = $d, li.XL = ei;
      ...
      si.displayName = "Flag", si.categories = ["account", "social"], si.tags = ["report"], si.MD = ai, si.LG = ri, si.XL = ti;
      ...
      ni.displayName = "FlagOff", ni.categories = ["account", "social"], ni.tags = ["unflag"], ni.MD = di, ni.LG = ii, ni.XL = oi;
      ...
      wi.displayName = "MapPin", wi.categories = ["navigation", "travel", "account"], wi.tags = ["location", "waypoint", "marker", "drop"], wi.MD = ci, wi.LG = hi, wi.XL = fi;
      ...
      ji.displayName = "ShieldAlert", ji.categories = ["account", "security", "development", "notifications", "gaming"], ji.tags = ["unshielded", "cybersecurity", "insecure", "unsecured", "safety", "unsafe", "protection", "unprotected", "guardian", "unguarded", "unarmored", "unarmoured", "defenseless", "defenceless", "undefended", "defender", "blocked", "stopped", "intercepted", "interception", "saved", "thwarted", "threat", "prevention", "unprevented", "antivirus", "vigilance", "vigilant", "detection", "detected", "scanned", "found", "exploit", "vulnerability", "vulnerable", "weakness", "infection", "infected", "comprimised", "data leak", "audited", "admin", "verification", "unverified", "uncertified", "warning", "emergency", "attention", "urgent", "alarm", "crest", "bravery", "strength", "tough", "attacked", "damaged", "injured", "hit", "expired", "disabled", "inactive", "error", "exclamation mark", "!"], ji.MD = vi, ji.LG = xi, ji.XL = gi;
      ...
      Ri.displayName = "ShieldCheck", Ri.categories = ["account", "security", "development", "gaming"], Ri.tags = ["cybersecurity", "secured", "safety", "protection", "protected", "guardian", "guarded", "armored", "armoured", "defense", "defence", "defended", "blocked", "threat", "prevention", "prevented", "antivirus", "vigilance", "vigilant", "active", "activated", "enabled", "detection", "scanned", "found", "strength", "strong", "tough", "invincible", "invincibility", "invulnerable", "undamaged", "audited", "admin", "verification", "verified", "certification", "certified", "tested", "passed", "qualified", "cleared", "cleaned", "disinfected", "uninfected", "task", "completed", "todo", "done", "ticked", "checked", "crest", "bravery"], Ri.MD = ui, Ri.LG = pi, Ri.XL = mi;
      ...
      zi.displayName = "Star", zi.categories = ["account", "social", "shapes", "multimedia", "weather", "emoji", "gaming"], zi.tags = ["bookmark", "favorite", "like", "review", "rating"], zi.MD = Mi, zi.LG = bi, zi.XL = Li;
      const Ci = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Di.displayName = "PersonMinus", Di.categories = ["account"], Di.tags = ["delete", "remove", "unfollow", "unsubscribe"], Di.MD = Ci, Di.LG = Ai, Di.XL = Hi;
      const Vi = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yi.displayName = "PersonPlus", yi.categories = ["account"], yi.tags = ["new", "add", "create", "follow", "subscribe"], yi.MD = Vi, yi.LG = Ii, yi.XL = Bi;
      ...
      qi.displayName = "TwoPeople", qi.categories = ["account"], qi.tags = ["group", "people"], qi.MD = Gi, qi.LG = Ni, qi.XL = Xi;
      ...
      Pi.displayName = "Wrench", Pi.categories = ["account", "development", "tools"], Pi.tags = ["account", "settings", "spanner", "diy", "toolbox", "build", "construction"], Pi.MD = ki, Pi.LG = Fi, Pi.XL = Si;
      ...
      Ei.displayName = "CircleSlash", Ei.categories = ["account"], Ei.tags = ["cancel", "no", "stop", "forbidden", "prohibited", "error", "incorrect", "mistake", "wrong", "failure", "circle", "slash", "null", "void", "ban", "Blocked", "Restricted", "Denied", "Unavailable", "Stop", "Alert"], Ei.MD = Oi, Ei.LG = _i, Ei.XL = Ti;
      const Ui = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Qi.displayName = "ThumbsUp", Qi.categories = ["account", "social", "emoji"], Qi.tags = ["like", "good", "emotion", "rate", "social", "review", "feedback", "positive"], Qi.MD = Ui, Qi.LG = Wi, Qi.XL = Zi;
      ...
      $i.displayName = "ThumbsDown", $i.categories = ["account", "social", "emoji"], $i.tags = ["dislike", "bad", "emotion", "rate", "social", "review", "feedback", "negative"], $i.MD = Yi, $i.LG = Ki, $i.XL = Ji;
      ...
      ro.displayName = "Link", ro.categories = ["text", "account"], ro.tags = ["chain", "url", "links", "hyperlink"], ro.MD = eo, ro.LG = lo, ro.XL = ao;
      ...
      oo.displayName = "Envelope", oo.categories = ["text", "account", "mail"], oo.tags = ["email", "message", "letter", "unread", "inbox", "chat", "letter", "invitation"], oo.MD = to, oo.LG = so, oo.XL = io;
      ...
      fo.displayName = "Person", fo.categories = ["account"], fo.tags = ["person", "account", "contact", "profile", "avatar", "user", "people", "human"], fo.MD = no, fo.LG = co, fo.XL = ho;
      ...
      go.displayName = "Gear", go.categories = ["account"], go.tags = ["Cog", "Settings", "Preferences", "Options", "Custom", "Customize"], go.LG = wo, go.MD = vo, go.XL = xo;
      ...
      mo.displayName = "Menu", mo.categories = ["layout", "account"], mo.tags = ["bars", "navigation", "hamburger", "options", "side nav", "triple bar", "item"], mo.MD = jo, mo.LG = uo, mo.XL = po;
      ...
      Lo.displayName = "PersonBlock", Lo.categories = ["account"], Lo.tags = ["ban", "block", "delete", "remove", "report"], Lo.MD = Ro, Lo.LG = Mo, Lo.XL = bo;
      ...
      Ho.displayName = "Handshake", Ho.categories = ["account", "social", "communication", "finance", "security"], Ho.tags = ["agreement", "partnership", "deal", "business", "assistance", "cooperation", "friendship", "union", "terms"], Ho.MD = zo, Ho.LG = Co, Ho.XL = Ao;
      ...
      Bo.displayName = "Bug", Bo.categories = ["development", "animals"], Bo.tags = ["issue", "report", "debug", "code", "insect"], Bo.MD = Do, Bo.LG = Vo, Bo.XL = Io;
      ...
      Xo.displayName = "BugOff", Xo.categories = ["development", "animals"], Xo.tags = ["issue", "report", "debug", "code", "insect"], Xo.MD = yo, Xo.LG = Go, Xo.XL = No;
      ...
      So.displayName = "EyeClosed", So.categories = ["accessibility", "photography", "design", "security"], So.tags = ["view", "watch", "see", "hide", "conceal", "mask", "hidden", "visibility", "vision"], So.MD = qo, So.LG = ko, So.XL = Fo;
      ...
      To.displayName = "Info", To.categories = ["accessibility", "notifications"], To.tags = ["help", "info", "information", "support"], To.MD = Po, To.LG = Oo, To.XL = _o;
      const Eo = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Zo.displayName = "CircleHelp", Zo.categories = ["accessibility", "text", "notifications"], Zo.tags = ["question mark", "help", "support", "assistance", "doubt", "FAQ", "tooltip"], Zo.MD = Eo, Zo.LG = Uo, Zo.XL = Wo;
      const Qo = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Jo.displayName = "Moon", Jo.categories = ["accessibility"], Jo.tags = ["dark", "night", "lightness", "theme", "brightness"], Jo.MD = Qo, Jo.LG = Yo, Jo.XL = Ko;
      const $o = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      an.displayName = "Sun", an.categories = ["accessibility", "weather", "seasons", "sustainability"], an.tags = ["brightness", "weather", "light", "summer", "day", "lightness", "theme", "brightness"], an.MD = $o, an.LG = en, an.XL = ln;
      ...
      dn.displayName = "ZoomIn", dn.categories = ["accessibility", "layout", "design", "text", "photography"], dn.tags = ["magnifying glass", "plus", "zoom", "view", "see", "more", "closer"], dn.MD = rn, dn.LG = tn, dn.XL = sn;
      ...
      hn.displayName = "ZoomOut", hn.categories = ["accessibility", "layout", "design", "text", "photography"], hn.tags = ["magnifying glass", "plus", "zoom", "view", "see", "less", "further"], hn.MD = on, hn.LG = nn, hn.XL = cn;
      ...
      xn.displayName = "Eye", xn.categories = ["accessibility", "photography", "design", "security"], xn.tags = ["view", "watch", "see", "show", "expose", "reveal", "display", "visible", "visibility", "vision", "preview", "read", "password", "sign", "vision", "look"], xn.MD = fn, xn.LG = wn, xn.XL = vn;
      ...
      pn.displayName = "EyeOff", pn.categories = ["accessibility", "photography", "design", "security"], pn.tags = ["view", "watch", "see", "hide", "conceal", "mask", "hidden", "visibility", "vision", "lock", "password", "private", "invisible"], pn.MD = gn, pn.LG = jn, pn.XL = un
    }
  }
]);