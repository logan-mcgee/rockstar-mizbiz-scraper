! function() {
  try {
    var a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (a._sentryDebugIds = a._sentryDebugIds || {}, a._sentryDebugIds[e] = "3264e791-c0e9-4b60-966d-fb4f57c6e24c", a._sentryDebugIdIdentifier = "sentry-dbid-3264e791-c0e9-4b60-966d-fb4f57c6e24c")
  } catch (a) {}
}();
  ...
  [2319], {
    94119: (a, e, t) => {
      ...
      const d = (0, i.defineMessages)({
        ...
        ta = (0, o.A)(),
        sa = (a, e) => "/" + [e, ...a.split("/")].filter(Boolean).join("/"),
        na = (a, e) => a ? a === e ? "" : a.startsWith("http") ? a : `https://${ta.sites[a]}.rockstargames.com` : "";
      var oa = t(52542),
        ra = t(91029);
      const ia = a => {
          let {
                ...
                s = a => {
                  ...
                  return {
                    ...
                    ...a.location ? {
                      location: {
                        ...a.location,
                        path: n ? sa(a.location.path, t) : a.location.path,
                        domain: e?.currentSite ? na(a.location.domain, e.currentSite.site) : ""
                      }
                    } : {}
                  }
                };
