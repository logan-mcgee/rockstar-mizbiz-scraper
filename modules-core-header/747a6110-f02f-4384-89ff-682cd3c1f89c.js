try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "747a6110-f02f-4384-89ff-682cd3c1f89c", t._sentryDebugIdIdentifier = "sentry-dbid-747a6110-f02f-4384-89ff-682cd3c1f89c")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [7283], {
    87283(t, e, n) {
      ...
      const E = ({
          ...
          const [f, g] = w(h), y = (0, s.useMemo)(() => S(t), [t]), x = h && !f ? [] : y.map(T), b = (0, s.useRef)(!0), E = (0, s.useRef)(y), P = a(() => new Map), A = (0, s.useRef)(new Set), [M, C] = (0, s.useState)(y), [V, k] = (0, s.useState)(y);
          u(() => {
            b.current = !1, E.current = y;
            for (let t = 0; t < V.length; t++) {
              const e = T(V[t]);
              x.includes(e) ? (P.delete(e), A.current.delete(e)) : !0 !== P.get(e) && P.set(e, !1)
            }
          }, [V, x.length, x.join("-")]);
          const R = [];
          if (y !== M) {
            ...
            for (let e = 0; e < V.length; e++) {
              const n = V[e],
                i = T(n);
              x.includes(i) || (t.splice(e, 0, n), R.push(n))
            }
      ...
      const fe = t => Math.round(1e5 * t) / 1e5,
        ...
        be = {
          ...
          transform: ({
            ...
            blue: n,
            alpha: i = 1
          }) => "rgba(" + we.transform(t) + ", " + we.transform(e) + ", " + we.transform(n) + ", " + fe(ht.transform(i)) + ")"
        },
        Te = {
          test: ve("#"),
          parse: function(t) {
      ...
      function bi(t, e, n, i, o, r) {
        ...
        !v || v.projection || !o || "html" !== v.type && "svg" !== v.type || function(t, e, n, i) {
          ...
          t.projection = new n(t.latestValues, e["data-framer-portal-id"] ? void 0 : Ti(t.parent)), t.projection.setOptions({
            layoutId: o,
            layout: s,
            alwaysMeasureLayout: Boolean(r) || a && wi(a),
            visualElement: t,
        ...
        (0, s.useInsertionEffect)(() => {
          v && w.current && v.update(n, h)
        });
        const b = n[vi],
          T = (0, s.useRef)(Boolean(b) && "undefined" != typeof window && !window.MotionHandoffIsComplete?.(b) && window.MotionHasOptimisedAnimation?.(b));
        return u(() => {
          y.current = !0, v && (w.current = !0, window.MotionIsMounted = !0, v.updateFeatures(), v.scheduleRenderMicrotask(), T.current && v.animationState && v.animationState.animateChanges())
        }), (0, s.useEffect)(() => {
      ...
      const Bo = (t, e) => {
        const n = Re.createTransformer(e),
          i = Ve(t),
          o = Ve(e);
        return i.indexes.var.length === o.indexes.var.length && i.indexes.color.length === o.indexes.color.length && i.indexes.number.length >= o.indexes.number.length ? Co.has(t) && !o.values.length || Co.has(e) && !i.values.length ? Vo(t, e) : wo(Do(function(t, e) {
          const n = [],
            i = {
              color: 0,
              var: 0,
      ...
      function Ko(t = .3, e = .3) {
        ...
        const s = n.keyframes[0],
          ...
          v = Math.abs(g) < 5;
        let x, w, b, T, S, E;
        if (i || (i = v ? Uo : No), o || (o = v ? $o : Yo), f < 1) b = zo(y, f), T = (m + f * y * g) / b, x = t => {
          const e = Math.exp(-f * y * t);
          return r - e * (T * Math.sin(b * t) + g * Math.cos(b * t))
        }, S = f * y * T + g * b, E = f * y * g - T * b, w = t => Math.exp(-f * y * t) * (S * Math.sin(b * t) + E * Math.cos(b * t));
        else if (1 === f) {
          x = t => r - Math.exp(-y * t) * (g + (m + y * g) * t);
          const t = m + y * g;
          w = e => Math.exp(-y * e) * (y * t * e - m)
        } else {
      ...
      function qo({
        ...
        const T = t => {
          var e;
          e = d.value, (void 0 !== a && e < a || void 0 !== l && e > l) && (w = t, b = Ko({
        ...
        return T(0), {
          ...
          next: t => {
            let e = !1;
            return b || void 0 !== w || (e = !0, x(t), T(t)), void 0 !== w && t >= w ? b.next(t - w) : (!e && x(t), d)
          }
        }
      }
      Ko.applyToOptions = t => {
      ...
      class Es extends Yt {
        ...
        initAnimation() {
          ...
          const a = e || ws;
          a !== ws && "number" != typeof r[0] && (this.mixKeyframes = wo(Ss, jo(r[0], r[1])), r = [0, 100]);
          const l = a({
            ...t,
            keyframes: r
          });
        ...
        tick(t, e = !1) {
          ...
          if (c) {
            ...
            let e = Math.floor(t),
              n = t % 1;
            !n && t >= 1 && (n = 1), 1 === n && e--, e = Math.min(e, c + 1), Boolean(e % 2) && ("reverse" === h ? (n = 1 - n, d && (n -= d / r)) : "mirror" === h && (w = s)), x = ut(0, 1, n) * r
          }
          y ? (this.delayState.value = u[0], v = this.delayState) : v = w.next(x), o && !y && (v.value = o(v.value));
          let {
            done: b
          } = v;
      ...
      function Js(t) {
        ...
        function r(r) {
          ...
          for (let e = 0; e < Zs; e++) {
            ...
            const x = Qs(m.prevProp, f);
            let w = x || p === r && m.isActive && !v && g || e > d && g,
              b = !1;
            ...
            const {
              ...
              w = !0, c.has(e) && (b = !0, c.delete(e)), m.needsAnimating[e] = !0;
            ...
            m.prevProp = f, m.prevResolvedValues = S, m.isActive && (h = {
              ...h,
              ...S
            }), (i || o) && t.blockInitialAnimation && (w = !1);
            const M = v && x;
            w && (!M || b) && u.push(...T.map(e => {
              const n = {
                type: p
              };
      ...
      class Nr {
        constructor(t, e, {
          ...
          c && c(t, zr(a, this.history)), this.removeListeners = wo(Ir(this.contextWindow, "pointermove", this.handlePointerMove), Ir(this.contextWindow, "pointerup", this.handlePointerUp), Ir(this.contextWindow, "pointercancel", this.handlePointerUp)), r && this.startScrollTracking(r)
        }
      ...
      class ta {
        ...
        resolveConstraints() {
          ...
          t && wi(t) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : this.constraints = !(!t || !n) && function(t, {
            top: e,
            left: n,
            bottom: i,
            right: o
          ...
          }(e), i !== this.constraints && !wi(t) && n && this.constraints && !this.hasMutatedConstraints && ar(t => {
        ...
        scalePositionWithinConstraints() {
          ...
          if (!wi(e) || !n || !this.constraints) return;
          this.stopAnimation();
          const i = {
            x: 0,
            y: 0
        ...
        addListeners() {
          ...
          const t = this.visualElement.current,
            e = Ir(t, "pointerdown", e => {
              const {
                drag: n,
                dragListener: i = !0
              } = this.getProps(), o = e.target, s = o !== t && xr(o);
              n && i && !s && this.start(e)
            });
          let n;
          const i = () => {
              ...
              wi(e) && e.current && (this.constraints = this.resolveRefConstraints(), n || (n = function(t, e, n) {
                const i = Dr(t, ea(n)),
                  o = Dr(e, ea(n));
                return () => {
                  i(), o()
          ...
          const r = wr(window, "resize", () => this.scalePositionWithinConstraints()),
      ...
      function aa(t) {
        const [e, n] = w(), i = (0, s.useContext)(r);
        return (0, o.jsx)(ra, {
          ...t,
          layoutGroup: i,
          switchLayoutGroup: (0, s.useContext)(xi),
          isPresent: e,
          safeToRemove: n
        })
      }
      ...
      function ga(t, e, n, i, o, s) {
        o ? (t.opacity = Wn(0, n.opacity ?? 1, va(i)), t.opacityExit = Wn(e.opacity ?? 1, 0, xa(i))) : s && (t.opacity = Wn(e.opacity ?? 1, n.opacity ?? 1, i));
        for (let o = 0; o < pa; o++) {
          const s = da[o];
          let r = ya(e, s),
            a = ya(n, s);
      ...
      const vl = Ga({
          attachResizeListener: (t, e) => wr(t, "resize", e),
          measureScroll: () => ({
        ...
        Fl = {
          ...
          focus: {
            Feature: class extends lo {
              ...
              mount() {
                this.unmount = wo(wr(this.node.current, "focus", () => this.onFocus()), wr(this.node.current, "blur", () => this.onBlur()))
              }
              unmount() {}
            }
          },
      ...
      function Ju(t, e, n) {
        ...
        return i && o.projection || (o.projection = new wl(o.latestValues, e)), o.projection.setOptions({
          ...n,
          visualElement: o
      ...
      function $c(t, e, n, i) {
        ...
        const o = "function" == typeof e ? e : wu(e, n, i),
                  ...
                  for (let n = 0; n < t.length; n++) {
                    ...
                    const y = (t, n, i, r = 0, a = 0) => {
                      ...
                      if (P > 0 && gs(c, P), 1 === l.length && l.unshift(null), m) {
                        Lt(m < 20, "Repeat count too high, must be less than 20", "repeat-count-high"), w = uh(w, m);
                        const t = [...l],
                          e = [...c];
                        ...
                        for (let i = 0; i < m; i++) {
                          l.push(...t);
                          for (let o = 0; o < t.length; o++) c.push(e[o] + (i + 1)), x.push(0 === o ? "linear" : oh(n, o - 1))
                        }
                        dh(c, m)
                      }
                      const A = E + w;
                      hh(i, l, x, c, E, A), g = Math.max(b + w, g), d = Math.max(A, d)
                    };
      ...
      function Wh(t) {
        xl.current && (xl.current.isUpdating = !1, xl.current.blockUpdate(), t && t())
      }
          ...
          onDrag: (t, e) => {
            ...
            v(n, s, i[g]),
              function(t, e, n, i) {
                ...
                if (null === a) return wd.delete(o), void xd.delete(o);
                const l = wd.get(o),
              ...
              }(x.current, o[g], g, i[g]), r && r(t, e)
          },
          onDragEnd: (t, e) => {
            ! function() {
              if (bd) {
                const t = Sd(bd, "y");
                t && (wd.delete(t), xd.delete(t));
                const e = Sd(bd, "x");
                e && e !== t && (wd.delete(e), xd.delete(e)), bd = null
              }
            }(), l && l(t, e)
          },
          onLayoutMeasure: t => {
