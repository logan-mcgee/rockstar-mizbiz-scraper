! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "035955c4-033e-40ec-8663-2a160be75e40", e._sentryDebugIdIdentifier = "sentry-dbid-035955c4-033e-40ec-8663-2a160be75e40")
  } catch (e) {}
}();
    ...
    2654: (e, t, s) => {
      ...
      var O = {
        ...
        updateSlides: function() {
          ...
          if (e.virtualSize = Math.max(e.virtualSize, n) + w, a && l && ("slide" === s.effect || "coverflow" === s.effect) && (r.style.width = `${e.virtualSize+E}px`), s.setWrapperSize && (r.style[e.getDirectionLabel("width")] = `${e.virtualSize+E}px`), P && e.grid.updateWrapperSize(_, u), !s.centeredSlides) {
            const t = [];
          ...
          loopFix: function(e) {
            ...
            if (o.__preventObserver__ = !0, requestAnimationFrame((() => {
              ...
              if (void 0 === t) {
                ...
                l ? o.setTranslate(o.translate - t) : (o.slideTo(y - M, 0, !1, !0), i && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t, o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t))
              } else {
      ...
      const X = {
          ...
          events: {
            attachEvents: function() {
              ...
              e.onTouchStart = D.bind(e), e.onTouchMove = N.bind(e), e.onTouchEnd = V.bind(e), e.onDocumentTouchStart = $.bind(e), t.cssMode && (e.onScroll = j.bind(e)), e.onClick = F.bind(e), e.onLoad = R.bind(e), H(e, "on")
            },
