try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "41e3313d-d494-4ac9-a1d1-73325cb1b953", t._sentryDebugIdIdentifier = "sentry-dbid-41e3313d-d494-4ac9-a1d1-73325cb1b953")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [8479], {
    ...
    38174(t, e, n) {
      ...
      function a() {
        r.useEffect(() => {
          ...
          return document.body.firstElementChild !== t && document.body.insertAdjacentElement("afterbegin", t), document.body.lastElementChild !== e && document.body.insertAdjacentElement("beforeend", e), o++, () => {
    ...
    21680(t, e, n) {
      ...
      function H(t) {
        return !!L() && (t instanceof Node || t instanceof _(t).Node)
      }
      ...
      function N(t) {
        return !!L() && (t instanceof HTMLElement || t instanceof _(t).HTMLElement)
      }

      function j(t) {
        return !(!L() || "undefined" == typeof ShadowRoot) && (t instanceof ShadowRoot || t instanceof _(t).ShadowRoot)
      }
      ...
      function Q(t) {
        ...
        const e = t.assignedSlot || t.parentNode || j(t) && t.host || W(t);
        return j(e) ? e.host : e
      }

      function Z(t) {
        const e = Q(t);
        return U(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : N(e) && B(e) ? e : Z(e)
      }
      ...
      function tt(t, e, n) {
        ...
        if (i) {
          const t = et(a);
          return e.concat(a, a.visualViewport || [], B(o) ? o : [], t && n ? tt(t) : [])
        }
      ...
      function ht(t, e) {
        if (!N(t) || "fixed" === J(t).position) return null;
        if (e) return e(t);
        ...
        getClippingRect: function(t) {
          ...
          const l = [..."clippingAncestors" === n ? $(e) ? [] : function(t, e) {
              ...
              for (; F(a) && !U(a);) {
                const e = J(a),
                  n = q(a);
                n || "fixed" !== e.position || (o = null), (i ? !n && !o : !n && "static" === e.position && o && ("absolute" === o.position || "fixed" === o.position) || B(a) && !n && ut(t, a)) ? r = r.filter(t => t !== a) : o = e, a = Q(a)
              }
              return e.set(t, r), r
            ...
            async fn(e) {
              ...
              if (N = [...N, {
                ...
                const t = ((null == (j = i.flip) ? void 0 : j.index) || 0) + 1,
                  e = W[t];
                if (e && ("alignment" !== u || T === y(e) || N.every(t => y(t.placement) !== T || t.overflows[0] > 0))) return {
                  data: {
                    index: t,
                    overflows: N
                  },
                ...
                let n = null == (B = N.filter(t => t.overflows[0] <= 0).sort((t, e) => t.overflows[1] - e.overflows[1])[0]) ? void 0 : B.placement;
                if (!n) switch (E) {
                  case "bestFit": {
                    var z;
        ...
        xt = t => ({
          ...
          async fn(e) {
            ...
            const m = E(p),
              ...
              k = y[x] - a.reference[x],
              C = await (null == l.getOffsetParent ? void 0 : l.getOffsetParent(f));
            let T = C ? C[O] : 0;
            T && await (null == l.isElement ? void 0 : l.isElement(C)) || (T = s.floating[O] || a.floating[v]);
            const D = P / 2 - k / 2,
              L = T / 2 - b[v] / 2 - 1,
              M = i(m[R], L),
              _ = i(m[S], L),
              ...
              F = T / 2 - b[v] / 2 + D,
              N = u(W, F, H),
              j = !c.arrow && null != h(o) && F !== N && a.reference[v] / 2 - (F < W ? M : _) - b[v] / 2 < 0,
              B = j ? F < W ? F - W : F - H : 0;
            return {
              [x]: y[x] + B,
              data: {
              ...
              async fn(e) {
                ...
                const {
                  ...
                  const {
                    ...
                    platform: r,
                    elements: o
                  } = t, i = await (null == r.isRTL ? void 0 : r.isRTL(o.floating)), a = p(n), l = h(n), s = "y" === y(n), c = D.has(a) ? -1 : 1, f = i && s ? -1 : 1, u = d(e, t);
                  let {
                    mainAxis: m,
                    crossAxis: g,
                    alignmentAxis: w
          ...
          const n = function(t) {
            return void 0 === t && (t = {}), {
              ...
              async fn(e) {
                ...
                let C = O,
                  T = P;
                if (null != (n = e.middlewareData.shift) && n.enabled.x && (T = E), null != (r = e.middlewareData.shift) && r.enabled.y && (C = S), k && !w) {
                  const t = a(m.left, 0),
                    e = a(m.right, 0),
                    n = a(m.top, 0),
                    r = a(m.bottom, 0);
                  x ? T = v - 2 * (0 !== t || 0 !== e ? t + e : a(m.left, m.right)) : C = b - 2 * (0 !== n || 0 !== r ? n + r : a(m.top, m.bottom))
                }
                await f({
                  ...e,
                  availableWidth: T,
              ...
              async fn(e) {
                ...
                switch (o) {
                  case "referenceHidden": {
                    const t = C(await r.detectOverflow(e, {
                      ...i,
      ...
      var Ft = Ht,
        ...
        Gt = t => {
          const {
            __scopePopper: e,
            children: n
          } = t, [o, i] = r.useState(null), [a, l] = r.useState(void 0);
          return (0, Wt.jsx)(Yt, {
            scope: e,
            anchor: o,
            onAnchorChange: i,
      ...
      var Ut = "PopperAnchor",
        Jt = r.forwardRef((t, e) => {
          const {
            ...
            virtualRef: o,
            ...i
          } = t, a = qt(Ut, n), l = r.useRef(null), s = a.onAnchorChange, c = r.useCallback(t => {
            l.current = t, t && s(t)
          }, [s]), f = (0, Nt.s)(e, c), u = r.useRef(null);
          r.useEffect(() => {
            if (!o) return;
            const t = u.current;
            u.current = o.current, t !== u.current && s(u.current)
          });
          const d = a.placementState && ae(a.placementState),
            p = d?.[0],
            h = d?.[1];
          return o ? null : (0, Wt.jsx)(_t.sG.div, {
      ...
      var Kt = "PopperContent",
        ...
        te = r.forwardRef((t, e) => {
          const {
            ...
            onPlaced: w,
            ...x
          } = t, v = qt(Kt, n), [b, A] = r.useState(null), R = (0, Nt.s)(e, t => A(t)), [S, E] = r.useState(null), O = (0, $t.X)(S), P = O?.width ?? 0, k = O?.height ?? 0, C = o + ("center" !== c ? "-" + c : ""), T = "number" == typeof h ? h : {
            top: 0,
            right: 0,
            bottom: 0,
            left: 0,
            ...h
          }, D = Array.isArray(p) ? p : [p], L = D.length > 0, M = {
            padding: T,
            boundary: D.filter(oe),
            altBoundary: L
          }, {
            refs: _,
            floatingStyles: H,
            ...
            const [m, g] = r.useState(null), [y, w] = r.useState(null), x = r.useCallback(t => {
            ...
            }, []), b = a || m, A = l || y, R = r.useRef(null), S = r.useRef(null), E = r.useRef(u), O = null != c, P = Pt(c), k = Pt(i), C = Pt(f), T = r.useCallback(() => {
              ...
              k.current && (t.platform = k.current), bt(R.current, S.current, t).then(t => {
                const e = {
                  ...t,
                  isPositioned: !1 !== C.current
                };
                D.current && !St(E.current, e) && (E.current = e, At.flushSync(() => {
                  d(e)
                }))
              })
            }, [p, e, n, k, C]);
            ...
            Rt(() => (D.current = !0, () => {
              ...
              if (b && (R.current = b), A && (S.current = A), b && A) {
                if (P.current) return P.current(b, A, T);
                T()
              }
            }, [b, A, T, P, O]);
            const L = r.useMemo(() => ({
            ...
            middleware: [kt({
              ...
              ...M,
              boundary: L ? M.boundary : void 0
            })]
          });
          var B;
          const z = v.setPlacementState;
          (0, zt.N)(() => (z(F), () => {
            z(void 0)
          }), [F, z]);
          const [$, I] = ae(F), V = (0, Bt.c)(w);
          (0, zt.N)(() => {
            N && V?.()
          }, [N, V]);
          const X = j.arrow?.x,
            Y = j.arrow?.y,
            q = 0 !== j.arrow?.centerOffset,
            [G, U] = r.useState();
          return (0, zt.N)(() => {
