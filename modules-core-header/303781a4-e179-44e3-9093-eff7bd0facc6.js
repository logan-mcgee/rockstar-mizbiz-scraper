        ...
        fn: function(e) {
          ...
          if (p && l) {
            var m = function(e, t) {
              ...
              g = "y" === u ? r : a,
              b = "y" === u ? o : i,
              y = n.rects.reference[h] + n.rects.reference[u] - l[u] - n.rects.popper[h],
      ...
      function te(e) {
        ...
        if (h) {
          var A = X(n),
            P = "clientHeight",
            _ = "clientWidth";
          A === M(n) && "static" !== N(A = U(n)).position && "absolute" === d && (P = "scrollHeight", _ = "scrollWidth"), (f === r || (f === a || f === i) && c === p) && (D = o, w -= (v && A === k && k.visualViewport ? k.visualViewport.height : A[P]) - s.height, w *= u ? 1 : -1), f !== a && (f !== r && f !== o || c !== p) || (j = i, b -= (v && A === k && k.visualViewport ? k.visualViewport.width : A[_]) - s.width, b *= u ? 1 : -1)
        }
      ...
      const be = {
        ...
        fn: function(e) {
          ...
          if (!t.modifiersData[p]._skip) {
            for (var l = n.mainAxis, d = void 0 === l || l, u = n.altAxis, h = void 0 === u || u, g = n.fallbackPlacements, b = n.padding, y = n.boundary, w = n.rootBoundary, x = n.altBoundary, O = n.flipVariations, E = void 0 === O || O, j = n.allowedAutoPlacements, D = t.options.placement, k = R(D), A = g || (k !== D && E ? function(e) {
                if (R(e) === s) return [];
                var t = ae(e);
                return [fe(e), t, fe(t)]
