try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    l = (new e.Error).stack;
  l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "9dcc406c-e52a-4818-bc44-1ec9902a6a6c", e._sentryDebugIdIdentifier = "sentry-dbid-9dcc406c-e52a-4818-bc44-1ec9902a6a6c")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [3368], {
    33368: (e, l, a) => {
      a.r(l), a.d(l, {
        ...
        ChevronsUpDown: () => it,
        CircleCheck: () => zn,
        CircleCheckFilled: () => Pn,
        CircleDollarSign: () => Hf,
        CircleHelp: () => k,
        CircleMinus: () => nc,
        CircleMinusFilled: () => Lc,
        CirclePerson: () => He,
        CircleSlash: () => Oe,
        CircleX: () => xc,
        Clipboard: () => Dd,
      ...
      Jh.displayName = "LockKeyhole", Jh.categories = ["security"], Jh.tags = ["security", "password", "secure", "admin", "lock", "safe", "protection", "security", "latch"], Jh.SM = Zh, Jh.LG = Yh, Jh.MD = Kh, Jh.XL = Qh;
      const $h = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      rn.displayName = "LockPassword", rn.categories = ["security"], rn.tags = ["security", "password", "secure", "admin"], rn.SM = $h, rn.LG = en, rn.MD = ln, rn.XL = an;
      ...
      hn.displayName = "Image", hn.categories = ["photography", "text", "multimedia", "files"], hn.tags = ["picture", "photo"], hn.SM = tn, hn.LG = sn, hn.MD = dn, hn.XL = on;
      ...
      vn.displayName = "Lightbulb", vn.categories = ["photography"], vn.tags = ["idea", "bright", "lights"], vn.SM = nn, vn.LG = cn, vn.MD = fn, vn.XL = wn;
      ...
      pn.displayName = "Check", pn.categories = ["notifications"], pn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "success", "accept"], pn.SM = xn, pn.LG = gn, pn.MD = jn, pn.XL = mn;
      ...
      zn.displayName = "CircleCheck", zn.categories = ["notifications"], zn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], zn.SM = un, zn.LG = Mn, zn.MD = Rn, zn.XL = bn;
      ...
      Vn.displayName = "TriangleAlert", Vn.categories = ["notifications", "shapes", "development"], Vn.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], Vn.SM = Ln, Vn.LG = Cn, Vn.MD = Hn, Vn.XL = An;
      ...
      Dn.displayName = "X", Dn.categories = ["notifications", "math"], Dn.tags = ["cancel", "close", "delete", "remove", "times", "clear", "math", "multiply", "multiplication", "error", "remove", "clean", "erase", "navigation", "cross", "times"], Dn.SM = Bn, Dn.LG = In, Dn.MD = Sn, Dn.XL = yn;
      ...
      Pn.displayName = "CircleCheckFilled", Pn.categories = ["notifications"], Pn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success", "filled"], Pn.SM = Gn, Pn.MD = Nn, Pn.LG = Xn, Pn.XL = qn;
      ...
      En.displayName = "Globe", En.categories = ["navigation"], En.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], En.SM = Fn, En.LG = kn, En.MD = On, En.XL = Tn;
      const Un = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Yn.displayName = "Pin", Yn.categories = ["navigation"], Yn.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point"], Yn.SM = Un, Yn.MD = _n, Yn.LG = Wn, Yn.XL = Zn;
      ...
      ec.displayName = "PinFilled", ec.categories = ["navigation"], ec.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point", "filled"], ec.SM = Kn, ec.MD = Qn, ec.LG = Jn, ec.XL = $n;
      ...
      sc.displayName = "HeartPulse", sc.categories = ["medical"], sc.tags = ["heartbeat", "pulse", "health", "medical", "blood pressure", "cardiac", "systole", "diastole"], sc.SM = lc, sc.LG = ac, sc.MD = rc, sc.XL = tc;
      ...
      nc.displayName = "CircleMinus", nc.categories = ["math"], nc.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete"], nc.SM = ic, nc.LG = dc, nc.MD = oc, nc.XL = hc;
      ...
      xc.displayName = "CircleX", xc.categories = ["math", "development"], xc.tags = ["cancel", "close", "delete", "remove", "times", "clear", "error", "incorrect", "wrong", "mistake", "failure", "linter", "multiply", "multiplication", "clean", "erase", "deprecate", "delete", "navigation"], xc.SM = cc, xc.LG = fc, xc.MD = wc, xc.XL = vc;
      ...
      uc.displayName = "Minus", uc.categories = ["math", "development", "text", "tools"], uc.tags = ["subtract", "remove", "decrease", "decrement", "reduce", "negative", "calculate", "line", "divider", "separator", "horizontal rule", "hr", "html", "markup", "markdown", "---", "toolbar", "operator", "code", "coding", "minimum", "downgrade", "less", "delete", "navigation", "minimize"], uc.SM = gc, uc.LG = jc, uc.MD = mc, uc.XL = pc;
      ...
      Lc.displayName = "CircleMinusFilled", Lc.categories = ["math"], Lc.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete", "filled"], Lc.SM = Mc, Lc.MD = Rc, Lc.LG = bc, Lc.XL = zc;
      const Cc = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Bc.displayName = "EnvelopeOpen", Bc.categories = ["mail"], Bc.tags = ["email", "message", "letter", "read"], Bc.SM = Cc, Bc.LG = Hc, Bc.MD = Ac, Bc.XL = Vc;
      const Ic = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Gc.displayName = "Paperclip", Gc.categories = ["text", "design", "files", "mail"], Gc.tags = ["attachment", "file", "attach", "clip", "document", "paper"], Gc.SM = Ic, Gc.LG = Sc, Gc.MD = yc, Gc.XL = Dc;
      ...
      Fc.displayName = "Trash", Fc.categories = ["files", "mail"], Fc.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], Fc.SM = Nc, Fc.LG = Xc, Fc.MD = qc, Fc.XL = Pc;
      ...
      Uc.displayName = "EllipsisVertical", Uc.categories = ["layout"], Uc.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], Uc.SM = kc, Uc.LG = Oc, Uc.MD = Tc, Uc.XL = Ec;
      ...
      Kc.displayName = "Filter", Kc.categories = ["layout"], Kc.tags = ["funnel", "hopper"], Kc.SM = _c, Kc.LG = Wc, Kc.MD = Zc, Kc.XL = Yc;
      ...
      lf.displayName = "Weapon", lf.categories = ["gaming"], lf.tags = ["gun", "pistol", "GTAO", "fire", "shoot", "death", "danger"], lf.SM = Qc, lf.LG = Jc, lf.MD = $c, lf.XL = ef;
      ...
      df.displayName = "Heart", df.categories = ["medical", "social", "multimedia", "emoji", "gaming", "shapes"], df.tags = ["like", "love", "emotion", "suit", "playing", "cards"], df.SM = af, df.LG = rf, df.MD = tf, df.XL = sf;
      ...
      ff.displayName = "FileText", ff.categories = ["files", "text"], ff.tags = ["data", "txt", "pdf", "document"], ff.SM = of, ff.LG = hf, ff.MD = nf, ff.XL = cf;
      ...
      jf.displayName = "Files", jf.categories = ["files"], jf.tags = ["multiple", "copy", "documents", "data", "file", "folder", "restore"], jf.SM = wf, jf.LG = vf, jf.MD = xf, jf.XL = gf;
      ...
      Rf.displayName = "Save", Rf.categories = ["files"], Rf.tags = ["floppy disk", "download", "backup", "storage", "disk", "document", "computer", "archive"], Rf.SM = mf, Rf.MD = pf, Rf.LG = uf, Rf.XL = Mf;
      ...
      Hf.displayName = "CircleDollarSign", Hf.categories = ["finance"], Hf.tags = ["monetization", "marketing", "currency", "money", "payment"], Hf.SM = bf, Hf.LG = zf, Hf.MD = Lf, Hf.XL = Cf;
      const Af = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Sf.displayName = "DollarSign", Sf.categories = ["finance"], Sf.tags = ["currency", "money", "payment"], Sf.SM = Af, Sf.LG = Vf, Sf.MD = Bf, Sf.XL = If;
      ...
      Xf.displayName = "FastForward", Xf.categories = ["multimedia", "arrows"], Xf.tags = ["music", "audio", "video", "control", "player", "media"], Xf.SM = yf, Xf.LG = Df, Xf.MD = Gf, Xf.XL = Nf;
      ...
      Of.displayName = "Pause", Of.categories = ["multimedia"], Of.tags = ["music", "audio", "video", "stop", "pause", "control", "player", "media"], Of.SM = qf, Of.LG = Pf, Of.MD = Ff, Of.XL = kf;
      ...
      Wf.displayName = "Play", Wf.categories = ["arrows", "multimedia"], Wf.tags = ["music", "audio", "video", "start", "run", "play", "continue", "control", "player", "media"], Wf.SM = Tf, Wf.LG = Ef, Wf.MD = Uf, Wf.XL = _f;
      ...
      Jf.displayName = "Rewind", Jf.categories = ["arrows", "multimedia"], Jf.tags = ["music", "audio", "video", "control", "player", "previous", "back", "reverse", "media"], Jf.SM = Zf, Jf.LG = Yf, Jf.MD = Kf, Jf.XL = Qf;
      ...
      rw.displayName = "SkipBack", rw.categories = ["multimedia", "arrows"], rw.tags = ["music", "audio", "video", "arrow", "previous", "back", "rewind", "reverse", "control", "player", "media"], rw.SM = $f, rw.LG = ew, rw.MD = lw, rw.XL = aw;
      ...
      ow.displayName = "SkipForward", ow.categories = ["multimedia", "arrows"], ow.tags = ["music", "audio", "video", "arrow", "skip", "next", "forward", "control", "player", "media"], ow.SM = tw, ow.LG = sw, ow.MD = iw, ow.XL = dw;
      ...
      ww.displayName = "StarOff", ww.categories = ["multimedia", "social"], ww.tags = ["dislike", "unlike", "remove", "unrate"], ww.SM = hw, ww.LG = nw, ww.MD = cw, ww.XL = fw;
      ...
      mw.displayName = "Stop", mw.categories = ["multimedia"], mw.tags = ["music", "audio", "video", "control", "player", "stop", "media"], mw.SM = vw, mw.LG = xw, mw.MD = gw, mw.XL = jw;
      ...
      bw.displayName = "ListMusic", bw.categories = ["multimedia"], bw.tags = ["playlist", "music", "audio", "control", "player", "media", "queue", "playback", "play", "list"], bw.SM = pw, bw.MD = uw, bw.LG = Mw, bw.XL = Rw;
      ...
      Aw.displayName = "Book", Aw.categories = ["text", "gaming"], Aw.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], Aw.SM = zw, Aw.LG = Lw, Aw.MD = Cw, Aw.XL = Hw;
      const Vw = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yw.displayName = "CloudAlert", yw.categories = ["development"], yw.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], yw.SM = Vw, yw.LG = Bw, yw.MD = Iw, yw.XL = Sw;
      ...
      qw.displayName = "CodeXml", qw.categories = ["text", "development"], qw.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], qw.SM = Dw, qw.LG = Gw, qw.MD = Nw, qw.XL = Xw;
      const Pw = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Tw.displayName = "Database", Tw.categories = ["devices", "development"], Tw.tags = ["storage", "memory", "container", "tin", "pot", "bytes", "servers"], Tw.SM = Pw, Tw.LG = Fw, Tw.MD = kw, Tw.XL = Ow;
      ...
      Zw.displayName = "Server", Zw.categories = ["development", "devices"], Zw.tags = ["cloud", "storage"], Zw.SM = Ew, Zw.LG = Uw, Zw.MD = _w, Zw.XL = Ww
    }
  }
]);