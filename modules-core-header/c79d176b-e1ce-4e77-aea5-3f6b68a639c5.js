try {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new a.Error).stack;
  e && (a._sentryDebugIds = a._sentryDebugIds || {}, a._sentryDebugIds[e] = "c79d176b-e1ce-4e77-aea5-3f6b68a639c5", a._sentryDebugIdIdentifier = "sentry-dbid-c79d176b-e1ce-4e77-aea5-3f6b68a639c5")
} catch (a) {} {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [4461], {
    ...
    37587: (a, e, t) => {
      ...
      const pa = a => {
        ...
        fa = "rockstargames-modules-core-headera4f8eb74ae350f61ed4b4fffa4d8ff8d";
      var ha = t(60520);
      const ba = (0, d.defineMessages)({
          games_menu_item: {
            id: "games_menu_item",
            defaultMessage: "Games"
          },
      ...
      const ka = a => {
          ...
          const t = (0, d.useIntl)(),
            ...
            l = s.currentSite?.site === r.C.www ? i : `https://${s.currentSite?.subDomain}.rockstargames.com`,
            {
              viewAllLocation: g,
              games: _
            } = (0, o.useMemo)((() => wa(t)), [n]);
            ...
            children: [(0, va.jsxs)("div", {
              ...
              children: [(0, va.jsx)("div", {
                ...
                children: (0, va.jsxs)("a", {
                  className: fa,
                  href: l + g.path,
                  children: [t.formatMessage(ba.games_menu_view_all), (0, va.jsx)("img", {
                    src: ha.ZM,
                    alt: t.formatMessage(ba.games_menu_view_all)
                  })]
                })
              })]
            }), (0, va.jsx)("div", {
              className: "rockstargames-modules-core-headere104ee1bbcd8b04a2ea224fdccd9bb67",
              children: _.map((a => (0, va.jsx)(pa, {
        ...
        Ca = a => {
          ...
          const t = (0, d.useIntl)(),
            {
              isHidden: s
            } = (0, o.useContext)(Ma.jd),
            {
              inMobileMenu: n
            } = (0, o.useContext)(ya.xN);
          return n ? (0, va.jsx)(Ta, {
            onNavigate: e
          }) : (0, va.jsxs)(Ma.Dr, {
            children: [(0, va.jsx)(Ma.cQ, {
              children: t.formatMessage(ba.games_menu_item)
            }), (0, va.jsx)(xa.AnimatePresence, {
              children: !s && (0, va.jsx)(Ma.rm, {
                className: "rockstargames-modules-core-headercaea3404775ed365d2f4aef72c9990dc",
                animationOverride: "expandCollapse",
                children: (0, va.jsx)(ka, {
                  onNavigate: e
                })
              })
            })]
        ...
        Ta = a => {
          ...
          const t = (0, d.useIntl)(),
            ...
            g = s.currentSite?.site === r.C.www ? l : `https://${s.currentSite?.subDomain}.rockstargames.com`,
            {
              viewAllLocation: _,
              games: c
            } = (0, o.useMemo)((() => wa(t)), [n]);
          return (0, va.jsxs)("div", {
            ...
            children: [(0, va.jsxs)("div", {
              ...
              slidesPerView: 2.5,
              speed: 700,
              children: c.map((a => (0, va.jsx)(ca.qr, {
      ...
      const Sa = a => {
          ...
          const u = (0, d.useIntl)(),
                ...
                s = a => {
                  ...
                  return {
                    ...
                    ...a.location ? {
                      location: {
                        ...a.location,
                        path: n ? oa(a.location.path, t) : a.location.path,
              ...
              return L.targets.findIndex((n => {
                if ("" === n.type && n.location) {
                  if (n.location.path && t.startsWith(n.location.path)) {
                    const t = j(s, n.location.params);
                    if (t) return e = t, a = n, !0
                  }
                  if (!n.location.params) {
                    const s = S(t, n.location.path);
            ...
            N = (0, o.useCallback)(((a, e) => {
              let t;
              return a.forEach((a => {
                if ("nav-dropdown" === a.type) {
                  const s = N(a.targets, e);
                  s && (t = s)
                } else a.value === e && (t = a)
              })), t
            }), [L]),
            B = (0, o.useCallback)((a => {
              if ("" === a) return !1;
              const e = ta?.(a);
              return a.split(/\s+/).every((a => a.length < 3)) ? (b(u.formatMessage(ja.A.nav_search_error_too_short, {
                count: 3
              })), !1) : e ? (b(u.formatMessage(ja.A.nav_search_error_invalid_chars, {
                invalidChars: [...new Set(e)].join(", ")
              })), !1) : (b(""), !0)
            }), []),
            A = (0, o.useCallback)(((a, e) => {
              if (B(a) && e) {
                const t = N(L.targets, e);
                return t ? f(a, t.location) : null
              }
            }), [L]),
            R = (0, o.useMemo)((() => ({
              loggedInLinks: la(u, g, _, c).map(p),
              helpItem: p(_a(u))
            })), [u, g, _, c]);
      ...
      const B = a => {
              ...
              children: (0, N.jsxs)(o.Root, {
                ...
                children: [(0, N.jsxs)(D, {
                  ...
                  children: [d, g?.length > 0 && (0, N.jsxs)(z, {
                    children: [(0, N.jsx)(E, {
                      children: t.formatMessage(S.A.nav_more_dropdown)
                    }), (0, N.jsx)(F, {
                      children: (0, N.jsx)(J, {
                        children: (0, N.jsx)(D, {
                          children: g
        ...
        J = (0, s.forwardRef)((function(a, e) {
          ...
          const {
            ...
            isNavHidden: d
          } = (0, s.useContext)(P.PY), [l, g] = (0, s.useState)("");
          (0, s.useEffect)((() => {
            g("")
          }), [i, d]);
          const _ = r ? r + 1 : 1;
    ...
    74956: (a, e, t) => {
      ...
      const f = (0, s.createContext)({
        ...
        M = a => {
          ...
          const n = (0, g.useIntl)();
          return (0, p.jsx)("div", {
            className: r()("rockstargames-modules-core-headerfb5e947b9aa01caf3aa9bca4ddcb3dee", e),
            children: (0, p.jsxs)(d.Trigger, {
              title: n.formatMessage(t ? u.A.nav_mobilemenu_close : u.A.nav_mobilemenu_open),
              type: "button",
              className: r()({
                [v]: t
              }, "rockstargames-modules-core-headerffee60778b241ac8cd6bc04685b782d3"),
              ...s,
    ...
    75736: (a, e, t) => {
      ...
      const b = a => {
        ...
        w = "rockstargames-modules-core-headerc21d08286895e5d5d2fc1a7586c6a11d",
        M = "rockstargames-modules-core-headerb82b1a7297d0e2f91a3ac183adcb21c4",
        y = "rockstargames-modules-core-headerfa4a01e9a53561bce475cd223f7cafe1",
        x = (0, s.createContext)({
          inAvatarMenu: !1,
                ...
                children: (0, h.jsxs)("div", {
                  ...
                  children: [(0, h.jsx)(n.Trigger, {
                    ...
                    children: (0, h.jsx)("button", {
                      className: M,
                      "aria-label": v.formatMessage(f ? m.A.avatar_menu_close : m.A.avatar_menu_open),
              ...
              children: (0, h.jsx)(c.E, {
                ...
                children: (0, h.jsxs)("div", {
                  ...
                  children: [(0, h.jsx)(r.Trigger, {
                    className: M,
                    "aria-label": v.formatMessage(I ? m.A.avatar_menu_close : m.A.avatar_menu_open),
                    "data-testid": "avatarMenuButton",
                    children: (0, h.jsx)("img", {
                      className: y,
                      src: e || p
                      ...
                      children: (0, h.jsxs)(r.Content, {
                        ...
                        children: [(0, h.jsx)(i.VisuallyHidden, {
                          children: (0, h.jsx)(r.Title, {
                            children: v.formatMessage(m.A.nav_avatarmenu_title)
                          })
                          ...
                          children: [(0, h.jsx)(r.Close, {
                            ...
                            children: (0, h.jsx)("img", {
                              ...
                              src: "",
                              "aria-label": v.formatMessage(m.A.avatar_menu_close)
                            })
                          }), (0, h.jsx)(o.Root, {
                            type: "multiple",
                            value: j,
        ...
        N = a => {
          ...
          const {
            ...
            avatarMenuItemId: r
          } = (0, s.useContext)(L), i = n.indexOf(r) >= 0;
    ...
    78211: (a, e, t) => {
      ...
      const m = (0, s.createContext)({
        ...
        u = a => {
          ...
          const {
            inMobileMenu: t
          } = (0, s.useContext)(r.xN), l = {
            hidden: {
              opacity: 0,
              y: 10,
              transition: d.b.staggerFade
            },
            show: {
              opacity: 1,
              y: 0,
          ...
          }, u = g()("rockstargames-modules-core-headeredd6d5149d36c2b3d89460393482b5a1", t ? n : o), v = g()("rockstargames-modules-core-headere3008521b763b81f3b4f2c3659d22cc2", t ? n : o);
          return t ? (0, c.jsx)(m.Provider, {
            value: {
              inQuickMenu: !0
            },
            children: (0, c.jsx)(_.Root, {
              asChild: !0,
              children: (0, c.jsx)(i.motion.div, {
                variants: l,
                className: u,
                children: s.Children.map(e, (a => (0, c.jsx)(i.motion.li, {
                  variants: l,
                  className: v,
                  children: a
                })))
