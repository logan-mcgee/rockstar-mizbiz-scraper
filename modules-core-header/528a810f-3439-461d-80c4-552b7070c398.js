try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "528a810f-3439-461d-80c4-552b7070c398", e._sentryDebugIdIdentifier = "sentry-dbid-528a810f-3439-461d-80c4-552b7070c398")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      var A = {
          ...
          for (let r = 0; r < p; r += 1) {
            ...
            if (_ = 0, c[r] && (i = c[r]), C && e.grid.updateSlide(r, i, c), !c[r] || "none" !== b(i, "display")) {
              if ("auto" === s.slidesPerView) {
                ...
                if (a && (i.style.transform = "none"), o && (i.style.webkitTransform = "none"), s.roundLengths) _ = e.isHorizontal() ? T(i, "width", !0) : T(i, "height", !0);
                else {
                  const e = t(n, "width"),
                    s = t(n, "padding-left"),
                    r = t(n, "padding-right"),
              ...
              c[r] && (c[r].swiperSlideSize = _), m.push(_), s.centeredSlides ? (x = x + _ / 2 + M / 2 + E, 0 === M && 0 !== r && (x = x - n / 2 - E), 0 === r && (x = x - n / 2 - E), Math.abs(x) < .001 && (x = 0), s.roundLengths && (x = Math.floor(x)), P % s.slidesPerGroup == 0 && u.push(x), f.push(x)) : (s.roundLengths && (x = Math.floor(x)), (P - Math.min(e.params.slidesPerGroupSkip, P)) % e.params.slidesPerGroup == 0 && u.push(x), f.push(x), x = x + _ + E), e.virtualSize += _ + E, M = _, P += 1
            }
          }
        ...
        updateSlidesProgress: function(e) {
          ...
          for (let e = 0; e < r.length; e += 1) {
            ...
            m && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), k(l, m, s.slideVisibleClass), k(l, h, s.slideFullyVisibleClass), l.progress = i ? -c : c, l.originalProgress = i ? -p : p
          }
        },
        ...
        updateSlidesClasses: function() {
          ...
          l && (a || (c = function(e, t) {
            ...
            O(e, e === l, s.slideActiveClass), O(e, e === c, s.slideNextClass), O(e, e === d, s.slidePrevClass)
          })), e.emitSlidesClasses()
        },
      ...
      var D = {
        ...
        N = {
          ...
          loopFix: function(e) {
            ...
            let k = 0,
              O = 0;
            const I = (T ? c[n].column : n) + (m && void 0 === i ? -w / 2 + .5 : 0);
            if (I < S) {
              k = Math.max(S - I, b);
              ...
              O = Math.max(I - (x - 2 * S), b), M && (O = Math.max(O, w - x + v + 1));
              for (let e = 0; e < O; e += 1) {
                const t = e - Math.floor(e / x) * x;
                T ? c.forEach(((e, s) => {
                  e.column === t && E.push(s)
            ...
            if (d.__preventObserver__ = !0, requestAnimationFrame((() => {
              ...
              if (void 0 === t) {
                ...
                l ? d.setTranslate(d.translate - t) : (d.slideTo(P - O, 0, !1, !0), i && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t))
              } else {
      ...
      const Z = {
          ...
          events: {
            attachEvents: function() {
              ...
              e.onTouchStart = V.bind(e), e.onTouchMove = R.bind(e), e.onTouchEnd = j.bind(e), e.onDocumentTouchStart = Y.bind(e), t.cssMode && (e.onScroll = H.bind(e)), e.onClick = $.bind(e), e.onLoad = W.bind(e), q(e, "on")
            },
          ...
          breakpoints: {
            setBreakpoint: function() {
              ...
              const p = (c in n ? n[c] : void 0) || e.originalParams,
                ...
                v = p.grabCursor,
                g = r.enabled;
              u && !h ? (i.classList.remove(`${r.containerModifierClass}grid`, `${r.containerModifierClass}grid-column`), e.emitContainerClasses()) : !u && h && (i.classList.add(`${r.containerModifierClass}grid`), (p.grid.fill && "column" === p.grid.fill || !p.grid.fill && "column" === r.grid.fill) && i.classList.add(`${r.containerModifierClass}grid-column`), e.emitContainerClasses()), m && !v ? e.unsetGrabCursor() : !m && v && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach((t => {
      ...
      const fe = (0, r.createContext)(null),
        ...
        me = (0, r.forwardRef)((function(e, t) {
          ...
          return g.current || L(), w.current && w.current.on("_beforeBreakpoint", I), (0, r.useEffect)((() => () => {
            ...
            swiper: w.current,
            swiperSlideIndex: t
          }))), O["wrapper-end"]), re(M) && r.createElement(r.Fragment, null, r.createElement("div", {
            ref: y,
