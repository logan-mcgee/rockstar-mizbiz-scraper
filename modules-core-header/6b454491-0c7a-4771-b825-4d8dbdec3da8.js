try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    o = (new e.Error).stack;
  o && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[o] = "6b454491-0c7a-4771-b825-4d8dbdec3da8", e._sentryDebugIdIdentifier = "sentry-dbid-6b454491-0c7a-4771-b825-4d8dbdec3da8")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const u = (e, o) => {
        ...
        g = () => {
          ...
          const a = `rockstarweb_lang.${o.cookieIdentifier}`,
            i = m(a);
          r = o.currentSite?.site === c.C.www ? w.find((e => e.subdomaincom === n)) || w.find((e => e.subdomaincom === t)) || s : w.find((e => e.iso === i)) || s;
          const [, l] = p(a, r.iso);
          return [r, l]
        };
      var k = t(55422);
        ...
        j = e => {
          ...
          if (n)
            for (const [s, {
              ...
              let p = "";
              return "www" !== s || d?.some((e => e.test(n.pathname))) ? (p += `https://${c}`, p += a ? `.${m.at(-2)}.${m.at(-1)}` : `.${m.at(-1)}`, {
        ...
        x = ({
          ...
          const n = (0, c.A)(),
            ...
            i = (e => {
              ...
              const t = o.split("/");
              return w.map((e => e.subdomaincom)).includes(t[0]) && (o = t.slice(1).join("/")), n.currentSite?.site === c.C.www ? "en" === e ? `${window.location.origin}/${o}${location.search}` : `${window.location.origin}/${e}/${o}${location.search}` : `${window.location.origin}/${o}${location.search}`
            })(r);
          o?.({
            event: "cta_other",
            link_url: i,
