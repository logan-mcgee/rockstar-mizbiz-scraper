try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "26d1fce2-f45c-46af-bce5-458edc5709fb", e._sentryDebugIdIdentifier = "sentry-dbid-26d1fce2-f45c-46af-bce5-458edc5709fb")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    65001(e, t, s) {
        ...
        for (let s = 1; s < arguments.length; s += 1) {
          ...
          if (null != r && !f(r)) {
            ...
            for (let t = 0, i = s.length; t < i; t += 1) {
              ...
              void 0 !== n && n.enumerable && (u(e[i]) && u(r[i]) ? r[i].__swiper__ ? e[i] = r[i] : h(e[i], r[i]) : !u(e[i]) && u(r[i]) ? (e[i] = {}, r[i].__swiper__ ? e[i] = r[i] : h(e[i], r[i])) : e[i] = r[i])
            }
          }
        }
        return e
      ...
      var D = {
        ...
        updateSlides: function() {
          ...
          for (let r = 0; r < p; r += 1) {
            let i;
            if (k = 0, c[r] && (i = c[r]), C && e.grid.updateSlide(r, i, c), !c[r] || "none" !== S(i, "display")) {
              if ("auto" === s.slidesPerView) {
                _ && (c[r].style[e.getDirectionLabel("width")] = "");
                const n = getComputedStyle(i),
                  a = i.style.transform,
                  o = i.style.webkitTransform;
                if (a && (i.style.transform = "none"), o && (i.style.webkitTransform = "none"), s.roundLengths) k = e.isHorizontal() ? y(i, "width", !0) : y(i, "height", !0);
                else {
                  const e = t(n, "width"),
                    s = t(n, "padding-left"),
                    r = t(n, "padding-right"),
                ...
                a && (i.style.transform = a), o && (i.style.webkitTransform = o), s.roundLengths && (k = Math.floor(k))
              } else k = (n - (s.slidesPerView - 1) * E) / s.slidesPerView, s.roundLengths && (k = Math.floor(k)), c[r] && (c[r].style[e.getDirectionLabel("width")] = `${k}px`);
              c[r] && (c[r].swiperSlideSize = k), h.push(k), s.centeredSlides ? (x = x + k / 2 + M / 2 + E, 0 === M && 0 !== r && (x = x - n / 2 - E), 0 === r && (x = x - n / 2 - E), Math.abs(x) < .001 && (x = 0), s.roundLengths && (x = Math.floor(x)), P % s.slidesPerGroup === 0 && u.push(x), f.push(x)) : (s.roundLengths && (x = Math.floor(x)), (P - Math.min(e.params.slidesPerGroupSkip, P)) % e.params.slidesPerGroup === 0 && u.push(x), f.push(x), x = x + k + E), e.virtualSize += k + E, M = k, P += 1
            }
          }
          if (e.virtualSize = Math.max(e.virtualSize, n) + w, a && o && ("slide" === s.effect || "coverflow" === s.effect) && (r.style.width = `${e.virtualSize+E}px`), s.setWrapperSize && (r.style[e.getDirectionLabel("width")] = `${e.virtualSize+E}px`), C && e.grid.updateWrapperSize(k, u), !s.centeredSlides) {
            const t = [];
        ...
        updateSlidesProgress: function(e) {
          ...
          for (let e = 0; e < r.length; e += 1) {
            ...
            m && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), O(l, m, s.slideVisibleClass), O(l, h, s.slideFullyVisibleClass), l.progress = i ? -c : c, l.originalProgress = i ? -p : p
          }
        },
      ...
      var B = {
          slideTo: function(e, t, s, r, i) {
            ...
            if (!h && !r && !i || n.destroyed || n.animating && o.preventInteractionOnTransition) return !1;
        ...
        V = {
          ...
          loopFix: function(e) {
            ...
            "auto" === g ? g = d.slidesPerViewDynamic() : (g = Math.ceil(parseFloat(h.slidesPerView, 10)), m && g % 2 == 0 && (g += 1));
            const b = h.slidesPerGroupAuto ? g : h.slidesPerGroup;
            let S = m ? Math.max(b, Math.ceil(g / 2)) : b;
            S % b !== 0 && (S += b - S % b), S += h.loopAdditionalSlides, d.loopedSlides = S;
            const T = d.grid && h.grid && h.grid.rows > 1;
            c.length < g + S || "cards" === d.params.effect && c.length < g + 2 * S ? w("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : T && "row" === h.grid.fill && w("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const y = [],
              E = [],
            ...
            let _ = 0,
              I = 0;
            const O = (T ? c[n].column : n) + (m && void 0 === i ? -g / 2 + .5 : 0);
            if (O < S) {
              _ = Math.max(S - O, b);
              ...
              I = Math.max(O - (x - 2 * S), b), M && (I = Math.max(I, g - x + v + 1));
              for (let e = 0; e < I; e += 1) {
                const t = e - Math.floor(e / x) * x;
                T ? c.forEach((e, s) => {
                  e.column === t && E.push(s)
            ...
            if (d.__preventObserver__ = !0, requestAnimationFrame(() => {
              ...
              }), "cards" === d.params.effect && c.length < g + 2 * S && (E.includes(n) && E.splice(E.indexOf(n), 1), y.includes(n) && y.splice(y.indexOf(n), 1)), k && y.forEach(e => {
              ...
              }), d.recalcSlides(), "auto" === h.slidesPerView ? d.updateSlides() : T && (y.length > 0 && k || E.length > 0 && C) && d.slides.forEach((e, t) => {
              ...
              if (y.length > 0 && k) {
                if (void 0 === t) {
                  ...
                  l ? d.setTranslate(d.translate - t) : (d.slideTo(P + Math.ceil(_), 0, !1, !0), i && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t))
                } else if (i) {
              ...
              if (void 0 === t) {
                ...
                l ? d.setTranslate(d.translate - t) : (d.slideTo(P - I, 0, !1, !0), i && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t))
              } else {
      ...
      const Q = {
          ...
          events: {
            attachEvents: function() {
              ...
              e.onTouchStart = j.bind(e), e.onTouchMove = F.bind(e), e.onTouchEnd = $.bind(e), e.onDocumentTouchStart = X.bind(e), t.cssMode && (e.onScroll = q.bind(e)), e.onClick = W.bind(e), e.onLoad = Y.bind(e), U(e, "on")
            },
          ...
          breakpoints: {
            setBreakpoint: function() {
              ...
              const p = (c in n ? n[c] : void 0) || e.originalParams,
                ...
                v = p.grabCursor,
                g = r.enabled;
              u && !f ? (i.classList.remove(`${r.containerModifierClass}grid`, `${r.containerModifierClass}grid-column`), e.emitContainerClasses()) : !u && f && (i.classList.add(`${r.containerModifierClass}grid`), (p.grid.fill && "column" === p.grid.fill || !p.grid.fill && "column" === r.grid.fill) && i.classList.add(`${r.containerModifierClass}grid-column`), e.emitContainerClasses()), m && !v ? e.unsetGrabCursor() : !m && v && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach(t => {
              ...
              const w = p.direction && p.direction !== r.direction,
                ...
                S = r.loop;
              w && s && e.changeDirection(), h(e.params, p);
      ...
      class te {
        constructor() {
          ...
          const a = this;
          a.__swiper__ = !0, a.support = C(), a.device = k({
            userAgent: t.userAgent
          }), a.browser = _(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
          const l = {};
          a.modules.forEach(e => {
            e({
              params: t,
          ...
          const d = h({}, Z, l);
          return a.params = h({}, d, ee, t), a.originalParams = h({}, a.params), a.passedParams = h({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach(e => {
      ...
      const me = (0, r.createContext)(null),
        ...
        ge = (0, r.forwardRef)(function(e, t) {
          ...
          const [c, p] = (0, r.useState)("swiper"), [u, f] = (0, r.useState)(null), [h, m] = (0, r.useState)(!1), v = (0, r.useRef)(!1), g = (0, r.useRef)(null), w = (0, r.useRef)(null), b = (0, r.useRef)(null), S = (0, r.useRef)(null), T = (0, r.useRef)(null), y = (0, r.useRef)(null), x = (0, r.useRef)(null), M = (0, r.useRef)(null), {
            params: P,
            passedParams: C,
            rest: k,
            events: _
          ...
          return g.current || z(), w.current && w.current.on("_beforeBreakpoint", L), (0, r.useEffect)(() => () => {
            ...
            }(C, b.current, I, S.current, e => e.key);
            return b.current = C, S.current = I, e.length && w.current && !w.current.destroyed && function(e) {
              let {
                swiper: t,
                slides: s,
                passedParams: r,
            ...
            ref: g,
            className: le(`${c}${s?` ${s}`:""}`)
          }, k), r.createElement(ve.Provider, {
            value: w.current
          }, O["container-start"], r.createElement(n, {
            className: de(P.wrapperClass)
          }, O["wrapper-start"], P.virtual ? function(e, t, s) {
            if (!s) return null;
            const i = e => {
                let s = e;
          ...
          }(w.current, I, u) : I.map((e, t) => r.cloneElement(e, {
            swiper: w.current,
            swiperSlideIndex: t
          })), O["wrapper-end"]), ne(P) && r.createElement(r.Fragment, null, r.createElement("div", {
            ref: y,
      ...
      const we = (0, r.forwardRef)(function(e, t) {
        ...
        }, p), o && r.createElement(me.Provider, {
          value: w
        }, r.createElement("div", {
