try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    o = (new e.Error).stack;
  o && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[o] = "71c7b428-8331-49d3-95b1-8de6d1b86bbb", e._sentryDebugIdIdentifier = "sentry-dbid-71c7b428-8331-49d3-95b1-8de6d1b86bbb")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [5859], {
    ...
    12841: (e, o, t) => {
      ...
      const m = (e, o) => {
        ...
        k = () => {
          ...
          const a = `rockstarweb_lang.${o.cookieIdentifier}`,
            i = p(a);
          r = o.currentSite?.site === u.C.www ? g.find(e => e.subdomaincom === s) || g.find(e => e.subdomaincom === t) || n : g.find(e => e.iso === i) || n;
          const [, l] = b(a, r.iso);
          return [r, l]
        },
        _ = () => "en-US";
      ...
      function y(e) {
        const o = e.split("-");
        return (0, d.A)(o[1] ? o[0] : e, ["relativetimeformat", "pluralrules", "listformat"])
      }
        ...
        j = e => {
          ...
          if (s)
            for (const [n, {
              ...
              if (!d) continue;
              let u = "";
              "en" !== o.subdomaincom && i && (u = `/${o[l||"subdomaincom"]}`, "circoloco" === n && "/" === s.pathname && (u += "/"));
              const m = s.host.split(".");
              let p = "";
              return "www" !== n || c?.some(e => e.test(s.pathname)) ? (p += `https://${d}`, p += a ? `.${m.at(-2)}.${m.at(-1)}` : `.${m.at(-1)}`, {
        ...
        x = ({
          ...
          const s = (0, u.A)(),
            ...
            i = (e => {
              ...
              const t = o.split("/");
              return g.map(e => e.subdomaincom).includes(t[0]) && (o = t.slice(1).join("/")), s.currentSite?.site === u.C.www ? "en" === e ? `${window.location.origin}/${o}${location.search}` : `${window.location.origin}/${e}/${o}${location.search}` : `${window.location.origin}/${o}${location.search}`
            })(r);
          o?.({
            event: "cta_other",
            link_url: i,
