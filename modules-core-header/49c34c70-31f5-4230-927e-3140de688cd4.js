try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "49c34c70-31f5-4230-927e-3140de688cd4", e._sentryDebugIdIdentifier = "sentry-dbid-49c34c70-31f5-4230-927e-3140de688cd4")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
          ...
          switch (l) {
            ...
            case "time":
              ...
              if (this.bumpIf(",")) {
                ...
                if (0 === (y = J(v.val)).length) return this.error(n.EXPECT_ARGUMENT_STYLE, G(this.clonePosition(), this.clonePosition()));
                f = {
                  style: y,
            ...
            case "select":
              ...
              if (this.bumpSpace(), !this.bumpIf(",")) return this.error(n.EXPECT_SELECT_ARGUMENT_OPTIONS, G(g, (0, s.Cl)({}, g)));
              this.bumpSpace();
        ...
        for (var f = [], p = 0, m = e; p < m.length; p++) {
          ...
          if ((0, i.eW)(E)) f.push({
            ...
            if ((0, i.Im)(E)) y && "string" != typeof y && "number" != typeof y || (y = "string" == typeof y || "number" == typeof y ? String(y) : ""), f.push({
              ...
              var g = "string" == typeof E.style ? h.date[E.style] : (0, i.Tu)(E.style) ? E.style.parsedOptions : void 0;
              f.push({
                type: n.literal,
                value: r.getDateTimeFormat(t, g).format(y)
              })
            } else if ((0, i.Qh)(E)) g = "string" == typeof E.style ? h.time[E.style] : (0, i.Tu)(E.style) ? E.style.parsedOptions : h.time.medium, f.push({
              type: n.literal,
              value: r.getDateTimeFormat(t, g).format(y)
            });
            else if ((0, i.oF)(E))(g = "string" == typeof E.style ? h.number[E.style] : (0, i.N1)(E.style) ? E.style.parsedOptions : void 0) && g.scale && (y *= g.scale || 1), f.push({
              type: n.literal,
