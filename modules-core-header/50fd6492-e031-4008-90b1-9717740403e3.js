! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      e = (new t.Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "50fd6492-e031-4008-90b1-9717740403e3", t._sentryDebugIdIdentifier = "sentry-dbid-50fd6492-e031-4008-90b1-9717740403e3")
  } catch (t) {}
}();
      ...
      ! function() {
        ...
        function a(t) {
          const e = function() {
            ...
            if (!o.element || 0 !== U(o.element).height && 0 !== U(o.element).width || (i = o.rect), !S(t)) {
              const e = m(t);
          ...
          let a = e,
            u = null;
          n && (u = document.elementFromPoint(n.x, n.y), null === u && (u = document.body), _(u) && !b(u) ? n = null : a = b(u) ? u : u.getSpatialNavigationContainer()), a !== document && a !== document.documentElement || (a = document.body || document.documentElement);
          let d = null;
        ...
        function l(t, e) {
          return N(t, e) && !M(t, e) ? (y(t, e), !0) : !t.parentElement && !x(t, e) && (y(t.ownerDocument.documentElement, e), !0)
        }
        ...
        function c(t) {
          ...
          if (t.childElementCount > 0) {
            ...
            const e = t.children;
            for (const t of e) E(t) ? n.push(t) : _(t) ? (n.push(t), !b(t) && t.childElementCount && (n = n.concat(c(t, {
              mode: "all"
        ...
        function Y(t) {
          ...
          window.__spatialNavigation__ = !1 === t ? G() : Object.assign(G(), function() {
            function t(t, e) {
              return N(t, e) && !M(t, e) || !t.parentElement && !x(t, e)
            }
              ...
              for (s || window.location === window.parent.location || (s = window.parent.document.documentElement); s;) {
                ...
                if (Array.isArray(n) && n.length > 0) {
                  ...
                  if (l === document || l === document.documentElement) {
                    ...
                    if (_(l) && (a = l), l = s, !l.parentElement) {
                      s = null;
                      break
                    }
                    s = l.getSpatialNavigationContainer()
        ...
        window.navigate = a, window.Element.prototype.spatialNavigationSearch = function(t, e) {
          ...
          if (p && p.length > 0) {
            ...
            if (r = r.concat(e).filter((t => h.contains(t))), l = l.concat(m).filter((t => h.contains(t))), l.length > 0 && (l = u(o, t, l, h)), i && (a = s(o, u(o, t, r, h), t)), r && r.length > 0 && "INPUT" !== o.nodeName && (a = function(t, e, o) {
              ...
              n ? a = n : _(a) || (p.splice(p.indexOf(a), 1), a = p.length ? o.spatialNavigationSearch(t, {
                candidates: p,
                container: h
              }) : null)
            }
          ...
          const e = this.parentElement ? this : document.body,
            n = Array.prototype.filter.call(e.getElementsByTagName("*"), _);
