! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "f7d940c9-d618-4221-9851-8157c08db8cc", e._sentryDebugIdIdentifier = "sentry-dbid-f7d940c9-d618-4221-9851-8157c08db8cc")
  } catch (e) {}
}();
  ...
  [605], {
    ...
    823: (e, t, o) => {
      ...
      const i = e => {
        ...
        const [i, c] = (0, n.useMemo)((() => (0, r.A)(o)), [o]), d = (0, n.useMemo)((() => function(e, t) {
          return e?.[t] ?? {}
        }(t, c)), [o, t]);
        return (0, l.jsx)(s.A, {
          messages: d,
    ...
    5478: (e, t, o) => {
      ...
      const r = () => {
        ...
        if (t.currentSite?.site === n.C.www) i = a.Ay.find((e => e.subdomaincom === r)) || a.Ay.find((e => e.subdomaincom === o)) || l;
        else {
          const e = (0, s.Ap)(c);
          i = a.Ay.find((t => t.iso === e)) || l
        }
        return [i, (e => t => {
          (0, s.My)(e, t)
        })(c)]
    ...
    1207: (e, t, o) => {
      ...
      const l = Object.freeze({
        ...
        i = Object.freeze(Object.values(l));
      ...
      const b = e => e.keys().forEach(e),
        ...
        w = () => [l.xbox360.name, l.xboxone.name, l.ps3.name, l.ps4.name, l.pc.name],
