try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "c4f441ed-0225-4d71-9c54-ef41b2ddb1bf", e._sentryDebugIdIdentifier = "sentry-dbid-c4f441ed-0225-4d71-9c54-ef41b2ddb1bf")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [9587], {
    ...
    63975: (e, t, r) => {
        ...
        for (var t = {}, r = 0, n = e; r < n.length; r++) {
          ...
          switch (i.stem) {
            ...
            case "integer-width":
              ...
              i.options[0].replace(N, function(e, r, n, i, a, o) {
          ...
          if (I.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
            ...
            i.stem.replace(A, function(e, r, n, i, a, o) {
            ...
            }) : a && (t = (0, s.__assign)((0, s.__assign)({}, t), P(a)))
          } else if (B.test(i.stem)) t = (0, s.__assign)((0, s.__assign)({}, t), P(i.stem));
          else {
            var o = S(i.stem);
      ...
      var G = !!String.prototype.startsWith && "_a".startsWith("a", 1),
        ...
        Z = !0;
      try {
        Z = "a" === (null === (C = ee("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) || void 0 === C ? void 0 : C[0])
      } catch (e) {
        Z = !1
      }
      var W, Y = G ? function(e, t, r) {
        ...
        return e.prototype.parse = function() {
          ...
          for (var a = []; !this.isEOF();) {
            ...
            if (123 === o) {
              ...
              if (35 !== o || "plural" !== t && "selectordinal" !== t) {
                ...
                if (60 === o && !this.ignoreTag && ne(this.peek() || 0)) {
          ...
          if (this.bumpIf(">")) {
            ...
            if (this.bumpIf("</")) {
              ...
              return a !== this.parseTagName() ? this.error(n.UNMATCHED_CLOSING_TAG, U(h, this.clonePosition())) : (this.bumpSpace(), this.bumpIf(">") ? {
                val: {
                  type: i.tag,
                  value: a,
                  children: s,
          ...
          if (!a) return this.error(n.MALFORMED_ARGUMENT, U(r, this.clonePosition()));
          ...
          switch (this.char()) {
            ...
            case 44:
              return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(n.EXPECT_ARGUMENT_CLOSING_BRACE, U(r, this.clonePosition())) : this.parseArgumentOptions(e, t, a, r);
            default:
          ...
          switch (u) {
            case "":
              return this.error(n.EXPECT_ARGUMENT_TYPE, U(h, c));
            case "number":
            case "date":
            case "time":
              this.bumpSpace();
              ...
              if (this.bumpIf(",")) {
                ...
                if (0 === (E = Q(T.val)).length) return this.error(n.EXPECT_ARGUMENT_STYLE, U(this.clonePosition(), this.clonePosition()));
                f = {
                  style: E,
                  styleLocation: U(m, this.clonePosition())
                }
              }
              if ((H = this.tryParseArgumentClose(o)).err) return H;
              var p = U(o, this.clonePosition());
            ...
            default:
              return this.error(n.INVALID_ARGUMENT_TYPE, U(h, c))
          }
          ...
          for (var a, o = !1, s = [], l = new Set, h = i.value, u = i.location;;) {
            if (0 === h.length) {
              ...
              if (f.err) return f;
              u = U(c, this.clonePosition()), h = this.message.slice(c.offset, this.offset())
            }
          ...
          return 0 === s.length ? this.error("select" === t ? n.EXPECT_SELECT_ARGUMENT_SELECTOR : n.EXPECT_PLURAL_ARGUMENT_SELECTOR, U(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !o ? this.error(n.MISSING_OTHER_CLAUSE, U(this.clonePosition(), this.clonePosition())) : {
            val: s,
            err: null
          }
