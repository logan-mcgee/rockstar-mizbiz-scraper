try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "30cddccd-a2d8-432c-8f1f-aaf86865d5c8", e._sentryDebugIdIdentifier = "sentry-dbid-30cddccd-a2d8-432c-8f1f-aaf86865d5c8")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    32654: (e, t, s) => {
        ...
        G = e => {
          ...
          if (e.params.rewind || e.params.loop)
            for (let r = i - t; r <= n + t; r += 1) {
              ...
              for (let r = Math.max(i - t, 0); r <= Math.min(n + t, s - 1); r += 1) r !== i && (r > n || r < i) && z(e, r)
        };
      var N = {
        updateSize: function() {
          const e = this;
        ...
        updateSlides: function() {
          ...
          for (let r = 0; r < p; r += 1) {
            ...
            if (O = 0, c[r] && (i = c[r]), C && e.grid.updateSlide(r, i, c), !c[r] || "none" !== S(i, "display")) {
              if ("auto" === s.slidesPerView) {
                ...
                if (a && (i.style.transform = "none"), o && (i.style.webkitTransform = "none"), s.roundLengths) O = e.isHorizontal() ? T(i, "width", !0) : T(i, "height", !0);
                else {
                  const e = t(n, "width"),
                    s = t(n, "padding-left"),
                    r = t(n, "padding-right"),
          ...
          if (p !== d && e.emit("slidesLengthChange"), u.length !== b && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), f.length !== y && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(l || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
      ...
      var V = {
        ...
        j = {
          ...
          loopFix: function(e) {
            ...
            c.length < g + S || "cards" === d.params.effect && c.length < g + 2 * S ? w("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : y && "row" === m.grid.fill && w("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const T = [],
              E = [],
            ...
            let k = 0,
              _ = 0;
            const I = (y ? c[n].column : n) + (h && void 0 === i ? -g / 2 + .5 : 0);
            if (I < S) {
              k = Math.max(S - I, b);
            ...
            if (d.__preventObserver__ = !0, requestAnimationFrame(() => {
              ...
              }), "cards" === d.params.effect && c.length < g + 2 * S && (E.includes(n) && E.splice(E.indexOf(n), 1), T.includes(n) && T.splice(T.indexOf(n), 1)), O && T.forEach(e => {
      ...
      const Q = {
          ...
          events: {
            attachEvents: function() {
              ...
              e.onTouchStart = R.bind(e), e.onTouchMove = F.bind(e), e.onTouchEnd = $.bind(e), e.onDocumentTouchStart = Y.bind(e), t.cssMode && (e.onScroll = X.bind(e)), e.onClick = W.bind(e), e.onLoad = q.bind(e), U(e, "on")
            },
      ...
      class te {
        ...
        getSlideIndex(e) {
          const {
            slidesEl: t,
            params: s
          } = this, r = y(g(t, `.${s.slideClass}, swiper-slide`)[0]);
          return y(e) - r
        }
      ...
      const he = (0, r.createContext)(null),
        ...
        ge = (0, r.forwardRef)(function(e, t) {
          ...
          const [c, p] = (0, r.useState)("swiper"), [u, f] = (0, r.useState)(null), [m, h] = (0, r.useState)(!1), v = (0, r.useRef)(!1), g = (0, r.useRef)(null), w = (0, r.useRef)(null), b = (0, r.useRef)(null), S = (0, r.useRef)(null), y = (0, r.useRef)(null), T = (0, r.useRef)(null), x = (0, r.useRef)(null), M = (0, r.useRef)(null), {
            params: P,
            passedParams: C,
            rest: O,
            events: k
          ...
          return g.current || A(), w.current && w.current.on("_beforeBreakpoint", L), (0, r.useEffect)(() => () => {
            ...
            return b.current = C, S.current = _, e.length && w.current && !w.current.destroyed && function(e) {
              ...
              i.includes("loop") && t.isElement && (c.loop && !r.loop ? y = !0 : !c.loop && r.loop ? T = !0 : x = !0), d.forEach(e => {
