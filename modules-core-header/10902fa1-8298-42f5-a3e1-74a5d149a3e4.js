try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "10902fa1-8298-42f5-a3e1-74a5d149a3e4", e._sentryDebugIdIdentifier = "sentry-dbid-10902fa1-8298-42f5-a3e1-74a5d149a3e4")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [4113], {
    94113(e, t, n) {
      ...
      const d = window?.env?.sc,
        ...
        }, x = (...e) => e.filter(Boolean).join(" "), y = e => e.includes("reddead") || e.includes("rdr") ? "#CC0000" : e.includes("bully") ? "#F8AD00" : "#FCAF17", b = () => {
      ...
      const re = document.documentElement.lang,
        ...
        xe = () => (0, M.useContext)(we),
        ye = /Edge?\/(13\d|1[4-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|Firefox\/(1{2}[5-9]|1[2-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|Chrom(ium|e)\/(109|1[1-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|(Maci|X1{2}).+ Version\/(17\.([6-9]|\d{2,})|(1[89]|[2-9]\d|\d{3,})\.\d+)([,.]\d+|)( \(\w+\)|)( Mobile\/\w+|) Safari\/|Chrome.+OPR\/(1{2}[3-9]|1[2-9]\d|[2-9]\d{2}|\d{4,})\.\d+\.\d+|(CPU[ +]OS|iPhone[ +]OS|CPU[ +]iPhone|CPU IPhone OS|CPU iPad OS)[ +]+(15[._]([6-9]|\d{2,})|(1[6-9]|[2-9]\d|\d{3,})[._]\d+)([._]\d+|)|Android:?[ /-](13[1-9]|1[4-9]\d|[2-9]\d{2}|\d{4,})(\.\d+|)(\.\d+|)|Mobile Safari.+OPR\/([89]\d|\d{3,})\.\d+\.\d+|Android.+Firefox\/(13[2-9]|1[4-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|Android.+Chrom(ium|e)\/(13[1-9]|1[4-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|Android.+(UC? ?Browser|UCWEB|U3)[ /]?(15\.([5-9]|\d{2,})|(1[6-9]|[2-9]\d|\d{3,})\.\d+)\.\d+|SamsungBrowser\/(2[6-9]|[3-9]\d|\d{3,})\.\d+|Android.+MQ{2}Browser\/(14(\.(9|\d{2,})|)|(1[5-9]|[2-9]\d|\d{3,})(\.\d+|))(\.\d+|)|K[Aa][Ii]OS\/(2\.([5-9]|\d{2,})|([3-9]|\d{2,})\.\d+)(\.\d+|)/,
        be = ({
          element: e
        }) => {
      ...
      const Me = () => {
        ...
        }, Ie = () => [Ce.xbox360.name, Ce.xboxone.name, Ce.ps3.name, Ce.ps4.name, Ce.pc.name], Oe = () => [Ce.xboxsx.name, Ce.ps5.name, Ce.pcalt.name], ze = e => Oe().includes(e), _e = e => {
          const t = new Map([
      ...
      var Qe = n(23066);
      const Je = (0, I.UT)(document.documentElement.lang),
        Ye = () => (0, R.q)(Je),
        Ke = Qe.J1`
    ...
    translations(locale: $locale, config: $config) {
      ...
      const zt = (0, I.UT)(Ot),
        _t = ({
          ...
          return n[e] = t, null === t && delete n[e], H.A.set(It, JSON.stringify(n), {
            expires: 30,
            domain: Me(),
            path: "/"
          }), zt(n), n
