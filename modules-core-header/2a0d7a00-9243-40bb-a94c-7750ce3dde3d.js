try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    l = (new e.Error).stack;
  l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "2a0d7a00-9243-40bb-a94c-7750ce3dde3d", e._sentryDebugIdIdentifier = "sentry-dbid-2a0d7a00-9243-40bb-a94c-7750ce3dde3d")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [9796], {
    99796: (e, l, a) => {
      a.r(l), a.d(l, {
        ...
        Circle: () => Jh,
        CircleCheck: () => Vn,
        CircleCheckFilled: () => En,
        CircleDollarSign: () => Sf,
        CircleHelp: () => k,
        CircleMinus: () => xc,
        CircleMinusFilled: () => Bc,
        CirclePerson: () => He,
        CircleSlash: () => Oe,
        CircleX: () => uc,
        Clipboard: () => Dd,
      ...
      Sh.displayName = "ShoppingBag", Sh.categories = ["shopping"], Sh.tags = ["ecommerce", "cart", "purchase", "store", "bag", "shop", "shopping", "tote"], Sh.SM = Ah, Sh.MD = Vh, Sh.LG = Bh, Sh.XL = Ih;
      ...
      Xh.displayName = "MessageSquareText", Xh.categories = ["social"], Xh.tags = ["comment", "chat", "conversation", "dialog", "feedback", "speech bubble", "clear", "close", "delete", "remove", "cancel", "silence", "mute", "moderate"], Xh.SM = yh, Xh.LG = Dh, Xh.MD = Gh, Xh.XL = Nh;
      ...
      Oh.displayName = "Search", Oh.categories = ["text", "social"], Oh.tags = ["find", "scan", "magnifier", "magnifying glass", "look", "view"], Oh.SM = qh, Oh.LG = Ph, Oh.MD = Fh, Oh.XL = kh;
      ...
      Wh.displayName = "PartialCircle", Wh.categories = ["shapes"], Wh.tags = ["Partial", "Half", "Middle", "Split"], Wh.SM = Th, Wh.LG = Eh, Wh.MD = Uh, Wh.XL = _h;
      ...
      Jh.displayName = "Circle", Jh.categories = ["shapes"], Jh.tags = ["Off", "Zero", "Record", "Shape", "Round", "Outline"], Jh.SM = Zh, Jh.MD = Yh, Jh.LG = Kh, Jh.XL = Qh;
      const $h = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      rn.displayName = "LockKeyhole", rn.categories = ["security"], rn.tags = ["security", "password", "secure", "admin", "lock", "safe", "protection", "security", "latch"], rn.SM = $h, rn.LG = en, rn.MD = ln, rn.XL = an;
      ...
      hn.displayName = "LockPassword", hn.categories = ["security"], hn.tags = ["security", "password", "secure", "admin"], hn.SM = tn, hn.LG = sn, hn.MD = dn, hn.XL = on;
      ...
      vn.displayName = "Image", vn.categories = ["photography", "text", "multimedia", "files"], vn.tags = ["picture", "photo"], vn.SM = nn, vn.LG = cn, vn.MD = fn, vn.XL = wn;
      ...
      pn.displayName = "Lightbulb", pn.categories = ["photography"], pn.tags = ["idea", "bright", "lights"], pn.SM = xn, pn.LG = gn, pn.MD = jn, pn.XL = mn;
      ...
      zn.displayName = "Check", zn.categories = ["notifications"], zn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "success", "accept"], zn.SM = un, zn.LG = Mn, zn.MD = Rn, zn.XL = bn;
      ...
      Vn.displayName = "CircleCheck", Vn.categories = ["notifications"], Vn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], Vn.SM = Ln, Vn.LG = Cn, Vn.MD = Hn, Vn.XL = An;
      ...
      Dn.displayName = "TriangleAlert", Dn.categories = ["notifications", "shapes", "development"], Dn.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], Dn.SM = Bn, Dn.LG = In, Dn.MD = Sn, Dn.XL = yn;
      ...
      Pn.displayName = "X", Pn.categories = ["notifications", "math"], Pn.tags = ["cancel", "close", "delete", "remove", "times", "clear", "math", "multiply", "multiplication", "error", "remove", "clean", "erase", "navigation", "cross", "times"], Pn.SM = Gn, Pn.LG = Nn, Pn.MD = Xn, Pn.XL = qn;
      ...
      En.displayName = "CircleCheckFilled", En.categories = ["notifications"], En.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success", "filled"], En.SM = Fn, En.MD = kn, En.LG = On, En.XL = Tn;
      const Un = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Yn.displayName = "Globe", Yn.categories = ["navigation"], Yn.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], Yn.SM = Un, Yn.LG = _n, Yn.MD = Wn, Yn.XL = Zn;
      ...
      ec.displayName = "Pin", ec.categories = ["navigation"], ec.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point"], ec.SM = Kn, ec.MD = Qn, ec.LG = Jn, ec.XL = $n;
      ...
      sc.displayName = "PinFilled", sc.categories = ["navigation"], sc.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point", "filled"], sc.SM = lc, sc.MD = ac, sc.LG = rc, sc.XL = tc;
      ...
      nc.displayName = "HeartPulse", nc.categories = ["medical"], nc.tags = ["heartbeat", "pulse", "health", "medical", "blood pressure", "cardiac", "systole", "diastole"], nc.SM = ic, nc.LG = dc, nc.MD = oc, nc.XL = hc;
      ...
      xc.displayName = "CircleMinus", xc.categories = ["math"], xc.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete"], xc.SM = cc, xc.LG = fc, xc.MD = wc, xc.XL = vc;
      ...
      uc.displayName = "CircleX", uc.categories = ["math", "development"], uc.tags = ["cancel", "close", "delete", "remove", "times", "clear", "error", "incorrect", "wrong", "mistake", "failure", "linter", "multiply", "multiplication", "clean", "erase", "deprecate", "delete", "navigation"], uc.SM = gc, uc.LG = jc, uc.MD = mc, uc.XL = pc;
      ...
      Lc.displayName = "Minus", Lc.categories = ["math", "development", "text", "tools"], Lc.tags = ["subtract", "remove", "decrease", "decrement", "reduce", "negative", "calculate", "line", "divider", "separator", "horizontal rule", "hr", "html", "markup", "markdown", "---", "toolbar", "operator", "code", "coding", "minimum", "downgrade", "less", "delete", "navigation", "minimize"], Lc.SM = Mc, Lc.LG = Rc, Lc.MD = bc, Lc.XL = zc;
      const Cc = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Bc.displayName = "CircleMinusFilled", Bc.categories = ["math"], Bc.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete", "filled"], Bc.SM = Cc, Bc.MD = Hc, Bc.LG = Ac, Bc.XL = Vc;
      const Ic = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Gc.displayName = "EnvelopeOpen", Gc.categories = ["mail"], Gc.tags = ["email", "message", "letter", "read"], Gc.SM = Ic, Gc.LG = Sc, Gc.MD = yc, Gc.XL = Dc;
      ...
      Fc.displayName = "Paperclip", Fc.categories = ["text", "design", "files", "mail"], Fc.tags = ["attachment", "file", "attach", "clip", "document", "paper"], Fc.SM = Nc, Fc.LG = Xc, Fc.MD = qc, Fc.XL = Pc;
      ...
      Uc.displayName = "Trash", Uc.categories = ["files", "mail"], Uc.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], Uc.SM = kc, Uc.LG = Oc, Uc.MD = Tc, Uc.XL = Ec;
      ...
      Kc.displayName = "EllipsisVertical", Kc.categories = ["layout"], Kc.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], Kc.SM = _c, Kc.LG = Wc, Kc.MD = Zc, Kc.XL = Yc;
      ...
      lf.displayName = "Filter", lf.categories = ["layout"], lf.tags = ["funnel", "hopper"], lf.SM = Qc, lf.LG = Jc, lf.MD = $c, lf.XL = ef;
      ...
      df.displayName = "Weapon", df.categories = ["gaming"], df.tags = ["gun", "pistol", "GTAO", "fire", "shoot", "death", "danger"], df.SM = af, df.LG = rf, df.MD = tf, df.XL = sf;
      ...
      ff.displayName = "Heart", ff.categories = ["medical", "social", "multimedia", "emoji", "gaming", "shapes"], ff.tags = ["like", "love", "emotion", "suit", "playing", "cards"], ff.SM = of, ff.LG = hf, ff.MD = nf, ff.XL = cf;
      ...
      jf.displayName = "FileText", jf.categories = ["files", "text"], jf.tags = ["data", "txt", "pdf", "document"], jf.SM = wf, jf.LG = vf, jf.MD = xf, jf.XL = gf;
      ...
      Rf.displayName = "Files", Rf.categories = ["files"], Rf.tags = ["multiple", "copy", "documents", "data", "file", "folder", "restore"], Rf.SM = mf, Rf.LG = pf, Rf.MD = uf, Rf.XL = Mf;
      ...
      Hf.displayName = "Save", Hf.categories = ["files"], Hf.tags = ["floppy disk", "download", "backup", "storage", "disk", "document", "computer", "archive"], Hf.SM = bf, Hf.MD = zf, Hf.LG = Lf, Hf.XL = Cf;
      const Af = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Sf.displayName = "CircleDollarSign", Sf.categories = ["finance"], Sf.tags = ["monetization", "marketing", "currency", "money", "payment"], Sf.SM = Af, Sf.LG = Vf, Sf.MD = Bf, Sf.XL = If;
      ...
      Xf.displayName = "DollarSign", Xf.categories = ["finance"], Xf.tags = ["currency", "money", "payment"], Xf.SM = yf, Xf.LG = Df, Xf.MD = Gf, Xf.XL = Nf;
      ...
      Of.displayName = "FastForward", Of.categories = ["multimedia", "arrows"], Of.tags = ["music", "audio", "video", "control", "player", "media"], Of.SM = qf, Of.LG = Pf, Of.MD = Ff, Of.XL = kf;
      ...
      Wf.displayName = "Pause", Wf.categories = ["multimedia"], Wf.tags = ["music", "audio", "video", "stop", "pause", "control", "player", "media"], Wf.SM = Tf, Wf.LG = Ef, Wf.MD = Uf, Wf.XL = _f;
      ...
      Jf.displayName = "Play", Jf.categories = ["arrows", "multimedia"], Jf.tags = ["music", "audio", "video", "start", "run", "play", "continue", "control", "player", "media"], Jf.SM = Zf, Jf.LG = Yf, Jf.MD = Kf, Jf.XL = Qf;
      ...
      rw.displayName = "Rewind", rw.categories = ["arrows", "multimedia"], rw.tags = ["music", "audio", "video", "control", "player", "previous", "back", "reverse", "media"], rw.SM = $f, rw.LG = ew, rw.MD = lw, rw.XL = aw;
      ...
      ow.displayName = "SkipBack", ow.categories = ["multimedia", "arrows"], ow.tags = ["music", "audio", "video", "arrow", "previous", "back", "rewind", "reverse", "control", "player", "media"], ow.SM = tw, ow.LG = sw, ow.MD = iw, ow.XL = dw;
      ...
      ww.displayName = "SkipForward", ww.categories = ["multimedia", "arrows"], ww.tags = ["music", "audio", "video", "arrow", "skip", "next", "forward", "control", "player", "media"], ww.SM = hw, ww.LG = nw, ww.MD = cw, ww.XL = fw;
      ...
      mw.displayName = "StarOff", mw.categories = ["multimedia", "social"], mw.tags = ["dislike", "unlike", "remove", "unrate"], mw.SM = vw, mw.LG = xw, mw.MD = gw, mw.XL = jw;
      ...
      bw.displayName = "Stop", bw.categories = ["multimedia"], bw.tags = ["music", "audio", "video", "control", "player", "stop", "media"], bw.SM = pw, bw.LG = uw, bw.MD = Mw, bw.XL = Rw;
      ...
      Aw.displayName = "ListMusic", Aw.categories = ["multimedia"], Aw.tags = ["playlist", "music", "audio", "control", "player", "media", "queue", "playback", "play", "list"], Aw.SM = zw, Aw.MD = Lw, Aw.LG = Cw, Aw.XL = Hw;
      const Vw = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yw.displayName = "Book", yw.categories = ["text", "gaming"], yw.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], yw.SM = Vw, yw.LG = Bw, yw.MD = Iw, yw.XL = Sw;
      ...
      qw.displayName = "CloudAlert", qw.categories = ["development"], qw.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], qw.SM = Dw, qw.LG = Gw, qw.MD = Nw, qw.XL = Xw;
      const Pw = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Tw.displayName = "CodeXml", Tw.categories = ["text", "development"], Tw.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], Tw.SM = Pw, Tw.LG = Fw, Tw.MD = kw, Tw.XL = Ow;
      ...
      Zw.displayName = "Database", Zw.categories = ["devices", "development"], Zw.tags = ["storage", "memory", "container", "tin", "pot", "bytes", "servers"], Zw.SM = Ew, Zw.LG = Uw, Zw.MD = _w, Zw.XL = Ww;
      ...
      $w.displayName = "Server", $w.categories = ["development", "devices"], $w.tags = ["cloud", "storage"], $w.SM = Yw, $w.LG = Kw, $w.MD = Qw, $w.XL = Jw
    }
  }
]);