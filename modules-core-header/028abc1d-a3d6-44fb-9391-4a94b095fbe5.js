  ...
  [5912], {
    75912: (t, e, n) => {
              ...
              function i(i, s) {
                ...
                for (let e = 0; e < hr; e++) {
                  ...
                  for (const t in A) {
                    const e = S[t],
                      n = T[t];
                    h.hasOwnProperty(t) || (e !== n ? Dt(e) && Dt(n) ? !Re(e, n) || b ? C(t) : g.protectedKeys[t] = !0 : void 0 !== e ? C(t) : c.add(t) : void 0 !== e && c.has(t) ? C(t) : g.protectedKeys[t] = !0)
                  }
          ...
          if (r.forEach(r => {
              ...
              if (Dt(h)) {
                const t = h.length,
                  e = null === h[0] ? 1 : 0;
                u = h[e], c = Sn(u);
                for (let n = e; n < t; n++) d ? Un(Sn(h[n]) === d, "All keyframes must be of the same type") : (d = Sn(h[n]), Un(d === c || hi(c) && hi(d), "Keyframes must be of the same dimension as the current value"))
              } else d = Sn(h);
              if (c !== d)
                if (hi(c) && hi(d)) {
                  const t = l.get();
      ...
      function hs({
        ...
        return class {
          ...
          didUpdate() {
            ...
            this.isUpdating && (this.isUpdating = !1, this.potentialNodes.size && (this.potentialNodes.forEach(Cs), this.potentialNodes.clear()), this.nodes.forEach(ys), this.nodes.forEach(ds), this.nodes.forEach(fs), this.clearAllSnapshots(), We.update(), We.preRender(), We.render())
          }
          clearAllSnapshots() {
          ...
          calcProjection() {
            ...
            Cr(this.projectionDelta, this.layoutCorrected, l, this.latestValues), this.projectionTransform = ss(this.projectionDelta, this.treeScale), this.projectionTransform === h && this.treeScale.x === u && this.treeScale.y === c || (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", l))
          }
          hide() {
            this.isVisible = !1
          }
      ...
      function Ga(t, e, n) {
        ...
        }(ja(h), e[i].offset), e[i].interpolatorOffsets = [...e[i].offset]), e[i].progress = e[i].interpolate(e[i].current)
      }
