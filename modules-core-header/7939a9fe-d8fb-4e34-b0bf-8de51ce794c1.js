! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      a = (new e.Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "7939a9fe-d8fb-4e34-b0bf-8de51ce794c1", e._sentryDebugIdIdentifier = "sentry-dbid-7939a9fe-d8fb-4e34-b0bf-8de51ce794c1")
  } catch (e) {}
}();
    ...
    88733: (e, a, t) => {
      ...
      const g = (0, o.defineMessages)({
        ...
        k = h((e => {
          ...
          const {
            track: p
          } = (0, f.useGtmTrack)(), h = (0, o.useIntl)(), [k] = (0, o.getLocale)(), [v, w] = (0, s.useState)(!1), x = (0, s.useRef)(null), [y, C] = (0, s.useState)(0), S = "ontouchstart" in window || navigator?.maxTouchPoints > 0 || navigator?.msMaxTouchPoints > 0, M = e => {
      ...
      const O = {
        ...
        A = e => ({
          text: e.formatMessage(G.sc_link_help),
          target: "_self",
          ga: {
            ...O,
          ...
          children: [{
            text: e.formatMessage(G.sc_link_support),
            location: {
              domain: T.C.support,
              path: "/"
            },
            ...
            text: e.formatMessage(G.sc_link_legal),
            location: {
              domain: T.C.www,
              path: "/legal"
            },
            ...
            text: e.formatMessage(G.sc_link_privacy_policy),
            location: {
              domain: T.C.www,
              path: "/privacy"
            },
            ...
            text: e.formatMessage(G.sc_link_cookies_policy),
            location: {
              domain: T.C.www,
              path: "/cookies"
            },
            ...
            text: e.formatMessage(G.sc_link_cookies_settings),
            onClickCallback: e => {
            ...
            text: e.formatMessage(G.sc_link_do_not_sell_my_information),
            location: {
              domain: T.C.www,
              path: "/ccpa"
            },
      ...
      const D = e => {
          ...
          return (0, _.jsxs)(H.A, {
            ...
            children: [a, l && (0, _.jsx)("div", {
              ...
              children: (0, _.jsx)("span", {
                ...
                children: h.formatMessage(G.nofications_new)
              })
            })]
          })
        },
        B = e => {
          ...
          const {
            ...
            navOpen: y
          } = (0, f.useRockstarUserState)(), C = (0, s.useRef)(null), [S, M] = (0, s.useState)(0), [j, N] = (0, s.useState)(0), [z, E] = (0, s.useState)(!0);
          return (0, s.useEffect)((() => {
            u !== a && !1 === z && E(!0), u === a && E(!1)
          }), [u]), (0, s.useEffect)((() => {
            if (!C.current) return;
        ...
        q = e => {
          ...
          const {
            ...
            navOpen: h
          } = (0, f.useRockstarUserState)(), v = (0, w.useLocale)(), x = (0, w.toScLocaleString)(v), [y, C] = (0, s.useState)(""), S = `${a.login}?returnUrl=${y}&lang=${x}`, M = `${a.signup}&returnUrl=${y}&lang=${x}`, j = (0, s.useMemo)((() => (0, T.A)()), []), N = (0, s.useMemo)((() => {
            const e = ((e, a, t) => [{
              text: e.formatMessage(G.sc_link_sign_in),
              href: a,
              ga: {
                event: "cta_login",
                text: G.sc_link_sign_in.defaultMessage,
                element_placement: "Account Menu"
              },
              dataTestId: "loginLink"
            }, {
              text: e.formatMessage(G.sc_link_join_social_club),
              href: t,
              ga: {
                event: "cta_signup",
                text: G.sc_link_join_social_club.defaultMessage,
                element_placement: "Account Menu"
              },
              dataTestId: "signUpLink"
            }, A(e)])(c, S, M);
            return e
          }), [c, S, M, j]), [z, E] = (0, s.useState)(0), R = (0, s.createRef)(), P = () => {
            if (R.current) {
              const {
                current: e
          ...
          return (0, s.useEffect)((() => {
            ...
            children: [(0, _.jsx)("nav", {
              ...
              children: (0, _.jsx)("div", {
                ...
                children: N.map((e => (0, s.createElement)(B, {
                  ...e,
                  activeSubNavId: u,
                  setActiveSubNavId: m,
                  setSubNavExtraHeight: b,
      ...
      const te = {
          ...
          return (0, s.useEffect)((() => {
            ...
            children: [(0, _.jsx)("div", {
              ...
              children: (0, _.jsx)("img", {
                src: h,
                alt: i.formatMessage(G.profile_selector_mugshot, {
                  userName: g
                }),
                onError: () => {
                  k(t(5931))
        ...
        _e = e => {
          ...
          const {
            ...
            platform: S
          } = a, [M, j] = (0, s.useState)("0"), [N, z] = (0, s.useState)("0"), E = e => parseInt(e, 10).toLocaleString("en-US", {
          ...
          (0, s.useEffect)((() => {
            ...
            P((0, _.jsx)("img", {
              ...
              onError: R,
              "data-testid": ce
            })), j(E(a.stats.overview.bank.value)), z(E(a.stats.overview.cash.value)), y(parseInt(a.stats.overview.rank.value))
        ...
        fe = e => {
          ...
          const {
            ...
            setUserData: Z
          } = (0, f.useRockstarUserState)(), [J, Q] = (0, s.useState)(null), [ee, ae] = (0, s.useState)(!1), [te, se] = (0, s.useState)(!1), [re, oe] = (0, s.useState)(0), ie = (0, s.createRef)(), ce = (0, $.ri)(ie, !1), le = (0, s.createRef)(), [de, fe] = (0, s.useState)(0), [ge, be] = (0, s.useState)([]), [pe, he] = (0, s.useState)(244), ke = (0, s.useRef)(null), ve = (0, s.useMemo)((() => (0, T.A)()), []), we = (0, s.useMemo)((() => ((e, a, t, s, r) => [{
            text: e.formatMessage(G.sc_link_activity_feed),
            location: {
            ...
            ga: {
              ...O,
              text: G.sc_link_activity_feed.defaultMessage
            },
            dataTestId: "activityFeedLink"
          }, {
            text: e.formatMessage(G.sc_link_account),
            target: "_self",
            dataTestId: "accountButton",
            children: [{
              text: e.formatMessage(G.sc_link_settings),
              location: {
                domain: T.C.socialClub,
                path: "/settings"
              },
              ...
              text: e.formatMessage(G.sc_link_view_my_profile),
              href: t.profile_link,
              target: "_self",
              ga: {
                ...O,
              ...
              text: e.formatMessage(G.sc_link_messages),
              location: {
                domain: T.C.socialClub,
                path: "/message"
              },
              ...
              ga: {
                ...O,
                text: G.sc_link_messages.defaultMessage
              },
              dataTestId: "messagesLink"
            }, {
              text: e.formatMessage(G.sc_link_game_activation),
              location: {
                domain: T.C.socialClub,
                path: "/activate"
              },
            ...
            text: e.formatMessage(G.sc_link_notifications),
            location: {
              domain: T.C.socialClub,
              path: "/notifications"
            },
            ...
            text: e.formatMessage(G.sc_link_crews),
            location: {
              domain: T.C.socialClub,
            ...
            text: e.formatMessage(G.sc_link_friends),
            target: "_self",
            dataTestId: "friendsButton",
            children: [{
              text: e.formatMessage(G.sc_link_my_friends),
              location: {
                domain: T.C.socialClub,
              ...
              text: e.formatMessage(G.sc_link_import_friends),
              location: {
                domain: T.C.socialClub,
                path: "/friends/import"
              },
              ...
              text: e.formatMessage(G.sc_link_find_friends),
              location: {
                domain: T.C.socialClub,
                path: "/members"
              },
            ...
            text: e.formatMessage(G.sc_link_log_out),
            href: `${a.logout}?returnUrl=${r}`,
            target: "_self",
            reloadDocument: !0,
            ga: {
              ...O,
              text: G.sc_link_log_out.defaultMessage
            },
            dataTestId: "logoutButton"
          }])(h, a, D, W, z, window)), [h, a, D, W, z, ve]), xe = () => {
            se(i + pe * re < ce)
          }, ye = () => {
            if (le.current) {
              const {
          ...
          return (0, s.useEffect)((() => {
            ...
            if (null !== q && !e.length) return void Y(!1);
            ...
            children: [null !== J && "gtao" === U && (0, _.jsxs)("div", {
              ...
              ref: ke,
              tabIndex: -1,
              "aria-label": h.formatMessage(G.profile_selector_profile_card),
              children: [(0, _.jsx)(_e, {
                s: me,
                character: J
              }), !0 === ee && (0, _.jsxs)("div", {
                ...
                children: [(0, _.jsx)("button", {
                  ...
                  children: (0, _.jsx)("span", {
                    children: (0, _.jsx)(o.FormattedMessage, {
                      ...G.profile_selector_switch_character
                    })
                  })
                }), !d && (0, _.jsx)("div", {
              ...
              children: [(0, _.jsx)("button", {
                ...
                children: we.map(((e, a) => (0, s.createElement)(B, {
                  ...e,
                  id: a,
                  activeSubNavId: y,
                  setActiveSubNavId: C,
        ...
        pe = h((e => {
          ...
          const {
            ...
            track: j
          } = (0, f.useGtmTrack)(), [N, z] = (0, s.useState)(!1), E = (0, s.useRef)(), [R, P] = (0, s.useState)(0), L = (0, s.createRef)(), [T, O] = (0, s.useState)(!1), [A, H] = (0, s.useState)(0), [D, B] = (0, s.useState)(!1), {
            mutateWebSettings: $,
            webSettings: U
          ...
          return (0, s.useEffect)((() => {
            null !== y && U.currentCharId !== y && $({
              key: "currentCharId",
              value: y
            }), !1 === x ? $({
              key: "currentCharId",
              value: null
            }) : x && M && M.accountSynced && j({
              event: "account_synced"
            })
          }), [y, x, M?.accountSynced]), (0, s.useEffect)((() => {
            E.current && (!1 === g && !1 === N && (E.current.style.height = `${E.current.scrollHeight}px`), !0 === g && (E.current.style.height = null))
          }), [g, E, N]), (0, s.useEffect)((() => {
            const e = () => {
                S(!1), V(!0)
              },
            ...
            L.current && h(L?.current?.scrollHeight >= n)
          }), [L, n]), (0, s.useEffect)((() => {
            C || (d(-1), l(!1))
          }), [C]), (0, s.useEffect)((() => {
            c && (g || V(!0), u && (m(!1), d(-1)))
            ...
            children: [(0, _.jsxs)("div", {
              ...
              children: [(0, _.jsx)("button", {
                ...
                children: (0, _.jsx)("img", {
                  ...
                  src: t(35902),
                  alt: i.formatMessage(G.sc_menu_drag_handle)
                })
              }), x ? (0, _.jsx)(fe, {
                sc: be,
                charListHidden: g,
        ...
        he = h((e => {
          ...
          return (0, s.useEffect)((() => {
            ...
            "aria-label": r.formatMessage(d ? G.sc_menu_close : G.sc_menu_open),
            "aria-expanded": d,
            type: "button",
            onClick: w,
            "data-mugshot": p,
        ...
        ve = e => {
          ...
          return (0, s.useEffect)((() => {
            ...
            U()
          }), [E, l, u, M]), (0, s.useEffect)((() => {
            j(B.characters?.[g] ?? [])
          }), [B, g]), (0, s.useEffect)((() => {
            B && v(B)
          }), [B]), (0, s.useEffect)((() => {
            const e = B?.characters?.gtao;
            if (null !== q && !e?.length) return void k(!1);
            ...
            let e = M.length - 1;
            e < 0 && (e = 0), R(e);
            const a = M.length > 0 ? M[b] ?? M[0] : null;
            if (a) return S(a), x(a.mugshotUrl), y(a.platform), M.length > 1 ? z(!0) : z(!1), c(M.length - 1 > 3), () => {
              x(""), y("")
            }
          }), [b, M]), (0, s.useEffect)((() => {
            const e = D?.currentCharId ?? 0;
            e !== b && h(Math.max(0, Math.min(e, M.length - 1)))
          }), [M, D]), C && "gtao" === g ? (0, _.jsxs)("div", {
            className: ke.profile,
            ref: O,
            tabIndex: -1,
            "aria-label": d.formatMessage(G.profile_selector_profile_card),
            children: [(0, _.jsx)(_e, {
              s: ke,
              character: C
            }), !0 === N && (0, _.jsxs)("div", {
              ...
              children: [(0, _.jsx)("button", {
                ...
                children: (0, _.jsx)(ue, {
                  ...
                  disablePager: L,
                  disableSwiper: L,
                  children: M.filter(((e, a) => a !== b)).map((e => (0, s.createElement)(ne, {
                    characterData: e,
                    setMobileCardWidth: P,
                    key: e.mugshotUrl,
                    tabIndex: a ? -1 : 0
