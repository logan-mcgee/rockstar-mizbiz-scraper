try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    l = (new e.Error).stack;
  l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "7043d441-ec79-4e6a-9b30-9154f7d448c2", e._sentryDebugIdIdentifier = "sentry-dbid-7043d441-ec79-4e6a-9b30-9154f7d448c2")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [2912], {
    92912: (e, l, a) => {
      ...
      B.displayName = "EyeClosed", B.categories = ["accessibility", "photography", "design", "security"], B.tags = ["view", "watch", "see", "hide", "conceal", "mask", "hidden", "visibility", "vision"], B.SM = H, B.LG = A, B.MD = V, B.XL = I;
      ...
      He.displayName = "CirclePerson", He.categories = ["account"], He.tags = ["person", "account", "contact"], He.SM = be, He.LG = Le, He.MD = ze, He.XL = Ce;
      ...
      Se.displayName = "Flag", Se.categories = ["account", "social"], Se.tags = ["report"], Se.SM = Ae, Se.LG = Ve, Se.XL = Ie, Se.MD = Be;
      ...
      Al.displayName = "ShieldCheck", Al.categories = ["account", "security", "development", "gaming"], Al.tags = ["cybersecurity", "secured", "safety", "protection", "protected", "guardian", "guarded", "armored", "armoured", "defense", "defence", "defended", "blocked", "threat", "prevention", "prevented", "antivirus", "vigilance", "vigilant", "active", "activated", "enabled", "detection", "scanned", "found", "strength", "strong", "tough", "invincible", "invincibility", "invulnerable", "undamaged", "audited", "admin", "verification", "verified", "certification", "certified", "tested", "passed", "qualified", "cleared", "cleaned", "disinfected", "uninfected", "task", "completed", "todo", "done", "ticked", "checked", "crest", "bravery"], Al.SM = Ll, Al.LG = zl, Al.MD = Cl, Al.XL = Hl;
      const Vl = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      La.displayName = "LogOut", La.categories = ["account"], La.tags = ["sign out", "arrow", "exit", "auth", "log", "out"], La.SM = ua, La.MD = Ma, La.LG = Ra, La.XL = ba;
      ...
      Va.displayName = "ArrowUp", Va.categories = ["arrows", "navigation"], Va.tags = ["forward", "direction", "north", "increase"], Va.SM = za, Va.LG = Ca, Va.MD = Ha, Va.XL = Aa;
      ...
      Da.displayName = "ArrowLeft", Da.categories = ["arrows", "navigation"], Da.tags = ["previous", "back", "direction", "west", "<-", "Left", "Navigation", "Back"], Da.SM = Ia, Da.LG = Ba, Da.MD = Sa, Da.XL = ya;
      ...
      Pa.displayName = "ArrowUpDown", Pa.categories = ["arrows", "navigation"], Pa.tags = ["bidirectional", "two-way", "2-way", "swap", "switch", "network", "mobile data", "internet", "sort", "reorder", "move", "Sortable", "Control", "Filter", "Sort"], Pa.SM = Ga, Pa.LG = Na, Pa.MD = Xa, Pa.XL = qa;
      ...
      Ea.displayName = "ArrowRightLeft", Ea.categories = ["arrows", "navigation"], Ea.tags = ["bidirectional", "two-way", "2-way", "swap", "switch", "transaction", "reorder", "move", "<-", "->"], Ea.SM = Fa, Ea.LG = ka, Ea.MD = Oa, Ea.XL = Ta;
      const Ua = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ya.displayName = "ChevronUp", Ya.categories = ["arrows", "navigation", "math", "gaming"], Ya.tags = ["caret", "keyboard", "mac", "control", "ctrl", "superscript", "exponential", "power", "ahead", "fast", "^", "dropdown", "up", "direction", "top"], Ya.SM = Ua, Ya.LG = _a, Ya.MD = Wa, Ya.XL = Za;
      ...
      er.displayName = "ArrowDown", er.categories = ["arrows", "navigation"], er.tags = ["backwards", "reverse", "direction", "south", "Down", "Navigation", "Decrease"], er.SM = Ka, er.LG = Qa, er.MD = Ja, er.XL = $a;
      ...
      sr.displayName = "ArrowRight", sr.categories = ["arrows", "navigation"], sr.tags = ["forward", "next", "direction", "east", "->"], sr.SM = lr, sr.LG = ar, sr.MD = rr, sr.XL = tr;
      ...
      hr.displayName = "ChevronDown", hr.categories = ["arrows", "navigation", "gaming"], hr.tags = ["backwards", "reverse", "slow", "dropdown", "down", "direction", "bottom"], hr.SM = ir, hr.LG = dr, hr.MD = or, hr.XL = nr;
      ...
      xr.displayName = "ChevronLeft", xr.categories = ["arrows", "navigation"], xr.tags = ["back", "previous", "less than", "fewer", "menu", "left", "direction", "side"], xr.SM = cr, xr.LG = fr, xr.MD = wr, xr.XL = vr;
      ...
      ur.displayName = "ChevronRight", ur.categories = ["arrows", "navigation", "math", "development"], ur.tags = ["forward", "next", "more than", "greater", "menu", "code", "coding", "command line", "terminal", "prompt", "shell", "right", "direction", "side"], ur.SM = gr, ur.LG = jr, ur.MD = mr, ur.XL = pr;
      ...
      zr.displayName = "ChevronsDownUp", zr.categories = ["arrows"], zr.tags = ["collapse", "fold", "vertical"], zr.SM = Mr, zr.LG = Rr, zr.MD = br, zr.XL = Lr;
      const Cr = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ir.displayName = "CloudUpload", Ir.categories = ["arrows", "files"], Ir.tags = ["file"], Ir.SM = Cr, Ir.LG = Hr, Ir.MD = Ar, Ir.XL = Vr;
      ...
      Gr.displayName = "ChevronsLeftRight", Gr.categories = ["arrows"], Gr.tags = ["expand", "horizontal", "unfold"], Gr.SM = Br, Gr.LG = Sr, Gr.MD = yr, Gr.XL = Dr;
      ...
      Fr.displayName = "ChevronFirst", Fr.categories = ["arrows", "multimedia"], Fr.tags = ["previous", "music"], Fr.SM = Nr, Fr.LG = Xr, Fr.MD = qr, Fr.XL = Pr;
      ...
      Ur.displayName = "ChevronLast", Ur.categories = ["arrows", "multimedia"], Ur.tags = ["skip", "next", "music"], Ur.SM = kr, Ur.LG = Or, Ur.MD = Tr, Ur.XL = Er;
      ...
      Kr.displayName = "ChevronsUpDown", Kr.categories = ["arrows"], Kr.tags = ["expand", "unfold", "vertical"], Kr.SM = _r, Kr.LG = Wr, Kr.MD = Zr, Kr.XL = Yr;
      ...
      lt.displayName = "CloudDownload", lt.categories = ["arrows", "files"], lt.tags = ["import"], lt.SM = Qr, lt.LG = Jr, lt.MD = $r, lt.XL = et;
      ...
      it.displayName = "Maximize2", it.categories = ["arrows", "layout", "design"], it.tags = ["fullscreen", "arrows", "expand"], it.SM = at, it.LG = rt, it.MD = tt, it.XL = st;
      ...
      ct.displayName = "Upload", ct.categories = ["arrows", "files"], ct.tags = ["file", "up", "file", "share"], ct.SM = dt, ct.LG = ot, ct.MD = nt, ct.XL = ht;
      ...
      gt.displayName = "Download", gt.categories = ["arrows", "files"], gt.tags = ["import", "export", "save", "down"], gt.SM = ft, gt.LG = wt, gt.MD = vt, gt.XL = xt;
      ...
      Mt.displayName = "ExternalLink", Mt.categories = ["arrows", "text", "social"], Mt.tags = ["outbound", "share", "link", "new tab", "new window", "open", "URL", "hyperlink", "external"], Mt.SM = jt, Mt.LG = mt, Mt.MD = pt, Mt.XL = ut;
      ...
      Ct.displayName = "RefreshCw", Ct.categories = ["arrows"], Ct.tags = ["rotate", "reload", "rerun", "synchronise", "synchronize", "arrows", "circular", "cycle", "loop", "repeat", "sync", "update", "reset", "restore"], Ct.SM = Rt, Ct.LG = bt, Ct.MD = Lt, Ct.XL = zt;
      ...
      Bt.displayName = "Replay", Bt.categories = ["arrows", "design", "photography"], Bt.tags = ["arrow", "right", "clockwise", "refresh", "reload", "rerun", "redo"], Bt.SM = Ht, Bt.LG = At, Bt.MD = Vt, Bt.XL = It;
      ...
      Nt.displayName = "Undo", Nt.categories = ["text", "arrows"], Nt.tags = ["redo", "rerun", "history", "back", "return", "reverse", "revert", "direction", "u-turn", "undo", "arrow", "navigation"], Nt.SM = St, Nt.LG = yt, Nt.MD = Dt, Nt.XL = Gt;
      ...
      kt.displayName = "RefreshCwOff", kt.categories = ["arrows"], kt.tags = ["rotate", "reload", "rerun", "synchronise", "synchronize", "arrows", "circular", "cycle", "cancel", "no", "stop", "error", "disconnect", "ignore"], kt.SM = Xt, kt.LG = qt, kt.MD = Pt, kt.XL = Ft;
      ...
      _t.displayName = "Minimize2", _t.categories = ["arrows", "layout", "design"], _t.tags = ["exit fullscreen", "arrows", "close", "shrink"], _t.SM = Ot, _t.LG = Tt, _t.MD = Et, _t.XL = Ut;
      ...
      Qt.displayName = "House", Qt.categories = ["buildings", "home"], Qt.tags = ["home", "living", "building", "residence", "architecture", "property", "homepage", "city"], Qt.SM = Wt, Qt.LG = Zt, Qt.MD = Yt, Qt.XL = Kt;
      const Jt = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      as.displayName = "Property", as.categories = ["account", "buildings"], as.tags = ["organization", "building", "house", "city", "GTAO", "structure"], as.SM = Jt, as.LG = $t, as.MD = es, as.XL = ls;
      ...
      ds.displayName = "Store", ds.categories = ["buildings", "navigation", "shopping"], ds.tags = ["shop", "supermarket", "stand", "boutique", "building"], ds.SM = rs, ds.LG = ts, ds.MD = ss, ds.XL = is;
      ...
      fs.displayName = "ChartSpline", fs.categories = ["charts"], fs.tags = ["statistics", "analytics", "diagram", "graph", "curve", "continuous", "smooth", "polynomial", "quadratic", "function", "interpolation"], fs.SM = os, fs.LG = ns, fs.MD = hs, fs.XL = cs;
      ...
      js.displayName = "PaperPlane", js.categories = ["mail", "communication", "connectivity"], js.tags = ["email", "message", "mail", "paper airplane", "paper aeroplane", "submit", "send"], js.SM = ws, js.LG = vs, js.MD = xs, js.XL = gs;
      ...
      Rs.displayName = "Volume", Rs.categories = ["connectivity", "communication", "multimedia"], Rs.tags = ["music", "sound", "mute", "speaker"], Rs.SM = ms, Rs.LG = ps, Rs.MD = us, Rs.XL = Ms;
      ...
      Hs.displayName = "Volume1", Hs.categories = ["connectivity", "communication", "multimedia"], Hs.tags = ["music", "sound", "speaker", "control", "volume", "low"], Hs.SM = bs, Hs.LG = Ls, Hs.MD = zs, Hs.XL = Cs;
      ...
      Ss.displayName = "Volume2", Ss.categories = ["connectivity", "communication", "multimedia"], Ss.tags = ["music", "sound", "speaker", "control", "volume", "high"], Ss.SM = As, Ss.LG = Vs, Ss.MD = Is, Ss.XL = Bs;
      ...
      Xs.displayName = "VolumeX", Xs.categories = ["connectivity", "communication", "multimedia"], Xs.tags = ["music", "sound", "mute", "speaker", "control", "volume"], Xs.SM = ys, Xs.LG = Ds, Xs.MD = Gs, Xs.XL = Ns;
      ...
      Os.displayName = "Headset", Os.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], Os.tags = ["music", "audio", "sound", "gaming", "headphones", "headset", "call", "center", "phone", "telephone", "voip", "video"], Os.SM = qs, Os.LG = Ps, Os.MD = Fs, Os.XL = ks;
      ...
      Ws.displayName = "Power", Ws.categories = ["connectivity"], Ws.tags = ["on", "off", "device", "switch", "toggle", "binary", "boolean", "reboot", "restart", "button", "keyboard", "troubleshoot"], Ws.SM = Ts, Ws.LG = Es, Ws.MD = Us, Ws.XL = _s;
      ...
      Js.displayName = "Wifi", Js.categories = ["connectivity", "devices"], Js.tags = ["connection", "signal", "wireless", "internet", "technology", "network"], Js.SM = Zs, Js.LG = Ys, Js.MD = Ks, Js.XL = Qs;
      const $s = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ri.displayName = "WifiOff", ri.categories = ["connectivity", "devices"], ri.tags = ["disabled", "connection", "internet", "wireless", "technology", "network", "signal", "no", "off"], ri.SM = $s, ri.LG = ei, ri.MD = li, ri.XL = ai;
      ...
      oi.displayName = "Monitor", oi.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], oi.tags = ["tv", "computer", "screen", "display", "virtual machine"], oi.SM = ti, oi.MD = si, oi.LG = ii, oi.XL = di;
      ...
      wi.displayName = "Pencil", wi.categories = ["design", "cursors", "tools", "text"], wi.tags = ["rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist", "update", "correct", "modify", "note"], wi.SM = ni, wi.LG = hi, wi.MD = ci, wi.XL = fi;
      ...
      mi.displayName = "PencilOff", mi.categories = ["design", "cursors", "tools", "text"], mi.tags = ["disabled", "inactive", "non-editable", "locked", "read-only", "unmodifiable", "frozen", "restricted", "rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist"], mi.SM = vi, mi.LG = xi, mi.MD = gi, mi.XL = ji;
      ...
      bi.displayName = "Plus", bi.categories = ["math", "tools", "development", "text", "cursors", "gaming"], bi.tags = ["add", "new", "increase", "increment", "positive", "calculate", "toolbar", "crosshair", "aim", "target", "scope", "sight", "reticule", "maximum", "upgrade", "extra", "+", "more", "create", "navigation"], bi.SM = pi, bi.LG = ui, bi.MD = Mi, bi.XL = Ri;
      ...
      Ai.displayName = "LayoutGrid", Ai.categories = ["design", "layout"], Ai.tags = ["app", "home", "start", "squares", "hub", "menu", "blocks", "options", "items", "gallery"], Ai.SM = Li, Ai.LG = zi, Ai.MD = Ci, Ai.XL = Hi;
      const Vi = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yi.displayName = "Maximize", yi.categories = ["layout", "design"], yi.tags = ["full screen", "expand", "dashed", "maximum", "big", "large"], yi.SM = Vi, yi.LG = Ii, yi.MD = Bi, yi.XL = Si;
      ...
      qi.displayName = "Minimize", qi.categories = ["layout", "design"], qi.tags = ["exit", "full screen", "close", "shrink", "window", "reduce", "video playback"], qi.SM = Di, qi.LG = Gi, qi.MD = Ni, qi.XL = Xi;
      const Pi = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ti.displayName = "Cpu", Ti.categories = ["devices"], Ti.tags = ["processor", "cores", "technology", "computer", "chip", "circuit", "memory", "ram", "specs", "gigahertz", "ghz"], Ti.SM = Pi, Ti.MD = Fi, Ti.LG = ki, Ti.XL = Oi;
      ...
      Zi.displayName = "Calendar", Zi.categories = ["time"], Zi.tags = ["date", "month", "year", "event", "birthday", "birthdate"], Zi.SM = Ei, Zi.LG = Ui, Zi.MD = _i, Zi.XL = Wi;
      ...
      $i.displayName = "CalendarOff", $i.categories = ["time"], $i.tags = ["date", "day", "month", "year", "event", "delete", "remove"], $i.SM = Yi, $i.LG = Ki, $i.MD = Qi, $i.XL = Ji;
      ...
      td.displayName = "Clock", td.categories = ["time"], td.tags = ["time", "watch", "alarm", "hour", "minute", "second", "planned", "watch"], td.SM = ed, td.LG = ld, td.MD = ad, td.XL = rd;
      ...
      nd.displayName = "Clipboard", nd.categories = ["text"], nd.tags = ["copy", "paste"], nd.SM = sd, nd.LG = id, nd.MD = dd, nd.XL = od;
      ...
      vd.displayName = "Copy", vd.categories = ["text"], vd.tags = ["clone", "duplicate", "multiple"], vd.SM = hd, vd.LG = cd, vd.MD = fd, vd.XL = wd;
      ...
      pd.displayName = "List", pd.categories = ["text"], pd.tags = ["options", "index", "table of contents", "menu", "side nav", "navigation", "bullet", "to do"], pd.SM = xd, pd.LG = gd, pd.MD = jd, pd.XL = md;
      ...
      Ld.displayName = "ListFilter", Ld.categories = ["text"], Ld.tags = ["options"], Ld.SM = ud, Ld.LG = Md, Ld.MD = Rd, Ld.XL = bd;
      ...
      Vd.displayName = "Unlink", Vd.categories = ["text"], Vd.tags = ["url", "unchain"], Vd.SM = zd, Vd.LG = Cd, Vd.MD = Hd, Vd.XL = Ad;
      ...
      Dd.displayName = "Trophy", Dd.categories = ["sports", "gaming"], Dd.tags = ["prize", "sports", "winner", "achievement", "award", "champion", "celebration", "victory"], Dd.SM = Id, Dd.LG = Bd, Dd.MD = Sd, Dd.XL = yd;
      ...
      Pd.displayName = "Discord", Pd.categories = ["brands", "social"], Pd.tags = ["Social media", "Video", "Player", "Game", "Community", "App", "Share", "Logo"], Pd.SM = Gd, Pd.LG = Nd, Pd.MD = Xd, Pd.XL = qd;
      ...
      Ed.displayName = "Instagram", Ed.categories = ["brands", "social", "photography"], Ed.tags = ["logo", "camera", "social media", "photo", "camera", "app", "share"], Ed.SM = Fd, Ed.LG = kd, Ed.MD = Od, Ed.XL = Td;
      const Ud = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Yd.displayName = "Facebook", Yd.categories = ["social", "brands"], Yd.tags = ["logo", "social media", "profile", "feed", "app", "share"], Yd.SM = Ud, Yd.LG = _d, Yd.MD = Wd, Yd.XL = Zd;
      ...
      eo.displayName = "Twitch", eo.categories = ["brands", "social", "account", "gaming"], eo.tags = ["logo", "social", "social media", "streaming", "game", "app", "share"], eo.SM = Kd, eo.LG = Qd, eo.MD = Jd, eo.XL = $d;
      ...
      so.displayName = "Youtube", so.categories = ["multimedia", "social", "brands"], so.tags = ["logo", "social", "video", "play", "video", "player", "app", "share"], so.SM = lo, so.LG = ao, so.MD = ro, so.XL = to;
      ...
      co.displayName = "Twitter", co.categories = ["brands", "social", "account"], co.tags = ["logo", "social", "social media", "twitter", "tweet", "app", "share", "x"], co.SM = io, co.LG = oo, co.MD = no, co.XL = ho;
      ...
      go.displayName = "Tiktok", go.categories = ["brands", "social"], go.tags = ["Social media", "video", "player", "game", "community", "app", "share", "logo", "photo", "camera"], go.SM = fo, go.MD = wo, go.LG = vo, go.XL = xo;
      ...
      Mo.displayName = "Reddit", Mo.categories = ["social", "brands"], Mo.tags = ["logo", "social media", "profile", "feed", "app", "share", "forum", "community"], Mo.SM = jo, Mo.MD = mo, Mo.LG = po, Mo.XL = uo;
      ...
      Co.displayName = "EpicGames", Co.categories = ["platform"], Co.tags = ["games", "gaming", "social", "brand", "third party"], Co.SM = Ro, Co.MD = bo, Co.LG = Lo, Co.XL = zo;
      ...
      Bo.displayName = "Steam", Bo.categories = ["platform"], Bo.tags = ["games", "gaming", "social", "brand", "third party"], Bo.SM = Ho, Bo.MD = Ao, Bo.LG = Vo, Bo.XL = Io;
      ...
      No.displayName = "Xbox", No.categories = ["platform"], No.tags = ["games", "gaming", "social", "brand", "third party"], No.SM = So, No.MD = yo, No.LG = Do, No.XL = Go;
      ...
      ko.displayName = "Car", ko.categories = ["transportation"], ko.tags = ["vehicle", "drive", "trip", "journey", "automobile", "GTAO", "transport"], ko.SM = Xo, ko.LG = qo, ko.MD = Po, ko.XL = Fo;
      ...
      _o.displayName = "CarSide", _o.categories = ["transportation"], _o.tags = ["vehicle", "drive", "trip", "journey"], _o.SM = Oo, _o.LG = To, _o.MD = Eo, _o.XL = Uo;
      ...
      Qo.displayName = "MessageSquareText", Qo.categories = ["social"], Qo.tags = ["comment", "chat", "conversation", "dialog", "feedback", "speech bubble", "clear", "close", "delete", "remove", "cancel", "silence", "mute", "moderate"], Qo.SM = Wo, Qo.LG = Zo, Qo.MD = Yo, Qo.XL = Ko;
      const Jo = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      an.displayName = "Search", an.categories = ["text", "social"], an.tags = ["find", "scan", "magnifier", "magnifying glass", "look", "view"], an.SM = Jo, an.LG = $o, an.MD = en, an.XL = ln;
      ...
      on.displayName = "PartialCircle", on.categories = ["shapes"], on.tags = ["Partial", "Half", "Middle", "Split"], on.SM = rn, on.LG = tn, on.MD = sn, on.XL = dn;
      ...
      wn.displayName = "LockKeyhole", wn.categories = ["security"], wn.tags = ["security", "password", "secure", "admin", "lock", "safe", "protection", "security", "latch"], wn.SM = nn, wn.LG = hn, wn.MD = cn, wn.XL = fn;
      ...
      An.displayName = "Lightbulb", An.categories = ["photography"], An.tags = ["idea", "bright", "lights"], An.SM = Ln, An.LG = zn, An.MD = Cn, An.XL = Hn;
      const Vn = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yn.displayName = "Check", yn.categories = ["notifications"], yn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "success", "accept"], yn.SM = Vn, yn.LG = In, yn.MD = Bn, yn.XL = Sn;
      ...
      qn.displayName = "CircleCheck", qn.categories = ["notifications"], qn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], qn.SM = Dn, qn.LG = Gn, qn.MD = Nn, qn.XL = Xn;
      const Pn = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Tn.displayName = "TriangleAlert", Tn.categories = ["notifications", "shapes", "development"], Tn.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], Tn.SM = Pn, Tn.LG = Fn, Tn.MD = kn, Tn.XL = On;
      ...
      $n.displayName = "Globe", $n.categories = ["navigation"], $n.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], $n.SM = Yn, $n.LG = Kn, $n.MD = Qn, $n.XL = Jn;
      ...
      th.displayName = "HeartPulse", th.categories = ["medical"], th.tags = ["heartbeat", "pulse", "health", "medical", "blood pressure", "cardiac", "systole", "diastole"], th.SM = eh, th.LG = lh, th.MD = ah, th.XL = rh;
      ...
      nh.displayName = "CircleMinus", nh.categories = ["math"], nh.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete"], nh.SM = sh, nh.LG = ih, nh.MD = dh, nh.XL = oh;
      ...
      vh.displayName = "CircleX", vh.categories = ["math", "development"], vh.tags = ["cancel", "close", "delete", "remove", "times", "clear", "error", "incorrect", "wrong", "mistake", "failure", "linter", "multiply", "multiplication", "clean", "erase", "deprecate", "delete", "navigation"], vh.SM = hh, vh.LG = ch, vh.MD = fh, vh.XL = wh;
      ...
      ph.displayName = "Minus", ph.categories = ["math", "development", "text", "tools"], ph.tags = ["subtract", "remove", "decrease", "decrement", "reduce", "negative", "calculate", "line", "divider", "separator", "horizontal rule", "hr", "html", "markup", "markdown", "---", "toolbar", "operator", "code", "coding", "minimum", "downgrade", "less", "delete", "navigation", "minimize"], ph.SM = xh, ph.LG = gh, ph.MD = jh, ph.XL = mh;
      ...
      Lh.displayName = "EnvelopeOpen", Lh.categories = ["mail"], Lh.tags = ["email", "message", "letter", "read"], Lh.SM = uh, Lh.LG = Mh, Lh.MD = Rh, Lh.XL = bh;
      ...
      Vh.displayName = "Paperclip", Vh.categories = ["text", "design", "files", "mail"], Vh.tags = ["attachment", "file", "attach", "clip", "document", "paper"], Vh.SM = zh, Vh.LG = Ch, Vh.MD = Hh, Vh.XL = Ah;
      ...
      Dh.displayName = "Trash", Dh.categories = ["files", "mail"], Dh.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], Dh.SM = Ih, Dh.LG = Bh, Dh.MD = Sh, Dh.XL = yh;
      const Gh = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...t
      ...
      Ph.displayName = "EllipsisVertical", Ph.categories = ["layout"], Ph.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], Ph.SM = Gh, Ph.LG = Nh, Ph.MD = Xh, Ph.XL = qh;
      ...
      Eh.displayName = "Filter", Eh.categories = ["layout"], Eh.tags = ["funnel", "hopper"], Eh.SM = Fh, Eh.LG = kh, Eh.MD = Oh, Eh.XL = Th;
      const Uh = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Yh.displayName = "Weapon", Yh.categories = ["gaming"], Yh.tags = ["gun", "pistol", "GTAO", "fire", "shoot", "death", "danger"], Yh.SM = Uh, Yh.LG = _h, Yh.MD = Wh, Yh.XL = Zh;
      ...
      ec.displayName = "Heart", ec.categories = ["medical", "social", "multimedia", "emoji", "gaming", "shapes"], ec.tags = ["like", "love", "emotion", "suit", "playing", "cards"], ec.SM = Kh, ec.LG = Qh, ec.MD = Jh, ec.XL = $h;
      ...
      sc.displayName = "FileText", sc.categories = ["files", "text"], sc.tags = ["data", "txt", "pdf", "document"], sc.SM = lc, sc.LG = ac, sc.MD = rc, sc.XL = tc;
      ...
      hc.displayName = "Files", hc.categories = ["files"], hc.tags = ["multiple", "copy", "documents", "data", "file", "folder", "restore"], hc.SM = ic, hc.LG = dc, hc.MD = oc, hc.XL = nc;
      ...
      xc.displayName = "Save", xc.categories = ["files"], xc.tags = ["floppy disk", "download", "backup", "storage", "disk", "document", "computer", "archive"], xc.SM = cc, xc.MD = fc, xc.LG = wc, xc.XL = vc;
      ...
      uc.displayName = "CircleDollarSign", uc.categories = ["finance"], uc.tags = ["monetization", "marketing", "currency", "money", "payment"], uc.SM = gc, uc.LG = jc, uc.MD = mc, uc.XL = pc;
      ...
      zc.displayName = "DollarSign", zc.categories = ["finance"], zc.tags = ["currency", "money", "payment"], zc.SM = Mc, zc.LG = Rc, zc.MD = bc, zc.XL = Lc;
      const Cc = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ic.displayName = "FastForward", Ic.categories = ["multimedia", "arrows"], Ic.tags = ["music", "audio", "video", "control", "player", "media"], Ic.SM = Cc, Ic.LG = Hc, Ic.MD = Ac, Ic.XL = Vc;
      ...
      Gc.displayName = "Pause", Gc.categories = ["multimedia"], Gc.tags = ["music", "audio", "video", "stop", "pause", "control", "player", "media"], Gc.SM = Bc, Gc.LG = Sc, Gc.MD = yc, Gc.XL = Dc;
      ...
      Fc.displayName = "Play", Fc.categories = ["arrows", "multimedia"], Fc.tags = ["music", "audio", "video", "start", "run", "play", "continue", "control", "player", "media"], Fc.SM = Nc, Fc.LG = Xc, Fc.MD = qc, Fc.XL = Pc;
      ...
      Uc.displayName = "Rewind", Uc.categories = ["arrows", "multimedia"], Uc.tags = ["music", "audio", "video", "control", "player", "previous", "back", "reverse", "media"], Uc.SM = kc, Uc.LG = Oc, Uc.MD = Tc, Uc.XL = Ec;
      ...
      Kc.displayName = "SkipBack", Kc.categories = ["multimedia", "arrows"], Kc.tags = ["music", "audio", "video", "arrow", "previous", "back", "rewind", "reverse", "control", "player", "media"], Kc.SM = _c, Kc.LG = Wc, Kc.MD = Zc, Kc.XL = Yc;
      ...
      lf.displayName = "SkipForward", lf.categories = ["multimedia", "arrows"], lf.tags = ["music", "audio", "video", "arrow", "skip", "next", "forward", "control", "player", "media"], lf.SM = Qc, lf.LG = Jc, lf.MD = $c, lf.XL = ef;
      ...
      df.displayName = "StarOff", df.categories = ["multimedia", "social"], df.tags = ["dislike", "unlike", "remove", "unrate"], df.SM = af, df.LG = rf, df.MD = tf, df.XL = sf;
      ...
      ff.displayName = "Stop", ff.categories = ["multimedia"], ff.tags = ["music", "audio", "video", "control", "player", "stop", "media"], ff.SM = of, ff.LG = nf, ff.MD = hf, ff.XL = cf;
      ...
      jf.displayName = "ListMusic", jf.categories = ["multimedia"], jf.tags = ["playlist", "music", "audio", "control", "player", "media", "queue", "playback", "play", "list"], jf.SM = wf, jf.MD = vf, jf.LG = xf, jf.XL = gf;
      ...
      Rf.displayName = "Book", Rf.categories = ["text", "gaming"], Rf.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], Rf.SM = mf, Rf.LG = pf, Rf.MD = uf, Rf.XL = Mf;
      ...
      Hf.displayName = "CloudAlert", Hf.categories = ["development"], Hf.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], Hf.SM = bf, Hf.LG = Lf, Hf.MD = zf, Hf.XL = Cf;
      const Af = (0, t.forwardRef)((({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Sf.displayName = "CodeXml", Sf.categories = ["text", "development"], Sf.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], Sf.SM = Af, Sf.LG = Vf, Sf.MD = If, Sf.XL = Bf;
      ...
      Xf.displayName = "Database", Xf.categories = ["devices", "development"], Xf.tags = ["storage", "memory", "container", "tin", "pot", "bytes", "servers"], Xf.SM = yf, Xf.LG = Df, Xf.MD = Gf, Xf.XL = Nf;
      ...
      Of.displayName = "Server", Of.categories = ["development", "devices"], Of.tags = ["cloud", "storage"], Of.SM = qf, Of.LG = Pf, Of.MD = Ff, Of.XL = kf
    }
  }
]);