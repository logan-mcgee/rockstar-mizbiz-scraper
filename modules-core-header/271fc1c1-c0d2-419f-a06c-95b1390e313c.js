try {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new a.Error).stack;
  e && (a._sentryDebugIds = a._sentryDebugIds || {}, a._sentryDebugIds[e] = "271fc1c1-c0d2-419f-a06c-95b1390e313c", a._sentryDebugIdIdentifier = "sentry-dbid-271fc1c1-c0d2-419f-a06c-95b1390e313c")
} catch (a) {} {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [4130], {
    ...
    98846: (a, e, t) => {
      ...
      const fa = ({
          ...
          const {
            isMobile: r
          } = (0, ha.useWindowResize)(), c = (0, ha.useLocale)(), l = (0, i.useMemo)(() => {
            let n = "";
            return a && (n = r ? t(16044)(`./${s}/mobile/${c}.jpg`) : t(51048)(`./${s}/desktop/${c}.jpg`)), n || (n = t(39294)(`./${s}.jpg`), n += `?im=Resize=${e}`), n
          }, [r, s]), [d] = (0, ha.usePreloadImg)(l);
          let g = l;
          return (0, _.jsx)("div", {
            role: "img",
            "aria-label": n,
      ...
      const Ka = ({
        ...
        Qa = (0, d.withIntl)(({
          ...
          brand: e,
          mode: t = "default",
          forceSolidBackground: n = !1
        }) => {
          const [s, o] = (0, i.useState)(!1), [r, c] = (0, i.useState)(!0), [l, g] = (0, i.useState)(!1), [v, m] = (0, i.useState)(n), [p, u] = (0, i.useState)({}), [h, b] = (0, i.useState)(!1), [f, w] = (0, i.useState)(!1), y = (0, i.useRef)(null), k = (0, i.useRef)(null), [x, M] = (0, i.useState)(null), [{
            iso: C
          }] = (0, d.getLocale)();
          return (0, i.useEffect)(() => {
            ...
            s ? document.body.setAttribute(a, "") : document.body.removeAttribute(a)
          }, [s]), (0, i.useEffect)(() => {
            g(!0)
          }, []), (0, i.useEffect)(() => {
            const a = a => {
              a.origin === window.origin && "dynamicSlideColors" === a.data.source && u(a.data.values)
            };
      ...
      const ae = (0, i.createContext)({
        ...
        se = ({
          ...
          const p = {
              show: {
                height: "100dvh",
                paddingBottom: t && l ? "var(--_1np1w6j0)" : "",
                transition: {
                  ...Ya.hamburgerOpen,
                  delay: .2,
                  staggerChildren: .15
      ...
      const me = (0, i.createContext)({
                ...
                children: (0, _.jsxs)(be, {
                  children: [(0, _.jsx)(_e.Trigger, {
                    ...
                    children: (0, _.jsx)(ua.IconButton, {
                      size: "SM",
                      label: r.formatMessage(l ? Ha.avatar_menu_close : Ha.avatar_menu_open),
                      appearance: "ghost",
                      icon: "Person",
                      className: ge,
                      "aria-label": r.formatMessage(l ? Ha.avatar_menu_close : Ha.avatar_menu_open),
        ...
        Re = (0, i.forwardRef)(function({
          ...
          const {
            ...
            inMobileMenu: o
          } = (0, i.useContext)(te), r = (0, i.useRef)(null), c = `rsm-${(0,Ga.useId)()}`;
          let l, d;
          return l = "_1bo9ltz5", d = "_1bo9ltz6", (0, _.jsx)(ze.Provider, {
            value: {
              value: c,
              ref: r
            },
        ...
        He = (0, i.forwardRef)(function({
          ...
          const {
            ...
            inAvatarMenu: p
          } = (0, i.useContext)(me), u = [r, c, l].includes(d);
          if (m) return null;
          let h, b, f, w, y;
        ...
        Ue = (0, i.forwardRef)(function({
          ...
          const {
            ...
            isNavHidden: o
          } = (0, i.useContext)($a), [r, c] = (0, i.useState)("");
          (0, i.useEffect)(() => {
            c("")
          }, [s, o]);
          const l = n ? n + 1 : 1;
      ...
      const pt = ({
          ...
          const t = (0, d.useIntl)(),
            ...
            l = s !== d.englishLocale.subdomaincom ? `/${s}` : "",
            g = n.currentSite?.site === c.C.www,
            v = `https://${n.sites[c.C.www]}.rockstargames.com`;
          let m = "";
          m = g ? "" : `${v}${l}`;
          const {
            viewAllLocation: p,
            ...
            children: [(0, _.jsxs)("div", {
              ...
              children: u.map(t => {
                return (0, _.jsx)(Ma, {
                  ...
                  title: t.text,
                  path: (!g || t.externalRoute ? t.useLocale ? `${v}${l}` : v : "") + t.path,
                  dataTestId: t.dataTestId,
                  onNavigate: a,
                  onClick: (n = t.gaText, s = `Games > ${t.gaText}`, o = (!g || t.externalRoute ? t.useLocale ? `${v}${l}` : v : "") + t.path, () => {
                    e?.(n, s, o)
                  })
                }, t.titleSlug);
                var n, s, o
        ...
        ht = ({
          ...
          const t = (0, d.useIntl)(),
            ...
            l = o !== d.englishLocale.subdomaincom ? `/${o}` : "",
            g = n.currentSite?.site === c.C.www,
            v = `https://${n.sites[c.C.www]}.rockstargames.com`;
          let m = "";
          m = g ? "" : `${v}${l}`;
          ...
          const m = (0, d.useIntl)(),
            ...
            u = ((a, e = "") => {
              const t = (0, c.A)(),
                ...
                o = a => {
                  const o = t.currentSite?.site !== c.C.www && a.location?.domain === c.C.www && "en" !== n,
            ...
            N = (0, i.useMemo)(() => ({
              loggedInLinks: ga(m, s, o, l).map(u),
              helpItem: u(ma(m))
            }), [m, s, o, l]);
          return (0, i.useEffect)(() => {
            const a = () => {
      ...
      const jt = (0, i.forwardRef)(function({
        ...
        const {
          inMobileMenu: o,
          closeMobileMenu: r
        } = (0, i.useContext)(te), c = (0, Ct.Ub)("(min-width: 1024px)"), l = (0, Mt.mergeProps)({
          "data-testid": e,
          onPress: a => {
            t?.(a), r()
          },
