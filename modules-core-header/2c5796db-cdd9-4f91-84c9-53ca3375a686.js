try {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new a.Error).stack;
  e && (a._sentryDebugIds = a._sentryDebugIds || {}, a._sentryDebugIds[e] = "2c5796db-cdd9-4f91-84c9-53ca3375a686", a._sentryDebugIdIdentifier = "sentry-dbid-2c5796db-cdd9-4f91-84c9-53ca3375a686")
} catch (a) {} {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [6629], {
      ...
      const r = {
        ...
        c = () => {
          ...
          const {
            ...
            site: e,
            subDomain: n
          }, !0)) >= 0), _ = i[n >= 0 ? n : 0], r = i.find(a => a.id === _.fallbackEnvironment);
          return a || (a = {
            site: "www",
            subDomain: "local"
          }), o()(s()({}, r, {
            currentSite: a
          }, _), "fallbackEnvironment")
        }
    },
    80917(a, e, t) {
      "use strict";
      t.r(e), t.d(e, {
        NavigationWrapper: () => _.A,
        navData: () => _.o
      });
      var n = t(37116),
        s = {};
      for (const a in n)["default", "NavigationWrapper", "navData"].indexOf(a) < 0 && (s[a] = () => n[a]);
      t.d(e, s);
      var _ = t(934)
    },
    934(a, e, t) {
      ...
      const ha = ({
        ...
        ba = ({
          ...
          return (0, _.jsx)("a", {
            ...
            className: t,
            onClick: e => {
              s?.(e), c || o || (n ? (e.preventDefault(), n(a)) : (e.preventDefault(), window.history.pushState({}, "", a)))
            },
            target: e,
            ...i,
            children: r
      ...
      const Ta = ({
          ...
          const t = (0, i.useIntl)(),
            ...
            v = `https://${n.sites[r.C.www]}.rockstargames.com`,
            m = g ? "" : `${v}${d}`,
            {
              viewAllLocation: p,
              games: u
            ...
            children: [(0, _.jsxs)("div", {
              ...
              children: u.map(t => {
                return (0, _.jsx)(fa, {
                  ...
                  onNavigate: a,
                  onClick: (n = t.gaText, s = `Games > ${t.gaText}`, o = (!g || t.externalRoute ? t.useLocale ? `${v}${d}` : v : "") + t.path, () => {
                    e?.(n, s, o)
                  })
                }, t.titleSlug);
                var n, s, o
        ...
        ja = (0, i.withIntl)(({
          ...
          return r ? (0, _.jsx)(Ga, {
            onNavigate: a,
            onClick: e
          }) : (0, _.jsxs)(Ma.MenuItem, {
            children: [(0, _.jsx)(Ma.MenuTrigger, {
              "data-testid": t,
              children: n.formatMessage(wa.games_menu_item)
            }), (0, _.jsx)(ka.AnimatePresence, {
              children: !s && (0, _.jsx)(Ma.MenuContent, {
                className: (0, ga.default)((0, xa.m)("dark"), "_1lj6mra5"),
        ...
        Ga = ({
          ...
          const t = (0, i.useIntl)(),
            ...
            h = (0, o.useMemo)(() => s && window?.matchMedia?.("(min-width: 0px) and (max-width: 767.98px)").matches ? 2.25 : 3.5, [s]);
          return (0, _.jsxs)("li", {
            className: "_1lj6mra6",
            "data-testid": "gamesMenu",
            children: [(0, _.jsxs)("div", {
              className: "_1lj6mra7",
              children: [(0, _.jsx)(ma.Label, {
                size: "MD",
                appearance: "bold",
                className: "_1lj6mra8",
        ...
        Ia = () => {
          ...
          return (t, n) => {
            ...
            const s = [
              ...
              _ = ((a, e) => e.filter(([, a]) => Boolean(a)).reduce((a, [e, t]) => a.replaceAll(`{${e}}`, t), a))(t.path, s),
      ...
      (Object.getOwnPropertyDescriptor(Ia, "name") || {}).writable || Object.defineProperty(Ia, "name", {
        value: "default",
        configurable: !0
      });
      const Aa = (0, i.defineMessages)({
        ...
        Sa = ({
          ...
          const m = (0, i.useIntl)(),
            ...
            u = ((a, e = "") => {
              const t = (0, r.A)(),
                n = a.subdomaincom,
                s = (a, t) => t?.requiresAuth && !e ? a : [...a, _(t)],
                _ = a => {
                  const _ = t.currentSite?.site !== r.C.www && a.location?.domain === r.C.www && "en" !== n,
            ...
            P = (0, o.useCallback)(() => {
              ...
              return G.targets.findIndex(s => {
                ...
                if ("nav-dropdown" === s.type) {
                  const _ = s.targets?.findIndex(s => {
                    if ("" === s.type) {
                      if (s.location.path && t.startsWith(s.location.path)) {
                        const t = A(n, s.location.params);
                        if (t) return e = t, a = s, !0
                      }
                      const _ = S(t, s.location.path);
                      if (_) return e = _, a = s, !0
                    }
                    return !1
                  });
                  return Boolean(_) && _ >= 0
                }
              }), [e, a]
            }, [G]),
            ...
            O = (0, o.useCallback)(a => {
              if ("" === a) return !1;
              const e = sa?.(a);
              return a.split(/\s+/).every(a => a.length < 3) ? (f(m.formatMessage(Aa.nav_search_error_too_short, {
                count: 3
              })), !1) : e ? (f(m.formatMessage(Aa.nav_search_error_invalid_chars, {
                invalidChars: [...new Set(e)].join(", ")
              })), !1) : (f(""), !0)
            }, []),
            z = (0, o.useCallback)((a, e) => {
              if (O(a) && e) {
                const t = L(G.targets, e);
                return t ? h(a, t.location) : null
              }
            }, [G]),
            V = (0, o.useMemo)(() => ({
              loggedInLinks: la(m, l, d, g).map(u),
              helpItem: u(da(m))
            }), [m, l, d, g]);
    ...
    86751(a, e, t) {
      ...
      }, s.resolve = _, a.exports = s, s.id = 86751
    },
    39294(a, e, t) {
      var n = {
        "./GTAOnline.jpg": 10111,
      ...
      s.keys = function() {
        return Object.keys(n)
      }, s.resolve = _, a.exports = s, s.id = 39294
    },
    51048(a, e, t) {
      var n = {
        "./VI/desktop/de_de.jpg": 20144,
      ...
      s.keys = function() {
        return Object.keys(n)
      }, s.resolve = _, a.exports = s, s.id = 51048
    },
    16044(a, e, t) {
      var n = {
        "./VI/mobile/de_de.jpg": 35996,
      ...
      s.keys = function() {
        return Object.keys(n)
      }, s.resolve = _, a.exports = s, s.id = 16044
    },
    10111(a) {
      "use strict";
