      ...
      const ge = {
        ...
        fn: function(e) {
          ...
          if (!t.modifiersData[p]._skip) {
            for (var d = n.mainAxis, l = void 0 === d || d, u = n.altAxis, h = void 0 === u || u, b = n.fallbackPlacements, g = n.padding, y = n.boundary, w = n.rootBoundary, x = n.altBoundary, O = n.flipVariations, E = void 0 === O || O, j = n.allowedAutoPlacements, D = t.options.placement, k = R(D), A = b || (k !== D && E ? function(e) {
                if (R(e) === s) return [];
                var t = ae(e);
                return [fe(e), t, fe(t)]
            ...
            if (A) {
              ...
              if (l) {
                var de, le = "x" === D ? r : a,
                  ...
                  Oe = ye ? he + M[me] + P[me] - we - L.altAxis : ge,
