try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "81495673-7c15-4482-a501-155367865c8e", e._sentryDebugIdIdentifier = "sentry-dbid-81495673-7c15-4482-a501-155367865c8e")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    64424: (e, t, s) => {
      ...
      const h = {
        ...
        x = ({
          ...
          const [S, E] = (0, l.useState)(!1), A = (0, r.useIntl)(), {
            track: N
          } = (0, i.useGtmTrack)(), {
            ref: C,
            inView: M
            ...
            buttonText: A.formatMessage(f.ns_ok_button_text),
            onClick: () => {
              p(!1)
            },
            testId: "ok-btn",
            ...
            buttonText: x?.showManagePreferences ? A.formatMessage(f.ns_manage_prefs_button_text) : "",
            isLink: !0,
            link: s.preferences,
          ...
          return (0, l.useEffect)(() => {
            ...
            children: [!y && (0, a.jsx)("div", {
              ...
              icon: x.icon,
              title: A.formatMessage(x.heading),
              secondaryText: A.formatMessage(x.bodyText),
        ...
        A = (e, t) => {
          const [s, a] = (0, l.useState)(), [o, c] = (0, l.useState)(!1), [d, u] = (0, l.useState)(!1), [b, g] = (0, l.useState)(!1), [m, _] = (0, l.useState)(!1), p = (0, n.useReactiveVar)(S), k = (0, r.useIntl)(), {
            ...
            element_placement: "newsletter subscribe",
            text: "subscribe now"
          }), t.loggedIn || window.location.assign(x.auth), t.loggedIn && t.isAMinor ? (A(y.ERROR_GENERIC), _(!1), void h({
            event: "alert_error",
            text: "error message with no preferences link",
            element_placement: "newsletter subscribe"
          })) : t.loggedIn && !p || t.loggedIn && 3 == p ? void await M() : t.loggedIn && p ? (h({
            event: "alert_update",
            text: "alert - user already subscribed",
            element_placement: "newsletter subscribe"
          }), A(y.ALREADY_SUBSCRIBED), void _(!1)) : void 0), M = async () => {
            const {
              error: e = null,
              result: s
    ...
    79867: (e, t, s) => {
      ...
      const o = {
        ...
        l = () => {
          ...
          const {
            location: t
          } = window, s = t.hostname.substring(0, t.hostname.indexOf(".rockstargames.com")), a = c.findIndex(t => Object.entries(t.sites).findIndex(([t, a]) => a === s && (e = {
            site: t,
            subDomain: a
          }, !0)) >= 0), i = c[a >= 0 ? a : 0], o = c.find(e => e.id === i.fallbackEnvironment);
          return e || (e = {
            site: "www",
            subDomain: "local"
          }), n()(r()({}, o, {
