try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e45d5d5b-8153-435d-a1fd-d81cbff7531b", e._sentryDebugIdIdentifier = "sentry-dbid-e45d5d5b-8153-435d-a1fd-d81cbff7531b")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [8331], {
    ...
    64010(e, t, n) {
      ...
      const c = function(e) {
        ...
        var t, n, c, d = function() {
          ...
          M = function(e) {
            var n, s, l, c, d, f = (d = function(e, t) {
                if (!t) return e;
              ...
              }((s = (n = e).deltaX * a[n.deltaMode], l = n.deltaY * a[n.deltaMode], c = (n.deltaZ || 0) * a[n.deltaMode], {
          ...
          init: function(o, r) {
            ...
            var b, y = g.observe(v),
              M = g.on("wheel", function(e) {
                ...
                Math.abs(s) > Math.abs(a) && !x && !e.isMomentum && !O && function(e) {
                  try {
    ...
    27859(e, t, n) {
      ...
      const a = "__FOUNDRY_ACCENT__",
        u = (e, t) => o.X ? t() : (window[a] || (window[a] = new Map), window[a].has(e) || window[a].set(e, t()), window[a].get(e));
      n(68309);
      var l, c = n(15963);
    ...
    13335(e, t, n) {
      ...
      function r(e = {}) {
          ...
          u = o.setTimeout(() => {
            e.scrollBody = function(e) {
              ...
              const x = {
                ...
                seek: function() {
                  let e = 0;
                  r.set(o), g = v * t.speed, b += g, o.add(g), s.set(o), e = b - y, w = Math.sign(e), y = b;
                  const h = a.byDistance(0, !1).index;
        ...
        function f() {
          ...
          e.scrollBody = a, t.clearTimeout(u), u = 0, l = !1
        }
          ...
          return r || (r = new Promise((i, s) => {
            ...
            const l = e => t => {
              ...
              f = () => {
                try {
                  const t = n();
                  u(t) ? (d.set(t, r), a = t, t.then(l(t), c(t)), o(e, t, f)) : i(t)
                } catch (e) {
                  s(e)
                }
              };
    ...
    48894(e, t, n) {
      ...
      const c = (e, t, ...n) => t.read(...n),
        ...
        h = e => {
          ...
          for (; m.length;) {
            ...
            if (f.has(r)) m.pop(), p.pop();
              ...
              if (o.get(r) === s.n) u.push(r), c.push(s);
              else if (o.has(r)) throw new Error("[Bug] invalidated atom exists");
              f.add(r), m.pop(), p.pop()
            } else {
              d.add(r);
              for (const t of l(r, s, n)) d.has(t) || (m.push(t), p.push(i(e, t)))
            }
          }
          for (let t = u.length - 1; t >= 0; --t) {
            ...
            for (const e of i.d.keys())
              if (e !== n && r.has(e)) {
                l = !0;
                break
              } l && (o.set(n, i.n), s(e, n), a(e, n)), o.delete(n)
          }
        },
        g = new WeakSet,
        w = (e, t) => {
          ...
          const A = new Set(D.d.keys()),
            ...
            L = n => {
              ...
              try {
                ...
                A.delete(n), D.d.set(n, l.n), a(D.v) && u(t, D.v, l), d.has(t) && (null == (r = d.get(n)) || r.t.add(t)), k || j()
              }
            };
          let C, z;
          const N = {
          ...
          try {
            g.delete(e);
            const o = v(e, t, L, N);
            if (g.has(e) && console.warn("Detected store mutation during atom read. This is not supported."), E(e, t, o), a(o)) {
            ...
            M = (n, ...r) => {
              ...
              try {
                if (n === t) {
                  ...
                  const t = u.n,
                    l = r[0];
                  return h(e, n, l), v(e, n), void(t !== u.n && (++w[0], i.add(n), m(e, n), null == (s = a.c) || s.call(a, n)))
                }
                return p(e, n, ...r)
              } finally {
                b || (d(e), c(e))
        ...
        M = (e, t) => {
          ...
          if (f && d.d.size > 0) {
            for (const [o, r] of d.d)
              if (!f.d.has(o)) {
                const c = a(e, o);
                l(e, o).t.add(t), f.d.add(o), r !== c.n && (i.add(o), u(e, o), null == (n = s.c) || n.call(s, o))
              } for (const n of f.d)
              if (!d.d.has(n)) {
                f.d.delete(n);
                const o = c(e, n);
        ...
        E = (e, t) => {
          ...
          d.u && s.add(d.u), d = void 0, i.delete(t);
        ...
        S = (e, t, n) => {
          ...
          s.v = n, delete s.e, l && Object.is(c, s.v) || (++s.n, a(c) && i(e, c))
        },
        O = (e, t) => s((0, _(e)[14])(e, t)),
        D = (e, t, ...n) => {
          const o = _(e),
            r = o[3],
            i = o[12],
