! function() {
  try {
    var r = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (r._sentryDebugIds = r._sentryDebugIds || {}, r._sentryDebugIds[e] = "03a564df-5414-4924-821d-5723defe3842", r._sentryDebugIdIdentifier = "sentry-dbid-03a564df-5414-4924-821d-5723defe3842")
  } catch (r) {}
}();
  ...
  [6872, 5240, 2860], {
    ...
    63892: (r, e, t) => {
      ...
      m && w || (m = function(r) {
        ...
        x.now(k(r))
      } : O && !g ? (i = (a = new O).port2, a.port1.onmessage = D, o = u(i.postMessage, i)) : c.addEventListener && f(c.postMessage) && !c.importScripts && n && "file:" !== n.protocol && !l(M) ? (o = M, c.addEventListener("message", D, !1)) : o = _ in d("script") ? function(r) {
