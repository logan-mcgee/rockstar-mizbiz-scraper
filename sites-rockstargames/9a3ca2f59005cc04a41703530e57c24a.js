! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "794a86ca-d6a7-4522-89c3-6e0cdf6f8800", e._sentryDebugIdIdentifier = "sentry-dbid-794a86ca-d6a7-4522-89c3-6e0cdf6f8800")
  } catch (e) {}
}();
    ...
    5226: (e, a, i) => {
      ...
      const N = e => {
          ...
          const {
            ...
            left: x,
            top: j
          } = l, [_, F] = (0, d.useState)(-1), {
            track: V
          } = (0, b.useGtmTrack)(), T = null !== u && (u?.length || 0) > 1 && ("flag_bg" === k || "fob" === w?.size), [D, I] = (0, p.useSearchParams)(), [A, $] = (0, d.useState)(!1), [E, L] = (0, d.useState)(!1), C = () => {
            const e = _ > -1 ? _ - 1 : 0;
            F(e), L(e <= 0), $(e >= (u?.length || 0) - 1), V({
          ...
          (0, d.useEffect)((() => {
            null !== _ && null !== u && u && _ < u.length && _ > -1 && I({
              info: u[_].toString()
            })
          }), [_, u]), (0, d.useEffect)((() => {
            if (null !== u && -1 === _ && u && u.length > 0) {
              const e = D.get("info");
              u?.forEach(((a, i) => {
                a === e && (F(i), L(i <= 0), $(i >= (u?.length || 0) - 1))
              }))
            }
          }), [u, _]);
          ...
          const U = () => {
            ...
            Q = e => {
              if (W?.current?.children && W.current.children[0]) {
                const a = W.current.children[0];
                switch (e.key) {
                  case "ArrowDown":
            ...
            children: (0, h.jsxs)(g.cp, {
              children: [(0, h.jsx)(v.motion.div, {
                ...
                children: (0, h.jsxs)(v.motion.div, {
                  ...
                  children: [!T && Y, (0, h.jsx)(v.motion.div, {
        ...
        S = "modal-context",
        y = [null, () => null],
        w = window?.[S] ?? (window[S] = (0, d.createContext)(y)),
        x = e => {
          let {
            children: a
          } = e;
          const [i, n] = (0, d.useState)(y), t = (0, d.useMemo)((() => i?.content ? (0, h.jsx)(N, {
            modal: i
          }) : null), [i]);
      ...
      const U = {
            ...
            children: [(0, h.jsx)("button", {
              ...
              children: (0, h.jsxs)("div", {
                ...
                children: [(0, h.jsx)("p", {
                  ...
                  className: [U.caret, r ? U.open : ""].join(" ")
                })]
              })
            }), (0, h.jsx)("ul", {
              className: [U.list, r ? U.open : ""].join(" "),
        ...
        ne = (0, V.withTranslations)((e => {
          ...
          return (0, h.jsxs)("div", {
            ...
            children: [(0, h.jsxs)("div", {
              className: [U.gridLarge, U.hero].join(" "),
              children: [(0, h.jsx)("div", {
                style: {
                  "--aspect-ratio": "1/1"
                },
                className: [U.img, U[i.title_slug]].join(" ")
              }), (0, h.jsxs)("div", {
                className: U.featuredDesc,
                children: [(0, h.jsxs)("div", {
                  className: U.text,
                  children: [(0, h.jsx)("h2", {
                    children: i.title
        ...
        te = (0, V.withTranslations)((e => {
          ...
          return (0, d.useEffect)((() => {
            ...
            children: [(0, h.jsxs)("div", {
              className: [U.sectionHeader, U.series].join(" "),
              children: [(0, h.jsx)("h4", {
                className: U.collectionTitle,
                children: `${a.title}`
              }), (0, h.jsx)("h2", {
                className: U.seriesTitle,
      ...
      var se = i(55380);
      const le = (0, V.withTranslations)((e => {
          let {
            t: a
          } = e;
          const {
            setBreadcrumb: i
          } = (0, C.useRockstarLocalState)(), n = (0, V.useQueryParams)(), [t, s] = (0, d.useState)(null), [l, r] = (0, d.useState)(null), {
            loading: c,
            refetch: o
          } = (0, F.useQuery)(se.Downloads, {
            variables: t,
            skip: !0,
            autoSetLoading: !0
          });
      ...
      var re = i(91336),
        ce = i.n(re);
      const oe = (0, V.withTranslations)((e => {
          let {
            t: a
          } = e;
          const i = (0, G.useParams)(),
            {
              setBreadcrumb: n,
              setNormalLogo: t
            } = (0, C.useRockstarLocalState)();
        ...
        me = "rockstargames-sites-rockstargamese6a4f8b4027dadd3be8f848d9b846bc3";
      var ue = i(98956),
        ke = i.n(ue);
      const ge = (0, V.withTranslations)((e => {
        ...
        const {
          setBreadcrumb: i,
          setNormalLogo: n
        } = (0, C.useRockstarLocalState)(), t = (0, V.useQueryParams)(), [s, l] = (0, d.useState)({}), {
          data: r
        } = (0, F.useQuery)(ke(), {
          variables: s,
      ...
      const we = e => {
        ...
        Ae = (0, V.withTranslations)((e => {
          ...
          const {
            setBreadcrumb: i,
            setTitle: n
          } = (0, C.useRockstarLocalState)(), t = (0, G.useParams)(), {
            data: s
          } = (0, F.useQuery)(ye(), {
            autoSetLoading: !0,
            variables: {
          ...
          return (0, d.useEffect)((() => {
            ...
            children: v[u].results.length ? (0, h.jsxs)("div", {
              ...
              children: [(0, h.jsx)("section", {
                ...
                children: (0, h.jsx)("h4", {
                  children: (0, h.jsx)(I.FormattedMessage, {
      ...
      var Me = i(79036),
        ze = i.n(Me);
      const He = (0, k.withSearchbarErrorBoundary)((e => {
          let {
          ...
          return (0, h.jsxs)("div", {
            ...
            children: [(0, h.jsxs)("section", {
              ...
              "data-json-type": s,
              children: "cookies" === s && f ? (0, h.jsx)(Oe(), {
                renderInWrapper: !1,
                components: {
                  CookieSettingsModal: a
                },
        ...
        Ue = (0, I.withIntl)((0, V.withLocale)((e => {
          let {
            locale: a
          } = e;
          const n = (0, I.useIntl)();
        ...
        ea = () => (0, h.jsx)(He, {
          ...
          CookieSettingsModal: (0, V.withTranslations)(Xe)
        }),
        aa = () => (0, h.jsx)(He, {
          jsonType: "ccpa",
          titleKey: "ccpa-title",
      ...
      const oa = () => {
        ...
        ba = {
          ...
          "screenshot-viewer": (0, d.lazy)((() => i.e(948).then(i.t.bind(i, 5330, 23)))),
        ...
        xa = {
          ...
          normalLogo: !0,
          loading: !1,
          headerHidden: ([].find((e => ya.includes(e))) ?? []).length > 0 || wa,
          customFooter: (["gta-online/license-plates"].find((e => ya.includes(e))) ?? []).length > 0,
          standalone: (["/screenshot-viewer", "/videoplayer", "/gifs"].find((e => ya.includes(e))) ?? []).length > 0,
          error: {
        ...
        ja = (0, F.makeVar)(xa),
        _a = (0, F.makeVarNamespace)("rockstar-root"),
        Fa = window?.env?.graphEnv ?? "prod";
      u();
      const Va = (() => {
          const e = window;
        ...
        Ta = () => {
          ...
          } = (0, V.useRockstarLocalState)(), [i] = (0, d.useContext)(w), [{
            iso: n
          }] = (0, I.getLocale)();
          return (0, h.jsx)(I.IntlProvider, {
            locales: A.intlMessages,
            lang: n,
            children: (0, h.jsx)(D.GtmProvider, {
              children: (0, h.jsxs)(k.ScrollTracker, {
                threshold: [25, 50, 75, 90, 100],
                children: [i, (0, h.jsx)(k.ScrollToTop, {}), (0, h.jsx)(Sa, {}), e || a ? "" : (0, h.jsx)(L.FooterNav, {})]
              })
            })
          })
        },
        ...
        $a = (0, F.withRockstarGraph)(Aa, {
          env: Fa,
          token: _a("token", null),
          tokenPing: _a("tokenPing", Ia),
          tokenPingExpires: _a("tokenPingExpires", null),
          typePolicies: {
            ..._()
          }
        }),
