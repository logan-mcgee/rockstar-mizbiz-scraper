! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "06f7c2c3-b14a-47aa-89cf-5abeadbc907d", e._sentryDebugIdIdentifier = "sentry-dbid-06f7c2c3-b14a-47aa-89cf-5abeadbc907d")
  } catch (e) {}
}();
    ...
    48525: (e, t, r) => {
      ...
      function b() {
        ...
        return e ? function() {
          let {
            router: e
          } = B(N.UseNavigateStable), t = L(w.UseNavigateStable), r = a.useRef(!1);
          return y((() => {
            r.current = !0
      ...
      function k(e, t, r, i) {
        ...
        if (t) {
          ...
          "/" === g || (null == (E = e.pathname) ? void 0 : E.startsWith(g)) || (0, n.Oi)(!1), y = e
        } else y = b;
        let _ = y.pathname || "/",
          R = _;
        if ("/" !== g) {
          let e = g.replace(/^\//, "").split("/");
          R = "/" + _.replace(/^\//, "").split("/").slice(e.length).join("/")
        }
        let C = !u && r && r.matches && r.matches.length > 0 ? r.matches : (0, n.ue)(e, {
            pathname: R
          }),
          x = U(C && C.map((e => Object.assign({}, e, {
      ...
      function A() {
        return L(w.UseRouteId)
      }

      function T() {
        return F(w.UseNavigation).navigation
      }

      function j() {
        let e = B(N.UseRevalidator),
          t = F(w.UseRevalidator);
        return a.useMemo((() => ({
      ...
      function G(e) {
        return F(w.UseRouteLoaderData).loaderData[e]
      }

      function z() {
        let e = F(w.UseActionData),
          t = L(w.UseLoaderData);
      ...
      function Y(e) {
        let {
          router: t,
          basename: r
        } = B(N.UseBlocker), i = F(w.UseBlocker), [l, u] = a.useState(""), s = a.useCallback((t => {
