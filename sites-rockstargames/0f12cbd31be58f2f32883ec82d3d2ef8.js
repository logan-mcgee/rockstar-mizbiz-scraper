! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "9cf0332d-d9b9-4348-8a91-dc514c7c8868", e._sentryDebugIdIdentifier = "sentry-dbid-9cf0332d-d9b9-4348-8a91-dc514c7c8868")
  } catch (e) {}
}();
    ...
    77100: (e, t, a) => {
      ...
      class Xt extends At {
        constructor(e, t, a, r) {
          ...
          !0 !== b || s || (Bt = this, n.killTweensOf(S), Bt = 0), Oe(N, this, a), t.reversed && this.reverse(), t.paused && this.paused(!0), (k || !_ && !v && this._start === de(N._time) && M(k) && Te(this) && "nested" !== N.data) && (this._tTime = -1e-8, this.render(Math.max(0, -p) || 0)), y && ze(this, y)
        }
        render(e, t, a) {
      ...
      let Fa, Va, $a, Ua, Ga, Ha, Wa, qa, Xa, Ya = {},
        ...
        Os = (e, t, a, s) => {
          let r, i, n, o, c = parseFloat(a) || 0,
            ...
            _ = "px" === s,
            p = "%" === s;
          return s === l || !c || Ls[s] || Ls[l] ? c : ("px" !== l && !_ && (c = Os(e, t, a, "px")), o = e.getCTM && Ms(e), !p && "%" !== l || !Ya[t] && !~t.indexOf("adius") ? (d[m ? "width" : "height"] = f + (_ ? l : s), i = ~t.indexOf("adius") || "em" === s && e.appendChild && !g ? e : e.parentNode, o && (i = (e.ownerSVGElement || {}).parentNode), i && i !== Va && i.appendChild || (i = Va.body), n = i._gsap, n && p && n.width && m && n.time === yt.time && !n.uncache ? le(c / n.width * f) : ((p || "%" === l) && !Ps[ys(i, "display")] && (d.position = ys(e, "position")), i === e && (d.position = "static"), i.appendChild(Ga), r = Ga[u], i.removeChild(Ga), d.position = "absolute", m && p && (n = ne(i), n.time = yt.time, n.width = i[u]), le(_ ? r * c / f : r && c ? f / r * c : 0))) : (r = o ? e.getBBox()[m ? "width" : "height"] : e[u], le(p ? c / r * f : c / 100 * r)))
        },
        zs = (e, t, a, s) => {
          let r;
          return Ua || Ss(), t in as && "transform" !== t && ~(t = as[t]).indexOf(",") && (t = t.split(",")[0]), Ya[t] && "transform" !== t ? (r = qs(e, s), r = "transformOrigin" !== t ? r[t] : r.svg ? r.origin : Xs(ys(e, ps)) + " " + r.zOrigin + "px") : (r = e.style[t], (!r || "auto" === r || s || ~(r + "").indexOf("calc(")) && (r = Fs[t] && Fs[t](e, t, a) || ys(e, t) || oe(e, t) || ("opacity" === t ? 1 : 0))), a && !~(r + "").trim().indexOf(" ") ? Os(e, t, r, a) + a : r
        },
        As = function(e, t, a, s) {
          if (!a || "none" === a) {
            let s = Ns(t, e, 1),
          ...
          if (k.b = a, k.e = s, a += "", "auto" == (s += "") && (e.style[t] = s, s = ys(e, t) || s, e.style[t] = a), r = [a, s], xt(r), s = r[1], n = (a = r[0]).match(A) || [], p = s.match(A) || [], p.length) {
            for (; i = A.exec(s);) d = i[0], g = s.substring(h, i.index), c ? c = (c + 1) % 5 : "rgba(" !== g.substr(-5) && "hsla(" !== g.substr(-5) || (c = 1), d !== (l = n[b++] || "") && (o = parseFloat(l) || 0, _ = l.substr((o + "").length), "=" === d.charAt(1) && (d = me(o, d) + _), m = parseFloat(d), u = d.substr((m + "").length), h = A.lastIndex - u.length, u || (u = u || f.units[t] || _, h === s.length && (s += u, k.e += u)), _ !== u && (o = Os(e, t, l, u) || 0), k._pt = {
              _next: k._pt,
              p: g || 1 === b ? g : ",",
              s: o,
              c: m - o,
        ...
        init(e, t, a, s, r) {
          ...
          for (m in Ua || Ss(), this.styles = this.styles || vs(e), x = this.styles.props, this.tween = a, t)
            if ("autoRound" !== m && (n = t[m], !ee[m] || !$t(m, t, a, s, e, r)))
              ...
              else if ("--" === m.substr(0, 2)) i = (getComputedStyle(e).getPropertyValue(m) + "").trim(), n += "", bt.lastIndex = 0, bt.test(i) || (g = We(i), u = We(n)), u ? g !== u && (i = Os(e, m, i, u) + u) : g && (n += g), this.add(w, "setProperty", i, n, s, r, 0, 0, m), y.push(m), x.push(m, 0, w[m]);
          else if ("undefined" !== l) {
            if (S && m in S ? (i = "function" == typeof S[m] ? S[m].call(a, s, e, r) : S[m], N(i) && ~i.indexOf("random(") && (i = it(i)), We(i + "") || (i += f.units[m] || We(zs(e, m)) || ""), "=" === (i + "").charAt(1) && (i = zs(e, m))) : i = zs(e, m), c = parseFloat(i), _ = "string" === l && "=" === n.charAt(1) && n.substr(0, 2), _ && (n = n.substr(2)), o = parseFloat(n), m in as && ("autoAlpha" === m && (1 === c && "hidden" === zs(e, "visibility") && o && (c = 0), x.push("visibility", 0, w.visibility), Es(this, w, "visibility", c ? "inherit" : "hidden", o ? "inherit" : "hidden", !o)), "scale" !== m && "transform" !== m && (m = as[m], ~m.indexOf(",") && (m = m.split(",")[0]))), p = m in Ya, p)
            ...
            if (p || (o || 0 === o) && (c || 0 === c) && !ts.test(n) && m in w) g = (i + "").substr((c + "").length), o || (o = 0), u = We(n) || (m in f.units ? f.units[m] : g), g !== u && (c = Os(e, m, i, u)), this._pt = new ca(this._pt, p ? h : w, m, c, (_ ? me(c, _ + o) : o) - c, p || "px" !== u && "zIndex" !== m || !1 === t.autoRound ? ss : ns), this._pt.u = u || 0, g !== u && "%" !== u && (this._pt.b = i, this._pt.r = is);
    ...
    77444: (e, t, a) => {
      ...
      const v = {
        ...
        N = e => {
          ...
          return (0, c.useEffect)((() => {
            const e = "audio",
              t = t => {
                t?.data?.rockstarAudioPlayerPlayTrackId && (o(t.data.rockstarAudioPlayerPlayTrackId), T(!1), _(!0)), u && t?.data?.attentionBlurredElsewhere && t?.data?.from !== e && _(!1)
              };
      ...
      const ot = function(e) {
        ...
        lt = ot((e => {
          ...
          const {
            track: _
          } = (0, $.useGtmTrack)(), p = (0, c.useRef)(null), k = (0, c.useRef)(null), h = (0, c.useRef)(null), [b, v] = (0, c.useState)(null), [x, y] = (0, c.useState)(!1), [w, N] = (0, c.useState)(null), [S, j] = (0, c.useState)(), [T, C] = (0, c.useState)(), {
            ref: I,
            inView: E
          } = (0, q.cD)({
            threshold: .6
          }), [L, P] = (0, c.useState)(!1), [O, A] = (0, c.useState)(null), [D, B] = (0, c.useState)(!1);
          let R = !1;
          R = !0;
          ...
          return (0, f.jsx)(_, {
            ...
            children: (0, f.jsxs)(f.Fragment, {
              children: [0 !== t || n.get("tag_id") ? (0, f.jsx)("div", {
                ...
                children: [(0, f.jsxs)("div", {
                  className: At.top,
                  children: [a.primary_tags.length ? (0, f.jsx)(zt, {
      ...
      const wa = e => {
        ...
        Ta = "rockstargames-sites-rockstargamesc4aa8e5d29b433c400796d0c493a9a4d",
        Ca = e => {
          let {
            minOffset: t = 0,
            maxOffset: a = 0,
      ...
      const za = (0, h.makeVarNamespace)("@rockstargames/components/profile-switcher"),
        ...
        Ha = e => Ga(e),
        Wa = () => {
          const e = (0, h.useReactiveVar)(Aa),
            t = (0, h.useReactiveVar)(Ba),
            a = (0, h.useReactiveVar)(Fa),
            s = (0, h.useReactiveVar)($a),
            r = (0, h.useReactiveVar)(Ga);
          return (0, c.useEffect)((() => {
      ...
      const Ka = {
        ...
        Za = e => {
          ...
          const {
            track: _
          } = (0, $.useGtmTrack)(), p = (0, bt.c)(), k = (0, l.useIntl)();
          let h = s;
          ...
          return (0, f.jsxs)(g.Link, {
            ...
            children: [t, c && (0, f.jsx)("div", {
              ...
              children: (0, f.jsx)("span", {
                ...
                children: k.formatMessage(Ea.nofications_new)
              })
            })]
          })
        },
        Ja = e => {
          ...
          const {
            ...
            navOpen: v
          } = (0, $.useRockstarUserState)(), x = (0, c.useRef)(null), [y, w] = (0, c.useState)(0), [N, S] = (0, c.useState)(0), [j, T] = (0, c.useState)(!0);
          return (0, c.useEffect)((() => {
            m !== t && !1 === j && T(!0), m === t && T(!1)
          }), [m]), (0, c.useEffect)((() => {
            if (!x.current) return;
        ...
        es = e => {
          ...
          const {
            ...
            return e
          }), [r, y, w, N]), [j, T] = (0, c.useState)(0), C = (0, c.createRef)(), M = () => {
            if (C.current) {
              const {
                current: e
          ...
          return (0, c.useEffect)((() => {
            ...
            children: [(0, f.jsx)("nav", {
              ...
              children: (0, f.jsx)(Ya.LanguageSelector, {
                theme: "sc-menu",
                languageSelectorOpened: i,
        ...
        ss = e => {
          ...
          const {
            ...
            track: i
          } = (0, $.useGtmTrack)(), n = (0, l.useIntl)(), [o, d] = (0, c.useState)([]), [m, g] = (0, c.useState)(null), [u, _] = (0, c.useState)(null), [p, k] = (0, c.useState)(!1), [h, b] = (0, c.useState)(-1), [v, x] = (0, c.useState)([]), [y, w] = (0, c.useState)(0), N = a(71084), [S, j] = (0, c.useState)("0"), [T, C] = (0, c.useState)("0"), M = e => parseInt(e, 10).toLocaleString("en-US", {
        ...
        os = (0, V.withTranslations)((e => {
          ...
          const {
            ...
            scNavOpened: N,
            setScNavOpened: S
          } = Wa(), [j, T] = (0, c.useState)(""), C = (0, g.useLocation)(), {
            lsSettings: M
              ...
              children: [(0, f.jsx)(ss, {
                ...
                children: [(0, f.jsx)("button", {
                  ...
                  children: (0, f.jsx)(is, {
                    ...
                    disablePager: K,
                    disableSwiper: K,
                    children: ie.filter(((e, t) => t !== z)).map((e => (0, c.createElement)(ts, {
                      characterData: e,
                      setMobileCardWidth: ce,
                      key: e.mugshotUrl,
                      tabIndex: a ? -1 : 0
        ...
        ls = (0, l.withIntl)((() => {
          const {
            ...
            track: y
          } = (0, $.useGtmTrack)(), [w, N] = (0, c.useState)(!1), S = (0, h.useReactiveVar)($.scConfig), j = (0, c.useRef)(), [T, C] = (0, c.useState)(0), M = (0, c.createRef)(), [I, E] = (0, c.useState)(!1), [L, P] = (0, c.useState)(0), [O, z] = (0, c.useState)(!1), {
            mutateLSSettings: A,
            lsSettings: D
          ...
          return (0, c.useEffect)((() => {
            ...
            n && (s && r(!1), d || B(!0))
          }), [n]), null === p ? null : (0, f.jsxs)(Oa.c, {
            enabled: !!b,
            removeScrollBar: !1,
            children: [(0, f.jsxs)("div", {
              className: [cs.scMenu, b ? cs.navOpen : ""].join(" "),
              "data-logged-in": p,
              "data-mac-browser": O,
              "data-scroll-mode": g,
              ref: M,
              ...
              className: [cs.scOverlay, b ? cs.navOpen : ""].join(" "),
              "data-logged-in": p
            })]
          })
        }), d),
        ...
        gs = (0, l.withIntl)((e => {
          ...
          return (0, c.useEffect)((() => {
            ...
            "data-img-set": h,
            "aria-label": a.formatMessage(n ? Ea.sc_menu_close : Ea.sc_menu_open),
            "aria-expanded": n,
            type: "button",
            onClick: y,
        ...
        fs = e => {
          ...
          return (0, c.useEffect)((() => {
            ...
            children: (0, f.jsx)("div", {
              className: us.promoModuleWrapper,
              children: (0, f.jsxs)(Fe.motion.div, {
