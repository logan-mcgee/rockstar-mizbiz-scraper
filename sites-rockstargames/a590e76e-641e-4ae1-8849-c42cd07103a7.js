! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "a590e76e-641e-4ae1-8849-c42cd07103a7", e._sentryDebugIdIdentifier = "sentry-dbid-a590e76e-641e-4ae1-8849-c42cd07103a7")
  } catch (e) {}
}();
  ...
  [1945], {
    91945: (e, i, n) => {
      ...
      var a = n(71403),
        ...
        m = n(70396),
        u = n(42756);
      const o = "rockstargames-sites-rockstargamese6a4f8b4027dadd3be8f848d9b846bc3";
      var r = n(1934),
        k = n(46632);
      const v = r.VideosList ?? VideosListDefault,
        c = (0, u.withTranslations)((e => {
          ...
          const {
            setBreadcrumb: n,
            setNormalLogo: r
          } = (0, m.useRockstarLocalState)(), c = (0, u.useQueryParams)(), [g, f] = (0, a.useState)({}), {
            data: N
          } = (0, l.useQuery)(v, {
            variables: g,
          ...
          if ((0, a.useEffect)((() => {
            ...
            }), [c.get("type"), c.get("gameId")]), (0, a.useEffect)((() => (r(!1), () => r(!0))), []), !N) return null;
          if (N?.game && N?.gameVideos) return (0, k.jsx)("div", {
            className: o,
            children: (0, k.jsx)(s.A, {
              vids: N.gameVideos.results,
              title: i("Videos from %s").replace("%s", N.game.title)
            })
          });
          const {
            games: b,
          ...
          return (0, k.jsx)("div", {
            className: o,
            children: g.type ? "" : (0, k.jsxs)(k.Fragment, {
              children: [(0, k.jsx)(t.A, {
                ...
                children: [(0, k.jsx)(s.A, {
                  vids: p.results,
                  title: i("Videos from %s").replace("%s", "Grand Theft Auto VI")
                }), (0, k.jsx)(s.A, {
                  vids: A.results,
                  title: i("Videos from %s").replace("%s", "Red Dead Online")
                }), (0, k.jsx)(s.A, {
                  vids: V.results,
                  title: i("Videos from %s").replace("%s", "GTA Online")
                }), (0, k.jsx)(s.A, {
                  vids: F.results,
                  title: i("GTA Online Sessions Episodes")
                }), (0, k.jsx)(s.A, {
                  games: b,
                  title: i("By Game")
                })]
    ...
    1934: e => {
      ...
      })), e.exports = i, e.exports.videoFields = l(i, "videoFields"), e.exports.VideosList = l(i, "VideosList")
    }
  }
]);