try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "988292ee-0a58-421e-9c9f-4c2b4d9a6198", e._sentryDebugIdIdentifier = "sentry-dbid-988292ee-0a58-421e-9c9f-4c2b4d9a6198")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    50662(e, t, s) {
      ...
      function n(e) {
        ...
        s({
          ...
          e = (0, r.m)(e), s = (0, r.m)(s), t.enabled ? o() : [...e, ...s].filter(e => !!e).forEach(e => e.classList.add(t.params.navigation.lockClass))
        }), i("click", (e, s) => {
          let {
            nextEl: i,
            prevEl: a
      ...
      function l(e) {
        ...
        function b(e) {
          ...
          const s = t.params.a11y,
            i = e.target;
          if (!t.pagination || !t.pagination.el || i !== t.pagination.el && !t.pagination.el.contains(e.target) || e.target.matches(a(t.params.pagination.bulletClass))) {
            ...
            t.pagination && i.matches(a(t.params.pagination.bulletClass)) && i.click()
          }
        }
        ...
        const y = (e, t, s) => {
            u(e), "BUTTON" !== e.tagName && (m(e, "button"), e.addEventListener("keydown", b)), v(e, s),
              function(e, t) {
                (e = (0, r.m)(e)).forEach(e => {
          ...
          C = e => {
            ...
            i || r || e.sourceCapabilities && e.sourceCapabilities.firesTouchEvents || (t.isHorizontal() ? t.el.scrollLeft = 0 : t.el.scrollTop = 0, requestAnimationFrame(() => {
              l || (t.params.loop ? t.slideToLoop(t.getSlideIndexWhenGrid(parseInt(s.getAttribute("data-swiper-slide-index"))), 0) : t.slideTo(t.getSlideIndexWhenGrid(t.slides.indexOf(s)), 0), l = !1)
            }))
          },
          P = () => {
            ...
            e.slideLabelMessage && t.slides.forEach((i, r) => {
              ...
              v(i, e.slideLabelMessage.replace(/\{\{index\}\}/, n + 1).replace(/\{\{slidesLength\}\}/, s))
            })
          };
        n("beforeInit", () => {
          ...
          t.params.a11y.enabled && (() => {
            ...
            t.el.append(d);
            const s = t.el;
            e.containerRoleDescriptionMessage && h(s, e.containerRoleDescriptionMessage), e.containerMessage && v(s, e.containerMessage), e.containerRole && m(s, e.containerRole);
            const n = t.wrapperEl,
            ...
            u = (0, r.m)(u), f = (0, r.m)(f), u && u.forEach(t => y(t, a, e.nextSlideMessage)), f && f.forEach(t => y(t, a, e.prevSlideMessage)), E() && (0, r.m)(t.pagination.el).forEach(e => {
          ...
          t.params.a11y.enabled && function() {
            ...
            s && (t.isBeginning ? (g(s), f(s)) : (w(s), u(s))), e && (t.isEnd ? (g(e), f(e)) : (w(e), u(e)))
          }()
        }), n("paginationUpdate", () => {
          t.params.a11y.enabled && function() {
            const e = t.params.a11y;
            S() && t.pagination.bullets.forEach(s => {
              t.params.pagination.clickable && (u(s), t.params.pagination.renderBullet || (m(s, "button"), v(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, (0, r.i)(s) + 1)))), s.matches(a(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
            })
          }()
        }), n("destroy", () => {
          t.params.a11y.enabled && function() {
    ...
    14653(e, t, s) {
      ...
      var w = {
        ...
        updateSlides: function() {
          ...
          for (let i = 0; i < u; i += 1) {
            let r;
            if (M = 0, p[i] && (r = p[i]), x && e.grid.updateSlide(i, r, p), !p[i] || "none" !== (0, n.q)(r, "display")) {
              if ("auto" === s.slidesPerView) {
                C && (p[i].style[e.getDirectionLabel("width")] = "");
                const a = getComputedStyle(r),
                  l = r.style.transform,
                  o = r.style.webkitTransform;
                if (l && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), s.roundLengths) M = e.isHorizontal() ? (0, n.h)(r, "width", !0) : (0, n.h)(r, "height", !0);
                else {
                  const e = t(a, "width"),
                    s = t(a, "padding-left"),
                    i = t(a, "padding-right"),
              ...
              } else M = (a - (s.slidesPerView - 1) * S) / s.slidesPerView, s.roundLengths && (M = Math.floor(M)), p[i] && (p[i].style[e.getDirectionLabel("width")] = `${M}px`);
              p[i] && (p[i].swiperSlideSize = M), h.push(M), s.centeredSlides ? (E = E + M / 2 + y / 2 + S, 0 === y && 0 !== i && (E = E - a / 2 - S), 0 === i && (E = E - a / 2 - S), Math.abs(E) < .001 && (E = 0), s.roundLengths && (E = Math.floor(E)), T % s.slidesPerGroup === 0 && f.push(E), m.push(E)) : (s.roundLengths && (E = Math.floor(E)), (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup === 0 && f.push(E), m.push(E), E = E + M + S), e.virtualSize += M + S, y = M, T += 1
            }
          }
          if (e.virtualSize = Math.max(e.virtualSize, a) + g, l && o && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize+S}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize+S}px`), x && e.grid.updateWrapperSize(M, f), !s.centeredSlides) {
            const t = [];
          ...
          if (Object.assign(e, {
            ...
            (0, n.a)(i, "--swiper-centered-offset-before", -f[0] + "px"), (0, n.a)(i, "--swiper-centered-offset-after", e.size / 2 - h[h.length - 1] / 2 + "px");
      ...
      var S = {
        ...
        E = {
          ...
          loopFix: function(e) {
            ...
            let S = v ? Math.max(b, Math.ceil(w / 2)) : b;
            S % b !== 0 && (S += b - S % b), S += h.loopAdditionalSlides, c.loopedSlides = S;
            const E = c.grid && h.grid && h.grid.rows > 1;
            p.length < w + S || "cards" === c.params.effect && p.length < w + 2 * S ? (0, n.v)("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : E && "row" === h.grid.fill && (0, n.v)("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const y = [],
              T = [],
              x = E ? Math.ceil(p.length / h.grid.rows) : p.length,
              M = l && x - g < w && !v;
            let C = M ? g : c.activeIndex;
            void 0 === a ? a = c.getSlideIndex(p.find(e => e.classList.contains(h.slideActiveClass))) : C = a;
            const P = "next" === i || !i,
              k = "prev" === i || !i;
            let L = 0,
              O = 0;
            const I = (E ? p[a].column : a) + (v && void 0 === r ? -w / 2 + .5 : 0);
            if (I < S) {
              L = Math.max(S - I, b);
            ...
            if (c.__preventObserver__ = !0, requestAnimationFrame(() => {
              ...
              }), "cards" === c.params.effect && p.length < w + 2 * S && (T.includes(a) && T.splice(T.indexOf(a), 1), y.includes(a) && y.splice(y.indexOf(a), 1)), k && y.forEach(e => {
              ...
              }), c.recalcSlides(), "auto" === h.slidesPerView ? c.updateSlides() : E && (y.length > 0 && k || T.length > 0 && P) && c.slides.forEach((e, t) => {
              ...
              if (y.length > 0 && k) {
                if (void 0 === t) {
                  ...
                  d ? c.setTranslate(c.translate - t) : (c.slideTo(C + Math.ceil(L), 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                } else if (r) {
              ...
              if (void 0 === t) {
                ...
                d ? c.setTranslate(c.translate - t) : (c.slideTo(C - O, 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
              } else {
      ...
      function T(e) {
        ...
        Object.assign(a, {
          ...
          isScrolling: void 0,
          startMoving: void 0
        }), o.startX = h, o.startY = v, a.touchStartTime = (0, n.f)(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, l.threshold > 0 && (a.allowThresholdMove = !1);
        let g = !0;
      ...
      function x(e) {
        ...
        let E = !0,
          y = a.resistanceRatio;
        if (a.touchReleaseOnEdges && (y = 0), v > 0 ? (b && S && i.allowThresholdMove && i.currentTranslate > (a.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] - ("auto" !== a.slidesPerView && s.slides.length - a.slidesPerView >= 2 ? s.slidesSizesGrid[s.activeIndex + 1] + s.params.spaceBetween : 0) - s.params.spaceBetween : s.minTranslate()) && s.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
          ...
          }), i.currentTranslate < s.maxTranslate() && (E = !1, a.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - v) ** y))), E && (p.preventedByNestedSwiper = !0), !s.allowSlideNext && "next" === s.swipeDirection && i.currentTranslate < i.startTranslate && (i.currentTranslate = i.startTranslate), !s.allowSlidePrev && "prev" === s.swipeDirection && i.currentTranslate > i.startTranslate && (i.currentTranslate = i.startTranslate), s.allowSlidePrev || s.allowSlideNext || (i.currentTranslate = i.startTranslate), a.threshold > 0) {
      ...
      const I = (e, t) => {
          ...
          n && "string" != typeof n && (s[d]("touchstart", e.onDocumentTouchStart, {
            ...
            passive: !0
          }), (i.preventClicks || i.preventClicksPropagation) && n[d]("click", e.onClick, !0), i.cssMode && a[d]("scroll", e.onScroll), i.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", C, !0) : e[c]("observerUpdate", C, !0), n[d]("load", e.onLoad, {
            capture: !0
          }))
        },
      ...
      const G = {
          ...
          events: {
            attachEvents: function() {
              ...
              e.onTouchStart = T.bind(e), e.onTouchMove = x.bind(e), e.onTouchEnd = M.bind(e), e.onDocumentTouchStart = O.bind(e), t.cssMode && (e.onScroll = k.bind(e)), e.onClick = P.bind(e), e.onLoad = L.bind(e), I(e, "on")
            },
          ...
          breakpoints: {
            setBreakpoint: function() {
              ...
              }), g && !E ? e.disable() : !g && E && e.enable(), e.currentBreakpoint = p, e.emit("_beforeBreakpoint", u), s && (b ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !S && y ? (e.loopCreate(t), e.updateSlides()) : S && !y && e.loopDestroy()), e.emit("breakpoint", u)
            },
      ...
      class N {
        constructor() {
          ...
          const f = (0, n.x)({}, A, u);
          return o.params = (0, n.x)({}, f, D, t), o.originalParams = (0, n.x)({}, o.params), o.passedParams = (0, n.x)({}, t), o.params && o.params.on && Object.keys(o.params.on).forEach(e => {
      ...
      const J = (0, i.createContext)(null),
        ...
        Q = (0, i.forwardRef)(function(e, t) {
          ...
          const [p, u] = (0, i.useState)("swiper"), [f, m] = (0, i.useState)(null), [h, v] = (0, i.useState)(!1), g = (0, i.useRef)(!1), w = (0, i.useRef)(null), b = (0, i.useRef)(null), S = (0, i.useRef)(null), E = (0, i.useRef)(null), y = (0, i.useRef)(null), T = (0, i.useRef)(null), x = (0, i.useRef)(null), M = (0, i.useRef)(null), {
            params: C,
            passedParams: P,
            rest: k,
            events: L
            ...
            return Object.keys(l).forEach(l => {
              void 0 !== e[l] && (a.indexOf(l) >= 0 ? V(e[l]) ? (s[l] = {}, r[l] = {}, R(s[l], e[l]), R(r[l], e[l])) : (s[l] = e[l], r[l] = e[l]) : 0 === l.search(/on[A-Z]/) && "function" == typeof e[l] ? t ? i[`${l[2].toLowerCase()}${l.substr(3)}`] = e[l] : s.on[`${l[2].toLowerCase()}${l.substr(3)}`] = e[l] : n[l] = e[l])
          ...
          const z = () => {
            ...
            if (delete e.wrapperClass, b.current = new N(e), b.current.virtual && b.current.params.virtual.enabled) {
          ...
          return w.current || z(), b.current && b.current.on("_beforeBreakpoint", _), (0, i.useEffect)(() => () => {
            ...
            if (t && (t.current = w.current), w.current) return b.current.destroyed && z(),
              function(e, t) {
                ...
                F(t) && i && r && (l.params.navigation.nextEl = i, l.originalParams.navigation.nextEl = i, l.params.navigation.prevEl = r, l.originalParams.navigation.prevEl = r), j(t) && n && (l.params.pagination.el = n, l.originalParams.pagination.el = n), $(t) && a && (l.params.scrollbar.el = a, l.originalParams.scrollbar.el = a), l.init(s)
              }({
                el: w.current,
                nextEl: y.current,
                prevEl: T.current,
            ...
            }(P, S.current, O, E.current, e => e.key);
            return S.current = P, E.current = O, e.length && b.current && !b.current.destroyed && function(e) {
              let {
                swiper: t,
                slides: s,
                passedParams: i,
          ...
          }(b.current, O, f) : O.map((e, t) => i.cloneElement(e, {
            swiper: b.current,
            swiperSlideIndex: t
          })), I["wrapper-end"]), F(C) && i.createElement(i.Fragment, null, i.createElement("div", {
            ref: T,
