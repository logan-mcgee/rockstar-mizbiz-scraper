try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "2f38e2a8-2845-4ef7-851d-5b76f35a3abf", e._sentryDebugIdIdentifier = "sentry-dbid-2f38e2a8-2845-4ef7-851d-5b76f35a3abf")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [597, 1177, 2533, 4809], {
    ...
    60597(e, t, o) {
      o.r(t), o.d(t, {
        ...
        useBodyScrollable: () => H,
        useDataLayer: () => Le,
        useGetTpaLinkGenerator: () => Te.gd,
        useHasReduceMotionPreference: () => Te.vx,
        useHasSaveDataPreference: () => Te.sb,
        useLazyQuery: () => y.useLazyQuery,
        useLocale: () => Te.Ym,
        useMutateState: () => k,
        useMutation: () => y.useMutation,
        useNewswirePost: () => Te.CA,
        usePreloadImg: () => Te.OG,
        usePrevious: () => Te.ZC,
        useQuery: () => U,
        useQueryParams: () => Te.sq,
        useReactiveVar: () => y.useReactiveVar,
        useRelativeTime: () => Te.Vq,
        useRockstarEventDispatcher: () => Te.OH,
        useRockstarEventSubscriber: () => Te.zP,
        useRockstarToken: () => E.e9,
        useRockstarTokenPing: () => E.Es,
        useRockstarTokenReactive: () => E.bD,
        useRockstarWebSettings: () => Ge,
        useScApi: () => Te.Cb,
        useScAuthLinks: () => Te.N6,
        useScroll: () => je.Ll,
        useScrollTracking: () => Te.GA,
        useScrollVisibility: () => Te.JE,
        useState: () => v,
      ...
      const D = document.documentElement.lang,
        ...
        Q = /Edge?\/(13\d|1[4-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|Firefox\/(1{2}[5-9]|1[2-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|Chrom(ium|e)\/(109|1[1-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|(Maci|X1{2}).+ Version\/(17\.([6-9]|\d{2,})|(1[89]|[2-9]\d|\d{3,})\.\d+)([,.]\d+|)( \(\w+\)|)( Mobile\/\w+|) Safari\/|Chrome.+OPR\/(1{2}[3-9]|1[2-9]\d|[2-9]\d{2}|\d{4,})\.\d+\.\d+|(CPU[ +]OS|iPhone[ +]OS|CPU[ +]iPhone|CPU IPhone OS|CPU iPad OS)[ +]+(15[._]([6-9]|\d{2,})|(1[6-9]|[2-9]\d|\d{3,})[._]\d+)([._]\d+|)|Android:?[ /-](13[1-9]|1[4-9]\d|[2-9]\d{2}|\d{4,})(\.\d+|)(\.\d+|)|Mobile Safari.+OPR\/([89]\d|\d{3,})\.\d+\.\d+|Android.+Firefox\/(13[2-9]|1[4-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|Android.+Chrom(ium|e)\/(13[1-9]|1[4-9]\d|[2-9]\d{2}|\d{4,})\.\d+(\.\d+|)|Android.+(UC? ?Browser|UCWEB|U3)[ /]?(15\.([5-9]|\d{2,})|(1[6-9]|[2-9]\d|\d{3,})\.\d+)\.\d+|SamsungBrowser\/(2[6-9]|[3-9]\d|\d{3,})\.\d+|Android.+MQ{2}Browser\/(14(\.(9|\d{2,})|)|(1[5-9]|[2-9]\d|\d{3,})(\.\d+|))(\.\d+|)|K[Aa][Ii]OS\/(2\.([5-9]|\d{2,})|([3-9]|\d{2,})\.\d+)(\.\d+|)/,
        W = ({
          id: e,
          init: t
        }) => {
      ...
      const ce = e => e.keys().forEach(e),
        ...
        ue = (e = !0) => de.filter(t => t.key === (e ? "prod" : "dev"))[0]?.path ?? null,
        pe = e => {
          e.preventDefault();
        ...
        fe = () => [ee.xbox360.name, ee.xboxone.name, ee.ps3.name, ee.ps4.name, ee.pc.name],
    ...
    translations(locale: $locale, config: $config) {
      ...
      const Ue = (0, y.makeVar)(Ne),
        ze = ({
          ...
          return o[e] = t, null === t && delete o[e], Be.A.set(Fe, JSON.stringify(o), {
            expires: 30,
            domain: re(),
            path: "/"
          }), Ue(o), o
        ...
        Ge = () => ({
          webSettings: (0, y.useReactiveVar)(Ue),
          webSettingsReactive: Ue,
          mutateWebSettings: ze
        });
      var Ve = o(25633)
