    ...
    60228: (t, e, r) => {
      ...
      t.exports = function(t, e) {
        var r = a(t),
          ...
          b = d.length;
        for (var h in t) !e && !u.call(t, h) || v && ("length" == h || f && ("offset" == h || "parent" == h) || l && ("buffer" == h || "byteLength" == h || "byteOffset" == h) || s(h, b)) || d.push(h);
        return d
      }
    },
    1412: t => {
    ...
    79336: (t, e, r) => {
      ...
      t.exports = function(t, e, r, i) {
        ...
        for (var u = -1, p = (e = n(e, t)).length, f = p - 1, l = t; null != l && ++u < p;) {
          ...
          if (u != f) {
            var b = l[v];
            void 0 === (d = i ? i(b, v, l) : void 0) && (d = c(b) ? b : a(e[u + 1]) ? [] : {})
          }
          o(l, v, d), l = l[v]
        }
        return t
