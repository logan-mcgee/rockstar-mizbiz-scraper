      ...
      const F = "undefined" != typeof window && void 0 !== window.document && void 0 !== window.document.createElement,
        ...
        D = o.forwardRef((function(e, t) {
          let {
            ...
            relative: v.relative
          }), p = (0, a.useLocation)(), b = o.useContext(a.UNSAFE_DataRouterStateContext), {
            navigator: g
          } = o.useContext(a.UNSAFE_NavigationContext), y = null != b && ne(h) && !0 === f, R = g.encodeLocation ? g.encodeLocation(h).pathname : h.pathname, S = p.pathname, E = b && b.navigation && b.navigation.location ? b.navigation.location.pathname : null;
        ...
        M = o.forwardRef(((e, t) => {
          ...
          } = e, p = s(e, b), w = "get" === l.toLowerCase() ? "get" : "post", g = W(c, {
            relative: m
          });
