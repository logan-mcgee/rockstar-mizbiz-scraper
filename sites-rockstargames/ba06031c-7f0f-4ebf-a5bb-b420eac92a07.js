  ...
  [784, 1177, 4809, 8403], {
    ...
    68403(e, o, t) {
      ...
      function i(e) {
        ...
        return "function" == typeof p ? p(Array.isArray(b) ? b : [b]) : d ? n.createElement(d, null, b) : n.createElement(n.Fragment, null, b)
      }
      ...
      const m = (e, o) => {
        ...
        k = () => {
          ...
          const s = `rockstarweb_lang.${o.cookieIdentifier}`,
            i = h(s);
          a = o.currentSite?.site === b.C.www ? v.find(e => e.subdomaincom === r) || v.find(e => e.subdomaincom === t) || n : v.find(e => e.iso === i) || n;
          const [, l] = w(s, a.iso);
          return [a, l]
        };
        ...
        j = e => {
          ...
          if (r)
            for (const [n, {
              ...
              let d = "";
              return "www" !== n || c?.some(e => e.test(r.pathname)) ? ("www" !== n && (d += `https://${u}`, d += s ? `.${f.at(-2)}.${f.at(-1)}` : `.${f.at(-1)}`), {
                link: `${d}${p}${"/"===r.pathname?"":r.pathname}${r.search}${r.hash}`,
                isExternal: !0
              }) : {
                link: `${d}${"/"===r.pathname?"":r.pathname}${r.search}${r.hash}`,
                isExternal: !1
              }
            }
    ...
    47279(e, o, t) {
      ...
      const a = {
        ...
        i = () => {
          ...
          const {
            location: o
          } = window, t = o.hostname.substring(0, o.hostname.indexOf(".rockstargames.com")), a = s.findIndex(o => Object.entries(o.sites).findIndex(([o, r]) => r === t && (e = {
            site: o,
            subDomain: r
    ...
    50573(e, o, t) {
      ...
      const y = function(e) {
        ...
        _ = function e(o, t, r, n, a) {
          ...
          for (r || (r = y), a || (a = []); ++s < i;) {
            var l = o[s];
            t > 0 && r(l) ? t > 1 ? e(l, t - 1, r, n, a) : (0, b.A)(a, l) : n || (a[a.length] = l)
          }
          return a
        },
        v = function(e) {
      ...
      const O = (A = function(e, o) {
        ...
        }), (0, p.A)(e, (0, $.A)(e), t), s && (t = (0, n.A)(t, 7, d));
