! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      e = (new t.Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "27d20a80-3ade-4a1b-a88b-6be082435ecf", t._sentryDebugIdIdentifier = "sentry-dbid-27d20a80-3ade-4a1b-a88b-6be082435ecf")
  } catch (t) {}
}();
      ...
      function s(t, s) {
        ...
        return function t(i, h, p) {
          p = p || 1, Object.keys(i).forEach((function(l) {
            const d = i[l],
              u = s.safe && Array.isArray(d),
              c = Object.prototype.toString.call(d),
              f = e(d),
              g = "[object Object]" === c || "[object Array]" === c,
              b = h ? h + o + r(l) : r(l);
            if (!u && !f && g && Object.keys(d).length && (!s.maxDepth || p < n)) return t(d, b, p + 1);
            a[b] = d
          }))
        }(t), a
      }
      t.exports = s, s.flatten = s, s.unflatten = function t(o, n) {
        ...
        return o = Object.keys(o).reduce((function(t, e) {
          ...
          for (; void 0 !== d;) {
            ...
            (a && !e || !a && null == u[s]) && (u[s] = "number" != typeof d || n.object ? {} : []), u = u[s], i.length > 0 && (s = l(i.shift()), d = l(i[0]))
          }
          u[s] = t(o[e], n)
        })), p
      }
      ...
      ! function(t) {
        ...
        c(e, t), Object.defineProperty(e.prototype, "parentNode", {
          ...
          var i, s = this.props.scale || 1,
            ...
            b = u || 0,
            w = c || 0;
          return v("right", h) && (f = p.width + (t - p.x) * n / s, d && (g = (f - w) / this.ratio + b)), v("left", h) && (f = p.width - (t - p.x) * n / s, d && (g = (f - w) / this.ratio + b)), v("bottom", h) && (g = p.height + (e - p.y) * r / s, d && (f = (g - b) * this.ratio + w)), v("top", h) && (g = p.height - (e - p.y) * r / s, d && (f = (g - b) * this.ratio + w)), {
            newWidth: f,
            newHeight: g
          }
          ...
          if (this.state.isResizing && this.resizable && this.window) {
            ...
            if (S = M.newWidth, z = M.newHeight, this.props.grid) {
              var W = w(S, this.props.grid[0], this.props.gridGap ? this.props.gridGap[0] : 0),
                j = w(z, this.props.grid[1], this.props.gridGap ? this.props.gridGap[1] : 0),
                k = this.props.snapGap || 0;
              S = 0 === k || Math.abs(W - S) <= k ? W : S, z = 0 === k || Math.abs(j - z) <= k ? j : z
            }
            var E = {
              width: S - u.width,
              height: z - u.height
            ...
            if (this.delta = E, c && "string" == typeof c)
              ...
              var O = S / this.window.innerHeight * 100;
              S = "".concat(O, "vh")
            }
            f && "string" == typeof f && (f.endsWith("%") ? (N = z / g.height * 100, z = "".concat(N, "%")) : f.endsWith("vw") ? (_ = z / this.window.innerWidth * 100, z = "".concat(_, "vw")) : f.endsWith("vh") && (O = z / this.window.innerHeight * 100, z = "".concat(O, "vh")));
            var B = {
            ...
            var H = this.state.width !== B.width,
              L = this.state.height !== B.height,
              A = this.state.flexBasis !== B.flexBasis,
              C = H || L || A;
            C && (0, r.flushSync)((function() {
              e.setState(B)
            })), this.props.onResize && C && this.props.onResize(t, d, this.resizable, E)
          }
