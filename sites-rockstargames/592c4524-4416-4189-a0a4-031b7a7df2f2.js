! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "592c4524-4416-4189-a0a4-031b7a7df2f2", e._sentryDebugIdIdentifier = "sentry-dbid-592c4524-4416-4189-a0a4-031b7a7df2f2")
  } catch (e) {}
}();
  ...
  [5102], {
    24079: (e, a, t) => {
      ...
      const d = e => {
        ...
        const {
          isMobile: c
        } = (0, s.useWindowResize)(), g = (0, i.useMemo)((() => {
          let e = "";
          return a && (e = c ? t(17426)(`./${o}/mobile.png`) : t(65392)(`./${o}/desktop.png`)), e || (e = t(32781)(`./${o}.jpg`), e += `?im=Resize=${d}`), e
        }), [c, o]), [l] = (0, s.usePreloadImg)(g);
        return (0, r.jsx)("div", {
          role: "img",
          "aria-label": m,
          className: [n.img, l ? n.startAnimation : "", a ? n.wide : ""].join(" "),
          style: {
    ...
    72558: (e, a, t) => {
      ...
      const g = e => {
        ...
        const {
          track: u
        } = (0, r.useGtmTrack)(), [f] = (0, s.useSearchParams)(), k = g.preview_images_parsed.newswire_block, b = {
          default: 0 !== t || l ? k.square || k.d16x9 || k._fallback : k.d16x9 || k.square || k._fallback,
        ...
        return (0, c.jsx)(d.A, {
          to: g.url,
          className: [o.newswireBlock, l ? o.newswireBlockNoSpecialOrder : "", null !== v ? o.startAnimation : ""].join(" "),
          focused: p,
          onClick: _,
          children: (0, c.jsxs)(c.Fragment, {
            children: [0 !== t || f.get("tag_id") ? (0, c.jsx)("div", {
              ...
              children: [(0, c.jsxs)("div", {
                className: o.top,
                children: [g.primary_tags.length ? (0, c.jsx)(m.A, {
      ...
      const b = "rockstargames-sites-rockstargamesa6b96f1aa331851eea3b9fad5cb04a8f",
        ...
        _ = (0, u.withTranslations)((e => {
          ...
          const {
            ...
            setSearch: s,
            setTitle: n
          } = (0, p.useRockstarLocalState)(), d = (0, u.useQueryParams)(), [m, c] = (0, i.useState)(null), [g, f] = (0, i.useState)({}), [k, _] = (0, i.useState)(d.get("tab") ?? "games"), {
            data: N = {},
            loading: x
          } = (0, l.useQuery)(j, {
            variables: g,
            skip: !Object.entries(g).length || !g.q,
            autoSetLoading: !0
          });
          ...
          }), [N, k]), Object.entries(g).length ? g.q ? null === m || x ? null : (0, r.jsxs)("div", {
            className: b,
