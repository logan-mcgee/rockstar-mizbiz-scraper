  ...
  [5102], {
    ...
    72558: (e, a, t) => {
      ...
      const g = e => {
        ...
        const {
          track: u
        } = (0, r.useGtmTrack)(), [k] = (0, s.useSearchParams)(), f = g.preview_images_parsed.newswire_block, b = {
          default: 0 !== t || l ? f.square || f.d16x9 || f._fallback : f.d16x9 || f.square || f._fallback,
      ...
      const b = "rockstargames-sites-rockstargamesa6b96f1aa331851eea3b9fad5cb04a8f",
        ...
        _ = (0, u.withTranslations)((e => {
          ...
          const {
            ...
            setSearch: s,
            setTitle: n
          } = (0, p.useRockstarLocalState)(), d = (0, u.useQueryParams)(), [m, c] = (0, i.useState)(null), [g, k] = (0, i.useState)({}), [f, _] = (0, i.useState)(d.get("tab") ?? "games"), {
            data: N = {},
            loading: x
          } = (0, l.useQuery)(j, {
            variables: g,
          ...
          }), [N, f]), Object.entries(g).length ? g.q ? null === m || x ? null : (0, r.jsxs)("div", {
            className: b,
