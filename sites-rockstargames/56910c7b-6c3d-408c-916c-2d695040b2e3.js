try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "56910c7b-6c3d-408c-916c-2d695040b2e3", e._sentryDebugIdIdentifier = "sentry-dbid-56910c7b-6c3d-408c-916c-2d695040b2e3")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [6918], {
    94141(e, t, n) {
      ...
      function _() {
        var e = window,
          t = navigator;
        return y(["msWriteProfilerMark" in e, "MSStream" in e, "msLaunchUri" in t, "msSaveBlob" in t]) >= 3 && !L()
      }
      ...
      function H(e) {
        for (var t = function(e) {
          ...
          var c = o[i],
            s = r[c].join(" ");
          "style" === c ? O(a.style, s) : a.setAttribute(c, s)
        }
        return a
      }
      ...
      function Z() {
        ...
        return function() {
            if (void 0 === G) {
              var e = function() {
                var t = Y();
                j(t) ? G = setTimeout(e, 2500) : (W = t, G = void 0)
              };
              e()
            }
          }(),
          function() {
            return (0, r.sH)(e, void 0, void 0, function() {
              ...
              return (0, r.YH)(this, function(t) {
                switch (t.label) {
                  case 0:
                    return j(e = Y()) ? W ? [2, (0, r.fX)([], W, !0)] : k() ? [4, (n = document, (n.exitFullscreen || n.msExitFullscreen || n.mozCancelFullScreen || n.webkitExitFullscreen).call(n))] : [3, 2] : [3, 2];
                  case 1:
      ...
      function B(e) {
        ...
        return (0, r.sH)(this, void 0, void 0, function() {
          ...
          return (0, r.YH)(this, function(r) {
            switch (r.label) {
              case 0:
                for (n = document, a = n.createElement("div"), o = new Array(e.length), c = {}, U(a), u = 0; u < e.length; ++u) "DIALOG" === (s = H(e[u])).tagName && s.show(), U(l = n.createElement("div")), l.appendChild(s), a.appendChild(l), o[u] = s;
                r.label = 1;
              case 1:
        ...
        ne = {
          fonts: function() {
            return V(function(e, t) {
              ...
              r.appendChild(a);
              for (var u = 0; u < D.length; u++) i[D[u]] = s[u].offsetWidth, o[D[u]] = s[u].offsetHeight;
              ...
              return (0, r.YH)(this, function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    }, n = Object.keys(e), [4, B((o = []).concat.apply(o, n.map(function(t) {
                      return e[t]
                    })))]) : [2, void 0];
                  case 1:
          ...
          fontPreferences: function() {
            return void 0 === e && (e = 4e3), V(function(t, n) {
              ...
              return c.textContent = (0, r.fX)([], Array(e / 20 | 0), !0).map(function() {
                ...
                function(e, t) {
                  for (var n = {}, r = {}, a = 0, i = Object.keys(te); a < i.length; a++) {
                    var o = i[a],
                      c = te[o],
                      s = c[0],
                      l = void 0 === s ? {} : s,
                  ...
                  for (var v = 0, b = Object.keys(te); v < b.length; v++) r[o = b[v]] = n[o].getBoundingClientRect().width;
                  return r
                }(a, i)
          ...
          canvas: function() {
            ...
            if (function(e, t) {
              ...
              var o = N(a);
              o !== N(a) ? e = t = "unstable" : (t = o, function(e, t) {
    ...
    77033(e, t, n) {
      ...
      function y() {
        let e = ["monospace", "sans-serif", "serif"],
          ...
          l = function(t) {
            ...
            for (let r = 0; r < e.length; r++)
              if (n = t[r].offsetWidth !== i[e[r]] || t[r].offsetHeight !== o[e[r]], n) return n;
            return n
          },
          u = function() {
            let t = [];
        ...
        n.appendChild(r);
        for (let t = 0, n = e.length; t < n; t++) i[e[t]] = u[t].offsetWidth, o[e[t]] = u[t].offsetHeight;
        let d = function() {
          let n = {};
        ...
        n.appendChild(a);
        let m = [];
        for (let e = 0, n = t.length; e < n; e++) l(d[t[e]]) && m.push(t[e]);
        return n.removeChild(a), n.removeChild(r), m
      }
