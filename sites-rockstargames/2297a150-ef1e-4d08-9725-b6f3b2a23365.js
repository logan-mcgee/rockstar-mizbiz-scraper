! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "2297a150-ef1e-4d08-9725-b6f3b2a23365", e._sentryDebugIdIdentifier = "sentry-dbid-2297a150-ef1e-4d08-9725-b6f3b2a23365")
  } catch (e) {}
}();
        ...
        const p = (0, l.useIntl)(),
          ...
          w = (e, a) => {
            const s = a ?? e.target.hash,
              ...
              o = h.get("country");
            if (e) {
              const a = `${b.pathname}${h.get("country")?`?country=${o}`:""}${s}`;
              y(a), e.preventDefault()
            }
            r && window.scroll(0, r.offsetTop - N.current.getBoundingClientRect().height - 60)
          },
          [S, j] = (0, n.useState)({}),
          {
            data: M,
          ...
          children: [(0, c.jsxs)("section", {
            ...
            children: [(0, c.jsx)("h1", {
              ...
              children: ["us", "br", "cz", "de", "es", "fr", "it", "jp", "kr", "mx", "nl", "pl", "ru", "sa", "tw", "zh"].map(((e, a) => {
                const s = p.formatMessage(g.rockstargames_company_info_display_for_country, {
