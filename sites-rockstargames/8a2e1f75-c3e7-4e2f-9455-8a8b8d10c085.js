! function() {
  try {
    var n = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (n._sentryDebugIds = n._sentryDebugIds || {}, n._sentryDebugIds[a] = "8a2e1f75-c3e7-4e2f-9455-8a8b8d10c085", n._sentryDebugIdIdentifier = "sentry-dbid-8a2e1f75-c3e7-4e2f-9455-8a8b8d10c085")
  } catch (n) {}
}();
  ...
  [3037], {
    83037: (n, a, e) => {
      ...
      var i = e(62229),
        ...
        x = e(49076),
        w = {};
      w.styleTagTransform = b(), w.setAttributes = A(), w.insert = p().bind(null, "head"), w.domAPI = c(), w.insertStyleElement = v(), l()(x.A, w);
      const y = x.A && x.A.locals ? x.A.locals : void 0;
      var C = e(99025),
        k = e(10633),
        B = e(52542),
        z = e(73855);
      const I = n => {
          ...
          return i ? (0, z.jsx)(z.Fragment, {
            children: (0, z.jsx)("div", {
              className: y.gamesIndex,
              "data-testid": "gamesBody",
              children: i.results.map((n => (0, z.jsx)(t.N, {
                game: n
              }, n.titleSlug)))
            })
          }) : null
        },
        S = (0, o.withIntl)((0, r.withTranslations)((n => {
          let {
            t: a
          } = n;
          const {
    ...
    49076: (n, a, e) => {
      ...
      var i = e(42587),
        ...
        r = e(15081),
        o = e.n(r)()(t());
      o.push([n.id, '.rockstargames-sites-rockstargamesb72670c307a7a170759a2026de564460{align-items:center;background:var(--white-15);border:none;border-radius:100px;color:var(--white-100);cursor:pointer;display:flex;font-family:var(--font-family-body);font-size:20px;font-style:normal;font-weight:700;justify-content:center;line-height:var(--rem-125);min-width:var(--rem-6);padding:var(--padding-xs) var(--padding-sm);text-align:center;transition:background-color .3s ease-in-out}.rockstargames-sites-rockstargamesb72670c307a7a170759a2026de564460 img{height:var(--nav-icon-size);margin-left:var(--grid-gap-xs);transition:filter .3s ease-in-out;width:var(--nav-icon-size)}.rockstargames-sites-rockstargamesb72670c307a7a170759a2026de564460:focus,.rockstargames-sites-rockstargamesb72670c307a7a170759a2026de564460:hover{background-color:var(--white-40);outline:none}.rockstargames-sites-rockstargamesb72670c307a7a170759a2026de564460.rockstargames-sites-rockstargameseae424257a2be1794796cda90f79a4f0{background:var(--white-100);color:var(--black-200)}.rockstargames-sites-rockstargamesb72670c307a7a170759a2026de564460.rockstargames-sites-rockstargameseae424257a2be1794796cda90f79a4f0 img{filter:invert()}.rockstargames-sites-rockstargamese1dc1951d9c2605f8dd4879f07e6f00b{grid-row-gap:var(--standard-grid-gap);grid-column-gap:var(--standard-grid-gap);display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));margin:0 auto;max-width:var(--max-width);padding:var(--padding-top-bottom) var(--padding-sides);width:100%}.rockstargames-sites-rockstargamesec15b7ff2e177338644214fcf0d15918+.rockstargames-sites-rockstargamese1dc1951d9c2605f8dd4879f07e6f00b{padding-top:2rem}@media (max-width:1023px){.rockstargames-sites-rockstargamese1dc1951d9c2605f8dd4879f07e6f00b{grid-template-columns:repeat(2,1fr)}}.rockstargames-sites-rockstargamesec15b7ff2e177338644214fcf0d15918{--font-family-body:"Chalet";--font-family-h:"ChaletComprime";--font-weight-regular:400;--font-weight-bold:700;--letter-spacing-body:0;--letter-spacing-h:0;--line-height-sm:1;--line-height-md:1.1;--line-height-lg:1.6;--black-200:#000;--black-100:#121212;--black-65:hsla(0,0%,7%,.65);--black-40:hsla(0,0%,7%,.4);--black-15:hsla(0,0%,7%,.15);--text-dark:#2d2d2d;--border-color:#2d2d2d;--white-100:#fff;--white-65:hsla(0,0%,100%,.65);--white-40:hsla(0,0%,100%,.4);--white-15:hsla(0,0%,100%,.15);--text-light:#e8e8e8;--focusring-blue:blue;--red:#e03232;--circoloco-red:#eb1818;--rockstar-gold:#fcaf17;--playstation-blue:#00439c;--microsoft-green:#387a26;--pc-legacy:#b2b2b2;--pc-enhanced:#beb279;--color-h:var(--white-100);--color-body:var(--text-light);--green-light:#c1f7bd;--green-dark:#81da85;--scroll-thumb-color:#7d7d7d;--scroll-track-color:transparent;--max-width-sm:640px;--max-width-md:1088px;--max-width-lg:1920px;--max-width-xl:2560px;--spacing-xxs:0.25rem;--spacing-xs:0.5rem;--spacing-sm:1rem;--spacing-md:2rem;--spacing-lg:4rem;--spacing-xl:8rem;--grid-gap-xxs:var(--spacing-xxs);--grid-gap-xs:var(--spacing-xs);--grid-gap-sm:var(--spacing-sm);--grid-gap-md:var(--spacing-md);--grid-gap-lg:var(--spacing-lg);--grid-gap-xl:var(--spacing-xl);--padding-xxs:var(--spacing-xxs);--padding-xs:var(--spacing-xs);--padding-sm:var(--spacing-sm);--padding-md:var(--spacing-md);--padding-lg:var(--spacing-lg);--padding-xl:var(--spacing-xl);--margin-xxs:var(--spacing-xxs);--margin-xs:var(--spacing-xs);--margin-sm:var(--spacing-sm);--margin-md:var(--spacing-md);--margin-lg:var(--spacing-lg);--margin-xl:var(--spacing-xl);--border-radius-xs:2px;--border-radius-sm:4px;--border-radius-md:8px;--border-radius-lg:16px;--gradient-overlay-bottom:linear-gradient(180.08deg,transparent 25%,rgba(0,0,0,.5) 65%,rgba(0,0,0,.6));--gradient-overlay-right:linear-gradient(270deg,rgba(0,0,0,.9),transparent);--promo-banner-z-index:11500;grid-gap:var(--spacing-sm);display:flex;justify-content:center;margin:0 auto;max-width:var(--max-width);padding:var(--padding-top-bottom) var(--padding-sides);padding-bottom:0;padding-top:var(--spacing-md);width:100%}@media (min-width:2560px){.rockstargames-sites-rockstargamesec15b7ff2e177338644214fcf0d15918{--max-width-md:1440px}}@media (max-width:767px){.rockstargames-sites-rockstargamesec15b7ff2e177338644214fcf0d15918{--spacing-lg:2rem;--spacing-xl:4rem}}@media (max-width:541px){.rockstargames-sites-rockstargamesec15b7ff2e177338644214fcf0d15918{justify-content:flex-start;overflow-x:auto;position:relative}.rockstargames-sites-rockstargamesec15b7ff2e177338644214fcf0d15918:after{background:var(--gradient-overlay-right);content:"";height:100%;pointer-events:none;position:fixed;right:0;top:0;width:2.625rem}}.rockstargames-sites-rockstargamesba02c012300c364048e52d344d3d8a23{align-items:center;background:var(--white-15);border:none;border-radius:100px;color:var(--white-100);cursor:pointer;display:flex;font-family:var(--font-family-body);font-size:20px;font-style:normal;font-weight:700;justify-content:center;line-height:var(--rem-125);min-width:var(--rem-6);padding:var(--padding-xs) var(--padding-sm);text-align:center;transition:background-color .3s ease-in-out;white-space:nowrap}.rockstargames-sites-rockstargamesba02c012300c364048e52d344d3d8a23 img{height:var(--nav-icon-size);margin-left:var(--grid-gap-xs);transition:filter .3s ease-in-out;width:var(--nav-icon-size)}.rockstargames-sites-rockstargamesba02c012300c364048e52d344d3d8a23:focus,.rockstargames-sites-rockstargamesba02c012300c364048e52d344d3d8a23:hover{background-color:var(--white-40);outline:none}.rockstargames-sites-rockstargamesba02c012300c364048e52d344d3d8a23.rockstargames-sites-rockstargameseae424257a2be1794796cda90f79a4f0{background:var(--white-100);color:var(--black-200)}.rockstargames-sites-rockstargamesba02c012300c364048e52d344d3d8a23.rockstargames-sites-rockstargameseae424257a2be1794796cda90f79a4f0 img{filter:invert()}', "", {
        version: 3,
        sources: ["webpack://./../../buildtime/legacy-design-system/less/gen9-mixins.less", "webpack://./src/pages/games/Index/index.less", "webpack://./../../buildtime/legacy-design-system/less/mixins.less", "webpack://./../../buildtime/legacy-design-system/less/gen9-vars.less"],
        names: [],
        mappings: "AA2QA,mEAKI,kBAAA,CAGA,0BAAA,CAFA,WAAA,CACA,mBAAA,CAIA,sBAAA,CAQA,cAAA,CAlBA,YAAA,CAYA,mCAAA,CACA,cAAA,CACA,iBAAA,CACA,eAAA,CAZA,sBAAA,CAaA,0BAAA,CAfA,sBAAA,CACA,2CAAA,CASA,iBAAA,CAQA,2CC9OJ,CD0NA,uEAwBQ,2BAAA,CADA,8BAAA,CAGA,iCAAA,CADA,0BC7OR,CDiPI,kJAEI,gCAAA,CACA,YC/OR,CDkPI,qIAEI,2BAAA,CADA,sBC/OR,CD8OI,yIAKQ,eChPZ,CAhEA,mEC+TI,qCAAA,CACA,wCAAA,CAFA,YAAA,CAGA,wDAAA,CAsEA,aAAA,CAFA,0BAAA,CAyUA,sDAAA,CAxUA,UDzTJ,CAzEI,sIACI,gBA2ER,CCtBI,0BAAA,mEDjDI,mCA2EN,CACF,CAxEA,mEEfA,2BAAA,CACA,gCAAA,CAGA,yBAAA,CACA,sBAAA,CAGA,uBAAA,CACA,oBAAA,CAGA,kBAAA,CACA,oBAAA,CACA,oBAAA,CAGA,gBAAA,CACA,mBAAA,CACA,4BAAA,CACA,2BAAA,CACA,4BAAA,CACA,mBAAA,CACA,sBAAA,CAEA,gBAAA,CACA,8BAAA,CACA,6BAAA,CACA,8BAAA,CACA,oBAAA,CAEA,qBAAA,CACA,aAAA,CACA,uBAAA,CACA,uBAAA,CACA,0BAAA,CACA,yBAAA,CACA,mBAAA,CAEA,qBAAA,CAGA,0BAAA,CACA,8BAAA,CAEA,qBAAA,CACA,oBAAA,CAGA,4BAAA,CACA,gCAAA,CAGA,oBAAA,CACA,qBAAA,CACA,qBAAA,CACA,qBAAA,CAIA,qBAAA,CACA,mBAAA,CACA,iBAAA,CACA,iBAAA,CACA,iBAAA,CACA,iBAAA,CAIA,iCAAA,CACA,+BAAA,CACA,+BAAA,CACA,+BAAA,CACA,+BAAA,CACA,+BAAA,CAGA,gCAAA,CACA,8BAAA,CACA,8BAAA,CACA,8BAAA,CACA,8BAAA,CACA,8BAAA,CAGA,+BAAA,CACA,6BAAA,CACA,6BAAA,CACA,6BAAA,CACA,6BAAA,CACA,6BAAA,CAGA,sBAAA,CACA,sBAAA,CACA,sBAAA,CACA,uBAAA,CAGA,sGAAA,CAMA,2EAAA,CAOA,4BAAA,CF5FI,0BAAA,CAFA,YAAA,CACA,sBAAA,CCsXA,aAAA,CAFA,0BAAA,CAyUA,sDAAA,CD3rBA,gBAAA,CACA,6BAAA,CCkXA,UD3NJ,CChEI,0BAAA,mECpDE,qBFwHJ,CACF,CCxII,yBAAA,mECwBI,iBAAA,CAAoB,iBFqH1B,CACF,CAhKI,yBAAA,mEACI,0BAAA,CACA,eAAA,CACA,iBAmKN,CAhKM,yEAEI,wCAAA,CADA,UAAA,CAMA,WAAA,CAJA,mBAAA,CACA,cAAA,CACA,OAAA,CACA,KAAA,CAEA,cAkKV,CACF,CA9JA,mEDoOI,kBAAA,CAGA,0BAAA,CAFA,WAAA,CACA,mBAAA,CAIA,sBAAA,CAQA,cAAA,CAlBA,YAAA,CAYA,mCAAA,CACA,cAAA,CACA,iBAAA,CACA,eAAA,CAZA,sBAAA,CAaA,0BAAA,CAfA,sBAAA,CACA,2CAAA,CASA,iBAAA,CAQA,2CAAA,CCjPA,kBAgLJ,CAlLA,uEDuPQ,2BAAA,CADA,8BAAA,CAGA,iCAAA,CADA,0BChER,CDoEI,kJAEI,gCAAA,CACA,YClER,CDqEI,qIAEI,2BAAA,CADA,sBClER,CDiEI,yIAKQ,eCnEZ",
        ...
        pillBtn: "rockstargames-sites-rockstargamesb72670c307a7a170759a2026de564460",
        selected: "rockstargames-sites-rockstargameseae424257a2be1794796cda90f79a4f0",
        gamesIndex: "rockstargames-sites-rockstargamese1dc1951d9c2605f8dd4879f07e6f00b",
        gamesFilters: "rockstargames-sites-rockstargamesec15b7ff2e177338644214fcf0d15918",
        filterBtn: "rockstargames-sites-rockstargamesba02c012300c364048e52d344d3d8a23"
      };
      const d = o
    },
    99025: n => {
      ...
      a.definitions.forEach((function(n) {
        if (n.name) {
          var a = new Set;
          e(n, a), i[n.name.value] = a
        }
      })), n.exports = a, n.exports.GamesIndex = function(n, a) {
        var e = {
          kind: n.kind,
          definitions: [t(n, a)]
        };
