! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "e102533e-5642-4ccf-8a77-2807d6a1e1f7", e._sentryDebugIdIdentifier = "sentry-dbid-e102533e-5642-4ccf-8a77-2807d6a1e1f7")
  } catch (e) {}
}();
  ...
  [7992], {
    57087: (e, a, t) => {
      ...
      const d = e => {
        ...
        const {
          isMobile: o
        } = (0, n.useWindowResize)(), l = (0, i.useMemo)((() => {
          let e = "";
          return a && (e = o ? t(75877)(`./${c}/mobile.png`) : t(55889)(`./${c}/desktop.png`)), e || (e = t(39294)(`./${c}.jpg`), e += `?im=Resize=${d}`), e
        }), [o, c]), [g] = (0, n.usePreloadImg)(l);
        return (0, r.jsx)("div", {
          role: "img",
          "aria-label": m,
    ...
    59048: (e, a, t) => {
      ...
      const d = e => {
        ...
        return (0, r.jsx)(n.A, {
          ...
          to: t ?? m,
          target: "_self",
          className: [s.fobLink, c ? s.wide : ""].join(" "),
          reloadDocument: c,
    ...
    37525: (e, a, t) => {
      ...
      const d = e => {
          ...
          const n = () => a.screencap.includes("akamai") ? `${a.screencap}?im=Resize=${t}` : a.screencap,
            [d] = (0, i.usePreloadImg)(n());
          return (0, r.jsx)("div", {
            className: [s.screencap, d ? s.screencapLoaded : ""].join(" "),
            style: {
    ...
    77992: (e, a, t) => {
      ...
      const m = e => {
          ...
          return (0, d.jsx)("a", {
            href: "#",
            className: n === t.page ? `rockstargames-sites-rockstargamesb577d5726806ec872ecdb8a46905734f ${s??""}` : "",
            onClick: e => {
        ...
        c = e => {
          ...
          const n = new Array(Math.min(a.pageCount, 8)),
            s = Math.max(a.pageCount - 8, 1),
            c = Math.max(2, a.page - 4),
            o = Array.from(n, ((e, a) => a + Math.min(s, c)));
          return (0, d.jsxs)("div", {
            ...
            children: [a.pageCount > 8 ? (0, d.jsxs)(d.Fragment, {
              ...
              children: [o.slice(-1)[0] + 1 < a.pageCount ? (0, d.jsx)("div", {
                className: r,
                children: "..."
              }) : "", (0, d.jsx)(m, {
                data: a,
      ...
      const f = "rockstargames-sites-rockstargamesfd5351e921b874473f5256931420f405",
        ...
        b = e => {
          ...
          const [r, m] = (0, n.useSearchParams)();
          let o;
          switch (i) {
            case "posts":
              o = t.posts.results.map((e => (0, d.jsx)(s.A, {
                post: e,
                noSpecialOrder: !0
              }, e.id)));
              break;
            case "games":
              o = t.games.results.map((e => (0, d.jsx)(g.N, {
                game: e
              }, e.id)));
              break;
            case "videos":
              o = t.videos.results.map((e => (0, d.jsx)(l.N, {
                video: e
              }, e.id)));
              break;
            default:
        ...
        j = (0, p.withTranslations)((e => {
          ...
          const {
            ...
            setSearch: n,
            setTitle: s
          } = (0, u.b)(), r = (0, p.useQueryParams)(), [m, c] = (0, i.useState)(null), [l, g] = (0, i.useState)({}), [j, h] = (0, i.useState)(r.get("tab") ?? "games"), {
            data: _ = {},
            loading: N
          ...
          return (0, i.useEffect)((() => {
            ...
            void 0 !== _?.games?.paging?.count && (c((_?.games?.paging?.count ?? 0) + (_?.videos?.paging?.count ?? 0) + (_?.posts?.paging?.count ?? 0)), s(_?.meta?.title.replace("%s", t)))
    ...
    19083: e => {
      ...
      })), e.exports = a, e.exports.postFields = s(a, "postFields"), e.exports.paging = s(a, "paging"), e.exports.SearchData = s(a, "SearchData")
    },
    86751: (e, a, t) => {
      var i = {
        "./GTAOnline.jpg": 10111,
      ...
      }, n.resolve = s, e.exports = n, n.id = 86751
    },
    39294: (e, a, t) => {
      var i = {
        "./GTAOnline.jpg": 10111,
      ...
      n.keys = function() {
        return Object.keys(i)
      }, n.resolve = s, e.exports = n, n.id = 39294
    },
    55889: (e, a, t) => {
      var i = {
        "./VI/desktop.png": 3660
      ...
      n.keys = function() {
        return Object.keys(i)
      }, n.resolve = s, e.exports = n, n.id = 55889
    },
    75877: (e, a, t) => {
      var i = {
        "./VI/mobile.png": 96048
      ...
      n.keys = function() {
        return Object.keys(i)
      }, n.resolve = s, e.exports = n, n.id = 75877
    },
    10111: e => {
      "use strict";
