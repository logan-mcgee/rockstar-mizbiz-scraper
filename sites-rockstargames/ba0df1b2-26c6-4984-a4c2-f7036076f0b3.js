try {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    o = (new a.Error).stack;
  o && (a._sentryDebugIds = a._sentryDebugIds || {}, a._sentryDebugIds[o] = "ba0df1b2-26c6-4984-a4c2-f7036076f0b3", a._sentryDebugIdIdentifier = "sentry-dbid-ba0df1b2-26c6-4984-a4c2-f7036076f0b3")
} catch (a) {} {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      var i = function(a) {
        ...
        b = l.forwardRef(function(a, o) {
          var r = l.useRef(null),
            ...
            E = void 0 === q ? "div" : q,
            S = a.gapMode,
            L = (0, e.__rest)(a, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]),
            N = h,
            M = function(a, o) {
            ...
            x = (0, e.__assign)((0, e.__assign)({}, L), t);
          return l.createElement(l.Fragment, null, p && l.createElement(N, {
            sideCar: i,
            removeScrollBar: y,
            shards: m,
            noRelative: w,
            ...
            lockRef: r,
            gapMode: S
          }), b ? l.cloneElement(l.Children.only(g), (0, e.__assign)((0, e.__assign)({}, x), {
            ref: M
          })) : l.createElement(E, (0, e.__assign)({}, x, {
            className: v,
            ref: M
          }), g))
        });
      ...
      var v = function() {
        ...
        _ = function(a, o, r, e) {
          var l = a.left,
            ...
            c = a.right,
            f = a.gap;
          return void 0 === r && (r = "margin"), "\n  .".concat("with-scroll-bars-hidden", " {\n   overflow: hidden ").concat(e, ";\n   padding-right: ").concat(f, "px ").concat(e, ";\n  }\n  body[").concat(w, "] {\n    overflow: hidden ").concat(e, ";\n    overscroll-behavior: contain;\n    ").concat([o && "position: relative ".concat(e, ";"), "margin" === r && "\n    padding-left: ".concat(l, "px;\n    padding-top: ").concat(d, "px;\n    padding-right: ").concat(c, "px;\n    margin-left:0;\n    margin-top:0;\n    margin-right: ").concat(f, "px ").concat(e, ";\n    "), "padding" === r && "padding-right: ".concat(f, "px ").concat(e, ";")].filter(Boolean).join(""), "\n  }\n  \n  .").concat(n, " {\n    right: ").concat(f, "px ").concat(e, ";\n  }\n  \n  .").concat(t, " {\n    margin-right: ").concat(f, "px ").concat(e, ";\n  }\n  \n  .").concat(n, " .").concat(n, " {\n    right: 0 ").concat(e, ";\n  }\n  \n  .").concat(t, " .").concat(t, " {\n    margin-right: 0 ").concat(e, ";\n  }\n  \n  body[").concat(w, "] {\n    ").concat("--removed-body-scroll-bar-size", ": ").concat(f, "px;\n  }\n")
        },
        k = function() {
      ...
      var S = !!q && {
        ...
        N = function(a, o) {
          var r = o.ownerDocument,
            e = o;
          do {
            if ("undefined" != typeof ShadowRoot && e instanceof ShadowRoot && (e = e.host), M(a, e)) {
              var l = x(a, e);
              if (l[1] > l[2]) return !0
            }
            e = e.parentNode
      ...
      const D = (V = function(a) {
        ...
        l.useEffect(function() {
          ...
          if (a.inert) {
            ...
            var o = (0, e.__spreadArray)([a.lockRef.current], (a.shards || []).map(R), !0).filter(Boolean);
        ...
        var f = l.useCallback(function(a, o) {
            if ("touches" in a && 2 === a.touches.length || "wheel" === a.type && a.ctrlKey) return !c.current.allowPinchZoom;
            var e, l = z(a),
              t = r.current,
              d = "deltaX" in a ? a.deltaX : t[0] - l[0],
              f = "deltaY" in a ? a.deltaY : t[1] - l[1],
              s = a.target,
              i = Math.abs(d) > Math.abs(f) ? "h" : "v";
            if ("touches" in a && "h" === i && "range" === s.type) return !1;
            var u = N(i, s);
            if (!u) return !0;
            if (u ? e = i : (e = "v" === i ? "h" : "v", u = N(i, s)), !u) return !1;
            if (!n.current && "changedTouches" in a && (d || f) && (n.current = e), !e) return !0;
            var b = n.current || e;
            return function(a, o, r, e) {
              ...
              return (f && (Math.abs(s) < 1 || !1) || !f && (Math.abs(i) < 1 || !1)) && (c = !0), c
            }(b, o, a, "h" === b ? d : f)
          }, []),
          s = l.useCallback(function(a) {
            var r = a;
            if (H.length && H[H.length - 1] === d) {
              ...
              if (l && l.should) r.cancelable && r.preventDefault();
                ...
                var n = (c.current.shards || []).map(R).filter(Boolean).filter(function(a) {
                  return a.contains(r.target)
                });
                (n.length > 0 ? f(r, n[0]) : !c.current.noIsolation) && r.cancelable && r.preventDefault()
              }
            }
          }, []),
          ...
          b = l.useCallback(function(o) {
            i(o.type, T(o), o.target, f(o, a.lockRef.current))
          }, []),
          g = l.useCallback(function(o) {
            i(o.type, z(o), o.target, f(o, a.lockRef.current))
          }, []);
        l.useEffect(function() {
          return H.push(d), a.setCallbacks({
              onScrollCapture: b,
              onWheelCapture: b,
              onTouchMoveCapture: g
            }), document.addEventListener("wheel", s, S), document.addEventListener("touchmove", s, S), document.addEventListener("touchstart", u, S),
            function() {
              H = H.filter(function(a) {
                return a !== d
              }), document.removeEventListener("wheel", s, S), document.removeEventListener("touchmove", s, S), document.removeEventListener("touchstart", u, S)
            }
        }, []);
