try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "d58b88d6-b1a0-49ba-8d3a-e8732884cff0", e._sentryDebugIdIdentifier = "sentry-dbid-d58b88d6-b1a0-49ba-8d3a-e8732884cff0")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [426, 2295, 8045], {
    ...
    70426: (e, t, o) => {
      ...
      const V = Object.freeze({
          pc: new G("pc", "PC Legacy", 8, "sc"),
          ps: new G("ps", "PlayStation", 3, "np", "ps"),
          ps3: new G("ps3", "PlayStation 3", 2, "np", "ps"),
          ps4: new G("ps4", "PlayStation 4", 11, "np", "ps"),
          ps5: new G("ps5", "PlayStation 5", 20, "np", "ps"),
          xbox: new G("xbox", "Xbox", 4, "xbl"),
          xbox360: new G("xbox360", "Xbox 360", 1, "xbl"),
          xboxone: new G("xboxone", "Xbox One", 12, "xbl"),
          xboxsx: new G("xboxsx", "Xbox Series X|S", 21, "xbl", null, "xboxseriesxs"),
          switch: new G("switch", "Nintendo Switch™", 18, "nintendoswitch"),
          nintendoswitch: new G("nintendoswitch", "Nintendo Switch™", 18, "nintendoswitch"),
          applestore: new G("applestore", "App Store", 102, "applestore"),
          googleplay: new G("googleplay", "Google Play", 1023, "googleplay"),
          appStore: new G("app_store", "App Store", 102, "applestore"),
          googlePlay: new G("ggle_play", "Google Play", 1023, "googleplay"),
          pcalt: new G("pcalt", "PC Enhanced", 22, "sc")
        }),
        $ = Object.freeze(Object.values(V));
      ...
      }, oe = () => [V.xbox360.name, V.xboxone.name, V.ps3.name, V.ps4.name, V.pc.name], ne = () => [V.xboxsx.name, V.ps5.name, V.pcalt.name], ae = e => ne().includes(e), re = e => {
        const t = new Map([
