! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      n = (new e.Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "27f52a61-c499-4dd3-96d0-f82a2d5a66ba", e._sentryDebugIdIdentifier = "sentry-dbid-27f52a61-c499-4dd3-96d0-f82a2d5a66ba")
  } catch (e) {}
}();
  ...
  [4480], {
    64480: (e, n, r) => {
      ...
      T.absoluteValue = T.abs = function() {
        ...
        var r = this,
          t = r.constructor;
        return r = new t(r), void 0 === e ? r : (M(e, 0, a), void 0 === n ? n = t.rounding : M(n, 0, 8), k(r, e + r.e + 1, n))
      }, T.toExponential = function(e, n) {
        var r, t = this,
          i = t.constructor;
        return void 0 === e ? r = P(t, !0) : (M(e, 0, a), void 0 === n ? n = i.rounding : M(n, 0, 8), r = P(t = k(new i(t), e + 1, n), !0, e + 1)), t.isNeg() && !t.isZero() ? "-" + r : r
      }, T.toFixed = function(e, n) {
        var r, t, i = this,
          u = i.constructor;
        return void 0 === e ? r = P(i) : (M(e, 0, a), void 0 === n ? n = u.rounding : M(n, 0, 8), r = P(t = k(new u(i), e + i.e + 1, n), !1, e + t.e + 1)), i.isNeg() && !i.isZero() ? "-" + r : r
        ...
        return (n = 0 != (r = b(+s, c)) && isFinite(r) ? new a(r + "").e : D(c * (Math.log("0." + A(s.d)) / Math.LN10 + s.e + 1))) > a.maxE + 1 || n < a.minE - 1 ? new a(n > 0 ? o / 0 : 0) : (g = !1, a.rounding = s.s = 1, r = Math.min(12, (n + "").length), (i = G(e.times(H(s, t + r)), t)).d && I((i = k(i, t + 5, 1)).d, t, u) && (n = t + 10, +A((i = k(G(e.times(H(s, n + r)), n), n + 5, 1)).d).slice(t + 1, t + 15) + 1 == 1e14 && (i = k(i, t + 1, 0))), i.s = o, g = !0, a.rounding = u, k(i, t, u))
      }, T.toPrecision = function(e, n) {
        var r, t = this,
          i = t.constructor;
        return void 0 === e ? r = P(t, t.e <= i.toExpNeg || t.e >= i.toExpPos) : (M(e, 1, a), void 0 === n ? n = i.rounding : M(n, 0, 8), r = P(t = k(new i(t), e, n), e <= t.e || t.e <= i.toExpNeg, e)), t.isNeg() && !t.isZero() ? "-" + r : r
      }, T.toSignificantDigits = T.toSD = function(e, n) {
        var r = this.constructor;
        return void 0 === e ? (e = r.precision, n = r.rounding) : (M(e, 1, a), void 0 === n ? n = r.rounding : M(n, 0, 8)), k(new r(this), e, n)
      }, T.toString = function() {
        var e = this,
          n = e.constructor,
      ...
      var B = function() {
        ...
        return function(t, i, o, s, a, c) {
          var l, f, d, g, m, p, h, v, y, b, w, F, E, N, S, x, T, A, M, I, O = t.constructor,
            ...
            P = t.d,
            _ = i.d;
          if (!(P && P[0] && _ && _[0])) return new O(t.s && i.s && (P ? !_ || P[0] != _[0] : _) ? P && 0 == P[0] || !_ ? 0 * B : B / 0 : NaN);
          for (c ? (m = 1, f = t.e - i.e) : (c = C, m = 7, f = D(t.e / m) - D(i.e / m)), M = _.length, T = P.length, b = (y = new O(B)).d = [], d = 0; _[d] == (P[d] || 0); d++);
          if (_[d] > (P[d] || 0) && f--, null == o ? (N = o = O.precision, s = O.rounding) : N = a ? o + (t.e - i.e) + 1 : o, N < 0) b.push(1), p = !0;
          else {
            if (N = N / m + 2 | 0, d = 0, 1 == M) {
              for (g = 0, _ = _[0], N++;
                (d < T || g) && N--; d++) S = g * c + (P[d] || 0), b[d] = S / _ | 0, g = S % _ | 0;
              p = g || d < T
            } else {
              for ((g = c / (_[0] + 1) | 0) > 1 && (_ = e(_, g, c), P = e(P, g, c), M = _.length, T = P.length), x = M, F = (w = P.slice(0, M)).length; F < M;) w[F++] = 0;
              (I = _.slice()).unshift(0), A = _[0], _[1] >= c / 2 && ++A;
              do {
                g = 0, (l = n(_, w, M, F)) < 0 ? (E = w[0], M != F && (E = E * c + (w[1] || 0)), (g = E / A | 0) > 1 ? (g >= c && (g = c - 1), 1 == (l = n(h = e(_, g, c), w, v = h.length, F = w.length)) && (g--, r(h, M < v ? I : _, v, c))) : (0 == g && (l = g = 1), h = _.slice()), (v = h.length) < F && h.unshift(0), r(w, h, F, c), -1 == l && (l = n(_, w, M, F = w.length)) < 1 && (g++, r(w, M < F ? I : _, F, c)), F = w.length) : 0 === l && (g++, w = [0]), b[d++] = g, l && w[0] ? w[F++] = P[x] || 0 : (w = [P[x]], F = 1)
      ...
      function G(e, n) {
        ...
        for (a += t = Math.log(b(2, f)) / Math.LN10 * 2 + 5 | 0, r = u = o = new d(1), d.precision = a;;) {
          if (u = k(u.times(e), a, 1), r = r.times(++l), A((s = o.plus(B(u, r, a, 1))).d).slice(0, a) === A(o.d).slice(0, a)) {
            ...
            if (!(c < 3 && I(o.d, a - t, m, c))) return k(o, d.precision = p, m, g = !0);
      ...
      function H(e, n) {
        ...
        if (null == n ? (g = !1, l = D) : l = n, v.precision = l += 10, t = (r = A(h)).charAt(0), !(Math.abs(u = p.e) < 15e14)) return c = j(v, l + 2, D).times(u + ""), p = H(new v(t + "." + r.slice(1)), l - 10).plus(c), v.precision = D, null == n ? k(p, D, y, g = !0) : p;
        ...
        for (u = p.e, t > 1 ? (p = new v("0." + r), u++) : p = new v(t + "." + r.slice(1)), f = p, a = o = p = B(p.minus(1), p.plus(1), l, 1), d = k(p.times(p), l, 1), i = 3;;) {
          if (o = k(o.times(d), l, 1), A((c = a.plus(B(o, new v(i), l, 1))).d).slice(0, l) === A(a.d).slice(0, l)) {
            ...
            if (!I(a.d, l - 10, y, s)) return k(a, v.precision = D, y, g = !0);
          ...
          case "unit":
            ...
            if (S = void 0, B) S = wr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[I][O]);
              ...
              var k = I.split("-per-"),
                ...
                _ = k[1];
              B = n.units.simple[P];
              var j = wr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[P][O]),
