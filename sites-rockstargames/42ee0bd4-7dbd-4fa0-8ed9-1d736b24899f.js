    ...
    50721: (e, n, r) => {
      ...
      var P = function() {
        ...
        return function(t, i, o, s, a, c) {
          ...
          for (c ? (m = 1, f = t.e - i.e) : (c = C, m = S, f = D(t.e / m) - D(i.e / m)), I = R.length, A = j.length, b = (y = new B(P)).d = [], d = 0; R[d] == (j[d] || 0); d++);
          if (R[d] > (j[d] || 0) && f--, null == o ? (N = o = B.precision, s = B.rounding) : N = a ? o + (t.e - i.e) + 1 : o, N < 0) b.push(1), p = !0;
          else {
            if (N = N / m + 2 | 0, d = 0, 1 == I) {
              for (g = 0, R = R[0], N++;
                (d < A || g) && N--; d++) x = g * c + (j[d] || 0), b[d] = x / R | 0, g = x % R | 0;
              p = g || d < A
            } else {
              for ((g = c / (R[0] + 1) | 0) > 1 && (R = e(R, g, c), j = e(j, g, c), I = R.length, A = j.length), T = I, F = (w = j.slice(0, I)).length; F < I;) w[F++] = 0;
              (M = R.slice()).unshift(0), O = R[0], R[1] >= c / 2 && ++O;
              do {
                g = 0, (l = n(R, w, I, F)) < 0 ? (E = w[0], I != F && (E = E * c + (w[1] || 0)), (g = E / O | 0) > 1 ? (g >= c && (g = c - 1), 1 == (l = n(h = e(R, g, c), w, v = h.length, F = w.length)) && (g--, r(h, I < v ? M : R, v, c))) : (0 == g && (l = g = 1), h = R.slice()), (v = h.length) < F && h.unshift(0), r(w, h, F, c), -1 == l && (l = n(R, w, I, F = w.length)) < 1 && (g++, r(w, I < F ? M : R, F, c)), F = w.length) : 0 === l && (g++, w = [0]), b[d++] = g, l && w[0] ? w[F++] = j[T] || 0 : (w = [j[T]], F = 1)
      ...
      function Y(e, n) {
        ...
        return u < 0 ? new t(0 * e.s) : (e.e = R(c, l), e.d = c, g = !1, o && (e = P(e, i, 4 * s)), a && (e = e.times(Math.abs(a) < 54 ? b(2, a) : Ze.pow(2, a))), g = !0, e)
      }
