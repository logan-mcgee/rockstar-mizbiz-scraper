! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      a = (new e.Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "67a3e5c6-cc3f-459f-86f6-c92301d6da88", e._sentryDebugIdIdentifier = "sentry-dbid-67a3e5c6-cc3f-459f-86f6-c92301d6da88")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [9323], {
    ...
    29323: (e, a, s) => {
      ...
      const g = e => {
        ...
        if (f?.src?.desktop) {
          ...
          if (u.background = `url(${f?.src?.desktop}) ${a} ${s}`, r?.style && r?.style["--linear-gradient"]) u.background = `linear-gradient(${r?.style["--linear-gradient"]}), url(${f?.src?.desktop}) ${a} ${s}`;
            ...
            u.background = `linear-gradient(180deg, ${t}, transparent ${e}%, transparent ${100-e}%, ${i}), url(${f?.src?.desktop}) ${a} ${s}`
          }
        }
        return (0, i.jsx)("div", {
          id: p,
          className: (0, n.classList)("rockstargames-sites-rockstargamesda87ead760b989fbe90a0b89c60b0653", g ? "rockstargames-sites-rockstargamesdfbda195073626bc6a7690dc73fba873" : "", l),
          "data-game": "community" === m ? null : t,
          style: (0, n.safeStyles)(u),
          "data-context": s,
          "data-template": m,
          "data-theme": c,
          children: a
      ...
      var l = s(75834);
      const p = "rockstargames-sites-rockstargamesc8dc03880ce2e12f3fdea5b5b587f27f",
        f = e => {
          let {
            alt: a,
            className: t,
          ...
          const [m, c] = (0, n.usePreloadImg)(r);
          let d = r;
          !1 === m && ("rockstargames-sites-rockstargamesa6a06e2d5c4f1811ea39d17312ca2e67" === t && (d = s(28839)), d = s(9333));
          const {
            width: g,
            height: l
          } = c, p = {
        ...
        u = e => {
          ...
          c.desktop || c.mobile || (m = "", c = {
            mobile: s(28839),
            desktop: s(9333)
          });
          let l = r.frame ? `${r.frame} ${p}` : p;
          return (0, i.jsx)("div", {
            className: l,
            style: t,
            children: (0, i.jsx)(f, {
              ...
              src: g ? c.mobile || c.desktop : c?.desktop || c?.mobile,
              alt: m,
              className: a
            })
          })
        ...
        _ = (v = () => (0, i.jsxs)("div", {
          className: k.jpwrapper,
          children: [(0, i.jsx)(u, {
            className: k.responsiveImage,
            image: {
              desktop: s(43305)
            }
          }), (0, i.jsxs)(g, {
            className: [k.body, k.inner, k.gap_sm].join(" "),
            children: [(0, i.jsx)("h1", {
          ...
          children: (0, i.jsx)(v, Object.assign({}, e))
        }));
      var v
    },
    29362: e => {
      ...
      const o = e => {
        ...
        m = e => {
          ...
          const g = (0, r.useLocale)(),
            ...
            [p, f] = (0, t.useState)(n ?? l?.cdn ?? l?.prod ?? !0);
          (0, t.useEffect)((() => {
            f(n ?? l?.cdn ?? l?.prod ?? !0)
          }), [n, l]);
          const u = (0, t.useCallback)((e => {
            ...
            if (s.startsWith("http")) return o(s);
            const t = `${a?(0,r.getCdnPrefix)(p):""}${s}`;
            return o(t)
          }), [p, d]);
          return {
            alt: a,
            ariaLabel: c,
            src: {
              mobile: u(d?.[g]?.mobile ?? d?.en_us?.mobile ?? s),
              desktop: u(d?.[g]?.desktop ?? d?.en_us?.desktop ?? m)
            }
          }
        },
        c = e => {
          const a = (0, i.i)() ?? {},
            ...
            [m, c] = (0, t.useState)(s?.cdn ?? s?.prod ?? !1);
          return (0, t.useEffect)((() => {
            c(s?.cdn ?? s?.prod ?? !1)
          }), [s]), e ? e?.startsWith("http") ? o(e) : o(`${(0,r.getCdnPrefix)(m)}${e}`) : null
        },
        d = () => {
          const e = (0, i.i)() ?? {},
            {
          ...
          return (0, t.useCallback)((function(e) {
            ...
            const t = a?.prod ?? s;
            return e ? e?.startsWith("http") ? o(e) : o(`${(0,r.getCdnPrefix)(t)}${e}`) : null
          }), [s])
        }
    },
    40491: e => {
    ...
    75834: (e, a, s) => {
      ...
      const u = (0, d.A)((0, p.g)((e => {
        ...
        const [b, h] = (0, t.useState)(!1), {
          ...
          track: N
        } = (0, m.useGtmTrack)(), j = (0, r.useIntl)(), {
          data: w
        } = (0, i.useQuery)(l.GameData, {
          variables: {
            titleSlug: k
          },
          skip: !k
        ...
        return (0, f.jsxs)("div", {
          className: [n.rating, S ? n.withDescriptors : n.withOutDescriptors, v || ""].join(" "),
          ...
          children: [(0, f.jsx)(c.A, {
            ...
            children: (0, f.jsx)("img", {
              alt: j.formatMessage(g.components_ratings_link_alt, {
                rating: (M = y.ratingImg, M.replace(/_/g, " ").split(".")[0].toUpperCase())
              }),
              src: s(85813)(`./${y.ratingImg}`)
            })
          }), S && (0, f.jsxs)("div", {
            className: n.text,
            children: [(0, f.jsx)("p", {
              className: n.descriptors,
    ...
    85813: (e, a, s) => {
      ...
      r.keys = function() {
        return Object.keys(t)
      }, r.resolve = i, e.exports = r, r.id = 85813
    },
    86595: e => {
      "use strict";
    ...
    95520: e => {
      ...
      a.definitions.forEach((function(e) {
        ...
        for (i.forEach((function(e) {
          ...
          var c = m;
          m = new Set, c.forEach((function(e) {
