! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "12a29aa4-a312-4391-ac82-5d00726ef45d", e._sentryDebugIdIdentifier = "sentry-dbid-12a29aa4-a312-4391-ac82-5d00726ef45d")
  } catch (e) {}
}();
      ...
      const _ = (0, i.A)((e => {
        ...
        (0, t.useEffect)((() => {
          const e = N.get("country") ?? N.get("locale") ?? null,
            a = void 0 === s,
            t = a && null !== e ? e : a && h.split("_").length > 1 ? "hans" === h.split("_")[1] ? h.split("_")[0] : h.split("_")[1] : h,
            n = o || t || "us";
          M({
            jsonType: k,
            jsonLocale: n,
        ...
        }), [N.get("country"), N.get("locale"), o]), (0, t.useEffect)((() => {
          document.querySelectorAll(".scrollToLink").forEach((e => {
            (e => {
              if (e) {
                ...
                e.setAttribute("href", `${t}${v.pathname.replace("/","")}${null!==a?`?country=${a}`:""}#${s}`)
              }
