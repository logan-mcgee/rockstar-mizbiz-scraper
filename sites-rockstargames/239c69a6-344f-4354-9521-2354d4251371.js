try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    s = (new e.Error).stack;
  s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "239c69a6-344f-4354-9521-2354d4251371", e._sentryDebugIdIdentifier = "sentry-dbid-239c69a6-344f-4354-9521-2354d4251371")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    19829: (e, s, t) => {
      ...
      const m = e => {
        ...
        k = e => {
          ...
          (0, c.useEffect)((() => {
            n && u?.current && (u.current?.showModal?.(), b(!0))
          }), [n]);
          const _ = () => {
          ...
          if (n) return (0, g.jsxs)("dialog", {
            ...
            onClick: e => (e => {
              ...
              (s.left > e.clientX || s.right < e.clientX || s.top > e.clientY || s.bottom < e.clientY) && l && (b(!1), o(), e.currentTarget.close())
            })(e),
      ...
      const y = {
        ...
        w = e => {
          ...
          const [S, R] = (0, c.useState)(!1), v = (0, a.useIntl)(), {
            track: M
          } = (0, r.useGtmTrack)(), {
            ref: D,
            inView: C
            ...
            buttonText: h?.showManagePreferences ? v.formatMessage(p.ns_manage_prefs_button_text) : "",
            isLink: !0,
            link: i.preferences,
          ...
          return (0, c.useEffect)((() => {
            ...
            children: [!w && (0, g.jsx)("div", {
              className: x()(y.newsletterSubscription),
              ...
              children: (0, g.jsx)("section", {
                ...
                children: (0, g.jsx)("div", {
                  className: y.inner,
                  children: s ? (0, g.jsx)(_.A, {}) : (0, g.jsxs)(g.Fragment, {
                    children: [(0, g.jsx)(b, {
                      disableLink: !0,
                      className: y.fadeIn
                    }), (0, g.jsxs)("div", {
                      ...
                      children: [(0, g.jsx)(d.Heading, {
                        ...
                        children: "twitchdrops" === E ? (0, g.jsx)(a.FormattedMessage, {
                          ...p.ns_cta_title_twitchdrops
                        }) : (0, g.jsx)(a.FormattedMessage, {
                          ...p.ns_cta_title
                        })
                      }), (0, g.jsx)(d.Body, {
                        className: [y.copy, y.fadeIn].join(" "),
                        children: (0, g.jsx)(a.FormattedMessage, {
                          ...p.ns_cta_text
                        })
                      })]
                    }), t ? (0, g.jsxs)(d.Button, {
              ...
              icon: h.icon,
              title: v.formatMessage(h.heading),
              secondaryText: v.formatMessage(h.bodyText),
              closeOnOutsideClick: h.closeOnOutsideClick,
              buttons: [{
                ...N[0]
              }, {
                ...N[1]
        ...
        E = {
          SUCCESS: {
            icon: "check",
            heading: p.ns_successfully_subscribed_title,
            bodyText: p.ns_successfully_subscribed_details,
            showManagePreferences: !0
          },
          CHECK_EMAIL: {
            icon: "mail",
            heading: p.ns_check_email_title,
            bodyText: p.ns_check_email_details
          },
          ERROR_PREFERENCES: {
            icon: "error",
            heading: p.ns_error_preferences_title,
            bodyText: p.ns_error_preferences_details,
            showManagePreferences: !0
          },
          ERROR_GENERIC: {
            icon: "error",
            heading: p.ns_error_generic_title,
            bodyText: p.ns_error_generic_details
          },
          ALREADY_SUBSCRIBED: {
            icon: "check",
            heading: p.ns_already_subbed_title,
            bodyText: p.ns_already_subbed_details,
            showManagePreferences: !0
          },
          NEW_ACCOUNT: {
            icon: "mail",
            heading: p.ns_confirm_after_register_title,
            bodyText: p.ns_confirm_after_register_details,
            showManagePreferences: !0
          },
          CONFIRM: {
            icon: "mail",
            heading: p.ns_confirm_title,
            bodyText: p.ns_confirm_details,
            showManagePreferences: !1
          }
        },
        S = {
          0: E.ERROR_PREFERENCES,
          1: E.SUCCESS,
          2: E.ERROR_PREFERENCES,
          3: E.ERROR_PREFERENCES,
          4: E.ERROR_GENERIC
        },
        R = (0, i.setMakeVarItem)({
          key: "subscriptionStatusReactive",
          value: (0, i.makeVar)(void 0)
        }),
        v = e => R(e),
        M = (e, s) => {
          const [t, n] = (0, c.useState)(), [o, l] = (0, c.useState)(!1), [d, u] = (0, c.useState)(!1), [g, b] = (0, c.useState)(!1), [_, m] = (0, c.useState)(!1), f = (0, i.useReactiveVar)(R), k = (0, a.useIntl)(), {
            ...
            buttons: [{
              buttonText: k.formatMessage(p.ns_yes_subscribe_text),
              style: "monochrome",
              onClick: () => {
                M()
              }
            }, {
              buttonText: k.formatMessage(p.ns_go_back_text),
              onClick: () => {
                n(null), u(!1)
              }
            }]
        ...
        D = (0, t(28329).g)((() => {
          const e = (0, i.useRockstarTokenPing)(),
            s = (0, n.A)(),
            [{
              iso: t
            }] = (0, a.getLocale)(),
            c = (0, i.toScLocaleString)(t),
            {
              login: l
    ...
    84082: (e, s) => {
      ...
      ! function() {
        ...
        function i(e) {
          ...
          var s = "";
          for (var t in e) a.call(e, t) && e[t] && (s = n(s, t));
          return s
        }
