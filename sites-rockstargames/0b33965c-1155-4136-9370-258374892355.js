! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "0b33965c-1155-4136-9370-258374892355", e._sentryDebugIdIdentifier = "sentry-dbid-0b33965c-1155-4136-9370-258374892355")
  } catch (e) {}
}();
  ...
  [8488], {
    77100: (e, t, a) => {
      ...
      let s, r, i, n, o, c, l, d, m, g, u, f = {
        ...
        Ae = (e, t) => (R.ScrollTrigger || G("scrollTrigger", t)) && R.ScrollTrigger.create(t, e),
        ...
        yt = function() {
          ...
          return s = {
            ...
            wake() {
              d && (!c && I() && (o = c = window, l = o.document || {}, R.gsap = xa, (o.gsapVersions || (o.gsapVersions = [])).push(xa.version), U($ || o.GreenSockGlobals || !o.gsap && o || {}), a = o.requestAnimationFrame, mt.forEach(gt)), e && s.sleep(), t = a || (e => setTimeout(e, k - 1e3 * s.time + 1 | 0)), u = 1, b(2))
            },
            sleep() {
      ...
      let Bt, Vt, Ft = function(e, t, a, s, r, i, n) {
        ...
        Rt = function(e, t, a, s, r, i, n, o, c, l) {
          j(s) && (s = s(r || 0, e, i));
          let d, m = e[t],
            g = "get" !== a ? a : j(m) ? c ? e[t.indexOf("set") || !j(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : m,
            u = j(m) ? c ? Qt : Kt : Yt;
          if (N(s) && (~s.indexOf("random(") && (s = it(s)), "=" === s.charAt(1) && (d = me(g, s) + (We(g) || 0), (d || 0 === d) && (s = d))), !l || g !== s || Vt) return isNaN(g * s) || "" === s ? (!m && !(t in e) && G(t, s), Ft.call(this, e, t, g, s, u, o || f.stringFilter, c)) : (d = new ca(this._pt, e, t, +g || 0, s - (g || 0), "boolean" == typeof m ? ta : ea, 0, u), c && (d.fp = c), n && d.modifier(n, this, e), this._pt = d)
        },
        $t = (e, t, a, s, r, i) => {
          let n, o, c, l;
          ...
          if (R && (!z || !w) && (w = "none"), e._ease = It(w, p.ease), e._yEase = L ? Ct(It(!0 === L ? w : L, p.ease)) : 0, L && e._yoyo && !e._repeat && (L = e._yEase, e._yEase = e._ease, e._ease = L), e._from = !R && !!y.runBackwards, !R || z && !y.stagger) {
            ...
            for (e._pt = e._ptCache = 0, S = A && M(S) || S && !A, o = 0; o < D.length; o++) {
              if (d = D[o], g = d._gsap || ie(D)[o]._gsap, e._ptLookup[o] = h = {}, J[g.id] && Z.length && ue(), b = V === D ? o : V.indexOf(d), u && !1 !== (f = new u).init(d, v || i, e, b, V) && (e._pt = l = new ca(e._pt, d, f.name, 0, 1, f.render, f, 0, f.priority), f._props.forEach((e => {
                ...
                for (c in i) ee[c] && (f = $t(c, i, e, b, d, V)) ? f.priority && (m = 1) : h[c] = l = Rt.call(e, d, c, "get", i[c], b, V, 0, y.stringFilter);
              e._op && e._op[o] && e.kill(d, e._op[o]), F && e._pt && (Bt = e, n.killTweensOf(d, h, e.globalTime(t)), x = !e.parent, Bt = 0), e._pt && S && (J[g.id] = 1)
            }
      ...
      const ha = {
        ...
        registerEffect(e) {
          ...
          (s || "").split(",").forEach((e => e && !ee[e] && !R[e] && H(t + " effect requires " + e + " plugin."))), te[t] = (e, t, s) => a(Ye(e), ke(t || {}, r), s), i && (Dt.prototype[t] = function(e, a, s) {
      ...
      let Fa, Ra, $a, Ua, Ga, Ha, Wa, qa, Xa, Ya = {},
        ...
        Ps = (e, t, a, s) => {
          let r, i, n, o, c = parseFloat(a) || 0,
            ...
            p = "px" === s,
            _ = "%" === s;
          return s === l || !c || Ls[s] || Ls[l] ? c : ("px" !== l && !p && (c = Ps(e, t, a, "px")), o = e.getCTM && Ms(e), !_ && "%" !== l || !Ya[t] && !~t.indexOf("adius") ? (d[m ? "width" : "height"] = f + (p ? l : s), i = ~t.indexOf("adius") || "em" === s && e.appendChild && !g ? e : e.parentNode, o && (i = (e.ownerSVGElement || {}).parentNode), i && i !== Ra && i.appendChild || (i = Ra.body), n = i._gsap, n && _ && n.width && m && n.time === yt.time && !n.uncache ? le(c / n.width * f) : ((_ || "%" === l) && !zs[ys(i, "display")] && (d.position = ys(e, "position")), i === e && (d.position = "static"), i.appendChild(Ga), r = Ga[u], i.removeChild(Ga), d.position = "absolute", m && _ && (n = ne(i), n.time = yt.time, n.width = i[u]), le(p ? r * c / f : r && c ? f / r * c : 0))) : (r = o ? e.getBBox()[m ? "width" : "height"] : e[u], le(_ ? c / r * f : c / 100 * r)))
        },
        As = (e, t, a, s) => {
          let r;
          return Ua || js(), t in as && "transform" !== t && ~(t = as[t]).indexOf(",") && (t = t.split(",")[0]), Ya[t] && "transform" !== t ? (r = qs(e, s), r = "transformOrigin" !== t ? r[t] : r.svg ? r.origin : Xs(ys(e, _s)) + " " + r.zOrigin + "px") : (r = e.style[t], (!r || "auto" === r || s || ~(r + "").indexOf("calc(")) && (r = Fs[t] && Fs[t](e, t, a) || ys(e, t) || oe(e, t) || ("opacity" === t ? 1 : 0))), a && !~(r + "").trim().indexOf(" ") ? Ps(e, t, r, a) + a : r
        },
        Os = function(e, t, a, s) {
          if (!a || "none" === a) {
            let s = Ns(t, e, 1),
        ...
        Gs = e => {
          let t = ys(e, ps);
          return Us(t) ? Rs : t.substr(7).match(A).map(le)
        },
        Hs = (e, t) => {
          let a, s, r, i, n = e._gsap || ne(e),
            o = e.style,
            c = Gs(e);
          return n.svg && e.getAttribute("transform") ? (r = e.transform.baseVal.consolidate().matrix, c = [r.a, r.b, r.c, r.d, r.e, r.f], "1,0,0,1,0,0" === c.join(",") ? Rs : c) : (c !== Rs || e.offsetParent || e === $a || n.svg || (r = o.display, o.display = "block", a = e.parentNode, a && e.offsetParent || (i = 1, s = e.nextElementSibling, $a.appendChild(e)), c = Gs(e), r ? o.display = r : Is(e, "display"), i && (s ? a.insertBefore(e, s) : a ? a.appendChild(e) : $a.removeChild(e))), t && c.length > 6 ? [c[0], c[1], c[4], c[5], c[12], c[13]] : c)
        },
        Ws = (e, t, a, s, r, i) => {
    ...
    61044: (e, t, a) => {
        ...
        G = e => {
          ...
          const [s, r] = (0, o.useState)(!1), i = (e => {
            const [t] = (0, m.useSearchParams)(), [a, s] = (0, o.useState)(null), r = (0, R.useRockstarUser)(), {
              ...
              currentCharId: n
            } = (0, R.useRockstarUserState)(), c = (0, R.useIsUserGtaPlus)(r?.data, n);
            return (0, o.useEffect)((() => {
      ...
      const de = e => {
        ...
        me = e => {
          ...
          const {
            track: v
          } = (0, R.useGtmTrack)(), x = (0, F.useDataLayer)(), y = r ?? t, w = (0, F.findPlatform)(p)?.friendlyName, N = (0, o.useMemo)((() => {
      ...
      const $e = {
        ...
        Ye = e => {
          ...
          const [f, p] = (0, o.useState)(!1), {
            track: _
          } = (0, R.useGtmTrack)(), k = (0, o.useRef)(null), h = (0, o.useRef)(f);
          (0, o.useEffect)((() => {
            h.current = f
          }), [f]), (0, o.useEffect)((() => {
            const e = e => {
      ...
      const rt = function(e) {
        ...
        nt = rt((e => {
          ...
          const {
            track: _
          } = (0, R.useGtmTrack)(), k = (0, o.useRef)(null), h = (0, o.useRef)(null), b = (0, o.useRef)(null), [v, x] = (0, o.useState)(null), [y, w] = (0, o.useState)(!1), [N, j] = (0, o.useState)(null), [S, T] = (0, o.useState)(), [M, I] = (0, o.useState)(), {
            ref: E,
            inView: L
          } = (0, W.cD)({
            threshold: .6
          }), [z, A] = (0, o.useState)(!1), [O, D] = (0, o.useState)(null), [B, V] = (0, o.useState)(!1), [F, $] = (0, o.useState)(0), [U, G] = (0, o.useState)(0);
          (0, o.useEffect)((() => {
            const e = () => {
            ...
            const e = () => {
              S && !(0, tt.isEmpty)(S) && S?.height > 0 && S?.height !== F && $(S?.height)
            };
            return e(), window.addEventListener("resize", e), () => {
              window.removeEventListener("resize", e)
            }
        ...
        gt = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            i(e), c(t)
          }), [a]), r.length ? (0, u.jsx)(Re.motion.div, {
      ...
      const kt = (0, c.defineMessages)({
        ...
        bt = (0, c.withIntl)((e => {
          ...
          const {
            track: i
          } = (0, R.useGtmTrack)(), n = (0, m.useLocation)(), l = (0, c.useIntl)(), [d, g] = (0, c.getLocale)(), [p, _] = (0, o.useState)(!1), k = (0, o.useMemo)((() => (0, _t.c)()), []), h = (0, o.useCallback)((e => {
            let t = n.pathname;
            const a = t.split("/");
        ...
        Pt = e => {
          ...
          const {
            track: n
          } = (0, R.useGtmTrack)(), [c] = (0, m.useSearchParams)(), l = s.preview_images_parsed.newswire_block, d = {
      ...
      const Dt = (0, F.withTranslations)((e => {
          ...
          const {
            track: n
          } = (0, R.useGtmTrack)(), [c] = (0, m.useSearchParams)(), {
            tagId: l = null
      ...
      const qt = (e, t) => {
        ...
        Jt = e => {
          ...
          } = (0, R.useRockstarUserState)(), [_, k] = (0, o.useState)(!1), [h, b] = (0, o.useState)(d), [v, x] = (0, o.useState)(!1), y = (0, c.useIntl)(), w = !!i?.length;
          (0, o.useEffect)((() => {
            if (Array.isArray(p)) {
              const e = p?.[0];
      ...
      const La = (0, k.makeVarNamespace)("@rockstargames/components/profile-switcher"),
        ...
        Fa = e => Va(e),
        Ra = La("charListHiddenReactive", !0),
        $a = e => Ra(e),
        Ua = () => {
          const e = (0, k.useReactiveVar)(za),
            ...
            r = (0, k.useReactiveVar)(Ra);
          return (0, o.useEffect)((() => {
            r || (e && Pa(!1), s && (Fa(!1), Oa(-1)))
          }), [r]), (0, o.useEffect)((() => {
            !e && r && (s || Fa(!0))
          }), [e, r]), (0, o.useMemo)((() => ({
      ...
      const qa = {
        ...
        Ya = e => {
          ...
          const {
            track: p
          } = (0, R.useGtmTrack)(), _ = (0, _t.c)(), k = (0, c.useIntl)();
          let h = s;
        ...
        Qa = e => {
          ...
          const {
            ...
            navOpen: _
          } = (0, R.useRockstarUserState)(), k = (0, F.useLocale)(), h = (0, F.toScLocaleString)(k), [b, v] = (0, o.useState)(""), x = (0, m.useLocation)(), y = `${t.login}?returnUrl=${b}&lang=${h}`, w = `${t.signup}&returnUrl=${b}&lang=${h}`, N = (0, o.useMemo)((() => (0, _t.c)()), []), j = (0, o.useMemo)((() => {
            const e = ((e, t, a) => [{
        ...
        es = e => {
          ...
          const {
            ...
            track: i
          } = (0, R.useGtmTrack)(), n = (0, c.useIntl)(), [l, d] = (0, o.useState)([]), [m, g] = (0, o.useState)(null), [f, p] = (0, o.useState)(null), [_, k] = (0, o.useState)(!1), [h, b] = (0, o.useState)(-1), [v, x] = (0, o.useState)([]), [y, w] = (0, o.useState)(0), N = a(71084), [j, S] = (0, o.useState)("0"), [T, C] = (0, o.useState)("0"), M = e => parseInt(e, 10).toLocaleString("en-US", {
        ...
        rs = (0, F.withTranslations)((e => {
          ...
          const {
            ...
            track: I
          } = (0, R.useGtmTrack)(), E = (0, k.useRockstarTokenPing)(), {
            data: L,
            loggedIn: z
          } = (0, R.useRockstarUser)(), {
            charactersNeeded: P,
            ...
            setUserData: U
          } = (0, R.useRockstarUserState)(), [G, H] = (0, o.useState)(null), [W, q] = (0, o.useState)(null), [X, Y] = (0, o.useState)(!1), [K, Q] = (0, o.useState)(!1), [Z, J] = (0, o.useState)(0), ee = (0, o.createRef)(), te = ts(ee, !1), ae = (0, o.createRef)(), [se, re] = (0, o.useState)(0), [ie, ne] = (0, o.useState)([]), [oe, ce] = (0, o.useState)(244), le = (0, o.useRef)(null), de = (0, o.useMemo)((() => (0, _t.c)()), []), me = (0, o.useMemo)((() => ((e, t, a, s, r) => [{
        ...
        ns = (0, c.withIntl)((() => {
          const {
            ...
            track: y
          } = (0, R.useGtmTrack)(), [w, N] = (0, o.useState)(!1), j = (0, k.useReactiveVar)(R.scConfig), S = (0, o.useRef)(), [T, C] = (0, o.useState)(0), M = (0, o.createRef)(), [I, E] = (0, o.useState)(!1), [L, z] = (0, o.useState)(0), [P, A] = (0, o.useState)(!1), {
            mutateLSSettings: O,
            lsSettings: D
      ...
      var fs = a(13316);
      const ps = void 0 !== fs.GameData ? fs.GameData : GameDataDefault;
      ...
      const _s = rt((0, c.withIntl)((e => {
        ...
        Ls = (0, o.forwardRef)(((e, t) => {
          const {
            ...
            track: n
          } = (0, R.useGtmTrack)(i), [c, l] = (0, o.useState)(t?.current);
          return (0, o.useEffect)((() => {
      ...
      const zs = Ls,
        ...
        Rs = "rockstargames-sites-rockstargameseca98eb0b5b84a0c9a2e6d952545a2d5",
        ...
        Gs = e => {
          ...
          const {
            track: l
          } = (0, R.useGtmTrack)(), [d, m] = (0, o.useState)([et.O4, et.Hj, et.eM]), [g, f] = (0, o.useState)(null), [p, _] = (0, o.useState)(null);
          return (0, o.useEffect)((() => {
