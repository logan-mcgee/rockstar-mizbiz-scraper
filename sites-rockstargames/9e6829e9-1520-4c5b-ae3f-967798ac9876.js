! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "9e6829e9-1520-4c5b-ae3f-967798ac9876", e._sentryDebugIdIdentifier = "sentry-dbid-9e6829e9-1520-4c5b-ae3f-967798ac9876")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [4], {
    40004: (e, a, s) => {
      ...
      const i = {
        ...
        o = e => {
          ...
          return (0, m.jsx)(r.motion.div, Object.assign({
        ...
        if (_?.src?.desktop) {
          ...
          if (k.background = `url(${_?.src?.desktop}) ${a} ${s}`, r?.style && r?.style["--linear-gradient"]) k.background = `linear-gradient(${r?.style["--linear-gradient"]}), url(${_?.src?.desktop}) ${a} ${s}`;
            ...
            const e = r?.style["--gradient-height"] || "3",
              ...
              m = r?.style["--gradient-end-color"] || "var(--background-color, transparent)";
            k.background = `linear-gradient(180deg, ${t}, transparent ${e}%, transparent ${100-e}%, ${m}), url(${_?.src?.desktop}) ${a} ${s}`
          }
        }
        return (0, m.jsx)("div", {
          id: f,
      ...
      const f = "rockstargames-sites-rockstargameseb64520e04e486931cd65dc5b3fa61e8",
        ...
        u = (b = () => (0, m.jsxs)("div", {
          ...
          children: (0, m.jsx)(b, Object.assign({}, e))
        }));
      var b
    },
    35856: (e, a, s) => {
    ...
    4905: (e, a, s) => {
      ...
      }, r.resolve = m, e.exports = r, r.id = 4905
    },
    73983: (e, a, s) => {
      var t = {
        "./cero_a.png": 81229,
      ...
      r.keys = function() {
        return Object.keys(t)
      }, r.resolve = m, e.exports = r, r.id = 73983
    },
    81229: e => {
      "use strict";
