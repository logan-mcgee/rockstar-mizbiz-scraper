! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      a = (new e.Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "4c83e63c-ea41-497f-add0-df45ca486391", e._sentryDebugIdIdentifier = "sentry-dbid-4c83e63c-ea41-497f-add0-df45ca486391")
  } catch (e) {}
}();
    ...
    8123: (e, a, s) => {
      ...
      const {
        ...
        const e = (0, n.useIntl)(),
          ...
          x = {
            event: "cta_other",
            text: l.email_settings_cta.defaultMessage,
            link_url: f,
        ...
        return (0, t.useEffect)((() => {
          (async () => {
            ...
            const a = await (0, i.coreScApiFetch)("marketing/unsubscribe", {
              ...
              s = a?.error?.code;
            a?.status ? k("success") : s && !a?.status && k(h[s] || "error")
          })()
        }), [g.get("token")]), (0, t.useEffect)((() => {
          s && a({
            event: "virtualPageview",
            view_name: l[`unsubscribe_${s}_header`].defaultMessage
          })
        }), [s]), (0, m.jsx)("div", {
          ...
          children: s ? (0, m.jsxs)("div", {
            ...
            children: [(0, m.jsx)("div", {
              ...
              children: [(0, m.jsx)("h3", {
                className: u.heading,
                children: e.formatMessage(l[`unsubscribe_${s}_header`])
              }), (0, m.jsx)("div", {
                className: u.description,
                children: e.formatMessage(l[`unsubscribe_${s}_description`])
              })]
            }), (0, m.jsx)("div", {
