try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    l = (new e.Error).stack;
  l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "dc7fa71a-f4ee-48eb-8216-8c7707dd9e8f", e._sentryDebugIdIdentifier = "sentry-dbid-dc7fa71a-f4ee-48eb-8216-8c7707dd9e8f")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [7507], {
    67507: (e, l, a) => {
      a.r(l), a.d(l, {
        ...
        Circle: () => an,
        CircleCheck: () => yn,
        CircleCheckFilled: () => Zn,
        CircleDollarSign: () => Gf,
        CircleHelp: () => U,
        CircleMinus: () => pc,
        CircleMinusFilled: () => Dc,
        CirclePerson: () => Ie,
        CircleSlash: () => _e,
        CircleX: () => zc,
        Clipboard: () => qd,
      ...
      Gh.displayName = "ShoppingBag", Gh.categories = ["shopping"], Gh.tags = ["ecommerce", "cart", "purchase", "store", "bag", "shop", "shopping", "tote"], Gh.SM = Sh, Gh.MD = yh, Gh.LG = Dh, Gh.XL = Nh;
      ...
      Ph.displayName = "MessageSquareText", Ph.categories = ["social"], Ph.tags = ["comment", "chat", "conversation", "dialog", "feedback", "speech bubble", "clear", "close", "delete", "remove", "cancel", "silence", "mute", "moderate"], Ph.SM = Xh, Ph.LG = qh, Ph.MD = Fh, Ph.XL = kh;
      ...
      _h.displayName = "Search", _h.categories = ["text", "social"], _h.tags = ["find", "scan", "magnifier", "magnifying glass", "look", "view"], _h.SM = Oh, _h.LG = Th, _h.MD = Eh, _h.XL = Uh;
      ...
      $h.displayName = "PartialCircle", $h.categories = ["shapes"], $h.tags = ["Partial", "Half", "Middle", "Split"], $h.SM = Wh, $h.LG = Zh, $h.MD = Yh, $h.XL = Kh;
      ...
      an.displayName = "Circle", an.categories = ["shapes"], an.tags = ["Off", "Zero", "Record", "Shape", "Round", "Outline"], an.SM = Qh, an.MD = Jh, an.LG = en, an.XL = ln;
      ...
      on.displayName = "LockKeyhole", on.categories = ["security"], on.tags = ["security", "password", "secure", "admin", "lock", "safe", "protection", "security", "latch"], on.SM = rn, on.LG = tn, on.MD = sn, on.XL = dn;
      ...
      wn.displayName = "LockPassword", wn.categories = ["security"], wn.tags = ["security", "password", "secure", "admin"], wn.SM = hn, wn.LG = nn, wn.MD = cn, wn.XL = fn;
      ...
      mn.displayName = "Image", mn.categories = ["photography", "text", "multimedia", "files"], mn.tags = ["picture", "photo"], mn.SM = vn, mn.LG = xn, mn.MD = gn, mn.XL = jn;
      ...
      bn.displayName = "Lightbulb", bn.categories = ["photography"], bn.tags = ["idea", "bright", "lights"], bn.SM = pn, bn.LG = un, bn.MD = Mn, bn.XL = Rn;
      ...
      An.displayName = "Check", An.categories = ["notifications"], An.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "success", "accept"], An.SM = zn, An.LG = Ln, An.MD = Cn, An.XL = Hn;
      const Vn = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yn.displayName = "CircleCheck", yn.categories = ["notifications"], yn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], yn.SM = Vn, yn.LG = Bn, yn.MD = In, yn.XL = Sn;
      ...
      qn.displayName = "TriangleAlert", qn.categories = ["notifications", "shapes", "development"], qn.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], qn.SM = Dn, qn.LG = Nn, qn.MD = Gn, qn.XL = Xn;
      ...
      Tn.displayName = "X", Tn.categories = ["notifications", "math"], Tn.tags = ["cancel", "close", "delete", "remove", "times", "clear", "math", "multiply", "multiplication", "error", "remove", "clean", "erase", "navigation", "cross", "times"], Tn.SM = Fn, Tn.LG = kn, Tn.MD = Pn, Tn.XL = On;
      ...
      Zn.displayName = "CircleCheckFilled", Zn.categories = ["notifications"], Zn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success", "filled"], Zn.SM = En, Zn.MD = Un, Zn.LG = _n, Zn.XL = Wn;
      ...
      Jn.displayName = "Globe", Jn.categories = ["navigation"], Jn.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], Jn.SM = Yn, Jn.LG = Kn, Jn.MD = $n, Jn.XL = Qn;
      ...
      tc.displayName = "Pin", tc.categories = ["navigation"], tc.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point"], tc.SM = ec, tc.MD = lc, tc.LG = ac, tc.XL = rc;
      ...
      hc.displayName = "PinFilled", hc.categories = ["navigation"], hc.tags = ["push pin", "pin push", "save", "map", "lock", "fix", "attach", "mark", "important", "location", "point", "filled"], hc.SM = sc, hc.MD = ic, hc.LG = dc, hc.XL = oc;
      ...
      vc.displayName = "HeartPulse", vc.categories = ["medical"], vc.tags = ["heartbeat", "pulse", "health", "medical", "blood pressure", "cardiac", "systole", "diastole"], vc.SM = nc, vc.LG = cc, vc.MD = fc, vc.XL = wc;
      ...
      pc.displayName = "CircleMinus", pc.categories = ["math"], pc.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete"], pc.SM = xc, pc.LG = gc, pc.MD = jc, pc.XL = mc;
      ...
      zc.displayName = "CircleX", zc.categories = ["math", "development"], zc.tags = ["cancel", "close", "delete", "remove", "times", "clear", "error", "incorrect", "wrong", "mistake", "failure", "linter", "multiply", "multiplication", "clean", "erase", "deprecate", "delete", "navigation"], zc.SM = uc, zc.LG = Mc, zc.MD = Rc, zc.XL = bc;
      ...
      Vc.displayName = "Minus", Vc.categories = ["math", "development", "text", "tools"], Vc.tags = ["subtract", "remove", "decrease", "decrement", "reduce", "negative", "calculate", "line", "divider", "separator", "horizontal rule", "hr", "html", "markup", "markdown", "---", "toolbar", "operator", "code", "coding", "minimum", "downgrade", "less", "delete", "navigation", "minimize"], Vc.SM = Lc, Vc.LG = Cc, Vc.MD = Hc, Vc.XL = Ac;
      ...
      Dc.displayName = "CircleMinusFilled", Dc.categories = ["math"], Dc.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete", "filled"], Dc.SM = Bc, Dc.MD = Ic, Dc.LG = Sc, Dc.XL = yc;
      const Nc = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Fc.displayName = "EnvelopeOpen", Fc.categories = ["mail"], Fc.tags = ["email", "message", "letter", "read"], Fc.SM = Nc, Fc.LG = Gc, Fc.MD = Xc, Fc.XL = qc;
      ...
      Ec.displayName = "Paperclip", Ec.categories = ["text", "design", "files", "mail"], Ec.tags = ["attachment", "file", "attach", "clip", "document", "paper"], Ec.SM = kc, Ec.LG = Pc, Ec.MD = Oc, Ec.XL = Tc;
      const Uc = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Yc.displayName = "Trash", Yc.categories = ["files", "mail"], Yc.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], Yc.SM = Uc, Yc.LG = _c, Yc.MD = Wc, Yc.XL = Zc;
      const Kc = (0, t.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ef.displayName = "EllipsisVertical", ef.categories = ["layout"], ef.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], ef.SM = Kc, ef.LG = $c, ef.MD = Qc, ef.XL = Jc;
      ...
      sf.displayName = "Filter", sf.categories = ["layout"], sf.tags = ["funnel", "hopper"], sf.SM = lf, sf.LG = af, sf.MD = rf, sf.XL = tf;
      ...
      cf.displayName = "Weapon", cf.categories = ["gaming"], cf.tags = ["gun", "pistol", "GTAO", "fire", "shoot", "death", "danger"], cf.SM = df, cf.LG = of, cf.MD = hf, cf.XL = nf;
      ...
      gf.displayName = "Heart", gf.categories = ["medical", "social", "multimedia", "emoji", "gaming", "shapes"], gf.tags = ["like", "love", "emotion", "suit", "playing", "cards"], gf.SM = ff, gf.LG = wf, gf.MD = vf, gf.XL = xf;
      ...
      Mf.displayName = "FileText", Mf.categories = ["files", "text"], Mf.tags = ["data", "txt", "pdf", "document"], Mf.SM = jf, Mf.LG = mf, Mf.MD = pf, Mf.XL = uf;
      ...
      Cf.displayName = "Files", Cf.categories = ["files"], Cf.tags = ["multiple", "copy", "documents", "data", "file", "folder", "restore"], Cf.SM = Rf, Cf.LG = bf, Cf.MD = zf, Cf.XL = Lf;
      ...
      If.displayName = "Save", If.categories = ["files"], If.tags = ["floppy disk", "download", "backup", "storage", "disk", "document", "computer", "archive"], If.SM = Hf, If.MD = Af, If.LG = Vf, If.XL = Bf;
      ...
      Gf.displayName = "CircleDollarSign", Gf.categories = ["finance"], Gf.tags = ["monetization", "marketing", "currency", "money", "payment"], Gf.SM = Sf, Gf.LG = yf, Gf.MD = Df, Gf.XL = Nf;
      ...
      Pf.displayName = "DollarSign", Pf.categories = ["finance"], Pf.tags = ["currency", "money", "payment"], Pf.SM = Xf, Pf.LG = qf, Pf.MD = Ff, Pf.XL = kf;
      ...
      _f.displayName = "FastForward", _f.categories = ["multimedia", "arrows"], _f.tags = ["music", "audio", "video", "control", "player", "media"], _f.SM = Of, _f.LG = Tf, _f.MD = Ef, _f.XL = Uf;
      ...
      $f.displayName = "Pause", $f.categories = ["multimedia"], $f.tags = ["music", "audio", "video", "stop", "pause", "control", "player", "media"], $f.SM = Wf, $f.LG = Zf, $f.MD = Yf, $f.XL = Kf;
      ...
      aw.displayName = "Play", aw.categories = ["arrows", "multimedia"], aw.tags = ["music", "audio", "video", "start", "run", "play", "continue", "control", "player", "media"], aw.SM = Qf, aw.LG = Jf, aw.MD = ew, aw.XL = lw;
      ...
      dw.displayName = "Rewind", dw.categories = ["arrows", "multimedia"], dw.tags = ["music", "audio", "video", "control", "player", "previous", "back", "reverse", "media"], dw.SM = rw, dw.LG = tw, dw.MD = sw, dw.XL = iw;
      ...
      fw.displayName = "SkipBack", fw.categories = ["multimedia", "arrows"], fw.tags = ["music", "audio", "video", "arrow", "previous", "back", "rewind", "reverse", "control", "player", "media"], fw.SM = ow, fw.LG = hw, fw.MD = nw, fw.XL = cw;
      ...
      jw.displayName = "SkipForward", jw.categories = ["multimedia", "arrows"], jw.tags = ["music", "audio", "video", "arrow", "skip", "next", "forward", "control", "player", "media"], jw.SM = ww, jw.LG = vw, jw.MD = xw, jw.XL = gw;
      ...
      Rw.displayName = "StarOff", Rw.categories = ["multimedia", "social"], Rw.tags = ["dislike", "unlike", "remove", "unrate"], Rw.SM = mw, Rw.LG = pw, Rw.MD = uw, Rw.XL = Mw;
      ...
      Hw.displayName = "Stop", Hw.categories = ["multimedia"], Hw.tags = ["music", "audio", "video", "control", "player", "stop", "media"], Hw.SM = bw, Hw.LG = zw, Hw.MD = Lw, Hw.XL = Cw;
      ...
      Sw.displayName = "ListMusic", Sw.categories = ["multimedia"], Sw.tags = ["playlist", "music", "audio", "control", "player", "media", "queue", "playback", "play", "list"], Sw.SM = Aw, Sw.MD = Vw, Sw.LG = Bw, Sw.XL = Iw;
      ...
      Xw.displayName = "Book", Xw.categories = ["text", "gaming"], Xw.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], Xw.SM = yw, Xw.LG = Dw, Xw.MD = Nw, Xw.XL = Gw;
      ...
      Ow.displayName = "CloudAlert", Ow.categories = ["development"], Ow.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], Ow.SM = qw, Ow.LG = Fw, Ow.MD = kw, Ow.XL = Pw;
      ...
      Ww.displayName = "CodeXml", Ww.categories = ["text", "development"], Ww.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], Ww.SM = Tw, Ww.LG = Ew, Ww.MD = Uw, Ww.XL = _w;
      ...
      Qw.displayName = "Database", Qw.categories = ["devices", "development"], Qw.tags = ["storage", "memory", "container", "tin", "pot", "bytes", "servers"], Qw.SM = Zw, Qw.LG = Yw, Qw.MD = Kw, Qw.XL = $w;
      ...
      rv.displayName = "Server", rv.categories = ["development", "devices"], rv.tags = ["cloud", "storage"], rv.SM = Jw, rv.LG = ev, rv.MD = lv, rv.XL = av
    }
  }
]);