try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    n = (new e.Error).stack;
  n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "b384f975-b755-4592-84ba-4683ef9decbd", e._sentryDebugIdIdentifier = "sentry-dbid-b384f975-b755-4592-84ba-4683ef9decbd")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      var t = r(78322),
        ...
        _ = function(e) {
          ...
          var n = e.uri,
            ...
            N = void 0 !== I && I,
            x = (0, t.__rest)(e, ["uri", "fetch", "print", "includeExtensions", "preserveHeaderCase", "useGETForQueries", "includeUnusedVariables"]);
          !1 !== globalThis.__DEV__ && (0, f.S)(_ || g);
          var S = {
            http: {
              includeExtensions: w,
          ...
          return new a.C(function(e) {
            ...
            var I = (0, t.__assign)((0, t.__assign)({}, f), a.headers),
              x = {
                http: a.http,
            ...
            if ((0, o.d8)(["client"], e.query)) {
              ...
              var D = (0, m.er)(e.query);
              if (!D) return (0, p.N)(new Error("HttpLink: Trying to send a client-only query to the server. To send to the server, ensure a non-client field is added to the query or set the `transformOptions.removeClientFields` option to `true`."));
              e.query = D
            }
            var T, A, V, C, R, q = (0, d.HY)(e, E, d.R4, S, x),
              F = q.options,
              j = q.body;
            j.variables && !N && (j.variables = (T = j.variables, A = e.query, V = (0, t.__assign)({}, T), C = new Set(Object.keys(T)), (0, h.visit)(A, {
            ...
            if ("GET" === F.method) {
              ...
              F.body = (0, u.Y)(j, "Payload")
            } catch (U) {
              return (0, p.N)(U)
            }
            return new s.c(function(r) {
              var t = _ || (0, i.no)(function() {
                  return fetch
                }) || g,
                a = r.next.bind(r);
    ...
    14120(e, n, r) {
      ...
      function f(e, n) {
        return (0, t.__awaiter)(this, void 0, void 0, function() {
          var r, i, a, s, l, f, p, h, m, y, g, _, b, E, w, O, k, I, N, x, S, D, T, A;
          return (0, t.__generator)(this, function(V) {
            switch (V.label) {
              case 0:
                ...
                r = new TextDecoder("utf-8"), i = null === (A = e.headers) || void 0 === A ? void 0 : A.get("content-type"), a = "boundary=", s = (null == i ? void 0 : i.includes(a)) ? null == i ? void 0 : i.substring((null == i ? void 0 : i.indexOf(a)) + 9).replace(/['"]/g, "").replace(/\;(.*)/gm, "").trim() : "-", l = "\r\n--".concat(s), f = "", p = o(e), h = !0, V.label = 1;
              case 1:
                return h ? [4, p.next()] : [3, 3];
              case 2:
                for (m = V.sent(), y = m.value, g = m.done, _ = "string" == typeof y ? y : r.decode(y), b = f.length - l.length + 1, h = !g, E = (f += _).indexOf(l, b); E > -1;) {
                  if (w = void 0, D = [f.slice(0, E), f.slice(E + l.length)], f = D[1], O = (w = D[0]).indexOf("\r\n\r\n"), k = d(w.slice(0, O)), (I = k["content-type"]) && -1 === I.toLowerCase().indexOf("application/json")) throw new Error("Unsupported patch content type: application/json is required.");
                  if (N = w.slice(O))
                    if (x = v(e, N), Object.keys(x).length > 1 || "data" in x || "incremental" in x || "errors" in x || "payload" in x)
                      if ((0, c.Nw)(x)) {
                        if (S = {}, "payload" in x) {
                          if (1 === Object.keys(x).length && null === x.payload) return [2];
                          S = (0, t.__assign)({}, x.payload)
                        }
                        "errors" in x && (S = (0, t.__assign)((0, t.__assign)({}, S), {
                          extensions: (0, t.__assign)((0, t.__assign)({}, "extensions" in S ? S.extensions : null), (T = {}, T[u.K$] = x.errors, T))
                        })), n(S)
                      } else n(x);
          ...
          w = (0, a.visit)(n, {
            ...
            FragmentDefinition: {
              enter: function(e, n, r, t) {
                _.set(JSON.stringify(t), e)
              },
              leave: function(e, n, r, t) {
                return e === _.get(JSON.stringify(t)) ? e : l > 0 && e.selectionSet.selections.every(function(e) {
