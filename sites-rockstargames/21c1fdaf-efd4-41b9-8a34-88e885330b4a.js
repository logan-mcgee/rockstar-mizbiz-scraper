...
_global.SENTRY_RELEASE = {
  ...
  [9154], {
    ...
    18040: (t, r, e) => {
      ...
      t.exports = function(t, r) {
        var e = a(t),
          ...
          y = d.length;
        for (var b in t) !r && !s.call(t, b) || l && ("length" == b || p && ("offset" == b || "parent" == b) || v && ("buffer" == b || "byteLength" == b || "byteOffset" == b) || i(b, y)) || d.push(b);
        return d
      }
    },
    10561: t => {
    ...
    18560: (t, r, e) => {
      ...
      E[A] = E["[object Array]"] = E["[object ArrayBuffer]"] = E["[object DataView]"] = E["[object Boolean]"] = E["[object Date]"] = E["[object Float32Array]"] = E["[object Float64Array]"] = E["[object Int8Array]"] = E["[object Int16Array]"] = E["[object Int32Array]"] = E["[object Map]"] = E["[object Number]"] = E[M] = E["[object RegExp]"] = E["[object Set]"] = E["[object String]"] = E["[object Symbol]"] = E["[object Uint8Array]"] = E["[object Uint8ClampedArray]"] = E["[object Uint16Array]"] = E["[object Uint32Array]"] = !0, E["[object Error]"] = E[S] = E["[object WeakMap]"] = !1, t.exports = function t(r, e, I, P, T, k) {
        ...
        if (N) {
          ...
          if (g(r)) return u(r, C);
          if ($ == M || $ == A || D && !T) {
            if (z = F || D ? {} : h(r), !C) return F ? p(r, i(z, r)) : f(r, c(z, r))
          } else {
            if (!E[$]) return T ? r : {};
            z = b(r, $, C)
          }
    ...
    23510: (t, r, e) => {
      ...
      t.exports = function(t) {
        return !(!a(t) || o(t)) && (n(t) ? v : i).test(c(t))
      }
    },
    76229: (t, r, e) => {
      var n = e(83608),
    ...
    57097: (t, r, e) => {
      ...
      t.exports = function t(r, e, f, p, v) {
        r !== e && a(e, (function(a, u) {
          if (v || (v = new n), i(a)) c(r, e, u, f, t, p, v);
          else {
        ...
        if (O) n(t, e, O);
          ...
          if (S) {
            var M = s(w),
              E = !M && p(w),
              I = !M && !E && y(w);
            A = w, M || E || I ? s(m) ? A = m : f(m) ? A = c(m) : E ? (S = !1, A = o(w, !0)) : I ? (S = !1, A = a(w, !0)) : A = [] : d(w) || u(w) ? (A = m, u(m) ? A = h(m) : l(m) && !v(m) || (A = i(w))) : S = !1
          }
    ...
    88049: (t, r, e) => {
      ...
      t.exports = function(t, r, e, u) {
        ...
        for (var s = -1, f = (r = o(r, t)).length, p = f - 1, v = t; null != v && ++s < f;) {
          ...
          if (s != p) {
            var y = v[l];
            void 0 === (d = u ? u(y, l, v) : void 0) && (d = c(y) ? y : a(r[s + 1]) ? [] : {})
          }
          n(v, l, d), v = v[l]
        }
        return t
    ...
    83608: (t, r, e) => {
      var n = e(67585),
        ...
        g = s(i),
        j = u;
      (n && j(new n(new ArrayBuffer(1))) != d || o && j(new o) != f || a && j(a.resolve()) != p || c && j(new c) != v || i && j(new i) != l) && (j = function(t) {
        var r = u(t),
    ...
    80098: (t, r, e) => {
      ...
      t.exports = function(t, r, e) {
        ...
        return r = a(r) || 0, n(e) && (y = !!e.leading, f = (b = "maxWait" in e) ? c(a(e.maxWait) || 0, r) : f, h = "trailing" in e ? !!e.trailing : h), m.cancel = function() {
    ...
    4255: (t, r, e) => {
      ...
      function u(...t) {
        ...
        for (let e = 1; e < t.length; e++) {
          ...
          for (const t in n) {
            const e = r[t],
              a = n[t];
            "function" == typeof e && "function" == typeof a && "o" === t[0] && "n" === t[1] && t.charCodeAt(2) >= 65 && t.charCodeAt(2) <= 90 ? r[t] = i(e, a) : "className" !== t && "UNSAFE_className" !== t || "string" != typeof e || "string" != typeof a ? "id" === t && e && a ? r.id = c(e, a) : r[t] = void 0 !== a ? a : e : r[t] = (0, o.A)(e, a)
          }
        }
        return r
      }
      ...
      const {
        ...
        const i = d(y(a * a - c)),
          u = a ? Math.atan(y(-c) / a) : -b / 2;
        let s;
        return s = e < 0 ? (a > 0 ? 2 * b : b) - u : o < 0 ? (a > 0 ? 2 * b : -3 * b) + u : (a > 0 ? 0 : b) + u, 2 * i * Math.cos(s / 3) - o
