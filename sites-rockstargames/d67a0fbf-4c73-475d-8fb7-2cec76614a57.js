! function() {
  try {
    var n = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      f = (new Error).stack;
    f && (n._sentryDebugIds = n._sentryDebugIds || {}, n._sentryDebugIds[f] = "d67a0fbf-4c73-475d-8fb7-2cec76614a57", n._sentryDebugIdIdentifier = "sentry-dbid-d67a0fbf-4c73-475d-8fb7-2cec76614a57")
  } catch (n) {}
}();
  ...
  [2475], {
    54152: (n, f, r) => {
      ...
      var S, O = /(\u000D|\u000C|\u000D\u000A)/g,
        ...
        M = function(n, f) {
          if (n.length <= f || !j(n, f)) return null;
          for (var r = [], d = n.charCodeAt(f); f < n.length; d = n.charCodeAt(++f))
            if (45 === d || 95 === d || d >= 65 && d <= 90 || d >= 97 && d <= 122 || d >= 128 || d >= 48 && d <= 57) r.push(d);
            else {
              var o = R(n, f);
        ...
        W = function(n) {
          ...
          if ("<at-keyword-token>" === f[0].type && "media" === f[0].value) {
            ...
            for (var o = 2; o < f.length - 1; o++) {
              ...
              if ("<semicolon-token>" === e.type) throw V("Expected '{' in media query but found ';'")
            }
          }
          return f = f.slice(r, d), Z(f)
        },
        X = function(n) {
        ...
        Z = function(n) {
          ...
          if (0 === u.length) throw V("No valid media queries");
          return u
        },
        Q = function(n) {
          var f = n[0];
          if ("<(-token>" === f.type) try {
            ...
            "only" !== o && "not" !== o || (r = o);
            var e = null === r ? 0 : 1;
            if (n.length <= e) throw V("Expected extra token in media query");
            var A = n[e];
            ...
            if (!(e + 4 < n.length)) throw V("Expected media condition after media prefix");
            var c = n[e + 1];
            ...
            try {
              return {
                mediaPrefix: r,
                mediaType: d,
                mediaCondition: G(n.slice(e + 2), !1)
              }
            } catch (n) {
        ...
        G = function n(f, r, d) {
          ...
          var y = f.slice(0, e + 1);
          if (o = 1 === A ? Y(y) : "<ident-token>" === y[1].type && "not" === y[1].value ? n(y.slice(2, -1), !0, "not") : n(y.slice(1, -1), !0), e === f.length - 1) return {
            operator: d,
            children: [o]
          };
          var B = f[e + 1];
      ...
      function fn(n) {
        for (var f = 1; f < arguments.length; f++) {
          ...
          f % 2 ? nn(Object(r), !0).forEach((function(f) {
            var d, o, e;
            d = n, o = f, e = r[f], (o = K(o)) in d ? Object.defineProperty(d, o, {
              value: e,
              enumerable: !0,
              configurable: !0,
              writable: !0
    ...
    21166: (n, f, r) => {
      ...
      var d = r(53178),
        ...
        C = r(31611),
        l = {};
      l.styleTagTransform = b(), l.setAttributes = y(), l.insert = u().bind(null, "head"), l.domAPI = A(), l.insertStyleElement = _(), o()(C.A, l), C.A && C.A.locals && C.A.locals
    },
    58858: n => {
      "use strict";
    ...
    42475: (n, f, r) => {
      ...
      var d = r(73855),
        ...
        l = r(32695),
        s = {};
      s.styleTagTransform = C(), s.setAttributes = B(), s.insert = c().bind(null, "head"), s.domAPI = a(), s.insertStyleElement = t(), e()(l.A, s), l.A && l.A.locals && l.A.locals;
      var i = r(5922),
        E = {};
      E.styleTagTransform = C(), E.setAttributes = B(), E.insert = c().bind(null, "head"), E.domAPI = a(), E.insertStyleElement = t(), e()(i.A, E), i.A && i.A.locals && i.A.locals;
      var p = r(96049),
        v = {};
      v.styleTagTransform = C(), v.setAttributes = B(), v.insert = c().bind(null, "head"), v.domAPI = a(), v.insertStyleElement = t(), e()(p.A, v), p.A && p.A.locals && p.A.locals;
      var h = r(57403),
        g = {};
      g.styleTagTransform = C(), g.setAttributes = B(), g.insert = c().bind(null, "head"), g.domAPI = a(), g.insertStyleElement = t(), e()(h.A, g), h.A && h.A.locals && h.A.locals, r(54152), r(21166);
      var m = r(22323),
        w = r(77997),
        k = {};
      k.styleTagTransform = C(), k.setAttributes = B(), k.insert = c().bind(null, "head"), k.domAPI = a(), k.insertStyleElement = t(), e()(w.A, k), w.A && w.A.locals && w.A.locals;
      var x = {
        ...
        z = "--foundry_65afb887",
        I = "foundry_91ebb51_nu8bkp0",
        j = r(62229);
      const R = (0, j.createContext)({
          colorScheme: "dark",
      ...
      var N = r(2719);
      const T = (n, f) => "dark" === n ? "more" === f ? S : q : "more" === f ? P : O;
      var M = r(95983);
        ...
        U = (0, j.forwardRef)((({
          ...
          const C = (0, j.useRef)(null),
            ...
            s = (0, j.useRef)(r),
            {
              ...
              const f = (0, j.useMemo)((() => ({
                ...
                [d, o] = (0, j.useState)(n.platformScale || n.defaultPlatformScale),
                e = (0, j.useRef)([]),
                A = () => {
                  if (!M.X3) {
                    for (const {
              ...
              return (0, j.useEffect)((() => (n.platformScale ? o(n.platformScale) : (() => {
                if (!M.X3) {
                  A();
                  for (const n in r) {
            ...
            }),
            {
              ...
              const o = (0, N.Ub)("(prefers-color-scheme: light)"),
                e = (0, N.Ub)("(prefers-color-scheme: dark)"),
                A = (0, N.Ub)("(prefers-contrast: more)"),
                a = "system" !== n && n || o && "light" || e && "dark" || f,
                u = r || A && "more" || d,
                c = (0, j.useMemo)((() => T(a, u)), [a, u]),
                y = (0, j.useMemo)((() => ((n, f) => {
                  const r = T(n, f);
          ...
          return ((n, f, r, d, o) => {
            const e = (0, N.ZC)(o),
              A = (0, N.ZC)(n.current);
            (0, j.useEffect)((() => {
              n.current?.classList.contains(I) || n.current?.classList.add(I), n.current?.classList.add(r), n.current?.classList.remove(...d), e && o && n.current?.classList.contains(e) ? n.current?.classList.replace(e, o) : e && !o && n.current?.classList.contains(e) ? n.current?.classList.remove(e) : o && n.current?.classList.add(o)
            }), [r, o]), (0, j.useEffect)((() => {
              n.current?.style.setProperty(z, f.toString())
            }), [f]), (0, j.useEffect)((() => {
              A?.classList.remove(I), A?.classList.remove(r), A?.style.removeProperty(z), o && A?.classList.remove(o)
            }), [A])
          })(o ? C : s, i, p, v, f), (0, d.jsx)(R.Provider, {
            value: {
              locale: t,
              defaultColorScheme: A,
              colorScheme: h,
