try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    l = (new e.Error).stack;
  l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "fec178f4-0068-4c60-9e96-c32d8785e73a", e._sentryDebugIdIdentifier = "sentry-dbid-fec178f4-0068-4c60-9e96-c32d8785e73a")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [5377], {
    5377: (e, l, a) => {
      ...
      k.displayName = "CircleHelp", k.categories = ["accessibility", "text", "notifications"], k.tags = ["question mark", "help", "support", "assistance", "doubt", "FAQ", "tooltip"], k.SM = G, k.LG = N, k.MD = X, k.XL = q;
      ...
      E.displayName = "Sun", E.categories = ["accessibility", "weather", "seasons", "sustainability"], E.tags = ["brightness", "weather", "light", "summer", "day", "lightness", "theme", "brightness"], E.SM = F, E.LG = P, E.MD = O, E.XL = T;
      const U = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Ge.displayName = "FlagOff", Ge.categories = ["account", "social"], Ge.tags = ["unflag"], Ge.SM = Be, Ge.LG = Se, Ge.XL = ye, Ge.MD = De;
      ...
      Fe.displayName = "CircleSlash", Fe.categories = ["account"], Fe.tags = ["cancel", "no", "stop", "forbidden", "prohibited", "error", "incorrect", "mistake", "wrong", "failure", "circle", "slash", "null", "void", "ban", "Blocked", "Restricted", "Denied", "Unavailable", "Stop", "Alert"], Fe.SM = Ne, Fe.LG = Xe, Fe.XL = qe, Fe.MD = ke;
      ...
      Pl.displayName = "Handshake", Pl.categories = ["account", "social", "communication", "finance", "security"], Pl.tags = ["agreement", "partnership", "deal", "business", "assistance", "cooperation", "friendship", "union", "terms"], Pl.SM = Xl, Pl.LG = ql, Pl.XL = kl, Pl.MD = Fl;
      ...
      Ha.displayName = "ArrowUp", Ha.categories = ["arrows", "navigation"], Ha.tags = ["forward", "direction", "north", "increase"], Ha.SM = Ra, Ha.LG = La, Ha.MD = za, Ha.XL = Ca;
      ...
      Sa.displayName = "ArrowLeft", Sa.categories = ["arrows", "navigation"], Sa.tags = ["previous", "back", "direction", "west", "<-", "Left", "Navigation", "Back"], Sa.SM = Aa, Sa.LG = Va, Sa.MD = Ia, Sa.XL = Ba;
      ...
      Xa.displayName = "ArrowUpDown", Xa.categories = ["arrows", "navigation"], Xa.tags = ["bidirectional", "two-way", "2-way", "swap", "switch", "network", "mobile data", "internet", "sort", "reorder", "move", "Sortable", "Control", "Filter", "Sort"], Xa.SM = ya, Xa.LG = Da, Xa.MD = Ga, Xa.XL = Na;
      ...
      Oa.displayName = "ArrowRightLeft", Oa.categories = ["arrows", "navigation"], Oa.tags = ["bidirectional", "two-way", "2-way", "swap", "switch", "transaction", "reorder", "move", "<-", "->"], Oa.SM = qa, Oa.LG = ka, Oa.MD = Fa, Oa.XL = Pa;
      ...
      Wa.displayName = "ChevronUp", Wa.categories = ["arrows", "navigation", "math", "gaming"], Wa.tags = ["caret", "keyboard", "mac", "control", "ctrl", "superscript", "exponential", "power", "ahead", "fast", "^", "dropdown", "up", "direction", "top"], Wa.SM = Ta, Wa.LG = Ea, Wa.MD = Ua, Wa.XL = _a;
      ...
      Ja.displayName = "ArrowDown", Ja.categories = ["arrows", "navigation"], Ja.tags = ["backwards", "reverse", "direction", "south", "Down", "Navigation", "Decrease"], Ja.SM = Za, Ja.LG = Ya, Ja.MD = Ka, Ja.XL = Qa;
      ...
      rr.displayName = "ArrowRight", rr.categories = ["arrows", "navigation"], rr.tags = ["forward", "next", "direction", "east", "->"], rr.SM = $a, rr.LG = er, rr.MD = lr, rr.XL = ar;
      ...
      or.displayName = "ChevronDown", or.categories = ["arrows", "navigation", "gaming"], or.tags = ["backwards", "reverse", "slow", "dropdown", "down", "direction", "bottom"], or.SM = tr, or.LG = sr, or.MD = ir, or.XL = dr;
      ...
      wr.displayName = "ChevronLeft", wr.categories = ["arrows", "navigation"], wr.tags = ["back", "previous", "less than", "fewer", "menu", "left", "direction", "side"], wr.SM = nr, wr.LG = hr, wr.MD = cr, wr.XL = fr;
      ...
      mr.displayName = "ChevronRight", mr.categories = ["arrows", "navigation", "math", "development"], mr.tags = ["forward", "next", "more than", "greater", "menu", "code", "coding", "command line", "terminal", "prompt", "shell", "right", "direction", "side"], mr.SM = vr, mr.LG = xr, mr.MD = gr, mr.XL = jr;
      ...
      Rr.displayName = "ChevronsDownUp", Rr.categories = ["arrows"], Rr.tags = ["collapse", "fold", "vertical"], Rr.SM = pr, Rr.LG = ur, Rr.MD = br, Rr.XL = Mr;
      ...
      Ar.displayName = "CloudUpload", Ar.categories = ["arrows", "files"], Ar.tags = ["file"], Ar.SM = Lr, Ar.LG = zr, Ar.MD = Cr, Ar.XL = Hr;
      const Vr = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yr.displayName = "ChevronsLeftRight", yr.categories = ["arrows"], yr.tags = ["expand", "horizontal", "unfold"], yr.SM = Vr, yr.LG = Ir, yr.MD = Br, yr.XL = Sr;
      ...
      qr.displayName = "ChevronFirst", qr.categories = ["arrows", "multimedia"], qr.tags = ["previous", "music"], qr.SM = Dr, qr.LG = Gr, qr.MD = Nr, qr.XL = Xr;
      const kr = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...s
      ...
      Tr.displayName = "ChevronLast", Tr.categories = ["arrows", "multimedia"], Tr.tags = ["skip", "next", "music"], Tr.SM = kr, Tr.LG = Fr, Tr.MD = Pr, Tr.XL = Or;
      ...
      Zr.displayName = "ChevronsUpDown", Zr.categories = ["arrows"], Zr.tags = ["expand", "unfold", "vertical"], Zr.SM = Er, Zr.LG = Ur, Zr.MD = _r, Zr.XL = Wr;
      ...
      $r.displayName = "CloudDownload", $r.categories = ["arrows", "files"], $r.tags = ["import"], $r.SM = Yr, $r.LG = Kr, $r.MD = Qr, $r.XL = Jr;
      ...
      tt.displayName = "Maximize2", tt.categories = ["arrows", "layout", "design"], tt.tags = ["fullscreen", "arrows", "expand"], tt.SM = et, tt.LG = lt, tt.MD = at, tt.XL = rt;
      ...
      nt.displayName = "Upload", nt.categories = ["arrows", "files"], nt.tags = ["file", "up", "file", "share"], nt.SM = st, nt.LG = it, nt.MD = dt, nt.XL = ot;
      ...
      vt.displayName = "Download", vt.categories = ["arrows", "files"], vt.tags = ["import", "export", "save", "down"], vt.SM = ht, vt.LG = ct, vt.MD = ft, vt.XL = wt;
      ...
      pt.displayName = "ExternalLink", pt.categories = ["arrows", "text", "social"], pt.tags = ["outbound", "share", "link", "new tab", "new window", "open", "URL", "hyperlink", "external"], pt.SM = xt, pt.LG = gt, pt.MD = jt, pt.XL = mt;
      ...
      Lt.displayName = "RefreshCw", Lt.categories = ["arrows"], Lt.tags = ["rotate", "reload", "rerun", "synchronise", "synchronize", "arrows", "circular", "cycle", "loop", "repeat", "sync", "update", "reset", "restore"], Lt.SM = ut, Lt.LG = bt, Lt.MD = Mt, Lt.XL = Rt;
      ...
      Vt.displayName = "Replay", Vt.categories = ["arrows", "design", "photography"], Vt.tags = ["arrow", "right", "clockwise", "refresh", "reload", "rerun", "redo"], Vt.SM = zt, Vt.LG = Ct, Vt.MD = Ht, Vt.XL = At;
      ...
      Dt.displayName = "Undo", Dt.categories = ["text", "arrows"], Dt.tags = ["redo", "rerun", "history", "back", "return", "reverse", "revert", "direction", "u-turn", "undo", "arrow", "navigation"], Dt.SM = It, Dt.LG = Bt, Dt.MD = St, Dt.XL = yt;
      ...
      kt.displayName = "RefreshCwOff", kt.categories = ["arrows"], kt.tags = ["rotate", "reload", "rerun", "synchronise", "synchronize", "arrows", "circular", "cycle", "cancel", "no", "stop", "error", "disconnect", "ignore"], kt.SM = Gt, kt.LG = Nt, kt.MD = Xt, kt.XL = qt;
      ...
      Et.displayName = "Minimize2", Et.categories = ["arrows", "layout", "design"], Et.tags = ["exit fullscreen", "arrows", "close", "shrink"], Et.SM = Ft, Et.LG = Pt, Et.MD = Ot, Et.XL = Tt;
      const Ut = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Yt.displayName = "House", Yt.categories = ["buildings", "home"], Yt.tags = ["home", "living", "building", "residence", "architecture", "property", "homepage", "city"], Yt.SM = Ut, Yt.LG = _t, Yt.MD = Wt, Yt.XL = Zt;
      ...
      es.displayName = "Property", es.categories = ["account", "buildings"], es.tags = ["organization", "building", "house", "city", "GTAO", "structure"], es.SM = Kt, es.LG = Qt, es.MD = Jt, es.XL = $t;
      ...
      ss.displayName = "Store", ss.categories = ["buildings", "navigation", "shopping"], ss.tags = ["shop", "supermarket", "stand", "boutique", "building"], ss.SM = ls, ss.LG = as, ss.MD = rs, ss.XL = ts;
      ...
      hs.displayName = "ChartSpline", hs.categories = ["charts"], hs.tags = ["statistics", "analytics", "diagram", "graph", "curve", "continuous", "smooth", "polynomial", "quadratic", "function", "interpolation"], hs.SM = is, hs.LG = ds, hs.MD = os, hs.XL = ns;
      ...
      xs.displayName = "PaperPlane", xs.categories = ["mail", "communication", "connectivity"], xs.tags = ["email", "message", "mail", "paper airplane", "paper aeroplane", "submit", "send"], xs.SM = cs, xs.LG = fs, xs.MD = ws, xs.XL = vs;
      ...
      us.displayName = "Volume", us.categories = ["connectivity", "communication", "multimedia"], us.tags = ["music", "sound", "mute", "speaker"], us.SM = gs, us.LG = js, us.MD = ms, us.XL = ps;
      ...
      zs.displayName = "Volume1", zs.categories = ["connectivity", "communication", "multimedia"], zs.tags = ["music", "sound", "speaker", "control", "volume", "low"], zs.SM = bs, zs.LG = Ms, zs.MD = Rs, zs.XL = Ls;
      const Cs = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Is.displayName = "Volume2", Is.categories = ["connectivity", "communication", "multimedia"], Is.tags = ["music", "sound", "speaker", "control", "volume", "high"], Is.SM = Cs, Is.LG = Hs, Is.MD = As, Is.XL = Vs;
      const Bs = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Gs.displayName = "VolumeX", Gs.categories = ["connectivity", "communication", "multimedia"], Gs.tags = ["music", "sound", "mute", "speaker", "control", "volume"], Gs.SM = Bs, Gs.LG = Ss, Gs.MD = ys, Gs.XL = Ds;
      ...
      Fs.displayName = "Headset", Fs.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], Fs.tags = ["music", "audio", "sound", "gaming", "headphones", "headset", "call", "center", "phone", "telephone", "voip", "video"], Fs.SM = Ns, Fs.LG = Xs, Fs.MD = qs, Fs.XL = ks;
      ...
      Us.displayName = "Power", Us.categories = ["connectivity"], Us.tags = ["on", "off", "device", "switch", "toggle", "binary", "boolean", "reboot", "restart", "button", "keyboard", "troubleshoot"], Us.SM = Ps, Us.LG = Os, Us.MD = Ts, Us.XL = Es;
      ...
      Ks.displayName = "Wifi", Ks.categories = ["connectivity", "devices"], Ks.tags = ["connection", "signal", "wireless", "internet", "technology", "network"], Ks.SM = _s, Ks.LG = Ws, Ks.MD = Zs, Ks.XL = Ys;
      ...
      li.displayName = "WifiOff", li.categories = ["connectivity", "devices"], li.tags = ["disabled", "connection", "internet", "wireless", "technology", "network", "signal", "no", "off"], li.SM = Qs, li.LG = Js, li.MD = $s, li.XL = ei;
      ...
      ii.displayName = "Monitor", ii.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], ii.tags = ["tv", "computer", "screen", "display", "virtual machine"], ii.SM = ai, ii.MD = ri, ii.LG = ti, ii.XL = si;
      ...
      ci.displayName = "Pencil", ci.categories = ["design", "cursors", "tools", "text"], ci.tags = ["rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist", "update", "correct", "modify", "note"], ci.SM = di, ci.LG = oi, ci.MD = ni, ci.XL = hi;
      ...
      gi.displayName = "PencilOff", gi.categories = ["design", "cursors", "tools", "text"], gi.tags = ["disabled", "inactive", "non-editable", "locked", "read-only", "unmodifiable", "frozen", "restricted", "rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist"], gi.SM = fi, gi.LG = wi, gi.MD = vi, gi.XL = xi;
      ...
      bi.displayName = "Plus", bi.categories = ["math", "tools", "development", "text", "cursors", "gaming"], bi.tags = ["add", "new", "increase", "increment", "positive", "calculate", "toolbar", "crosshair", "aim", "target", "scope", "sight", "reticule", "maximum", "upgrade", "extra", "+", "more", "create", "navigation"], bi.SM = ji, bi.LG = mi, bi.MD = pi, bi.XL = ui;
      ...
      Ci.displayName = "LayoutGrid", Ci.categories = ["design", "layout"], Ci.tags = ["app", "home", "start", "squares", "hub", "menu", "blocks", "options", "items", "gallery"], Ci.SM = Mi, Ci.LG = Ri, Ci.MD = Li, Ci.XL = zi;
      ...
      Bi.displayName = "Maximize", Bi.categories = ["layout", "design"], Bi.tags = ["full screen", "expand", "dashed", "maximum", "big", "large"], Bi.SM = Hi, Bi.LG = Ai, Bi.MD = Vi, Bi.XL = Ii;
      ...
      Ni.displayName = "Minimize", Ni.categories = ["layout", "design"], Ni.tags = ["exit", "full screen", "close", "shrink", "window", "reduce", "video playback"], Ni.SM = Si, Ni.LG = yi, Ni.MD = Di, Ni.XL = Gi;
      ...
      Pi.displayName = "Cpu", Pi.categories = ["devices"], Pi.tags = ["processor", "cores", "technology", "computer", "chip", "circuit", "memory", "ram", "specs", "gigahertz", "ghz"], Pi.SM = Xi, Pi.MD = qi, Pi.LG = ki, Pi.XL = Fi;
      ...
      _i.displayName = "Calendar", _i.categories = ["time"], _i.tags = ["date", "month", "year", "event", "birthday", "birthdate"], _i.SM = Oi, _i.LG = Ti, _i.MD = Ei, _i.XL = Ui;
      ...
      Qi.displayName = "CalendarOff", Qi.categories = ["time"], Qi.tags = ["date", "day", "month", "year", "event", "delete", "remove"], Qi.SM = Wi, Qi.LG = Zi, Qi.MD = Yi, Qi.XL = Ki;
      const Ji = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ad.displayName = "Clock", ad.categories = ["time"], ad.tags = ["time", "watch", "alarm", "hour", "minute", "second", "planned", "watch"], ad.SM = Ji, ad.LG = $i, ad.MD = ed, ad.XL = ld;
      ...
      dd.displayName = "Clipboard", dd.categories = ["text"], dd.tags = ["copy", "paste"], dd.SM = rd, dd.LG = td, dd.MD = sd, dd.XL = id;
      ...
      fd.displayName = "Copy", fd.categories = ["text"], fd.tags = ["clone", "duplicate", "multiple"], fd.SM = od, fd.LG = nd, fd.MD = hd, fd.XL = cd;
      ...
      jd.displayName = "List", jd.categories = ["text"], jd.tags = ["options", "index", "table of contents", "menu", "side nav", "navigation", "bullet", "to do"], jd.SM = wd, jd.LG = vd, jd.MD = xd, jd.XL = gd;
      ...
      Md.displayName = "ListFilter", Md.categories = ["text"], Md.tags = ["options"], Md.SM = md, Md.LG = pd, Md.MD = ud, Md.XL = bd;
      const Rd = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Hd.displayName = "Unlink", Hd.categories = ["text"], Hd.tags = ["url", "unchain"], Hd.SM = Rd, Hd.LG = Ld, Hd.MD = zd, Hd.XL = Cd;
      ...
      Sd.displayName = "Trophy", Sd.categories = ["sports", "gaming"], Sd.tags = ["prize", "sports", "winner", "achievement", "award", "champion", "celebration", "victory"], Sd.SM = Ad, Sd.LG = Vd, Sd.MD = Id, Sd.XL = Bd;
      ...
      Xd.displayName = "Discord", Xd.categories = ["brands", "social"], Xd.tags = ["Social media", "Video", "Player", "Game", "Community", "App", "Share", "Logo"], Xd.SM = yd, Xd.LG = Dd, Xd.MD = Gd, Xd.XL = Nd;
      ...
      Od.displayName = "Instagram", Od.categories = ["brands", "social", "photography"], Od.tags = ["logo", "camera", "social media", "photo", "camera", "app", "share"], Od.SM = qd, Od.LG = kd, Od.MD = Fd, Od.XL = Pd;
      ...
      Wd.displayName = "Facebook", Wd.categories = ["social", "brands"], Wd.tags = ["logo", "social media", "profile", "feed", "app", "share"], Wd.SM = Td, Wd.LG = Ed, Wd.MD = Ud, Wd.XL = _d;
      ...
      Jd.displayName = "Twitch", Jd.categories = ["brands", "social", "account", "gaming"], Jd.tags = ["logo", "social", "social media", "streaming", "game", "app", "share"], Jd.SM = Zd, Jd.LG = Yd, Jd.MD = Kd, Jd.XL = Qd;
      ...
      ro.displayName = "Youtube", ro.categories = ["multimedia", "social", "brands"], ro.tags = ["logo", "social", "video", "play", "video", "player", "app", "share"], ro.SM = $d, ro.LG = eo, ro.MD = lo, ro.XL = ao;
      ...
      no.displayName = "Twitter", no.categories = ["brands", "social", "account"], no.tags = ["logo", "social", "social media", "twitter", "tweet", "app", "share", "x"], no.SM = to, no.LG = so, no.MD = io, no.XL = oo;
      ...
      vo.displayName = "Tiktok", vo.categories = ["brands", "social"], vo.tags = ["Social media", "video", "player", "game", "community", "app", "share", "logo", "photo", "camera"], vo.SM = ho, vo.MD = co, vo.LG = fo, vo.XL = wo;
      ...
      po.displayName = "Reddit", po.categories = ["social", "brands"], po.tags = ["logo", "social media", "profile", "feed", "app", "share", "forum", "community"], po.SM = xo, po.MD = go, po.LG = jo, po.XL = mo;
      ...
      Lo.displayName = "EpicGames", Lo.categories = ["platform"], Lo.tags = ["games", "gaming", "social", "brand", "third party"], Lo.SM = uo, Lo.MD = bo, Lo.LG = Mo, Lo.XL = Ro;
      ...
      Vo.displayName = "Steam", Vo.categories = ["platform"], Vo.tags = ["games", "gaming", "social", "brand", "third party"], Vo.SM = zo, Vo.MD = Co, Vo.LG = Ho, Vo.XL = Ao;
      ...
      Do.displayName = "Xbox", Do.categories = ["platform"], Do.tags = ["games", "gaming", "social", "brand", "third party"], Do.SM = Io, Do.MD = Bo, Do.LG = So, Do.XL = yo;
      ...
      ko.displayName = "Car", ko.categories = ["transportation"], ko.tags = ["vehicle", "drive", "trip", "journey", "automobile", "GTAO", "transport"], ko.SM = Go, ko.LG = No, ko.MD = Xo, ko.XL = qo;
      ...
      Eo.displayName = "CarSide", Eo.categories = ["transportation"], Eo.tags = ["vehicle", "drive", "trip", "journey"], Eo.SM = Fo, Eo.LG = Po, Eo.MD = Oo, Eo.XL = To;
      const Uo = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Yo.displayName = "MessageSquareText", Yo.categories = ["social"], Yo.tags = ["comment", "chat", "conversation", "dialog", "feedback", "speech bubble", "clear", "close", "delete", "remove", "cancel", "silence", "mute", "moderate"], Yo.SM = Uo, Yo.LG = _o, Yo.MD = Wo, Yo.XL = Zo;
      ...
      en.displayName = "Search", en.categories = ["text", "social"], en.tags = ["find", "scan", "magnifier", "magnifying glass", "look", "view"], en.SM = Ko, en.LG = Qo, en.MD = Jo, en.XL = $o;
      ...
      sn.displayName = "PartialCircle", sn.categories = ["shapes"], sn.tags = ["Partial", "Half", "Middle", "Split"], sn.SM = ln, sn.LG = an, sn.MD = rn, sn.XL = tn;
      ...
      cn.displayName = "LockKeyhole", cn.categories = ["security"], cn.tags = ["security", "password", "secure", "admin", "lock", "safe", "protection", "security", "latch"], cn.SM = dn, cn.LG = on, cn.MD = nn, cn.XL = hn;
      ...
      gn.displayName = "LockPassword", gn.categories = ["security"], gn.tags = ["security", "password", "secure", "admin"], gn.SM = fn, gn.LG = wn, gn.MD = vn, gn.XL = xn;
      ...
      bn.displayName = "Image", bn.categories = ["photography", "text", "multimedia", "files"], bn.tags = ["picture", "photo"], bn.SM = jn, bn.LG = mn, bn.MD = pn, bn.XL = un;
      ...
      Cn.displayName = "Lightbulb", Cn.categories = ["photography"], Cn.tags = ["idea", "bright", "lights"], Cn.SM = Mn, Cn.LG = Rn, Cn.MD = Ln, Cn.XL = zn;
      ...
      Bn.displayName = "Check", Bn.categories = ["notifications"], Bn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "success", "accept"], Bn.SM = Hn, Bn.LG = An, Bn.MD = Vn, Bn.XL = In;
      ...
      Nn.displayName = "CircleCheck", Nn.categories = ["notifications"], Nn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], Nn.SM = Sn, Nn.LG = yn, Nn.MD = Dn, Nn.XL = Gn;
      ...
      Pn.displayName = "TriangleAlert", Pn.categories = ["notifications", "shapes", "development"], Pn.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], Pn.SM = Xn, Pn.LG = qn, Pn.MD = kn, Pn.XL = Fn;
      ...
      _n.displayName = "X", _n.categories = ["notifications", "math"], _n.tags = ["cancel", "close", "delete", "remove", "times", "clear", "math", "multiply", "multiplication", "error", "remove", "clean", "erase", "navigation", "cross", "times"], _n.SM = On, _n.LG = Tn, _n.MD = En, _n.XL = Un;
      ...
      Qn.displayName = "Globe", Qn.categories = ["navigation"], Qn.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], Qn.SM = Wn, Qn.LG = Zn, Qn.MD = Yn, Qn.XL = Kn;
      const Jn = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      ah.displayName = "HeartPulse", ah.categories = ["medical"], ah.tags = ["heartbeat", "pulse", "health", "medical", "blood pressure", "cardiac", "systole", "diastole"], ah.SM = Jn, ah.LG = $n, ah.MD = eh, ah.XL = lh;
      ...
      dh.displayName = "CircleMinus", dh.categories = ["math"], dh.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete"], dh.SM = rh, dh.LG = th, dh.MD = sh, dh.XL = ih;
      ...
      fh.displayName = "CircleX", fh.categories = ["math", "development"], fh.tags = ["cancel", "close", "delete", "remove", "times", "clear", "error", "incorrect", "wrong", "mistake", "failure", "linter", "multiply", "multiplication", "clean", "erase", "deprecate", "delete", "navigation"], fh.SM = oh, fh.LG = nh, fh.MD = hh, fh.XL = ch;
      ...
      jh.displayName = "Minus", jh.categories = ["math", "development", "text", "tools"], jh.tags = ["subtract", "remove", "decrease", "decrement", "reduce", "negative", "calculate", "line", "divider", "separator", "horizontal rule", "hr", "html", "markup", "markdown", "---", "toolbar", "operator", "code", "coding", "minimum", "downgrade", "less", "delete", "navigation", "minimize"], jh.SM = wh, jh.LG = vh, jh.MD = xh, jh.XL = gh;
      ...
      Mh.displayName = "EnvelopeOpen", Mh.categories = ["mail"], Mh.tags = ["email", "message", "letter", "read"], Mh.SM = mh, Mh.LG = ph, Mh.MD = uh, Mh.XL = bh;
      const Rh = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Hh.displayName = "Paperclip", Hh.categories = ["text", "design", "files", "mail"], Hh.tags = ["attachment", "file", "attach", "clip", "document", "paper"], Hh.SM = Rh, Hh.LG = Lh, Hh.MD = zh, Hh.XL = Ch;
      ...
      Sh.displayName = "Trash", Sh.categories = ["files", "mail"], Sh.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], Sh.SM = Ah, Sh.LG = Vh, Sh.MD = Ih, Sh.XL = Bh;
      ...
      Xh.displayName = "EllipsisVertical", Xh.categories = ["layout"], Xh.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], Xh.SM = yh, Xh.LG = Dh, Xh.MD = Gh, Xh.XL = Nh;
      ...
      Oh.displayName = "Filter", Oh.categories = ["layout"], Oh.tags = ["funnel", "hopper"], Oh.SM = qh, Oh.LG = kh, Oh.MD = Fh, Oh.XL = Ph;
      ...
      Wh.displayName = "Weapon", Wh.categories = ["gaming"], Wh.tags = ["gun", "pistol", "GTAO", "fire", "shoot", "death", "danger"], Wh.SM = Th, Wh.LG = Eh, Wh.MD = Uh, Wh.XL = _h;
      const Zh = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...s
      ...
      Jh.displayName = "Heart", Jh.categories = ["medical", "social", "multimedia", "emoji", "gaming", "shapes"], Jh.tags = ["like", "love", "emotion", "suit", "playing", "cards"], Jh.SM = Zh, Jh.LG = Yh, Jh.MD = Kh, Jh.XL = Qh;
      ...
      rc.displayName = "FileText", rc.categories = ["files", "text"], rc.tags = ["data", "txt", "pdf", "document"], rc.SM = $h, rc.LG = ec, rc.MD = lc, rc.XL = ac;
      ...
      oc.displayName = "Files", oc.categories = ["files"], oc.tags = ["multiple", "copy", "documents", "data", "file", "folder", "restore"], oc.SM = tc, oc.LG = sc, oc.MD = ic, oc.XL = dc;
      ...
      wc.displayName = "Save", wc.categories = ["files"], wc.tags = ["floppy disk", "download", "backup", "storage", "disk", "document", "computer", "archive"], wc.SM = nc, wc.MD = hc, wc.LG = cc, wc.XL = fc;
      ...
      mc.displayName = "CircleDollarSign", mc.categories = ["finance"], mc.tags = ["monetization", "marketing", "currency", "money", "payment"], mc.SM = vc, mc.LG = xc, mc.MD = gc, mc.XL = jc;
      ...
      Rc.displayName = "DollarSign", Rc.categories = ["finance"], Rc.tags = ["currency", "money", "payment"], Rc.SM = pc, Rc.LG = uc, Rc.MD = bc, Rc.XL = Mc;
      ...
      Ac.displayName = "FastForward", Ac.categories = ["multimedia", "arrows"], Ac.tags = ["music", "audio", "video", "control", "player", "media"], Ac.SM = Lc, Ac.LG = zc, Ac.MD = Cc, Ac.XL = Hc;
      const Vc = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      yc.displayName = "Pause", yc.categories = ["multimedia"], yc.tags = ["music", "audio", "video", "stop", "pause", "control", "player", "media"], yc.SM = Vc, yc.LG = Ic, yc.MD = Bc, yc.XL = Sc;
      ...
      qc.displayName = "Play", qc.categories = ["arrows", "multimedia"], qc.tags = ["music", "audio", "video", "start", "run", "play", "continue", "control", "player", "media"], qc.SM = Dc, qc.LG = Gc, qc.MD = Nc, qc.XL = Xc;
      ...
      Tc.displayName = "Rewind", Tc.categories = ["arrows", "multimedia"], Tc.tags = ["music", "audio", "video", "control", "player", "previous", "back", "reverse", "media"], Tc.SM = kc, Tc.LG = Fc, Tc.MD = Pc, Tc.XL = Oc;
      ...
      Zc.displayName = "SkipBack", Zc.categories = ["multimedia", "arrows"], Zc.tags = ["music", "audio", "video", "arrow", "previous", "back", "rewind", "reverse", "control", "player", "media"], Zc.SM = Ec, Zc.LG = Uc, Zc.MD = _c, Zc.XL = Wc;
      ...
      $c.displayName = "SkipForward", $c.categories = ["multimedia", "arrows"], $c.tags = ["music", "audio", "video", "arrow", "skip", "next", "forward", "control", "player", "media"], $c.SM = Yc, $c.LG = Kc, $c.MD = Qc, $c.XL = Jc;
      ...
      tf.displayName = "StarOff", tf.categories = ["multimedia", "social"], tf.tags = ["dislike", "unlike", "remove", "unrate"], tf.SM = ef, tf.LG = lf, tf.MD = af, tf.XL = rf;
      ...
      hf.displayName = "Stop", hf.categories = ["multimedia"], hf.tags = ["music", "audio", "video", "control", "player", "stop", "media"], hf.SM = sf, hf.LG = df, hf.MD = of, hf.XL = nf;
      ...
      xf.displayName = "ListMusic", xf.categories = ["multimedia"], xf.tags = ["playlist", "music", "audio", "control", "player", "media", "queue", "playback", "play", "list"], xf.SM = cf, xf.MD = ff, xf.LG = wf, xf.XL = vf;
      ...
      uf.displayName = "Book", uf.categories = ["text", "gaming"], uf.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], uf.SM = gf, uf.LG = jf, uf.MD = mf, uf.XL = pf;
      ...
      zf.displayName = "CloudAlert", zf.categories = ["development"], zf.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], zf.SM = bf, zf.LG = Mf, zf.MD = Rf, zf.XL = Lf;
      const Cf = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      If.displayName = "CodeXml", If.categories = ["text", "development"], If.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], If.SM = Cf, If.LG = Hf, If.MD = Af, If.XL = Vf;
      const Bf = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Gf.displayName = "Database", Gf.categories = ["devices", "development"], Gf.tags = ["storage", "memory", "container", "tin", "pot", "bytes", "servers"], Gf.SM = Bf, Gf.LG = Sf, Gf.MD = yf, Gf.XL = Df;
      ...
      Ff.displayName = "Server", Ff.categories = ["development", "devices"], Ff.tags = ["cloud", "storage"], Ff.SM = Nf, Ff.LG = Xf, Ff.MD = qf, Ff.XL = kf
    }
  }
]);