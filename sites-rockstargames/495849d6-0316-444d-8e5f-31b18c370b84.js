! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "495849d6-0316-444d-8e5f-31b18c370b84", e._sentryDebugIdIdentifier = "sentry-dbid-495849d6-0316-444d-8e5f-31b18c370b84")
  } catch (e) {}
}();
  ...
  [4981], {
    ...
    72558: (e, a, t) => {
      ...
      const l = e => {
        ...
        const {
          track: u
        } = (0, r.useGtmTrack)(), [f] = (0, i.useSearchParams)(), k = l.preview_images_parsed.newswire_block, b = {
    ...
    49853: (e, a, t) => {
      ...
      const p = (0, r.withTranslations)((e => {
        ...
        const {
          track: f
        } = (0, o.useGtmTrack)(), k = (0, r.useLocale)(), [b, v] = (0, i.useSearchParams)(), {
          tagId: j = null
        } = (0, i.useParams)(), [h, _] = (0, s.useState)(j ?? m ?? b.get("tag_id")), [x, N] = (0, s.useState)(1), [w, y] = (0, s.useState)(20), [S, z] = (0, s.useState)([]), [A, T] = (0, s.useState)(null), [V, {
          loading: F,
          data: D
        }] = (0, n.useLazyQuery)(l(), {
          variables: {
        ...
        return (0, s.useEffect)((() => {
          N(1), z([]), y(20), _(j ?? m ?? b.get("tag_id")), V()
        }), [b.get("tag_id"), j, m]), (0, s.useEffect)((() => {
          const e = S;
          D?.posts?.paging && T(D?.posts?.paging), D?.posts?.results && z(e.concat(D?.posts?.results))
        }), [D]), (0, s.useEffect)((() => {
          (() => {
            const e = b.get("page"),
              a = Number(e ?? 1);
    ...
    57928: (e, a, t) => {
      ...
      const p = (0, n.withLocale)((e => {
        ...
        const {
          ...
          setBodyIsLocked: u
        } = (0, n.useBodyScrollable)("VideoCarousel"), [f, k] = (0, s.useState)(0), [b, v] = (0, s.useState)(0), j = (0, s.useRef)(null), h = (0, s.useRef)(null);
        return (0, s.useEffect)((() => {
          ...
          const a = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
            ...
            s = () => {
              const e = f + 1 >= r.length - 1 ? r.length - 1 : f + 1;
              k(e), v(0)
            },
            i = e => {
