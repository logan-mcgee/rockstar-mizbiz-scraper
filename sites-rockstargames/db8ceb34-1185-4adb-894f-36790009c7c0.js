! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "db8ceb34-1185-4adb-894f-36790009c7c0", e._sentryDebugIdIdentifier = "sentry-dbid-db8ceb34-1185-4adb-894f-36790009c7c0")
  } catch (e) {}
}();
  ...
  [7048], {
    17048: function(e) {
      e.exports = function() {
        ...
        var h, y = M(Array.prototype.forEach),
          b = M(Array.prototype.pop),
          T = M(Array.prototype.push),
          v = M(String.prototype.toLowerCase),
          N = M(String.prototype.toString),
          E = M(String.prototype.match),
          _ = M(String.prototype.replace),
          A = M(String.prototype.indexOf),
          w = M(String.prototype.trim),
          S = M(RegExp.prototype.test),
        ...
        return function t() {
          ...
          var he, ye, be = j,
            ...
            Se = K,
            ke = null,
            Me = x({}, [].concat(r(L), r(D), r(R), r(F), r(H))),
            xe = null,
          ...
          var vt = function(e) {
            ...
            kt = function(e) {
              ...
              }(e) ? (vt(e), !0) : "noscript" !== n && "noembed" !== n && "noframes" !== n || !S(/<\/no(script|embed|frames)/i, e.innerHTML) ? (He && 3 === e.nodeType && (t = e.textContent, t = _(t, be, " "), t = _(t, Te, " "), t = _(t, ve, " "), e.textContent !== t && (T(o.removed, {
                element: e.cloneNode()
              ...
              if (l && !At(t)) {
                ...
                for (i = l.length; i--;) {
                  ...
                  if (r = "value" === u ? n.value : w(n.value), a = ye(u), c.attrName = a, c.attrValue = r, c.keepAttr = !0, c.forceKeepAttr = void 0, St("uponSanitizeAttribute", t, c), r = c.attrValue, !c.forceKeepAttr && (Nt(u, t), c.keepAttr))
                    if (Ue || !S(/\/>/i, r)) {
                      He && (r = _(r, be, " "), r = _(r, Te, " "), r = _(r, ve, " "));
                      var m = ye(t.nodeName);
                      if (Mt(m, a, r))
                        if (!$e || "id" !== a && "name" !== a || (Nt(u, t), r = "user-content-" + r), ze && S(/((--!?|])>)|<\/(style|title)/i, r)) Nt(u, t);
                        else {
                          if (ie && "object" === e(M) && "function" == typeof M.getAttributeType)
                            if (f);
                            else switch (M.getAttributeType(m, a)) {
                              case "TrustedHTML":
                                r = ie.createHTML(r);
                                break;
            ...
            Ct = function e(t) {
              var n, r = _t(t);
              for (St("beforeSanitizeShadowDOM", t, null); n = r.nextNode();) St("uponSanitizeShadowNode", n, null), kt(n), Ot(n), n.content instanceof l && e(n.content);
          ...
          return o.sanitize = function(t) {
            ...
            if (Pe || pt(m), o.removed = [], "string" == typeof t && (Ve = !1), Ve) {
              ...
              if (!(r = Et(t))) return je ? null : qe ? le : ""
            }
            r && Be && vt(r.firstChild);
            for (var p = _t(Ve ? t : r); c = p.nextNode();) 3 === c.nodeType && c === u || (kt(c), Ot(c), c.content instanceof l && Ct(c.content), u = c);
            ...
            return Ge && ke["!doctype"] && r.ownerDocument && r.ownerDocument.doctype && r.ownerDocument.doctype.name && S(Z, r.ownerDocument.doctype.name) && (g = "<!DOCTYPE " + r.ownerDocument.doctype.name + ">\n" + g), He && (g = _(g, be, " "), g = _(g, Te, " "), g = _(g, ve, " ")), ie && qe ? ie.createHTML(g) : g
