! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "467b1f99-eb69-4e35-a13f-940f962de971", e._sentryDebugIdIdentifier = "sentry-dbid-467b1f99-eb69-4e35-a13f-940f962de971")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [1739], {
    91739: (e, a, i) => {
      ...
      var v = i(91029);
      const p = (0, t.withTranslations)((e => {
          let {
            links: a,
            collectionId: i,
            name: r,
          ...
          const p = (0, d.useIntl)(),
            ...
            S = e => {
              (0, t.downloadFile)(e), y()
            },
            x = e => {
              "Escape" === e.key && b(!1)
            };
          (0, n.useEffect)((() => (f ? window.addEventListener("keyup", x) : window.removeEventListener("keyup", x), () => window.removeEventListener("keyup", x))), [x, f]), k().addHook("afterSanitizeAttributes", (function(e) {
            e.hasAttribute("target") && e.setAttribute("tabindex", f ? 0 : -1)
          })), (0, n.useEffect)((() => (f ? document.addEventListener("mousedown", _) : document.removeEventListener("mousedown", _), () => {
          ...
          const F = e => {
            ...
            if (a) {
              const e = a[1],
                i = a[2];
              return p.formatMessage(l.rockstargames_downloads_dimensions_label, {
                width: e,
                height: i
              })
            }
          ...
          let V = null;
          return V = o(), (0, v.jsx)("div", {
            ref: j,
            className: g.dropdownWrapper,
            children: (0, v.jsx)(V, {
              disabled: !f,
                ...
                children: [(0, v.jsx)("button", {
                  ...
                  children: (0, v.jsxs)("div", {
                    ...
                    children: [(0, v.jsx)("p", {
                      ...
                      className: [g.caret, f ? g.open : ""].join(" ")
                    })]
                  })
                }), (0, v.jsx)("ul", {
                  className: [g.list, f ? g.open : ""].join(" "),
                  children: h ? (0, v.jsx)(v.Fragment, {
                    ...
                    if ("thumb" !== e.label) return (0, v.jsx)("li", {
                      className: g.item,
                      children: (0, v.jsx)(s.A, {
                        to: e.src,
        ...
        f = (0, t.withTranslations)((e => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [(0, v.jsx)("h2", {
              ...
              className: g.grid,
              children: i.results.map((e => (0, v.jsxs)("div", {
                className: g.downloadItem,
        ...
        b = (0, t.withTranslations)((e => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [(0, v.jsx)("h2", {
              ...
              className: g.grid,
              children: a.apps.slice(0, i ? 4 : 100).map((e => (0, v.jsxs)("div", {
                className: g.downloadItem,
        ...
        N = e => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [(0, v.jsx)("h4", {
              ...
              className: g.grid,
              children: a.gold_bars.map((e => (0, v.jsxs)("div", {
                className: g.downloadItem,
                children: [(0, v.jsx)("div", {
                  className: g.img,
                  style: {
        ...
        h = e => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [(0, v.jsx)("h4", {
              ...
              className: g.grid,
              children: a.patches.map((e => (0, v.jsx)(s.A, {
                to: e.support_url,
                target: "_blank",
                "data-gtm-category": "Downloads",
        ...
        w = e => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [(0, v.jsx)("h4", {
              ...
              className: g.grid,
              children: a.shark_cards.map((e => (0, v.jsxs)("div", {
                className: g.downloadItem,
                children: [(0, v.jsx)("div", {
                  className: g.img,
                  style: {
        ...
        j = e => {
          ...
          return (0, n.useEffect)((() => {
            ...
            children: [(0, v.jsx)("h4", {
              ...
              children: (0, v.jsx)(s.A, {
                to: "/downloads",
                children: t.formatMessage(l.rockstargames_downloads_go_back)
              })
            }), (0, v.jsx)("h2", {
              className: g.sectionHeader,
              children: a.title
              ...
              className: g.grid,
              children: a.series.map((e => (0, v.jsx)(s.A, {
                to: `/downloads?collection=${a.id}&series=${e.id}`,
                "data-gtm-category": "Downloads",
                "data-gtm-action": `Collection : ${a.title}`,
                "data-gtm-label": e.title,
                "aria-label": t.formatMessage(l.rockstargames_downloads_collections_download_text, {
                  item: e.title,
                  collection: a.title
                }),
                children: (0, v.jsxs)("div", {
        ...
        x = (0, t.withTranslations)((e => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [(0, v.jsxs)("div", {
              className: [g.gridLarge, g.hero].join(" "),
              children: [(0, v.jsx)("div", {
                style: {
                  "--aspect-ratio": "1/1"
                },
                className: [g.img, g[i.titleSlug]].join(" ")
              }), (0, v.jsxs)("div", {
                className: g.featuredDesc,
                children: [(0, v.jsxs)("div", {
                  className: g.text,
                  children: [(0, v.jsx)("h2", {
                    children: i.title
              ...
              className: g.gridLarge,
              children: a.map((e => (0, v.jsx)(s.A, {
                to: e.href,
        ...
        F = (0, t.withTranslations)((e => {
          ...
          return (0, n.useEffect)((() => {
            ...
            children: [(0, v.jsxs)("div", {
              className: [g.sectionHeader, g.series].join(" "),
              children: [(0, v.jsx)("h4", {
                className: g.collectionTitle,
                children: (0, v.jsx)(s.A, {
                  to: `/downloads?collection=${a.id}`,
      ...
      const T = D.Downloads ?? A.Downloads,
        I = (0, t.withTranslations)((e => {
          let {
            t: a
          } = e;
          const {
            setBreadcrumb: i
          } = (0, V.b)(), d = (0, t.useQueryParams)(), [l, s] = (0, n.useState)(null), [r, m] = (0, n.useState)(null), {
            loading: c,
            refetch: o
          } = (0, t.useQuery)(T, {
            variables: l,
          ...
          if ((0, n.useEffect)((() => {
              ...
              s(a)
            }), [d.get("series"), d.get("collection"), m]), (0, n.useEffect)((() => {
              let e = [{
                href: "/downloads",
                title: a("Downloads")
              }];
              return r?.collection?.id && l.withSeries && (e = [...e, {
          ...
          if (l.withIndex) return (0, v.jsx)("div", {
            className: g.index,
            children: (0, v.jsxs)("div", {
          ...
          if (l.withSeries) {
            const e = [6, 12, 13].includes(l.collectionId) ? "1/1" : "16/9";
            return (0, v.jsx)("div", {
              className: g.index,
              children: (0, v.jsx)(F, {
          ...
          return l.withCollection ? (0, v.jsx)("div", {
            className: g.index,
            children: (0, v.jsx)(_, {
              collection: r.collection,
              games: r.pcMacGames
    ...
    57087: (e, a, i) => {
      ...
      const s = e => {
        ...
        const {
          ...
          let e = "";
          return a && (e = c ? i(75877)(`./${m}/mobile.png`) : i(55889)(`./${m}/desktop.png`)), e || (e = i(39294)(`./${m}.jpg`), e += `?im=Resize=${s}`), e
    ...
    55889: (e, a, i) => {
      ...
      t.keys = function() {
        return Object.keys(n)
      }, t.resolve = d, e.exports = t, t.id = 55889
    },
    75877: (e, a, i) => {
      var n = {
        "./VI/mobile.png": 96048
      ...
      t.keys = function() {
        return Object.keys(n)
      }, t.resolve = d, e.exports = t, t.id = 75877
    },
    10111: e => {
      "use strict";
