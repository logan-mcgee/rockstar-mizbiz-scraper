try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    n = (new e.Error).stack;
  n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "6e8bccc0-a834-4116-b8f4-30f619e3e749", e._sentryDebugIdIdentifier = "sentry-dbid-6e8bccc0-a834-4116-b8f4-30f619e3e749")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [2306], {
    62306: (e, n, r) => {
      ...
      r.r(n), r.d(n, {
        ...
        GetOption: () => zn,
        GetOptionsObject: () => Hn,
        GetStringOrBooleanOption: () => Gn,
        GetUnsignedRoundingMode: () => or,
        HasOwnProperty: () => gn,
        HourFromTime: () => Bn,
        InLeapYear: () => Nn,
        InitializeNumberFormat: () => Pr,
        ...
        SetNumberFormatUnitOptions: () => kr,
        SupportedLocales: () => Rr,
        TimeClip: () => cn,
        TimeFromYear: () => wn,
        ToIntlMathematicalValue: () => _r,
        ToNumber: () => an,
        ToObject: () => ln,
        ToPrimitive: () => _n,
        ToRawFixed: () => ar,
      ...
      function G(e, n) {
        ...
        if (null == n ? (g = !1, l = D) : l = n, v.precision = l += 10, t = (r = A(h)).charAt(0), !(Math.abs(u = p.e) < 15e14)) return c = R(v, l + 2, D).times(u + ""), p = G(new v(t + "." + r.slice(1)), l - 10).plus(c), v.precision = D, null == n ? k(p, D, y, g = !0) : p;
      ...
      function kn(e) {
        return hn(Math.floor(e / Mn), Tn)
      }

      function Pn(e) {
        return hn(Math.floor(e / In), An)
      }
      ...
      function yr(e, n, r, t) {
        ...
        if ("compact" === l && c && (m = function(e, n, r, t, i, u, o) {
            ...
            return "0" === a ? null : a = wr(a, l).replace(/([^\s;\-\+\d¤]+)/g, "{c:$1}").replace(/0+/, "0")
        ...
        o = m || ("decimal" === f || "unit" === f || "currency" === f && "name" === t.currencyDisplay ? wr((n.numbers.decimal[d] || n.numbers.decimal[g]).standard, s) : wr("currency" === f ? (v = n.numbers.currency[d] || n.numbers.currency[g])[t.currencySign] : n.numbers.percent[d] || n.numbers.percent[g], s));
        var h = vr.exec(o)[0];
        ...
        for (var w = o.split(/({c:[^}]+}|\{0\}|[¤%\-\+])/g), b = [], F = n.numbers.symbols[d] || n.numbers.symbols[g], E = 0, N = w; E < N.length; E++)
          if (z = N[E]) switch (z) {
            case "{0}":
              b.push.apply(b, Dr(F, e, l, a, d, !m && (null === (i = t.useGrouping) || void 0 === i || i), h, f, t.roundingIncrement, or(t.roundingMode, -1 === s)));
              break;
            case "-":
              b.push({
                type: "minusSign",
        ...
        switch (f) {
          case "currency":
            if ("name" === t.currencyDisplay) {
              ...
              C = x ? br(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), x.displayName) : t.currency;
          ...
          case "unit":
            var M = t.unit,
              O = t.unitDisplay,
              B = n.units.simple[M];
            if (S = void 0, B) S = br(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[M][O]);
            else {
              var k = M.split("-per-"),
                P = k[0],
                j = k[1];
              B = n.units.simple[P];
              var R = br(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[P][O]),
                L = n.units.simple[j].perUnit[O];
              if (L) S = L.replace("{0}", R);
              else {
                var _ = n.units.compound.per[O],
                  q = br(r, 1, n.units.simple[j][O]);
      ...
      function Pr(e, n, r, i) {
        ...
        g.nu = p;
        var h = (0, Mr.ResolveLocale)(Array.from(s), f, g, ["nu"], o, c),
          v = o[h.dataLocale];
        en(!!v, "Missing locale data for ".concat(h.dataLocale));
        var y = u(e);
        y.locale = h.locale, y.dataLocale = h.dataLocale, y.numberingSystem = h.nu, y.dataLocaleData = v, kr(y, d);
        var D, w, b = y.style,
        ...
        var S = Gn(d, "useGrouping", ["min2", "auto", "always"], "always", !1, C);
        y.useGrouping = S;
      ...
      function Rr(e, n, r) {
        return void 0 !== r && zn(r = ln(r), "localeMatcher", "string", ["lookup", "best fit"], "best fit"), (0, Mr.LookupSupportedLocales)(Array.from(e), n)
      }
      ...
      Ir = Error, (0, He.__extends)(function() {
          var e = null !== Ir && Ir.apply(this, arguments) || this;
