    ...
    62306: (e, n, r) => {
      ...
      var B = function() {
        ...
        return function(t, i, o, s, a, c) {
          var l, f, d, g, m, p, h, v, y, b, w, F, E, N, S, x, T, A, I, M, O = t.constructor,
            B = t.s == i.s ? 1 : -1,
            P = t.d,
            j = i.d;
          if (!(P && P[0] && j && j[0])) return new O(t.s && i.s && (P ? !j || P[0] != j[0] : j) ? P && 0 == P[0] || !j ? 0 * B : B / 0 : NaN);
          for (c ? (m = 1, f = t.e - i.e) : (c = C, m = 7, f = D(t.e / m) - D(i.e / m)), I = j.length, T = P.length, b = (y = new O(B)).d = [], d = 0; j[d] == (P[d] || 0); d++);
          if (j[d] > (P[d] || 0) && f--, null == o ? (N = o = O.precision, s = O.rounding) : N = a ? o + (t.e - i.e) + 1 : o, N < 0) b.push(1), p = !0;
          else {
            if (N = N / m + 2 | 0, d = 0, 1 == I) {
              for (g = 0, j = j[0], N++;
                (d < T || g) && N--; d++) S = g * c + (P[d] || 0), b[d] = S / j | 0, g = S % j | 0;
              p = g || d < T
            } else {
              for ((g = c / (j[0] + 1) | 0) > 1 && (j = e(j, g, c), P = e(P, g, c), I = j.length, T = P.length), x = I, F = (w = P.slice(0, I)).length; F < I;) w[F++] = 0;
              (M = j.slice()).unshift(0), A = j[0], j[1] >= c / 2 && ++A;
              do {
                g = 0, (l = n(j, w, I, F)) < 0 ? (E = w[0], I != F && (E = E * c + (w[1] || 0)), (g = E / A | 0) > 1 ? (g >= c && (g = c - 1), 1 == (l = n(h = e(j, g, c), w, v = h.length, F = w.length)) && (g--, r(h, I < v ? M : j, v, c))) : (0 == g && (l = g = 1), h = j.slice()), (v = h.length) < F && h.unshift(0), r(w, h, F, c), -1 == l && (l = n(j, w, I, F = w.length)) < 1 && (g++, r(w, I < F ? M : j, F, c)), F = w.length) : 0 === l && (g++, w = [0]), b[d++] = g, l && w[0] ? w[F++] = P[x] || 0 : (w = [P[x]], F = 1)
        ...
        switch (f) {
          ...
          case "unit":
            var M = t.unit,
              O = t.unitDisplay,
              B = n.units.simple[M];
            if (S = void 0, B) S = wr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[M][O]);
            else {
              var k = M.split("-per-"),
                P = k[0],
                j = k[1];
              B = n.units.simple[P];
              var R = wr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[P][O]),
                L = n.units.simple[j].perUnit[O];
              if (L) S = L.replace("{0}", R);
              else {
                var _ = n.units.compound.per[O],
                  q = wr(r, 1, n.units.simple[j][O]);
