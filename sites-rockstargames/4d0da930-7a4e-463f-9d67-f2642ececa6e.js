! function() {
  try {
    var n = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (n._sentryDebugIds = n._sentryDebugIds || {}, n._sentryDebugIds[e] = "4d0da930-7a4e-463f-9d67-f2642ececa6e", n._sentryDebugIdIdentifier = "sentry-dbid-4d0da930-7a4e-463f-9d67-f2642ececa6e")
  } catch (n) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [2202], {
    12202: (n, e, a) => {
      ...
      var S = a(81187),
        z = a(73855);
      const F = (0, o.withTranslations)((n => {
        let {
          t: e
        } = n;
        const {
          setBreadcrumb: a,
          setNormalLogo: s
        } = (0, l.b)(), m = (0, o.useQueryParams)(), [c, g] = (0, i.useState)({}), {
          data: u
        } = (0, o.useQuery)(S.VideosList, {
          variables: c,
        ...
        if ((0, i.useEffect)((() => {
            ...
            g({
              ...
              type: m.get("type"),
              gameId: m.get("gameId"),
              index: null === m.get("type"),
              gtaoSessionsEpisodes: "78cs3289" === m.get("gameId")
            })
          }), [m.get("type"), m.get("gameId")]), (0, i.useEffect)((() => (s(!1), () => s(!0))), []), !u) return null;
        if (u?.game && u?.gameVideos) return (0, z.jsxs)("div", {
          className: N.videosIndex,
          children: [(0, z.jsx)(d.A, {
            vids: u.gameVideos.results,
            title: e("Videos from %s").replace("%s", u.game.title)
          }), u?.gtaosessions?.results && (0, z.jsx)(d.A, {
            vids: u.gtaosessions.results,
        ...
        return (0, z.jsx)("div", {
          className: N.videosIndex,
          children: c.type ? "" : (0, z.jsxs)(z.Fragment, {
            children: [(0, z.jsx)(r.A, {
              videos: k.results,
              t: e
            }), (0, z.jsxs)("div", {
              className: N.sections,
              children: [(0, z.jsx)(d.A, {
                vids: f.results,
    ...
    81187: n => {
      ...
      function r(n, e) {
        ...
        for (r.forEach((function(n) {
          ...
          var l = o;
          o = new Set, l.forEach((function(n) {
            d.has(n) || (d.add(n), (i[n] || new Set).forEach((function(n) {
              o.add(n)
            })))
          }))
        }
      ...
      })), n.exports = e, n.exports.videoFields = r(e, "videoFields"), n.exports.VideosList = r(e, "VideosList")
    }
  }
]);