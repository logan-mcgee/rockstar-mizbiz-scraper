! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "507380f8-3648-403d-b401-597055ca6ab5", e._sentryDebugIdIdentifier = "sentry-dbid-507380f8-3648-403d-b401-597055ca6ab5")
  } catch (e) {}
}();
    ...
    5226: (e, a, i) => {
      ...
      const N = e => {
          ...
          const {
            ...
            left: y,
            top: j
          } = d, [F, _] = (0, l.useState)(null), {
            track: V
          } = (0, b.useGtmTrack)(), T = null !== u && (u?.length || 0) > 1 && ("flag_bg" === k || "fob" === x?.size), [I, A] = (0, p.useSearchParams)(), [D, $] = (0, l.useState)(!1), [E, C] = (0, l.useState)(!1), L = () => {
            const e = F - 1;
          ...
          return (0, l.useMemo)((() => (0, h.jsx)("div", {
        ...
        S = "modal-context",
        w = [null, () => null],
        x = window?.[S] ?? (window[S] = (0, l.createContext)(w)),
        y = e => {
          let {
            children: a
          } = e;
          const [i, n] = (0, l.useState)(w), t = (0, l.useMemo)((() => i?.content ? (0, h.jsx)(N, {
            modal: i
          }) : null), [i]);
      ...
      const z = {
        ...
        U = (0, V.withTranslations)((e => {
          ...
          const [r, c] = (0, l.useState)(!1), {
            sanitize: o
          } = H(), m = n ?? d("Select Retailer"), u = (0, l.useRef)(), g = e => {
          ...
          })), (0, l.useEffect)((() => (r ? document.addEventListener("mousedown", g) : document.removeEventListener("mousedown", g), () => {
      ...
      const se = (0, V.withTranslations)((e => {
          ...
          const {
            setBreadcrumb: i
          } = (0, L.useRockstarLocalState)(), n = (0, V.useQueryParams)(), [t, s] = (0, l.useState)(null), [d, r] = (0, l.useState)(null), {
            loading: c,
            refetch: o
          ...
          if ((0, l.useEffect)((() => {
              ...
              s(a)
            }), [n.get("series"), n.get("collection"), r]), (0, l.useEffect)((() => {
              let e = [{
                href: "/downloads",
                title: a("Downloads")
              }];
              return d?.collection?.id && t.withSeries && (e = [...e, {
                href: `/downloads?collection=${d.collection.id}`,
          ...
          if (t.withIndex) return (0, h.jsx)("div", {
            ...
            children: (0, h.jsxs)("div", {
              ...
              children: [(0, h.jsx)(ie, {
                ...
                homepage: !0,
                games: d.pc_mac_games,
                collection: d.collections.find((e => "gamespcmac" === e.title_slug))
              }), (0, h.jsx)(K, {
                homepage: !0,
                collection: d.collections.find((e => "apps" === e.title_slug))
              }), (0, h.jsx)(ae, {
                collections: d.collections.filter((e => !["apps", "gamespcmac", "sharkcards"].includes(e.title_slug)))
              })]
            })
          });
          if (t.withSeries) {
      ...
      const ke = (0, V.withTranslations)((e => {
        ...
        const {
          setBreadcrumb: i,
          setNormalLogo: n
        } = (0, L.useRockstarLocalState)(), t = (0, V.useQueryParams)(), [s, d] = (0, l.useState)({}), {
          data: r
        } = (0, _.useQuery)(ue(), {
          variables: s,
        ...
        if ((0, l.useEffect)((() => {
          ...
          }), [t.get("type"), t.get("gameId")]), (0, l.useEffect)((() => (n(!1), () => n(!0))), []), !r) return null;
      ...
      const xe = e => {
        ...
        _e = e => {
          ...
          const [n, t] = (0, l.useState)(!1), s = "<br>", d = a.description.includes(s);
          return (0, h.jsx)(Ae, {
        ...
        De = (0, V.withTranslations)((e => {
          ...
          return (0, l.useEffect)((() => (d && n(d.title), i([{
            href: "/games",
            title: a("Games")
          }]), () => {
            i()
            ...
            children: [(0, h.jsxs)("div", {
              ...
              children: [(0, h.jsxs)("div", {
                ...
                children: [(0, h.jsx)(ye, {
                  ...
                  children: [(0, h.jsx)(xe, {
                    game: d,
                    t: a
                  }), d.has_official_site && (0, h.jsx)(k.Button, {
                    to: d.url_official,
                    context: "secondary",
                    target: "_blank",
                    "data-gtm-category": "Games",
              ...
              children: [(0, h.jsx)(_e, {
                game: d,
                t: a
              }), d.tags.length && d.tags[0].videos.length ? (0, h.jsx)(Te, {
                game: d,
                videos: d.tags[0].videos,
                t: a
              }) : "", d.tags.length && d.tags[0].posts.length ? (0, h.jsx)(Ve, {
                game: d,
                posts: d.tags[0].posts,
                t: a
              }) : "", d.screens.length ? (0, h.jsx)(Fe, {
                screens: d.screens,
                t: a
              }) : "", (0, h.jsx)(je, {
                game: d,
      ...
      const Le = "rockstargames-sites-rockstargamesfb53bedab2c55d1a3c602f6d22cbf878",
        ...
        Be = (0, V.withTranslations)((e => {
          ...
          const i = (0, A.useIntl)(),
            ...
            d = (0, V.useQueryParams)(),
            [r, c] = (0, l.useState)(null),
            [o, m] = (0, l.useState)({}),
            [u, g] = (0, l.useState)(d.get("tab") ?? "games"),
            {
              data: v = {},
              loading: f
            } = (0, _.useQuery)(Ce(), {
      ...
      const ze = (0, k.withSearchbarErrorBoundary)((e => {
          ...
          const d = (0, p.useNavigate)(),
            ...
            u = (e, a) => {
              const i = a ?? e.target.hash,
                ...
                l = o.get("country");
              if (e) {
                const a = `${r.pathname}${o.get("country")?`?country=${l}`:""}${i}`;
          ...
          }), [o.get("country"), o.get("locale"), n]), (0, l.useEffect)((() => {
      ...
      const oa = () => {
        ...
        ba = {
          "gta-tv": (0, l.lazy)((() => i.e(572).then(i.t.bind(i, 49952, 23)))),
          ...
          "screenshot-viewer": (0, l.lazy)((() => i.e(484).then(i.t.bind(i, 55484, 23)))),
      ...
      const Va = (() => {
        ...
        Ta = () => {
          ...
          } = (0, V.useRockstarLocalState)(), [i] = (0, l.useContext)(x), [{
            iso: n
          }] = (0, A.getLocale)();
      ...
      (0, n.init)({
        ...
        init: () => {
          ...
          document.body.appendChild(e), (0, d.C)(e).render((0, h.jsx)($a, {}))
        }
      })
    },
    79036: e => {
...
//# sourceMappingURL=b15cd8654e0893956ecac552d432826d.js.map