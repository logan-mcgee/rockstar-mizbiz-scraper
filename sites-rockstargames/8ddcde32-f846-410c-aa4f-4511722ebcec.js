    ...
    44573: (e, o, a) => {
      ...
      const T = e => {
        ...
        const r = (0, D.useLocation)(),
          ...
          _ = s,
          l = e => {
            e?.startsWith("http") ? window.location.href = e : t(e)
          },
          m = (0, i.useMemo)((() => o.reduce(((e, o) => o.appearancePaths ? [...e, ...o.appearancePaths.map((e => ({
            element: (0, v.jsx)(_, {
              navData: o,
              location: r,
              onNavigate: l,
      ...
      const K = function(e) {
        ...
        X = (0, O.A)((() => {
          ...
          const t = {
            path: "*",
            element: K((() => Promise.resolve().then(a.bind(a, 88038))), {
              error: {
          ...
          let n = [{
            path: "/",
            element: K((() => Promise.all([a.e(6855), a.e(9028), a.e(7021), a.e(588), a.e(9286), a.e(8417), a.e(4558), a.e(4981)]).then(a.bind(a, 44981))))
          }, {
            path: "/careers-privacy",
            element: K((() => Promise.all([a.e(5865), a.e(2290), a.e(5476)]).then(a.bind(a, 65476))))
          }, {
            path: "/ccpa",
            element: K((() => Promise.all([a.e(5865), a.e(2290), a.e(1504)]).then(a.bind(a, 41504))))
          }, {
            path: "/community-guidelines",
            element: K((() => Promise.all([a.e(6855), a.e(5865), a.e(2785), a.e(3333)]).then(a.bind(a, 43775))))
          }, {
            path: "/community-guidelines/resources",
            element: K((() => Promise.all([a.e(6855), a.e(5865), a.e(2785), a.e(5665)]).then(a.bind(a, 12787))))
          }, {
            path: "/conduct",
            element: (0, v.jsx)(D.Navigate, {
              to: "/community-guidelines",
              replace: !0
            })
          }, {
            path: "/contact",
            element: K((() => a.e(864).then(a.bind(a, 20864))))
          }, {
            path: "/cookies",
            element: K((() => Promise.all([a.e(5865), a.e(2290), a.e(4996)]).then(a.bind(a, 74996))))
          }, {
            path: "/corpinfo",
            element: K((() => Promise.all([a.e(5865), a.e(2290), a.e(1907)]).then(a.bind(a, 31907))))
          }, {
            path: "/VI",
            element: K((() => a.e(3326).then(a.t.bind(a, 43326, 23))))
          }, {
            path: "/games",
            element: K((() => Promise.all([a.e(6855), a.e(7021), a.e(9286), a.e(9468)]).then(a.bind(a, 9468))))
          }, {
            path: "/games/:gameTitlelug",
            element: K((() => Promise.all([a.e(7021), a.e(588), a.e(9237)]).then(a.bind(a, 69237))))
          }, {
            path: "/legal",
            element: K((() => Promise.all([a.e(5865), a.e(2290), a.e(4150)]).then(a.bind(a, 31769))))
          }, {
            path: "/gta-v/thankyou",
            element: K((() => Promise.resolve().then(a.bind(a, 61998))), {
              title: "v"
            })
          }, {
            path: "/standarddeviation",
            element: K((() => a.e(760).then(a.bind(a, 70760))))
          }, {
            path: "/community_event",
            element: K((() => Promise.all([a.e(7021), a.e(4)]).then(a.bind(a, 40004))))
          }, {
            path: "/reddeadredemption2/*",
            element: K((() => a.e(9147).then(a.t.bind(a, 29147, 23))))
          }, {
            path: "/reddeadredemption/*",
            element: K((() => a.e(7538).then(a.t.bind(a, 47538, 23))))
          }, {
            ...
            path: "/bully/*",
            element: K((() => a.e(5202).then(a.t.bind(a, 35202, 23))))
          }, {
            ...
            path: "/careers/*",
            element: K((() => a.e(3137).then(a.t.bind(a, 53137, 23))))
          }, {
            path: "/downloads/*",
            element: K((() => Promise.all([a.e(1631), a.e(7989)]).then(a.bind(a, 47989))))
          }, {
            path: "/reddeadonline/*",
            element: K((() => a.e(3416).then(a.t.bind(a, 33416, 23))))
          }, {
            path: "/gifs/:hashId",
            element: K((() => a.e(1626).then(a.t.bind(a, 41626, 23))))
          }, {
            path: "/gta-v/*",
            element: K((() => a.e(6766).then(a.t.bind(a, 36766, 23))), {
              routeRoot: "/gta-v"
            })
          }, {
            path: "/gta-plus/*",
            ...
            path: "/gta-plus",
            element: K((() => a.e(5427).then(a.bind(a, 85427))), {
              routeRoot: "/gta-plus"
            })
          }, {
            path: "/gta-online/*",
            ...
            path: "/GTATrilogy/*",
            element: K((() => a.e(2405).then(a.t.bind(a, 12405, 23))))
          }, {
            path: "/gtatv/*",
            element: K((() => a.e(8987).then(a.t.bind(a, 88987, 23))))
          }, {
            path: "/manuals",
            element: K((() => Promise.all([a.e(1458), a.e(7709)]).then(a.bind(a, 97709))))
          }, {
            path: "/manuals/music",
            element: K((() => Promise.all([a.e(1458), a.e(1631), a.e(3798)]).then(a.bind(a, 93798))))
          }, {
            path: "/newswire",
            element: K((() => Promise.all([a.e(6855), a.e(7021), a.e(588), a.e(9286), a.e(8417), a.e(4558), a.e(5275)]).then(a.bind(a, 35275))))
          }, {
            path: "/newswire/article/:articleId/:articleSlug",
            element: K((() => a.e(5678).then(a.bind(a, 75678))))
          }, {
            path: "/newswire/article/:articleId/:articleSlug",
            element: K((() => a.e(5678).then(a.bind(a, 75678))))
          }, {
            path: "/privacy",
            element: K((() => Promise.all([a.e(5865), a.e(2290), a.e(1721)]).then(a.bind(a, 11721))))
          }, {
            path: "/rockstartv/*",
            element: K((() => a.e(8778).then(a.t.bind(a, 78778, 23))))
          }, {
            path: "/screenshot-viewer/*",
            element: K((() => a.e(9343).then(a.t.bind(a, 39343, 23))))
          }, {
            path: "/search",
            element: K((() => Promise.all([a.e(588), a.e(8417), a.e(5102)]).then(a.bind(a, 85102))))
          }, {
            path: "/socialclubmaintenance",
            element: K((() => a.e(4233).then(a.bind(a, 84233))))
          }, {
            path: "/south-korean-privacy-addendum",
            element: K((() => Promise.all([a.e(5865), a.e(2290), a.e(6968)]).then(a.bind(a, 76968))))
          }, {
            path: "/unsubscribe",
            element: K((() => Promise.all([a.e(6855), a.e(7079)]).then(a.bind(a, 87079))))
          }, {
            path: "/videos",
            element: K((() => Promise.all([a.e(2370), a.e(9028), a.e(1945)]).then(a.bind(a, 91945))))
          }, {
            path: "/videos/:videoId",
            element: K((() => Promise.all([a.e(2370), a.e(1710)]).then(a.bind(a, 1710))))
          }, {
            ...t
          }];
          return isNaN(parseInt(s?.code)) || 200 === s?.code || (n = [t]), (0, D.useRoutes)(n)
        })),
        q = {
        ...
        J = (0, s.withAutoRouteTracking)((() => {
          ...
          return (0, i.useEffect)((() => {
            ...
            role: "main",
            id: "main",
            className: [q.main, o ? q.standalone : "", e ? q.headerHidden : ""].join(" "),
            children: (0, v.jsx)(X, {})
          })
        })),
        Z = ((0, E.makeVar)({
        ...
        W = {
          ...
          normalLogo: !0,
          loading: !1,
          headerHidden: ([].find((e => Z.includes(e))) ?? []).length > 0 || $,
          customFooter: (["gta-online/license-plates"].find((e => Z.includes(e))) ?? []).length > 0,
          standalone: (["/screenshot-viewer", "/VI", "/videoplayer", "/gifs"].find((e => Z.includes(e))) ?? []).length > 0,
          error: {
      ...
      const oe = {
        ...
        ae = (0, E.makeVarNamespace)("rockstar-root"),
        se = window?.env?.graphEnv ?? "prod";
      d();
      const re = (() => {
          const e = window;
        ...
        ce = (0, E.withReactiveState)((() => {
          ...
          return (0, i.useEffect)((() => {
            ...
            children: (0, v.jsx)(I.ScrollProvider, {
              children: (0, v.jsx)(M.RockstarUserProvider, {
                children: (0, v.jsx)(_(), {
                  history: re,
                  basename: e,
                  children: (0, v.jsx)(ne, {})
        ...
        _e = (0, E.withRockstarGraph)(ce, {
          env: se,
          token: ae("token", null),
          tokenPing: ae("tokenPing", ie),
          tokenPingExpires: ae("tokenPingExpires", null),
          typePolicies: {
            ...G()
          }
        }),
      ...
      (0, s.init)({
        ...
        init: () => {
          ...
          document.body.appendChild(e), (0, n.H)(e).render((0, v.jsx)(_e, {}))
        }
      })
    },
    26454: e => {
