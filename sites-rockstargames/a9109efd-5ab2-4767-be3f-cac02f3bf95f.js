try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "a9109efd-5ab2-4767-be3f-cac02f3bf95f", e._sentryDebugIdIdentifier = "sentry-dbid-a9109efd-5ab2-4767-be3f-cac02f3bf95f")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    24162: (e, t, s) => {
        ...
        updateSlides: function() {
          ...
          for (let i = 0; i < u; i += 1) {
            ...
            if (M = 0, p[i] && (r = p[i]), x && e.grid.updateSlide(i, r, p), !p[i] || "none" !== (0, n.q)(r, "display")) {
              ...
              p[i] && (p[i].swiperSlideSize = M), h.push(M), s.centeredSlides ? (E = E + M / 2 + T / 2 + S, 0 === T && 0 !== i && (E = E - a / 2 - S), 0 === i && (E = E - a / 2 - S), Math.abs(E) < .001 && (E = 0), s.roundLengths && (E = Math.floor(E)), y % s.slidesPerGroup === 0 && f.push(E), m.push(E)) : (s.roundLengths && (E = Math.floor(E)), (y - Math.min(e.params.slidesPerGroupSkip, y)) % e.params.slidesPerGroup === 0 && f.push(E), m.push(E), E = E + M + S), e.virtualSize += M + S, T = M, y += 1
            }
          }
      ...
      var S = {
        ...
        E = {
          ...
          loopFix: function(e) {
            ...
            let _ = 0,
              L = 0;
            const O = (E ? p[a].column : a) + (v && void 0 === r ? -w / 2 + .5 : 0);
            if (O < S) {
              _ = Math.max(S - O, b);
              ...
              L = Math.max(O - (x - 2 * S), b), M && (L = Math.max(L, w - x + g + 1));
              for (let e = 0; e < L; e += 1) {
                const t = e - Math.floor(e / x) * x;
                E ? p.forEach((e, s) => {
                  e.column === t && y.push(s)
            ...
            if (c.__preventObserver__ = !0, requestAnimationFrame(() => {
              ...
              if (T.length > 0 && k) {
                if (void 0 === t) {
                  const e = c.slidesGrid[C],
                    t = c.slidesGrid[C + _] - e;
                  d ? c.setTranslate(c.translate - t) : (c.slideTo(C + Math.ceil(_), 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                } else if (r) {
              ...
              if (void 0 === t) {
                ...
                d ? c.setTranslate(c.translate - t) : (c.slideTo(C - L, 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
              } else {
      ...
      const G = {
          ...
          events: {
            attachEvents: function() {
              ...
              e.onTouchStart = y.bind(e), e.onTouchMove = x.bind(e), e.onTouchEnd = M.bind(e), e.onDocumentTouchStart = L.bind(e), t.cssMode && (e.onScroll = k.bind(e)), e.onClick = P.bind(e), e.onLoad = _.bind(e), O(e, "on")
            },
      ...
      const Z = (0, i.createContext)(null),
        ...
        Q = (0, i.forwardRef)(function(e, t) {
          ...
          const [p, u] = (0, i.useState)("swiper"), [f, m] = (0, i.useState)(null), [h, v] = (0, i.useState)(!1), g = (0, i.useRef)(!1), w = (0, i.useRef)(null), b = (0, i.useRef)(null), S = (0, i.useRef)(null), E = (0, i.useRef)(null), T = (0, i.useRef)(null), y = (0, i.useRef)(null), x = (0, i.useRef)(null), M = (0, i.useRef)(null), {
            params: C,
            passedParams: P,
            rest: k,
            events: _
          ...
          return w.current || z(), b.current && b.current.on("_beforeBreakpoint", I), (0, i.useEffect)(() => () => {
            ...
            }(P, S.current, L, E.current, e => e.key);
            return S.current = P, E.current = L, e.length && b.current && !b.current.destroyed && function(e) {
              let {
                swiper: t,
                slides: s,
                passedParams: i,
              ...
              r.includes("loop") && t.isElement && (p.loop && !i.loop ? T = !0 : !p.loop && i.loop ? y = !0 : x = !0), c.forEach(e => {
          ...
          }(b.current, L, f) : L.map((e, t) => i.cloneElement(e, {
            swiper: b.current,
            swiperSlideIndex: t
