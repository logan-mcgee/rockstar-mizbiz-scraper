! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "04e8a289-f8e4-438e-aa8d-d3f09862f0c5", e._sentryDebugIdIdentifier = "sentry-dbid-04e8a289-f8e4-438e-aa8d-d3f09862f0c5")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [9237], {
      ...
      const k = e => {
          ...
          return (0, t.useEffect)((() => {
            ...
            for (let t = 1; t <= 4; t++) try {
              let s;
              s = m(51393)(`./${a}-${t}.jpg`), e.push(s)
            } catch (e) {}
            c(e)
          }), []), o.length ? (0, n.jsxs)("section", {
            ...
            children: [(0, n.jsx)("h4", {
              ...
              children: o.map((e => (0, n.jsx)("img", {
                src: e
              }, e)))
            })]
          }) : null
        },
        j = m(30282).GameInfo ?? GameInfoDefault,
        _ = e => {
          let {
            game: a
          } = e;
        ...
        v = (0, g.withTranslations)((e => {
          ...
          const {
            setBreadcrumb: m,
            setTitle: c
          } = (0, f.useRockstarLocalState)(), d = (0, s.useParams)(), {
            data: r
          } = (0, i.useQuery)(j, {
            autoSetLoading: !0,
            variables: {
              titleSlug: d.gameTitlelug
            }
          }), g = r?.game ?? null;
          return (0, t.useEffect)((() => (g && c(g.title), m([{
            href: "/games",
            title: a("Games")
          }]), () => {
            m()
            ...
            children: [(0, n.jsxs)("div", {
              ...
              children: [(0, n.jsxs)("div", {
                ...
                children: [(0, n.jsx)(_, {
                  game: g,
                  t: a
                }), g?.storePath ? (0, n.jsx)("div", {
                  className: "rockstargames-sites-rockstargamese117d55b425e388a7f3ef0036fad9045",
                  children: (0, n.jsx)(o.A, {
                    to: `https://store.rockstargames.com${g.storePath}`,
                    context: "secondary",
                    target: "_blank",
                    "data-gtm-category": "Games",
                    "data-gtm-action": "Buy Now",
                    "data-gtm-label": g.title,
                    children: a("Buy Now")
                  })
                }) : null]
              }), (0, n.jsx)(p.s, {
                title: g.title,
                titleSlug: g.titleSlug
              })]
            }), (0, n.jsxs)("div", {
              ...
              children: [(0, n.jsx)(u, {
                game: g,
                t: a
              }), g?.tags?.[0]?.videos?.length ? (0, n.jsx)(x, {
                game: g,
                videos: g.tags[0].videos,
                t: a
              }) : "", g?.tags?.[0]?.posts?.length ? (0, n.jsx)(h, {
                game: g,
                posts: g.tags[0].posts,
                t: a
              }) : "", (0, n.jsx)(k, {
                id: g.id,
                t: a
    ...
    30282: (e, a, m) => {
      ...
      t.definitions = t.definitions.concat(o(m(90588).definitions)), t.definitions = t.definitions.concat(o(m(28300).definitions));
      var d = {};

      function r(e, a) {
        for (var m = 0; m < e.definitions.length; m++) {
          var t = e.definitions[m];
      ...
      t.definitions.forEach((function(e) {
        ...
        e.hasOwnProperty("loc") && (m.loc = e.loc);
        var t = d[a] || new Set,
          s = new Set,
          o = new Set;
