try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "fa09f4c4-daa7-4893-8d8a-d22aa4650041", e._sentryDebugIdIdentifier = "sentry-dbid-fa09f4c4-daa7-4893-8d8a-d22aa4650041")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [137], {
    ...
    8194: (e, a, t) => {
      ...
      }, s.resolve = o, e.exports = s, s.id = 8194
    },
    8286: e => {
      "use strict";
    ...
    13989: (e, a, t) => {
      ...
      const n = {
        ...
        f = ({
          ...
          const {
            track: _
          } = (0, c.useGtmTrack)(), [u] = (0, o.useSearchParams)(), j = t.preview_images_parsed.newswire_block, b = (0, d.Ub)(i.fi.mobile), l = {
            default: 0 !== a || f ? j.square || j.d16x9 || j._fallback : j.d16x9 || j.square || j._fallback,
            mobile: j.square || j._fallback
          }, [h] = (0, r.usePreloadImg)(l.default), x = {
            default: {
          ...
          return (0, m.jsx)(p.A, {
            to: t.url,
            className: [n.newswireBlock, f ? n.newswireBlockNoSpecialOrder : "", null !== h ? n.startAnimation : ""].join(" "),
            focused: k,
            onClick: z,
            children: (0, m.jsxs)(m.Fragment, {
              children: [0 !== a || u.get("tag_id") ? (0, m.jsx)("div", {
                className: n.preview,
                style: x.default
              }) : (0, m.jsx)("div", {
                className: b ? n.previewMobile : n.preview,
                style: b ? x.mobile : x.default
              }), (0, m.jsxs)("div", {
                className: n.info,
                children: [(0, m.jsxs)("div", {
                  className: n.top,
                  children: [t.primary_tags.length ? (0, m.jsx)(g.A, {
    ...
    16044: (e, a, t) => {
      ...
      s.keys = function() {
        return Object.keys(m)
      }, s.resolve = o, e.exports = s, s.id = 16044
    },
    16046: e => {
      "use strict";
    ...
    18670: (e, a, t) => {
      ...
      const c = ({
        ...
        const {
          isMobile: p
        } = (0, o.useWindowResize)(), g = (0, o.useLocale)(), n = (0, s.useMemo)(() => {
          let m = "";
          return e && (m = p ? t(16044)(`./${d}/mobile/${g}.jpg`) : t(51048)(`./${d}/desktop/${g}.jpg`)), m || (m = t(39294)(`./${d}.jpg`), m += `?im=Resize=${a}`), m
        }, [p, d]), [f] = (0, o.usePreloadImg)(n);
        let k = n;
        return (0, m.jsx)("div", {
          role: "img",
          "aria-label": c,
    ...
    20517: (e, a, t) => {
      ...
      const _ = (0, p.A)((0, k.g)(({
        ...
        const [l, h] = (0, s.useState)(!1), {
          ...
          track: N
        } = (0, d.useGtmTrack)(), y = (0, o.useIntl)(), {
          data: S
        } = (0, r.useQuery)(f.GameData, {
          variables: {
            titleSlug: _
          },
          skip: !_
        ...
        if ((0, s.useEffect)(() => {
          ...
          }, [x]), !z.ratingImg) return null;
        const w = !!z.ratingDescriptors;
        return (0, m.jsxs)("div", {
          className: [g.rating, w ? g.withDescriptors : g.withOutDescriptors, j || ""].join(" "),
          ...
          children: [(0, m.jsx)(i.A, {
            ...
            children: (0, m.jsx)("img", {
              alt: y.formatMessage(n.components_ratings_link_alt, {
                rating: (I = z.ratingImg, I.replace(/_/g, " ").split(".")[0].toUpperCase())
              }),
              src: t(8194)(`./${z.ratingImg}`)
            })
          }), w && (0, m.jsxs)("div", {
            className: g.text,
            children: [(0, m.jsx)("p", {
            ...
            }), z.ratingFooter && (0, m.jsx)("hr", {}), z.ratingFooter && (0, m.jsx)("p", {
              dangerouslySetInnerHTML: {
    ...
    23395: (e, a, t) => {
      ...
      const o = {
        ...
        r = ({
          ...
          const c = (0, m.jsxs)("div", {
            style: r,
            className: [o.tag, e].join(" "),
            children: [(0, m.jsx)("i", {}), t]
          });
          return void 0 !== a ? (0, m.jsx)(s.A, {
            to: a,
            children: c
          }) : c
        }
    ...
    29625: (e, a, t) => {
      ...
      const c = {
        ...
        d = ({
          ...
          const g = o()(c.button, c[t], e);
          return s ? (0, m.jsx)(r.A, {
            ...p,
            to: s,
            className: g,
            onClick: d,
    ...
    36672: (e, a, t) => {
      ...
      s.keys = function() {
        return Object.keys(m)
      }, s.resolve = o, e.exports = s, s.id = 36672
    },
    36725: e => {
      "use strict";
    ...
    38971: e => {
      ...
      function o(e, a) {
        ...
        for (o.forEach(function(e) {
          ...
          c = new Set, d.forEach(function(e) {
            r.has(e) || (r.add(e), (m[e] || new Set).forEach(function(e) {
              c.add(e)
            }))
          })
        }
      ...
      }), e.exports = a, e.exports.postFields = o(a, "postFields"), e.exports.videoFields = o(a, "videoFields"), e.exports.GameInfo = o(a, "GameInfo")
    },
    39003: e => {
      "use strict";
    ...
    40137: (e, a, t) => {
      ...
      const u = ({
        ...
        return (0, s.useEffect)(() => {
          ...
          for (let a = 1; a <= 4; a++) try {
            const m = t(72992)(`./${d}-${a}.jpg`);
            e.push(m)
          } catch (e) {}
          c(e)
        }, []), r.length ? (0, m.jsxs)("section", {
          ...
          children: [(0, m.jsx)("h4", {
            ...
            children: r.map((e, a) => (0, m.jsx)("img", {
              src: e,
              alt: o.formatMessage(_.game_screens_alt_text, {
                title: i,
                id: a + 1,
                total: r.length
              })
      ...
      const l = ({
          purchases: e,
          t: a
        }) => e?.length > 1 ? (0, m.jsx)(d.A, {
          title: a("Buy Now"),
          children: e.map(e => {
            if (e?.platform?.name) return (0, m.jsx)(r.A, {
              target: "_blank",
              to: e.href,
              children: e.platform.name
            }, e.href)
          })
        }) : 1 === e?.length ? (0, m.jsx)("div", {
        ...
        x = ({
          ...
          const t = e?.platforms?.map(e => e?.name) ?? [],
            s = e?.developers?.map(e => e?.title) ?? [],
            o = ["libertycitystories", "vicecitystories"].includes(e.title_slug);
          return (0, m.jsx)(S, {
        ...
        v = ({
          ...
          children: [(0, m.jsx)("div", {
            ...
            "data-gtm-label": `${e.title} - More Click`,
            to: `/newswire?tag_id=${e.tags[0].id}`,
            context: "secondary",
        ...
        N = ({
          ...
          children: [(0, m.jsx)("div", {
            ...
            "data-gtm-label": `${e.title} - View All Click`,
            to: `/videos?type=game&gameId=${e.id}`,
            context: "secondary",
            children: t("See all %s videos").replace("%s", e.title)
          })]
        }),
        y = ({
          children: e,
        ...
        S = ({
          ...
          className: a,
          style: s,
          children: [e ? (0, m.jsx)("h4", {
            className: "rockstargames-sites-rockstargamesa2b8fdb05372993030b9b4edb2e4ce48",
            children: e
          }) : "", t]
        }),
        w = (0, f.withTranslations)(({
          t: e
        }) => {
          const {
            setBreadcrumb: a,
            setTitle: t
          } = (0, j.b)(), r = (0, o.useParams)(), {
            data: c
          } = (0, f.useQuery)(b.GameInfo, {
            autoSetLoading: !0,
            variables: {
              titleSlug: r.gameTitlelug
            }
          }), d = c?.game ?? null;
          return (0, s.useEffect)(() => (d && t(d.title), a([{
            href: "/games",
            title: e("Games")
          }]), () => {
            a()
            ...
            children: [(0, m.jsxs)("div", {
              ...
              children: [(0, m.jsxs)("div", {
                ...
                children: [(0, m.jsx)(h, {
                  game: d,
                  t: e
                }), d?.purchases?.length > 0 && (0, m.jsx)("div", {
              ...
              children: [(0, m.jsx)(z, {
                game: d,
                t: e
              }), d?.tags?.[0]?.videos?.length ? (0, m.jsx)(N, {
                game: d,
                videos: d.tags[0].videos,
                t: e
              }) : "", d?.tags?.[0]?.posts?.length ? (0, m.jsx)(v, {
                game: d,
      ...
      const c = {
        ...
        d = ({
          ...
          return (0, m.jsx)(r(), {
            ...
            children: (0, m.jsxs)("div", {
              className: [c.dropdownWrapper, o ? c.open : "", void 0 !== a ? a : ""].join(" "),
    ...
    51048: (e, a, t) => {
      ...
      s.keys = function() {
        return Object.keys(m)
      }, s.resolve = o, e.exports = s, s.id = 51048
    },
    51213: e => {
      "use strict";
      ...
      const r = {
        ...
        c = ({
          ...
          return (0, s.jsx)(o.A, {
            ...
            to: a ?? c,
            target: "_self",
            className: [r.fobLink, d ? r.wide : ""].join(" "),
            reloadDocument: d,
    ...
    72992: (e, a, t) => {
      ...
      s.keys = function() {
        return Object.keys(m)
      }, s.resolve = o, e.exports = s, s.id = 72992
    },
    72994: e => {
      "use strict";
    ...
    75471: (e, a, t) => {
      var m = {
        ...
        "./game-id-update/52ssc16k-3.jpg": 40890,
        "./game-id-update/52ssc16k-4.jpg": 2310,
        "./game-id-update/5ao9tr5e-1.jpg": 91947,
        "./game-id-update/5ao9tr5e-2.jpg": 1263,
      ...
      s.keys = function() {
        return Object.keys(m)
      }, s.resolve = o, e.exports = s, s.id = 75471
    },
    75509: e => {
      "use strict";
      e.exports = "https://media-rockstargames-com.akamaized.net/mfe6/prod/__common/img/a67cd294bd5b65208032d4979834f996.jpg"
