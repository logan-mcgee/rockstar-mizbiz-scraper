try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "3aff55bd-964f-446d-89ba-cfec6d040c28", t._sentryDebugIdIdentifier = "sentry-dbid-3aff55bd-964f-446d-89ba-cfec6d040c28")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [7485], {
    17485: (t, e, n) => {
      n.r(e), n.d(e, {
        ...
        AnimationType: () => $t,
        DeprecatedLayoutGroupContext: () => Hs,
        DragControls: () => vl,
        FlatTree: () => as,
        LayoutGroup: () => _s,
        ...
        const y = (0, o.forwardRef)((function(y, w) {
          ...
          if (!A && l) {
            ...
            const r = (0, o.useContext)(c).strict,
              l = (0, o.useContext)(V);
            k.visualElement && (C = k.visualElement.loadFeatures(S, r, t, L, n || x.projectionNodeConstructor, l))
          }
          ...
          }(R, k.visualElement, w), R, A, k.visualElement)))
        }));
        return y[A] = g, y
      }
      ...
      const Ve = t => e => (t(e), null),
        Ae = {
          inView: Ve((function({
            ...
            let a = Boolean(e || n || i);
            r.once && s.current.hasEnteredView && (a = !1), ("undefined" == typeof IntersectionObserver ? Te : Se)(a, s.current, t, r)
          })),
          tap: Ve((function({
            onTap: t,
            onTapStart: e,
        ...
        if (s)
          for (let a = 0; a < s; a++) {
            const s = r[a],
              l = e[s];
            let u = null;
            Array.isArray(l) && (u = l[0]), null === u && (u = null !== (i = null !== (o = n[s]) && void 0 !== o ? o : t.readValue(s)) && void 0 !== i ? i : e[s]), null != u && ("string" == typeof u && (Le(u) || Re(u)) ? u = parseFloat(u) : !Vn(u) && fn.test(l) && (u = En(s, l)), t.addValue(s, Qe(u, {
              owner: t
          ...
          },
          {
            ...
            if (!Mo(t, Co) && Mo(t, Ao)) {
              const n = function({
                ...
                let s = 1 - e;
                s = H(Po, So, s), t = H(Eo, bo, t / 1e3), s < 1 ? (i = e => {
                  const o = e * s,
                    i = o * t,
                    r = o - n,
                    a = Vo(e, s),
      ...
      function Fo({
        ...
        const S = Do[s.length > 2 ? "keyframes" : p],
          T = s[0],
          V = s[s.length - 1];
        (null === (g = (m = S).needsInterpolation) || void 0 === g ? void 0 : g.call(m, T, V)) && (x = so([0, 100], [T, V], {
          clamp: !1
        }), s = [0, 100]);
        const A = S({
          ...f,
        ...
        return a && (l && l(), v = e((function(t) {
          if (P || (t = -t), n += t, !b) {
            ...
            y = t.value, x && (y = x(y)), b = P ? t.done : n <= 0
          }
          d && d(y), b && (0 === w && (E = void 0 !== E ? E : n), w < o ? function(t, e, n, o) {
            return o ? t >= e + n : t <= -n
          }(n, E, r, P) && (w++, "reverse" === i ? (P = w % 2 == 0, n = function(t, e = 0, n = 0, o = !0) {
            return o ? Bo(e + -t, e, n) : e - (t - e) + n
          }(n, E, r, P)) : (n = Bo(n, E, r), "mirror" === i && A.flipTarget()), b = !1, h && h()) : (v.stop(), c && c()))
        })), v.start()), {
          stop: () => {
            u && u(), v.stop()
          },
      ...
      const ni = new Set(["opacity"]),
        oi = (t, e, n, o = {}) => i => {
          ...
          if (!h || !d || zn.current || !1 === r.type) return zo(p);
          if ("inertia" === r.type) {
            const t = function({
              keyframes: t,
              velocity: e = 0,
            ...
            ...p,
            ..._o(t, p)
          }), p.duration && (p.duration = $n(p.duration)), p.repeatDelay && (p.repeatDelay = $n(p.repeatDelay));
          const f = e.owner,
            m = f && f.current;
      ...
      const ui = [$t.Animate, $t.InView, $t.Focus, $t.Hover, $t.Tap, $t.Drag, $t.Exit],
        ci = [...ui].reverse(),
        hi = ui.length;
            ...
            t.animationState || (t.animationState = function(t) {
              ...
              function r(r, s) {
                ...
                for (let e = 0; e < hi; e++) {
                  ...
                  const P = (m = y.prevProp, "string" == typeof(g = x) ? g !== m : !!Array.isArray(g) && !ke(g, m));
                  let S = P || v === s && y.isActive && !b && w || e > f && w;
                  ...
                  for (const t in C) {
                    const e = V[t],
                      n = A[t];
                    h.hasOwnProperty(t) || (e !== n ? Rt(e) && Rt(n) ? !ke(e, n) || P ? M(t) : y.protectedKeys[t] = !0 : void 0 !== e ? M(t) : c.add(t) : void 0 !== e && c.has(t) ? M(t) : y.protectedKeys[t] = !0)
                  }
                  y.prevProp = x, y.prevResolvedValues = V, y.isActive && (h = {
                    ...h,
                    ...V
                  }), o && t.blockInitialAnimation && (S = !1), S && !b && u.push(...T.map((t => ({
                    animation: t,
                    options: {
                      type: v,
                      ...r
      ...
      class gi {
        constructor(t, e, {
          ...
          if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.updatePoint = () => {
              ...
              this.lastMoveEvent = t, this.lastMoveEventInfo = vi(e, this.transformPagePoint), Ht(t) && 0 === t.buttons ? this.handlePointerUp(t, e) : ze.update(this.updatePoint, !0)
      ...
      function bi(t, e) {
        ...
        let n = t.length - 1,
          o = null;
        const i = Ei(t);
        for (; n >= 0 && (o = t[n], !(i.timestamp - o.timestamp > $n(e)));) n--;
        if (!o) return {
          x: 0,
          y: 0
        };
      ...
      function Ti(t, e, n, o = .5) {
        t.origin = o, t.originPoint = _n(e.min, e.max, t.origin), t.scale = Pi(n) / Pi(e), (Si(t.scale, 1, 1e-4) || isNaN(t.scale)) && (t.scale = 1), t.translate = _n(n.min, n.max, t.origin) - t.originPoint, (Si(t.translate) || isNaN(t.translate)) && (t.translate = 0)
      }

      function Vi(t, e, n, o) {
        Ti(t.x, e.x, n.x, null == o ? void 0 : o.originX), Ti(t.y, e.y, n.y, null == o ? void 0 : o.originY)
      }

      function Ai(t, e, n) {
        t.min = n.min + e.min, t.max = t.min + Pi(e)
      }

      function Ci(t, e, n) {
        t.min = e.min - n.min, t.max = t.min + Pi(e)
      }
      ...
      function Ni(t) {
        return Ui(t) || $i(t) || t.z || t.rotate || t.rotateX || t.rotateY
      }
      ...
      function Hi(t, e, n, o, i) {
        return void 0 !== i && (t = Wi(t, i, o)), Wi(t, n, o) + e
      }

      function Yi(t, e = 0, n = 1, o, i) {
        t.min = Hi(t.min, e, n, o, i), t.max = Hi(t.max, e, n, o, i)
      }
      ...
      function Xi(t, {
        ...
        Yi(t.x, e.translate, e.scale, e.originPoint), Yi(t.y, n.translate, n.scale, n.originPoint)
      }
      ...
      function qi(t, e, [n, o, i]) {
        const r = void 0 !== e[i] ? e[i] : .5,
          s = _n(t.min, t.max, r);
        Yi(t, e[n], e[o], s, e.scale)
      }
      const Zi = ["x", "scaleX", "originX"],
        Ki = ["y", "scaleY", "originY"];

      function Ji(t, e) {
        qi(t.x, e, Zi), qi(t.y, e, Ki)
      }
      ...
      class er {
        constructor(t) {
          this.openGlobalLock = null, this.isDragging = !1, this.currentDirection = null, this.originPoint = {
            x: 0,
            y: 0
          }, this.constraints = !1, this.hasMutatedConstraints = !1, this.elastic = Ii(), this.visualElement = t
        }
        start(t, {
          snapToCursor: e = !1
        } = {}) {
          !1 !== this.visualElement.isPresent && (this.panSession = new gi(t, {
            ...
            onStart: (t, e) => {
              ...
              (!o || i || (this.openGlobalLock && this.openGlobalLock(), this.openGlobalLock = le(o), this.openGlobalLock)) && (this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), Fi((t => {
                var e, n;
        ...
        updateAxis(t, e, n) {
          ...
          if (!n || !nr(t, o, this.currentDirection)) return;
        ...
        resolveConstraints() {
          ...
          }(e), o !== this.constraints && n && this.constraints && !this.hasMutatedConstraints && Fi((t => {
        ...
        resolveRefConstraints() {
          ...
          const i = function(t, e, n) {
            ...
            return i && (_i(o.x, i.offset.x), _i(o.y, i.offset.y)), o
          ...
          if (e) {
            ...
            this.hasMutatedConstraints = !!t, t && (r = Oi(t))
          }
          return r
        }
        startAnimation(t) {
          ...
          } = this.getProps(), a = this.constraints || {}, l = Fi((s => {
            if (!nr(s, e, this.currentDirection)) return;
        ...
        stopAnimation() {
          Fi((t => this.getAxisMotionValue(t).stop()))
        }
        ...
        snapToCursor(t) {
          Fi((e => {
            ...
            if (!nr(e, n, this.currentDirection)) return;
            const {
              projection: o
        ...
        scalePositionWithinConstraints() {
          ...
          this.visualElement.current.style.transform = r ? r({}, "") : "none", null === (t = o.root) || void 0 === t || t.updateScroll(), o.updateLayout(), this.resolveConstraints(), Fi((t => {
            if (!nr(t, e, null)) return;
            const n = this.getAxisMotionValue(t),
              {
                min: o,
                max: r
      ...
      const rr = /var\((--[a-zA-Z0-9-_]+),? ?([a-zA-Z0-9 ()%#.,-]+)?\)/;
      ...
      function sr(t, e, n = 1) {
        ...
        return r ? r.trim() : ir(i) ? sr(i, e, n + 1) : i
      }
      const ar = new Set(["width", "height", "top", "left", "right", "bottom", "x", "y"]),
        lr = t => ar.has(t),
        ur = (t, e) => {
          t.set(e, !1), t.set(e)
        },
      ...
      const dr = (t, e) => parseFloat(t.split(", ")[e]),
        pr = (t, e) => (n, {
          transform: o
        }) => {
          if ("none" === o || !o) return 0;
          const i = o.match(/^matrix3d\((.+)\)$/);
          if (i) return dr(i[1], e); {
            const e = o.match(/^matrix\((.+)\)$/);
            return e ? dr(e[1], t) : 0
          }
        },
        fr = new Set(["x", "y", "z"]),
        mr = I.filter((t => !fr.has(t))),
        gr = {
          width: ({
            x: t
          }, {
      ...
      function vr(t, e, n, o) {
        return (t => Object.keys(t).some(lr))(e) ? ((t, e, n = {}, o = {}) => {
          e = {
            ...e
          }, o = {
            ...o
          ...
          if (i.forEach((i => {
              ...
              if (Rt(h)) {
                const t = h.length,
                  e = null === h[0] ? 1 : 0;
                u = h[e], c = Sn(u);
                for (let n = e; n < t; n++) d ? Nn(Sn(h[n]) === d, "All keyframes must be of the same type") : (d = Sn(h[n]), Nn(d === c || cr(c) && cr(d), "Keyframes must be of the same dimension as the current value"))
              } else d = Sn(h);
              if (c !== d)
                if (cr(c) && cr(d)) {
                  const t = l.get();
                ...
                }(t), s = !0), a.push(i), o[i] = void 0 !== o[i] ? o[i] : e[i], ur(l, h))
            })), a.length) {
        ...
        if (xr.current = !0, l)
          if (window.matchMedia) {
            const t = window.matchMedia("(prefers-reduced-motion)"),
              e = () => yr.current = t.matches;
            t.addListener(e), e()
          } else yr.current = !1
      }
      const Er = Object.keys(x),
        br = Er.length,
      ...
      class Sr {
        ...
        mount(t) {
          var e;
          this.current = t, this.projection && this.projection.mount(t), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = null === (e = this.parent) || void 0 === e ? void 0 : e.addVariantChild(this)), this.values.forEach(((t, e) => this.bindToMotionValue(e, t))), xr.current || wr(), this.shouldReduceMotion = "never" !== this.reducedMotionConfig && ("always" === this.reducedMotionConfig || yr.current), this.parent && this.parent.children.add(this), this.setProps(this.props)
        }
        unmount() {
          var t, e, n;
        ...
        makeTargetAnimatableFromInstance({
          ...
          if (o && (e && (e = o(e)), n && (n = o(n)), r && (r = o(r))), i) {
            ...
            const t = ((t, e, n, o) => {
              ...
              return vr(t, e = i.target, n, o = i.transitionEnd)
            })(this, n, r, e);
      ...
      class Mr extends Ar {
        ...
        readValueFromInstance(t, e) {
          var n;
          return F.has(e) ? (null === (n = wn(e)) || void 0 === n ? void 0 : n.default) || 0 : (e = At.has(e) ? e : Tt(e), t.getAttribute(e))
        }
        ...
        Br = {
          correct: (t, {
            ...
            const o = t,
              i = t.includes("var("),
              r = [];
            i && (t = t.replace(rr, (t => (r.push(t), Dr))));
            const s = fn.parse(t);
      ...
      class Ir extends o.Component {
        componentDidMount() {
          ...
          B(Fr), i && (e.group && e.group.add(i), n && n.register && o && n.register(i), i.root.didUpdate(), i.addEventListener("animationComplete", (() => {
            this.safeToRemove()
          })), i.setOptions({
            ...i.options,
      ...
      const Fr = {
        ...
        Or = {
          measureLayout: function(t) {
            const [e, n] = Ce(), i = (0, o.useContext)(S);
      ...
      const Ur = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
        Nr = Ur.length,
        $r = t => "string" == typeof t ? parseFloat(t) : t,
        zr = t => "number" == typeof t || nt.test(t);
      ...
      function _r(t, e) {
        Gr(t.x, e.x), Gr(t.y, e.y)
      }

      function qr(t, e, n, o, i) {
        return t = Wi(t -= e, 1 / n, o), void 0 !== i && (t = Wi(t, 1 / i, o)), t
      }
      ...
      function Zr(t, e, [n, o, i], r, s) {
        ! function(t, e = 0, n = 1, o = .5, i, r = t, s = t) {
          ...
          t === r && (a -= e), t.min = qr(t.min, e, n, a, i), t.max = qr(t.max, e, n, a, i)
      ...
      function Qr(t, e, n, o) {
        Zr(t.x, e, Kr, null == n ? void 0 : n.x, null == o ? void 0 : o.x), Zr(t.y, e, Jr, null == n ? void 0 : n.y, null == o ? void 0 : o.y)
      }
        ...
        return class {
          ...
          mount(e, n = !1) {
            ...
            if (s && !s.current && s.mount(e), this.root.nodes.add(this), null === (o = this.parent) || void 0 === o || o.children.add(this), this.elementId && this.root.potentialNodes.delete(this.elementId), n && (r || i) && (this.isLayoutDirty = !0), t) {
              ...
              t(e, (() => {
                this.root.updateBlockedByResize = !0, n && n(), n = $o(o, 250), b.hasAnimatedSinceResize && (b.hasAnimatedSinceResize = !1, this.nodes.forEach(vs))
              }))
            }
            i && this.root.registerSharedNode(i, this), !1 !== this.options.animate && s && (i || r) && this.addEventListener("didUpdate", (({
              ...
              const c = null !== (r = null !== (i = this.options.transition) && void 0 !== i ? i : s.getDefaultTransition()) && void 0 !== r ? r : Ts,
                {
          ...
          didUpdate() {
            ...
            this.isUpdating && (this.isUpdating = !1, this.potentialNodes.size && (this.potentialNodes.forEach(Vs), this.potentialNodes.clear()), this.nodes.forEach(gs), this.nodes.forEach(hs), this.nodes.forEach(ds), this.clearAllSnapshots(), He.update(), He.preRender(), He.render())
          }
          clearAllSnapshots() {
            this.nodes.forEach(fs), this.sharedNodes.forEach(Es)
          }
          ...
          updateLayout() {
            ...
            const e = this.layout;
            this.layout = this.measure(!1), this.layoutCorrected = Ii(), this.isLayoutDirty = !1, this.projectionDelta = void 0, this.notifyListeners("measure", this.layout.layoutBox), null === (t = this.options.visualElement) || void 0 === t || t.notify("LayoutMeasure", this.layout.layoutBox, null == e ? void 0 : e.layoutBox)
          }
          ...
          resetTransform() {
            ...
            e && (n || Ni(this.latestValues) || s) && (i(this.instance, r), this.shouldResetTransform = !1, this.scheduleRender())
          }
          measure(t = !0) {
          ...
          measurePageBox() {
            ...
            return n && (_i(e.x, n.offset.x), _i(e.y, n.offset.y)), e
          }
            ...
            for (let n = 0; n < this.path.length; n++) {
              ...
              if (o !== this.root && i && r.layoutScroll) {
                if (i.isRoot) {
                  ...
                  n && (_i(e.x, -n.offset.x), _i(e.y, -n.offset.y))
                }
                _i(e.x, i.offset.x), _i(e.y, i.offset.y)
              }
            }
            return e
          }
          applyTransform(t, e = !1) {
            ...
            for (let t = 0; t < this.path.length; t++) {
              const o = this.path[t];
              !e && o.options.layoutScroll && o.scroll && o !== o.root && Ji(n, {
                x: -o.scroll.offset.x,
                y: -o.scroll.offset.y
              }), Ni(o.latestValues) && Ji(n, o.latestValues)
            }
            return Ni(this.latestValues) && Ji(n, this.latestValues), n
          }
          removeTransform(t) {
            var e;
            const n = Ii();
            ...
            for (let t = 0; t < this.path.length; t++) {
              ...
              if (!Ni(o.latestValues)) continue;
              Ui(o.latestValues) && o.updateSnapshot();
              const i = Ii();
              _r(i, o.measurePageBox()), Qr(n, o.latestValues, null === (e = o.snapshot) || void 0 === e ? void 0 : e.layoutBox, i)
            }
            return Ni(this.latestValues) && Qr(n, this.latestValues), n
          }
          setTargetDelta(t) {
          ...
          resolveTargetDelta() {
            ...
            if (this.layout && (n || o)) {
              if (!this.targetDelta && !this.relativeTarget) {
                ...
                t && t.layout ? (this.relativeParent = t, this.relativeTarget = Ii(), this.relativeTargetOrigin = Ii(), Mi(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox), _r(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
              }
              var i, r, s;
              if ((this.relativeTarget || this.targetDelta) && (this.target || (this.target = Ii(), this.targetWithTransforms = Ii()), this.relativeTarget && this.relativeTargetOrigin && (null === (t = this.relativeParent) || void 0 === t ? void 0 : t.target) ? (i = this.target, r = this.relativeTarget, s = this.relativeParent.target, Ai(i.x, r.x, s.x), Ai(i.y, r.y, s.y)) : this.targetDelta ? (Boolean(this.resumingFrom) ? this.target = this.applyTransform(this.layout.layoutBox) : _r(this.target, this.layout.layoutBox), Xi(this.target, this.targetDelta)) : _r(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget)) {
                this.attemptToResolveRelativeTarget = !1;
                const t = this.getClosestProjectingParent();
                t && Boolean(t.resumingFrom) === Boolean(this.resumingFrom) && !t.options.layoutScroll && t.target ? (this.relativeParent = t, this.relativeTarget = Ii(), this.relativeTargetOrigin = Ii(), Mi(this.relativeTargetOrigin, this.target, t.target), _r(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
              }
            }
          }
          getClosestProjectingParent() {
            if (this.parent && !Ui(this.parent.latestValues) && !$i(this.parent.latestValues)) return (this.parent.relativeTarget || this.parent.targetDelta) && this.parent.layout ? this.parent : this.parent.getClosestProjectingParent()
          }
          calcProjection() {
            var t;
            const {
            ...
            _r(this.layoutCorrected, this.layout.layoutBox),
              function(t, e, n, o = !1) {
                ...
                let a, l;
                e.x = e.y = 1;
                for (let u = 0; u < s; u++) a = n[u], l = a.projectionDelta, "contents" !== (null === (r = null === (i = a.instance) || void 0 === i ? void 0 : i.style) || void 0 === r ? void 0 : r.display) && (o && a.options.layoutScroll && a.scroll && a !== a.root && Ji(t, {
                  x: -a.scroll.offset.x,
                  y: -a.scroll.offset.y
                }), l && (e.x *= l.x.scale, e.y *= l.y.scale, Xi(t, l)), o && Ni(a.latestValues) && Ji(t, a.latestValues));
                e.x = Gi(e.x), e.y = Gi(e.y)
            ...
            Vi(this.projectionDelta, this.layoutCorrected, l, this.latestValues), this.projectionTransform = rs(this.projectionDelta, this.treeScale), this.projectionTransform === h && this.treeScale.x === u && this.treeScale.y === c || (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", l))
          }
          hide() {
            this.isVisible = !1
          }
          ...
          setAnimationOrigin(t, e = !1) {
            ...
            this.animationProgress = 0, this.mixTargetDelta = e => {
              ...
              const o = e / 1e3;
              var i, d, p, f;
              bs(a.x, t.x, o), bs(a.y, t.y, o), this.setTargetDelta(a), this.relativeTarget && this.relativeTargetOrigin && this.layout && (null === (n = this.relativeParent) || void 0 === n ? void 0 : n.layout) && (Mi(l, this.layout.layoutBox, this.relativeParent.layout.layoutBox), i = this.relativeTarget, d = this.relativeTargetOrigin, p = l, f = o, Ps(i.x, d.x, p.x, f), Ps(i.y, d.y, p.y, f)), u && (this.animationValues = s, function(t, e, n, o, i, r) {
                i ? (t.opacity = _n(0, void 0 !== n.opacity ? n.opacity : 1, Hr(o)), t.opacityExit = _n(void 0 !== e.opacity ? e.opacity : 1, 0, Yr(o))) : r && (t.opacity = _n(void 0 !== e.opacity ? e.opacity : 1, void 0 !== n.opacity ? n.opacity : 1, o));
                for (let i = 0; i < Nr; i++) {
                  const r = `border${Ur[i]}Radius`;
                  let s = Wr(e, r),
                    a = Wr(n, r);
                  void 0 === s && void 0 === a || (s || (s = 0), a || (a = 0), 0 === s || 0 === a || zr(s) === zr(a) ? (t[r] = Math.max(_n($r(s), $r(a), o), 0), (et.test(a) || et.test(s)) && (t[r] += "%")) : t[r] = a)
          ...
          startAnimation(t) {
            ...
            this.notifyListeners("animationStart"), null === (e = this.currentAnimation) || void 0 === e || e.stop(), this.resumingFrom && (null === (n = this.resumingFrom.currentAnimation) || void 0 === n || n.stop()), this.pendingAnimation && (We.update(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = ze.update((() => {
              b.hasAnimatedSinceResize = !0, this.currentAnimation = jr(0, 1e3, {
                ...t,
                onUpdate: e => {
                  var n;
          ...
          applyTransformsToTarget() {
            ...
            if (e && n && o) {
              if (this !== t && this.layout && o && Cs(this.options.animationType, this.layout.layoutBox, o.layoutBox)) {
                n = this.target || Ii();
                const e = Pi(this.layout.layoutBox.x);
                n.x.min = t.target.x.min, n.x.max = n.x.min + e;
                const o = Pi(this.layout.layoutBox.y);
                n.y.min = t.target.y.min, n.y.max = n.y.min + o
              }
              _r(e, n), Ji(e, i), Vi(this.projectionDeltaWithTransform, this.layoutCorrected, e, i)
            }
          }
          ...
          getProjectionStyles(t = {}) {
            ...
            if (!this.projectionDelta || !this.layout || !s.target) {
              const e = {};
              return this.options.layoutId && (e.opacity = void 0 !== this.latestValues.opacity ? this.latestValues.opacity : 1, e.pointerEvents = It(t.pointerEvents) || ""), this.hasProjected && !Ni(this.latestValues) && (e.transform = r ? r({}, "") : "none", this.hasProjected = !1), e
            }
            const a = s.animationValues || s.latestValues;
            this.applyTransformsToTarget(), i.transform = rs(this.projectionDeltaWithTransform, this.treeScale, a), r && (i.transform = r(a, i.transform));
            const {
              x: l,
              y: u
      ...
      function Cs(t, e, n) {
        return "position" === t || "preserve-aspect" === t && !Si(os(e), os(n), .2)
      }
      const Ms = cs({
      ...
      const zs = t => t.key || "",
        Ws = ({
          ...
          return "wait" === a && f.size && (p = []), f.forEach((t => {
            ...
            if (!n) return;
            const r = y.indexOf(t);
            p.splice(r, 0, o.createElement(Ns, {
              key: zs(n),
              isPresent: !1,
              onExitComplete: () => {
        ...
        Hs = (0, o.createContext)(null),
        Ys = t => !t.isLayoutDirty && t.willUpdate(!1);
      ...
      const Gs = t => !0 === t,
        _s = ({
          ...
          void 0 !== n && (i = n);
          const r = (0, o.useContext)(S),
            s = (0, o.useContext)(Hs),
            [a, l] = Os(),
            u = (0, o.useRef)(null),
            c = r.id || s;
          null === u.current && ((t => Gs(!0 === t) || "id" === t)(i) && c && (e = e ? c + "-" + e : c), u.current = {
            id: e,
            group: Gs(i) && r.group || Xs()
          });
          const h = (0, o.useMemo)((() => ({
            ...u.current,
            forceRender: a
      ...
      function Js({
        ...
        const [, i] = (0, o.useState)(!Qs(e)), r = (0, o.useRef)(void 0);
        if (!Qs(e)) {
          const {
            renderer: t,
            ...n
        ...
        ea = (0, o.forwardRef)((function({
          ...
          const h = {
            ...
            updateOrder: (t, e, n) => {
              ...
              u !== o && (c.current = !0, i(o.map(na).filter((t => -1 !== r.indexOf(t)))))
            }
          };
          return (0, o.useEffect)((() => {
            c.current = !1
      ...
      const ra = t => (t => "object" == typeof t && t.mix)(t) ? t.mix : void 0;
      ...
      function la(t, e, n, o) {
        const i = "function" == typeof e ? e : sa(e, n, o);
        return Array.isArray(t) ? ua(t, i) : ua([t], (([t]) => i(t)))
      }
      ...
      function ga(t, e = {}) {
        const {
          isStatic: n
        } = (0, o.useContext)(i), r = (0, o.useRef)(null), s = ia(j(t) ? t.get() : t);
      ...
      function ba(t) {
        ...
        var i;
        null === (i = wa.get(e)) || void 0 === i || i.forEach((t => {
          t({
            target: e,
            contentSize: n,
            get size() {
      ...
      function La(t, e, n, o) {
        const i = n[e],
          ...
          a = i.current,
          l = n.time;
        i.current = t[`scroll${s}`], i.scrollLength = t[`scroll${r}`] - t[`client${r}`], i.offset.length = 0, i.offset[0] = 0, i.offset[1] = i.scrollLength, i.progress = Aa(0, i.scrollLength, i.current);
        const u = o - l;
        var c, h;
        i.velocity = u > Ca ? 0 : (c = i.current - a, (h = u) ? c * (1e3 / h) : 0)
      }
      const Ra = t => t,
        Da = (t, e, n) => -n * t + n * e + t;
      ...
      const Fa = t => "number" == typeof t,
        Oa = t => Array.isArray(t) && !Fa(t[0]),
        ja = (t, e, n) => {
          const o = e - t;
          return ((n - t) % o + o) % o + t
        },
        Ua = (t, e, n) => Math.min(Math.max(n, t), e);
      const Na = {
          Enter: [
            [0, 1],
            [1, 1]
      ...
      function Ya(t, e, n, o) {
        let i = Array.isArray(t) ? t : Ha,
          r = 0,
          s = 0;
        return Fa(t) ? i = [t, t] : $a(t) && (i = (t = t.trim()).includes(" ") ? t.split(" ") : [t, za[t] ? t : "0"]), r = Wa(i[0], n, o), s = Wa(i[1], e), r - s
      }
      const Xa = {
        x: 0,
        y: 0
      ...
      function Ga(t, e, n) {
        ...
        const h = o.length;
        for (let t = 0; t < h; t++) {
          const n = Ya(o[t], u[s], l[s], a[r]);
          c || n === e[r].interpolatorOffsets[t] || (c = !0), e[r].offset[t] = n
        }
        c && (e[r].interpolate = function(t) {
          let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Ia(t.length),
            n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Ra;
          const o = t.length,
            i = o - e.length;
          return i > 0 && Ba(e, i), i => {
            let r = 0;
            for (; r < o - 2 && !(i < e[r + 1]); r++);
            let s = Ua(0, 1, Aa(e[r], e[r + 1], i));
            const a = function(t, e) {
              return Oa(t) ? t[ja(0, t.length, e)] : t
            }(n, r);
            return s = a(s), Da(t[r], t[r + 1], s)
          }
        }(Ia(h), e[r].offset), e[r].interpolatorOffsets = [...e[r].offset]), e[r].progress = e[r].interpolate(e[r].current)
      }
      ...
      function Ja(t) {
        ...
        const r = Ma(),
          s = function(t, e, n) {
            ...
            return {
              ...
              notify: Va(e) ? () => e(n) : (r = e, s = n[i], r.pause(), r.forEachNative(((t, e) => {
                let {
                  easing: n
                } = e;
                var o, i;
                if (t.updateDuration) n || (t.easing = Ra), t.updateDuration(1);
                else {
                  const e = {
                    duration: 1e3
                  };
        ...
        if (i.add(s), !_a.has(n)) {
          ...
          window.addEventListener("resize", t, {
            passive: !0
          }), n !== document.documentElement && qa.set(n, (u = t, Va(l = n) ? (a = l, Sa.add(a), Ta || (Ta = () => {
            const t = {
            ...
            return n.forEach((t => {
              let n = wa.get(t);
              n || (n = new Set, wa.set(t, n)), n.add(e), null == Ea || Ea.observe(t)
            })), () => {
              n.forEach((t => {
                const n = wa.get(t);
        ...
        return () => {
          ...
          const i = _a.get(n);
          _a.delete(n), i && (Ka(n).removeEventListener("scroll", i), null === (e = qa.get(n)) || void 0 === e || e(), window.removeEventListener("resize", i))
        }
      }
      const Qa = () => ({
        scrollX: Qe(0),
      ...
      function el(t) {
        return ye(!1, "useElementScroll is deprecated. Convert to useScroll({ container: ref })."), tl({
          container: t
        })
      }

      function nl() {
        return ye(!1, "useViewportScroll is deprecated. Convert to useScroll()."), tl()
      }
      ...
      class rl extends Je {
        ...
        add(t) {
          let e;
          F.has(t) ? (this.transforms.add(t), e = "transform") : t.startsWith("origin") || z(t) || "willChange" === t || (e = Tt(t)), e && (_e(this.members, e), this.update())
        }
        remove(t) {
          F.has(t) ? (this.transforms.delete(t), this.transforms.size || qe(this.members, "transform")) : qe(this.members, Tt(t)), this.update()
        }
        update() {
      ...
      function ll() {
        !xr.current && wr();
        const [t] = (0, o.useState)(yr.current);
        return t
      }
      ...
      function fl(...t) {
        ...
        return [n, (0, o.useCallback)((n => {
          e.current = "number" != typeof n ? pl(0, t.length, e.current + 1) : n, i(t[e.current])
        }), [t.length, ...t])]
      }
      const ml = {
        any: 0,
          ...
          return function(t, e) {
            ...
            const r = xa(t),
              ...
              a = new IntersectionObserver((t => {
                ...
                root: n,
                rootMargin: o,
                threshold: "number" == typeof i ? i : ml[i]
              });
      ...
      function kl(t) {
        const [e, n] = (0, o.useState)(t), i = Ml({}, !1), r = E((() => new Cl({
          props: {},
          visualState: i
        }, {
          initialState: t
      ...
      function Dl(t) {
        let e = ia(1),
          n = ia(1);
        const o = s();
        return Nn(!(!t && !o), "If no scale values are provided, useInvertedScale must be used within a child of another motion component."), Un(Rl, "useInvertedScale is deprecated and will be removed in 3.0. Use the layout prop instead."), Rl = !0, t ? (e = t.scaleX || e, n = t.scaleY || n) : o && (e = o.getValue("scaleX", 1), n = o.getValue("scaleY", 1)), {
          scaleX: la(e, Ll),
          scaleY: la(n, Ll)
        }
      }
