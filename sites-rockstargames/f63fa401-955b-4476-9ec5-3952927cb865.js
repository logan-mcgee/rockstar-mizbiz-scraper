! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "f63fa401-955b-4476-9ec5-3952927cb865", e._sentryDebugIdIdentifier = "sentry-dbid-f63fa401-955b-4476-9ec5-3952927cb865")
  } catch (e) {}
}();
        ...
        const p = (0, l.useIntl)(),
          ...
          S = (e, a) => {
            const n = a ?? e.target.hash,
              ...
              o = h.get("country");
            if (e) {
              const a = `${b.pathname}${h.get("country")?`?country=${o}`:""}${n}`;
