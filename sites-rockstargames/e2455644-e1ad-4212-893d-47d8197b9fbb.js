try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e2455644-e1ad-4212-893d-47d8197b9fbb", e._sentryDebugIdIdentifier = "sentry-dbid-e2455644-e1ad-4212-893d-47d8197b9fbb")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [8256], {
      ...
      const k = {
        ...
        h = ({
          ...
          const [S, A] = (0, l.useState)(!1), E = (0, r.useIntl)(), {
            ...
            buttonText: E.formatMessage(_.ns_ok_button_text),
            onClick: () => {
              h(!1)
            },
            testId: "ok-btn",
            ...
            buttonText: x?.showManagePreferences ? E.formatMessage(_.ns_manage_prefs_button_text) : "",
            isLink: !0,
            link: s.preferences,
        ...
        x = {
          SUCCESS: {
            icon: "check",
            heading: _.ns_successfully_subscribed_title,
            bodyText: _.ns_successfully_subscribed_details_amp,
            showManagePreferences: !0
          },
          CHECK_EMAIL: {
            icon: "mail",
            heading: _.ns_check_email_title,
            bodyText: _.ns_check_email_details
          },
          ERROR_PREFERENCES: {
            icon: "error",
            heading: _.ns_error_preferences_title,
            bodyText: _.ns_error_preferences_details,
            showManagePreferences: !0
          },
          ERROR_GENERIC: {
            icon: "error",
            heading: _.ns_error_generic_title,
            bodyText: _.ns_error_generic_details
          },
          ALREADY_SUBSCRIBED: {
            icon: "check",
            heading: _.ns_already_subbed_title,
            bodyText: _.ns_already_subbed_details_amp,
            showManagePreferences: !0
          },
          NEW_ACCOUNT: {
            icon: "mail",
            heading: _.ns_confirm_after_register_title,
            bodyText: _.ns_confirm_after_register_details,
            showManagePreferences: !0
          },
          CONFIRM: {
            icon: "mail",
            heading: _.ns_confirm_title,
            bodyText: _.ns_confirm_details,
        ...
        S = e => w(e),
        A = (e, t) => {
          const [s, a] = (0, l.useState)(), [o, c] = (0, l.useState)(!1), [d, u] = (0, l.useState)(!1), [b, g] = (0, l.useState)(!1), [m, f] = (0, l.useState)(!1), p = (0, n.useReactiveVar)(w), k = (0, r.useIntl)(), {
            track: h
          } = (0, i.useGtmTrack)(), A = {
            ...
            buttons: [{
              buttonText: k.formatMessage(_.ns_yes_subscribe_text),
              style: "monochrome",
              onClick: () => {
                C()
              }
            }, {
              buttonText: k.formatMessage(_.ns_go_back_text),
              onClick: () => {
                a(null), u(!1)
              }
            }]
            ...
            element_placement: "newsletter subscribe",
            text: "subscribe now"
          }), t.loggedIn || window.location.assign(A.auth), t.loggedIn && t.isAMinor ? (E(x.ERROR_GENERIC), f(!1), void h({
            event: "alert_error",
            ...
            element_placement: "newsletter subscribe"
          }), E(x.ALREADY_SUBSCRIBED), void f(!1)) : void 0), N = async () => {
            const {
              error: e = null,
              result: s
    ...
    47279(e, t, s) {
      ...
      const i = {
        ...
        o = () => {
          ...
          const {
            location: t
          } = window, s = t.hostname.substring(0, t.hostname.indexOf(".rockstargames.com")), i = n.findIndex(t => Object.entries(t.sites).findIndex(([t, a]) => a === s && (e = {
            site: t,
            subDomain: a
          }, !0)) >= 0), o = n[i >= 0 ? i : 0], c = n.find(e => e.id === o.fallbackEnvironment);
          return e || (e = {
            site: "www",
            subDomain: "local"
          }), (0, r.A)((0, a.A)({}, c, {
    ...
    50573(e, t, s) {
      ...
      var m = s(68071),
        ...
        _ = s(48348),
        p = s(6700),
        k = f.A ? f.A.isConcatSpreadable : void 0;
      const h = function(e) {
          return (0, p.A)(e) || (0, _.A)(e) || !!(k && e && e[k])
        },
