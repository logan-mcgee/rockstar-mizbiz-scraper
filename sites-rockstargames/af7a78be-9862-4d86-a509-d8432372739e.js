! function() {
  try {
    var n = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (n._sentryDebugIds = n._sentryDebugIds || {}, n._sentryDebugIds[e] = "af7a78be-9862-4d86-a509-d8432372739e", n._sentryDebugIdIdentifier = "sentry-dbid-af7a78be-9862-4d86-a509-d8432372739e")
  } catch (n) {}
}();
  ...
  [2843], {
    82843: (n, e, a) => {
      ...
      var t = a(62229),
        ...
        _ = a(55300),
        w = {};
      w.styleTagTransform = k(), w.setAttributes = u(), w.insert = h().bind(null, "head"), w.domAPI = p(), w.insertStyleElement = A(), g()(_.A, w);
      ...
      const N = (0, m.A)((0, B.g)((n => {
        ...
        return (0, S.jsxs)("div", {
          className: [y.rating, w ? y.withDescriptors : y.withOutDescriptors, f || ""].join(" "),
          ...
          children: [(0, S.jsx)(d.A, {
            ...
            children: (0, S.jsx)("img", {
              alt: k.formatMessage(C.components_ratings_link_alt, {
                rating: (B = b.ratingImg, B.replace(/_/g, " ").split(".")[0].toUpperCase())
              }),
            ...
            }), b.ratingFooter && (0, S.jsx)("hr", {}), b.ratingFooter && (0, S.jsx)("p", {
              dangerouslySetInnerHTML: {
    ...
    65317: (n, e, a) => {
      ...
      var t = a(62229),
        ...
        v = a(39460),
        u = {};
      u.styleTagTransform = h(), u.setAttributes = g(), u.insert = m().bind(null, "head"), u.domAPI = o(), u.insertStyleElement = p(), i()(v.A, u);
    ...
    55300: (n, e, a) => {
      ...
      s.push([n.id, '.rockstargames-sites-rockstargamesc3e95c84902dd75b827d3c95532e22dc{--font-family-body:"Chalet";--font-family-h:"ChaletComprime";--font-weight-regular:400;--font-weight-bold:700;--letter-spacing-body:0;--letter-spacing-h:0;--line-height-sm:1;--line-height-md:1.1;--line-height-lg:1.6;--black-200:#000;--black-100:#121212;--black-65:hsla(0,0%,7%,.65);--black-40:hsla(0,0%,7%,.4);--black-15:hsla(0,0%,7%,.15);--text-dark:#2d2d2d;--border-color:#2d2d2d;--white-100:#fff;--white-65:hsla(0,0%,100%,.65);--white-40:hsla(0,0%,100%,.4);--white-15:hsla(0,0%,100%,.15);--text-light:#e8e8e8;--focusring-blue:blue;--red:#e03232;--circoloco-red:#eb1818;--rockstar-gold:#fcaf17;--playstation-blue:#00439c;--microsoft-green:#387a26;--pc-legacy:#b2b2b2;--pc-enhanced:#beb279;--color-h:var(--white-100);--color-body:var(--text-light);--green-light:#c1f7bd;--green-dark:#81da85;--scroll-thumb-color:#7d7d7d;--scroll-track-color:transparent;--max-width-sm:640px;--max-width-md:1088px;--max-width-lg:1920px;--max-width-xl:2560px;--spacing-xxs:0.25rem;--spacing-xs:0.5rem;--spacing-sm:1rem;--spacing-md:2rem;--spacing-lg:4rem;--spacing-xl:8rem;--grid-gap-xxs:var(--spacing-xxs);--grid-gap-xs:var(--spacing-xs);--grid-gap-sm:var(--spacing-sm);--grid-gap-md:var(--spacing-md);--grid-gap-lg:var(--spacing-lg);--grid-gap-xl:var(--spacing-xl);--padding-xxs:var(--spacing-xxs);--padding-xs:var(--spacing-xs);--padding-sm:var(--spacing-sm);--padding-md:var(--spacing-md);--padding-lg:var(--spacing-lg);--padding-xl:var(--spacing-xl);--margin-xxs:var(--spacing-xxs);--margin-xs:var(--spacing-xs);--margin-sm:var(--spacing-sm);--margin-md:var(--spacing-md);--margin-lg:var(--spacing-lg);--margin-xl:var(--spacing-xl);--border-radius-xs:2px;--border-radius-sm:4px;--border-radius-md:8px;--border-radius-lg:16px;--gradient-overlay-bottom:linear-gradient(180.08deg,transparent 25%,rgba(0,0,0,.5) 65%,rgba(0,0,0,.6));--gradient-overlay-right:linear-gradient(270deg,rgba(0,0,0,.9),transparent);--promo-banner-z-index:11500;background-color:var(--black-200);border:1px solid var(--border-color);border-radius:var(--border-radius-sm);color:#000;display:grid;font-size:10px;margin:0 auto;max-width:270px;padding:var(--padding-sm)}@media (min-width:2560px){.rockstargames-sites-rockstargamesc3e95c84902dd75b827d3c95532e22dc{--max-width-md:1440px}}@media (max-width:767px){.rockstargames-sites-rockstargamesc3e95c84902dd75b827d3c95532e22dc{--spacing-lg:2rem;--spacing-xl:4rem}}.rockstargames-sites-rockstargamesc3e95c84902dd75b827d3c95532e22dc.rockstargames-sites-rockstargamesb98963abfc7a63295bebc6c6d15b391a{grid-gap:var(--grid-gap-sm);grid-template-columns:72px 1fr}.rockstargames-sites-rockstargamesc3e95c84902dd75b827d3c95532e22dc.rockstargames-sites-rockstargamesb6339480b5fd086fb0c025930bfb7dcd{max-width:calc(72px + (2 * var(--padding-sm)))}.rockstargames-sites-rockstargamesc3e95c84902dd75b827d3c95532e22dc hr{background:var(--white-15);border:0;height:1px;margin:0;width:100%}.rockstargames-sites-rockstargamesc3e95c84902dd75b827d3c95532e22dc img{width:100%}.rockstargames-sites-rockstargamesbabdd6ae2ff83f380dadc6982effa011{grid-gap:var(--grid-gap-xs);align-content:center;display:grid}.rockstargames-sites-rockstargamesbabdd6ae2ff83f380dadc6982effa011 p{color:var(--white-100)!important;font-family:var(--font-family-body)!important;font-size:10px!important;line-height:1.25!important}.rockstargames-sites-rockstargamesbabdd6ae2ff83f380dadc6982effa011 p:empty{display:none!important}.rockstargames-sites-rockstargamesbabdd6ae2ff83f380dadc6982effa011 a{font-weight:700}', "", {
        ...
        names: [],
        mappings: "AAEA,mECDA,2BAAA,CACA,gCAAA,CAGA,yBAAA,CACA,sBAAA,CAGA,uBAAA,CACA,oBAAA,CAGA,kBAAA,CACA,oBAAA,CACA,oBAAA,CAGA,gBAAA,CACA,mBAAA,CACA,4BAAA,CACA,2BAAA,CACA,4BAAA,CACA,mBAAA,CACA,sBAAA,CAEA,gBAAA,CACA,8BAAA,CACA,6BAAA,CACA,8BAAA,CACA,oBAAA,CAEA,qBAAA,CACA,aAAA,CACA,uBAAA,CACA,uBAAA,CACA,0BAAA,CACA,yBAAA,CACA,mBAAA,CAEA,qBAAA,CAGA,0BAAA,CACA,8BAAA,CAEA,qBAAA,CACA,oBAAA,CAGA,4BAAA,CACA,gCAAA,CAGA,oBAAA,CACA,qBAAA,CACA,qBAAA,CACA,qBAAA,CAIA,qBAAA,CACA,mBAAA,CACA,iBAAA,CACA,iBAAA,CACA,iBAAA,CACA,iBAAA,CAIA,iCAAA,CACA,+BAAA,CACA,+BAAA,CACA,+BAAA,CACA,+BAAA,CACA,+BAAA,CAGA,gCAAA,CACA,8BAAA,CACA,8BAAA,CACA,8BAAA,CACA,8BAAA,CACA,8BAAA,CAGA,+BAAA,CACA,6BAAA,CACA,6BAAA,CACA,6BAAA,CACA,6BAAA,CACA,6BAAA,CAGA,sBAAA,CACA,sBAAA,CACA,sBAAA,CACA,uBAAA,CAGA,sGAAA,CAMA,2EAAA,CAOA,4BAAA,CDzGI,iCAAA,CACA,oCAAA,CACA,qCAAA,CACA,UAAA,CALA,YAAA,CAMA,cAAA,CACA,aAAA,CAGA,eAAA,CAFA,yBAmGJ,CEHI,0BAAA,mEDpDE,qBD2DJ,CACF,CE3EI,yBAAA,mEDwBI,iBAAA,CAAoB,iBDwD1B,CACF,CA1GI,qIAEI,2BAAA,CADA,8BA6GR,CAzGI,qIACI,8CA2GR,CAjIA,sEA0BQ,0BAAA,CACA,QAAA,CAIA,UAAA,CAHA,QAAA,CAEA,UA0GR,CAxIA,uEAmCQ,UAwGR,CAzFA,mEACI,2BAAA,CACA,oBAAA,CACA,YA2FJ,CA9FA,qEAVI,gCAAA,CACA,6CAAA,CACA,wBAAA,CACA,0BA2GJ,CAzGI,2EACI,sBA2GR,CAvGA,qEAUQ,eAgGR",
