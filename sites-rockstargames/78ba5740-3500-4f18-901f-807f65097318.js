try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "78ba5740-3500-4f18-901f-807f65097318", t._sentryDebugIdIdentifier = "sentry-dbid-78ba5740-3500-4f18-901f-807f65097318")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [1118], {
    10376(t, e, n) {
      ...
      async function S(t, e) {
        ...
        } : l.reference, x = await (null == i.getOffsetParent ? void 0 : i.getOffsetParent(s.floating)), b = await (null == i.isElement ? void 0 : i.isElement(x)) && await (null == i.getScale ? void 0 : i.getScale(x)) || {
          x: 1,
          y: 1
        }, v = T(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
          elements: s,
          rect: w,
          offsetParent: x,
          strategy: a
        ...
        return {
          top: (y.top - v.top + p.top) / b.y,
          bottom: (v.bottom - y.bottom + p.bottom) / b.y,
          left: (y.left - v.left + p.left) / b.x,
          right: (v.right - y.right + p.right) / b.x
        }
      }
      ...
      function lt(t, e, n, o) {
        ...
        if (i) {
          ...
          for (; r && o && e !== n;) {
            ...
            c *= t.x, f *= t.y, u *= t.x, d *= t.y, c += i, f += l, n = P(r), r = tt(n)
          }
        }
        return T({
          width: u,
      ...
      const pt = {
        convertOffsetParentRelativeRectToViewportRelativeRect: function(t) {
          ...
          const u = a(0),
            d = B(o);
          if ((d || !d && !i) && (("body" !== M(o) || j(l)) && (c = G(o)), d)) {
            const t = lt(o);
            f = ot(o), u.x = t.x + o.clientLeft, u.y = t.y + o.clientTop
          }
          const h = !l || d || i ? a(0) : at(l, c);
          return {
            width: n.width * f.x,
            height: n.height * f.y,
            ...
            async fn(e) {
              ...
              const {
                ...
                const {
                  ...
                  platform: o,
                  elements: r
                } = t, i = await (null == o.isRTL ? void 0 : o.isRTL(r.floating)), l = d(n), s = h(n), a = "y" === g(n), c = k.has(l) ? -1 : 1, f = i && a ? -1 : 1, m = u(e, t);
                let {
                  mainAxis: p,
                  crossAxis: y,
                  alignmentAxis: w
          ...
          return void 0 === t && (t = {}), {
            ...
            async fn(e) {
              const {
                ...
                x: n,
                y: o
              }, p = await i.detectOverflow(e, c), y = g(d(r)), w = m(y);
              let x = h[w],
                b = h[y];
              if (l) {
          ...
          return void 0 === t && (t = {}), {
            ...
            async fn(e) {
              ...
              const {
                ...
                apply: f = () => {},
                ...m
              } = u(t, e), p = await a.detectOverflow(e, m), y = d(l), w = h(l), x = "y" === g(l), {
                width: b,
                height: v
              } = s.floating;
              let R, E;
              "top" === y || "bottom" === y ? (R = y, E = w === (await (null == a.isRTL ? void 0 : a.isRTL(c.floating)) ? "start" : "end") ? "left" : "right") : (E = y, R = "end" === w ? "top" : "bottom");
              const A = v - p.top - p.bottom,
                T = b - p.left - p.right,
                D = r(v - p[R], A),
                S = r(b - p[E], T),
              ...
              if (null != (n = e.middlewareData.shift) && n.enabled.x && (k = T), null != (o = e.middlewareData.shift) && o.enabled.y && (O = A), L && !w) {
                const t = i(p.left, 0),
                  ...
                  n = i(p.top, 0),
                  o = i(p.bottom, 0);
                x ? k = b - 2 * (0 !== t || 0 !== e ? t + e : i(p.left, p.right)) : O = v - 2 * (0 !== n || 0 !== o ? n + o : i(p.top, p.bottom))
              }
              await f({
                ...e,
                availableWidth: k,
              ...
              const C = await a.getDimensions(c.floating);
        ...
        Et = t => ({
          ...
          async fn(e) {
            ...
            const g = A(m),
              ...
              S = l.reference[b] + l.reference[x] - w[x] - l.floating[b],
              L = w[x] - l.reference[x],
              O = await (null == s.getOffsetParent ? void 0 : s.getOffsetParent(d));
            let k = O ? O[D] : 0;
            k && await (null == s.isElement ? void 0 : s.isElement(O)) || (k = a.floating[D] || l.floating[b]);
            const C = S / 2 - L / 2,
              M = k / 2 - v[b] / 2 - 1,
              P = r(g[E], M),
              H = r(g[T], M),
              ...
              B = k / 2 - v[b] / 2 + C,
              W = f(_, B, F),
              j = !c.arrow && null != h(i) && B !== W && l.reference[b] / 2 - (B < _ ? P : H) - v[b] / 2 < 0,
              z = j ? B < _ ? B - _ : B - F : 0;
            return {
              [x]: w[x] + z,
              data: {
            ...
            fn(e) {
              ...
              if (a) {
                const t = "y" === p ? "height" : "width",
                  e = i.reference[p] - i.floating[t] + b.mainAxis,
                  n = i.reference[p] + i.reference[t] - b.mainAxis;
                y < e ? y = e : y > n && (y = n)
              }
              if (c) {
                var v, R;
                const t = "y" === p ? "width" : "height",
                  e = k.has(d(r)),
                  n = i.reference[h] - i.floating[t] + (e && (null == (v = l.offset) ? void 0 : v[h]) || 0) + (e ? 0 : b.crossAxis),
                  o = i.reference[h] + i.reference[t] + (e ? 0 : (null == (R = l.offset) ? void 0 : R[h]) || 0) - (e ? b.crossAxis : 0);
                w < n ? w = n : w > o && (w = o)
              }
              return {
                [p]: y,
