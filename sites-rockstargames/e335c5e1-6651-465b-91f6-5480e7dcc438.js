! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "e335c5e1-6651-465b-91f6-5480e7dcc438", t._sentryDebugIdIdentifier = "sentry-dbid-e335c5e1-6651-465b-91f6-5480e7dcc438")
  } catch (t) {}
}();
    ...
    15409: (t, e, n) => {
      ...
      ! function(s, r, o, a) {
        ...
        var N = "ontouchstart" in s,
          Y = O(s, "PointerEvent") !== a,
          X = N && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
          F = "touch",
          W = "mouse",
          q = 25,
          L = 1,
        ...
        Ft.prototype = {
          set: function(t) {
            t == Rt && (t = this.compute()), xt && this.manager.element.style && Xt[t] && (this.manager.element.style[Mt] = t), this.actions = t.toLowerCase().trim()
          },
          update: function() {
          ...
          compute: function() {
            ...
            return g(this.manager.recognizers, (function(e) {
              ...
              function(t) {
                ...
                var e = S(t, Nt),
                  n = S(t, Yt);
                return e && n ? zt : e || n ? e ? Nt : Yt : S(t, kt) ? kt : Ot
              }(t.join(" "))
          },
        ...
        function Lt(t) {
          this.options = u({}, this.defaults, t || {}), this.id = k++, this.manager = null, this.options.enable = w(this.options.enable, !0), this.state = Wt, this.simultaneous = {}, this.requireFail = []
        }
        ...
        function te(t, e) {
          this.options = u({}, Qt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new(this.options.inputClass || (Y ? gt : X ? It : N ? Ct : pt))(this, nt), this.touchAction = new Ft(this, this.options.touchAction), ee(this, !0), g(this.options.recognizers, (function(t) {
        ...
        Lt.prototype = {
          ...
          getTouchAction: function() {
            var t = this.options.direction,
              e = [];
            return t & $ && e.push(Yt), t & J && e.push(Nt), e
          },
