try {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new a.Error).stack;
  t && (a._sentryDebugIds = a._sentryDebugIds || {}, a._sentryDebugIds[t] = "61b73d4e-486f-4736-9fe3-6c2bfc0939f8", a._sentryDebugIdIdentifier = "sentry-dbid-61b73d4e-486f-4736-9fe3-6c2bfc0939f8")
} catch (a) {} {
  let a = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [8322, 9615], {
    ...
    69221(a, t, n) {
      ...
      n.r(t), n.d(t, {
        ...
        PartitionNumberRangePattern: () => ka,
        PartitionPattern: () => Ha,
        RangePatternType: () => Ea,
        SANCTIONED_UNITS: () => T,
        SIMPLE_UNITS: () => U,
      ...
      function ca(a, t, n, e) {
        ...
        if (i = i.replace(da, "{0}").replace(/'(.)'/g, "$1"), "currency" === u && "name" !== e.currencyDisplay) {
          ...
          k && !ua.test(r) && (i = i.replace("{0}¤", "{0}".concat(k, "¤")))
        }
      ...
      function qa(a, t, n, r) {
        ...
        var h = function(a, t, n, e, r, i) {
            ...
            for (var o = L.locale, s = {
              ...
              if (d in n) {
                var k = n[d];
                Za("string" == typeof k || null == k, "optionsValue must be String, Undefined or Null"), ~g.indexOf(k) && k !== b && (b = k, h = "")
              }
              s[d] = b, l += h
            }
            if (l.length > 2) {
        ...
        var k = i(a);
        k.locale = h.locale, k.dataLocale = h.dataLocale, k.numberingSystem = h.nu, k.dataLocaleData = y, Ua(a, d, {
          getInternalSlots: i
        });
        var f, p, D = k.style;
        if ("currency" === D) {
        ...
        var N = S(d, "compactDisplay", "string", ["short", "long"], "short"),
          C = "auto";
        return "compact" === A && (k.compactDisplay = N, C = "min2"), k.useGrouping = x(d, "useGrouping", ["min2", "auto", "always"], "always", !1, C), k.signDisplay = S(d, "signDisplay", "string", ["auto", "never", "always", "exceptZero", "negative"], "auto"), k.roundingMode = S(d, "roundingMode", "string", ["ceil", "floor", "expand", "trunc", "halfCeil", "halfFloor", "halfExpand", "halfTrunc", "halfEven"], "halfExpand"), a
      }
