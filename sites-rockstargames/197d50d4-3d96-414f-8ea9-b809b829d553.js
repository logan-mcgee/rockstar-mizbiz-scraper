try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "197d50d4-3d96-414f-8ea9-b809b829d553", e._sentryDebugIdIdentifier = "sentry-dbid-197d50d4-3d96-414f-8ea9-b809b829d553")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    94931(e, t, a) {
      ...
      function l(e, t, a) {
        var r, n = {},
          l = null,
          d = null;
        for (r in void 0 !== a && (l = "" + a), void 0 !== t.key && (l = "" + t.key), void 0 !== t.ref && (d = t.ref), t) s.call(t, r) && !c.hasOwnProperty(r) && (n[r] = t[r]);
        if (e && e.defaultProps)
    ...
    48382(e, t, a) {
      ...
      const V = ({
        ...
        Z = () => {
          ...
          let w = null;
          return !x || k || v || (w = x?.wwwBottomSheetCollection?.items?.[0]), (0, r.jsx)(V, {
            open: m,
            onOpenChange: p,
            children: (0, r.jsxs)(B, {
      ...
      const Oe = () => {
        ...
        $e = (0, o.forwardRef)(function({
          ...
          const {
            ...
            setError: p,
            reducedMotion: f
          } = Oe(), [h, y] = (0, o.useState)("Pause"), k = (!m || !g) && _.current;
          (0, o.useEffect)(() => {
...
fragment postFields on RockstarGames_Newswire_Model_Entity_Post_o {
    ...
    preview_images_parsed {
        ...
        xa = ({
          ...
          const N = (0, o.useCallback)((e, t) => {
            ...
            D = (0, o.useCallback)((e, t) => {
              k.current[t] = e, e && t === b.current && !u.current && m.current && P(t, {
                fromStored: !0
              })
            }, [P]),
            L = (0, o.useCallback)(() => {
            ...
            G = (0, o.useCallback)(() => {
              g.current = !1, u.current = !1, P(b.current, {
                fromStored: !0
              })
            }, [P]),
            W = (0, o.useCallback)(() => {
            ...
            O = (0, o.useCallback)(() => {
              g.current && (g.current = !1, u.current = !1, P(b.current))
            }, [P]),
            V = (0, o.useCallback)(e => {
          ...
          (0, o.useLayoutEffect)(() => {
            ...
            return Promise.all(t.map(e => new Promise(t => {
              ...
              a = !0, S.off("select", e), S.off("reInit", e), S.off("init", e), z(), o.forEach((e, t) => {
                t.removeEventListener("load", e)
              })
            }
          }, [S, B, z, n, r]), (0, o.useEffect)(() => {
            if (!S) return;
            let e = b.current;
            const t = () => {
                e = b.current, j.current = e, A(), E(), M(e)
              },
              a = () => {
                ...
                u.current || (b.current = t, j.current = t, P(t, {
                  fromStored: !0
                })), requestAnimationFrame(() => {
                  const e = S.selectedScrollSnap();
                  u.current || p.current || (b.current = e, j.current = e, P(e, {
                    fromStored: !0
                  }))
                })
              };
          ...
          }, [S, E, M, P, A, i]), (0, o.useEffect)(() => {
            const e = () => {
              f.current && clearTimeout(f.current);
              const e = S?.selectedScrollSnap() ?? b.current;
              m.current = !0, j.current = e, A(), E(), M(e), f.current = setTimeout(() => {
                v.current = "resize-sync";
                const e = S?.selectedScrollSnap() ?? b.current;
                j.current = e, m.current = !1, u.current ? M(e) : (P(e, {
                  fromStored: !0
                }), Ct.u.refresh())
              }, 250)
            };
      ...
      const Ma = (0, o.createContext)({
        ...
        La = (0, o.forwardRef)(function({
          ...
          const {
            ...
            className: "_1obdf6xd"
          }, a), E = !f.current, z = d.length, T = (0, o.useCallback)(() => {
            f.current ? (N({
              event: "cta_other",
              text: "toggle play"
            }), y()) : (N({
          ...
          const M = (0, r.jsx)(l.IconButton, {
            className: "_1obdf6x6",
            icon: E ? "Pause" : "Play",
            label: S(E ? Ca.hero_carousel_pause_button : Ca.hero_carousel_play_button),
            "aria-label": S(E ? Ca.hero_carousel_play_button : Ca.hero_carousel_pause_button),
            size: "SM",
            appearance: "ghost",
            onPress: T
          });
        ...
        Pr = (0, o.forwardRef)(function({
          ...
          return (0, r.jsxs)(Fr.Provider, {
            ...
            children: [(0, r.jsx)(y, {
              ...
              total: t.length,
              announcer: (e, t) => b(Er.image_carousel_screen_reader_announcer_label, {
                selectedTab: `${e+1}`,
                total: `${t}`
              })
            })]
      ...
      const Do = (0, i.defineMessages)({
        ...
        Lo = {
          SUCCESS: {
            icon: "check",
            heading: Do.ns_successfully_subscribed_title,
            bodyText: Do.ns_successfully_subscribed_details_amp,
            showManagePreferences: !0
          },
          CHECK_EMAIL: {
            icon: "mail",
            heading: Do.ns_check_email_title,
            bodyText: Do.ns_check_email_details
          },
          ERROR_PREFERENCES: {
            icon: "error",
            heading: Do.ns_error_preferences_title,
            bodyText: Do.ns_error_preferences_details,
            showManagePreferences: !0
          },
          ERROR_GENERIC: {
            icon: "error",
            heading: Do.ns_error_generic_title,
            bodyText: Do.ns_error_generic_details
          },
          ALREADY_SUBSCRIBED: {
            icon: "check",
            heading: Do.ns_already_subbed_title,
            bodyText: Do.ns_already_subbed_details_amp,
            showManagePreferences: !0
          },
          NEW_ACCOUNT: {
            icon: "mail",
            heading: Do.ns_confirm_after_register_title,
            bodyText: Do.ns_confirm_after_register_details,
            showManagePreferences: !0
          },
          CONFIRM: {
            icon: "mail",
            heading: Do.ns_confirm_title,
            bodyText: Do.ns_confirm_details,
        ...
        Wo = (0, Fo.eU)(null),
        qo = (e, t) => {
          const [a, r] = (0, o.useState)(), [n, c] = (0, o.useState)(!1), [l, d] = (0, o.useState)(!1), [_, u] = (0, o.useState)(!1), [m, g] = (0, o.useState)(!1), [b, f] = (0, Po.fp)(Wo), h = (0, i.useIntl)(), {
            track: y
          } = (0, p.useGtmTrack)(), k = {
          ...
          const v = {
              ...
              buttons: [{
                buttonText: h.formatMessage(Do.ns_yes_subscribe_text),
                style: "monochrome",
                onClick: () => {
                  x()
                }
              }, {
                buttonText: h.formatMessage(Do.ns_go_back_text),
                onClick: () => {
                  r(null)
                }
              }]
        ...
        Fs = (0, i.withIntl)(({
          ...
          const h = {
              ...
              introScreen: {
                ...
                image: {
                  ...
                  sources: {
                    desktop: (0, Vn.useGetCdnSource)(a?.image?.sources?.en_us?.desktop) || null,
                    mobile: (0, Vn.useGetCdnSource)(a?.image?.sources?.en_us?.mobile) || null
                  }
                },
                tag: a?.tag || ""
              },
            ...
            I = 1280,
            A = (0, o.createRef)(),
            [E, z] = (0, o.useState)(null),
            [T, M] = (0, o.useState)([]),
            [F, P] = (0, o.useState)(!1),
            [D, L] = (0, o.useState)(),
            [G, W] = (0, o.useState)("hidden"),
            [q, O] = (0, o.useState)("hidden"),
            [V, B] = (0, o.useState)("hidden"),
            [$, U] = (0, o.useState)("hidden"),
            [X, H] = (0, o.useState)(!1),
            [K, Y] = (0, o.useState)(zs.landing),
            [Z, J] = (0, o.useState)(h.introScreen.image.sources.mobile || Ts),
            Q = `${document.location.pathname}${document.location.search}#${d}`,
            ee = (0, s.usePrevious)(D),
            te = (0, s.usePrevious)(v),
            {
              signInUrl: ae
            } = (0, s.useScAuthLinks)(Q),
            re = e => {
              e === zs.landing ? (Y(zs.landing), O("onScreen"), W("hidden"), U("hidden"), B("hidden")) : e === zs.success ? (Y(zs.success), O("offScreen"), W("visible"), setTimeout(() => {
                O("hidden"), U("hidden")
              }, 300), setTimeout(() => {
                W("onScreen")
              }, 100)) : e === zs.error ? (Y(zs.error), O("offScreen"), U("visible"), setTimeout(() => {
                O("hidden")
              }, 300), setTimeout(() => {
                U("onScreen")
              }, 100)) : e === zs.unlinked && (Y(zs.unlinked), O("offScreen"), B("visible"), setTimeout(() => {
                O("hidden"), U("hidden")
              }, 300), setTimeout(() => {
                B("onScreen")
              }, 100))
          ...
          return (0, o.useEffect)(() => {
            ...
            const e = () => {
              ...
              a = () => {
                window.innerWidth <= I && !F ? (P(!0), re(K)) : window.innerWidth > I && F && P(!1), e()
              };
            ...
            "boolean" != typeof ee && "boolean" != typeof te || !e || D && v && (async () => {
              try {
                const {
                  result: t
            ...
            "boolean" == typeof v ? v ? L(!0) : (L(!1), O("onScreen")) : L(!0)
          }, [v]), (0, o.useEffect)(() => {
            "boolean" == typeof E && k?.accountSynced && L(!1)
          }, [E, k?.accountSynced, L]), (0, o.useEffect)(() => {
            D || (async () => {
              T.length > 0 && E ? re(zs.success) : re(E ? zs.unlinked : zs.landing)
            })()
          }, [D]), (0, o.useEffect)(() => {
            if (N && !X) {
              if (void 0 === v) return;
            ...
            children: (0, r.jsx)("div", {
              ...
              children: (0, r.jsxs)(Wn.motion.div, {
                ...
                children: [(0, r.jsx)("div", {
                  ...
                  className: (0, xt.default)("_3rocp64", D ? "loader" : ""),
                  ref: A,
                  children: D ? (0, r.jsx)("div", {
                    className: "_3rocp6w",
                    ...
                    children: [K === zs.landing && (0, r.jsx)(ss, {
                      content: h,
                      loggedIn: v,
                      addClaim: async () => {
                        const a = {
                      ...
                      linkMoreAccounts: () => {
                        C({
                          ...
                          event: "cta_link_account",
                          link_url: w,
                          text: On.engagement_link_account.defaultMessage
                        })
                      },
                      linkAccountBtn: j.formatMessage(On.engagement_link_account)
                    }), K === zs.unlinked && (0, r.jsx)(As, {
                      content: h,
                      unlinkedSlide: V,
                      returnUrl: Q,
                      giftId: e
                    }), K === zs.error && (0, r.jsx)(Es, {
                      errorSlide: $,
                      content: h
                    })]
                  })
          ...
          [De]: ({
            ...
            if (e) return (0, r.jsxs)(Ie, {
              ...
              children: [(0, r.jsxs)(Ae, {
                ...
                children: e.cardsCollection?.items?.map((t, o) => (0, r.jsx)(Pe.Provider, {
                  value: {
                    totalItems: l,
                    itemIndex: o
                  },
    ...
    `;
          ...
          [Ur]: ({
            ...
            return (0, r.jsxs)(Pr, {
              ...
              children: [(0, r.jsx)(qr, {
                ...
                children: !!d.length && d.map((e, t) => (0, r.jsx)(Vr, {
                  index: t,
                  children: (0, r.jsx)(rr, {
                    children: (0, r.jsx)(or, {
                      children: (0, r.jsx)($r, {
          ...
          [Xo]: ({
            ...
            if ((0, o.useEffect)(() => {
                ...
                t && P && D && t(M || x)
              }, [x, t, P, D, M]), !e) return null;
            const L = S?.buttons || [{
                buttonText: a.formatMessage(Do.ns_ok_button_text),
                onClick: () => {
                  T(!1)
                },
                testId: "ok-btn",
                ...
                buttonText: S?.showManagePreferences ? a.formatMessage(Do.ns_manage_prefs_button_text) : "",
                isLink: !0,
                link: N.preferences,
    ...
    51177(e, t, a) {
        ...
        function i(i) {
          return function(c) {
            return function(i) {
              ...
              for (; s && (s = 0, i[0] && (n = 0)), n;) try {
                if (a = 1, r && (o = 2 & i[0] ? r.return : i[0] ? r.throw || ((o = r.return) && o.call(r), 0) : r.next) && !(o = o.call(r, i[1])).done) return o;
      ...
      function l(e, t) {
        ...
        try {
          for (;
            (void 0 === t || t-- > 0) && !(r = n.next()).done;) s.push(r.value)
        } catch (e) {
          o = {
            error: e
          }
