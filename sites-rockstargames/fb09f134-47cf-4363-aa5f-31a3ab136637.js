try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "fb09f134-47cf-4363-aa5f-31a3ab136637", e._sentryDebugIdIdentifier = "sentry-dbid-fb09f134-47cf-4363-aa5f-31a3ab136637")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const j = "nav-dropdown",
        ...
        I = (0, d.withIntl)(({
          ...
          const b = a,
            ...
            [E, L] = (0, i.useState)({}),
            [P, T] = (0, i.useState)("default");
          (0, i.useEffect)(() => {
            const e = {
              "transparent-dark": ["/", "/gta-online/mansions"],
              "transparent-light": ["/"]
            };
            e["transparent-dark"].includes(w.pathname) ? T("transparent-dark") : T("default");
            const a = ["/"];
            a.includes(w.pathname) || L({});
            const s = s => {
              s.origin === window.origin && "navColorMode" === s.data.source && s.data.mode ? "default" !== s.data.mode && e[s.data.mode].includes(w.pathname) ? T(s.data.mode) : T("default") : s.origin === window.origin && "dynamicSlideColors" === s.data.source && s.data.values && L(a.includes(w.pathname) ? s.data.values : {})
            };
            return window.addEventListener("message", s), () => {
              window.removeEventListener("message", s), T("default")
            }
          }, [w.pathname]);
          ...
          (0, i.useEffect)(() => {
            ...
            if (null !== v && !e.length) return void A(!1);
            if (null == q || !e.length) return;
            const a = e?.[q] ?? e?.[0] ?? null;
            A(!!a?.platform && [a.platform, a.characterSlot])
          }, [q, x, v]);
          const U = H?.matchedPath.options.isSearchPage || !1,
            B = (0, i.useMemo)(() => d.locales.find(e => e.iso.toLowerCase() === (0, o.toScLocaleString)(y))?.label, [d.locales]),
            D = (0, i.useMemo)(() => `${(0,o.getBase)()}${w?.pathname}`.replace(/\/\//g, "/"), [w?.pathname]);
          return (0, t.jsx)(b.Root, {
            brand: H?.brand ? (0, t.jsx)(N, {
              brand: H.brand,
              site: H.site
            }) : null,
            mode: P,
            dynamicSlideStyles: E,
            children: (0, t.jsxs)(b.Header, {
              children: [(0, t.jsx)(b.SiteTitle, {
                quickAccessHidden: H?.hideQuickAccess,
                onNavigate: j,
                children: w.pathname.length > 0 && !H?.hideQuickAccess && (0, t.jsxs)(b.QuickMenu, {
                ...
                children: ["careers" !== H.site && (0, t.jsxs)(t.Fragment, {
                  children: [(0, t.jsx)(R, {
                    globalNavigationComponent: a,
                    searchConfig: r,
                    onSearch: l,
                  ...
                  children: H?.links.map(e => (0, t.jsx)(z, {
                    globalNavigationComponent: b,
                    gamesMenuComponent: s,
                    link: e
                  }, e.text))
                }), H?.cta && (0, t.jsx)(b.CallToAction, {
                  ...H.cta,
                  asChild: !0,
                  onClick: I(H.cta.ga, H.cta.gaText, H.cta.gaText, `${H.cta.location.domain}${H.cta.location.path}`),
                  size: "LG",
                  children: (0, t.jsx)(c.Link, {
                    to: `${H.cta.location.domain}${H.cta.location.path}`,
                    reloadDocument: Boolean(H.cta.location.domain),
                    children: H.cta.text
                  })
                }), !H?.hideQuickAccess && (0, t.jsxs)(b.QuickMenu, {
                  children: [(0, t.jsx)(b.MenuItem, {
                    children: (0, t.jsx)(b.MenuLink, {
                      asChild: !0,
                      children: (0, t.jsxs)(c.Link, {
                ...
                children: [(0, t.jsx)(b.Breakpoint, {
                  showOn: "desktop",
                  children: H?.cta && (0, t.jsx)(b.CallToAction, {
                    ...H.cta,
                    asChild: !0,
                    onClick: I(H.cta.ga, H.cta.gaText, H.cta.gaText, `${H.cta.location.domain}${H.cta.location.path}`),
                    children: (0, t.jsx)(c.Link, {
                ...
                }), "careers" !== H.site && (0, t.jsxs)(b.Search, {
                  isSearchPage: U,
                    ...
                    children: (0, t.jsx)(b.AvatarMenuSectionContent, {
                      children: (0, t.jsx)(b.MenuList, {
                        children: v ? (0, t.jsxs)(t.Fragment, {
                          ...
                          children: [(0, t.jsx)(b.MenuItem, {
                            children: (0, t.jsx)(b.MenuLink, {
                              href: `${G.login}?returnUrl=${D}&lang=${(0,o.toScLocaleString)(y)}`,
                              "data-testid": "loginLink",
                              children: f.avatarMenuSignIn
                            })
                          }), (0, t.jsx)(b.MenuItem, {
                            children: (0, t.jsx)(b.MenuLink, {
                              href: `${G.signup}&returnUrl=${D}&lang=${(0,o.toScLocaleString)(y)}`,
                    ...
                    children: [(0, t.jsx)(b.AvatarMenuSectionHeaderDropdown, {
                      children: (0, t.jsxs)(b.AvatarMenuLanguageLabel, {
                        children: [(0, t.jsx)(u.Globe, {
                          ...
                          children: B ?? f.avatarMenuSelectLanguage
                        })]
                      })
      ...
      const ee = (e, a = {}) => {
        ...
        ae = (0, Z.A)(() => {
          ...
          let l = [{
            ...
            element: ee(() => Promise.all([s.e(2521), s.e(1128), s.e(5367), s.e(886)]).then(s.bind(s, 77306)))
          }, {
            path: "/community-resources/guidelines",
            element: ee(() => Promise.all([s.e(4346), s.e(2521), s.e(1128), s.e(5367), s.e(9031)]).then(s.bind(s, 90777)))
          }, {
            path: "/community-resources/additional-resources",
            element: ee(() => Promise.all([s.e(4346), s.e(2521), s.e(1128), s.e(5367), s.e(3178)]).then(s.bind(s, 8982)))
          }, {
            path: "/community-resources/online-comms-privacy",
            element: ee(() => Promise.all([s.e(4346), s.e(2521), s.e(1128), s.e(5367), s.e(6005)]).then(s.bind(s, 20879)))
          }, {
            path: "/community-resources/how-to-report",
            element: ee(() => Promise.all([s.e(4346), s.e(2521), s.e(1128), s.e(5367), s.e(586)]).then(s.bind(s, 3686)))
          }, {
            path: "/community-resources/keep-account-safe",
            element: ee(() => Promise.all([s.e(4346), s.e(2521), s.e(1128), s.e(5367), s.e(4642)]).then(s.bind(s, 5118)))
          }, {
            path: "/conduct",
            ...
            path: "/games",
            element: ee(() => Promise.all([s.e(4346), s.e(2521), s.e(1128), s.e(4424), s.e(2200)]).then(s.bind(s, 40807)))
          }, {
            ...
            path: "/newswire",
            element: ee(() => Promise.all([s.e(4346), s.e(2521), s.e(1128), s.e(4424), s.e(7975)]).then(s.bind(s, 86546)))
          }, {
