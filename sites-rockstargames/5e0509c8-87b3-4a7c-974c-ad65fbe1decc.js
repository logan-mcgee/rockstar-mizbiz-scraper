! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      a = (new e.Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "5e0509c8-87b3-4a7c-974c-ad65fbe1decc", e._sentryDebugIdIdentifier = "sentry-dbid-5e0509c8-87b3-4a7c-974c-ad65fbe1decc")
  } catch (e) {}
}();
        ...
        const y = (0, l.useIntl)(),
          ...
          M = (e, a) => {
            const s = a ?? e.target.hash,
              ...
              r = h.get("country");
            if (e) {
              const a = `${p.pathname}${h.get("country")?`?country=${r}`:""}${s}`;
          ...
          document.querySelectorAll(".scrollToLink").forEach((e => {
            (e => {
              if (e) {
                ...
                e.setAttribute("href", `${n}${p.pathname.replace("/","")}${null!==a?`?country=${a}`:""}#${s}`)
              }
          ...
          children: [(0, c.jsxs)("section", {
            ...
            children: [(0, c.jsx)("h1", {
              ...
              children: ["us", "br", "cz", "de", "es", "fr", "it", "jp", "kr", "mx", "nl", "pl", "ru", "sa", "tw", "zh"].map(((e, a) => {
                const s = y.formatMessage(u.rockstargames_company_info_display_for_country, {
                  country: y.formatMessage(u[`rockstargames_company_info_${e}`])
                });
                return (0, c.jsx)(r.A, {
                  to: `${p.pathname}?country=${e}`,
                  className: g[e],
                  title: s,
                  children: (0, c.jsx)(d, {
                    children: s
