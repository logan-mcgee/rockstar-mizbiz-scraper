! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "9023e953-fdc3-4653-9588-35a97cef72ac", e._sentryDebugIdIdentifier = "sentry-dbid-9023e953-fdc3-4653-9588-35a97cef72ac")
  } catch (e) {}
}();
    ...
    43851: (e, t, s) => {
      ...
      var w = {
        ...
        updateSlides: function() {
          ...
          for (let i = 0; i < u; i += 1) {
            let r;
            if (M = 0, p[i] && (r = p[i]), x && e.grid.updateSlide(i, r, p), !p[i] || "none" !== (0, n.p)(r, "display")) {
              if ("auto" === s.slidesPerView) {
                C && (p[i].style[e.getDirectionLabel("width")] = "");
                const a = getComputedStyle(r),
                  l = r.style.transform,
                  o = r.style.webkitTransform;
                if (l && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), s.roundLengths) M = e.isHorizontal() ? (0, n.f)(r, "width", !0) : (0, n.f)(r, "height", !0);
                else {
                  const e = t(a, "width"),
                    s = t(a, "padding-left"),
                    i = t(a, "padding-right"),
        ...
        E = {
          ...
          loopFix: function(e) {
            ...
            if (L < S) {
              ...
              O = Math.max(L - (x - 2 * S), b), M && (O = Math.max(O, w - x + g + 1));
              for (let e = 0; e < O; e += 1) {
                const t = e - Math.floor(e / x) * x;
                E ? p.forEach(((e, s) => {
                  e.column === t && y.push(s)
      ...
      const G = {
          ...
          events: {
            attachEvents: function() {
              ...
              e.onTouchStart = y.bind(e), e.onTouchMove = x.bind(e), e.onTouchEnd = M.bind(e), e.onDocumentTouchStart = O.bind(e), t.cssMode && (e.onScroll = k.bind(e)), e.onClick = P.bind(e), e.onLoad = _.bind(e), L(e, "on")
            },
