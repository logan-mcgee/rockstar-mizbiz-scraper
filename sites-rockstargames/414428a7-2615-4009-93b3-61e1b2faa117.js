try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    l = (new e.Error).stack;
  l && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[l] = "414428a7-2615-4009-93b3-61e1b2faa117", e._sentryDebugIdIdentifier = "sentry-dbid-414428a7-2615-4009-93b3-61e1b2faa117")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [5021], {
    ...
    45021: (e, l, a) => {
      ...
      $.displayName = "Info", $.categories = ["accessibility", "notifications"], $.tags = ["help", "info", "information", "support"], $.SM = U, $.LG = _, $.MD = W, $.XL = Z;
      ...
      Ye.displayName = "ThumbsDown", Ye.categories = ["account", "social", "emoji"], Ye.tags = ["dislike", "bad", "emotion", "rate", "social", "review", "feedback", "negative"], Ye.SM = _e, Ye.LG = We, Ye.MD = Ze, Ye.XL = $e;
      ...
      Kl.displayName = "Star", Kl.categories = ["account", "social", "shapes", "multimedia", "weather", "emoji", "gaming"], Kl.tags = ["bookmark", "favorite", "like", "review", "rating"], Kl.SM = Wl, Kl.LG = Zl, Kl.XL = $l, Kl.MD = Yl;
      ...
      Qa.displayName = "ArrowRightLeft", Qa.categories = ["arrows", "navigation"], Qa.tags = ["bidirectional", "two-way", "2-way", "swap", "switch", "transaction", "reorder", "move", "<-", "->"], Qa.SM = Za, Qa.LG = $a, Qa.MD = Ya, Qa.XL = Ka;
      ...
      Jr.displayName = "ChevronLast", Jr.categories = ["arrows", "multimedia"], Jr.tags = ["skip", "next", "music"], Jr.SM = $r, Jr.LG = Yr, Jr.MD = Kr, Jr.XL = Qr;
      ...
      const xt = (0, i.forwardRef)(({
        ...
        mt = (0, i.forwardRef)(({
          ...
          children: (0, r.jsx)("svg", {
            ...
            children: (0, r.jsx)("path", {
              fill: e,
              d: "M15.997 29.334c.736 0 1.333-.597 1.333-1.334V12.553l5.724 5.723a1.333 1.333 0 1 0 1.885-1.885l-8-8a1.333 1.333 0 0 0-1.885 0l-8 8a1.333 1.333 0 0 0 1.885 1.886l5.724-5.724V28c0 .737.597 1.334 1.334 1.334M5.33 4c0-.736.597-1.333 1.333-1.333H25.33a1.333 1.333 0 0 1 0 2.667H6.663A1.333 1.333 0 0 1 5.33 4",
              fillRule: "evenodd",
              clipRule: "evenodd"
            })
          })
      ...
      const ut = (0, i.forwardRef)(({
        ...
        Rt = (0, i.forwardRef)(({
          ...
          children: (0, r.jsx)("svg", {
            ...
            children: (0, r.jsx)("path", {
              fill: e,
              d: "M15.997 2.667c.736 0 1.333.597 1.333 1.333v15.448l5.724-5.724a1.333 1.333 0 1 1 1.885 1.886l-8 8c-.52.52-1.364.52-1.885 0l-8-8a1.333 1.333 0 1 1 1.885-1.886l5.724 5.724V4c0-.736.597-1.333 1.334-1.333M5.33 28c0-.736.597-1.333 1.333-1.333H25.33a1.333 1.333 0 0 1 0 2.667H6.663A1.333 1.333 0 0 1 5.33 28",
              fillRule: "evenodd",
              clipRule: "evenodd"
            })
          })
      ...
      $t.displayName = "RefreshCwOff", $t.categories = ["arrows"], $t.tags = ["rotate", "reload", "rerun", "synchronise", "synchronize", "arrows", "circular", "cycle", "cancel", "no", "stop", "error", "disconnect", "ignore", "reset", "clockwise"], $t.SM = Ut, $t.LG = _t, $t.MD = Wt, $t.XL = Zt;
      ...
      Ys.displayName = "VolumeX", Ys.categories = ["connectivity", "communication", "multimedia"], Ys.tags = ["music", "sound", "mute", "speaker", "control", "volume"], Ys.SM = _s, Ys.LG = Ws, Ys.MD = Zs, Ys.XL = $s;
      ...
      li.displayName = "Headset", li.categories = ["multimedia", "connectivity", "devices", "files", "gaming"], li.tags = ["music", "audio", "sound", "gaming", "headphones", "headset", "call", "center", "phone", "telephone", "voip", "video"], li.SM = Ks, li.LG = Qs, li.MD = Js, li.XL = ei;
      ...
      ci.displayName = "Wifi", ci.categories = ["connectivity", "devices"], ci.tags = ["connection", "signal", "wireless", "internet", "technology", "network"], ci.SM = di, ci.LG = oi, ci.MD = ni, ci.XL = hi;
      ...
      Bi.displayName = "PencilOff", Bi.categories = ["design", "cursors", "tools", "text"], Bi.tags = ["disabled", "inactive", "non-editable", "locked", "read-only", "unmodifiable", "frozen", "restricted", "rubber", "edit", "create", "draw", "sketch", "draft", "writer", "writing", "stationery", "artist"], Bi.SM = Hi, Bi.LG = Ai, Bi.MD = Vi, Bi.XL = Ii;
      ...
      Gi.displayName = "Plus", Gi.categories = ["math", "tools", "development", "text", "cursors", "gaming"], Gi.tags = ["add", "new", "increase", "increment", "positive", "calculate", "toolbar", "crosshair", "aim", "target", "scope", "sight", "reticule", "maximum", "upgrade", "extra", "+", "more", "create", "navigation"], Gi.SM = Si, Gi.LG = yi, Gi.MD = Di, Gi.XL = Ni;
      ...
      Pi.displayName = "LayoutGrid", Pi.categories = ["design", "layout"], Pi.tags = ["app", "home", "start", "squares", "hub", "menu", "blocks", "options", "items", "gallery"], Pi.SM = Xi, Pi.LG = qi, Pi.MD = Fi, Pi.XL = ki;
      ...
      Ki.displayName = "Minimize", Ki.categories = ["layout", "design"], Ki.tags = ["exit", "full screen", "close", "shrink", "window", "reduce", "video playback"], Ki.SM = Wi, Ki.LG = Zi, Ki.MD = $i, Ki.XL = Yi;
      ...
      ad.displayName = "Cpu", ad.categories = ["devices"], ad.tags = ["processor", "cores", "technology", "computer", "chip", "circuit", "memory", "ram", "specs", "gigahertz", "ghz"], ad.SM = Qi, ad.MD = Ji, ad.LG = ed, ad.XL = ld;
      ...
      fd.displayName = "CalendarOff", fd.categories = ["time"], fd.tags = ["date", "day", "month", "year", "event", "delete", "remove"], fd.SM = od, fd.LG = nd, fd.MD = hd, fd.XL = cd;
      ...
      Sd.displayName = "List", Sd.categories = ["text"], Sd.tags = ["options", "index", "table of contents", "menu", "side nav", "navigation", "bullet", "to do"], Sd.SM = Ad, Sd.LG = Vd, Sd.MD = Id, Sd.XL = Bd;
      ...
      Xd.displayName = "ListFilter", Xd.categories = ["text"], Xd.tags = ["options"], Xd.SM = yd, Xd.LG = Dd, Xd.MD = Nd, Xd.XL = Gd;
      ...
      Od.displayName = "Unlink", Od.categories = ["text"], Od.tags = ["url", "unchain"], Od.SM = qd, Od.LG = Fd, Od.MD = kd, Od.XL = Pd;
      ...
      Qd.displayName = "Discord", Qd.categories = ["brands", "social"], Qd.tags = ["Social media", "Video", "Player", "Game", "Community", "App", "Share", "Logo"], Qd.SM = Zd, Qd.LG = $d, Qd.MD = Yd, Qd.XL = Kd;
      ...
      ro.displayName = "Instagram", ro.categories = ["brands", "social", "photography"], ro.tags = ["logo", "camera", "social media", "photo", "camera", "app", "share"], ro.SM = Jd, ro.LG = eo, ro.MD = lo, ro.XL = ao;
      ...
      no.displayName = "Facebook", no.categories = ["social", "brands"], no.tags = ["logo", "social media", "profile", "feed", "app", "share"], no.SM = to, no.LG = so, no.MD = io, no.XL = oo;
      ...
      vo.displayName = "Twitch", vo.categories = ["brands", "social", "account", "gaming"], vo.tags = ["logo", "social", "social media", "streaming", "game", "app", "share"], vo.SM = ho, vo.LG = co, vo.MD = fo, vo.XL = wo;
      ...
      Do.displayName = "Reddit", Do.categories = ["social", "brands"], Do.tags = ["logo", "social media", "profile", "feed", "app", "share", "forum", "community"], Do.SM = Io, Do.MD = Bo, Do.LG = So, Do.XL = yo;
      ...
      Fo.displayName = "EpicGames", Fo.categories = ["platform"], Fo.tags = ["games", "gaming", "social", "brand", "third party"], Fo.SM = No, Fo.MD = Go, Fo.LG = Xo, Fo.XL = qo;
      ...
      Eo.displayName = "Steam", Eo.categories = ["platform"], Eo.tags = ["games", "gaming", "social", "brand", "third party"], Eo.SM = ko, Eo.MD = Po, Eo.LG = Oo, Eo.XL = To;
      const Uo = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      $o.displayName = "Xbox", $o.categories = ["platform"], $o.tags = ["games", "gaming", "social", "brand", "third party"], $o.SM = Uo, $o.MD = _o, $o.LG = Wo, $o.XL = Zo;
      ...
      en.displayName = "Car", en.categories = ["transportation"], en.tags = ["vehicle", "drive", "trip", "journey", "automobile", "GTAO", "transport"], en.SM = Yo, en.LG = Ko, en.MD = Qo, en.XL = Jo;
      ...
      sn.displayName = "CarSide", sn.categories = ["transportation"], sn.tags = ["vehicle", "drive", "trip", "journey"], sn.SM = ln, sn.LG = an, sn.MD = rn, sn.XL = tn;
      ...
      cn.displayName = "ShoppingBag", cn.categories = ["shopping"], cn.tags = ["ecommerce", "cart", "purchase", "store", "bag", "shop", "shopping", "tote"], cn.SM = dn, cn.MD = on, cn.LG = nn, cn.XL = hn;
      ...
      gn.displayName = "MessageSquareText", gn.categories = ["social"], gn.tags = ["comment", "chat", "conversation", "dialog", "feedback", "speech bubble", "clear", "close", "delete", "remove", "cancel", "silence", "mute", "moderate"], gn.SM = fn, gn.LG = wn, gn.MD = vn, gn.XL = xn;
      ...
      bn.displayName = "Search", bn.categories = ["text", "social"], bn.tags = ["find", "scan", "magnifier", "magnifying glass", "look", "view"], bn.SM = jn, bn.LG = mn, bn.MD = pn, bn.XL = un;
      ...
      Cn.displayName = "PartialCircle", Cn.categories = ["shapes"], Cn.tags = ["Partial", "Half", "Middle", "Split"], Cn.SM = Mn, Cn.LG = Rn, Cn.MD = Ln, Cn.XL = zn;
      ...
      Bn.displayName = "LockKeyhole", Bn.categories = ["security"], Bn.tags = ["security", "password", "secure", "admin", "lock", "safe", "protection", "security", "latch"], Bn.SM = Hn, Bn.LG = An, Bn.MD = Vn, Bn.XL = In;
      ...
      Gn.displayName = "LockPassword", Gn.categories = ["security"], Gn.tags = ["security", "password", "secure", "admin"], Gn.SM = Sn, Gn.LG = yn, Gn.MD = Dn, Gn.XL = Nn;
      ...
      Pn.displayName = "Image", Pn.categories = ["photography", "text", "multimedia", "files"], Pn.tags = ["picture", "photo"], Pn.SM = Xn, Pn.LG = qn, Pn.MD = Fn, Pn.XL = kn;
      ...
      _n.displayName = "Lightbulb", _n.categories = ["photography"], _n.tags = ["idea", "bright", "lights"], _n.SM = On, _n.LG = Tn, _n.MD = En, _n.XL = Un;
      ...
      Kn.displayName = "Check", Kn.categories = ["notifications"], Kn.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "success", "accept"], Kn.SM = Wn, Kn.LG = Zn, Kn.MD = $n, Kn.XL = Yn;
      ...
      ah.displayName = "CircleCheck", ah.categories = ["notifications"], ah.tags = ["done", "todo", "tick", "complete", "task", "ready", "yes", "available", "circle", "approve", "success"], ah.SM = Qn, ah.LG = Jn, ah.MD = eh, ah.XL = lh;
      ...
      dh.displayName = "TriangleAlert", dh.categories = ["notifications", "shapes", "development"], dh.tags = ["warning", "alert", "danger", "exclamation mark", "linter", "caution", "attention", "error", "triangle"], dh.SM = rh, dh.LG = th, dh.MD = sh, dh.XL = ih;
      ...
      fh.displayName = "X", fh.categories = ["notifications", "math"], fh.tags = ["cancel", "close", "delete", "remove", "times", "clear", "math", "multiply", "multiplication", "error", "remove", "clean", "erase", "navigation", "cross", "times"], fh.SM = oh, fh.LG = nh, fh.MD = hh, fh.XL = ch;
      ...
      jh.displayName = "Globe", jh.categories = ["navigation"], jh.tags = ["world", "browser", "language", "translate", "global", "network", "earth"], jh.SM = wh, jh.LG = vh, jh.MD = xh, jh.XL = gh;
      ...
      Mh.displayName = "HeartPulse", Mh.categories = ["medical"], Mh.tags = ["heartbeat", "pulse", "health", "medical", "blood pressure", "cardiac", "systole", "diastole"], Mh.SM = mh, Mh.LG = ph, Mh.MD = uh, Mh.XL = bh;
      const Rh = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Hh.displayName = "CircleMinus", Hh.categories = ["math"], Hh.tags = ["subtract", "remove", "decrease", "reduce", "calculate", "line", "operator", "code", "coding", "minimum", "downgrade", "minus", "no", "less", "n/a", "delete"], Hh.SM = Rh, Hh.LG = Lh, Hh.MD = zh, Hh.XL = Ch;
      ...
      Sh.displayName = "CircleX", Sh.categories = ["math", "development"], Sh.tags = ["cancel", "close", "delete", "remove", "times", "clear", "error", "incorrect", "wrong", "mistake", "failure", "linter", "multiply", "multiplication", "clean", "erase", "deprecate", "delete", "navigation"], Sh.SM = Ah, Sh.LG = Vh, Sh.MD = Ih, Sh.XL = Bh;
      ...
      Xh.displayName = "Minus", Xh.categories = ["math", "development", "text", "tools"], Xh.tags = ["subtract", "remove", "decrease", "decrement", "reduce", "negative", "calculate", "line", "divider", "separator", "horizontal rule", "hr", "html", "markup", "markdown", "---", "toolbar", "operator", "code", "coding", "minimum", "downgrade", "less", "delete", "navigation", "minimize"], Xh.SM = yh, Xh.LG = Dh, Xh.MD = Nh, Xh.XL = Gh;
      ...
      Oh.displayName = "EnvelopeOpen", Oh.categories = ["mail"], Oh.tags = ["email", "message", "letter", "read"], Oh.SM = qh, Oh.LG = Fh, Oh.MD = kh, Oh.XL = Ph;
      ...
      Wh.displayName = "Paperclip", Wh.categories = ["text", "design", "files", "mail"], Wh.tags = ["attachment", "file", "attach", "clip", "document", "paper"], Wh.SM = Th, Wh.LG = Eh, Wh.MD = Uh, Wh.XL = _h;
      ...
      Qh.displayName = "Trash", Qh.categories = ["files", "mail"], Qh.tags = ["garbage", "delete", "remove", "bin", "trashcan", "bin", "waste bin", "erase"], Qh.SM = Zh, Qh.LG = $h, Qh.MD = Yh, Qh.XL = Kh;
      const Jh = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
          ...s
      ...
      rc.displayName = "EllipsisVertical", rc.categories = ["layout"], rc.tags = ["menu", "options", "spread", "more", "further", "extra", "overflow", "dots", "..."], rc.SM = Jh, rc.LG = ec, rc.MD = lc, rc.XL = ac;
      ...
      wc.displayName = "Weapon", wc.categories = ["gaming"], wc.tags = ["gun", "pistol", "GTAO", "fire", "shoot", "death", "danger"], wc.SM = nc, wc.LG = hc, wc.MD = cc, wc.XL = fc;
      ...
      yc.displayName = "Save", yc.categories = ["files"], yc.tags = ["floppy disk", "download", "backup", "storage", "disk", "document", "computer", "archive"], yc.SM = Vc, yc.MD = Ic, yc.LG = Bc, yc.XL = Sc;
      ...
      qc.displayName = "CircleDollarSign", qc.categories = ["finance"], qc.tags = ["monetization", "marketing", "currency", "money", "payment"], qc.SM = Dc, qc.LG = Nc, qc.MD = Gc, qc.XL = Xc;
      ...
      Tc.displayName = "DollarSign", Tc.categories = ["finance"], Tc.tags = ["currency", "money", "payment"], Tc.SM = Fc, Tc.LG = kc, Tc.MD = Pc, Tc.XL = Oc;
      ...
      Jc.displayName = "Pause", Jc.categories = ["multimedia"], Jc.tags = ["music", "audio", "video", "stop", "pause", "control", "player", "media"], Jc.SM = $c, Jc.LG = Yc, Jc.MD = Kc, Jc.XL = Qc;
      ...
      hf.displayName = "Rewind", hf.categories = ["arrows", "multimedia"], hf.tags = ["music", "audio", "video", "control", "player", "previous", "back", "reverse", "media"], hf.SM = sf, hf.LG = df, hf.MD = of, hf.XL = nf;
      ...
      If.displayName = "Stop", If.categories = ["multimedia"], If.tags = ["music", "audio", "video", "control", "player", "stop", "media"], If.SM = Cf, If.LG = Hf, If.MD = Af, If.XL = Vf;
      const Bf = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      Nf.displayName = "ListMusic", Nf.categories = ["multimedia"], Nf.tags = ["playlist", "music", "audio", "control", "player", "media", "queue", "playback", "play", "list"], Nf.SM = Bf, Nf.MD = Sf, Nf.LG = yf, Nf.XL = Df;
      const Gf = (0, i.forwardRef)(({
          color: e = "currentColor",
          testId: l,
          label: a,
      ...
      kf.displayName = "Book", kf.categories = ["text", "gaming"], kf.tags = ["code", "coding", "version control", "git", "repository", "remove", "delete", "reading", "misinformation", "disinformation", "misinformed", "charlatan", "sophistry", "false", "lies", "untruth", "propaganda", "censored", "cancelled", "forbidden", "prohibited", "banned", "uneducated", "re-education", "unlearn"], kf.SM = Gf, kf.LG = Xf, kf.MD = qf, kf.XL = Ff;
      ...
      Uf.displayName = "CloudAlert", Uf.categories = ["development"], Uf.tags = ["weather", "danger", "warning", "alert", "error", "sync", "network", "exclamation"], Uf.SM = Pf, Uf.LG = Of, Uf.MD = Tf, Uf.XL = Ef;
      ...
      Yf.displayName = "CodeXml", Yf.categories = ["text", "development"], Yf.tags = ["source", "programming", "html", "xml", "code", "computer", "dev", "engineering", "web", "tag"], Yf.SM = _f, Yf.LG = Wf, Yf.MD = Zf, Yf.XL = $f;
      ...
      lw.displayName = "Database", lw.categories = ["devices", "development"], lw.tags = ["storage", "memory", "container", "tin", "pot", "bytes", "servers"], lw.SM = Kf, lw.LG = Qf, lw.MD = Jf, lw.XL = ew;
