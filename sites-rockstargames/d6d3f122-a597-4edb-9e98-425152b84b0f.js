try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "d6d3f122-a597-4edb-9e98-425152b84b0f", t._sentryDebugIdIdentifier = "sentry-dbid-d6d3f122-a597-4edb-9e98-425152b84b0f")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [7731], {
    87731: (t, e, n) => {
      ...
      ! function(s, r, o, a) {
        ...
        function E(t, e, n) {
          var i, s = e.prototype;
          (i = t.prototype = Object.create(s)).constructor = t, i._super = s, n && h(i, n)
        }
        ...
        function R(t, e) {
          for (var n, i, s = e[0].toUpperCase() + e.slice(1), r = 0; r < u.length;) {
            if ((i = (n = u[r]) ? n + s : e) in t) return i;
            r++
          }
          return a
        }
        ...
        function H(t, e, n) {
          ...
          n.isFirst = !!r, n.isFinal = !!o, r && (t.session = {}), n.eventType = e,
            function(t, e) {
              ...
              var r = n.firstInput,
                o = n.firstMultiple,
                h = o ? o.center : r.center,
                u = e.center = V(i);
              e.timeStamp = f(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = B(h, u), e.distance = Z(h, u),
                function(t, e) {
                  var n = e.center,
                    i = t.offsetDelta || {},
                    s = t.prevDelta || {},
                ...
                function(t, e) {
                  ...
                  if (8 != e.eventType && (h > 25 || o.velocity === a)) {
                    var u = e.deltaX - o.deltaX,
                      c = e.deltaY - o.deltaY,
                      l = j(h, u, c);
                    i = l.x, s = l.y, n = p(l.x) > p(l.y) ? l.x : l.y, r = G(u, c), t.lastInterval = e
        ...
        L.prototype = {
          ...
          destroy: function() {
            this.evEl && A(this.element, this.evEl, this.domHandler), this.evTarget && A(this.target, this.evTarget, this.domHandler), this.evWin && A(k(this.element), this.evWin, this.domHandler)
          }
        };
        var $ = {
          mousedown: 1,
        ...
        function wt(t) {
          this.options = h({}, this.defaults, t || {}), this.id = O++, this.manager = null, this.options.enable = I(this.options.enable, !0), this.state = 1, this.simultaneous = {}, this.requireFail = []
        }
        ...
        function zt(t, e) {
          return (e = e || {}).recognizers = I(e.recognizers, zt.defaults.preset), new Nt(t, e)
        }

        function Nt(t, e) {
          this.options = h({}, zt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new(this.options.inputClass || (N ? nt : Y ? at : z ? ut : J))(this, H), this.touchAction = new _t(this, this.options.touchAction), Yt(this, !0), m(this.options.recognizers, function(t) {
        ...
        wt.prototype = {
          ...
          bindFn: b,
          prefixed: R
        }), (void 0 !== s ? s : "undefined" != typeof self ? self : {}).Hammer = zt, (i = function() {
          return zt
