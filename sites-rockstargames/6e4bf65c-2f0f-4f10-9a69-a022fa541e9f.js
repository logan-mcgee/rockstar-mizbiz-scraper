try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "6e4bf65c-2f0f-4f10-9a69-a022fa541e9f", e._sentryDebugIdIdentifier = "sentry-dbid-6e4bf65c-2f0f-4f10-9a69-a022fa541e9f")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    63975: (e, t, r) => {
      ...
      function O(e) {
        for (var t = {}, r = 0, n = e; r < n.length; r++) {
          ...
          } else if (H.test(o.stem)) t = (0, s.__assign)((0, s.__assign)({}, t), N(o.stem));
          else {
            var a = I(o.stem);
      ...
      var re = function() {
        ...
        return e.prototype.parse = function() {
          ...
          if (this.bumpIf(">")) {
            ...
            if (this.bumpIf("</")) {
              if (this.isEOF() || !ne(this.char())) return this.error(n.INVALID_TAG, G(l, this.clonePosition()));
              ...
              return i !== this.parseTagName() ? this.error(n.UNMATCHED_CLOSING_TAG, G(c, this.clonePosition())) : (this.bumpSpace(), this.bumpIf(">") ? {
                ...
                err: null
              } : this.error(n.INVALID_TAG, G(l, this.clonePosition())))
            }
          ...
          switch (u) {
            case "":
              return this.error(n.EXPECT_ARGUMENT_TYPE, G(c, h));
            case "number":
            case "date":
            case "time":
              this.bumpSpace();
              ...
              if (this.bumpIf(",")) {
                ...
                if (0 === (y = Q(T.val)).length) return this.error(n.EXPECT_ARGUMENT_STYLE, G(this.clonePosition(), this.clonePosition()));
                f = {
                  style: y,
            ...
            default:
              return this.error(n.INVALID_ARGUMENT_TYPE, G(c, h))
          }
          ...
          for (var i, a = !1, s = [], l = new Set, c = o.value, u = o.location;;) {
            if (0 === c.length) {
              ...
              if (f.err) return f;
              u = G(h, this.clonePosition()), c = this.message.slice(h.offset, this.offset())
            }
