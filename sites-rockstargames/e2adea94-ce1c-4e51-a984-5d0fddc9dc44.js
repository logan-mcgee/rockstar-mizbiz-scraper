    ...
    33586: (e, o, t) => {
      ...
      const a = () => {
        ...
        const c = `rockstarweb_lang.${o.cookieIdentifier}`,
          u = (0, n.h)(c);
        l = o.currentSite?.site === s.C.www ? r.Ay.find((e => e.subdomaincom === a)) || r.Ay.find((e => e.subdomaincom === t)) || i : r.Ay.find((e => e.iso === u)) || i;
        const [d, m] = (0, n.A)(c, l.iso);
        return [l, m]
      }
    },
    7308: (e, o, t) => {
