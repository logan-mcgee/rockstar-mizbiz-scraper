! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      s = (new Error).stack;
    s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "96b595d6-4217-42de-b83f-17c46fa45aed", e._sentryDebugIdIdentifier = "sentry-dbid-96b595d6-4217-42de-b83f-17c46fa45aed")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [4956], {
    ...
    24956: (e, s, a) => {
      ...
      const {
        host: b
      } = (0, i.getScConfigForOrigin)(), f = (0, n.withIntl)((() => {
        const e = (0, n.useIntl)(),
          {
            track: s
          } = (0, o.useGtmTrack)(),
        ...
        return (0, t.useEffect)((() => {
          (async () => {
            ...
            const s = await (0, i.coreScApiFetch)("marketing/unsubscribe", {
                fetchOptions: {
                  method: "POST"
                },
                pingBearer: p,
              ...
              a = s?.error?.code;
            s?.status ? k("success") : a && !s?.status && k(h[a] || "error")
          })()
