! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "56e6a97d-27f3-4d8c-9cff-67d904670af4", e._sentryDebugIdIdentifier = "sentry-dbid-56e6a97d-27f3-4d8c-9cff-67d904670af4")
  } catch (e) {}
}();
  ...
  [267], {
    5138: (e, a, t) => {
      ...
      const i = {
        ...
        n = () => {
          ...
          const {
            location: a
          } = window, t = a.hostname.substring(0, a.hostname.indexOf(".rockstargames.com")), i = s.findIndex((a => Object.entries(a.sites).findIndex((a => {
            let [i, s] = a;
            return s === t && (e = {
              site: i,
              subDomain: s
    ...
    1207: (e, a, t) => {
      ...
      const i = e => {
          ...
          const t = setInterval((() => a.scrollIntoView({
            ...
            i = e => {
              e.target === document && (clearInterval(t), document.removeEventListener("scroll", i))
            };
      ...
      class r {
        constructor(e, a, t) {
          ...
          this.name = e, this.friendlyName = a, this.id = t, this.alias = i
        }
      }
      ...
      function l(e) {
        ...
        return c.find((e => a === e.name || a === e.id.toString() || a === e.friendlyName.toLowerCase() || a === e.alias?.toLowerCase()))
      }
      const d = function() {
      ...
      const u = e => {
        ...
        _ = (e, a) => {
          e && void 0 !== a && (0, m.canStoreCookie)(e) && u(e) !== a && (document.cookie = `${e}=${a}; domain=${(()=>{const e=window.location.hostname.split(".");return e.slice(e.length-2).join(".")})()}; path=/;`)
        };
      t(8096);
      const p = e => e.keys().forEach(e),
        ...
        f = function() {
          ...
          return g.filter((a => a.key === (e ? "prod" : "dev")))[0]?.path ?? null
        },
        b = e => {
          e.preventDefault();
          ...
          fetch(a, {
            ...
            i.href = a, i.setAttribute("download", t), document.body.appendChild(i), i.click(), document.body.removeChild(i)
          })).catch((e => {
            console.log(e)
          }))
        },
        k = () => [o.xbox360.name, o.xboxone.name, o.ps3.name, o.ps4.name, o.pc.name],
        v = () => [o.xboxsx.name, o.ps5.name],
        h = e => v().includes(e),
        j = e => {
          const a = new Map([
    ...
    5267: (e, a, t) => {
      ...
      const _ = e => {
          ...
          const [n, o] = (0, i.useMemo)((() => function(e) {
            const a = e.split(/[-_]/)[1];
            let t = e.split(/[-_]/)[0],
              i = a?.toLowerCase();
            return "cn" === i && (i = "hans"), t && a || (t = "en", i = "us"), [t, i]
          }(t)), [t]), c = (0, i.useMemo)((() => function(e, a) {
            return e?.[a] ?? {}
          }(a, o)), [t, a]);
          return (0, u.jsx)(r.A, {
            messages: c,
      ...
      var f = t(9623);
      const b = "rockstargames-sites-gta-tvea8cf4797c830e5b5dad68b2ec814e67",
        k = function(e, a) {
          return t => {
            const [{
              iso: i
              ...
              if (a.currentSite?.site === o.C.www) n = m.find((e => e.subdomaincom === i)) || m.find((e => e.subdomaincom === t)) || s;
              else {
                const e = (0, c.Ap)(r);
                n = m.find((a => a.iso === e)) || s
              }
              return [n, (e => a => {
                (0, c.My)(e, a)
              })(r)]
          ...
          const m = (0, i.useRef)(null),
            ...
            k = /^#/.test(t),
            v = d?.target ?? (o ? "_blank" : "_self"),
            {
              ...h
            } = d;
          let j = "";
          if ("aria-label" in h && h["aria-label"] && (j = "_blank" === v ? `${h["aria-label"]} ${_.formatMessage(g.aria_label_open_new_window)}` : h["aria-label"]), (0, i.useEffect)((() => {
            ...
            return (0, u.jsxs)("a", {
              ...
              "aria-label": j,
              ref: m,
              children: [a, "_blank" === v && !j && (0, u.jsx)("span", {
                className: b,
                children: _.formatMessage(g.aria_label_open_new_window)
              })]
            })
          }
          if (p) return (0, u.jsxs)(f.NavLink, {
            title: r,
            to: t,
            onClick: c,
            ...h,
          ...
          const y = Object.keys(h).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, a) => ({
            ...e,
            [a]: d[a]
          })), {});
        ...
        v = () => (0, u.jsx)("header", {
          ...
          children: (0, u.jsxs)("div", {
            ...
            children: [(0, u.jsx)(k, {
              ...
              children: ["The future of", " ", (0, u.jsx)("strong", {
      ...
      const y = e => {
          ...
          const {
            isMobile: o
          } = (0, h.useWindowResize)(), c = (0, i.useMemo)((() => {
            let e = "";
            return a && (e = o ? t(5877)(`./${r}/mobile.png`) : t(5889)(`./${r}/desktop.png`)), e || (e = t(9294)(`./${r}.jpg`), e += `?im=Resize=${s}`), e
          }), [o, r]), [l] = (0, h.usePreloadImg)(c);
          return (0, u.jsx)("div", {
            role: "img",
            "aria-label": n,
            className: [j.img, l ? j.startAnimation : "", a ? j.wide : ""].join(" "),
            style: {
        ...
        x = e => {
          ...
          return (0, u.jsx)(k, {
            ...
            to: t ?? s,
            target: "_self",
            className: [w.fobLink, n ? w.wide : ""].join(" "),
            reloadDocument: n,
            children: (0, u.jsx)(y, {
              title: a.title,
              titleSlug: i,
        ...
        N = e => {
          ...
          return (0, u.jsxs)("div", {
            ...
            children: [(0, u.jsx)("h2", {
              ...
              className: z.items,
              children: i.map((e => (0, u.jsxs)(k, {
                className: [z.item, e.id === a ? z.playing : ""].join(" "),
                to: `?id=${e.id}`,
        ...
        V = e => {
          ...
          return (0, u.jsxs)("div", {
            ...
            children: [(0, u.jsx)("h2", {
              ...
              games: a.filter((e => "VI" !== e.titleSlug))
            })]
          })
        },
        R = () => {
      ...
      const D = () => {
        ...
        M = () => (0, u.jsx)("div", {
          ...
          children: (0, u.jsxs)("div", {
            ...
            children: [(0, u.jsx)(v, {}), (0, u.jsx)("div", {
    ...
    5889: (e, a, t) => {
      ...
      s.keys = function() {
        return Object.keys(i)
      }, s.resolve = n, e.exports = s, s.id = 5889
    },
    5877: (e, a, t) => {
      var i = {
        "./VI/mobile.png": 6048
      ...
      s.keys = function() {
        return Object.keys(i)
      }, s.resolve = n, e.exports = s, s.id = 5877
    },
    111: e => {
      "use strict";
