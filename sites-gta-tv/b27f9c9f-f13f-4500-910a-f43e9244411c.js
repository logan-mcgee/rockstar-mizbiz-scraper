! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "b27f9c9f-f13f-4500-910a-f43e9244411c", e._sentryDebugIdIdentifier = "sentry-dbid-b27f9c9f-f13f-4500-910a-f43e9244411c")
  } catch (e) {}
}();
  ...
  [9449, 1830], {
    5039: (e, t, n) => {
      ...
      function c(e, t, n) {
        var o, c = {},
          l = null,
          d = null;
        for (o in void 0 !== n && (l = "" + n), void 0 !== t.key && (l = "" + t.key), void 0 !== t.ref && (d = t.ref), t) s.call(t, o) && !i.hasOwnProperty(o) && (c[o] = t[o]);
        if (e && e.defaultProps)
    ...
    9449: (e, t, n) => {
      ...
      const F = k(),
        H = () => F;
      var z = n(9094);
      const N = (0, U.UT)(document.documentElement.lang),
        q = () => (0, z.q)(N),
        G = e => {
      ...
      const re = () => {
        ...
        we = e => {
          ...
          const [n, o] = (0, L.useState)(window.pageYOffset), [r, s] = (0, L.useState)(null), [a, i] = (0, L.useState)(!1), c = (0, z.q)(de);
          let l;
          const d = () => {
          ...
          }), [a, c]), (0, L.useMemo)((() => (0, T.jsx)(he.Provider, {
            value: {
      ...
      const Ee = e => {
        ...
        Oe = window?.["apollo-use-query"] ?? (window["apollo-use-query"] = (e, t) => (0, L.useContext)(Ce)(e, t)),
        Ae = window?.["apollo-use-mutation"] ?? (window["apollo-use-mutation"] = e => (0, L.useContext)(Re)(e));
      var Me = n(5197);
      var Ue = n(3556),
        Ie = n(2600),
        $e = n.n(Ie);
      const Be = (0, n(6162).e)({
        ...
        ze = (0, U.UT)({}),
        Ne = "data-disallow-body-scroll",
        qe = e => {
          const t = (0, z.q)(ze),
            n = Object.values(t).some((e => !!e));
          return (0, L.useEffect)((() => {
            n ? document.documentElement.setAttribute(Ne, "true") : document.documentElement.removeAttribute(Ne)
          }), [n]), {
            bodyShouldLock: n,
      ...
      const Je = Object.freeze({
          pc: new Ye("pc", "PC", 8),
          ps: new Ye("ps", "PlayStation", 3),
          ps3: new Ye("ps3", "PlayStation 3", 2),
          ps4: new Ye("ps4", "PlayStation 4", 11),
          ps5: new Ye("ps5", "PlayStation 5", 20),
          xbox: new Ye("xbox", "Xbox", 4),
          xbox360: new Ye("xbox360", "Xbox 360", 1),
          xboxone: new Ye("xboxone", "Xbox One", 12),
          xboxsx: new Ye("xboxsx", "Xbox Series X|S", 21, "xboxseriesxs"),
          switch: new Ye("switch", "Nintendo Switch™", 18),
          nintendoswitch: new Ye("nintendoswitch", "Nintendo Switch™", 18),
          applestore: new Ye("applestore", "App Store", 102),
          googleplay: new Ye("googleplay", "Google Play", 1023),
          appStore: new Ye("app_store", "App Store", 102),
          googlePlay: new Ye("ggle_play", "Google Play", 1023)
        }),
        Ke = Object.freeze(Object.values(Je));
      ...
      const ot = e => {
        ...
        it = function() {
          ...
          return at.filter((t => t.key === (e ? "prod" : "dev")))[0]?.path ?? null
        },
        ct = e => {
          e.preventDefault();
        ...
        lt = () => [Je.xbox360.name, Je.xboxone.name, Je.ps3.name, Je.ps4.name, Je.pc.name],
        dt = () => [Je.xboxsx.name, Je.ps5.name],
        ut = e => dt().includes(e),
        ht = e => {
          const t = new Map([
      ...
      const Ct = (0, U.UT)(Pt),
        ...
        jt = e => {
          ...
          return (0, T.jsx)(_t.Provider, {
            value: r,
            children: t
          })
        },
        Ot = e => t => ((e, t) => (0, T.jsx)(e, {
          ...t,
          gtmTrack: e => {
            kt(e)
          }
