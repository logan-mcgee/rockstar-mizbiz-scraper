try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "c2c368ae-d0ba-48da-abbe-a6be48e42b0a", e._sentryDebugIdIdentifier = "sentry-dbid-c2c368ae-d0ba-48da-abbe-a6be48e42b0a")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    6402(e, t, n) {
      ...
      const d = window?.env?.sc,
        ...
        v = async (e, {
          ...
          try {
            ...
            let h = `${p}/${e}`;
            if (null === o || (0, c.A)(o) || (h += `?${new URLSearchParams(o)}`), !l && a) return null;
      ...
      const ce = document.documentElement.lang,
        de = (e, t) => {
          ...
          }, [o]), (0, q.useEffect)(() => (n.autoSetLoading && window.postMessage({
...
query Translations($locale: String!, $config: String!) {
    translations(locale: $locale, config: $config) {
        ...
        it = () => at,
        ct = e => {
          const [t, n] = (0, q.useState)(null), [o, r] = (0, q.useState)(null), [s, a] = (0, q.useState)({});
      ...
      const pt = () => {
          const e = (e, t) => {
            ...
            window[mt][n] || (window[mt][n] = {
              eventQueue: [],
              subscribers: []
            }), window[mt][n].eventQueue.push(o), window[mt][n].subscribers.forEach(e => {
              e(o.detail)
            })
          };
          return (0, q.useMemo)(() => ({
        ...
        kt = ({
          ...
          const [t, n] = (0, q.useState)(window.pageYOffset), [o, r] = (0, q.useState)(null), [s, a] = (0, q.useState)(!1), i = (0, U.q)(ft);
          let c;
          const d = () => {
      ...
      const qt = e => {
          const [t, n] = (0, q.useState)(!1), o = (0, q.useRef)(null);
          return (0, q.useEffect)(() => {
            const r = () => {
