! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "71454dcc-b0b9-4257-804a-da784ecb4662", e._sentryDebugIdIdentifier = "sentry-dbid-71454dcc-b0b9-4257-804a-da784ecb4662")
  } catch (e) {}
}();
    ...
    839: (e, t, n) => {
      ...
      const c = window?.env?.sc,
        ...
        v = async function(e) {
          ...
          try {
            ...
            let g = `${m}/${e}`;
            if (null === r || l().isEmpty(r) || (g += `?${new URLSearchParams(r)}`), !d && i) return null;
      ...
      const se = () => {
        ...
        me = e => {
          ...
          const [n, r] = (0, T.useState)(window.pageYOffset), [o, s] = (0, T.useState)(null), [a, i] = (0, T.useState)(!1), l = (0, q.q)(ue);
          let c;
          const d = () => {
          ...
          }), [a, l]), (0, T.useMemo)((() => (0, L.jsx)(he.Provider, {
            value: {
        ...
        Ce = (e, t) => {
          ...
          return (0, T.useEffect)((() => {
            if (o && r.setTitleDataPath) {
              const e = l().get(o, r.setTitleDataPath) ?? null;
      ...
      const lt = (0, U.UT)(it),
        ct = e => {
          ...
          return r[t] = n, null === n && delete r[t], window.localStorage.setItem(at, JSON.stringify(r)), lt(r), r
        },
        dt = () => ({
          lsSettings: (0, q.q)(lt),
          settingsReactive: lt,
