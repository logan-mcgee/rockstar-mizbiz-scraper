! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "db85e42c-daea-4663-8abd-dce9b31ec290", e._sentryDebugIdIdentifier = "sentry-dbid-db85e42c-daea-4663-8abd-dce9b31ec290")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [8326], {
    ...
    2301: (e, t, a) => {
      ...
      const l = (e, t) => {
        ...
        p = () => {
          ...
          const r = `rockstarweb_lang.${t.cookieIdentifier}`,
            c = d(r);
          n = t.currentSite?.site === o.C.www ? _.find((e => e.subdomaincom === i)) || _.find((e => e.subdomaincom === a)) || s : _.find((e => e.iso === c)) || s;
      ...
      var h = a(9623);
      const j = "rockstargames-sites-gta-tvea8cf4797c830e5b5dad68b2ec814e67",
        y = (w = e => {
          let {
            children: t,
            to: a = "#",
          ...
          let b = "";
          if ("aria-label" in f && f["aria-label"] && (b = "_blank" === g ? `${f["aria-label"]} ${u.formatMessage(v.aria_label_open_new_window)}` : f["aria-label"]), (0, i.useEffect)((() => {
            ...
            return (0, k.jsxs)("a", {
              ...
              "aria-label": b,
              ref: m,
              children: [t, "_blank" === g && !b && (0, k.jsx)("span", {
                className: j,
                children: u.formatMessage(v.aria_label_open_new_window)
              })]
            })
          }
          if (_) return (0, k.jsxs)(h.NavLink, {
            title: r,
            to: a,
            onClick: c,
            ...f,
          ...
          const y = Object.keys(f).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
            ...e,
            [t]: d[t]
          })), {});
      ...
      const R = e => {
          ...
          const {
            ...
            let e = "";
            return t && (e = o ? a(5877)(`./${r}/mobile.png`) : a(5889)(`./${r}/desktop.png`)), e || (e = a(9294)(`./${r}.jpg`), e += `?im=Resize=${s}`), e
        ...
        V = e => {
          ...
          return (0, k.jsx)(y, {
            ...
            to: a ?? s,
            target: "_self",
            className: [G.fobLink, n ? G.wide : ""].join(" "),
            reloadDocument: n,
            children: (0, k.jsx)(R, {
              title: t.title,
              titleSlug: i,
