try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "2d0e6b8d-69cc-440d-9d64-c24f7e33b8a6", e._sentryDebugIdIdentifier = "sentry-dbid-2d0e6b8d-69cc-440d-9d64-c24f7e33b8a6")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [9772], {
    29772: (e, t, n) => {
      ...
      const d = window?.env?.sc,
        ...
        }, b = (...e) => e.filter(Boolean).join(" "), y = e => e.includes("reddead") || e.includes("rdr") ? "#CC0000" : e.includes("bully") ? "#F8AD00" : "#FCAF17", k = () => {
      ...
      const ke = Object.freeze({
          pc: new ye("pc", "PC Legacy", 8, "sc"),
          ps: new ye("ps", "PlayStation", 3, "np", "ps"),
          ps3: new ye("ps3", "PlayStation 3", 2, "np", "ps"),
          ps4: new ye("ps4", "PlayStation 4", 11, "np", "ps"),
          ps5: new ye("ps5", "PlayStation 5", 20, "np", "ps"),
          xbox: new ye("xbox", "Xbox", 4, "xbl"),
          xbox360: new ye("xbox360", "Xbox 360", 1, "xbl"),
          xboxone: new ye("xboxone", "Xbox One", 12, "xbl"),
          xboxsx: new ye("xboxsx", "Xbox Series X|S", 21, "xbl", null, "xboxseriesxs"),
          switch: new ye("switch", "Nintendo Switch™", 18, "nintendoswitch"),
          nintendoswitch: new ye("nintendoswitch", "Nintendo Switch™", 18, "nintendoswitch"),
          applestore: new ye("applestore", "App Store", 102, "applestore"),
          googleplay: new ye("googleplay", "Google Play", 1023, "googleplay"),
          appStore: new ye("app_store", "App Store", 102, "applestore"),
          googlePlay: new ye("ggle_play", "Google Play", 1023, "googleplay"),
          pcalt: new ye("pcalt", "PC Enhanced", 22, "sc")
        }),
        xe = Object.freeze(Object.values(ke));
      ...
      }, $e = () => [ke.xbox360.name, ke.xboxone.name, ke.ps3.name, ke.ps4.name, ke.pc.name], Be = () => [ke.xboxsx.name, ke.ps5.name, ke.pcalt.name], Oe = e => Be().includes(e), Ie = e => {
        const t = new Map([
