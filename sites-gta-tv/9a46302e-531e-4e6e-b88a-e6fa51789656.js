! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "9a46302e-531e-4e6e-b88a-e6fa51789656", e._sentryDebugIdIdentifier = "sentry-dbid-9a46302e-531e-4e6e-b88a-e6fa51789656")
  } catch (e) {}
}();
    ...
    5980: (e, t, a) => {
      ...
      const l = "www",
        ...
        k = () => {
          ...
          const r = `rockstarweb_lang.${t.cookieIdentifier}`,
            o = g(r);
          n = t.currentSite?.site === l ? h.find((e => e.subdomaincom === i)) || h.find((e => e.subdomaincom === a)) || s : h.find((e => e.iso === o)) || s;
      ...
      const ae = function(e) {
        ...
        se = (ae((e => {
          ...
          const {
            track: f
          } = (0, B.useGtmTrack)(), h = (0, i.useRef)(null), k = (0, i.useRef)(null), b = (0, i.useRef)(null), [y, x] = (0, i.useState)(null), [N, w] = (0, i.useState)(!1), [S, j] = (0, i.useState)(null), [T, C] = (0, i.useState)(), [M, z] = (0, i.useState)(), {
            ref: E,
            inView: D
          } = (0, H.Wx)({
            threshold: .6
          }), [A, O] = (0, i.useState)(!1), [F, I] = (0, i.useState)(null), [L, R] = (0, i.useState)(!1), [$, U] = (0, i.useState)(0), [q, G] = (0, i.useState)(0);
          (0, i.useEffect)((() => {
            const e = () => {
            ...
            const e = () => {
              T && !(0, ee.isEmpty)(T) && T?.height > 0 && T?.height !== $ && U(T?.height)
            };
            return e(), window.addEventListener("resize", e), () => {
              window.removeEventListener("resize", e)
            }
          ...
          (0, i.useEffect)((() => {
            ...
            const e = () => {
              if (h.current) {
                const e = o || Number(window.getComputedStyle(h.current).getPropertyValue("--slides-per-view")),
                  t = o ? 1 : Number(window.getComputedStyle(h.current).getPropertyValue("--slides-per-view-multiplier"));
                j(e * t)
              }
            };
            ...
            let e = !1;
            a.forEach((t => {
              "cover-card" === t?.props?.tina?.payload?.meta?.type && (e = !0, I(t))
            })), O(e);
            const t = a.map(((e, t) => "cover-card" === e?.props?.tina?.payload?.meta?.type && L ? null : (0, v.jsx)(P.qr, {
                  ...
                  children: [!A && n && (0, v.jsxs)("div", {
                    ...
                    onNextKeyDown: e => {
                      if ("Tab" === e.key && !e.shiftKey) {
                        const t = T?.slides[T?.activeIndex].querySelector('a, button, [role="button"]');
        ...
        re = y((e => {
          ...
          const {
            track: d
          } = (0, B.useGtmTrack)(), u = (0, r.A)(), [_, g] = k(), [p, f] = (0, i.useState)(!1), b = (0, i.useMemo)((() => m()), []), y = (0, i.useCallback)((e => {
            let t = o.pathname;
            const a = t.split("/");
            return h.map((e => e.subdomaincom)).includes(a[0]) && (t = a.slice(1).join("/")), b.currentSite?.site === l ? "en" === e ? `${window.location.origin}${t}${o.search}` : `${window.location.origin}/${e}${t}${o.search}` : `${window.location.origin}${t}${o.search}`
            ...
            const t = h.find((t => t.subdomaincom === e));
            if (t) {
              const a = y(e);
              d({
                event: "cta_other",
