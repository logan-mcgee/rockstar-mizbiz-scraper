! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "db0608e6-e35f-4b22-8871-b0a322d55306", e._sentryDebugIdIdentifier = "sentry-dbid-db0608e6-e35f-4b22-8871-b0a322d55306")
  } catch (e) {}
}();
  ...
  [968], {
    5968: (e, i, s) => {
      ...
      const o = [{
        ...
        _ = e => {
          const i = document.cookie.split("; "),
            s = `${e}=`,
            a = i.find((e => e.startsWith(s))),
            n = a?.substring(s.length, a.length);
          return n
        },
        d = [{
          label: "Deutsch",
        ...
        p = () => {
          const {
            ...
            const {
              location: i
            } = window, s = i.hostname.substring(0, i.hostname.indexOf(".rockstargames.com")), a = o.findIndex((i => Object.entries(i.sites).findIndex((i => {
              let [a, n] = i;
              return n === s && (e = {
                site: a,
                subDomain: n
            ...
            const i = u.map((e => e.subdomaincom)),
              s = e.pathname.substring(1).split("/"),
              a = "detect-locals" === s[0] ? 1 : 0;
            return -1 !== i.indexOf(s[a]) ? s[a] : null
          })(e), a = (e => {
          ...
          const r = `rockstarweb_lang.${i.cookieIdentifier}`,
            l = _(r);
          t = "www" === i.currentSite?.site ? u.find((e => e.subdomaincom === a)) || u.find((e => e.subdomaincom === s)) || n : u.find((e => e.iso === l)) || n;
          const [d, p] = function(e, i) {
            let s = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const a = _(e);
            return a && !s || c(e, i), [a, (n = e, e => {
              c(n, e)
            })];
            var n
          }(r, t.iso);
      ...
      const f = e => {
          ...
          const [t, o] = (0, a.useMemo)((() => function(e) {
            let [i, s] = e.split(/[-_]/), a = s?.toLowerCase();
            return "cn" === a && (a = "hans"), i && s || (i = "en", a = "us"), [i, a]
          }(s)), [s]), c = (0, a.useMemo)((() => function(e, i) {
            return e?.[i] ?? {}
          }(i, o)), [s, i]);
          return (0, g.jsx)(r.A, {
            messages: c,
      ...
      var v = s(9779);
      const h = "rockstargames-sites-gta-tvff481c537a56a6fcdb1be85dfbc8944e",
        y = function(e, i) {
          return s => {
            const [{
              iso: a
          ...
          const d = (0, a.useRef)(null),
            ...
            p = /^#/.test(s),
            f = _?.target ?? (o ? "_blank" : "_self");
          let {
            ...k
          } = _, y = "";
          if ("aria-label" in k && k["aria-label"] && (y = "_blank" === f ? `${k["aria-label"]} ${m.formatMessage(b.aria_label_open_new_window)}` : k["aria-label"]), (0, a.useEffect)((() => {
            ...
            return (0, g.jsxs)("a", {
              ...
              "aria-label": y,
              ref: d,
              children: [i, "_blank" === f && !y && (0, g.jsx)("span", {
                className: h,
                children: m.formatMessage(b.aria_label_open_new_window)
              })]
            })
          }
          if (u) return (0, g.jsxs)(v.NavLink, {
            title: r,
            to: s,
            onClick: c,
            ...k,
          ...
          const j = Object.keys(k).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, i) => ({
            ...e,
            [i]: _[i]
          })), {});
          return "function" == typeof j?.className && delete j.className, (0, g.jsxs)("a", {
            href: s,
            title: r,
            onClick: c,
            target: f,
      ...
      const N = e => {
          ...
          const {
            isMobile: o
          } = (0, x.useWindowResize)(), c = (0, a.useMemo)((() => {
            let e = "";
            return i && (e = o ? s(7426)(`./${r}/mobile.png`) : s(5392)(`./${r}/desktop.png`)), e || (e = s(2781)(`./${r}.jpg`), e += `?im=Resize=${n}`), e
          }), [o, r]), [l] = (0, x.usePreloadImg)(c);
          return (0, g.jsx)("div", {
            role: "img",
            "aria-label": t,
            className: [z.img, l ? z.startAnimation : "", i ? z.wide : ""].join(" "),
            style: {
        ...
        C = e => {
          ...
          return (0, g.jsx)(y, {
            ...
            to: s ?? n,
            target: "_self",
            className: [S.fobLink, t ? S.wide : ""].join(" "),
            reloadDocument: t,
            children: (0, g.jsx)(N, {
              title: i.title,
              titleSlug: a,
        ...
        V = e => {
          ...
          return (0, g.jsxs)("div", {
            ...
            children: [(0, g.jsx)("h2", {
              ...
              className: A.items,
              children: a.map((e => (0, g.jsxs)(y, {
                className: [A.item, e.id === i ? A.playing : ""].join(" "),
                to: `?id=${e.id}`,
      ...
      var q = s(1879),
        ...
        O = s(3451);
      const T = () => {
          const e = (0, x.useQueryParams)(),
            [i, s] = (0, a.useState)(null),
            {
              data: n,
              loading: t
            } = (0, R.useQuery)(O.VideoData, {
              variables: {
                id: i
              }
            });
        ...
        $ = () => (0, g.jsx)("div", {
          ...
          children: (0, g.jsxs)("div", {
            ...
            children: [(0, g.jsx)(j, {}), (0, g.jsx)("div", {
    ...
    3451: e => {
      ...
      })), e.exports = i, e.exports.videoFields = t(i, "videoFields"), e.exports.VideoData = t(i, "VideoData")
    },
    3202: (e, i, s) => {
      var a = {
        "./GTAOnline.jpg": 46,
      ...
      }, n.resolve = t, e.exports = n, n.id = 3202
    },
    2781: (e, i, s) => {
      var a = {
        "./GTAOnline.jpg": 46,
      ...
      n.keys = function() {
        return Object.keys(a)
      }, n.resolve = t, e.exports = n, n.id = 2781
    },
    5392: (e, i, s) => {
      var a = {
        "./VI/desktop.png": 4699
      ...
      n.keys = function() {
        return Object.keys(a)
      }, n.resolve = t, e.exports = n, n.id = 5392
    },
    7426: (e, i, s) => {
      var a = {
        "./VI/mobile.png": 7821
      ...
      n.keys = function() {
        return Object.keys(a)
      }, n.resolve = t, e.exports = n, n.id = 7426
    },
    46: e => {
      "use strict";
