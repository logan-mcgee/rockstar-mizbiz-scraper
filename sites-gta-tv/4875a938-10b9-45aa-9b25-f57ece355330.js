try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "4875a938-10b9-45aa-9b25-f57ece355330", e._sentryDebugIdIdentifier = "sentry-dbid-4875a938-10b9-45aa-9b25-f57ece355330")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [174, 291], {
    ...
    5174(e, a, t) {
      ...
      const l = (e, a) => {
          ...
          document.cookie = `${e}=${a}; domain=${i}; path=/;`
        },
        d = e => {
          const a = document.cookie.split("; "),
            t = `${e}=`,
            i = a.find(e => e.startsWith(t)),
            s = i?.substring(t.length, i.length);
          return s
        },
        _ = [{
          label: "English",
        ...
        p = () => {
          const {
            ...
            const a = u.map(e => e.subdomaincom),
              t = e.pathname.substring(1).split("/"),
              i = "detect-locals" === t[0] ? 1 : 0;
            return -1 !== a.indexOf(t[i]) ? t[i] : null
          })(e), i = (e => {
          ...
          const n = `rockstarweb_lang.${a.cookieIdentifier}`,
            o = d(n);
          r = a.currentSite?.site === c.C.www ? u.find(e => e.subdomaincom === i) || u.find(e => e.subdomaincom === t) || s : u.find(e => e.iso === o) || s;
          const [, _] = ((e, a, t = !1) => {
            const i = d(e);
            return i && !t || l(e, a), [i, (s = e, e => {
              l(s, e)
            })];
            var s
          })(n, r.iso);
    ...
    7279(e, a, t) {
      ...
      const r = {
        ...
        o = () => {
          ...
          const {
            location: a
          } = window, t = a.hostname.substring(0, a.hostname.indexOf(".rockstargames.com")), r = n.findIndex(a => Object.entries(a.sites).findIndex(([a, i]) => i === t && (e = {
            site: a,
            subDomain: i
          }, !0)) >= 0), o = n[r >= 0 ? r : 0], c = n.find(e => e.id === o.fallbackEnvironment);
          return e || (e = {
            site: "www",
            subDomain: "local"
          }), (0, s.A)((0, i.A)({}, c, {
    ...
    3291(e, a, t) {
      ...
      const c = "rockstargames-sites-gta-tvea8cf4797c830e5b5dad68b2ec814e67",
        ...
        d = (_ = ({
          ...
          const g = (0, s.useRef)(null),
            ...
            y = h["aria-current"] ?? !1;
          let w = "";
          if ("aria-label" in h && h["aria-label"] && (w = "_blank" === v ? `${h["aria-label"]} ${b.formatMessage(n.aria_label_open_new_window)}` : h["aria-label"]), (0, s.useEffect)(() => {
            ...
            return (0, i.jsxs)("a", {
              ...
              ref: g,
              role: _,
              children: [e, "_blank" === v && !w && (0, i.jsx)("span", {
                className: c,
                children: b.formatMessage(n.aria_label_open_new_window)
              })]
            })
          }
          if (f) return (0, i.jsxs)(o.NavLink, {
            title: l,
            to: a,
            onClick: m,
            ...h,
          ...
          const j = Object.keys(h).filter(e => !["activeClassName", "key", "end"].includes(e)).reduce((e, a) => ({
            ...e,
            [a]: p[a]
          }), {});
          return "function" == typeof j?.className && delete j.className, (0, i.jsxs)("a", {
            href: a,
            title: l,
            onClick: m,
            target: v,
      ...
      const m = () => (0, i.jsx)("header", {
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(d, {
            ...
            children: ["The future of", " ", (0, i.jsx)("strong", {
      ...
      const g = ({
          ...
          const {
            isMobile: c
          } = (0, u.useWindowResize)(), l = (0, s.useMemo)(() => {
            let i = "";
            return e && (i = c ? t(5087)(`./${n}/mobile/global.jpg`) : t(8963)(`./${n}/desktop/global.jpg`)), i || (i = t(9294)(`./${n}.jpg`), i += `?im=Resize=${a}`), i
          }, [c, n]), [d] = (0, u.usePreloadImg)(l);
          let _ = l;
          return (0, i.jsx)("div", {
            role: "img",
            "aria-label": r,
            ...
            className: [p.img, d ? p.startAnimation : "", e ? p.wide : ""].join(" ")
          })
        },
        b = {
        ...
        f = ({
          ...
          return (0, i.jsx)(d, {
            ...
            to: a ?? s,
            target: "_self",
            className: [b.fobLink, r ? b.wide : ""].join(" "),
            reloadDocument: r,
            children: (0, i.jsx)(g, {
              title: e.title,
              titleSlug: t,
      ...
      const G = () => {
          const e = (0, u.useQueryParams)(),
            [a, t] = (0, s.useState)(null),
            {
              data: r,
              loading: n
            } = (0, u.useQuery)(S.VideoData, {
              variables: {
                id: a
              }
            });
    ...
    6751(e, a, t) {
      var i = {
        ...
        "./V.jpg": 8754,
        "./VI.jpg": 1157,
        "./VI/desktop/global.jpg": 7156,
        "./VI/mobile/global.jpg": 2640,
        "./agent.jpg": 8323,
        "./beaterator.jpg": 3587,
      ...
      }, s.resolve = r, e.exports = s, s.id = 6751
    },
    9294(e, a, t) {
      var i = {
        "./GTAOnline.jpg": 111,
      ...
      s.keys = function() {
        return Object.keys(i)
      }, s.resolve = r, e.exports = s, s.id = 9294
    },
    8963(e, a, t) {
      var i = {
        "./VI/desktop/global.jpg": 7156
      ...
      s.keys = function() {
        return Object.keys(i)
      }, s.resolve = r, e.exports = s, s.id = 8963
    },
    5087(e, a, t) {
      var i = {
        "./VI/mobile/global.jpg": 2640
      ...
      s.keys = function() {
        return Object.keys(i)
      }, s.resolve = r, e.exports = s, s.id = 5087
    },
    111(e) {
      "use strict";
