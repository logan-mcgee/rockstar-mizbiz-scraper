try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "5511cb01-466f-45b3-84d8-ad14ee110203", e._sentryDebugIdIdentifier = "sentry-dbid-5511cb01-466f-45b3-84d8-ad14ee110203")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [804, 4776], {
    ...
    7648: (e, t, a) => {
      ...
      s.keys = () => Object.keys(i), s.id = 7648, e.exports = s
    },
    8005: e => {
      "use strict";
    ...
    8613: (e, t, a) => {
      ...
      const l = (e, t) => {
          ...
          const a = window.location.hostname.split("."),
            i = a.slice(a.length - 2).join(".");
          document.cookie = `${e}=${t}; domain=${i}; path=/;`
        },
        d = e => {
        ...
        p = () => {
          ...
          const r = `rockstarweb_lang.${t.cookieIdentifier}`,
            o = d(r);
          n = t.currentSite?.site === c.C.www ? u.find((e => e.subdomaincom === i)) || u.find((e => e.subdomaincom === a)) || s : u.find((e => e.iso === o)) || s;
          const [m, p] = ((e, t, a = !1) => {
            const i = d(e);
    ...
    9115: (e, t, a) => {
      ...
      const c = "rockstargames-sites-gta-tvea8cf4797c830e5b5dad68b2ec814e67",
        ...
        d = (m = ({
          ...
          let w = "";
          if ("aria-label" in h && h["aria-label"] && (w = "_blank" === v ? `${h["aria-label"]} ${f.formatMessage(r.aria_label_open_new_window)}` : h["aria-label"]), (0, s.useEffect)((() => {
          ...
          const j = Object.keys(h).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
            ...e,
            [t]: p[t]
          })), {});
      ...
      const g = ({
          ...
          const {
            isMobile: o
          } = (0, u.useWindowResize)(), c = (0, s.useMemo)((() => {
            let i = "";
            return e && (i = o ? a(4865)(`./${r}/mobile.jpg`) : a(3781)(`./${r}/desktop.jpg`)), i || (i = a(9294)(`./${r}.jpg`), i += `?im=Resize=${t}`), i
          }), [o, r]), [l] = (0, u.usePreloadImg)(c);
          let d = c;
          return (0, i.jsx)("div", {
            role: "img",
            "aria-label": n,
            ...
            className: [p.img, l ? p.startAnimation : "", e ? p.wide : ""].join(" ")
          })
        },
        f = {
        ...
        b = ({
          ...
          return (0, i.jsx)(d, {
            ...
            to: t ?? s,
            target: "_self",
            className: [f.fobLink, n ? f.wide : ""].join(" "),
            reloadDocument: n,
            children: (0, i.jsx)(g, {
              title: e.title,
              titleSlug: a,
    ...
    9867: (e, t, a) => {
      ...
      const i = {
        ...
        n = () => {
          ...
          const {
            location: t
          } = window, a = t.hostname.substring(0, t.hostname.indexOf(".rockstargames.com")), i = s.findIndex((t => Object.entries(t.sites).findIndex((([t, i]) => i === a && (e = {
            site: t,
            subDomain: i
          }, !0))) >= 0)), n = s[i >= 0 ? i : 0];
          return e || (e = {
