try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "f56faa1c-a495-4972-9074-59ef3d8e3ccc", e._sentryDebugIdIdentifier = "sentry-dbid-f56faa1c-a495-4972-9074-59ef3d8e3ccc")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [804, 4776], {
    ...
    5267: (e, a, t) => {
      ...
      function r(e) {
        if (!t.o(i, e)) return Promise.resolve().then(() => {
          var a = new Error("Cannot find module '" + e + "'");
          throw a.code = "MODULE_NOT_FOUND", a
        });
        var a = i[e],
          r = a[0];
        return t.e(a[1]).then(() => t.t(r, 23))
      }
      r.keys = () => Object.keys(i), r.id = 5267, e.exports = r
    },
    6927: e => {
      "use strict";
    ...
    16044: (e, a, t) => {
      ...
      }, r.resolve = s, e.exports = r, r.id = 16044
    },
    16264: e => {
      "use strict";
    ...
    33019: (e, a, t) => {
      ...
      r.keys = () => Object.keys(i), r.id = 33019, e.exports = r
    },
    33055: e => {
      "use strict";
    ...
    38525: (e, a, t) => {
      ...
      r.keys = () => Object.keys(i), r.id = 38525, e.exports = r
    },
    38537: e => {
      "use strict";
    ...
    39115: (e, a, t) => {
      ...
      const c = "rockstargames-sites-gta-tvea8cf4797c830e5b5dad68b2ec814e67",
        ...
        l = (m = ({
          ...
          const g = (0, r.useRef)(null),
            ...
            j = h["aria-current"] ?? !1;
          let w = "";
          if ("aria-label" in h && h["aria-label"] && (w = "_blank" === v ? `${h["aria-label"]} ${f.formatMessage(n.aria_label_open_new_window)}` : h["aria-label"]), (0, r.useEffect)(() => {
          ...
          if (b) return (0, i.jsxs)(o.NavLink, {
            title: d,
            to: a,
            onClick: _,
            ...h,
          ...
          return "function" == typeof y?.className && delete y.className, (0, i.jsxs)("a", {
            href: a,
            title: d,
            onClick: _,
            target: v,
      ...
      const g = ({
          ...
          const {
            isMobile: c
          } = (0, u.useWindowResize)(), d = (0, u.useLocale)(), l = (0, r.useMemo)(() => {
            let i = "";
            return e && (i = c ? t(16044)(`./${n}/mobile/${d}.jpg`) : t(51048)(`./${n}/desktop/${d}.jpg`)), i || (i = t(39294)(`./${n}.jpg`), i += `?im=Resize=${a}`), i
        ...
        b = ({
          ...
          return (0, i.jsx)(l, {
            ...
            to: a ?? r,
            target: "_self",
            className: [f.fobLink, s ? f.wide : ""].join(" "),
            reloadDocument: s,
            children: (0, i.jsx)(g, {
              title: e.title,
              titleSlug: t,
    ...
    39294: (e, a, t) => {
      ...
      r.keys = function() {
        return Object.keys(i)
      }, r.resolve = s, e.exports = r, r.id = 39294
    },
    40401: e => {
      "use strict";
    ...
    51048: (e, a, t) => {
      ...
      r.keys = function() {
        return Object.keys(i)
      }, r.resolve = s, e.exports = r, r.id = 51048
    },
    52014: e => {
      "use strict";
    ...
    63514: (e, a, t) => {
      ...
      r.keys = () => Object.keys(i), r.id = 63514, e.exports = r
    },
    63839: e => {
      "use strict";
    ...
    79867: (e, a, t) => {
      ...
      const o = {
        ...
        d = () => {
          ...
          const {
            location: a
          } = window, t = a.hostname.substring(0, a.hostname.indexOf(".rockstargames.com")), i = c.findIndex(a => Object.entries(a.sites).findIndex(([a, i]) => i === t && (e = {
            site: a,
            subDomain: i
          }, !0)) >= 0), s = c[i >= 0 ? i : 0], o = c.find(e => e.id === s.fallbackEnvironment);
          return e || (e = {
            site: "www",
            subDomain: "local"
          }), n()(r()({}, o, {
    ...
    86751: (e, a, t) => {
      ...
      r.keys = function() {
        return Object.keys(i)
      }, r.resolve = s, e.exports = r, r.id = 86751
    },
    88613: (e, a, t) => {
      "use strict";
      t.d(a, {
      ...
      const l = (e, a) => {
        ...
        g = () => {
          ...
          const n = `rockstarweb_lang.${a.cookieIdentifier}`,
            o = m(n);
          s = a.currentSite?.site === d.C.www ? p.find(e => e.subdomaincom === i) || p.find(e => e.subdomaincom === t) || r : p.find(e => e.iso === o) || r;
          const [, c] = ((e, a, t = !1) => {
            const i = m(e);
            return i && !t || l(e, a), [i, (r = e, e => {
              l(r, e)
            })];
            var r
          })(n, s.iso);
    ...
    94375: (e, a, t) => {
      ...
      r.keys = () => Object.keys(i), r.id = 94375, e.exports = r
    },
    94819: (e, a, t) => {
      var i = {
        "./de": [17894, 5259],
      ...
      r.keys = () => Object.keys(i), r.id = 94819, e.exports = r
    },
    95732: e => {
      "use strict";
      e.exports = "https://media-rockstargames-com.akamaized.net/mfe6/prod/__common/img/6205f3bd39adb33d23221501f6506dc5.jpg"
