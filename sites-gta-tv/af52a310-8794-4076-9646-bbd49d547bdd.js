! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "af52a310-8794-4076-9646-bbd49d547bdd", e._sentryDebugIdIdentifier = "sentry-dbid-af52a310-8794-4076-9646-bbd49d547bdd")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [8391], {
    2982: (e, t, r) => {
      Object.defineProperty(t, "__esModule", {
        ...
        var d = (0, n.CanonicalizeLocaleList)(t),
          ...
          v = (0, n.CoerceOptionsToObject)(r),
          _ = (0, n.GetOption)(v, "localeMatcher", "string", ["best fit", "lookup"], "best fit");
        y.localeMatcher = _;
        var b = (0, n.GetOption)(v, "numberingSystem", "string", void 0, void 0);
        if (void 0 !== b && !a.test(b)) throw new RangeError("Invalid numbering system ".concat(b));
        y.nu = b;
        var m = (0, o.ResolveLocale)(c, d, y, s, u, f),
          h = m.locale,
          w = m.nu;
        p.locale = h, p.style = (0, n.GetOption)(v, "style", "string", ["long", "narrow", "short"], "long"), p.numeric = (0, n.GetOption)(v, "numeric", "string", ["always", "auto"], "always");
    ...
    9441: (e, t, r) => {
      Object.defineProperty(t, "__esModule", {
        ...
        var c = (0, o.SingularRelativeTimeUnit)(r),
          ...
          y = s.numberFormat,
          v = c;
        "short" === f ? v = "".concat(c, "-short") : "narrow" === f && (v = "".concat(c, "-narrow")), v in u || (v = c);
        var _ = u[v];
        if ("auto" === p && (0, n.ToString)(t) in _) return [{
          type: "literal",
          value: _[(0, n.ToString)(t)]
        }];
        var b = "future";
    ...
    6284: (e, t, r) => {
      ...
      var n = r(8362).__importDefault(r(4533));
