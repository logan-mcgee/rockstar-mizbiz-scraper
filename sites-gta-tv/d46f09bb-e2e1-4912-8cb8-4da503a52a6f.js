! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "d46f09bb-e2e1-4912-8cb8-4da503a52a6f", e._sentryDebugIdIdentifier = "sentry-dbid-d46f09bb-e2e1-4912-8cb8-4da503a52a6f")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [1004], {
    ...
    1133: (e, t, a) => {
      ...
      s.keys = () => Object.keys(i), s.id = 1133, e.exports = s
    },
    1157: e => {
      "use strict";
    ...
    2723: (e, t, a) => {
      ...
      const c = (e, t) => {
        ...
        p = () => {
          ...
          const r = `rockstarweb_lang.${t.cookieIdentifier}`,
            l = d(r);
          n = t.currentSite?.site === o.C.www ? u.find((e => e.subdomaincom === i)) || u.find((e => e.subdomaincom === a)) || s : u.find((e => e.iso === l)) || s;
          const [m, p] = function(e, t) {
            let a = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const i = d(e);
            return i && !a || c(e, t), [i, (s = e, e => {
              c(s, e)
            })];
            var s
          }(r, n.iso);
      ...
      const E = e => {
          ...
          return (0, k.jsx)("div", {
            ...
            className: [G.img, c ? G.startAnimation : "", t ? G.wide : ""].join(" ")
          })
        },
        R = {
