try {
  let n = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new n.Error).stack;
  t && (n._sentryDebugIds = n._sentryDebugIds || {}, n._sentryDebugIds[t] = "1a1c3bc3-d49d-4f8b-9ba5-4f3a0daf3cc5", n._sentryDebugIdIdentifier = "sentry-dbid-1a1c3bc3-d49d-4f8b-9ba5-4f3a0daf3cc5")
} catch (n) {} {
  let n = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
          ...
          var pr = Zt({
            ...
            vr = function n(t) {
              ...
              function au(n, t) {
                ...
                for (; ++r < e;) {
                  var u = Ti(t[r]);
                  if ("__proto__" === u && !Wn.call(n, "__proto__")) return !1;
                  if (("constructor" === u || "prototype" === u) && r < e - 1) return !1
                }
                var i = Ai(n, t);
                return null == i || delete i[Ti(Gi(t))]
              }
              ...
              return Dr.after = function(n, t) {
                ...
                r && gi(n, t, r) && (t = u), n = df(n), t = xf({}, t, e, Yu);
                var i = xf({}, t.imports, e.imports, Yu),
                  o = Sf(i),
                  f = Jt(i, o);
                It(o, function(n) {
                  if (ln.test(n)) throw new xn("Invalid `imports` option passed into `_.template`")
                });
                var a, c, l = 0,
                  s = t.interpolate || wn,
                  h = "__p += '",
                ...
                n.replace(p, function(t, r, e, u, i, o) {
                  return e || (e = u), h += n.slice(l, o).replace(mn, er), r && (a = !0, h += "' +\n__e(" + r + ") +\n'"), i && (c = !0, h += "';\n" + i + ";\n__p += '"), e && (h += "' +\n((__t = (" + e + ")) == null ? '' : __t) +\n'"), l = o + t.length, t
                }), h += "';\n";
                var _ = Wn.call(t, "variable") && t.variable;
                if (_) {
                  if (ln.test(_)) throw new xn("Invalid `variable` option passed into `_.template`")
                } else h = "with (obj) {\n" + h + "\n}\n";
                h = (c ? h.replace(F, "") : h).replace(P, "$1").replace(q, "$1;"), h = "function(" + (_ || "obj") + ") {\n" + (_ ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (a ? ", __e = _.escape" : "") + (c ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + h + "return __p\n}";
                var g = Qf(function() {
                  return jn(o, v + "return " + h).apply(u, f)
                });
                ...
                chain: !1
              }), Dr.VERSION = "4.18.1", It(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], function(n) {
                Dr[n].placeholder = Dr
