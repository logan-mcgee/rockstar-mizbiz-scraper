! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "62dacd5d-f379-4269-9a88-70b9f459dea1", e._sentryDebugIdIdentifier = "sentry-dbid-62dacd5d-f379-4269-9a88-70b9f459dea1")
  } catch (e) {}
}();
  ...
  [7265], {
    7265: (e, a, s) => {
      ...
      const u = (0, i.withTranslations)((e => {
          ...
          const [t, o] = (0, r.useState)(null), u = (0, r.useRef)(), m = (0, r.useRef)(), _ = (0, r.useRef)(), [p] = (0, i.useMutation)(c.ContactUs), [f, b] = (0, r.useState)(""), [h, k] = (0, r.useState)(!0);
          if (!a) return null;
          let g = null;
          return g = l(), (0, d.jsx)(g, {
            disabled: !a,
                  ...
                  children: [(0, d.jsx)("h1", {
                    ...
                    onSubmit: e => (async e => {
                      ...
                      try {
                        b(""), await p({
                          variables: a
                        }), b("Your message has been received."), k(!1)
                      } catch ({
                        graphQLErrors: e
                      }) {
      ...
      const h = (0, b.defineMessages)({
        ...
        v = (y = e => {
          ...
          const u = (0, r.useRef)(null),
            ...
            f = /^#/.test(s),
            g = c?.target ?? (t ? "_blank" : "_self"),
            {
              ...v
            } = c;
          let y = "";
          if ("aria-label" in v && v["aria-label"] && (y = "_blank" === g ? `${v["aria-label"]} ${m.formatMessage(h.aria_label_open_new_window)}` : v["aria-label"]), (0, r.useEffect)((() => {
            ...
            return (0, d.jsxs)("a", {
              ...
              "aria-label": y,
              ref: u,
              children: [a, "_blank" === g && !y && (0, d.jsx)("span", {
                className: k,
      ...
      const A = {
        ...
        P = () => {
          const [e, a] = (0, r.useState)("companyName"), [s, n] = (0, r.useState)("department"), [t, o] = (0, r.useState)(null), [l, c] = (0, r.useState)(null), [u, m] = (0, r.useState)(null), [p, f] = (0, r.useState)(null), [b, h] = (0, r.useState)(!0), {
            refetch: k
          } = (0, i.useQuery)(D.OpeningsData, {
            skip: !0
          }), [g] = (0, _.useSearchParams)(), y = g.get("q"), x = (0, r.useRef)(), j = (0, _.useNavigate)(), w = g.get("department"), N = g.get("q"), R = e => {
          ...
          return (0, r.useEffect)((() => {
            ...
            l && o((e => {
              ...
              return (0, d.jsx)("div", {
                className: [A.heirarchy, i ? A.heirarchyRendered : ""].join(" "),
                children: F({
                  key: s,
                  positions: a
                }).map((e => {
            ...
            children: [p || "", !p && b ? "Searching..." : "", p || b || !l || !w && !N ? "" : (0, d.jsxs)("p", {
              className: A.searchHeader,
              children: [`${l.length} positions found ${N?` matching "${N}"`:""}${w?` in the ${w} department`:""}.`, (0, d.jsx)(v, {
                to: "./",
                children: (0, d.jsx)("button", {
              ...
              children: [!b && (0, d.jsx)("form", {
                onSubmit: e => (e => {
                  ...
                  document.activeElement.blur(), j(s)
                })(e),
                children: (0, d.jsx)("input", {
                  placeholder: "Search",
                  ref: x,
      ...
      var O = s(549);
      const M = "rockstargames-sites-careersb6989a5f80571f3520ddd9a4b38be7dd",
        ...
        U = "rockstargames-sites-careersd18e91b47575286953c9ebc9d8235ce2",
        Y = e => {
          let {
            label: a,
            clarification: s,
      ...
      const se = "rockstargames-sites-careersebcbfd45730eb5d64a7d824a18595f39",
        ...
        re = () => {
          const [e, a] = (0, r.useState)(null), [s, t] = (0, r.useState)({}), [o, l] = (0, r.useState)(!1), [c, u] = (0, r.useState)(!1), [m, _] = (0, r.useState)(""), [p, f] = (0, r.useState)(!1), [b, h] = (0, r.useState)(!1), [k, g] = (0, r.useState)(!1), {
            data: v
          } = (0, i.useQuery)(ae.greenhouseData), [y] = (0, i.useMutation)(ae.AddProspect), x = n => {
            let {
              key: i,
              value: t
            } = n;
