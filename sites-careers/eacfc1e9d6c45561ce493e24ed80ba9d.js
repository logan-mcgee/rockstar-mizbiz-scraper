! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "b2b98cca-69d8-4d00-9be3-aab6d51fdfcf", e._sentryDebugIdIdentifier = "sentry-dbid-b2b98cca-69d8-4d00-9be3-aab6d51fdfcf")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [300], {
    30300: (e, t, n) => {
      ...
      function z() {
        return j = H > 0 ? V($, --H) : 0, T--, 10 === j && (T = 1, L--), j
      }

      function U() {
        return j = H < A ? V($, H++) : 0, T++, 10 === j && (T = 1, L++), j
      }
      ...
      Ft.addEventListener && Ft.removeEventListener && (Ft.addEventListener("p", yt, Dt), Ft.removeEventListener("p", yt, !1));
      var Lt = Rt;
                ...
                i = function(e) {
                  ...
                  switch (o) {
                    ...
                    case "bottom":
                      ...
                      if (x >= h && !a) return i && kt(u, I, M), {
                        placement: "bottom",
                        maxHeight: t
                      };
                      if (!a && x >= r || a && C >= r) return i && kt(u, I, M), {
                        placement: "bottom",
                        maxHeight: a ? C - y : x - y
                      };
                      if ("auto" === o || a) {
                    ...
                    case "top":
                      ...
                      if (S >= h && !a) return i && kt(u, E, M), {
                        placement: "top",
                        maxHeight: t
                      };
                      if (!a && S >= r || a && w >= r) {
                        var P = t;
                        return (!a && S >= r || a && w >= r) && (P = a ? w - O : S - O), i && kt(u, E, M), {
                          placement: "top",
                          maxHeight: P
                        }
                      }
      ...
      for (var mn = {
          ...
          var t = e.ariaSelection,
            ...
            P = (0, d.useMemo)((function() {
              ...
              return e
            }), [S, n, r, m, v, g, b, I, s, w, V]),
            R = Ye(d.Fragment, null, Ye("span", {
              id: "aria-selection"
            }, E), Ye("span", {
              id: "aria-focused"
            }, M), Ye("span", {
            ...
            var t = e.isEnabled,
              ...
              a = (0, d.useCallback)((function(e) {
                if (jn) {
                  ...
                  t && Hn() && (t.addEventListener("touchmove", Ln, _n), e && (e.addEventListener("touchstart", An, _n), e.addEventListener("touchmove", Tn, _n))), $n += 1
                }
              }), [r]),
              s = (0, d.useCallback)((function(e) {
                if (jn) {
                  ...
                  $n = Math.max($n - 1, 0), r && $n < 1 && Dn.forEach((function(e) {
                    var t = o.current[e];
                    n && (n[e] = t)
                  })), t && Hn() && (t.removeEventListener("touchmove", Ln, _n), e && (e.removeEventListener("touchstart", An, _n), e.removeEventListener("touchmove", Tn, _n)))
                }
              }), [r]);
            return (0, d.useEffect)((function() {
                if (t) {
          ...
          return t = a, n = [{
            ...
            value: function() {
              ...
              var L = {
                ...
                T = d.createElement(Bt, (0, h.c)({}, c, L), (function(t) {
                  var n = t.ref,
                    r = t.placerProps,
                    a = r.placement,
                    s = r.maxHeight;
                  return d.createElement(o, (0, h.c)({}, c, L, {
                    innerRef: n,
                    innerProps: {
      ...
      var pr = (0, d.forwardRef)((function(e, t) {
          var n = f(e);
          return d.createElement(dr, (0, h.c)({
            ref: t
          }, n))
        })),
        fr = function(e) {
