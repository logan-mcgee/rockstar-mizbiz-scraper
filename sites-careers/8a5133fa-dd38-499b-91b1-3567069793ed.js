try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    n = (new e.Error).stack;
  n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "8a5133fa-dd38-499b-91b1-3567069793ed", e._sentryDebugIdIdentifier = "sentry-dbid-8a5133fa-dd38-499b-91b1-3567069793ed")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    951(e, n, r) {
      ...
      T.absoluteValue = T.abs = function() {
        ...
        var e = this,
          ...
          t = n.precision,
          i = n.rounding;
        return -1 !== r ? 0 === r ? e.isNeg() ? L(n, t, i) : new n(0) : new n(NaN) : e.isZero() ? L(n, t + 4, i).times(.5) : (n.precision = t + 6, n.rounding = 1, e = new n(1).minus(e).div(e.plus(1)).sqrt().atan(), n.precision = t, n.rounding = i, e.times(2))
        ...
        if (c.isFinite()) {
          ...
          if (c.abs().eq(1) && f + 4 <= x) return (o = L(l, f + 4, d).times(.25)).s = c.s, o
        } else {
          if (!c.s) return new l(NaN);
          if (f + 4 <= x) return (o = L(l, f + 4, d).times(.5)).s = c.s, o
        }
        ...
        if (n)
          if (r.length > 1) u = !0;
            ...
            u = 1 !== i
          } if (g = !1, o = G(c, s = f + 5), t = n ? R(l, s + 10) : G(e, s), M((a = B(o, t, s, 1)).d, i = f, d))
          do {
            if (o = G(c, s += 10), t = n ? R(l, s + 10) : G(e, s), a = B(o, t, s, 1), !u) {
        ...
        for (; 0 === c[--o];) c.pop();
        for (; 0 === c[0]; c.shift()) --r;
        return c[0] ? (e.d = c, e.e = j(c, r), g ? P(e, s, a) : e) : new p(3 === a ? -0 : 0)
        ...
        return r.d ? (n = _(r.d), e && r.e + 1 > n && (n = r.e + 1)) : n = NaN, n
      }, T.round = function() {
        var e = this,
          n = e.constructor;
        ...
        for (; !u[--o];) u.pop();
        return n ? ++r : u.shift(), e.d = u, e.e = j(u, r), g ? P(e, f.precision, f.rounding) : e
        ...
        var n, r, t, i, u, o, s, a, c, l, f, d, m = this,
          ...
          v = m.constructor;
        if (!h) return new v(m);
        if (c = r = new v(1), t = a = new v(0), o = (u = (n = new v(t)).e = _(h) - m.e - 1) % 7, n.d[0] = w(10, o < 0 ? 7 + o : o), null == e) e = u > 0 ? n : c;
        else {
      ...
      var B = function() {
        ...
        return function(t, i, o, s, a, c) {
          var l, f, d, g, m, p, h, v, y, w, b, F, E, N, S, x, T, A, I, M, O = t.constructor,
            ...
            k = t.d,
            j = i.d;
          if (!(k && k[0] && j && j[0])) return new O(t.s && i.s && (k ? !j || k[0] != j[0] : j) ? k && 0 == k[0] || !j ? 0 * B : B / 0 : NaN);
          for (c ? (m = 1, f = t.e - i.e) : (c = C, m = 7, f = D(t.e / m) - D(i.e / m)), I = j.length, T = k.length, w = (y = new O(B)).d = [], d = 0; j[d] == (k[d] || 0); d++);
          if (j[d] > (k[d] || 0) && f--, null == o ? (N = o = O.precision, s = O.rounding) : N = a ? o + (t.e - i.e) + 1 : o, N < 0) w.push(1), p = !0;
          else {
            if (N = N / m + 2 | 0, d = 0, 1 == I) {
              for (g = 0, j = j[0], N++;
                (d < T || g) && N--; d++) S = g * c + (k[d] || 0), w[d] = S / j | 0, g = S % j | 0;
              p = g || d < T
            } else {
              for ((g = c / (j[0] + 1) | 0) > 1 && (j = e(j, g, c), k = e(k, g, c), I = j.length, T = k.length), x = I, F = (b = k.slice(0, I)).length; F < I;) b[F++] = 0;
              (M = j.slice()).unshift(0), A = j[0], j[1] >= c / 2 && ++A;
              do {
                g = 0, (l = n(j, b, I, F)) < 0 ? (E = b[0], I != F && (E = E * c + (b[1] || 0)), (g = E / A | 0) > 1 ? (g >= c && (g = c - 1), 1 == (l = n(h = e(j, g, c), b, v = h.length, F = b.length)) && (g--, r(h, I < v ? M : j, v, c))) : (0 == g && (l = g = 1), h = j.slice()), (v = h.length) < F && h.unshift(0), r(b, h, F, c), -1 == l && (l = n(j, b, I, F = b.length)) < 1 && (g++, r(b, I < F ? M : j, F, c)), F = b.length) : 0 === l && (g++, b = [0]), w[d++] = g, l && b[0] ? b[F++] = k[x] || 0 : (b = [k[x]], F = 1)
      ...
      function H(e, n) {
        ...
        for (a += t = Math.log(w(2, f)) / Math.LN10 * 2 + 5 | 0, r = u = o = new d(1), d.precision = a;;) {
          if (u = P(u.times(e), a, 1), r = r.times(++l), A((s = o.plus(B(u, r, a, 1))).d).slice(0, a) === A(o.d).slice(0, a)) {
            ...
            if (!(c < 3 && M(o.d, a - t, m, c))) return P(o, d.precision = p, m, g = !0);
      ...
      function G(e, n) {
        ...
        if (null == n ? (g = !1, l = D) : l = n, v.precision = l += 10, t = (r = A(h)).charAt(0), !(Math.abs(u = p.e) < 15e14)) return c = R(v, l + 2, D).times(u + ""), p = G(new v(t + "." + r.slice(1)), l - 10).plus(c), v.precision = D, null == n ? P(p, D, y, g = !0) : p;
        ...
        for (u = p.e, t > 1 ? (p = new v("0." + r), u++) : p = new v(t + "." + r.slice(1)), f = p, a = o = p = B(p.minus(1), p.plus(1), l, 1), d = P(p.times(p), l, 1), i = 3;;) {
          if (o = P(o.times(d), l, 1), A((c = a.plus(B(o, new v(i), l, 1))).d).slice(0, l) === A(a.d).slice(0, l)) {
            if (a = a.times(2), 0 !== u && (a = a.plus(R(v, l + 2, D).times(u + ""))), a = B(a, new v(m), l, 1), null != n) return v.precision = D, a;
            if (!M(a.d, l - 10, y, s)) return P(a, v.precision = D, y, g = !0);
          ...
          case "unit":
            ...
            if (S = void 0, B) S = pr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[M][O]);
              ...
              var P = M.split("-per-"),
                ...
                j = P[1];
              B = n.units.simple[k];
              var R = pr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[k][O]),
                L = n.units.simple[j].perUnit[O];
              if (L) S = L.replace("{0}", R);
              else {
                var _ = n.units.compound.per[O],
                  q = pr(r, 1, n.units.simple[j][O]);
                S = S = _.replace("{0}", R).replace("{1}", q.replace("{0}", ""))
              }
            }
            T = [];
      ...
      function xr(e, n, r, t, i) {
        ...
        var f = Rn(n, "roundingMode", "string", ["ceil", "floor", "expand", "trunc", "halfCeil", "halfFloor", "halfExpand", "halfTrunc", "halfEven"], "halfExpand"),
          d = Rn(n, "roundingPriority", "string", ["auto", "morePrecision", "lessPrecision"], "auto"),
          g = Rn(n, "trailingZeroDisplay", "string", ["auto", "stripIfInteger"], "auto");
        1 !== l && (t = r), e.roundingIncrement = l, e.roundingMode = f, e.trailingZeroDisplay = g;
        var m = void 0 !== a || void 0 !== c,
          p = void 0 !== o || void 0 !== s,
          h = !0,
          v = !0;
        if ("auto" === d && (h = m, (m || !p && "compact" === i) && (v = !1)), h && (m ? (e.minimumSignificantDigits = kn(a, 1, 21, 1), e.maximumSignificantDigits = kn(c, e.minimumSignificantDigits, 21, 21)) : (e.minimumSignificantDigits = 1, e.maximumSignificantDigits = 21)), v)
          if (p) {
            if (o = kn(o, 0, 100, void 0), s = kn(s, 0, 100, void 0), void 0 === o) en(void 0 !== s, "maximumFractionDigits must be defined"), o = Math.min(r, s);
      ...
      function Tr(e, n) {
        ...
        var r = Rn(n, "style", "string", ["decimal", "percent", "currency", "unit"], "decimal");
        e.style = r;
        var t = Rn(n, "currency", "string", void 0, void 0);
        en(void 0 === t || Wn(t), "Malformed currency code", RangeError), en("currency" !== r || void 0 !== t, "currency cannot be undefined", TypeError);
        var i = Rn(n, "currencyDisplay", "string", ["code", "symbol", "narrowSymbol", "name"], "symbol"),
          u = Rn(n, "currencySign", "string", ["standard", "accounting"], "standard"),
          o = Rn(n, "unit", "string", void 0, void 0);
        ...
        var s = Rn(n, "unitDisplay", "string", ["short", "narrow", "long"], "short");
      ...
      function Ar(e, n, r, i) {
        var u = i.getInternalSlots,
          ...
          m = Rn(d, "localeMatcher", "string", ["lookup", "best fit"], "best fit");
        g.localeMatcher = m;
        var p = Rn(d, "numberingSystem", "string", void 0, void 0);
        ...
        var D, w, b = y.style,
          F = Rn(d, "notation", "string", ["standard", "scientific", "engineering", "compact"], "standard");
        ...
        xr(y, d, D, w, F);
        var N = Rn(d, "compactDisplay", "string", ["short", "long"], "short"),
          C = "auto";
        "compact" === F && (y.compactDisplay = N, C = "min2");
        var S = _n(d, "useGrouping", ["min2", "auto", "always"], "always", !1, C);
        y.useGrouping = S;
        var x = Rn(d, "signDisplay", "string", ["auto", "never", "always", "exceptZero", "negative"], "auto");
      ...
      function Mr(e, n, r) {
        return void 0 !== r && Rn(r = ln(r), "localeMatcher", "string", ["lookup", "best fit"], "best fit"), (0, Cr.LookupSupportedLocales)(Array.from(e), n)
      }
