! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "ee390727-a4d7-4674-83e0-5cf374cb8e98", e._sentryDebugIdIdentifier = "sentry-dbid-ee390727-a4d7-4674-83e0-5cf374cb8e98")
  } catch (e) {}
}();
    ...
    77100: (e, t, a) => {
      ...
      class Xt extends At {
        constructor(e, t, a, r) {
          ...
          !0 !== b || s || (Bt = this, n.killTweensOf(S), Bt = 0), Oe(N, this, a), t.reversed && this.reverse(), t.paused && this.paused(!0), (h || !_ && !v && this._start === de(N._time) && M(h) && Te(this) && "nested" !== N.data) && (this._tTime = -1e-8, this.render(Math.max(0, -p) || 0)), y && ze(this, y)
        }
        render(e, t, a) {
    ...
    77444: (e, t, a) => {
      ...
      const v = {
        ...
        N = e => {
          ...
          return (0, o.useEffect)((() => {
            const e = "audio",
              t = t => {
                t?.data?.rockstarAudioPlayerPlayTrackId && (c(t.data.rockstarAudioPlayerPlayTrackId), T(!1), _(!0)), f && t?.data?.attentionBlurredElsewhere && t?.data?.from !== e && _(!1)
              };
      ...
      const ot = function(e) {
        ...
        dt = ot((e => {
          ...
          const {
            track: _
          } = (0, $.useGtmTrack)(), p = (0, o.useRef)(null), h = (0, o.useRef)(null), k = (0, o.useRef)(null), [b, v] = (0, o.useState)(null), [x, y] = (0, o.useState)(!1), [w, N] = (0, o.useState)(null), [S, j] = (0, o.useState)(), [T, C] = (0, o.useState)(), {
            ref: I,
            inView: E
          } = (0, W.cD)({
            threshold: .6
      ...
      const Na = e => {
        ...
        Ca = "rockstargames-sites-careersc4aa8e5d29b433c400796d0c493a9a4d",
        Ma = e => {
          let {
            minOffset: t = 0,
            maxOffset: a = 0,
      ...
      var za = a(92104);
      const Aa = (0, k.makeVarNamespace)("@rockstargames/components/profile-switcher"),
        Da = Aa("languageSelectorOpenedReactive", !1),
        Ba = e => Da(e),
        Ra = Aa("activeSubNavIdReactive", -1),
        Fa = e => Ra(e),
        Va = Aa("subNavExtraHeightReactive", -1),
        $a = e => Va(e),
        Ua = Aa("scNavOpenedReactive", !0),
        Ga = e => Ua(e),
        Ha = Aa("charListHiddenReactive", !0),
        qa = e => Ha(e),
        Wa = () => {
          const e = (0, k.useReactiveVar)(Da),
            t = (0, k.useReactiveVar)(Ra),
            a = (0, k.useReactiveVar)(Va),
            s = (0, k.useReactiveVar)(Ua),
            r = (0, k.useReactiveVar)(Ha);
          return (0, o.useEffect)((() => {
            r || (e && Ba(!1), s && (Ga(!1), Fa(-1)))
          }), [r]), (0, o.useEffect)((() => {
            !e && r && (s || Ga(!0))
          }), [e, r]), (0, o.useMemo)((() => ({
            languageSelectorOpened: e,
            setLanguageSelectorOpened: Ba,
            activeSubNavId: t,
            setActiveSubNavId: Fa,
            subNavExtraHeight: a,
            setSubNavExtraHeight: $a,
            scNavOpened: s,
            setScNavOpened: Ga,
            charListHidden: r,
            setCharListHidden: qa
          })), [e, t, a, s, r])
        };
      var Xa = a(69760),
        Ya = a.n(Xa),
      ...
      const Qa = {
        ...
        Ja = e => {
          ...
          const {
            track: _
          } = (0, $.useGtmTrack)(), p = (0, vt.c)(), h = (0, l.useIntl)();
          let k = s;
          ...
          return (0, g.jsxs)(u.Link, {
            ...
            children: [t, o && (0, g.jsx)("div", {
              ...
              children: (0, g.jsx)("span", {
                ...
                children: h.formatMessage(La.nofications_new)
              })
            })]
          })
        },
        ...
        ts = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            children: [(0, g.jsx)("nav", {
              ...
              children: (0, g.jsx)(Ka.LanguageSelector, {
                theme: "sc-menu",
                languageSelectorOpened: i,
        ...
        rs = e => {
          ...
          const {
            ...
            track: i
          } = (0, $.useGtmTrack)(), n = (0, l.useIntl)(), [c, d] = (0, o.useState)([]), [m, u] = (0, o.useState)(null), [f, _] = (0, o.useState)(null), [p, h] = (0, o.useState)(!1), [k, b] = (0, o.useState)(-1), [v, x] = (0, o.useState)([]), [y, w] = (0, o.useState)(0), N = a(71084), [S, j] = (0, o.useState)("0"), [T, C] = (0, o.useState)("0"), M = e => parseInt(e, 10).toLocaleString("en-US", {
        ...
        os = (0, V.withTranslations)((e => {
          ...
          const {
            ...
            scNavOpened: N,
            setScNavOpened: S
          } = Wa(), [j, T] = (0, o.useState)(""), C = (0, u.useLocation)(), {
            lsSettings: M
          ...
          return (0, o.useEffect)((() => {
            ...
            de.currentSite?.site === vt.U.socialClub && (e = encodeURIComponent("/")), T(e)
          }), [C]), (0, o.useEffect)((() => {
            ne(L.characters[O] ?? [])
          }), [L, O]), (0, o.useEffect)((() => {
            L && U(L)
        ...
        ds = (0, l.withIntl)((() => {
          ...
          return (0, o.useEffect)((() => {
            ...
            n && (s && r(!1), d || B(!0))
          }), [n]), null === p ? null : (0, g.jsxs)(za.c, {
            enabled: !!b,
            removeScrollBar: !1,
            children: [(0, g.jsxs)("div", {
              className: [ls.scMenu, b ? ls.navOpen : ""].join(" "),
              "data-logged-in": p,
              "data-mac-browser": O,
              "data-scroll-mode": u,
              ref: M,
              ...
              className: [ls.scOverlay, b ? ls.navOpen : ""].join(" "),
              "data-logged-in": p
            })]
          })
        }), d),
        ...
        fs = (0, l.withIntl)((e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            "data-img-set": k,
            "aria-label": a.formatMessage(n ? La.sc_menu_close : La.sc_menu_open),
            "aria-expanded": n,
            type: "button",
            onClick: y,
