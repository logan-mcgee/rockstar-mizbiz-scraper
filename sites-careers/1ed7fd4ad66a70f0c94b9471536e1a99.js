! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "1f01cc61-7907-47cb-a83e-8f46238e9b59", e._sentryDebugIdIdentifier = "sentry-dbid-1f01cc61-7907-47cb-a83e-8f46238e9b59")
  } catch (e) {}
}();
  ...
  [78, 584], {
    79584: (e, a, s) => {
      ...
      var n = s(45052),
        ...
        c = s(53592);
      const l = (e, a) => {
          e && a ? document.cookie = `${e}=${a}; domain=${d()}; path=/;` : console.log(`Couldn't set cookie (${e}) to value (${a})`)
        },
        d = () => {
        ...
        f = () => {
          const {
            ...
            return -1 !== a.indexOf(s[n]) ? s[n] : null
          })(e), n = (e => {
            const a = e.search.substring(1).split("&").find((e => e.startsWith("lang")));
            return a?.split("=")[1]
          })(e), i = p, [t, r] = function(e, a) {
            let s = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const n = document.cookie.split("; "),
              i = `${e}=`,
              t = n.find((e => e.startsWith(i))),
              r = t?.substring(i.length, t.length);
            return r && !s || l(e, a), [r, (o = e, e => {
              l(o, e)
            })];
            var o
          }(`rockstarweb_lang.${a.cookieIdentifier}`, s ?? void 0);
          let o = i;
          return o = a.currentSite?.site === c.U.www ? u.find((e => e.subdomaincom === n)) || u.find((e => e.subdomaincom === s)) || i : u.find((e => e.iso === t)) || i, [o, r]
        };
      var h = s(95240);
      const b = e => {
        let {
    ...
    53592: (e, a, s) => {
      ...
      const n = {
        ...
        t = () => {
          ...
          const {
            location: a
          } = window, s = a.hostname.substring(0, a.hostname.indexOf(".rockstargames.com")), n = i.findIndex((a => Object.entries(a.sites).findIndex((a => {
            let [n, i] = a;
            return i === s && (e = {
              site: n,
              subDomain: i
    ...
    82078: (e, a, s) => {
      ...
      const L = "rockstargames-sites-careersd609da80d38334b92bc11246a08e7e4d",
        ...
        $ = "rockstargames-sites-careersd7320ade289756fc8512a8cb4fd1e271",
        M = "rockstargames-sites-careerseb5fe5fd94a29526f4335437ca1b9cc9",
      ...
      const B = e => {
        ...
        W = "rockstargames-sites-careersd5506aa3a5b4592eb47ac7c0a60fedcc",
        Y = e => {
          let {
            label: a,
            seasonsData: s,
      ...
      const Z = "rockstargames-sites-careerscc195f280984da7e156baea83a20e7dc",
        K = () => (0, m.jsxs)(m.Fragment, {
          children: [(0, m.jsx)(V, {}), (0, m.jsxs)("div", {
        ...
        ae = () => {
          const [e, a] = (0, r.useState)(null), [s, i] = (0, r.useState)({}), [t, o] = (0, r.useState)(!1), [c, d] = (0, r.useState)(!1), [u, p] = (0, r.useState)(""), [f, h] = (0, r.useState)(!1), [b, k] = (0, r.useState)(!1), [v, g] = (0, r.useState)(!1), {
            data: y
          } = (0, l.useQuery)(Q.greenhouseData), [j] = (0, l.useMutation)(Q.AddProspect), x = n => {
            let {
              key: i,
              value: t
            } = n;
      ...
      se = () => {
        const [e, a] = (0, r.useState)("companyName"), [s, n] = (0, r.useState)("department"), [i, t] = (0, r.useState)(null), [o, c] = (0, r.useState)(null), [d, u] = (0, r.useState)(null), [p, h] = (0, r.useState)(null), [b, v] = (0, r.useState)(!0), {
          refetch: g
        } = (0, l.useQuery)(E.OpeningsData, {
          skip: !0
        }), [y] = (0, f.useSearchParams)(), j = y.get("q"), x = (0, r.useRef)(), N = (0, f.useNavigate)(), _ = y.get("department"), S = y.get("q"), C = e => {
          ...
          children: [p || "", !p && b ? "Searching..." : "", p || b || !o || !_ && !S ? "" : (0, m.jsxs)("p", {
            ...
            children: [!b && (0, m.jsx)("form", {
              onSubmit: e => (e => {
                ...
                document.activeElement.blur(), N(s)
              })(e),
              children: (0, m.jsx)("input", {
                placeholder: "Search",
                ref: x,
...
//# sourceMappingURL=1ed7fd4ad66a70f0c94b9471536e1a99.js.map