! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "cbd20dc2-9f0f-4512-b150-0e356d54f30b", e._sentryDebugIdIdentifier = "sentry-dbid-cbd20dc2-9f0f-4512-b150-0e356d54f30b")
  } catch (e) {}
}();
  ...
  [852], {
    77100: (e, t, a) => {
      ...
      let s, r, i, n, c, o, l, d, m, u, g, f = {
        ...
        yt = function() {
          ...
          return s = {
            ...
            wake() {
              d && (!o && I() && (c = o = window, l = c.document || {}, F.gsap = xa, (c.gsapVersions || (c.gsapVersions = [])).push(xa.version), U($ || c.GreenSockGlobals || !c.gsap && c || {}), a = c.requestAnimationFrame, mt.forEach(ut)), e && s.sleep(), t = a || (e => setTimeout(e, h - 1e3 * s.time + 1 | 0)), g = 1, b(2))
            },
            sleep() {
      ...
      let Bt, Vt, Rt = function(e, t, a, s, r, i, n) {
        ...
        Ft = function(e, t, a, s, r, i, n, c, o, l) {
          j(s) && (s = s(r || 0, e, i));
          let d, m = e[t],
            u = "get" !== a ? a : j(m) ? o ? e[t.indexOf("set") || !j(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](o) : e[t]() : m,
            g = j(m) ? o ? Qt : Kt : Yt;
          if (N(s) && (~s.indexOf("random(") && (s = it(s)), "=" === s.charAt(1) && (d = me(u, s) + (qe(u) || 0), (d || 0 === d) && (s = d))), !l || u !== s || Vt) return isNaN(u * s) || "" === s ? (!m && !(t in e) && G(t, s), Rt.call(this, e, t, u, s, g, c || f.stringFilter, o)) : (d = new oa(this._pt, e, t, +u || 0, s - (u || 0), "boolean" == typeof m ? ta : ea, 0, g), o && (d.fp = o), n && d.modifier(n, this, e), this._pt = d)
        },
        $t = (e, t, a, s, r, i) => {
          let n, c, o, l;
          ...
          if (F && (!z || !w) && (w = "none"), e._ease = It(w, p.ease), e._yEase = L ? Ct(It(!0 === L ? w : L, p.ease)) : 0, L && e._yoyo && !e._repeat && (L = e._yEase, e._yEase = e._ease, e._ease = L), e._from = !F && !!y.runBackwards, !F || z && !y.stagger) {
            ...
            for (e._pt = e._ptCache = 0, S = O && M(S) || S && !O, c = 0; c < D.length; c++) {
              if (d = D[c], u = d._gsap || ie(D)[c]._gsap, e._ptLookup[c] = k = {}, J[u.id] && Z.length && ge(), b = V === D ? c : V.indexOf(d), g && !1 !== (f = new g).init(d, v || i, e, b, V) && (e._pt = l = new oa(e._pt, d, f.name, 0, 1, f.render, f, 0, f.priority), f._props.forEach((e => {
                ...
                for (o in i) ee[o] && (f = $t(o, i, e, b, d, V)) ? f.priority && (m = 1) : k[o] = l = Ft.call(e, d, o, "get", i[o], b, V, 0, y.stringFilter);
              e._op && e._op[c] && e.kill(d, e._op[c]), R && e._pt && (Bt = e, n.killTweensOf(d, k, e.globalTime(t)), x = !e.parent, Bt = 0), e._pt && S && (J[u.id] = 1)
            }
      ...
      let Ra, Fa, $a, Ua, Ga, Ha, qa, Wa, Xa, Ya = {},
        ...
        Ps = (e, t, a, s) => {
          let r, i, n, c, o = parseFloat(a) || 0,
            ...
            p = "px" === s,
            _ = "%" === s;
          return s === l || !o || Ls[s] || Ls[l] ? o : ("px" !== l && !p && (o = Ps(e, t, a, "px")), c = e.getCTM && Ms(e), !_ && "%" !== l || !Ya[t] && !~t.indexOf("adius") ? (d[m ? "width" : "height"] = f + (p ? l : s), i = ~t.indexOf("adius") || "em" === s && e.appendChild && !u ? e : e.parentNode, c && (i = (e.ownerSVGElement || {}).parentNode), i && i !== Fa && i.appendChild || (i = Fa.body), n = i._gsap, n && _ && n.width && m && n.time === yt.time && !n.uncache ? le(o / n.width * f) : ((_ || "%" === l) && !zs[ys(i, "display")] && (d.position = ys(e, "position")), i === e && (d.position = "static"), i.appendChild(Ga), r = Ga[g], i.removeChild(Ga), d.position = "absolute", m && _ && (n = ne(i), n.time = yt.time, n.width = i[g]), le(p ? r * o / f : r && o ? f / r * o : 0))) : (r = c ? e.getBBox()[m ? "width" : "height"] : e[g], le(_ ? o / r * f : o / 100 * r)))
        },
        Os = (e, t, a, s) => {
          let r;
          return Ua || js(), t in as && "transform" !== t && ~(t = as[t]).indexOf(",") && (t = t.split(",")[0]), Ya[t] && "transform" !== t ? (r = Ws(e, s), r = "transformOrigin" !== t ? r[t] : r.svg ? r.origin : Xs(ys(e, _s)) + " " + r.zOrigin + "px") : (r = e.style[t], (!r || "auto" === r || s || ~(r + "").indexOf("calc(")) && (r = Rs[t] && Rs[t](e, t, a) || ys(e, t) || ce(e, t) || ("opacity" === t ? 1 : 0))), a && !~(r + "").trim().indexOf(" ") ? Ps(e, t, r, a) + a : r
        },
        As = function(e, t, a, s) {
          if (!a || "none" === a) {
            let s = Ns(t, e, 1),
    ...
    65596: (e, t, a) => {
      ...
      const $ = (0, a(62748).U1)(),
        ...
        G = e => {
          ...
          const [s, r] = (0, c.useState)(!1), i = (e => {
            const [t] = (0, m.useSearchParams)(), [a, s] = (0, c.useState)(null), r = (0, F.useRockstarUser)(), {
              loggedIn: i
            } = r, {
              currentCharId: n
            } = (0, F.useRockstarUserState)(), o = (0, F.useIsUserGtaPlus)(r?.data, n);
            return (0, c.useEffect)((() => {
      ...
      const me = e => {
        ...
        ue = e => {
          ...
          const {
            track: v
          } = (0, F.useGtmTrack)(), x = (0, R.useDataLayer)(), y = r ?? t, w = (0, R.findPlatform)(p)?.friendlyName, N = (0, c.useMemo)((() => {
      ...
      const it = function(e) {
        ...
        ct = it((e => {
          ...
          const {
            track: _
          } = (0, F.useGtmTrack)(), h = (0, c.useRef)(null), k = (0, c.useRef)(null), b = (0, c.useRef)(null), [v, x] = (0, c.useState)(null), [y, w] = (0, c.useState)(!1), [N, j] = (0, c.useState)(null), [S, T] = (0, c.useState)(), [M, I] = (0, c.useState)(), {
            ref: E,
            inView: L
          } = (0, q.cD)({
            threshold: .6
          ...
          (0, c.useEffect)((() => {
            ...
            const e = () => {
              S && !(0, at.isEmpty)(S) && S?.height > 0 && S?.height !== R && $(S?.height)
            };
            return e(), window.addEventListener("resize", e), () => {
              window.removeEventListener("resize", e)
            }
      ...
      const kt = (0, o.defineMessages)({
        ...
        vt = (0, o.withIntl)((e => {
          ...
          const {
            track: i
          } = (0, F.useGtmTrack)(), n = (0, m.useLocation)(), l = (0, o.useIntl)(), [d, u] = (0, o.getLocale)(), [p, _] = (0, c.useState)(!1), h = (0, c.useMemo)((() => (0, ht.c)()), []), k = (0, c.useCallback)((e => {
            let t = n.pathname;
            const a = t.split("/");
        ...
        Ot = e => {
          ...
          }, [u, p] = (0, R.usePreloadImg)(d.default), _ = {
            default: {
      ...
      var At = a(55492),
        Dt = a.n(At);
      const Bt = (0, R.withTranslations)((e => {
          let {
            section: t = "",
            relativeTo: a = "",
            tagId: s = null,
      ...
      const Xt = (e, t) => {
        ...
        ea = e => {
          ...
          } = (0, F.useRockstarUserState)(), [_, h] = (0, c.useState)(!1), [k, b] = (0, c.useState)(d), [v, x] = (0, c.useState)(!1), y = (0, o.useIntl)(), w = !!i?.length;
          (0, c.useEffect)((() => {
            if (Array.isArray(p)) {
              const e = p?.[0];
      ...
      const Xa = {
        ...
        Ka = e => {
          ...
          const {
            track: p
          } = (0, F.useGtmTrack)(), _ = (0, ht.c)(), h = (0, o.useIntl)();
          let k = s;
        ...
        Qa = e => {
          ...
          const {
            ...
            navOpen: v
          } = (0, F.useRockstarUserState)(), x = (0, c.useRef)(null), [y, w] = (0, c.useState)(0), [N, j] = (0, c.useState)(0), [S, T] = (0, c.useState)(!0);
          return (0, c.useEffect)((() => {
            m !== t && !1 === S && T(!0), m === t && T(!1)
          }), [m]), (0, c.useEffect)((() => {
            if (!x.current) return;
        ...
        Za = e => {
          ...
          const {
            windowWidth: a,
            windowHeight: s
          } = (0, R.useWindowResize)(), r = (0, o.useIntl)(), {
            ...
            navOpen: _
          } = (0, F.useRockstarUserState)(), h = (0, R.useLocale)(), k = (0, R.toScLocaleString)(h), [b, v] = (0, c.useState)(""), x = (0, m.useLocation)(), y = `${t.login}?returnUrl=${b}&lang=${k}`, w = `${t.signup}&returnUrl=${b}&lang=${k}`, N = (0, c.useMemo)((() => (0, ht.c)()), []), j = (0, c.useMemo)((() => {
            const e = ((e, t, a) => [{
        ...
        ts = e => {
          ...
          const {
            ...
            track: i
          } = (0, F.useGtmTrack)(), n = (0, o.useIntl)(), [l, d] = (0, c.useState)([]), [m, u] = (0, c.useState)(null), [f, p] = (0, c.useState)(null), [_, h] = (0, c.useState)(!1), [k, b] = (0, c.useState)(-1), [v, x] = (0, c.useState)([]), [y, w] = (0, c.useState)(0), N = a(71084), [j, S] = (0, c.useState)("0"), [T, C] = (0, c.useState)("0"), M = e => parseInt(e, 10).toLocaleString("en-US", {
        ...
        is = (0, R.withTranslations)((e => {
          ...
          const {
            ...
            setUserData: U
          } = (0, F.useRockstarUserState)(), [G, H] = (0, c.useState)(null), [q, W] = (0, c.useState)(null), [X, Y] = (0, c.useState)(!1), [K, Q] = (0, c.useState)(!1), [Z, J] = (0, c.useState)(0), ee = (0, c.createRef)(), te = as(ee, !1), ae = (0, c.createRef)(), [se, re] = (0, c.useState)(0), [ie, ne] = (0, c.useState)([]), [ce, oe] = (0, c.useState)(244), le = (0, c.useRef)(null), de = (0, c.useMemo)((() => (0, ht.c)()), []), me = (0, c.useMemo)((() => ((e, t, a, s, r) => [{
      ...
      var ps = a(13784);
      const _s = "undefined" != typeof GameDataNewGamesDatabaseConnection ? GameDataNewGamesDatabaseConnection : ps.GameData;
      ...
      const hs = it((0, o.withIntl)((e => {
        ...
        zs = (0, c.forwardRef)(((e, t) => {
          const {
            ...
            track: n
          } = (0, F.useGtmTrack)(i), [o, l] = (0, c.useState)(t?.current);
          return (0, c.useEffect)((() => {
      ...
      const Ps = zs,
        ...
        Hs = e => {
          ...
          const {
            track: l
          } = (0, F.useGtmTrack)(), [d, m] = (0, c.useState)([tt.O4, tt.Hj, tt.eM]), [u, f] = (0, c.useState)(null), [p, _] = (0, c.useState)(null);
          return (0, c.useEffect)((() => {
      ...
      const Qs = {
        ...
        er = (0, R.withLocale)((e => {
          ...
          const {
            ...
            setBodyIsLocked: i
          } = (0, R.useBodyScrollable)("VideoCarousel"), [n, o] = (0, c.useState)(0), [l, d] = (0, c.useState)(0), m = (0, c.useRef)(null), u = (0, c.useRef)(null);
          return (0, c.useEffect)((() => {
