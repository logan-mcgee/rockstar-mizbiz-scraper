      ...
      const d = (e, o) => {
        ...
        p = () => {
          const {
            ...
            return i && !s || d(e, o), [i, (l = e, e => {
              d(l, e)
            })];
            var l
          }(`rockstarweb_lang.${o.cookieIdentifier}`, s ?? void 0);
          let l = t;
          return l = o.currentSite?.site === r.U.www ? b.find((e => e.subdomaincom === n)) || b.find((e => e.subdomaincom === s)) || t : b.find((e => e.iso === a)) || t, [l, i]
        };
      var f = s(95240);
      const w = e => {
        let {
...
//# sourceMappingURL=df6b7943a37c5e40717e2638d5665ce3.js.map