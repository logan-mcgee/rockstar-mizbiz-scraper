try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "51345c57-df01-4cf0-9cff-434f1381cdc1", e._sentryDebugIdIdentifier = "sentry-dbid-51345c57-df01-4cf0-9cff-434f1381cdc1")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const f = (e, t) => {
        ...
        h = () => {
          ...
          const i = `rockstarweb_lang.${t.cookieIdentifier}`,
            s = p(i);
          a = t.currentSite?.site === l.C.www ? b.find((e => e.subdomaincom === o)) || b.find((e => e.subdomaincom === r)) || n : b.find((e => e.iso === s)) || n;
          const [c, u] = d(i, a.iso);
          return [a, u]
        };
      var w = r(5422);
          ...
          if (o)
            for (const [n, {
              ...
              const u = "en" === t ? "" : `/${t}`,
                l = o.host.split(".");
              let f = "";
              return "www" !== n || s?.some((e => e.test(o.pathname))) ? (f += `https://${c}`, f += i ? `.${l.at(-2)}.${l.at(-1)}` : `.${l.at(-1)}`, {
                link: `${f}${u}${"/"===o.pathname?"":o.pathname}${o.search}`,
                isExternal: !0
              }) : {
        ...
        S = ({
          ...
          const o = (0, l.A)(),
            ...
            s = (e => {
              ...
              const r = t.split("/");
              return b.map((e => e.subdomaincom)).includes(r[0]) && (t = r.slice(1).join("/")), o.currentSite?.site === l.C.www ? "en" === e ? `${window.location.origin}/${t}${location.search}` : `${window.location.origin}/${e}/${t}${location.search}` : `${window.location.origin}/${t}${location.search}`
            })(a);
          t?.({
            event: "cta_other",
            link_url: s,
      ...
      function u(e, t, r, o, n, a) {
        ...
        for (var s, c = o.kind, u = "getter" === c ? "get" : "setter" === c ? "set" : "value", l = !t && e ? o.static ? e : e.prototype : null, f = t || (l ? Object.getOwnPropertyDescriptor(l, o.name) : {}), p = !1, d = r.length - 1; d >= 0; d--) {
          ...
          if ("accessor" === c) {
            ...
            (s = i(m.get)) && (f.get = s), (s = i(m.set)) && (f.set = s), (s = i(m.init)) && n.unshift(s)
          } else(s = i(m)) && ("field" === c ? n.unshift(s) : f[u] = s)
        }
