! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "88bf9db3-97ce-4394-977f-99008a78bb64", e._sentryDebugIdIdentifier = "sentry-dbid-88bf9db3-97ce-4394-977f-99008a78bb64")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [1205], {
    ...
    1205: (e, t, n) => {
      ...
      function N(e, t) {
        return M($("", null, null, "", null, null, 0), e, {
          length: -e.length
        }, t)
      }

      function z() {
        return _ = H > 0 ? k(j, --H) : 0, L--, 10 === _ && (L = 1, F--), _
      }

      function U() {
        return _ = H < T ? k(j, H++) : 0, L++, 10 === _ && (L = 1, F++), _
      }
          ...
          case 0:
            switch (b) {
              ...
              case 125:
                v = 0;
              case 59 + c:
                -1 == g && (S = E(S, /\f/g, "")), f > 0 && V(S) - d && D(f > 32 ? me(S + ";", r, n, d - 1) : me(E(S, " ", "") + ";", r, n, d - 2), u);
                break;
              case 59:
                S += ";";
              default:
      ...
      function fe(e, t, n, r, o, i, a, s, u, l, c) {
        for (var d = o - 1, p = 0 === o ? i : [""], f = R(p), h = 0, m = 0, v = 0; h < r; ++h)
          for (var g = 0, b = P(e, d + 1, d = S(m = a[h])), y = e; g < f; ++g)(y = I(m > 0 ? p[g] + " " + b : E(b, /&\f/g, p[g]))) && (u[v++] = y);
        return $(e, t, n, 0 === o ? ae : s, u, l, c)
      }

      function he(e, t, n) {
        return $(e, t, n, ie, x(_), P(e, 2, -2), 0)
      }

      function me(e, t, n, r) {
        return $(e, t, n, se, P(e, 0, r), P(e, r + 1, -1), r)
      }
      ...
      function Oe(e, t) {
        switch (function(e, t) {
          ...
          case 5187:
            return oe + e + E(e, /(\w+).+(:[^]+)/, oe + "box-$1$2" + ne + "flex-$1$2") + e;
          case 5443:
            return oe + e + ne + "flex-item-" + E(e, /flex-|-self/, "") + e;
          case 4675:
            return oe + e + ne + "flex-line-pack" + E(e, /align-content|flex-|-self/, "") + e;
          case 5548:
            return oe + e + ne + E(e, "shrink", "negative") + e;
          case 5292:
            return oe + e + ne + E(e, "basis", "preferred-size") + e;
          case 6060:
            return oe + "box-" + E(e, "-grow", "") + oe + e + ne + E(e, "grow", "positive") + e;
          case 4554:
          ...
          case 4968:
            return E(E(e, /(.+:)(flex-)?(.*)/, oe + "box-pack:$3" + ne + "flex-pack:$3"), /s.+-b[^;]+/, "justify") + oe + e + e;
          case 4095:
          case 3583:
          case 4068:
          case 2532:
          ...
          case 4765:
            if (V(e) - 1 - t > 6) switch (k(e, t + 1)) {
              case 109:
                if (45 !== k(e, t + 4)) break;
              case 102:
                return E(e, /(.+:)(.+)-([^]+)/, "$1" + oe + "$2-$3$1" + re + (108 == k(e, t + 3) ? "$3" : "$2-$3")) + e;
              case 115:
                return ~A(e, "stretch") ? Oe(E(e, "stretch", "fill-available"), t) + e : e
            }
            break;
          case 4949:
          ...
          case 6444:
            switch (k(e, V(e) - 3 - (~A(e, "!important") && 10))) {
              case 107:
                return E(e, ":", ":" + oe) + e;
              case 101:
                return E(e, /(.+:)([^;!]+)(;|!.+)?/, "$1" + oe + (45 === k(e, 14) ? "inline-" : "") + "box$3$1" + oe + "$2$3$1" + ne + "$2box$3") + e
            }
            break;
          case 5936:
            switch (k(e, t + 11)) {
              case 114:
                return oe + e + ne + E(e, /[svh]\w+-[tblr]{2}/, "tb") + e;
              case 108:
                return oe + e + ne + E(e, /[svh]\w+-[tblr]{2}/, "tb-rl") + e;
              case 45:
                return oe + e + ne + E(e, /[svh]\w+-[tblr]{2}/, "lr") + e
            }
            return oe + e + ne + e + e
        }
        return e
      ...
      var Te, He, _e = !!d.useInsertionEffect && d.useInsertionEffect,
        je = _e || function(e) {
          return e()
        },
        $e = (_e || d.useLayoutEffect, d.createContext("undefined" != typeof HTMLElement ? Ce({
          key: "css"
        }) : null)),
        Ne = $e.Provider,
        ze = function(e) {
      ...
      function It(e, t) {
        ...
        var i = [].concat(r);
        if (t && e)
          for (var a in t) t.hasOwnProperty(a) && t[a] && i.push("".concat(Mt(e, a)));
      ...
      _t.addEventListener && _t.removeEventListener && (_t.addEventListener("p", xt, Ht), _t.removeEventListener("p", xt, !1));
      var jt = Tt;
                ...
                i = function(e) {
                  ...
                  switch (o) {
                    ...
                    case "bottom":
                      ...
                      if (x >= h && !a) return i && Dt(u, M, E), {
                        placement: "bottom",
                        maxHeight: t
                      };
                      if (!a && x >= r || a && C >= r) return i && Dt(u, M, E), {
                        placement: "bottom",
                        maxHeight: a ? C - y : x - y
                      };
                      if ("auto" === o || a) {
                    ...
                    case "top":
                      ...
                      if (S >= h && !a) return i && Dt(u, I, E), {
                        placement: "top",
                        maxHeight: t
                      };
                      if (!a && S >= r || a && w >= r) {
                        var P = t;
                        return (!a && S >= r || a && w >= r) && (P = a ? w - O : S - O), i && Dt(u, I, E), {
                          placement: "top",
                          maxHeight: P
                        }
                      }
      ...
      for (var On = {
          ...
          base: "z",
          letters: "zⓩｚźẑżžẓẕƶȥɀⱬꝣ"
        }], Mn = new RegExp("[" + xn.map((function(e) {
          return e.letters
        })).join("") + "]", "g"), In = {}, En = 0; En < xn.length; En++)
        for (var An = xn[En], kn = 0; kn < An.letters.length; kn++) In[An.letters[kn]] = An.base;
      var Pn = function(e) {
            ...
            var t = e.isEnabled,
              ...
              a = (0, d.useCallback)((function(e) {
                if (Un) {
                  ...
                  t && zn() && (t.addEventListener("touchmove", jn, Wn), e && (e.addEventListener("touchstart", Nn, Wn), e.addEventListener("touchmove", $n, Wn))), Bn += 1
                }
              }), [r]),
              s = (0, d.useCallback)((function(e) {
                if (Un) {
                  ...
                  Bn = Math.max(Bn - 1, 0), r && Bn < 1 && Hn.forEach((function(e) {
                    var t = o.current[e];
                    n && (n[e] = t)
                  })), t && zn() && (t.removeEventListener("touchmove", jn, Wn), e && (e.removeEventListener("touchstart", Nn, Wn), e.removeEventListener("touchmove", $n, Wn)))
                }
              }), [r]);
            return (0, d.useEffect)((function() {
                if (t) {
        ...
        vr = function(e) {
          ...
          function n(e) {
            ...
            if (function(e, t) {
              ...
              }, r.state.instancePrefix = "react-select-" + (r.props.instanceId || ++mr), r.state.selectValue = Et(e.value), e.menuIsOpen && r.state.selectValue.length) {
