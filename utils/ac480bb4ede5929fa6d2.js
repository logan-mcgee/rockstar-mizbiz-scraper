/*! For license information please see ac480bb4ede5929fa6d2.js.LICENSE.txt */
"use strict";
(self.webpackChunk_rockstargames_utils = self.webpackChunk_rockstargames_utils || []).push([
  [585], {
    740: (e, t, r) => {
      ...
      const {
        apiHost: u
      } = (0, a.Z)(), c = (0, s.r)(document.documentElement.lang), l = {
        ...
        let {
          ...
          finalFetchOptions: n = {},
          query: a = null
        } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, s = `${u}/${e}`;
        null !== a && (s += `?${new URLSearchParams(a)}`), t && (l.Authorization = `Bearer ${t}`);
        const c = {
            headers: l
          },
          i = o().all([c, r, n]),
