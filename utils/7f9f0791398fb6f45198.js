(self.webpackChunk_rockstargames_utils = self.webpackChunk_rockstargames_utils || []).push([
  [667, 52, 342, 188, 681], {
    761: (e, t, n) => {
      ...
      const {
        apiHost: u
      } = (0, l.Z)(), m = (0, d.r)(document.documentElement.lang), g = {}, h = async function(e) {
        let {
          fetchOptions: t = {},
          finalFetchOptions: n = {},
          query: r = null,
        ...
        let f = `${u}/${e}`;
        if (null === r || c().isEmpty(r) || (f += `?${new URLSearchParams(r)}`), !d && s) return null;
        d && (h.Authorization = `Bearer ${d}`);
        const v = {
            headers: h
          },
          p = i().all([v, t, n]),
    ...
    901: (e, t, n) => {
      ...
      const r = window?.env?.sc,
        ...
        o = [(e => {
          ...
          return {
            apiHost: `https://${r?.apiHost??t}.rockstargames.com`,
            graphEnv: r?.graphEnv ?? i,
            host: r?.scHost ?? s,
            hostname: c,
            cdnBase: r?.cdnBase ?? l,
            key: d,
            login: `https://${r?.authHost??n}.rockstargames.com/connect/authorize/${r?.clientId??o}`,
            silentCheck: `https://${r?.authHost??n}.rockstargames.com/connect/cors/check/${r?.clientId??o}`,
            signup: `https://${r?.authHost??n}.rockstargames.com/create/?cid=${r?.clientId??o}`,
            gateway: `https://${a?.marketingAuthTLD??u}.rockstargames.com/auth/gateway.json`,
            logout: `https://${a?.marketingAuthTLD??u}.rockstargames.com/auth/sc-auth-logout`,
            pingBearer: `https://${a?.marketingAuthTLD??u}.rockstargames.com/auth/ping-bearer.json`
          }
        })()],
        i = () => {
    ...
    188: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, {
        setFreezeUserShouldSeeMore: () => h.rj,
        useLocale: () => o,
        ...
        const s = (0, r.useRockstarTokenPing)(),
          ...
          f = (0, i.useCallback)((async function() {
            ...
            try {
              ...
              return i?.status || h(JSON.stringify(i?.error)), l(i), m(!1), i
            } catch (e) {
              h(String(e)), m(!1)
            }
            return null
    ...
    550: (e, t, n) => {
      ...
      const i = (0, r.makeVar)(!1),
        ...
        d = e => {
          ...
          const [n, l] = (0, a.useState)(window.pageYOffset), [d, u] = (0, a.useState)(null), [m, g] = (0, a.useState)(!1), h = (0, r.useReactiveVar)(i);
          let f;
          const v = () => {
          ...
          }), [m, h]), (0, a.useMemo)((() => (0, o.jsx)(c.Provider, {
            value: {
