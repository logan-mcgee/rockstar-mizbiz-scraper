! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "9fd143c2-b089-439a-84f2-90ad415d3ad1", e._sentryDebugIdIdentifier = "sentry-dbid-9fd143c2-b089-439a-84f2-90ad415d3ad1")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [965, 509, 244, 508, 847, 50], {
    ...
    508: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, {
        setFreezeUserShouldSeeMore: () => E.U4,
        useGetPlatformLoginUrl: () => h,
        useHasReduceMotionPreference: () => v,
        useHasSaveDataPreference: () => w,
        useLocale: () => o,
        useNewswirePost: () => y.useNewswirePost,
        usePreloadImg: () => i,
        usePrevious: () => d,
        useQueryParams: () => l,
        useRockstarEventDispatcher: () => S,
        useRockstarEventSubscriber: () => k,
      ...
      const S = () => {
          const e = (e, t) => {
            ...
            window[p][n] || (window[p][n] = {
              eventQueue: [],
              subscribers: []
            }), window[p][n].eventQueue.push(r), window[p][n].subscribers.forEach((e => {
              e(r.detail)
            }))
          };
          return (0, s.useMemo)((() => ({
