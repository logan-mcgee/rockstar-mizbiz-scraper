...
_global.SENTRY_RELEASE = {
  ...
  [96], {
    ...
    775: (e, t, n) => {
      ...
      const {
        apiHost: i
      } = (0, c.c)(), d = (0, u._)(document.documentElement.lang), h = {}, f = async function(e) {
        let {
          fetchOptions: t = {},
          finalFetchOptions: n = {},
          query: r = null,
        ...
        try {
          ...
          let p = `${i}/${e}`;
          if (null === r || l().isEmpty(r) || (p += `?${new URLSearchParams(r)}`), !f && c) return null;
          ...
          const l = (0, s.useRockstarTokenPing)(),
            ...
            p = (0, a.useCallback)((async function() {
              ...
              try {
                ...
                return a?.status || w(JSON.stringify(a?.error)), u(a), h(!1), a
              } catch (e) {
                w(String(e)), h(!1)
              }
              return null
    ...
    172: (e, t, n) => {
      ...
      const a = (0, s.makeVar)(!1),
        ...
        i = e => {
          ...
          const [n, u] = (0, r.useState)(window.pageYOffset), [i, d] = (0, r.useState)(null), [h, f] = (0, r.useState)(!1), w = (0, s.useReactiveVar)(a);
          let p;
          const g = () => {
          ...
          }), [h, w]), (0, r.useMemo)((() => (0, o.jsx)(c.Provider, {
            value: {
