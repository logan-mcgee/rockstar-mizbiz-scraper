! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e6790883-461e-4aa3-9275-4b371edc518d", e._sentryDebugIdIdentifier = "sentry-dbid-e6790883-461e-4aa3-9275-4b371edc518d")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [372, 400, 32, 240, 744, 543], {
      ...
      const m = e => e.keys().forEach(e),
        ...
        g = function(e) {
          ...
          return Object.keys(e).forEach((r => {
            const o = t ? `${t}.${r}` : r;
            "object" == typeof e[r] && null !== e[r] ? Object.assign(n, g(e[r], o)) : n[o] = e[r]
          })), n
        },
        h = e => {
          const t = {};
    ...
    860: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, {
        setFreezeUserShouldSeeMore: () => E.C0,
      ...
      const h = (e, t, n) => {
          ...
          return `https://${o}.rockstargames.com/tpa/${e}/link/?cid=${a}&lang=${t}&returnUrl=${encodeURIComponent(n)}&accessToken=${s}`
        },
        w = () => {
    ...
    372: (e, t, n) => {
      ...
      n.r(t), n.d(t, {
        ...
        useGetPlatformLoginUrl: () => a.useGetPlatformLoginUrl,
        useHasReduceMotionPreference: () => a.useHasReduceMotionPreference,
        useHasSaveDataPreference: () => a.useHasSaveDataPreference,
    ...
    172: (e, t, n) => {
      ...
      const s = (0, r.makeVar)(!1),
        ...
        d = e => {
          ...
          const [n, l] = (0, o.useState)(window.pageYOffset), [d, u] = (0, o.useState)(null), [m, f] = (0, o.useState)(!1), g = (0, r.useReactiveVar)(s);
          let h;
          const w = () => {
          ...
          }), [m, g]), (0, o.useMemo)((() => (0, a.jsx)(c.Provider, {
            value: {
