(self.webpackChunk_rockstargames_utils = self.webpackChunk_rockstargames_utils || []).push([
  [688, 66, 938, 923], {
    740: (e, t, n) => {
      ...
      const {
        apiHost: s
      } = (0, i.Z)(), c = (0, o.r)(document.documentElement.lang), l = {
        ...
        let {
          ...
          finalFetchOptions: r = {},
          query: i = null
        } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, o = `${s}/${e}`;
        null !== i && (o += `?${new URLSearchParams(i)}`), t && (l.Authorization = `Bearer ${t}`);
        const c = {
            headers: l
          },
          u = a().all([c, n, r]),
    ...
    923: (e, t, n) => {
      ...
      const o = (0, r.makeVar)(i),
        s = e => {
          ...
          if (null == t || null == n) throw Error("You have to specify a key and a value.");
          const r = o() ?? {};
          return r[t] = n, window.localStorage.setItem(a, JSON.stringify(r)), r
        },
        c = () => ({
