...
_global.SENTRY_RELEASE = {
  ...
  [908], {
    464: (e, a, t) => {
      var n, d = (n = t(616)) && n.__esModule ? n : {
          default: n
        },
        r = {
          tags: function(e) {
            var a = e.id,
              ...
              o = "&gtm_auth=" + e.auth,
              s = "&gtm_preview=" + i;
            return a || (0, d.default)("GTM Id is required"), {
    ...
    912: (e, a, t) => {
      var n, d = (n = t(464)) && n.__esModule ? n : {
          default: n
        },
        r = {
          ...
          initialize: function(e) {
            ...
            d && document.head.appendChild(u.dataScript), document.head.insertBefore(u.script(), document.head.childNodes[0]), document.body.insertBefore(u.noScript(), document.body.childNodes[0])
          },
          dataLayer: function(e) {
            var a = e.dataLayer,
              t = e.dataLayerName,
              n = void 0 === t ? "dataLayer" : t;
            if (window[n]) return window[n].push(a);
            var r = d.default.dataLayer(a, n),
              i = this.dataScript(r);
    ...
    908: (e, a, t) => {
      var n, d = (n = t(912)) && n.__esModule ? n : {
        default: n
      };
      e.exports = d.default
    },
