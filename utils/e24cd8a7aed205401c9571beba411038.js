! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "252a0aa5-4c86-4a56-b4d5-807cc375910a", e._sentryDebugIdIdentifier = "sentry-dbid-252a0aa5-4c86-4a56-b4d5-807cc375910a")
  } catch (e) {}
}();
  ...
  [372, 400, 32, 96, 744, 543], {
      ...
      const m = e => e.keys().forEach(e),
        ...
        S = e => {
          ...
          fetch(e, {
            ...
            r.href = n, r.setAttribute("download", t), document.body.appendChild(r), r.click(), document.body.removeChild(r)
          })).catch((e => {
            console.log(e)
          }))
        },
    ...
    96: (e, t, n) => {
      ...
      n.r(t), n.d(t, {
        ...
        useLocale: () => a,
        useNewswirePost: () => p.useNewswirePost,
        usePreloadImg: () => i,
        useQueryParams: () => l,
          ...
          const i = (0, r.useRockstarTokenPing)(),
            ...
            g = (0, s.useCallback)((async function() {
              ...
              try {
                ...
                h(null), l(null), m(!0);
                const s = await (0, u.c)(n ?? e, {
                  pingBearer: i,
                  fetchOptions: o,
                  finalFetchOptions: r,
                  query: a
                });
                return s?.status || h(JSON.stringify(s?.error)), l(s), m(!1), s
              } catch (e) {
                h(String(e)), m(!1)
              }
              return null
