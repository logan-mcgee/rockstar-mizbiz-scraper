...
_global.SENTRY_RELEASE = {
  ...
  [96], {
    576: (e, t, n) => {
      ...
      t.jsx = function(e, t, n) {
        var s, l = {},
          u = null,
          i = null;
        for (s in void 0 !== n && (u = "" + n), void 0 !== t.key && (u = "" + t.key), void 0 !== t.ref && (i = t.ref), t) o.call(t, s) && !c.hasOwnProperty(s) && (l[s] = t[s]);
        if (e && e.defaultProps)
    ...
    775: (e, t, n) => {
      ...
      const {
        apiHost: i
      } = (0, l.c)(), d = (0, u._)(document.documentElement.lang), h = {}, w = async function(e) {
        let {
          fetchOptions: t = {},
          finalFetchOptions: n = {},
          query: r = null,
        ...
        try {
          ...
          let p = `${i}/${e}`;
          if (null === r || c().isEmpty(r) || (p += `?${new URLSearchParams(r)}`), !w && l) return null;
    ...
    96: (e, t, n) => {
      ...
      var a = n(664);
      const c = e => {
        const [t, n] = (0, a.useState)(null), [s, r] = (0, a.useState)(null), [o, c] = (0, a.useState)({});
      ...
      const h = (e, t) => {
          ...
          const c = (0, s.useRockstarTokenPing)(),
    ...
    172: (e, t, n) => {
      ...
      const a = (0, s.makeVar)(!1),
        ...
        i = e => {
          ...
          }), [h, f]), (0, r.useMemo)((() => (0, o.jsx)(l.Provider, {
            value: {
