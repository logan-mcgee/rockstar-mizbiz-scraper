! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "e328679a-faa9-4dd8-8bc4-6ebfd74e4ea2", t._sentryDebugIdIdentifier = "sentry-dbid-e328679a-faa9-4dd8-8bc4-6ebfd74e4ea2")
  } catch (t) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [648], {
    ...
    57648: (t, e, n) => {
        ...
        const y = (0, o.forwardRef)((function(y, w) {
          ...
          if (!V && l) {
            ...
            const r = (0, o.useContext)(c).strict,
              l = (0, o.useContext)(A);
            L.visualElement && (C = L.visualElement.loadFeatures(S, r, t, k, n || x.projectionNodeConstructor, l))
          }
      ...
      const Pt = t => t.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
      ...
      function Ct(t, e, n, o) {
        At(t, e, void 0, o);
        for (const n in e.attrs) t.setAttribute(Vt.has(n) ? n : Pt(n), e.attrs[n])
      }
      ...
      const Ae = t => e => (t(e), null),
        Ve = {
          inView: Ae((function({
            ...
            let a = Boolean(e || n || i);
            r.once && s.current.hasEnteredView && (a = !1), ("undefined" == typeof IntersectionObserver ? Pe : Se)(a, s.current, t, r)
          })),
          tap: Ae((function({
            onTap: t,
            onTapStart: e,
        ...
        if (s)
          for (let a = 0; a < s; a++) {
            const s = r[a],
              l = e[s];
            let u = null;
            Array.isArray(l) && (u = l[0]), null === u && (u = null !== (i = null !== (o = n[s]) && void 0 !== o ? o : t.readValue(s)) && void 0 !== i ? i : e[s]), null != u && ("string" == typeof u && (ke(u) || Re(u)) ? u = parseFloat(u) : !An(u) && fn.test(l) && (u = En(s, l)), t.addValue(s, Qe(u, {
              owner: t
          ...
          },
          {
            ...
            if (!Mo(t, Co) && Mo(t, Vo)) {
              const n = function({
                ...
                let s = 1 - e;
                s = H(To, So, s), t = H(Eo, bo, t / 1e3), s < 1 ? (i = e => {
                  const o = e * s,
                    i = o * t,
                    r = o - n,
                    a = Ao(e, s),
      ...
      function Fo({
        ...
        const S = Do[s.length > 2 ? "keyframes" : p],
          P = s[0],
          A = s[s.length - 1];
        (null === (g = (m = S).needsInterpolation) || void 0 === g ? void 0 : g.call(m, P, A)) && (x = so([0, 100], [P, A], {
          clamp: !1
        }), s = [0, 100]);
        const V = S({
          ...f,
        ...
        return a && (l && l(), v = e((function(t) {
          ...
          }(n, E, r, T)) : (n = Bo(n, E, r), "mirror" === i && V.flipTarget()), b = !1, h && h()) : (v.stop(), c && c()))
        })), v.start()), {
          stop: () => {
            u && u(), v.stop()
          },
            ...
            t.animationState || (t.animationState = function(t) {
              ...
              function r(r, s) {
                ...
                for (let e = 0; e < hi; e++) {
                  ...
                  let S = T || v === s && y.isActive && !b && w || e > f && w;
                  ...
                  y.prevProp = x, y.prevResolvedValues = A, y.isActive && (h = {
                    ...h,
                    ...A
                  }), o && t.blockInitialAnimation && (S = !1), S && !b && u.push(...P.map((t => ({
                    animation: t,
                    options: {
                      type: v,
                      ...r
      ...
      function Pi(t, e, n, o = .5) {
        t.origin = o, t.originPoint = _n(e.min, e.max, t.origin), t.scale = Ti(n) / Ti(e), (Si(t.scale, 1, 1e-4) || isNaN(t.scale)) && (t.scale = 1), t.translate = _n(n.min, n.max, t.origin) - t.originPoint, (Si(t.translate) || isNaN(t.translate)) && (t.translate = 0)
      }
          ...
          if (i.forEach((i => {
              ...
              if (Rt(h)) {
                const t = h.length,
                  e = null === h[0] ? 1 : 0;
                u = h[e], c = Sn(u);
                for (let n = e; n < t; n++) d ? Nn(Sn(h[n]) === d, "All keyframes must be of the same type") : (d = Sn(h[n]), Nn(d === c || hr(c) && hr(d), "Keyframes must be of the same dimension as the current value"))
              } else d = Sn(h);
              if (c !== d)
                if (hr(c) && hr(d)) {
                  const t = l.get();
      ...
      const br = Object.keys(x),
        Tr = br.length,
        Sr = ["AnimationStart", "AnimationComplete", "Update", "Unmount", "BeforeLayoutMeasure", "LayoutMeasure", "LayoutAnimationStart", "LayoutAnimationComplete"];
      class Pr {
        constructor({
          parent: t,
          props: e,
      ...
      class Lr extends Cr {
        ...
        readValueFromInstance(t, e) {
          var n;
          return F.has(e) ? (null === (n = wn(e)) || void 0 === n ? void 0 : n.default) || 0 : (e = Vt.has(e) ? e : Pt(e), t.getAttribute(e))
        }
        ...
        return class {
          ...
          resolveTargetDelta() {
            ...
            if (this.layout && (n || o)) {
              ...
              var i, r, s;
              if ((this.relativeTarget || this.targetDelta) && (this.target || (this.target = Fi(), this.targetWithTransforms = Fi()), this.relativeTarget && this.relativeTargetOrigin && (null === (t = this.relativeParent) || void 0 === t ? void 0 : t.target) ? (i = this.target, r = this.relativeTarget, s = this.relativeParent.target, Vi(i.x, r.x, s.x), Vi(i.y, r.y, s.y)) : this.targetDelta ? (Boolean(this.resumingFrom) ? this.target = this.applyTransform(this.layout.layoutBox) : qr(this.target, this.layout.layoutBox), Gi(this.target, this.targetDelta)) : qr(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget)) {
          ...
          setAnimationOrigin(t, e = !1) {
            ...
            this.animationProgress = 0, this.mixTargetDelta = e => {
              ...
              const o = e / 1e3;
              var i, d, p, f;
              Ts(a.x, t.x, o), Ts(a.y, t.y, o), this.setTargetDelta(a), this.relativeTarget && this.relativeTargetOrigin && this.layout && (null === (n = this.relativeParent) || void 0 === n ? void 0 : n.layout) && (Mi(l, this.layout.layoutBox, this.relativeParent.layout.layoutBox), i = this.relativeTarget, d = this.relativeTargetOrigin, p = l, f = o, Ss(i.x, d.x, p.x, f), Ss(i.y, d.y, p.y, f)), u && (this.animationValues = s, function(t, e, n, o, i, r) {
      ...
      function Ra(t, e, n, o) {
        const i = n[e],
          ...
          a = i.current,
          l = n.time;
        i.current = t["scroll" + s], i.scrollLength = t["scroll" + r] - t["client" + r], i.offset.length = 0, i.offset[0] = 0, i.offset[1] = i.scrollLength, i.progress = Ca(0, i.scrollLength, i.current);
        const u = o - l;
        var c, h;
      ...
      function Qa(t) {
        ...
        if (i.add(s), !qa.has(n)) {
          ...
          window.addEventListener("resize", t, {
            passive: !0
          }), n !== document.documentElement && Za.set(n, (u = t, Va(l = n) ? (a = l, Pa.add(a), Aa || (Aa = () => {
            const t = {
            ...
            Pa.delete(a), !Pa.size && Aa && (Aa = void 0)
          }) : function(t, e) {
      ...
      class sl extends Je {
        ...
        add(t) {
          let e;
          F.has(t) ? (this.transforms.add(t), e = "transform") : t.startsWith("origin") || $(t) || "willChange" === t || (e = Pt(t)), e && (_e(this.members, e), this.update())
        }
        remove(t) {
          F.has(t) ? (this.transforms.delete(t), this.transforms.size || qe(this.members, "transform")) : qe(this.members, Pt(t)), this.update()
        }
        update() {
...
//# sourceMappingURL=36e9cba73b62bd6b9ef0a1b5d05c8052.js.map