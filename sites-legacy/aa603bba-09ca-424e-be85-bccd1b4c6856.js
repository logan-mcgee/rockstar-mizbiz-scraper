try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "aa603bba-09ca-424e-be85-bccd1b4c6856", t._sentryDebugIdIdentifier = "sentry-dbid-aa603bba-09ca-424e-be85-bccd1b4c6856")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
          ...
          return c(e, t), Object.defineProperty(e.prototype, "parentNode", {
            ...
            if (this.state.isResizing && this.resizable && this.window) {
              ...
              if (this.delta = k, c && "string" == typeof c)
                ...
                var L = S / this.window.innerHeight * 100;
                S = "".concat(L, "vh")
              }
              f && "string" == typeof f && (f.endsWith("%") ? (B = z / g.height * 100, z = "".concat(B, "%")) : f.endsWith("vw") ? (H = z / this.window.innerWidth * 100, z = "".concat(H, "vw")) : f.endsWith("vh") && (L = z / this.window.innerHeight * 100, z = "".concat(L, "vh")));
              var _ = {
                width: this.createSizeForCssProperty(S, "width"),
                height: this.createSizeForCssProperty(z, "height")
              };
              "row" === this.flexDir ? _.flexBasis = _.width : "column" === this.flexDir && (_.flexBasis = _.height);
              var C = this.state.width !== _.width,
                T = this.state.height !== _.height,
                A = this.state.flexBasis !== _.flexBasis,
                D = C || T || A;
