! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "5f727cfa-1f5e-44ec-a02b-f90140335879", e._sentryDebugIdIdentifier = "sentry-dbid-5f727cfa-1f5e-44ec-a02b-f90140335879")
  } catch (e) {}
}();
  ...
  [4465], {
    ...
    93665: (e, a, t) => {
      ...
      const m = e => {
          ...
          const {
            ...
            track: L
          } = (0, o.useGtmTrack)(), M = null !== k && (k?.length || 0) > 1 && ("flag_bg" === _ || "fob" === N?.size), [E, P] = (0, l.useSearchParams)(), [z, B] = (0, s.useState)(!1), [O, A] = (0, s.useState)(!1), [D, V] = (0, s.useState)(), $ = e => {
    ...
    53149: (e, a, t) => {
      ...
      let Da, Va, $a = function(e, a, t, s, i, r, n) {
        ...
        Ga = (e, a, t) => {
          ...
          if (F && (!P || !j) && (j = "none"), e._ease = La(j, p.ease), e._yEase = E ? Ta(La(!0 === E ? j : E, p.ease)) : 0, E && e._yoyo && !e._repeat && (E = e._yEase, e._yEase = e._ease, e._ease = E), e._from = !F && !!x.runBackwards, !F || P && !x.stagger) {
            if (u = A[0] ? ne(A[0]).harness : 0, _ = u && x[u.prop], r = _e(x, K), O && (O._zTime < 0 && O.progress(1), a < 0 && M && w && !z ? O.render(-1, !0) : O.revert(M && B ? Y : X), O._lazy = 0), N) {
              if (Ne(e._startAt = Xa.set(A, be({
                  ...
                  callbackScope: L,
                  stagger: 0
                }, N))), e._startAt._dp = 0, e._startAt._sat = e, a < 0 && (i || !w && !z) && e._startAt.revert(Y), w && B && a <= 0 && t <= 0) return void(a && (e._zTime = a))
            } else if (M && B && !O)
              if (a && (w = !1), o = be({
                  overwrite: !1,
                  data: "isFromStart",
      ...
      class Xa extends Oa {
        constructor(e, a, t, i) {
          ...
          !0 !== v || s || (Da = this, n.killTweensOf(w), Da = 0), ze(N, this, t), a.reversed && this.reverse(), a.paused && this.paused(!0), (b || !p && !_ && this._start === de(N._time) && I(b) && Ce(this) && "nested" !== N.data) && (this._tTime = -1e-8, this.render(Math.max(0, -h) || 0)), x && Be(this, x)
        }
        render(e, a, t) {
      ...
      const ri = {
        ...
        init(e, a, t, s, i) {
          ...
          for (m in Gt || ws(), this.styles = this.styles || _s(e), y = this.styles.props, this.tween = t, a)
            ...
            else if (m in j) Os.call(this, e, m, r, p ? p + n : n);
    ...
    84828: (e, a, t) => {
      ...
      t.r(c), t.d(c, {
        ...
        withSearchbarErrorBoundary: () => En.A,
      ...
      const ws = {
        ...
        qs = e => {
          ...
          const b = (e => {
            ...
            v = (0, I.useGetCdnSource)(t?.desktop?.full_src ?? k),
            _ = (0, I.useGetCdnSource)(l?.mobile?.full_src ?? null),
            y = (0, I.useGetCdnSource)(l?.desktop?.full_src ?? _);
          return (0, p.jsxs)(O.motion.div, {
      ...
      const yi = (e, a) => {
        ...
        Ni = "TierIndicator:checkList",
        wi = e => {
          let {
            tiers: a
          } = e;
          return (0, p.jsx)("div", {
            className: ji.packCardTierIndicator,
            "data-testid": Ni,
            children: a?.map(((e, a) => (0, p.jsx)("div", {
              className: [ji.tierIndicator, e.isComplete ? ji.active : ""].join(" ")
            }, a)))
          })
        },
        Si = {
        ...
        Li = e => {
          ...
          return (0, m.usePreloadImg)(j), (0, p.jsx)(Ka.NavLink, {
      ...
      const br = {
        ...
        Nr = "CharacterButton:characterName",
        ...
        Fr = (0, d.withIntl)((e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            removeScrollBar: !1,
            children: [(0, p.jsxs)("div", {
              className: [$r.scMenu, N ? $r.navOpen : ""].join(" "),
              "data-logged-in": x,
              "data-mac-browser": V,
              "data-scroll-mode": v,
              ref: z,
              ...
              className: [$r.scOverlay, N ? $r.navOpen : ""].join(" "),
              "data-logged-in": x
            })]
          })
        }), k),
        ...
        cn = e => {
          ...
          const s = a ? "span" : f.A;
          return (0, p.jsx)(s, {
            className: [nn.rockstarLogo, t || ""].join(" "),
      ...
      const hn = {
        ...
        bn = e => {
          ...
          const {
            ...
            refetch: c
          } = (0, l.useQuery)(pn.UserGetVote, {
            skip: !0
          }), [d] = (0, l.useMutation)(pn.UserCastVote), [m, g] = (0, o.useState)(null), f = (0, o.useCallback)((async e => {
            r({
              event: "cta_" + (e ? "like" : "dislike"),
              text: `${s} ${t}`
            });
          ...
          return (0, o.useEffect)((() => {
            ...
            className: hn.userVote,
            children: (0, p.jsxs)("div", {
              className: hn.voteContent,
              children: [(0, p.jsxs)("div", {
                className: hn.info,
                children: [(0, p.jsx)("h3", {
                  children: i
                ...
                className: [hn.voteButtons, n ? "" : hn.loggedOutButtons].join(" "),
                children: [(0, p.jsx)("button", {
                  onClick: () => f(!0),
                  className: [hn.upVote, m ? hn.voteButtonActive : ""].join(" "),
                  type: "button",
                  "aria-label": "Vote up"
                }), (0, p.jsx)("button", {
                  className: [hn.downVote, !1 === m ? hn.voteButtonActive : ""].join(" "),
                  onClick: () => f(!1),
                  type: "button",
        ...
        vn = e => {
          ...
          return (0, p.jsx)("div", {
            className: [kn.screencap, i ? kn.screencapLoaded : ""].join(" "),
            style: {
        ...
        xn = (0, m.withLocale)((e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            const a = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
              ...
              o = e => {
                d(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !h.current?.classList.contains(yn.dragging) || a() && r(!0)
              },
              l = () => {
                a() && r(!1), d(0)
              },
              m = e => {
                "press" === e.type && g.current?.classList.add(`${yn.disableClick}`), "tap" === e.type && (g.current?.classList.remove(`${yn.disableClick}`), document.elementFromPoint(e.center.x, e.center.y).click())
              },
              u = () => {
                a() && r(!1), g.current && g.current.classList.remove(`${yn.disableClick}`)
              },
              f = () => {
                a() && r(!1)
              };
            ...
            className: yn.carousel,
            children: [(0, p.jsx)("div", {
              className: yn.track,
              ref: g,
              children: (0, p.jsx)("div", {
                className: `${yn.items} ${0!==l?yn.dragging:""}`,
                ref: h,
                style: {
              ...
              children: [(0, p.jsx)("div", {
                ...
                children: s.map(((e, s) => {
                  return (0, p.jsxs)(f.A, {
                    className: [yn.info, s === n ? yn.active : ""].join(" "),
                    "data-gtm-category": "Carousel",
                    ...
                    children: [(0, p.jsxs)("div", {
                      className: yn.title,
                      children: [(0, p.jsxs)("div", {
                        className: yn.gameTitle,
                        children: [e.game.title, "fr_fr" === a && " "]
                      }), (0, p.jsx)("h2", {
                        className: yn.videoTitle,
                        children: e.title
                      })]
                    }), (0, p.jsx)(Ct, {
                      className: yn.cta,
      ...
      const wn = e => {
        ...
        Cn = e => {
          ...
          return (0, p.jsx)(f.A, {
            ...
            to: t ?? i,
            target: "_self",
            className: [Sn.fobLink, r ? Sn.wide : ""].join(" "),
            children: (0, p.jsx)(wn, {
              title: a.title,
              titleSlug: s,
              isWideCard: r
            ...
            children: [(0, p.jsxs)("h3", {
              ...
              children: [s, (0, p.jsxs)("div", {
                ...
                children: [(0, p.jsx)("button", {
                  ...
                  type: "button",
                  ref: k,
                  "aria-label": r.formatMessage(jn.previous_button_label)
                }), (0, p.jsx)("button", {
                  className: [Tn.arrow, Tn.next].join(" "),
                  type: "button",
                  ref: v,
                  "aria-label": r.formatMessage(jn.next_button_label),
                  onKeyDown: e => {
                    if ("Tab" === e.key && !e.shiftKey) {
                      const a = l?.slides[l?.activeIndex].querySelector('a, button, [role="button"]');
              ...
              className: [Tn.items, h % 1 != 0 ? Tn.partial : ""].join(" "),
              children: (0, p.jsx)("div", {
      ...
      const {
        Gen9CoreCarousel: zn,
        framer: Bn,
        useTinaModuleFetchByIds: On,
        withSimpleErrorBoundary: An
      } = c, Dn = {
        Card: pt,
      ...
      const $n = Bn.withFadeIn(An((e => {
        ...
        Hn = e => {
          ...
          return h["--playlist-background-color"] = u?.["--playlist-background-color"], h["--template-bg-color"] = _, (0, p.jsx)(T, {
            children: (0, p.jsxs)("div", {
              className: [Gn.legacyPageTemplate, f].join(" "),
              "data-brand": l,
              style: h,
              children: [t && (0, p.jsx)(w(), {
                ...
                children: [c?.collections?.length && (0, p.jsx)(Ve, {
                  ...
                  children: u && k && (0, p.jsxs)("div", {
                    className: Gn.videosContainer,
                    children: [(0, p.jsx)("h2", {
                      children: u.sectionLabel
                    }), (0, p.jsx)("div", {
                      className: Gn.videoPlayerContainer,
                      children: (0, p.jsx)(L.VideoWithPlaylist, {
                        tagIds: [Number(u.videoTag ?? 0)],
                        className: Gn.legacyVideoStyles,
                        autoplay: !1,
                        locale: v,
                ...
                className: Gn.tinaModuleContainer,
                children: (0, p.jsx)(He, {
                  components: b,
                  id: g
                })
