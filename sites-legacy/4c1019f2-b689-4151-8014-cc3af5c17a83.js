! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      a = (new e.Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "4c1019f2-b689-4151-8014-cc3af5c17a83", e._sentryDebugIdIdentifier = "sentry-dbid-4c1019f2-b689-4151-8014-cc3af5c17a83")
  } catch (e) {}
}();
    ...
    41454: (e, a, s) => {
      ...
      function m(e, a, s) {
        var t, o = {},
          m = null,
          n = null;
        for (t in void 0 !== s && (m = "" + s), void 0 !== a.key && (m = "" + a.key), void 0 !== a.ref && (n = a.ref), a) c.call(a, t) && !i.hasOwnProperty(t) && (o[t] = a[t]);
        if (e && e.defaultProps)
                ...
                switch (i) {
                  ...
                  case "buy":
                    return (0, b.jsx)(k.A, {
                      ...
                      role: "button",
                      onClick: () => {
                        m.includes("#") && (0, r.detectIfWeShouldAnchorSomewhere)({
                          paramName: m.replace("#", "")
                        }), a({
                          event: "cta_buy",
                          element_placement: "hero",
                  ...
                  case "trailer":
                    return (0, b.jsx)(k.A, {
                      ...
                      "aria-controls": m.startsWith("/") ? "modal" : "",
                      "aira-haspopup": m.startsWith("/"),
                      children: (0, b.jsxs)("div", {
                        className: [d ? j.primary : "", j.cta].filter((e => e)).join(" "),
                        children: [e?.icon && (0, b.jsx)("img", {
                          className: j.platformIcon,
        ...
        C = e => {
          ...
          const _ = (0, r.useLocale)(),
                ...
                Object.getOwnPropertyNames(e[t]).forEach((r => {
                  if (s.has(r)) {
                    const {
                      unit: o,
                      value: c
                    } = e[t][r], d = s.get(r), i = o?.length && c?.length ? `${c}${o}` : void 0;
                    i && (a = {
                      ...a,
                      [`${d}${t}`]: `${i}`
                    })
            ...
            W = {
              ...
              ...L ? {
                "--foreground-image-desktop": `url(${L})`
              } : {},
              ...R ? {
                "--foreground-image-mini": `url(${R})`
              } : {},
              ...G ? {
                "--foreground-image-mobile": `url(${G})`
              } : {},
              ...O ? {
                "--foreground-image-tablet": `url(${O})`
              } : {},
              ...D ? {
