try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "a625e2b4-a84e-4349-a2c0-9f2af9706952", e._sentryDebugIdIdentifier = "sentry-dbid-a625e2b4-a84e-4349-a2c0-9f2af9706952")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    21375: (e, a, s) => {
      ...
      const f = (0, o.setContextItem)({
        ...
        h = () => {
          ...
          return (0, t.jsxs)(c.motion.div, {
            className: m()("rockstargames-sites-legacybe07ac034642f2cd87f687e179775b46", r),
            style: o,
            initial: "hidden",
            animate: "visible",
            variants: e ? n : void 0,
      ...
      const j = {
        ...
        I = ({
          ...
          return e?.buttons?.length ? (0, t.jsxs)("section", {
            className: [N.ctaAndPlatformContainer, r ? N.bottomEdge : ""].join(" "),
            children: [(0, t.jsx)("div", {
              className: N.buttons,
              style: {
                width: r ? "100%" : ""
              },
              children: e?.buttons.map((e => ((e, a) => {
                const {
                  key: s,
                  label: r,
                  name: c,
                ...
                switch (i) {
                  case "wishlist":
                    return (0, t.jsx)(y.A, {
                      ...
                      role: "button",
                      onClick: () => {
                        (0, o.detectIfWeShouldAnchorSomewhere)(), a({
                          event: "add_to_wishlist",
                          text: (c ?? r).toLowerCase(),
                          element_placement: "hero",
                          link_url: n
                        })
                      },
                      children: (0, t.jsxs)("div", {
                        className: [m ? N.primary : "", N.cta].filter((e => e)).join(" "),
                        children: [e?.icon && (0, t.jsx)("img", {
                  ...
                  case "buy":
                    return (0, t.jsx)(y.A, {
                      ...
                      role: "button",
                      onClick: () => {
                        n.includes("#") && (0, o.detectIfWeShouldAnchorSomewhere)({
                          paramName: n.replace("#", "")
                        }), a({
                          event: "cta_buy",
                          element_placement: "hero",
                  ...
                  case "trailer":
                    return (0, t.jsx)(y.A, {
                      ...
                      "aria-controls": n.startsWith("/") ? "modal" : "",
                      "aira-haspopup": n.startsWith("/"),
                      children: (0, t.jsxs)("div", {
                        className: [m ? N.primary : "", N.cta].filter((e => e)).join(" "),
                        children: [e?.icon && (0, t.jsx)("img", {
                          className: N.platformIcon,
        ...
        T = () => {
          const e = (0, o.useLocale)(),
            ...
            } = (0, o.useWindowResize)(),
            {
              ...
              hasForegroundImage: b,
              imageStyles: p,
              foregroundImageStyles: v
            } = u(),
            h = d?.[0]?.brand ?? null;
          let y;
          if (h) try {
          ...
          return (0, t.jsxs)(c.motion.div, {
            ...
            children: [(0, t.jsxs)("div", {
              ...
              children: (0, t.jsxs)(c.motion.div, {
                ...
                }), a.sm.activeMin && (0, t.jsx)(I, {
                  ctas: i,
                  platformCollection: n,
                  enablePlatforms: g
                })]
              })
            }), a.sm.activeMin && g && (0, t.jsx)("div", {
              className: C.platformSection,
        ...
        S = ({
          ...
          const v = (0, o.useLocale)(),
            {
              isMobile: _
            } = (0, o.useWindowResize)(),
            k = (0, r.useGenerateCdnSource)(),
            {
              background: x,
              foreground: y
            } = l,
            ...
            B = {
              ...A ? {
                "--background-image-desktop": `url(${A})`
              } : {},
              ...M ? {
              ...
              ...R ? {
                "--foreground-image-mini": `url(${R})`
              } : {},
              ...E ? {
                "--foreground-image-mobile": `url(${E})`
              } : {},
              ...L ? {
                "--foreground-image-tablet": `url(${L})`
              } : {},
              ...D ? {
                "--foreground-image-ultrawide": `url(${D})`
              } : {}
            },
            W = !(!A && !M),
            F = !(!O && !E);
    ...
    69245: (e, a, s) => {
      ...
      function i(e, a, s) {
        var t, o = {},
          i = null,
          n = null;
        for (t in void 0 !== s && (i = "" + s), void 0 !== a.key && (i = "" + a.key), void 0 !== a.ref && (n = a.ref), a) c.call(a, t) && !m.hasOwnProperty(t) && (o[t] = a[t]);
        if (e && e.defaultProps)
