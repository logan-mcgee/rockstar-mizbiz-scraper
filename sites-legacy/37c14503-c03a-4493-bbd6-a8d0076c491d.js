try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "37c14503-c03a-4493-bbd6-a8d0076c491d", e._sentryDebugIdIdentifier = "sentry-dbid-37c14503-c03a-4493-bbd6-a8d0076c491d")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const p = (0, l.defineMessages)({
        ...
        x = (0, l.withIntl)(({
          ...
          return (0, a.jsxs)(d.motion.div, {
            "aria-hidden": !h,
            "aria-label": g.formatMessage(p.cph_highlights_group_aria, {
              index: n + 1,
              total: r
            }),
            onAnimationStart: () => {
              o.current && h && setTimeout(() => o.current?.scrollTo({
                top: 0
              }), 0)
            },
            role: "group",
            ...
            children: [e && (0, a.jsx)("h1", {
              children: e || g.formatMessage(p.cph_highlights_heading)
            }), t && (0, a.jsx)("h2", {
              className: f.heading,
              children: t
        ...
        v = (0, l.withIntl)(({
          ...
          }, [f]), (0, s.useEffect)(() => (C.el && C.el.querySelectorAll(".swiper-pagination-bullet").forEach((e, t) => {
            ...
            children: [(0, a.jsxs)("div", {
              ...
              children: [e.length > 1 && (0, a.jsxs)(a.Fragment, {
                children: [(0, a.jsx)(d.motion.button, {
                  ref: R,
                  type: "button",
                  "aria-label": i.formatMessage(p.cph_highlights_previous),
                  className: [y.controlBtn, y.prevBtn, k ? y.fadeIn : y.fadeOut].join(" "),
                  onClick: () => {
                    b({
                  ...
                  ref: P,
                  type: "button",
                  "aria-label": i.formatMessage(p.cph_highlights_next),
                  className: [y.controlBtn, y.nextBtn, k ? y.fadeIn : y.fadeOut].join(" "),
                  onClick: () => {
                    b({
                      event: "carousel_next",
                      element_placement: "highlights"
                ...
                children: e.map((e, t) => (0, a.jsx)(o.qr, {
              ...
              children: [(0, a.jsx)("div", {
                ...
                children: (0, a.jsx)(o.RC, {
                  ...
                  slidesPerView: "auto",
                  initialSlide: j,
                  children: e.map((t, i) => (0, a.jsx)(o.qr, {
                    children: (0, a.jsx)("button", {
                      ...
                      onClick: () => (t => {
                        b({
                          ...
                          position: t,
                          card_name: e[t]?.title
                        }), I(t), A.current?.slideTo(t), N.current?.slideTo(t)
                      })(i),
                      className: `${i===j?y.active:""}`,
                      "aria-label": t.altText ?? t.title,
                      "aria-current": i === j,
                      children: (0, a.jsx)("img", {
                        src: `${z(t.image)}?im=Resize,width=252`,
