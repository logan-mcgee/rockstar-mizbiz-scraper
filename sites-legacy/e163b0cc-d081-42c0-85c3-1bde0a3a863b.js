! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e163b0cc-d081-42c0-85c3-1bde0a3a863b", e._sentryDebugIdIdentifier = "sentry-dbid-e163b0cc-d081-42c0-85c3-1bde0a3a863b")
  } catch (e) {}
}();
        ...
        return function e(n, c, l) {
          l = l || 1, Object.keys(n).forEach((function(u) {
            const d = n[u],
              ...
              b = c ? c + o + s(u) : s(u);
            if (!f && !y && m && Object.keys(d).length && (!r.maxDepth || l < a)) return e(d, b, l + 1);
            i[b] = d
          }))
        }(e), i
      }
    ...
    52437: (e, t, n) => {
      ...
      const h = {
        ...
        v = e => {
          ...
          }), [s, c, JSON.stringify(g), JSON.stringify(_)])
        };
      var k = n(13916);
      const w = function() {
