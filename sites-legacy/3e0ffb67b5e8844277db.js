  ...
  [62, 599], {
    5062: (e, a, l) => {
      ...
      const b = (0, m.withTranslations)((e => {
        ...
        }), [b.get("video"), x, h]), (0, o.useEffect)((() => () => l(null)), []), k || h ? k ? (0, p.jsx)("div", {
      ...
      const k = () => {
          ...
          if (!l) return null;
          const o = e(f.sY[`legacy_header_cta_href_${l}`]),
            i = e(f.sY[`legacy_header_cta_label_${l}`]);
          return (0, p.jsx)(n.A, {
            to: o,
            role: "button",
            tabIndex: "-1",
          ...
          legacy: {
            LegacyPageTemplate: () => ({
              ...
              defaultItem: () => (0, t.defaultItemUnique)({
                ...
                hero: (0, t.defaultItemUnique)(o()().defaultItem),
