try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "e7214e6c-8208-48dd-ae1e-742eac956c85", t._sentryDebugIdIdentifier = "sentry-dbid-e7214e6c-8208-48dd-ae1e-742eac956c85")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
              ...
              function i(i, s) {
                ...
                for (let e = 0; e < hr; e++) {
                  ...
                  for (const t in A) {
                    const e = S[t],
                      n = T[t];
                    h.hasOwnProperty(t) || (e !== n ? Dt(e) && Dt(n) ? !ke(e, n) || b ? C(t) : g.protectedKeys[t] = !0 : void 0 !== e ? C(t) : c.add(t) : void 0 !== e && c.has(t) ? C(t) : g.protectedKeys[t] = !0)
                  }
        ...
        return class {
          ...
          resolveTargetDelta() {
            ...
            if (this.layout && (n || o)) {
              if (!this.targetDelta && !this.relativeTarget) {
                ...
                t && t.layout ? (this.relativeParent = t, this.relativeTarget = jr(), this.relativeTargetOrigin = jr(), kr(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox), qi(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
              }
              var r, i, s;
              if ((this.relativeTarget || this.targetDelta) && (this.target || (this.target = jr(), this.targetWithTransforms = jr()), this.relativeTarget && this.relativeTargetOrigin && (null === (t = this.relativeParent) || void 0 === t ? void 0 : t.target) ? (r = this.target, i = this.relativeTarget, s = this.relativeParent.target, Vr(r.x, i.x, s.x), Vr(r.y, i.y, s.y)) : this.targetDelta ? (Boolean(this.resumingFrom) ? this.target = this.applyTransform(this.layout.layoutBox) : qi(this.target, this.layout.layoutBox), Xr(this.target, this.targetDelta)) : qi(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget)) {
                ...
                const t = this.getClosestProjectingParent();
                t && Boolean(t.resumingFrom) === Boolean(this.resumingFrom) && !t.options.layoutScroll && t.target ? (this.relativeParent = t, this.relativeTarget = jr(), this.relativeTargetOrigin = jr(), kr(this.relativeTargetOrigin, this.target, t.target), qi(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
              }
            }
          }
          ...
          setAnimationOrigin(t, e = !1) {
            ...
            this.animationProgress = 0, this.mixTargetDelta = e => {
              ...
              const o = e / 1e3;
              var r, d, f, p;
              Ps(a.x, t.x, o), Ps(a.y, t.y, o), this.setTargetDelta(a), this.relativeTarget && this.relativeTargetOrigin && this.layout && (null === (n = this.relativeParent) || void 0 === n ? void 0 : n.layout) && (kr(l, this.layout.layoutBox, this.relativeParent.layout.layoutBox), r = this.relativeTarget, d = this.relativeTargetOrigin, f = l, p = o, Ss(r.x, d.x, f.x, p), Ss(r.y, d.y, f.y, p)), u && (this.animationValues = s, function(t, e, n, o, r, i) {
        ...
        if (t.isLead() && t.layout && r && t.hasListeners("didUpdate")) {
          ...
          if (!t.resumeFrom) {
            ...
            if (n && !n.resumeFrom) {
              ...
              if (t && o) {
                const n = jr();
                kr(n, r.layoutBox, t.layoutBox);
                const i = jr();
                kr(i, e, o.layoutBox), os(n, i) || (u = !0)
              }
            }
          }
