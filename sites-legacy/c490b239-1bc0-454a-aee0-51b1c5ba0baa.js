! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      e = (new t.Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "c490b239-1bc0-454a-aee0-51b1c5ba0baa", t._sentryDebugIdIdentifier = "sentry-dbid-c490b239-1bc0-454a-aee0-51b1c5ba0baa")
  } catch (t) {}
}();
          ...
          return c(e, t), Object.defineProperty(e.prototype, "parentNode", {
            ...
            if (this.state.isResizing && this.resizable && this.window) {
              ...
              if (S = M.newWidth, z = M.newHeight, this.props.grid) {
                ...
                S = 0 === N || Math.abs(W - S) <= N ? W : S, z = 0 === N || Math.abs(E - z) <= N ? E : z
              }
              var k = {
                width: S - u.width,
                height: z - u.height
              ...
              f && "string" == typeof f && (f.endsWith("%") ? (_ = z / g.height * 100, z = "".concat(_, "%")) : f.endsWith("vw") ? (B = z / this.window.innerWidth * 100, z = "".concat(B, "vw")) : f.endsWith("vh") && (H = z / this.window.innerHeight * 100, z = "".concat(H, "vh")));
              var L = {
