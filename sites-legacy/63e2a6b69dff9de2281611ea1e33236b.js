    ...
    94072: (n, e, t) => {
      ...
      var x = function(n) {
        ...
        cn = function(n, e) {
          ...
          if (v[0] || (v = l)[0]) {
            var p, m, y, b = K([f], s).map((function(n) {
                return n.node
              })),
              ...
              O = function(n, e, t, r) {
                var o = n.length,
                  ...
                  c = C(t);
                if (!(t && n.indexOf(t) >= 0)) {
                  var a, d, f = void 0 !== t ? e.indexOf(t) : -1,
                    s = r ? e.indexOf(r) : f,
                    l = r ? n.indexOf(r) : -1,
                    v = f - s,
                    p = e.indexOf(u),
                    m = e.indexOf(i),
                    y = (a = e, d = new Set, a.forEach((function(n) {
                      return d.add($(n, a))
                    })), a.filter((function(n) {
                      return d.has(n)
                    }))),
                    ...
                    h = en(n, 0),
                    g = en(n, o - 1);
                  return -1 === f || -1 === l ? tn : !v && l >= 0 ? l : f <= p && c && Math.abs(v) > 1 ? g : f >= m && c && Math.abs(v) > 1 ? h : v && Math.abs(b) > 1 ? l : f <= p ? g : f > m ? h : v ? Math.abs(v) > 1 ? l : (o + l + v) % o : void 0
                }
              }(g, b, a, e);
            if (O === tn) {
        ...
        fn = function(n, e, t) {
          ...
          var r, o, u = cn(n, e);
          if (!dn && u) {
            if (an > 2) return console.error("FocusLock: focus-fighting detected. Only one focus management system could be active. See https://github.com/theKashey/focus-lock/#focus-fighting"), dn = !0, void setTimeout((function() {
              dn = !1
            }), 1);
        ...
        On = function() {
          ...
          if (ln) {
            var a = ln,
              ...
              v = a.crossFrame,
              p = a.focusOptions,
              m = d || pn && pn.portaledElement,
              y = document && document.activeElement;
            if (m) {
              var b = [m].concat(l.map(hn).filter(Boolean));
              if (y && ! function(n) {
                  return (ln.whiteList || yn)(n)
                }(y) || (f || (v ? Boolean(mn) : "meanwhile" === mn) || !(document && document.activeElement === document.body || function(n) {
                  void 0 === n && (n = document);
                  var e = z(n);
                ...
                }(y, b) || (i = y, pn && pn.portaledElement === i)) && (document && !vn && y && !s ? (y.blur && y.blur(), document.body.focus()) : (c = fn(b, vn, {
                  focusOptions: p
...
//# sourceMappingURL=63e2a6b69dff9de2281611ea1e33236b.js.map