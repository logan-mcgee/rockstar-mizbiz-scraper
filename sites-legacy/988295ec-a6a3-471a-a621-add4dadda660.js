      ...
      var l = t(23514),
        ...
        s = function() {
          function e(a, t) {
            ...
            var y = d.dataLocale,
              p = r[y];
            (0, n.invariant)(!!p, "Missing locale data for ".concat(y)), u(this, "localeData", p), (0, n.invariant)(void 0 !== p, "locale data for ".concat(d.locale, " does not exist."));
            var g = p.types;
          ...
          return e.supportedLocalesOf = function(a, t) {
            ...
            }(c(this, "languageDisplay"), s, u, p, y);
            else {
              var g = s.types[a];
              l = g[u][p] || g.long[p]
            }
