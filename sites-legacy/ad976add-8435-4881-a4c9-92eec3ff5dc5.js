! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "ad976add-8435-4881-a4c9-92eec3ff5dc5", e._sentryDebugIdIdentifier = "sentry-dbid-ad976add-8435-4881-a4c9-92eec3ff5dc5")
  } catch (e) {}
}();
  ...
  [861], {
    ...
    37017: (e, a, t) => {
      ...
      var n = t(71403),
        ...
        s = t(42756);
      var o = t(46632);
      const d = (0, s.withTranslations)((e => {
        let {
          t: a
        } = e;
        const [t] = (0, n.useState)(""), s = (0, i.useNavigate)(), d = (0, r.useMutateState)();
    ...
    88038: (e, a, t) => {
      ...
      const d = (0, i.withTranslations)((e => {
        ...
        let d = a?.message ?? t("error-404-new");
        d = t("error-404-new");
        const l = a?.code ?? 398,
          c = (0, n.useRef)(null);
    ...
    87240: (e, a, t) => {
      ...
      var n = t(71403),
        ...
        k = t(51389);
      var f = t(46632);
      const p = (0, u.withTranslations)((e => {
        let {
          t: a
        } = e;
        const [, t] = (0, d.h)(), [p, h] = (0, i.useSearchParams)(), {
          pathname: x
        } = (0, i.useLocation)(), {
          data: v,
          loading: y
        } = (0, o.useQuery)(m.MetaUrlInfo, {
          variables: {
            url: x.replace(/\/$/, "")
          },
          setTitleDataPath: "metaUrlInfo.title"
        }), b = (0, u.useLocale)(), g = v?.metaUrlInfo?.tina;
        return (0, n.useEffect)((() => {
          const e = p.get("video");
          if (!e || !g) return void t(null);
          const n = Number(g?.payload?.content[0].content[0]?.tag ?? 0);
          let i;
          i = 40 === n && ["pt_br", "zh_tw", "zh_hans", "ko_kr", "ru_ru", "ja_jp", "pl_pl"].includes(b) ? "en_us" : b;
          const r = (0, f.jsx)(c.VideoWithPlaylist, {
              tagIds: [n],
              locale: i,
        ...
        }), [p.get("video"), b, g]), (0, n.useEffect)((() => () => t(null)), []), y || g ? y ? (0, f.jsx)("div", {
          className: "rockstargames-sites-legacye7319efabeddf6cdc8c95f038912d0c1",
          children: (0, f.jsx)(r.A, {})
        }) : (0, f.jsx)(l.TinaParser, {
          components: k.componentsForTinaParser,
          tina: g
        }) : (0, f.jsx)(s.A, {})
      }))
    },
