              ...
              O = function(n, e, t, r) {
                ...
                if (!(t && n.indexOf(t) >= 0)) {
                  var a, f, d = void 0 !== t ? e.indexOf(t) : -1,
                    ...
                    p = e.indexOf(u),
                    m = e.indexOf(i),
                    b = (a = e, f = new Set, a.forEach((function(n) {
                      return f.add($(n, a))
                    })), a.filter((function(n) {
                      return f.has(n)
                    }))),
                    ...
                    h = en(n, 0),
                    g = en(n, o - 1);
                  return -1 === d || -1 === l ? tn : !v && l >= 0 ? l : d <= p && c && Math.abs(v) > 1 ? g : d >= m && c && Math.abs(v) > 1 ? h : v && Math.abs(y) > 1 ? l : d <= p ? g : d > m ? h : v ? Math.abs(v) > 1 ? l : (o + l + v) % o : void 0
                }
              }(g, y, a, e);
            if (O === tn) {
          ...
          if (ln) {
            ...
            if (m) {
              ...
              if (b && ! function(n) {
                ...
                }(b, y) || (i = b, pn && pn.portaledElement === i)) && (document && !vn && b && !s ? (b.blur && b.blur(), document.body.focus()) : (c = dn(y, vn, {
                  focusOptions: p
...
//# sourceMappingURL=5a961aaef3e480b31f94a3fd7434174c.js.map