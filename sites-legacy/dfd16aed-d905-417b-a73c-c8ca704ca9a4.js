! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "dfd16aed-d905-417b-a73c-c8ca704ca9a4", e._sentryDebugIdIdentifier = "sentry-dbid-dfd16aed-d905-417b-a73c-c8ca704ca9a4")
  } catch (e) {}
}();
    ...
    47325: (e, a, t) => {
      ...
      const wn = e => {
          ...
          return (0, p.jsx)("div", {
            role: "img",
            "aria-label": i,
            className: [jn.img, l ? jn.startAnimation : "", a ? jn.wide : ""].join(" "),
            style: {
            ...
            children: [(0, p.jsxs)("h3", {
              ...
              children: [s, (0, p.jsxs)("div", {
                ...
                children: [(0, p.jsx)("button", {
                  ...
                  type: "button",
                  ref: k,
                  "aria-label": r.formatMessage(Nn.previous_button_label)
                }), (0, p.jsx)("button", {
                  className: [Tn.arrow, Tn.next].join(" "),
                  type: "button",
                  ref: v,
                  "aria-label": r.formatMessage(Nn.next_button_label),
                  onKeyDown: e => {
                    if ("Tab" === e.key && !e.shiftKey) {
                      const a = l?.slides[l?.activeIndex].querySelector('a, button, [role="button"]');
