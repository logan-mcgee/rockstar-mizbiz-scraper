! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      n = (new Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "dbbac7a4-e684-4a34-9870-cf0e1c29596e", e._sentryDebugIdIdentifier = "sentry-dbid-dbbac7a4-e684-4a34-9870-cf0e1c29596e")
  } catch (e) {}
}();
  ...
  [721], {
    50721: (e, n, r) => {
      ...
      A.absoluteValue = A.abs = function() {
        ...
        if (n)
          if (r.length > 1) u = !0;
            ...
            u = 1 !== i
          } if (g = !1, o = W(c, s = f + 5), t = n ? _(l, s + 10) : W(e, s), M((a = P(o, t, s, 1)).d, i = f, d))
          do {
            if (o = W(c, s += 10), t = n ? _(l, s + 10) : W(e, s), a = P(o, t, s, 1), !u) {
        ...
        for (; 0 === c[--o];) c.pop();
        for (; 0 === c[0]; c.shift()) --r;
        return c[0] ? (e.d = c, e.e = R(c, r), g ? k(e, s, a) : e) : new p(3 === a ? -0 : 0)
        ...
        return e.d = c, e.e = R(c, t), g ? k(e, s, a) : e
        ...
        for (; !u[--o];) u.pop();
        return n ? ++r : u.shift(), e.d = u, e.e = R(u, r), g ? k(e, f.precision, f.rounding) : e
      ...
      var P = function() {
        ...
        return function(t, i, o, s, a, c) {
          var l, f, d, g, m, p, h, v, y, w, b, F, E, N, x, T, A, O, I, M, B = t.constructor,
            ...
            j = t.d,
            R = i.d;
          if (!(j && j[0] && R && R[0])) return new B(t.s && i.s && (j ? !R || j[0] != R[0] : R) ? j && 0 == j[0] || !R ? 0 * P : P / 0 : NaN);
          for (c ? (m = 1, f = t.e - i.e) : (c = C, m = S, f = D(t.e / m) - D(i.e / m)), I = R.length, A = j.length, w = (y = new B(P)).d = [], d = 0; R[d] == (j[d] || 0); d++);
          if (R[d] > (j[d] || 0) && f--, null == o ? (N = o = B.precision, s = B.rounding) : N = a ? o + (t.e - i.e) + 1 : o, N < 0) w.push(1), p = !0;
          else {
            if (N = N / m + 2 | 0, d = 0, 1 == I) {
              for (g = 0, R = R[0], N++;
                (d < A || g) && N--; d++) x = g * c + (j[d] || 0), w[d] = x / R | 0, g = x % R | 0;
              p = g || d < A
            } else {
              for ((g = c / (R[0] + 1) | 0) > 1 && (R = e(R, g, c), j = e(j, g, c), I = R.length, A = j.length), T = I, F = (b = j.slice(0, I)).length; F < I;) b[F++] = 0;
              (M = R.slice()).unshift(0), O = R[0], R[1] >= c / 2 && ++O;
              do {
                g = 0, (l = n(R, b, I, F)) < 0 ? (E = b[0], I != F && (E = E * c + (b[1] || 0)), (g = E / O | 0) > 1 ? (g >= c && (g = c - 1), 1 == (l = n(h = e(R, g, c), b, v = h.length, F = b.length)) && (g--, r(h, I < v ? M : R, v, c))) : (0 == g && (l = g = 1), h = R.slice()), (v = h.length) < F && h.unshift(0), r(b, h, F, c), -1 == l && (l = n(R, b, I, F = b.length)) < 1 && (g++, r(b, I < F ? M : R, F, c)), F = b.length) : 0 === l && (g++, b = [0]), w[d++] = g, l && b[0] ? b[F++] = j[T] || 0 : (b = [j[T]], F = 1)
      ...
      function W(e, n) {
        ...
        if (null == n ? (g = !1, l = D) : l = n, v.precision = l += 10, t = (r = O(h)).charAt(0), !(Math.abs(u = p.e) < 15e14)) return c = _(v, l + 2, D).times(u + ""), p = W(new v(t + "." + r.slice(1)), l - 10).plus(c), v.precision = D, null == n ? k(p, D, y, g = !0) : p;
        ...
        for (u = p.e, t > 1 ? (p = new v("0." + r), u++) : p = new v(t + "." + r.slice(1)), f = p, a = o = p = P(p.minus(1), p.plus(1), l, 1), d = k(p.times(p), l, 1), i = 3;;) {
          if (o = k(o.times(d), l, 1), O((c = a.plus(P(o, new v(i), l, 1))).d).slice(0, l) === O(a.d).slice(0, l)) {
            if (a = a.times(2), 0 !== u && (a = a.plus(_(v, l + 2, D).times(u + ""))), a = P(a, new v(m), l, 1), null != n) return v.precision = D, a;
      ...
      function Y(e, n) {
        ...
        return u < 0 ? new t(0 * e.s) : (e.e = R(c, l), e.d = c, g = !1, o && (e = P(e, i, 4 * s)), a && (e = e.times(Math.abs(a) < 54 ? w(2, a) : Ze.pow(2, a))), g = !0, e)
      }
          ...
          case "unit":
            ...
            if (S = void 0, B) S = Er(r, e.roundedNumber.times(Ue.pow(10, a)).toNumber(), n.units.simple[I][M]);
              ...
              var P = I.split("-per-"),
                ...
                j = P[1];
              B = n.units.simple[k];
              var R = Er(r, e.roundedNumber.times(Ue.pow(10, a)).toNumber(), n.units.simple[k][M]),
                _ = n.units.simple[j].perUnit[M];
              if (_) S = _.replace("{0}", R);
              else {
                var L = n.units.compound.per[M],
                  q = Er(r, 1, n.units.simple[j][M]);
                S = S = L.replace("{0}", R).replace("{1}", q.replace("{0}", ""))
              }
            }
            T = [];
