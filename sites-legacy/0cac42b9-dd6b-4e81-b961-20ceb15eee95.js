try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "0cac42b9-dd6b-4e81-b961-20ceb15eee95", e._sentryDebugIdIdentifier = "sentry-dbid-0cac42b9-dd6b-4e81-b961-20ceb15eee95")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    24162: (e, t, s) => {
      ...
      var y = {
        ...
        S = {
          ...
          loopFix: function(e) {
            ...
            let y = v ? Math.max(b, Math.ceil(w / 2)) : b;
            y % b !== 0 && (y += b - y % b), y += h.loopAdditionalSlides, c.loopedSlides = y;
            const S = c.grid && h.grid && h.grid.rows > 1;
            p.length < w + y || "cards" === c.params.effect && p.length < w + 2 * y ? (0, n.v)("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : S && "row" === h.grid.fill && (0, n.v)("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const E = [],
              T = [],
      ...
      const Z = (0, i.createContext)(null),
        ...
        Q = (0, i.forwardRef)(function(e, t) {
          ...
          const [p, u] = (0, i.useState)("swiper"), [m, f] = (0, i.useState)(null), [h, v] = (0, i.useState)(!1), g = (0, i.useRef)(!1), w = (0, i.useRef)(null), b = (0, i.useRef)(null), y = (0, i.useRef)(null), S = (0, i.useRef)(null), E = (0, i.useRef)(null), T = (0, i.useRef)(null), x = (0, i.useRef)(null), C = (0, i.useRef)(null), {
            params: M,
            passedParams: P,
            rest: k,
            events: L
          ...
          const z = () => {
            ...
            if (delete e.wrapperClass, b.current = new B(e), b.current.virtual && b.current.params.virtual.enabled) {
              ...
              V(b.current.params.virtual, e), V(b.current.originalParams.virtual, e)
            }
          };
          return w.current || z(), b.current && b.current.on("_beforeBreakpoint", _), (0, i.useEffect)(() => () => {
            ...
            if (t && (t.current = w.current), w.current) return b.current.destroyed && z(),
              function(e, t) {
                ...
                R(t) && i && r && (l.params.navigation.nextEl = i, l.originalParams.navigation.nextEl = i, l.params.navigation.prevEl = r, l.originalParams.navigation.prevEl = r), F(t) && n && (l.params.pagination.el = n, l.originalParams.pagination.el = n), j(t) && a && (l.params.scrollbar.el = a, l.originalParams.scrollbar.el = a), l.init(s)
              }({
                el: w.current,
                nextEl: E.current,
                prevEl: T.current,
            ...
            }(P, y.current, I, S.current, e => e.key);
            return y.current = P, S.current = I, e.length && b.current && !b.current.destroyed && function(e) {
              let {
                swiper: t,
                slides: s,
                passedParams: i,
              ...
              r.includes("loop") && t.isElement && (p.loop && !i.loop ? E = !0 : !p.loop && i.loop ? T = !0 : x = !0), c.forEach(e => {
            ...
            swiper: b.current,
            swiperSlideIndex: t
          })), O["wrapper-end"]), R(M) && i.createElement(i.Fragment, null, i.createElement("div", {
            ref: T,
