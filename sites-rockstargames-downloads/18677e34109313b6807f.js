/*! For license information please see 18677e34109313b6807f.js.LICENSE.txt */
      ...
      e.exports = function() {
        ...
        return function t() {
          ...
          var he, ge, ye = G,
            ...
            _e = K,
            we = null,
            Se = O({}, [].concat(r(C), r(D), r(M), r(F), r(H))),
            ke = null,
            xe = O({}, [].concat(r(z), r(P), r(j), r(B))),
            ...
            $e = {},
            Ke = null,
            Ve = O({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]),
            Xe = null,
            ...
            mt = function(t) {
              ct && ct === t || (t && "object" === e(t) || (t = {}), t = L(t), he = he = -1 === lt.indexOf(t.PARSER_MEDIA_TYPE) ? "text/html" : t.PARSER_MEDIA_TYPE, ge = "application/xhtml+xml" === he ? N : T, we = "ALLOWED_TAGS" in t ? O({}, t.ALLOWED_TAGS, ge) : Se, ke = "ALLOWED_ATTR" in t ? O({}, t.ALLOWED_ATTR, ge) : xe, at = "ALLOWED_NAMESPACES" in t ? O({}, t.ALLOWED_NAMESPACES, N) : it, Je = "ADD_URI_SAFE_ATTR" in t ? O(L(Qe), t.ADD_URI_SAFE_ATTR, ge) : Qe, Xe = "ADD_DATA_URI_TAGS" in t ? O(L(Ze), t.ADD_DATA_URI_TAGS, ge) : Ze, Ke = "FORBID_CONTENTS" in t ? O({}, t.FORBID_CONTENTS, ge) : Ve, Le = "FORBID_TAGS" in t ? O({}, t.FORBID_TAGS, ge) : {}, Re = "FORBID_ATTR" in t ? O({}, t.FORBID_ATTR, ge) : {}, $e = "USE_PROFILES" in t && t.USE_PROFILES, Ce = !1 !== t.ALLOW_ARIA_ATTR, De = !1 !== t.ALLOW_DATA_ATTR, Me = t.ALLOW_UNKNOWN_PROTOCOLS || !1, Ie = !1 !== t.ALLOW_SELF_CLOSE_IN_ATTR, Fe = t.SAFE_FOR_TEMPLATES || !1, Ue = t.WHOLE_DOCUMENT || !1, Pe = t.RETURN_DOM || !1, je = t.RETURN_DOM_FRAGMENT || !1, Be = t.RETURN_TRUSTED_TYPE || !1, ze = t.FORCE_BODY || !1, Ge = !1 !== t.SANITIZE_DOM, We = t.SANITIZE_NAMED_PROPS || !1, qe = !1 !== t.KEEP_CONTENT, Ye = t.IN_PLACE || !1, _e = t.ALLOWED_URI_REGEXP || _e, rt = t.NAMESPACE || nt, Oe = t.CUSTOM_ELEMENT_HANDLING || {}, t.CUSTOM_ELEMENT_HANDLING && ut(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (Oe.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck), t.CUSTOM_ELEMENT_HANDLING && ut(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (Oe.attributeNameCheck = t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), t.CUSTOM_ELEMENT_HANDLING && "boolean" == typeof t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && (Oe.allowCustomizedBuiltInElements = t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), Fe && (De = !1), je && (Pe = !0), $e && (we = O({}, r(H)), ke = [], !0 === $e.html && (O(we, C), O(ke, z)), !0 === $e.svg && (O(we, D), O(ke, P), O(ke, B)), !0 === $e.svgFilters && (O(we, M), O(ke, P), O(ke, B)), !0 === $e.mathMl && (O(we, F), O(ke, j), O(ke, B))), t.ADD_TAGS && (we === Se && (we = L(we)), O(we, t.ADD_TAGS, ge)), t.ADD_ATTR && (ke === xe && (ke = L(ke)), O(ke, t.ADD_ATTR, ge)), t.ADD_URI_SAFE_ATTR && O(Je, t.ADD_URI_SAFE_ATTR, ge), t.FORBID_CONTENTS && (Ke === Ve && (Ke = L(Ke)), O(Ke, t.FORBID_CONTENTS, ge)), qe && (we["#text"] = !0), Ue && O(we, ["html", "head", "body"]), we.table && (O(we, ["tbody"]), delete Le.tbody), u && u(t), ct = t)
            },
            ft = O({}, ["mi", "mo", "mn", "ms", "mtext"]),
            pt = O({}, ["foreignobject", "desc", "title", "annotation-xml"]),
          ...
          var yt = function(e) {
            ...
            At = function(e) {
              ...
              if (!we[r] || Le[r]) {
                if (!Le[r] && wt(r)) {
                  if (Oe.tagNameCheck instanceof RegExp && S(Oe.tagNameCheck, r)) return !1;
              ...
              }(e) ? (yt(e), !0) : "noscript" !== r && "noembed" !== r || !S(/<\/no(script|embed)/i, e.innerHTML) ? (Fe && 3 === e.nodeType && (t = e.textContent, t = A(t, ye, " "), t = A(t, be, " "), t = A(t, ve, " "), e.textContent !== t && (v(o.removed, {
                element: e.cloneNode()
            ...
            _t = function(e, t, n) {
              ...
              if (De && !Re[t] && S(Te, t));
                ...
                if (!(wt(e) && (Oe.tagNameCheck instanceof RegExp && S(Oe.tagNameCheck, e) || Oe.tagNameCheck instanceof Function && Oe.tagNameCheck(e)) && (Oe.attributeNameCheck instanceof RegExp && S(Oe.attributeNameCheck, t) || Oe.attributeNameCheck instanceof Function && Oe.attributeNameCheck(t)) || "is" === t && Oe.allowCustomizedBuiltInElements && (Oe.tagNameCheck instanceof RegExp && S(Oe.tagNameCheck, n) || Oe.tagNameCheck instanceof Function && Oe.tagNameCheck(n)))) return !1
              } else if (Je[t]);
              else if (S(_e, A(n, Ae, "")));
              else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== _(n, "data:") || !Xe[e])
                if (Me && !S(Ee, A(n, Ae, "")));
                else if (n) return !1;
              return !0
            },
              ...
              if (l) {
                ...
                for (i = l.length; i--;) {
                  var s = n = l[i],
                    u = s.name,
                    m = s.namespaceURI;
                  if (r = "value" === u ? n.value : w(n.value), a = ge(u), c.attrName = a, c.attrValue = r, c.keepAttr = !0, c.forceKeepAttr = void 0, Et("uponSanitizeAttribute", t, c), r = c.attrValue, !c.forceKeepAttr && (bt(u, t), c.keepAttr))
                    if (Ie || !S(/\/>/i, r)) {
          ...
          return o.sanitize = function(t) {
            ...
            if (He || mt(f), o.removed = [], "string" == typeof t && (Ye = !1), Ye) {
              if (t.nodeName) {
                var p = ge(t.nodeName);
                if (!we[p] || Le[p]) throw k("root node is forbidden and cannot be sanitized in-place")
              }
              ...
              if (!Pe && !Fe && !Ue && -1 === t.indexOf("<")) return ae && Be ? ae.createHTML(t) : t;
            ...
            return Ue && we["!doctype"] && r.ownerDocument && r.ownerDocument.doctype && r.ownerDocument.doctype.name && S(Z, r.ownerDocument.doctype.name) && (h = "<!DOCTYPE " + r.ownerDocument.doctype.name + ">\n" + h), Fe && (h = A(h, ye, " "), h = A(h, be, " "), h = A(h, ve, " ")), ae && Be ? ae.createHTML(h) : h
