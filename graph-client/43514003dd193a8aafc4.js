    ...
    4320: (t, e, n) => {
      ...
      var _ = function() {
        ...
        return t.prototype.peek = function() {
          ...
          return V(!this.recomputing, "already recomputing"), S(this), j(this) ? function(t, e) {
            return P(t), g.withValue(t, E, [t, e]),
              function(t, e) {
          ...
          this.dirty || (this.dirty = !0, this.value.length = 0, O(this), m(this))
        }, t.prototype.dispose = function() {
          var t = this;
          this.setDirty(), P(this), A(this, (function(e, n) {
            e.setDirty(), N(e, t)
          }))
      ...
      function S(t) {
        var e = g.getValue();
        if (e) return t.parents.add(e), e.childValues.has(t) || e.childValues.set(t, []), j(t) ? M(e, t) : z(e, t), e
      }
      ...
      function M(t, e) {
        V(t.childValues.has(e)), V(j(e));
        var n = !j(t);
        if (t.dirtyChildren) {
          if (t.dirtyChildren.has(e)) return
        } else t.dirtyChildren = C.pop() || new Set;
        t.dirtyChildren.add(e), n && O(t)
      }

      function z(t, e) {
        V(t.childValues.has(e)), V(!j(e));
        var n, r, i, o = t.childValues.get(e);
        0 === o.length ? t.childValues.set(e, e.value.slice(0)) : (n = o, r = e.value, (i = n.length) > 0 && i === r.length && n[i - 1] === r[i - 1] || t.setDirty()), K(t, e), j(t) || x(t)
      }

      function K(t, e) {
        var n = t.dirtyChildren;
        n && (n.delete(e), 0 === n.size && (C.length < 100 && C.push(n), t.dirtyChildren = null))
      }

      function P(t) {
        t.childValues.size > 0 && t.childValues.forEach((function(e, n) {
          N(t, n)
        })), t.forgetDeps(), V(null === t.dirtyChildren)
      }
      ...
      function B(t, e) {
        ...
        var n = new w(e.max || Math.pow(2, 16), (function(t) {
          ...
          o = function() {
            ...
            var u = n.get(o);
            u || (n.set(o, u = new _(t)), u.subscribe = e.subscribe, u.forget = function() {
              return n.delete(o)
            });
            var a = u.recompute(Array.prototype.slice.call(arguments));
            return n.set(o, u), q.add(n), g.hasValue() || (q.forEach((function(t) {
              return t.clean()
            })), q.clear()), a
          };
