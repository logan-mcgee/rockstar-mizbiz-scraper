  ...
  [782, 208], {
    ...
    5782: (t, e, i) => {
      ...
      var n = i(5489),
        s = (i(4208), i(1851)),
        o = i(7343);
      i(822), i(7469), n.C.registerHelper("hint", "graphql", ((t, e) => {
        const {
          schema: i,
          externalFragments: r
        } = e;
        ...
        const c = t.getCursor(),
          l = t.getTokenAt(c),
          a = null !== l.type && /"|\w/.test(l.string[0]) ? l.start : l.end,
          h = new o.P(c.line, a),
          u = {
            list: (0, s.g)(i, t.getValue(), h, l, r).map((t => ({
              text: t.label,
              type: t.type,
        ...
        return (null == u ? void 0 : u.list) && u.list.length > 0 && (u.from = n.C.Pos(u.from.line, u.from.ch), u.to = n.C.Pos(u.to.line, u.to.ch), n.C.signal(t, "hasCompletion", t, u, l)), u
      }))
    },
    4208: (t, e, i) => {
      i.r(e), i.d(e, {
      ...
      ! function(t) {
          ...
          if (!(i.length > 1)) {
            if (this.somethingSelected()) {
              ...
              for (var s = 0; s < i.length; s++)
                if (i[s].head.line != i[s].anchor.line) return
            }
            this.state.completionActive && this.state.completionActive.close();
            var o = this.state.completionActive = new n(this, e);
            o.options.hint && (t.signal(this, "startCompletion", this), o.update(!0))
          }
        ...
        function a(t, e) {
          ...
          function r(t, n) {
            var r;
            r = "string" != typeof n ? o((function(t) {
              return n(t, e)
            }), "bound") : i.hasOwnProperty(n) ? i[n] : n, s[t] = r
          }
          if (o(r, "addBinding"), n)
        ...
        function u(n, s) {
          this.id = "cm-complete-" + Math.floor(Math.random(1e6)), this.completion = n, this.data = s, this.picked = !1;
          var o = this,
            r = n.cm,
            c = r.getInputField().ownerDocument,
            u = c.defaultView || c.parentWindow,
            d = this.hints = c.createElement("ul");
          d.setAttribute("role", "listbox"), d.setAttribute("aria-expanded", "true"), d.id = this.id;
          var p = n.cm.options.theme;
          d.className = "CodeMirror-hints " + p, this.selectedHint = s.selectedHint || 0;
          for (var f = s.list, g = 0; g < f.length; ++g) {
            var m = d.appendChild(c.createElement("li")),
              v = f[g],
              y = e + (g != this.selectedHint ? "" : " " + i);
            null != v.className && (y = v.className + " " + y), m.className = y, g == this.selectedHint && m.setAttribute("aria-selected", "true"), m.id = this.id + "-" + g, m.setAttribute("role", "option"), v.render ? v.render(m, s, v) : m.appendChild(c.createTextNode(v.displayText || l(v))), m.hintId = g
          }
          var b = n.options.container || c.body,
            w = r.cursorCoords(n.options.alignWithWord ? s.from : null),
            C = w.left,
            H = w.bottom,
            A = !0,
            k = 0,
          ...
          d.style.left = C - k + "px", d.style.top = H - x + "px";
          var P = u.innerWidth || Math.max(c.body.offsetWidth, c.documentElement.offsetWidth),
            F = u.innerHeight || Math.max(c.body.offsetHeight, c.documentElement.offsetHeight);
          b.appendChild(d), r.getInputField().setAttribute("aria-autocomplete", "list"), r.getInputField().setAttribute("aria-owns", this.id), r.getInputField().setAttribute("aria-activedescendant", this.id + "-" + this.selectedHint);
          var M, N = n.options.moveOnOverlap ? d.getBoundingClientRect() : new DOMRect,
            E = !!n.options.paddingForScrollbar && d.scrollHeight > d.clientHeight + 1;
          if (setTimeout((function() {
              M = r.getScrollInfo()
            })), N.bottom - F > 0) {
            var I = N.bottom - N.top;
            if (w.top - (w.bottom - N.top) - I > 0) d.style.top = (H = w.top - I - x) + "px", A = !1;
            else if (I > F) {
              d.style.height = F - 5 + "px", d.style.top = (H = w.bottom - N.top - x) + "px";
              var R = r.getCursor();
              s.from.ch != R.ch && (w = r.cursorCoords(R), d.style.left = (C = w.left - k) + "px", N = d.getBoundingClientRect())
            }
          }
          var W, B = N.right - P;
          if (E && (B += r.display.nativeBarWidth), B > 0 && (N.right - N.left > P && (d.style.width = P - 5 + "px", B -= N.right - N.left - P), d.style.left = (C = w.left - B - k) + "px"), E)
            for (var K = d.firstChild; K; K = K.nextSibling) K.style.paddingRight = r.display.nativeBarWidth + "px";
          r.addKeyMap(this.keyMap = a(n, {
            moveFocus: function(t, e) {
              o.changeActive(o.selectedHint + t, e)
            },
            setFocus: function(t) {
              o.changeActive(t)
            },
            ...
            M || (M = r.getScrollInfo());
            var i = H + M.top - t.top,
              s = i - (u.pageYOffset || (c.documentElement || c.body).scrollTop);
            if (A || (s += d.offsetHeight), s <= e.top || s >= e.bottom) return n.close();
            d.style.top = i + "px", d.style.left = C + M.left - t.left + "px"
          }), t.on(d, "dblclick", (function(t) {
            var e = h(d, t.target || t.srcElement);
            e && null != e.hintId && (o.changeActive(e.hintId), o.pick())
          })), t.on(d, "click", (function(t) {
            var e = h(d, t.target || t.srcElement);
            e && null != e.hintId && (o.changeActive(e.hintId), n.options.completeOnSingleClick && o.pick())
          ...
          return 0 === L.from && 0 === L.to || this.scrollToActive(), t.signal(s, "select", f[this.selectedHint], d.childNodes[this.selectedHint]), !0
        }
        ...
        function f(e, i) {
          var n, s = e.getHelpers(i, "hint");
          if (s.length) {
            var r = o((function(t, e, i) {
              var n = d(t, s);

              function r(s) {
                if (s == n.length) return e(null);
                p(n[s], t, i, (function(t) {
        ...
        n.prototype = {
          ...
          pick: function(e, i) {
            ...
            this.cm.operation((function() {
              n.hint ? n.hint(s.cm, e, n) : s.cm.replaceRange(l(n), n.from || e.from, n.to || e.to, "complete"), t.signal(e, "pick", n), s.cm.scrollIntoView()
        ...
        }, o(c, "parseOptions"), o(l, "getText"), o(a, "buildKeyMap"), o(h, "getHintElement"), o(u, "Widget"), u.prototype = {
          close: function() {
          ...
          changeActive: function(e, n) {
            if (e >= this.data.list.length ? e = n ? this.data.list.length - 1 : 0 : e < 0 && (e = n ? 0 : this.data.list.length - 1), this.selectedHint != e) {
              ...
              s && (s.className = s.className.replace(" " + i, ""), s.removeAttribute("aria-selected")), (s = this.hints.childNodes[this.selectedHint = e]).className += " " + i, s.setAttribute("aria-selected", "true"), this.completion.cm.getInputField().setAttribute("aria-activedescendant", s.id), this.scrollToActive(), t.signal(this.data, "select", this.data.list[this.selectedHint], s)
            }
          },
        ...
        }, o(d, "applicableHelpers"), o(p, "fetchHints"), o(f, "resolveAutoHints"), t.registerHelper("hint", "auto", {
          resolve: f
          ...
          var n, s = e.getCursor(),
            ...
            c = s;
          o.start < s.ch && /\w/.test(o.string.charAt(s.ch - o.start - 1)) ? n = o.string.substr(0, s.ch - o.start) : (n = "", r = s);
