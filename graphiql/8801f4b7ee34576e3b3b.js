  ...
  [417], {
    2417: (e, t, n) => {
      ...
      ! function(e) {
        ...
        function c(e, t, n) {
          t = l(t, "g");
          for (var i = n.line, o = n.ch, h = e.lastLine(); i <= h; i++, o = 0) {
            t.lastIndex = o;
            var c = e.getLine(i),
              s = t.exec(c);
            if (s) return {
              from: r(i, s.index),
              to: r(i, s.index + s[0].length),
              match: s
            }
          }
        }
        ...
        function s(e, t, n) {
          if (!h(t)) return c(e, t, n);
          t = l(t, "gm");
          for (var i, o = 1, s = n.line, a = e.lastLine(); s <= a;) {
            for (var f = 0; f < o && !(s > a); f++) {
              var u = e.getLine(s++);
              i = null == i ? u : i + "\n" + u
            }
            o *= 2, t.lastIndex = n.ch;
            var g = t.exec(i);
            if (g) {
              var p = i.slice(0, g.index).split("\n"),
                d = g[0].split("\n"),
                m = n.line + p.length - 1,
                v = p[p.length - 1].length;
              return {
                from: r(m, v),
                to: r(m + d.length - 1, 1 == d.length ? v + d[0].length : d[d.length - 1].length),
                match: g
              }
            }
          }
        ...
        function f(e, t, n) {
          t = l(t, "g");
          for (var i = n.line, o = n.ch, h = e.firstLine(); i >= h; i--, o = -1) {
            var c = e.getLine(i),
              s = a(c, t, o < 0 ? 0 : c.length - o);
            if (s) return {
              from: r(i, s.index),
              to: r(i, s.index + s[0].length),
              match: s
        ...
        function u(e, t, n) {
          if (!h(t)) return f(e, t, n);
          t = l(t, "gm");
          for (var i, o = 1, c = e.getLine(n.line).length - n.ch, s = n.line, u = e.firstLine(); s >= u;) {
            for (var g = 0; g < o && s >= u; g++) {
              var p = e.getLine(s--);
              i = null == i ? p : p + "\n" + i
            }
            o *= 2;
            ...
            if (d) {
              var m = i.slice(0, d.index).split("\n"),
                v = d[0].split("\n"),
                x = s + m.length,
                L = m[m.length - 1].length;
              return {
                from: r(x, L),
                to: r(x + v.length - 1, 1 == v.length ? L + v[0].length : v[v.length - 1].length),
                match: d
              }
            }
          }
        ...
        function p(e, i, o, l) {
          ...
          var h = l ? t : n,
            c = h(i).split(/\r|\n\r?/);
          e: for (var s = o.line, a = o.ch, f = e.lastLine() + 1 - c.length; s <= f; s++, a = 0) {
            var u = e.getLine(s).slice(a),
              p = h(u);
            if (1 == c.length) {
              var d = p.indexOf(c[0]);
              if (-1 == d) continue e;
              return o = g(u, p, d, h) + a, {
                from: r(s, g(u, p, d, h) + a),
                to: r(s, g(u, p, d + c[0].length, h) + a)
              }
            }
            var m = p.length - c[0].length;
            if (p.slice(m) == c[0]) {
              for (var v = 1; v < c.length - 1; v++)
                if (h(e.getLine(s + v)) != c[v]) continue e;
              var x = e.getLine(s + c.length - 1),
                L = h(x),
                O = c[c.length - 1];
              if (L.slice(0, O.length) == O) return {
                from: r(s, g(u, p, m, h) + a),
                to: r(s + c.length - 1, g(x, L, O.length, h))
              }
            }
          }
        }
        ...
        function d(e, i, o, l) {
          ...
          var h = l ? t : n,
            c = h(i).split(/\r|\n\r?/);
          e: for (var s = o.line, a = o.ch, f = e.firstLine() - 1 + c.length; s >= f; s--, a = -1) {
            var u = e.getLine(s);
            a > -1 && (u = u.slice(0, a));
            var p = h(u);
            if (1 == c.length) {
              var d = p.lastIndexOf(c[0]);
              if (-1 == d) continue e;
              return {
                from: r(s, g(u, p, d, h)),
                to: r(s, g(u, p, d + c[0].length, h))
              }
            }
            var m = c[c.length - 1];
            if (p.slice(0, m.length) == m) {
              var v = 1;
              for (o = s - c.length + 1; v < c.length - 1; v++)
                if (h(e.getLine(o + v)) != c[v]) continue e;
              var x = e.getLine(s + 1 - c.length),
                L = h(x);
              if (L.slice(L.length - c[0].length) == c[0]) return {
                from: r(s + 1 - c.length, g(x, L, x.length - c[0].length, h)),
                to: r(s, g(u, p, m.length, h))
              }
            }
          }
        }
        ...
        function m(e, t, n, i) {
          ...
          this.atOccurrence = !1, this.afterEmptyMatch = !1, this.doc = e, n = n ? e.clipPos(n) : r(0, 0), this.pos = {
            from: n,
            to: n
          }, "object" == typeof i ? o = i.caseFold : (o = i, i = null), "string" == typeof t ? (null == o && (o = !1), this.matches = function(n, r) {
            return (n ? d : p)(e, t, r, o)
          }) : (t = l(t, "gm"), i && !1 === i.multiline ? this.matches = function(n, r) {
            return (n ? f : c)(e, t, r)
          } : this.matches = function(n, r) {
            return (n ? u : s)(e, t, r)
          })
        }
        o(i, "regexpFlags"), o(l, "ensureFlags"), o(h, "maybeMultiline"), o(c, "searchRegexpForward"), o(s, "searchRegexpForwardMultiline"), o(a, "lastMatchIn"), o(f, "searchRegexpBackward"), o(u, "searchRegexpBackwardMultiline"), String.prototype.normalize ? (t = o((function(e) {
          return e.normalize("NFD").toLowerCase()
        }), "doFold"), n = o((function(e) {
          return e.normalize("NFD")
        }), "noFold")) : (t = o((function(e) {
          return e.toLowerCase()
        }), "doFold"), n = o((function(e) {
          return e
        }), "noFold")), o(g, "adjustPos"), o(p, "searchStringForward"), o(d, "searchStringBackward"), o(m, "SearchCursor"), m.prototype = {
          findNext: function() {
            return this.find(!1)
          },
