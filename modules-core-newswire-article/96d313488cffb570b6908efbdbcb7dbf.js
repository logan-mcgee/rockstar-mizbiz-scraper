  ...
  [980], {
    76980: (e, a, s) => {
      ...
      const c = e => {
          ...
          return (0, i.jsx)("div", {
            className: (0, l.classList)(t, a ? d.fadeIn : "", s ? d.active : ""),
            children: r
          })
        },
        f = e => {
        ...
        m = e => {
          ...
          return a && a?.content ? (0, i.jsx)(c, {
            shouldFade: a?.fadeIn,
            condition: a?.fadeIn,
            className: (0, l.classList)(d.slot, d[s], d[t]),
