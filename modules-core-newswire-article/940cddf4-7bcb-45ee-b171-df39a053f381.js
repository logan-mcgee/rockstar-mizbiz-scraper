! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "940cddf4-7bcb-45ee-b171-df39a053f381", e._sentryDebugIdIdentifier = "sentry-dbid-940cddf4-7bcb-45ee-b171-df39a053f381")
  } catch (e) {}
}();
    ...
    21760: (e, a, t) => {
      ...
      const D = "modal-context",
        ...
        W = e => {
          ...
          const {
            track: u
          } = (0, z.useGtmTrack)(), f = (0, s.useCallback)((() => {
            u({
              event: "card_click",
              event_action: "click",
              event_category: "card",
      ...
      const be = {
        ...
        Ne = ke.withFadeIn(ye((e => {
          ...
          (0, s.useEffect)((() => {
            ...
            if (!b.current) return;
            const e = () => {
              const e = m || window.getComputedStyle(b.current).getPropertyValue("--slides-per-view");
              k(e)
            };
          ...
          const N = (0, s.useMemo)((() => {
            ...
            return w ? w.reduce(((a, s) => {
              if (s) {
                ...
                r().set(d, "payload.meta.id", i), a.push((0, l.jsx)(o.TinaParser, {
                  components: je,
                  tina: d,
                  componentProps: {
                    deckProps: {
