        ...
        n("beforeInit", () => {
          ...
          a.params.a11y.enabled && function() {
            ...
            E() && a.pagination.bullets.forEach(t => {
              a.params.pagination.clickable && (u(t), a.params.pagination.renderBullet || (g(t, "button"), v(t, e.paginationBulletMessage.replace(/\{\{index\}\}/, (0, i.i)(t) + 1)))), t.matches(r(a.params.pagination.bulletActiveClass)) ? t.setAttribute("aria-current", "true") : t.removeAttribute("aria-current")
            })
          }()
        }), n("destroy", () => {
          a.params.a11y.enabled && function() {
