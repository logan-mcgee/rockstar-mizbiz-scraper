/*! For license information please see e42f1970394455875931510c67d7d1e7.js.LICENSE.txt */ ! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "58464f90-b557-4171-99db-58632c050316", e._sentryDebugIdIdentifier = "sentry-dbid-58464f90-b557-4171-99db-58632c050316")
  } catch (e) {}
}();
  ...
  [208, 650], {
    1996: (e, a, s) => {
      ...
      function o(e, a, s) {
        var i, t = {},
          o = null,
          c = null;
        for (i in void 0 !== s && (o = "" + s), void 0 !== a.key && (o = "" + a.key), void 0 !== a.ref && (c = a.ref), a) n.call(a, i) && !l.hasOwnProperty(i) && (t[i] = a[i]);
        if (e && e.defaultProps)
    ...
    9650: (e, a, s) => {
      ...
      const l = (0, t.withTranslations)((e => {
        ...
        const y = (0, d.jsx)("div", {
          ...
          children: h.map((e => (0, d.jsx)(i.A, {
            to: e.to,
            children: e.text
          }, e.to)))
        });
        return v?.desktop && (o.background = `url(${v.desktop}) center/cover no-repeat`), (0, d.jsx)("div", {
    ...
    9208: (e, a, s) => {
      ...
      const c = e => {
        ...
        const d = t?.style ?? {};
        return i && (s?.mobile && (d["--mobile-cols"] = s.mobile), s?.desktop && (d["--desktop-cols"] = s.desktop)), (0, n.jsxs)(n.Fragment, {
      ...
      const u = {
        ...
        f = e => {
          ...
          const [l, o] = (0, t.useState)(null), [c, f] = (0, t.useState)(3), b = (0, t.useRef)(null);
          return (0, t.useEffect)((() => {
            ...
            children: [(0, n.jsxs)("div", {
              ...
              className: `\n                    ${u.limitedGridContent}\n                    ${2===d.desktop?u.columnsDesktop2:""}\n                    ${3===d.desktop?u.columnsDesktop3:""}\n                    ${d.desktop>=4?u.columnsDesktop4:""}\n                    ${s?u.noTextFit:""}\n                    ${i?u[i]:""}\n                `,
      ...
      const C = {
        ...
        V = e => {
          ...
          L().set(u, "meta.prod", g);
          let b = l?.gifVideoProps?.hasVideoInHero || !1;
          const p = l?.htmlVideoProps?.id || !1,
            k = !!l?.htmlVideoProps?.hasHtmlVideoInHero && p;
          k && b && (b = !1);
          const w = void 0 === l || !b && !k,
            h = (0, t.useMemo)((() => ({
              ...f,
          ...
          return (0, n.jsxs)("div", {
            className: (0, P.classList)(C.event, d),
            children: [b && (0, n.jsx)("div", {
              className: C.videoWrapper,
              children: (0, n.jsx)(F(), {
                hash: {
                  desktop: l?.gifVideoProps?.hash?.desktop,
                  mobile: l?.gifVideoProps?.hash?.mobile
                },
                loop: l?.gifVideoProps?.isLooping
              })
            }), k && p && (0, n.jsx)("div", {
              className: C.videoWrapper,
              children: (0, n.jsx)(E(), {
                autoplay: l?.htmlVideoProps?.autoPlay || !1,
                id: p
              })
            }), w && (0, n.jsx)(M, {
              images: a
      ...
      const z = {
        ...
        H = e => {
          ...
          return "primeGaming" === l && ["ru", "kr", "ko_kr", "ru_ru"].includes(c) ? null : (0, n.jsx)("div", {
            className: z.gamingWrapper,
            children: (0, n.jsx)("div", {
              className: `${z.gamingRewards} ${z[l]}`,
              style: o,
      ...
      const q = e => {
          ...
          const [r, d] = (0, t.useState)(null), l = (0, P.useGetCdnSource)(a?.backgroundImg?.full_src ?? null), o = (0, P.useGetCdnSource)(a?.layeredImg?.full_src ?? null), c = (0, t.useRef)(null), {
            data: u,
            error: g
      ...
      const X = e => {
        ...
        ee = e => {
          ...
          return (0, n.jsxs)(n.Fragment, {
            children: [d ?? (0, n.jsx)(m.ResponsiveSection, {
              style: {
                backgroundColor: `${t}`,
...
//# sourceMappingURL=e42f1970394455875931510c67d7d1e7.js.map