try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    n = (new e.Error).stack;
  n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "bc31dd33-2032-40e6-962d-aa776e120c9d", e._sentryDebugIdIdentifier = "sentry-dbid-bc31dd33-2032-40e6-962d-aa776e120c9d")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    87579: (e, n, a) => {
      ...
      function k(e) {
        for (var n = 1; n < arguments.length; n++) {
          ...
          n % 2 ? v(Object(a), !0).forEach((function(n) {
            var t, i, r;
            t = e, i = n, r = a[n], (i = T(i)) in t ? Object.defineProperty(t, i, {
              value: r,
              enumerable: !0,
              configurable: !0,
              writable: !0
      ...
      var A, j, S = (e, n, a) => {
          for (var t of Object.keys(e)) {
            var i;
            if (e[t] !== (null !== (i = n[t]) && void 0 !== i ? i : a[t])) return !1
          }
          return !0
        },
        w = "_1238r7n",
        N = (A = {
          defaultClassName: "_1238r7p",
          variantClassNames: {
            slideName: {
              success: "_1238r7q",
              error: "_1238r7r"
          ...
          var n = A.defaultClassName,
            a = k(k({}, A.defaultVariants), e);
          for (var t in a) {
            var i, r = null !== (i = a[t]) && void 0 !== i ? i : A.defaultVariants[t];
            if (null != r) {
              var s = r;
          ...
          get variants() {
            return x(A.variantClassNames, (e => x(e, (e => e.split(" ")[0]))))
          }
        }, j),
        y = "_1238r7o",
        G = "_1238r7k _1238r7i",
      ...
      const F = ({
        ...
        className: h()(E, "_1238r7c _1238r7b", "onScreen" === r ? P : "", "hidden" === r ? O : "", "visible" === r ? M : ""),
            ...
            children: (0, t.jsxs)("div", {
              ...
              children: [(0, t.jsx)(_.Badge.Root, {
                ...
                children: [(0, t.jsx)(_.Heading, {
                  className: h()("_1238r713", "override"),
                  level: 4,
      ...
      const W = ({
        ...
        return (0, i.useEffect)((() => {
          ...
          className: h()(E, "_1238r7d _1238r7b", "onScreen" === n ? P : "", "hidden" === n ? O : "", "visible" === n ? M : ""),
          children: [e?.introScreen?.image?.sources?.mobile && (0, t.jsx)("img", {
            src: e.introScreen.image.sources.mobile,
            className: L,
            alt: e.introScreen.image.alt
      ...
      const $ = ({
          ...
          return (0, t.jsxs)("div", {
            className: h()(E, "_1238r7e _1238r7b", R, "onScreen" === n ? P : "", "hidden" === n ? O : "", "visible" === n ? M : ""),
            children: [e?.introScreen?.image?.sources?.mobile && (0, t.jsx)("img", {
              src: e.introScreen.image.sources.mobile,
              className: L,
              alt: e.introScreen.image.alt
        ...
        J = ({
          ...
          className: h()(E, "_1238r7g", R, "onScreen" === e ? P : "", "hidden" === e ? O : "", "visible" === e ? M : ""),
      ...
      const K = "https://media-rockstargames-com.akamaized.net/mfe6/prod/__common/img/cb04fb2acd10f43aa501729b4d7d26a8.jpg",
        ...
        Z = (0, u.withIntl)((({
          ...
          const k = {
            ...
            w = `https://${X}.rockstargames.com/settings/linkedaccounts`,
            N = (0, u.useIntl)(),
            {
              track: y
            } = (0, c.useGtmTrack)(),
            ...
            [R, I] = (0, i.useState)(!1),
            [M, U] = (0, i.useState)(),
            [D, B] = (0, i.useState)("hidden"),
            [V, H] = (0, i.useState)("hidden"),
            [Q, Z] = (0, i.useState)("hidden"),
            [ee, ne] = (0, i.useState)("hidden"),
            [ae, te] = (0, i.useState)(!1),
            [ie, re] = (0, i.useState)(Y.landing),
            [se, oe] = (0, i.useState)(k.introScreen.image.sources.mobile || K),
            le = `${document.location.pathname}${document.location.search}#${h}`,
            ce = (0, l.usePrevious)(M),
            de = (0, l.usePrevious)(j),
            {
              signInUrl: ue
            } = (0, l.useScAuthLinks)(le),
            ge = e => {
              e === Y.landing ? (re(Y.landing), H("onScreen"), B("hidden"), ne("hidden"), Z("hidden")) : e === Y.success ? (re(Y.success), H("offScreen"), B("visible"), setTimeout((() => {
                H("hidden"), ne("hidden")
              }), 300), setTimeout((() => {
                B("onScreen")
              }), 100)) : e === Y.error ? (re(Y.error), H("offScreen"), ne("visible"), setTimeout((() => {
                H("hidden")
              }), 300), setTimeout((() => {
                ne("onScreen")
              }), 100)) : e === Y.unlinked && (re(Y.unlinked), H("offScreen"), Z("visible"), setTimeout((() => {
                H("hidden"), ne("hidden")
              }), 300), setTimeout((() => {
                Z("onScreen")
              }), 100))
          ...
          return (0, i.useEffect)((() => {
            const e = () => {
              ...
              a = () => {
                window.innerWidth <= O && !R ? (I(!0), ge(ie)) : window.innerWidth > O && R && I(!1), e()
              };
            ...
            z(e || [])
          }), [A?.characters?.gtao]), (0, i.useEffect)((() => {
            "boolean" != typeof ce && "boolean" != typeof de || !e || M && j && (async () => {
              const {
                result: n
            ...
            "boolean" == typeof j ? j ? U(!0) : (U(!1), H("onScreen")) : U(!0)
          }), [j]), (0, i.useEffect)((() => {
            void 0 !== C && A?.accountSynced && U(!1)
          }), [C, A?.accountSynced, U]), (0, i.useEffect)((() => {
            M || (async () => {
              P.length > 0 && C ? ge(Y.success) : ge(C ? Y.unlinked : Y.landing)
            })()
          }), [M]), (0, i.useEffect)((() => {
            if (E && !ae) {
              if (void 0 === j) return;
              ...
              children: (0, t.jsxs)(s.P.div, {
                ...
                children: [(0, t.jsx)("div", {
                  ...
                  children: M ? (0, t.jsx)("div", {
                    ...
                    children: [ie === Y.landing && (0, t.jsx)(F, {
                      content: k,
                      loggedIn: j,
                      addClaim: async () => {
                        const a = {
                    ...
                    }), ie === Y.unlinked && (0, t.jsx)($, {
                      content: k,
                      unlinkedSlide: Q,
                      returnUrl: le,
                      giftId: e
                    }), ie === Y.error && (0, t.jsx)(J, {
                      errorSlide: ee,
                      content: k
                    })]
                  })
