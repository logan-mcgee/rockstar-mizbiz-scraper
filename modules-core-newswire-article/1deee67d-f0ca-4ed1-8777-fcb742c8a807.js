! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "1deee67d-f0ca-4ed1-8777-fcb742c8a807", e._sentryDebugIdIdentifier = "sentry-dbid-1deee67d-f0ca-4ed1-8777-fcb742c8a807")
  } catch (e) {}
}();
  ...
  [2938], {
    ...
    96532: (e, t, a) => {
      ...
      a.r(t), a.d(t, {
        ...
        Wasted: () => Jt.A,
        framer: () => aa,
        useTinaModuleFetchByIds: () => Et.X,
        withInViewTracker: () => fe.r,
        withSearchbarErrorBoundary: () => ta,
      ...
      const X = e => {
        ...
        Q = (0, Y.A)((e => {
          ...
          const {
            track: b
          } = (0, _.useGtmTrack)(), v = (0, p.useRef)(null), k = (0, p.useRef)(null), w = (0, p.useRef)(null), [x, y] = (0, p.useState)(null), [j, N] = (0, p.useState)(!1), [T, S] = (0, p.useState)(null), [C, z] = (0, p.useState)(), [A, M] = (0, p.useState)(), {
            ref: E,
            inView: I
          } = (0, W.Wx)({
            threshold: .6
          }), [O, L] = (0, p.useState)(!1), [D, P] = (0, p.useState)(null), [B, V] = (0, p.useState)(!1), [R, F] = (0, p.useState)(0), [$, U] = (0, p.useState)(0);
          (0, p.useEffect)((() => {
            const e = () => {
            ...
            const e = () => {
              C && !(0, q.isEmpty)(C) && C?.height > 0 && C?.height !== R && F(C?.height)
            };
            return e(), window.addEventListener("resize", e), () => {
              window.removeEventListener("resize", e)
            }
          ...
          (0, p.useEffect)((() => {
            ...
            const e = () => {
              if (v.current) {
                const e = n || Number(window.getComputedStyle(v.current).getPropertyValue("--slides-per-view")),
                  t = n ? 1 : Number(window.getComputedStyle(v.current).getPropertyValue("--slides-per-view-multiplier"));
                S(e * t)
              }
            };
            ...
            const t = a.map(((e, t) => "cover-card" === e?.props?.tina?.payload?.meta?.type && B ? null : (0, o.jsx)(H.qr, {
      ...
      const Dt = {
        ...
        Pt = e => {
          ...
          const {
            ...
            refetch: c
          } = (0, F.useQuery)(Lt.UserGetVote, {
            skip: !0
          }), [l] = (0, F.useMutation)(Lt.UserCastVote), [d, m] = (0, p.useState)(null), u = (0, p.useCallback)((async e => {
            i({
          ...
          return (0, p.useEffect)((() => {
            ...
            className: Dt.userVote,
            children: (0, o.jsxs)("div", {
              className: Dt.voteContent,
              children: [(0, o.jsxs)("div", {
                className: Dt.info,
                children: [(0, o.jsx)("h3", {
                  children: s
                ...
                className: [Dt.voteButtons, n ? "" : Dt.loggedOutButtons].join(" "),
                children: [(0, o.jsx)("button", {
                  onClick: () => u(!0),
                  className: [Dt.upVote, d ? Dt.voteButtonActive : ""].join(" "),
                  type: "button",
                  "aria-label": "Vote up"
                }), (0, o.jsx)("button", {
                  className: [Dt.downVote, !1 === d ? Dt.voteButtonActive : ""].join(" "),
                  onClick: () => u(!1),
                  type: "button",
      ...
      const Rt = {
        ...
        Ft = e => {
          ...
          return (0, o.jsx)("div", {
            className: [Rt.screencap, s ? Rt.screencapLoaded : ""].join(" "),
            style: {
        ...
        Gt = (0, h.withLocale)((e => {
          ...
          return (0, p.useEffect)((() => {
            ...
            const t = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
              ...
              i = e => {
                u(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !f.current?.classList.contains(Ut.dragging) || t() && n(!0)
              },
              o = () => {
                t() && n(!1), u(0)
              },
              l = e => {
                "press" === e.type && g.current?.classList.add(`${Ut.disableClick}`), "tap" === e.type && (g.current?.classList.remove(`${Ut.disableClick}`), document.elementFromPoint(e.center.x, e.center.y).click())
              },
              m = () => {
                t() && n(!1), g.current && g.current.classList.remove(`${Ut.disableClick}`)
              },
              p = () => {
                t() && n(!1)
              };
            ...
            children: [(0, o.jsx)("div", {
              ...
              ref: g,
              children: (0, o.jsx)("div", {
                className: `${Ut.items} ${0!==m?Ut.dragging:""}`,
                ref: f,
                style: {
              ...
              children: [(0, o.jsx)("div", {
                ...
                children: r.map(((e, r) => {
                  return (0, o.jsx)(s.A, {
                    ...
                    tabIndex: c === r ? 0 : -1,
                    children: (0, o.jsxs)("div", {
                      className: [Ut.info, r === c ? Ut.active : ""].join(" "),
                      children: [(0, o.jsxs)("div", {
                        className: Ut.title,
                        children: [(0, o.jsx)("div", {
      ...
      const Ht = e => {
          ...
          return (0, o.jsx)("div", {
            role: "img",
            "aria-label": s,
            className: [Wt.img, l ? Wt.startAnimation : "", t ? Wt.wide : ""].join(" "),
            style: {
        ...
        Xt = e => {
          ...
          return (0, o.jsx)(s.A, {
            ...
            to: a ?? i,
            target: "_self",
            className: [Yt.fobLink, n ? Yt.wide : ""].join(" "),
            children: (0, o.jsx)(Ht, {
              title: t.title,
              titleSlug: r,
              isWideCard: n
          ...
          return w = "games" === c ? (0, o.jsx)(o.Fragment, {
            ...
            children: [(0, o.jsxs)("h3", {
              ...
              children: [r, (0, o.jsxs)("div", {
                ...
                children: [(0, o.jsx)("button", {
                  className: [Qt.arrow, Qt.previous].join(" "),
                  type: "button",
                  ref: b,
                  "aria-label": i.formatMessage(qt.previous_button_label)
                }), (0, o.jsx)("button", {
                  className: [Qt.arrow, Qt.next].join(" "),
                  type: "button",
                  ref: v,
                  "aria-label": i.formatMessage(qt.next_button_label),
                  onKeyDown: e => {
                    if ("Tab" === e.key && !e.shiftKey) {
              ...
              className: [Qt.items, f % 1 != 0 ? Qt.partial : ""].join(" "),
              children: (0, o.jsx)("div", {
      ...
      class ea extends p.Component {
        ...
        render() {
          return null !== this.state.error.code ? (0, o.jsx)(Jt.A, {
