! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "b87be5f3-bcfc-4f93-b3ba-ae3f5ffffc4d", t._sentryDebugIdIdentifier = "sentry-dbid-b87be5f3-bcfc-4f93-b3ba-ae3f5ffffc4d")
  } catch (t) {}
}();
  ...
  [1469], {
    37197: (t, e, n) => {
      ...
      function S({
        ...
        const v = (0, i.forwardRef)((function(v, V) {
          const P = {
              ...(0, i.useContext)(o),
              ...v,
              layoutId: A(v)
          ...
          }(D, M.visualElement, V), D, S, M.visualElement)))
        }));
        return v[P] = f, v
      }
      ...
      function Et(t, e, n, i) {
        wt(t, e, void 0, i);
        for (const n in e.attrs) t.setAttribute(Vt.has(n) ? n : bt(n), e.attrs[n])
      }
      ...
      const Lt = {
          useVisualState: Dt({
            ...
            onMount: (t, e, {
              ...
              ft(n, i, {
                enableHardwareAcceleration: !1
              }, vt(e.tagName), t.transformTemplate), Et(e, n)
            }
          })
        },
        Bt = {
      ...
      const Ee = {
        ...
        Se = "undefined" != typeof window ? t => window.requestAnimationFrame(t) : t => setTimeout((() => t(Pe())), Te);
      let Ae = !0,
        Ce = !1,
        Me = !1;
      const ke = ["read", "update", "preRender", "render", "postRender"],
        ...
        Ie = t => De[t].process(Ee),
        Fe = t => {
          Ce = !1, Ee.delta = Ae ? Te : Math.max(Math.min(t - Ee.timestamp, 40), 1), Ee.timestamp = t, Me = !0, ke.forEach(Ie), Me = !1, Ce && (Ae = !1, Se(Fe))
        },
        je = () => {
          Ce = !0, Ae = !0, Me || Se(Fe)
        };
      ...
      const En = "data-" + bt("framerAppearId");
      var Tn = n(87104);
      const Pn = t => 1e3 * t,
      ...
      function In(t) {
        ...
        var n;
        (0, Tn.V)(Boolean(e), `'${t}' is not an animatable color. Use the equivalent color code instead.`);
        let i = e.parse(t);
      ...
      const On = (t, e) => {
        ...
        Nn = (t, e) => {
          const n = on.createTransformer(e),
            i = Qe(t),
            o = Qe(e);
          return i.numColors === o.numColors && i.numNumbers >= o.numNumbers ? le(On(i.values, o.values), n) : ((0, Tn.$)(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), n => `${n>0?e:t}`)
        },
        $n = (t, e, n) => {
          const i = e - t;
          return 0 === i ? 1 : (n - t) / i
      ...
      function Wn(t, e, {
        ...
        const s = t.length;
        (0, Tn.V)(s === e.length, "Both input and output ranges must be the same length"), (0, Tn.V)(!i || !Array.isArray(i) || i.length === s - 1, "Array of easing functions must be of length `input.length - 1`, as it applies to the transitions **between** the defined values."), t[0] > t[s - 1] && (t = [...t].reverse(), e = [...e].reverse());
      ...
      const _n = t => 1 - Math.sin(Math.acos(t)),
        ...
        ti = t => {
          if (Array.isArray(t)) {
            (0, Tn.V)(4 === t.length, "Cubic bezier arrays must contain four numerical values.");
            const [e, n, i, o] = t;
            return Xn(e, n, i, o)
          }
          return "string" == typeof t ? ((0, Tn.V)(void 0 !== Qn[t], `Invalid easing type '${t}'`), Qn[t]) : t
        };
          ...
          },
          {
            ...
            if (!hi(t, ci) && hi(t, ui)) {
              const n = function({
                ...
                let o, s;
                (0, Tn.$)(t <= 1e3 * oi, "Spring duration must be 10 seconds or less");
                let r = 1 - e;
      ...
      function vi({
        ...
        let v, y, x, b = 0,
          ...
          V = !1,
          E = !0;
        const T = mi[r.length > 2 ? "keyframes" : p],
          P = r[0],
          S = r[r.length - 1];
        (null === (g = (f = T).needsInterpolation) || void 0 === g ? void 0 : g.call(f, P, S)) && (x = Wn([0, 100], [P, S], {
          clamp: !1
        }), r = [0, 100]);
        const A = T({
          ...m,
        ...
        return a && (l && l(), v = e((function(t) {
          if (E || (t = -t), n += t, !V) {
            ...
            y = t.value, x && (y = x(y)), V = E ? t.done : n <= 0
          }
          d && d(y), V && (0 === b && (w = void 0 !== w ? w : n), b < i ? function(t, e, n, i) {
            return i ? t >= e + n : t <= -n
          }(n, w, s, E) && (b++, "reverse" === o ? (E = b % 2 == 0, n = function(t, e = 0, n = 0, i = !0) {
            return i ? fi(e + -t, e, n) : e - (t - e) + n
          }(n, w, s, E)) : (n = fi(n, w, s), "mirror" === o && A.flipTarget()), V = !1, h && h()) : (v.stop(), c && c()))
        })), v.start()), {
          stop: () => {
            u && u(), v.stop()
          },
      ...
      const Fi = new Set(["opacity"]),
        ji = (t, e, n, i = {}) => o => {
          ...
          const l = function(t, e, n, i) {
            ...
            h = Mi(t, u),
            d = Mi(t, c);
          (0, Tn.$)(h === d, `You are trying to animate ${t} from "${u}" to "${c}". ${u} is not an animatable value - to enable this animation set ${u} to a value animatable to ${c} via the \`style\` property.`);
          let p = {
            keyframes: l,
          ...
          if ("inertia" === s.type) {
            const t = function({
              ...
              if (g(m)) x({
                ...
                let a, c;
                const h = t => {
                  a = c, c = t, e = $e(t - a, Ee.delta), (1 === r && t > i || -1 === r && t < i) && x({
                    keyframes: [t, i],
                    velocity: e
                  })
                };
      ...
      function Hi(t) {
        ...
        function s(s, r) {
          ...
          for (let e = 0; e < Yi; e++) {
            ...
            !1 === w && (m = e);
            let V = x === l[v] && x !== a[v] && b;
            if (V && i && t.manuallyAnimateOnMount && (V = !1), y.protectedKeys = {
                ...p
              }, !y.isActive && null === w || !x && !y.prevProp || d(x) || "boolean" == typeof x) continue;
            const E = (f = y.prevProp, "string" == typeof(g = x) ? g !== f : !!Array.isArray(g) && !Ve(g, f));
            let T = E || v === r && y.isActive && !V && b || e > m && b;
            ...
            for (const t in C) {
              const e = S[t],
                n = A[t];
              p.hasOwnProperty(t) || (e !== n ? At(e) && At(n) ? !Ve(e, n) || E ? M(t) : y.protectedKeys[t] = !0 : void 0 !== e ? M(t) : c.add(t) : void 0 !== e && c.has(t) ? M(t) : y.protectedKeys[t] = !0)
            }
            y.prevProp = x, y.prevResolvedValues = S, y.isActive && (p = {
              ...p,
              ...S
            }), i && t.blockInitialAnimation && (T = !1), T && !V && u.push(...P.map((t => ({
              animation: t,
              options: {
                type: v,
                ...s
      ...
      function wo(t) {
        return bo(t) || Vo(t) || t.z || t.rotate || t.rotateX || t.rotateY
      }
      ...
      function Po(t, e, n, i, o) {
        return void 0 !== o && (t = To(t, o, i)), To(t, n, i) + e
      }
      ...
      class Fo {
        ...
        resolveRefConstraints() {
          ...
          if (!t || !c(t)) return !1;
          const n = t.current;
          (0, Tn.V)(null !== n, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.");
          const {
            projection: i
          } = this.visualElement;
      ...
      function $o(t, e, n = 1) {
        (0, Tn.V)(n <= 4, `Max CSS variable fallback depth detected in property "${t}". This may indicate a circular fallback dependency.`);
          ...
          if (o.forEach((o => {
              ...
              if (At(h)) {
                const t = h.length,
                  e = null === h[0] ? 1 : 0;
                u = h[e], c = mn(u);
                for (let n = e; n < t; n++) d ? (0, Tn.V)(mn(h[n]) === d, "All keyframes must be of the same type") : (d = mn(h[n]), (0, Tn.V)(d === c || Ho(c) && Ho(d), "Keyframes must be of the same dimension as the current value"))
              } else d = mn(h);
              if (c !== d)
                if (Ho(c) && Ho(d)) {
                  const t = a.get();
      ...
      class os {
        ...
        loadFeatures(t, e, n, o, s, r) {
          const a = [];
          "production" !== ce && n && e && (0, Tn.V)(!1, "You have rendered a `motion` component within a `LazyMotion` component. This will break tree shaking. Import and render a `m` component instead.");
          for (let e = 0; e < ns; e++) {
            const n = es[e],
              {
                isEnabled: o,
      ...
      class us extends as {
        ...
        readValueFromInstance(t, e) {
          var n;
          return L.has(e) ? (null === (n = cn(e)) || void 0 === n ? void 0 : n.default) || 0 : (e = Vt.has(e) ? e : bt(e), t.getAttribute(e))
        }
      ...
      const gs = {
        ...
        vs = {
          measureLayout: function(t) {
            const [e, n] = we(), o = (0, i.useContext)(V);
      ...
      function Cs(t, e, n, i, o) {
        return t = To(t -= e, 1 / n, i), void 0 !== o && (t = To(t, 1 / o, i)), t
      }
      ...
      function Ws({
        ...
        return class {
          ...
          getClosestProjectingParent() {
            if (this.parent && !bo(this.parent.latestValues) && !Vo(this.parent.latestValues)) return (this.parent.relativeTarget || this.parent.targetDelta) && this.parent.layout ? this.parent : this.parent.getClosestProjectingParent()
          }
          calcProjection() {
            var t;
            const {
          ...
          setAnimationOrigin(t, e = !1) {
            ...
            this.animationProgress = 0, this.mixTargetDelta = e => {
              ...
              er(a.x, t.x, i), er(a.y, t.y, i), this.setTargetDelta(a), this.relativeTarget && this.relativeTargetOrigin && this.layout && (null === (n = this.relativeParent) || void 0 === n ? void 0 : n.layout) && (lo(l, this.layout.layoutBox, this.relativeParent.layout.layoutBox), o = this.relativeTarget, d = this.relativeTargetOrigin, p = l, m = i, nr(o.x, d.x, p.x, m), nr(o.y, d.y, p.y, m)), u && (this.animationValues = r, function(t, e, n, i, o, s) {
                o ? (t.opacity = Dn(0, void 0 !== n.opacity ? n.opacity : 1, Es(i)), t.opacityExit = Dn(void 0 !== e.opacity ? e.opacity : 1, 0, Ts(i))) : s && (t.opacity = Dn(void 0 !== e.opacity ? e.opacity : 1, void 0 !== n.opacity ? n.opacity : 1, i));
                for (let o = 0; o < xs; o++) {
