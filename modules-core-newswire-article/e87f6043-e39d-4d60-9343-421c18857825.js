! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      n = (new Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "e87f6043-e39d-4d60-9343-421c18857825", e._sentryDebugIdIdentifier = "sentry-dbid-e87f6043-e39d-4d60-9343-421c18857825")
  } catch (e) {}
}();
            ...
            children: [(0, b.jsxs)("div", {
              ...
              children: [(0, b.jsx)("div", {
                ...
                children: (0, b.jsxs)(w.RC, {
                  ...
                  children: [o.map((e => (0, b.jsx)(w.qr, {
                    tabIndex: "0",
                    children: (0, t.createElement)(T.CharacterCard, {
                      characterData: e,
                      key: `${e.platformUsername}-${e.platform}-${e.characterSlot}`
                    })
                  }, `${e.platformUsername}-${e.platform}-${e.characterSlot}`))), (0, b.jsx)(w.qr, {
      ...
      const E = {
        ...
        O = (0, d.withIntl)((e => {
          ...
          const x = (0, c.useLocale)(),
            ...
            F = `https://${y}.rockstargames.com/settings/linkedaccounts`,
            R = (0, c.toScLocaleString)(x),
            P = (0, d.useIntl)(),
            {
              track: U
            } = (0, i.h)(),
            ...
            Fe = (e, n) => {
              e === G.landing && (e => {
                ke(G.landing), e && we(he), ce("onScreen"), se("hidden"), ue("hidden"), le("hidden")
              })(n), e === G.success && (e => {
                ke(G.success), e && we(xe), ce("offScreen"), se("visible"), setTimeout((() => {
                  ce("hidden"), ue("hidden")
                }), 300), setTimeout((() => {
                  se("onScreen")
                }), 100)
              })(n), e === G.error && (e => {
                ke(G.error), e && we(Se), ce("offScreen"), setTimeout((() => {
                  ce("hidden")
                }), 300), setTimeout((() => {
                  ue("onScreen")
                }), 100)
              })(n), e === G.unlinked && (e => {
                ke(G.unlinked), e && we(je), ce("offScreen"), le("visible"), setTimeout((() => {
                  ce("hidden"), ue("hidden")
                }), 300), setTimeout((() => {
                  le("onScreen")
                }), 100)
            ...
            Re = () => {
              "disabled" === fe ? (async () => {
                ...
                if (X.length > 0) {
                  ...
                  Fe(n ? G.success : G.error, !1)
                } else Fe(Y ? G.unlinked : G.landing, !1)
              })() : "success" === fe ? Fe(G.success, !1) : "error" === fe ? Fe(G.error, !1) : "unlinked" === fe && Fe(G.unlinked, !1)
            };
          return (0, t.useEffect)((() => {
            const e = () => {
              ...
              n = () => {
                ze(), window.innerWidth <= B && !ee && (ne(!0), Fe(_e, !0)), window.innerWidth > B && ee && ne(!1), e()
              };
            return ne(window.innerWidth <= B), e(), window.addEventListener("resize", n), () => {
              window.removeEventListener("resize", n)
            }
          }), [_e, ee, H, V, Q, D]), (0, t.useEffect)((() => {
            _e === G.success && pe !== xe ? we(xe) : _e === G.error && pe !== Se ? we(Se) : _e === G.landing && pe !== he ? we(he) : _e === G.unlinked && pe !== je && we(je)
          }), [Se, xe, pe, je, he]), (0, t.useEffect)((() => {
            qe || (Oe(!0), ze(), Ee && _e === G.success && we(D?.current?.scrollHeight || 0))
          }), [H, V, Q, D]), (0, t.useEffect)((() => {
            const e = I?.characters?.gtao;
            Z(e || [])
          }), [I]), (0, t.useEffect)((() => {
            "boolean" != typeof Ie && "boolean" != typeof Me || !n || ae && M && (async () => {
              const {
                result: e
          ...
          }), [ae, M, n]), (0, t.useEffect)((() => {
            "boolean" == typeof M ? M ? te(!0) : (te(!1), ce("onScreen")) : te(!0)
          }), [M]), (0, t.useEffect)((() => {
            Y && X.length > 0 ? (ye(!0), Fe(G.success, !0)) : Y && 0 === X.length ? Fe(G.unlinked, !0) : "boolean" != typeof Y && Y || Fe(G.landing, !0)
          }), [Y]), (0, t.useEffect)((() => {
            if (W && !ge) {
              if (void 0 === M) return;
              U({
                ...
                children: [(0, b.jsx)("div", {
                  ...
                  children: ae ? (0, b.jsx)("div", {
                    ...
                    children: [(0, b.jsx)(p, {
                      ...
                      signin: () => {
                        const e = `${N}?returnUrl=${encodeURIComponent(Le)}&lang=${R}`;
                        U({
                          element_placement: "WOC",
                          event: "cta_login",
                          link_url: e,
                      ...
                      platformLogin: e => `https://${C}.rockstargames.com/tpa/${e}/link/?cid=${q}&lang=${R}&returnUrl=${encodeURIComponent(Le)}&accessToken=${L}`,
                      giftId: n
                    }), (0, b.jsx)(j, {
                      s: E,
                      errorSlide: de,
