try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "8b450212-2e13-47b1-b7e2-76e51a72a1b4", t._sentryDebugIdIdentifier = "sentry-dbid-8b450212-2e13-47b1-b7e2-76e51a72a1b4")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
          ...
          return c(e, t), Object.defineProperty(e.prototype, "parentNode", {
            ...
            if (this.state.isResizing && this.resizable && this.window) {
              ...
              if (S = W.newWidth, z = W.newHeight, this.props.grid) {
                var E = b(S, this.props.grid[0], this.props.gridGap ? this.props.gridGap[0] : 0),
                  M = b(z, this.props.grid[1], this.props.gridGap ? this.props.gridGap[1] : 0),
                  k = this.props.snapGap || 0;
                S = 0 === k || Math.abs(E - S) <= k ? E : S, z = 0 === k || Math.abs(M - z) <= k ? M : z
              }
              var _ = {
                width: S - u.width,
                height: z - u.height
              ...
              "row" === this.flexDir ? T.flexBasis = T.width : "column" === this.flexDir && (T.flexBasis = T.height);
              var L = this.state.width !== T.width,
                C = this.state.height !== T.height,
                O = this.state.flexBasis !== T.flexBasis,
                D = L || C || O;
              D && (0, r.flushSync)(function() {
                e.setState(T)
              }), this.props.onResize && D && this.props.onResize(t, l, this.resizable, _)
            }
