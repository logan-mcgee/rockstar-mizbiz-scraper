try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    n = (new e.Error).stack;
  n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "1544ceb9-b4e7-4953-9c8d-85ade639262d", e._sentryDebugIdIdentifier = "sentry-dbid-1544ceb9-b4e7-4953-9c8d-85ade639262d")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    60951(e, n, r) {
      ...
      T.absoluteValue = T.abs = function() {
        ...
        if (n)
          if (r.length > 1) u = !0;
            ...
            u = 1 !== i
          } if (g = !1, o = G(c, s = f + 5), t = n ? j(l, s + 10) : G(e, s), M((a = B(o, t, s, 1)).d, i = f, d))
          do {
      ...
      var B = function() {
        ...
        return function(t, i, o, s, a, c) {
          ...
          for (c ? (m = 1, f = t.e - i.e) : (c = C, m = 7, f = D(t.e / m) - D(i.e / m)), I = _.length, T = k.length, w = (y = new O(B)).d = [], d = 0; _[d] == (k[d] || 0); d++);
          if (_[d] > (k[d] || 0) && f--, null == o ? (N = o = O.precision, s = O.rounding) : N = a ? o + (t.e - i.e) + 1 : o, N < 0) w.push(1), p = !0;
          else {
            if (N = N / m + 2 | 0, d = 0, 1 == I) {
              ...
              (M = _.slice()).unshift(0), A = _[0], _[1] >= c / 2 && ++A;
              do {
                g = 0, (l = n(_, b, I, F)) < 0 ? (E = b[0], I != F && (E = E * c + (b[1] || 0)), (g = E / A | 0) > 1 ? (g >= c && (g = c - 1), 1 == (l = n(h = e(_, g, c), b, v = h.length, F = b.length)) && (g--, r(h, I < v ? M : _, v, c))) : (0 == g && (l = g = 1), h = _.slice()), (v = h.length) < F && h.unshift(0), r(b, h, F, c), -1 == l && (l = n(_, b, I, F = b.length)) < 1 && (g++, r(b, I < F ? M : _, F, c)), F = b.length) : 0 === l && (g++, b = [0]), w[d++] = g, l && b[0] ? b[F++] = k[x] || 0 : (b = [k[x]], F = 1)
          ...
          case "unit":
            ...
            if (S = void 0, B) S = pr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[M][O]);
              ...
              var P = M.split("-per-"),
                ...
                _ = P[1];
              B = n.units.simple[k];
              var j = pr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[k][O]),
                R = n.units.simple[_].perUnit[O];
              if (R) S = R.replace("{0}", j);
              else {
                var L = n.units.compound.per[O],
                  q = pr(r, 1, n.units.simple[_][O]);
      ...
      function xr(e, n, r, t, i) {
        ...
        var f = jn(n, "roundingMode", "string", ["ceil", "floor", "expand", "trunc", "halfCeil", "halfFloor", "halfExpand", "halfTrunc", "halfEven"], "halfExpand"),
          d = jn(n, "roundingPriority", "string", ["auto", "morePrecision", "lessPrecision"], "auto"),
          g = jn(n, "trailingZeroDisplay", "string", ["auto", "stripIfInteger"], "auto");
      ...
      function Tr(e, n) {
        ...
        var r = jn(n, "style", "string", ["decimal", "percent", "currency", "unit"], "decimal");
        e.style = r;
        var t = jn(n, "currency", "string", void 0, void 0);
        en(void 0 === t || Wn(t), "Malformed currency code", RangeError), en("currency" !== r || void 0 !== t, "currency cannot be undefined", TypeError);
        var i = jn(n, "currencyDisplay", "string", ["code", "symbol", "narrowSymbol", "name"], "symbol"),
          u = jn(n, "currencySign", "string", ["standard", "accounting"], "standard"),
          o = jn(n, "unit", "string", void 0, void 0);
        ...
        var s = jn(n, "unitDisplay", "string", ["short", "narrow", "long"], "short");
      ...
      function Ar(e, n, r, i) {
        var u = i.getInternalSlots,
          ...
          m = jn(d, "localeMatcher", "string", ["lookup", "best fit"], "best fit");
        g.localeMatcher = m;
        var p = jn(d, "numberingSystem", "string", void 0, void 0);
        ...
        var D, w, b = y.style,
          F = jn(d, "notation", "string", ["standard", "scientific", "engineering", "compact"], "standard");
        ...
        xr(y, d, D, w, F);
        var N = jn(d, "compactDisplay", "string", ["short", "long"], "short"),
          C = "auto";
        "compact" === F && (y.compactDisplay = N, C = "min2");
        var S = Ln(d, "useGrouping", ["min2", "auto", "always"], "always", !1, C);
        y.useGrouping = S;
        var x = jn(d, "signDisplay", "string", ["auto", "never", "always", "exceptZero", "negative"], "auto");
      ...
      function Mr(e, n, r) {
        return void 0 !== r && jn(r = ln(r), "localeMatcher", "string", ["lookup", "best fit"], "best fit"), (0, Cr.LookupSupportedLocales)(Array.from(e), n)
      }
