! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "8f182948-f062-4258-a676-866620f08982", e._sentryDebugIdIdentifier = "sentry-dbid-8f182948-f062-4258-a676-866620f08982")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [285], {
    60285: (e, i, _) => {
      ...
      var c = _(89779);
      const a = "rockstargames-modules-core-newswire-articleff481c537a56a6fcdb1be85dfbc8944e";
      var t = _(46632);
      const r = (0, s.withIntl)((e => {
        let {
          children: i,
          to: _ = "#",
          alt: o = "",
        ...
        const m = (0, n.useRef)(null),
          k = (0, s.useIntl)(),
          f = !/^(https?|mailto):/i.test(_),
          g = /^#/.test(_),
          b = u?.target ?? (r ? "_blank" : "_self");
        let {
          ...w
        } = u, h = "";
        if ("aria-label" in w && w["aria-label"] && (h = "_blank" === b ? `${w["aria-label"]} ${k.formatMessage(l.aria_label_open_new_window)}` : w["aria-label"]), (0, n.useEffect)((() => {
            p && m?.current && m.current.focus()
          }), [m?.current, p]), g) {
          const e = e => {
            e.preventDefault(), document?.querySelector(`[id='${_.replace("#","")}']`)?.scrollIntoView({
              behavior: "smooth",
              block: "center"
            }), d && d(e)
          };
          return (0, t.jsxs)("a", {
            ...
            "aria-label": h,
            ref: m,
            children: [i, "_blank" === b && !h && (0, t.jsx)("span", {
              className: a,
              children: k.formatMessage(l.aria_label_open_new_window)
            })]
          })
        }
        if (f) return (0, t.jsxs)(c.NavLink, {
          title: o,
          to: _,
          onClick: d,
          ...w,
        ...
        const v = Object.keys(w).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, i) => ({
          ...e,
          [i]: u[i]
        })), {});
        return "function" == typeof v?.className && delete v.className, (0, t.jsxs)("a", {
          href: _,
          title: o,
          onClick: d,
          target: b,
    ...
    56309: (e, i, _) => {
      ...
      var n = _(30452),
        ...
        a = _(13963);
      const t = (e, i) => {
          e && i ? document.cookie = `${e}=${i}; domain=${r()}; path=/;` : console.log(`Couldn't set cookie (${e}) to value (${i})`)
        },
        r = () => {
        ...
        d = e => {
          const i = document.cookie.split("; "),
            _ = `${e}=`,
            n = i.find((e => e.startsWith(_))),
            s = n?.substring(_.length, n.length);
          return s
        },
        p = [{
          label: "Deutsch",
        ...
        k = () => {
          const {
            ...
            const i = u.map((e => e.subdomaincom)),
              _ = e.pathname.substring(1).split("/"),
              n = "detect-locals" === _[0] ? 1 : 0;
            return -1 !== i.indexOf(_[n]) ? _[n] : null
          })(e), n = (e => {
            const i = e.search.substring(1).split("&").find((e => e.startsWith("lang")));
            return i?.split("=")[1]
          })(e), s = m;
          let o = s;
          const l = `rockstarweb_lang.${i.cookieIdentifier}`,
            c = d(l);
          o = i.currentSite?.site === a.C.www ? u.find((e => e.subdomaincom === n)) || u.find((e => e.subdomaincom === _)) || s : u.find((e => e.iso === c)) || s;
          const [r, p] = function(e, i) {
            let _ = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const n = d(e);
            return n && !_ || t(e, i), [n, (s = e, e => {
              t(s, e)
            })];
            var s
          }(l, o.iso);
      ...
      const g = e => {
        ...
        const s = (0, l.useMemo)((() => function(e) {
            let [i, _] = e.split(/[-_]/);
            return _ = _?.toLowerCase(), "cn" === _ && (_ = "hans"), i && _ || (i = "en", _ = "us"), [i, _]
          }(_)), [_]),
          o = (0, l.useMemo)((() => function(e, i) {
            return e?.[i] ?? {}
          }(i, s[1])), [_, i]);
        return (0, f.jsx)(c.A, {
          messages: o,
    ...
    13963: (e, i, _) => {
      ...
      const n = {
        ...
        o = () => {
          ...
          const {
            location: i
          } = window, _ = i.hostname.substring(0, i.hostname.indexOf(".rockstargames.com")), n = s.findIndex((i => Object.entries(i.sites).findIndex((i => {
            let [n, s] = i;
            return s === _ && (e = {
              site: n,
              subDomain: s
