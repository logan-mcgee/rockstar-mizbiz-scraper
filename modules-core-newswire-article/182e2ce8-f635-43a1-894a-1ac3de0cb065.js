      ...
      const F = "undefined" != typeof window && void 0 !== window.document && void 0 !== window.document.createElement,
        ...
        P = o.forwardRef((function(e, t) {
          let {
            ...
            relative: p.relative
          }), v = (0, a.zy)(), b = o.useContext(a.Rq), {
            navigator: g
          } = o.useContext(a.jb), y = null != b && ne(w) && !0 === f, R = g.encodeLocation ? g.encodeLocation(w).pathname : w.pathname, S = v.pathname, E = b && b.navigation && b.navigation.location ? b.navigation.location.pathname : null;
        ...
        O = o.forwardRef(((e, t) => {
          ...
          } = e, v = s(e, b), h = "get" === u.toLowerCase() ? "get" : "post", g = Y(c, {
            relative: m
          });
