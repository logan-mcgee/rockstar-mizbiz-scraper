! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "852ea3f2-6fa4-4223-b174-a5eb12f67b7f", e._sentryDebugIdIdentifier = "sentry-dbid-852ea3f2-6fa4-4223-b174-a5eb12f67b7f")
  } catch (e) {}
}();
  ...
  [2553], {
    ...
    76612: (e, t, a) => {
      ...
      a.r(t), a.d(t, {
        ...
        Wasted: () => cs.A,
        framer: () => ms,
        useTinaModuleFetchByIds: () => Fa.X,
        withInViewTracker: () => je.r,
        withSearchbarErrorBoundary: () => ds,
      ...
      const J = {
        ...
        ne = e => {
          ...
          const k = (e => {
            ...
            v = (0, m.useGetCdnSource)(a?.mobile?.full_src ?? null),
            w = (0, m.useGetCdnSource)(a?.desktop?.full_src ?? v),
            _ = (0, m.useGetCdnSource)(d?.mobile?.full_src ?? null),
            x = (0, m.useGetCdnSource)(d?.desktop?.full_src ?? _);
          return (0, c.jsxs)(Z.P.div, {
            className: (0, m.classList)(J.hero, r),
            style: {
              "--background-image-desktop": `url(${w})`,
              "--background-image-mobile": `url(${v})`,
              "--layered-image-desktop": `url(${x})`,
      ...
      const Le = (0, b.withTranslations)((e => {
        ...
        const {
          ...
          tagId: l = null
        } = (0, h.useParams)(), [m, u] = (0, p.useState)(l ?? s ?? o.get("tag_id")), [g, f] = (0, p.useState)(1), [b, v] = (0, p.useState)([]), [w, _] = (0, p.useState)(null), {
          data: x
        } = (0, R.useQuery)(Me(), {
          variables: {
            tagId: Number(m),
        ...
        return (0, p.useEffect)((() => {
          ...
          x && x.posts && x.posts.paging && _(x.posts.paging), x && x.posts && x.posts.results && v(b.concat(x.posts.results))
      ...
      const Ca = {
        ...
        Aa = e => {
          ...
          const s = t ? "span" : i.A;
          return (0, c.jsx)(s, {
            className: [Ca.rockstarLogo, a || ""].join(" "),
      ...
      const Ua = {
        ...
        Wa = e => {
          ...
          const {
            ...
            refetch: o
          } = (0, R.useQuery)(Ha.UserGetVote, {
            skip: !0
          }), [l] = (0, R.useMutation)(Ha.UserCastVote), [d, m] = (0, p.useState)(null), u = (0, p.useCallback)((async e => {
            i({
              event: "cta_" + (e ? "like" : "dislike"),
              text: `${s} ${a}`
            });
          ...
          return (0, p.useEffect)((() => {
            ...
            className: Ua.userVote,
            children: (0, c.jsxs)("div", {
              className: Ua.voteContent,
              children: [(0, c.jsxs)("div", {
                className: Ua.info,
                children: [(0, c.jsx)("h3", {
                  children: r
                ...
                className: [Ua.voteButtons, n ? "" : Ua.loggedOutButtons].join(" "),
                children: [(0, c.jsx)("button", {
                  onClick: () => u(!0),
                  className: [Ua.upVote, d ? Ua.voteButtonActive : ""].join(" "),
                  type: "button",
                  "aria-label": "Vote up"
                }), (0, c.jsx)("button", {
                  className: [Ua.downVote, !1 === d ? Ua.voteButtonActive : ""].join(" "),
                  onClick: () => u(!1),
                  type: "button",
      ...
      const Ya = {
        ...
        Qa = e => {
          ...
          return (0, c.jsx)("div", {
            className: [Ya.screencap, r ? Ya.screencapLoaded : ""].join(" "),
            style: {
        ...
        Ja = (0, b.withLocale)((e => {
          ...
          return (0, p.useEffect)((() => {
            ...
            const t = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
              ...
              i = e => {
                u(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !f.current?.classList.contains(Za.dragging) || t() && n(!0)
              },
              c = () => {
                t() && n(!1), u(0)
              },
              d = e => {
                "press" === e.type && g.current?.classList.add(`${Za.disableClick}`), "tap" === e.type && (g.current?.classList.remove(`${Za.disableClick}`), document.elementFromPoint(e.center.x, e.center.y).click())
              },
              m = () => {
                t() && n(!1), g.current && g.current.classList.remove(`${Za.disableClick}`)
              },
              p = () => {
                t() && n(!1)
              };
            ...
            children: [(0, c.jsx)("div", {
              ...
              ref: g,
              children: (0, c.jsx)("div", {
                className: `${Za.items} ${0!==m?Za.dragging:""}`,
                ref: f,
                style: {
              ...
              children: [(0, c.jsx)("div", {
                ...
                children: s.map(((e, s) => {
                  return (0, c.jsxs)(i.A, {
                    className: [Za.info, s === o ? Za.active : ""].join(" "),
                    "data-gtm-category": "Carousel",
                    ...
                    children: [(0, c.jsxs)("div", {
                      className: Za.title,
                      children: [(0, c.jsxs)("div", {
                        className: Za.gameTitle,
                        children: [e.game.title, "fr_fr" === t && " "]
                      }), (0, c.jsx)("h2", {
                        className: Za.videoTitle,
                        children: e.title
                      })]
                    }), (0, c.jsx)(d.A, {
                      className: Za.cta,
      ...
      const as = e => {
          ...
          return (0, c.jsx)("div", {
            role: "img",
            "aria-label": r,
            className: [ts.img, l ? ts.startAnimation : "", t ? ts.wide : ""].join(" "),
            style: {
        ...
        rs = e => {
          ...
          return (0, c.jsx)(i.A, {
            ...
            to: a ?? r,
            target: "_self",
            className: [ss.fobLink, n ? ss.wide : ""].join(" "),
            children: (0, c.jsx)(as, {
              title: t.title,
              titleSlug: s,
              isWideCard: n
        ...
        ns = (0, ce.withIntl)((e => {
          ...
          return _ = "games" === o ? (0, c.jsx)(c.Fragment, {
            ...
            className: is.videoList,
            children: [(0, c.jsxs)("h3", {
              className: is.sectionHeader,
              children: [s, (0, c.jsxs)("div", {
                className: is.arrowNav,
                children: [(0, c.jsx)("button", {
                  className: [is.arrow, is.previous].join(" "),
                  type: "button",
                  ref: b,
                  "aria-label": i.formatMessage(es.previous_button_label)
                }), (0, c.jsx)("button", {
                  className: [is.arrow, is.next].join(" "),
                  type: "button",
                  ref: v,
                  "aria-label": i.formatMessage(es.next_button_label),
                  onKeyDown: e => {
                    if ("Tab" === e.key && !e.shiftKey) {
              ...
              className: [is.items, f % 1 != 0 ? is.partial : ""].join(" "),
              children: (0, c.jsx)("div", {
                className: is.trackWrapper,
      ...
      class ls extends p.Component {
        ...
        render() {
          return null !== this.state.error.code ? (0, c.jsx)(cs.A, {
