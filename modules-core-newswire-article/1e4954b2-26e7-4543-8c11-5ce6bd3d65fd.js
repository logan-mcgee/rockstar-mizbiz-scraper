try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "1e4954b2-26e7-4543-8c11-5ce6bd3d65fd", e._sentryDebugIdIdentifier = "sentry-dbid-1e4954b2-26e7-4543-8c11-5ce6bd3d65fd")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [4453], {
    73951(e, t, r) {
      ...
      const c = "requestAnimationFrame" in window ? (e = {
        ...
        m = e => {
          ...
          const t = e.filter(f);
          for (let e = 0; e < 2; e++) t.forEach(p), t.forEach(e => {
            h(e), u(e)
          }), t.forEach(y)
        },
        u = e => e.dirty = 0,
      ...
      const F = (0, n.createContext)({
        ...
        R = (0, n.forwardRef)(function({
          ...
          const {
            ...
            max: d,
            mode: m
          } = (0, n.useContext)(F), u = (0, n.useRef)(null), p = (0, n.useRef)(null);
          (0, n.useEffect)(() => (p.current = C(u.current, {
            minSize: c,
            maxSize: d,
            multiLine: "multi" === m
          }), () => p.current.unsubscribe()), [c, d, m]), (0, n.useEffect)(() => {
            if (null === l.current || null === p.current) return;
            const e = new ResizeObserver(() => {
              p.current.fit()
            });
            return e.observe(l.current), () => e.disconnect()
          }, [l, p]), (0, n.useEffect)(() => {
            document.fonts.ready.then(() => p.current && p.current.fit())
          }, []);
          const f = (0, T.UP)(u, o),
            b = (0, s.v6)({
              className: "p5vfye0",
        ...
        l = ({
          ...
          return c ? e.split(c).map(e => d.push(e)) : d.push(e), (0, i.jsxs)(o, {
            ...
            children: [(0, i.jsx)(i.Fragment, {
              ...
              children: d.shift() && c && d.length >= 1 && (0, i.jsx)(a.Root, {
                min: 8,
                max: 1e3,
                mode: "single",
                children: (0, i.jsx)(a.Text, {
          ...
          return (0, i.jsx)(c, {
            ...
            children: (0, i.jsx)("figure", {
              children: (0, i.jsxs)("div", {
                className: (0, s.default)("rockstargames-modules-core-newswire-articled9ac792281efe15bcd4589b028d1c27b", g ? "rockstargames-modules-core-newswire-articlee430c4662cd185f58259d4a8d8b322de" : "", f?.hiddenMobile ? "hiddenMobile" : "", f?.hiddenLarge ? "hiddenLarge" : "", f?.className, p),
                ...
                children: [(0, i.jsx)(l.A, {
                  ...
                  image: m,
                  className: p
                }), h, m?.caption && (0, i.jsx)("figcaption", {
    ...
    95967(e, t, r) {
      ...
      const s = ({
        ...
        l = ({
          ...
          const {
            isMobile: p
          } = (0, a.useWindowResize)(), f = p ? u.imageMobileStyle : u.imageDesktopStyle;
          ...
          return (0, i.jsx)("div", {
            ...
            children: (0, i.jsx)(s, {
              ...
              src: p ? u.mobile || u.desktop : u?.desktop || u?.mobile,
              alt: m,
              role: d,
              className: e
            })
    ...
    54563(e, t, r) {
      ...
      var i = r(39793),
        n = r(93082);
      const a = (0, r(13331).setContextItem)({
    ...
    25993(e, t, r) {
      ...
      const s = e => {
        ...
        o = ({
          ...
          const u = (0, n.useLocale)(),
            {
              meta: p = {}
            } = (0, a.i)() ?? {},
            [f, b] = (0, i.useState)(m ?? p?.cdn ?? p?.prod ?? !0);
          (0, i.useEffect)(() => {
            b(m ?? p?.cdn ?? p?.prod ?? !0)
          }, [m, p]);
          const g = (0, i.useCallback)(e => {
            ...
            const i = `${t?(0,n.getCdnPrefix)(f):""}${r}`;
            return s(i)
          }, [f, d]);
          return {
            alt: e,
        ...
        l = e => {
          ...
          return (0, i.useEffect)(() => {
            l(r?.cdn ?? r?.prod ?? !1)
          }, [r]), e ? e?.startsWith("http") ? s(e) : s(`${(0,n.getCdnPrefix)(o)}${e}`) : null
        },
        c = () => {
          const e = (0, a.i)() ?? {},
            {
          ...
          return (0, i.useCallback)((e, t = {}) => {
            const i = t?.prod ?? r;
            return e ? e?.startsWith("http") ? s(e) : s(`${(0,n.getCdnPrefix)(i)}${e}`) : null
          }, [r])
        },
        d = e => e.full_src,
        m = e => {
    ...
    65287(e, t, r) {
      ...
      }, n.resolve = a, e.exports = n, n.id = 65287
    },
    7502(e) {
      "use strict";
