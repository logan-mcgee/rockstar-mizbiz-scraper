try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "0329add3-4b76-4b30-b5c3-b2948f8981da", t._sentryDebugIdIdentifier = "sentry-dbid-0329add3-4b76-4b30-b5c3-b2948f8981da")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    64728: (t, e, n) => {
      ...
      async function S(t, e) {
        ...
        const {
          ...
          altBoundary: p = !1,
          padding: m = 0
        } = d(e, t), y = v(m), h = c[p ? "floating" === u ? "reference" : "floating" : u], g = R(await i.getClippingRect({
          ...
          x: 1,
          y: 1
        }, T = R(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
          elements: c,
          rect: w,
          offsetParent: b,
          strategy: s
        ...
        return {
          top: (g.top - T.top + y.top) / x.y,
          bottom: (T.bottom - g.bottom + y.bottom) / x.y,
          left: (g.left - T.left + y.left) / x.x,
          right: (T.right - g.right + y.right) / x.x
        }
      }
      ...
      function V(t) {
        ...
        const e = t.assignedSlot || t.parentNode || _(t) && t.host || P(t);
        return _(e) ? e.host : e
      }

      function I(t) {
        const e = V(t);
        return N(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : M(e) && k(e) ? e : I(e)
      }
      ...
      function Y(t, e, n) {
        ...
        if (i) {
          const t = U(l);
          return e.concat(l, l.visualViewport || [], k(r) ? r : [], t && n ? Y(t) : [])
        }
      ...
      function it(t, e) {
        if (!M(t) || "fixed" === W(t).position) return null;
        if (e) return e(t);
      ...
      const ct = {
        convertOffsetParentRelativeRectToViewportRelativeRect: function(t) {
          ...
          const u = s(0),
            d = M(o);
          if ((d || !d && !i) && (("body" !== D(o) || k(l)) && (a = z(o)), M(o))) {
            const t = Q(o);
        ...
        getClippingRect: function(t) {
          ...
          const c = [..."clippingAncestors" === n ? H(e) ? [] : function(t, e) {
              ...
              for (; C(l) && !N(l);) {
                const e = W(l),
                  n = j(l);
                n || "fixed" !== e.position || (r = null), (i ? !n && !r : !n && "static" === e.position && r && ["absolute", "fixed"].includes(r.position) || k(l) && !n && nt(t, l)) ? o = o.filter((t => t !== l)) : r = e, l = V(l)
              }
              return e.set(t, o), o
          ...
          return void 0 === t && (t = {}), {
            ...
            async fn(e) {
              ...
              if (k = [...k, {
                ...
                let n = null == (H = k.filter((t => t.overflows[0] <= 0)).sort(((t, e) => t.overflows[1] - e.overflows[1]))[0]) ? void 0 : H.placement;
                if (!n) switch (v) {
                  case "bestFit": {
                    var j;
                    const t = null == (j = k.filter((t => {
                      if ($) {
        ...
        pt = function(t) {
          return void 0 === t && (t = {}), {
            ...
            async fn(e) {
              ...
              let R, T;
              "top" === h || "bottom" === h ? (R = h, T = w === (await (null == s.isRTL ? void 0 : s.isRTL(a.floating)) ? "start" : "end") ? "left" : "right") : (T = h, R = "end" === w ? "top" : "bottom");
              ...
              let P = L,
                $ = D;
              if (null != (n = e.middlewareData.shift) && n.enabled.x && ($ = A), null != (o = e.middlewareData.shift) && o.enabled.y && (P = E), O && !w) {
                const t = i(y.left, 0),
                  e = i(y.right, 0),
                  n = i(y.top, 0),
                  o = i(y.bottom, 0);
        ...
        yt = t => ({
          ...
          async fn(e) {
            ...
            const y = v(p),
              ...
              L = l.reference[x] + l.reference[b] - g[b] - l.floating[x],
              D = g[b] - l.reference[b],
              O = await (null == c.getOffsetParent ? void 0 : c.getOffsetParent(f));
            let P = O ? O[A] : 0;
            P && await (null == c.isElement ? void 0 : c.isElement(O)) || (P = s.floating[A] || l.floating[x]);
            const $ = L / 2 - D / 2,
              C = P / 2 - R[x] / 2 - 1,
              M = r(y[S], C),
              _ = r(y[E], C),
              ...
              H = P / 2 - R[x] / 2 + $,
              j = u(k, H, F),
              B = !a.arrow && null != m(i) && H !== j && l.reference[x] / 2 - (H < k ? M : _) - R[x] / 2 < 0,
              N = B ? H < k ? H - k : H - F : 0;
            return {
              [b]: g[b] + N,
              data: {
