! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      s = (new Error).stack;
    s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "c2c60912-ab89-484b-ac5e-3ad03b4c41f9", e._sentryDebugIdIdentifier = "sentry-dbid-c2c60912-ab89-484b-ac5e-3ad03b4c41f9")
  } catch (e) {}
}();
  ...
  [8750], {
    12363: (e, s, t) => {
      ...
      const c = (0, _.g)((e => {
        ...
        const f = (0, a.useRef)(null),
          ...
          k = /^#/.test(t),
          w = b?.target ?? (u ? "_blank" : "_self"),
          {
            ...y
          } = b;
        let v = "";
        if ("aria-label" in y && y["aria-label"] && (v = "_blank" === w ? `${y["aria-label"]} ${p.formatMessage(n.aria_label_open_new_window)}` : y["aria-label"]), (0, a.useEffect)((() => {
          ...
          return (0, l.jsxs)("a", {
            ...
            "aria-label": v,
            ref: f,
            children: [s, "_blank" === w && !v && (0, l.jsx)("span", {
              className: o,
    ...
    97652: (e, s, t) => {
      ...
      const n = (0, r.setContextItem)({
        ...
        o = () => (0, a.useContext)(n) ?? i,
        _ = (0, r.setMakeVarItem)({
          key: "navOpenReactive",
        ...
        x = () => {
          const e = (0, r.useReactiveVar)(k),
            s = (0, r.useReactiveVar)(y),
            t = (0, r.useReactiveVar)(b),
            a = (0, r.useReactiveVar)(_),
            n = (0, r.useReactiveVar)(d),
            i = (0, r.useReactiveVar)(p);
          return {
            charactersNeeded: e,
            crewsNeeded: s,
            currentCharId: t,
      ...
      t(43425), t(29830);
      const j = {},
        R = (0, r.setContextItem)({
          context: (0, a.createContext)(j),
          key: "userContext"
        }),
        G = () => (0, a.useContext)(R)
    }
