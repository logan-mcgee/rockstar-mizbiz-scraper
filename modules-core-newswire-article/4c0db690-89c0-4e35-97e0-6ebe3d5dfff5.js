! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "4c0db690-89c0-4e35-97e0-6ebe3d5dfff5", e._sentryDebugIdIdentifier = "sentry-dbid-4c0db690-89c0-4e35-97e0-6ebe3d5dfff5")
  } catch (e) {}
}();
  ...
  [6668], {
      ...
      var b = function(e) {
        ...
        return function(e, t) {
          ...
          value: function() {
            ...
            if (b <= 0 || isNaN(b)) console.warn("Can not process element without height. Make sure the element is displayed and has a static height.");
            else if (h <= 0 || isNaN(h)) console.warn("Can not process element without width. Make sure the element is displayed and has a static width.");
            else {
              var g = (0, c.default)();
              this.pid = g;
              var v = function() {
              ...
              this.setState({
                ...
                return (0, u.default)((function() {
                  ...
                  if (v()) return t(!0);
                  _ = parseInt((k + M) / 2, 10), e.setState({
                    fontSize: _
                  }, (function() {
                    return v() ? t(!0) : (w() ? k = _ + 1 : M = _ - 1, t())
                  }))
                }), t)
              }, function(t) {
                return "single" === i && o || m() ? t() : (k = n, M = _, (0, u.default)((function() {
                  return k < M
                }), (function(t) {
                  if (v()) return t(!0);
                  _ = parseInt((k + M) / 2, 10), e.setState({
                    ...
                    return g !== e.pid ? t(!0) : (m() ? k = _ + 1 : M = _ - 1, t())
                  }))
                }), t))
              }, function(t) {
                if (_ = Math.min(k, M), _ = Math.max(_, n), _ = Math.min(_, r), _ = Math.max(_, 0), v()) return t(!0);
                e.setState({
                  fontSize: _
                }, t)
              }], (function(t) {
          ...
          value: function() {
            ...
            return "single" === a && (h.whiteSpace = "nowrap"), o.default.createElement("div", r({
              ref: function(t) {
                return e._parent = t
              },
              style: f
    ...
    300: (e, t, n) => {
      ...
      function f({
        ...
        var f;
        const [h, p] = r.useState(null), y = r.useRef(), [b, g] = r.useState({
          inView: !!l,
          entry: void 0
        });
        ...
        }), [Array.isArray(e) ? e.toString() : e, h, o, i, s, a, n, u, t]);
        const v = null == (f = b.entry) ? void 0 : f.target,
          w = r.useRef();
        h || !v || s || a || w.current === v || (w.current = v, g({
          inView: !!l,
          entry: void 0
        }));
        const m = [p, b.inView, b.entry];
