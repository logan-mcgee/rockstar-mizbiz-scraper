try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    o = (new e.Error).stack;
  o && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[o] = "d6776606-9491-45dd-9101-f0ad8f77ec58", e._sentryDebugIdIdentifier = "sentry-dbid-d6776606-9491-45dd-9101-f0ad8f77ec58")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const m = (e, o) => {
        ...
        g = () => {
          ...
          const i = `rockstarweb_lang.${o.cookieIdentifier}`,
            a = p(i);
          n = o.currentSite?.site === d.C.www ? k.find(e => e.subdomaincom === r) || k.find(e => e.subdomaincom === t) || s : k.find(e => e.iso === a) || s;
          const [, l] = f(i, n.iso);
          return [n, l]
        },
        _ = () => "en-US";
        ...
        L = e => {
          ...
          if (r)
            for (const [s, {
              ...
              let p = "";
              return "www" !== s || c?.some(e => e.test(r.pathname)) ? (p += `https://${u}`, p += i ? `.${m.at(-2)}.${m.at(-1)}` : `.${m.at(-1)}`, {
        ...
        j = ({
          ...
          const r = (0, d.A)(),
            ...
            a = (e => {
              ...
              const t = o.split("/");
              return k.map(e => e.subdomaincom).includes(t[0]) && (o = t.slice(1).join("/")), r.currentSite?.site === d.C.www ? "en" === e ? `${window.location.origin}/${o}${location.search}` : `${window.location.origin}/${e}/${o}${location.search}` : `${window.location.origin}/${o}${location.search}`
            })(n);
          o?.({
            event: "cta_other",
            link_url: a,
