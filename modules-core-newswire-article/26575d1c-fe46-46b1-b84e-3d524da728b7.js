! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "26575d1c-fe46-46b1-b84e-3d524da728b7", e._sentryDebugIdIdentifier = "sentry-dbid-26575d1c-fe46-46b1-b84e-3d524da728b7")
  } catch (e) {}
}();
      ...
      e.exports = function() {
        ...
        return function t() {
          ...
          var vt = function(e) {
            ...
            Mt = function(e) {
              var t;
              if (St("beforeSanitizeElements", e, null), wt(e)) return vt(e), !0;
            ...
            kt = function(e, t, n) {
              ...
              else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== w(n, "data:") || !Qe[e])
                if (Fe && !S(Ee, E(n, we, "")));
                else if (n) return !1;
              return !0
            },
            xt = function(e) {
              return "annotation-xml" !== e && N(e, Ae)
            },
            Ot = function(t) {
              var n, r, a, i;
              ...
              if (l && !wt(t)) {
                ...
                for (i = l.length; i--;) {
                  var s = n = l[i],
                    u = s.name,
                    f = s.namespaceURI;
                  if (r = "value" === u ? n.value : A(n.value), a = ye(u), c.attrName = a, c.attrValue = r, c.keepAttr = !0, c.forceKeepAttr = void 0, St("uponSanitizeAttribute", t, c), r = c.attrValue, !c.forceKeepAttr && (_t(u, t), c.keepAttr))
                    if (Ue || !S(/\/>/i, r)) {
                      He && (r = E(r, be, " "), r = E(r, Te, " "), r = E(r, ve, " "));
                      var m = ye(t.nodeName);
                      if (kt(m, a, r))
                        if (!$e || "id" !== a && "name" !== a || (_t(u, t), r = "user-content-" + r), ze && S(/((--!?|])>)|<\/(style|title)/i, r)) _t(u, t);
                        else {
                          ...
                          try {
                            f ? t.setAttributeNS(f, u, r) : t.setAttribute(u, r), wt(t) ? vt(t) : b(o.removed)
                          } catch (e) {}
                        }
                    } else _t(u, t)
                }
          ...
          return o.sanitize = function(t) {
            ...
            if (Pe || pt(m), o.removed = [], "string" == typeof t && (Ve = !1), Ve) {
              ...
              if (!(r = Nt(t))) return je ? null : qe ? le : ""
            }
            ...
            var h = Ge ? r.outerHTML : r.innerHTML;
            return Ge && Me["!doctype"] && r.ownerDocument && r.ownerDocument.doctype && r.ownerDocument.doctype.name && S(Z, r.ownerDocument.doctype.name) && (h = "<!DOCTYPE " + r.ownerDocument.doctype.name + ">\n" + h), He && (h = E(h, be, " "), h = E(h, Te, " "), h = E(h, ve, " ")), ie && qe ? ie.createHTML(h) : h
