! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      n = (new e.Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "d573aef8-484a-4904-ab45-87c3ea436b16", e._sentryDebugIdIdentifier = "sentry-dbid-d573aef8-484a-4904-ab45-87c3ea436b16")
  } catch (e) {}
}();
    ...
    64480: (e, n, r) => {
      ...
      var B = function() {
        ...
        return function(t, i, o, s, a, c) {
          var l, f, d, g, m, p, h, v, y, w, b, F, E, N, S, x, T, A, M, I, O = t.constructor,
            B = t.s == i.s ? 1 : -1,
            _ = t.d,
            k = i.d;
          if (!(_ && _[0] && k && k[0])) return new O(t.s && i.s && (_ ? !k || _[0] != k[0] : k) ? _ && 0 == _[0] || !k ? 0 * B : B / 0 : NaN);
          for (c ? (m = 1, f = t.e - i.e) : (c = C, m = 7, f = D(t.e / m) - D(i.e / m)), M = k.length, T = _.length, w = (y = new O(B)).d = [], d = 0; k[d] == (_[d] || 0); d++);
          if (k[d] > (_[d] || 0) && f--, null == o ? (N = o = O.precision, s = O.rounding) : N = a ? o + (t.e - i.e) + 1 : o, N < 0) w.push(1), p = !0;
          else {
            if (N = N / m + 2 | 0, d = 0, 1 == M) {
              for (g = 0, k = k[0], N++;
                (d < T || g) && N--; d++) S = g * c + (_[d] || 0), w[d] = S / k | 0, g = S % k | 0;
              p = g || d < T
            } else {
              for ((g = c / (k[0] + 1) | 0) > 1 && (k = e(k, g, c), _ = e(_, g, c), M = k.length, T = _.length), x = M, F = (b = _.slice(0, M)).length; F < M;) b[F++] = 0;
              (I = k.slice()).unshift(0), A = k[0], k[1] >= c / 2 && ++A;
              do {
                g = 0, (l = n(k, b, M, F)) < 0 ? (E = b[0], M != F && (E = E * c + (b[1] || 0)), (g = E / A | 0) > 1 ? (g >= c && (g = c - 1), 1 == (l = n(h = e(k, g, c), b, v = h.length, F = b.length)) && (g--, r(h, M < v ? I : k, v, c))) : (0 == g && (l = g = 1), h = k.slice()), (v = h.length) < F && h.unshift(0), r(b, h, F, c), -1 == l && (l = n(k, b, M, F = b.length)) < 1 && (g++, r(b, M < F ? I : k, F, c)), F = b.length) : 0 === l && (g++, b = [0]), w[d++] = g, l && b[0] ? b[F++] = _[x] || 0 : (b = [_[x]], F = 1)
      ...
      function $(e, n) {
        ...
        return u < 0 ? new t(0 * e.s) : (e.e = k(c, l), e.d = c, g = !1, o && (e = B(e, i, 4 * s)), a && (e = e.times(Math.abs(a) < 54 ? w(2, a) : qe.pow(2, a))), g = !0, e)
      }
        ...
        switch (f) {
          ...
          case "unit":
            var I = t.unit,
              O = t.unitDisplay,
              B = n.units.simple[I];
            if (S = void 0, B) S = br(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[I][O]);
            else {
              var P = I.split("-per-"),
                _ = P[0],
                k = P[1];
              B = n.units.simple[_];
              var j = br(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[_][O]),
                R = n.units.simple[k].perUnit[O];
              if (R) S = R.replace("{0}", j);
              else {
                var L = n.units.compound.per[O],
                  q = br(r, 1, n.units.simple[k][O]);
