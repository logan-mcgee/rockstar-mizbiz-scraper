      ...
      t.exports = (s = i(4932), (() => {
        var t = {
            ...
            272: (t, e, i) => {
              ...
              var oe = new WeakMap,
                ...
                ue = function(t) {
                  ...
                  function i() {
                    ...
                    return ae(se(t = e.call.apply(e, [this].concat(r))), "ParsedChildren", null), oe.set(se(t), {
                      writable: !0,
                      value: function(e) {
                        var i = U.extend(Rt()({
                      ...
                      value: function(e, i) {
                        switch (e.type) {
                          case "JSXAttribute":
                            return null === e.value || ne(se(t), he).call(se(t), e.value, i);
                          case "JSXElement":
                          case "JSXFragment":
                            return ne(se(t), le).call(se(t), e, i);
                          case "JSXExpressionContainer":
                            return ne(se(t), he).call(se(t), e.expression, i);
                          case "JSXText":
                          ...
                          case "ArrayExpression":
                            return e.elements.map((function(e) {
                              return ne(se(t), he).call(se(t), e, i)
                            }));
                          case "BinaryExpression":
                            switch (e.operator) {
                              case "-":
                                return ne(se(t), he).call(se(t), e.left) - ne(se(t), he).call(se(t), e.right);
                              case "!=":
                                return ne(se(t), he).call(se(t), e.left) != ne(se(t), he).call(se(t), e.right);
                              case "!==":
                                return ne(se(t), he).call(se(t), e.left) !== ne(se(t), he).call(se(t), e.right);
                              case "*":
                                return ne(se(t), he).call(se(t), e.left) * ne(se(t), he).call(se(t), e.right);
                              case "**":
                                return Math.pow(ne(se(t), he).call(se(t), e.left), ne(se(t), he).call(se(t), e.right));
                              case "/":
                                return ne(se(t), he).call(se(t), e.left) / ne(se(t), he).call(se(t), e.right);
                              case "%":
                                return ne(se(t), he).call(se(t), e.left) % ne(se(t), he).call(se(t), e.right);
                            ...
                            return;
                          case "CallExpression":
                            var r = ne(se(t), he).call(se(t), e.callee);
                            return void 0 === r ? void t.props.onError(new Error("The expression '".concat(e.callee, "' could not be resolved, resulting in an undefined return value."))) : r.apply(void 0, Zt(e.arguments.map((function(i) {
                              return ne(se(t), he).call(se(t), i, e.callee)
                            }))));
                          case "ConditionalExpression":
                            return ne(se(t), he).call(se(t), e.test) ? ne(se(t), he).call(se(t), e.consequent) : ne(se(t), he).call(se(t), e.alternate);
                          case "ExpressionStatement":
                            return ne(se(t), he).call(se(t), e.expression);
                          case "Identifier":
                            return i && e.name in i ? i[e.name] : (t.props.bindings || {})[e.name];
                          case "Literal":
                            return e.value;
                          case "LogicalExpression":
                            var a = ne(se(t), he).call(se(t), e.left);
                            return "||" === e.operator && a ? a : !!("&&" === e.operator && a || "||" === e.operator && !a) && ne(se(t), he).call(se(t), e.right);
                          case "MemberExpression":
                            return ne(se(t), pe).call(se(t), e, i);
                          case "ObjectExpression":
                            var n = {};
                            return e.properties.forEach((function(e) {
                              n[e.key.name || e.key.value] = ne(se(t), he).call(se(t), e.value)
                            })), n;
                      ...
                      value: function(e, i) {
                        ...
                        if ("Literal" !== e.object.type)
                          for (; o && ["MemberExpression", "Literal"].includes(null === (p = o) || void 0 === p ? void 0 : p.type);) {
                            ...
                            o.computed ? h.unshift(ne(se(t), he).call(se(t), u, i)) : h.unshift(null !== (c = null == u ? void 0 : u.name) && void 0 !== c ? c : JSON.parse(null !== (l = null == u ? void 0 : u.raw) && void 0 !== l ? l : '""')), o = o.object
                          }
                        var d = ne(se(t), he).call(se(t), o, i);
                        try {
                          var f = d,
                      ...
                      writable: !0,
                      value: function(e) {
                        return "JSXIdentifier" === e.type ? e.name : "".concat(ne(se(t), ce).call(se(t), e.object), ".").concat(ne(se(t), ce).call(se(t), e.property))
                      }
                    }), le.set(se(t), {
                      writable: !0,
                      value: function(e, i) {
                        var s = t.props,
                          ...
                          l = c.attributes,
                          u = void 0 === l ? [] : l,
                          d = "JSXElement" === e.type ? ne(se(t), ce).call(se(t), c.name) : "",
                        ...
                        var y = "JSXElement" === e.type ? Xt(a, d) : Mt.Fragment;
                        (y || function(t) {
                          ...
                          switch (Wt(t)) {
                            case "string":
                              return t.split(";").filter((function(t) {
                                ...
                                return Gt(Gt({}, t), {}, Ht({}, i.replace(/([A-Z])([A-Z])/g, "$1 $2").replace(/([a-z])([A-Z])/g, "$1 $2").replace(/[^a-zA-Z\u00C0-\u00ff]/g, " ").toLowerCase().split(" ").filter((function(t) {
                                  return t
                                })).map((function(t, e) {
                    ...
                    }), ae(se(t), "render", (function() {
                      var e = (t.props.jsx || "").trim().replace(/<!DOCTYPE([^>]*)>/g, "");
                      t.ParsedChildren = ne(se(t), oe).call(se(t), e);
              ...
              ae(ue, "displayName", "JsxParser"), ae(ue, "defaultProps", {
