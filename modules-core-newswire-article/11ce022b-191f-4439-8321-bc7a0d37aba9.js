try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "11ce022b-191f-4439-8321-bc7a0d37aba9", e._sentryDebugIdIdentifier = "sentry-dbid-11ce022b-191f-4439-8321-bc7a0d37aba9")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    14653(e, t, s) {
      ...
      var S = {
        ...
        T = {
          ...
          loopFix: function(e) {
            ...
            let _ = 0,
              I = 0;
            const O = (T ? p[a].column : a) + (v && void 0 === i ? -w / 2 + .5 : 0);
            if (O < S) {
              _ = Math.max(S - O, b);
              ...
              I = Math.max(O - (x - 2 * S), b), M && (I = Math.max(I, w - x + g + 1));
              for (let e = 0; e < I; e += 1) {
                const t = e - Math.floor(e / x) * x;
                T ? p.forEach((e, s) => {
                  e.column === t && E.push(s)
            ...
            if (c.__preventObserver__ = !0, requestAnimationFrame(() => {
              ...
              }), "cards" === c.params.effect && p.length < w + 2 * S && (E.includes(a) && E.splice(E.indexOf(a), 1), y.includes(a) && y.splice(y.indexOf(a), 1)), k && y.forEach(e => {
              ...
              if (y.length > 0 && k) {
                if (void 0 === t) {
                  ...
                  d ? c.setTranslate(c.translate - t) : (c.slideTo(C + Math.ceil(_), 0, !1, !0), i && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                } else if (i) {
              ...
              if (void 0 === t) {
                const e = c.slidesGrid[C],
                  t = c.slidesGrid[C - I] - e;
                d ? c.setTranslate(c.translate - t) : (c.slideTo(C - I, 0, !1, !0), i && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
              } else {
      ...
      const O = (e, t) => {
          ...
          n && "string" != typeof n && (s[d]("touchstart", e.onDocumentTouchStart, {
            ...
            passive: !0
          }), (r.preventClicks || r.preventClicksPropagation) && n[d]("click", e.onClick, !0), r.cssMode && a[d]("scroll", e.onScroll), r.updateOnWindowResize ? e[c](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", C, !0) : e[c]("observerUpdate", C, !0), n[d]("load", e.onLoad, {
            capture: !0
          }))
        },
      ...
      const G = {
          ...
          events: {
            attachEvents: function() {
              ...
              e.onTouchStart = E.bind(e), e.onTouchMove = x.bind(e), e.onTouchEnd = M.bind(e), e.onDocumentTouchStart = I.bind(e), t.cssMode && (e.onScroll = k.bind(e)), e.onClick = P.bind(e), e.onLoad = _.bind(e), O(e, "on")
            },
      ...
      const Z = (0, r.createContext)(null),
        ...
        Q = (0, r.forwardRef)(function(e, t) {
          ...
          return w.current || z(), b.current && b.current.on("_beforeBreakpoint", L), (0, r.useEffect)(() => () => {
            ...
            if (t && (t.current = w.current), w.current) return b.current.destroyed && z(),
              function(e, t) {
                ...
                swiper: b.current
              }, C), l && !b.current.destroyed && l(b.current), () => {
            ...
            }(P, S.current, I, T.current, e => e.key);
            return S.current = P, T.current = I, e.length && b.current && !b.current.destroyed && function(e) {
              let {
                swiper: t,
                slides: s,
                passedParams: r,
            ...
            ref: w,
            className: H(`${p}${s?` ${s}`:""}`)
          }, k), r.createElement(J.Provider, {
            value: b.current
          }, O["container-start"], r.createElement(a, {
          ...
          }(b.current, I, f) : I.map((e, t) => r.cloneElement(e, {
            swiper: b.current,
            swiperSlideIndex: t
          })), O["wrapper-end"]), j(C) && r.createElement(r.Fragment, null, r.createElement("div", {
            ref: E,
