try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "4569e1ce-bf79-4b35-b504-3f992b67e3e8", e._sentryDebugIdIdentifier = "sentry-dbid-4569e1ce-bf79-4b35-b504-3f992b67e3e8")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    40445: (e, t, n) => {
      ...
      class u extends Error {
        constructor(e, ...t) {
          ...
          super(e), this.name = "GraphQLError", this.path = null != d ? d : void 0, this.originalError = null != l ? l : void 0, this.nodes = h(Array.isArray(s) ? s : s ? [s] : void 0);
      ...
      class v {
        constructor(e) {
          const t = new p.ou(f.SOF, 0, 0, 0, 0);
      ...
      function _(e, t) {
        return x(e.charCodeAt(t)) && g(e.charCodeAt(t + 1))
      }
      ...
      function w(e, t) {
        ...
        for (; i < r;) {
          ...
          switch (t) {
            ...
            case 34:
              return 34 === n.charCodeAt(i + 1) && 34 === n.charCodeAt(i + 2) ? P(e, i) : D(e, i)
          }
          if ((0, b.yp)(t) || 45 === t) return k(e, i, t);
          if ((0, b.un)(t)) return B(e, i);
          throw d(e.source, i, 39 === t ? "Unexpected single quote character ('), did you mean to use a double quote (\")?" : T(t) || _(n, i) ? `Unexpected character: ${N(e,i)}.` : `Invalid character: ${N(e,i)}.`)
        }
      ...
      function k(e, t, n) {
        ...
        if (45 === s && (s = r.charCodeAt(++i)), 48 === s) {
          if (s = r.charCodeAt(++i), (0, b.yp)(s)) throw d(e.source, i, `Invalid number, unexpected digit after 0: ${N(e,i)}.`)
        } else i = I(e, i, s), s = r.charCodeAt(i);
        if (46 === s && (o = !0, s = r.charCodeAt(++i), i = I(e, i, s), s = r.charCodeAt(i)), 69 !== s && 101 !== s || (o = !0, s = r.charCodeAt(++i), 43 !== s && 45 !== s || (s = r.charCodeAt(++i)), i = I(e, i, s), s = r.charCodeAt(i)), 46 === s || (0, b.un)(s)) throw d(e.source, i, `Invalid number, expected digit but got: ${N(e,i)}.`);
        return A(e, o ? f.FLOAT : f.INT, t, i, r.slice(t, i))
      }

      function I(e, t, n) {
        if (!(0, b.yp)(n)) throw d(e.source, t, `Invalid number, expected digit but got: ${N(e,t)}.`);
        const r = e.source.body;
        let i = t + 1;
        for (;
        ...
        for (; i < r;) {
          ...
          if (92 !== r) {
            ...
            if (T(r)) ++i;
              ...
              if (!_(n, i)) throw d(e.source, i, `Invalid character within String: ${N(e,i)}.`);
              i += 2
            }
          } else {
            o += n.slice(s, i);
            const t = 117 === n.charCodeAt(i + 1) ? 123 === n.charCodeAt(i + 2) ? C(e, i) : R(e, i) : F(e, i);
          ...
          if (92 !== r || 34 !== n.charCodeAt(s + 1) || 34 !== n.charCodeAt(s + 2) || 34 !== n.charCodeAt(s + 3))
            if (10 !== r && 13 !== r)
              if (T(r)) ++s;
                ...
                if (!_(n, s)) throw d(e.source, s, `Invalid character within String: ${N(e,s)}.`);
                s += 2
              }
      ...
      class V {
        constructor(e, t = "GraphQL request", n = {
          ...
          "string" == typeof e || (0, M.U)(!1, `Body must be a string. Received: ${(0,U.N)(e)}.`), this.body = e, this.name = t, this.locationOffset = n, this.locationOffset.line > 0 || (0, M.U)(!1, "line in locationOffset is 1-indexed and must be positive."), this.locationOffset.column > 0 || (0, M.U)(!1, "column in locationOffset is 1-indexed and must be positive.")
        }
        get[Symbol.toStringTag]() {
          return "Source"
        }
            ...
            return e.definitions.forEach((function(e) {
              if ("FragmentDefinition" === e.kind) {
                var r = e.name.value,
                  ...
                  s = H.get(r);
                s && !s.has(i) ? q && console.warn("Warning: fragment with name " + r + " already exists.\ngraphql-tag enforces all fragment names across your application to be unique; read more about\nthis in the docs: http://dev.apollodata.com/core/fragments.html#unique-names") : s || H.set(r, s = new Set), s.add(i), t.has(i) || (t.add(i), n.push(e))
              } else n.push(e);
              var o
