! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "cc938321-dae0-4e33-bc66-cd5faf7b7e90", e._sentryDebugIdIdentifier = "sentry-dbid-cc938321-dae0-4e33-bc66-cd5faf7b7e90")
  } catch (e) {}
}();
  ...
  [2399], {
    39695: (e, a, t) => {
      ...
      const h = e => {
          ...
          const n = o ?? (s.startsWith(document.location.origin) ? "_self" : "_blank"),
            l = [b.platformButton, b[c]].join(" "),
            d = c ? t(52917)(`./${c}.svg`) : null,
            m = (0, k.jsxs)(k.Fragment, {
              children: [d ? (0, k.jsx)("img", {
                src: d,
                alt: a
              }) : "", !d && (0, k.jsx)("div", {
          ...
          return s.startsWith("http") ? (0, k.jsx)("a", {
            href: s,
            className: l,
            target: n,
            onClick: i,
        ...
        _ = e => {
          ...
          const [y, S] = (0, s.useState)(!1), {
            track: C
          } = (0, d.useGtmTrack)(), M = (0, s.useRef)(null), j = (0, s.useRef)(y);
          (0, s.useEffect)((() => {
            j.current = y
          }), [y]), (0, s.useEffect)((() => {
            const e = e => {
              j && !M?.current?.contains(e.target) && S(!1)
            };
          ...
          return (0, k.jsxs)("div", {
            className: (0, n.classList)(b.container, m),
            children: [(0, k.jsx)(c.P.div, {
              className: b.content,
              ...
              "data-variant": a,
              className: i()(y ? b.expandedButton : b.unexpandedButton),
              animate: y ? "open" : "closed",
              variants: p,
              initial: !1,
              ref: M,
              children: [(0, k.jsx)(c.P.button, {
                ...
                children: (0, k.jsxs)("div", {
                  children: [(0, k.jsx)("button", {
                    ...
                    children: _.length ? _.map((e => (0, k.jsx)(h, {
    ...
    42341: (e, a, t) => {
      ...
      const u = (0, s.withIntl)((e => {
        ...
        const {
          track: g
        } = (0, c.useGtmTrack)(), p = (0, s.useIntl)(), [b, k] = (0, s.getLocale)(), [h, _] = (0, r.useState)(!1), w = (0, r.useMemo)((() => (0, o.A)()), []), x = (0, r.useCallback)((e => {
          let a = u.pathname;
          const t = a.split("/");
        ...
        }), [u]), v = (0, r.useRef)(null), [N, y] = (0, r.useState)(0), S = matchMedia("(hover: none) and (pointer: coarse)").matches, C = e => {
        ...
        return (0, r.useEffect)((() => {
          void 0 !== t && !1 === t && !0 === h && _(!1)
        }), [t]), (0, r.useEffect)((() => {
          v.current && y(v.current.scrollHeight)
        }), [v]), (0, m.jsxs)("div", {
          className: [d.languageSelector, h ? d.open : ""].join(" "),
          "data-theme": a,
          children: [S && "sc-menu" === a && (0, m.jsx)("div", {
          ...
          }), (!S || "sc-menu" !== a) && (0, m.jsxs)(m.Fragment, {
            children: [(0, m.jsxs)("button", {
              onClick: e => {
                e.stopPropagation(), i && i(!h), _(!h)
              },
              type: "button",
              "aria-label": p.formatMessage(n.language_selector_default),
    ...
    86503: (e, a, t) => {
      ...
      const T = {
        ...
        O = e => {
          ...
          const {
            track: k
          } = (0, p.useGtmTrack)(), h = (0, L.A)(), _ = (0, r.useIntl)();
          let w = s;
          c && (w = c.domain === h.currentSite?.site ? c.path : `https://${h.sites[c.domain]}.rockstargames.com${c.path}`);
          const x = {
            ...o,
            link_url: w
          };
          return (0, d.jsxs)(R, {
            ...
            children: [a, m && (0, d.jsx)("div", {
              ...
              children: (0, d.jsx)("span", {
                ...
                children: _.formatMessage(n.nofications_new)
              })
            })]
          })
        },
        P = e => {
          ...
          const {
            ...
            navOpen: N
          } = (0, p.useRockstarUserState)(), y = (0, s.useRef)(null), [S, C] = (0, s.useState)(0), [M, j] = (0, s.useState)(0), [I, E] = (0, s.useState)(!0);
          return (0, s.useEffect)((() => {
            u !== a && !1 === I && E(!0), u === a && E(!1)
          }), [u]), (0, s.useEffect)((() => {
            if (!y.current) return;
          ...
          }), [y, w, x]), m.length > 0 ? (0, d.jsxs)(d.Fragment, {
            children: [(0, d.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), v(i), u === a ? (g(-1), b(0)) : (g(a), b(S + M + M))
              },
              children: [(0, d.jsx)("span", {
        ...
        A = e => {
          ...
          const {
            ...
            navOpen: w
          } = (0, p.useRockstarUserState)(), x = (0, f.useLocale)(), v = (0, f.toScLocaleString)(x), [N, y] = (0, s.useState)(""), S = `${a.login}?returnUrl=${N}&lang=${v}`, C = `${a.signup}&returnUrl=${N}&lang=${v}`, j = (0, s.useMemo)((() => (0, L.A)()), []), T = (0, s.useMemo)((() => {
            const e = ((e, a, t) => [{
            ...
            return e
          }), [l, S, C, j]), [R, O] = (0, s.useState)(0), A = (0, s.createRef)(), D = () => {
            if (A.current) {
              const {
                current: e
        ...
        U = e => {
          ...
          const {
            ...
            track: l
          } = (0, p.useGtmTrack)(), m = (0, r.useIntl)(), [u, f] = (0, s.useState)([]), [g, b] = (0, s.useState)(null), [k, h] = (0, s.useState)(null), [_, w] = (0, s.useState)(!1), [x, v] = (0, s.useState)(-1), [N, y] = (0, s.useState)([]), [S, C] = (0, s.useState)(0), M = t(58989), [j, I] = (0, s.useState)("0"), [E, L] = (0, s.useState)("0"), T = e => parseInt(e, 10).toLocaleString("en-US", {
          ...
          (0, s.useEffect)((() => {
            ...
            u && u.forEach((e => {
              !0 === e.isPrimary && (b(e.crewTag), h(e.crewColour), v(e.rankOrder), w(!1), !0 === Object.prototype.hasOwnProperty.call(e, "crewType") && "rockstar" === e.crewType && w(!0))
            }))
          }), [u]), (0, s.useEffect)((() => {
            const e = [];
            if (!_ && x > -1)
        ...
        z = e => {
          ...
          const m = (0, s.createRef)(),
            ...
            [k, h] = (0, s.useState)(0),
            [_, w] = (0, s.useState)([r]),
            [x, v] = (0, s.useState)(_[0]),
            [N, y] = (0, s.useState)(252),
            [S, C] = (0, s.useState)(0),
            [M, j] = (0, s.useState)([]),
            [I, E] = (0, s.useState)([]),
            [L, T] = (0, s.useState)(!1),
            ...
            R = e => {
              ...
              r > a ? (s > 0 ? (() => {
                ...
                e < 0 && (e = 0), b(e), v(_[e]), c && c(e)
              })(), h(0)) : v(_[p] + r * s)
            },
            O = () => {
              !0 !== f && !0 !== l && (g(!0), !0 !== f && (v(_[p]), h(0)))
            };
          return (0, s.useEffect)((() => {
            const e = [];
            i.forEach((() => {
            ...
            w(i.map(((e, a) => (e => {
              let a = 0;
              const t = i.length;
              return 1 === t ? .5 * u - .5 * N - 2 * r + S : (0 === e && (a = r - e * N), e === t - 1 && t > 1 && (a = t * N * -1 + (u - (r - S))), e > 0 && e < t - 1 && (a = e * N * -1 + (.5 * u - .5 * N + .5 * S)), a)
        ...
        G = (0, f.withTranslations)((e => {
          ...
          const {
            ...
            setUserData: se
          } = (0, p.useRockstarUserState)(), [re, ce] = (0, s.useState)(null), [oe, ie] = (0, s.useState)(null), [ne, le] = (0, s.useState)(!1), [de, me] = (0, s.useState)(!1), [ue, fe] = (0, s.useState)(0), ge = (0, s.createRef)(), pe = H(ge, !1), be = (0, s.createRef)(), [ke, he] = (0, s.useState)(0), [_e, we] = (0, s.useState)([]), [xe, ve] = (0, s.useState)(244), Ne = (0, s.useRef)(null), ye = (0, s.useMemo)((() => (0, L.A)()), []), Se = (0, s.useMemo)((() => ((e, a, t, s, r) => [{
          ...
          return (0, s.useEffect)((() => {
            ...
            ye.currentSite?.site === L.C.socialClub && (e = encodeURIComponent("/")), G(e)
          }), [h]), (0, s.useEffect)((() => {
            we(J.characters[Y] ?? [])
          }), [J, Y]), (0, s.useEffect)((() => {
            J && se(J)
            ...
            let e = _e.length - 1;
            e < 0 && (e = 0), fe(e);
            const a = _e.length > 0 ? _e[q] ?? _e[0] : null;
            if (!a) return;
            const t = null !== a ? o(a.platform, "large") : null;
            ie(t), ce(a), _e.length > 1 ? le(!0) : le(!1), u(_e.length - 1 > 3)
          }), [q, _e]), (0, s.useEffect)((() => {
            Ce()
          }), [ue, b, w, _e]), (0, s.useEffect)((() => {
            Me(), I()((() => {
              setTimeout(Me, 0)
            }), 300)
          }), [w, x]), (0, s.useEffect)((() => {
            const e = W?.currentCharId ?? 0;
            e !== q && ee(Math.max(0, Math.min(e, _e.length - 1)))
          }), [_e, W]), (0, d.jsxs)(d.Fragment, {
            children: [null !== re && "gtao" === Y && (0, d.jsxs)("div", {
              ...
              children: [(0, d.jsx)(U, {
                ...
                children: [(0, d.jsx)("button", {
                  ...
                  children: (0, d.jsx)(z, {
                    ...
                    disablePager: de,
                    disableSwiper: de,
                    children: _e.filter(((e, a) => a !== q)).map((e => (0, s.createElement)(D, {
                      characterData: e,
                      setMobileCardWidth: ve,
                      key: e.mugshotUrl,
                      tabIndex: t ? -1 : 0
              ...
              children: [(0, d.jsx)("button", {
                ...
                children: Se.map(((e, a) => (0, s.createElement)(P, {
                  ...e,
                  id: a,
                  activeSubNavId: S,
                  setActiveSubNavId: C,
        ...
        V = (0, r.withIntl)((e => {
          ...
          const {
            ...
            track: E
          } = (0, p.useGtmTrack)(), [L, T] = (0, s.useState)(!1), B = (0, g.useReactiveVar)(p.scConfig), R = (0, s.useRef)(), [O, P] = (0, s.useState)(0), D = (0, s.createRef)(), [$, U] = (0, s.useState)(!1), [H, z] = (0, s.useState)(0), [F, V] = (0, s.useState)(!1), {
            mutateLSSettings: X,
            lsSettings: J
          ...
          return (0, s.useEffect)((() => {
            ...
            R.current && (!1 === _ && !1 === L && (R.current.style.height = `${R.current.scrollHeight}px`), !0 === _ && (R.current.style.height = null))
          }), [_, R, L]), (0, s.useEffect)((() => {
            const e = () => {
                j(!1), K(!0)
              },
    ...
    62811: (e, a, t) => {
      ...
      const o = e => {
        ...
        n = e => {
          ...
          const h = [r.plusButton, r[b] ?? "", r[f] ?? "", r[s] ?? "", t].join(" "),
            _ = {
              "--hvr-color": a ?? d,
              "--hvr-bg-color": d ?? a,
