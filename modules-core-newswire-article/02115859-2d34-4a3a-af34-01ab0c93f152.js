try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "02115859-2d34-4a3a-af34-01ab0c93f152", e._sentryDebugIdIdentifier = "sentry-dbid-02115859-2d34-4a3a-af34-01ab0c93f152")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const m = {
        ...
        f = ({
          ...
          const v = (0, l.useRockstarTokenPing)(),
            ...
            L = (0, s.useRef)(null),
            I = () => {
              P.current?.blur(), R(!0), j(!1), L.current = window.setTimeout(() => {
                A.current?.focus()
              }, 30)
            },
            D = (0, s.useCallback)(() => {
          ...
          (0, s.useEffect)(() => () => {
            ...
            z && T.current ? q(T.current.scrollHeight) : q(0)
          }, [z]), (0, s.useEffect)(() => {
            if (!z) return;
            const e = e => {
              const a = e.target;
              S.current && !S.current.contains(a) && document.contains(a) && (I(), L?.current && (L.current = window.setTimeout(() => {
                A.current?.blur()
              }, 40)))
            };
            ...
            if (S?.current) {
              const e = getComputedStyle(S.current).getPropertyValue("--expandingPlatformButton-expandDuration"),
