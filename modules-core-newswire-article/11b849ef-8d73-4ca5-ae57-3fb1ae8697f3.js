try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    n = (new e.Error).stack;
  n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "11b849ef-8d73-4ca5-ae57-3fb1ae8697f3", e._sentryDebugIdIdentifier = "sentry-dbid-11b849ef-8d73-4ca5-ae57-3fb1ae8697f3")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const X = "https://media-rockstargames-com.akamaized.net/mfe6/prod/__common/img/cb04fb2acd10f43aa501729b4d7d26a8.jpg",
        ...
        ee = (0, u.withIntl)(({
          ...
          const j = {
            ...
            [Q, ee] = (0, r.useState)("hidden"),
            [ne, ae] = (0, r.useState)("hidden"),
            [te, re] = (0, r.useState)("hidden"),
            [ie, se] = (0, r.useState)(!1),
            [oe, le] = (0, r.useState)(K.landing),
            [ce, de] = (0, r.useState)(j.introScreen.image.sources.mobile || X),
            ...
            _e = e => {
              e === K.landing ? (le(K.landing), ee("onScreen"), W("hidden"), re("hidden"), ae("hidden")) : e === K.success ? (le(K.success), ee("offScreen"), W("visible"), setTimeout(() => {
                ee("hidden"), re("hidden")
              }, 300), setTimeout(() => {
                W("onScreen")
              }, 100)) : e === K.error ? (le(K.error), ee("offScreen"), re("visible"), setTimeout(() => {
                ee("hidden")
              }, 300), setTimeout(() => {
                re("onScreen")
          ...
          return (0, r.useEffect)(() => {
            ...
            const e = () => {
                window.innerWidth >= 2560 && "newswire" !== n ? de(j.introScreen.image.sources.mobile || X) : de(j.introScreen.image.sources.desktop || X)
              },
              a = () => {
            ...
            "boolean" == typeof w ? w ? V(!0) : (V(!1), ee("onScreen")) : V(!0)
          }, [w]), (0, r.useEffect)(() => {
            "boolean" == typeof z && S?.accountSynced && V(!1)
          }, [z, S?.accountSynced, V]), (0, r.useEffect)(() => {
            B || (async () => {
              R.length > 0 && z ? _e(K.success) : _e(z ? K.unlinked : K.landing)
            })()
          }, [B]), (0, r.useEffect)(() => {
            if (C && !ie) {
              if (void 0 === w) return;
