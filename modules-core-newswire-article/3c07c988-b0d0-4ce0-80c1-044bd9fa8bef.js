  ...
  [1357], {
    61651: (e, a, i) => {
      ...
      const r = (0, n.forwardRef)(((e, a) => {
        const {
          ...
          track: c
        } = (0, t.useGtmTrack)(o), [l, d] = (0, n.useState)(a?.current);
        return (0, n.useEffect)((() => {
          ...
          const c = (0, n.useCallback)((() => {
            const e = document.documentElement,
              n = document.body,
              o = i?.scrollTop || e.scrollTop || n.scrollTop,
              l = i?.scrollHeight || e.scrollHeight || n.scrollHeight,
              {
                clientHeight: d
              } = e,
              m = o / (l - d) * 100;
            if (s) {
              ...
              if (m >= e) {
                ...
                0 === n.length && (i ?? window).removeEventListener("scroll", c), a && a({
                  scrollY: e,
                  scrollPercent: m,
                  remainingDepths: n
                }), r({
        ...
        l = (0, n.withIntl)((e => {
          ...
          return (0, o.jsxs)("div", {
            ...
            children: [(0, o.jsx)("h4", {
              ...
              children: (0, o.jsx)(n.FormattedMessage, {
      ...
      const m = e => {
        ...
        f = e => {
          ...
          const {
            ...
            skip: !0
          }), [l] = (0, o.useMutation)(c.UserCastVote), [m, f] = (0, n.useState)(null), k = (0, n.useCallback)((e => {
            (async () => {
    ...
    39613: (e, a, i) => {
      ...
      const h = e => {
        ...
        w = e => {
          ...
          const {
            track: T
          } = (0, r.useGtmTrack)(), V = (0, s.useDataLayer)(), $ = c ?? a, I = (0, s.findPlatform)(y)?.friendlyName, D = (0, n.useMemo)((() => {
          ...
          return (0, b.jsx)(t.Link, {
            to: i,
            target: D ? "_self" : "_blank",
            className: p()(g.cta, "platform" === l && y ? g[y] : "", N && g[N], S ? g.disabled : "", j),
            style: o,
            "data-variant": l,
            "data-size": d,
            onClick: F,
            ...
            children: "platform" === l && y ? (0, b.jsx)(h, {
              ...
              children: ["left" === u && E(), (0, b.jsx)("span", {
                className: g.label,
                children: $
              }), "right" === u && E(), v ? (0, b.jsx)("span", {
                className: g.badge,
                style: w,
                children: v
              }) : null]
    ...
    37017: (e, a, i) => {
      ...
      const c = (0, s.withTranslations)((e => {
        ...
        const [i] = (0, n.useState)(""), s = (0, t.useNavigate)(), c = (0, r.useMutateState)();
    ...
    22545: (e, a, i) => {
      ...
      const m = {
        ...
        u = e => {
          ...
          const {
            track: p
          } = (0, r.useGtmTrack)(), [b, h] = (0, n.useState)([o.U1, o.WO, o.dK]), [w, y] = (0, n.useState)(null), [N, x] = (0, n.useState)(null);
          return (0, n.useEffect)((() => {
    ...
    25180: (e, a, i) => {
      ...
      const l = e => {
          ...
          const s = i ?? [a],
            {
              data: c
            } = (0, n.useQuery)(o.TinaModulesInfo, {
              variables: {
                ids: s,
                sync: r
              },
    ...
    22778: (e, a, i) => {
      ...
      const s = e => {
        ...
        const m = [t.button, t[s], a].join(" ");
        return o ? (0, r.jsx)(n.A, {
          ...d,
          to: o,
          className: m,
          onClick: c,
        ...
        if (g?.src?.desktop) {
          ...
          if (v.background = `url(${g?.src?.desktop}) ${a} ${i}`, c?.style && c?.style["--linear-gradient"]) v.background = `linear-gradient(${c?.style["--linear-gradient"]}), url(${g?.src?.desktop}) ${a} ${i}`;
            ...
            const e = c?.style["--gradient-height"] || "3",
              n = c?.style["--gradient-start-color"] || "var(--background-color, transparent)",
              t = c?.style["--gradient-end-color"] || "var(--background-color, transparent)";
            v.background = `linear-gradient(180deg, ${n}, transparent ${e}%, transparent ${100-e}%, ${t}), url(${g?.src?.desktop}) ${a} ${i}`
          }
        }
        return (0, s.jsx)("div", {
          id: k,
          className: (0, n.classList)("rockstargames-modules-core-newswire-articlef42b4606ed4a5b16b7647ad7b7eb229d", u ? "rockstargames-modules-core-newswire-articleb00444166ce6346d7ca364a75a335ecc" : "", f),
    ...
    95625: (e, a, i) => {
      ...
      const r = e => {
        ...
        return void 0 !== i && (c.gridTemplateColumns = `repeat(${i}, 1fr)`), void 0 !== s && (c.gridTemplateRows = `repeat(${s}, 1fr)`), (0, t.jsx)("div", {
          className: [n.responsiveGridBox, void 0 !== r ? r : ""].join(" "),
          style: c,
          children: a
        })
      }
    ...
    61841: (e, a, i) => {
      ...
      const r = e => {
        ...
        return (0, t.jsx)("div", {
          className: [n.responsiveGridItem, void 0 !== i ? i : ""].join(" "),
          style: r,
          children: a
        })
      }
    ...
    37297: (e, a, i) => {
      ...
      const s = e => {
        ...
        const [l, d] = (0, n.usePreloadImg)(a);
        return l ? (c.backgroundImage = `url(${a})`, (0, r.jsx)("div", {
          role: "img",
          "aria-label": o ?? "R* Games",
          className: [t.responsiveImage, s ? t.animateBox : "", i].join(" "),
          style: {
            ...c,
    ...
    17375: (e, a, i) => {
      ...
      const r = e => {
        ...
        return (0, t.jsx)("section", {
          className: [n.responsiveSection, void 0 !== i ? i : ""].join(" "),
          style: r,
    ...
    47252: (e, a, i) => {
      ...
      class r extends n.Component {
        ...
        render() {
          return this?.state?.error?.message ? (0, t.jsxs)("div", {
    ...
    14924: (e, a, i) => {
      ...
      function d({
        ...
        const [, n] = (0, t.useState)(!m(a)), r = (0, t.useRef)(void 0);
        if (!m(a)) {
          const {
            renderer: e,
            ...i
        ...
        return (0, t.useEffect)((() => {
          m(a) && a().then((({
            ...
            (0, l.Y)(a), r.current = e, n(!0)
          }))
        }), []), t.createElement(c.Y.Provider, {
          value: {
            renderer: r.current,
            strict: i
          }
