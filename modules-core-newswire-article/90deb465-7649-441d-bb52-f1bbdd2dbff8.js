try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "90deb465-7649-441d-bb52-f1bbdd2dbff8", t._sentryDebugIdIdentifier = "sentry-dbid-90deb465-7649-441d-bb52-f1bbdd2dbff8")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    10376(t, e, n) {
      ...
      async function A(t, e) {
        ...
        const {
          ...
          altBoundary: h = !1,
          padding: p = 0
        } = u(e, t), m = T(p), g = s[h ? "floating" === d ? "reference" : "floating" : d], y = E(await r.getClippingRect({
      ...
      function ct(t, e, n) {
        ...
        if ("viewport" === e) o = function(t, e) {
          ...
          const a = -n.scrollTop;
          return "rtl" === Z(o).direction && (s += r(e.clientWidth, o.clientWidth) - i), {
            width: i,
            height: l,
            x: s,
            y: a
      ...
      function ut(t, e, n) {
        ...
        if (o || !o && !r)
          if (("body" !== C(e) || N(i)) && (s = G(e)), o) {
            const t = lt(e, !0, r, e);
            c.x = t.x + e.clientLeft, c.y = t.y + e.clientTop
          } else i && f();
        r && !o && i && f();
        const u = !i || o || r ? a(0) : at(i, s);
        return {
      ...
      const mt = {
        ...
        getClippingRect: function(t) {
          ...
          const s = [..."clippingAncestors" === n ? z(e) ? [] : function(t, e) {
              const n = e.get(t);
              if (n) return n;
      ...
      const wt = function(t) {
            ...
            async fn(e) {
              ...
              const {
                ...
                const {
                  ...
                  platform: o,
                  elements: i
                } = t, r = await (null == o.isRTL ? void 0 : o.isRTL(i.floating)), l = d(n), s = h(n), a = "y" === g(n), c = _.has(l) ? -1 : 1, f = r && a ? -1 : 1, p = u(e, t);
                let {
                  mainAxis: m,
                  crossAxis: y,
                  alignmentAxis: w
                ...
                return s && "number" == typeof w && (y = "end" === s ? -1 * w : w), a ? {
                  x: y * f,
                  y: m * c
                } : {
                  x: m * c,
          ...
          return void 0 === t && (t = {}), {
            ...
            async fn(e) {
              ...
              const {
                ...
                apply: f = () => {},
                ...p
              } = u(t, e), m = await a.detectOverflow(e, p), y = d(l), w = h(l), x = "y" === g(l), {
                width: b,
                height: v
              } = s.floating;
              let R, k;
              "top" === y || "bottom" === y ? (R = y, k = w === (await (null == a.isRTL ? void 0 : a.isRTL(c.floating)) ? "start" : "end") ? "left" : "right") : (k = y, R = "end" === w ? "top" : "bottom");
              ...
              const S = await a.getDimensions(c.floating);
        ...
        kt = t => ({
          ...
          async fn(e) {
            ...
            let _ = O ? O[L] : 0;
            _ && await (null == s.isElement ? void 0 : s.isElement(O)) || (_ = a.floating[L] || l.floating[b]);
            const S = A / 2 - D / 2,
              C = _ / 2 - v[b] / 2 - 1,
              W = i(g[k], C),
              M = i(g[E], C),
