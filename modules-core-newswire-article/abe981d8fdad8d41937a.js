            ...
            234: function(t, e) {
              ! function(t) {
                ...
                $.parseNew = function() {
                  ...
                  return t.callee = this.parseSubscripts(this.parseExprAtom(), s, r, !0), a && "ImportExpression" === t.callee.type && this.raise(s, "Cannot use new with import()"), this.eat(b.parenL) ? t.arguments = this.parseExprList(b.parenR, this.options.ecmaVersion >= 8, !1) : t.arguments = tt, this.finishNode(t, "NewExpression")
                ...
                _t.prototype.reset = function(t, e, i) {
                  ...
                  var e = t.pos,
                    i = 0;
                  for (t.lastIntValue = 0; It(i = t.current());) t.lastIntValue = 16 * t.lastIntValue + Pt(i), t.advance();
                  return t.pos !== e
                ...
                Lt.tryReadTemplateToken = function() {
                  ...
                  for (var t = "", e = !0, i = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
                    ...
                    if (d(r, s)) this.pos += r <= 65535 ? 1 : 2;
                      ...
                      (e ? u : d)(n, s) || this.invalidStringToken(a, "Invalid Unicode escape"), t += Ot(n), i = this.pos
                    }
                    e = !1
                  }
