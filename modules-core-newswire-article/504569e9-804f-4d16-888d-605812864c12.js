! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "504569e9-804f-4d16-888d-605812864c12", e._sentryDebugIdIdentifier = "sentry-dbid-504569e9-804f-4d16-888d-605812864c12")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [50], {
    89950: (e, t, s) => {
      ...
      var o = s(9623);
      const l = "rockstargames-modules-core-newswire-articleea8cf4797c830e5b5dad68b2ec814e67";
      var c = s(98096);
      const _ = (0, n.withIntl)((e => {
        let {
          children: t,
          to: s = "#",
          reloadDocument: i = !1,
        ...
        const f = (0, a.useRef)(null),
          ...
          g = /^#/.test(s),
          v = b?.target ?? (u ? "_blank" : "_self"),
          {
            ...w
          } = b;
        let y = "";
        if ("aria-label" in w && w["aria-label"] && (y = "_blank" === v ? `${w["aria-label"]} ${p.formatMessage(r.aria_label_open_new_window)}` : w["aria-label"]), (0, a.useEffect)((() => {
        ...
        const h = Object.keys(w).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
          ...e,
          [t]: b[t]
        })), {});
    ...
    93075: (e, t, s) => {
      ...
      const i = (0, n.setMakeVarItem)({
        ...
        g = e => k(e),
        v = () => {
          const e = (0, n.useReactiveVar)(f),
            t = (0, n.useReactiveVar)(u),
            s = (0, n.useReactiveVar)(i),
            a = (0, n.useReactiveVar)(c),
            v = (0, n.useReactiveVar)(m);
          return {
            charactersNeeded: e,
            currentCharId: t,
            hasNotifications: a,
            navOpen: s,
            userData: (0, n.useReactiveVar)(k),
      ...
      s(8384);
      const w = (0, n.getScConfigForOrigin)(),
        y = (0, n.makeVar)(w);
      s(83428);
      const {
        graphEnv: h
      } = (0, n.getScConfigForOrigin)();
      (0, n.getUriForGraphEnv)(h), s(98096);
      const x = {
          data: null,
          characters: {
            gtao: []
        ...
        z = (0, n.setContextItem)({
          context: (0, a.createContext)(x),
          key: "userContext"
        }),
        j = () => (0, a.useContext)(z),
        R = function(e) {
          ...
          return (0, a.useMemo)((() => {
            const a = e?.characters?.[s];
            return "1" === (a?.[t]?.stats?.overview?.hasGtaPlus?.value ?? "0")
          }), [e, s, t])
        };
      s(86082);
      const G = (0, n.setContextItem)({
