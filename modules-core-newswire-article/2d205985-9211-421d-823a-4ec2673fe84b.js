! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "2d205985-9211-421d-823a-4ec2673fe84b", e._sentryDebugIdIdentifier = "sentry-dbid-2d205985-9211-421d-823a-4ec2673fe84b")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [6175, 8556], {
          ...
          value: function() {
            ...
            if (b <= 0 || isNaN(b)) console.warn("Can not process element without height. Make sure the element is displayed and has a static height.");
              ...
              this.setState({
                ...
                if (x = Math.min(v, _), x = Math.max(x, r), x = Math.min(x, a), x = Math.max(x, 0), w()) return t(!0);
                e.setState({
                  fontSize: x
                }, t)
              }], (function(t) {
    ...
    16762: (e, t, r) => {
      "use strict";
      t.zb = void 0;
      var a, s = (a = r(60056)) && a.__esModule ? a : {
        default: a
      };
    ...
    23651: (e, t, r) => {
      ...
      var a, s = (a = r(61771)) && a.__esModule ? a : {
        default: a
      }
    },
    90278: (e, t) => {
    ...
    8458: (e, t, r) => {
      ...
      const i = e => {
        ...
        c = e => {
          const {
            meta: t = {}
          } = (0, n.i)() ?? {}, [r, o] = (0, a.useState)(t?.cdn ?? t?.prod ?? !1);
          return (0, a.useEffect)((() => {
            o(t?.cdn ?? t?.prod ?? !1)
          }), [t]), null === e ? null : e?.startsWith("http") ? i(e) : i(`${(0,s.getCdnPrefix)(r)}${e}`)
        },
        l = () => {
          const {
            meta: e = {}
          } = (0, n.i)() ?? {}, t = (0, a.useMemo)((() => e?.cdn ?? e?.prod ?? !1), [e]);
