! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "c5a61d94-9d76-4c8d-b624-155d421cca21", t._sentryDebugIdIdentifier = "sentry-dbid-c5a61d94-9d76-4c8d-b624-155d421cca21")
  } catch (t) {}
}();
        ...
        W = function(t) {
          ...
          return c(e, t), Object.defineProperty(e.prototype, "parentNode", {
            ...
            get: function() {
              ...
              return {
                width: e && void 0 !== e.width && !this.state.isResizing ? m(e.width) : i("width"),
                height: e && void 0 !== e.height && !this.state.isResizing ? m(e.height) : i("height")
              }
            },
            enumerable: !1,
            configurable: !0
            ...
            if (this.state.isResizing && this.resizable && this.window) {
              ...
              this.props.snap && this.props.snap.x && (S = y(S, this.props.snap.x, this.props.snapGap)), this.props.snap && this.props.snap.y && (m = y(m, this.props.snap.y, this.props.snapGap));
              var W = this.calculateNewSizeFromAspectRatio(S, m, {
                width: R.maxWidth,
                height: R.maxHeight
              }, {
                width: r,
              ...
              if (S = W.newWidth, m = W.newHeight, this.props.grid) {
                var M = b(S, this.props.grid[0]),
                  E = b(m, this.props.grid[1]),
                  _ = this.props.snapGap || 0;
                S = 0 === _ || Math.abs(M - S) <= _ ? M : S, m = 0 === _ || Math.abs(E - m) <= _ ? E : m
              }
              var N = {
                width: S - u.width,
                height: m - u.height
              };
              c && "string" == typeof c && (c.endsWith("%") ? S = S / g.width * 100 + "%" : c.endsWith("vw") ? S = S / this.window.innerWidth * 100 + "vw" : c.endsWith("vh") && (S = S / this.window.innerHeight * 100 + "vh")), f && "string" == typeof f && (f.endsWith("%") ? m = m / g.height * 100 + "%" : f.endsWith("vw") ? m = m / this.window.innerWidth * 100 + "vw" : f.endsWith("vh") && (m = m / this.window.innerHeight * 100 + "vh"));
              var k = {
...
//# sourceMappingURL=cb2a7afa2b41b8916170bb326a3e0cea.js.map