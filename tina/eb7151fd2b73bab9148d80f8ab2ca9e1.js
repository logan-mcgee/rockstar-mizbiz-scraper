...
_global.SENTRY_RELEASE = {
  ...
  [378], {
    1378: (e, n, t) => {
      ...
      const l = function(e) {
        const n = f(e, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0);
      ...
      const g = function(e, n, t) {
          ...
          const g = i - p + (l - y) / 1e4;
          if (g < 0 && void 0 === e.clockseq && (s = s + 1 & 16383), (g < 0 || i > p) && void 0 === e.nsecs && (l = 0), l >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
          p = i, y = l, d = s, i += 122192928e5;
          ...
          for (let e = 0; e < o; ++e) {
            ...
            for (let e = 0; e < 80; ++e) {
              const t = Math.floor(e / 20),
                a = C(o, 5) + M(t, c, s, i) + f + n[t] + r[e] >>> 0;
              f = i, i = s, s = C(c, 30) >>> 0, c = o, o = a
            }
            t[0] = t[0] + o >>> 0, t[1] = t[1] + c >>> 0, t[2] = t[2] + s >>> 0, t[3] = t[3] + i >>> 0, t[4] = t[4] + f >>> 0
          }
