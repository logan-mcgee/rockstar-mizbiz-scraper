/*! For license information please see a0fefbd31210218399d67d61b99161b6.js.LICENSE.txt */ ! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "5dae67be-3a4c-4d52-b6e4-6cd3f79d5ea1", e._sentryDebugIdIdentifier = "sentry-dbid-5dae67be-3a4c-4d52-b6e4-6cd3f79d5ea1")
  } catch (e) {}
}();
  ...
  [832, 544], {
    ...
    1832: (e, t, a) => {
      ...
      a.r(t), a.d(t, {
        ...
        MetaField: () => Pe,
        NameField: () => De,
        PlatformsAndLinksField: () => Le,
        PostEntryFields: () => Ne,
        PostMetaField: () => Fe,
        PreviewImagesField: () => Ae,
        StyleField: () => re,
        TINA_MEMOQ_PREFIX: () => qe,
        TINA_PARSER_KEY: () => Ve,
        TagsField: () => je,
        TextField: () => Re,
        ThemeField: () => $e,
        ...
        defaultItemUnique: () => Ke,
        defaultPricingOptionsUnique: () => Je,
        itemPropsWithKey: () => Ze,
      ...
      const ce = function() {
        ...
        _e = e => {
          ...
          return "discounts" !== a && l.push(et({
            ...
            itemProps: e => Ze(e, {
              label: e?.[qe]?.title ? `${e[qe].title} [Image/Title/Text Block]` : "New [Image/Title/Text Block]"
            })
          }
        },
        Ie = e => {
      ...
      const He = e => {
          ...
          return (0, d.jsxs)(Ge.c, {
            name: n,
            label: o,
            description: i,
            children: [(0, d.jsx)(ze.c, {
              onChange: e => {
                m(e)
              },
              name: a?.name,
        ...
        We = ["de_de", "fr_fr", "it_it", "ja_jp", "ru_ru", "es_es", "es_mx", "pt_br", "ko_kr", "zh_tw", "pl_pl", "zh_hans"],
        Ye = e => {
          let {
            name: t = "image",
            label: a = "Image configuration"
...
//# sourceMappingURL=a0fefbd31210218399d67d61b99161b6.js.map