        ...
        return function e(n, i, s) {
          s = s || 1, Object.keys(n).forEach((function(b) {
            const l = n[b],
              ...
              g = i ? i + r + f(b) : f(b);
            if (!u && !y && p && Object.keys(l).length && (!o.maxDepth || s < c)) return e(l, g, s + 1);
            a[g] = l
          }))
        }(e), a
      }
      e.exports = o, o.flatten = o, o.unflatten = function e(r, c) {
        ...
        return r = Object.keys(r).reduce((function(e, t) {
          ...
          for (; void 0 !== l;) {
            ...
            if (!a && !t && void 0 !== u[o]) return;
            (a && !t || !a && null == u[o]) && (u[o] = "number" != typeof l || c.object ? {} : []), u = u[o], n.length > 0 && (o = b(n.shift()), l = b(n[0]))
          }
          u[o] = e(r[t], c)
        })), s
      }
