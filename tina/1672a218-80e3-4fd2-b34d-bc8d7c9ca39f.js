    ...
    51328: e => {
      ...
      function o(e, o) {
        const r = (o = o || {}).delimiter || ".",
          ...
          a = o.transformKey || n,
          f = {};
        return function e(n, i, b) {
          b = b || 1, Object.keys(n).forEach((function(s) {
            const d = n[s],
              ...
              g = i ? i + r + a(s) : a(s);
            if (!l && !y && p && Object.keys(d).length && (!o.maxDepth || b < c)) return e(d, g, b + 1);
            f[g] = d
          }))
        }(e), f
      }
      e.exports = o, o.flatten = o, o.unflatten = function e(r, c) {
        ...
        return r = Object.keys(r).reduce((function(e, t) {
          ...
          for (; void 0 !== d;) {
            ...
            (f && !t || !f && null == l[o]) && (l[o] = "number" != typeof d || c.object ? {} : []), l = l[o], n.length > 0 && (o = s(n.shift()), d = s(n[0]))
          }
          l[o] = e(r[t], c)
        })), b
      }
