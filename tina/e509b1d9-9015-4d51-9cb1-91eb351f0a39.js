    ...
    6516: (e, t, r) => {
      ...
      function d(e, t, r) {
        var n, d = {},
          u = null,
          i = null;
        for (n in void 0 !== r && (u = "" + r), void 0 !== t.key && (u = "" + t.key), void 0 !== t.ref && (i = t.ref), t) l.call(t, n) && !s.hasOwnProperty(n) && (d[n] = t[n]);
        if (e && e.defaultProps)
      ...
      const o = e => {
        ...
        s = e => {
          ...
          const f = (0, a.useLocale)(),
            ...
            [p, b] = (0, n.useState)(i ?? c?.cdn ?? c?.prod ?? !0);
          (0, n.useEffect)((() => {
            b(i ?? c?.cdn ?? c?.prod ?? !0)
          }), [i, c]);
          ...
          return {
            ...
            src: {
              ...
              desktop: _(u?.[f]?.desktop ?? u?.en_us?.desktop ?? s)
            }
          }
        },
        d = e => {
