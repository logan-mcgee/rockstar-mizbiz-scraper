  ...
  [646], {
    4646: (e, n, t) => {
      ...
      const g = function(e, n, t) {
          ...
          const g = f - p + (l - y) / 1e4;
          if (g < 0 && void 0 === e.clockseq && (c = c + 1 & 16383), (g < 0 || f > p) && void 0 === e.nsecs && (l = 0), l >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
          p = f, y = l, u = c, f += 122192928e5;
          const b = (1e4 * (268435455 & f) + l) % 4294967296;
          o[r++] = b >>> 24 & 255, o[r++] = b >>> 16 & 255, o[r++] = b >>> 8 & 255, o[r++] = 255 & b;
          const h = f / 4294967296 * 1e4 & 268435455;
      ...
      function h(e, n, t) {
        function r(e, r, o, a) {
          ...
          if ("string" == typeof e && (e = function(e) {
              ...
              return n
            }(e)), "string" == typeof r && (r = b(r)), 16 !== (null === (s = r) || void 0 === s ? void 0 : s.length)) throw TypeError("Namespace must be array-like (16 iterable integer values, 0-255)");
          ...
          for (let e = 0; e < o; ++e) {
            ...
            for (let e = 0; e < 80; ++e) {
              const t = Math.floor(e / 20),
                a = C(o, 5) + M(t, s, c, f) + i + n[t] + r[e] >>> 0;
              i = f, f = c, c = C(s, 30) >>> 0, s = o, o = a
            }
            t[0] = t[0] + o >>> 0, t[1] = t[1] + s >>> 0, t[2] = t[2] + c >>> 0, t[3] = t[3] + f >>> 0, t[4] = t[4] + i >>> 0
          }
