try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "bbdc00b5-94b2-4f1a-a779-e72691c307f3", e._sentryDebugIdIdentifier = "sentry-dbid-bbdc00b5-94b2-4f1a-a779-e72691c307f3")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [3304], {
    ...
    85302: (e, a, t) => {
      ...
      const f = u((e => {
        ...
        const {
          track: h
        } = (0, o.useGtmTrack)(), b = (0, n.useIntl)(), [k] = (0, n.getLocale)(), [v, x] = (0, s.useState)(!1), C = (0, s.useRef)(null), [S, N] = (0, s.useState)(0), M = "ontouchstart" in window || navigator?.maxTouchPoints > 0 || navigator?.msMaxTouchPoints > 0, w = e => {
          if (m && m(!1), k.subdomaincom === e || "none" === e) return void(m && m(!1));
            ...
            children: (0, g.jsx)("div", {
              ...
              children: (0, g.jsxs)("select", {
                ...
                children: [(0, g.jsx)("option", {
                  ...
                  children: n.locales.find((e => e.subdomaincom === k.subdomaincom))?.label ?? (0, g.jsx)(n.FormattedMessage, {
      ...
      const T = {
        ...
        O = e => {
          ...
          }), [N, v, x]), m.length > 0 ? (0, g.jsxs)(g.Fragment, {
            children: [(0, g.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), C(r), u === a ? (f(-1), p(0)) : (f(a), p(M + y + y))
              },
              children: [(0, g.jsx)("span", {
              ...
              children: m.map((e => (0, s.createElement)(H, {
                ...e,
                isSubLink: !0,
                key: e.text,
                tabIndex: I || !S ? -1 : 0,
      ...
      const W = e => e < 100 ? "#2d6eb9" : e > 99 && e < 500 ? "#b48261" : e > 499 && e < 750 ? "#9699a1" : "#D6B563",
        A = (0, s.forwardRef)((function(e, a) {
          ...
          const o = W(t),
            i = (0, D.v6)(r, {
              className: z()("rockstargames-modules-gtao-license-platef54750ef62f8600000c94f0caba85986", c),
              "data-testid": n
            });
          return (0, g.jsxs)("div", {
            "data-size": s,
      ...
      const Q = "ProfileCard:characterName",
        ...
        se = e => {
          ...
          const {
            ...
            track: l
          } = (0, o.useGtmTrack)(), r = (0, n.useIntl)(), [i, d] = (0, s.useState)([]), [m, u] = (0, s.useState)(null), [f, p] = (0, s.useState)(null), [_, h] = (0, s.useState)(!1), [b, k] = (0, s.useState)(-1), [v, x] = (0, s.useState)([]), [C, S] = (0, s.useState)(0), N = t(5931), {
            platform: M
      ...
      let ce = "rockstargames-modules-gtao-license-plateb794a0e12537ad5fd506353133b9d60a",
        le = "rockstargames-modules-gtao-license-platec1e8d8d5b52081b34283a5ac0d377362",
        ne = "rockstargames-modules-gtao-license-platedd4bcd955436c8a6982ee16756f7fd8b",
        re = "rockstargames-modules-gtao-license-platee8e5249dac92a2bc76788d0fe7d7dfb7",
      ...
      const ie = e => {
          ...
          const d = (0, s.createRef)(),
            ...
            O = e => {
              ...
              c > a ? (s > 0 ? (() => {
                ...
                e < 0 && (e = 0), b(e), N(x[e]), l && l(e)
              })(), v(0)) : N(x[h] + c * s)
            },
            $ = () => {
              !0 !== u && !0 !== i && (f(!0), !0 !== u && (N(x[h]), v(0)), _(!1))
            };
          return (0, s.useEffect)((() => {
            const e = [];
            r.forEach((() => {
            ...
            C(r.map(((e, a) => (e => {
              let a = 0;
              const t = r.length;
              return 1 === t ? .5 * m - .5 * M - 2 * c + y : (0 === e && (a = c - e * M), e === t - 1 && t > 1 && (a = t * M * -1 + (m - (c - y))), e > 0 && e < t - 1 && (a = e * M * -1 + (.5 * m - .5 * M + .5 * y)), a)
            })(a)))), 1 === r.length ? R(!0) : R(!1)
          }), [d.current, r, m]), (0, s.useEffect)((() => {
            const e = (a = h, r.map(((e, t) => {
              const s = {
                active: !1
              };
            ...
            }), L.length > 1 && !1 === o && (0, g.jsx)("div", {
              className: re,
              children: L.map(((e, a) => (0, g.jsx)("div", {
                className: oe,
        ...
        me = e => {
          ...
          const {
            ...
            track: U
          } = (0, o.useGtmTrack)(), z = (0, _.useRockstarTokenPing)(), {
            data: W,
            loggedIn: A
          } = (0, o.useRockstarUser)(), {
            charactersNeeded: F,
            ...
            setSelectedCharacterTuple: K,
            setUserData: q
          } = (0, o.useRockstarUserState)(), [Q, ee] = (0, s.useState)(null), [ae, te] = (0, s.useState)(!1), [ce, le] = (0, s.useState)(!1), [ne, re] = (0, s.useState)(0), oe = (0, s.createRef)(), me = (0, B.ri)(oe, !1), ue = (0, s.createRef)(), [ge, fe] = (0, s.useState)(0), [pe, _e] = (0, s.useState)([]), [he, be] = (0, s.useState)(244), ke = (0, s.useRef)(null), ve = (0, s.useMemo)((() => (0, L.A)()), []), xe = (0, s.useMemo)((() => ((e, a, t, s, c) => [{
          ...
          return (0, s.useEffect)((() => {
            ...
            a && (ee(a), pe.length > 1 ? te(!0) : te(!1), d(pe.length - 1 > 3))
          }), [V, pe]), (0, s.useEffect)((() => {
            Ce()
          }), [ne, m, b, pe]), (0, s.useEffect)((() => {
            Se(), E()((() => {
              setTimeout(Se, 0)
            }), 300)
          }), [b, k]), (0, s.useEffect)((() => {
            ...
            children: [null !== Q && "gtao" === F && (0, g.jsxs)("div", {
              ...
              children: [(0, g.jsx)(se, {
                ...
                children: [(0, g.jsx)("button", {
                  ...
                  "data-list-closed": t,
                  children: (0, g.jsx)("span", {
                    children: (0, g.jsx)(n.FormattedMessage, {
                  ...
                  children: (0, g.jsx)(ie, {
                    ...
                    disablePager: ce,
                    disableSwiper: ce,
                    children: pe.filter(((e, a) => a !== V)).map((e => (0, s.createElement)(Y, {
                      characterData: e,
                      setMobileCardWidth: be,
        ...
        fe = u((e => {
          ...
          const {
            ...
            track: I
          } = (0, o.useGtmTrack)(), [E, L] = (0, s.useState)(!1), T = (0, s.useRef)(), [P, R] = (0, s.useState)(0), H = (0, s.createRef)(), [O, B] = (0, s.useState)(!1), [D, U] = (0, s.useState)(0), [z, W] = (0, s.useState)(!1), {
            mutateWebSettings: A,
            webSettings: F
          ...
          return (0, s.useEffect)((() => {
            ...
            u && (i && d(!1), h || V(!0))
          }), [u]), void 0 === C ? null : (0, g.jsxs)(p.A, {
            enabled: !!N,
            removeScrollBar: !1,
            children: [(0, g.jsxs)("div", {
              className: [ue.menu, N ? ue.navOpen : ""].join(" "),
              "data-logged-in": C,
              "data-mac-browser": z,
              "data-scroll-mode": k,
              ref: H,
              ...
              className: [ue.scOverlay, N ? ue.navOpen : ""].join(" "),
              "data-logged-in": C
            })]
          })
        })),
        pe = u((e => {
          ...
          }), [l, k, d, r]), (0, g.jsxs)("button", {
            className: "rockstargames-modules-gtao-license-plateee811a1fa8b17eb47afb419dd08ffb03",
            "aria-label": c.formatMessage(m ? j.sc_menu_close : j.sc_menu_open),
            "aria-expanded": m,
            type: "button",
            onClick: x,
            "data-mugshot": h,
      ...
      const he = {
        ...
        be = () => {
          ...
          return null !== t && "gtao" === w && M ? (0, g.jsxs)("div", {
            tabIndex: -1,
            ...
            children: [(0, g.jsx)(se, {
              ...
              children: [(0, g.jsx)("button", {
                ...
                children: (0, g.jsx)("span", {
                  className: _e.scCharacterBtnText,
                  children: (0, g.jsx)(n.FormattedMessage, {
                    ...j.profile_selector_switch_character
                  })
                })
                ...
                "aria-hidden": L,
                children: p.filter(((e, a) => a !== I)).map(((e, a) => (0, g.jsx)(Y, {
                  tabIndex: L ? -1 : 0,
                  onClick: () => R(a),
                  characterData: e,
                ...
                children: (0, g.jsx)(ie, {
                  ...
                  disablePager: i,
                  disableSwiper: i,
                  children: p.filter(((e, a) => a !== I)).map((e => (0, s.createElement)(Y, {
                    characterData: e,
                    setMobileCardWidth: k,
                    key: `${e.platformUsername}-${e.platform}-${e.characterSlot}`,
                    tabIndex: L ? -1 : 0
