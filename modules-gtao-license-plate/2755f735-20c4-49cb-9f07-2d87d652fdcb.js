! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "2755f735-20c4-49cb-9f07-2d87d652fdcb", e._sentryDebugIdIdentifier = "sentry-dbid-2755f735-20c4-49cb-9f07-2d87d652fdcb")
  } catch (e) {}
}();
    ...
    2024: (e, t, a) => {
      ...
      const w = (0, s.withIntl)((e => {
        ...
        const u = (0, r.useRef)(null),
          ...
          g = /^#/.test(a),
          f = d?.target ?? (o ? "_blank" : "_self");
        let {
          ...b
        } = d, h = "";
        if ("aria-label" in b && b["aria-label"] && (h = "_blank" === f ? `${b["aria-label"]} ${m.formatMessage(y.aria_label_open_new_window)}` : b["aria-label"]), (0, r.useEffect)((() => {
          ...
          return (0, x.jsxs)("a", {
            ...
            "aria-label": h,
            ref: u,
            children: [t, "_blank" === f && !h && (0, x.jsx)("span", {
              className: v,
              children: m.formatMessage(y.aria_label_open_new_window)
            })]
          })
        }
        if (_) return (0, x.jsxs)(p.NavLink, {
          title: i,
          to: a,
          onClick: c,
          ...b,
        ...
        const k = Object.keys(b).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
          ...e,
          [t]: d[t]
        })), {});
        return "function" == typeof k?.className && delete k.className, (0, x.jsxs)("a", {
          href: a,
          title: i,
          onClick: c,
          target: f,
      ...
      const S = (0, s.defineMessages)({
        ...
        N = (0, s.withIntl)((e => {
          ...
          const {
            track: l
          } = (0, c.useGtmTrack)(), d = (0, s.useIntl)(), [u, m] = (0, s.getLocale)(), [_, p] = (0, r.useState)(!1), g = (0, r.useMemo)((() => (0, E.A)()), []), f = (0, r.useCallback)((e => {
      ...
      function H(e, t, a, r) {
        ...
        const {
          ...
          left: _,
          bottom: p
        } = r.gridDimensions.margins.pixels, g = Math.floor(e / i), f = e % i, b = c * o + d * (o - 1), h = l * i + u * (i - 1), k = n - s.x - 2 * _, y = a - s.y - m - p, v = y * (c / b), x = k * (l / h), w = g * (c + d) / b, E = {
          x: k * (f * (l + u) / h) + _ + s.x,
          y: y * w + m + s.y
        };
        return {
      ...
      function Z(e, t) {
        ...
        const {
          ...
          camera: u,
          controls: _
        } = s, p = U(), g = !B() || W() ? p * n : 1.6 * p * n, f = [];
        let b = null;
        d.traverse((e => {
          e.name === Te.LP && f.push(e), e.userData.index === a && (b = e)
        }));
      ...
      const vt = "#898989",
        ...
        Ct = e => {
          ...
          return (0, r.useEffect)((() => {
            ...
            ce.shaderIndex.value = h ? g ? 0 : 2 : 0, O.current && (O.current.bumpScale = .015 * v, O.current.needsUpdate = !0)
          }), [O.current, g, h, v]), (0, r.useEffect)((() => {
            if (T.map && w[n] !== T.map) {
              const e = [...w];
              e[n] = T.map, d(e)
            }
          }), [T, w]), (0, r.useEffect)((() => {
            const [e, t, a] = M(C ? f : s.plateText);
            A({
              map: t,
              bumpMap: e,
              roughnessMap: a
            })
          }), [C ? f : void 0, C ? S : void 0]), (0, r.useMemo)((() => p && T.map && T.bumpMap ? (0, x.jsxs)("mesh", {
            name: Te.LP,
            visible: !0,
            userData: {
              index: n
      ...
      const jt = {
        ...
        Ot = e => {
          ...
          (0, r.useEffect)((() => {
            f && S.current && !f?.controlsInit && n({
              ...f,
              controls: S,
              controlsInit: !0
            })
          }), [S.current, f]), (0, r.useEffect)((() => {
            f?.scene && S?.current && (S.current.enabled = k)
          }), [k, f]), (0, r.useEffect)((() => {
      ...
      const Vt = e => {
          ...
          const {
            ...
            currentView: _
          } = m, p = (0, r.useRef)(null), g = (0, r.useState)(te), f = d?.get ? d.get() : 0, b = (0, Mt.useSpring)({
            y: t ? f : u,
            config: {
                ...
                if (!y.current)
                  if (h.current = Math.max(a, Math.min(s, b.y.get() + e.delta[1])), k.current = e.movement[1], e.dragging) b.y.set(h.current);
                    ...
                    if (h.current < a / 2) {
                      ...
                      p.current.style.touchAction = "auto", p.current.style.overflowY = "auto", g.current = ae
                      ...
                      p.current.style.touchAction = "none", p.current.style.overflowY = "hidden", g.current = re
                    } else {
                      const t = M().to(e, {
                        y: 0,
                        ease: le.sidebar.mobile.drawerSnap.ease,
                      ...
                      p.current.style.touchAction = "none", p.current.style.overflowY = "hidden", g.current = te
                    }
                    h.current = b.y.get()
                  } const t = {
                  top: a,
            ...
            w = () => {
              if (Math.abs(k.current) < 3) {
                ...
                const e = {
                  ...
                  t = {};
                g.current === te ? (t.y = a, p.current.style.touchAction = "auto", p.current.style.overflowY = "auto", g.current = ae) : (g.current === ae || g.current === re) && (t.y = 0, p.current.style.touchAction = "none", p.current.style.overflowY = "hidden", g.current = te), M().to(e, {
                  y: t.y,
                  duration: le.sidebar.mobile.drawerSnap.duration,
                  ease: le.sidebar.mobile.drawerSnap.ease,
                  onUpdate: () => {
          ...
          return (0, r.useMemo)((() => (0, x.jsxs)(Mt.animated.div, {
            ...v(),
            ref: p,
            style: b ? {
              y: b.y
        ...
        qt = (0, d.withTranslations)((e => {
              ...
              if (c && l && u && d) {
                ...
                r.to(f, {
                  ...
                  onUpdate: () => {
                    const {
                      current: a
                    } = f, r = (0, ht.Cc)(Number(i.x), g.x, a), s = (0, ht.Cc)(Number(i.y), g.y + (N ? .4 * window.innerHeight / -2 : 0), a), n = (0, ht.Cc)(Number(i.scale), _, a);
            ...
            j?.scene && J?.current && (e => {
              ...
              switch (e) {
                case Ht: {
                  ...
                  e && t && a && r && Oe(s), he?.current && s.to([J.current, he.current, N ? void 0 : K.current], {
                    autoAlpha: 1,
                  ...
                  }, 0), j?.camera && N && !Q.current && (Q.current = j.camera.fov);
                  break
                }
                default:
          ...
          (0, r.useEffect)((() => {
            w && (Ae.current = w), n() === Ce.VIEW_PLATE ? De() : W() && (Me(), fe(.4 * window.innerHeight))
          }), [w]), (0, r.useEffect)((() => {
            if (!j?.scene) return;
      ...
      const Kt = JSON.parse('{"assets":[],"layers":[{"ddd":0,"ind":0,"ty":4,"nm":"Shape Layer 1","ks":{"o":{"k":100},"r":{"k":0},"p":{"k":[300,300,0]},"a":{"k":[0,0,0]},"s":{"k":[244,244,100]}},"ao":0,"shapes":[{"d":1,"ty":"el","s":{"k":[100,100]},"p":{"k":[0,0]},"nm":"Ellipse Path 1","mn":"ADBE Vector Shape - Ellipse"},{"ty":"tm","s":{"k":[{"i":{"x":[0.439],"y":[1.016]},"o":{"x":[0.561],"y":[0.015]},"n":["0p439_1p016_0p561_0p015"],"t":5,"s":[100],"e":[0]},{"t":33.0000013441176}],"ix":1},"e":{"k":[{"i":{"x":[0.439],"y":[1.017]},"o":{"x":[0.561],"y":[0.016]},"n":["0p439_1p017_0p561_0p016"],"t":0,"s":[100],"e":[0]},{"t":30.0000012219251}],"ix":2},"o":{"k":0,"ix":3},"m":1,"ix":2,"nm":"Trim Paths 1","mn":"ADBE Vector Filter - Trim"},{"ty":"st","fillEnabled":true,"c":{"k":[1,1,1,1]},"o":{"k":100},"w":{"k":16},"lc":2,"lj":1,"ml":4,"nm":"Stroke 1","mn":"ADBE Vector Graphic - Stroke"}],"ip":0,"op":900.000036657751,"st":0,"bm":0,"sr":1}],"v":"4.5.3","ddd":0,"ip":1.00000004073083,"op":33.0000013441175,"fr":29.9700012207031,"w":600,"h":600}'),
        ...
        sa = (0, d.withTranslations)((e => {
          ...
          (0, r.useEffect)((() => {
            ...
            f === Ce.NEW_PLATE && document.activeElement === j.current && j.current?.setSelectionRange(w, w)
          }), [w]), (0, r.useEffect)((() => {
            j?.current && f === Ce.NEW_PLATE && setTimeout((() => j?.current?.focus()), 1e3)
          }), [f, j?.current]);
          const O = f === Ce.NEW_PLATE ? 0 : -1,
            z = (0, r.useCallback)((() => {
              (async () => {
                if (n && h) try {
                  t(!0);
            ...
            children: [(0, x.jsxs)("section", {
              children: [(0, x.jsx)("label", {
                ...
                children: [(0, x.jsx)("i", {
                  ...
                  type: "text",
                  onKeyDown: e => {
                    "Enter" === e.code && f === Ce.NEW_PLATE && j.current && j.current.blur()
                  },
                  value: P,
                  ref: j
                }), (0, x.jsx)(ta, {
        ...
        da = (0, d.withTranslations)((e => {
          ...
          const N = g[se.CONFIRM_CONTENT]?.current,
            ...
            W = y.current,
            B = g[se.UI]?.current,
            F = g[se.NEW_PLATE_UI]?.current,
            U = g[se.SIDEBAR]?.current,
          ...
          }), [t, E.current, f, _, b ? i : void 0]), (0, x.jsx)("div", {
        ...
        ua = (0, d.withTranslations)((e => {
          ...
          const {
            ...
            loggedIn: R
          } = (0, c.useRockstarUser)(), C = (0, o.useRockstarTokenPing)(), T = g === Ce.CONFIRM_ORDER, [A, I] = (0, r.useState)(P), [j, O] = (0, r.useState)(!1), z = (0, r.useRef)(null), V = (0, r.useRef)(null), D = (0, r.useRef)(null), {
            track: W
          } = (0, c.useGtmTrack)(), B = {
            view_name: "license plate creator - confirm order"
          }, F = g === Ce.CONFIRM_ORDER ? 0 : -1;
          (0, r.useEffect)((() => {
          ...
          }), [R, N, h?.[0]?.plateText, f, j, E]);
          (0, r.useEffect)((() => {
            if (g !== Ce.CONFIRM_ORDER || S) {
              if (y && !S) {
                Q && M().set(Q, {
                  pointerEvents: "all"
                });
        ...
        ga = (0, d.withTranslations)((e => {
          ...
          (0, r.useEffect)((() => {
            p?.[0]?.current && g === Ce.NEW_PLATE && ie($(p[0].parentElement))
          }), [p, g]);
          ...
          const He = (0, r.useCallback)((function(e) {
            ...
            switch (e) {
              case pa: {
                ...
                Ge?.current && Ge.current.getWorldPosition(i);
                ...
                if (y && E) {
                  ...
                  R.translateY = {
                    start: g === Ce.NEW_PLATE ? Fe?.current?.offsetHeight : 0,
                    end: g === Ce.NEW_PLATE ? 0 : Fe?.current?.offsetHeight
                ...
                if (g === Ce.NEW_PLATE) {
                  ...
                  h.to(T, {
                    ...
                    onComplete: () => {
                      g === Ce.NEW_PLATE && (o && (o.style.touchAction = "none"), _e.current = new m.Vector3(r.position.x, r.position.y, r.position.z), Le?.current?.children && Le.current.querySelectorAll("button").forEach((e => {
                        e.style.pointerEvents = "all"
                ...
                } else g === Ce.CONFIRM_ORDER && (!0 === Ae.current && st(), y && (h.to(T, {
                  current: 1,
                  duration: le.sidebar.mobile.drawer.duration,
                  ease: le.sidebar.mobile.drawer.ease,
                  onUpdate: () => {
              ...
              default:
                ...
                if (g === Ce.CONFIRM_ORDER ? v || 1 == !Ae.current && M().to(r.position, {
          ...
          }), [g, T, C, y, P, f, b, E, S, A, K, Y, oe.current, Ae.current, k]);
          (0, r.useEffect)((() => {
          ...
          const Xe = (0, r.useCallback)((function(e) {
              ...
              }), s = U(), n = y && g === Ce.CONFIRM_ORDER ? 1.5 : 1, o = !B() || y ? s * f * n : 1.6 * s * f, c = C[se.ROOT].current, l = document.getElementById("list-plates-sidebar"), d = C[se.CANVAS_WRAP].current, u = p[0].current;
              if (c && (y || l) && u && d) {
                const e = H(0, c, Number(A.replace("px", "")), b, y ? void 0 : {
                  ...
                  k = p.map((e => e?.current ? Number(getComputedStyle(e?.current).getPropertyValue("opacity")) : null)).filter((e => e));
                console.log(u, k);
                const v = S === Ce.CONFIRM_ORDER ? le.transaction.confirmOrder.ease : le.clickPlate.ease,
                ...
                r.to(h, {
                  ...
                  onUpdate: () => {
                    const {
                      current: a
                    } = h, r = (0, ht.Cc)(Number(n.x), f.x, a), s = (0, ht.Cc)(Number(n.y), f.y + (y ? w / -2 : 0), a), i = (0, ht.Cc)(Number(n.scale), _, a);
            ...
            }), [b, A, y, g, G, T, p, C, S, Oe?.current, E]),
            Ze = (0, r.useCallback)((() => {
              ...
              z ? (g === Ce.NEW_PLATE && (W() ? s.domElement.style.transform = `translateY(${.4*window.innerHeight/-2}px)` : s.domElement.style.transform = "translateY(0px)", Me?.current && (Me.current.style.opacity = "1", Me.current.style.visibility = "visible", Me.current.style.pointerEvents = "all")), g === Ce.CONFIRM_ORDER && W() && (s.domElement.style.transform = `translateY(${Y/1.5}px)`)) : g !== Ce.CONFIRM_ORDER || W() || (s.domElement.style.transform = "translateY(0px)"), i() !== Ce.NEW_PLATE && i() !== Ce.CONFIRM_ORDER || Xe(null, !0), W() && Je(), Ae.current && rt({
                isResize: !0,
                onComplete: null,
                delay: 0
              })
            }), [W(), z, k, g, T, Me.current, f, E]),
          ...
          }), [T, z, g === Ce.CONFIRM_ORDER, S]), (0, r.useEffect)((() => {
          ...
          (0, r.useEffect)((() => {
            ...
            je.current || (je.current = g), Oe.current || (Oe.current = je.current), g && (Oe.current = je.current, o(je.current), je.current = g), g === Ce.LIST_PLATES && Ae.current && Ke({}, !0), g === Ce.NEW_PLATE && (ze.current = !1)
          }), [g]), (0, r.useEffect)((() => {
          ...
          (0, r.useEffect)((() => {
            f && (Qe.current = f), i() === Ce.NEW_PLATE || i() === Ce.CONFIRM_ORDER ? Ze() : W() && (Je(), J(window.innerHeight), Fe.current && (Fe.current.style.transform = `translateY(${Fe.current.offsetHeight}px`))
          }), [f]);
          const et = (0, r.useCallback)((function(e, t) {
            ...
            }), [T, Ae.current, Ge, Ge?.current, f, y, I, k]),
            st = (0, r.useCallback)((function() {
              ...
              const {
                ...
                camera: a,
                controls: r
              } = T, n = e.delay || 0, i = t.getObjectByName("Scene"), o = t.getObjectByName("Light1"), c = t.getObjectByName("Light2"), l = t.getObjectByName("Light3"), d = U(), u = !B() || y ? d * f : 1.6 * d * f;
            ...
            }), [T, Ae.current, Ge, Ge?.current, f, I, k]),
        ...
        fa = "rockstargames-modules-gtao-license-plateba2215c87866e0b4c5739e49512b96ef",
      ...
      const Pa = () => {
          ...
          const R = (0, r.useCallback)((e => {
            ...
            switch (x.traverse((e => {
                ...
                duration: g ? S.mobile.drawer.duration : w.duration,
                ease: g ? S.mobile.drawer.ease : w.ease
              }), e) {
              case wa: {
                ...
                if (Ea.to(e, {
                    ...
                    onUpdate: () => {
                      ...
                      if (c.current.target.x = s.x, c.current.target.y = s.y, c.current.target.z = s.z, j && j.parentElement?.classList?.contains(fa)) {
                  ...
                  }, 0), (o.length === y.length && o?.[0]?.current || v && !f && o[0].current && o?.filter((e => e?.current)).length === y.length && 0 !== y.length && 0 !== o.length) && !Sa) {
                  const e = {
                    current: 0
                  };
                  Sa = !0, Ea.to(e, {
                ...
                Ea.to(R, {
                  autoAlpha: 1,
                  duration: g ? S.mobile.footer.in.duration : S.in.duration,
                  ease: g ? S.mobile.footer.in.ease : S.in.ease,
                  delay: g ? S.mobile.footer.in.delay : S.in.delay
                }, 0), Ea.to(C, {
                  autoAlpha: 1,
                  duration: g ? S.mobile.fadeHeader.in.duration : S.in.duration,
                  ease: g ? S.mobile.fadeHeader.in.ease : S.in.ease,
                  delay: g ? S.mobile.fadeHeader.in.delay : S.in.delay,
                  onStart: () => {
                    T && (f ? (T.classList.add(va), A && A.classList.add(ha), I && I.classList.remove(ka)) : (T.classList.remove(va), A && A.classList.remove(ha), I && I.classList.add(ka)))
                  }
                }, 0), g && (N && M().set(N.style, {
                  visibility: "visible"
              ...
              default:
                if (M().to(R, {
                    autoAlpha: 0,
                    duration: g ? S.mobile.footer.out.duration : S.out.duration,
                    ease: g ? S.mobile.footer.out.ease : S.out.ease
                  }), N && M().set(N.style, {
                    visibility: "hidden"
          ...
          }), [b, S, E.current, _, p, g, f, b?.[se.FOOTER]?.current, b?.[se.SIDEBAR]?.current]), (0, x.jsx)("div", {
            ref: E,
        ...
        Na = e => {
          ...
          return t && (u = d ? (0, zt.createPortal)((0, x.jsx)(Pa, {}), d) : null), (0, x.jsxs)("div", {
            ...
            children: [a && !t && (0, x.jsx)(ua, {}), t ? u : (0, x.jsx)(Pa, {}), a && (0, x.jsx)(qt, {}), (0, x.jsx)(ga, {})]
          })
        },
        ...
        Ia = e => {
          ...
          const [i, l] = (0, r.useState)(!1), {
            ...
            (async () => {
              ...
              _(a), p(null), g(""), f(V(Ae.style.name)?.id), E({
                ...S,
                event: "cta_cancel",
        ...
        Oa = e => {
          ...
          const V = d === Ce.LIST_PLATES ? 0 : -1,
            ...
            G = (0, r.useMemo)((() => void 0 !== b ? Y(g, b) ? (0, x.jsx)(Ia, {
              t,
            ...
            F = (0, r.useMemo)((() => void 0 !== g && S ? (0, x.jsx)("div", {
              onKeyPress: e => {
                "Space" !== e.code && "Enter" !== e.code || (z({
                  ...M,
                  event: "license_plate_create_click",
              ...
              children: G
            }) : null), [d, g, S, h, N, G, k, C]);
          return (0, r.useEffect)((() => {
            if (v?.[0]) {
              const e = v[0].image;
              if (e && j.current) {
                const t = j.current.querySelector("canvas");
                t && j.current.removeChild(t), e.style.width = "100%", e.style.height = "100%", e.style.position = "absolute", e.style.top = "0px", e.style.left = "0px", e.style.pointerEvents = "none", e.style.opacity = 1, e.style.transition = "transform 0.25s ease-out", a && !g && d === Ce.LIST_PLATES && e.classList.add(ma.newOrder), j.current.append(e)
              }
            }
          }), [v, j.current, g, a, d]), (0, r.useEffect)((() => {
            ...
            const e = Y(g, b) ? ma.pendingOrderShader : "",
        ...
        Ma = e => {
          ...
          const {
            ...
            loggedIn: _
          } = (0, c.useRockstarUser)(), [p, g] = (0, r.useState)([]), f = (0, r.useRef)(null), b = (0, r.useRef)([]);
          return (0, r.useEffect)((() => {
