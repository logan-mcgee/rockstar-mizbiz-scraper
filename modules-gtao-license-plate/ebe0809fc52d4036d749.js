    ...
    6531: (t, e, i) => {
      ...
      class x {
        ...
        compute(t) {
          ...
          v && (e.first = e._active && !e.active, e.last = !e._active && e.active, e.active = n[this.ingKey] = e._active, t && (e.first && ("bounds" in i && (e._bounds = k(i.bounds, e)), this.setup && this.setup()), e.movement = d, this.computeOffset()));
          const [f, m] = e.offset, [
            [g, _],
            [b, y]
          ] = e._bounds;
      ...
      const A = t => t,
        ...
        C = r(r({}, M), {}, {
          ...
          bounds() {
            ...
            if ("function" == typeof t) return e => C.bounds(t(e));
      ...
      function P() {
        return D && "ontouchstart" in window || D && window.navigator.maxTouchPoints > 1
      }
      const K = {
          isBrowser: D,
          gesture: function() {
      ...
      function Z(t) {
        J.set(t.key, t.engine), Q.set(t.key, t.resolver)
      }
      const q = {
          key: "drag",
          engine: class extends I {
            ...
            keyUp(t) {
              t.key in V && (this.state._keyboardActive = !1, this.setActive(), this.compute(t), this.emit())
            }
            bind(t) {
        ...
        $ = {
          ...
          engine: class extends x {
            ...
            wheelChange(t) {
              ...
              const e = this.state;
              e._delta = [-S(t)[1] / 100 * e.offset[0], 0], s.V.addTo(e._movement, e._delta), z(e), this.state.origin = [t.clientX, t.clientY], this.compute(t), this.emit()
            }
            wheelEnd() {
        ...
        et = {
          ...
          engine: class extends I {
            ...
            wheelChange(t) {
              const e = this.state;
              e._delta = S(t), s.V.addTo(e._movement, e._delta), z(e), this.compute(t), this.emit()
            }
            wheelEnd() {
              this.state._active && (this.state._active = !1, this.compute(), this.emit())
            }
