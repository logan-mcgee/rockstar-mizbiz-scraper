! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "78c24027-0ff9-45e9-a520-a90b68852492", e._sentryDebugIdIdentifier = "sentry-dbid-78c24027-0ff9-45e9-a520-a90b68852492")
  } catch (e) {}
}();
      ...
      const Et = e => {
        ...
        Bt = (0, i.withTranslations)((e => {
          ...
          const {
            ...
            loggedIn: O
          } = (0, o.useRockstarUser)(), A = (0, s.useRockstarTokenPing)(), L = g === me.CONFIRM_ORDER, [j, M] = (0, r.useState)(I), [V, D] = (0, r.useState)(!1), W = (0, r.useRef)(null), Y = (0, r.useRef)(null), z = (0, r.useRef)(null), {
            track: U
          } = (0, o.useGtmTrack)(), $ = {
            view_name: "license plate creator - confirm order"
          }, H = g === me.CONFIRM_ORDER ? 0 : -1;
          (0, r.useEffect)((() => {
            p(B.CONFIRM_SIDEBAR, W)
          }), [W.current]), (0, r.useEffect)((() => {
            p(B.CONFIRM_CONTENT, Y)
          }), [Y.current]);
          const G = S[B.ORDER_BG]?.current,
            q = S[B.CONFIRM_CONTENT]?.current,
            X = S[B.CONFIRM_SIDEBAR]?.current,
            Z = S[B.CONFIRM_SIDEBAR_BUTTONS_PORTAL]?.current,
            K = S[B.CONFIRM_SIDEBAR_BUTTONS]?.current,
            J = S[B.ACCESSIBLE_PLATE_GRID]?.current,
            Q = S[B.NEW_PLATE_SIDEBAR]?.current,
            ee = S[B.CANVAS_WRAP]?.current,
            te = S[B.SIDEBAR_BUTTONS]?.current,
            ae = S[B.NEW_PLATE_UI]?.current;
            ...
            if (g !== me.CONFIRM_ORDER || C) {
              if (P && !C) {
                ...
                v().to(e, {
                  ...
                  duration: F.sidebar.mobile.drawer.duration,
                  ease: F.sidebar.mobile.drawer.ease
                }), Z && (Z.style.pointerEvents = "none", v().to(Z.style, {
                  opacity: 0,
                  duration: F.sidebar.mobile.drawer.duration,
                  ease: F.sidebar.mobile.drawer.ease
                }))
              ...
              if (z.current?.focus(), !(E?.camera && q && X && ee && G && J)) return;
              let e = _();
              P || 100 !== e || (e = 0);
              const t = v().timeline({
                  defaults: {
              ...
              if (te && v().set(te, {
                  pointerEvents: "none"
                }), P && (a.ease = F.sidebar.mobile.drawer.ease, a.duration = F.sidebar.mobile.drawer.duration, a.delay = F.sidebar.mobile.drawer.duration / 2, r.ease = F.sidebar.mobile.drawer.ease, r.duration = F.sidebar.mobile.drawer.duration, X && t.to(X, a, 0), J)) {
                const e = {
                    current: 0
                  },
                  a = {
              ...
              if (P) {
                if (K) {
                  K.style.pointerEvents = "all", v().set(K.style, {
                    visibility: "visible"
                  });
                  const e = {
                    lerp: 0
                ...
                Z && (Z.style.pointerEvents = "all", v().set(Z.style, {
                  visibility: "visible"
                }), v().to(Z.style, {
                  opacity: 1,
                  duration: F.sidebar.mobile.drawer.duration,
          ...
          let le;
          return P && (le = Z ? (0, vt.createPortal)(oe, Z) : null), (0, Qe.jsx)("div", {
