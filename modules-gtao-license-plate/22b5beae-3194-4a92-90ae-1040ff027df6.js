  ...
  [24], {
    ...
    2024: (e, t, a) => {
      ...
      const w = (0, s.withIntl)((e => {
        ...
        const h = Object.keys(g).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
          ...e,
          [t]: l[t]
        })), {});
            ...
            switch (e) {
              case pa: {
                ...
                const o = C[se.ROOT].current,
                  ...
                  E = p?.[0].current;
                o && (b || y) && E && x && (f === Ce.NEW_PLATE || y && f === Ce.CONFIRM_ORDER) && Xe(h, t);
                const N = (new m.Vector3).copy(i);
                Ae.current && (N.z = i.z - 5 * g);
                const R = {
                  cameraPosition: {
        ...
        Ia = e => {
          ...
          const [i, l] = (0, r.useState)(!1), {
            ...
            (async () => {
              ...
              _(a), p(null), f(""), g(V(Ae.style.name)?.id), E({
                ...S,
                event: "cta_cancel",
