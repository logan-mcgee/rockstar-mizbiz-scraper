try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "0e00e24c-5443-4980-8ad2-2f7b0ceeed51", e._sentryDebugIdIdentifier = "sentry-dbid-0e00e24c-5443-4980-8ad2-2f7b0ceeed51")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [6801], {
    76801(e, t, a) {
      ...
      function i(e, t, a, n, r, o) {
        if ("string" == typeof e && (e = document.getElementById(e)), e && ("HTMLImageElement" !== Object.prototype.toString.call(e).slice(8, -1) || "naturalWidth" in e)) {
          var i = r ? "offset" : "natural",
            l = e[i + "Width"],
            d = e[i + "Height"];
          if ("ImageBitmap" === Object.prototype.toString.call(e).slice(8, -1) && (l = e.width, d = e.height), "string" == typeof t && (t = document.getElementById(t)), t && "getContext" in t) {
            o || (t.style.width = l + "px", t.style.height = d + "px"), t.width = l, t.height = d;
            var g = t.getContext("2d");
            g.clearRect(0, 0, l, d), g.drawImage(e, 0, 0, e.naturalWidth, e.naturalHeight, 0, 0, l, d), isNaN(a) || a < 1 || (n ? f(t, 0, 0, l, d, a) : s(t, 0, 0, l, d, a))
          }
        }
      }
      ...
      function d(e, t, a, n, i, l) {
        for (var f, d = e.data, s = 2 * l + 1, g = n - 1, b = i - 1, u = l + 1, y = u * (u + 1) / 2, p = new c, v = p, h = 1; h < s; h++) v = v.next = new c, h === u && (f = v);
        v.next = p;
        for (var m = null, w = null, x = 0, _ = 0, E = r[l], I = o[l], k = 0; k < i; k++) {
          v = p;
          for (var C = d[_], B = d[_ + 1], S = d[_ + 2], T = d[_ + 3], D = 0; D < u; D++) v.r = C, v.g = B, v.b = S, v.a = T, v = v.next;
        ...
        for (var oe = 0; oe < n; oe++) {
          var ie = d[_ = oe << 2],
            ...
            ve = y * de;
          v = p;
          for (var he = 0; he < u; he++) v.r = ie, v.g = le, v.b = fe, v.a = de, v = v.next;
          for (var me = n, we = 0, xe = 0, _e = 0, Ee = 0, Ie = 1; Ie <= l; Ie++) {
            _ = me + oe << 2;
            var ke = u - Ie;
            ue += (v.r = ie = d[_]) * ke, ye += (v.g = le = d[_ + 1]) * ke, pe += (v.b = fe = d[_ + 2]) * ke, ve += (v.a = de = d[_ + 3]) * ke, Ee += ie, we += le, xe += fe, _e += de, v = v.next, Ie < b && (me += n)
          }
          _ = oe, m = p, w = f;
          for (var Ce = 0; Ce < i; Ce++) {
            var Be = _ << 2;
            d[Be + 3] = de = ve * E >>> I, de > 0 ? (de = 255 / de, d[Be] = (ue * E >>> I) * de, d[Be + 1] = (ye * E >>> I) * de, d[Be + 2] = (pe * E >>> I) * de) : d[Be] = d[Be + 1] = d[Be + 2] = 0, ue -= se, ye -= ge, pe -= ce, ve -= be, se -= m.r, ge -= m.g, ce -= m.b, be -= m.a, Be = oe + ((Be = Ce + u) < b ? Be : b) * n << 2, ue += Ee += m.r = d[Be], ye += we += m.g = d[Be + 1], pe += xe += m.b = d[Be + 2], ve += _e += m.a = d[Be + 3], m = m.next, se += ie = w.r, ge += le = w.g, ce += fe = w.b, be += de = w.a, Ee -= ie, we -= le, xe -= fe, _e -= de, w = w.next, _ += n
          }
        }
        return e
      }
      ...
      function g(e, t, a, n, i, l) {
        ...
        for (var m, w, x = null, _ = null, E = r[l], I = o[l], k = 0, C = 0, B = 0; B < i; B++) {
          ...
          for (var O = 0, W = 0, L = 0, Y = 1; Y < u; Y++) m = C + ((g < Y ? g : Y) << 2), G += (v.r = S = d[m]) * (w = u - Y), j += (v.g = T = d[m + 1]) * w, A += (v.b = D = d[m + 2]) * w, O += S, W += T, L += D, v = v.next;
          x = p, _ = f;
          for (var q = 0; q < n; q++) d[C] = G * E >>> I, d[C + 1] = j * E >>> I, d[C + 2] = A * E >>> I, G -= M, j -= N, A -= R, M -= x.r, N -= x.g, R -= x.b, m = k + ((m = q + l + 1) < g ? m : g) << 2, G += O += x.r = d[m], j += W += x.g = d[m + 1], A += L += x.b = d[m + 2], x = x.next, M += S = _.r, N += T = _.g, R += D = _.b, O -= S, W -= T, L -= D, _ = _.next, C += 4;
          k += n
        }
        for (var z = 0; z < n; z++) {
          var F = d[C = z << 2],
          ...
          for (var ee = 0, te = 0, ae = 0, ne = 1, re = n; ne <= l; ne++) C = re + z << 2, V += (v.r = F = d[C]) * (w = u - ne), X += (v.g = J = d[C + 1]) * w, Z += (v.b = K = d[C + 2]) * w, ee += F, te += J, ae += K, v = v.next, ne < b && (re += n);
          C = z, x = p, _ = f;
          for (var oe = 0; oe < i; oe++) d[m = C << 2] = V * E >>> I, d[m + 1] = X * E >>> I, d[m + 2] = Z * E >>> I, V -= P, X -= Q, Z -= U, P -= x.r, Q -= x.g, U -= x.b, m = z + ((m = oe + u) < b ? m : b) * n << 2, V += ee += x.r = d[m], X += te += x.g = d[m + 1], Z += ae += x.b = d[m + 2], x = x.next, P += F = _.r, Q += J = _.g, U += K = _.b, ee -= F, te -= J, ae -= K, _ = _.next, C += n
        }
        return e
      }
      var c = function e() {
