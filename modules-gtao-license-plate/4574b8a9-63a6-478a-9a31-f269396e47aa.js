! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      e = (new t.Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "4574b8a9-63a6-478a-9a31-f269396e47aa", t._sentryDebugIdIdentifier = "sentry-dbid-4574b8a9-63a6-478a-9a31-f269396e47aa")
  } catch (t) {}
}();
  ...
  [8149], {
    ...
    8582: (t, e, i) => {
      ...
      function E() {
        ...
        return 0 === e.length ? M : 1 === e.length ? e[0] : function() {
          let t;
      ...
      const $ = {
        ...
        Z = {
          ...
          engine: class extends x {
            ...
            wheelChange(t) {
              ...
              const e = this.state;
              e._delta = [-S(t)[1] / 100 * e.offset[0], 0], s.V.addTo(e._movement, e._delta), G(e), this.state.origin = [t.clientX, t.clientY], this.compute(t), this.emit()
            }
            wheelEnd() {
        ...
        et = {
          ...
          engine: class extends O {
            ...
            wheelChange(t) {
              const e = this.state;
              e._delta = S(t), s.V.addTo(e._movement, e._delta), G(e), this.compute(t), this.emit()
            }
            wheelEnd() {
              this.state._active && (this.state._active = !1, this.compute(), this.emit())
            }
