(self.webpackChunk_rockstargames_modules_gtao_license_plate = self.webpackChunk_rockstargames_modules_gtao_license_plate || []).push([
  [451], {
    ...
    7898: (t, e, i) => {
      ...
      function f(t) {
        return v(t) ? "touch" : "pointerType" in t ? t.pointerType : "mouse"
      }
      ...
      function y(t) {
        const e = m(t);
        return v(t) ? e.identifier : e.pointerId
      }
      ...
      function E(t) {
        ...
        return 1 === s ? (e *= S, i *= S) : 2 === s && (e *= k, i *= k), [e, i]
      }
      ...
      function x() {
        ...
        return 0 === e.length ? O : 1 === e.length ? e[0] : function() {
          let t;
      ...
      class A {
        ...
        start(t) {
          const e = this.state,
            i = this.config;
          e._active || (this.reset(), this.computeInitial(), e._active = !0, e.target = t.target, e.currentTarget = t.currentTarget, e.lastOffset = i.from ? T(i.from, e) : e.offset, e.offset = e.lastOffset), e.startTime = e.timeStamp = t.timeStamp
        }
        computeValues(t) {
          const e = this.state;
        ...
        compute(t) {
          ...
          v && (e.first = e._active && !e.active, e.last = !e._active && e.active, e.active = n[this.ingKey] = e._active, t && (e.first && ("bounds" in i && (e._bounds = T(i.bounds, e)), this.setup && this.setup()), e.movement = d, this.computeOffset()));
          const [f, m] = e.offset, [
            [g, _],
            [b, y]
          ] = e._bounds;
          e.overflow = [f < g ? -1 : f > _ ? 1 : 0, m < b ? -1 : m > y ? 1 : 0], e._movementBound[0] = !!e.overflow[0] && (!1 === e._movementBound[0] ? e._movement[0] : e._movementBound[0]), e._movementBound[1] = !!e.overflow[1] && (!1 === e._movementBound[1] ? e._movement[1] : e._movementBound[1]);
          const w = e._active && i.rubberband || [0, 0];
          if (e.offset = (0, s.c)(e._bounds, e.offset, w), e.delta = s.V.sub(e.offset, p), this.computeMovement(), v && (!e.last || o > 32)) {
            e.delta = s.V.sub(e.offset, p);
            const t = e.delta.map(Math.abs);
            s.V.addTo(e.distance, t), e.direction = e.delta.map(Math.sign), e._direction = e._delta.map(Math.sign), !e.first && o > 0 && (e.velocity = [t[0] / o, t[1] / o])
          }
        }
        emit() {
          const t = this.state,
      ...
      class M extends A {
        ...
        axisIntent(t) {
          const e = this.state,
            i = this.config;
          if (!e.axis && t) {
            const s = "object" == typeof i.axisThreshold ? i.axisThreshold[f(t)] : i.axisThreshold;
            e.axis = function(t, e) {
              let [i, s] = t;
              const n = Math.abs(i),
                o = Math.abs(s);
      ...
      const C = t => t,
        V = {
          ...
          transform(t, e, i) {
            ...
            return this.hasCustomTransform = !!s, s || C
          },
      ...
      function j() {
        return K && "ontouchstart" in window || K && window.navigator.maxTouchPoints > 1
      }
      const B = {
          isBrowser: K,
          gesture: function() {
          ...
          touch: j(),
          touchscreen: j(),
          pointer: K && "onpointerdown" in window,
          pointerLock: K && "exitPointerLock" in window.document
        },
        L = .5,
        H = 50,
        U = 250,
        ...
        X = r(r({}, D), {}, {
          device(t, e, i) {
            ...
            return this.pointerLock = n && B.pointerLock, B.touch && s ? "touch" : this.pointerLock ? "mouse" : B.pointer && !o ? "pointer" : B.touch ? "touch" : "mouse"
          },
          preventScrollAxis(t, e, i) {
            let {
              preventScroll: s
            } = i;
            if (this.preventScrollDelay = "number" == typeof s ? s : s || void 0 === s && t ? 250 : void 0, B.touchscreen && !1 !== s) return t || (void 0 !== s ? "y" : void 0)
          },
      ...
      const R = r(r({}, V), {}, {
          device(t, e, i) {
            ...
            if (s.target && !B.touch && B.gesture) return "gesture";
      ...
      function F(t) {
        Z.set(t.key, t.engine), q.set(t.key, t.resolver)
      }
      const N = {
          key: "drag",
          engine: class extends M {
            ...
            pointerUp(t) {
              ...
              if (e.tap = n <= i.tapsThreshold && o <= i.tapsThreshold, e.tap && i.filterTaps) e._force = !0;
                ...
                const [t, s] = e.direction, [n, o] = e.velocity, [r, a] = e.movement, [c, h] = i.swipe.velocity, [l, u] = i.swipe.distance, d = i.swipe.duration;
                e.elapsedTime < d && (Math.abs(n) > c && Math.abs(r) > l && (e.swipe[0] = t), Math.abs(o) > h && Math.abs(a) > u && (e.swipe[1] = s))
              }
              this.emit()
            }
            pointerClick(t) {
            ...
            keyUp(t) {
              t.key in P && (this.state._keyboardActive = !1, this.setActive(), this.compute(t), this.emit())
            }
            bind(t) {
        ...
        et = {
          ...
          engine: class extends A {
            ...
            wheelChange(t) {
              ...
              const e = this.state;
              e._delta = [-E(t)[1] / 100 * e.offset[0], 0], s.V.addTo(e._movement, e._delta), Y(e), this.state.origin = [t.clientX, t.clientY], this.compute(t), this.emit()
            }
            wheelEnd() {
        ...
        st = {
          ...
          engine: class extends M {
            ...
            wheelChange(t) {
              const e = this.state;
              e._delta = E(t), s.V.addTo(e._movement, e._delta), Y(e), this.compute(t), this.emit()
            }
            wheelEnd() {
              this.state._active && (this.state._active = !1, this.compute(), this.emit())
            }
