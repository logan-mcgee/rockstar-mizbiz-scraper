try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    d = (new e.Error).stack;
  d && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[d] = "11e85d47-1536-48cd-8e42-c3d2c7da7f03", e._sentryDebugIdIdentifier = "sentry-dbid-11e85d47-1536-48cd-8e42-c3d2c7da7f03")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [8679], {
    48679(e, d, a) {
        ...
        if (i && "$" === i[0]) {
          var o = "!" !== i[1],
            c = (o ? a[i.slice(1)] : a[i.slice(2)]).map(function(e) {
              ...
              return (0, _.__spreadArray)((0, _.__spreadArray)([], e, !0), d, !0)
            }, []);
          u && (u = !(c.indexOf(e.region || "") > -1 != o))
        } else u && (u = !e.region || "*" === i || i === e.region);
        return u && (u = !e.script || "*" === s || s === e.script), u && (u = !e.language || "*" === r || r === e.language), u
      }
      ...
      function c(e, d, a) {
        for (var n = 0, _ = a.matches; n < _.length; n++) {
          var r = _[n],
            t = u(e, r.desired, a.matchVariables) && u(d, r.supported, a.matchVariables);
          if (r.oneway || t || (t = u(e, r.supported, a.matchVariables) && u(d, r.desired, a.matchVariables)), t) {
            var s = 10 * r.distance;
            return a.paradigmLocales.indexOf(o(e)) > -1 != a.paradigmLocales.indexOf(o(d)) > -1 ? s - 1 : s
          }
        }
      ...
      function y(e, d, a) {
        var t, i, u = [],
          o = d.reduce(function(e, d) {
            var a = d.replace(s, "");
            return u.push(a), e[a] = d, e
          }, {}),
          y = function(e, d, a) {
            void 0 === a && (a = 838);
            var t = 1 / 0,
            ...
            return e.forEach(function(e, a) {
              s.distances[e] || (s.distances[e] = {}), d.forEach(function(d) {
                var i = function(e, d) {
                  var a = new Intl.Locale(e).maximize(),
                    t = new Intl.Locale(d).maximize(),
                    s = {
                      language: a.language,
                      script: a.script || "",
                      region: a.region || ""
                    ...
                    o = function() {
                      ...
                      if (!n) {
                        var a = null === (d = null === (e = r.supplemental.languageMatching["written-new"][0]) || void 0 === e ? void 0 : e.paradigmLocales) || void 0 === d ? void 0 : d._locales.split(" "),
                          t = r.supplemental.languageMatching["written-new"].slice(1, 5),
                          s = r.supplemental.languageMatching["written-new"].slice(5).map(function(e) {
                        ...
                        n = {
                          matches: s,
                          matchVariables: t.reduce(function(e, d) {
                            var a = Object.keys(d)[0],
                              n = d[a];
                            return e[a.slice(1)] = n._value.split("+"), e
                          }, {}),
                          paradigmLocales: (0, _.__spreadArray)((0, _.__spreadArray)([], a, !0), a.map(function(e) {
                  ...
                  return s.language !== i.language && (u += c({
                    language: a.language,
                    script: "",
                    region: ""
                  }, {
                    ...
                    script: i.script,
                    region: ""
                  }, o)), s.region !== i.region && (u += c(s, i, o)), u
                }(e, d) + 0 + 40 * a;
                s.distances[e][d] = i, i < t && (t = i, s.matchedDesiredLocale = e, s.matchedSupportedLocale = d)
              })
            }), t >= a && (s.matchedDesiredLocale = void 0, s.matchedSupportedLocale = void 0), s
          }(u, e);
        return y.matchedSupportedLocale && y.matchedDesiredLocale && (t = y.matchedSupportedLocale, i = o[y.matchedDesiredLocale].slice(y.matchedDesiredLocale.length) || void 0), t ? {
          locale: t,
          extension: i
        } : {
          locale: a()
      ...
      function M(e, d, a, n, _, r) {
        var t, u;
        u = "lookup" === a.localeMatcher ? function(e, d, a) {
          for (var n = {
              locale: ""
            }, _ = 0, r = d; _ < r.length; _++) {
            var t = r[_],
              i = t.replace(s, ""),
              u = l(e, i);
            if (u) return n.locale = u, t !== i && (n.extension = t.slice(i.length, t.length)), n
          }
          return n.locale = a(), n
        }(Array.from(e), d, r) : y(Array.from(e), d, r), null == u && (u = {
          locale: r(),
          extension: ""
        });
        var o, c, M = u.locale,
        ...
        u.extension ? (o = function(e) {
          i(e === e.toLowerCase(), "Expected extension to be lowercase"), i("-u-" === e.slice(0, 3), "Expected extension to be a Unicode locale extension");
          for (var d, a = [], n = [], _ = e.length, r = 3; r < _;) {
            var t, s = e.indexOf("-", r);
            t = -1 === s ? _ - r : s - r;
            var u = e.slice(r, r + t);
            i(t >= 2, "Expected a subtag to have at least 2 characters"), void 0 === d && 2 != t ? -1 === a.indexOf(u) && a.push(u) : 2 === t ? (d = {
              key: u,
              value: ""
            }, void 0 === n.find(function(e) {
              return e.key === (null == d ? void 0 : d.key)
            }) && n.push(d)) : "" === (null == d ? void 0 : d.value) ? d.value = u : (i(void 0 !== d, "Expected keyword to be defined"), d.value += "-" + u), r += t + 1
          }
          return {
            attributes: a,
            keywords: n
        ...
        for (var S = [], L = function(e) {
            var d = null !== (t = null == g ? void 0 : g[e]) && void 0 !== t ? t : [];
            i(Array.isArray(d), "keyLocaleData for ".concat(e, " must be an array"));
            var n = d[0];
            i(void 0 === n || "string" == typeof n, "value must be a string or undefined");
            var _ = void 0,
              r = c.find(function(d) {
                return d.key === e
              });
            ...
            var u, o, y = a[e];
            i(null == y || "string" == typeof y, "optionsValue must be a string or undefined"), "string" == typeof y && (u = e.toLowerCase(), o = y.toLowerCase(), i(void 0 !== u, "ukey must be defined"), "" === (y = o) && (y = "true")), y !== n && d.indexOf(y) > -1 && (n = y, _ = void 0), _ && S.push(_), m[e] = n
          }, f = 0, G = n; f < G.length; f++) L(G[f]);
        return S.length > 0 && (M = function(e, d, a) {
          i(-1 === e.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
          for (var n = "-u", _ = 0, r = []; _ < r.length; _++) {
            n += "-".concat(r[_])
          }
          ...
          if ("-u" === n) return w(e);
          var y = e.indexOf("-x-");
          return w(-1 === y ? e + n : e.slice(0, y) + n + e.slice(y))
        }(M, 0, S)), m.locale = M, m
      }

      function g(e, d) {
        for (var a = [], n = 0, _ = d; n < _.length; n++) {
          var r = l(e, _[n].replace(s, ""));
          r && a.push(r)
        }
        return a
      }
      ...
      function m(e, d, a, n) {
        return M(d, (_ = e, Intl.getCanonicalLocales(_)), {
