/*! For license information please see 31d216a96d614684d5bee1b223ca8317.js.LICENSE.txt */
"use strict";
        ...
        constructor(e, t) {
          super(), void 0 === t && console.warn('THREE.OrbitControls: The second parameter "domElement" is now mandatory.'), t === document && console.error('THREE.OrbitControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.'), this.object = e, this.domElement = t, this.domElement.style.touchAction = "none", this.enabled = !0, this.target = new r.Vector3, this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = !1, this.dampingFactor = .05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = {
            ...
            return function() {
              ...
              t.copy(e).sub(s.target), t.applyQuaternion(o), u.setFromVector3(t), s.autoRotate && c === a.NONE && S(2 * Math.PI / 60 / 60 * s.autoRotateSpeed), s.enableDamping ? (u.theta += h.theta * s.dampingFactor, u.phi += h.phi * s.dampingFactor) : (u.theta += h.theta, u.phi += h.phi);
              let r = s.minAzimuthAngle,
                _ = s.maxAzimuthAngle;
              return isFinite(r) && isFinite(_) && (r < -Math.PI ? r += T : r > Math.PI && (r -= T), _ < -Math.PI ? _ += T : _ > Math.PI && (_ -= T), u.theta = r <= _ ? Math.max(r, Math.min(_, u.theta)) : u.theta > (r + _) / 2 ? Math.max(r, u.theta) : Math.min(_, u.theta)), u.phi = Math.max(s.minPolarAngle, Math.min(s.maxPolarAngle, u.phi)), u.makeSafe(), u.radius *= d, u.radius = Math.max(s.minDistance, Math.min(s.maxDistance, u.radius)), !0 === s.enableDamping ? s.target.addScaledVector(p, s.dampingFactor) : s.target.add(p), t.setFromSpherical(u), t.applyQuaternion(i), e.copy(s.target).add(t), s.object.lookAt(s.target), !0 === s.enableDamping ? (h.theta *= 1 - s.dampingFactor, h.phi *= 1 - s.dampingFactor, p.multiplyScalar(1 - s.dampingFactor)) : (h.set(0, 0, 0), p.set(0, 0, 0)), d = 1, !!(m || f.distanceToSquared(s.object.position) > l || 8 * (1 - g.dot(s.object.quaternion)) > l) && (s.dispatchEvent(n), f.copy(s.object.position), g.copy(s.object.quaternion), m = !1, !0)
            }
          ...
          function O(e) {
            s.object.isPerspectiveCamera ? d /= e : s.object.isOrthographicCamera ? (s.object.zoom = Math.max(s.minZoom, Math.min(s.maxZoom, s.object.zoom * e)), s.object.updateProjectionMatrix(), m = !0) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."), s.enableZoom = !1)
          }
          ...
          function U() {
            if (1 === A.length) f.set(A[0].pageX, A[0].pageY);
            else {
          ...
          function H(e) {
            if (1 == A.length) g.set(e.pageX, e.pageY);
            else {
              const t = Q(e),
                s = .5 * (e.pageX + t.x),
                r = .5 * (e.pageY + t.y);
          ...
          function D(e) {
            if (1 === A.length) E.set(e.pageX, e.pageY);
            else {
              const t = Q(e),
                s = .5 * (e.pageX + t.x),
                r = .5 * (e.pageY + t.y);
            ...
            R.subVectors(E, _).multiplyScalar(s.panSpeed), P(R.x, R.y), _.copy(E)
          }
          ...
          function G(e) {
            const t = Q(e),
              ...
              n = e.pageY - t.y,
              o = Math.sqrt(r * r + n * n);
            x.set(0, o), w.set(0, Math.pow(x.y / y.y, s.zoomSpeed)), O(w.y), y.copy(x)
          }

          function j(e) {
            !1 !== s.enabled && (0 === A.length && (s.domElement.setPointerCapture(e.pointerId), s.domElement.addEventListener("pointermove", K), s.domElement.addEventListener("pointerup", V)), function(e) {
              A.push(e)
            ...
            !1 !== s.enabled && ("touch" === e.pointerType ? function(e) {
              ...
              if (!1 !== s.enabled) switch (c) {
                ...
                case a.DOLLY:
                  if (!1 === s.enableZoom) return;
                  ! function(e) {
                    x.set(e.clientX, e.clientY), w.subVectors(x, y), w.y > 0 ? O(M()) : w.y < 0 && k(M()), y.copy(x), s.update()
                  }(e);
                  break;
                case a.PAN:
                  if (!1 === s.enablePan) return;
                  ! function(e) {
                    E.set(e.clientX, e.clientY), R.subVectors(E, _).multiplyScalar(s.panSpeed), P(R.x, R.y), _.copy(E), s.update()
                  }(e)
              }
            }(e))
          }
          ...
          function V(e) {
            q(e), 0 === A.length && (s.domElement.releasePointerCapture(e.pointerId), s.domElement.removeEventListener("pointermove", K), s.domElement.removeEventListener("pointerup", V)), s.dispatchEvent(i), c = a.NONE
          }
          ...
          function Z(e) {
            let t = b[e.pointerId];
            void 0 === t && (t = new r.Vector2, b[e.pointerId] = t), t.set(e.pageX, e.pageY)
          }
    ...
    8693: (e, t, s) => {
      ...
      function i() {
        ...
        function s(e, t, s, r, n, o) {
          ...
          const h = new n(e.HEAPF32.buffer, u, a).slice();
          return e._free(u), {
            name: r,
            array: h,
            itemSize: i
                ...
                try {
                  const e = function(e, t, r, n) {
                      ...
                      for (const r in o) {
                        const c = self[i[r]];
                        let l, h;
                        if (n.useUniqueIDs) h = o[r], l = t.GetAttributeByUniqueId(a, h);
                        else {
                          if (h = t.GetAttributeId(a, e[o[r]]), -1 === h) continue;
    ...
    9038: (e, t, s) => {
      ...
      class n extends r.Loader {
        ...
        parse(e, t, s, n) {
          ...
          else if (r.LoaderUtils.decodeText(new Uint8Array(e, 0, 4)) === R) {
            try {
              a[i.KHR_BINARY_GLTF] = new y(e)
            } catch (e) {
              return void(n && n(e))
            }
          ...
          h.setExtensions(a), h.setPlugins(l), h.parse(s, n)
        }
        parseAsync(e, t) {
          const s = this;
      ...
      class A extends r.MeshStandardMaterial {
        constructor(e) {
      ...
      class K {
        ...
        loadAccessor(e) {
          ...
          return void 0 !== n.bufferView ? o.push(this.getDependency("bufferView", n.bufferView)) : o.push(null), void 0 !== n.sparse && (o.push(this.getDependency("bufferView", n.sparse.indices.bufferView)), o.push(this.getDependency("bufferView", n.sparse.values.bufferView))), Promise.all(o).then((function(e) {
            ...
            if (h && h !== l) {
              ...
              let l = t.cache.get(s);
              l || (p = new a(o, e * h, n.count * h / c), l = new r.InterleavedBuffer(p, h / c), t.cache.add(s, l)), m = new r.InterleavedBufferAttribute(l, i, u % h / c, d)
            } else p = null === o ? new a(n.count * i) : new a(o, u, n.count * i), m = new r.BufferAttribute(p, i, d);
            if (void 0 !== n.sparse) {
              const t = k.SCALAR,
                ...
                h = new a(e[2], l, n.sparse.count * i);
        ...
        loadMaterial(e) {
          ...
          if ("BLEND" === h ? (c.transparent = !0, c.depthWrite = !1) : (c.transparent = !1, "MASK" === h && (c.alphaTest = void 0 !== o.alphaCutoff ? o.alphaCutoff : .5)), void 0 !== o.normalTexture && a !== r.MeshBasicMaterial && (u.push(t.assignTexture(c, "normalMap", o.normalTexture)), c.normalScale = new r.Vector2(1, 1), void 0 !== o.normalTexture.scale)) {
          ...
          return void 0 !== o.occlusionTexture && a !== r.MeshBasicMaterial && (u.push(t.assignTexture(c, "aoMap", o.occlusionTexture)), void 0 !== o.occlusionTexture.strength && (c.aoMapIntensity = o.occlusionTexture.strength)), void 0 !== o.emissiveFactor && a !== r.MeshBasicMaterial && (c.emissive = (new r.Color).fromArray(o.emissiveFactor)), void 0 !== o.emissiveTexture && a !== r.MeshBasicMaterial && u.push(t.assignTexture(c, "emissiveMap", o.emissiveTexture, r.sRGBEncoding)), Promise.all(u).then((function() {
            let s;
            return s = a === A ? n[i.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS].createMaterial(c) : new a(c), o.name && (s.name = o.name), B(s, o), t.associations.set(s, {
              materials: e
        ...
        loadMesh(e) {
          ...
          return a.push(t.loadGeometries(i)), Promise.all(a).then((function(s) {
            ...
            for (let s = 0, u = c.length; s < u; s++) {
              ...
              let d;
              const p = a[s];
              if (4 === h.mode || 5 === h.mode || 6 === h.mode || void 0 === h.mode) d = !0 === o.isSkinnedMesh ? new r.SkinnedMesh(u, p) : new r.Mesh(u, p), !0 !== d.isSkinnedMesh || d.geometry.attributes.skinWeight.normalized || d.normalizeSkinWeights(), 5 === h.mode ? d.geometry = W(d.geometry, r.TriangleStripDrawMode) : 6 === h.mode && (d.geometry = W(d.geometry, r.TriangleFanDrawMode));
              else if (1 === h.mode) d = new r.LineSegments(u, p);
              else if (3 === h.mode) d = new r.Line(u, p);
              else if (2 === h.mode) d = new r.LineLoop(u, p);
              else {
                if (0 !== h.mode) throw new Error("THREE.GLTFLoader: Primitive mode unsupported: " + h.mode);
                d = new r.Points(u, p)
              }
              Object.keys(d.geometry.morphAttributes).length > 0 && H(d, o), d.name = t.createUniqueName(o.name || "mesh_" + e), B(d, o), h.extensions && N(n, d, h), t.assignFinalMaterial(d), l.push(d)
            }
        ...
        loadAnimation(e) {
          ...
          for (let e = 0, r = t.channels.length; e < r; e++) {
            ...
            s.push(this.getDependency("node", u)), n.push(this.getDependency("accessor", h)), o.push(this.getDependency("accessor", d)), i.push(c), a.push(l)
          }
          return Promise.all([Promise.all(s), Promise.all(n), Promise.all(o), Promise.all(i), Promise.all(a)]).then((function(s) {
            ...
            for (let e = 0, t = n.length; e < t; e++) {
              ...
              let p;
              switch (t.updateMatrix(), t.matrixAutoUpdate = !0, F[d.path]) {
                case F.weights:
              ...
              const m = t.name ? t.name : t.uuid,
                f = void 0 !== h.interpolation ? U[h.interpolation] : r.InterpolateLinear,
                g = [];
              F[d.path] === F.weights ? t.traverse((function(e) {
              ...
              for (let e = 0, t = g.length; e < t; e++) {
                const t = new p(g[e] + "." + F[d.path], s.array, T, f);
              ...
              t.then((() => {
                try {
                  const {
                    ...
                    const h = i.isUASTC() ? o.UASTC_4x4 : o.ETC1S,
                      d = i.getWidth(),
                      p = i.getHeight(),
                      m = i.getLevels(),
                      f = i.getHasAlpha(),
                      ...
                      T = i.getDFDFlags(),
                      {
                        ...
                        for (let r = 0; r < p.length; r++) {
                          const n = p[r];
                          if (e[n.if] && n.basisFormat.includes(t) && !(u && n.transcoderFormat.length < 2) && (!n.needsPowerOfTwo || l(s) && l(i))) return h = n.transcoderFormat[u ? 1 : 0], d = n.engineFormat[u ? 1 : 0], {
                            transcoderFormat: h,
                            engineFormat: d
                          }
                        }
                        return console.warn("THREE.KTX2Loader: No suitable compressed texture format found. Decoding to RGBA32."), h = n.RGBA32, d = r.RGBAFormat, {
                          transcoderFormat: h,
                          engineFormat: d
                        }
                      }(h, d, p, f);
                    if (!d || !p || !m) throw u(), new Error("THREE.KTX2Loader:\tInvalid texture");
