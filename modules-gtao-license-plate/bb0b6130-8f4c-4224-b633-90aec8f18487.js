! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      n = (new e.Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "bb0b6130-8f4c-4224-b633-90aec8f18487", e._sentryDebugIdIdentifier = "sentry-dbid-bb0b6130-8f4c-4224-b633-90aec8f18487")
  } catch (e) {}
}();
          ...
          case "unit":
            ...
            if (S = void 0, B) S = wr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[I][O]);
              ...
              var P = I.split("-per-"),
                ...
                k = P[1];
              B = n.units.simple[_];
              var j = wr(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[_][O]),
                R = n.units.simple[k].perUnit[O];
              if (R) S = R.replace("{0}", j);
              else {
                var L = n.units.compound.per[O],
                  q = wr(r, 1, n.units.simple[k][O]);
