try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "00373579-c356-4268-9a77-4b1233ed04b6", e._sentryDebugIdIdentifier = "sentry-dbid-00373579-c356-4268-9a77-4b1233ed04b6")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [2499, 5186], {
    ...
    2078(e, t, a) {
      ...
      const E = ((e, t = null, a = !1) => {
        ...
        const S = !!h.ratingDescriptors;
        return (0, r.jsxs)("div", {
          className: [x.rating, S ? x.withDescriptors : x.withOutDescriptors, d || ""].join(" "),
          ...
          children: [(0, r.jsx)(b.A, {
            ...
            children: (0, r.jsx)("img", {
              alt: E.formatMessage(k.components_ratings_link_alt, {
            ...
            }), h.ratingFooter && (0, r.jsx)("hr", {}), h.ratingFooter && (0, r.jsx)("p", {
              dangerouslySetInnerHTML: {
      ...
      const S = e => fe.find(({
        ...
        C = () => window.innerWidth < be.lg,
        T = () => window.innerHeight > .75 * window.innerWidth,
        R = () => {
        ...
        A = (e, t) => e?.plateText && t.length ? !t.some(({
          plateText: t,
          style: a
      ...
      function M(e, t, a, r, s = {
        ...
        const {
          ...
          left: p,
          bottom: g
        } = r.gridDimensions.margins.pixels, f = Math.floor(e / o), b = e % o, h = c * i + d * (i - 1), y = l * o + m * (o - 1), v = n - s.x - 2 * p, x = a - s.y - u - g, k = x * (c / h), w = v * (l / y), _ = f * (c + d) / h, E = {
          x: v * (b * (l + m) / y) + p + s.x,
          y: x * _ + u + s.y
        };
        return {
      ...
      const L = (e, t) => {
          t === ze.LIST_PLATES && (document.body.style.cursor = "pointer")
        },
        z = e => {
          document.body.style.cursor = "auto", P.gsap.to(e.scale, {
            x: 1,
            y: 1,
            z: 1,
            duration: ye.plateHover.duration,
            ease: ye.plateHover.ease
          })
        };
      ...
      function D(e, t) {
        ...
        const {
          ...
          camera: u,
          controls: p
        } = s, g = O(), f = !T() || C() ? g * n : 1.6 * g * n, b = [];
        let h = null;
        m.traverse(e => {
          e.name === De.LP && b.push(e), e.userData.index === a && (h = e)
        });
        const y = new i.Vector3;
        h && h.getWorldPosition(y);
        const v = {
            cameraPosition: {
              start: (new i.Vector3).copy(u.position),
        ...
        let k = 0;
        return t.isResize || (k = C() ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration), r.to(x, {
          current: 1,
          duration: k,
          ease: C() ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease,
          onUpdate: () => {
            const {
              current: e
          ...
          current: 1,
          duration: C ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
          ease: C ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease,
          onUpdate: () => {
            const {
              current: e
      ...
      const Y = "GTALicensePlatesRegular",
        ...
        F = "top",
        B = "bottom",
        G = "accessiblePlateGrid",
        X = "canvasWrap",
        q = "confirmContent",
        Z = "confirmSidebar",
        J = "confirmOrderSidebarButtons",
        K = "confirmOrderSidebarButtonsPortal",
        Q = "ctaShader",
        ee = "firstPlateMesh",
        te = "footer",
        ae = "loadingScreen",
        re = "mobileSidebarPortalTarget",
        se = "newPlateForm",
        ne = "newPlateSidebar",
        oe = "newPlateUI",
        ie = "orderBg",
        ...
        de = "sidebar",
        me = "sidebarButtons",
        ue = "sidebarButtonsLoadingAnimation",
        pe = "ui",
        ge = "toggleViewButton",
        fe = [{
          id: 0,
        ...
        Be = (0, g.setMakeVarItem)({
          key: "setCurrentView",
          value: (0, g.makeVar)(ze.LIST_PLATES)
        }),
        ...
        ot = (0, g.setMakeVarItem)({
          key: "setLastScrollY",
          value: (0, g.makeVar)(0)
        }),
        it = (0, g.setMakeVarItem)({
          key: "setLastView",
          value: (0, g.makeVar)(ze.LIST_PLATES)
        }),
        ct = (0, g.setMakeVarItem)({
          key: "setLoginUrl",
          value: (0, g.makeVar)("")
        }),
        lt = (0, g.setMakeVarItem)({
          key: "setPendingOrder",
          value: (0, g.makeVar)(void 0)
        }),
        dt = (0, g.setMakeVarItem)({
          key: "setPlateNumber",
          value: (0, g.makeVar)("")
        }),
        mt = (0, g.setMakeVarItem)({
          key: "setPlates",
          value: (0, g.makeVar)([])
        }),
        ut = (0, g.setMakeVarItem)({
          key: "setPlateTextures",
          value: (0, g.makeVar)([])
        }),
        pt = (0, g.setMakeVarItem)({
        ...
        gt = (0, g.setMakeVarItem)({
          key: "setPlateStyles",
          value: (0, g.makeVar)(fe)
        }),
        ft = (0, g.setMakeVarItem)({
          key: "setRealHeight",
          value: (0, g.makeVar)(0)
        }),
        bt = (0, g.setMakeVarItem)({
          key: "setRefsInternal",
          value: (0, g.makeVar)({})
        }),
        ht = (e, t) => {
        ...
        yt = (0, g.setMakeVarItem)({
          key: "setSelectedStyle",
          value: (0, g.makeVar)(We.style?.id)
        }),
        vt = (0, g.setMakeVarItem)({
          key: "setSelectedVehicle",
          value: (0, g.makeVar)(null)
        }),
        xt = (0, g.setMakeVarItem)({
          key: "setShouldForce2D",
          value: (0, g.makeVar)(!!C())
        }),
        kt = (0, g.setMakeVarItem)({
          key: "setShouldRenderScene",
          value: (0, g.makeVar)(!1)
        }),
        wt = (0, g.setMakeVarItem)({
          key: "setThree",
          value: (0, g.makeVar)(null)
        }),
        _t = (0, g.setMakeVarItem)({
          key: "setVehicles",
          value: (0, g.makeVar)(null)
        }),
        Et = (0, g.setMakeVarItem)({
        ...
        Pt = () => {
          const e = (0, g.useLocale)(),
            ...
            a = (0, g.useReactiveVar)(Ye),
            r = (0, g.useReactiveVar)($e),
            n = (0, g.useReactiveVar)(He),
            o = (0, g.useReactiveVar)(Ue),
            i = (0, g.useReactiveVar)(Fe),
            c = (0, g.useReactiveVar)(Be),
            l = (0, g.useReactiveVar)(Ge),
            d = (0, g.useReactiveVar)(Xe),
            m = (0, g.useReactiveVar)(qe),
            u = (0, g.useReactiveVar)(Ze),
            p = (0, g.useReactiveVar)(Je),
            f = (0, g.useReactiveVar)(Ke),
            b = (0, g.useReactiveVar)(Qe),
            h = (0, g.useReactiveVar)(et),
            y = (0, g.useReactiveVar)(tt),
            v = (0, g.useReactiveVar)(at),
            x = (0, g.useReactiveVar)(rt),
            k = (0, g.useReactiveVar)(st),
            w = (0, g.useReactiveVar)(nt),
            _ = (0, g.useReactiveVar)(ot),
            E = (0, g.useReactiveVar)(it),
            P = (0, g.useReactiveVar)(ct),
            S = (0, g.useReactiveVar)(lt),
            N = (0, g.useReactiveVar)(dt),
            I = (0, g.useReactiveVar)(mt),
            C = (0, g.useReactiveVar)(ut),
            T = (0, g.useReactiveVar)(pt),
            R = (0, g.useReactiveVar)(gt),
            j = (0, g.useReactiveVar)(ft),
            O = (0, g.useReactiveVar)(bt),
            A = (0, g.useReactiveVar)(yt),
            V = (0, g.useReactiveVar)(vt),
            M = (0, g.useReactiveVar)(xt),
            L = (0, g.useReactiveVar)(kt),
            z = (0, g.useReactiveVar)(wt),
            D = (0, g.useReactiveVar)(_t),
            W = (0, g.useReactiveVar)(Et),
            [Y, $] = (0, s.useState)({
              width: 0,
              height: 0
            });
          return (0, s.useEffect)(() => {
            ...
            setCharacter: He,
            setCurrentPlate: Ue,
            setCurrentPlateIndex: Fe,
            setCurrentView: Be,
            setDeletedPlateIndex: Ge,
            setError: Xe,
            setFirstPlateMesh: qe,
            setGridState: Je,
            setIsLoading: tt,
            setIsLoggedIn: at,
            setIsOrderConfirmed: rt,
            setLastScrollY: ot,
            setLastView: it,
            setPendingOrder: lt,
            setPlates: mt,
            ...
            setIsMobile: Qe,
            setIsSceneLoaded: st,
            setIsScrollEnabled: nt,
            setGridScale: Ze,
            setPlateNumber: dt,
            setPlateNumberStatus: pt,
            setPlateStyles: gt,
            setPlateTextures: ut,
            setRefs: ht,
            setSelectedStyle: yt,
            ...
            setShouldForce2D: xt,
            setShouldRenderScene: kt,
            setThree: wt,
            setVehicles: _t,
            setXmas23PlatesAllowed: Et
          }
        },
        St = (0, g.setContextItem)({
          context: (0, s.createContext)(Pt),
          key: "lpeState"
        }),
        Nt = () => (0, s.useContext)(St),
        It = ({
          t: e
        }) => {
          const {
          ...
          return (0, s.useEffect)(() => {
            ...
            children: (0, r.jsxs)("div", {
              ...
              children: [(0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)(h.LanguageSelector, {
                  location: o,
      ...
      const Ot = "#898989",
        ...
        Dt = () => {
          ...
          return a <= be.sm ? t = 1 / 4 : a <= be.md && (t = .5), e.canvas.width = 2048 * t, e.canvas.height = 1024 * t, e.textAlign = "center", e.textBaseline = "middle", e
        },
        Wt = {
          bumpMap: Dt(),
          map: Dt(),
        ...
        Yt = ({
          ...
          const {
            ...
            gridScale: k,
            plateTextures: w
          } = l, _ = 0 === n && "number" == typeof x, [E, P] = (0, s.useState)(S(_ ? x : a.style.id)), N = [0, 0, 0], I = [1, 1, 1], [C] = (0, s.useState)(0 === a.index), [T, R] = (0, s.useState)({}), j = (0, s.useRef)(), O = h.filter(({
            faux: e
          }) => !e).length >= 30;
          (0, s.useEffect)(() => {
            j.current && 0 === j.current.userData.index && u(ee, j)
          }, [j.current]);
          const A = (0, s.useRef)(),
            V = (0, s.useCallback)(e => {
              !a.index && O || L(0, p)
            ...
            M = (0, s.useCallback)(e => {
              ...
              const t = String.fromCharCode(8202).repeat(0),
                a = e.split("")?.join(t) ?? "",
                r = ((e, t) => {
                  delete Wt.bumpMap, Wt.bumpMap = Dt();
                  const a = Wt.bumpMap;
                  let r = 1;
                  const {
                    innerWidth: s
                  } = window;
                  s <= be.sm ? r = 1 / 4 : s <= be.md && (r = .5);
                  ...
                  const o = 5 * r;
                  return zt || (a.filter = `blur(${o}px)`), t?.bumpMap?.image && a.drawImage(t.bumpMap.image, 0, 0, a.canvas.width, a.canvas.height), a.strokeText(e, a.canvas.width / 2, a.canvas.height / 1.7), a.fillText(e, a.canvas.width / 2, a.canvas.height / 1.7), zt && jt.canvasRGB(a.canvas, 0, 0, a.canvas.width, a.canvas.height, 3 * o), new i.CanvasTexture(a.canvas)
                })(a, E),
                s = ((e, t) => {
                  delete Wt.map, Wt.map = Dt();
                  const a = Wt.map;
                  let r = 1;
                  const {
                    innerWidth: s
                ...
                n = v ? void 0 : ((e, t) => {
                  delete Wt.roughnessMap, Wt.roughnessMap = Dt();
                  const a = Wt.roughnessMap;
                  let r = 1;
                  const {
                    innerWidth: s
                  } = window;
                  s <= be.sm ? r = 1 / 4 : s <= be.md && (r = .5);
                  const n = t.fontSize * r;
                  a.strokeStyle = At, a.fillStyle = At, a.fillRect(0, 0, a.canvas.width, a.canvas.height), a.font = `${n}px ${t.fontName}`;
                  for (let r = 1; r < 2; r += 1) t?.roughnessMap?.image && a.drawImage(t.roughnessMap.image, 0, 0, a.canvas.width, a.canvas.height), a.strokeStyle = Ot, a.fillStyle = Ot, a.strokeText(e, a.canvas.width / 2, a.canvas.height / 1.7), a.fillText(e, a.canvas.width / 2, a.canvas.height / 1.7);
          ...
          return (0, s.useEffect)(() => {
            ...
            const [e, t, r] = M(C ? b : a.plateText);
            R({
              map: t,
              bumpMap: e,
              roughnessMap: r
            })
          }, [C ? b : void 0, C ? E : void 0]), (0, s.useMemo)(() => g && T.map && T.bumpMap ? (0, r.jsxs)("mesh", {
            name: De.LP,
            visible: !0,
            userData: {
              index: n
            ...
            onPointerOver: v ? void 0 : () => {
              y && d() === ze.LIST_PLATES && j.current && V(j.current)
            },
            onPointerOut: v ? void 0 : () => {
              var e;
              y && j.current && (e = j.current, !a.index && O || z(e))
            },
        ...
        $t = ({
          ...
          const [a, n, c, l] = [2, 1, 2, 1, [0, 0, 0]], {
            ...
            scene: Y,
            gl: $
          } = (0, o.useThree)(), [H, U] = (0, s.useState)(new i.Vector3(u.x, u.y, u.z)), [F, B] = (0, s.useState)(0), [G, X] = (0, s.useState)(0), {
            track: q
          } = (0, p.useGtmTrack)(), Z = {
            view_name: "license plate creator - landing page logged " + (I ? "in" : "out")
          }, [J, K] = (0, s.useState)(null);
          (0, s.useEffect)(() => {
            P === ze.LIST_PLATES && q({
              ...Z,
          ...
          const Q = (0, s.useCallback)(() => {
            if (V) {
              const t = c * b + f * (b - 1),
                a = Math.abs(u.z) * Math.tan((0, Tt.pu)(D.fov / 2)) * 2,
                ...
                l = i / a;
              X((i - a + r + s).toFixed(4)), w(o), (() => {
                ze.LIST_PLATES;
                const e = $.domElement.offsetHeight,
                  t = l * e + v * e + g * e,
                  a = j(),
                  r = R[le]?.current;
                r && (r.style.height = `${t}px`), K({
                  canvasHeight: e,
                  rootHeight: t
                }), k(`${Math.round(t)}px`);
          ...
          const ee = (0, s.useMemo)(() => N?.map(e => {
            ...
            te = (0, s.useCallback)(() => {
              const e = R[le].current,
                t = document.body;
              e && (e.style.touchAction = "auto"), W() || requestAnimationFrame(() => {
            ...
            ae = (0, s.useCallback)(() => {
              const e = R[le].current,
                t = document.body,
                a = window.scrollY;
              _(a), e && (e.style.touchAction = "none"), W() || (window.scrollTo(0, a), requestAnimationFrame(() => {
          ...
          const re = (0, s.useCallback)((e = !1) => {
            if (E() === ze.LIST_PLATES || e) {
              const e = R[le]?.current;
              if (!e || !J) return;
              const {
                canvasHeight: t,
                rootHeight: a
              } = J, r = C && N.length <= 2 ? 2 : 1;
          ...
          }, [z.current, I, H, u, T, R, G, J]), (0, s.useEffect)(() => {
            if (!z.current || !Y) return;
            const e = Y.getObjectByName("Scene");
            z.current.add(e), e && e.scale.set(6.5, 6.5, 6.5)
          }, [z.current, Y]), (0, s.useMemo)(() => (0, r.jsx)("group", {
            name: De.LP_GRID,
            ref: z,
            position: u,
            scale: S,
        ...
        Bt = ({
          ...
          const R = (0, s.useCallback)(e => {
            ...
            const a = j(),
              ...
              d = l * Math.tan((0, Tt.pu)(17.5)),
              m = -1 * k.aspect * d,
              u = window.innerWidth < be.lg ? t.offsetHeight + a : a,
              p = a,
              ...
              O = Math.abs(P.z) * Math.tan((0, Tt.pu)(k.fov / 2)) * 2,
              A = y * (O * (g / b)),
              V = x * O,
              M = E * O,
              L = Math.abs(2 * P.x),
          ...
          (0, s.useEffect)(() => {
            ...
            E?.current && (!p && u || (E.current.enabled = !1))
          }, [p, u]), (0, o.useFrame)(() => {
            v && (E?.current?.update(), w.render(_, k))
          }, 1), (0, s.useEffect)(() => {
            const e = () => {
              const e = x[X]?.current;
              e && C({
          ...
          const O = (0, s.useMemo)(() => e?.environmentMap && e?.environmentModel ? (0, r.jsx)(Rt, {
              position: [0, -4.05, -11.76],
              envMap: e.environmentMap,
              envModel: e.environmentModel,
              onLoad: T
            }) : null, [e]),
            A = (0, s.useMemo)(() => (0, r.jsx)(Ut, {
              baseIntensity: Ve,
              mapSize: 1024
            }), []),
            V = (0, s.useMemo)(() => (0, r.jsx)($t, {
              gridState: d,
              loadedAssets: e
            }), [d, e]),
            M = (0, s.useMemo)(() => (0, r.jsx)("orbitControls", {
              ...
              enableZoom: !1,
              enablePan: !1,
              maxPolarAngle: ve.plateView.maxPolarAngle,
              minPolarAngle: ve.plateView.minPolarAngle,
              maxAzimuthAngle: ve.plateView.maxAzimuthAngle,
              minAzimuthAngle: ve.plateView.minAzimuthAngle,
              minDistance: -1,
              maxDistance: 100
            }), [k, E, w]);
      ...
      const Zt = ({
          ...
          onTap: l,
          drawerY: d,
          mobileSidebarHeight: m
        }) => {
          const {
            state: u
          } = Nt(), {
            currentView: p
          } = u, g = (0, s.useRef)(null), f = (0, s.useState)(U), b = d?.get ? d.get() : 0, h = (0, Xt.useSpring)({
            y: e ? b : m,
            config: {
              easing: Xt.easings.easeInOutQuart,
              duration: 900
            }
          }), y = (0, s.useRef)(m), v = (0, s.useRef)(0), x = (0, s.useRef)(!1);
          (0, s.useEffect)(() => {
            const r = {
              top: t,
              bottom: a,
          ...
          const k = (0, s.useCallback)((0, qt.useDrag)(e => {
              if (p !== ze.CONFIRM_ORDER) {
                if (!x.current)
                  if (y.current = Math.max(t, Math.min(a, h.y.get() + e.delta[1])), v.current = e.movement[1], e.dragging) h.y.set(y.current);
                    ...
                    if (y.current < t / 2) {
                      const a = P.gsap.to(e, {
                        y: t,
                        duration: ye.sidebar.mobile.drawerSnap.duration,
                        ease: ye.sidebar.mobile.drawerSnap.ease,
                        onUpdate: () => {
                          x.current ? a.kill() : h.y.set(e.y)
                        }
                      });
                      g.current.style.touchAction = "auto", g.current.style.overflowY = "auto", f.current = F
                      ...
                      g.current.style.touchAction = "none", g.current.style.overflowY = "hidden", f.current = U
                    }
                    y.current = h.y.get()
                  } const r = {
                  top: t,
            ...
            w = () => {
              if (Math.abs(v.current) < 3) {
                ...
                const e = {
                  ...
                  a = {};
                f.current === U ? (a.y = t, g.current.style.touchAction = "auto", g.current.style.overflowY = "auto", f.current = F) : (f.current === F || f.current === B) && (a.y = 0, g.current.style.touchAction = "none", g.current.style.overflowY = "hidden", f.current = U), P.gsap.to(e, {
                  y: a.y,
                  duration: ye.sidebar.mobile.drawerSnap.duration,
                  ease: ye.sidebar.mobile.drawerSnap.ease,
                  onUpdate: () => {
          ...
          return (0, s.useMemo)(() => (0, r.jsxs)(Xt.animated.div, {
            ...k(),
            ref: g,
            style: h ? {
              y: h.y
      ...
      const ta = ({
        ...
        ra = ({
          ...
          (0, s.useEffect)(() => {
            o && d?.current && (d.current?.showModal?.(), m(!0))
          }, [o]);
          const u = () => {
            m(!1), i(), d.current?.close?.()
          };
          if (o) return (0, r.jsxs)("dialog", {
            ...
            onClick: e => (e => {
              ...
              (t.left > e.clientX || t.right < e.clientX || t.top > e.clientY || t.bottom < e.clientY) && c && (m(!1), i(), e.currentTarget.close())
            })(e),
            "data-testid": "alert-dialog",
            children: [e && (0, r.jsx)("i", {
              className: [aa.icon, aa[e]].join(" ")
            }), (0, r.jsxs)("div", {
              className: [aa.content, l?.content].join(" "),
              children: [(0, r.jsx)("h3", {
                className: [aa.heading, l?.heading].join(" "),
                children: t
              }), a && (0, r.jsx)("div", {
                className: [aa.message, l?.message].join(" "),
                dangerouslySetInnerHTML: {
                  __html: a
                }
              })]
              ...
              children: n.slice(0, 2).map((e, t) => (0, r.jsx)(ta, {
        ...
        oa = "visible",
        ia = (0, g.withTranslations)(({
          t: e
        }) => {
          const t = (0, g.useRockstarTokenPing)(),
            {
              loggedIn: a
            } = (0, p.useRockstarUser)(),
            {
            ...
            [z, W] = (0, s.useState)(x === ze.VIEW_PLATE),
            [Y, $] = (0, s.useState)([]),
            [H, G] = (0, s.useState)(!1),
            [q, Z] = (0, s.useState)(!1),
            J = (0, s.useRef)(null),
            ...
            Se = x === ze.VIEW_PLATE ? 0 : -1;
          (0, s.useEffect)(() => {
            x !== ze.VIEW_PLATE && q && Z(!1)
          }, [x, q]);
          const Ne = (0, s.useRef)(0);
          (0, s.useEffect)(() => {
            Number.isNaN(y) || (Ne.current = y)
          }, [y]);
          const Ie = (0, s.useRef)(null);
          (0, s.useEffect)(() => {
            x && (Ie.current = x), x === ze.VIEW_PLATE && (xe.current = !1)
          }, [x]);
          const Ce = (0, s.useRef)(0);
          (0, s.useEffect)(() => {
            k && (Ce.current = k)
          }, [k]), (0, s.useEffect)(() => {
            h?.[0]?.current && x === ze.NEW_PLATE && _e(V(h[0].parentElement))
          }, [h, x]);
          ...
          const Re = (0, s.useCallback)((e, t, a = !1) => {
            if (Ie.current !== ze.VIEW_PLATE) return;
            const {
              renderer: r
            } = L;
            D({
              ...
              onStart: () => {
                S ? document.body.style.touchAction = "none" : f(!1)
              },
              onComplete: e => {
                e?.three?.camera && (J.current = new i.Vector3(e.three.camera.position.x, e.three.camera.position.y, e.three.camera.position.z)), ee?.current?.children && ee.current.querySelectorAll("button").forEach(e => {
                  e.style.pointerEvents = "all"
                }), S && (r.domElement.style.touchAction = "none", N && setTimeout(() => {
                  document.body.style.touchAction = "auto", f(!1)
                }, 200), ue.current = V(r.domElement).y)
              },
              tweenPosition: 0,
              isResize: a,
              is3D: _
          ...
          (0, s.useEffect)(() => {
            if (!L?.controls || !z) return;
            const {
              controls: e
            } = L, t = P.gsap.timeline({
              duration: S ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
              ease: S ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease,
              onStart: () => {
          ...
          const je = (e, t = {}) => {
              if (!L?.controls || !h?.[y]) return;
              const {
                controls: a
              } = L, r = e || P.gsap.timeline({
                defaults: {
                  duration: 0,
                  ease: S ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease
                },
              ...
              }), s = O(), o = S && x === ze.CONFIRM_ORDER ? 1.5 : 1, i = !T() || S ? s * k * o : 1.6 * s * k, c = A[le].current, l = document.getElementById("list-plates-sidebar"), d = A[X].current, m = h[y].current;
              if (c && l && m && d) {
                const e = M(y, c, Number(j.replace("px", "")), w, S ? void 0 : {
                    x: l.offsetWidth,
                    y: 0
                  }).rect.center,
                  ...
                  p = 5 / i,
                  g = S || n() !== ze.CONFIRM_ORDER ? 0 : -1 * l.offsetWidth,
                  f = {
                    x: u.x - e.x + g,
                    y: u.y - e.y - 80 + (t.isResize ? ke.current : window.scrollY)
                  },
                  b = {
                    current: 0
                  },
                ...
                r.to(b, {
                  ...
                  ease: S ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease,
                  onComplete: () => {
                    _e(V(m.parentElement))
                  },
                  onUpdate: () => {
                    const {
                      current: a
                    } = b, r = (0, Tt.Cc)(Number(o.x), f.x, a), s = (0, Tt.Cc)(Number(o.y), f.y + (S ? .4 * window.innerHeight / -2 : 0), a), n = (0, Tt.Cc)(Number(o.scale), p, a);
                    m.parentElement.style.transformOrigin = `${e.x}px ${e.y}px`, m.parentElement.style.transform = `translate(${r}px, ${s}px) scale(${n})`, t.isResize || h.forEach((e, t) => {
                      if (t !== y && e?.current) {
                        const r = (0, Tt.Cc)(v[t], 0, Math.min(1, 20 * a));
            ...
            Oe = (0, s.useCallback)((e = void 0) => {
              if (!L?.camera || !J.current) return;
              const {
                camera: t,
                controls: a,
                renderer: r
              } = L;
              if (P.gsap.to(t.position, {
                  x: Number(J.current.x),
                  y: Number(J.current.y),
                  z: Number(J.current.z),
                  ease: ye.toggleView.camera.ease,
                  duration: ye.toggleView.camera.duration,
                  onStart: () => {
                    a?.current && (a.current.minDistance = 2, a.current.enableZoom = !1, a.current.enabled = !1)
                  },
                  onComplete: () => {
                    n(ze.LIST_PLATES), a?.current && (a.current.minDistance = 0, a.current.maxPolarAngle = ve.plateView.maxPolarAngle, a.current.minPolarAngle = ve.plateView.minPolarAngle, a.current.maxAzimuthAngle = ve.plateView.maxAzimuthAngle, a.current.minAzimuthAngle = ve.plateView.minAzimuthAngle, a.current.enableZoom = !1), me.current = 0, e?.onComplete && e.onComplete()
                  }
                }), S) {
                const e = r.domElement;
                P.gsap.to(e.style, {
                  opacity: 1,
                  duration: ye.toggleView.reset.duration,
                  ease: ye.toggleView.reset.ease
                })
              }
              Ee({
                ...Pe,
          ...
          (0, s.useEffect)(() => {
            ...
            L?.scene && ee?.current && (e => {
              const {
                scene: t,
                controls: a
              } = L, r = [];
              t.traverse(e => {
                e.name === De.LP && r.push(e), e.userData.index === Number(y) && (K.current = e)
              });
              const s = P.gsap.timeline({
                defaults: {
                  duration: S ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
                  ease: S ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease
                },
              ...
              switch (e) {
                case oa: {
                  Re(s, Ce.current, !1);
                  const e = A[le]?.current,
                    t = A[de]?.current,
                    a = h[y].current,
                    r = A?.[X]?.current;
                  e && t && a && r && je(s), he?.current && s.to([ee.current, he.current, S ? void 0 : Q.current], {
                    autoAlpha: 1,
                    duration: ye.sidebar.in.duration,
                    ease: ye.sidebar.in.ease,
                    delay: ye.sidebar.in.delay,
                    onComplete: () => {
                      he?.current && (he.current.style.pointerEvents = "all"), Q?.current && (Q.current.style.pointerEvents = "all")
                    }
                  }, 0), L?.camera && S && !te.current && (te.current = L.camera.fov);
                  break
                }
                default:
                  Q.current && P.gsap.to(Q.current, {
                    pointerEvents: "none"
                  }), (ee.current ? ee.current.querySelectorAll("button") : []).forEach(e => {
                    e.style.pointerEvents = "none"
                  }), P.gsap.to(ee.current, {
                    autoAlpha: 0,
                    duration: ye.sidebar.out.duration,
                    ease: ye.sidebar.out.ease,
                    delay: ye.sidebar.out.delay
                  }), !S && Q.current ? (P.gsap.to(Q.current, {
                    autoAlpha: 0,
                    duration: ye.sidebar.out.duration,
                    ease: ye.sidebar.out.ease,
                    delay: ye.sidebar.out.delay
                  }), P.gsap.to(he.current, {
                    autoAlpha: 0,
                    duration: ye.sidebar.out.duration,
                    ease: ye.sidebar.out.ease,
                    delay: ye.sidebar.out.delay,
          ...
          }, [A[de]?.current, he.current, L, z]);
          const Ve = (0, s.useCallback)(() => {
            if (S && ae.current) {
          ...
          const We = (0, s.useCallback)((0, u.debounce)(() => {
            if (!0 !== Me.current) return;
            const {
              renderer: e
            } = Le.current;
            Ie.current === ze.VIEW_PLATE && (C() ? e.domElement.style.transform = `translateY(${.4*window.innerHeight/-2}px)` : e.domElement.style.transform = "translateY(0px)", Q?.current && (Q.current.style.opacity = "1", Q.current.style.visibility = "visible", Q.current.style.pointerEvents = "all"), je(null, {
              isResize: !0
            }), Ve())
          }, 100), [S, z, x, L, ne, j, w]);
          (0, s.useEffect)(() => {
            k && (Ce.current = k), n() === ze.VIEW_PLATE ? We() : C() && (Ve(), fe(.4 * window.innerHeight))
          }, [k]), (0, s.useEffect)(() => {
            if (!L?.scene) return;
            if (!L?.scene || !h?.[0]?.current) return;
            const {
              scene: e
            } = L, t = [], a = [], r = h[y].current;
            if (e.traverse(e => {
                e.name === De.LP && e.material ? a[e.userData.index] = e.material : t.push(e.material)
              }), n() === ze.VIEW_PLATE)
              if (_) {
                const t = a[y];
                if (P.gsap.to(t, {
                    opacity: 1,
                    delay: S ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
                    duration: S ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
                    ease: S ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease,
                    onStart: () => {
                      o(!0), P.gsap.to(r.style, {
                        opacity: 0,
                        duration: ye.accessibilePlate.duration,
                        ease: ye.accessibilePlate.ease,
                        onUpdate: () => {}
                      })
                    }
                  }), !xe.current) {
                  const t = e.getObjectByName("Light4"),
                    a = new i.Vector3;
                  K?.current && (K.current.getWorldPosition(a), P.gsap.to(t.position, {
                    x: Ae.x,
                    y: a.y + Ae.y,
                    z: Ae.z,
                    delay: S ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
                    duration: ye.plateShimmer.duration,
                    ease: ye.plateShimmer.ease
                  }));
                  const r = {
                    current: 0
                  };
          ...
          const Ye = (0, r.jsxs)(r.Fragment, {
              children: [!S && (0, r.jsx)("hr", {
                className: na.drawerHandle,
                onClick: () => {
                  c(!E)
                },
                "aria-hidden": "true"
              }), (0, r.jsx)("div", {
                className: na.plateInfo,
                children: (0, r.jsxs)("section", {
                  className: na.vehiclesApplied,
                  children: [(0, r.jsx)("label", {
                    htmlFor: "vehicles",
                    className: Y.length ? "" : `${na.noVehicles}`,
              ...
              if (a) {
                const e = V(a.parentElement),
                  ...
                  o = {
                    ...
                    buttonWrapTranslateY: V(be.current).y,
                    canvasWrapOpacity: n.style.opacity,
                    canvasHeight: n.offsetHeight,
                    canvasTranslateY: Number(V(n).y),
                    fov: s.fov,
                  ...
                  i = {};
                t.current === U ? (i.buttonWrapOpacity = 0, i.buttonWrapTranslateY = ne, i.canvasWrapOpacity = 0, i.canvasHeight = -ne, i.canvasTranslateY = ue.current, i.fov = te.current, i.accessiblePlateX = Te.current.x, i.accessiblePlateY = Te.current.y, i.accessiblePlateScale = Te.current.scale, n.style.pointerEvents = "none") : (t.current === F || t.current === B) && (i.buttonWrapOpacity = 1, i.buttonWrapTranslateY = 0, i.canvasWrapOpacity = 1, i.canvasHeight = -ne, i.canvasTranslateY = ue.current, i.fov = te.current, i.accessiblePlateX = Te.current.x, i.accessiblePlateY = Te.current.y, i.accessiblePlateScale = Te.current.scale, n.style.pointerEvents = "all"), P.gsap.to(o, {
            ...
            He = (0, s.useCallback)(e => {
              ...
              const {
                ...
                camera: o,
                renderer: i
              } = L, c = i.domElement, l = h?.[0]?.current, d = -ne + .4 * window.innerHeight - 48;
              if (l)
                if (t.dragging) {
                  const e = (0, Tt.U4)(0, s, r.get()),
                    i = (0, Tt.Cc)(0, 1, 1 - e);
                  c.style.opacity = i, be.current.style.opacity = i, be.current.style.transform = `translateY(${r.get()}px)`;
                  const d = (0, Tt.Cc)(0, 1, 1 - 3 * e);
                  if (l.parentElement.style.opacity = d, a.current > 0 && Math.abs(t.delta[1]) > 0 && o && a.current < n) {
                    const e = (0, Tt.U4)(0, n, r.get()),
                      a = (0, Tt.Cc)(te.current, 40, e);
                    o.fov = a;
                    const s = Number(V(c).y) + t.delta[1] / 2;
                    if (c.style.transform = `translateY(${s}px)`, l) {
                      const e = V(l.parentElement),
                        a = Number(e.x),
                        r = Number(e.scale),
                        s = Number(V(l.parentElement).y) + t.delta[1] / 2;
                  ...
                  const e = {
                    ...
                    fov: o.fov,
                    uiButtonsTransformY: V(be.current).y,
                    canvasHeight: c.offsetHeight,
                    canvasTranslateY: Number(V(c).y),
                    accessibilityPlateY: Number(V(l.parentElement).y),
                    accessibilityPlateOpacity: l.parentElement.style.opacity
                  };
                  a.current < ne / 2 ? (c.style.pointerEvents = "none", P.gsap.to(e, {
                    buttonWrapOpacity: 0,
                    canvasWrapOpacity: 0,
                  ...
                  })) : a.current > n / 2 ? (c.style.pointerEvents = "all", P.gsap.to(e, {
                    buttonWrapOpacity: 1,
                    uiButtonsTransformY: n,
                    canvasWrapOpacity: 1,
                    fov: 40,
                    canvasHeight: d,
                    canvasTranslateY: Number(ue.current) + n / 2,
                  ...
                  })) : Math.abs(a.current) > 0 && (c.style.pointerEvents = "all", P.gsap.to(e, {
                    buttonWrapOpacity: 1,
                    canvasWrapOpacity: 1,
            ...
            }, [L, be.current, ne, h, re, we]),
            Ue = (0, s.useCallback)(e => {
              const t = A[pe]?.current;
              if (!t || !L?.scene || !e) return;
              const {
                camera: a,
                renderer: r
              } = L, s = r.domElement, {
              ...
              P.gsap.to(c, {
                ...
                fov: te.current,
                duration: ye.sidebar.mobile.drawer.duration,
                ease: ye.sidebar.mobile.drawer.ease,
                onUpdate: () => {
            ...
            Be = (0, s.useMemo)(() => S ? (0, r.jsx)(Zt, {
              ...
              children: Ye
            }), [be.current, he.current, E, re, S, z, A, Q.current, Y, ne, ie]);
          return (0, s.useEffect)(() => {
            if (H) {
            ...
            children: [(0, r.jsx)(ra, {
              ...
              buttons: [{
                    ...
                    try {
                      ...
                      const r = {
                        ...
                        },
                        {
                          error: s,
                          status: n
                        } = await (0, g.coreScApiFetch)("games/gtao/licensePlates/plate", r);
                ...
                extraClasses: na.secondaryButton,
                onClick: () => {
                  Ee({
                    ...Pe,
                    event: "cta_cancel",
              ...
              children: [(0, r.jsx)(Jt, {
                onClick: Oe
              }), (0, r.jsx)(Xt.animated.div, {
                ref: be,
                className: na.uiBottom,
                style: ge ? {
                  y: ge
                } : void 0,
                children: (0, r.jsx)(Kt, {})
              ...
              className: na.deleteBtnContainer,
              ref: he,
              children: [(0, r.jsx)("button", {
                "data-testid": "lp-cta-delete",
                "aria-label": e("lp.modal.delete.title"),
                className: na.deleteBtn,
                disabled: v?.noDelete || q,
                onClick: () => {
                  v?.noDelete || q || (Ee({
                    ...Pe,
                ...
                htmlFor: "nodelete",
                className: na.noDeleteClarification,
      ...
      const da = JSON.parse('{"assets":[],"layers":[{"ddd":0,"ind":0,"ty":4,"nm":"Shape Layer 1","ks":{"o":{"k":100},"r":{"k":0},"p":{"k":[300,300,0]},"a":{"k":[0,0,0]},"s":{"k":[244,244,100]}},"ao":0,"shapes":[{"d":1,"ty":"el","s":{"k":[100,100]},"p":{"k":[0,0]},"nm":"Ellipse Path 1","mn":"ADBE Vector Shape - Ellipse"},{"ty":"tm","s":{"k":[{"i":{"x":[0.439],"y":[1.016]},"o":{"x":[0.561],"y":[0.015]},"n":["0p439_1p016_0p561_0p015"],"t":5,"s":[100],"e":[0]},{"t":33.0000013441176}],"ix":1},"e":{"k":[{"i":{"x":[0.439],"y":[1.017]},"o":{"x":[0.561],"y":[0.016]},"n":["0p439_1p017_0p561_0p016"],"t":0,"s":[100],"e":[0]},{"t":30.0000012219251}],"ix":2},"o":{"k":0,"ix":3},"m":1,"ix":2,"nm":"Trim Paths 1","mn":"ADBE Vector Filter - Trim"},{"ty":"st","fillEnabled":true,"c":{"k":[1,1,1,1]},"o":{"k":100},"w":{"k":16},"lc":2,"lj":1,"ml":4,"nm":"Stroke 1","mn":"ADBE Vector Graphic - Stroke"}],"ip":0,"op":900.000036657751,"st":0,"bm":0,"sr":1}],"v":"4.5.3","ddd":0,"ip":1.00000004073083,"op":33.0000013441175,"fr":29.9700012207031,"w":600,"h":600}'),
        ...
        ua = ({
          ...
          let t;
          return t = "threeDots" === e ? ma : da, (0, r.jsx)(la(), {
            loop: !0,
            autoplay: !0,
            animationData: t,
            style: {
        ...
        pa = (0, g.withTranslations)(({
          ...
          const {
            track: n
          } = (0, p.useGtmTrack)(), o = (e ? "lp.create.valid-profane" : t && "lp.create.valid-reserved") || "lp.create.helper";
          return (e || t) && n({
        ...
        fa = ({
          ...
          return (0, r.jsx)("button", {
            ...
            className: [ga.lpStyleOption, i === e.id ? ga.selected : ""].join(" "),
            onClick: () => c(),
            type: "button",
            tabIndex: t,
            "aria-label": `${e.displayName} plate style`,
            children: (0, r.jsx)("img", {
              className: ga.lpStyleOptionImage,
              src: e.previewUrl,
              alt: e.displayName
            })
          })
        },
        ba = (0, g.withTranslations)(({
          setIsLoading: e,
          validateFnRef: t,
          t: a
        }) => {
          ...
          } = u, [k, w] = (0, s.useState)(0), {
            isValid: _
          } = y, E = (0, s.useMemo)(() => h, [h]), {
            track: P
          } = (0, p.useGtmTrack)(), S = {
            view_name: "license plate creator - " + (n ? "create plate form" : "try lp editor")
          }, N = (0, s.useRef)(null), I = (0, s.useRef)(null), C = (0, s.useRef)(null), T = (0, s.useRef)(null), R = (0, s.useRef)(null);
          (0, s.useEffect)(() => {
            m(se, C)
          }, [C.current]), (0, s.useEffect)(() => {
            f === ze.NEW_PLATE && document.activeElement === R.current && R.current?.setSelectionRange(k, k)
          }, [k]), (0, s.useEffect)(() => {
            R?.current && f === ze.NEW_PLATE && setTimeout(() => R?.current?.focus(), 1e3)
          }, [f, R?.current]);
          const j = f === ze.NEW_PLATE ? 0 : -1,
            O = (0, s.useCallback)(() => {
              (async () => {
                if (n && h) try {
                  e(!0);
          ...
          const A = (0, s.useMemo)(() => b?.filter(e => !e.isXmas2023Plate || e.isXmas2023Plate && x).map(e => (0, r.jsx)(fa, {
            style: e,
            tabIndex: j
          }, e.id)), [b, f]);
          return (0, r.jsxs)("form", {
            ...
            children: [(0, r.jsxs)("section", {
              children: [(0, r.jsx)("label", {
                ...
                "aria-live": "polite",
                children: [(0, r.jsx)("i", {
                  className: "" + (!1 === _ ? "rockstargames-modules-gtao-license-plateca69ffac1f84964e08803d88539baf54" : "")
                }), (0, r.jsx)("input", {
                  id: "plate-text-input",
                  autoComplete: "off",
                  maxLength: 8,
                  ...
                  type: "text",
                  onKeyDown: e => {
                    "Enter" === e.code && f === ze.NEW_PLATE && R.current && R.current.blur()
                  },
                  value: E,
                  ref: R
                }), (0, r.jsx)(pa, {
        ...
        ya = "rockstargames-modules-gtao-license-plateef96579824fcf289d6b760a367574ba2",
        va = "rockstargames-modules-gtao-license-platead5528668e11995670231ff5023524c9",
        xa = (0, g.withTranslations)(({
          onToggleView: e = () => {},
          is3DToggle: t = !1,
          hasLiveRegion: a = !1,
          t: n
        }) => {
          const [o, i] = (0, s.useState)(!1), [c, l] = (0, s.useState)(!1), {
            state: d,
            setRefs: m
          } = Nt(), {
            currentView: u,
          ...
          (0, s.useEffect)(() => {
            ...
            t || m(ge, v)
          }, [v.current, t]), (0, s.useEffect)(() => {
            u === ze.NEW_PLATE && b && i(!1)
          }, [b, u]), (0, s.useEffect)(() => {
            t || (u === ze.NEW_PLATE ? o ? (h({
              ...y,
              event: "virtualPageview",
          ...
          const x = {
            ...
            k = t ? "Switch between 2D and 3D views" : "Switch between viewing the plate on a car and by itself";
          let w;
          return w = t ? f ? x.dimensionToggle.threeDimensions : x.dimensionToggle.twoDimensions : o ? x.carViewToggle.carView : x.carViewToggle.plateView, (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsxs)("button", {
              ...
              children: [(0, r.jsx)("div", {
                ...
                children: (0, r.jsx)("p", {
                  className: c ? va : "",
                  children: t ? x.dimensionToggle.twoDimensions : x.carViewToggle.plateView
                })
              }), (0, r.jsx)("div", {
                className: ya,
                children: (0, r.jsx)("p", {
                  className: c ? va : "",
                  children: t ? x.dimensionToggle.threeDimensions : x.carViewToggle.carView
                })
              }), (0, r.jsx)("span", {
        ...
        wa = (0, g.withTranslations)(({
          ...
          const {
            ...
            isMobile: h,
            accessiblePlates: y
          } = m, v = (0, s.useRef)(null), x = (0, s.useRef)(null), k = (0, s.useRef)(null), w = (0, s.useRef)(null), _ = (0, s.useRef)(null), {
            track: E
          } = (0, p.useGtmTrack)(), S = {
          ...
          return (0, s.useEffect)(() => {
            ...
            if (!(t && V && N && H)) return;
            const d = R();
            if (g && u === ze.LIST_PLATES) {
              const e = P.gsap.timeline({
                defaults: {
                  ease: ye.transaction.confirmOrder.ease,
                  duration: ye.transaction.confirmOrder.duration
                },
                onComplete: () => {
                  l(!1)
                }
              });
              if (P.gsap.to([t.domElement, $], {
                  autoAlpha: 1,
                  ease: ye.transaction.fade.landingPage.ease,
                  duration: ye.transaction.fade.landingPage.duration
                }), h) {
                const t = {
                  opacity: 1
                };
              ...
              const e = P.gsap.timeline({
                ...
                onComplete: () => {
                  l(!0), P.gsap.set(O, {
                    ...
                    e.name === De.LP && 0 === e.userData.index && e.material && (e.material.opacity = 0)
                  }), a.position.set(r.x, r.y, r.z), i?.current && (i.current.minDistance = 0, i.current.target.set(c.x, c.y, c.z)), W && (a.fov = s, a.updateProjectionMatrix(), he.saturation.value = 0)
                },
                onStart: () => {
                  P.gsap.set(D, {
                    height: 0
              ...
              if (e.to(t.domElement, {
                ...
                if (o) {
                  ...
                  e.to(t, {
                    ...
                    lerp: 1,
                    onUpdate: () => {
                      V.style.transform = `translateY(${n-t.drawerHeight}px`, o.set(t.drawerHeight), T && (T.style.pointerEvents = "none", T.style.opacity = String(1 - t.lerp), T.style.transform = `translateY(${100*t.lerp}%)`), C && (C.style.pointerEvents = "none", C.style.opacity = String(1 - t.lerp)), e.to(A, {
                        autoAlpha: 0
                ...
                autoAlpha: 0,
                ease: ye.transaction.fade.out.ease,
                duration: ye.transaction.fade.out.duration
              }, 0).set(V, {
                pointerEvents: "all"
              }), I && e.to(I, {
                left: 100 - d + "vw"
          ...
          }, [e, _.current, b, u, h ? o : void 0]), (0, r.jsx)("div", {
            className: [ka.orderConfirmed, g ? ka.visible : ""].join(" "),
            children: (0, r.jsx)("div", {
              ref: _,
              className: ka.background,
              children: (0, r.jsxs)("div", {
                className: ka.content,
                children: [(0, r.jsx)("h1", {
                  ref: v,
                  className: ka.contentHeading,
                  tabIndex: -1,
                  children: a("lp.success.title")
                }), (0, r.jsxs)("div", {
                  ref: x,
                  className: ka.secondaryWrap,
                  children: [(0, r.jsx)("p", {
                    ref: k,
                    className: ka.plateRedemptionInstructions,
                    dangerouslySetInnerHTML: {
                    ...
                    ref: w,
                    type: "button",
                    className: ka.backToPlatesButton,
                    onClick: () => {
                      F()
                    },
        ...
        _a = (0, g.withTranslations)(({
          ...
          const {
            ...
            loggedIn: I
          } = (0, p.useRockstarUser)(), C = (0, g.useRockstarTokenPing)(), T = u === ze.CONFIRM_ORDER, [j, O] = (0, s.useState)(E), [A, M] = (0, s.useState)(!1), L = (0, s.useRef)(null), z = (0, s.useRef)(null), D = (0, s.useRef)(null), {
            track: W
          } = (0, p.useGtmTrack)(), Y = {
            view_name: "license plate creator - confirm order"
          }, $ = u === ze.CONFIRM_ORDER ? 0 : -1;
          (0, s.useEffect)(() => {
            d(Z, L)
          }, [L.current]), (0, s.useEffect)(() => {
            d(q, z)
          }, [z.current]);
          const H = x[ie]?.current,
            U = x[q]?.current,
            F = x[Z]?.current,
            B = x[K]?.current,
            Q = x[J]?.current,
          ...
          function ce() {
            ...
            const e = {
                ease: v ? ye.sidebar.mobile.drawer.ease : ye.transaction.confirmOrder.ease,
                duration: v ? ye.sidebar.mobile.drawer.duration : ye.transaction.confirmOrder.duration
              },
              t = P.gsap.timeline({
                defaults: {
                  ...e
            ...
            u === ze.LIST_PLATES && j && ce()
          }, [u, j]);
          const le = (0, s.useCallback)(() => {
            (async () => {
              try {
                const e = S(w);
                if (!(I && f && e?.name && N)) return;
                const [t, a] = N, {
                  index: r
                } = f, s = {
                  vehicleIndex: r,
          ...
          }, [I, N, h?.[0]?.plateText, f, A, w]);
          (0, s.useEffect)(() => {
            if (u !== ze.CONFIRM_ORDER || _) {
              if (v && !_) {
                re && P.gsap.set(re, {
                  pointerEvents: "all"
                });
                ...
                P.gsap.to(e, {
                  ...
                  ease: ye.sidebar.mobile.drawer.ease,
                  onUpdate: () => {
                    Q && (Q.style.opacity = "" + (1 - e.lerp), Q.style.transform = `translateY(${100*e.lerp}%`)
                  }
                }), F && P.gsap.to(F, {
                  autoAlpha: 0,
                  duration: ye.sidebar.mobile.drawer.duration,
                  ease: ye.sidebar.mobile.drawer.ease
                }), B && (B.style.pointerEvents = "none", P.gsap.to(B.style, {
                  opacity: 0,
                  duration: ye.sidebar.mobile.drawer.duration,
                  ease: ye.sidebar.mobile.drawer.ease
                }))
              ...
              if (re && P.gsap.set(re, {
                  pointerEvents: "none"
                }), v && (a.ease = ye.sidebar.mobile.drawer.ease, a.duration = ye.sidebar.mobile.drawer.duration, a.delay = ye.sidebar.mobile.drawer.duration / 2, r.ease = ye.sidebar.mobile.drawer.ease, r.duration = ye.sidebar.mobile.drawer.duration, F && t.to(F, a, 0), ee)) {
                const e = {
                    current: 0
                  },
                  a = {
                ...
                t.to(e, {
                  current: 1,
                  delay: ye.sidebar.mobile.drawer.duration / 2,
                  onUpdate: () => {
                    const {
                      current: t
                    } = e, r = (0, Tt.Cc)(a.start, a.end, t);
                    ee.style.opacity = r
                  }
                }, 0)
              }
              if (v) {
                if (Q) {
                  Q.style.pointerEvents = "all", P.gsap.set(Q.style, {
                    visibility: "visible"
                  });
                  const e = {
                    lerp: 0
                  ...
                  P.gsap.to(e, {
                    ...
                    ease: ye.sidebar.mobile.drawer.ease,
                    onUpdate: () => {
                      Q.style.opacity = e.lerp, Q.style.transform = `translateY(${100*(1-e.lerp)}%`
                    }
                  })
                }
                B && (B.style.pointerEvents = "all", P.gsap.set(B.style, {
                  visibility: "visible"
                }), P.gsap.to(B.style, {
                  opacity: 1,
                  duration: ye.sidebar.mobile.drawer.duration,
                ...
                if (te && ae && (t.to([te, ae, se], {
                  ...
                  t.to(o, {
                    ...
                    onUpdate: () => {
                      const {
                        current: e
                      } = o, t = `translate(${(0,Tt.Cc)(n.x.start,n.x.end,e)}px, ${(0,Tt.Cc)(n.y.start,n.y.end,e)}px) scale(${(0,Tt.Cc)(n.scale.start,n.scale.end,e)})`;
            ...
            j && !T && _ && c(!1)
          }, [y, u, v, Q, _, B, R()]), (0, s.useEffect)(() => {
            if (u !== ze.CONFIRM_ORDER && k?.length) {
              let e = k[0];
              if (b) {
                const t = k.find(({
                  manufacturer: e,
          ...
          const de = (0, s.useCallback)(e => {
            ...
            ue = (0, r.jsx)(ha, {
              ...
              buttons: [{
                ...
                buttonText: A ? (0, r.jsx)(ua, {}) : e("lp.confirm.next"),
                isDisabled: !I || !f || A,
                onClick: () => {
                  le(), W({
                    ...Y,
          ...
          let pe;
          return v && (pe = B ? (0, Gt.createPortal)(ue, B) : null), (0, r.jsx)("div", {
            className: "rockstargames-modules-gtao-license-plateccf4dd7ed6d54ec03316f9491d1ceb0b",
            "aria-hidden": u !== ze.CONFIRM_ORDER,
            tabIndex: -1,
            children: (0, r.jsxs)("div", {
        ...
        Na = (0, g.withTranslations)(({
          ...
          const {
            ...
            realHeight: A,
            shouldForce2D: L
          } = n, [z, W] = (0, s.useState)(0), [Y, $] = (0, s.useState)(!1), [H, G] = (0, s.useState)(!1), [q, Z] = (0, s.useState)(.4 * window.innerHeight), [J, ee] = (0, s.useState)(-1 * (.6 * window.innerHeight - 80)), te = (0, s.useRef)(q), [ae, re] = (0, s.useState)(null), [ie, ce] = (0, s.useState)(!1), [de, ue] = (0, s.useState)(null), fe = (0, s.useRef)(null), be = (0, s.useRef)(null), xe = (0, s.useRef)(null), ke = (0, s.useRef)(null), we = (0, s.useRef)(null), Ie = (0, s.useRef)(!1), Ce = (0, s.useRef)(!1), [Re, je] = (0, s.useState)(null), Oe = (0, s.useRef)(Re), We = (0, s.useRef)(null), Ye = (0, s.useRef)(null), $e = (0, s.useRef)(null), He = (0, s.useRef)(null), Ue = (0, s.useRef)(null), Fe = (0, s.useRef)(null), Be = (0, s.useRef)(null), Ge = (0, s.useRef)(null), Xe = (0, s.useRef)(null), qe = (0, s.useRef)(null), Ze = (0, s.useRef)(null), Je = (0, s.useRef)(null), {
            track: Ke
          } = (0, p.useGtmTrack)(), Qe = {
            view_name: "license plate creator - create plate form"
          };
          (0, s.useEffect)(() => {
            g?.[0]?.current && f === ze.NEW_PLATE && ue(V(g[0].parentElement))
          }, [g, f]);
          const et = (0, s.useRef)(null);
          (0, s.useEffect)(() => {
            de && (et.current = de)
          }, [de]), (0, s.useEffect)(() => {
            const e = f === ze.NEW_PLATE || !(!C() || f !== ze.CONFIRM_ORDER);
            Y !== e && $(e), e || ce(!1)
          }, [f, C()]);
          const tt = (0, s.useCallback)((e, t = !1) => {
            ...
            const {
              ...
              controls: s,
              renderer: n
            } = j, o = a.getObjectByName("Scene");
            if (!o) return;
            const c = O(),
              d = x && f === ze.CONFIRM_ORDER ? 1.5 : 1,
              m = !T() || x ? c * b * d : 1.6 * c * b,
              p = [];
            a.traverse(e => {
              0 === e.userData.index && (Ze.current = e, o.position.set(e.position.x, e.position.y + -4.58, e.position.z + -13.77)), e.name === De.LP && p.push(e)
            });
            const h = x ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
              y = P.gsap.timeline({
                defaults: {
                  duration: h,
                  ease: x ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease
                },
                onStart: () => {
                  Oe.current || (s.current.minDistance = 0)
                }
              });
            switch (e) {
              case Sa: {
                ...
                const c = R[le].current,
                  h = document.getElementById("list-plates-sidebar"),
                  _ = R[X].current,
                  N = g?.[0].current;
                c && (h || x) && N && _ && (f === ze.NEW_PLATE || x && f === ze.CONFIRM_ORDER) && rt(y, t);
                const I = (new i.Vector3).copy(o);
                Oe.current && (I.z = o.z - 5 * b);
                const C = {
                  cameraPosition: {
                    start: (new i.Vector3).copy(r.position),
                    end: new i.Vector3(o.x, o.y, o.z + m)
                  },
                  controlsTarget: {
                  ...
                  firstPlateSaturation: {
                    start: he.saturation.value,
                    end: 1
                  },
                  firstPlateOpacity: {
                    start: E === ze.LIST_PLATES ? .2 : 1,
                    end: 1
                  },
                  cameraFov: {
                    start: r.fov,
                    end: x && f === ze.CONFIRM_ORDER ? 1.2 * we.current : we.current
                  },
                  ctaShaderOpacity: {
                ...
                if (x && N) {
                  const e = V(N.parentElement);
                  C.translateY = {
                    start: f === ze.NEW_PLATE ? Je?.current?.offsetHeight : 0,
                    end: f === ze.NEW_PLATE ? 0 : Je?.current?.offsetHeight
                  }, C.startingDrawerHeight = fe.current ? fe.current.get() : 0, C.startingCanvasHeight = Number(V(n.domElement).y), C.canvasWidth = n.domElement.offsetWidth, C.canvasY = {
                    start: Number(V(n.domElement).y),
                    end: .4 * window.innerHeight / -2
                  }, C.canvasYConfirmOrder = {
                    start: Number(V(n.domElement).y),
                    end: J / 1.5
                  }, C.accessiblePlateGridYConfirmOrder = {
                    start: Number(e.y),
                    end: Number(e.y) + (C.canvasYConfirmOrder.end - C.canvasYConfirmOrder.start)
                  }, C.accessiblePlateGridXConfirmOrder = {
                    start: Number(e.x),
                    end: Number(e.x)
                  }, C.accessiblePlateGridScaleConfirmOrder = {
                    start: Number(V(N.parentElement).scale),
                    end: Number(V(N.parentElement).scale) / d
                  }, C.drawerHeight = {
                    start: fe.current ? fe.current.get() : 0,
                    end: f === ze.NEW_PLATE ? 0 : J / (k ? 1 : 2)
                  }, C.cameraFov = {
                    start: r.fov,
                    end: f === ze.CONFIRM_ORDER ? 1.2 * we.current : we.current
                  }, C.canvasOpacity = {
                ...
                if (f === ze.NEW_PLATE) {
                  ...
                  y.to(T, {
                    current: 1,
                    duration: x ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
                    ease: x ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease,
                    onUpdate: () => {
                      const a = t ? 1 : T.current,
                        i = C.cameraPosition.start.clone().lerp(C.cameraPosition.end, a);
                      r.position.set(i.x, i.y, i.z);
                      const c = C.controlsTarget.start.clone().lerp(C.controlsTarget.end, a);
                      s.current.target.x = c.x, s.current.target.y = c.y, s.current.target.z = c.z, p.forEach((e, t) => {
                        e.material && (e.material.opacity = (0, Tt.Cc)(C.plateOpacity[t].start, C.plateOpacity[t].end, a))
                      });
                      const l = (0, Tt.Cc)(C.firstPlateSaturation.start, C.firstPlateSaturation.end, a);
                      if (he.saturation.value = l, u && !S && o) {
                        const e = !!S,
                          t = (0, Tt.Cc)(C.firstPlateOpacity.start, C.firstPlateOpacity.end, a);
                        o.style.filter = `saturate(${l})${!e&&` opacity(${t})`}`
                      }
                      if (e) {
                        const t = (0, Tt.Cc)(C.ctaShaderOpacity.start, C.ctaShaderOpacity.end, a);
                        e.style.opacity = t
                      }
                      if (C.cameraFov.start !== C.cameraFov.end && r.updateProjectionMatrix(), x) {
                        if (Je.current) {
                          const e = (0, Tt.Cc)(C.translateY.start, C.translateY.end, a);
                          Je.current.style.transform = `translateY(${e}px)`, Je.current.style.opacity = String(a), Je.current.style.pointerEvents = "all"
                        }
                        fe.current && fe.current.set((0, Tt.Cc)(C.drawerHeight.start, C.drawerHeight.end, a));
                        const e = (0, Tt.Cc)(C.canvasY.start, C.canvasY.end, a);
                    ...
                    onComplete: () => {
                      f === ze.NEW_PLATE && (c && (c.style.touchAction = "none"), ke.current = new i.Vector3(r.position.x, r.position.y, r.position.z), Fe?.current?.children && Fe.current.querySelectorAll("button").forEach(e => {
                        e.style.pointerEvents = "all"
                      }), x && (n.domElement.style.touchAction = "none", w && setTimeout(() => {
                        l(!1), document.body.style.touchAction = "auto"
                      }, 200), xe.current = V(n.domElement).y), o && o.classList.remove(Ea.newOrder), n.render(a, r))
                    }
                  }, 0), x && y.to(R[se].current, {
                    autoAlpha: 1,
                    duration: t ? 0 : ye.sidebar.mobile.drawer.duration,
                    ease: ye.sidebar.mobile.drawer.ease,
                    delay: ye.sidebar.mobile.drawer.duration / 2,
                    onStart: () => {
                      Je.current && (Je.current.style.pointerEvents = "all", Je.current.style.visibility = "visible")
                    }
                  }, 0), y.to([Fe.current, x ? void 0 : Ue.current], {
                    autoAlpha: 1,
                    duration: t ? 0 : ye.sidebar.in.duration,
                    ease: ye.sidebar.in.ease,
                    delay: ye.sidebar.in.delay,
                    onStart: () => {
                    ...
                    onComplete: () => {
                      x || P.gsap.set([Ue.current, R[me]?.current], {
                        pointerEvents: "all"
                ...
                } else f === ze.CONFIRM_ORDER && (!0 === Oe.current && ut(), x && (y.to(T, {
                  current: 1,
                  duration: ye.sidebar.mobile.drawer.duration,
                  ease: ye.sidebar.mobile.drawer.ease,
                  onUpdate: () => {
                    ...
                    if (Je.current) {
                      fe.current && fe.current.set((0, Tt.Cc)(C.drawerHeight.start, C.drawerHeight.end, e));
                      const t = C.cameraPosition.start.clone().lerp(C.cameraPosition.end, e);
                      r.position.set(t.x, t.y, t.z), n.domElement.style.opacity = (0, Tt.Cc)(C.canvasOpacity.start, C.canvasOpacity.end, e), Fe?.current?.style && (Fe.current.style.opacity = String(1 - e));
                      const a = (0, Tt.Cc)(C.translateY.start, C.translateY.end, e);
                      Je.current.style.transform = `translateY(${a}px)`, Je.current.style.pointerEvents = "none";
                      const s = (0, Tt.Cc)(C.canvasYConfirmOrder.start, C.canvasYConfirmOrder.end, e);
                      n.domElement.style.transform = `translateY(${s}px)`;
                      const o = (0, Tt.Cc)(C.accessiblePlateGridXConfirmOrder.start, C.accessiblePlateGridXConfirmOrder.end, e),
                        i = (0, Tt.Cc)(C.accessiblePlateGridYConfirmOrder.start, C.accessiblePlateGridYConfirmOrder.end, e),
                        c = (0, Tt.Cc)(C.accessiblePlateGridScaleConfirmOrder.start, C.accessiblePlateGridScaleConfirmOrder.end, e);
              ...
              default:
                if (Fe.current.querySelectorAll("button").forEach(e => {
                  ...
                  const e = {
                    transform: 0,
                    translateY: V(Je.current).y,
                    drawerHeight: fe.current ? fe.current.get() : 0,
                    fov: r.fov
                  };
                  P.gsap.to(e, {
                    translateY: Je?.current?.offsetHeight,
                    duration: ye.sidebar.mobile.drawer.duration,
                    drawerHeight: .4 * window.innerHeight,
                    fov: we.current,
                    ease: ye.sidebar.mobile.drawer.ease,
                    onUpdate: () => {
                      Je.current && (fe.current && fe.current.set(e.drawerHeight), Je.current.style.transform = `translateY(${e.translateY}px)`, Je.current.style.pointerEvents = "none", r.fov = e.fov, r.updateProjectionMatrix())
                    }
                  })
                }
                if (f === ze.CONFIRM_ORDER ? k || 1 == !Oe.current && P.gsap.to(r.position, {
                    x: Number(ke.current.x),
                    y: Number(ke.current.y),
                    z: 0,
                    ease: ye.transaction.confirmOrder.ease,
                    duration: ye.transaction.confirmOrder.duration
                  }) : P.gsap.to(Ue.current, {
                    autoAlpha: 0,
                    duration: ye.sidebar.out.duration,
                    ease: ye.sidebar.out.ease,
                    delay: ye.sidebar.out.delay
                ...
                s?.current && (s.current.minDistance = 0), Oe.current = !1, je(!1)
            }
          }, [f, j, R, x, S, b, h, _, E, A, ae, J, fe.current, Oe.current, v]);
          (0, s.useEffect)(() => {
            R?.[me]?.current && (Je.current = R[me].current)
          }, [R]), (0, s.useEffect)(() => {
            m("newPlate", Xe)
          ...
          const rt = (0, s.useCallback)((e, t = !1) => {
              if (!j?.controls || !g?.[0]) return;
              const {
                controls: a
              } = j, r = e || P.gsap.timeline({
                defaults: {
                  duration: 0,
                  ease: x ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease
                },
              ...
              }), s = O(), n = x && f === ze.CONFIRM_ORDER ? 1.5 : 1, i = !T() || x ? s * b * n : 1.6 * s * b, c = R[le].current, l = document.getElementById("list-plates-sidebar"), d = R[X].current, m = g[0].current;
              if (c && (x || l) && m && d) {
                const e = M(0, c, Number(A.replace("px", "")), h, x ? void 0 : {
                    x: l.offsetWidth,
                    y: 0
                  }).rect.center,
                  a = d.getBoundingClientRect(),
                  ...
                  p = 5 / i,
                  f = x || o() !== ze.CONFIRM_ORDER ? 0 : -1 * l.offsetWidth,
                  b = {
                    x: u.x - e.x + f,
                    y: u.y - e.y - 80 + (E === ze.CONFIRM_ORDER || t ? _ : window.scrollY)
                  },
                  y = {
                    current: 0
                  },
                  v = g.map(e => e?.current ? Number(getComputedStyle(e?.current).getPropertyValue("opacity")) : null).filter(e => e),
                  k = E === ze.CONFIRM_ORDER ? ye.transaction.confirmOrder.ease : ye.clickPlate.ease,
                  w = E === ze.CONFIRM_ORDER ? ye.transaction.confirmOrder.duration : ye.clickPlate.duration,
                  P = .4 * window.innerHeight,
                  S = x ? ye.sidebar.mobile.drawer.duration : w,
                  N = t ? 0 : S;
                r.to(y, {
                  current: 1,
                  ease: x ? ye.sidebar.mobile.drawer.ease : k,
                  duration: N,
                  onComplete: () => {
                    ue(V(m.parentElement)), ce(!0)
                  },
                  onUpdate: () => {
                    const {
                      current: a
                    } = y, r = (0, Tt.Cc)(Number(n.x), b.x, a), s = (0, Tt.Cc)(Number(n.y), b.y + (x ? P / -2 : 0), a), o = (0, Tt.Cc)(Number(n.scale), p, a);
                    m.parentElement.style.transformOrigin = `${e.x}px ${e.y}px`, m.parentElement.style.transform = `translate(${r}px, ${s}px) scale(${o})`, t || g.forEach((e, t) => {
                      if (0 !== t && e?.current) {
                        const r = (0, Tt.Cc)(v[t], 0, Math.min(1, 20 * a));
            ...
            }, [h, A, x, f, q, j, g, R, E, $e?.current, _]),
            st = (0, s.useCallback)(() => {
              if (!j?.controls) return;
              const {
                controls: e,
                scene: t
              } = j, a = P.gsap.timeline({
              ...
              Y ? (f === ze.NEW_PLATE && (C() ? s.domElement.style.transform = `translateY(${.4*window.innerHeight/-2}px)` : s.domElement.style.transform = "translateY(0px)", Ue?.current && (Ue.current.style.opacity = "1", Ue.current.style.visibility = "visible", Ue.current.style.pointerEvents = "all")), f === ze.CONFIRM_ORDER && C() && (s.domElement.style.transform = `translateY(${J/1.5}px)`)) : f !== ze.CONFIRM_ORDER || C() || (s.domElement.style.transform = "translateY(0px)"), o() !== ze.NEW_PLATE && o() !== ze.CONFIRM_ORDER || rt(null, !0), C() && ot(), Oe.current && mt({
                isResize: !0,
                onComplete: null,
                delay: 0
              })
            }, [C(), Y, v, f, j, Ue.current, b, _]),
            nt = (0, s.useCallback)((e = {}, t = !1) => {
              if (!Ze?.current || !ke.current || !j?.camera) return;
              Ke({
                ...Qe,
                event: "modal_close",
              ...
              const {
                ...
                controls: s,
                renderer: n
              } = j, o = r.getObjectByName("Scene"), i = r.getObjectByName("Light1"), c = r.getObjectByName("Light2"), l = r.getObjectByName("Light3"), d = n.domElement, m = P.gsap.timeline({
                defaults: {
                  ease: ye.toggleView.camera.ease,
                  duration: t ? 0 : ye.toggleView.camera.duration
                },
                onStart: () => {
                  s?.current && (s.current.minDistance = 2, s.current.enableZoom = !1, s.current.enabled = !1)
                },
                onComplete: () => {
                  s?.current && (s.current.minDistance = 0, s.current.maxPolarAngle = ve.plateView.maxPolarAngle, s.current.minPolarAngle = ve.plateView.minPolarAngle, s.current.maxAzimuthAngle = ve.plateView.maxAzimuthAngle, s.current.minAzimuthAngle = ve.plateView.minAzimuthAngle, s.current.enableZoom = !1), te.current = 0, e.onComplete && e.onComplete()
                }
              });
              m.to(a.position, {
                x: Number(ke.current.x),
                ...
                depthTest: !1
              }, "<"), Ze?.current?.material && m.to(Ze.current.material, {
                envMapIntensity: Me
              }, "<"), o.traverse(e => {
                e.material && P.gsap.to(e.material, {
                  opacity: 0,
                  duration: t ? 0 : ye.toggleView.fadeOut.duration,
                  ease: ye.toggleView.fadeOut.ease
                })
              })
            }, [Ze.current, ke.current, j]);
          (0, s.useEffect)(() => {
            j?.scene && !we.current && (we.current = j.camera.fov)
          }, [we.current, j]), (0, s.useEffect)(() => {
            j?.scene && Je.current && tt(Y ? Sa : Pa)
          }, [j, Y, f === ze.CONFIRM_ORDER, E]), (0, s.useEffect)(() => {
            j?.scene && Je.current && tt(Y ? Sa : Pa, !0)
          }, [x]);
          const ot = (0, s.useCallback)(() => {
            if (Je?.current && x && Xe.current) {
              const e = Xe.current.offsetHeight + 80,
                t = e - window.innerHeight,
                a = .4 * e;
              W(a - 48 - Je.current.offsetHeight - t), Z(a), ee(-1 * (.6 * e - 80)), Je.current.style.transform = `translateY${Je.current.offsetHeight}px`
            }
          }, [Je.current, x, Xe.current]);
          (0, s.useEffect)(() => {
            ot()
          }, [Je.current, x, Xe.current]), (0, s.useEffect)(() => {
            Ye.current || (Ye.current = f), $e.current || ($e.current = Ye.current), f && ($e.current = Ye.current, c(Ye.current), Ye.current = f), f === ze.LIST_PLATES && Oe.current && nt({}, !0), f === ze.NEW_PLATE && (He.current = !1)
          }, [f]), (0, s.useEffect)(() => {
            const e = x ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
              a = ie ? 0 : e;
            if (!j?.scene) return;
            if (!j?.scene || !g?.[0]?.current) return;
            const {
              scene: r,
              renderer: s,
              camera: n
            ...
            if (r.traverse(e => {
                e.name === De.LP && e.material ? l[e.userData.index] = e.material : c.push(e.material)
              }), o() === ze.NEW_PLATE)
              if (v) {
                const e = l[0];
                if (P.gsap.to(e, {
                  ...
                  const e = r.getObjectByName("Light4"),
                    t = new i.Vector3;
                  Ze?.current && (Ze.current.getWorldPosition(t), P.gsap.to(e.position, {
                    x: Ae.x,
                    y: t.y + Ae.y,
                    z: Ae.z,
                    delay: a,
                ...
                P.gsap.to(d.style, {
                  ...
                  onStart: () => {
                    P.gsap.to(e, {
                      ...
                      ease: ye.accessibilePlate.ease,
                      onComplete: () => {
                        t(!1), Ce.current = !1, s.render(r, n)
                      }
                    })
                  }
                })
              }
          }, [v, x, j, g]), (0, s.useEffect)(() => {
            if (o() === ze.NEW_PLATE && ie && j?.camera) {
              const {
                camera: e
              } = j, t = v ? 0 : .5;
              v || P.gsap.to(e.position, {
                duration: t,
                x: Number(ke.current.x),
                y: Number(ke.current.y),
                z: Number(ke.current.z)
          ...
          (0, s.useEffect)(() => {
            b && (it.current = b), o() === ze.NEW_PLATE || o() === ze.CONFIRM_ORDER ? st() : C() && (ot(), re(window.innerHeight), Je.current && (Je.current.style.transform = `translateY(${Je.current.offsetHeight}px`))
          }, [b]);
          const ct = (0, s.useCallback)((e, t, a = !1) => {
              if (Ye.current !== ze.NEW_PLATE && Ye.current !== ze.CONFIRM_ORDER) return;
              const {
                renderer: r
              } = j;
              D({
            ...
            lt = (0, s.useCallback)(e => {
              ...
              if (a) {
                const {
                  renderer: e,
                  camera: r
                } = j, s = e.domElement, n = V(a.parentElement), o = {
                  buttonWrapOpacity: Be.current.style.opacity,
                  canvasWrapOpacity: s.style.opacity,
                  fov: r.fov,
                  canvasTranslateY: Number(V(s).y),
                ...
                t.current === U ? (i.buttonWrapOpacity = 0, i.canvasWrapOpacity = 0, i.fov = we.current, i.canvasTranslateY = xe.current, i.accessiblePlateX = et.current.x, i.accessiblePlateY = et.current.y, i.accessiblePlateScale = et.current.scale, s.style.pointerEvents = "all", c.forEach(e => {
                  e.style.pointerEvents = "none"
                })) : (t.current === F || t.current === B) && (i.buttonWrapOpacity = 1, i.canvasWrapOpacity = 1, i.fov = we.current, i.canvasTranslateY = xe.current, i.accessiblePlateX = et.current.x, i.accessiblePlateY = et.current.y, i.accessiblePlateScale = et.current.scale, s.style.pointerEvents = "all", c.forEach(e => {
                  e.style.pointerEvents = "all"
                })), P.gsap.to(o, {
                  buttonWrapOpacity: i.buttonWrapOpacity,
                  canvasWrapOpacity: i.canvasWrapOpacity,
            ...
            dt = (0, s.useCallback)(e => {
              ...
              const {
                ...
                camera: o,
                renderer: i
              } = j, c = i.domElement, l = g?.[0]?.current;
              if (l)
                if (t.dragging) {
                  const e = (0, Tt.U4)(0, s, r.get()),
                    i = (0, Tt.Cc)(0, 1, 1 - e);
                  ...
                  if (l.parentElement.style.opacity = d, Be.current.style.opacity = i, Fe.current.querySelectorAll("button").forEach(e => {
                    ...
                    const e = (0, Tt.U4)(0, n, r.get()),
                      a = Oe.current ? 60 : 40,
                      s = (0, Tt.Cc)(we.current, a, e);
                    o.fov = s, o.updateProjectionMatrix();
                    const i = Number(V(c).y) + t.delta[1] / 2;
                  ...
                  a.current < s / 2 ? (Fe.current.querySelectorAll("button").forEach(e => {
                    ...
                    canvasTranslateY: Number(xe.current) + n / 2,
                    fov: Oe.current ? 60 : 40,
                    duration: ye.sidebar.mobile.drawerSnap.duration,
                    ease: ye.sidebar.mobile.drawerSnap.ease,
                    onUpdate: () => {
            ...
            }, [j, Je.current, q, g, xe.current, de]),
            mt = (0, s.useCallback)((e = {
              ...
              const {
                ...
                camera: s,
                controls: n
              } = j, o = r.getObjectByName("Scene"), c = r.getObjectByName("Light1"), l = r.getObjectByName("Light2"), d = r.getObjectByName("Light3");
              let m = null;
              const u = [];
              o.traverse(e => {
                ...
                e.name === De.LP && 0 === e.userData.index && (m = e)
              });
              ...
              P.gsap.to(g, {
                ...
                light1Intensity: Ve,
                light2Intensity: .2,
                light2PositionX: Se.x,
                light2PositionY: Se.y,
                light2PositionZ: Se.z,
                light3Intensity: Ve,
                light3PositionX: Te.x,
                delay: a,
                envMapIntensity: Le,
                duration: t ? 0 : ye.toggleView.camera.duration,
                ease: ye.toggleView.camera.ease,
                onStart: () => {
                  const e = x ? 52 * b : 26 * b;
                  n.current.enableZoom = !0, n.current.maxPolarAngle = ve.carView.maxPolarAngle, n.current.minPolarAngle = ve.carView.minPolarAngle, n.current.maxAzimuthAngle = ve.carView.maxAzimuthAngle, n.current.minAzimuthAngle = ve.carView.minAzimuthAngle, n.current.maxDistance = e, o.visible = !0, R[ge].current.style.pointerEvents = "none"
                },
                onUpdate: () => {
                ...
                onComplete: () => {
                  Ie.current = !1, n.current.minDistance = x ? 20 * b : 10 * b, R[ge].current.style.pointerEvents = "all"
                }
              });
              const f = {
                opacity: 0
              ...
              P.gsap.to(f, {
                ...
                delay: t ? 0 : .4 + a,
                onComplete: () => {
                  m.material && (m.receiveShadow = !0, m.material.depthTest = !1, m.renderOrder = 99998)
                }
              })
            }, [j, Oe.current, Ze, Ze?.current, b, x, L, v]),
            ut = (0, s.useCallback)((e = {
              delay: 0,
              onComplete: null
            }) => {
              if (!j?.scene || !j?.controls?.current || !Ze || !Ze?.current || Ie.current) return;
              const {
                scene: t,
                camera: r,
                controls: s
              } = j, n = e.delay || 0, o = t.getObjectByName("Scene"), c = t.getObjectByName("Light1"), l = t.getObjectByName("Light2"), d = t.getObjectByName("Light3"), m = O(), u = !T() || x ? m * b : 1.6 * m * b;
              if (o && s && !Ie.current && !Ce.current) {
                const t = [];
                if (o.traverse(e => {
                  ...
                  if (Ze.current.getWorldPosition(a), setTimeout(() => {
                    ...
                    P.gsap.to(n, {
                      ...
                      ease: ye.toggleView.camera.ease,
                      onStart: () => {
                        s.current.minDistance = 2, s.current.enableZoom = !1, R[ge].current.style.pointerEvents = "none";
                        const e = P.gsap.timeline({
                          duration: x ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
                          ease: x ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease
                        });
                      ...
                      onComplete: () => {
                        Ie.current = !1, o.visible = !1, s.current.maxPolarAngle = ve.plateView.maxPolarAngle, s.current.minPolarAngle = ve.plateView.minPolarAngle, s.current.maxAzimuthAngle = ve.plateView.maxAzimuthAngle, s.current.minAzimuthAngle = ve.plateView.minAzimuthAngle, R[ge].current.style.pointerEvents = "all", e.onComplete && e.onComplete()
                      }
                    });
                    const i = {
                      opacity: 1
                    ...
                    P.gsap.to(i, {
                      opacity: 0,
                      duration: ye.toggleView.fadeOut.duration,
                      ease: ye.toggleView.fadeOut.ease,
                      onUpdate: () => {
                        t.forEach(e => {
                          e.opacity = i.opacity
            ...
            }, [j, Oe.current, Ze, Ze?.current, b, L, v]),
            pt = (0, s.useCallback)(e => {
              if (!j?.scene || !Je?.current || !Be.current) return;
              const t = R[pe]?.current;
              if (t) {
                const {
                  camera: a,
                  renderer: r
                ...
                P.gsap.to(c, {
                  ...
                  mobileSidebarHeight: .4 * window.innerHeight,
                  fov: we.current,
                  submitOrderTranslateY: Je.current.offsetHeight,
                  duration: ye.sidebar.mobile.drawer.duration,
                  ease: ye.sidebar.mobile.drawer.ease,
                  onUpdate: () => {
                    o.current.style.transform = `translateY(${c.mobileSidebarHeight}px)`, o.current.style.opacity = c.opacity, Je.current.style.transform = `translateY(${c.submitOrderTranslateY}px)`, Be.current.style.opacity = c.opacity, s.style.height = c.height, n.set(c.mobileSidebarHeight), a && (a.fov = c.fov, a.updateProjectionMatrix())
                  },
                  onComplete: () => {
                    s.style.pointerEvents = "all"
                  }
            ...
            gt = e => {
              ...
              re(r), fe.current = r, t.current.style.pointerEvents = "all";
              const i = {
                mobileSidebarHeight: .4 * window.innerHeight,
                opacity: t.current.style.opacity
              };
            ...
            ft = (0, s.useMemo)(() => {
              ...
              } = I, s = H ? (0, r.jsx)(ua, {}) : e("lp.create.next");
              return (0, r.jsx)(ha, {
                buttons: [{
                  buttonText: u ? s : e("lp.create.signin"),
                  isDisabled: !!u && (H || !N || !t && N === a),
                  onClick: async () => {
                    We?.current?.(), u || (Ke({
                      ...Qe,
                      event: "cta_login",
                ...
                isLoading: H,
                isVisible: [ze.NEW_PLATE, ze.CONFIRM_ORDER].includes(f),
                tabIndex: f === ze.NEW_PLATE ? 0 : -1
              })
            }, [N, f, u, Y, I, We.current, H]),
            bt = (0, s.useCallback)(() => {
              d(!k)
            }, [k]),
            ht = (0, s.useMemo)(() => x ? (0, r.jsxs)(Zt, {
              bottom: z,
              isVisible: Y,
              onDrag: dt,
              onHide: pt,
            ...
            }), [N, z, k, x, Y, fe.current, Ue.current, J, ae, H, q]);
          return (0, r.jsxs)("div", {
            ref: Xe,
            ...
            children: [ht, (0, r.jsxs)("div", {
              ...
              children: [(0, r.jsx)(Jt, {
                onClick: () => {
                  Ie.current || nt({
                    onComplete: () => {
                      ce(!1), o(ze.LIST_PLATES)
                    }
                  })
                }
              }), (0, r.jsxs)(Xt.animated.div, {
                ref: Be,
                ...
                children: [(0, r.jsx)(xa, {
                  is3DToggle: !0,
                  hasLiveRegion: f === ze.NEW_PLATE,
                  onToggleView: () => {
                    Ce.current || Ie.current || (Oe.current && !L ? ut({
                      onComplete: () => {
                        a(!L), je(!1)
                      }
                    }) : a(!L), Ce.current = !0)
                  ...
                  hasLiveRegion: f === ze.NEW_PLATE,
                  onToggleView: e => {
                    if (!Ie.current && !Ce.current) {
                      const t = x ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
                        a = v ? 0 : t;
                      "function" == typeof e?.onStart && e.onStart(), ut({
                        delay: a
                      }), Ie.current = !0
                    }
                  }
        ...
        Ta = "rockstargames-modules-gtao-license-platee8b715cd9fe57b8045d6cdba432a383d",
        Ra = "rockstargames-modules-gtao-license-platedb428a8c19f00e1957c84f82211c4d0c",
        ja = (0, g.withTranslations)(({
          t: e
        }) => {
          const t = (0, n.useIntl)(),
            {
            ...
            children: [(0, r.jsx)("div", {
              ...
              children: [(0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)("h5", {
                  ...
                  children: t.formatMessage(Ca.lpe_sidebar_total_plates_text, {
                    total: g,
                    max: 30
                  })
                }), (0, r.jsxs)("span", {
                  ...
                  children: [(0, r.jsxs)("span", {
                    ...
                    children: [m?.current && (0, r.jsx)("span", {
                      ref: m,
        ...
        Oa = "rockstargames-modules-gtao-license-plateb93df9086c68643b2659f4db7a32cea3",
        {
          lerp: Aa
        } = i.MathUtils,
        Va = "visible";
      ...
      const za = () => {
          ...
          } = (0, p.useRockstarUserState)(), E = (0, s.useRef)(null), [S, N] = (0, s.useState)(u === ze.LIST_PLATES), I = y?.[re]?.current;
          (0, s.useEffect)(() => {
            Ma && (Ma.pause(), Ma = null), La = !1
          }, [_]), (0, s.useEffect)(() => {
            N(u === ze.LIST_PLATES)
          }, [u]);
          const [C, T] = (0, s.useState)();
          return (0, s.useEffect)(() => {
            if (!(y && y?.[Q]?.current && y?.[te]?.current && y?.[de]?.current && y?.[pe]?.current && y?.[ae]?.current && E.current && f?.scene && f?.controls)) return;
            const e = S ? Va : "hidden";
            C !== e && (e => {
              T(e);
              const {
                ...
                sidebar: S,
                deletePlate: N
              } = ye, C = y[te].current, R = y[de].current, j = y[ae].current, O = y[ue].current, A = y[ce].current, M = l?.[m]?.current || null, L = l?.[0]?.current || null, z = y[Q]?.current || null, D = [];
              switch (v.traverse(e => {
                  e.name === De.LP && D.push(e)
                }), Ma = P.gsap.timeline({
                  duration: b ? S.mobile.drawer.duration : _.duration,
                  ease: b ? S.mobile.drawer.ease : _.ease
                }), e) {
                case Va: {
                  ...
                  const m = {
                    ...
                    f = {
                      ...
                      canvasTranslateY: {
                        start: Number(V(g.domElement).y),
                        end: 0
                      },
                      canvasWidth: g.domElement.offsetWidth,
                      drawerHeight: {
                        start: Number(V(E.current).y),
                        end: 0
                      },
                      ctaShaderOpacity: {
                  ...
                  M?.parentElement && (f.currentAccessibilityPlateTransform = {
                    start: {
                      x: Number(V(M.parentElement).x),
                      y: Number(V(M.parentElement).y),
                      scale: Number(V(M.parentElement).scale)
                    },
                    end: {
                      x: 0,
                      y: 0,
                  ...
                  if (Ma.to(m, {
                      ...
                      onStart: () => {
                        m.current = 0, R && (R.style.pointerEvents = "all"), g.render(v, r), a(!0)
                      },
                      onUpdate: () => {
                        const {
                          current: e
                        } = m, t = f.cameraPosition.start.clone().lerp(f.cameraPosition.end, e);
                        r.position.set(t.x, t.y, t.z);
                        const a = f.controlsTarget.start.clone().lerp(f.controlsTarget.end, e);
                        if (s.current.target.x = a.x, s.current.target.y = a.y, s.current.target.z = a.z, M && M.parentElement?.classList?.contains(Ia)) {
                          const t = Aa(f.currentAccessibilityPlateTransform.start.x, f.currentAccessibilityPlateTransform.end.x, e),
                            a = Aa(f.currentAccessibilityPlateTransform.start.y, f.currentAccessibilityPlateTransform.end.y, e),
                            r = Aa(f.currentAccessibilityPlateTransform.start.scale, f.currentAccessibilityPlateTransform.end.scale, e);
                          M.parentElement.style.transform = `translate(${t}px,\n                            ${a}px) scale(${r})`
                        }
                        const n = Aa(f.firstPlateSaturation.start, f.firstPlateSaturation.end, e);
                        if (he.saturation.value = n, w && !d && y) {
                          const t = Aa(f.firstPlateOpacity.start, f.firstPlateOpacity.end, e),
                            a = !!d;
                          y.style.filter = `saturate(${n})${!a&&` opacity(${t})`}`
                        }
                        if (z) {
                          const t = Aa(f.ctaShaderOpacity.start, f.ctaShaderOpacity.end, e);
                          z.style.opacity = t
                        }
                        if (b) {
                          const t = Aa(f.canvasTranslateY.start, f.canvasTranslateY.end, e);
                          if (g.domElement.style.transform = `translateY(${t}px)`, E.current) {
                            const t = Aa(f.drawerHeight.start, f.drawerHeight.end, e);
                            E.current.style.transform = `translateY(${t}px)`
                          }
                        }
                      }
                    }, 0), (l.length === k.length && l?.[0]?.current || w && !h && l[0].current && l?.filter(e => e?.current).length === k.length && 0 !== k.length && 0 !== l.length) && !La) {
                    const e = {
                      current: 0
                    };
                    La = !0, Ma.to(e, {
                      current: 1,
                      duration: b ? ye.sidebar.mobile.drawer.duration : ye.clickPlate.duration,
                      ease: b ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease,
                      onStart: () => {
                        La = !0
                      },
                      onComplete: () => {
                      ...
                      onUpdate: () => {
                        ...
                        l.forEach((e, a) => {
                          if (e.current && f.accessiblePlateOpacity[a]) {
                            const r = Aa(f.accessiblePlateOpacity[a].start, f.accessiblePlateOpacity[a].end, 2.5 * (t - .6));
                            e.current.style.opacity = r
                          }
                          if (D[a] && D[a].material) {
                            const e = Aa(f.plateOpacity[a].start, f.plateOpacity[a].end, t);
                    ...
                    if (t < 1) {
                      ...
                      Ma.to(a, {
                        ...
                        ease: b ? ye.sidebar.mobile.drawer.ease : ye.clickPlate.ease,
                        onUpdate: () => {
                          const t = Aa(e.start, e.end, a.current);
                    ...
                    if (e && t) {
                      ...
                      Ma.to(a, {
                        ...
                        onUpdate: () => {
                          const {
                            current: s
                          } = a, n = Aa(r.plateOpacity.start, r.plateOpacity.end, s), o = Aa(r.accessiblePlateOpacity.start, r.accessiblePlateOpacity.end, s);
                  ...
                  Ma.to(C, {
                    autoAlpha: 1,
                    duration: b ? S.mobile.footer.in.duration : S.in.duration,
                    ease: b ? S.mobile.footer.in.ease : S.in.ease,
                    delay: b ? S.mobile.footer.in.delay : S.in.delay
                  }, 0), Ma.to(R, {
                    autoAlpha: 1,
                    duration: b ? S.mobile.fadeHeader.in.duration : S.in.duration,
                    ease: b ? S.mobile.fadeHeader.in.ease : S.in.ease,
                    delay: b ? S.mobile.fadeHeader.in.delay : S.in.delay,
                    onStart: () => {
                      j && (h ? (j.classList.add(Oa), O && O.classList.add(Ra), A && A.classList.remove(Ta)) : (j.classList.remove(Oa), O && O.classList.remove(Ra), A && A.classList.add(Ta)))
                    }
                  }, 0), b && (I && P.gsap.set(I.style, {
                    visibility: "visible"
                ...
                default:
                  if (P.gsap.to(C, {
                      autoAlpha: 0,
                      duration: b ? S.mobile.footer.out.duration : S.out.duration,
                      ease: b ? S.mobile.footer.out.ease : S.out.ease
                    }), I && P.gsap.set(I.style, {
                      visibility: "hidden"
          ...
          }, [y, y.length, v, l?.[0]?.current, S, E.current, g, f, b, h, y?.[Q]?.current, y?.[te]?.current, y?.[de]?.current]), (0, r.jsx)("div", {
            ref: E,
        ...
        Da = ({
          ...
          const {
            ...
            plates: o,
            refs: i
          } = n, c = (0, s.useRef)(null), l = i[re]?.current;
          if ((0, s.useEffect)(() => {
              a(pe, c)
            }, [c.current]), !o) return null;
          let d;
          return e && (d = l ? (0, Gt.createPortal)((0, r.jsx)(za, {}), l) : null), (0, r.jsxs)("div", {
            ref: c,
            className: "rockstargames-modules-gtao-license-plated2586ff68fbf36883beccbd139e83c3b",
            children: [t && !e && (0, r.jsx)(_a, {}), e ? d : (0, r.jsx)(za, {}), t && (0, r.jsx)(ia, {}), (0, r.jsx)(Na, {})]
          })
        },
        Wa = (0, n.defineMessages)({
        ...
        Ya = ({
          ...
          const t = {
            ...
            g = {
              ...
              character: a(Wa.gtao_lp_no_character_errror),
            ...
            f = {
              ...
              character: a(Wa.gtao_lp_link_account_cta),
          ...
          return (0, s.useEffect)(() => {
            if (!o) return d(null), void u(null);
            d(o[0]), u(o[1] ?? t)
          }, [String(o)]), (0, s.useEffect)(() => {
            b({
              ...y,
              event: "alert_error",
              text: g[c] || e("lp.error.unexpected.description")
            }), b({
              ...y,
              event: "trackPageview",
            ...
            children: [(0, r.jsxs)("div", {
              ...
              children: [(0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)("i", {}), (0, r.jsx)("h4", {
                  children: g[c] || e("lp.error.unexpected.description")
                }), m?.code && (0, r.jsxs)("div", {
                  className: "rockstargames-modules-gtao-license-platef9f0425f6b691854deb61847717b396a",
                  children: [(0, r.jsx)("p", {
                    children: `Code: ${m.code}`
                  }), m?.logId && (0, r.jsx)("p", {
                    children: `LogID: ${m?.logId}`
                  })]
                })]
              }), (0, r.jsx)(l.NavLink, {
                to: "character" !== c ? "/gta-online" : "https://rockstargames.com/account/connections",
        ...
        $a = () => {
          ...
          return (0, s.useEffect)(() => {
            ...
            if (n && a?.[de]?.current && i.current) {
              const e = 80,
                t = 50,
                r = window.innerHeight - e,
                s = a?.[de].current.offsetHeight,
                n = s + (r - s) / 2 - t / 2;
        ...
        Ua = ({
          ...
          }, E = x === ze.LIST_PLATES ? 0 : -1, P = (0, s.useCallback)(() => {
            (async () => {
              if (!c || !y) return;
              const [e] = y, {
                error: t
              ...
              const a = [We, ...v.slice(1, v.length)];
              d(a), m(null), u(""), f(N(We.style.name)?.id), w({
                ..._,
                event: "cta_cancel",
          ...
          return (0, s.useEffect)(() => {
            ...
            className: [Ha.orderInProgressCTA, a ? "" : Ha.hidden].join(" "),
            children: [(0, r.jsx)("h1", {
              className: Ha.contentHeading,
              children: n("lp.inprogress.title")
            }), (0, r.jsx)("p", {
              className: Ha.orderInstructions,
              dangerouslySetInnerHTML: {
                __html: n("lp.inprogress.description").replace("<span>{car_name}</span>", `<span className=${Ha.vehicleName}>${e}</span>`)
              }
            }), (0, r.jsxs)("div", {
              className: Ha.buttonWrap,
              children: [(0, r.jsx)("button", {
              ...
              extraClasses: {
                message: Ha.dialogMessage,
                heading: Ha.heading
              },
              buttons: [{
                buttonText: n("lp.modal.order-cancel.confirm"),
                onClick: P,
                extraClasses: Ha.primaryButton,
                ...
                extraClasses: Ha.secondaryButton,
        ...
        Fa = ({
          ...
          className: Ea.firstPlateLoggedOut,
          style: {
            background: "none",
            border: "none",
            opacity: a === ze.LIST_PLATES ? 1 : 0,
            width: `${t}px`,
            height: t / 2 + "px"
          },
          children: (0, r.jsxs)("div", {
            className: [Ea.loggedOutCTA, a !== ze.LIST_PLATES ? Ea.hidden : ""].join(" "),
            children: [(0, r.jsx)("button", {
              ...
              className: [Ea.signIn, a !== ze.LIST_PLATES ? Ea.hidden : ""].join(" "),
              tabIndex: n,
              children: (0, r.jsx)("span", {
              ...
              className: [Ea.tryWithoutSigningIn, Ea.firstLoad, a !== ze.LIST_PLATES ? Ea.hidden : ""].join(" "),
              tabIndex: n,
              children: (0, r.jsx)("span", {
                className: Ea.ctaText,
        ...
        Ba = ({
          ...
          const {
            ...
            realHeight: x,
            plateTextures: k
          } = a, [w, _] = (0, s.useState)(!1), [E, P] = (0, s.useState)(!1);
          (0, s.useEffect)(() => {
            _(/([wW]in)/i.test(window.navigator.userAgent))
          }, []), (0, s.useEffect)(() => {
            h?.length && (C(h[0]), R(h.filter(({
              faux: e
            }) => !e).length >= 30))
          }, [h]);
          const [S, N] = (0, s.useState)(null), [I, C] = (0, s.useState)(null), [T, R] = (0, s.useState)(!1), j = y[ee], O = y[le], V = (0, s.useRef)(null), D = (0, s.useRef)(null);
          (0, s.useEffect)(() => {
            const e = y[de];
            if (!(e?.current && O?.current && m?.gridOptions && I)) return;
            const t = e.current,
              a = {
                x: v ? 0 : t.offsetWidth,
                y: 0
              },
              r = M(I.index, O.current, Number(x.replace("px", "")), m, a);
            N(r)
          }, [y]);
          const {
            track: W
          ...
          (0, s.useEffect)(() => {
            V.current && c("ctaWrap", V)
          }, [V.current, E]), (0, s.useEffect)(() => {
            D.current && c(Q, D)
          }, [D.current]);
          const H = l === ze.LIST_PLATES ? 0 : -1,
            U = (0, s.useCallback)(e => {
              if (n() === ze.LIST_PLATES) {
                const t = 0 === e ? ze.NEW_PLATE : ze.VIEW_PLATE;
                e && (W({
                  ...Y,
            ...
            G = (0, s.useMemo)(() => void 0 !== h ? A(f, h) ? (0, r.jsx)(Ua, {
              t: e,
              ...
              isVisible: l === ze.LIST_PLATES
            }) : T ? (0, r.jsxs)("div", {
              className: [Ea.maxPlatesReached, l !== ze.LIST_PLATES ? Ea.hidden : ""].join(" "),
              children: [(0, r.jsx)("i", {}), e("lp.notify.max-plates")]
            }) : 0 === h.length ? null : (0, r.jsxs)("button", {
              type: "button",
              style: {
                pointerEvents: l === ze.LIST_PLATES ? "all" : "none"
              },
              onKeyPress: e => {
              ...
              onPointerOver: v ? void 0 : () => {
                j?.current && F(j?.current)
              },
              onPointerOut: v ? void 0 : () => {
                var e;
                j?.current && (e = j?.current, z(e))
              },
              className: [Ea.createNewPlate, l !== ze.LIST_PLATES ? Ea.hidden : ""].join(" "),
              ref: $,
              tabIndex: H,
              children: [(0, r.jsx)("span", {
                className: `${Ea.ctaText} ${w?Ea.isWindows:""}`,
                children: e("lp.landing.newcta")
              }), (0, r.jsx)("div", {
                className: Ea.ctaIcon,
                role: "presentation",
                "aria-hidden": "true"
              })]
            }) : null, [S, l, T]),
            X = (0, s.useMemo)(() => void 0 !== f && S ? (0, r.jsx)("div", {
              ...
              children: G
            }) : null, [l, f, S, y, I, G, v, T]);
          return (0, s.useEffect)(() => {
            if (k?.[0]) {
              const e = k[0].image;
              if (e && V.current) {
                const a = V.current.querySelector("canvas");
                a && V.current.removeChild(a), e.style.width = "100%", e.style.height = "100%", e.style.position = "absolute", e.style.top = "0px", e.style.left = "0px", e.style.pointerEvents = "none", e.style.opacity = 1, e.style.transition = "transform 0.25s ease-out", t && !f && l === ze.LIST_PLATES && e.classList.add(Ea.newOrder), V.current.append(e)
              }
            }
          }, [k, V.current, f, t, l]), (0, s.useEffect)(() => {
            d?.[0]?.current || V.current && (d[0] = V)
          }, [d, V.current]), (0, s.useEffect)(() => {
            if (k?.[0]) {
              const e = k[0].image;
              e && b?.scene && (e.style.transition = "transform 0.25s ease-out")
            }
          }, [u, b, k]), (0, s.useMemo)(() => {
            if (!S || !I || !m?.gridOptions) return null;
            const e = A(f, h) ? Ea.pendingOrderShader : "",
              a = t ? e : Ea.loggedOutShader,
              {
                width: s,
                height: n
              } = S,
              ...
              d = [Ea.CTAWrap];
            return t || d.push(Ea.loggedOut), t && T && d.push(Ea.maxPlatesReachedWrap), P(!0), (0, r.jsxs)("div", {
              ref: V,
              className: d.join(" "),
              style: {
                top: o,
        ...
        Ga = ({
          ...
          return (0, s.useEffect)(() => {
            !a.current[t + 1]?.current && w && (a.current[t + 1] = w)
          }, [w.current, b, g]), (0, s.useEffect)(() => {
            if (i && w.current) {
          ...
          }, [f, i, w.current]), (0, s.useMemo)(() => (0, r.jsx)("button", {
            ...
            style: {
              ...
              pointerEvents: u !== ze.LIST_PLATES || "number" == typeof h || v ? "none" : "all"
            },
            tabIndex: o,
            type: "button",
            onClick: a => {
        ...
        Xa = ({
          ...
          const {
            ...
            loggedIn: u
          } = (0, p.useRockstarUser)(), [g, f] = (0, s.useState)([]), b = (0, s.useRef)(null), h = (0, s.useRef)([]);
          return (0, s.useEffect)(() => {
            h.current && i.length > 0 && h.current.length === i.length && t(h.current)
          }, [h.current?.length, i]), (0, s.useEffect)(() => {
            a(G, b)
          }, [b.current]), (0, s.useEffect)(() => {
            const e = l[le]?.current,
              t = l?.[de]?.current,
              a = [];
            e && t && o && (i.forEach((r, s) => {
              if (s) {
                const r = M(s, e, Number(c.replace("px", "")), o, d ? void 0 : {
                    x: t.offsetWidth,
                    y: 0
                  }),
                  {
          ...
          }, [m, l && l?.[de]?.current]), (0, s.useMemo)(() => u && !g.length ? null : (h.current.forEach(e => {
            ...
            children: [(0, r.jsx)(Ba, {
              t: e
            }), i.filter((e, t) => t).map((e, t) => (0, r.jsx)(Ga, {
              accessiblePlateRefs: h,
              plate: e,
              index: t,
              details: g[t],
              tabIndex: n === ze.LIST_PLATES ? 0 : -1,
              texture: m[t + 1]?.image
            }, e.plateText + e.vehicles.toString()))]
          })), [g, n])
        },
        qa = JSON.parse('{"de-DE":{"lpe_sidebar_total_owned_plates":"Nummernschilder in Besitz: {total} von {max}"},"en-US":{"lpe_sidebar_total_owned_plates":"{total} owned plates out of a maximum of {max}"},"es-ES":{"lpe_sidebar_total_owned_plates":"Matrículas en propiedad: {total} de {max}"},"es-MX":{"lpe_sidebar_total_owned_plates":"Tienes {total} placas de un máximo de {max}."},"fr-FR":{"lpe_sidebar_total_owned_plates":"{total} plaques possédées sur un maximum de {max}"},"it-IT":{"lpe_sidebar_total_owned_plates":"Targhe possedute: {total}/{max}"},"ja-JP":{"lpe_sidebar_total_owned_plates":"最大{max}枚のうち{total}枚のプレートを所有"},"ko-KR":{"lpe_sidebar_total_owned_plates":"최대 {max}개의 번호판 중 {total}개 소유"},"pl-PL":{"lpe_sidebar_total_owned_plates":"Liczba posiadanych tablic: {total} z {max}"},"pt-BR":{"lpe_sidebar_total_owned_plates":"Tem {total} placas de um máximo de {max}"},"ru-RU":{"lpe_sidebar_total_owned_plates":"Количество номерных знаков, которыми вы владеете: {total} из {max}"},"zh-CN":{"lpe_sidebar_total_owned_plates":"已拥有 {total} 张车牌（最多 {max} 张）"},"zh-TW":{"lpe_sidebar_total_owned_plates":"擁有 {total} 個車牌（最多 {max} 個）"}}'),
        Za = (Ja = (0, n.withIntl)((0, g.withTranslations)(({
          t: e
        }) => {
          const t = Nt(),
            {
          ...
          } = (0, p.useRockstarUserState)(), B = (0, g.useRockstarTokenPing)(), G = (0, s.useRef)(null), q = (0, s.useRef)(null), Z = (0, s.useRef)(null), [J, K] = (0, s.useState)(null), [Q] = (0, l.useSearchParams)(), [ee, te] = (0, s.useState)(!1);
          return (0, s.useEffect)(() => {
            try {
            ...
            (0, f.U4)(!1), h(ze.LIST_PLATES), R(null)
          }, []), (0, s.useEffect)(() => {
            I(X, G)
          }, [G.current]), (0, s.useEffect)(() => {
            q?.current && (0, f.U4)(!0), I(le, q)
          }, [q.current]), (0, s.useEffect)(() => {
            I(re, Z)
          }, [Z.current]), (0, s.useEffect)(() => {
            if (!ee || "webgl" === M || "browser" === M) return;
            v(null), b(F), h(ze.LIST_PLATES), T(We.style?.id), E(null), y(null);
            const e = (H ? [] : [We]).map((e, t) => ({
              ...e,
              index: t
            }));
            null !== H && (S(e), !1 === H && k(!1)), j([]), U?.accountSynced && (async () => {
              try {
                H && k(!0);
                const e = v();
                ...
                O(s?.xmas23PlatesAllowed);
                const n = s?.plates?.map(e => {
                    const t = N(e?.vehicles?.[0]?.plateStyle ?? "YellowBlack") ?? N("YellowBlack");
                    return {
                      ...e,
                      style: t
                    }
                ...
                p = p.map((e, t) => ({
                  ...e,
                  index: t
                })), m ? (E(d), T(We.style.id)) : E(null), P(We.plateText), k(!1), S(p)
              } catch (e) {
                v(["api", e]), k(!1)
              }
            })()
            ...
            if (A(z, L)) {
              const e = N(z.plateStyle);
              "number" == typeof e?.id && T(e.id), L[0].plateText || P(z.plateText)
            }
          }, [z]), (0, s.useEffect)(() => {
            if (J || !fe || M || !ee) return;
          ...
          }, [J, fe, M, ee]), (0, s.useEffect)(() => {
            const e = Y !== ze.LIST_PLATES && !$;
            x(e)
          }, [Y, $]), null != J && ee && void 0 !== H ? M ? (0, r.jsx)(Ya, {
            t: e
          }) : (0, r.jsxs)("div", {
            ref: q,
