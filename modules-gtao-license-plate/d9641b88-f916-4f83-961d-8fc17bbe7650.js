try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "d9641b88-f916-4f83-961d-8fc17bbe7650", e._sentryDebugIdIdentifier = "sentry-dbid-d9641b88-f916-4f83-961d-8fc17bbe7650")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [9830], {
    9830(e, t, a) {
      ...
      function f(e, t, a, n, r, o) {
        if ("string" == typeof e && (e = document.getElementById(e)), e && ("HTMLImageElement" !== Object.prototype.toString.call(e).slice(8, -1) || "naturalWidth" in e)) {
          var f = r ? "offset" : "natural",
            i = e[f + "Width"],
            d = e[f + "Height"];
          if ("ImageBitmap" === Object.prototype.toString.call(e).slice(8, -1) && (i = e.width, d = e.height), "string" == typeof t && (t = document.getElementById(t)), t && "getContext" in t) {
            o || (t.style.width = i + "px", t.style.height = d + "px"), t.width = i, t.height = d;
            var g = t.getContext("2d");
            g.clearRect(0, 0, i, d), g.drawImage(e, 0, 0, e.naturalWidth, e.naturalHeight, 0, 0, i, d), isNaN(a) || a < 1 || (n ? l(t, 0, 0, i, d, a) : s(t, 0, 0, i, d, a))
          }
        }
      }
      ...
      function d(e, t, a, n, f, i) {
        for (var l, d = e.data, s = 2 * i + 1, g = n - 1, u = f - 1, c = i + 1, y = c * (c + 1) / 2, p = new b, v = p, h = 1; h < s; h++) v = v.next = new b, h === c && (l = v);
        v.next = p;
        ...
        for (var oe = 0; oe < n; oe++) {
          var fe = d[_ = oe << 2],
            ...
            ve = y * de;
          v = p;
          for (var he = 0; he < c; he++) v.r = fe, v.g = ie, v.b = le, v.a = de, v = v.next;
          for (var me = n, we = 0, xe = 0, _e = 0, Ee = 0, Ie = 1; Ie <= i; Ie++) {
            _ = me + oe << 2;
            var ke = c - Ie;
            ce += (v.r = fe = d[_]) * ke, ye += (v.g = ie = d[_ + 1]) * ke, pe += (v.b = le = d[_ + 2]) * ke, ve += (v.a = de = d[_ + 3]) * ke, Ee += fe, we += ie, xe += le, _e += de, v = v.next, Ie < u && (me += n)
          }
          _ = oe, m = p, w = l;
          for (var Ce = 0; Ce < f; Ce++) {
            var Be = _ << 2;
            d[Be + 3] = de = ve * E >>> I, de > 0 ? (de = 255 / de, d[Be] = (ce * E >>> I) * de, d[Be + 1] = (ye * E >>> I) * de, d[Be + 2] = (pe * E >>> I) * de) : d[Be] = d[Be + 1] = d[Be + 2] = 0, ce -= se, ye -= ge, pe -= be, ve -= ue, se -= m.r, ge -= m.g, be -= m.b, ue -= m.a, Be = oe + ((Be = Ce + c) < u ? Be : u) * n << 2, ce += Ee += m.r = d[Be], ye += we += m.g = d[Be + 1], pe += xe += m.b = d[Be + 2], ve += _e += m.a = d[Be + 3], m = m.next, se += fe = w.r, ge += ie = w.g, be += le = w.b, ue += de = w.a, Ee -= fe, we -= ie, xe -= le, _e -= de, w = w.next, _ += n
          }
        }
        return e
      }
      ...
      function g(e, t, a, n, f, i) {
        ...
        for (var m, w, x = null, _ = null, E = r[i], I = o[i], k = 0, C = 0, B = 0; B < f; B++) {
          ...
          x = p, _ = l;
          for (var q = 0; q < n; q++) d[C] = G * E >>> I, d[C + 1] = j * E >>> I, d[C + 2] = A * E >>> I, G -= M, j -= N, A -= R, M -= x.r, N -= x.g, R -= x.b, m = k + ((m = q + i + 1) < g ? m : g) << 2, G += O += x.r = d[m], j += W += x.g = d[m + 1], A += L += x.b = d[m + 2], x = x.next, M += S = _.r, N += T = _.g, R += D = _.b, O -= S, W -= T, L -= D, _ = _.next, C += 4;
          k += n
        }
        for (var z = 0; z < n; z++) {
          var F = d[C = z << 2],
          ...
          for (var ee = 0, te = 0, ae = 0, ne = 1, re = n; ne <= i; ne++) C = re + z << 2, V += (v.r = F = d[C]) * (w = c - ne), X += (v.g = J = d[C + 1]) * w, Z += (v.b = K = d[C + 2]) * w, ee += F, te += J, ae += K, v = v.next, ne < u && (re += n);
          C = z, x = p, _ = l;
          for (var oe = 0; oe < f; oe++) d[m = C << 2] = V * E >>> I, d[m + 1] = X * E >>> I, d[m + 2] = Z * E >>> I, V -= P, X -= Q, Z -= U, P -= x.r, Q -= x.g, U -= x.b, m = z + ((m = oe + c) < u ? m : u) * n << 2, V += ee += x.r = d[m], X += te += x.g = d[m + 1], Z += ae += x.b = d[m + 2], x = x.next, P += F = _.r, Q += J = _.g, U += K = _.b, ee -= F, te -= J, ae -= K, _ = _.next, C += n
        }
        return e
      }
      var b = function e() {
