! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "cead9392-f42f-4ce0-af9b-649132e5a35d", e._sentryDebugIdIdentifier = "sentry-dbid-cead9392-f42f-4ce0-af9b-649132e5a35d")
  } catch (e) {}
}();
  ...
  [852], {
    65596: (e, a, t) => {
      ...
      const p = (0, o.withIntl)((e => {
        ...
        if ("aria-label" in v && v["aria-label"] && (h = "_blank" === b ? `${v["aria-label"]} ${f.formatMessage(d.aria_label_open_new_window)}` : v["aria-label"]), (0, c.useEffect)((() => {
      ...
      const v = {
        ...
        j = e => {
          ...
          }), [i, n] = (0, c.useState)(), [r, o] = (0, c.useState)(), [l, d] = (0, c.useState)(), [m, g] = (0, c.useState)(!1), [p, f] = (0, c.useState)(!1), [_, j] = (0, c.useState)(new HTMLAudioElement), [N, w] = (0, c.useState)({
            current: 0,
            duration: 0
          }), [S, C] = (0, c.useState)(!0);
          return (0, c.useEffect)((() => {
            const e = "audio",
              a = a => {
                a?.data?.rockstarAudioPlayerPlayTrackId && (o(a.data.rockstarAudioPlayerPlayTrackId), C(!1), f(!0)), p && a?.data?.attentionBlurredElsewhere && a?.data?.from !== e && f(!1)
              };
      ...
      const V = {
        ...
        D = e => {
          ...
          const [g, p] = (0, c.useState)(0), f = (0, c.useMemo)((() => a && Array.isArray(a) ? a.map((() => (0, P.c)())) : null), [a]);
          ...
          return (0, u.jsxs)("div", {
            ...
            }), (o?.title || o?.description) && (0, u.jsx)(we, {
              item: o
            })]
          })
        };
      ...
      const F = (0, t(62748).U1)(),
        ...
        H = (0, O.withTranslations)((e => {
          ...
          return c.Children.map(c.Children.toArray(a), (e => (0, u.jsx)(G, {
            ...e?.props
          })))
        }));
      var W = t(37960),
      ...
      const de = e => {
        ...
        me = e => {
          ...
          const {
            track: h
          } = (0, R.useGtmTrack)(), x = (0, O.useDataLayer)(), y = i ?? a, j = (0, O.findPlatform)(f)?.friendlyName, N = (0, c.useMemo)((() => {
          ...
          return (0, u.jsx)(m.Link, {
            ...
            className: le()(ce.cta, "platform" === n && f ? ce[f] : "", k ? ce.disabled : "", v),
            style: s,
            "data-variant": n,
            "data-size": r,
            onClick: w,
      ...
      const be = {
        ...
        he = e => {
          ...
          const [m, g] = (0, c.useState)(null), p = t ? t.split("_#_") : a;
          return (0, c.useEffect)((() => {
            g(a)
            ...
            style: (0, O.safeStyles)(i),
            className: (0, T.classList)(be.itemList, be.custom, o ? be.noImg : "", s ? be[s] : "", r ? be[r] : "", n ?? ""),
        ...
        je = "rockstargames-modules-gtao-license-platefa6885b15a718acb24f48949c52e31f1",
        Ne = e => {
          let {
            to: a,
            children: t
      ...
      const Ae = e => {
          ...
          return (0, u.jsx)("div", {
            id: d,
            className: (0, Ve.classList)("rockstargames-modules-gtao-license-platef42b4606ed4a5b16b7647ad7b7eb229d", o ? "rockstargames-modules-gtao-license-plateb00444166ce6346d7ca364a75a335ecc" : "", l),
      ...
      const Re = {
        ...
        Xe = e => {
          ...
          const [p, f] = (0, c.useState)(!1), {
            track: _
          } = (0, R.useGtmTrack)(), k = (0, c.useRef)(null), b = (0, c.useRef)(p);
          (0, c.useEffect)((() => {
            b.current = p
          }), [p]), (0, c.useEffect)((() => {
            const e = e => {
          ...
          return (0, u.jsxs)("div", {
            className: (0, T.classList)(We.container, n),
            children: [(0, u.jsx)(Oe.q.div, {
              ...
              "data-variant": a,
              className: le()(p ? We.expandedButton : We.unexpandedButton),
              animate: p ? "open" : "closed",
              variants: He,
              initial: !1,
              ref: k,
              children: [(0, u.jsx)(Oe.q.button, {
                className: le()(We.buttonText, i),
                "aria-expanded": p,
                disabled: p,
                ...!p && {
                  onClick: () => {
      ...
      const sa = function(e) {
        ...
        na = sa((e => {
          ...
          let O = !1;
          O = !0;
          const [F, U] = (0, c.useState)(0), [G, H] = (0, c.useState)(0);
          (0, c.useEffect)((() => {
            const e = () => {
            ...
            const e = () => {
              S && !(0, ea.isEmpty)(S) && S?.height > 0 && S?.height !== F && U(S?.height)
            };
            return e(), window.addEventListener("resize", e), () => {
              window.removeEventListener("resize", e)
            }
      ...
      const _a = (0, o.defineMessages)({
        ...
        ba = (0, o.withIntl)((e => {
          ...
          const i = (0, m.useLocation)(),
            ...
            _ = (0, c.useCallback)((e => {
              let a = i.pathname;
              const t = a.split("/");
              return o.locales.map((e => e.subdomaincom)).includes(t[0]) && (a = t.slice(1).join("/")), f.currentSite?.site === fa.U.www ? "en" === e ? `${window.location.origin}${a}${i.search}` : `${window.location.origin}/${e}${a}${i.search}` : `${window.location.origin}${a}${i.search}`
            }), [i]),
            k = (0, c.useRef)(null),
            [b, v] = (0, c.useState)(0),
          ...
          return (0, c.useEffect)((() => {
            ...
            children: [h && "sc-menu" === a && (0, u.jsx)("div", {
              ...
              children: (0, u.jsxs)("select", {
                ...
                "aria-label": n.formatMessage(_a.language_selector_default),
          ...
          children: (0, u.jsxs)("div", {
            ...
            children: [e?.images?.map(((e, a) => {
              ...
              return (0, u.jsx)(fe, {
                ...
                imageStyle: d,
                className: (0, T.classList)(l, g, va.imageLayer, va[s], va[i], va[n], va[r], va[c]),
                alt: m
              }, o ?? a + 1)
        ...
        wa = e => {
          ...
          return (0, u.jsxs)("div", {
            ...
            children: [!l && (0, u.jsx)("img", {
              className: [t, Na.animatePlaceholder].join(" "),
              src: "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTkyMCIgaGVpZ2h0PSIxMDgwIiB2aWV3Qm94PSIwIDAgMTkyMCAxMDgwIiBmaWxsPSJub25lIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPgo8cmVjdCB3aWR0aD0iMTkyMCIgaGVpZ2h0PSIxMDgwIiBmaWxsPSIjMzMzMzMzIi8+Cjwvc3ZnPgo=",
              sizes: "(max-width: 1024px) 100vw, 1024px",
              alt: "Loading...",
              style: i
            }), (0, u.jsx)("img", {
              className: [Na.multiSourceImage, t].join(" "),
      ...
      const Va = (0, O.withTranslations)((e => {
          ...
          const {
            ...
            tagId: l = null
          } = (0, m.useParams)(), [d, g] = (0, c.useState)(l ?? s ?? o.get("tag_id")), [p, f] = (0, c.useState)(1), [_, b] = (0, c.useState)([]), [v, h] = (0, c.useState)(null), {
            data: x
          } = (0, k.useQuery)(Pa(), {
            variables: {
              tagId: Number(d),
        ...
        Oa = (0, O.withGtmTracking)((e => {
          ...
          return (0, c.useEffect)((() => {
            ...
            className: [Da.newswireBlocks, t ? Da.noSpecialOrder : "", Da.contextHome].join(" "),
        ...
        Ua = e => {
          ...
          return (0, c.useEffect)((() => {
            ...
            children: (0, u.jsx)("ol", {
              style: (0, O.safeStyles)(i),
              className: (0, T.classList)(Ra.itemList, Ra.noImg, Ra[s], Ra[r]),
            ...
            style: (0, O.safeStyles)(i),
            className: (0, T.classList)(Ra.itemList, Ra.custom, o ? Ra.noImg : "", s ? Ra[s] : "", r ? Ra[r] : "", n ?? ""),
      ...
      const Wa = (e, a) => {
        ...
        Za = e => {
          ...
          return (0, O.usePreloadImg)(N, (() => v(!0))), (0, u.jsx)(m.NavLink, {
      ...
      const nt = e => c.createElement("svg", it({
        xmlns: "http://www.w3.org/2000/svg",
        width: 24,
        height: 24,
        fill: "none"
      ...
      const ot = e => c.createElement("svg", ct({
          xmlns: "http://www.w3.org/2000/svg",
          width: 24,
          height: 24,
          fill: "none"
        }, e), rt || (rt = c.createElement("path", {
          stroke: "#fff",
          strokeLinecap: "round",
          strokeLinejoin: "round",
          strokeWidth: 2,
        ...
        dt = e => {
          ...
          return (0, u.jsxs)("button", {
            ...
            ...s,
            children: ["left" === a && (0, u.jsx)(nt, {}), "right" === a && (0, u.jsx)(ot, {})]
          })
        },
        ...
        ut = e => {
          ...
          const l = (0, o.useIntl)(),
            ...
            p = (0, c.useMemo)((() => Math.max(a.findIndex((e => e.name === t)), 0)), [a, g]),
            [f, _] = (0, c.useState)(p),
            [k, b] = (0, c.useState)(!1),
            [v, h] = (0, c.useState)(!1),
            [x, y] = (0, c.useState)(!1),
      ...
      const vt = e => {
        ...
        jt = "rockstargames-modules-gtao-license-platec4aa8e5d29b433c400796d0c493a9a4d",
        Nt = e => {
          let {
            minOffset: a = 0,
            maxOffset: t = 0,
      ...
      const Lt = (0, k.makeVarNamespace)("@rockstargames/components/profile-switcher"),
        ...
        Ft = () => {
          const e = (0, k.useReactiveVar)(Et),
            ...
            s = (0, k.useReactiveVar)($t),
            i = (0, k.useReactiveVar)(Ot);
          return (0, c.useEffect)((() => {
            i || (e && zt(!1), s && (Dt(!1), Pt(-1)))
          }), [i]), (0, c.useEffect)((() => {
            !e && i && (s || Dt(!0))
          }), [e, i]), (0, c.useMemo)((() => ({
            ...
            subNavExtraHeight: t,
            setSubNavExtraHeight: At,
            scNavOpened: s,
            setScNavOpened: Dt,
            charListHidden: i,
            setCharListHidden: Rt
          })), [e, a, t, s, i])
        };
      var Ut = t(69760),
        Gt = t.n(Ut),
      ...
      const Wt = {
        ...
        Xt = e => {
          ...
          const {
            track: f
          } = (0, R.useGtmTrack)(), _ = (0, fa.c)(), k = (0, o.useIntl)();
          let b = s;
        ...
        Kt = e => {
          ...
          return (0, c.useEffect)((() => {
            ...
            children: [(0, u.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), v(r), m === a ? (g(-1), p(0)) : (g(a), p(y + N + N))
              },
              children: [(0, u.jsx)("span", {
              ...
              children: d.map((e => (0, c.createElement)(Xt, {
                ...e,
                isSubLink: !0,
                key: e.text,
                tabIndex: S || !h ? -1 : 0
        ...
        Qt = e => {
          ...
          const {
            ...
            navOpen: _
          } = (0, R.useRockstarUserState)(), k = (0, O.useLocale)(), b = (0, O.toScLocaleString)(k), [v, h] = (0, c.useState)(""), x = (0, m.useLocation)(), y = `${a.login}?returnUrl=${v}&lang=${b}`, j = `${a.signup}&returnUrl=${v}&lang=${b}`, N = (0, c.useMemo)((() => (0, fa.c)()), []), w = (0, c.useMemo)((() => {
            const e = ((e, a, t) => [{
          ...
          return (0, c.useEffect)((() => {
            ...
            children: [(0, u.jsx)("nav", {
              ...
              children: (0, u.jsx)("div", {
                ...
                children: w.map((e => (0, c.createElement)(Kt, {
                  ...e,
                  activeSubNavId: l,
                  setActiveSubNavId: d,
                  setSubNavExtraHeight: p,
        ...
        Jt = e => {
          ...
          const {
            ...
            track: n
          } = (0, R.useGtmTrack)(), r = (0, o.useIntl)(), [l, d] = (0, c.useState)([]), [m, g] = (0, c.useState)(null), [p, f] = (0, c.useState)(null), [_, k] = (0, c.useState)(!1), [b, v] = (0, c.useState)(-1), [h, x] = (0, c.useState)([]), [y, j] = (0, c.useState)(0), N = t(71084), [w, S] = (0, c.useState)("0"), [C, T] = (0, c.useState)("0"), I = e => parseInt(e, 10).toLocaleString("en-US", {
        ...
        ss = (0, O.withTranslations)((e => {
          ...
          const {
            ...
            scNavOpened: N,
            setScNavOpened: w
          } = Ft(), [S, C] = (0, c.useState)(""), T = (0, m.useLocation)(), {
            lsSettings: I
            ...
            setSelectedCharacterTuple: F,
            setUserData: U
          } = (0, R.useRockstarUserState)(), [G, H] = (0, c.useState)(null), [W, q] = (0, c.useState)(null), [X, K] = (0, c.useState)(!1), [Q, Y] = (0, c.useState)(!1), [Z, J] = (0, c.useState)(0), ee = (0, c.createRef)(), ae = es(ee, !1), te = (0, c.createRef)(), [se, ie] = (0, c.useState)(0), [ne, re] = (0, c.useState)([]), [ce, oe] = (0, c.useState)(244), le = (0, c.useRef)(null), de = (0, c.useMemo)((() => (0, fa.c)()), []), me = (0, c.useMemo)((() => ((e, a, t, s, i) => [{
          ...
          return (0, c.useEffect)((() => {
            ...
            children: [null !== G && "gtao" === B && (0, u.jsxs)("div", {
              ...
              children: [(0, u.jsx)(Jt, {
                ...
                children: [(0, u.jsx)("button", {
                  ...
                  children: (0, u.jsx)(as, {
                    ...
                    disablePager: Q,
                    disableSwiper: Q,
                    children: ne.filter(((e, a) => a !== P)).map((e => (0, c.createElement)(Yt, {
                      characterData: e,
                      setMobileCardWidth: oe,
                      key: e.mugshotUrl,
                      tabIndex: t ? -1 : 0
              ...
              children: [(0, u.jsx)("button", {
                ...
                children: me.map(((e, a) => (0, c.createElement)(Kt, {
                  ...e,
                  id: a,
                  activeSubNavId: h,
                  setActiveSubNavId: x,
        ...
        os = (0, o.withIntl)((e => {
          ...
          return (0, c.useEffect)((() => {
            const e = s?.id ?? !1,
              a = e ? (h?.[n]?.mugshotUrl ?? s?.avatar) || rs : cs,
              t = wt(h?.[n]?.platform, "small") ?? null;
            k(t), g(a), f(e), v(!!h?.[n]?.mugshotUrl)
          }), [s, h, n, rs, cs]), (0, u.jsxs)("button", {
      ...
      const ps = sa((0, o.withIntl)((e => {
        ...
        _s = e => {
          ...
          return (0, u.jsx)("div", {
            className: [fs.responsiveFlexBox, void 0 !== t ? t : ""].join(" "),
            style: s,
            children: a
          })
        },
        ...
        bs = e => {
          ...
          return (0, u.jsx)("div", {
            className: [ks.responsiveFlexItem, void 0 !== t ? t : ""].join(" "),
            style: s,
            children: a
          })
        },
        ...
        ys = e => {
          ...
          return (0, u.jsx)("div", {
            className: [xs.responsiveGridItem, void 0 !== t ? t : ""].join(" "),
            style: s,
            children: a
          })
        },
        ...
        Ss = e => {
          ...
          return (0, u.jsx)("section", {
            className: [ws.responsiveSection, void 0 !== t ? t : ""].join(" "),
            style: s,
      ...
      const Ls = Ms,
        ...
        Bs = e => {
          ...
          return a ? (0, u.jsx)("div", {
            className: [zs.skeleton, zs[a]].join(" ")
          }) : null
        },
          ...
          return (0, u.jsxs)("div", {
            ...
            children: [(0, u.jsx)("h4", {
              ...
              children: (0, u.jsx)("div", {
                ...
                children: c.Children.map(c.Children.toArray(a), (e => (0, u.jsx)(As, {
                  ...e?.props
                })))
              })
            })]
        ...
        Ds = "rockstargames-modules-gtao-license-plateeca98eb0b5b84a0c9a2e6d952545a2d5",
        Os = "rockstargames-modules-gtao-license-plated3d0b4ecd3bddba96c73f49fcca34ed8",
        Rs = {
          0: {
            spaceBetween: 8
          },
        ...
        Fs = e => {
          ...
          const {
            track: l
          } = (0, R.useGtmTrack)(), [d, m] = (0, c.useState)([Je.O4, Je.Hj, Je.eM]), [g, p] = (0, c.useState)(null), [f, _] = (0, c.useState)(null);
          return (0, c.useEffect)((() => {
      ...
      const Xs = {
        ...
        Ks = e => {
          ...
          const {
            ...
            skip: !0
          }), [l] = (0, k.useMutation)(qs.UserCastVote), [d, m] = (0, c.useState)(null), g = (0, c.useCallback)((async e => {
            n({
        ...
        Ys = (0, O.withLocale)((e => {
          ...
          return (0, c.useEffect)((() => {
            ...
            const a = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
              ...
              c = e => {
                d(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !g.current?.classList.contains(Qs.dragging) || a() && n(!0)
              },
              l = () => {
                a() && n(!1), d(0)
              },
              ...
              p = () => {
                a() && n(!1), m.current && m.current.classList.remove(`${Qs.disableClick}`)
              },
              f = () => {
                a() && n(!1)
              };
            return g.current.addEventListener("transitionend", f), e.on("swiperight", t), e.on("swipeleft", i), e.on("pan", c), e.on("panend", l), e.on("press tap", u), e.on("pressup", p), () => {
              e.off("swiperight", t), e.off("swipeleft", i), e.off("pan", c), e.off("panend", l), e.off("press tap", u), e.off("pressup", p), g.current && g.current.removeEventListener("transitionend", f), d(0)
            }
      ...
      const ei = e => {
          ...
          return (0, u.jsx)("div", {
            role: "img",
            "aria-label": i,
            className: [Js.img, l ? Js.startAnimation : "", a ? Js.wide : ""].join(" "),
            style: {
        ...
        ti = e => {
          ...
          return (0, u.jsx)(p, {
            ...
            to: r,
            target: "_self",
            className: [ai.fobLink, c ? ai.wide : ""].join(" "),
            children: (0, u.jsx)(ei, {
              title: a.title,
              titleSlug: i,
              isWideCard: c
          ...
          return h = "games" === l ? (0, u.jsx)(u.Fragment, {
            ...
            children: [(0, u.jsxs)("h3", {
              ...
              children: [s, (0, u.jsxs)("div", {
                ...
                children: [(0, u.jsx)("button", {
                  className: [si.arrow, si.previous].join(" "),
                  type: "button",
                  ref: k,
                  "aria-label": n.formatMessage(Zs.previous_button_label)
                }), (0, u.jsx)("button", {
                  className: [si.arrow, si.next].join(" "),
                  type: "button",
                  ref: b,
              ...
              className: [si.items, f % 1 != 0 ? si.partial : ""].join(" "),
              children: (0, u.jsx)("div", {
