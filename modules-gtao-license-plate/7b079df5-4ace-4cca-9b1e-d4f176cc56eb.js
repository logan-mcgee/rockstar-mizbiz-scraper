! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "7b079df5-4ace-4cca-9b1e-d4f176cc56eb", e._sentryDebugIdIdentifier = "sentry-dbid-7b079df5-4ace-4cca-9b1e-d4f176cc56eb")
  } catch (e) {}
}();
  ...
  [9735], {
    25922: (e, a, t) => {
      ...
      const f = u((e => {
        ...
        const {
          track: h
        } = (0, o.useGtmTrack)(), b = (0, n.useIntl)(), [k] = (0, n.getLocale)(), [v, x] = (0, s.useState)(!1), C = (0, s.useRef)(null), [S, M] = (0, s.useState)(0), N = "ontouchstart" in window || navigator?.maxTouchPoints > 0 || navigator?.msMaxTouchPoints > 0, w = e => {
          if (g && g(!1), k.subdomaincom === e || "none" === e) return void(g && g(!1));
        ...
        return (0, s.useEffect)((() => {
          ...
          children: [N && "sc-menu" === a && (0, m.jsx)("div", {
            ...
            children: (0, m.jsx)("div", {
              ...
              children: (0, m.jsxs)("select", {
                ...
                children: [(0, m.jsx)("option", {
                  ...
                  value: "none",
                  children: (0, m.jsx)(n.FormattedMessage, {
          ...
          }), (!N || "sc-menu" !== a) && "footer" !== a && (0, m.jsxs)("div", {
            className: [d.languageSelector, v ? d.open : ""].join(" "),
            "data-theme": a,
            "data-testid": `${f||a}-language-selector`,
            ..._,
            children: [(0, m.jsxs)("button", {
              onClick: e => {
                e.stopPropagation(), g && g(!v), x(!v)
              },
              type: "button",
              "aria-label": b.formatMessage(i.language_selector_default),
              children: [(0, m.jsx)("i", {}), (0, m.jsx)("span", {
                children: n.locales.find((e => e.subdomaincom === k.subdomaincom))?.label ?? (0, m.jsx)(n.FormattedMessage, {
                  ...i.language_selector_default
                })
              })]
            }), (0, m.jsx)("div", {
                ...
                children: n.locales.map((e => {
                  ...
                  return (0, m.jsx)(s.Fragment, {
                    children: (0, m.jsx)(r.A, {
                      ...
                      tabIndex: v ? 0 : -1,
                      "data-testid": `${f||a}-language-selector-${t}`,
                      children: c
                    })
                  }, c)
                }))
            ...
            children: [(0, m.jsx)(l.Globe, {
              ...
              hideLabel: !0,
              placeholder: n.locales.find((e => e.subdomaincom === k.subdomaincom))?.label ?? b.formatMessage(i.language_selector_default),
              onValueChange: e => {
                w(e)
              },
              children: n.locales.map((e => {
      ...
      const T = {
        ...
        R = e => {
          ...
          return (0, m.jsx)("a", {
            ...
            className: s,
            onClick: e => {
              l?.(e), i || n || (c ? (e.preventDefault(), c(a)) : (e.preventDefault(), window.history.pushState({}, "", a)))
            },
            target: t,
            ...o,
            children: r
        ...
        H = e => {
          ...
          const {
            track: _
          } = (0, o.useGtmTrack)(), h = (0, L.A)(), b = (0, n.useIntl)();
          let k = s;
        ...
        O = e => {
          ...
          const {
            ...
            navOpen: S
          } = (0, o.useRockstarUserState)(), M = (0, s.useRef)(null), [N, w] = (0, s.useState)(0), [y, j] = (0, s.useState)(0), [I, E] = (0, s.useState)(!0);
          return (0, s.useEffect)((() => {
            u !== a && !1 === I && E(!0), u === a && E(!1)
          }), [u]), (0, s.useEffect)((() => {
            if (!M.current) return;
            w(M?.current?.scrollHeight);
          ...
          }), [M, v, x]), g.length > 0 ? (0, m.jsxs)(m.Fragment, {
            children: [(0, m.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), C(r), u === a ? (f(-1), p(0)) : (f(a), p(N + y + y))
              },
              children: [(0, m.jsx)("span", {
              ...
              children: g.map((e => (0, s.createElement)(H, {
                ...e,
                isSubLink: !0,
                key: e.text,
                tabIndex: I || !S ? -1 : 0,
        ...
        D = e => {
          ...
          const {
            windowWidth: l,
            windowHeight: r
          } = (0, _.useWindowResize)(), i = (0, n.useIntl)(), {
            ...
            navOpen: v
          } = (0, o.useRockstarUserState)(), x = (0, _.useLocale)(), C = (0, _.toScLocaleString)(x), [S, M] = (0, s.useState)(""), N = `${a.login}?returnUrl=${S}&lang=${C}`, w = `${a.signup}&returnUrl=${S}&lang=${C}`, I = (0, s.useMemo)((() => (0, L.A)()), []), T = (0, s.useMemo)((() => {
            const e = ((e, a, t) => [{
            ...
            return e
          }), [i, N, w, I]), [R, H] = (0, s.useState)(0), D = (0, s.createRef)(), $ = () => {
            if (D.current) {
              const {
                current: e
      ...
      const K = {
        ...
        ee = e => {
          ...
          const r = (0, n.useIntl)(),
            ...
            x = i === a.index;
          return (0, s.useEffect)((() => {
            u.current && c && c(u?.current?.offsetWidth)
          }), [u]), (0, m.jsxs)("button", {
        ...
        ne = e => {
          ...
          const {
            ...
            track: l
          } = (0, o.useGtmTrack)(), r = (0, n.useIntl)(), [i, d] = (0, s.useState)([]), [g, u] = (0, s.useState)(null), [f, p] = (0, s.useState)(null), [_, h] = (0, s.useState)(!1), [b, k] = (0, s.useState)(-1), [v, x] = (0, s.useState)([]), [C, S] = (0, s.useState)(0), M = t(5931), {
            platform: N
          ...
          (0, s.useEffect)((() => {
            ...
            i && i.forEach((e => {
              !0 === e.isPrimary && (u(e.crewTag), p(e.crewColour), k(e.rankOrder), h(!1), !0 === Object.prototype.hasOwnProperty.call(e, "crewType") && "rockstar" === e.crewType && h(!0))
            }))
          }), [i]), (0, s.useEffect)((() => {
            const e = [];
            if (!_ && b > -1)
          ...
          const d = (0, s.createRef)(),
            ...
            R = e => {
              ...
              c > a ? (s > 0 ? (() => {
                ...
                e < 0 && (e = 0), _(e), C(k[e]), l && l(e)
              })(), b(0)) : C(k[p] + c * s)
            },
            H = () => {
              !0 !== u && !0 !== i && (f(!0), !0 !== u && (C(k[p]), b(0)))
            };
          return (0, s.useEffect)((() => {
            const e = [];
            r.forEach((() => {
            ...
            v(r.map(((e, a) => (e => {
              let a = 0;
              const t = r.length;
              return 1 === t ? .5 * g - .5 * S - 2 * c + N : (0 === e && (a = c - e * S), e === t - 1 && t > 1 && (a = t * S * -1 + (g - (c - N))), e > 0 && e < t - 1 && (a = e * S * -1 + (.5 * g - .5 * S + .5 * N)), a)
            })(a)))), 1 === r.length ? T(!0) : T(!1)
          }), [d.current, r, g]), (0, s.useEffect)((() => {
            ...
            children: [(0, m.jsx)("div", {
              ...
              children: (0, m.jsx)("div", {
                ...
                children: r.map(((e, a) => (0, m.jsx)("div", {
        ...
        ie = e => {
          ...
          const {
            windowWidth: b,
            windowHeight: k
          } = (0, _.useWindowResize)(), v = (0, n.useIntl)(), {
            ...
            setUserData: K
          } = (0, o.useRockstarUserState)(), [q, Q] = (0, s.useState)(null), [ae, te] = (0, s.useState)(!1), [se, ce] = (0, s.useState)(!1), [le, ie] = (0, s.useState)(0), de = (0, s.createRef)(), ge = (0, $.ri)(de, !1), ue = (0, s.createRef)(), [me, fe] = (0, s.useState)(0), [pe, _e] = (0, s.useState)([]), [he, be] = (0, s.useState)(244), ke = (0, s.useRef)(null), ve = (0, s.useMemo)((() => (0, L.A)()), []), xe = (0, s.useMemo)((() => ((e, a, t, s, c) => [{
          ...
          }])(v, a, W, G, H, window)), [v, a, W, G, H, ve]), Ce = () => {
            ce(r + he * le < ge)
          }, Se = () => {
            if (ue.current) {
              const {
          ...
          return (0, s.useEffect)((() => {
            ...
            if (null !== z && !e.length) return void J(!1);
        ...
        ue = u((e => {
          ...
          const {
            windowHeight: l
          } = (0, _.useWindowResize)(), r = (0, n.useIntl)(), {
            ...
            track: I
          } = (0, o.useGtmTrack)(), [E, L] = (0, s.useState)(!1), T = (0, s.useRef)(), [P, R] = (0, s.useState)(0), H = (0, s.createRef)(), [O, $] = (0, s.useState)(!1), [U, B] = (0, s.useState)(0), [A, W] = (0, s.useState)(!1), {
            mutateWebSettings: z,
            webSettings: F
          ...
          return (0, s.useEffect)((() => {
            ...
            H.current && v(H?.current?.scrollHeight >= l)
          }), [H, l]), (0, s.useEffect)((() => {
            M || (g(-1), d(!1))
          }), [M]), (0, s.useEffect)((() => {
            i && (h || V(!0), u && (f(!1), g(-1)))
            ...
            _((() => {
              switch (r) {
                ...
                case !1:
                  return t(32810);
                case !0:
                  return k?.[d]?.mugshotUrl ?? l?.avatar
              }
            })())
          }), [l, k, d, r]), (0, m.jsxs)("button", {
            className: "rockstargames-modules-gtao-license-plateee811a1fa8b17eb47afb419dd08ffb03",
            "aria-label": c.formatMessage(g ? j.sc_menu_close : j.sc_menu_open),
            "aria-expanded": g,
            type: "button",
            onClick: x,
            "data-mugshot": h,
        ...
        pe = e => {
          ...
          return (0, s.useEffect)((() => {
            ...
            const e = W?.characters?.gtao;
            if (null !== z && !e?.length) return void v(!1);
            ...
            if (a) return N(a), C(a.mugshotUrl), S(a.platform), w.length > 1 ? E(!0) : E(!1), i(w.length - 1 > 3), () => {
              C(""), S("")
            }
          }), [h, w]), (0, s.useEffect)((() => {
            const e = A?.currentCharId ?? 0;
            e !== h && k(Math.max(0, Math.min(e, w.length - 1)))
          }), [w, A]), M && "gtao" === p ? (0, m.jsxs)("div", {
            className: fe.profile,
            ref: D,
            tabIndex: -1,
            "aria-label": g.formatMessage(j.profile_selector_profile_card),
            children: [(0, m.jsx)(ne, {
              s: fe,
              character: M
            }), !0 === I && (0, m.jsxs)("div", {
