...
_global.SENTRY_RELEASE = {
  ...
  [692], {
    8692: (e, t, n) => {
      ...
      function te(e) {
        ...
        if (h) {
          var A = X(n),
            M = "clientHeight",
            P = "clientWidth";
          A === _(n) && "static" !== N(A = U(n)).position && "absolute" === l && (M = "scrollHeight", P = "scrollWidth"), (f === r || (f === a || f === i) && c === p) && (D = o, w -= (v && A === k && k.visualViewport ? k.visualViewport.height : A[M]) - s.height, w *= d ? 1 : -1), f !== a && (f !== r && f !== o || c !== p) || (j = i, b -= (v && A === k && k.visualViewport ? k.visualViewport.width : A[P]) - s.width, b *= d ? 1 : -1)
        }
        ...
        return b = R.x, w = R.y, d ? Object.assign({}, W, ((L = {})[D] = E ? "0" : "", L[j] = O ? "0" : "", L.transform = (k.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + w + "px)" : "translate3d(" + b + "px, " + w + "px, 0)", L)) : Object.assign({}, W, ((t = {})[D] = E ? w + "px" : "", t[j] = O ? b + "px" : "", t.transform = "", t))
      }
      const ne = {
        name: "computeStyles",
        enabled: !0,
      ...
      function le(e) {
        return ["html", "body", "#document"].indexOf(A(e)) >= 0 ? e.ownerDocument.body : P(e) && ue(e) ? e : le(z(e))
      }
      ...
      const be = {
        ...
        fn: function(e) {
          ...
          if (!t.modifiersData[p]._skip) {
            for (var u = n.mainAxis, l = void 0 === u || u, d = n.altAxis, h = void 0 === d || d, g = n.fallbackPlacements, b = n.padding, y = n.boundary, w = n.rootBoundary, x = n.altBoundary, O = n.flipVariations, E = void 0 === O || O, j = n.allowedAutoPlacements, D = t.options.placement, k = R(D), A = g || (k !== D && E ? function(e) {
                if (R(e) === s) return [];
                var t = ae(e);
                return [fe(e), t, fe(t)]
              ...
              var F = ae(N),
                U = [];
              if (l && U.push(I[T] <= 0), h && U.push(I[N] <= 0, I[F] <= 0), U.every((function(e) {
                  return e
                }))) {
                B = S, W = !1;
                break
        ...
        Oe = {
          ...
          fn: function(e) {
            var t = e.state,
              ...
              u = p.x,
              l = p.y;
            null != t.modifiersData.popperOffsets && (t.modifiersData.popperOffsets.x += u, t.modifiersData.popperOffsets.y += l), t.modifiersData[o] = c
          }
        },
        Ee = {
          name: "popperOffsets",
            ...
            p = {
              ...
              setOptions: function(n) {
                ...
                u(), s.options = Object.assign({}, i, s.options, o), s.scrollParents = {
                  reference: M(e) ? de(e) : e.contextElement ? de(e.contextElement) : [],
                  popper: de(t)
                };
...
//# sourceMappingURL=74e3d3a509daa5a9117e1bba5dd00542.js.map