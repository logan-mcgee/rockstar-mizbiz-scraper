...
_global.SENTRY_RELEASE = {
  ...
  [748], {
    5748: (e, t, n) => {
      ...
      const Z = {
        ...
        fn: function(e) {
          var t, n = e.state,
            ...
            d = R(n.placement),
            l = G(d),
            h = [a, i].indexOf(d) >= 0 ? "height" : "width";
          if (p && u) {
            var m = function(e, t) {
              ...
              b = "y" === l ? r : a,
              g = "y" === l ? o : i,
              y = n.rects.reference[h] + n.rects.reference[l] - u[l] - n.rects.popper[h],
              w = u[l] - n.rects.reference[l],
              x = X(p),
      ...
      function te(e) {
        ...
        if (h) {
          var A = X(n),
            M = "clientHeight",
            P = "clientWidth";
          A === _(n) && "static" !== N(A = U(n)).position && "absolute" === d && (M = "scrollHeight", P = "scrollWidth"), (f === r || (f === a || f === i) && c === p) && (D = o, w -= (v && A === k && k.visualViewport ? k.visualViewport.height : A[M]) - s.height, w *= l ? 1 : -1), f !== a && (f !== r && f !== o || c !== p) || (j = i, g -= (v && A === k && k.visualViewport ? k.visualViewport.width : A[P]) - s.width, g *= l ? 1 : -1)
        }
        ...
        return g = R.x, w = R.y, l ? Object.assign({}, W, ((L = {})[D] = E ? "0" : "", L[j] = O ? "0" : "", L.transform = (k.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + w + "px)" : "translate3d(" + g + "px, " + w + "px, 0)", L)) : Object.assign({}, W, ((t = {})[D] = E ? w + "px" : "", t[j] = O ? g + "px" : "", t.transform = "", t))
      }
      const ne = {
        name: "computeStyles",
        enabled: !0,
      ...
      function de(e) {
        return ["html", "body", "#document"].indexOf(A(e)) >= 0 ? e.ownerDocument.body : P(e) && ue(e) ? e : de(z(e))
      }
      ...
      function le(e, t) {
        ...
        var r = de(e),
          ...
          i = _(r),
          a = o ? [i].concat(i.visualViewport || [], ue(r) ? r : []) : r,
          s = t.concat(a);
      ...
      function be(e, t) {
        ...
        var n = t,
          ...
          }(M(L) ? L : L.contextElement || U(e.elements.popper), v, g, p),
      ...
      const ge = {
        ...
        fn: function(e) {
          ...
          if (!t.modifiersData[p]._skip) {
            for (var u = n.mainAxis, d = void 0 === u || u, l = n.altAxis, h = void 0 === l || l, b = n.fallbackPlacements, g = n.padding, y = n.boundary, w = n.rootBoundary, x = n.altBoundary, O = n.flipVariations, E = void 0 === O || O, j = n.allowedAutoPlacements, D = t.options.placement, k = R(D), A = b || (k !== D && E ? function(e) {
                if (R(e) === s) return [];
                var t = ae(e);
                return [fe(e), t, fe(t)]
              ...
              var F = ae(N),
                U = [];
              if (d && U.push(I[T] <= 0), h && U.push(I[N] <= 0, I[F] <= 0), U.every((function(e) {
                  return e
                }))) {
                B = S, W = !1;
                break
        ...
        Oe = {
          ...
          fn: function(e) {
            var t = e.state,
              ...
              u = p.x,
              d = p.y;
            null != t.modifiersData.popperOffsets && (t.modifiersData.popperOffsets.x += u, t.modifiersData.popperOffsets.y += d), t.modifiersData[o] = c
          }
        },
        Ee = {
          name: "popperOffsets",
            ...
            if (A) {
              ...
              if (d) {
                var ue, de = "x" === D ? r : a,
                  ...
                  ge = he - x[le],
                  ye = -1 !== [r, a].indexOf(O),
                  we = null != (ue = null == W ? void 0 : W[k]) ? ue : 0,
                  xe = ye ? ve : he - _[me] - M[me] - we + L.altAxis,
                  Oe = ye ? he + _[me] + M[me] - we - L.altAxis : ge,
                  Ee = g && ye ? function(e, t, n) {
                    var r = J(e, t, n);
                    return r > n ? n : r
                  }(xe, he, Oe) : J(g ? xe : ve, he, g ? Oe : ge);
                A[k] = Ee, S[k] = Ee - he
              }
              t.modifiersData[s] = S
            }
      ...
      function De(e, t, n) {
        ...
        return (i || !i && !n) && (("body" !== A(t) || ue(s)) && (c = (r = t) !== _(r) && P(r) ? {
