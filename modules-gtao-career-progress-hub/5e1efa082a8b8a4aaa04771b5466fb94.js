      ...
      function te(e) {
        ...
        if (h) {
          var A = X(n),
            M = "clientHeight",
            P = "clientWidth";
          A === _(n) && "static" !== N(A = U(n)).position && "absolute" === l && (M = "scrollHeight", P = "scrollWidth"), (f === r || (f === a || f === i) && c === p) && (D = o, w -= (v && A === k && k.visualViewport ? k.visualViewport.height : A[M]) - s.height, w *= d ? 1 : -1), f !== a && (f !== r && f !== o || c !== p) || (j = i, g -= (v && A === k && k.visualViewport ? k.visualViewport.width : A[P]) - s.width, g *= d ? 1 : -1)
        }
        ...
        return g = R.x, w = R.y, d ? Object.assign({}, W, ((L = {})[D] = E ? "0" : "", L[j] = O ? "0" : "", L.transform = (k.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + w + "px)" : "translate3d(" + g + "px, " + w + "px, 0)", L)) : Object.assign({}, W, ((t = {})[D] = E ? w + "px" : "", t[j] = O ? g + "px" : "", t.transform = "", t))
      }
      const ne = {
        name: "computeStyles",
        enabled: !0,
      ...
      const ge = {
        ...
        fn: function(e) {
          ...
          if (!t.modifiersData[p]._skip) {
            for (var u = n.mainAxis, l = void 0 === u || u, d = n.altAxis, h = void 0 === d || d, b = n.fallbackPlacements, g = n.padding, y = n.boundary, w = n.rootBoundary, x = n.altBoundary, O = n.flipVariations, E = void 0 === O || O, j = n.allowedAutoPlacements, D = t.options.placement, k = R(D), A = b || (k !== D && E ? function(e) {
                if (R(e) === s) return [];
                var t = ae(e);
                return [fe(e), t, fe(t)]
...
//# sourceMappingURL=5e1efa082a8b8a4aaa04771b5466fb94.js.map