    ...
    5543: (e, a, t) => {
      ...
      const S = {
        ...
        f = e => {
          ...
          return (0, _.jsx)("div", {
            className: [s, S.check, t ? S[t] : null].join(" "),
        ...
        x = e => {
          ...
          return (0, _.jsx)("ul", {
            ...
            children: a.map(((e, r) => {
              ...
              return (0, _.jsx)("li", {
                "data-unlocked": o,
                children: o ? (0, _.jsx)(f, {
                  alt: e,
                  type: e,
                  classes: I.completed
                }) : (0, _.jsx)("div", {
                  className: [I.locked, I[e]].join(" "),
                  "aria-label": c(u.cph_awards_not_unlocked),
                  role: "img"
                })
              }, e)
            }))
        ...
        P = e => {
          ...
          return (0, _.jsx)("div", {
            ...
            role: "progressbar",
            "aria-label": c.formatMessage(u.cph_progress_bar_aria),
        ...
        y = e => {
          ...
          const p = function(e) {
              ...
              if (a.length > 1 && t.progress >= a[a.length - 1] || !a.length && t.progress >= 1) t.isComplete = !0, t.percent = 100, t.levelEnd = a.length ? a[a.length - 1] : 1, t.currentLevel = a.length ? V[a.length - 1] : t.currentLevel, t.progress = t.levelEnd;
                ...
                if (e < 0 && (e = 0), e >= 0) {
                  const o = 0 === e ? 0 : e - 1;
                  t.currentLevel = V[e], t.levelEnd = a[e], t.metalLevel = e, t.percent = (s = t.progress, r = o, c = t.levelEnd, Math.floor(100 * (s - r) / (c - r) + 0))
                }
              }
              var s, r, c;
              return t
          ...
          return (0, _.jsxs)(_.Fragment, {
            children: [(0, _.jsxs)(R, {
              ...
              className: [N.award, ...p.isComplete ? [N.completed] : [], ...t ? [N.expanded] : [], ...m ? [N.hovered] : [], ...o ? [o] : []].join(" "),
              ref: r ? W : f,
              tabIndex: 0,
              ...r && !t && {
                onClick: () => {
        ...
        M = () => {
          const {
            ...
            awardsKey: c
          } = r, [o, i] = (0, s.useState)([]), S = (0, p.useRockstarTokenPing)(), {
            loggedIn: f
          } = (0, l.useRockstarUser)(), {
            selectedCharacterTuple: b
          } = (0, l.useRockstarUserState)(), h = o ? function() {
          ...
          }(o) : 0, [k, j] = (0, s.useState)(!1), [I, x] = (0, s.useState)(!1), [A, P] = (0, s.useState)(!1), {
            setBodyIsScrollable: T
          } = (0, m.useBodyScrollable)(), {
            track: N
          } = (0, l.useGtmTrack)(), [W, C] = (0, s.useState)(12), [w, G] = (0, s.useState)(4), D = (0, s.useRef)(null), V = (0, s.useRef)(null), [M, U] = (0, s.useState)(!1), {
            inView: H
          } = (0, R.YD)({
            threshold: .6
          ...
          return (0, _.jsx)("div", {
            ...
            children: (0, _.jsxs)(te, {
              ...
              className: [z.awardsContainer, k && e ? z.modalOpen : "", k && !e ? z.expanded : "", !k && I ? z.isClosed : "", A && !e ? z.hovered : ""].join(" "),
              ref: D,
              layout: !0,
              children: [(0, _.jsxs)(E.E.div, {
                ...
                children: [(0, _.jsxs)(E.E.div, {
                  ...
                  children: [(0, _.jsxs)("h2", {
                    ...
                    children: [(0, _.jsx)("button", {
                      ...
                      "aria-label": q(u.cph_reward_ready_to_claim)
                    }), (0, _.jsx)("div", {
                      className: z.tooltip,
                      style: Q.popper,
                      ref: F,
      ...
      const ee = e => {
        ...
        te = e => {
          ...
          const [R, S] = (0, s.useState)(window.innerWidth >= 1280), [f, b] = (0, s.useState)(1), [h, k] = (0, s.useState)("auto"), {
            track: j
          } = (0, l.useGtmTrack)(), {
            setBodyIsScrollable: v
          } = (0, m.useBodyScrollable)(), [I, x] = (0, s.useState)(!1), A = (0, s.useRef)(), P = R ? Q.tq : "div", T = R ? Q.o5 : "li", O = (0, s.useRef)(null), N = (0, s.useRef)(null), W = r.some((e => e.isCompleted && e?.numClaimable > 0)), C = (0, d.Z)(), w = (0, s.useMemo)((() => {
            const e = [];
          ...
          function D() {
            if (i && j({
              ...
              if (i) A.current?.swiper.disable(), b(0), setTimeout((() => {
                A.current?.swiper.enable();
                const e = w.findIndex((e => e.id === `reward-${a}-0`));
                A.current?.swiper.slideTo(e), A.current?.swiper.disable(), x(!1), A.current?.swiper.enable(), A.current?.swiper.slideTo(0)
              }), 100), setTimeout((() => {
                p(!1), b(1)
              }), 250);
              else {
        ...
        re = () => {
          const {
            ...
            rewardsKey: r
          } = t, c = r ? b[r] : null, [o, i] = (0, s.useState)(null), g = o ? (e => {
            const a = [];
            return e.forEach((e => {
              const {
                challenges: t,
          ...
          })(o.tiers) : null, [S, f] = (0, s.useState)(0), [h, k] = (0, s.useState)(!1), {
            ref: j,
            inView: I
          } = (0, R.YD)({
            threshold: .6
          }), x = (0, p.useRockstarTokenPing)(), {
            loggedIn: A
          } = (0, l.useRockstarUser)(), {
              ...
              children: [(0, _.jsx)("div", {
                ...
                children: (0, _.jsx)("ul", {
                  children: g && g.map(((e, a) => (0, _.jsx)("li", {
                    children: (0, _.jsx)("button", {
                      type: "button",
                      className: [se.tier, S === a ? se.active : ""].join(" "),
                      onClick: () => {
                        ! function(e) {
                          f(e)
                        }(a), O({
      ...
      const ne = ["1"],
        ...
        _e = e => {
          ...
          const c = (0, d.Z)(),
            o = r ? u.cph_nav_close : u.cph_nav_open,
            i = (0, s.useContext)(Ae);
          return (0, _.jsx)("div", {
        ...
        ge = e => {
          ...
          const c = `${s}?im=Resize,height=420`,
            [o] = (0, m.usePreloadImg)(c);
          return (0, _.jsx)(ce.NavLink, {
            className: pe.navCard,
            to: t,
            onClick: r,
            children: (0, _.jsx)("div", {
              className: [pe.navCardImageBox, o ? pe.navCardImageLoaded : ""].join(" "),
              style: {
      ...
      const fe = e => s.createElement("svg", Se({
        xmlns: "http://www.w3.org/2000/svg",
        width: 24,
        height: 24,
        fill: "none"
      ...
      const he = e => s.createElement("svg", ue({
        ...
        je = e => {
          ...
          return (0, _.jsxs)("button", {
            ...
            ...s,
            children: ["left" === a && (0, _.jsx)(fe, {}), "right" === a && (0, _.jsx)(he, {})]
          })
        },
        ve = {
          initial: {
          ...
          return (0, s.useEffect)((() => {
            ...
            children: (0, _.jsxs)("div", {
              ...
              children: [(0, _.jsxs)("div", {
                ...
                className: [Re.navMenuScroll, o ? Re.headerVisible : ""].join(" "),
                children: (0, _.jsx)("div", {
                    ...
                    return (0, _.jsx)(ge, {
                      ...
                      onClick: () => ((e, a) => {
                        v({
                          ...
                          event_action: "click",
                          event_category: "nav",
                          event_label: `Secondary Nav > ${I} > ${A.title} > ${e}`,
                          text: `Secondary Nav > ${I} > ${A.title} > ${e}`,
                          link_url: a,
                          element_placement: "Secondary Nav"
                        }), r()
                      })(a, t)
        ...
        Te = e => {
          ...
          const {
            pathname: t
          } = (0, ce.useLocation)(), r = (0, ce.useParams)(), {
            data: c,
            loading: o
          } = (() => {
            ...
            state: n
          } = (0, m.useRockstarLocalState)(), [d, g] = (0, s.useState)(!1), [R, S] = (0, s.useState)(!1), [f, b] = (0, s.useState)(!1), {
            pageYOffset: u
          } = (0, m.useScroll)(), {
            track: h
          } = (0, l.useGtmTrack)(), k = (0, s.useContext)(Ae), j = !n.navHidden, v = !o && c?.length > 0, I = (0, s.useMemo)((() => r["*"]?.slice(0, r["*"].indexOf("/"))), [c, t]), x = (0, s.useMemo)((() => {
            if (!v) return null;
            const e = c.find((e => e.name === I))?.subNavItems?.find((e => e.name.toLowerCase() === r.section)),
              a = e?.imageUrl;
          ...
          }), [d, R]), v ? (0, _.jsxs)(Ae.Provider, {
            value: a,
            children: [(0, _.jsx)(E.E.div, {
              className: xe.navOverlay,
              onClick: () => g(!1),
              variants: Pe,
              initial: "initial",
              animate: d ? "open" : "closed"
            }), (0, _.jsx)("div", {
              className: [xe.navContainer, j ? xe.headerVisible : ""].join(" "),
              children: (0, _.jsxs)("nav", {
                className: xe.nav,
                children: [(0, _.jsx)("div", {
                  className: [xe.navBar, u > 0 ? xe.navBarVisible : ""].join(" "),
                  children: (0, _.jsx)(_e, {
                    imageUrl: x,
                    isOpen: d,
                    onClick: () => g(!d)
        ...
        Oe = e => {
          ...
          const s = (0, oe.useGetCdnSource)(t?.backgroundMobileImage ?? null),
            r = (0, oe.useGetCdnSource)(t?.backgroundDesktopImage ?? null),
            c = (0, oe.useGetCdnSource)(t?.layeredMobileImage ?? null),
            o = (0, oe.useGetCdnSource)(t?.layeredDesktopImage ?? null),
            i = (0, oe.useGetCdnSource)(t?.brandImage ?? null);
      ...
      const {
        ...
        const {
          ...
          setAwardsKey: j,
          setRewardsKey: I
        } = v(), [x, A] = (0, s.useState)("unknown"), P = (0, s.useRef)(null), T = (0, s.useRef)(null), {
          formatMessage: O
        } = (0, d.Z)(), {
          track: N
        ...
        }), [h, x, T.current]), (0, s.useEffect)((() => {
          r.p8.matchMediaRefresh()
        }), [f]), h ? (0, _.jsx)("div", {
          className: we.loadingScreen,
          children: (0, _.jsx)(o.LoadingAnimation, {
            type: "SPINNING"
          })
        }) : (0, _.jsxs)(_.Fragment, {
          children: [(0, _.jsx)(Te, {
            ...
            children: [(0, _.jsx)(Oe, {
              ...
              steps: p,
              guideLink: g
            }), (0, _.jsx)(M, {}), null, null, !k && (0, _.jsx)(o.CalloutSection, {
            ...
            }), k && !1 === b && (0, _.jsx)(o.CalloutSection, {
            ...
            }), (0, _.jsx)(re, {}), (0, _.jsx)(o.CalloutSection, {
...
//# sourceMappingURL=cd30600d7bd089345aaa.js.map