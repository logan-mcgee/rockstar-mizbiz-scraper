try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "0b220cf1-ba6f-4b8b-adb8-02722446b253", e._sentryDebugIdIdentifier = "sentry-dbid-0b220cf1-ba6f-4b8b-adb8-02722446b253")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [5455], {
    4819(e, t, n) {
      ...
      function r(e) {
        ...
        var t = o[e],
          r = t[0];
        return n.e(t[1][0]).then(() => n.t(r, 23))
      }
    ...
    1983(e, t, n) {
      ...
      r.keys = () => Object.keys(o), r.id = 1983, e.exports = r
    },
    7461(e, t, n) {
      var o = {
        "./de": [2845, [4710]],
      ...
      r.keys = () => Object.keys(o), r.id = 7461, e.exports = r
    },
    5267(e, t, n) {
      var o = {
        "./de": [406, [299]],
    ...
    8613(e, t, n) {
      ...
      const c = (e, t) => {
        ...
        p = () => {
          ...
          const a = `rockstarweb_lang.${t.cookieIdentifier}`,
            u = d(a);
          s = t.currentSite?.site === i.C.www ? m.find(e => e.subdomaincom === o) || m.find(e => e.subdomaincom === n) || r : m.find(e => e.iso === u) || r;
          const [, p] = ((e, t, n = !1) => {
            const o = d(e);
            return o && !n || c(e, t), [o, (r = e, e => {
              c(r, e)
            })];
            var r
          })(a, s.iso);
      ...
      function h(e) {
        const t = e.split("-");
        return (0, a.A)(t[1] ? t[0] : e, ["relativetimeformat", "pluralrules", "listformat"])
      }
    ...
    8035(e, t, n) {
      ...
      n.r(t), n.d(t, {
        ...
        Platform: () => Ee,
        Platforms: () => Ce,
        ReactiveStateProvider: () => z,
        ResizeProvider: () => yt,
        RockstarGraphProvider: () => ue,
        ...
        useApolloClient: () => ie,
        useBase: () => tt,
        useBodyScrollable: () => he,
        useDataLayer: () => Rt,
        useGetTpaLinkGenerator: () => jt,
        ...
        useRockstarEventSubscriber: () => ut,
        useRockstarToken: () => Q,
        useRockstarTokenPing: () => V,
        useRockstarTokenReactive: () => X,
        ...
        useState: () => U,
        useWindowResize: () => St,
        webSettingsReactive: () => qt,
        withAutoRouteTracking: () => zt,
        withGtmTracking: () => Xe,
        withMediaBasedProps: () => Qe,
        withReactiveState: () => D,
        withRockstarGraph: () => le,
        withTranslations: () => Ze
      });
      var o = {};
      n.r(o), n.d(o, {
      ...
      const d = window?.env?.sc,
        ...
        f = h(document.documentElement.lang),
        w = {},
        b = async (e, {
          fetchOptions: t = {},
          finalFetchOptions: n = {},
          ...
          try {
            ...
            let m = `${g}/${e}`;
            if (null === o || c().isEmpty(o) || (m += `?${new URLSearchParams(o)}`), !u && i) return null;
            ...
            const p = {
              ...
              v = await (0, r.sc)(b);
            if (d) {
              if (w[v]?.response) return w[v].response;
              if (w[v]?.loading) return {
                error: null,
                result: null
              };
              w[v] = {
        ...
        }, v = (...e) => e.filter(Boolean).join(" "), x = e => e.includes("reddead") || e.includes("rdr") ? "#CC0000" : e.includes("bully") ? "#F8AD00" : "#FCAF17", k = () => {
      ...
      const re = document.documentElement.lang,
        ...
        ce = (0, j.createContext)(se),
        de = (e, t) => (0, j.useContext)(ce)(e, t),
        ue = (0, A.QY)(({
          children: e,
          graphOptions: t,
          typePolicies: n = {}
        ...
        me = (0, $.UT)({}),
        pe = "data-disallow-body-scroll",
        he = e => {
          const t = (0, M.q)(me),
            n = Object.values(t).some(e => !!e);
          return (0, j.useEffect)(() => {
            n ? document.documentElement.setAttribute(pe, "true") : document.documentElement.removeAttribute(pe)
          }, [n]), {
            bodyShouldLock: n,
            setBodyIsLocked: n => (e => me(e))({
              ...t,
              [e]: n
            })
          }
      ...
      const je = () => {
        ...
        Oe = (e, t) => {
          e && void 0 !== t && (0, Le.canStoreCookie)(e) && Me(e) !== t && (document.cookie = `${e}=${t}; domain=${je()}; path=/;`)
        },
        Ue = async ({
          service: e,
          returnUrl: t,
        ...
        }, Re = e => e.keys().forEach(e), _e = [{
          key: "dev",
          path: "https://media-dev-rockstargames-com.akamaized.net"
        }, {
          key: "prod",
          path: "https://media-rockstargames-com.akamaized.net"
        }], ze = (e = !0) => _e.filter(t => t.key === (e ? "prod" : "dev"))[0]?.path ?? null, De = e => {
          e.preventDefault();
        ...
        }, $e = () => [Ce.xbox360.name, Ce.xboxone.name, Ce.ps3.name, Ce.ps4.name, Ce.pc.name], Ae = () => [Ce.xboxsx.name, Ce.ps5.name, Ce.pcalt.name], qe = e => Ae().includes(e), Be = e => {
          const t = new Map([
      ...
      var Ve = n(445);
      const Je = (0, $.UT)(document.documentElement.lang),
        Ye = () => (0, M.q)(Je),
        Ke = Ve.J1`
query Translations($locale: String!, $config: String!) {
    translations(locale: $locale, config: $config) {
          ...
          const a = V(),
            ...
            g = (0, j.useCallback)(async (t = {}, i = null) => {
              try {
                ...
                return l?.status || m(JSON.stringify(l?.error)), c(l), u(!1), l
              } catch (e) {
                m(String(e)), u(!1)
              } finally {
                h(!0)
      ...
      const dt = () => {
        ...
        ht = () => (0, j.useContext)(pt),
        gt = ({
          children: e
        }) => {
          const [t, n] = (0, j.useState)(window.pageYOffset), [o, r] = (0, j.useState)(null), [s, a] = (0, j.useState)(!1), i = (0, M.q)(lt);
          let c;
          const d = () => {
          ...
          }, [s, i]), (0, j.useMemo)(() => (0, L.jsx)(pt.Provider, {
            value: {
              freezeUserShouldSeeMore: i,
              pageYOffset: t,
              pauseUserShouldSeeMore: d,
              setFreezeUserShouldSeeMore: mt,
              userShouldSeeMore: o
            },
            children: e
          }), [i, t, d, o])
        ...
        bt = () => {
          const e = window.innerWidth,
            ...
            n = wt;
          return Object.keys(wt).map(t => {
            const {
              min: o,
              max: r
            } = wt[t], s = e >= o && e <= r, a = e >= o;
            n[t] = {
              activeExact: s,
              activeMin: a,
              min: o,
            ...
            isMobile: e < wt.sm.min,
            isTablet: e < wt.md.max,
            breakpoints: n,
            windowWidth: e,
            windowHeight: t
          }
      ...
      const qt = (0, $.UT)(At),
        Bt = ({
          ...
          return n[e] = t, null === t && delete n[e], N.A.set($t, JSON.stringify(n), {
            expires: 30,
            domain: je(),
            path: "/"
          }), qt(n), n
