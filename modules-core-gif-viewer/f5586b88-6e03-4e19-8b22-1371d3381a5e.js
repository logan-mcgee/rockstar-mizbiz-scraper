try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "f5586b88-6e03-4e19-8b22-1371d3381a5e", e._sentryDebugIdIdentifier = "sentry-dbid-f5586b88-6e03-4e19-8b22-1371d3381a5e")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
        ...
        I = function(e) {
          ...
          return E(t, e), Object.defineProperty(t.prototype, "parentNode", {
            ...
            var i, n = this.props.scale || 1,
              ...
              h = this.props,
              p = h.lockAspectRatio,
              u = h.lockAspectRatioExtraHeight,
              c = h.lockAspectRatioExtraWidth,
              f = d.width,
              m = d.height,
              v = u || 0,
              g = c || 0;
            ...
            if (this.state.isResizing && this.resizable && this.window) {
              ...
              if (this.delta = N, u && "string" == typeof u)
                if (u.endsWith("%")) {
                  var E = b / f.width * 100;
                  b = "".concat(E, "%")
              ...
              c && "string" == typeof c && (c.endsWith("%") ? (E = g / f.height * 100, g = "".concat(E, "%")) : c.endsWith("vw") ? (R = g / this.window.innerWidth * 100, g = "".concat(R, "vw")) : c.endsWith("vh") && (_ = g / this.window.innerHeight * 100, g = "".concat(_, "vh")));
              var L = {
      ...
      const o = (e, t) => {
        ...
        d = () => {
          ...
          const p = `rockstarweb_lang.${t.cookieIdentifier}`,
            u = s(p);
          h = t.currentSite?.site === n.C.www ? l.find(e => e.subdomaincom === r) || l.find(e => e.subdomaincom === i) || d : l.find(e => e.iso === u) || d;
          const [, c] = ((e, t, i = !1) => {
            const n = s(e);
