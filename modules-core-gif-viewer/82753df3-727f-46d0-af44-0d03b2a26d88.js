try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "82753df3-727f-46d0-af44-0d03b2a26d88", e._sentryDebugIdIdentifier = "sentry-dbid-82753df3-727f-46d0-af44-0d03b2a26d88")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    8881: (e, t, n) => {
      ...
      const Te = e => {
        ...
        Me = [() => je, {
          ...
          called: !1,
          reset: () => null,
          client: window?.["apollo-client"] ?? (window["apollo-client"] = new I.R(Ue))
        }],
        Re = (0, L.createContext)((() => Me)),
        $e = window?.["apollo-graph-provider"] ?? (window["apollo-graph-provider"] = ({
          children: e
        }) => (0, T.jsx)(Re.Provider, {
          value: B.n,
          children: (0, T.jsx)(Oe.Provider, {
            value: Le,
            children: e
          })
        })),
        De = window?.["apollo-use-query"] ?? (window["apollo-use-query"] = (e, t) => (0, L.useContext)(Oe)(e, t)),
        _e = window?.["apollo-use-mutation"] ?? (window["apollo-use-mutation"] = e => (0, L.useContext)(Re)(e));
      var Ae = n(6347);
      var Ie = n(3605),
        ze = n(1162),
        Be = n.n(ze);
      ...
      const rt = () => {
        ...
        at = (e, t) => {
          e && void 0 !== t && (0, ot.canStoreCookie)(e) && st(e) !== t && (document.cookie = `${e}=${t}; domain=${rt()}; path=/;`)
        };
      var it = n(8613);
      const ct = async ({
        service: e,
      ...
      }], ut = (e = !0) => dt.filter((t => t.key === (e ? "prod" : "dev")))[0]?.path ?? null, pt = e => {
        e.preventDefault();
      ...
      }, mt = () => [et.xbox360.name, et.xboxone.name, et.ps3.name, et.ps4.name, et.pc.name], ht = () => [et.xboxsx.name, et.ps5.name, et.pcalt.name], wt = e => ht().includes(e), gt = e => {
        const t = new Map([
    ...
    translations(locale: $locale, config: $config) {
      ...
      const _t = (0, _.UT)(Dt),
        At = ({
          ...
          return n[e] = t, null === t && delete n[e], Rt.A.set($t, JSON.stringify(n), {
            expires: 30,
            domain: rt(),
            path: "/"
          }), _t(n), n
