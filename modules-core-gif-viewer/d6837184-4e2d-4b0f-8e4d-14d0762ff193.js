      ...
      var l = t(8322),
        ...
        d = function() {
          function e(a, t) {
            ...
            f(this, "type", u), f(this, "fallback", (0, r.GetOption)(t, "fallback", "string", ["code", "none"], "code")), f(this, "locale", s.locale);
            var p = s.dataLocale,
              g = o[p];
            (0, r.invariant)(!!g, "Missing locale data for ".concat(p)), f(this, "localeData", g), (0, r.invariant)(void 0 !== g, "locale data for ".concat(s.locale, " does not exist."));
            var y = g.types;
            ...
            var w = "language" === u ? y[u][b][c] : y[u][c];
          ...
          return e.supportedLocalesOf = function(a, t) {
            ...
            if ("language" === a) l = function(e, a, t, l, r) {
              ...
              if (i) {
                ...
                var f = a.types.region,
                  u = f[t][s] || f.long[s];
                if (u || "code" === r) return a.patterns.locale.replace("{0}", c).replace("{1}", u || s)
              }
            }(c(this, "languageDisplay"), d, f, g, p);
            else {
              var y = d.types[a];
              l = y[f][g] || y.long[g]
            }
            ...
            return u(this, "resolvedOptions"), l.__assign({}, (0, r.getMultiInternalSlots)(s, this, "locale", "style", "type", "fallback", "languageDisplay"))
