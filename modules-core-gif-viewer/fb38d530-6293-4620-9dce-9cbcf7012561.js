! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "fb38d530-6293-4620-9dce-9cbcf7012561", e._sentryDebugIdIdentifier = "sentry-dbid-fb38d530-6293-4620-9dce-9cbcf7012561")
  } catch (e) {}
}();
    ...
    7513: (e, t, n) => {
      ...
      const re = () => {
        ...
        we = e => {
          ...
          const [n, o] = (0, L.useState)(window.pageYOffset), [r, a] = (0, L.useState)(null), [s, i] = (0, L.useState)(!1), c = (0, F.q)(de);
          let l;
          const d = () => {
      ...
      const Ee = e => {
        ...
        je = [() => Le, {
          ...
          called: !1,
          reset: () => null,
          client: window?.["apollo-client"] ?? (window["apollo-client"] = new B.R(Te))
        }],
        Re = (0, L.createContext)((() => je)),
      ...
      const nt = () => {
        ...
        rt = (e, t) => {
          e && void 0 !== t && (0, tt.canStoreCookie)(e) && ot(e) !== t && (document.cookie = `${e}=${t}; domain=${nt()}; path=/;`)
        },
