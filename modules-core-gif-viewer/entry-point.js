  ...
  return Object.defineProperty(r, "__esModule", {
    ...
    execute: function() {
      e((() => {
        var e, a, i, s, l = {
            344: (e, t, r) => {
              ...
              function T(e, t) {
                let r = e.split("/"),
                  n = r.length;
                return r.some(P) && (n += L), t && (n += _), r.filter((e => !P(e))).reduce(((e, t) => e + (x.test(t) ? C : "" === t ? k : D)), n)
              }
              ...
              function fe(e) {
                ...
                let k, D, L = !(C.some((e => e.route.lazy)) || C.some((e => e.route.loader)) && null == e.hydrationData),
                  P = {
                ...
                return k = {
                  ...
                  initialize: function() {
                    ...
                    return P.initialized || Q(n.Pop, P.location), k
                  },
                  ...
                  fetch: function(t, r, n, d) {
                    ...
                    j = !0 === (d && d.preventScrollReset), g && Ae(g.formMethod) ? async function(t, r, n, o, d, h) {
                      ...
                      let C = Fe(h, g.data);
                      P.fetchers.set(t, C);
                      let [_, k] = me(e.history, P, R, h, b, I, B, F, K, q, S, f, {
                        [o.route.id]: g.data
                      }, void 0);
                      ...
                      let L = () => k.forEach((e => fe(e.key)));
                      m.signal.addEventListener("abort", L);
                      let {
                        results: j,
                        loaderResults: A,
                        fetcherResults: M
                      } = await te(P.matches, R, _, k, E);
                      if (m.signal.aborted) return;
                      m.signal.removeEventListener("abort", L), H.delete(t), $.delete(t), k.forEach((e => $.delete(e.key)));
                      let U = De(j);
                      if (U) {
                        if (U.idx >= _.length) {
                          let e = k[U.idx - _.length].key;
                          q.add(e)
                        }
                      ...
                      let {
                        loaderData: O,
                        errors: N
                      } = Re(P, P.matches, _, A, void 0, k, M, V);
                      if (P.fetchers.has(t)) {
                        let e = $e(g.data);
                        P.fetchers.set(t, e)
                      }
              ...
              function Ir() {
                return [...Lr(kr.UseFetchers).fetchers.values()]
              }
            ...
            224: (e, t) => {
              ...
              function L(e, t, o, a, i) {
                ...
                if (l) return i = i(l = e), e = "" === a ? "." + D(l, 0) : a, E(i) ? (o = "", null != e && (o = e.replace(k, "$&/") + "/"), L(i, t, o, "", (function(e) {
                  return e
                ...
                }(i, o + (!i.key || l && l.key === i.key ? "" : ("" + i.key).replace(k, "$&/") + "/") + e)), t.push(i)), 1;
                if (l = 0, a = "" === a ? "." : a + ":", E(e))
            ...
            812: (e, t, r) => {
              "use strict";
              var n = {
                  "./index": () => Promise.all([r.e(52), r.e(856)]).then((() => () => r(856))),
                  "./lazy": () => Promise.all([r.e(52), r.e(920)]).then((() => () => r(920))),
                  "./tina": () => Promise.all([r.e(52), r.e(912)]).then((() => () => r(912))),
                  "./tinaBlockTemplates": () => Promise.all([r.e(52), r.e(912)]).then((() => () => r(912)))
                },
        ...
        return c.m = l, c.c = u, c.y = t, c.n = e => {
        ...
        }(), c.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = {}, a = "@rockstargames/modules-core-gif-viewer:", c.l = (t, r, n, o) => {
          if (e[t]) e[t].push(r);
          else {
            var i, s;
            if (void 0 !== n)
              for (var l = document.getElementsByTagName("script"), u = 0; u < l.length; u++) {
                var d = l[u];
                if (d.getAttribute("src") == t || d.getAttribute("data-webpack") == a + n) {
                  i = d;
                  break
                }
              }
            i || (s = !0, (i = document.createElement("script")).charset = "utf-8", i.timeout = 120, c.nc && i.setAttribute("nonce", c.nc), i.setAttribute("data-webpack", a + n), i.src = t), e[t] = [r];
            var f = (r, n) => {
          ...
          104: ["default", "./ui", 428],
          468: ["default", "./properties", 428],
          668: ["default", "./index", 476]
        }, c.f.remotes = (e, t) => {
          ...
          c.I = (r, n) => {
            ...
            if (o || (o = t[r] = {}), !(n.indexOf(o) >= 0)) {
              ...
              var a = c.S[r],
                ...
                u = [];
              return "default" === r && (s("react-router-dom", "6.17.0", (() => () => c(344)), 1), s("react", "18.2.0", (() => () => c(188)), 1), l(864), l(476), l(428)), u.length ? e[r] = Promise.all(u).then((() => e[r] = 1)) : e[r] = 1
            }
          }
        })(), (() => {
          var e;
          ...
          var e = e => {
            ...
            n = (e => function(t, r, n, o) {
              ...
              var i = t && c.o(t, n) && r(t, n, o);
              return i ? (e => (e.loaded = 1, e.get()))(i) : a()
            })),
            o = {},
            a = {
              320: () => n("default", "react-router-dom", [1, 6, 11, 2], (() => () => c(344))),
          ...
          var t = (t, r) => {
              ...
              for (t && t(r); l < a.length; l++) o = a[l], c.o(e, o) && e[o] && e[o][0](), e[o] = 0
            },
