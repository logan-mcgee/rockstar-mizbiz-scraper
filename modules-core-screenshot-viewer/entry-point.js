/*! For license information please see remote-entry.js.LICENSE.txt */ ! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "8412ebb3-809d-40f1-8769-af8050290502", e._sentryDebugIdIdentifier = "sentry-dbid-8412ebb3-809d-40f1-8769-af8050290502")
  } catch (e) {}
}();
  ...
  return {
    execute: function() {
      e((() => {
        var e, r, n, o, a = {
            344: (e, t, r) => {
              ...
              function w(e, t, r) {
                ...
                let a = null;
                for (let e = 0; null == a && e < o.length; ++e) a = A(o[e], M(n));
                return a
              }
              ...
              function T(e, t) {
                let r = e.split("/"),
                  n = r.length;
                return r.some(P) && (n += L), t && (n += D), r.filter((e => !P(e))).reduce(((e, t) => e + (x.test(t) ? C : "" === t ? _ : k)), n)
              }
              ...
              function fe(e) {
                ...
                let _, k, L = !(C.some((e => e.route.lazy)) || C.some((e => e.route.loader)) && null == e.hydrationData),
                  P = {
                ...
                function G(t, r) {
                  var o, i;
                  let l, c = null != P.actionData && null != P.navigation.formMethod && je(P.navigation.formMethod) && "loading" === P.navigation.state && !0 !== (null == (o = t.state) ? void 0 : o._isRedirect);
                  ...
                  let h, p = !0 === A || null != P.navigation.formMethod && je(P.navigation.formMethod) && !0 !== (null == (i = t.state) ? void 0 : i._isRedirect);
                  if (s && (u = s, s = void 0), N || T === n.Pop || (T === n.Push ? e.history.push(t, t.state) : T === n.Replace && e.history.replace(t, t.state)), T === n.Pop) {
                    let e = U.get(P.location.pathname);
                    ...
                    let e = U.get(P.location.pathname);
                    e ? e.add(t.pathname) : (e = new Set([t.pathname]), U.set(P.location.pathname, e)), h = {
                      currentLocation: P.location,
                      nextLocation: t
                    }
                  }
                  X(a({}, r, {
                    ...
                    blockers: f
                  }), h), T = n.Pop, A = !1, j = !1, N = !1, I = !1, B = [], F = []
                }
                async function Q(t, r, o) {
                  k && k.abort(), k = null, T = t, N = !0 === (o && o.startUninterruptedRevalidation),
                    function(e, t) {
                      if (g && R) {
                        let r = ze(e, t);
                        g[r] = R()
                      }
                    }(P.location, P.matches), A = !0 === (o && o.preventScrollReset), j = !0 === (o && o.enableViewTransition);
                  let c = s || u,
                  ...
                  if (P.initialized && !I && (p = P.location, m = r, p.pathname === m.pathname && p.search === m.search && ("" === p.hash ? "" !== m.hash : p.hash === m.hash || "" !== m.hash)) && !(o && o.submission && je(o.submission.formMethod))) return void G(r, {
                    matches: h
                  });
                  var p, m;
                  ...
                  if (o && o.pendingError) b = {
                    [Ce(h).route.id]: o.pendingError
                  };
                  else if (o && o.submission && je(o.submission.formMethod)) {
                  ...
                  let {
                    ...
                    k && k.signal.removeEventListener("abort", b), g.forEach((e => $.delete(e.key)));
                    let R = ke(w);
                    if (R) {
                      if (R.idx >= y.length) {
                ...
                async function ee(o, i, s) {
                  ...
                  let b = l || u;
                  if (ae.has(i.status) && b && je(b.formMethod)) await Q(m, p, {
                    submission: a({}, b, {
                ...
                async function te(t, r, n, o, a) {
                  let s = await Promise.all([...n.map((e => be("loader", a, e, r, l, i, f))), ...o.map((t => t.matches && t.match && t.controller ? be("loader", we(e.history, t.path, t.controller.signal), t.match, t.matches, l, i, f) : {
                    ...
                    c = s.slice(n.length);
                  return await Promise.all([Ue(t, n, u, u.map((() => a.signal)), !1, P.loaderData), Ue(t, o.map((e => e.match)), c, o.map((e => e.controller ? e.controller.signal : null)), !0)]), {
                    results: s,
                    loaderResults: u,
                    fetcherResults: c
                  }
                ...
                return _ = {
                  ...
                  navigate: async function t(r, o) {
                    ...
                    let m = o && null != o.replace ? o.replace : void 0,
                      v = n.Push;
                    !0 === m ? v = n.Replace : !1 === m || null != l && je(l.formMethod) && l.formAction === P.location.pathname + P.location.search && (v = n.Replace);
                  ...
                  fetch: function(t, r, n, d) {
                    ...
                    let E = Ne(v, y);
                    A = !0 === (d && d.preventScrollReset), g && je(g.formMethod) ? async function(t, r, n, o, d, h) {
                      ...
                      let C = Fe(h, g.data);
                      P.fetchers.set(t, C);
                      let [D, _] = me(e.history, P, R, h, b, I, B, F, K, q, S, f, {
                        [o.route.id]: g.data
                      }, void 0);
                      ...
                      let {
                        ...
                        loaderResults: j,
                        fetcherResults: U
                      } = await te(P.matches, R, D, _, E);
                      if (m.signal.aborted) return;
                      m.signal.removeEventListener("abort", L), H.delete(t), $.delete(t), _.forEach((e => $.delete(e.key)));
                      let M = ke(A);
                      if (M) {
                        if (M.idx >= D.length) {
                          let e = _[M.idx - D.length].key;
                          q.add(e)
                        }
                        return ee(P, M.result)
                      }
                      let {
                        loaderData: O,
                        errors: N
                      } = Re(P, P.matches, D, j, void 0, _, U, V);
                      if (P.fetchers.has(t)) {
                        let e = $e(g.data);
                        P.fetchers.set(t, e)
                      }
                      let J = ge(x);
                      "loading" === P.navigation.state && x > W ? (c(T, "Expected pending action"), k && k.abort(), G(P.navigation.location, {
                        matches: R,
                        loaderData: O,
                        errors: N,
                        fetchers: new Map(P.fetchers)
                      ...
                      if (Pe(v) && (v = await Me(v, p.signal, !0) || v), $.get(t) === h && $.delete(t), p.signal.aborted) return;
                      if (Ae(v)) {
                        if (W > m) {
                          let e = $e(void 0);
                          return P.fetchers.set(t, e), void X({
                  ...
                  deleteFetcher: oe,
                  dispose: function() {
                    m && m(), M && M(), v.clear(), k && k.abort(), P.fetchers.forEach(((e, t) => oe(t))), P.blockers.forEach(((e, t) => Ee(t)))
                  },
              ...
              function Re(e, t, r, n, o, i, s, l) {
                let {
                  ...
                  return r.forEach(((r, d) => {
                    let f = t[d].route.id;
                    if (c(!Ae(r), "Cannot handle redirect results in processLoaderData"), Te(r)) {
                      let t = Ce(e, f),
                        o = r.error;
              ...
              function Nr() {
                ...
                let {
                  router: t
                } = kr(Dr.UseFetcher), r = o.useContext(Je);
                r || c(!1);
                ...
                })), l = Ur(a, n), u = t.getFetcher(a), d = o.useMemo((() => Jt({
                  Form: i,
                  submit: l,
                  load: s
                }, u)), [u, i, l, s]);
              ...
              function Hr(e, t) {
                ...
                let {
                  basename: n
                } = kr(Dr.useViewTransitionState), a = st(e, {
                  relative: t.relative
                });
            ...
            224: (e, t) => {
              ...
              function L(e, t, o, a, i) {
                ...
                if (l) return i = i(l = e), e = "" === a ? "." + k(l, 0) : a, E(i) ? (o = "", null != e && (o = e.replace(_, "$&/") + "/"), L(i, t, o, "", (function(e) {
                  return e
                ...
                if (l = 0, a = "" === a ? "." : a + ":", E(e))
                  for (var u = 0; u < e.length; u++) {
                    ...
                    for (e = c.call(e), u = 0; !(s = e.next()).done;) l += L(s = s.value, t, o, c = a + k(s, u++), i);
              ...
              }, t.Component = y, t.Fragment = o, t.Profiler = i, t.PureComponent = b, t.StrictMode = a, t.Suspense = c, t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = U, t.cloneElement = function(e, t, n) {
        ...
        return s.m = a, s.c = i, s.y = t, s.d = (e, t) => {
          for (var r in t) s.o(t, r) && !s.o(e, r) && Object.defineProperty(e, r, {
            enumerable: !0,
            get: t[r]
          })
        }, s.f = {}, s.e = e => Promise.all(Object.keys(s.f).reduce(((t, r) => (s.f[r](e, t), t)), [])), s.u = e => "js/867bafccd783aea2194f82188126e2ac.js", s.miniCssF = e => "css/8ddeaa662a389c67ab26ff2d3e176f9a.css", s.g = function() {
        ...
        }(), s.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = {}, r = "@rockstargames/modules-core-screenshot-viewer:", s.l = (t, n, o, a) => {
          if (e[t]) e[t].push(n);
          else {
            var i, l;
            if (void 0 !== o)
          ...
          s.o(n, e) && n[e].forEach((e => {
            ...
            if (!(r.indexOf(n) >= 0)) {
              ...
              var a = t => {
                ...
                l = (e, t, o) => i(t.get, n[1], r, 0, u, o),
                u = t => {
                  n.p = 1, s.m[e] = e => {
                    e.exports = t()
                  }
                };
              i(s, n[2], 0, 0, ((e, t, r) => e ? i(s.I, n[0], 0, e, l, r) : a()), 1)
            }
          }))
        }, (() => {
          s.S = {};
          ...
          s.I = (r, n) => {
            ...
            if (o || (o = t[r] = {}), !(n.indexOf(o) >= 0)) {
              ...
              var a = s.S[r],
                ...
                u = [];
              return "default" === r && (l("react-router-dom", "6.17.0", (() => () => s(344)), 1), l("react", "18.2.0", (() => () => s(188)), 1)), e[r] = u.length ? Promise.all(u).then((() => e[r] = 1)) : 1
            }
          }
        })(), (() => {
          var e;
          ...
          var e = e => {
            ...
            o = {},
            a = {
              320: () => n("default", "react-router-dom", [1, 6, 11, 2], (() => () => s(344))),
              200: () => n("default", "react", [1, 18, 2, 0], (() => () => s(188)))
            };
          [200].forEach((e => {
            s.m[e] = t => {
              o[e] = 0, delete s.c[e];
          ...
          var t = (t, r) => {
            ...
            r = self.webpackChunk_rockstargames_modules_core_screenshot_viewer = self.webpackChunk_rockstargames_modules_core_screenshot_viewer || [];
