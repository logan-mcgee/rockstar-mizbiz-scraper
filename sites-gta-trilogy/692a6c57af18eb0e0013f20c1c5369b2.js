  ...
  [28], {
    28: (e, s, t) => {
      ...
      const m = e => {
          ...
          return (0, i.jsx)("img", {
            style: r,
            className: (0, n.classList)("rockstargames-sites-gta-trilogye713aa2e2995a6755fff195529f21156", a?.split(" ")),
        ...
        b = (0, d.withTranslations)((e => {
          ...
          return (0, i.jsx)("div", {
            className: (0, n.classList)("rockstargames-sites-gta-trilogye06ad1179cdbca03d9b8c92489d722f5", a?.split(" ")),
            style: r,
      ...
      const u = e => {
          ...
          return (0, i.jsx)("section", {
            className: (0, n.classList)("rockstargames-sites-gta-trilogyc4b62be59154f67f28815d02813c6b78", t?.split(" ")),
            ...a,
            children: s
          })
        },
      ...
      const N = e => {
          ...
          return (0, i.jsxs)("div", {
            className: (0, n.classList)("rockstargames-sites-gta-trilogyd4701b70db493e5c28da87a2b72a3de5", r?.split(" ")),
            style: a,
            children: [(0, i.jsx)("div", {
        ...
        O = (0, d.withMediaBasedProps)((0, d.withTranslations)((e => {
          ...
          const [t, a] = (0, v.useState)(1), [r, c] = (0, v.useState)(16), o = () => {
          ...
          return (0, v.useEffect)((() => (o(), window.addEventListener("resize", o), () => window.removeEventListener("resize", o)))), (0, i.jsxs)(u, {
            id: "enhancements",
      ...
      const F = e => {
          ...
          return {
            ...
            triggers: {
              ...
              gamesTrigger2: g,
              gamesTrigger3: l,
              introTriggers: [e, d, d + m, d + g],
              introTriggers2: [e, d, d + m, d + g, d + l, d + n * a],
              FadeFOBTriggers: [d + m, d + g],
              FadeFOBTriggersText: [d + m + .2 * r, d + g],
              FadeFOBTriggersGirl: [d + m + .05 * r, d + g - .2 * r]
            }
          }
        },
        C = e => {
          ...
          } = c, [l, f] = (0, v.useState)(null), [h, b] = (0, v.useState)(null), [x, p] = (0, v.useState)(null), [j, u] = (0, v.useState)(null);
          (0, v.useEffect)((() => {
            const e = () => {
              let e, s, t, a;
              window.innerWidth < 768 ? (e = .3, s = 1.1 * e, t = .05, a = .1) : window.innerWidth >= 768 && window.innerWidth < 1024 ? (e = .22, s = .8 * e, t = .05, a = .2) : window.innerWidth >= 1024 && window.innerWidth < 1920 || window.innerWidth >= 1920 && window.innerWidth < 2560 ? (e = .15, s = .6 * e, t = .05, a = .2) : window.innerWidth >= 2560 && (e = .11, s = .6 * e, t = .1, a = .2), f(e), b(s), p(t), u(a)
            };
            return e(), window.addEventListener("resize", e), () => window.removeEventListener("resize", e)
          }), []);
          const k = (0, L.H)(o, n, [window.innerWidth * l, window.innerWidth * h]),
            y = (0, L.H)(o, n, [window.innerHeight * x, window.innerHeight * j]),
            w = (0, L.H)(o, g, [1, 0]),
            _ = (0, L.H)(o, d, [0, 1]);
          return (0, i.jsxs)($.E.div, {
            className: "rockstargames-sites-gta-trilogyf4a72102ceddef029be930bb493b8d88",
            "data-game": s,
            style: r,
            children: [(0, i.jsx)($.E.div, {
        ...
        G = e => {
          ...
          const {
            ...
            finalColumnWidth: p,
            gameDescriptionWidth: j,
            gameDescriptionHeight: u,
            imageGridGap: k,
            transitionDistance: y
          } = r, v = (0, L.H)(c, l, [p, p, p, j]), w = (0, L.H)(c, f, [0, 0, 0, (b - u) / 2, (b - u) / 2, (b - u) / 2]), _ = (0, L.H)(c, f, [0, 0, 0, j + k, j + k, j - y]), N = (0, L.H)(c, [n, n + 1, n + d, n + m], [b, b, b, u]);
          return (0, i.jsx)(C, {
            gameSlug: s,
            style: {
              x: _,
        ...
        D = e => {
          ...
          const {
            ...
            vw: f,
            vh: h,
            initialMiddleWidth: b,
            finalColumnWidth: x,
            gameDescriptionWidth: p,
            gameDescriptionHeight: j,
            imageGridGap: u,
            transitionDistance: k
          } = a, y = (0, L.H)(r, g, [b, x, x, p]), v = (0, L.H)(r, l, [0, 0, 0, (h - j) / 2, (h - j) / 2, (h - j) / 2]), w = (0, L.H)(r, l, [0, 0, 0, p + u, p + u, p - k]), _ = (0, L.H)(r, [o, o + 1, o + n, o + d], [h, h, h, j]);
          return (0, i.jsxs)(C, {
            gameSlug: "VC",
            style: {
              x: w,
        ...
        Y = () => {
          const e = (0, v.useRef)(),
            [s, t] = (0, v.useState)(parseInt(localStorage?.getItem("startGames")) ?? null),
            a = (0, W.S1)(e, {
              threshold: [0]
            }),
            [r, c] = (0, v.useState)(0),
        ...
        A = "rockstargames-sites-gta-trilogybaf0910838232b08c92edcb6a981d263",
        U = "rockstargames-sites-gta-trilogyc12b85147ab877bdd1e264eae95885ec",
        R = "rockstargames-sites-gta-trilogyb9c2f6d143c919d269e79c918c9119bd",
        P = "rockstargames-sites-gta-trilogydb25c893ecdb3316b14c93891cbd4296",
        q = "rockstargames-sites-gta-trilogyd0a69bb831b4e0786451f3fb0a98caf5",
        J = "rockstargames-sites-gta-trilogyd557c3260fa1478a9ab89ebdcf82b84b",
        K = (0, d.withTranslations)((e => {
          ...
          return (0, i.jsxs)(u, {
            ...
            children: [(0, i.jsx)("div", {
              ...
              className: `${A} rockstargames-sites-gta-trilogycc94677a83f454af7a5022a362878d7d`,
              children: [(0, i.jsx)("img", {
                src: t(6276)
              }), (0, i.jsx)("img", {
                src: t(3642)
        ...
        ee = e => {
          ...
          const a = function(e) {
            ...
            const t = document.documentElement,
              ...
              i = (r - t.scrollTop) / s * 10;
            setTimeout((() => {
              t.scrollTop += i, t.scrollTop !== r && a(e, s - 10)
            }), 10)
          };
          return (0, i.jsx)("a", {
            onClick: () => a(s),
        ...
        se = (0, d.withTranslations)((e => {
          ...
          const {
            scrollY: t
          } = (0, H.M)(), [a, r] = (0, v.useState)(!1);
          t.onChange((e => r(e > 600)));
          const [c, o] = (0, v.useState)(!1), [n, d] = (0, v.useState)(0), [g, l] = (0, v.useState)(60);
          return (0, v.useEffect)((() => {
            const e = () => {
              const e = window.pageYOffset;
              o(e > n), d(e), l(e > n ? 0 : 60)
            };
            return window.addEventListener("scroll", e), () => window.removeEventListener("scroll", e)
          }), [c, n]), (0, i.jsxs)($.E.nav, {
            className: "rockstargames-sites-gta-trilogyc4dfd198843fa9cb49f13f86bcb03c30",
            animate: a ? {
              opacity: 1,
              y: g,
              x: "-50%"
            ...
            children: [(0, i.jsx)(m, {
              ...
              className: "rockstargames-sites-gta-trilogyeb8736bf47ca81c3f10f7c97c8ea7eee",
              children: [(0, i.jsx)(ee, {
                to: "trailer",
        ...
        te = () => (0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(se, {}), (0, i.jsx)(x, {}), (0, i.jsx)(k, {}), (0, i.jsx)(y, {}), (0, i.jsx)(O, {}), (0, i.jsx)(Y, {}), (0, i.jsx)(K, {}), (0, i.jsx)(Z, {})]
        }),
        ae = () => {
          const e = [{
            path: "/",
    ...
    1163: (e, s, t) => {
      ...
      }, r.resolve = i, e.exports = r, r.id = 1163
    },
    7118: (e, s, t) => {
      var a = {
        "./III-logo.svg": 3581,
      ...
      r.keys = function() {
        return Object.keys(a)
      }, r.resolve = i, e.exports = r, r.id = 7118
    },
    3098: (e, s, t) => {
      var a = {
        "./FOB_III.jpg": 3805,
      ...
      r.keys = function() {
        return Object.keys(a)
      }, r.resolve = i, e.exports = r, r.id = 3098
    },
    648: e => {
      "use strict";
