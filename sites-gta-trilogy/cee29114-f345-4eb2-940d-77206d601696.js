! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      s = (new Error).stack;
    s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "cee29114-f345-4eb2-940d-77206d601696", e._sentryDebugIdIdentifier = "sentry-dbid-cee29114-f345-4eb2-940d-77206d601696")
  } catch (e) {}
}();
    ...
    1464: (e, s, i) => {
      ...
      const m = (0, n.withIntl)((e => {
        ...
        const u = (0, t.useRef)(null),
          f = (0, n.useIntl)(),
          p = !/^(https?|mailto):/i.test(i),
          k = /^#/.test(i),
          b = g?.target ?? (r ? "_blank" : "_self");
        let {
          ...v
        } = g, h = "";
        if ("aria-label" in v && v["aria-label"] && (h = "_blank" === b ? `${v["aria-label"]} ${f.formatMessage(c.aria_label_open_new_window)}` : v["aria-label"]), (0, t.useEffect)((() => {
          ...
          return (0, d.jsxs)("a", {
            ...
            "aria-label": h,
            ref: u,
            children: [s, "_blank" === b && !h && (0, d.jsx)("span", {
              className: l,
              children: f.formatMessage(c.aria_label_open_new_window)
            })]
          })
        }
        if (p) return (0, d.jsxs)(_.NavLink, {
          title: a,
          to: i,
          onClick: o,
          ...v,
        ...
        const y = Object.keys(v).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, s) => ({
          ...e,
          [s]: g[s]
        })), {});
      ...
      const u = (0, r.withTranslations)((e => {
          ...
          const [i] = (0, t.useState)(""), a = (0, _.useNavigate)(), r = (0, g.useMutateState)();
      ...
      const P = (0, n.defineMessages)({
        ...
        F = (0, r.withMediaBasedProps)((0, r.withTranslations)((e => {
          ...
          const [i, a] = (0, t.useState)(1), [r, n] = (0, t.useState)(16), o = () => {
          ...
          return (0, t.useEffect)((() => (o(), window.addEventListener("resize", o), () => window.removeEventListener("resize", o)))), (0, d.jsxs)(C, {
            id: "enhancements",
      ...
      const W = e => {
          ...
          return {
            ...
            triggers: {
              ...
              introTriggers2: [e, _, _ + l, _ + d, _ + m, _ + c * a],
              FadeFOBTriggers: [_ + l, _ + d],
              FadeFOBTriggersText: [_ + l + .2 * t, _ + d],
              FadeFOBTriggersGirl: [_ + l + .05 * t, _ + d - .2 * t]
            }
          }
        },
        $ = e => {
          ...
          } = n, [m, g] = (0, t.useState)(null), [u, f] = (0, t.useState)(null), [p, k] = (0, t.useState)(null), [b, h] = (0, t.useState)(null);
          (0, t.useEffect)((() => {
            const e = () => {
              let e, s, i, a;
              window.innerWidth < 768 ? (e = .3, s = 1.1 * e, i = .05, a = .1) : window.innerWidth >= 768 && window.innerWidth < 1024 ? (e = .22, s = .8 * e, i = .05, a = .2) : window.innerWidth >= 1024 && window.innerWidth < 1920 || window.innerWidth >= 1920 && window.innerWidth < 2560 ? (e = .15, s = .6 * e, i = .05, a = .2) : window.innerWidth >= 2560 && (e = .11, s = .6 * e, i = .1, a = .2), g(e), f(s), k(i), h(a)
            };
        ...
        B = e => {
          ...
          } = t, b = (0, L.useTransform)(r, _, [g, g, g, u]), v = (0, L.useTransform)(r, l, [0, 0, 0, (m - f) / 2, (m - f) / 2, (m - f) / 2]), h = (0, L.useTransform)(r, l, [0, 0, 0, u + p, u + p, u - k]), y = (0, L.useTransform)(r, [n, n + 1, n + o, n + c], [m, m, m, f]);
          return (0, d.jsx)($, {
            gameSlug: s,
            style: {
              x: h,
        ...
        H = e => {
          ...
          const {
            ...
            imageGridGap: p,
            transitionDistance: k
          } = a, b = (0, L.useTransform)(t, c, [m, g, g, u]), v = (0, L.useTransform)(t, _, [0, 0, 0, (l - f) / 2, (l - f) / 2, (l - f) / 2]), h = (0, L.useTransform)(t, _, [0, 0, 0, u + p, u + p, u - k]), y = (0, L.useTransform)(t, [r, r + 1, r + n, r + o], [l, l, l, f]);
          return (0, d.jsxs)($, {
            gameSlug: "VC",
            style: {
              x: h,
        ...
        Z = () => {
          const e = (0, t.useRef)(),
            ...
            a = (0, V.useIntersectionObserver)(e, {
              threshold: [0]
            }),
            [r, n] = (0, t.useState)(0),
            o = e => {
          ...
          return (0, t.useEffect)((() => {
            const i = () => {
              n(window.pageYOffset), a?.isIntersecting && !s && (o(window.pageYOffset > r ? window.pageYOffset : window.pageYOffset - e.current.offsetHeight - window.innerHeight), window.removeEventListener("scroll", i))
            };
      ...
      const me = oe((0, n.withIntl)((e => {
        ...
        pe = () => (0, d.jsxs)("div", {
          ...
          children: [(0, d.jsx)(z, {}), (0, d.jsx)(R, {}), (0, d.jsx)(G, {}), (0, d.jsx)(F, {}), (0, d.jsx)(Z, {}), (0, d.jsx)(ae, {}), (0, d.jsx)(fe, {})]
        }),
        ke = () => {
          const e = [{
            path: "/",
