! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      s = (new Error).stack;
    s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "b89b2b37-6f8e-4e63-b2f4-ad06831bef50", e._sentryDebugIdIdentifier = "sentry-dbid-b89b2b37-6f8e-4e63-b2f4-ad06831bef50")
  } catch (e) {}
}();
  ...
  [464], {
    1464: (e, s, i) => {
      ...
      const d = (0, n.withIntl)((e => {
        ...
        if ("aria-label" in v && v["aria-label"] && (h = "_blank" === b ? `${v["aria-label"]} ${p.formatMessage(c.aria_label_open_new_window)}` : v["aria-label"]), (0, t.useEffect)((() => {
      ...
      const M = (0, n.defineMessages)({
        ...
        L = (0, r.withMediaBasedProps)((0, r.withTranslations)((e => {
          ...
          return (0, t.useEffect)((() => (o(), window.addEventListener("resize", o), () => window.removeEventListener("resize", o)))), (0, m.jsxs)(C, {
            id: "enhancements",
      ...
      const W = e => {
          ...
          return {
            ...
            triggers: {
              ...
              introTriggers2: [e, l, l + _, l + m, l + d, l + c * a],
        ...
        G = e => {
          ...
          const x = (0, $.useTransform)(o, c, [window.innerWidth * d, window.innerWidth * f]),
            y = (0, $.useTransform)(o, c, [window.innerHeight * k, window.innerHeight * b]),
            w = (0, $.useTransform)(o, _, [1, 0]),
            j = (0, $.useTransform)(o, l, [0, 1]);
        ...
        H = e => {
          ...
          } = t, b = (0, $.useTransform)(r, l, [g, g, g, f]), v = (0, $.useTransform)(r, _, [0, 0, 0, (d - p) / 2, (d - p) / 2, (d - p) / 2]), h = (0, $.useTransform)(r, _, [0, 0, 0, f + k, f + k, f - u]), x = (0, $.useTransform)(r, [n, n + 1, n + o, n + c], [d, d, d, p]);
          return (0, m.jsx)(G, {
            gameSlug: s,
            style: {
              x: h,
        ...
        U = e => {
          ...
          const {
            ...
            imageGridGap: k,
            transitionDistance: u
          } = a, b = (0, $.useTransform)(t, c, [d, g, g, f]), v = (0, $.useTransform)(t, l, [0, 0, 0, (_ - p) / 2, (_ - p) / 2, (_ - p) / 2]), h = (0, $.useTransform)(t, l, [0, 0, 0, f + k, f + k, f - u]), x = (0, $.useTransform)(t, [r, r + 1, r + n, r + o], [_, _, _, p]);
          return (0, m.jsxs)(G, {
            gameSlug: "VC",
            style: {
              x: h,
      ...
      const de = oe((0, n.withIntl)((e => {
          ...
          return (0, m.jsxs)("div", {
            className: [ce.rating, w ? ce.withDescriptors : ce.withOutDescriptors, f || ""].join(" "),
