! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e8a1da0a-13f8-42f9-9ae9-c38cbe783f72", e._sentryDebugIdIdentifier = "sentry-dbid-e8a1da0a-13f8-42f9-9ae9-c38cbe783f72")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [884], {
    7100: (e, t, a) => {
        ...
        Ze = e => {
          ...
          return j(s) ? l = d = {
            ...
            if (!j) {
              ...
              for (j = r[w] = [], g = o ? Math.min(x, w) * l - .5 : s % x, u = x === _ ? 0 : o ? w * d / x - .5 : s / x | 0, b = 0, v = _, k = 0; k < w; k++) f = k % x - g, p = u - (k / x | 0), j[k] = h = c ? Math.abs("y" === c ? p : f) : y(f * f + p * p), h > b && (b = h), h < v && (v = h);
              "random" === s && Qe(j), j.max = b - v, j.min = v, j.v = w = (parseFloat(t.amount) || parseFloat(t.each) * (x > w ? w - 1 : c ? "y" === c ? w / x : x : Math.max(x, w / x)) || 0) * ("edges" === s ? -1 : 1), j.b = w < 0 ? i - w : i, j.u = We(t.amount || t.each) || 0, a = a && w < 0 ? Ct(a) : a
            }
      ...
      let Dt, Rt, Vt = function(e, t, a, s, i, r, n) {
        ...
        Gt = (e, t, a) => {
          let r, o, c, l, d, m, g, u, f, k, b, v, y, x = e.vars,
            ...
            F = e.timeline;
          if (F && (!z || !w) && (w = "none"), e._ease = It(w, p.ease), e._yEase = E ? Ct(It(!0 === E ? w : E, p.ease)) : 0, E && e._yoyo && !e._repeat && (E = e._yEase, e._yEase = e._ease, e._ease = E), e._from = !F && !!x.runBackwards, !F || z && !x.stagger) {
            if (u = B[0] ? ne(B[0]).harness : 0, v = u && x[u.prop], r = ve(x, Q), A && (A._zTime < 0 && A.progress(1), t < 0 && L && N && !P ? A.render(-1, !0) : A.revert(L && O ? Y : X), A._lazy = 0), j) {
              ...
              if (t && (N = !1), c = he({
                  ...
                  stagger: 0,
                  parent: D
                }, r), v && (c[u.prop] = v), je(e._startAt = Xt.set(B, c)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (i ? e._startAt.revert(Y) : e._startAt.render(-1, !0)), e._zTime = t, N) {
                if (!t) return
              } else Gt(e._startAt, h, h);
            for (e._pt = e._ptCache = 0, S = O && M(S) || S && !O, o = 0; o < B.length; o++) {
              if (d = B[o], g = d._gsap || re(B)[o]._gsap, e._ptLookup[o] = k = {}, J[g.id] && Z.length && ue(), b = R === B ? o : R.indexOf(d), u && !1 !== (f = new u).init(d, v || r, e, b, R) && (e._pt = l = new ca(e._pt, d, f.name, 0, 1, f.render, f, 0, f.priority), f._props.forEach((e => {
                  k[e] = l
                })), f.priority && (m = 1)), !u || v)
                for (c in r) ee[c] && (f = $t(c, r, e, b, d, R)) ? f.priority && (m = 1) : k[c] = l = Ft.call(e, d, c, "get", r[c], b, R, 0, x.stringFilter);
              e._op && e._op[o] && e.kill(d, e._op[o]), V && e._pt && (Dt = e, n.killTweensOf(d, k, e.globalTime(t)), y = !e.parent, Dt = 0), e._pt && S && (J[g.id] = 1)
            }
        ...
        constructor(e, t, a, i) {
          ...
          if (this._targets = N.length ? re(N) : H("GSAP target " + e + " not found. https://greensock.com", !f.nullTargetWarn) || [], this._ptLookup = [], this._overwrite = b, v || k || L(p) || L(_)) {
            if (t = this.vars, r = this.timeline = new Bt({
              ...
              if (l = N.length, g = k && Ze(k), C(k))
                for (d in k) ~Wt.indexOf(d) && (u || (u = {}), u[d] = k[d]);
              for (o = 0; o < l; o++) c = ve(t, qt), c.stagger = 0, w && (c.yoyoEase = w), u && ke(c, u), m = N[o], c.duration = +Ht(p, this, o, m, N), c.delay = (+Ht(_, this, o, m, N) || 0) - this._delay, !k && 1 === l && c.delay && (this._delay = _ = c.delay, this._start += _, c.delay = 0), r.to(m, c, g ? g(o, m, N) : 0), r._ease = jt.none;
          ...
          !0 !== b || s || (Dt = this, n.killTweensOf(N), Dt = 0), Pe(j, this, a), t.reversed && this.reverse(), t.paused && this.paused(!0), (h || !p && !v && this._start === de(j._time) && M(h) && Te(this) && "nested" !== j.data) && (this._tTime = -1e-8, this.render(Math.max(0, -_) || 0)), x && Oe(this, x)
        }
        render(e, t, a) {
          ...
          if (p) {
            if (k !== this._tTime || !e || a || !this._initted && this._tTime || this._startAt && this._zTime < 0 !== _) {
              ...
              m && m.render(e < 0 ? e : !s && l ? -1e-8 : m._dur * m._ease(s / this._dur), t, a) || this._startAt && (this._zTime = e), this._onUpdate && !t && (_ && Se(this, e, 0, a), lt(this, "onUpdate")), this._repeat && n !== c && this.vars.onRepeat && !t && this.parent && lt(this, "onRepeat"), k !== this._tDur && k || this._tTime !== k || (_ && !this._onUpdate && Se(this, e, 0, !0), (e || !p) && (k === this._tDur && this._ts > 0 || !k && this._ts < 0) && je(this, 1), t || _ && !u || !(k || u || l) || (lt(this, k === f ? "onComplete" : "onReverseComplete", !0), this._prom && !(k < f && this.timeScale() > 0) && this._prom()))
            }
          } else((e, t, a, s) => {
            let r, n, o, c = e.ratio,
      ...
      ce("to,from,fromTo,delayedCall,set,killTweensOf", (e => ka[e] = Xt[e])), xt.add(Bt.updateRoot), g = ka.to({}, {
        duration: 0
      });
      let ba = (e, t) => {
          let a = e._pt;
      ...
      let Va, Fa, $a, Ga, Ua, Ha, Wa, qa, Xa, Ya = {},
        ...
        Ns = () => {
          "undefined" != typeof window && window.document && (Va = window, Fa = Va.document, $a = Fa.documentElement, Ua = ys("div") || {
            style: {}
          }, Ha = ys("div"), ps = js(ps), _s = ps + "Origin", Ua.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Xa = !!js("perspective"), qa = ya.core.reverting, Ga = 1)
        },
        Ss = function(e) {
        ...
        Ps = (e, t, a, s) => {
          let i, r, n, o, c = parseFloat(a) || 0,
            ...
            p = "px" === s,
            _ = "%" === s;
          return s === l || !c || Es[s] || Es[l] ? c : ("px" !== l && !p && (c = Ps(e, t, a, "px")), o = e.getCTM && Ms(e), !_ && "%" !== l || !Ya[t] && !~t.indexOf("adius") ? (d[m ? "width" : "height"] = f + (p ? l : s), r = ~t.indexOf("adius") || "em" === s && e.appendChild && !g ? e : e.parentNode, o && (r = (e.ownerSVGElement || {}).parentNode), r && r !== Fa && r.appendChild || (r = Fa.body), n = r._gsap, n && _ && n.width && m && n.time === xt.time && !n.uncache ? le(c / n.width * f) : ((_ || "%" === l) && !zs[xs(r, "display")] && (d.position = xs(e, "position")), r === e && (d.position = "static"), r.appendChild(Ua), i = Ua[u], r.removeChild(Ua), d.position = "absolute", m && _ && (n = ne(r), n.time = xt.time, n.width = r[u]), le(p ? i * c / f : i && c ? f / i * c : 0))) : (i = o ? e.getBBox()[m ? "width" : "height"] : e[u], le(_ ? c / i * f : c / 100 * i)))
        },
        Os = (e, t, a, s) => {
          let i;
          return Ga || Ns(), t in as && "transform" !== t && ~(t = as[t]).indexOf(",") && (t = t.split(",")[0]), Ya[t] && "transform" !== t ? (i = qs(e, s), i = "transformOrigin" !== t ? i[t] : i.svg ? i.origin : Xs(xs(e, _s)) + " " + i.zOrigin + "px") : (i = e.style[t], (!i || "auto" === i || s || ~(i + "").indexOf("calc(")) && (i = Vs[t] && Vs[t](e, t, a) || xs(e, t) || oe(e, t) || ("opacity" === t ? 1 : 0))), a && !~(i + "").trim().indexOf(" ") ? Ps(e, t, i, a) + a : i
        },
        As = function(e, t, a, s) {
          if (!a || "none" === a) {
            let s = js(t, e, 1),
    ...
    3544: (e, t, a) => {
      ...
      const Pe = {
        ...
        Re = "rockstargames-sites-gta-trilogyfa6885b15a718acb24f48949c52e31f1",
        Ve = e => {
          let {
            to: t,
            children: a
      ...
      const bt = function(e) {
        ...
        yt = bt((e => {
          ...
          const {
            track: p
          } = (0, se.useGtmTrack)(), _ = (0, o.useRef)(null), h = (0, o.useRef)(null), k = (0, o.useRef)(null), [b, v] = (0, o.useState)(null), [y, x] = (0, o.useState)(!1), [j, N] = (0, o.useState)(null), [S, T] = (0, o.useState)(), [C, M] = (0, o.useState)(), {
            ref: I,
            inView: L
          } = (0, ce.cD)({
            threshold: .6
        ...
        zt = N((e => {
          ...
          const i = (0, C.useLocation)(),
            ...
            _ = (0, o.useCallback)((e => {
              let t = i.pathname;
              const a = t.split("/");
              return v.map((e => e.subdomaincom)).includes(a[0]) && (t = a.slice(1).join("/")), f.currentSite?.site === g ? "en" === e ? `${window.location.origin}${t}${i.search}` : `${window.location.origin}/${e}${t}${i.search}` : `${window.location.origin}${t}${i.search}`
            }), [i]),
            h = (0, o.useRef)(null),
            [k, b] = (0, o.useState)(0),
          ...
          return (0, o.useEffect)((() => {
            ...
            "data-theme": t,
            children: [y && "sc-menu" === t && (0, w.jsx)("div", {
            ...
            }), (!y || "sc-menu" !== t) && (0, w.jsxs)(w.Fragment, {
              children: [(0, w.jsxs)("button", {
                onClick: e => {
      ...
      const Pa = e => {
        ...
        Da = "rockstargames-sites-gta-trilogyc4aa8e5d29b433c400796d0c493a9a4d",
        Ra = e => {
          let {
            minOffset: t = 0,
            maxOffset: a = 0,
      ...
      const os = {
        ...
        ds = e => {
          ...
          const {
            ...
            navOpen: b
          } = (0, se.useRockstarUserState)(), v = (0, o.useRef)(null), [y, x] = (0, o.useState)(0), [j, N] = (0, o.useState)(0), [S, T] = (0, o.useState)(!0);
          return (0, o.useEffect)((() => {
            m !== t && !1 === S && T(!0), m === t && T(!1)
          }), [m]), (0, o.useEffect)((() => {
            if (!v.current) return;
            ...
            children: [(0, w.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), k(n), m === t ? (g(-1), u(0)) : (g(t), u(y + j + j))
              },
              children: [(0, w.jsx)("span", {
        ...
        ms = e => {
          ...
          const {
            ...
            navOpen: f
          } = (0, se.useRockstarUserState)(), _ = (0, ae.useLocale)(), h = (0, ae.toScLocaleString)(_), [k, b] = (0, o.useState)(""), v = (0, C.useLocation)(), y = `${t.login}?returnUrl=${k}&lang=${h}`, x = `${t.signup}&returnUrl=${k}&lang=${h}`, j = (0, o.useMemo)((() => p()), []), N = (0, o.useMemo)((() => {
            const e = ((e, t, a) => [{
            ...
            return e
          }), [i, y, x, j]), [S, T] = (0, o.useState)(0), M = (0, o.createRef)(), I = () => {
            if (M.current) {
              const {
                current: e
        ...
        fs = e => {
          ...
          const {
            ...
            track: r
          } = (0, se.useGtmTrack)(), n = (0, d.c)(), [c, l] = (0, o.useState)([]), [m, g] = (0, o.useState)(null), [u, f] = (0, o.useState)(null), [p, _] = (0, o.useState)(!1), [h, k] = (0, o.useState)(-1), [b, v] = (0, o.useState)([]), [y, x] = (0, o.useState)(0), j = a(1084), [N, S] = (0, o.useState)("0"), [T, C] = (0, o.useState)("0"), M = e => parseInt(e, 10).toLocaleString("en-US", {
        ...
        _s = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            b(n.map(((e, t) => (e => {
              let t = 0;
              const a = n.length;
              return 1 === a ? .5 * m - .5 * x - 2 * s + N : (0 === e && (t = s - e * x), e === a - 1 && a > 1 && (t = a * x * -1 + (m - (s - N))), e > 0 && e < a - 1 && (t = e * x * -1 + (.5 * m - .5 * x + .5 * N)), t)
        ...
        vs = N((() => {
          const {
            ...
            track: v
          } = (0, se.useGtmTrack)(), [y, x] = (0, o.useState)(!1), j = (0, z.useReactiveVar)(se.scConfig), N = (0, o.useRef)(), [S, T] = (0, o.useState)(0), C = (0, o.createRef)(), [M, I] = (0, o.useState)(!1), [L, E] = (0, o.useState)(0), [P, O] = (0, o.useState)(!1), {
            mutateLSSettings: A,
            lsSettings: B
          ...
          return (0, o.useEffect)((() => {
            ...
            N.current && (!1 === l && !1 === y && (N.current.style.height = `${N.current.scrollHeight}px`), !0 === l && (N.current.style.height = null))
          }), [l, N, y]), (0, o.useEffect)((() => {
            const e = () => {
                k(!1), D(!0)
              },
      ...
      const Ws = Hs,
        ...
        ei = "rockstargames-sites-gta-trilogyeca98eb0b5b84a0c9a2e6d952545a2d5",
        ti = "rockstargames-sites-gta-trilogyd3d0b4ecd3bddba96c73f49fcca34ed8",
        ai = {
          0: {
            spaceBetween: 8
          },
      ...
      const pi = e => {
          ...
          return (0, w.jsx)("div", {
            role: "img",
            "aria-label": i,
            className: [fi.img, l ? fi.startAnimation : "", t ? fi.wide : ""].join(" "),
            style: {
        ...
        hi = e => {
          ...
          return (0, w.jsx)(I, {
            ...
            to: n,
            target: "_self",
            className: [_i.fobLink, o ? _i.wide : ""].join(" "),
            children: (0, w.jsx)(pi, {
              title: t.title,
              titleSlug: i,
              isWideCard: o
        ...
        bi = N((e => {
          ...
          return b = "games" === c ? (0, w.jsx)(w.Fragment, {
            ...
            children: [(0, w.jsxs)("h3", {
              ...
              className: [ki.items, f % 1 != 0 ? ki.partial : ""].join(" "),
              children: (0, w.jsx)("div", {
                className: ki.trackWrapper,
