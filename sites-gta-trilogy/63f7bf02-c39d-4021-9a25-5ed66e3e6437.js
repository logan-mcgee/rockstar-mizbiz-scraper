        ...
        updateSlides: function() {
          ...
          for (let n = 0; n < p; n += 1) {
            ...
            if (C = 0, u[n] && (i = u[n]), T && e.grid.updateSlide(n, i, u), !u[n] || "none" !== (0, a.o)(i, "display")) {
              ...
              u[n] && (u[n].swiperSlideSize = C), h.push(C), r.centeredSlides ? (S = S + C / 2 + x / 2 + y, 0 === x && 0 !== n && (S = S - s / 2 - y), 0 === n && (S = S - s / 2 - y), Math.abs(S) < .001 && (S = 0), r.roundLengths && (S = Math.floor(S)), E % r.slidesPerGroup == 0 && f.push(S), m.push(S)) : (r.roundLengths && (S = Math.floor(S)), (E - Math.min(e.params.slidesPerGroupSkip, E)) % e.params.slidesPerGroup == 0 && f.push(S), m.push(S), S = S + C + y), e.virtualSize += C + y, x = C, E += 1
            }
          }
          if (e.virtualSize = Math.max(e.virtualSize, s) + v, o && l && ("slide" === r.effect || "coverflow" === r.effect) && (n.style.width = `${e.virtualSize+y}px`), r.setWrapperSize && (n.style[e.getDirectionLabel("width")] = `${e.virtualSize+y}px`), T && e.grid.updateWrapperSize(C, f), !r.centeredSlides) {
            const t = [];
      ...
      var v = {
          slideTo: function(e, t, r, n, i) {
            ...
            if (s.initialized && o !== p) {
              if (!s.allowSlideNext && (f ? b > s.translate && b > s.minTranslate() : b < s.translate && b < s.minTranslate())) return !1;
              if (!s.allowSlidePrev && b > s.translate && b > s.maxTranslate() && (p || 0) !== o) return !1
            }
            let w;
            if (o !== (u || 0) && r && s.emit("beforeSlideChangeStart"), s.updateProgress(b), w = o > p ? "next" : o < p ? "prev" : "reset", f && -b === s.translate || !f && b === s.translate) return s.updateActiveIndex(o), l.autoHeight && s.updateAutoHeight(), s.updateSlidesClasses(), "slide" !== l.effect && s.setTranslate(b), "reset" !== w && (s.transitionStart(r, w), s.transitionEnd(r, w)), !1;
            if (l.cssMode) {
        ...
        b = {
          ...
          loopFix: function(e) {
            ...
            let b = v;
            b % v != 0 && (b += v - b % v), b += m.loopAdditionalSlides, d.loopedSlides = b;
            const w = d.grid && m.grid && m.grid.rows > 1;
            c.length < g + b ? (0, a.t)("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : w && "row" === m.grid.fill && (0, a.t)("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const y = [],
              S = [];
            let x = d.activeIndex;
            ...
            let C = 0,
              M = 0;
            const A = w ? Math.ceil(c.length / m.grid.rows) : c.length,
            ...
            if (d.__preventObserver__ = !0, requestAnimationFrame((() => {
              ...
              })), d.recalcSlides(), "auto" === m.slidesPerView ? d.updateSlides() : w && (y.length > 0 && T || S.length > 0 && E) && d.slides.forEach(((e, t) => {
