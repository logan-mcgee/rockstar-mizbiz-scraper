  ...
  return Object.defineProperty(r, "__esModule", {
    ...
    execute: function() {
      e((() => {
        var e, i, s, l, u = {
            9344: (e, t, r) => {
              ...
              function T(e, t) {
                let r = e.split("/"),
                  n = r.length;
                return r.some(P) && (n += L), t && (n += k), r.filter((e => !P(e))).reduce(((e, t) => e + (x.test(t) ? C : "" === t ? _ : D)), n)
              }
              ...
              function fe(e) {
                ...
                let _, D, L = !(C.some((e => e.route.lazy)) || C.some((e => e.route.loader)) && null == e.hydrationData),
                  P = {
                ...
                return _ = {
                  ...
                  fetch: function(t, r, n, d) {
                    ...
                    j = !0 === (d && d.preventScrollReset), g && Ae(g.formMethod) ? async function(t, r, n, o, d, h) {
                      ...
                      let C = Fe(h, g.data);
                      P.fetchers.set(t, C);
                      let [k, _] = me(e.history, P, R, h, b, I, B, F, K, q, S, f, {
                        [o.route.id]: g.data
                      }, void 0);
                      ...
                      let {
                        loaderData: O,
                        errors: N
                      } = Re(P, P.matches, k, A, void 0, _, M, V);
                      if (P.fetchers.has(t)) {
                        let e = $e(g.data);
                        P.fetchers.set(t, e)
                      }
            ...
            7461: (e, t, r) => {
              "use strict";
              var n = {
                  "./index": () => Promise.all([r.e(560), r.e(280)]).then((() => () => r(9280)))
                },
        ...
        return d.m = u, d.c = c, d.y = t, d.n = e => {
        ...
        }(), d.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = {}, i = "@rockstargames/sites-gta-trilogy:", d.l = (t, r, n, o) => {
          if (e[t]) e[t].push(r);
          else {
            var a, s;
            if (void 0 !== n)
          ...
          d.I = (r, n) => {
            ...
            if (o || (o = t[r] = {}), !(n.indexOf(o) >= 0)) {
              ...
              var a = d.S[r],
                ...
                u = [];
              return "default" === r && (s("framer-motion", "7.10.3", (() => d.e(96).then((() => () => d(4096))))), s("react-router-dom", "6.17.0", (() => () => d(9344)), 1), s("react", "18.2.0", (() => () => d(8188)), 1), s("usehooks-ts", "2.9.1", (() => d.e(713).then((() => () => d(713))))), l(8856), l(4472), l(8428), l(6964)), u.length ? e[r] = Promise.all(u).then((() => e[r] = 1)) : e[r] = 1
            }
          }
        })(), (() => {
          var e;
          ...
          var e = e => {
            ...
            o = {},
            a = {
              1320: () => n("default", "react-router-dom", [1, 6, 11, 2], (() => () => d(9344))),
              4900: () => n("default", "framer-motion", [1, 7, 5, 1], (() => d.e(96).then((() => () => d(4096))))),
              5620: () => n("default", "usehooks-ts", [1, 2, 7, 2], (() => d.e(713).then((() => () => d(713))))),
              8200: () => n("default", "react", [1, 18, 2, 0], (() => () => d(8188)))
            };
          [8200].forEach((e => {
            d.m[e] = t => {
              o[e] = 0, delete d.c[e];
