/*! For license information please see f4342befbc9962a9d1ca48e36f68dbf0.js.LICENSE.txt */
"use strict";
    ...
    799: (e, a, c) => {
      ...
      const n = e => {
        ...
        m = e => {
          ...
          const d = c.path.map((e => 1 === c.path.length && "_root" === e.feedback_type.name ? null : (0, b.jsx)(r.A, {
              to: `?step=${e.id_hash}`,
              className: f[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            t = c.next.map((e => "_root" === e.feedback_type.name ? null : (0, b.jsxs)(r.A, {
        ...
        k = e => {
          ...
          const {
            data: t
          } = (0, o.useRockstarUser)(), n = (0, s.useRef)(), [m, {
            data: k,
            error: l
          }] = (0, d.useMutation)(c);
          return t && !1 !== t?.user?.logged_in ? k?.submittal?.id ? (0, b.jsx)("div", {
            className: f.success,
            dangerouslySetInnerHTML: {
          ...
          }) : r("online-feedback-signin-0").replace("%s", r("signin-0"))
        },
        l = e => {
          let {
            mutation: a,
