/*! For license information please see 1a5a80dae07d919bbb37825f071e61cc.js.LICENSE.txt */ ! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "5d3e2316-99d3-461d-8465-ab8a3b6ba487", e._sentryDebugIdIdentifier = "sentry-dbid-5d3e2316-99d3-461d-8465-ab8a3b6ba487")
  } catch (e) {}
}();
    ...
    996: (e, a, c) => {
      ...
      function f(e, a, c) {
        var s, f = {},
          b = null,
          n = null;
        for (s in void 0 !== c && (b = "" + c), void 0 !== a.key && (b = "" + a.key), void 0 !== a.ref && (n = a.ref), a) d.call(a, s) && !t.hasOwnProperty(s) && (f[s] = a[s]);
        if (e && e.defaultProps)
    ...
    768: (e, a, c) => {
      ...
      const n = e => {
        ...
        l = e => {
          ...
          const r = c.path.map((e => 1 === c.path.length && "_root" === e.feedback_type.name ? null : (0, b.jsx)(o.A, {
              to: `?step=${e.id_hash}`,
              className: f[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            t = c.next.map((e => "_root" === e.feedback_type.name ? null : (0, b.jsxs)(o.A, {
        ...
        m = e => {
          ...
          const {
            data: t
          } = (0, d.useRockstarUser)(), n = (0, s.useRef)(), [l, {
            data: m,
            error: k
          }] = (0, r.useMutation)(c);
          return t && !1 !== t?.user?.logged_in ? m?.submittal?.id ? (0, b.jsx)("div", {
            className: f.success,
            dangerouslySetInnerHTML: {
              __html: o("feedback.enter_success")
            }
          }) : (0, b.jsxs)("form", {
            onSubmit: e => (e => {
              e.preventDefault(), (() => {
            ...
            children: [(0, b.jsx)("textarea", {
              ...
              maxLength: 500,
              rows: 6,
              placeholder: o("feedback.placeholder")
            }), k ? (0, b.jsx)("div", {
              className: f.error,
              children: String(k)
            }) : "", (0, b.jsx)("button", {
          ...
          }) : o("online-feedback-signin-0").replace("%s", o("signin-0"))
        },
        k = e => {
          let {
            mutation: a,
...
//# sourceMappingURL=1a5a80dae07d919bbb37825f071e61cc.js.map