! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "3e7b9ce1-644b-42b4-ac67-efbd43625720", e._sentryDebugIdIdentifier = "sentry-dbid-3e7b9ce1-644b-42b4-ac67-efbd43625720")
  } catch (e) {}
}();
    ...
    556: (e, a, c) => {
      ...
      const n = e => {
        ...
        l = e => {
          ...
          const r = c.path.map((e => 1 === c.path.length && "_root" === e.feedback_type.name ? null : (0, b.jsx)(o.NavLink, {
              to: `?step=${e.id_hash}`,
              className: f[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            t = c.next.map((e => "_root" === e.feedback_type.name ? null : (0, b.jsxs)(o.NavLink, {
        ...
        m = e => {
          ...
          return t ? m?.submittal?.id ? (0, b.jsx)("div", {
            className: f.success,
            dangerouslySetInnerHTML: {
