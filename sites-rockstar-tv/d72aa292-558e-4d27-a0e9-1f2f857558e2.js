try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "d72aa292-558e-4d27-a0e9-1f2f857558e2", e._sentryDebugIdIdentifier = "sentry-dbid-d72aa292-558e-4d27-a0e9-1f2f857558e2")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [4776, 6272], {
    686: e => {
      ...
      }), e.exports = t, e.exports.videoFields = i(t, "videoFields"), e.exports.VideoData = i(t, "VideoData")
    },
    3019: (e, t, a) => {
      var n = {
        "./de": [2666, 6879],
    ...
    7325: e => {
      ...
      }), e.exports = t, e.exports.videoFields = i(t, "videoFields"), e.exports.HomeData = i(t, "HomeData")
    },
    8525: (e, t, a) => {
      var n = {
        "./de": [5149, 9990],
    ...
    8613: (e, t, a) => {
      ...
      const _ = (e, t) => {
        ...
        f = () => {
          ...
          const s = `rockstarweb_lang.${t.cookieIdentifier}`,
            o = d(s);
          i = t.currentSite?.site === l.C.www ? b.find(e => e.subdomaincom === n) || b.find(e => e.subdomaincom === a) || r : b.find(e => e.iso === o) || r;
          const [, c] = ((e, t, a = !1) => {
            const n = d(e);
            return n && !a || _(e, t), [n, (r = e, e => {
              _(r, e)
            })];
            var r
          })(s, i.iso);
      ...
      function k(e) {
        const t = e.split("-");
        return (0, c.A)(t[1] ? t[0] : e, ["relativetimeformat", "pluralrules", "listformat"])
      }
    ...
    9611: (e, t, a) => {
      ...
      const c = "rockstargames-sites-rockstar-tvea8cf4797c830e5b5dad68b2ec814e67",
        ...
        _ = (d = ({
          ...
          const f = (0, r.useRef)(null),
            ...
            v = /^#/.test(t),
            g = b?.target ?? (_ ? "_blank" : "_self"),
            {
              ...h
            } = b,
            w = h["aria-current"] ?? !1;
          let y = "";
          if ("aria-label" in h && h["aria-label"] && (y = "_blank" === g ? `${h["aria-label"]} ${p.formatMessage(s.aria_label_open_new_window)}` : h["aria-label"]), (0, r.useEffect)(() => {
            ...
            return (0, n.jsxs)("a", {
              ...
              ref: f,
              role: d,
              children: [e, "_blank" === g && !y && (0, n.jsx)("span", {
                className: c,
      ...
      const f = {
        ...
        p = ({
          ...
          className: f.list,
          children: a.map(a => (0, n.jsxs)(_, {
            className: [f.item, e === a.id ? f.active : ""].join(" "),
            to: `${t}play?id=${a.id}`,
    ...
    9867: (e, t, a) => {
      ...
      const o = {
        ...
        l = () => {
          ...
          const {
            location: t
          } = window, a = t.hostname.substring(0, t.hostname.indexOf(".rockstargames.com")), n = c.findIndex(t => Object.entries(t.sites).findIndex(([t, n]) => n === a && (e = {
            site: t,
            subDomain: n
          }, !0)) >= 0), i = c[n >= 0 ? n : 0], o = c.find(e => e.id === i.fallbackEnvironment);
          return e || (e = {
            site: "www",
            subDomain: "local"
          }), s()(r()({}, o, {
