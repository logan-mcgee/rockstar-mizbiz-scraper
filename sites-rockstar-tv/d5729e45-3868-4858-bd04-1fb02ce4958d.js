try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "d5729e45-3868-4858-bd04-1fb02ce4958d", e._sentryDebugIdIdentifier = "sentry-dbid-d5729e45-3868-4858-bd04-1fb02ce4958d")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const c = (e, t) => {
        ...
        b = () => {
          ...
          const r = `rockstarweb_lang.${t.cookieIdentifier}`,
            o = _(r);
          a = t.currentSite?.site === l.C.www ? m.find(e => e.subdomaincom === s) || m.find(e => e.subdomaincom === i) || n : m.find(e => e.iso === o) || n;
          const [, d] = ((e, t, i = !1) => {
            const s = _(e);
    ...
    9611: (e, t, i) => {
      ...
      const l = "rockstargames-sites-rockstar-tvea8cf4797c830e5b5dad68b2ec814e67",
        ...
        _ = (d = ({
          ...
          const f = (0, n.useRef)(null),
            ...
            w = h["aria-current"] ?? !1;
          let y = "";
          if ("aria-label" in h && h["aria-label"] && (y = "_blank" === v ? `${h["aria-label"]} ${p.formatMessage(r.aria_label_open_new_window)}` : h["aria-label"]), (0, n.useEffect)(() => {
          ...
          if (k) return (0, s.jsxs)(o.NavLink, {
            title: c,
            to: t,
            onClick: u,
            ...h,
          ...
          const x = Object.keys(h).filter(e => !["activeClassName", "key", "end"].includes(e)).reduce((e, t) => ({
            ...e,
            [t]: b[t]
          }), {});
      ...
      const f = {
        ...
        p = ({
          ...
          className: f.list,
          children: i.map(i => (0, s.jsxs)(_, {
            className: [f.item, e === i.id ? f.active : ""].join(" "),
            to: `${t}play?id=${i.id}`,
            children: [(0, s.jsx)("div", {
              style: {
                background: `url(${i.screencap}) no-repeat center/contain`,
                "--aspect-ratio": 16 / 9
              }
            }), (0, s.jsx)("h5", {
              children: i.title
        ...
        N = () => (0, s.jsx)("div", {
          children: (0, s.jsx)("div", {
            ...
            children: (0, s.jsxs)("div", {
              ...
              children: [(0, s.jsx)(m, {}), (0, s.jsx)("div", {
    ...
    9867: (e, t, i) => {
      ...
      const s = {
        ...
        a = () => {
          ...
          const {
            location: t
          } = window, i = t.hostname.substring(0, t.hostname.indexOf(".rockstargames.com")), s = n.findIndex(t => Object.entries(t.sites).findIndex(([t, s]) => s === i && (e = {
            site: t,
            subDomain: s
          }, !0)) >= 0), a = n[s >= 0 ? s : 0];
          return e || (e = {
