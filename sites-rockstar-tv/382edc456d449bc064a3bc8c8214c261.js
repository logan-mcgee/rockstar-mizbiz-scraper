! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "32c20176-1365-4ae9-8016-bd2a0908429b", e._sentryDebugIdIdentifier = "sentry-dbid-32c20176-1365-4ae9-8016-bd2a0908429b")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [644], {
    7212: (e, a, t) => {
      ...
      const g = "www",
        ...
        _ = () => {
          ...
          const {
            location: a
          } = window, t = a.hostname.substring(0, a.hostname.indexOf(".rockstargames.com")), s = k.findIndex((a => Object.entries(a.sites).findIndex((a => {
            let [s, r] = a;
            return r === t && (e = {
              site: s,
              subDomain: r
        ...
        y = () => {
          const {
            ...
            return a?.split("=")[1]
          })(e), r = x, [i, c] = function(e, a) {
            let t = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const s = document.cookie.split("; "),
              r = `${e}=`,
              i = s.find((e => e.startsWith(r))),
              c = i?.substring(r.length, i.length);
            return c && !t || p(e, a), [c, (n = e, e => {
              p(n, e)
            })];
            var n
          }(`rockstarweb_lang.${a.cookieIdentifier}`, t ?? void 0);
          let n = r;
          return n = a.currentSite?.site === g ? h.find((e => e.subdomaincom === s)) || h.find((e => e.subdomaincom === t)) || r : h.find((e => e.iso === i)) || r, [n, c]
        };
      var N = t(5240);
      const j = e => {
        let {
      ...
      const I = "rockstargames-sites-rockstar-tvff481c537a56a6fcdb1be85dfbc8944e",
        T = e => {
          ...
          const n = (0, m.c)(),
            ...
            l = /^#/.test(t),
            d = c?.target ?? (r ? "_blank" : "_self");
          let {
            t: f,
            ...g
          } = c, u = "";
          if ("aria-label" in g && g["aria-label"] && (u = "_blank" === d ? `${g["aria-label"]} ${n.formatMessage(w.aria_label_open_new_window)}` : g["aria-label"]), l) {
            const e = e => {
            ...
            return (0, N.jsxs)("a", {
              ...
              children: [a, "_blank" === d && !u && (0, N.jsx)("span", {
                className: I,
                children: n.formatMessage(w.aria_label_open_new_window)
              })]
            })
          }
          ...
          const k = Object.keys(g).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, a) => ({
            ...e,
            [a]: c[a]
          })), {});
      ...
      const z = {
        ...
        $ = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            const e = () => {
              u.current && g.current && _(u.current.clientWidth > g.current.clientWidth)
            };
            return window.addEventListener("resize", e), e(), () => window.removeEventListener("resize", e)
          }), [u, g, a]), (0, o.useEffect)((() => {
            if (!f.current || !a?.duration) return;
            let e = null;
            const t = new(L())(f.current),
              r = e => {
                if (f.current) {
            ...
            return t.on("panstart", c), t.on("panleft", r), t.on("panright", r), t.on("panend", i), t.on("tap", r), () => {
              t.off("panstart", c), t.off("panleft", r), t.off("panright", r), t.off("panend", i), t.off("tap", r)
            }
            ...
            children: [(0, N.jsx)("div", {
              className: [z.controlsCurrentBg, p ? z.controlsCurrentBgVisible : ""].join(" ")
            }), (0, N.jsx)("div", {
        ...
        D = e => {
          ...
          }), [r, i] = (0, o.useState)(), [c, n] = (0, o.useState)(), [l, d] = (0, o.useState)(), [m, f] = (0, o.useState)(!1), [g, u] = (0, o.useState)(!1), [k, _] = (0, o.useState)(new HTMLAudioElement), [p, v] = (0, o.useState)({
            current: 0,
            duration: 0
          }), [b, h] = (0, o.useState)(!0);
          return (0, o.useEffect)((() => {
            const e = "audio",
              a = a => {
                a?.data?.rockstarAudioPlayerPlayTrackId && (n(a.data.rockstarAudioPlayerPlayTrackId), h(!1), u(!0)), g && a?.data?.attentionBlurredElsewhere && a?.data?.from !== e && u(!1)
              };
            ...
            k && (g ? k.play() : k.pause(), f(!1))
          }), [g, k, l?.id]), (0, o.useEffect)((() => {
            if (!c) return;
            const {
              tracks: e
      ...
      const H = {
        ...
        q = e => {
          ...
          const g = [H.plusButton, H[f] ?? "", H[l] ?? "", H[s] ?? "", t].join(" "),
            u = {
              "--hvr-color": a ?? c,
              "--hvr-bg-color": c ?? a,
        ...
        X = e => {
          ...
          return a.length ? (0, N.jsx)("div", {
            className: (0, G.classList)("rockstargames-sites-rockstar-tvb411a36e7fd12ab75861fe560b31b206", t),
            children: a.map(((e, a) => {
              let {
                icon: t,
                title: s,
      ...
      const Q = {
        ...
        ee = e => {
          ...
          const [f, g] = (0, o.useState)(0), u = (0, o.useMemo)((() => a && Array.isArray(a) ? a.map((() => (0, Y.c)())) : null), [a]);
          ...
          return (0, N.jsxs)("div", {
            className: (0, G.classList)(Q.deprecatedCarousel, Q[c], Q[`infinite_${!r}`], a ? Q.renderedWithChildren : "", i),
            style: s,
            ...
            }), (n?.title || n?.description) && (0, N.jsx)(Oe, {
              item: n
            })]
          })
        };
      ...
      const se = (0, t(2748).U1)(),
        ...
        ie = e => {
          ...
          const [s, r] = (0, o.useState)(!1), i = (e => {
            const [a] = (0, C.useSearchParams)(), [t, s] = (0, o.useState)(null), r = (0, te.useRockstarUser)(), {
              loggedIn: i
            } = r, {
              currentCharId: c
            } = (0, te.useRockstarUserState)(), n = function(e) {
          ...
          return (0, o.useEffect)((() => {
            r(i)
          }), [i]), (0, o.useMemo)((() => s ? t : null), [s])
        },
        ce = (0, ae.withTranslations)((e => {
          let {
            children: a
          } = e;
          return o.Children.map(o.Children.toArray(a), (e => (0, N.jsx)(ie, {
            ...e?.props
          })))
        }));
      var ne = t(1512),
      ...
      const le = e => {
        ...
        me = e => {
          ...
          const {
            ...
            skip: !0
          }), [i] = (0, E.useMutation)(oe.UserCastVote), [c, n] = (0, o.useState)(null), l = (0, o.useCallback)((e => {
            (async () => {
      ...
      const ve = e => {
          ...
          const [i, c] = (0, o.useState)(""), n = (0, o.useMemo)((() => pe()().getData()), []);
        ...
        je = e => {
          ...
          const {
            track: _
          } = (0, te.useGtmTrack)(), p = (0, ae.useDataLayer)(), v = r ?? a, b = `Redirect to ${t}`, h = (0, o.useMemo)((() => {
          ...
          }), [g, t, p]), y = () => c ? (0, N.jsx)("span", {
            className: [ye.icon, `icon-${n}`].join(" "),
            style: l,
          ...
          return (0, N.jsx)(C.NavLink, {
            ...
            className: [ye.cta, "platform" === i && f ? ye[f] : "", u ? ye.disabled : "", k].join(" "),
            style: s,
            "data-variant": i,
            onClick: x,
            disabled: u,
            "aria-label": b,
            children: "platform" === i && f ? (0, N.jsx)(Ne, {
              platform: f
            }) : (0, N.jsxs)("div", {
              className: ye.btnContent,
              children: ["left" === n && y(), (0, N.jsx)("span", {
                children: v
              }), "right" === n && y(), d ? (0, N.jsx)("span", {
                className: ye.badge,
                style: m,
                children: d
              }) : null]
      ...
      var Se = t(5652);
      const we = "rockstargames-sites-rockstar-tveb64520e04e486931cd65dc5b3fa61e8",
        Ce = "rockstargames-sites-rockstar-tvcc9a6fdcc84b758d60987ea9a5ddfd81",
        ...
        Te = e => {
          ...
          const [c, n] = (0, ae.usePreloadImg)(r);
          let o = r;
          !1 === c && (s === Ie && (o = t(1820)), o = t(3976));
          const {
            width: l,
            height: d
          } = n, m = {
        ...
        Me = e => {
          ...
          return n.desktop || n.mobile || (c = "placeholder", n = {
            ...
            style: s,
            children: n?.desktop && n?.mobile ? (0, N.jsxs)(N.Fragment, {
              children: [(0, N.jsx)(Te, {
                style: {
                  ...i,
                  ...r?.style
      ...
      const Be = {
        ...
        Pe = e => {
          ...
          const [m, f] = (0, o.useState)(null), g = t ? t.split("_#_") : a;
          return (0, o.useEffect)((() => {
            f(a)
            ...
            children: (0, N.jsx)("ul", {
              ...
              className: (0, G.classList)(Be.itemList, Be.noImg, Be[s], Be[c]),
            ...
            style: (0, ae.safeStyles)(r),
            className: (0, G.classList)(Be.itemList, Be.custom, n ? Be.noImg : "", s ? Be[s] : "", c ? Be[c] : "", i ?? ""),
        ...
        De = "rockstargames-sites-rockstar-tvfa6885b15a718acb24f48949c52e31f1",
        Ae = e => {
          let {
            to: a,
            children: t
        ...
        Oe = e => {
          ...
          return (0, N.jsxs)("div", {
            className: (0, G.classList)("rockstargames-sites-rockstar-tvef9e6981551ac5ce250ebff8b18d7a29", t),
      ...
      const Re = e => {
        ...
        Ue = e => {
          ...
          let n = 100;
          return 2 == c.length && c[1].length < 4 && "off" !== c[1].toLowerCase() && 45, (0, N.jsxs)(He, {
            splitter: i,
            role: r,
            ...
            children: [(0, N.jsx)(N.Fragment, {
              ...
              children: c.shift() && i && c.length >= 1 && (0, N.jsx)(Re, {
                min: 8,
                max: 1e3,
                mode: "single",
        ...
        We = "rockstargames-sites-rockstar-tvc63cfb461217f059c8c25eec09602b30",
        qe = e => {
          let {
            color: a
          } = e;
      ...
      const Ke = {
        ...
        Ye = e => {
          ...
          return (0, N.jsx)(Xe.cp, {
            disabled: !r,
            children: (0, N.jsxs)("div", {
              className: [Ke.dropdownWrapper, r ? Ke.open : "", void 0 !== t ? t : ""].join(" "),
              children: [(0, N.jsx)("button", {
                className: Ke.opener,
                onClick: () => i(!r),
                children: s
      ...
      const Ze = e => {
          ...
          return (0, N.jsx)("div", {
            id: d,
            className: (0, Qe.classList)("rockstargames-sites-rockstar-tvf42b4606ed4a5b16b7647ad7b7eb229d", o ? "rockstargames-sites-rockstar-tvb00444166ce6346d7ca364a75a335ecc" : "", l),
      ...
      const ta = {
        ...
        oa = e => {
          ...
          const n = i ?? (s.startsWith(document.location.origin) ? "_self" : "_blank"),
            o = [na.platformButton, na[r]].join(" "),
            l = r ? t(3892)(`./${r}.svg`) : null,
        ...
        la = e => {
          ...
          return (0, N.jsxs)("div", {
            className: (0, G.classList)(na.container, s),
            children: [(0, N.jsx)(aa.q.div, {
              ...
              children: [(0, N.jsx)(aa.q.div, {
                ...
                className: na.expandedArea,
                animate: m ? "open" : "closed",
                variants: ia,
                initial: !1,
                children: [(0, N.jsx)("img", {
                  className: na.closeButton,
                  onClick: () => f(!1),
                  onKeyDown: e => {
                    f(!1)
                  },
                  ...
                  className: na.platformButtons,
                  children: i.length ? i.map((e => (0, N.jsx)(oa, {
        ...
        ua = e => {
          ...
          return (0, N.jsx)(T, {
            ...
            to: n,
            target: "_self",
            className: "rockstargames-sites-rockstar-tvfded54fb94f7325c5a0b57590585b175",
            children: (0, N.jsx)(ga, {
              imgSrc: s,
              title: a.title
            })
        ...
        _a = e => {
          ...
          const [c, n] = (0, o.useState)(!1), l = (0, E.useMutateState)(), {
            navHidden: d
          } = (0, E.useState)();
          return (0, o.useEffect)((() => {
            l({
            ...
            "data-game": i,
            className: [ka.gameSiteHeader, c ? ka.headerNavOpen : "", d ? ka.navHidden : "", t.gameSiteHeader, c ? t.headerNavOpen : ""].join(" "),
            children: [(0, N.jsx)("button", {
              className: [ka.headerLogo, t.headerLogo].join(" "),
              onClick: e => {
      ...
      const ba = function(e) {
        ...
        xa = ba((e => {
          ...
          const {
            track: u
          } = (0, te.useGtmTrack)(), k = (0, o.useRef)(null), _ = (0, o.useRef)(null), p = (0, o.useRef)(null), [v, b] = (0, o.useState)(null), [h, x] = (0, o.useState)(!1), [y, j] = (0, o.useState)(null), [S, w] = (0, o.useState)({}), [C, I] = (0, o.useState)(), {
            ref: T,
            inView: M
          } = (0, ne.cD)({
            threshold: .6
          ...
          return (0, N.jsxs)("div", {
            className: (0, G.classList)("rockstargames-sites-rockstar-tvd0c3d91603036c852633939015a6cb48", d),
            "data-size": s,
            "data-sm": m?.sm ? m?.sm : s,
            "data-md": m?.md ? m?.md : s,
            "data-lg": m?.lg ? m?.lg : s,
            ...
            children: [(0, N.jsx)("div", {
              ...
              modules: [pa._2],
              breakpoints: V,
              slideClass: (0, G.classList)("swiper-slide", n),
        ...
        Sa = e => {
          ...
          const r = (0, G.useGetCdnSource)(t ?? null),
        ...
        Ca = e => {
          ...
          return (0, o.useEffect)((() => {
            n(t.reduce(((e, a) => a.isInExpandingButton ? (e.push({
              href: a.href,
              platform: a.platform,
          ...
          }), t), t.length ? c.length ? (0, N.jsx)(aa.q.div, {
              ...
              return Object.entries(e).forEach((e => {
                ...
                if (t.has(s)) {
                  ...
                  Object.entries(r).forEach((r => {
                    ...
                    if (t.has(s) && t.has(i)) {
                      const s = `${t.get(i)}${e}`;
                      a[s] = "imageWidth" !== i ? c ? `${c}px` : "0px" : c ? `${c}vw` : "100vw"
                    }
                  }))
                }
              })), a
            })(l),
            k = (0, G.useGetCdnSource)(t?.mobile?.full_src ?? null),
            _ = (0, G.useGetCdnSource)(t?.desktop?.full_src ?? k),
            p = (0, G.useGetCdnSource)(o?.mobile?.full_src ?? null),
            v = (0, G.useGetCdnSource)(o?.desktop?.full_src ?? p);
          return (0, N.jsxs)(aa.q.div, {
      ...
      const Ea = e => {
          ...
          return (0, N.jsx)("span", {
            className: (0, G.classList)(s, t?.className, "rockstargames-sites-rockstar-tva7f106a8036d74ed9282a741476c6b5a"),
            style: (0, ae.safeStyles)(r ?? t?.style ?? {}),
            dangerouslySetInnerHTML: {
        ...
        $a = S((e => {
          ...
          const r = (0, C.useLocation)(),
            ...
            k = (0, o.useCallback)((e => {
              let a = r.pathname;
              const t = a.split("/");
              return h.map((e => e.subdomaincom)).includes(t[0]) && (a = t.slice(1).join("/")), u.currentSite?.site === g ? "en" === e ? `${window.location.origin}${a}${r.search}` : `${window.location.origin}/${e}${a}${r.search}` : `${window.location.origin}${a}${r.search}`
            }), [r]),
            p = (0, o.useRef)(null),
            [v, b] = (0, o.useState)(0),
            ...
            j = e => {
              ...
              a && (n(a.iso), window.location.href = k(e))
            };
          return (0, o.useEffect)((() => {
        ...
        Da = e => {
          ...
          return r && (s["--border-image-source"] = `url(${(0,G.useGetCdnSource)(r)})`), (0, N.jsx)("div", {
          ...
          children: (0, N.jsxs)("div", {
            ...
            children: [e?.images?.map(((e, a) => {
              ...
              return (0, N.jsx)(Me, {
                ...
                imageStyle: d,
                className: (0, G.classList)(l, f, Va.imageLayer, Va[s], Va[r], Va[i], Va[c], Va[n]),
                alt: m
              }, o ?? ++a)
        ...
        Fa = e => {
          ...
          return (0, N.jsx)(Oa, {
            ...
            children: (0, N.jsx)("figure", {
              children: (0, N.jsxs)("div", {
                className: (0, G.classList)("rockstargames-sites-rockstar-tvcab262c98c7f5bb3e982d9b075b3c2a8", d ? "rockstargames-sites-rockstar-tvcefd6d8859aeec1057caed28caa160c3" : "", o?.hiddenMobile ? "hiddenMobile" : "", o?.hiddenLarge ? "hiddenLarge" : "", o?.className, n),
                ...
                children: [(0, N.jsx)(Me, {
                  image: i,
                  className: n
                }), (i?.badge || i?.discountTxt || a || s) && (0, N.jsx)(Ue, {
        ...
        qa = e => {
          ...
          const [i] = (0, C.useSearchParams)(), c = t.preview_images_parsed.newswire_block, n = {
            default: 0 !== a || s ? c.square || c.d16x9 || c._fallback : c.d16x9 || c.square || c._fallback,
            mobile: c.square || c._fallback
          }, [o, l] = (0, ae.usePreloadImg)(n.default), [d, m] = (0, ae.usePreloadImg)(n.mobile), f = {
            default: {
      ...
      const Ya = (0, ae.withTranslations)((e => {
          ...
          const [i] = (0, C.useSearchParams)(), {
            tagId: c = null
          } = (0, C.useParams)(), [n, l] = (0, o.useState)(c ?? t ?? i.get("tag_id")), [d, m] = (0, o.useState)(1), [f, g] = (0, o.useState)([]), [u, k] = (0, o.useState)(null), {
            data: _
          } = (0, E.useQuery)(Ka(), {
            variables: {
              tagId: Number(n),
          ...
          return (0, o.useEffect)((() => {
            m(1), g([]), l(c ?? t ?? i.get("tag_id"))
          }), [i.get("tag_id")]), (0, o.useEffect)((() => {
            _ && _.posts && _.posts.paging && k(_.posts.paging), _ && _.posts && _.posts.results && g(f.concat(_.posts.results))
          }), [_]), f.length ? (0, N.jsxs)(N.Fragment, {
            children: [(0, N.jsx)(et, {
              posts: f,
              relativeTo: a,
        ...
        st = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            children: (0, N.jsx)("ol", {
              style: (0, ae.safeStyles)(r),
              className: (0, G.classList)(at.itemList, at.noImg, at[s], at[c]),
              children: m.map((e => (0, N.jsx)("li", {
                dangerouslySetInnerHTML: {
                  __html: tt(e.content)
                }
            ...
            style: (0, ae.safeStyles)(r),
            className: (0, G.classList)(at.itemList, at.custom, n ? at.noImg : "", s ? at[s] : "", c ? at[c] : "", i ?? ""),
        ...
        lt = e => {
          ...
          const [m, f] = (0, o.useState)(!1), [g, u] = (0, o.useState)(d);
          (0, o.useEffect)((() => {
            if (i) {
          ...
          return (0, ae.usePreloadImg)(k, (() => u(!0))), (0, N.jsx)(C.NavLink, {
            className: [ot.packCard, r, m ? ot.packCompleted : ""].join(" "),
            to: t,
            onClick: c,
            children: (0, N.jsxs)("div", {
              className: [ot.packCardImageBox, g ? ot.packCardImageLoaded : ""].join(" "),
              style: {
        ...
        mt = e => {
          let {
            ...
            packGridClassName: r = dt.packGrid,
            selectPackCard: i,
            sortFunction: c = rt
          } = e;
        ...
        ft = {
          pillBtn: "rockstargames-sites-rockstar-tve2620ca79db4bb12b74eb4adbcba56ce",
          selected: "rockstargames-sites-rockstar-tvd429050d220c77a1c9e8631f9b9f4f02",
          navPill: "rockstargames-sites-rockstar-tvc3ef0af25cfc7d1d0048148984230190"
        },
        gt = e => {
          let {
            title: a,
          ...
          return (0, N.jsx)("button", {
            type: "button",
            onClick: t,
            className: [ft.navPill, s ? ft.selected : ""].join(" "),
            children: (0, N.jsx)("div", {
              children: a
            })
          })
      ...
      const _t = e => o.createElement("svg", kt({
        xmlns: "http://www.w3.org/2000/svg",
        width: 24,
        height: 24,
        fill: "none"
      ...
      const bt = e => o.createElement("svg", vt({
        ...
        ht = {
          pillBtn: "rockstargames-sites-rockstar-tvfaa583ebd1250f30b148562c5964fa46",
          selected: "rockstargames-sites-rockstar-tvf55ea6a51cd0de4060f152d9a070e040",
          navScrollButton: "rockstargames-sites-rockstar-tvb13f52032a7c6105f881b2a3764d7ba6"
        },
        xt = e => {
          let {
            direction: a,
          ...
          return (0, N.jsxs)("button", {
            ...
            ...s,
            children: ["left" === a && (0, N.jsx)(_t, {}), "right" === a && (0, N.jsx)(bt, {})]
          })
        },
        yt = (0, l.Os)({
          plm_nav_scroll_left: {
        ...
        jt = e => {
          let {
            ...
            isOpen: r,
            isHeaderVisible: i,
            menuClass: c = Nt.navMenu,
            menuContainerClass: n = Nt.navMenuMain,
            menuSectionClass: l = Nt.sectionMenu,
            menuPrevBtnClass: d = Nt.previousNavButton,
            menuNextBtnClass: f = Nt.nextNavButton
          } = e;
          const g = (0, m.c)(),
            {
              track: u
            ...
            T = (0, o.useCallback)(((e, t) => {
              M(`Secondary Nav > ${a[p].title} > ${e}`, t), s()
            }), [a, s, p, u]),
            M = (e, a) => {
              u({
                event: "nav_click",
              ...
              children: [(0, N.jsxs)("div", {
                ...
                children: [!j && b && (0, N.jsx)("div", {
                  ...
                  children: (0, N.jsx)(xt, {
                    ...
                    "aria-label": g.formatMessage(yt.plm_nav_scroll_left)
                  })
                }), (0, N.jsx)("div", {
                  ...
                  children: (0, N.jsx)(xt, {
                    ...
                    "aria-label": g.formatMessage(yt.plm_nav_scroll_right)
                  })
                })]
              }), (0, N.jsx)(mt, {
                isHeaderVisible: i,
        ...
        St = "rockstargames-sites-rockstar-tvc54c374409e11d1429ce99457cbf7441",
        wt = e => {
          let {
            children: a,
            data: t,
          ...
          return (0, N.jsx)("a", {
            href: "#",
            className: r === t.page ? `rockstargames-sites-rockstar-tvc0eebf4f915ff9f5cc362e22d6d7d976 ${i??""}` : "",
            onClick: e => {
      ...
      const Tt = e => {
        ...
        Et = e => {
          ...
          return (0, N.jsx)(It.Sr, {
            className: (0, G.classList)("rockstargames-sites-rockstar-tvb8c85703a3c76902e49a61a6afcb81bc", t),
            layers: i,
            style: s
          })
        },
        Bt = "rockstargames-sites-rockstar-tvc4aa8e5d29b433c400796d0c493a9a4d",
        zt = e => {
          let {
            minOffset: a = 0,
            maxOffset: t = 0,
        ...
        Qt = () => {
          const e = (0, E.useReactiveVar)(Ft),
            ...
            r = (0, E.useReactiveVar)(Kt);
          return (0, o.useEffect)((() => {
            r || (e && Rt(!1), s && (Xt(!1), Ht(-1)))
          }), [r]), (0, o.useEffect)((() => {
            !e && r && (s || Xt(!0))
          }), [e, r]), (0, o.useMemo)((() => ({
      ...
      const as = {
        ...
        rs = e => {
          ...
          const {
            track: f
          } = (0, te.useGtmTrack)(), g = _();
          let u = s;
          r && (u = r.domain === g.currentSite?.site ? r.path : `https://${g.sites[r.domain]}.rockstargames.com${r.path}`);
          const k = {
            ...i,
            link_url: u
          };
          return (0, N.jsxs)(C.Link, {
            className: n ? ss.scSubLink : ss.scLink,
        ...
        is = e => {
          ...
          }), [h, _, p]), d.length > 0 ? (0, N.jsxs)(N.Fragment, {
            children: [(0, N.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), v(c), m === a ? (f(-1), g(0)) : (f(a), g(x + j + j))
              },
              children: [(0, N.jsx)("span", {
        ...
        cs = e => {
          ...
          const {
            ...
            navOpen: u
          } = (0, te.useRockstarUserState)(), k = (0, ae.useLocale)(), p = (0, ae.toScLocaleString)(k), [v, b] = (0, o.useState)(""), h = (0, C.useLocation)(), x = `${a.login}?returnUrl=${v}&lang=${p}`, y = `${a.signup}&returnUrl=${v}&lang=${p}`, j = (0, o.useMemo)((() => _()), []), S = (0, o.useMemo)((() => {
            const e = ((e, a, t) => [{
            ...
            return e
          }), [r, x, y, j]), [w, I] = (0, o.useState)(0), T = (0, o.createRef)(), M = () => {
            if (T.current) {
              const {
                current: e
          ...
          return (0, o.useEffect)((() => {
            ...
            children: [(0, N.jsx)("nav", {
              ...
              children: (0, N.jsx)("div", {
                ...
                children: S.map((e => (0, o.createElement)(is, {
                  ...e,
                  activeSubNavId: n,
                  setActiveSubNavId: l,
                  setSubNavExtraHeight: f,
        ...
        ls = e => {
          ...
          const {
            ...
            track: i
          } = (0, te.useGtmTrack)(), c = (0, m.c)(), [n, l] = (0, o.useState)([]), [d, f] = (0, o.useState)(null), [g, u] = (0, o.useState)(null), [k, _] = (0, o.useState)(!1), [p, v] = (0, o.useState)(-1), [b, h] = (0, o.useState)([]), [x, y] = (0, o.useState)(0), j = t(1084), [S, w] = (0, o.useState)("0"), [C, I] = (0, o.useState)("0"), T = e => parseInt(e, 10).toLocaleString("en-US", {
          ...
          (0, o.useEffect)((() => {
            ...
            n && n.forEach((e => {
              !0 === e.isPrimary && (f(e.crewTag), u(e.crewColour), v(e.rankOrder), _(!1), !0 === Object.prototype.hasOwnProperty.call(e, "crewType") && "rockstar" === e.crewType && _(!0))
            }))
          }), [n]), (0, o.useEffect)((() => {
            const e = [];
            if (!k && p > -1)
              for (let a = 5; a > p; a -= 1) e.push((0, N.jsx)("div", {
          ...
          const d = (0, o.createRef)(),
            ...
            z = e => {
              ...
              i > a ? (s > 0 ? (() => {
                ...
                e < 0 && (e = 0), k(e), x(v[e]), r && r(e)
              })(), p(0)) : x(v[u] + i * s)
            },
            P = () => {
              !0 !== f && !0 !== l && (g(!0), !0 !== f && (x(v[u]), p(0)))
            };
          return (0, o.useEffect)((() => {
            const e = [];
            c.forEach((() => {
        ...
        gs = (0, ae.withTranslations)((e => {
          ...
          const {
            ...
            setSelectedCharacterTuple: G,
            setUserData: H
          } = (0, te.useRockstarUserState)(), [U, W] = (0, o.useState)(null), [q, X] = (0, o.useState)(null), [K, Y] = (0, o.useState)(!1), [Q, Z] = (0, o.useState)(!1), [J, ee] = (0, o.useState)(0), se = (0, o.createRef)(), re = ds(se, !1), ie = (0, o.createRef)(), [ce, ne] = (0, o.useState)(0), [oe, le] = (0, o.useState)([]), [de, me] = (0, o.useState)(244), fe = (0, o.useMemo)((() => _()), []), ge = (0, o.useMemo)((() => ((e, a, t, s, r) => [{
          ...
          }])(p, a, P, A, I, window)), [p, a, P, A, I, fe]), ue = () => {
            Z(i + de * J < re)
          }, ke = () => {
            if (ie.current) {
              const {
                current: e
              } = ie, a = e?.scrollHeight, t = window.getComputedStyle(e);
              if (t) {
                let e = 16 * parseInt(t.getPropertyValue("--scSubNav-opened-margin"), 10) * 2;
          ...
          return (0, o.useEffect)((() => {
            ...
            X(t), W(a), oe.length > 1 ? Y(!0) : Y(!1), n(oe.length - 1 > 3)
          }), [D, oe]), (0, o.useEffect)((() => {
            ue()
          }), [J, l, g, oe]), (0, o.useEffect)((() => {
            ke(), Jt()((() => {
              setTimeout(ke, 0)
            }), 300)
          }), [g, k]), (0, o.useEffect)((() => {
            ...
            children: [null !== U && "gtao" === V && (0, N.jsxs)("div", {
              className: fs.scProfile,
              tabIndex: -1,
              "aria-label": p.formatMessage(Vt.profile_selector_profile_card),
              children: [(0, N.jsx)(ls, {
                s: fs,
                character: U,
                platformTag: q
              }), !0 === K && (0, N.jsxs)("div", {
                className: fs.scCharacterSelector,
                children: [(0, N.jsx)("button", {
                  className: fs.scCharacterSelectBtn,
                  type: "button",
                  onClick: e => {
                    e.stopPropagation();
                    const a = !t;
                  ...
                  className: fs.scCharacterList,
                  "data-long-list": c,
                  "aria-hidden": t,
                  ref: r,
                  children: oe.map((e => (0, N.jsx)(ns, {
                    tabIndex: t ? -1 : 0,
                    characterData: e,
                  ...
                  children: (0, N.jsx)(ms, {
                    ...
                    disablePager: Q,
                    disableSwiper: Q,
                    children: oe.filter(((e, a) => a !== D)).map((e => (0, o.createElement)(ns, {
                      characterData: e,
                      setMobileCardWidth: me,
                      key: e.mugshotUrl,
                      tabIndex: t ? -1 : 0
              ...
              children: [(0, N.jsx)("button", {
                ...
                children: ge.map(((e, a) => (0, o.createElement)(is, {
                  ...e,
                  id: a,
                  activeSubNavId: h,
                  setActiveSubNavId: x,
              ...
              className: fs.scLanguageSelector,
              style: {
        ...
        ks = S((() => {
          ...
          return (0, o.useEffect)((() => {
            ...
            c && (s && r(!1), l || A(!0))
          }), [c]), null === _ ? null : (0, N.jsxs)(N.Fragment, {
            children: [(0, N.jsxs)("div", {
        ...
        vs = S((e => {
          ...
          return (0, o.useEffect)((() => {
            const e = s?.id ?? !1,
              a = e ? (b?.[i]?.mugshotUrl ?? s?.avatar) || _s : ps,
              t = Pt(b?.[i]?.platform, "small") ?? null;
            _(t), f(a), u(e), v(!!b?.[i]?.mugshotUrl)
          }), [s, b, i, _s, ps]), (0, N.jsxs)("button", {
            ...
            children: [(0, N.jsx)("img", {
              ...
              "data-platform": b?.[i]?.platform ?? null
            })]
          })
        }), Ba),
        bs = {
        ...
        hs = e => {
          ...
          const [m, f] = (0, o.useState)(!1), {
            ...
            "--promo-image": `url(${(0,G.useGetCdnSource)(n)})` ?? 0,
          ...
          return (0, o.useEffect)((() => {
            ...
            ref: g,
            children: [(0, N.jsx)("div", {
              className: [bs.promoModuleImage, c ? bs.gradient : "", "left" === l ? bs.left : bs.right].join(" ")
            }), (0, N.jsxs)("div", {
      ...
      const js = ba(S((e => {
          ...
          return (0, N.jsxs)("div", {
            ...
            style: (0, ae.safeStyles)(n),
            children: [(0, N.jsx)(T, {
              to: u.url_rating,
              target: "_blank",
              children: (0, N.jsx)("img", {
                alt: p.formatMessage(Ns.components_ratings_link_alt, {
        ...
        Ms = e => {
          ...
          return void 0 !== t && (c.gridTemplateColumns = `repeat(${t}, 1fr)`), void 0 !== r && (c.gridTemplateRows = `repeat(${r}, 1fr)`), (0, N.jsx)("div", {
        ...
        zs = e => {
          ...
          const [c, n] = (0, ae.usePreloadImg)(a);
          return c ? (i.backgroundImage = `url(${a})`, (0, N.jsx)("div", {
            role: "img",
        ...
        As = (0, o.forwardRef)(((e, a) => {
          const {
            ...
            track: c
          } = (0, te.useGtmTrack)(i), [n, l] = (0, o.useState)(a?.current);
          return (0, o.useEffect)((() => {
            ...
            const n = (0, o.useCallback)((() => {
              ...
              if (i) {
                ...
                if (m >= e) {
                  ...
                  0 === s.length && (t ?? window).removeEventListener("scroll", n), a && a({
                    scrollY: e,
                    scrollPercent: m,
                    remainingDepths: s
                  }), r({
        ...
        Os = (0, ae.withTranslations)((e => {
          ...
          const [t] = (0, o.useState)(""), s = (0, C.useNavigate)(), r = (0, E.useMutateState)();
        ...
        qs = "rockstargames-sites-rockstar-tveca98eb0b5b84a0c9a2e6d952545a2d5",
        Xs = "rockstargames-sites-rockstar-tvd3d0b4ecd3bddba96c73f49fcca34ed8",
        Ks = {
          0: {
            spaceBetween: 8
          },
        ...
        Ys = e => {
          ...
          const {
            track: l
          } = (0, te.useGtmTrack)(), [d, m] = (0, o.useState)([pa.O4, pa.Hj, pa.eM]), [f, g] = (0, o.useState)(null), [u, k] = (0, o.useState)(null);
          return (0, o.useEffect)((() => {
            const e = [pa.O4, pa.Hj, pa.eM];
            r && e.push(pa._2), m(e)
          }), [r]), (0, o.useEffect)((() => {
            if (!i) return;
      ...
      const Zs = e => {
        ...
        Js = ba((e => {
          ...
          if (!i) return (0, N.jsx)(Rs, {
            skeleton: r
          });
          const c = i?.[0]?.tina;
          return c ? (0, N.jsx)(N.Fragment, {
            children: i.map(((e, t) => {
              let {
                tina: s
              } = e;
      ...
      const tr = {
        ...
        sr = e => {
          ...
          const {
            ...
            refetch: n
          } = (0, E.useQuery)(ar.UserGetVote, {
            skip: !0
          }), [l] = (0, E.useMutation)(ar.UserCastVote), [d, m] = (0, o.useState)(null), f = (0, o.useCallback)((async e => {
            i({
          ...
          return (0, o.useEffect)((() => {
            ...
            children: (0, N.jsxs)("div", {
              ...
              children: [(0, N.jsxs)("div", {
                ...
                className: [tr.voteButtons, c ? "" : tr.loggedOutButtons].join(" "),
                children: [(0, N.jsx)("button", {
                  onClick: () => f(!0),
                  className: [tr.upVote, d ? tr.voteButtonActive : ""].join(" "),
                  type: "button",
                  "aria-label": "Vote up"
                }), (0, N.jsx)("button", {
                  className: [tr.downVote, !1 === d ? tr.voteButtonActive : ""].join(" "),
                  onClick: () => f(!1),
                  type: "button",
        ...
        ir = (0, ae.withLocale)((e => {
          ...
          } = (0, ae.useBodyScrollable)(), [i, c] = (0, o.useState)(0), [n, l] = (0, o.useState)(0), d = (0, o.useRef)(null), m = (0, o.useRef)(null);
          return (0, o.useEffect)((() => {
            ...
            const a = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
              ...
              o = e => {
                l(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !m.current?.classList.contains(rr.dragging) || a() && r(!1)
              },
              f = () => {
                a() && r(!0), l(0)
              },
              ...
              u = () => {
                a() && r(!0), d.current && d.current.classList.remove(`${rr.disableClick}`)
              },
              k = () => {
                a() && r(!0)
              };
            return m.current.addEventListener("transitionend", k), e.on("swiperight", t), e.on("swipeleft", n), e.on("pan", o), e.on("panend", f), e.on("press tap", g), e.on("pressup", u), () => {
              e.off("swiperight", t), e.off("swipeleft", n), e.off("pan", o), e.off("panend", f), e.off("press tap", g), e.off("pressup", u), m.current && m.current.removeEventListener("transitionend", k), l(0)
            }
            ...
            children: [(0, N.jsx)("div", {
              ...
              ref: d,
              children: (0, N.jsx)("div", {
                className: `${rr.items} ${0!==n?rr.dragging:""}`,
                ref: m,
                style: {
        ...
        or = S((e => {
          ...
          const i = (0, m.c)(),
            ...
            n = "videos" === c ? a : t.results,
            l = (0, o.useRef)(null),
            [d, f] = (0, o.useState)(0),
            [g, u] = (0, o.useState)(0),
            k = e => {
              const a = Math.ceil(n.length / d);
              let t = e;
          ...
          return (0, o.useEffect)((() => {
            ...
            return {}
          }), [l.current, g]), v = "games" === c ? (0, N.jsx)(N.Fragment, {
            ...
            children: [(0, N.jsxs)("h3", {
              ...
              children: [s, (0, N.jsxs)("div", {
                ...
                children: [(0, N.jsx)("button", {
                  className: [nr.arrow, nr.previous, 0 === g ? nr.disabled : ""].join(" "),
                  onClick: () => k(g - 1),
                  type: "button",
                  "aria-label": `${0===g?i.formatMessage(cr.disabled_label)+", ":""}${i.formatMessage(cr.previous_button_label)}`
                }), (0, N.jsx)("button", {
                  className: [nr.arrow, nr.next, g === Math.ceil(n.length / d) - 1 ? nr.disabled : ""].join(" "),
                  onClick: () => k(g + 1),
                  type: "button",
                  "aria-label": `${g===Math.ceil(n.length/d)-1?i.formatMessage(cr.disabled_label)+", ":""}${i.formatMessage(cr.next_button_label)}`
                })]
              })]
            }), (0, N.jsx)("div", {
              className: nr.items,
              children: (0, N.jsx)("div", {
                ...
                children: (0, N.jsx)("div", {
                  className: [nr.track, 0 !== _ ? nr.dragging : ""].join(" "),
                  ref: l,
                  style: {
                    transform: `translateX(calc(-${100*g}% + ${_}px - (var(--standard-grid-gap) * ${g}))`,
      ...
      class gr extends o.Component {
        ...
        render() {
          return null !== this.state.error.code ? (0, N.jsx)(lr, {
      ...
      const vr = (0, o.forwardRef)(((e, a) => {
        ...
        Tr = function() {
          ...
          return Ir[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "imageMask"][e]
        };
      var Mr = t(544);
    ...
    5492: (e, a, t) => {
      ...
      s.definitions = s.definitions.concat(i(t(3784).definitions)), s.definitions = s.definitions.concat(i(t(8540).definitions));
      var n = {};
...
//# sourceMappingURL=382edc456d449bc064a3bc8c8214c261.js.map