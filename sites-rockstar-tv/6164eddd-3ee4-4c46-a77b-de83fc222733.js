! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "6164eddd-3ee4-4c46-a77b-de83fc222733", e._sentryDebugIdIdentifier = "sentry-dbid-6164eddd-3ee4-4c46-a77b-de83fc222733")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [3539], {
    ...
    6400: (e, t, n) => {
      ...
      const i = {
        ...
        a = () => {
          ...
          const {
            location: t
          } = window, n = t.hostname.substring(0, t.hostname.indexOf(".rockstargames.com")), i = s.findIndex((t => Object.entries(t.sites).findIndex((t => {
            let [i, s] = t;
            return s === n && (e = {
              site: i,
              subDomain: s
    ...
    6992: (e, t, n) => {
        ...
        b = () => {
          const {
            ...
            const t = m.map((e => e.subdomaincom)),
              ...
              i = "detect-locals" === n[0] ? 1 : 0;
            return -1 !== t.indexOf(n[i]) ? n[i] : null
          })(e), i = (e => {
          ...
          const r = `rockstarweb_lang.${t.cookieIdentifier}`,
            l = d(r);
          a = t.currentSite?.site === o.C.www ? m.find((e => e.subdomaincom === i)) || m.find((e => e.subdomaincom === n)) || s : m.find((e => e.iso === l)) || s;
          const [_, b] = function(e, t) {
            let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const i = d(e);
            return i && !n || c(e, t), [i, (s = e, e => {
              c(s, e)
            })];
            var s
          }(r, a.iso);
      ...
      var w = n(9623);
      const y = "rockstargames-sites-rockstar-tvea8cf4797c830e5b5dad68b2ec814e67",
        h = (x = e => {
          let {
            children: t,
            to: n = "#",
          ...
          let p = "";
          if ("aria-label" in k && k["aria-label"] && (p = "_blank" === f ? `${k["aria-label"]} ${u.formatMessage(g.aria_label_open_new_window)}` : k["aria-label"]), (0, i.useEffect)((() => {
            ...
            return (0, v.jsxs)("a", {
              ...
              "aria-label": p,
              ref: _,
              children: [t, "_blank" === f && !p && (0, v.jsx)("span", {
                className: y,
                children: u.formatMessage(g.aria_label_open_new_window)
              })]
            })
          }
          if (m) return (0, v.jsxs)(w.NavLink, {
            title: r,
            to: n,
            onClick: l,
            ...k,
          ...
          const h = Object.keys(k).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
            ...e,
            [t]: d[t]
          })), {});
      ...
      const R = {
        ...
        G = e => {
          ...
          return (0, v.jsx)("div", {
            className: R.list,
            children: i.map((e => (0, v.jsxs)(h, {
              className: [R.item, t === e.id ? R.active : ""].join(" "),
              to: `${n}play?id=${e.id}`,
        ...
        P = () => (0, v.jsx)("div", {
          children: (0, v.jsx)("div", {
            ...
            children: (0, v.jsxs)("div", {
              ...
              children: [(0, v.jsx)(S, {}), (0, v.jsx)("div", {
