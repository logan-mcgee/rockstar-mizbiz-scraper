! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      n = (new Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "524f86d1-cabb-408b-8ef2-75ddfbdd747e", e._sentryDebugIdIdentifier = "sentry-dbid-524f86d1-cabb-408b-8ef2-75ddfbdd747e")
  } catch (e) {}
}();
  ...
  [8332], {
    4819: (e, n, t) => {
      ...
      function i(e) {
        ...
        var n = a[e],
          i = n[0];
        return t.e(n[1]).then((() => t.t(i, 23)))
      }
      i.keys = () => Object.keys(a), i.id = 4819, e.exports = i
    },
    5267: (e, n, t) => {
      var a = {
        "./de": [7998, 299],
      ...
      i.keys = () => Object.keys(a), i.id = 5267, e.exports = i
    },
    8525: (e, n, t) => {
      var a = {
        "./de": [4853, 9990],
      ...
      i.keys = () => Object.keys(a), i.id = 8525, e.exports = i
    },
    3019: (e, n, t) => {
      var a = {
        "./de": [2306, 6879],
      ...
      i.keys = () => Object.keys(a), i.id = 3019, e.exports = i
    },
    4375: (e, n, t) => {
      var a = {
        "./de": [5888, 5639],
      ...
      i.keys = () => Object.keys(a), i.id = 4375, e.exports = i
    },
    3514: (e, n, t) => {
      var a = {
        "./de": [8655, 4710],
      ...
      i.keys = () => Object.keys(a), i.id = 3514, e.exports = i
    },
    62: (e, n, t) => {
      "use strict";
      t.d(n, {
      ...
      const a = {
        ...
        r = () => {
          ...
          const {
            location: n
          } = window, t = n.hostname.substring(0, n.hostname.indexOf(".rockstargames.com")), a = i.findIndex((n => Object.entries(n.sites).findIndex((n => {
            let [a, i] = n;
            return i === t && (e = {
              site: a,
              subDomain: i
    ...
    3863: (e, n, t) => {
      ...
      var a = t(2229),
        ...
        l = t(1793);
      const d = (e, n) => {
          e && n ? document.cookie = `${e}=${n}; domain=${(0,l.F)()}; path=/;` : console.log(`Couldn't set cookie (${e}) to value (${n})`)
        },
        c = e => {
        ...
        p = () => {
          const {
            ...
            const n = g.map((e => e.subdomaincom)),
              t = e.pathname.substring(1).split("/"),
              a = "detect-locals" === t[0] ? 1 : 0;
            return -1 !== n.indexOf(t[a]) ? t[a] : null
          })(e), a = (e => {
            const n = e.search.substring(1).split("&").find((e => e.startsWith("lang")));
            return n?.split("=")[1]
          })(e), i = u;
          let r = i;
          const s = `rockstarweb_lang.${n.cookieIdentifier}`,
            l = c(s);
          r = n.currentSite?.site === o.C.www ? g.find((e => e.subdomaincom === a)) || g.find((e => e.subdomaincom === t)) || i : g.find((e => e.iso === l)) || i;
          const [m, p] = function(e, n) {
            let t = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const a = c(e);
            return a && !t || d(e, n), [a, (i = e, e => {
              d(i, e)
            })];
            var i
          }(s, r.iso);
      ...
      function f(e) {
        const n = e.split("-");
        return (0, _.A)(n[1] ? n[0] : e, ["relativetimeformat", "pluralrules", "listformat"])
      }
      ...
      var k = t(9623),
        ...
        D = t(1835),
        B = {};
      B.styleTagTransform = G(), B.setAttributes = j(), B.insert = C().bind(null, "head"), B.domAPI = A(), B.insertStyleElement = E(), y()(D.A, B);
      const F = D.A && D.A.locals ? D.A.locals : void 0,
        P = (I = e => {
          let {
            children: n,
            to: t = "#",
          ...
          let w = "";
          if ("aria-label" in b && b["aria-label"] && (w = "_blank" === f ? `${b["aria-label"]} ${g.formatMessage(v.aria_label_open_new_window)}` : b["aria-label"]), (0, a.useEffect)((() => {
            ...
            return (0, h.jsxs)("a", {
              ...
              ref: u,
              role: l,
              children: [n, "_blank" === f && !w && (0, h.jsx)("span", {
                className: F.visuallyHidden,
                children: g.formatMessage(v.aria_label_open_new_window)
              })]
            })
          }
          if (p) return (0, h.jsxs)(k.NavLink, {
            title: s,
            to: t,
            onClick: d,
            ...b,
          ...
          const y = Object.keys(b).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, n) => ({
            ...e,
            [n]: m[n]
          })), {});
          return "function" == typeof y?.className && delete y.className, (0, h.jsxs)("a", {
            href: t,
            title: s,
            onClick: d,
            target: f,
          ...
          const n = (0, a.useMemo)((() => {
            if (M) return function(e, n) {
              return function(e, n) {
                const t = n ?? p()[0].iso ?? "en-US",
                  [, a] = [f(t), b(e, t)];
                var i;
                return {
                  rsLocale: t,
      ...
      var I, M, T, V = t(4595),
        O = {};
      O.styleTagTransform = G(), O.setAttributes = j(), O.insert = C().bind(null, "head"), O.domAPI = A(), O.insertStyleElement = E(), y()(V.A, O);
      const q = V.A && V.A.locals ? V.A.locals : void 0,
        H = () => (0, h.jsx)("header", {
          className: q.tvHeader,
          children: (0, h.jsxs)("div", {
            ...
            children: [(0, h.jsx)(P, {
              ...
              children: ["The future of", " ", (0, h.jsx)("strong", {
      ...
      var L = t(5966),
        U = t(6365),
        W = {};
      W.styleTagTransform = G(), W.setAttributes = j(), W.insert = C().bind(null, "head"), W.domAPI = A(), W.insertStyleElement = E(), y()(U.A, W);
      const Y = U.A && U.A.locals ? U.A.locals : void 0,
        $ = e => {
          ...
          return (0, h.jsx)("div", {
            className: Y.list,
            children: a.map((e => (0, h.jsxs)(P, {
              className: [Y.item, n === e.id ? Y.active : ""].join(" "),
              to: `${t}play?id=${e.id}`,
      ...
      var K = t(7325),
        J = t(4635),
        Q = {};
      Q.styleTagTransform = G(), Q.setAttributes = j(), Q.insert = C().bind(null, "head"), Q.domAPI = A(), Q.insertStyleElement = E(), y()(J.A, Q);
      const Z = J.A && J.A.locals ? J.A.locals : void 0,
        X = () => {
          const {
            data: e
      ...
      var ee = t(1879),
        ...
        ae = t(1598),
        ie = {};
      ie.styleTagTransform = G(), ie.setAttributes = j(), ie.insert = C().bind(null, "head"), ie.domAPI = A(), ie.insertStyleElement = E(), y()(ae.A, ie);
      const re = ae.A && ae.A.locals ? ae.A.locals : void 0,
        se = () => {
          const e = (0, L.useQueryParams)(),
            [n, t] = (0, a.useState)(null),
            {
              data: i,
              loading: r
            } = (0, L.useQuery)(te.VideoData, {
              variables: {
                id: n
              }
            });
        ...
        oe = () => {
          ...
          return (0, k.useRoutes)(e)
        };
      var le = t(8418),
        de = {};
      de.styleTagTransform = G(), de.setAttributes = j(), de.insert = C().bind(null, "head"), de.domAPI = A(), de.insertStyleElement = E(), y()(le.A, de);
      const ce = le.A && le.A.locals ? le.A.locals : void 0,
        me = () => (0, h.jsx)("div", {
          children: (0, h.jsx)("div", {
            className: ce.rockstartv,
            children: (0, h.jsxs)("div", {
              className: ce.content,
              children: [(0, h.jsx)(H, {}), (0, h.jsx)("div", {
                className: ce.router,
                children: (0, h.jsx)(oe, {})
              })]
            })
    ...
    1835: (e, n, t) => {
      ...
      var a = t(2587),
        ...
        r = t(5081),
        s = t.n(r)()(i());
      s.push([e.id, ".rockstargames-sites-rockstar-tvedb30438bec02a28ec1d06d071bcf836{align-items:center;background:var(--white-15);border:none;border-radius:100px;color:var(--white-100);cursor:pointer;display:flex;font-family:var(--font-family-body);font-size:20px;font-style:normal;font-weight:700;justify-content:center;line-height:var(--rem-125);min-width:var(--rem-6);padding:var(--padding-xs) var(--padding-sm);text-align:center;transition:background-color .3s ease-in-out}.rockstargames-sites-rockstar-tvedb30438bec02a28ec1d06d071bcf836 img{height:var(--nav-icon-size);margin-left:var(--grid-gap-xs);transition:filter .3s ease-in-out;width:var(--nav-icon-size)}.rockstargames-sites-rockstar-tvedb30438bec02a28ec1d06d071bcf836:focus,.rockstargames-sites-rockstar-tvedb30438bec02a28ec1d06d071bcf836:hover{background-color:var(--white-40);outline:none}.rockstargames-sites-rockstar-tvedb30438bec02a28ec1d06d071bcf836.rockstargames-sites-rockstar-tvc1ac4227ecc3c60c4a623f13dd4609b6{background:var(--white-100);color:var(--black-200)}.rockstargames-sites-rockstar-tvedb30438bec02a28ec1d06d071bcf836.rockstargames-sites-rockstar-tvc1ac4227ecc3c60c4a623f13dd4609b6 img{filter:invert()}.rockstargames-sites-rockstar-tvea8cf4797c830e5b5dad68b2ec814e67{clip:rect(0 0 0 0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}", "", {
        version: 3,
        sources: ["webpack://./../../buildtime/legacy-design-system/less/gen9-mixins.less", "webpack://./../../buildtime/components/src/dom/A/index.less"],
        names: [],
        mappings: "AA2QA,iEAKI,kBAAA,CAGA,0BAAA,CAFA,WAAA,CACA,mBAAA,CAIA,sBAAA,CAQA,cAAA,CAlBA,YAAA,CAYA,mCAAA,CACA,cAAA,CACA,iBAAA,CACA,eAAA,CAZA,sBAAA,CAaA,0BAAA,CAfA,sBAAA,CACA,2CAAA,CASA,iBAAA,CAQA,2CC9OJ,CD0NA,qEAwBQ,2BAAA,CADA,8BAAA,CAGA,iCAAA,CADA,0BC7OR,CDiPI,8IAEI,gCAAA,CACA,YC/OR,CDkPI,iIAEI,2BAAA,CADA,sBC/OR,CD8OI,qIAKQ,eChPZ,CAjEA,iEDwYI,kBAAA,CADA,QAAA,CAEA,UAAA,CACA,eAAA,CACA,SAAA,CACA,iBAAA,CACA,kBAAA,CACA,SCnUJ",
        ...
        pillBtn: "rockstargames-sites-rockstar-tvedb30438bec02a28ec1d06d071bcf836",
        selected: "rockstargames-sites-rockstar-tvc1ac4227ecc3c60c4a623f13dd4609b6",
        visuallyHidden: "rockstargames-sites-rockstar-tvea8cf4797c830e5b5dad68b2ec814e67"
      };
      const o = s
    },
    4595: (e, n, t) => {
      ...
      var a = t(2587),
        ...
        o = t(9908),
        l = t.n(o),
        d = new URL(t(8369), t.b),
        c = s()(i()),
        m = l()(d);
      c.push([e.id, `.rockstargames-sites-rockstar-tvdcf6464262c0f8c1aab18d7ba5f104f3{grid-gap:.5rem;--header-multiplier:0.25;--color-h:rgba(0,0,0,.5);align-items:center;display:grid;grid-template-columns:50% 1fr;margin:0 auto;max-width:var(--maxw);padding:1rem}.rockstargames-sites-rockstar-tvdcf6464262c0f8c1aab18d7ba5f104f3 h1{font-style:italic;text-align:right;text-transform:uppercase}.rockstargames-sites-rockstar-tvdcf6464262c0f8c1aab18d7ba5f104f3 h1 em{text-decoration:underline}.rockstargames-sites-rockstar-tvea94f5ebe20a3abe32611486a45fa571{background:url(${m}) no-repeat 50%/contain;max-width:234px}.rockstargames-sites-rockstar-tvea94f5ebe20a3abe32611486a45fa571:after{content:"";display:block;padding-top:15.81196581%}`, "", {
        version: 3,
        sources: ["webpack://./src/components/Header/index.less"],
        names: [],
        mappings: "AAAA,iEAOI,cAAA,CACA,wBAAA,CACA,wBAAA,CAJA,kBAAA,CADA,YAAA,CAEA,6BAAA,CAHA,aAAA,CADA,qBAAA,CADA,YASJ,CAVA,oEAaQ,iBAAA,CADA,gBAAA,CADA,wBAIR,CAfA,uEAeY,yBAGZ,CAEA,iEAGI,wEAAA,CADA,eAAJ,CAEI,uEACI,UAAA,CAEA,aAAA,CADA,wBACR",
        sourcesContent: [".content {\n    padding: 1rem;\n    max-width: var(--maxw);\n    margin: 0 auto;\n    display: grid;\n    align-items: center;\n    grid-template-columns: 50% 1fr;\n    grid-gap: 0.5rem;\n    --header-multiplier: 0.25;\n    --color-h: rgba(0, 0, 0, 0.5);\n    h1 {\n        text-transform: uppercase;\n        text-align: right;\n        font-style: italic;\n        em {\n            text-decoration: underline;\n        }\n    }\n}\n\n.tvLogo {\n    @logo: ./img/logo.png;\n    max-width: image-width(@logo);\n    background: url(@logo) no-repeat center/contain;\n    &:after {\n        content: '';\n        padding-top: (image-height(@logo) / image-width(@logo) * 100%);\n        display: block;\n    }\n}\n"],
        sourceRoot: ""
      }]), c.locals = {
    ...
    8418: (e, n, t) => {
      ...
      var a = t(2587),
        ...
        r = t(5081),
        s = t.n(r)()(i());
      s.push([e.id, ".rockstargames-sites-rockstar-tvd69f64ea3f616867829ed6faffe6aff2{--maxw:1400px;background:#fff;color:#000;flex:1}.rockstargames-sites-rockstar-tva1abc388b89589494df434c53aaf3198{display:grid}.rockstargames-sites-rockstar-tvd4698361acb311054e478e1413357320{margin:0 auto;max-width:var(--maxw);padding:0 1rem 2rem;width:100%}", "", {
        version: 3,
        sources: ["webpack://./src/components/Root/index.less"],
        names: [],
        mappings: "AAAA,iEAII,aAAA,CAHA,eAAA,CACA,UAAA,CACA,MAEJ,CAEA,iEACI,YAAJ,CAGA,iEAEI,aAAA,CADA,qBAAA,CAEA,mBAAA,CACA,UADJ",
        sourcesContent: [".rockstartv {\n    background: white;\n    color: black;\n    flex: 1;\n    --maxw: 1400px;\n}\n\n.content {\n    display: grid;\n}\n\n.router {\n    max-width: var(--maxw);\n    margin: 0 auto;\n    padding: 0 1rem 2rem;\n    width: 100%;\n}\n"],
        sourceRoot: ""
      }]), s.locals = {
        rockstartv: "rockstargames-sites-rockstar-tvd69f64ea3f616867829ed6faffe6aff2",
        content: "rockstargames-sites-rockstar-tva1abc388b89589494df434c53aaf3198",
        router: "rockstargames-sites-rockstar-tvd4698361acb311054e478e1413357320"
      };
      const o = s
    },
    6365: (e, n, t) => {
    ...
    4635: (e, n, t) => {
      ...
      var a = t(2587),
        ...
        r = t(5081),
        s = t.n(r)()(i());
      s.push([e.id, ".rockstargames-sites-rockstar-tva9f290c70f40a29f685537afe8addab4{grid-gap:2rem;display:grid}", "", {
        version: 3,
        sources: ["webpack://./src/pages/Home/index.less"],
        names: [],
        mappings: "AAEA,iEAEI,aAAA,CADA,YA+BJ",
        sourcesContent: ["@import '@rsgweb/legacy-design-system/less/mixins.less';\n\n.home {\n    display: grid;\n    grid-gap: 2rem;\n}\n"],
        sourceRoot: ""
      }]), s.locals = {
        home: "rockstargames-sites-rockstar-tva9f290c70f40a29f685537afe8addab4"
      };
      const o = s
    },
    1598: (e, n, t) => {
      ...
      var a = t(2587),
        ...
        r = t(5081),
        s = t.n(r)()(i());
      s.push([e.id, ".rockstargames-sites-rockstar-tvc708473f77ebcba15ee9062ac5921b9c{grid-gap:1rem;--color-h:#000;--header-multiplier:0.8;display:grid}", "", {
        version: 3,
        sources: ["webpack://./src/pages/Play/index.less"],
        names: [],
        mappings: "AAAA,iEAEI,aAAA,CACA,cAAA,CACA,uBAAA,CAHA,YAIJ",
        sourcesContent: [".play {\n    display: grid;\n    grid-gap: 1rem;\n    --color-h: black;\n    --header-multiplier: 0.8;\n}\n"],
        sourceRoot: ""
      }]), s.locals = {
        play: "rockstargames-sites-rockstar-tvc708473f77ebcba15ee9062ac5921b9c"
      };
      const o = s
    },
    7325: e => {
      ...
      })), e.exports = n, e.exports.videoFields = r(n, "videoFields"), e.exports.HomeData = r(n, "HomeData")
    },
    686: e => {
      var n = {
        kind: "Document",
      ...
      })), e.exports = n, e.exports.videoFields = r(n, "videoFields"), e.exports.VideoData = r(n, "VideoData")
    },
    8369: e => {
      "use strict";
      e.exports = "https://media-rockstargames-com.akamaized.net/mfe6/prod/__common/img/42089b243011b4d4effd75d882112792.png"
    }
  }
]);