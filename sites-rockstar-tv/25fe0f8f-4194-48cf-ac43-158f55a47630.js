! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "25fe0f8f-4194-48cf-ac43-158f55a47630", e._sentryDebugIdIdentifier = "sentry-dbid-25fe0f8f-4194-48cf-ac43-158f55a47630")
  } catch (e) {}
}();
  ...
  [610], {
    610: (e, i, n) => {
      ...
      const o = [{
        ...
        c = e => {
          const i = document.cookie.split("; "),
            ...
            a = s?.substring(n.length, s.length);
          return a
        },
        d = [{
          label: "Deutsch",
        ...
        f = () => {
          ...
          const r = `rockstarweb_lang.${i.cookieIdentifier}`,
            l = c(r);
          t = "www" === i.currentSite?.site ? m.find((e => e.subdomaincom === s)) || m.find((e => e.subdomaincom === n)) || a : m.find((e => e.iso === l)) || a;
          const [d, f] = function(e, i) {
            let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const s = c(e);
            return s && !n || _(e, i), [s, (a = e, e => {
              _(a, e)
            })];
            var a
          }(r, t.iso);
      ...
      const k = e => {
          ...
          const [t, o] = (0, s.useMemo)((() => function(e) {
      ...
      const h = "rockstargames-sites-rockstar-tvff481c537a56a6fcdb1be85dfbc8944e",
        y = function(e, i) {
          ...
          const c = (0, s.useRef)(null),
            d = (0, t.A)(),
            u = !/^(https?|mailto):/i.test(n),
            m = /^#/.test(n),
            f = l?.target ?? (r ? "_blank" : "_self");
          let {
            ...k
          } = l, g = "";
          if ("aria-label" in k && k["aria-label"] && (g = "_blank" === f ? `${k["aria-label"]} ${d.formatMessage(b.aria_label_open_new_window)}` : k["aria-label"]), (0, s.useEffect)((() => {
              _ && c?.current && c.current.focus()
            }), [c?.current, _]), m) {
            const e = e => {
            ...
            return (0, p.jsxs)("a", {
              ...
              "aria-label": g,
              ref: c,
              children: [i, "_blank" === f && !g && (0, p.jsx)("span", {
                className: h,
                children: d.formatMessage(b.aria_label_open_new_window)
              })]
            })
          }
          if (u) return (0, p.jsxs)(v.NavLink, {
            title: a,
            to: n,
            onClick: o,
            ...k,
    ...
    768: (e, i, n) => {
      ...
      s.definitions.forEach((function(e) {
        ...
        for (s.forEach((function(e) {
          ...
          var _ = t;
          t = new Set, _.forEach((function(e) {
