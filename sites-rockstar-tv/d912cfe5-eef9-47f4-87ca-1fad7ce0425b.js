! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "d912cfe5-eef9-47f4-87ca-1fad7ce0425b", e._sentryDebugIdIdentifier = "sentry-dbid-d912cfe5-eef9-47f4-87ca-1fad7ce0425b")
  } catch (e) {}
}();
  ...
  [1327], {
    148: (e, t, i) => {
      ...
      const n = {
        ...
        a = () => {
          ...
          const {
            location: t
          } = window, i = t.hostname.substring(0, t.hostname.indexOf(".rockstargames.com")), n = s.findIndex((t => Object.entries(t.sites).findIndex((t => {
            let [n, s] = t;
            return s === i && (e = {
              site: n,
              subDomain: s
    ...
    1133: (e, t, i) => {
      ...
      function s(e) {
        ...
        var t = n[e],
          s = t[0];
        return i.e(t[1]).then((() => i.t(s, 23)))
      }
      s.keys = () => Object.keys(n), s.id = 1133, e.exports = s
    },
    2784: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, {
      ...
      const c = (e, t) => {
        ...
        _ = e => {
          const t = document.cookie.split("; "),
            ...
            s = n?.substring(i.length, n.length);
          return s
        },
        d = [{
          label: "English",
        ...
        b = () => {
          ...
          const r = `rockstarweb_lang.${t.cookieIdentifier}`,
            l = _(r);
          a = t.currentSite?.site === o.C.www ? m.find((e => e.subdomaincom === n)) || m.find((e => e.subdomaincom === i)) || s : m.find((e => e.iso === l)) || s;
          const [d, b] = function(e, t) {
            let i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            const n = _(e);
            return n && !i || c(e, t), [n, (s = e, e => {
              c(s, e)
            })];
            var s
          }(r, a.iso);
      ...
      const w = "rockstargames-sites-rockstar-tvea8cf4797c830e5b5dad68b2ec814e67",
        y = (x = e => {
          ...
          let y = "";
          if ("aria-label" in k && k["aria-label"] && (y = "_blank" === p ? `${k["aria-label"]} ${m.formatMessage(v.aria_label_open_new_window)}` : k["aria-label"]), (0, n.useEffect)((() => {
