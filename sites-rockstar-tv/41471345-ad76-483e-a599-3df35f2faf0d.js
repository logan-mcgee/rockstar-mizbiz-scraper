try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    n = (new e.Error).stack;
  n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "41471345-ad76-483e-a599-3df35f2faf0d", e._sentryDebugIdIdentifier = "sentry-dbid-41471345-ad76-483e-a599-3df35f2faf0d")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [5932], {
    5932(e, n, r) {
      ...
      r.r(n), r.d(n, {
        ...
        FormatNumericToParts: () => Ir,
        FormatNumericToString: () => dr,
        GetNumberOption: () => Hn,
        GetOption: () => Gn,
        GetOptionsObject: () => Vn,
        GetStringOrBooleanOption: () => $n,
        ...
        SameValue: () => Dn,
        SecFromTime: () => _n,
        SetNumberFormatDigitOptions: () => Pr,
      ...
      T.absoluteValue = T.abs = function() {
        ...
        if (n)
          if (r.length > 1) u = !0;
            ...
            u = 1 !== i
          } if (g = !1, o = G(c, s = f + 5), t = n ? _(l, s + 10) : G(e, s), O((a = B(o, t, s, 1)).d, i = f, d))
          do {
      ...
      var B = function() {
        ...
        return function(t, i, o, s, a, c) {
          var l, f, d, g, m, p, h, v, y, w, b, F, E, N, S, x, T, A, I, O, M = t.constructor,
            ...
            P = t.d,
            j = i.d;
          if (!(P && P[0] && j && j[0])) return new M(t.s && i.s && (P ? !j || P[0] != j[0] : j) ? P && 0 == P[0] || !j ? 0 * B : B / 0 : NaN);
          for (c ? (m = 1, f = t.e - i.e) : (c = C, m = 7, f = D(t.e / m) - D(i.e / m)), I = j.length, T = P.length, w = (y = new M(B)).d = [], d = 0; j[d] == (P[d] || 0); d++);
          if (j[d] > (P[d] || 0) && f--, null == o ? (N = o = M.precision, s = M.rounding) : N = a ? o + (t.e - i.e) + 1 : o, N < 0) w.push(1), p = !0;
          else {
            if (N = N / m + 2 | 0, d = 0, 1 == I) {
              ...
              do {
                g = 0, (l = n(j, b, I, F)) < 0 ? (E = b[0], I != F && (E = E * c + (b[1] || 0)), (g = E / A | 0) > 1 ? (g >= c && (g = c - 1), 1 == (l = n(h = e(j, g, c), b, v = h.length, F = b.length)) && (g--, r(h, I < v ? O : j, v, c))) : (0 == g && (l = g = 1), h = j.slice()), (v = h.length) < F && h.unshift(0), r(b, h, F, c), -1 == l && (l = n(j, b, I, F = b.length)) < 1 && (g++, r(b, I < F ? O : j, F, c)), F = b.length) : 0 === l && (g++, b = [0]), w[d++] = g, l && b[0] ? b[F++] = P[x] || 0 : (b = [P[x]], F = 1)
      ...
      function H(e, n) {
        ...
        for (a += t = Math.log(w(2, f)) / Math.LN10 * 2 + 5 | 0, r = u = o = new d(1), d.precision = a;;) {
          if (u = k(u.times(e), a, 1), r = r.times(++l), A((s = o.plus(B(u, r, a, 1))).d).slice(0, a) === A(o.d).slice(0, a)) {
            ...
            if (!(c < 3 && O(o.d, a - t, m, c))) return k(o, d.precision = p, m, g = !0);
      ...
      function G(e, n) {
        ...
        for (u = p.e, t > 1 ? (p = new v("0." + r), u++) : p = new v(t + "." + r.slice(1)), f = p, a = o = p = B(p.minus(1), p.plus(1), l, 1), d = k(p.times(p), l, 1), i = 3;;) {
          if (o = k(o.times(d), l, 1), A((c = a.plus(B(o, new v(i), l, 1))).d).slice(0, l) === A(a.d).slice(0, l)) {
            ...
            if (!O(a.d, l - 10, y, s)) return k(a, v.precision = D, y, g = !0);
      ...
      function Q(e, n, r, t) {
        ...
        if (v ? (I(r, 1, a), void 0 === t ? t = h.rounding : I(t, 0, 8)) : (r = h.precision, t = h.rounding), e.isFinite()) {
          for (v ? (i = 2, 16 == n ? r = 4 * r - 3 : 8 == n && (r = 3 * r - 2)) : i = n, (s = (g = P(e)).indexOf(".")) >= 0 && (g = g.replace(".", ""), (p = new h(1)).e = g.length - s, p.d = M(P(p), 10, i), p.e = p.d.length), o = f = (m = M(g, 10, i)).length; 0 == m[--f];) m.pop();
          if (m[0]) {
      ...
      function xn(e) {
        if (e < 100) {
          var n = new Date(0);
          return n.setUTCFullYear(e, 0, 1), n.setUTCHours(0, 0, 0, 0), n.getTime() / En
        }
      ...
      function Pn(e) {
        return Nn(Math.floor(e / 36e5), 24)
      }

      function jn(e) {
        return Nn(Math.floor(e / 6e4), 60)
      }

      function _n(e) {
        return Nn(Math.floor(e / 1e3), 60)
      }
      ...
      function wr(e, n, r, t) {
        ...
        for (var w = o.split(/({c:[^}]+}|\{0\}|[¤%\-\+])/g), b = [], F = n.numbers.symbols[d] || n.numbers.symbols[g], E = 0, N = w; E < N.length; E++)
          if (z = N[E]) switch (z) {
            case "{0}":
              b.push.apply(b, br(F, e, l, a, d, !m && (null === (i = t.useGrouping) || void 0 === i || i), h, f, t.roundingIncrement, ar(t.roundingMode, -1 === s)));
              break;
            case "-":
              b.push({
                type: "minusSign",
        ...
        switch (f) {
          case "currency":
            if ("name" === t.currencyDisplay) {
              ...
              C = x ? Er(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), x.displayName) : t.currency;
          ...
          case "unit":
            var O = t.unit,
              M = t.unitDisplay,
              B = n.units.simple[O];
            if (S = void 0, B) S = Er(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[O][M]);
            else {
              var k = O.split("-per-"),
                P = k[0],
                j = k[1];
              B = n.units.simple[P];
              var _ = Er(r, e.roundedNumber.times(Ze.pow(10, a)).toNumber(), n.units.simple[P][M]),
      ...
      function br(e, n, r, t, i, u, o, s, a, c) {
        var l = [],
          f = n.formattedString,
          d = n.roundedNumber;
        if (d.isNaN()) return [{
      ...
      function Cr(e, n) {
        ...
        if (u.isNaN()) t = l.nan;
          ...
          u.isZero() || (cn(u.isFinite(), "Input must be a mathematical value"), "percent" == e.style && (u = u.times(100)), f = (r = gr(e, u))[0], o = r[1], u = u.times(Ze.pow(10, -f)));
          var d = dr(e, u);
      ...
      function Ir(e, n, r) {
        for (var t = Cr(r.getInternalSlots(e), n), i = wn(0), u = 0, o = t; u < o.length; u++) {
          var s = o[u];
          i.push({
            type: s.type,
            value: s.value
      ...
      var Or, Mr, Br = r(4578),
        kr = new Set([1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 2500, 5e3]);
      ...
      function Pr(e, n, r, t, i) {
        ...
        cn(kr.has(l), "Invalid rounding increment value: ".concat(l, ".\nValid values are ").concat(Array.from(kr).join(", "), "."));
        ...
        if ("auto" === d && (h = m, (m || !p && "compact" === i) && (v = !1)), h && (m ? (e.minimumSignificantDigits = zn(a, 1, 21, 1), e.maximumSignificantDigits = zn(c, e.minimumSignificantDigits, 21, 21)) : (e.minimumSignificantDigits = 1, e.maximumSignificantDigits = 21)), v)
          if (p) {
            if (o = zn(o, 0, 100, void 0), s = zn(s, 0, 100, void 0), void 0 === o) cn(void 0 !== s, "maximumFractionDigits must be defined"), o = Math.min(r, s);
      ...
      function jr(e, n) {
        ...
        cn(void 0 === t || er(t), "Malformed currency code", RangeError), cn("currency" !== r || void 0 !== t, "currency cannot be undefined", TypeError);
        ...
        cn(void 0 === o || nr(o), "Invalid unit argument for Intl.NumberFormat()", RangeError), cn("unit" !== r || void 0 !== o, "unit cannot be undefined", TypeError);
      ...
      function _r(e, n, r, i) {
        ...
        var S = $n(d, "useGrouping", ["min2", "auto", "always"], "always", !1, C);
        y.useGrouping = S;
      ...
      function Lr(e, n, r) {
        return void 0 !== r && Gn(r = yn(r), "localeMatcher", "string", ["lookup", "best fit"], "best fit"), (0, Br.LookupSupportedLocales)(Array.from(e), n)
      }
      ...
      Mr = Error, (0, He.__extends)(function() {
