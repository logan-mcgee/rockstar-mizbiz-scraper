      ...
      var l = t(8322),
        ...
        s = function() {
          function e(a, t) {
            ...
            var p = c.dataLocale,
              y = o[p];
            (0, r.invariant)(!!y, "Missing locale data for ".concat(p)), f(this, "localeData", y), (0, r.invariant)(void 0 !== y, "locale data for ".concat(c.locale, " does not exist."));
            var g = y.types;
            ...
            var w = "language" === u ? g[u][b][d] : g[u][d];
          ...
          return e.supportedLocalesOf = function(a, t) {
            ...
            }(d(this, "languageDisplay"), s, f, y, p);
            else {
              var g = s.types[a];
              l = g[f][y] || g.long[y]
            }
