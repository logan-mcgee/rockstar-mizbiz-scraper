! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "aecce1bd-81ae-495b-8702-9c23c856e841", e._sentryDebugIdIdentifier = "sentry-dbid-aecce1bd-81ae-495b-8702-9c23c856e841")
  } catch (e) {}
}();
  ...
  [325], {
    ...
    6817: (e, i, s) => {
      ...
      const k = (0, a.forwardRef)(((e, i) => {
        ...
        return (0, m.jsxs)("div", {
          className: [f.infoSection, n || ""].join(" "),
          ref: i,
      ...
      const x = "rockstargames-sites-gtaff481c537a56a6fcdb1be85dfbc8944e",
        j = (0, b.withIntl)((e => {
          ...
          if ("aria-label" in u && u["aria-label"] && (f = "_blank" === p ? `${u["aria-label"]} ${l.formatMessage(w.aria_label_open_new_window)}` : u["aria-label"]), (0, a.useEffect)((() => {
            ...
            return (0, m.jsxs)("a", {
              ...
              "aria-label": f,
              ref: _,
              children: [i, "_blank" === p && !f && (0, m.jsx)("span", {
                className: x,
          ...
          const k = Object.keys(u).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, i) => ({
            ...e,
            [i]: c[i]
          })), {});
      ...
      const D = function(e) {
        ...
        const [g, p] = (0, a.useState)(!1), {
          ...
          var d;
          const [m, g] = a.useState(null), p = a.useRef(), [u, f] = a.useState({
            inView: !!c,
            entry: void 0
          });
          ...
          const k = null == (d = u.entry) ? void 0 : d.target,
            v = a.useRef();
          m || !k || o || r || v.current === k || (v.current = k, f({
            inView: !!c,
            entry: void 0
          }));
          const b = [g, u.inView, u.entry];
          ...
          children: [(0, m.jsx)(j, {
            ...
            children: (0, m.jsx)("img", {
              alt: h.formatMessage(T.components_ratings_link_alt, {
                rating: (x = f.ratingImg, x.replace(/_/g, " ").split(".")[0].toUpperCase())
              }),
              src: s(3983)(`./${f.ratingImg}`)
            })
          }), y && (0, m.jsxs)("div", {
            className: I.text,
            children: [(0, m.jsx)("p", {
