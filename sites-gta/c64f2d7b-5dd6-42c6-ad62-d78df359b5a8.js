! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      s = (new Error).stack;
    s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "c64f2d7b-5dd6-42c6-ad62-d78df359b5a8", e._sentryDebugIdIdentifier = "sentry-dbid-c64f2d7b-5dd6-42c6-ad62-d78df359b5a8")
  } catch (e) {}
}();
      ...
      const x = "rockstargames-sites-gtaff481c537a56a6fcdb1be85dfbc8944e",
        z = (0, v.withIntl)((e => {
          ...
          const l = (0, t.useRef)(null),
            ...
            g = /^#/.test(i),
            f = _?.target ?? (r ? "_blank" : "_self");
          let {
            ...p
          } = _, k = "";
          if ("aria-label" in p && p["aria-label"] && (k = "_blank" === f ? `${p["aria-label"]} ${d.formatMessage(y.aria_label_open_new_window)}` : p["aria-label"]), (0, t.useEffect)((() => {
            ...
            return (0, m.jsxs)("a", {
              ...
              "aria-label": k,
              ref: l,
              children: [s, "_blank" === f && !k && (0, m.jsx)("span", {
                className: x,
                children: d.formatMessage(y.aria_label_open_new_window)
              })]
            })
          }
          if (u) return (0, m.jsxs)(w.NavLink, {
            title: n,
            to: i,
            onClick: o,
            ...p,
          ...
          const b = Object.keys(p).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, s) => ({
            ...e,
            [s]: _[s]
          })), {});
          return "function" == typeof b?.className && delete b.className, (0, m.jsxs)("a", {
            href: i,
            title: n,
            onClick: o,
            target: f,
