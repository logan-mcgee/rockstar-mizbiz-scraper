/*! For license information please see a1771b1142805b4a96ece427201ab32b.js.LICENSE.txt */ ! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e78ad54a-875f-41f8-92ce-a32fd164deea", e._sentryDebugIdIdentifier = "sentry-dbid-e78ad54a-875f-41f8-92ce-a32fd164deea")
  } catch (e) {}
}();
    ...
    5832: (e, t, a) => {
      ...
      const k = {
        ...
        j = (0, s.forwardRef)(((e, t) => {
          ...
          const o = y(),
            i = "esrb_rp.svg" === o.rating_img ? "<p>May contain content inappropriate for children.</p>" : void 0,
      ...
      const N = () => {
          const {
            ...
            setStandalone: _
          } = (0, l.useRockstarLocalState)(), x = (0, s.useRef)(), y = (0, s.useRef)(null), N = (0, s.useRef)(null), W = (0, s.useRef)(null), C = (0, s.useRef)(null), S = (0, s.useRef)(null), I = (0, s.useRef)(null), E = (0, s.useRef)(null), P = (0, s.useRef)(a), O = (0, s.useRef)(null), {
            loading: M,
            translation: $
          } = (0, m.A1)(), {
            track: L
          ...
          const D = e => {
            ...
            y.current && (N?.current?.heroUIRef?.current.contains(t) ? r.gsap.set(window, {
              scrollTo: 0
            }) : y.current.contains(t) && r.gsap.set(window, {
              scrollTo: t
            }))
          };
          return (0, s.useEffect)((() => (t(!0), _(!0), window.document.body.style.overflowY = "hidden", window.document.addEventListener("focusout", D), () => {
            window.document.body.style.overflowY = "unset", window.document.removeEventListener("focusout", D), _(!1)
          })), []), (0, s.useEffect)((() => {
            P.current = a, x.current && x.current.paused(a)
          }), [a]), (0, s.useEffect)((() => (S.current && (x.current = o.m.create({
            content: S.current,
            smooth: .5,
            normalizeScroll: !0
          }), x.current.paused(!0)), () => {
            x.current?.kill()
          })), [S.current]), (0, s.useLayoutEffect)((() => {
            ...
            e?.introTimeline && t.add({
              ...
              } = t.conditions, s = N?.current?.heroUIRef?.current, o = N?.current?.heroImagesRefs?.current?.heroImagesRef?.current, i = n.W.isTouch ? .75 : 100, c = n.W.isTouch ? r.Expo.easeInOut : "none";
              E.current && E.current.progress(0).kill(), E.current = r.gsap.timeline({
                ...
                scrollTrigger: {
                  ...
                  onToggle: e => {
                    ...
                    }), -1 !== e.direction && (P.current || (x.current.paused(!0), setTimeout((() => {
                      P.current || x?.current?.paused(!1)
                    }), 500))))
                  }
                },
                onComplete: () => {
                ...
                maxHeight: () => C?.current?.clientHeight
              }).fromTo(s, {
                opacity: 1
              }, {
                opacity: 0,
                ...
                immediateRender: !1
              }).fromTo(N?.current?.heroRef?.current, {
          ...
          }), [a, e?.introTimeline, y?.current, N?.current?.heroRef?.current, N?.current?.heroUIRef?.current, N?.current?.heroImagesRef?.current, W?.current, I?.current]), (0, s.useEffect)((() => {
            b && p.current && i({
              target: p,
              id: "dialog"
            })
            ...
            children: [(0, g.jsx)(f, {
              ...
              children: [(0, g.jsxs)("div", {
                ...
                children: [(0, g.jsx)(u.c, {
                  ...
                  children: (0, g.jsx)(h, {
                    blurb: M ? "" : $("d2.destDescription"),
                    buttonText: M ? "" : $("d2.playbackCTA"),
                    header: M ? "" : $("d2.destHeadline"),
...
//# sourceMappingURL=a1771b1142805b4a96ece427201ab32b.js.map