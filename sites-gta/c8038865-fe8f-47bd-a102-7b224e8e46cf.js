! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      s = (new Error).stack;
    s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "c8038865-fe8f-47bd-a102-7b224e8e46cf", e._sentryDebugIdIdentifier = "sentry-dbid-c8038865-fe8f-47bd-a102-7b224e8e46cf")
  } catch (e) {}
}();
    ...
    6817: (e, s, i) => {
      ...
      const x = "rockstargames-sites-gtaff481c537a56a6fcdb1be85dfbc8944e",
        z = (0, v.withIntl)((e => {
          ...
          if ("aria-label" in f && f["aria-label"] && (p = "_blank" === g ? `${f["aria-label"]} ${l.formatMessage(w.aria_label_open_new_window)}` : f["aria-label"]), (0, t.useEffect)((() => {
      ...
      var I = i(5913);
      const A = void 0 !== I.GameData ? I.GameData : GameDataDefault;
      ...
      const G = function(e) {
        ...
        return (0, m.jsxs)("div", {
          className: [M.rating, y ? M.withDescriptors : M.withOutDescriptors, d || ""].join(" "),
      ...
      const U = () => {
          const {
            ...
            setStandalone: w
          } = (0, _.useRockstarLocalState)(), y = (0, t.useRef)(), x = (0, t.useRef)(null), z = (0, t.useRef)(null), j = (0, t.useRef)(null), N = (0, t.useRef)(null), R = (0, t.useRef)(null), S = (0, t.useRef)(null), C = (0, t.useRef)(null), P = (0, t.useRef)(i), M = (0, t.useRef)(null), {
            loading: E,
            translation: I
          } = (0, g.c3)(), {
            track: A
          ...
          return (0, t.useEffect)((() => (s(!0), w(!0), window.document.body.style.overflowY = "hidden", window.document.addEventListener("focusout", G), () => {
            window.document.body.style.overflowY = "unset", window.document.removeEventListener("focusout", G), w(!1)
          })), []), (0, t.useEffect)((() => {
            P.current = i, y.current && y.current.paused(i)
          }), [i]), (0, t.useEffect)((() => (R.current && (y.current = r.R.create({
            content: R.current,
            smooth: .5,
            normalizeScroll: !0
          }), y.current.paused(!0)), () => {
            ...
            e?.introTimeline && s.add({
              ...
              C.current && C.current.progress(0).kill(), C.current = a.gsap.timeline({
                ...
                scrollTrigger: {
                  ...
                  onToggle: e => {
                    y.current && (a.gsap.set(S?.current, {
                      display: e.isActive ? "none" : "block"
                    }), -1 !== e.direction && (P.current || (y.current.paused(!0), setTimeout((() => {
                      P.current || y?.current?.paused(!1)
                    }), 500))))
                  }
                },
                onComplete: () => {
            ...
            children: [(0, m.jsx)(u, {
              ...
              children: [(0, m.jsxs)("div", {
                ...
                children: [(0, m.jsx)(d.A, {
                  ...
                  children: (0, m.jsx)(b, {
                    blurb: E ? "" : I("d2.destDescription"),
                    buttonText: E ? "" : I("d2.playbackCTA"),
                    header: E ? "" : I("d2.destHeadline"),
