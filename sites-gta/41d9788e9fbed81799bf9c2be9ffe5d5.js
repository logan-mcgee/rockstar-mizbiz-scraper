! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "7434a8c6-09ea-4f34-8452-f599fe88c7f6", e._sentryDebugIdIdentifier = "sentry-dbid-7434a8c6-09ea-4f34-8452-f599fe88c7f6")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [380], {
    26724: (e, t, a) => {
      ...
      g.gsap.registerPlugin(b.W, f.m, u.M);
      const L = () => {
          const {
            loading: e,
            translation: t
          ...
          return (0, k.useEffect)((() => {
            ...
            const e = g.gsap.context((() => {
              A?.bannerTimeline?.progress(0).kill(), D && (u.current = g.gsap.timeline({
                paused: !0,
                defaults: {
                    ...
                    children: [(0, v.jsx)(R, {
                      ...
                      onClick: () => {
                        B(!1), r({
                          ...
                          u.current && A.playVideoTimeline && A.playVideoTimeline.progress(0).pause(), H()
                        })), n({
