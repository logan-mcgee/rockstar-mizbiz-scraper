    ...
    48787: (e, o, s) => {
      ...
      const i = () => {
        const {
          ...
          return o?.split("=")[1]
        })(e), l = n.u, [r, c] = (0, a.c)(`rockstarweb_lang.${o.cookieIdentifier}`, s ?? void 0);
        let d = l;
        return d = o.currentSite?.site === t.U.www ? n.c.find((e => e.subdomaincom === i)) || n.c.find((e => e.subdomaincom === s)) || l : n.c.find((e => e.iso === r)) || l, [d, c]
      }
    },
    36320: (e, o, s) => {
      "use strict";
...
//# sourceMappingURL=efde0fcdda2a42bc0619ce0735c9ea4c.js.map