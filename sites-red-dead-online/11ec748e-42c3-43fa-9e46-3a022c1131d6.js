try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "11ec748e-42c3-43fa-9e46-3a022c1131d6", e._sentryDebugIdIdentifier = "sentry-dbid-11ec748e-42c3-43fa-9e46-3a022c1131d6")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    67263: (e, a, t) => {
      ...
      const M = {
        ...
        I = ({
          ...
          return (0, r.jsx)("div", {
            "aria-describedby": t,
            role: "img",
            className: [M.mainImg, n ? M.imgLoaded : M.imgHidden].join(" "),
            style: {
        ...
        C = ({
          ...
          (0, s.useEffect)(() => {
            ...
            return e.on("swiperight", a), e.on("swipeleft", t), e.on("pan", r), e.on("panend", s), () => {
              e.off("swiperight", a), e.off("swipeleft", t), e.off("pan", r), e.off("panend", s), g(0)
            }
          }, [c.current, l]), (0, s.useEffect)(() => {
            const e = () => {
          ...
          const f = e => {
            e >= 0 && e < a.length && d.current[e] && d.current[e]?.focus()
          };
          return (0, r.jsxs)("div", {
            className: [M.trackWrapper, M[`pass_${o}`]].join(" "),
            style: {
              "--current-page": l
            },
            role: "listbox",
            "aria-label": i.formatMessage(X.rdo_club_rewards_slideshow_info, {
              number: a.length
            }),
            children: [(0, r.jsx)("div", {
              className: [M.trackGrid, 0 !== _ ? M.trackDragging : ""].join(" "),
              ref: c,
              style: {
                "--drag-x": `${_}px`
              },
              children: a.map((s, n) => (0, r.jsx)("button", {
                type: "button",
                ref: e => d.current[n] = e,
                onClick: () => t(s),
                onKeyDown: e => ((e, r) => {
                  ...
                  switch (e.key) {
                    case "Home":
                      e.preventDefault(), m(0), setTimeout(() => {
                        t(a[0]), f(0)
                      }, 100);
                      break;
                    case "End":
                      e.preventDefault(), m(V(a.length - 1, u, a.length)), setTimeout(() => {
                        t(a[a.length - 1]), f(a.length - 1)
                      }, 100);
                      break;
                    case "Tab":
                      if (e.shiftKey) {
                        if (0 === r) return;
                        e.preventDefault(), s = r - 1, m(V(s, u, a.length)), setTimeout(() => {
                          t(a[s]), f(s)
                        }, 100)
                      } else {
                ...
                className: e && e.id === s.id ? M.activeTrackItem : "",
                style: {
                  backgroundImage: `url(${s.img_thumb})`
                },
                role: "option",
                "aria-label": i.formatMessage(X.rdo_club_rewards_slideshow_thumb_info, {
                  number: n + 1,
                  name: s.name,
              ...
              className: M.pagingWrapper,
              children: (0, r.jsx)("nav", {
                className: M.paging,
                children: Array.from(new Array(u)).map((e, a) => (0, r.jsx)("button", {
                  tabIndex: -1,
                  onClick: () => m(a),
                  className: l === a ? M.activePage : ""
                }, a))
              })
            })]
          })
        ...
        A = ({
          ...
          return (0, s.useEffect)(() => {
            if (t && !n.length) {
              const e = t.rdoClubRewards.clubs_items.filter(e => e.pass === a);
              i(e), c(e[0])
            }
          }, [t]), t && n.length && d ? (0, r.jsxs)("div", {
            className: M.clubRewardsModule,
            children: [(0, r.jsx)(I, {
              activeItem: d,
              describedBy: l,
              children: (0, r.jsx)(L, {
        ...
        q = "rockstargames-sites-red-dead-onlinea655d6534d0cd1ae64c8bb84437c68fa";
            ...
            children: [(0, r.jsx)("h2", {
              ...
              children: a.map((a, s) => {
                ...
                return (0, r.jsxs)("div", {
                  children: [(0, r.jsx)("div", {
                    role: "img",
                    "aria-label": o.formatMessage(J.rdo_tip_number, {
                      number: s + 1
                    }),
      ...
      const ae = f(({
        ...
        re = ({
          ...
          className: [te.link, te.swipe, te[e]].join(" "),
          to: s,
          target: t,
          children: a
        }),
        ...
        de = ({
          type: e = "default"
        }) => "halloween" === e ? (0, r.jsx)(ie, {}) : (0, r.jsx)(ne, {}),
        ce = () => ((0, o.useQuery)(T.Meta, {
          variables: {
      ...
      const pe = () => (0, r.jsx)(ge(), {
        ...
        be = ({
          ...
          const u = {
              "ps4-dpad-right": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_dpad_right),
              "xb1-dpad-right": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_dpad_right),
              "ps4-dpad-up": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_dpad_up),
              "xb1-dpad-up": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_dpad_up),
              "ps4-options": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_options),
              "xb1-options": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_options),
              "ps4-x": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_x),
              "xb1-a": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_a),
              "ps4-l3": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_l3),
              "xb1-l3": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_l3),
              "ps4-r3": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_r3),
              "xb1-r3": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_r3),
              "ps4-l1": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_l1),
              "xb1-lb": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_lb),
              "ps4-r": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_r),
              "ps4-l2": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_l2),
              "xb1-lt": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_lt),
              "ps4-r2": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_r2),
              "xb1-rt": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_rt),
              "ps4-circle": a.formatMessage(fe.rdo_feature_getting_started_controller_ps4_circle),
              "xb1-b": a.formatMessage(fe.rdo_feature_getting_started_controller_xb1_b),
              or: a.formatMessage(fe.rdo_feature_getting_started_or)
            },
            p = e => {
      ...
      const xe = {
        ...
        je = "rockstargames-sites-red-dead-onlinec8dc03880ce2e12f3fdea5b5b587f27f",
        Se = ({
          alt: e,
          className: a,
          src: s,
          ...
          let l = s;
          !1 === d && ("rockstargames-sites-red-dead-onlinea6a06e2d5c4f1811ea39d17312ca2e67" === a && (l = t(28839)), l = t(9333));
          const {
            width: m,
            height: _
          } = c, g = {
        ...
        ze = ({
          ...
          let {
            ...
            const d = (0, o.useLocale)(),
              ...
              [l, m] = (0, s.useState)(i ?? c?.cdn ?? c?.prod ?? !0);
            (0, s.useEffect)(() => {
              m(i ?? c?.cdn ?? c?.prod ?? !0)
            }, [i, c]);
            const _ = (0, s.useCallback)(e => {
              const a = null !== n,
                t = e?.previewSrc ?? e ?? null;
              if (null === t || "string" != typeof t) return null;
              if (t.startsWith("http")) return Ne(t);
              const r = `${a?(0,o.getCdnPrefix)(l):""}${t}`;
              return Ne(r)
            }, [l, n]);
            return {
              alt: e,
              ariaLabel: r,
              src: {
                mobile: _(n?.[d]?.mobile ?? n?.en_us?.mobile ?? a),
                desktop: _(n?.[d]?.desktop ?? n?.en_us?.desktop ?? t)
              }
            }
          })(n);
          const {
      ...
      const Te = {
        ...
        Fe = ({
          ...
          return delete n?.color, l && _ ? (0, r.jsx)("div", {
            ...
            children: (0, r.jsx)("ul", {
              className: (0, ve.A)(Te.itemList, Te.noImg, Te[t], Te[d]),
            ...
            style: (0, o.safeStyles)(n),
            className: (0, ve.A)(Te.itemList, Te.custom, c ? Te.noImg : "", t ? Te[t] : "", d ? Te[d] : "", i ?? ""),
        ...
        Be = ({
          ...
          style: e,
          className: [Xe.hr, Xe[t], a].join(" ")
        }),
        De = "rockstargames-sites-red-dead-onlineacd27eff2209196752622710f7b27558",
        Re = ({
          to: e,
          children: a
        }) => e ? (0, r.jsx)("a", {
        ...
        Me = ({
          ...
          className: (0, ve.A)("rockstargames-sites-red-dead-onlinef8bc9589974046cdac4a2264be12d2df", a),
          children: [e.title && (0, r.jsx)(Re, {
            to: e?.href ?? e?.to,
            children: (0, r.jsx)("h3", {
              children: e.title
            })
          }), Array.isArray(e?.description?.content) ? e.description.content?.map((e, a) => e?.unorderedList ? (0, r.jsx)(Fe, {
      ...
      const Le = ({
        ...
        Ae = ({
          ...
          const o = [];
          return n ? e.split(n).map(e => o.push(e)) : o.push(e), (0, r.jsxs)(Ce, {
            splitter: n,
            role: s,
            wrapper: e => (0, r.jsx)("div", {
              className: `${Ie.badge} ${a?Ie[a]:""} `,
              children: e
            }),
            children: [(0, r.jsx)(r.Fragment, {
              children: s && (0, r.jsx)(ze, {
                image: {
                  alt: s,
              ...
              className: `${n||s?"":Ie.badge} ${a?Ie[a]:""}`,
              min: 8,
              max: 1e3,
              mode: n || s ? "single" : "multi",
              children: o[0]
            }), (0, r.jsx)(r.Fragment, {
              children: o.shift() && n && o.length >= 1 && (0, r.jsx)(Le, {
                min: 8,
                max: 1e3,
                mode: "single",
        ...
        Ge = ({
          ...
          const g = (0, s.useMemo)(() => {
            if (i?.badge || i?.discountTxt || e || t) return (0, r.jsx)(Ae, {
          ...
          return (0, r.jsx)($e, {
            ...
            children: (0, r.jsx)("figure", {
              children: (0, r.jsxs)("div", {
                className: (0, ve.A)("rockstargames-sites-red-dead-onlined9ac792281efe15bcd4589b028d1c27b", _ ? "rockstargames-sites-red-dead-onlinee430c4662cd185f58259d4a8d8b322de" : "", l?.hiddenMobile ? "hiddenMobile" : "", l?.hiddenLarge ? "hiddenLarge" : "", l?.className, c),
                ...
                children: [(0, r.jsx)(ze, {
                  ...
                  image: i,
                  className: c
                }), g, i?.caption && (0, r.jsx)("figcaption", {
                  dangerouslySetInnerHTML: {
                    __html: i.caption
                  }
                })]
        ...
        qe = ({
          ...
          children: [(0, r.jsx)(Ge, {
            ...
            style: e?.style,
            className: (0, ve.A)(xe.img, e?.className)
          }), (e?.title || e?.description) && (0, r.jsx)(Me, {
            item: e
          })]
        }),
        Ue = ({
        ...
        He = ({
          ...
          const [_, g] = (0, s.useState)(0), u = (0, s.useMemo)(() => e && Array.isArray(e) ? e.map(() => (0, he.A)()) : null, [e]);
          ...
          return (0, r.jsxs)("div", {
            className: (0, ve.A)(xe.deprecatedCarousel, xe[i], xe[`infinite_${!n}`], e ? xe.renderedWithChildren : "", o),
            style: t,
            children: [(0, r.jsxs)(ke.RC, {
              loop: a.length > 2 && !n,
              grabCursor: !0,
              centeredSlides: l,
              ...
              children: [(0, r.jsx)("div", {
                className: xe.trackWrapper,
                children: (0, r.jsxs)("div", {
                  className: xe.track,
                  children: [a?.map(e => (0, r.jsx)(ke.qr, {
                    children: (0, r.jsx)(qe, {
                      item: e
                    })
                  }, e.key)), e && e.map((e, a) => e && (0, r.jsx)(ke.qr, {
                    children: e
                  }, u && u[a]))]
                })
              }), (0, r.jsx)(Ue, {
            ...
            }), (d?.title || d?.description) && (0, r.jsx)(Me, {
              item: d
            })]
          })
        },
      ...
      const Ke = ({
          ...
          return a ? (0, r.jsxs)(u, {
            ...
            isActive: () => t,
            className: We.activeNavItem,
            children: [(0, r.jsx)("div", {
              className: [We.navTitle, te.swipe, t ? te.red : te.gray].join(" "),
              children: a.title
            }), (0, r.jsx)(Qe, {
              role: a
            })]
        ...
        Ye = ({
          ...
          className: [We.progressionItem, te.swipe, te.gray].join(" "),
          children: [(0, r.jsx)("i", {
            style: {
              background: `url(${t(59393)(`./${e.title_slug}.png`)}) no-repeat center/contain`
            }
          }), (0, r.jsxs)("div", {
            className: We.progressionItemText,
            children: [(0, r.jsx)("h5", {
              children: e.title
            }), (0, r.jsx)("div", {
              children: e.description
        ...
        Je = ({
          ...
          return s ? (0, r.jsxs)("div", {
            className: We.prestigiousItem,
            "aria-label": e?.title,
            tabIndex: 0,
            children: [(0, r.jsx)("div", {
              role: "presentation",
              className: We.prestigiousImg,
              style: {
        ...
        Ze = (0, o.withTranslations)(({
          ...
          return (0, s.useEffect)(() => {
            ...
            children: [(0, r.jsxs)("section", {
              ...
              className: We.nav,
              children: a.map(e => (0, r.jsx)(Ke, {
                activeRole: i,
                role: e
              }, e.title_slug))
            }), i && (0, r.jsx)("section", {
              className: We.mobileActiveRole,
              children: (0, r.jsx)(Qe, {
                role: i
              })
            }), (0, r.jsx)("span", {
              ...
              className: We.infoBlocks,
              children: i.roles_info_blocks.map(e => (0, r.jsxs)("div", {
                className: We.infoBlock,
                children: [(0, r.jsx)("div", {
                  className: We.infoBlockImg,
                  style: {
                    "--aspect-ratio": "16/9",
              ...
              className: We.prestigious,
              children: (0, r.jsx)("div", {
                className: We.progressionText,
                dangerouslySetInnerHTML: {
                  __html: i.prestigious_intro_text
                }
              })
            }), (0, r.jsxs)("section", {
              className: We.progression,
              children: [(0, r.jsx)("div", {
                className: We.progressionText,
                dangerouslySetInnerHTML: {
                ...
                className: We.progressionItems,
                children: i.roles_items.map((e, a) => {
                  if (!e.type) return (0, r.jsx)(Ye, {
                    item: e
                  }, `progression-items-${a}`)
                }).filter(Boolean)
              })]
        ...
        ta = ({
          ...
          className: ea.showdownAndElimination,
      ...
      const na = () => {
          const {
            ...
            data: a
          } = (0, o.useQuery)(sa.RDOFeatureDetail, {
            variables: {
              featureSlug: e,
              withRoles: "roles" === e
            },
      ...
      const da = {
        ...
        la = ({
          ...
          children: (0, r.jsx)("div", {
            className: da.wheelerRawson,
            children: (0, r.jsxs)("div", {
              className: da.wheelerContent,
              children: [(0, r.jsx)("h2", {
        ...
        ma = ({
          ...
          className: da.features,
          children: [(0, r.jsx)(ee, {
            text: e("Features")
          }), (0, r.jsx)("div", {
            className: da.grid,
            children: a.map(e => (0, r.jsx)(Q, {
              feature: e
            }, e.title_slug))
          }), (0, r.jsx)("div", {
            className: da.newsEtc,
            children: (0, r.jsx)(re, {
              color: "red",
        ...
        ua = ({
          ...
          }, [n, o]), (0, r.jsxs)("section", {
            className: da.top,
            children: [(0, r.jsxs)("div", {
              className: da.content,
              children: [(0, r.jsx)("img", {
                className: da.gameLogo,
                alt: "Red Dead Online",
                src: t(94643)
              }), (0, r.jsxs)("div", {
                className: da.links,
      ...
      const ba = () => {
        ...
        return (0, r.jsx)(fa.NewswireArticle, {
          idHash: String(e)
        })
      };
      var ka = t(96566);
      const ha = {
        ...
        va = ({
          ...
          const d = (0, ve.A)(ha.button, ha[t], e);
          return s ? (0, r.jsx)(u, {
            ...i,
            to: s,
            className: d,
      ...
      const ya = {
        ...
        Sa = ({
          ...
          const {
            track: c
          } = (0, d.h)(), [m] = (0, l.useSearchParams)(), _ = t.preview_images_parsed.newswire_block, g = (0, xa.Ub)(wa.fi.mobile), p = {
          ...
          return (0, r.jsx)(u, {
            to: t.url,
            className: [ja.newswireBlock, n ? ja.newswireBlockNoSpecialOrder : "", null !== f ? ja.startAnimation : ""].join(" "),
            focused: i,
            onClick: k,
            children: (0, r.jsxs)(r.Fragment, {
              children: [0 !== a || m.get("tag_id") ? (0, r.jsx)("div", {
                ...
                className: g ? ja.previewMobile : ja.preview,
                style: g ? b.mobile : b.default
              }), (0, r.jsxs)("div", {
                className: ja.info,
                children: [(0, r.jsxs)("div", {
                  className: ja.top,
                  children: [t.primary_tags.length ? (0, r.jsx)(Na, {
      ...
      (0, o.withTranslations)(({
        ...
        children: [(0, r.jsx)("h2", {
          ...
          className: [za.posts, 1 === e.length ? za.just1post : ""].join(" "),
          children: e.map(e => (0, r.jsx)(Sa, {
            noSpecialOrder: !0,
            post: e
          }, e.id))
        })]
      ...
      const Oa = {
        ...
        Ea = (0, o.withGtmTracking)(({
          ...
          return (0, s.useEffect)(() => {
            ...
            className: [Oa.newswireBlocks, a ? Oa.noSpecialOrder : "", Oa.contextHome].join(" "),
            children: t.map((t, s) => (0, r.jsx)(Sa, {
              section: e,
              index: s,
              noSpecialOrder: a,
              post: t,
      ...
      const Fa = (0, o.withTranslations)(({
        ...
        Da = ({
          ...
          return (0, r.jsx)("div", {
            className: [Ba.screencap, s ? Ba.screencapLoaded : ""].join(" "),
            "aria-label": e?.title,
            role: "img",
            style: {
      ...
      var Va = t(87529);
      const La = (0, o.withTranslations)(({
        t: e
      }) => {
        const {
          data: a
        } = (0, o.useQuery)(Va.RDOTrailers, {
          autoSetLoading: !0
        });
        if (!a) return null;
        const {
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsxs)("section", {
            ...
            children: [(0, r.jsx)("h2", {
              ...
              className: Ma.grid,
              children: t.results.slice(1, 99).map(e => (0, r.jsx)(Ra, {
                video: e,
      ...
      const Ca = (0, o.withTranslations)(({
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(P.PlayerWithInfo, {
              ...
              children: [(0, r.jsx)("h2", {
                ...
                children: n.results.map(e => (0, r.jsx)(Ra, {
                  video: e,
                  toExplicit: `../videos/${e.id}`
                }, e.id))
              })]
        ...
        qa = (0, n.withIntl)(() => {
          ...
          return (0, r.jsxs)("div", {
            className: Ga.gameSite,
            children: [(0, r.jsx)("div", {
              className: [Ga.gameSiteContent, e ? Ga.navOpen : ""].join(" "),
              children: (0, r.jsx)($a, {})
            }), (0, r.jsx)("div", {
              className: Ga.reddeadrating,
              children: (0, r.jsx)(v, {
      ...
      const g = (e, a) => {
          ...
          return (0, s.useEffect)(() => {
            if (n && r.setTitleDataPath) {
              const e = m().get(n, r.setTitleDataPath) ?? null;
              e && window.postMessage({
                type: "graph.titleUpdate",
                title: e
              })
            }
          }, [n]), (0, s.useEffect)(() => (r.autoSetLoading && window.postMessage({
        ...
        f = {
          cache: window?.["apollo-cache"] ?? (window["apollo-cache"] = new n.D)
        },
        b = [() => p, {
          data: null,
          loading: !1,
          called: !1,
          reset: () => null,
          client: window?.["apollo-client"] ?? (window["apollo-client"] = new o.R(f))
        }],
        k = (0, s.createContext)(() => b),
        ...
        v = window?.["apollo-use-query"] ?? (window["apollo-use-query"] = (e, a) => (0, s.useContext)(u)(e, a)),
        x = window?.["apollo-use-mutation"] ?? (window["apollo-use-mutation"] = e => (0, s.useContext)(k)(e))
    },
    96665: e => {
      "use strict";
