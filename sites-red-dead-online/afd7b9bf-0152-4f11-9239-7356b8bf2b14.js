! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "afd7b9bf-0152-4f11-9239-7356b8bf2b14", e._sentryDebugIdIdentifier = "sentry-dbid-afd7b9bf-0152-4f11-9239-7356b8bf2b14")
  } catch (e) {}
}();
    ...
    8852: (e, a, s) => {
      ...
      const l = e => {
        ...
        p = e => {
          ...
          const n = s.path.map((e => 1 === s.path.length && "_root" === e.feedback_type.name ? null : (0, b.jsx)(d.NavLink, {
              to: `?step=${e.id_hash}`,
              className: f[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            r = s.next.map((e => "_root" === e.feedback_type.name ? null : (0, b.jsxs)(d.NavLink, {
        ...
        g = e => {
          ...
          const {
            ...
            loggedIn: l
          } = (0, n.useRockstarUser)(), p = (0, t.useRef)(), [g, {
            data: m,
            error: k
          }] = (0, r.useMutation)(s);
          return l ? m?.submittal?.id ? (0, b.jsx)("div", {
            className: f.success,
            dangerouslySetInnerHTML: {
