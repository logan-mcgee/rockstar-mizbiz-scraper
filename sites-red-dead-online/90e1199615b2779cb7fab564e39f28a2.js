! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "d32e2967-d86d-407d-98f1-15d6dbe8aeb5", e._sentryDebugIdIdentifier = "sentry-dbid-d32e2967-d86d-407d-98f1-15d6dbe8aeb5")
  } catch (e) {}
}();
    ...
    39544: (e, a, s) => {
      ...
      const f = e => {
        ...
        b = e => {
          ...
          const r = s.path.map((e => 1 === s.path.length && "_root" === e.feedback_type.name ? null : (0, i.jsx)(d.NavLink, {
            ...
            n = s.next.map((e => "_root" === e.feedback_type.name ? null : (0, i.jsxs)(d.NavLink, {
              ...
              children: [e.feedback_type.title, e.message ? (0, i.jsx)("div", {
        ...
        l = e => {
          ...
          const {
            loggedIn: n
          } = (0, c.useRockstarUser)(), f = (0, t.useRef)(), [b, {
            data: l,
            error: p
          }] = (0, r.useMutation)(s);
          return n ? l?.submittal?.id ? (0, i.jsx)("div", {
            className: o.success,
            dangerouslySetInnerHTML: {
