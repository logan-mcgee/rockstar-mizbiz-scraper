try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "565abd18-93af-4139-9f9e-6fecfcab9185", e._sentryDebugIdIdentifier = "sentry-dbid-565abd18-93af-4139-9f9e-6fecfcab9185")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
        ...
        v = function(e) {
          function t(e) {
            ...
            ! function(e, t) {
              ...
              return u
            }, (a = c(a = "getNodeForOption")) in o ? Object.defineProperty(o, a, {
              value: i,
              enumerable: !0,
              configurable: !0,
              writable: !0
          ...
          var n, i = (null == t ? void 0 : t.document) || document,
            ...
            P = function(e) {
              ...
              if (g.tabbableGroups.length > 0) {
                ...
                if (u < 0) i = r ? g.tabbableGroups[g.tabbableGroups.length - 1].lastTabbableNode : g.tabbableGroups[0].firstTabbableNode;
                else if (r) {
            ...
            R = function(e) {
              ...
              if (n || t instanceof Document) n && (g.mostRecentlyFocusedNode = t);
                ...
                if (g.mostRecentlyFocusedNode)
                  if ((0, o.getTabIndex)(g.mostRecentlyFocusedNode) > 0) {
                    ...
                    if (u.length > 0) {
                      ...
                      s >= 0 && (m.isKeyForward(g.recentNavEvent) ? s + 1 < u.length && (a = u[s + 1], r = !1) : s - 1 >= 0 && (a = u[s - 1], r = !1))
                    }
                ...
                })), D(a || g.mostRecentlyFocusedNode || E())
              }
          ...
          return n = {
            ...
            activate: function(e) {
              ...
              var t, o = w(e, "onActivate"),
                a = w(e, "onPostActivate"),
                r = w(e, "checkCanFocusTrap"),
                s = l.getActiveTrap(u),
                c = !1;
              s && !s.paused && (null === (t = s._setSubtreeIsolation) || void 0 === t || t.call(s, !1), c = !0);
              try {
                r || S(), g.active = !0, g.paused = !1, g.nodeFocusedBeforeActivation = k(i), null == o || o();
                var d = function() {
                  r && S(), _(), G(), m.isolateSubtrees && n._setSubtreeIsolation(!0), null == a || a()
                };
            ...
            deactivate: function(e) {
              ...
              clearTimeout(g.delayInitialFocusTimer), g.delayInitialFocusTimer = void 0, g.paused || n._setSubtreeIsolation(!1), g.alreadySilent.clear(), j(), g.active = !1, g.paused = !1, G(), l.deactivateTrap(u, n);
              var o = w(t, "onDeactivate"),
                a = w(t, "onPostDeactivate"),
                r = w(t, "checkCanReturnFocus"),
                i = w(t, "returnFocus", "returnFocusOnDeactivate");
              null == o || o();
              var c = function() {
                v(function() {
                  i && D(F(g.nodeFocusedBeforeActivation)), null == a || a()
                })
              };
              return i && r ? (r(F(g.nodeFocusedBeforeActivation)).then(c, c), this) : (c(), this)
            },
            pause: function(e) {
            ...
            updateContainerElements: function(e) {
              ...
              }(g.containers), g.active && (S(), m.isolateSubtrees && !g.paused && n._setSubtreeIsolation(!0)), G(), this
            }
            ...
            _setPausedState: {
              value: function(e, t) {
                ...
                if (g.paused = e, e) {
                  var o = w(t, "onPause"),
                    a = w(t, "onPostPause");
                  null == o || o(), j(), G(), n._setSubtreeIsolation(!1), null == a || a()
                } else {
                  var r = w(t, "onUnpause"),
                    i = w(t, "onPostUnpause");
                  null == r || r(), n._setSubtreeIsolation(!0), S(), _(), G(), null == i || i()
                }
                return this
              }
            },
      ...
      var o = ["input:not([inert]):not([inert] *)", "select:not([inert]):not([inert] *)", "textarea:not([inert]):not([inert] *)", "a[href]:not([inert]):not([inert] *)", "area[href]:not([inert]):not([inert] *)", "button:not([inert]):not([inert] *)", "[tabindex]:not(slot):not([inert]):not([inert] *)", "audio[controls]:not([inert]):not([inert] *)", "video[controls]:not([inert]):not([inert] *)", '[contenteditable]:not([contenteditable="false"]):not([inert]):not([inert] *)', "details>summary:first-of-type:not([inert]):not([inert] *)", "details:not([inert]):not([inert] *)"],
          ...
          for (var o = [], r = Array.from(e); r.length;) {
            ...
            if (!s(u, !1))
              if ("SLOT" === u.tagName) {
                ...
                i.call(u, a) && n.filter(u) && (t || !e.includes(u)) && o.push(u);
                ...
                } else r.unshift.apply(r, u.children)
              }
          }
          return o
        },
        ...
        h = function(e, t) {
          return !(t.disabled || function(e) {
            ...
            var a = getComputedStyle(e).visibility;
        ...
        g = function(e) {
          ...
          return e.forEach(function(e, o) {
            var a = !!e.scopeParent,
              ...
              u = a ? g(e.candidates) : r;
            0 === i ? a ? t.push.apply(t, u) : t.push(r) : n.push({
              documentOrder: o,
              tabIndex: i,
              item: e,
              isScope: a,
