  ...
  [322], {
    4322: (e, a, t) => {
      ...
      var n = t(4859),
        ...
        i = t(9929);
      const r = {
        cta: "rockstargames-sites-red-dead-onlined738e20bff0d7e85aad04d2eed843892",
        gameSiteHeader: "rockstargames-sites-red-dead-onlineaa409680c8bdd2b951705649da58ea5b",
        headerLogo: "rockstargames-sites-red-dead-onlinecf57abd86625894d6361543b412d495e",
        activeClassName: "rockstargames-sites-red-dead-onlinecc5116ddc6ce10d79fe1aa73187ff636"
      };
      var o = t(3705);
      const d = (0, i.withTranslations)((0, i.withLocale)((e => {
        let {
          locale: a,
          t
        } = e;
        const i = (0, n.useMutateState)(),
          d = [{
            to: "",
            label: "Home",
            end: !0
        ...
        return (0, o.jsx)(s.GameSiteHeader, {
          buttonText: "Red Dead Online",
          navLinks: d,
          cta: m,
          game: "rdo",
          gameOverrideStyles: r
        })
      })), "rdo");
      var m = t(7583),
        c = t(927);
          ...
          children: [(0, o.jsxs)("section", {
            ...
            children: [(0, o.jsx)("div", {
              ...
              children: [{
                ...
                return (0, o.jsx)("div", {
                  className: [p.bar, e.name === i ? p.activeBar : ""].join(" "),
                  style: {
      ...
      const h = {
        ...
        j = e => {
          ...
          return (0, c.useEffect)((() => {
            ...
            children: [(0, o.jsx)("div", {
              className: [h.trackGrid, 0 !== p ? h.trackDragging : ""].join(" "),
              ref: r,
              style: {
                "--drag-x": `${p}px`
              },
              ...
              children: (0, o.jsx)("div", {
                className: h.paging,
                children: Array.from(new Array(g)).map(((e, a) => (0, o.jsx)("a", {
                  onClick: () => m(a),
                  className: d === a ? h.activePage : ""
                }, a)))
              })
            })]
          })
        ...
        N = e => {
          ...
          }), [r, d] = (0, c.useState)([]), [m, p] = (0, c.useState)(null);
          return (0, c.useEffect)((() => {
            if (i && !r.length) {
              const e = i.rdoClubRewards.clubs_items.filter((e => e.pass === s));
              d(e), p(e[0])
            }
          }), [i]), i && r.length ? (0, o.jsxs)("div", {
            className: h.clubRewardsModule,
            children: [a ? (0, o.jsx)(x, {
              activeItem: m,
              clubId: t,
              children: (0, o.jsx)(v, {
                activeItem: m,
      ...
      (0, i.importAll)(t(1144));
      const O = (0, i.withLocale)((e => {
          let {
            className: a,
            locale: n,
            titleSlug: s
      ...
      (0, i.importAll)(t(5706));
      const E = (0, i.withTranslations)((e => {
          let {
            feature: a,
            tips: n = [],
            t: s
          } = e;
          return n.length ? (0, o.jsxs)("section", {
      ...
      (0, i.importAll)(t(4505));
      const $ = (0, s.withSimpleErrorBoundary)((e => {
          let {
            highlight: a
          } = e;
          return (0, o.jsx)(s.A, {
        ...
        L = e => {
          ...
          return (0, o.jsx)(s.A, {
            className: [A.link, A.swipe, A[a]].join(" "),
            to: i,
            target: n,
            children: t
          })
        ...
        M = e => {
          ...
          return "halloween" === a ? (0, o.jsx)(B, {}) : (0, o.jsx)(C, {})
        },
        ...
        J = e => {
          ...
          return (0, c.useEffect)((() => {
            ...
            children: [(0, o.jsx)(V, {
              ...
              ref: n,
              children: a.sub_features.map(((e, a) => (0, o.jsx)("button", {
              ...
              children: a.sub_features.map(((e, n) => (0, o.jsxs)("div", {
      ...
      const Y = e => {
          ...
          return t ? (0, o.jsxs)(s.A, {
            to: `?active=${t.title_slug}`,
            isActive: () => n,
            className: K.activeNavItem,
            children: [(0, o.jsx)("div", {
              className: [K.navTitle, A.swipe, n ? A.red : A.gray].join(" "),
              children: t.title
            }), (0, o.jsx)(Z, {
              role: t
            })]
        ...
        ee = e => {
          ...
          return (0, o.jsxs)("div", {
            className: [K.progressionItem, A.swipe, A.gray].join(" "),
            children: [(0, o.jsx)("i", {
              style: {
        ...
        te = (0, i.withTranslations)((e => {
          ...
          const [d, m] = (0, c.useState)(null), p = (0, i.useQueryParams)();
          return (0, c.useEffect)((() => {
            const e = null === p.get("active") ? n[0] : n.find((e => e.title_slug === p.get("active")));
            m(e)
          }), [p.get("active")]), null === d ? null : (0, o.jsxs)("div", {
            className: K.roles,
            children: [(0, o.jsxs)("section", {
              className: K.top,
              children: [(0, o.jsx)("h1", {
              ...
              children: d.roles_info_blocks.map((e => (0, o.jsxs)("div", {
            ...
            }), d.prestigious_intro_text && (0, o.jsx)("section", {
              ...
              children: [(0, o.jsx)("div", {
                ...
                children: d.roles_items.map(((e, a) => {
                  if (!e.type) return (0, o.jsx)(ee, {
                    item: e
                  }, `progression-items-${a}`)
                })).filter(Boolean)
              })]
            }), d.prestigious_item_text && (0, o.jsxs)("section", {
              className: K.prestigious,
              children: [(0, o.jsx)("div", {
                className: K.progressionText,
                dangerouslySetInnerHTML: {
                ...
                children: d.roles_items.filter((e => "prestigious" === e.type)).map(((e, a) => (0, o.jsx)("div", {
                  children: (0, o.jsx)(ae, {
                    item: e
                  })
                }, `prestigious-items-${a}`)))
        ...
        ie = e => {
          ...
          return (0, o.jsx)("section", {
            ...
            children: a.sub_features.map((e => (0, o.jsxs)("div", {
              className: ne.item,
              children: [(0, o.jsx)(se, {
        ...
        re = e => {
          ...
          const t = (0, c.useRef)([]),
            n = (0, i.useQueryParams)();
          return (0, c.useEffect)((() => {
            if (!n.get("active")) return;
            const e = t?.current?.[n.get("active")];
            e && e.scrollIntoView()
          }), [n.get("active")]), (0, o.jsxs)(o.Fragment, {
            children: [(0, o.jsx)(V, {
              titleSlug: a.title_slug,
              titleImg: a.img_title
            }), (0, o.jsx)(z, {
      ...
      const de = () => {
        const {
          ...
          data: a
        } = (0, n.useQuery)(oe.RDOFeatureDetail, {
          variables: {
            featureSlug: e,
            withRoles: "roles" === e
          },
      ...
      const ve = () => {
        ...
        xe = () => (0, o.jsx)("div", {
          ...
          children: (0, o.jsx)(s.NewswireList, {
            tagId: 736,
      ...
      var Ne = t(4371);
      const we = (0, i.withTranslations)((e => {
        let {
          t: a
        } = e;
        const {
        ...
        return (0, o.jsxs)("div", {
          ...
          children: [(0, o.jsxs)("section", {
            ...
            children: [(0, o.jsx)("h2", {
              ...
              className: je.grid,
              children: i.results.slice(1, 99).map((e => (0, o.jsx)(s.VideoCard.Link, {
                video: e
              }, e.id)))
            })]
          })]
      ...
      var ze = t(5477);
      const Se = (0, i.withTranslations)((e => {
          let {
            t: a
          } = e;
          const {
          ...
          return (0, o.jsxs)("div", {
            ...
            children: [(0, o.jsx)(f.PlayerWithInfo, {
              video: r
            }), (0, o.jsxs)("section", {
              ...
              children: [(0, o.jsx)("h2", {
                ...
                children: d.results.map((e => (0, o.jsx)(s.VideoCard.Link, {
                  video: e
                }, e.id)))
              })]
            })]
        ...
        ye = [{
          ...
          path: "*",
          element: (0, o.jsx)(s.Wasted, {
            error: {
              code: window?.env?.responseStatusCode ?? 398
            }
          })
        }],
        Fe = (0, s.withSimpleErrorBoundary)((() => (0, m.useRoutes)(ye))),
        De = {
