try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    o = (new e.Error).stack;
  o && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[o] = "60cff9a8-a8db-4dd8-8fdf-dfb2ff7439f8", e._sentryDebugIdIdentifier = "sentry-dbid-60cff9a8-a8db-4dd8-8fdf-dfb2ff7439f8")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [4218], {
    94819(e, o, t) {
      ...
      function r(e) {
        ...
        var o = s[e],
          r = o[0];
        return t.e(o[1][0]).then(() => t.t(r, 23))
      }
    ...
    61983(e, o, t) {
      ...
      r.keys = () => Object.keys(s), r.id = 61983, e.exports = r
    },
    77461(e, o, t) {
      var s = {
        "./de": [92845, [4710]],
      ...
      r.keys = () => Object.keys(s), r.id = 77461, e.exports = r
    },
    5267(e, o, t) {
      var s = {
        "./de": [406, [299]],
    ...
    12841(e, o, t) {
      "use strict";
      t.r(o), t.d(o, {
        FormattedMessage: () => s.sA,
        POSIXLocales: () => m,
        ReactIntlProviderForMocking: () => s.Dk,
        createDevLocaleHook: () => _,
        createIntl: () => s.EY,
        defineMessages: () => s.YK,
        englishLocale: () => p,
        getCookieValueByName: () => c,
        getLocale: () => b,
        linkWithLocale: () => x,
      ...
      const l = (e, o) => {
        ...
        b = () => {
          ...
          const i = `rockstarweb_lang.${o.cookieIdentifier}`,
            l = c(i);
          n = o.currentSite?.site === a.C.www ? f.find(e => e.subdomaincom === s) || f.find(e => e.subdomaincom === t) || r : f.find(e => e.iso === l) || r;
          const [, u] = d(i, n.iso);
          return [n, u]
        };
      ...
      function h(e) {
        const o = e.split("-");
        return (0, i.A)(o[1] ? o[0] : e, ["relativetimeformat", "pluralrules", "listformat"])
      }
        ...
        x = e => {
          ...
          if (s)
            for (const [r, {
              ...
              let m = "";
              return "www" !== r || c?.some(e => e.test(s.pathname)) ? (m += `https://${d}`, m += i ? `.${p.at(-2)}.${p.at(-1)}` : `.${p.at(-1)}`, {
                link: `${m}${u}${"/"===s.pathname?"":s.pathname}${s.search}${s.hash}`,
                isExternal: !0
              }) : {
        ...
        $ = ({
          ...
          const s = (0, a.A)(),
            ...
            l = (e => {
              ...
              const t = o.split("/");
              return f.map(e => e.subdomaincom).includes(t[0]) && (o = t.slice(1).join("/")), s.currentSite?.site === a.C.www ? "en" === e ? `${window.location.origin}/${o}${location.search}` : `${window.location.origin}/${e}/${o}${location.search}` : `${window.location.origin}/${o}${location.search}`
            })(n);
          o?.({
            event: "cta_other",
            link_url: l,
    ...
    79867(e, o, t) {
      ...
      const a = {
        ...
        c = () => {
          ...
          const {
            location: o
          } = window, t = o.hostname.substring(0, o.hostname.indexOf(".rockstargames.com")), s = l.findIndex(o => Object.entries(o.sites).findIndex(([o, s]) => s === t && (e = {
            site: o,
            subDomain: s
          }, !0)) >= 0), n = l[s >= 0 ? s : 0], a = l.find(e => e.id === n.fallbackEnvironment);
          return e || (e = {
            site: "www",
            subDomain: "local"
          }), i()(r()({}, a, {
