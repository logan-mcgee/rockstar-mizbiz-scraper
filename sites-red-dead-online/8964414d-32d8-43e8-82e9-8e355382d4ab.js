! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "8964414d-32d8-43e8-82e9-8e355382d4ab", e._sentryDebugIdIdentifier = "sentry-dbid-8964414d-32d8-43e8-82e9-8e355382d4ab")
  } catch (e) {}
}();
  ...
  [852], {
    77100: (e, t, a) => {
      ...
      let s, i, r, n, o, d, c, l, m, u, g, f = {
        ...
        yt = function() {
          ...
          return s = {
            ...
            wake() {
              l && (!d && I() && (o = d = window, c = o.document || {}, R.gsap = xa, (o.gsapVersions || (o.gsapVersions = [])).push(xa.version), U($ || o.GreenSockGlobals || !o.gsap && o || {}), a = o.requestAnimationFrame, mt.forEach(ut)), e && s.sleep(), t = a || (e => setTimeout(e, h - 1e3 * s.time + 1 | 0)), g = 1, b(2))
            },
            sleep() {
      ...
      let Bt, Vt, Ft = function(e, t, a, s, i, r, n) {
        ...
        Rt = function(e, t, a, s, i, r, n, o, d, c) {
          j(s) && (s = s(i || 0, e, r));
          let l, m = e[t],
            u = "get" !== a ? a : j(m) ? d ? e[t.indexOf("set") || !j(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](d) : e[t]() : m,
            g = j(m) ? d ? Qt : Kt : Yt;
          if (N(s) && (~s.indexOf("random(") && (s = rt(s)), "=" === s.charAt(1) && (l = me(u, s) + (qe(u) || 0), (l || 0 === l) && (s = l))), !c || u !== s || Vt) return isNaN(u * s) || "" === s ? (!m && !(t in e) && G(t, s), Ft.call(this, e, t, u, s, g, o || f.stringFilter, d)) : (l = new da(this._pt, e, t, +u || 0, s - (u || 0), "boolean" == typeof m ? ta : ea, 0, g), d && (l.fp = d), n && l.modifier(n, this, e), this._pt = l)
        },
        $t = (e, t, a, s, i, r) => {
          let n, o, d, c;
          ...
          if (R && (!z || !w) && (w = "none"), e._ease = It(w, p.ease), e._yEase = L ? Ct(It(!0 === L ? w : L, p.ease)) : 0, L && e._yoyo && !e._repeat && (L = e._yEase, e._yEase = e._ease, e._ease = L), e._from = !R && !!y.runBackwards, !R || z && !y.stagger) {
            ...
            for (e._pt = e._ptCache = 0, S = O && M(S) || S && !O, o = 0; o < D.length; o++) {
              if (l = D[o], u = l._gsap || re(D)[o]._gsap, e._ptLookup[o] = k = {}, J[u.id] && Z.length && ge(), b = V === D ? o : V.indexOf(l), g && !1 !== (f = new g).init(l, v || r, e, b, V) && (e._pt = c = new da(e._pt, l, f.name, 0, 1, f.render, f, 0, f.priority), f._props.forEach((e => {
                ...
                for (d in r) ee[d] && (f = $t(d, r, e, b, l, V)) ? f.priority && (m = 1) : k[d] = c = Rt.call(e, l, d, "get", r[d], b, V, 0, y.stringFilter);
              e._op && e._op[o] && e.kill(l, e._op[o]), F && e._pt && (Bt = e, n.killTweensOf(l, k, e.globalTime(t)), x = !e.parent, Bt = 0), e._pt && S && (J[u.id] = 1)
            }
      ...
      let Fa, Ra, $a, Ua, Ga, Ha, qa, Wa, Xa, Ya = {},
        ...
        Ps = (e, t, a, s) => {
          let i, r, n, o, d = parseFloat(a) || 0,
            ...
            p = "px" === s,
            _ = "%" === s;
          return s === c || !d || Ls[s] || Ls[c] ? d : ("px" !== c && !p && (d = Ps(e, t, a, "px")), o = e.getCTM && Ms(e), !_ && "%" !== c || !Ya[t] && !~t.indexOf("adius") ? (l[m ? "width" : "height"] = f + (p ? c : s), r = ~t.indexOf("adius") || "em" === s && e.appendChild && !u ? e : e.parentNode, o && (r = (e.ownerSVGElement || {}).parentNode), r && r !== Ra && r.appendChild || (r = Ra.body), n = r._gsap, n && _ && n.width && m && n.time === yt.time && !n.uncache ? ce(d / n.width * f) : ((_ || "%" === c) && !zs[ys(r, "display")] && (l.position = ys(e, "position")), r === e && (l.position = "static"), r.appendChild(Ga), i = Ga[g], r.removeChild(Ga), l.position = "absolute", m && _ && (n = ne(r), n.time = yt.time, n.width = r[g]), ce(p ? i * d / f : i && d ? f / i * d : 0))) : (i = o ? e.getBBox()[m ? "width" : "height"] : e[g], ce(_ ? d / i * f : d / 100 * i)))
        },
        Os = (e, t, a, s) => {
          let i;
          return Ua || js(), t in as && "transform" !== t && ~(t = as[t]).indexOf(",") && (t = t.split(",")[0]), Ya[t] && "transform" !== t ? (i = Ws(e, s), i = "transformOrigin" !== t ? i[t] : i.svg ? i.origin : Xs(ys(e, _s)) + " " + i.zOrigin + "px") : (i = e.style[t], (!i || "auto" === i || s || ~(i + "").indexOf("calc(")) && (i = Fs[t] && Fs[t](e, t, a) || ys(e, t) || oe(e, t) || ("opacity" === t ? 1 : 0))), a && !~(i + "").trim().indexOf(" ") ? Ps(e, t, i, a) + a : i
        },
        As = function(e, t, a, s) {
          if (!a || "none" === a) {
            let s = Ns(t, e, 1),
        ...
        Hs = (e, t) => {
          let a, s, i, r, n = e._gsap || ne(e),
            o = e.style,
            d = Gs(e);
          return n.svg && e.getAttribute("transform") ? (i = e.transform.baseVal.consolidate().matrix, d = [i.a, i.b, i.c, i.d, i.e, i.f], "1,0,0,1,0,0" === d.join(",") ? Rs : d) : (d !== Rs || e.offsetParent || e === $a || n.svg || (i = o.display, o.display = "block", a = e.parentNode, a && e.offsetParent || (r = 1, s = e.nextElementSibling, $a.appendChild(e)), d = Gs(e), i ? o.display = i : Is(e, "display"), r && (s ? a.insertBefore(e, s) : a ? a.appendChild(e) : $a.removeChild(e))), t && d.length > 6 ? [d[0], d[1], d[4], d[5], d[12], d[13]] : d)
        },
        qs = (e, t, a, s, i, r) => {
    ...
    65596: (e, t, a) => {
      ...
      const $ = (0, a(62748).U1)(),
        ...
        G = e => {
          ...
          const [s, i] = (0, o.useState)(!1), r = (e => {
            const [t] = (0, m.useSearchParams)(), [a, s] = (0, o.useState)(null), i = (0, R.useRockstarUser)(), {
              loggedIn: r
            } = i, {
              currentCharId: n
            } = (0, R.useRockstarUserState)(), d = (0, R.useIsUserGtaPlus)(i?.data, n);
            return (0, o.useEffect)((() => {
      ...
      const le = e => {
        ...
        me = e => {
          ...
          const {
            track: v
          } = (0, R.useGtmTrack)(), x = (0, F.useDataLayer)(), y = i ?? t, w = (0, F.findPlatform)(p)?.friendlyName, N = (0, o.useMemo)((() => {
      ...
      const $e = {
        ...
        Ye = e => {
          ...
          const [f, p] = (0, o.useState)(!1), {
            track: _
          } = (0, R.useGtmTrack)(), h = (0, o.useRef)(null), k = (0, o.useRef)(f);
          (0, o.useEffect)((() => {
            k.current = f
          }), [f]), (0, o.useEffect)((() => {
            const e = e => {
      ...
      const it = function(e) {
        ...
        ut = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            r(e), d(t)
          }), [a]), i.length ? (0, g.jsx)(Re.q.div, {
            variants: t ? ct : void 0,
            children: (0, g.jsx)(Ye, {
              variant: "gen9",
              buttonText: s,
              platformsAndLinks: i,
              children: !!n.length && (0, g.jsx)(Re.q.div, {
                variants: ct,
                children: (0, g.jsx)(z, {
                  buttons: n,
      ...
      const ht = (0, d.defineMessages)({
        ...
        bt = (0, d.withIntl)((e => {
          ...
          const {
            track: r
          } = (0, R.useGtmTrack)(), n = (0, m.useLocation)(), c = (0, d.useIntl)(), [l, u] = (0, d.getLocale)(), [p, _] = (0, o.useState)(!1), h = (0, o.useMemo)((() => (0, _t.c)()), []), k = (0, o.useCallback)((e => {
            let t = n.pathname;
            const a = t.split("/");
        ...
        Pt = e => {
          ...
          }, [u, p] = (0, F.usePreloadImg)(l.default), _ = {
            default: {
      ...
      const Wt = (e, t) => {
        ...
        Jt = e => {
          ...
          } = (0, R.useRockstarUserState)(), [_, h] = (0, o.useState)(!1), [k, b] = (0, o.useState)(l), [v, x] = (0, o.useState)(!1), y = (0, d.useIntl)(), w = !!r?.length;
          (0, o.useEffect)((() => {
            if (Array.isArray(p)) {
              const e = p?.[0];
      ...
      const Wa = {
        ...
        Ya = e => {
          ...
          const {
            track: p
          } = (0, R.useGtmTrack)(), _ = (0, _t.c)(), h = (0, d.useIntl)();
          let k = s;
        ...
        Qa = e => {
          ...
          const {
            ...
            navOpen: _
          } = (0, R.useRockstarUserState)(), h = (0, F.useLocale)(), k = (0, F.toScLocaleString)(h), [b, v] = (0, o.useState)(""), x = (0, m.useLocation)(), y = `${t.login}?returnUrl=${b}&lang=${k}`, w = `${t.signup}&returnUrl=${b}&lang=${k}`, N = (0, o.useMemo)((() => (0, _t.c)()), []), j = (0, o.useMemo)((() => {
            const e = ((e, t, a) => [{
        ...
        es = e => {
          ...
          const {
            ...
            track: r
          } = (0, R.useGtmTrack)(), n = (0, d.useIntl)(), [c, l] = (0, o.useState)([]), [m, u] = (0, o.useState)(null), [f, p] = (0, o.useState)(null), [_, h] = (0, o.useState)(!1), [k, b] = (0, o.useState)(-1), [v, x] = (0, o.useState)([]), [y, w] = (0, o.useState)(0), N = a(71084), [j, S] = (0, o.useState)("0"), [T, C] = (0, o.useState)("0"), M = e => parseInt(e, 10).toLocaleString("en-US", {
        ...
        is = (0, F.withTranslations)((e => {
          ...
          const {
            ...
            setUserData: U
          } = (0, R.useRockstarUserState)(), [G, H] = (0, o.useState)(null), [q, W] = (0, o.useState)(null), [X, Y] = (0, o.useState)(!1), [K, Q] = (0, o.useState)(!1), [Z, J] = (0, o.useState)(0), ee = (0, o.createRef)(), te = ts(ee, !1), ae = (0, o.createRef)(), [se, ie] = (0, o.useState)(0), [re, ne] = (0, o.useState)([]), [oe, de] = (0, o.useState)(244), ce = (0, o.useRef)(null), le = (0, o.useMemo)((() => (0, _t.c)()), []), me = (0, o.useMemo)((() => ((e, t, a, s, i) => [{
      ...
      const _s = it((0, d.withIntl)((e => {
        ...
        Ls = (0, o.forwardRef)(((e, t) => {
          const {
            ...
            track: n
          } = (0, R.useGtmTrack)(r), [d, c] = (0, o.useState)(t?.current);
          return (0, o.useEffect)((() => {
      ...
      const zs = Ls,
        ...
        Gs = e => {
          ...
          const {
            track: c
          } = (0, R.useGtmTrack)(), [l, m] = (0, o.useState)([et.O4, et.Hj, et.eM]), [u, f] = (0, o.useState)(null), [p, _] = (0, o.useState)(null);
          return (0, o.useEffect)((() => {
      ...
      const Ks = {
        ...
        Js = (0, F.withLocale)((e => {
          ...
          const {
            ...
            setBodyIsLocked: r
          } = (0, F.useBodyScrollable)("VideoCarousel"), [n, d] = (0, o.useState)(0), [c, l] = (0, o.useState)(0), m = (0, o.useRef)(null), u = (0, o.useRef)(null);
          return (0, o.useEffect)((() => {
