try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    o = (new e.Error).stack;
  o && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[o] = "4dd247de-cf64-4a96-8472-c14f44ff40b9", e._sentryDebugIdIdentifier = "sentry-dbid-4dd247de-cf64-4a96-8472-c14f44ff40b9")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [784, 8403], {
    ...
    68403(e, o, t) {
      ...
      function i(e) {
        ...
        return "function" == typeof d ? d(Array.isArray(b) ? b : [b]) : f ? r.createElement(f, null, b) : r.createElement(r.Fragment, null, b)
      }
      ...
      const m = (e, o) => {
        ...
        x = () => {
          ...
          const a = `rockstarweb_lang.${o.cookieIdentifier}`,
            i = w(a);
          s = o.currentSite?.site === b.C.www ? k.find(e => e.subdomaincom === n) || k.find(e => e.subdomaincom === t) || r : k.find(e => e.iso === i) || r;
          const [, l] = h(a, s.iso);
          return [s, l]
        };
        ...
        j = e => {
          ...
          if (n)
            for (const [r, {
              ...
              if (!u) continue;
              let d = "";
              "en" !== o.subdomaincom && i && (d = `/${o[l||"subdomaincom"]}`, "circoloco" === r && "/" === n.pathname && (d += "/"));
              const p = n.host.split(".");
              let f = "";
              return "www" !== r || c?.some(e => e.test(n.pathname)) ? ("www" !== r && (f += `https://${u}`, f += a ? `.${p.at(-2)}.${p.at(-1)}` : `.${p.at(-1)}`), {
                link: `${f}${d}${"/"===n.pathname?"":n.pathname}${n.search}${n.hash}`,
                isExternal: !0
              }) : {
        ...
        I = ({
          ...
          const n = (0, b.A)(),
            ...
            i = (e => {
              ...
              const t = o.split("/");
              return k.map(e => e.subdomaincom).includes(t[0]) && (o = t.slice(1).join("/")), n.currentSite?.site === b.C.www ? "en" === e ? `${window.location.origin}/${o}${location.search}` : `${window.location.origin}/${e}/${o}${location.search}` : `${window.location.origin}/${o}${location.search}`
            })(s);
          o?.({
            event: "cta_other",
            link_url: i,
