try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "1e01cd70-63b5-4422-8c32-4b52187061b1", e._sentryDebugIdIdentifier = "sentry-dbid-1e01cd70-63b5-4422-8c32-4b52187061b1")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    1762(e, a, t) {
      ...
      const v = f(g(({
        ...
        w = (0, i.withTranslations)(({
          ...
          const [a] = (0, s.useState)(""), t = (0, l.useNavigate)(), n = (0, i.useMutateState)();
        ...
        N = ({
          ...
          let i = e?.message ?? t(y.wasted_error_404_new);
          i = t(y.wasted_error_404_new);
          const o = e?.code ?? 398,
            d = (0, s.useRef)(null);
      ...
      const E = () => {
        ...
        return (0, s.useEffect)(() => {
          const e = e => {
              c(a => a > -1 && o.current[a] && !o.current[a].contains(e.target) ? -1 : a)
            },
            a = e => {
              "Escape" === e.key && c(-1)
            };
      ...
      const D = (0, n.defineMessages)({
        ...
        V = ({
          ...
          const s = e.img_full,
            [n] = (0, i.usePreloadImg)(s);
          return (0, r.jsx)("div", {
            "aria-describedby": t,
            role: "img",
            className: (0, X.default)(R.mainImg, n ? R.imgLoaded : R.imgHidden),
            style: {
        ...
        L = ({
          ...
          const o = (0, n.useIntl)(),
            ...
            k = (r, s) => {
              ...
              e?.id !== i.id && t(i);
              const o = b(n);
              _(e => e === o ? e : o), s?.focus && requestAnimationFrame(() => {
                (e => {
                  d.current[e]?.focus({
                    preventScroll: !1
        ...
        I = ({
          ...
          }), [n, o] = (0, s.useState)([]), [d, c] = (0, s.useState)(), l = `slideshow-${e}-${a}`;
          return (0, s.useEffect)(() => {
      ...
      (0, i.importAll)(t(13411));
      const H = ({
          className: e,
          titleSlug: a,
          title: s
        }) => {
          const n = (0, i.useLocale)();
          return (0, r.jsx)("div", {
            role: "img",
            "aria-label": s,
          ...
          return (0, s.useEffect)(() => {
            ...
            children: [(0, r.jsx)(K, {
              ...
              children: e.sub_features.map((e, a) => (0, r.jsx)("button", {
                className: o === a ? "rockstargames-sites-red-dead-onlineae23c424516b1cce1764d4b74e5e4db2" : "",
                onClick: () => d(a),
                type: "button",
                children: e.title
              }, e.title_slug))
        ...
        je = ({
          ...
          let {
            ...
            const u = (0, s.useCallback)(e => {
              ...
              const r = `${a?(0,i.getCdnPrefix)(_):""}${t}`;
              return we(r)
            }, [_, d]);
            return {
              alt: e,
      ...
      const Oe = {
        ...
        Te = ({
          ...
          return delete n?.color, l && _ ? (0, r.jsx)("div", {
            ...
            children: (0, r.jsx)("ul", {
              className: (0, X.default)(Oe.itemList, Oe.noImg, Oe[t], Oe[d]),
            ...
            style: (0, i.safeStyles)(n),
            className: (0, X.default)(Oe.itemList, Oe.custom, c ? Oe.noImg : "", t ? Oe[t] : "", d ? Oe[d] : "", o ?? ""),
        ...
        De = ({
          ...
          className: (0, X.default)("rockstargames-sites-red-dead-onlinef8bc9589974046cdac4a2264be12d2df", a),
      ...
      const ia = ta,
        ...
        ca = (0, s.forwardRef)(function({
          ...
          const {
            ...
            max: d,
            mode: c
          } = (0, s.useContext)(oa), l = (0, s.useRef)(null), m = (0, s.useRef)(null);
          (0, s.useEffect)(() => (m.current = ia(l.current, {
            minSize: o,
            maxSize: d,
            multiLine: "multi" === c
          }), () => m.current.unsubscribe()), [o, d, c]), (0, s.useEffect)(() => {
        ...
        _a = ({
          ...
          const i = [];
          return n ? e.split(n).map(e => i.push(e)) : i.push(e), (0, r.jsxs)(ma, {
            splitter: n,
            role: s,
            ...
            children: [(0, r.jsx)(r.Fragment, {
              ...
              children: i.shift() && n && i.length >= 1 && (0, r.jsx)(da, {
                min: 8,
                max: 1e3,
                mode: "single",
                children: (0, r.jsx)(ca, {
        ...
        ua = ({
          ...
          const g = (0, s.useMemo)(() => {
            if (o?.badge || o?.discountTxt || e || t) return (0, r.jsx)(_a, {
              badge: o?.discountTxt ?? o?.badge ?? e ?? t,
              badgeType: a,
              splitter: o?.splitter ?? n,
              role: o?.role ?? m
            })
          }, [e, a, t, o, m, n]);
          return (0, r.jsx)(ga, {
      ...
      const ha = ({
        ...
        ya = (0, i.withTranslations)(({
          feature: e,
          roles: a,
          t: n
        }) => {
          const [o, d] = (0, s.useState)(null), c = (0, i.useQueryParams)();
          return (0, s.useEffect)(() => {
            ...
            children: [(0, r.jsxs)("section", {
              ...
              children: o.roles_info_blocks.map(e => (0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)("div", {
                  ...
                  style: {
                    "--aspect-ratio": "16/9",
                    background: `url(${t(78855)(`./${o.title_slug}/${e.key}.jpg`)}) no-repeat center/cover`
                  }
                }), (0, r.jsx)("div", {
                  dangerouslySetInnerHTML: {
                    __html: e.text
              ...
              children: [(0, r.jsx)("div", {
                ...
                children: o.roles_items.filter(e => "prestigious" === e.type).map((e, a) => (0, r.jsx)("div", {
                  children: (0, r.jsx)(wa, {
                    item: e
                  })
                }, `prestigious-items-${a}`))
      ...
      const Ea = () => {
          const {
            ...
            data: a
          } = (0, i.useQuery)(Oa.RDOFeatureDetail, {
            variables: {
              featureSlug: e,
              withRoles: "roles" === e
            },
      ...
      const Fa = {
        ...
        Ba = ({
          ...
          children: (0, r.jsx)("div", {
            className: Fa.wheelerRawson,
            children: (0, r.jsxs)("div", {
              className: Fa.wheelerContent,
              children: [(0, r.jsx)("h2", {
        ...
        Va = ({
          ...
          }, [n, i]), (0, r.jsxs)("section", {
            className: Fa.top,
            children: [(0, r.jsxs)("div", {
              className: Fa.content,
              children: [(0, r.jsx)("img", {
                className: Fa.gameLogo,
                alt: "Red Dead Online",
                src: t(94643)
              }), (0, r.jsxs)("div", {
                className: Fa.links,
      ...
      const Ca = () => {
          ...
          return (0, r.jsx)(Ia.NewswireArticle, {
            idHash: String(e)
          })
        },
        Aa = {
        ...
        $a = ({
          ...
          const d = (0, X.default)(Aa.button, Aa[t], e);
          return s ? (0, r.jsx)(u, {
            ...o,
            to: s,
            className: d,
        ...
        Ha = ({
          ...
          const {
            track: c
          } = (0, d.h)(), [m] = (0, l.useSearchParams)(), _ = t.preview_images_parsed.newswire_block, g = (0, ke.Ub)(Me.fi.mobile), p = {
          ...
          return (0, r.jsx)(u, {
            to: t.url,
            className: [Ua.newswireBlock, n ? Ua.newswireBlockNoSpecialOrder : "", null !== f ? Ua.startAnimation : ""].join(" "),
            focused: o,
            onClick: k,
            children: (0, r.jsxs)(r.Fragment, {
              children: [0 !== a || m.get("tag_id") ? (0, r.jsx)("div", {
                ...
                className: g ? Ua.previewMobile : Ua.preview,
                style: g ? b.mobile : b.default
              }), (0, r.jsxs)("div", {
                className: Ua.info,
                children: [(0, r.jsxs)("div", {
                  className: Ua.top,
                  children: [t.primary_tags.length ? (0, r.jsx)(qa, {
      ...
      (0, i.withTranslations)(({
        ...
        children: [(0, r.jsx)("h2", {
          ...
          className: [Wa.posts, 1 === e.length ? Wa.just1post : ""].join(" "),
          children: e.map(e => (0, r.jsx)(Ha, {
            noSpecialOrder: !0,
            post: e
          }, e.id))
        })]
      ...
      const Za = (0, i.withTranslations)(({
        ...
        tt = ({
          ...
          const t = () => e.screencap.includes("akamai") ? `${e.screencap}?im=Resize=${a}` : e.screencap,
            [s] = (0, i.usePreloadImg)(t());
          return (0, r.jsx)("div", {
            className: [at.screencap, s ? at.screencapLoaded : ""].join(" "),
            "aria-hidden": "true",
            role: "img",
            style: {
      ...
      var nt = t(88039);
      const it = (0, i.withTranslations)(({
        t: e
      }) => {
        const {
          data: a
        } = (0, i.useQuery)(nt.RDOTrailers, {
          autoSetLoading: !0
        });
        if (!a) return null;
        const {
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsxs)("section", {
            ...
            children: [(0, r.jsx)("h2", {
              ...
              className: st.grid,
              children: t.results.slice(1, 99).map(e => (0, r.jsx)(rt, {
                video: e,
      ...
      const dt = (0, i.withTranslations)(({
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(P.PlayerWithInfo, {
              ...
              children: [(0, r.jsx)("h2", {
                ...
                children: n.results.map(e => (0, r.jsx)(rt, {
                  video: e,
                  toExplicit: `../videos/${e.id}`
                }, e.id))
              })]
        ...
        _t = (0, n.withIntl)(() => {
          ...
          return (0, r.jsxs)("div", {
            className: mt.gameSite,
            children: [(0, r.jsx)("div", {
              className: [mt.gameSiteContent, e ? mt.navOpen : ""].join(" "),
              children: (0, r.jsx)(lt, {})
            }), (0, r.jsx)("div", {
              className: mt.reddeadrating,
              children: (0, r.jsx)(v, {
