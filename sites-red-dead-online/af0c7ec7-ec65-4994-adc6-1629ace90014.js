! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "af0c7ec7-ec65-4994-adc6-1629ace90014", e._sentryDebugIdIdentifier = "sentry-dbid-af0c7ec7-ec65-4994-adc6-1629ace90014")
  } catch (e) {}
}();
    ...
    26516: (e, a, s) => {
      ...
      function i(e, a, s) {
        var t, d = {},
          i = null,
          f = null;
        for (t in void 0 !== s && (i = "" + s), void 0 !== a.key && (i = "" + a.key), void 0 !== a.ref && (f = a.ref), a) r.call(a, t) && !o.hasOwnProperty(t) && (d[t] = a[t]);
        if (e && e.defaultProps)
    ...
    8852: (e, a, s) => {
      ...
      const b = e => {
        ...
        p = e => {
          ...
          const r = s.path.map((e => 1 === s.path.length && "_root" === e.feedback_type.name ? null : (0, l.jsx)(c.NavLink, {
              to: `?step=${e.id_hash}`,
              className: f[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            n = s.next.map((e => "_root" === e.feedback_type.name ? null : (0, l.jsxs)(c.NavLink, {
