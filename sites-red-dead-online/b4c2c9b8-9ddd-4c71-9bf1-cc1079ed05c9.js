try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "b4c2c9b8-9ddd-4c71-9bf1-cc1079ed05c9", e._sentryDebugIdIdentifier = "sentry-dbid-b4c2c9b8-9ddd-4c71-9bf1-cc1079ed05c9")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    67263(e, a, t) {
      ...
      const D = (0, n.defineMessages)({
        ...
        L = ({
          ...
          return (0, s.useLayoutEffect)(() => {
            ...
            const t = new ResizeObserver(() => {
              (() => {
                ...
                console.log("width", t), a.style.setProperty("--page-width", `${t}px`)
              })()
            });
            return t.observe(e), () => {
              t.disconnect()
          ...
          }, [p, a.length]), (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsx)("div", {
              ref: c,
      ...
      const Me = ({
        ...
        Ie = ({
          ...
          const o = [];
          return n ? e.split(n).map(e => o.push(e)) : o.push(e), (0, r.jsxs)(Le, {
            splitter: n,
            role: s,
            wrapper: e => (0, r.jsx)("div", {
              className: `${Ve.badge} ${a?Ve[a]:""} `,
              children: e
            }),
            children: [(0, r.jsx)(r.Fragment, {
              ...
              className: `${n||s?"":Ve.badge} ${a?Ve[a]:""}`,
              min: 8,
              max: 1e3,
              mode: n || s ? "single" : "multi",
              children: o[0]
            }), (0, r.jsx)(r.Fragment, {
              children: o.shift() && n && o.length >= 1 && (0, r.jsx)(Me, {
                min: 8,
                max: 1e3,
                mode: "single",
        ...
        Ae = ({
          ...
          const g = (0, s.useMemo)(() => {
            if (i?.badge || i?.discountTxt || e || t) return (0, r.jsx)(Ie, {
      ...
      const He = ({
          ...
          return a ? (0, r.jsxs)(u, {
            ...
            isActive: () => t,
            className: Ue.activeNavItem,
            children: [(0, r.jsx)("div", {
              className: [Ue.navTitle, ee.swipe, t ? ee.red : ee.gray].join(" "),
              children: a.title
            }), (0, r.jsx)(We, {
              role: a
            })]
        ...
        Ke = ({
          ...
          className: [Ue.progressionItem, ee.swipe, ee.gray].join(" "),
          children: [(0, r.jsx)("i", {
            style: {
              background: `url(${t(59393)(`./${e.title_slug}.png`)}) no-repeat center/contain`
            }
          }), (0, r.jsxs)("div", {
            className: Ue.progressionItemText,
            children: [(0, r.jsx)("h5", {
              children: e.title
            }), (0, r.jsx)("div", {
              children: e.description
        ...
        Qe = ({
          ...
          return s ? (0, r.jsxs)("div", {
            className: Ue.prestigiousItem,
            "aria-label": e?.title,
            tabIndex: 0,
            children: [(0, r.jsx)("div", {
              role: "presentation",
              className: Ue.prestigiousImg,
              style: {
        ...
        Je = (0, o.withTranslations)(({
          ...
          return (0, s.useEffect)(() => {
            ...
            children: [(0, r.jsxs)("section", {
              ...
              className: Ue.nav,
              children: a.map(e => (0, r.jsx)(He, {
                activeRole: i,
                role: e
              }, e.title_slug))
            }), i && (0, r.jsx)("section", {
              className: Ue.mobileActiveRole,
              children: (0, r.jsx)(We, {
                role: i
              })
            }), (0, r.jsx)("span", {
              ...
              className: Ue.infoBlocks,
              children: i.roles_info_blocks.map(e => (0, r.jsxs)("div", {
                className: Ue.infoBlock,
                children: [(0, r.jsx)("div", {
                  className: Ue.infoBlockImg,
                  style: {
                    "--aspect-ratio": "16/9",
              ...
              className: Ue.prestigious,
              children: (0, r.jsx)("div", {
                className: Ue.progressionText,
                dangerouslySetInnerHTML: {
                  __html: i.prestigious_intro_text
                }
              })
            }), (0, r.jsxs)("section", {
              className: Ue.progression,
              children: [(0, r.jsx)("div", {
                className: Ue.progressionText,
                dangerouslySetInnerHTML: {
                ...
                className: Ue.progressionItems,
                children: i.roles_items.map((e, a) => {
                  if (!e.type) return (0, r.jsx)(Ke, {
                    item: e
                  }, `progression-items-${a}`)
                }).filter(Boolean)
              })]
              ...
              className: Ue.details,
              children: [(0, r.jsx)("h2", {
                children: n("Bonuses and Tokens")
              }), (0, r.jsx)("div", {
                className: Ue.detailsText,
                dangerouslySetInnerHTML: {
                  __html: e.details
                }
              }), (0, r.jsx)(ae, {
        ...
        ea = ({
          ...
          className: Ye.showdownAndElimination,
      ...
      const ra = () => {
          const {
            ...
            data: a
          } = (0, o.useQuery)(ta.RDOFeatureDetail, {
            variables: {
              featureSlug: e,
              withRoles: "roles" === e
            },
      ...
      const pa = () => {
          ...
          return (0, r.jsx)(ua.NewswireArticle, {
            idHash: String(e)
          })
        },
        fa = {
        ...
        ba = ({
          ...
          const d = (0, B.default)(fa.button, fa[t], e);
          return s ? (0, r.jsx)(u, {
            ...i,
            to: s,
            className: d,
      ...
      const ha = {
        ...
        wa = ({
          ...
          const {
            track: c
          } = (0, d.h)(), [m] = (0, l.useSearchParams)(), _ = t.preview_images_parsed.newswire_block, g = (0, ke.Ub)(ka.fi.mobile), p = {
          ...
          return (0, r.jsx)(u, {
            to: t.url,
            className: [xa.newswireBlock, n ? xa.newswireBlockNoSpecialOrder : "", null !== f ? xa.startAnimation : ""].join(" "),
            focused: i,
            onClick: k,
            children: (0, r.jsxs)(r.Fragment, {
              children: [0 !== a || m.get("tag_id") ? (0, r.jsx)("div", {
                className: xa.preview,
                style: b.default
              }) : (0, r.jsx)("div", {
                className: g ? xa.previewMobile : xa.preview,
                style: g ? b.mobile : b.default
              }), (0, r.jsxs)("div", {
                className: xa.info,
                children: [(0, r.jsxs)("div", {
                  className: xa.top,
                  children: [t.primary_tags.length ? (0, r.jsx)(va, {
      ...
      (0, o.withTranslations)(({
        ...
        children: [(0, r.jsx)("h2", {
          ...
          className: [ya.posts, 1 === e.length ? ya.just1post : ""].join(" "),
      ...
      const Na = {
        ...
        ja = (0, o.withGtmTracking)(({
          ...
          return (0, s.useEffect)(() => {
            ...
            className: [Na.newswireBlocks, a ? Na.noSpecialOrder : "", Na.contextHome].join(" "),
      ...
      const Oa = (0, o.withTranslations)(({
        ...
        Pa = ({
          ...
          return (0, r.jsx)("div", {
            className: [Ta.screencap, s ? Ta.screencapLoaded : ""].join(" "),
            "aria-hidden": "true",
            role: "img",
            style: {
      ...
      var Xa = t(87529);
      const Da = (0, o.withTranslations)(({
        t: e
      }) => {
        const {
          data: a
        } = (0, o.useQuery)(Xa.RDOTrailers, {
          autoSetLoading: !0
        });
        if (!a) return null;
        const {
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsxs)("section", {
            ...
            children: [(0, r.jsx)("h2", {
              ...
              className: Ba.grid,
              children: t.results.slice(1, 99).map(e => (0, r.jsx)(Fa, {
                video: e,
      ...
      const Ma = (0, o.withTranslations)(({
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(P.PlayerWithInfo, {
              ...
              children: [(0, r.jsx)("h2", {
                ...
                children: n.results.map(e => (0, r.jsx)(Fa, {
                  video: e,
                  toExplicit: `../videos/${e.id}`
                }, e.id))
              })]
        ...
        Ca = (0, n.withIntl)(() => {
          ...
          return (0, r.jsxs)("div", {
            className: Ia.gameSite,
            children: [(0, r.jsx)("div", {
              className: [Ia.gameSiteContent, e ? Ia.navOpen : ""].join(" "),
              children: (0, r.jsx)(La, {})
            }), (0, r.jsx)("div", {
              className: Ia.reddeadrating,
              children: (0, r.jsx)(v, {
