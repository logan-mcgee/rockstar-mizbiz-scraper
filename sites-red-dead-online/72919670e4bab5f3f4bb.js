/*! For license information please see 72919670e4bab5f3f4bb.js.LICENSE.txt */
"use strict";
  ...
  [994], {
    5994: (e, t, r) => {
      ...
      function w(e, t, r) {
        ...
        let a = null;
        for (let e = 0; null == a && e < o.length; ++e) a = M(o[e], _(n));
        return a
      }
        ...
        async function V(t, r, o) {
          ...
          let {
            ...
            let p = o || Ne(r, i),
              m = i || s || Be(p),
              v = l || u,
              [y, g] = pe(e.history, A, n, m, r, T, _, B, H, W, v, h, d, f);
        ...
        return k = {
          ...
          fetch: function(t, r, n, d) {
            ...
            M = !0 === (d && d.preventScrollReset), g && Me(g.formMethod) ? async function(t, r, n, o, d, f) {
              ...
              let D = Fe(f, g.data);
              A.fetchers.set(t, D);
              let [C, k] = pe(e.history, A, x, f, b, T, _, B, H, W, R, h, {
                [o.route.id]: g.data
              }, void 0);
      ...
      function he(e, t, r, n, o, a, i) {
        ...
        let u = I(o || ".", F(l).map((e => e.pathnameBase)), O(e.pathname, r) || e.pathname, "path" === i);
        return null == o && (u.search = e.search, u.hash = e.hash), null != o && "" !== o && "." !== o || !s || !s.route.index || _e(u.search) || (u.search = u.search ? u.search.replace(/^\?/, "?index&") : "?index"), n && "/" !== r && (u.pathname = "/" === u.pathname ? r : z([r, u.pathname])), p(u)
      }
      ...
      function fe(e, t, r, n) {
        ...
        let f = m(r);
        return t && f.search && _e(f.search) && a.append("index", ""), f.search = "?" + a, {
          path: p(f),
          submission: h
        }
      }
      ...
      function or(e, t) {
        ...
        if (Zt(l = e) && "form" === l.tagName.toLowerCase()) {
          ...
          n = i ? O(i, t) : null, r = e.getAttribute("method") || Gt, o = nr(e.getAttribute("enctype")) || Qt, a = new FormData(e)
        } else if (function(e) {
          ...
          if (n = l ? O(l, t) : null, r = e.getAttribute("formmethod") || i.getAttribute("method") || Gt, o = nr(e.getAttribute("formenctype")) || nr(i.getAttribute("enctype")) || Qt, a = new FormData(i, e), ! function() {
              if (null === tr) try {
      ...
      function Nr(e) {
        ...
        o.useEffect((() => (window.history.scrollRestoration = "manual", () => {
          ...
          function(e, t) {
            ...
            sessionStorage.setItem(r || Or, JSON.stringify(Br)), window.history.scrollRestoration = "auto"
            ...
            let e = t && "/" !== l ? (e, r) => t(Vt({}, e, {
                pathname: O(e.pathname, l) || e.pathname
              }), r) : t,
