/*! For license information please see d00a6223b864cfb34b0f48f1c0d6969f.js.LICENSE.txt */ ! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "4fff2743-6d04-4417-af04-c9d26a4f0d43", e._sentryDebugIdIdentifier = "sentry-dbid-4fff2743-6d04-4417-af04-c9d26a4f0d43")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [220], {
    ...
    6220: (e, a, t) => {
      ...
      const E = (0, o.withTranslations)((e => {
          ...
          return n.length ? (0, m.jsxs)("section", {
            ...
            children: [(0, m.jsx)("h2", {
              ...
              children: n.map((e => {
                const n = t(7992)(`./${a.title_slug}/${e.slug}.jpg`);
                return (0, m.jsxs)("div", {
                  children: [(0, m.jsx)("div", {
                    role: "img",
      ...
      (0, o.importAll)(t(7480));
      const V = (0, s.withSimpleErrorBoundary)((e => {
          let {
            highlight: a
          } = e;
          return (0, m.jsx)(s.A, {
        ...
        W = e => {
          ...
          return (0, r.useEffect)((() => {
            ...
            const e = () => {
              ...
              e > l && o ? d(!1) : e < l && !o && d(!0), l = e <= 0 ? 0 : e
            };
            return window.addEventListener("scroll", e, !1), () => window.removeEventListener("scroll", e, !1)
          }), [o]), (0, r.useEffect)((() => {
            p(o ? "calc(var(--game-header-height) + var(--promo-banner-height) + 30px)" : "0px")
          }), [o]), (0, m.jsxs)("div", {
      ...
      const K = e => {
          ...
          return t ? (0, m.jsxs)(s.A, {
            ...
            isActive: () => n,
            className: Y.activeNavItem,
            children: [(0, m.jsx)("div", {
              className: [Y.navTitle, I.swipe, n ? I.red : I.gray].join(" "),
              children: t.title
            }), (0, m.jsx)(X, {
              role: t
            })]
        ...
        Z = e => {
          ...
          return (0, m.jsxs)("div", {
            className: [Y.progressionItem, I.swipe, I.gray].join(" "),
            children: [(0, m.jsx)("i", {
              style: {
                background: `url(${t(3988)(`./${a.title_slug}.png`)}) no-repeat center/contain`
              }
            }), (0, m.jsxs)("div", {
              className: Y.progressionItemText,
              children: [(0, m.jsx)("h5", {
                children: a.title
              }), (0, m.jsx)("div", {
                children: a.description
        ...
        J = e => {
          ...
          return s ? (0, m.jsxs)("div", {
            className: Y.prestigiousItem,
            children: [(0, m.jsx)("div", {
              className: Y.prestigiousImg,
              style: {
        ...
        ee = (0, o.withTranslations)((e => {
          ...
          return (0, r.useEffect)((() => {
            ...
            children: [(0, m.jsxs)("section", {
              ...
              className: Y.nav,
              children: n.map((e => (0, m.jsx)(K, {
                activeRole: d,
                role: e
              }, e.title_slug)))
            }), d && (0, m.jsx)("section", {
              className: Y.mobileActiveRole,
              children: (0, m.jsx)(X, {
                role: d
              })
            }), (0, m.jsx)("section", {
              className: Y.infoBlocks,
              children: d.roles_info_blocks.map((e => (0, m.jsxs)("div", {
                className: Y.infoBlock,
                children: [(0, m.jsx)("div", {
                  className: Y.infoBlockImg,
                  style: {
                    "--aspect-ratio": "16/9",
                    background: `url(${t(5659)(`./${d.title_slug}/${e.key}.jpg`)}) no-repeat center/cover`
                  }
                }), (0, m.jsx)("div", {
                  dangerouslySetInnerHTML: {
                    __html: e.text
              ...
              className: Y.prestigious,
              children: (0, m.jsx)("div", {
                className: Y.progressionText,
                dangerouslySetInnerHTML: {
                  __html: d.prestigious_intro_text
                }
              })
            }), (0, m.jsxs)("section", {
              className: Y.progression,
              children: [(0, m.jsx)("div", {
                className: Y.progressionText,
                dangerouslySetInnerHTML: {
                ...
                className: Y.progressionItems,
                children: d.roles_items.map(((e, a) => {
                  if (!e.type) return (0, m.jsx)(Z, {
                    item: e
                  }, `progression-items-${a}`)
                })).filter(Boolean)
              })]
...
//# sourceMappingURL=d00a6223b864cfb34b0f48f1c0d6969f.js.map