! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "8d0d7232-9721-4e38-a5e5-d3972e1460af", e._sentryDebugIdIdentifier = "sentry-dbid-8d0d7232-9721-4e38-a5e5-d3972e1460af")
  } catch (e) {}
}();
    ...
    8852: (e, a, s) => {
      ...
      const l = e => {
        ...
        p = e => {
          ...
          const n = s.path.map((e => 1 === s.path.length && "_root" === e.feedback_type.name ? null : (0, b.jsx)(t.NavLink, {
              to: `?step=${e.id_hash}`,
              className: f[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            r = s.next.map((e => "_root" === e.feedback_type.name ? null : (0, b.jsxs)(t.NavLink, {
        ...
        g = e => {
          ...
          const {
            ...
            loggedIn: l
          } = (0, n.useRockstarUser)(), p = (0, d.useRef)(), [g, {
            data: m,
            error: k
          }] = (0, r.useMutation)(s);
        ...
        m = e => {
          ...
          return (0, o.withTranslations)(l, "rdo" === d ? "rdr2" : d)({
            mutation: a,
            query: s,
            type: d
          })
