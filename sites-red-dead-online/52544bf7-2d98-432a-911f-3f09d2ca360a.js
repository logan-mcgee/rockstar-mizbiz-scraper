! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "52544bf7-2d98-432a-911f-3f09d2ca360a", e._sentryDebugIdIdentifier = "sentry-dbid-52544bf7-2d98-432a-911f-3f09d2ca360a")
  } catch (e) {}
}();
    ...
    84903: (e, t, a) => {
      ...
      const u = _((e => {
        ...
        const f = (0, r.useRef)(null),
          ...
          h = /^#/.test(a),
          v = p?.target ?? (i ? "_blank" : "_self"),
          {
            ...x
          } = p;
        let w = "";
        if ("aria-label" in x && x["aria-label"] && (w = "_blank" === v ? `${x["aria-label"]} ${b.formatMessage(d.aria_label_open_new_window)}` : x["aria-label"]), (0, r.useEffect)((() => {
          ...
          return (0, g.jsxs)("a", {
            ...
            ref: f,
            role: m,
            children: [t, "_blank" === v && !w && (0, g.jsx)("span", {
              className: l,
        ...
        const N = Object.keys(x).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
          ...e,
          [t]: p[t]
        })), {});
        return "function" == typeof N?.className && delete N.className, (0, g.jsxs)("a", {
          href: a,
          title: o,
          onClick: _,
          target: v,
      ...
      const v = f(_((e => {
        ...
        w = (0, n.withTranslations)((e => {
          ...
          const [a] = (0, r.useState)(""), s = (0, c.useNavigate)(), o = (0, n.useMutateState)();
        ...
        j = e => {
          ...
          let o = t?.message ?? n(N.wasted_error_404_new);
          o = n(N.wasted_error_404_new);
          const i = t?.code ?? 398,
            d = (0, r.useRef)(null);
      ...
      const E = () => {
        ...
        (0, r.useEffect)((() => {
          const e = e => {
              d((t => t > -1 && o.current[t] && !o.current[t].contains(e.target) ? -1 : t))
            },
            t = e => {
              "Escape" === e.key && d(-1)
            };
          ...
          children: [(0, g.jsxs)("section", {
            ...
            children: [(0, g.jsx)("div", {
              ...
              children: n.map(((t, r) => {
                ...
                return (0, g.jsxs)("div", {
                  className: [O.barWrapper, r === i ? O.activeBar : ""].join(" "),
                  children: [(0, g.jsx)("button", {
                    className: O.bar,
                    style: {
      ...
      const R = {
        ...
        L = e => {
          ...
          const s = t.img_full,
            [o] = (0, n.usePreloadImg)(s);
          return (0, g.jsx)("div", {
            "aria-describedby": r,
            role: "img",
            className: [R.mainImg, o ? R.imgLoaded : R.imgHidden].join(" "),
            style: {
          ...
          return (0, g.jsxs)("div", {
            ...
            children: [(0, g.jsx)("div", {
              ...
              children: a.map(((e, r) => (0, g.jsx)("button", {
                ...
                className: t && t.id === e.id ? R.activeTrackItem : "",
                style: {
        ...
        A = e => {
          ...
          }), [o, i] = (0, r.useState)([]), [d, c] = (0, r.useState)(), l = `slideshow-${t}-${a}`;
          return (0, r.useEffect)((() => {
            if (s && !o.length) {
              const e = s.rdoClubRewards.clubs_items.filter((e => e.pass === a));
              i(e), c(e[0])
            }
          }), [s]), s && o.length && d ? (0, g.jsxs)("div", {
      ...
      const K = e => {
          ...
          const o = (0, n.useLocale)();
          return (0, g.jsx)("div", {
            role: "img",
            "aria-label": s,
            className: [W.title, t].join(" "),
            style: {
              background: `url(${a(17308)(`./${o}/${r}.png`)}) no-repeat left bottom/contain content-box`
            }
          })
        },
        Q = e => {
      ...
      const Z = (0, n.withTranslations)((e => {
          let {
            feature: t,
            tips: r = [],
            t: n
      ...
      const te = f((e => {
        ...
        re = e => {
          ...
          return (0, g.jsx)(u, {
            className: [ae.link, ae.swipe, ae[t]].join(" "),
            to: s,
            target: r,
            children: a
          })
        ...
        de = e => {
          ...
          return "halloween" === t ? (0, g.jsx)(ie, {}) : (0, g.jsx)(ne, {})
        },
        ce = () => ((0, n.useQuery)(P.Meta, {
          variables: {
      ...
      const ve = {
        ...
        ye = e => {
          ...
          const [i, d] = (0, n.usePreloadImg)(s);
          let c = s;
          !1 === i && ("rockstargames-sites-red-dead-onlinea6a06e2d5c4f1811ea39d17312ca2e67" === r && (c = a(28839)), c = a(9333));
          const {
            width: l,
            height: m
          } = d, _ = {
        ...
        Se = e => {
          let {
            ...
            const g = (0, r.useCallback)((e => {
              ...
              if (a.startsWith("http")) return Ne(a);
            ...
            return {
              ...
              ariaLabel: o,
              src: {
                mobile: g(i?.[c]?.mobile ?? i?.en_us?.mobile ?? a),
                desktop: g(i?.[c]?.desktop ?? i?.en_us?.desktop ?? s)
              }
            }
          })(o);
          const {
      ...
      const Ee = {
        ...
        Te = e => {
          ...
          return delete o?.color, l && _ ? (0, g.jsx)("div", {
            className: Ee.grid,
            style: {
            ...
            children: (0, g.jsx)("ul", {
              className: (0, n.classList)(Ee.itemList, Ee.noImg, Ee[s], Ee[d]),
              style: (0, n.safeStyles)(o),
            ...
            style: (0, n.safeStyles)(o),
            className: (0, n.classList)(Ee.itemList, Ee.custom, c ? Ee.noImg : "", s ? Ee[s] : "", d ? Ee[d] : "", i ?? ""),
        ...
        De = e => {
          ...
          return (0, g.jsxs)("div", {
            ...
            children: [t.title && (0, g.jsx)(Me, {
              to: t?.href ?? t?.to,
              children: (0, g.jsx)("h3", {
                children: t.title
              })
            }), Array.isArray(t?.description?.content) ? t.description.content?.map(((e, t) => e?.unorderedList ? (0, g.jsx)(Te, {
      ...
      const Ve = e => {
        ...
        Ce = e => {
          ...
          const o = [];
          return n ? t.split(n).map(((e, t) => o.push(e))) : o.push(t), (0, g.jsxs)(Le, {
            splitter: n,
            role: s,
            ...
            children: [(0, g.jsx)(g.Fragment, {
              ...
              className: `${n||s?"":Ie.badge} ${r?Ie[r]:""}`,
              min: 8,
              max: 1e3,
              mode: n || s ? "single" : "multi",
              children: o[0]
            }), (0, g.jsx)(g.Fragment, {
              children: o.shift() && n && o.length >= 1 && (0, g.jsx)(Ve, {
                min: 8,
                max: 1e3,
                mode: "single",
        ...
        $e = e => {
          ...
          const u = (0, r.useMemo)((() => {
            if (i?.badge || i?.discountTxt || t || s) return (0, g.jsx)(Ce, {
              badge: i?.discountTxt ?? i?.badge ?? t ?? s,
              badgeType: a,
              splitter: i?.splitter ?? o,
              role: i?.role ?? m
            })
          }), [t, a, s, i, m, o]);
          return (0, g.jsx)(Ae, {
            ...
            children: (0, g.jsx)("figure", {
              children: (0, g.jsxs)("div", {
                ...
                children: [(0, g.jsx)(Se, {
                  image: i,
                  className: c
                }), u, i?.caption && (0, g.jsx)("figcaption", {
                  dangerouslySetInnerHTML: {
                    __html: i.caption
                  }
                })]
        ...
        Ge = e => {
          ...
          return (0, g.jsxs)("div", {
            children: [(0, g.jsx)($e, {
              ...
              style: t?.style,
              className: (0, n.classList)(ve.img, t?.className)
            }), (t?.title || t?.description) && (0, g.jsx)(De, {
              item: t
            })]
          })
        },
        ...
        Ue = e => {
          ...
          const [u, p] = (0, r.useState)(0), f = (0, r.useMemo)((() => t && Array.isArray(t) ? t.map((() => (0, he.A)())) : null), [t]);
          ...
          return (0, g.jsxs)("div", {
            className: (0, n.classList)(ve.deprecatedCarousel, ve[d], ve[`infinite_${!o}`], t ? ve.renderedWithChildren : "", i),
            style: s,
            children: [(0, g.jsxs)(ke.RC, {
              loop: !o,
              grabCursor: !0,
              centeredSlides: m,
              ...
              children: [(0, g.jsx)("div", {
                className: ve.trackWrapper,
                children: (0, g.jsxs)("div", {
                  className: ve.track,
                  children: [a?.map((e => (0, g.jsx)(ke.qr, {
                    children: (0, g.jsx)(Ge, {
                      item: e
                    })
                  }, e.key))), t && t.map(((e, t) => e && (0, g.jsx)(ke.qr, {
                    children: e
                  }, f && f[t])))]
                })
              }), (0, g.jsx)(qe, {
            ...
            }), (c?.title || c?.description) && (0, g.jsx)(De, {
              item: c
            })]
          })
        },
      ...
      const We = e => {
          ...
          return a ? (0, g.jsxs)(u, {
            ...
            children: [(0, g.jsx)("div", {
              className: [He.navTitle, ae.swipe, r ? ae.red : ae.gray].join(" "),
              children: a.title
            }), (0, g.jsx)(Ke, {
              role: a
            })]
        ...
        Qe = e => {
          ...
          return (0, g.jsxs)("div", {
            className: [He.progressionItem, ae.swipe, ae.gray].join(" "),
            children: [(0, g.jsx)("i", {
              style: {
        ...
        Je = (0, n.withTranslations)((e => {
          let {
            feature: t,
            roles: s,
            t: o
          } = e;
          const [i, d] = (0, r.useState)(null), c = (0, n.useQueryParams)();
          return (0, r.useEffect)((() => {
            ...
            children: [(0, g.jsxs)("section", {
              ...
              "aria-live": "polite",
              children: `${o("Page updated")}, ${i.title}`
            }), (0, g.jsx)("section", {
              ...
              children: [(0, g.jsx)("div", {
                ...
                children: i.roles_items.filter((e => "prestigious" === e.type)).map(((e, t) => (0, g.jsx)("div", {
                  children: (0, g.jsx)(Ye, {
                    item: e
                  })
                }, `prestigious-items-${t}`)))
        ...
        tt = e => {
          ...
          return (0, g.jsx)("section", {
            className: Ze.showdownAndElimination,
      ...
      const st = () => {
          const {
            ...
            data: t
          } = (0, n.useQuery)(rt.RDOFeatureDetail, {
            variables: {
              featureSlug: e,
              withRoles: "roles" === e
            },
      ...
      const it = {
        ...
        ct = e => {
          ...
          return t("clubrewards-header"), t("clubrewards-subheader"), t("clubrewards-discover"), (0, g.jsx)(g.Fragment, {
            children: (0, g.jsx)("div", {
      ...
      const ft = () => {
        ...
        return (0, g.jsx)(pt.NewswireArticle, {
          idHash: String(e)
        })
      };
      var bt = a(81588);
      const kt = {
        ...
        Nt = e => {
          ...
          const {
            track: l
          } = (0, i.h)(), [m] = (0, c.useSearchParams)(), _ = s.preview_images_parsed.newswire_block, p = {
            default: 0 !== a || o ? _.square || _.d16x9 || _._fallback : _.d16x9 || _.square || _._fallback,
          ...
          return (0, g.jsx)(u, {
            to: s.url,
            className: [wt.newswireBlock, o ? wt.newswireBlockNoSpecialOrder : "", null !== f ? wt.startAnimation : ""].join(" "),
            focused: d,
            onClick: h,
            children: (0, g.jsxs)(g.Fragment, {
              children: [0 !== a || m.get("tag_id") ? (0, g.jsx)("div", {
                ...
                children: [(0, g.jsxs)("div", {
                  className: wt.top,
                  children: [s.primary_tags.length ? (0, g.jsx)(xt, {
        ...
        St = (0, n.withGtmTracking)((e => {
          ...
          return (0, r.useEffect)((() => {
            ...
            className: [yt.newswireBlocks, a ? yt.noSpecialOrder : "", yt.contextHome].join(" "),
            children: s.map(((e, r) => (0, g.jsx)(Nt, {
              section: t,
              index: r,
              noSpecialOrder: a,
              post: e,
      ...
      var zt = a(46368),
        Ot = a.n(zt);
      const Et = (0, n.withTranslations)((e => {
          let {
            section: t = "",
            relativeTo: a = "",
            tagId: s = null,
      ...
      var Mt = a(87529);
      const Dt = (0, n.withTranslations)((e => {
        let {
          t
        } = e;
        const {
          data: a
        } = (0, n.useQuery)(Mt.RDOTrailers, {
          autoSetLoading: !0
        });
        if (!a) return null;
        const {
        ...
        return (0, g.jsxs)("div", {
          ...
          children: [(0, g.jsxs)("section", {
            ...
            children: [(0, g.jsx)("h2", {
              ...
              className: Bt.grid,
              children: r.results.slice(1, 99).map((e => (0, g.jsx)(Xt, {
                video: e,
      ...
      const Vt = (0, n.withTranslations)((e => {
          ...
          return (0, g.jsxs)("div", {
            ...
            children: [(0, g.jsx)(T.PlayerWithInfo, {
              videoId: s.id
            }), (0, g.jsxs)("section", {
              ...
              children: [(0, g.jsx)("h2", {
                ...
                children: o.results.map((e => (0, g.jsx)(Xt, {
                  video: e,
                  toExplicit: `../videos/${e.id}`
                }, e.id)))
              })]
        ...
        At = (0, s.withIntl)((() => {
          ...
          return (0, g.jsxs)("div", {
            className: Ct.gameSite,
            children: [(0, g.jsx)("div", {
              className: [Ct.gameSiteContent, e ? Ct.navOpen : ""].join(" "),
              children: (0, g.jsx)(Lt, {})
            }), (0, g.jsx)("div", {
              className: Ct.reddeadrating,
              children: (0, g.jsx)(v, {
