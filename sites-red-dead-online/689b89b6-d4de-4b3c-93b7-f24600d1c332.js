! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "689b89b6-d4de-4b3c-93b7-f24600d1c332", e._sentryDebugIdIdentifier = "sentry-dbid-689b89b6-d4de-4b3c-93b7-f24600d1c332")
  } catch (e) {}
}();
    ...
    39544: (e, a, s) => {
      ...
      const f = e => {
          ...
          return (0, d.useEffect)((() => {
            ...
            children: [(0, i.jsx)("h1", {
              children: t("online-feedback-h1")
            }), (0, i.jsx)("div", {
              className: o.desc,
              dangerouslySetInnerHTML: {
                __html: t("online-feedback-desc")
              }
            }), m && (0, i.jsx)(b, {
              mutation: a,
              tree: m.tree,
        ...
        b = e => {
          ...
          const n = s.path.map((e => 1 === s.path.length && "_root" === e.feedback_type.name ? null : (0, i.jsx)(c.NavLink, {
              to: `?step=${e.id_hash}`,
              className: o[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            r = s.next.map((e => "_root" === e.feedback_type.name ? null : (0, i.jsxs)(c.NavLink, {
        ...
        l = e => {
          ...
          const {
            loggedIn: r
          } = (0, t.useRockstarUser)(), f = (0, d.useRef)(), [b, {
            data: l,
            error: p
          }] = (0, n.useMutation)(s);
          return r ? l?.submittal?.id ? (0, i.jsx)("div", {
            className: o.success,
            dangerouslySetInnerHTML: {
          ...
          }) : c("online-feedback-signin-0").replace("%s", c("signin-0"))
        },
        p = e => {
          let {
            mutation: a,
          ...
          return (0, r.withTranslations)(f, "rdo" === d ? "rdr2" : d)({
            mutation: a,
            query: s,
            type: d
          })
