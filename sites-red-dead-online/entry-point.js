    ...
    execute: function() {
      e((() => {
        var e, l, u, c, d = {
            5784: (e, t, r) => {
              ...
              function w(e, t, r) {
                ...
                let a = null;
                for (let e = 0; null == a && e < o.length; ++e) a = T(o[e], O(n));
                return a
              }
              ...
              function fe(e) {
                ...
                function G(t, r) {
                  ...
                  let h, p = !0 === T || null != P.navigation.formMethod && Ae(P.navigation.formMethod) && !0 !== (null == (i = t.state) ? void 0 : i._isRedirect);
                ...
                async function Q(t, r, o) {
                  D && D.abort(), D = null, j = t, N = !0 === (o && o.startUninterruptedRevalidation),
                    ...
                    }(P.location, P.matches), T = !0 === (o && o.preventScrollReset), A = !0 === (o && o.enableViewTransition);
                  let c = s || u,
                ...
                return C = {
                  ...
                  initialize: function() {
                    ...
                    return P.initialized || Q(n.Pop, P.location), C
                  },
                  ...
                  fetch: function(t, r, n, d) {
                    ...
                    let E = Ne(v, y);
                    T = !0 === (d && d.preventScrollReset), g && Ae(g.formMethod) ? async function(t, r, n, o, d, h) {
                      ...
                      let J = ge(x);
                      "loading" === P.navigation.state && x > W ? (c(j, "Expected pending action"), D && D.abort(), G(P.navigation.location, {
                        matches: R,
                        loaderData: U,
                        errors: N,
                        fetchers: new Map(P.fetchers)
                        ...
                        errors: N,
                        loaderData: xe(P.loaderData, U, R, N)
                      }, J || C.length > 0 ? {
                        fetchers: new Map(P.fetchers)
                      } : {})), I = !1)
                    }(t, r, y, E, v, g): (K.set(t, {
                      ...
                      if (Pe(v) && (v = await Oe(v, p.signal, !0) || v), $.get(t) === h && $.delete(t), p.signal.aborted) return;
                      if (Te(v)) {
                        if (W > m) {
                          let e = $e(void 0);
                          return P.fetchers.set(t, e), void X({
                  ...
                  revalidate: function() {
                    ...
                    }), "submitting" !== P.navigation.state && ("idle" !== P.navigation.state ? Q(j || P.historyAction, P.navigation.location, {
                  ...
                  deleteFetcher: oe,
                  dispose: function() {
                    m && m(), O && O(), v.clear(), D && D.abort(), P.fetchers.forEach(((e, t) => oe(t))), P.blockers.forEach(((e, t) => Ee(t)))
                  },
              ...
              async function Me(e, t, r, n, o, a) {
                for (let i = 0; i < r.length; i++) {
                  ...
                  if (Pe(s) && (o || d)) {
                    let e = n[i];
                    c(e, "Expected an AbortSignal for revalidating fetcher deferred result"), await Oe(s, e, o).then((e => {
                      e && (r[i] = e || r[i])
                    }))
                  }
                }
              ...
              const br = "undefined" != typeof window && void 0 !== window.document && void 0 !== window.document.createElement,
                ...
                xr = o.forwardRef(((e, t) => {
                  let {
                    ...
                    preventScrollReset: d,
                    unstable_viewTransition: f
                  } = e, h = Yt(e, ir), p = "get" === i.toLowerCase() ? "get" : "post", m = Or(s, {
                    relative: c
                  });
              ...
              function Ir() {
                return [...Lr(Cr.UseFetchers).fetchers.values()]
              }
        ...
        function h(e) {
          ...
          return d[e](r, r.exports, h), r.exports
        }
        return h.m = d, h.c = f, h.y = t, h.n = e => {
        ...
        }(), h.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = {}, l = "@rockstargames/sites-red-dead-online:", h.l = (t, r, n, o) => {
          if (e[t]) e[t].push(r);
          else {
            var a, i;
            if (void 0 !== n)
            ...
            a || (i = !0, (a = document.createElement("script")).charset = "utf-8", a.timeout = 120, h.nc && a.setAttribute("nonce", h.nc), a.setAttribute("data-webpack", l + n), a.src = t), e[t] = [r];
            var d = (r, n) => {
          ...
          h.o(u, e) && u[e].forEach((e => {
            ...
            if (!(r.indexOf(n) >= 0)) {
              ...
              a(h, n[2], 0, 0, ((e, t, r) => e ? a(h.I, n[0], 0, e, i, r) : o()), 1)
            }
          }))
        }, (() => {
          h.S = {};
              ...
              var a = h.S[r],
                ...
                l = e => {
                  ...
                  try {
                    var o = h(e);
                    if (!o) return;
                    var a = e => e && e.init && e.init(h.S[r], n);
          ...
          var e = e => {
            ...
            n = (e => function(t, r, n, o) {
              var a = h.I(t);
              return a && a.then ? a.then(e.bind(e, t, h.S[t], r, n, o)) : e(t, h.S[t], r, n, o)
            })(((e, t, n, o, a) => {
              var i = t && h.o(t, n) && r(t, n, o);
          ...
          var t = (t, r) => {
              ...
              for (t && t(r); l < a.length; l++) o = a[l], h.o(e, o) && e[o] && e[o][0](), e[o] = 0
            },
