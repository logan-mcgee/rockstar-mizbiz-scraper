! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "9515d609-dd63-4529-88cb-c90820a39951", t._sentryDebugIdIdentifier = "sentry-dbid-9515d609-dd63-4529-88cb-c90820a39951")
  } catch (t) {}
}();
    ...
    77016: (t, e, n) => {
      ...
      function B(t) {
        ...
        return e && l(e), (0, o.forwardRef)((function(t, l) {
          ...
          }(C, B, (0, r.C3)((0, r.C3)({}, P), t), n), function(t, e, n, r) {
            var i, a = e.layoutId,
              s = e.layout,
              u = e.drag,
              l = e.dragConstraints,
      ...
      function Ot(t, e) {
        ...
        if (t.style) {
          var i = {};
          Et(i, t.style, t), n.style = (0, r.C3)((0, r.C3)({}, i), n.style)
        }
        return n
      }
      ...
      function Sn(t) {
        ...
        let n = 0;
        const r = t.match(it);
        r && (n = r.length, t = t.replace(it, En), e.push(...r.map(Cn.parse)));
        const o = t.match(ot);
      ...
      function An(t) {
        ...
        return t => {
          let e = r;
          for (let r = 0; r < o; r++) e = e.replace(r < n ? En : wn, r < n ? Cn.transform(t[r]) : rt(t[r]));
          return e
        }
      }
      ...
      function Cr(t) {
        ...
        (null === (n = (e = P).needsInterpolation) || void 0 === n ? void 0 : n.call(e, o, b)) && (x = jn([0, 100], [o, b], {
          clamp: !1
        }), o = 0, b = 100);
        ...
        return i && (null == f || f(), g = a((function(t) {
          ...
          null == h || h(y), w && (0 === C && (null != E || (E = s)), C < u ? function(t, e, n, r) {
            return r ? t >= e + n : t <= -n
          }(s, E, c, S) && (C++, "reverse" === l ? (S = C % 2 == 0, s = function(t, e, n = 0, r = !0) {
            return r ? xr(e + -t, e, n) : e - (t - e) + n
          }(s, E, c, S)) : (s = xr(s, E, c), "mirror" === l && A.flipTarget()), w = !1, v && v()) : (g.stop(), p && p()))
        })), g.start()), {
          stop: () => {
            null == d || d(), g.stop()
          }
        ...
        return (0, c.s)(f === l, "You are trying to animate ".concat(t, ' from "').concat(u, '" to "').concat(n, '". ').concat(u, " is not an animatable value - to enable this animation set ").concat(u, " to a value animatable to ").concat(n, " via the `style` property.")), f && l && !1 !== s.type ? function() {
          ...
          return "inertia" === s.type || "decay" === s.type ? function({
            ...
            if (h(t)) y({
              ...
              let c, f;
              const d = t => {
                c = f, f = t, e = Er(t - c, gr().delta), (1 === s && t > a || -1 === s && t < a) && y({
                  from: t,
                  to: a,
                  velocity: e
                })
            ...
            return Array.isArray(e.to) && (null !== (o = t.duration) && void 0 !== o || (t.duration = .8)),
              ...
              function(t) {
                ...
                var e = t.ease,
                  ...
                  u = (0, r.C3)({}, s);
                return n && (u.offset = n), s.duration && (u.duration = wr(s.duration)), s.repeatDelay && (u.repeatDelay = wr(s.repeatDelay)), e && (u.ease = Dr(e) ? e.map(kr) : kr(e)), "tween" === s.type && (u.type = "keyframes"), (o || a || i) && ((0, c.s)(!$r, "yoyo, loop and flip have been removed from the API. Replace with repeat and repeatType options."), $r = !0, o ? u.repeatType = "reverse" : a ? u.repeatType = "loop" : i && (u.repeatType = "mirror"), u.repeat = a || o || i || s.repeat), "spring" !== s.type && (u.type = "keyframes"), u
              }(t))
          }(s, o, t)), {
            onUpdate: function(t) {
              var e;
      ...
      function to(t, e, n, r) {
        return void 0 === r && (r = {}), qr.current && (r = {
          ...
          return u ? i = window.setTimeout(l, wr(u)) : l(),
            function() {
        ...
        var u = i ? function() {
          ...
          l = (null === (o = t.variantChildren) || void 0 === o ? void 0 : o.size) ? function(o) {
            ...
            return function(t, e, n, o, i, a) {
              ...
              return Array.from(t.variantChildren).sort(wo).forEach((function(t, o) {
          ...
          e.animationState || (e.animationState = function(t) {
            ...
            function u(e, u) {
              for (var l, c = t.getProps(), f = t.getVariantContext(!0) || {}, d = [], p = new Set, v = {}, h = 1 / 0, m = function(n) {
                  ...
                  m.prevProp = g, m.prevResolvedValues = S, m.isActive && (v = (0, r.C3)((0, r.C3)({}, v), S)), a && t.blockInitialAnimation && (E = !1), E && !b && d.push.apply(d, (0, r.Mt)([], (0, r.o5)(w.map((function(t) {
                    return {
                      animation: t,
                      options: (0, r.C3)({
                        type: i
      ...
      function No(t, e) {
        ...
        for (var n = t.length - 1, r = null, o = Uo(t); n >= 0 && (r = t[n], !(o.timestamp - r.timestamp > wr(e)));) n--;
        if (!r) return {
          x: 0,
          y: 0
        };
      ...
      var bi = {
        ...
        Ei = function(t) {
          ...
          return function(t, e) {
            ...
            function k() {
              x && C && (D(), u(x, w, v.style, z.projection))
            }
            ...
            function I(t, e) {
              var n = e.onChange((function(e) {
                  E[t] = e, v.onUpdate && yr.update(O, !1, !0)
                })),
            ...
            var U = M(v),
              ...
              z = (0, r.C3)((0, r.C3)({
                ...
                mount: function(t) {
                  C = !0, x = z.current = t, z.projection && z.projection.mount(t), N && p && !U && (b = null == p ? void 0 : p.addVariantChild(z)), P.forEach((function(t, e) {
                    return I(e, t)
                  })), null == p || p.children.add(z), z.setProps(v)
                },
                unmount: function() {
                  var t;
                  null === (t = z.projection) || void 0 === t || t.unmount(), dr.update(O), dr.render(k), T.forEach((function(t) {
                    return t()
                ...
                addValue: function(t, e) {
                  z.hasValue(t) && z.removeValue(t), P.set(t, e), E[t] = e.get(), I(t, e)
                },
                removeValue: function(t) {
                  var e;
                  P.delete(t), null === (e = T.get(t)) || void 0 === e || e(), T.delete(t), delete E[t], c(t, w)
                },
                hasValue: function(t) {
                  return P.has(t)
                },
      ...
      function ba(t) {
        ...
        return function() {
          ...
          return t.prototype.addEventListener = function(t, e) {
            ...
            this.isUpdating && (this.isUpdating = !1, this.potentialNodes.size && (this.potentialNodes.forEach(Ia), this.potentialNodes.clear()), this.nodes.forEach(Pa), this.nodes.forEach(Ca), this.nodes.forEach(Ea), this.clearAllSnapshots(), pr.update(), pr.preRender(), pr.render())
          }, t.prototype.clearAllSnapshots = function() {
            this.nodes.forEach(wa), this.sharedNodes.forEach(Ra)
      ...
      var $a = function(t) {
        ...
        Za = function(t) {
          ...
          m = (0, r.Mt)([], (0, r.o5)(m), !1);
          for (var E = y.current.map($a), w = h.map($a), S = E.length, P = 0; P < S; P++) {
            var A = E[P]; - 1 === w.indexOf(A) && g.add(A)
          }
      ...
      var gs = (0, o.forwardRef)((function(t, e) {
          ...
          return (0, o.useEffect)((function() {
            ...
            onDrag: function(t, e) {
              var n = e.velocity;
              n[b] && E(a, m[b].get(), n[b]), null == l || l(t, e)
            },
