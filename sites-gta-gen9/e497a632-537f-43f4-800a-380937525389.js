! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e497a632-537f-43f4-800a-380937525389", e._sentryDebugIdIdentifier = "sentry-dbid-e497a632-537f-43f4-800a-380937525389")
  } catch (e) {}
}();
    ...
    17048: function(e) {
      e.exports = function() {
        ...
        var L = u(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
          ...
          P = u(["accent", "accentunder", "align", "bevelled", "close", "columnsalign", "columnlines", "columnspan", "denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id", "largeop", "length", "linethickness", "lspace", "lquote", "mathbackground", "mathcolor", "mathsize", "mathvariant", "maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing", "rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator", "separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"]),
        ...
        return function t() {
          ...
          var he, ye, be = j,
            ...
            Se = K,
            Me = null,
            ke = x({}, [].concat(r(L), r(D), r(R), r(F), r(H))),
            xe = null,
            Oe = x({}, [].concat(r(z), r(G), r(P), r(B))),
            ...
            Qe = null,
            et = x({}, ["audio", "video", "img", "source", "image", "track"]),
            tt = null,
            nt = x({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
            ...
            pt = function(t) {
              ft && ft === t || (t && "object" === e(t) || (t = {}), t = O(t), he = he = -1 === ut.indexOf(t.PARSER_MEDIA_TYPE) ? "text/html" : t.PARSER_MEDIA_TYPE, ye = "application/xhtml+xml" === he ? N : v, Me = "ALLOWED_TAGS" in t ? x({}, t.ALLOWED_TAGS, ye) : ke, xe = "ALLOWED_ATTR" in t ? x({}, t.ALLOWED_ATTR, ye) : Oe, ct = "ALLOWED_NAMESPACES" in t ? x({}, t.ALLOWED_NAMESPACES, N) : st, tt = "ADD_URI_SAFE_ATTR" in t ? x(O(nt), t.ADD_URI_SAFE_ATTR, ye) : nt, Qe = "ADD_DATA_URI_TAGS" in t ? x(O(et), t.ADD_DATA_URI_TAGS, ye) : et, Ze = "FORBID_CONTENTS" in t ? x({}, t.FORBID_CONTENTS, ye) : Je, Le = "FORBID_TAGS" in t ? x({}, t.FORBID_TAGS, ye) : {}, De = "FORBID_ATTR" in t ? x({}, t.FORBID_ATTR, ye) : {}, Xe = "USE_PROFILES" in t && t.USE_PROFILES, Re = !1 !== t.ALLOW_ARIA_ATTR, Ie = !1 !== t.ALLOW_DATA_ATTR, Fe = t.ALLOW_UNKNOWN_PROTOCOLS || !1, Ue = !1 !== t.ALLOW_SELF_CLOSE_IN_ATTR, He = t.SAFE_FOR_TEMPLATES || !1, ze = !1 !== t.SAFE_FOR_XML, Ge = t.WHOLE_DOCUMENT || !1, je = t.RETURN_DOM || !1, We = t.RETURN_DOM_FRAGMENT || !1, qe = t.RETURN_TRUSTED_TYPE || !1, Be = t.FORCE_BODY || !1, Ye = !1 !== t.SANITIZE_DOM, $e = t.SANITIZE_NAMED_PROPS || !1, Ke = !1 !== t.KEEP_CONTENT, Ve = t.IN_PLACE || !1, Se = t.ALLOWED_URI_REGEXP || Se, it = t.NAMESPACE || at, Ce = t.CUSTOM_ELEMENT_HANDLING || {}, t.CUSTOM_ELEMENT_HANDLING && dt(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (Ce.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck), t.CUSTOM_ELEMENT_HANDLING && dt(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (Ce.attributeNameCheck = t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), t.CUSTOM_ELEMENT_HANDLING && "boolean" == typeof t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && (Ce.allowCustomizedBuiltInElements = t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), He && (Ie = !1), We && (je = !0), Xe && (Me = x({}, r(H)), xe = [], !0 === Xe.html && (x(Me, L), x(xe, z)), !0 === Xe.svg && (x(Me, D), x(xe, G), x(xe, B)), !0 === Xe.svgFilters && (x(Me, R), x(xe, G), x(xe, B)), !0 === Xe.mathMl && (x(Me, F), x(xe, P), x(xe, B))), t.ADD_TAGS && (Me === ke && (Me = O(Me)), x(Me, t.ADD_TAGS, ye)), t.ADD_ATTR && (xe === Oe && (xe = O(xe)), x(xe, t.ADD_ATTR, ye)), t.ADD_URI_SAFE_ATTR && x(tt, t.ADD_URI_SAFE_ATTR, ye), t.FORBID_CONTENTS && (Ze === Je && (Ze = O(Ze)), x(Ze, t.FORBID_CONTENTS, ye)), Ke && (Me["#text"] = !0), Ge && x(Me, ["html", "head", "body"]), Me.table && (x(Me, ["tbody"]), delete Le.tbody), u && u(t), ft = t)
            },
            gt = x({}, ["mi", "mo", "mn", "ms", "mtext"]),
            ht = x({}, ["annotation-xml"]),
            yt = x({}, ["title", "style", "font", "a", "script"]),
            bt = x({}, D);
          x(bt, R), x(bt, I);
          var Tt = x({}, F);
          x(Tt, U);
          var vt = function(e) {
            ...
            _t = function(e) {
              ...
              return e && n && a.insertBefore(i.createTextNode(n), a.childNodes[0] || null), it === at ? me.call(t, Ge ? "html" : "body")[0] : Ge ? t.documentElement : a
            },
            Et = function(e) {
            ...
            Mt = function(e) {
              var t;
              if (St("beforeSanitizeElements", e, null), At(e)) return vt(e), !0;
              if (S(/[\u0080-\uFFFF]/, e.nodeName)) return vt(e), !0;
              var n = ye(e.nodeName);
              if (St("uponSanitizeElement", e, {
                  tagName: n,
                  allowedTags: Me
                }), e.hasChildNodes() && !wt(e.firstElementChild) && (!wt(e.content) || !wt(e.content.firstElementChild)) && S(/<[/\w]/g, e.innerHTML) && S(/<[/\w]/g, e.textContent)) return vt(e), !0;
              ...
              return e instanceof f && ! function(e) {
                ...
                var n = v(e.tagName),
                  r = v(t.tagName);
                return !!ct[e.namespaceURI] && (e.namespaceURI === ot ? t.namespaceURI === at ? "svg" === n : t.namespaceURI === rt ? "svg" === n && ("annotation-xml" === r || gt[r]) : Boolean(bt[n]) : e.namespaceURI === rt ? t.namespaceURI === at ? "math" === n : t.namespaceURI === ot ? "math" === n && ht[r] : Boolean(Tt[n]) : e.namespaceURI === at ? !(t.namespaceURI === ot && !ht[r]) && !(t.namespaceURI === rt && !gt[r]) && !Tt[n] && (yt[n] || !bt[n]) : !("application/xhtml+xml" !== he || !ct[e.namespaceURI]))
              }(e) ? (vt(e), !0) : "noscript" !== n && "noembed" !== n && "noframes" !== n || !S(/<\/no(script|embed|frames)/i, e.innerHTML) ? (He && 3 === e.nodeType && (t = e.textContent, t = E(t, be, " "), t = E(t, Te, " "), t = E(t, ve, " "), e.textContent !== t && (T(o.removed, {
                element: e.cloneNode()
            ...
            xt = function(e) {
              return "annotation-xml" !== e && _(e, we)
            },
            Ot = function(t) {
              var n, r, a, i;
              ...
              if (l && !At(t)) {
                ...
                for (i = l.length; i--;) {
                  var s = n = l[i],
                    u = s.name,
                    f = s.namespaceURI;
                  if (r = "value" === u ? n.value : w(n.value), a = ye(u), c.attrName = a, c.attrValue = r, c.keepAttr = !0, c.forceKeepAttr = void 0, St("uponSanitizeAttribute", t, c), r = c.attrValue, !c.forceKeepAttr && (Nt(u, t), c.keepAttr))
                    if (Ue || !S(/\/>/i, r)) {
                      He && (r = E(r, be, " "), r = E(r, Te, " "), r = E(r, ve, " "));
                      var m = ye(t.nodeName);
                      if (kt(m, a, r))
                        if (!$e || "id" !== a && "name" !== a || (Nt(u, t), r = "user-content-" + r), ze && S(/((--!?|])>)|<\/(style|title)/i, r)) Nt(u, t);
                        else {
                          if (ie && "object" === e(k) && "function" == typeof k.getAttributeType)
                            if (f);
                            else switch (k.getAttributeType(m, a)) {
                              case "TrustedHTML":
                                r = ie.createHTML(r);
                                break;
                          ...
                          try {
                            f ? t.setAttributeNS(f, u, r) : t.setAttribute(u, r), At(t) ? vt(t) : b(o.removed)
                          } catch (e) {}
                        }
                    } else Nt(u, t)
                }
            ...
            Ct = function e(t) {
              var n, r = Et(t);
              for (St("beforeSanitizeShadowDOM", t, null); n = r.nextNode();) St("uponSanitizeShadowNode", n, null), Mt(n), Ot(n), n.content instanceof l && e(n.content);
          ...
          return o.sanitize = function(t) {
            ...
            if ((lt = !t) && (t = "\x3c!--\x3e"), "string" != typeof t && !wt(t)) {
            ...
            if (Pe || pt(m), o.removed = [], "string" == typeof t && (Ve = !1), Ve) {
              if (t.nodeName) {
                var d = ye(t.nodeName);
                if (!Me[d] || Le[d]) throw M("root node is forbidden and cannot be sanitized in-place")
              }
            } else if (t instanceof s) 1 === (i = (r = _t("\x3c!----\x3e")).ownerDocument.importNode(t, !0)).nodeType && "BODY" === i.nodeName || "HTML" === i.nodeName ? r = i : r.appendChild(i);
            else {
              if (!je && !He && !Ge && -1 === t.indexOf("<")) return ie && qe ? ie.createHTML(t) : t;
              if (!(r = _t(t))) return je ? null : qe ? le : ""
            }
            r && Be && vt(r.firstChild);
            for (var p = Et(Ve ? t : r); c = p.nextNode();) 3 === c.nodeType && c === u || (Mt(c), Ot(c), c.content instanceof l && Ct(c.content), u = c);
            if (u = null, Ve) return t;
            if (je) {
              if (We)
                for (f = fe.call(r.ownerDocument); r.firstChild;) f.appendChild(r.firstChild);
              else f = r;
              return (xe.shadowroot || xe.shadowrootmod) && (f = de.call(a, f, !0)), f
            }
            var g = Ge ? r.outerHTML : r.innerHTML;
            return Ge && Me["!doctype"] && r.ownerDocument && r.ownerDocument.doctype && r.ownerDocument.doctype.name && S(Z, r.ownerDocument.doctype.name) && (g = "<!DOCTYPE " + r.ownerDocument.doctype.name + ">\n" + g), He && (g = E(g, be, " "), g = E(g, Te, " "), g = E(g, ve, " ")), ie && qe ? ie.createHTML(g) : g
            ...
            "function" == typeof t && (ge[e] = ge[e] || [], T(ge[e], t))
