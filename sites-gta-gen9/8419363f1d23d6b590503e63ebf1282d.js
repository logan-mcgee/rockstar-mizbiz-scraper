! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "f543a900-c126-4835-b658-94e259fc9d64", e._sentryDebugIdIdentifier = "sentry-dbid-f543a900-c126-4835-b658-94e259fc9d64")
  } catch (e) {}
}();
  ...
  [4576, 5240], {
    ...
    11e3: (e, t, a) => {
      ...
      const {
        ...
        authHost: v,
        clientId: S
      } = (0, l.getScConfigForOrigin)(), j = "error", y = "landing", w = "success", C = "unlinked", T = e => {
        let {
          legalText: t
        } = e;
        return (0, k.jsx)("div", {
        ...
        const W = (0, l.useLocale)(),
          ...
          [Oe, Be] = (0, n.useState)(0),
          [Re, We] = (0, n.useState)(!1),
          [Me, Pe] = (0, n.useState)(!1),
          Le = (0, n.useRef)(null),
          $e = (0, n.useRef)(null),
          [He, Ae] = (0, n.useState)({}),
          [Fe, Ue] = (0, n.useState)(),
          ...
          [ze, Ke] = (0, n.useState)(M.introScreen.image.sources.mobile || h),
          Ye = `${document.location.pathname}${document.location.search}#${B}`,
          Qe = (0, l.usePrevious)(ce),
          Je = (0, l.usePrevious)(H),
          Xe = () => {
            K.current && Ce(K?.current?.scrollHeight), Y.current && Ne(Y?.current?.scrollHeight), Q.current && Ee(Q?.current?.scrollHeight), J.current && Be(J?.current?.scrollHeight)
          },
          Ze = (e, t) => {
            e === y && (Se(y), t && ye(we), ge("onScreen"), le("hidden"), be("hidden"), me("hidden")), e === w && (Se(w), t && ye(Te), ge("offScreen"), le("visible"), setTimeout((() => {
              ge("hidden")
            }), 300), setTimeout((() => {
              le("onScreen")
          ...
          et = e => `https://${v}.rockstargames.com/tpa/${e}/link/?cid=${S}&lang=${U}&returnUrl=${encodeURIComponent(Ye)}&accessToken=${pe}`;
        return (0, n.useEffect)((() => {
          const e = () => {
              window.innerWidth > 2560 && "newswire" !== a ? Ke(M.introScreen.image.sources.mobile || h) : Ke(M.introScreen.image.sources.desktop || h)
            },
            t = () => {
          ...
          ve === w && je !== Te ? ye(Te) : ve === j && je !== Ie ? ye(Ie) : ve === y && je !== we ? ye(we) : ve === C && je !== Oe && ye(Oe)
        }), [Ie, Te, je, Oe, we]), (0, n.useEffect)((() => {
          Xe(), Re && ve === w && ye(Y?.current?.scrollHeight)
        }), [K, J, Q, Y]), (0, n.useEffect)((() => {
          const e = $?.characters?.gtao;
          ne(e || [])
        }), [$]), (0, n.useEffect)((() => {
          "boolean" != typeof Qe && "boolean" != typeof Je || ce && H && (async () => {
            const {
              result: e
          ...
          ee ? (We(!0), Ze(w, !0)) : "boolean" != typeof ee || ee || Ze(y, !0)
        }), [ee]), (0, n.useEffect)((() => {
          V && !he && (G({
                ...
                children: ce ? (0, k.jsx)(f.LoadingAnimation, {
                  ...
                  children: [(0, k.jsxs)("div", {
                    ...
                    children: [(0, k.jsx)("img", {
                      src: M.introScreen.image.sources.mobile || h,
                      className: x.moduleImageMobile,
                      alt: M.introScreen.image.alt
                    }), (0, k.jsxs)("div", {
                      ...
                      children: [(0, k.jsx)("div", {
                        ...
                        children: (0, k.jsxs)("div", {
                          ...
                          children: [(0, k.jsx)("div", {
                            ...
                            children: [(0, k.jsx)("h2", {
                              children: M.introScreen.headline
                            }), (0, k.jsx)("div", {
                              dangerouslySetInnerHTML: {
                        ...
                        children: (0, k.jsx)(f.Gen9Button, {
                          ...
                          onClick: H ? async () => {
                            ...
                            else "success" === ke ? Ze(w, !1) : "error" === ke ? Ze(j, !1) : "unlinked" === ke && Ze(C, !1)
                          } : () => {
