try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "d90eefdd-d426-418d-a0c5-d5837b7864e2", e._sentryDebugIdIdentifier = "sentry-dbid-d90eefdd-d426-418d-a0c5-d5837b7864e2")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [9353], {
    ...
    22673: (e, t, a) => {
      ...
      var r = a(15411);
      const o = e => e - .02;
      o(768), o(1440), o(1920), o(2560), a(3322);
      const n = "__FOUNDRY_ACCENT__",
        i = (e, t) => r.X ? t() : (window[n] || (window[n] = new Map), window[n].has(e) || window[n].set(e, t()), window[n].get(e));
      var l;
    ...
    84735: (e, t, a) => {
          ...
          var t = function(e, t) {
            ...
            for (var a = []; t < e.length; t += 1) {
              ...
              if (9 === r || 32 === r || 10 === r) {
                ...
                var O;
                if (null === (O = H(e, t))) return null;
                var x = T(O, 3);
                i = x[0], l = x[1], y = x[2], a.push({
                  type: y,
                  value: l
                }), t = i
              } else a.push({
      ...
      class we {
        ...
        pixelifyProperties(e) {
          return ne(e, (t, a) => {
            "number" != typeof t || 0 === t || ye[a] || (e[a] = "".concat(t, "px"))
          }), e
        }
        transformVars(e) {
          var {
        ...
        transformSelectors(e, t, a) {
          ne(t.selectors, (t, r) => {
            ...
            this.transformLayer(i, t["@layer"], a), this.transformSupports(i, t["@supports"], a), this.transformMedia(i, t["@media"], a), this.transformContainer(i, t["@container"], a), this.transformStartingStyle(i, t["@starting-style"], a)
          })
        }
        transformMedia(e, t) {
        ...
        transformStartingStyle(e, t) {
          var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [];
          if (t) {
            var r, o = Object.keys(t).find(e => e.startsWith("@"));
            if (o) throw new Error('Nested at-rules (e.g. "'.concat(o, '") are not allowed inside @starting-style.'));
            null === (r = this.currConditionalRuleset) || void 0 === r || r.addConditionPrecedence(a, ["@starting-style"]);
            var n = [...a, "@starting-style"];
            this.addConditionalRule({
              selector: e.selector,
              rule: ie(t, me)
      ...
      class je {
        ...
        constructor(e) {
          ...
          if (this.allowStale = !!l, this.noDeleteOnStaleGet = !!b, this.updateAgeOnGet = !!n, this.updateAgeOnHas = !!i, this.ttlResolution = ze(r) || 0 === r ? r : 1, this.ttlAutopurge = !!o, this.ttl = a || 0, this.ttl) {
        ...
        dump() {
          ...
          for (const t of this.#_({
            ...
            this.#b && (n.size = this.#b[t]), e.unshift([a, n])
          }
          return e
        }
        load(e) {
        ...
        set(e, t, a = {}) {
          ...
          if (void 0 === d) d = 0 === this.#l ? this.#v : 0 !== this.#p.length ? this.#p.pop() : this.#l === this.#t ? this.#M(!1) : this.#l, this.#d[d] = e, this.#f[d] = t, this.#c.set(e, d), this.#u[this.#v] = d, this.#h[d] = this.#v, this.#v = d, this.#l++, this.#I(d, c, l), l && (l.set = "add"), s = !1;
            ...
            if (t !== a) {
              if (this.#C && this.#A(a)) {
                ...
                void 0 === t || n || (this.#k && this.#r?.(t, e, "set"), this.#S && this.#y?.push([t, e, "set"]))
              } else n || (this.#k && this.#r?.(a, e, "set"), this.#S && this.#y?.push([a, e, "set"]));
              if (this.#P(d), this.#I(d, c, l), this.#f[d] = t, l) {
                l.set = "replace";
          ...
          if (0 === r || this.#w || this.#T(), this.#w && (s || this.#F(d, r, o), l && this.#R(l, d)), !n && this.#S && this.#y) {
            const e = this.#y;
            let t;
        ...
        #M(e) {
          const t = this.#g,
            a = this.#d[t],
            r = this.#f[t];
          return this.#C && this.#A(r) ? r.__abortController.abort(new Error("evicted")) : (this.#k || this.#S) && (this.#k && this.#r?.(r, a, "evict"), this.#S && this.#y?.push([r, a, "evict"])), this.#P(t), e && (this.#d[t] = void 0, this.#f[t] = void 0, this.#p.push(t)), 1 === this.#l ? (this.#g = this.#v = 0, this.#p.length = 0) : this.#g = this.#u[t], this.#c.delete(a), this.#l--, t
        }
        has(e, t = {}) {
          const {
          ...
          if (0 !== this.#l) {
            ...
            if (void 0 !== r)
              if (a = !0, 1 === this.#l) this.#W(t);
                ...
                this.#P(r);
                const a = this.#f[r];
                if (this.#A(a) ? a.__abortController.abort(new Error("deleted")) : (this.#k || this.#S) && (this.#k && this.#r?.(a, e, t), this.#S && this.#y?.push([a, e, t])), this.#c.delete(e), this.#d[r] = void 0, this.#f[r] = void 0, r === this.#v) this.#v = this.#h[r];
        ...
        #W(e) {
          for (const t of this.#L({
            ...
            if (this.#A(a)) a.__abortController.abort(new Error("deleted"));
              ...
              const r = this.#d[t];
              this.#k && this.#r?.(a, r, e), this.#S && this.#y?.push([a, r, e])
            }
          }
