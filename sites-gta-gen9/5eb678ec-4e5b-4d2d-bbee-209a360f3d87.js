try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "5eb678ec-4e5b-4d2d-bbee-209a360f3d87", e._sentryDebugIdIdentifier = "sentry-dbid-5eb678ec-4e5b-4d2d-bbee-209a360f3d87")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const f = (0, d.defineMessages)({
        ...
        p = ({
          ...
          const {
            ...
            bug: r(f.report_issue_button_label),
            suggestions: r(f.suggestions_button_label)
          }, p = a.path.map(e => 1 === a.path.length && "_root" === e.feedback_type.name ? null : (0, s.jsx)(i.NavLink, {
            to: `?step=${e.id_hash}`,
            className: n[`stepIcon${e.feedback_type.name}`],
            children: e.feedback_type.title
          }, e.id_hash)), l = a.next.map(e => "_root" === e.feedback_type.name ? null : !e?.message || "bug" !== e.feedback_type.name && "suggestions" !== e.feedback_type.name ? (0, s.jsxs)(i.NavLink, {
            ...
            children: [e.feedback_type.title, e?.feedback_type?.href ? (0, s.jsx)("span", {
              ...
              children: r(f.aria_label_open_new_window)
            }) : ""]
          }, e.id_hash) : (0, s.jsxs)("div", {
            className: n.primaryStepSection,
            children: [(0, s.jsxs)("div", {
              className: n.primaryStepSectionTextContent,
              children: [(0, s.jsx)("div", {
                className: (0, g.default)(n.feedbackIcon, n[`primaryStepSection${e.feedback_type.name}`])
              }), (0, s.jsx)("h4", {
                children: e?.feedback_type.title
              }), (0, s.jsx)("div", {
                className: n.stepMessage,
              ...
              "aria-label": e?.feedback_type?.href && `${b[e.feedback_type.name]} ${r(f.aria_label_open_new_window)}`,
              asChild: !0,
              children: (0, s.jsx)(i.NavLink, {
                className: n.primaryStepLink,
                target: e?.feedback_type?.href ? "_blank" : "_self",
                to: e?.feedback_type?.href ? e.feedback_type.href : `?step=${e.id_hash}`,
                children: b[e.feedback_type.name]
              })
            })]
          }, e.id_hash));
          return (0, s.jsxs)("div", {
            className: [n.steps, n[t]].join(" "),
            children: [(0, s.jsx)("div", {
              className: n.stepsPrevious,
              children: p
            }), (0, s.jsx)("div", {
              className: n.stepsNext,
              children: l
            }), l.length ? "" : (0, s.jsx)(m, {
        ...
        m = ({
          ...
          const {
            ...
            loggedIn: o
          } = (0, b.useRockstarUser)(), g = (0, c.useRef)(null), [p, {
            data: m,
            error: l
          }] = (0, r.useMutation)(a), k = (0, c.useMemo)(() => `${(0,r.getBase)()}${location?.pathname}`.replace(/\/\//g, "/"), [location?.pathname]), {
            signInUrl: u
          } = (0, r.useScAuthLinks)(k);
          return o ? m?.submittal?.id ? (0, s.jsx)("div", {
            ...
            children: i(f.gtao_feedback_login_cta_text, {
              SignInLink: e => (0, s.jsx)("a", {
                className: n.signInLink,
                href: u,
                children: e
              })
            })
        ...
        l = ({
          ...
          }, [o.get("step")]), (0, s.jsxs)("div", {
            className: n.feedback,
            children: [(0, s.jsx)("h1", {
              children: i("online-feedback-h1")
            }), (0, s.jsx)("div", {
              className: n.desc,
              dangerouslySetInnerHTML: {
                __html: i("online-feedback-desc")
              }
            }), b && (0, s.jsx)(p, {
              mutation: e,
              tree: b.tree,
        ...
        k = ({
          ...
          query: a,
          type: t
        }) => (0, r.withTranslations)(l, "rdo" === t ? "rdr2" : t)({
          mutation: e,
          query: a,
          type: t
        })
