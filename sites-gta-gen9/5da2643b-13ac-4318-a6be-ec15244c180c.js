        ...
        async function Q(t, r, a) {
          ...
          let {
            ...
            let p = a || Ie(r, i),
              m = i || l || ze(p),
              y = s || u,
              [g, v] = pe(e.history, A, o, m, r, I, W, B, K, H, y, f, d, h);
            if ($e((e => !(o && o.some((t => t.route.id === e))) || g && g.some((t => t.route.id === e)))), F = ++N, 0 === g.length && 0 === v.length) {
              let e = ge();
              return G(r, n({
                matches: o,
                loaderData: {},
