try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "28c5e122-07b9-4bf7-91e3-3b8d1209fdcc", t._sentryDebugIdIdentifier = "sentry-dbid-28c5e122-07b9-4bf7-91e3-3b8d1209fdcc")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    42625: (t, e, n) => {
        ...
        if (s)
          for (let a = 0; a < s; a++) {
            const s = r[a],
              l = e[s];
            let u = null;
            Array.isArray(l) && (u = l[0]), null === u && (u = null !== (i = null !== (o = n[s]) && void 0 !== o ? o : t.readValue(s)) && void 0 !== i ? i : e[s]), null != u && ("string" == typeof u && (ke(u) || Re(u)) ? u = parseFloat(u) : !Sn(u) && fn.test(l) && (u = bn(s, l)), t.addValue(s, Qe(u, {
              owner: t
      ...
      function Io({
        ...
        return a && (l && l(), v = e(function(t) {
          ...
          }(n, b, r, T)) : (n = Do(n, b, r), "mirror" === i && A.flipTarget()), E = !1, h && h()) : (v.stop(), c && c()))
        }), v.start()), {
          stop: () => {
            u && u(), v.stop()
          },
            ...
            t.animationState || (t.animationState = function(t) {
              ...
              function r(r, s) {
                ...
                for (let e = 0; e < ci; e++) {
                  ...
                  const b = hi(g.prevProp, v);
                  let E = b || m === s && g.isActive && !w && y || e > f && y;
                  ...
                  for (const t in S) {
                    const e = P[t],
                      n = V[t];
                    h.hasOwnProperty(t) || (e !== n ? Rt(e) && Rt(n) ? !Le(e, n) || b ? A(t) : g.protectedKeys[t] = !0 : void 0 !== e ? A(t) : c.add(t) : void 0 !== e && c.has(t) ? A(t) : g.protectedKeys[t] = !0)
                  }
                  g.prevProp = v, g.prevResolvedValues = P, g.isActive && (h = {
                    ...h,
                    ...P
                  }), o && t.blockInitialAnimation && (E = !1), E && !w && u.push(...T.map(t => ({
                    animation: t,
                    options: {
                      type: m,
                      ...r
      ...
      function Vi(t, e, n, o = .5) {
        t.origin = o, t.originPoint = Gn(e.min, e.max, t.origin), t.scale = Ti(n) / Ti(e), (Pi(t.scale, 1, 1e-4) || isNaN(t.scale)) && (t.scale = 1), t.translate = Gn(n.min, n.max, t.origin) - t.originPoint, (Pi(t.translate) || isNaN(t.translate)) && (t.translate = 0)
      }
      ...
      function cs({
        ...
        return class {
          ...
          didUpdate() {
            ...
            this.isUpdating && (this.isUpdating = !1, this.potentialNodes.size && (this.potentialNodes.forEach(Ss), this.potentialNodes.clear()), this.nodes.forEach(gs), this.nodes.forEach(hs), this.nodes.forEach(ds), this.clearAllSnapshots(), He.update(), He.preRender(), He.render())
          }
          clearAllSnapshots() {
      ...
      function Ra(t, e, n, o) {
        const i = n[e],
          ...
          a = i.current,
          l = n.time;
        i.current = t[`scroll${s}`], i.scrollLength = t[`scroll${r}`] - t[`client${r}`], i.offset.length = 0, i.offset[0] = 0, i.offset[1] = i.scrollLength, i.progress = (0, Aa.q)(0, i.scrollLength, i.current);
        const u = o - l;
        i.velocity = u > Ma ? 0 : (0, Ca.f)(i.current - a, u)
      }
      var Da = n(72023),
        Ba = n(44367),
        Ia = n(38138);
      ...
      function Na(t, e, n = 0) {
        let o = 0;
        if (void 0 !== Ua[t] && (t = Ua[t]), (0, ja.K)(t)) {
        ...
        return (0, Oa.E)(t) && (o = e * t), n + o
      }
      const $a = [0, 0];

      function za(t, e, n, o) {
        let i = Array.isArray(t) ? t : $a,
          r = 0,
          s = 0;
        return (0, Oa.E)(t) ? i = [t, t] : (0, ja.K)(t) && (i = (t = t.trim()).includes(" ") ? t.split(" ") : [t, Ua[t] ? t : "0"]), r = Na(i[0], n, o), s = Na(i[1], e), r - s
      }
      const Wa = {
        x: 0,
        y: 0
        ...
        return {
          ...
          update: e => {
            ! function(t, e, n) {
              ...
              const h = o.length;
              for (let t = 0; t < h; t++) {
                const n = za(o[t], u[s], l[s], a[r]);
                c || n === e[r].interpolatorOffsets[t] || (c = !0), e[r].offset[t] = n
              }
              c && (e[r].interpolate = (0, Ba.G)((0, Ia.Z)(h), e[r].offset), e[r].interpolatorOffsets = [...e[r].offset]), e[r].progress = e[r].interpolate(e[r].current)
            }(t, n, o)
          },
          notify: Sa(e) ? () => e(n) : (r = e, s = n[i], r.pause(), r.forEachNative((t, {
            easing: e
          }) => {
            var n, o;
            if (t.updateDuration) e || (t.easing = Da.p), t.updateDuration(1);
            else {
              const i = {
                duration: 1e3
              };
      ...
      function qa(t, e = {}) {
        ...
        if (i.add(s), !Ya.has(n)) {
          ...
          window.addEventListener("resize", t, {
            passive: !0
          }), n !== document.documentElement && Xa.set(n, (u = t, Sa(l = n) ? (a = l, Pa.add(a), Va || (Va = () => {
            const t = {
            ...
            Pa.delete(a), !Pa.size && Va && (Va = void 0)
          }) : function(t, e) {
              ...
              a = new IntersectionObserver(t => {
                t.forEach(t => {
                  ...
                  if (t.isIntersecting !== Boolean(n))
                    if (t.isIntersecting) {
                      const n = e(t);
                      Sa(n) ? s.set(t.target, n) : a.unobserve(t.target)
      ...
      function Al(t) {
        const [e, n] = (0, o.useState)(t), i = Sl({}, !1), r = b(() => new Vl({
          props: {},
          visualState: i
        }, {
          initialState: t
      ...
      function Ll(t) {
        let e = ia(1),
          n = ia(1);
        const o = s();
        return (0, Un.V)(!(!t && !o), "If no scale values are provided, useInvertedScale must be used within a child of another motion component."), (0, Un.$)(Ml, "useInvertedScale is deprecated and will be removed in 3.0. Use the layout prop instead."), Ml = !0, t ? (e = t.scaleX || e, n = t.scaleY || n) : o && (e = o.getValue("scaleX", 1), n = o.getValue("scaleY", 1)), {
          scaleX: la(e, Cl),
          scaleY: la(n, Cl)
        }
      }
