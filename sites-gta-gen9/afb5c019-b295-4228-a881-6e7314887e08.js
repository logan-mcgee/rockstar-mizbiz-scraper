! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "afb5c019-b295-4228-a881-6e7314887e08", e._sentryDebugIdIdentifier = "sentry-dbid-afb5c019-b295-4228-a881-6e7314887e08")
  } catch (e) {}
}();
  ...
  [2196, 5328], {
    11e3: (e, t, a) => {
      ...
      const {
        ...
        authHost: v,
        clientId: S
      } = (0, l.getScConfigForOrigin)(), j = "error", w = "landing", y = "success", C = "unlinked", T = e => {
        let {
          legalText: t
        } = e;
        return (0, k.jsx)("div", {
        ...
        const O = (0, l.useLocale)(),
          ...
          [ze, Ke] = (0, n.useState)($.introScreen.image.sources.mobile || h),
        ...
        return (0, n.useEffect)((() => {
          const e = () => {
              window.innerWidth > 2560 && "newswire" !== a ? Ke($.introScreen.image.sources.mobile || h) : Ke($.introScreen.image.sources.desktop || h)
            },
            t = () => {
              Xe(), window.innerWidth <= z && !se && (re(!0), Ze(ve, !0)), window.innerWidth > z && se && re(!1), e()
            };
          return re(window.innerWidth <= z), e(), window.addEventListener("resize", t), () => {
            window.removeEventListener("resize", t)
          }
        }), [ve, se, K, J, Y, Q]), (0, n.useEffect)((() => {
          ve === y && je !== Te ? we(Te) : ve === j && je !== Ie ? we(Ie) : ve === w && je !== ye ? we(ye) : ve === C && je !== Be && we(Be)
        }), [Ie, Te, je, Be, ye]), (0, n.useEffect)((() => {
          Xe(), We && ve === y && we(Q?.current?.scrollHeight)
          ...
          "boolean" == typeof R ? R ? ie(!0) : (ie(!1), ge("onScreen")) : ie(!0)
        }), [R]), (0, n.useEffect)((() => {
          ee ? (Oe(!0), Ze(y, !0)) : "boolean" != typeof ee || ee || Ze(w, !0)
        }), [ee]), (0, n.useEffect)((() => {
          V && !he && (D({
        ...
        }), [Pe, Le]), (0, k.jsxs)(k.Fragment, {
          children: [!1, (0, k.jsx)("div", {
            className: x.interestTrackerWrapper,
            children: (0, k.jsxs)(i.motion.div, {
                      ...
                      children: [(0, k.jsx)("div", {
                        ...
                        children: (0, k.jsx)(m.Gen9Button, {
                          ...
                          onClick: R ? async () => {
                            ...
                            else "success" === ke ? Ze(y, !1) : "error" === ke ? Ze(j, !1) : "unlinked" === ke && Ze(C, !1)
                          } : () => {
                    ...
                    children: [(0, k.jsxs)("div", {
                      ...
                      children: [(0, k.jsxs)("div", {
                        ...
                        children: [(0, k.jsx)("div", {
                          ...
                          ref: Pe,
                          onClick: () => {
                            Re?.slidePrev(), De(Re?.isEnd), Ve(Re?.isBeginning)
                          },
                          disabled: qe,
                          "data-hidden": !$e
                        }), (0, k.jsx)("button", {
                          ...
                          ref: Le,
                          onClick: () => {
                            Re?.slideNext(), De(Re?.isEnd), Ve(Re?.isBeginning)
                          },
                          disabled: Ge,
                          "data-hidden": !$e
                        })]
