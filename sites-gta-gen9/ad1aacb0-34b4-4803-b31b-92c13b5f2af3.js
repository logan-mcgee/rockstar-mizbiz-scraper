! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      n = (new Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "ad1aacb0-34b4-4803-b31b-92c13b5f2af3", e._sentryDebugIdIdentifier = "sentry-dbid-ad1aacb0-34b4-4803-b31b-92c13b5f2af3")
  } catch (e) {}
}();
  ...
  [2860], {
    22860: (e, n, a) => {
      ...
      const C = e => {
        ...
        return (0, b.jsxs)("div", {
          ...
          children: [(0, b.jsx)("img", {
            src: a.introScreen.image.sources.mobile || h,
      ...
      const w = e => {
        ...
        return (0, t.useEffect)((() => {
          const e = () => {
            c?.current && h(c?.current?.scrollWidth > c?.current?.offsetWidth)
          };
        ...
        }), [g?.current, A?.current]), (0, b.jsxs)("div", {
            ...
            children: [(0, b.jsxs)("div", {
              ...
              children: [(0, b.jsx)("div", {
                ...
                children: (0, b.jsxs)(u.RC, {
                  ...
                  onSlideChange: e => {
                    B(e?.isEnd), D(e?.isBeginning)
                  },
                  children: [i.map((e => (0, b.jsx)(u.qr, {
                    tabIndex: 0,
                  ...
                  }, `${e.platformUsername}-${e.platform}-${e.characterSlot}`))), (0, b.jsx)(u.qr, {
      ...
      const B = e => {
          ...
          const d = (0, s.useScAuthTpaLink)("np", i).href,
            c = (0, s.useScAuthTpaLink)("xbl", i).href;
          return (0, b.jsxs)("div", {
      ...
      var D = function(e) {
        ...
        L = a(58269),
        q = {};
      q.styleTagTransform = W(), q.setAttributes = R(), q.insert = T().bind(null, "head"), q.domAPI = F(), q.insertStyleElement = j(), z()(L.A, q);
      const P = L.A && L.A.locals ? L.A.locals : void 0,
        {
          host: J
        ...
        H = (0, A.withIntl)((e => {
          ...
          const k = {
              ...
              legalText: x,
              successScreen: {
                body: u?.successContent || "",
                headline: u?.successHeadline || ""
              },
              unlinkedScreen: {
            ...
            F = `https://${J}.rockstargames.com/settings/linkedaccounts`,
            S = (0, A.useIntl)(),
            {
              track: T
            } = (0, d.useGtmTrack)(),
            ...
            [H, U] = (0, t.useState)(!1),
            [O, Q] = (0, t.useState)(),
            [$, Y] = (0, t.useState)("hidden"),
            [K, V] = (0, t.useState)("hidden"),
            [X, Z] = (0, t.useState)("hidden"),
            [ee, ne] = (0, t.useState)("hidden"),
            [ae, te] = (0, t.useState)(!1),
            [re, ie] = (0, t.useState)(D.landing),
            [oe, se] = (0, t.useState)(k.introScreen.image.sources.mobile || h),
            de = `${document.location.pathname}${document.location.search}#${v}`,
            ce = (0, s.usePrevious)(O),
            Ae = (0, s.usePrevious)(z),
            {
              signInUrl: ge
            } = (0, s.useScAuthLinks)(de),
            le = e => {
              e === D.landing ? (ie(D.landing), V("onScreen"), Y("hidden"), ne("hidden"), Z("hidden")) : e === D.success ? (ie(D.success), V("offScreen"), Y("visible"), setTimeout((() => {
                V("hidden"), ne("hidden")
              }), 300), setTimeout((() => {
                Y("onScreen")
              }), 100)) : e === D.error ? (ie(D.error), V("offScreen"), ne("visible"), setTimeout((() => {
                V("hidden")
              }), 300), setTimeout((() => {
                ne("onScreen")
              }), 100)) : e === D.unlinked && (ie(D.unlinked), V("offScreen"), Z("visible"), setTimeout((() => {
                V("hidden"), ne("hidden")
              }), 300), setTimeout((() => {
                Z("onScreen")
              }), 100))
          ...
          return (0, t.useEffect)((() => {
            const e = () => {
                window.innerWidth > 2560 && "newswire" !== a ? se(k.introScreen.image.sources.mobile || h) : se(k.introScreen.image.sources.desktop || h)
              },
              n = () => {
                window.innerWidth <= G && !H ? (U(!0), le(re)) : window.innerWidth > G && H && U(!1), e()
              };
            ...
            "boolean" != typeof ce && "boolean" != typeof Ae || !n || O && z && (async () => {
              const {
                result: e
            ...
            void 0 !== M && E?.accountSynced && Q(!1)
          }), [M, E?.accountSynced, Q]), (0, t.useEffect)((() => {
            O || (async () => {
              L.length > 0 && M ? le(D.success) : le(M ? D.unlinked : D.landing)
            })()
          }), [O]), (0, t.useEffect)((() => {
            if (R && !ae) {
              if (void 0 === z) return;
            ...
            children: (0, b.jsx)("div", {
              ...
              children: (0, b.jsxs)(i.motion.div, {
                className: [P.interestTracker, O && P.loader].join(" "),
                initial: {
                  opacity: 0
                },
                whileInView: {
                ...
                children: [(0, b.jsx)("div", {
                  ...
                  className: [P.slideContainer, O ? P.loader : ""].join(" "),
                  ref: j,
                  children: O ? (0, b.jsx)("div", {
                    ...
                    children: [re === D.landing && (0, b.jsx)(C, {
                      s: P,
                      content: k,
                      loggedIn: z,
                      addClaim: async () => {
                      ...
                      linkMoreAccounts: () => {
                        T({
                          ...
                          link_url: F,
                          text: l.engagement_link_account.defaultMessage
                        })
                      },
                      linkAccountBtn: S.formatMessage(l.engagement_link_account)
                    }), re === D.unlinked && (0, b.jsx)(B, {
                      s: P,
                      content: k,
                      unlinkedSlide: X,
                      linkConsoleText: S.formatMessage(l.engagement_link_console_account),
                      returnUrl: de,
                      giftId: n
                    }), re === D.error && (0, b.jsx)(I, {
                      s: P,
                      errorSlide: ee,
                      content: k
                    })]
    ...
    58269: (e, n, a) => {
      ...
      var t = a(42587),
        ...
        s = a(79908),
        d = a.n(s),
        c = new URL(a(56353), a.b),
        A = new URL(a(50228), a.b),
        g = new URL(a(304), a.b),
        l = new URL(a(79539), a.b),
        m = new URL(a(61494), a.b),
        f = new URL(a(313), a.b),
        b = new URL(a(94904), a.b),
        p = new URL(a(49027), a.b),
        h = new URL(a(83493), a.b),
        C = new URL(a(53037), a.b),
        u = new URL(a(93803), a.b),
        v = new URL(a(69400), a.b),
        x = new URL(a(44840), a.b),
        k = new URL(a(28168), a.b),
        w = new URL(a(40792), a.b),
        y = new URL(a(31431), a.b),
        B = new URL(a(51594), a.b),
        I = new URL(a(21130), a.b),
        D = new URL(a(57390), a.b),
        E = new URL(a(36606), a.b),
        z = new URL(a(73075), a.b),
        _ = new URL(a(16183), a.b),
        F = new URL(a(28255), a.b),
        S = new URL(a(99589), a.b),
        T = new URL(a(52695), a.b),
        ...
        le = d()(G),
        me = d()(j);
      M.push([e.id, `.rockstargames-sites-gta-gen9d00777e4f5cd743e631c6c55037e895d{align-items:center;background:var(--white-15);border:none;border-radius:100px;color:var(--white-100);cursor:pointer;display:flex;font-family:var(--font-family-body);font-size:20px;font-style:normal;font-weight:700;justify-content:center;line-height:var(--rem-125);min-width:var(--rem-6);padding:var(--padding-xs) var(--padding-sm);text-align:center;transition:background-color .3s ease-in-out}.rockstargames-sites-gta-gen9d00777e4f5cd743e631c6c55037e895d img{height:var(--nav-icon-size);margin-left:var(--grid-gap-xs);transition:filter .3s ease-in-out;width:var(--nav-icon-size)}.rockstargames-sites-gta-gen9d00777e4f5cd743e631c6c55037e895d:focus,.rockstargames-sites-gta-gen9d00777e4f5cd743e631c6c55037e895d:hover{background-color:var(--white-40);outline:none}.rockstargames-sites-gta-gen9d00777e4f5cd743e631c6c55037e895d.rockstargames-sites-gta-gen9b58430ad013dcff6fef7da7166cc691f{background:var(--white-100);color:var(--black-200)}.rockstargames-sites-gta-gen9d00777e4f5cd743e631c6c55037e895d.rockstargames-sites-gta-gen9b58430ad013dcff6fef7da7166cc691f img{filter:invert()}.rockstargames-sites-gta-gen9d2b8c4d79af33709f68b37001ab7be39{--padding-dynamic:var(--padding-sides);--padding-dynamic-tb:0;margin:0 auto;max-width:calc(var(--max-width-dynamic, var(--content-max-width)) + var(--padding-dynamic, 0px) * 2)!important;padding:var(--padding-t,var(--padding-dynamic-tb,0)) var(--padding-dynamic,0) var(--padding-b,var(--padding-dynamic-tb,0)) var(--padding-dynamic,0);width:100%}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{--font-family-body:"Chalet";--font-family-h:"ChaletComprime";--font-weight-regular:400;--font-weight-bold:700;--letter-spacing-body:0;--letter-spacing-h:0;--line-height-sm:1;--line-height-md:1.1;--line-height-lg:1.6;--black-200:#000;--black-100:#121212;--black-65:hsla(0,0%,7%,.65);--black-40:hsla(0,0%,7%,.4);--black-15:hsla(0,0%,7%,.15);--text-dark:#2d2d2d;--border-color:#2d2d2d;--white-100:#fff;--white-65:hsla(0,0%,100%,.65);--white-40:hsla(0,0%,100%,.4);--white-15:hsla(0,0%,100%,.15);--text-light:#e8e8e8;--focusring-blue:blue;--red:#e03232;--circoloco-red:#eb1818;--rockstar-gold:#fcaf17;--playstation-blue:#00439c;--microsoft-green:#387a26;--pc-legacy:#b2b2b2;--pc-enhanced:#beb279;--color-h:var(--white-100);--color-body:var(--text-light);--green-light:#c1f7bd;--green-dark:#81da85;--scroll-thumb-color:#7d7d7d;--scroll-track-color:transparent;--max-width-sm:640px;--max-width-md:1088px;--max-width-lg:1920px;--max-width-xl:2560px;--spacing-xxs:0.25rem;--spacing-xs:0.5rem;--spacing-sm:1rem;--spacing-md:2rem;--spacing-lg:4rem;--spacing-xl:8rem;--grid-gap-xxs:var(--spacing-xxs);--grid-gap-xs:var(--spacing-xs);--grid-gap-sm:var(--spacing-sm);--grid-gap-md:var(--spacing-md);--grid-gap-lg:var(--spacing-lg);--grid-gap-xl:var(--spacing-xl);--padding-xxs:var(--spacing-xxs);--padding-xs:var(--spacing-xs);--padding-sm:var(--spacing-sm);--padding-md:var(--spacing-md);--padding-lg:var(--spacing-lg);--padding-xl:var(--spacing-xl);--margin-xxs:var(--spacing-xxs);--margin-xs:var(--spacing-xs);--margin-sm:var(--spacing-sm);--margin-md:var(--spacing-md);--margin-lg:var(--spacing-lg);--margin-xl:var(--spacing-xl);--border-radius-xs:2px;--border-radius-sm:4px;--border-radius-md:8px;--border-radius-lg:16px;--gradient-overlay-bottom:linear-gradient(180.08deg,transparent 25%,rgba(0,0,0,.5) 65%,rgba(0,0,0,.6));--gradient-overlay-right:linear-gradient(270deg,rgba(0,0,0,.9),transparent);--promo-banner-z-index:11500;--gen9-max-width:2560px;--content-max-width:var(--gen9-max-width);--padding-sides:var(--padding-lg);--content-padding:0 var(--padding-sides);--engagement-background:var(--black-200);--engagement-image:url(${W});--cta-position:relative;background-color:var(--engagement-background);border:1px solid var(--border-color);border-radius:var(--border-radius-md);display:flex;display:flex!important;flex:1;flex-direction:column;justify-content:center;overflow:hidden}@media (min-width:2560px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{--max-width-md:1440px}}@media (max-width:767px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{--spacing-lg:2rem;--spacing-xl:4rem}}@font-face{font-family:ChaletComprime;font-style:normal;font-weight:400;src:url(${L}) format("woff")}@font-face{font-family:ChaletComprime;font-style:normal;font-weight:700;src:url(${q}) format("woff")}@font-face{font-family:Chalet;font-style:normal;font-weight:400;src:url(${P}) format("woff")}@font-face{font-family:Chalet;font-style:normal;font-weight:700;src:url(${J}) format("woff")}@font-face{font-family:Pricedown;font-style:normal;font-weight:700;src:url(${H}) format("woff")}@font-face{font-family:NeueHelveticaW05;font-style:normal;font-weight:400;src:url(${U}) format("woff")}@font-face{font-family:NeueHelveticaW05;font-style:normal;font-weight:700;src:url(${O}) format("woff")}@font-face{font-family:NeueHelveticaW05;font-style:normal;font-weight:900;src:url(${Q}) format("woff")}@font-face{font-family:FrizQuadrataW05;font-style:normal;font-weight:400;src:url(${$}) format("woff")}@font-face{font-family:FrizQuadrataW05;font-style:italic;font-weight:400;src:url(${Y}) format("woff")}@font-face{font-family:FrizQuadrataW05;font-style:normal;font-weight:700;src:url(${K}) format("woff")}@font-face{font-family:FrizQuadrataW05;font-style:italic;font-weight:700;src:url(${V}) format("woff")}@font-face{font-family:CorporateW05;font-style:normal;font-weight:400;src:url(${X}) format("woff")}@font-face{font-family:NimbusSansW05;font-style:normal;font-weight:400;src:url(${Z}) format("woff")}@font-face{font-family:NimbusSansW05;font-style:normal;font-weight:700;src:url(${ee}) format("woff")}@font-face{font-family:EurostileNextW05;font-style:normal;font-weight:700;src:url(${ne}) format("woff")}@font-face{font-family:Diploma;font-style:normal;font-weight:400;src:url(${ae}) format("woff")}@font-face{font-family:BrushScriptMT;font-style:normal;font-weight:400;src:url(${te}) format("woff")}@font-face{font-family:BankGothicBT;font-style:normal;font-weight:400;src:url(${re}) format("woff")}@font-face{font-family:NeueHelveticaPaneuropean;font-style:italic;font-weight:700;src:url(${ie}) format("woff")}@font-face{font-family:NeueHelveticaPaneuropean;font-style:normal;font-weight:700;src:url(${oe}) format("woff")}@font-face{font-family:NeueHelveticaPaneuropean;font-style:normal;font-weight:400;src:url(${se}) format("woff")}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f :lang(pl_pl){--font-family-h:NeueHelveticaPaneuropean;--font-family-std:NeueHelveticaPaneuropean}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f :lang(ru_ru){--font-family-h:NeueHelveticaPaneuropean}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f [data-type-lang=pl],.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f [data-type-lang=ru]{font-family:NeueHelveticaPaneuropean!important}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f :lang(zh_hans){--font-family-h:ChaletComprime,NotoSansSC;--font-family-body:NotoSansSC}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f [data-type-lang=zh]{font-family:ChaletComprime,NotoSansSC!important}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f :lang(zh_tw){--font-family-h:ChaletComprime,NotoSansTC;--font-family-body:NotoSansTC}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f [data-type-lang=tw]{font-family:ChaletComprime,NotoSansTC!important}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f :lang(ja_jp){--font-family-h:ChaletComprime,NotoSansJP;--font-family-body:NotoSansJP}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f [data-type-lang=jp]{font-family:ChaletComprime,NotoSansJP!important}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f :lang(ko_kr){--font-family-h:ChaletComprime,NotoSansKR;--font-family-body:NotoSansKR}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f [data-type-lang=kr]{font-family:ChaletComprime,NotoSansKR!important}@media (min-width:1920px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{--padding-sides:var(--padding-xl)}}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f h1{font-size:calc(var(--font-size-8) * var(--header-multiplier))}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f h1,.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f h2{color:var(--color-override,var(--color-h));font-family:var(--font-family-h);font-weight:var(--font-weight-bold);letter-spacing:var(--letter-spacing-h);line-height:var(--line-height-md)}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f h2{font-size:calc(var(--font-size-7) * var(--header-multiplier))}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f h3{font-size:calc(var(--font-size-6) * var(--header-multiplier))}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f h3,.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f h4{color:var(--color-override,var(--color-h));font-family:var(--font-family-h);font-weight:var(--font-weight-regular);letter-spacing:var(--letter-spacing-h);line-height:var(--line-height-md)}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f h4{font-size:calc(var(--font-size-5) * var(--header-multiplier))}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f h5{color:var(--color-override,var(--color-h));font-family:var(--font-family-h);font-size:calc(var(--font-size-4) * var(--header-multiplier));font-weight:var(--font-weight-regular);letter-spacing:var(--letter-spacing-h);line-height:var(--line-height-md)}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f p{color:var(--color-body);font-family:var(--font-family-body);font-size:var(--font-size-3);font-weight:var(--font-weight-regular);letter-spacing:var(--letter-spacing-body);line-height:var(--line-height-lg)}@media (min-width:0px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{--root-font-size:16}}@media (min-width:768px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{--root-font-size:18}}@media (min-width:1024px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{--root-font-size:20}}@media (min-width:1920px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{--root-font-size:22}}@media (max-width:1279px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f.rockstargames-sites-gta-gen9d8c578c46f36662f7652cc76eac7da9b{background-color:inherit;border:none}}@media (min-width:1280px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{flex-direction:row}}@media (max-width:1279px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{height:auto}}@media (min-width:1280px) and (max-width:2559px){@supports not (aspect-ratio:1/1){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{position:relative}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f:before{content:"";display:block;padding-top:calc((1 / 1) * 100%);width:100%}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f>.rockstargames-sites-gta-gen9befb0ce557a2dd74f4835661fb577844{bottom:0;height:100%!important;left:0;position:absolute;right:0;top:0;width:100%!important}}@supports (aspect-ratio:1/1){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f .rockstargames-sites-gta-gen9befb0ce557a2dd74f4835661fb577844{aspect-ratio:1/1!important;height:auto!important;width:100%!important}}}@media (min-width:2560px){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{--engagement-image:url(${de})}@supports not (aspect-ratio:16/9){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f{position:relative}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f:before{content:"";display:block;padding-top:calc((9 / 16) * 100%);width:100%}.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f>.rockstargames-sites-gta-gen9befb0ce557a2dd74f4835661fb577844{bottom:0;height:100%!important;left:0;position:absolute;right:0;top:0;width:100%!important}}@supports (aspect-ratio:16/9){.rockstargames-sites-gta-gen9db2a4f7b1cfeb4aeca1410a7cd445b8f .rockstargames-sites-gta-gen9befb0ce557a2dd74f4835661fb577844{aspect-ratio:16/9!important;height:auto!important;width:100%!important}}}.rockstargames-sites-gta-gen9befb0ce557a2dd74f4835661fb577844{background-image:var(--engagement-image);background-position:50%;background-size:cover;width:100%;z-index:1}@media (max-width:1279px){.rockstargames-sites-gta-gen9befb0ce557a2dd74f4835661fb577844{display:none}}@media (min-width:1440px){.rockstargames-sites-gta-gen9befb0ce557a2dd74f4835661fb577844{flex:1}}@media (min-width:2560px){.rockstargames-sites-gta-gen9befb0ce557a2dd74f4835661fb577844{flex:1}}.rockstargames-sites-gta-gen9c0fc20e5997ec0175e466407b77f13ea{max-height:70vh;min-height:30vw}@media (min-width:1280px){.rockstargames-sites-gta-gen9be574bc57f2a974b9acfab41bf011e87{display:none}}.rockstargames-sites-gta-gen9ebe07d21ea2d2a2e3c9c8abd04d3eb7c{position:relative;width:100%}@media (min-width:1440px){.rockstargames-sites-gta-gen9ebe07d21ea2d2a2e3c9c8abd04d3eb7c{flex:1.5}}@media (min-width:1920px){.rockstargames-sites-gta-gen9ebe07d21ea2d2a2e3c9c8abd04d3eb7c{flex:2}}@media (min-width:2560px){.rockstargames-sites-gta-gen9ebe07d21ea2d2a2e3c9c8abd04d3eb7c{flex:1}}.rockstargames-sites-gta-gen9ebe07d21ea2d2a2e3c9c8abd04d3eb7c.rockstargames-sites-gta-gen9d8c578c46f36662f7652cc76eac7da9b{align-content:center;display:grid}@media (max-width:1279px){.rockstargames-sites-gta-gen9ebe07d21ea2d2a2e3c9c8abd04d3eb7c.rockstargames-sites-gta-gen9d8c578c46f36662f7652cc76eac7da9b{background-color:var(--black-200);border:1px solid var(--border-color)}}@media (max-width:1280px){.rockstargames-sites-gta-gen9ebe07d21ea2d2a2e3c9c8abd04d3eb7c.rockstargames-sites-gta-gen9d8c578c46f36662f7652cc76eac7da9b{background:none;border:none;min-height:50px}}.rockstargames-sites-gta-gen9ffc948e8cbe4f2137ab4e2772eb1195d{align-content:flex-end;display:flex;flex-direction:column;justify-content:space-between;top:0;transition:transform .3s ease-out,opacity .3s ease-out;width:100%}@media (min-width:1280px){.rockstargames-sites-gta-gen9ffc948e8cbe4f2137ab4e2772eb1195d{grid-gap:var(--grid-gap-sm);padding:var(--padding-md)}}@media (min-width:1440px){.rockstargames-sites-gta-gen9ffc948e8cbe4f2137ab4e2772eb1195d{padding:var(--padding-md) var(--padding-lg)}}@media (min-width:2560px){.rockstargames-sites-gta-gen9ffc948e8cbe4f2137ab4e2772eb1195d{grid-gap:var(--grid-gap-sm)}}@media (max-width:1279px){.rockstargames-sites-gta-gen9ffc948e8cbe4f2137ab4e2772eb1195d{grid-gap:var(--grid-gap-sm);transition:transform .3s ease-out,opacity .2s ease-out}.rockstargames-sites-gta-gen9ffc948e8cbe4f2137ab4e2772eb1195d.rockstargames-sites-gta-gen9c25099ec278fe51b5b3c1874dbf7f177{height:auto;position:relative}}@media (min-width:1280px){.rockstargames-sites-gta-gen9ffc948e8cbe4f2137ab4e2772eb1195d{max-height:100%;position:absolute}}@media (max-width:1279px){.rockstargames-sites-gta-gen9c25099ec278fe51b5b3c1874dbf7f177 .rockstargames-sites-gta-gen9a8602b1bf8cb8b652a23bdd9757d227e{padding:var(--padding-md) var(--padding-md) 0 var(--padding-md)}}.rockstargames-sites-gta-gen9ba550c3a58739708ed4e9ba1d5cc9284 .rockstargames-sites-gta-gen9a8602b1bf8cb8b652a23bdd9757d227e{grid-gap:var(--grid-gap-sm);display:grid}@media (max-width:1279px){.rockstargames-sites-gta-gen9ba550c3a58739708ed4e9ba1d5cc9284{padding:var(--padding-md)}}.rockstargames-sites-gta-gen9fed30d7e2c15a2e8588bfcb1947d415d .rockstargames-sites-gta-gen9a8602b1bf8cb8b652a23bdd9757d227e{grid-gap:var(--grid-gap-md);display:grid}.rockstargames-sites-gta-gen9fed30d7e2c15a2e8588bfcb1947d415d .rockstargames-sites-gta-gen9cac0eb7158ec985ab3ee6372a2bd7672{max-width:var(--max-width-sm)}@media (max-width:767px){.rockstargames-sites-gta-gen9fed30d7e2c15a2e8588bfcb1947d415d .rockstargames-sites-gta-gen9cac0eb7158ec985ab3ee6372a2bd7672{width:100%}}@media (max-width:1279px){.rockstargames-sites-gta-gen9fed30d7e2c15a2e8588bfcb1947d415d{padding:var(--padding-md)}}.rockstargames-sites-gta-gen9c25099ec278fe51b5b3c1874dbf7f177,.rockstargames-sites-gta-gen9ba550c3a58739708ed4e9ba1d5cc9284,.rockstargames-sites-gta-gen9fed30d7e2c15a2e8588bfcb1947d415d{overflow-x:hidden;overflow-y:auto;scrollbar-color:var(--scroll-thumb-color) var(--scroll-track-color);scrollbar-width:auto;z-index:0}.rockstargames-sites-gta-gen9c25099ec278fe51b5b3c1874dbf7f177::-webkit-scrollbar,.rockstargames-sites-gta-gen9ba550c3a58739708ed4e9ba1d5cc9284::-webkit-scrollbar,.rockstargames-sites-gta-gen9fed30d7e2c15a2e8588bfcb1947d415d::-webkit-scrollbar{width:8px}.rockstargames-sites-gta-gen9c25099ec278fe51b5b3c1874dbf7f177::-webkit-scrollbar-track,.rockstargames-sites-gta-gen9ba550c3a58739708ed4e9ba1d5cc9284::-webkit-scrollbar-track,.rockstargames-sites-gta-gen9fed30d7e2c15a2e8588bfcb1947d415d::-webkit-scrollbar-track{background:transparent}.rockstargames-sites-gta-gen9c25099ec278fe51b5b3c1874dbf7f177::-webkit-scrollbar-thumb,.rockstargames-sites-gta-gen9ba550c3a58739708ed4e9ba1d5cc9284::-webkit-scrollbar-thumb,.rockstargames-sites-gta-gen9fed30d7e2c15a2e8588bfcb1947d415d::-webkit-scrollbar-thumb{background-color:var(--scroll-thumb-color);border:none;border-radius:10px}.rockstargames-sites-gta-gen9c55d286bddb7bc024ba481baa3f25282{grid-gap:var(--grid-gap-md);align-items:flex-start}@media (max-width:1279px){.rockstargames-sites-gta-gen9c55d286bddb7bc024ba481baa3f25282{padding:var(--padding-md)}}.rockstargames-sites-gta-gen9a8602b1bf8cb8b652a23bdd9757d227e h3{color:var(--color-override,var(--color-h));color:var(--white-100)!important;font-family:var(--font-family-h);font-size:calc(var(--font-size-6) * var(--header-multiplier));letter-spacing:var(--letter-spacing-h);line-height:var(--line-height-md)}.rockstargames-sites-gta-gen9a8602b1bf8cb8b652a23bdd9757d227e h3,.rockstargames-sites-gta-gen9a8602b1bf8cb8b652a23bdd9757d227e p{font-weight:var(--font-weight-regular)}.rockstargames-sites-gta-gen9a8602b1bf8cb8b652a23bdd9757d227e p{color:var(--color-body);font-family:var(--font-family-body);font-size:var(--font-size-3);letter-spacing:var(--letter-spacing-body);line-height:var(--line-height-lg);max-width:var(--max-width-md)}@media (max-width:1279px){.rockstargames-sites-gta-gen9f4b714d7985247039d190db0652b8ceb{padding:0 var(--padding-md)}}.rockstargames-sites-gta-gen9de05099174e82770aeae6cd301329294{grid-gap:var(--grid-gap-sm)}.rockstargames-sites-gta-gen9a01ac7c10f297d8150a9b802bedb72af,.rockstargames-sites-gta-gen9de05099174e82770aeae6cd301329294{display:flex;flex-direction:column}.rockstargames-sites-gta-gen9a01ac7c10f297d8150a9b802bedb72af{grid-gap:var(--grid-gap-xs);align-items:flex-start}@media (max-width:1279px){.rockstargames-sites-gta-gen9a01ac7c10f297d8150a9b802bedb72af{padding:var(--padding-md)}}.rockstargames-sites-gta-gen9c2720597abb7fa1a9af5cd99d8c40a54{color:var(--color-body);color:var(--white-65);font-family:var(--font-family-body);font-size:var(--font-size-1);font-size:.625rem;font-weight:var(--font-weight-regular);letter-spacing:var(--letter-spacing-body);line-height:var(--line-height-lg);max-width:var(--max-width-md)}.rockstargames-sites-gta-gen9c2720597abb7fa1a9af5cd99d8c40a54 a,.rockstargames-sites-gta-gen9c2720597abb7fa1a9af5cd99d8c40a54 p{color:var(--color-body)!important;color:var(--white-65)!important;font-family:var(--font-family-body)!important;font-size:var(--font-size-1)!important;font-size:.625rem!important;font-weight:var(--font-weight-regular)!important;letter-spacing:var(--letter-spacing-body)!important;line-height:var(--line-height-lg)!important}.rockstargames-sites-gta-gen9c2720597abb7fa1a9af5cd99d8c40a54 .rockstargames-sites-gta-gen9f56f546a21ace49c216e9a67228efb66,.rockstargames-sites-gta-gen9c2720597abb7fa1a9af5cd99d8c40a54 a{color:var(--white-100,#fff)!important;text-decoration:underline!important}@media (min-width:768px){.rockstargames-sites-gta-gen9c2720597abb7fa1a9af5cd99d8c40a54{font-size:.556rem}}@media (min-width:1024px){.rockstargames-sites-gta-gen9c2720597abb7fa1a9af5cd99d8c40a54{font-size:.5rem}}@media (min-width:1920px){.rockstargames-sites-gta-gen9c2720597abb7fa1a9af5cd99d8c40a54{font-size:.455rem}}.rockstargames-sites-gta-gen9f11c7041488926e7c7f25fc224f98947{font-weight:var(--font-weight-bold);text-decoration:underline!important}.rockstargames-sites-gta-gen9bcac1dcfa5b088eab1e65fc68e8c85a3{background-color:var(--rockstar-gold);border-radius:var(--border-radius-xs);color:var(--black-200);display:block;font-family:var(--font-family-h);font-size:var(--font-size-4);font-size:var(--font-size-3);font-weight:var(--font-weight-regular);letter-spacing:var(--letter-spacing-h);line-height:var(--line-height-sm);padding:.4rem var(--padding-xs) .25rem;text-transform:uppercase;width:-moz-max-content;width:max-content}.rockstargames-sites-gta-gen9de0d2e1871164ef762659167bbd6529a{pointer-events:none;visibility:hidden}@media (min-width:1280px){.rockstargames-sites-gta-gen9de0d2e1871164ef762659167bbd6529a{transform:translateX(100%)}}.rockstargames-sites-gta-gen9b344d81cd5eafc49a6b22f62e6e7f76f{display:flex;opacity:1}@media (min-width:1280px){.rockstargames-sites-gta-gen9b344d81cd5eafc49a6b22f62e6e7f76f{transform:translateX(100%)}}@media (max-width:1279px){.rockstargames-sites-gta-gen9b344d81cd5eafc49a6b22f62e6e7f76f{transform:translateY(100%)}}.rockstargames-sites-gta-gen9ae620b51e3ff54bcb035a20296ee980c{transform:translateX(0);transform:translateY(0)}.rockstargames-sites-gta-gen9c5da19bfed6924ef3a54c7b6950850dd{opacity:0}@media (min-width:1280px){.rockstargames-sites-gta-gen9c5da19bfed6924ef3a54c7b6950850dd{transform:translateX(-100%)}}.rockstargames-sites-gta-gen9d18a7942f6ffe1c595090c27db4ed3cf{grid-gap:var(--grid-gap-sm);display:flex;flex-direction:column;margin-bottom:var(--spacing-sm)}.rockstargames-sites-gta-gen9d18a7942f6ffe1c595090c27db4ed3cf p{color:var(--color-body);font-family:var(--font-family-body);font-size:var(--font-size-3);font-weight:var(--font-weight-regular);letter-spacing:var(--letter-spacing-body);line-height:var(--line-height-lg)}.rockstargames-sites-gta-gen9cbddf3c3597e3da9c2cb9388de7ea8f8{grid-gap:var(--grid-gap-xxs);display:flex;flex-direction:column}.rockstargames-sites-gta-gen9cbddf3c3597e3da9c2cb9388de7ea8f8 h2,.rockstargames-sites-gta-gen9cbddf3c3597e3da9c2cb9388de7ea8f8 h3{color:var(--white-100)!important}.rockstargames-sites-gta-gen9cbddf3c3597e3da9c2cb9388de7ea8f8 a{font-weight:700;text-decoration:underline}.rockstargames-sites-gta-gen9d3d7cc42ef277206a733e4cb57942870{background-color:var(--red);-webkit-mask-image:url(${ce});mask-image:url(${ce})}.rockstargames-sites-gta-gen9d3d7cc42ef277206a733e4cb57942870,.rockstargames-sites-gta-gen9d0d2bcc799b1f77be3797b44c90a217d{height:2.5rem;margin-bottom:var(--grid-gap-sm);-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-size:contain;mask-size:contain}.rockstargames-sites-gta-gen9d0d2bcc799b1f77be3797b44c90a217d{background-color:var(--green-dark);-webkit-mask-image:url(${Ae});mask-image:url(${Ae})}.rockstargames-sites-gta-gen9e3f0330500235638f50be4a36b2e498a{align-items:center;background:var(--black-15);border:1px solid var(--white-100);border-radius:var(--border-radius-sm);color:var(--white-100)!important;cursor:pointer;display:inline-flex;font-family:var(--font-family-h);font-size:var(--font-size-3)!important;font-size:var(--font-size-4);font-weight:var(--font-weight-regular);letter-spacing:var(--letter-spacing-h);line-height:var(--line-height-sm);min-width:-moz-max-content;min-width:max-content;padding:var(--padding-sm) var(--padding-md);text-transform:uppercase;transition:background .3s ease-out,color .3s ease-out,border-color .3s ease-out}.rockstargames-sites-gta-gen9e3f0330500235638f50be4a36b2e498a.rockstargames-sites-gta-gen9b1c731df00d3a0b945adcfb95b5e026e{height:calc(100% - 2px)}.rockstargames-sites-gta-gen9e3f0330500235638f50be4a36b2e498a.rockstargames-sites-gta-gen9b1c731df00d3a0b945adcfb95b5e026e .rockstargames-sites-gta-gen9ea24dcc72092b2111a1bc9b420d3595e{display:inline-flex}.rockstargames-sites-gta-gen9e3f0330500235638f50be4a36b2e498a.rockstargames-sites-gta-gen9b1c731df00d3a0b945adcfb95b5e026e .rockstargames-sites-gta-gen9ea24dcc72092b2111a1bc9b420d3595e:after{background-color:var(--white-100);content:"";-webkit-mask-image:url(${ge});mask-image:url(${ge});-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-size:contain;mask-size:contain;order:1;transition:all .2s ease;width:.9rem}.rockstargames-sites-gta-gen9e3f0330500235638f50be4a36b2e498a:hover{background:var(--btn-hover-bg-color,var(--white-100));border-color:var(--btn-hover-border-color,var(--btn-hover-bg-color));color:var(--btn-hover-font-color,var(--black-100))!important}.rockstargames-sites-gta-gen9e3f0330500235638f50be4a36b2e498a:hover .rockstargames-sites-gta-gen9ea24dcc72092b2111a1bc9b420d3595e:after{background-color:var(--black-100)!important;transition:all .2s ease}.rockstargames-sites-gta-gen9ba3a5dd56ead99e725ea9031a0105852,.rockstargames-sites-gta-gen9ce299e602293eb072f2aa29f92ade94d{position:relative}.rockstargames-sites-gta-gen9ba3a5dd56ead99e725ea9031a0105852{display:inline-block;margin-bottom:auto;max-width:100%}.rockstargames-sites-gta-gen9ba3a5dd56ead99e725ea9031a0105852 .swiper-wrapper{display:grid;gap:var(--grid-gap-xs);grid-auto-flow:column;justify-content:left;will-change:transform}.rockstargames-sites-gta-gen9ba3a5dd56ead99e725ea9031a0105852 .swiper-slide{width:-moz-fit-content;width:fit-content}.rockstargames-sites-gta-gen9becae27bc56d3d7ce5e33da63b298355{height:100%;position:absolute;top:0;transition:opacity .25s ease-in-out;width:4rem}.rockstargames-sites-gta-gen9becae27bc56d3d7ce5e33da63b298355:focus:after,.rockstargames-sites-gta-gen9becae27bc56d3d7ce5e33da63b298355:hover:after{filter:unset}.rockstargames-sites-gta-gen9becae27bc56d3d7ce5e33da63b298355[data-hidden=true],.rockstargames-sites-gta-gen9becae27bc56d3d7ce5e33da63b298355[disabled]{opacity:0;pointer-events:none}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b{background:var(--black-65,rgba(0,0,0,.65));background:var(--black-200);background:linear-gradient(90deg,var(--engagement-background) 0,transparent 100%);border:none;border-radius:50%;border-radius:0;cursor:pointer;height:3rem;margin-left:calc(var(--padding-md) * -3);padding:0;position:relative;transform:translateX(100%);transition:background .3s ease-in-out;transition:opacity .25s ease-in-out;width:3rem;width:4rem}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b,.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:after{height:100%;left:0;position:absolute;top:0}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:after{background:url(${le}) no-repeat 50%/1rem;content:"";display:block;transition:.3s ease-in-out;width:100%}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:focus{border:none;outline:none}@media (pointer:coarse){.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:active{background:var(--white-100,#fff)}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:active:after{filter:invert(1)}}@media not ((pointer:coarse)){.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:focus,.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:hover{background:var(--white-100,#fff)}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:focus:after,.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:hover:after{filter:invert(1)}}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:after{background-size:1.5rem}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:focus:after,.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:hover:after{filter:unset}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b[data-hidden=true],.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b[disabled]{opacity:0;pointer-events:none}.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:focus,.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b:hover{background:linear-gradient(90deg,var(--engagement-background) 0,transparent 100%)}@media (min-width:1440px){.rockstargames-sites-gta-gen9c2a3afc2e5783cecd9f1096c3cfdf61b{margin-left:calc(var(--padding-lg) * -2)}}.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf{background:var(--black-65,rgba(0,0,0,.65));background:var(--black-200);background:linear-gradient(270deg,var(--engagement-background) 0,transparent 100%);border:none;border-radius:50%;border-radius:0;cursor:pointer;height:3rem;height:100%;padding:0;position:relative;position:absolute;right:calc(var(--padding-md) * -3);top:0;transform:translateX(-100%);transition:background .3s ease-in-out;transition:opacity .25s ease-in-out;width:3rem;width:4rem}.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:after{background:url(${me}) no-repeat 50%/1rem;content:"";display:block;height:100%;left:0;position:absolute;top:0;transition:.3s ease-in-out;width:100%}.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:focus{border:none;outline:none}@media (pointer:coarse){.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:active{background:var(--white-100,#fff)}.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:active:after{filter:invert(1)}}@media not ((pointer:coarse)){.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:focus,.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:hover{background:var(--white-100,#fff)}.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:focus:after,.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:hover:after{filter:invert(1)}}.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:after{background-size:1.5rem}.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:focus:after,.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:hover:after{filter:unset}.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf[data-hidden=true],.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf[disabled]{opacity:0;pointer-events:none}.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:focus,.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf:hover{background:linear-gradient(270deg,var(--engagement-background) 0,transparent 100%)}@media (min-width:1440px){.rockstargames-sites-gta-gen9ee20a3331aa9cb5857d0c4d7a18b4aaf{right:calc(var(--padding-lg) * -2)}}.rockstargames-sites-gta-gen9c596ce72795db40bd64a752fcff020f2{left:50%;position:absolute;top:50%;transform:translate(-50%,-50%)}.rockstargames-sites-gta-gen9c999e2136e0f6804222f8e8c2e623865{height:112px}.rockstargames-sites-gta-gen9cec42ef44a23c75f81c06af15a1b52ba{aspect-ratio:1;width:var(--foundry-global-spacing-dimensions-500)}.rockstargames-sites-gta-gen9ecabab4d06fea8b01b7aaef8c0af779b{object-fit:cover;width:100%}`, "", {
        version: 3,
        ...
        names: [],
        mappings: "AA2QA,8DAKI,kBAAA,CAGA,0BAAA,CAFA,WAAA,CACA,mBAAA,CAIA,sBAAA,CAQA,cAAA,CAlBA,YAAA,CAYA,mCAAA,CACA,cAAA,CACA,iBAAA,CACA,eAAA,CAZA,sBAAA,CAaA,0BAAA,CAfA,sBAAA,CACA,2CAAA,CASA,iBAAA,CAQA,2CC9OJ,CD0NA,kEAwBQ,2BAAA,CADA,8BAAA,CAGA,iCAAA,CADA,0BC7OR,CDiPI,wIAEI,gCAAA,CACA,YC/OR,CDkPI,2HAEI,2BAAA,CADA,sBC/OR,CD8OI,+HAKQ,eChPZ,CA5CA,8DD6II,sCAAA,CACA,sBAAA,CALA,aAAA,CAJA,8GAAA,CAWA,mJAAA,CAZA,UChFJ,CAhDA,8DC1BA,2BAAA,CACA,gCAAA,CAGA,yBAAA,CACA,sBAAA,CAGA,uBAAA,CACA,oBAAA,CAGA,kBAAA,CACA,oBAAA,CACA,oBAAA,CA