try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "f84dfd0a-e93a-4b88-a5d3-7f5c6feed997", e._sentryDebugIdIdentifier = "sentry-dbid-f84dfd0a-e93a-4b88-a5d3-7f5c6feed997")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [6930], {
    86930(e, t, s) {
      ...
      const i = ({
        ...
        const l = (0, o.useImageParser)(t ?? {}),
          c = (0, o.useGetCdnSource)(e?.mobile ?? null),
          _ = (0, o.useGetCdnSource)(e?.desktop ?? c),
          u = l?.src?.mobile,
          m = l?.src?.desktop ?? u;
        return (0, a.jsx)("div", {
          className: (0, n.default)("rockstargames-sites-gta-gen9dd3eed68318843fe25f147a11901017e", r ? "rockstargames-sites-gta-gen9d1ac49cbb3da8269c13f1ccc1b515fb4" : ""),
          style: {
      ...
      const g = (0, m.defineMessages)({
        ...
        f = ({
          ...
          const {
            isMobile: h
          } = (0, u.useWindowResize)(), [b, p] = (0, r.useState)(!1), x = (0, o.useGetCdnSource)(c?.imageLeft?.mobile ?? null), k = (0, o.useGetCdnSource)(c?.imageLeft?.desktop ?? x), v = (0, o.useGetCdnSource)(c?.imageRight?.mobile ?? null), j = (0, o.useGetCdnSource)(c?.imageRight?.desktop ?? v), y = (0, o.useGetCdnSource)(f?.imageLeft?.mobile ?? null), N = (0, o.useGetCdnSource)(f?.imageLeft?.desktop ?? y), M = (0, o.useGetCdnSource)(f?.imageRight?.mobile ?? null), S = (0, o.useGetCdnSource)(f?.imageRight?.desktop ?? M), C = (0, r.useCallback)((e, t) => {
            const s = _(e, new Date);
            return s <= 0 ? (p(!0), {
              days: "00",
              hours: "00",
              minutes: "00",
          ...
          return (0, r.useEffect)(() => {
            ...
            className: (0, n.default)(w.countdownContainer, t),
            style: {
              ...
              "--counter-background-color": d ? l : "none",
            ...
            children: ["active" === t && (0, a.jsxs)(a.Fragment, {
              children: [(0, a.jsx)("h1", {
                ...
                children: (0, a.jsx)(m.FormattedMessage, {
                  ...g.countdown_timer_header_title
                })
              }), "active" === t && b && (0, a.jsx)("div", {
                "data-testid": "pendingResults",
                className: w.pendingResults,
                children: (0, a.jsx)("p", {
                  children: (0, a.jsx)(m.FormattedMessage, {
                    ...g.countdown_timer_header_pending_title
                  })
                })
              }), (0, a.jsxs)("ul", {
                "data-testid": "countdownTimer",
                className: (0, n.default)(w.countDownTimer),
                children: [(0, a.jsx)("li", {
                  children: (0, a.jsxs)("div", {
                    className: w.countdownBlock,
                    children: [(0, a.jsx)("span", {
                      className: (0, n.default)(w.counter, s?.textGlow ? w.textGlow : ""),
                      children: T.days
                    }), (0, a.jsx)("div", {
                      className: w.countdownLabel,
                      children: h ? (0, a.jsx)(m.FormattedMessage, {
                        ...g.countdown_timer_days_title_short
                      }) : (0, a.jsx)(m.FormattedMessage, {
                        ...g.countdown_timer_days_title_long
                      })
                    })]
                  })
                }), (0, a.jsx)("li", {
                  children: (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsx)("span", {
                      ...
                      className: w.countdownLabel,
                      children: h ? (0, a.jsx)(m.FormattedMessage, {
                        ...g.countdown_timer_hours_title_short
                      }) : (0, a.jsx)(m.FormattedMessage, {
                        ...g.countdown_timer_hours_title_long
                      })
                    })]
                  })
                }), (0, a.jsx)("li", {
                  children: (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsx)("span", {
                      ...
                      className: w.countdownLabel,
                      children: h ? (0, a.jsx)(m.FormattedMessage, {
                        ...g.countdown_timer_minutes_title_short
                      }) : (0, a.jsx)(m.FormattedMessage, {
                        ...g.countdown_timer_minutes_title_long
                      })
                    })]
                  })
                }), i && (0, a.jsx)("li", {
                  children: (0, a.jsxs)("div", {
                    className: (0, n.default)(w.countdownBlock, w.secondsCounter),
                    children: [(0, a.jsx)("span", {
                      className: (0, n.default)(w.counter, s?.textGlow ? w.textGlow : ""),
                      children: T.seconds
                    }), (0, a.jsx)("div", {
                      className: w.countdownLabel,
                      children: h ? (0, a.jsx)(m.FormattedMessage, {
                        ...g.countdown_timer_seconds_title_short
                      }) : (0, a.jsx)(m.FormattedMessage, {
                        ...g.countdown_timer_seconds_title_long
                      })
                    })]
                  })
                })]
              ...
              children: [k && (0, a.jsx)("img", {
                ...
                children: (0, a.jsx)(m.FormattedMessage, {
                  ...g.countdown_timer_success_title
                })
              }), j && (0, a.jsx)("img", {
                className: w.accentImage,
                src: j,
              ...
              children: [N && (0, a.jsx)("img", {
                ...
                children: (0, a.jsx)(m.FormattedMessage, {
                  ...g.countdown_timer_failure_title
                })
              }), S && (0, a.jsx)("img", {
                className: w.accentImage,
                src: S,
      ...
      const p = ({
        ...
        y = ({
          ...
          if ((0, b.T0)(d), (0, r.useEffect)(() => {
              u && d.current && l.current && (d.current.scrollLeft = l.current.getBoundingClientRect().left - window.innerWidth / 2, d.current.addEventListener("scroll", e => {
                const t = e.target;
      ...
      const I = ({
        ...
        R = ({
          ...
          const {
            isMobile: s
          } = (0, u.useWindowResize)(), o = (0, m.useIntl)(), i = (0, r.useRef)(null), d = (0, r.useRef)(null), l = (0, r.useRef)(null), c = (0, r.useRef)(), [_, g] = (0, r.useState)(!1), [w, f] = (0, r.useState)(), [h, b] = (0, r.useState)(!1), [p, x] = (0, r.useState)(!1), {
            track: k
          } = (0, S.useGtmTrack)(), v = c?.current?.swiper, j = e?.heading, y = e?.cards;
          (0, r.useEffect)(() => {
            if (v && "number" == typeof v?.params?.slidesPerView) {
              const e = v.slides?.length;
              g(e > v.params.slidesPerView)
            }
          }, [y, v?.params.slidesPerView]), (0, r.useEffect)(() => {
            f({
              nextEl: d.current,
              prevEl: i.current
            })
                ...
                children: [(0, a.jsxs)("div", {
                  ...
                  children: [(0, a.jsx)("h1", {
                    ...
                    children: [(0, a.jsx)("button", {
                      "data-testid": "prevBtn",
                      ref: i,
                      className: (0, n.default)(G.prevBtn, h ? G.disabled : ""),
                      onClick: T,
                      "aria-label": o.formatMessage(C.rewards_carousel_previous),
                      type: "button",
                      disabled: h
                    }), (0, a.jsx)("button", {
                      "data-testid": "nextBtn",
                      ref: d,
                      className: (0, n.default)(G.nextBtn, p ? G.disabled : ""),
                      onClick: R,
                      onKeyDown: L,
                      "aria-label": o.formatMessage(C.rewards_carousel_next),
                      type: "button",
                      disabled: p
                    })]
                  })]
        ...
        P = (0, m.withIntl)(({
          ...
          className: L.communityChallenges,
          children: (0, a.jsxs)("div", {
            className: L.wrapper,
            children: [e && (0, a.jsx)(i, {
              ...
              className: L.content,
              children: [t?.timer && (0, a.jsx)(f, {
                ...t.timer
              }), n && (0, a.jsx)(y, {
                ...n
              }), s && (0, a.jsx)("section", {
                className: L.rewardsSection,
                children: (0, a.jsx)(R, {
                  ...s
                })
              })]
