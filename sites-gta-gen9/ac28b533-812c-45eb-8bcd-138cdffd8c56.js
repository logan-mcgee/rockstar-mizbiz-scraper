try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "ac28b533-812c-45eb-8bcd-138cdffd8c56", t._sentryDebugIdIdentifier = "sentry-dbid-ac28b533-812c-45eb-8bcd-138cdffd8c56")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [930, 9016], {
      ...
      const s = (0, n.setContextItem)({
        ...
        d = ({
          ...
          const {
            ...
            data: a,
            loading: i
          } = (0, _.useRockstarUser)(), [c, d] = (0, o.useState)(!1), [A, l] = (0, o.useState)(!1), [p, h] = (0, o.useState)(), [u, f] = (0, o.useState)(), [w, g] = (0, o.useState)(), [m, b] = (0, o.useState)(), [v, y] = (0, o.useState)({}), k = a?.linkedAccounts?.some((t => "twitch" === t?.onlineService)) ?? !1, x = (0, n.useRockstarTokenPing)(), j = a?.characters?.gtao || [], T = new Set(["xbl", "ps", "np"]), D = new Set(j.map((t => (0, n.findPlatform)(t.platform))).flatMap((t => [t?.onlineService, t?.aliasOnlineService].filter(Boolean))).filter((t => t && T.has(t)))), P = {
            activeStreams: p,
            canClaim: w,
            characters: j,
      ...
      const y = (0, o.forwardRef)((function({
        ...
        C = () => {
          const t = (0, i.useIntl)(),
            ...
            p = (0, o.useMemo)((() => a?.linkedAccounts?.find((t => "twitch" === t?.onlineService))), [a?.linkedAccounts]);
          if (!a) return null;
          const {
            isTwitchLinked: h,
            trackingParent: u
      ...
      const B = ({
        ...
        Y = () => {
          const t = (0, i.useIntl)(),
            ...
            a = A(),
            c = window.location.pathname,
            s = (0, n.useScAuthTpaLink)("np", c).href,
            d = (0, n.useScAuthTpaLink)("xbl", c).href,
            [l, p] = (0, o.useState)(!1),
            [h, u] = (0, o.useState)(!1),
            {
              trackingParent: w
            ...
            children: [(0, r.jsxs)(E, {
              ...
              children: [(0, r.jsx)(G, {
                children: (0, r.jsx)(m.Button, {
                  ...
                  children: t.formatMessage(D.twitch_drops_gaming_state_action_card_unlinked_title)
                })
              }), (0, r.jsxs)(O, {
                children: [(0, r.jsx)(N, {}), (0, r.jsxs)(I, {
                  ...
                  children: [(0, r.jsx)(L, {
                    "aria-label": t.formatMessage(D.twitch_drops_platform_dialog_close_btn_label),
                    onClick: y,
                    ref: g,
                    children: (0, r.jsx)(m.IconButton, {
                      ...
                      appearance: "ghost",
                      icon: "X",
                      label: t.formatMessage(D.twitch_drops_platform_dialog_close_btn_label),
                      className: Z.closeButton
                    })
                  }), (0, r.jsx)(B, {
                    children: (0, r.jsx)(S, {
                      children: t.formatMessage(D.twitch_drops_platform_options_title)
                    })
                  }), (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsxs)("div", {
                      ...
                      children: [(0, r.jsx)("h3", {
                        ...
                        children: t.formatMessage(D.twitch_drops_platform_options_description)
                      })]
                    }), (0, r.jsx)("div", {
                      className: Z.wrapper,
                      children: (0, r.jsx)("div", {
                        className: Z.ctas,
                        children: b.map(((t, e) => "pc" === t.type ? (0, r.jsx)(m.Button, {
                          appearance: "primary",
                          size: "MD",
                  ...
                  children: [(0, r.jsx)(L, {
                    ...
                    children: [(0, r.jsxs)("div", {
                      ...
                      children: [(0, r.jsx)(v.TriangleAlert, {
                        className: Z.alert,
                        label: t.formatMessage(D.twitch_drops_dialog_no_character_found_title),
                        size: "XL",
                        color: "var(--foundry-alias-color-icon-warning)"
                      }), (0, r.jsx)("h3", {
                        className: Z.title,
                        children: t.formatMessage(D.twitch_drops_dialog_no_character_found_title)
                      }), (0, r.jsx)("p", {
                        className: Z.description,
                        children: t.formatMessage(D.twitch_drops_dialog_no_character_found_description)
                      })]
                    }), (0, r.jsx)(L, {
                      "aria-label": t.formatMessage(D.twitch_drops_platform_dialog_close_btn_label),
                      onClick: y,
                      children: (0, r.jsx)(m.Button, {
                        ...
                        children: t.formatMessage(D.twitch_drops_platform_dialog_ok_btn_label)
                      })
                    })]
                  })]
                })]
        ...
        H = () => {
          ...
          }), [d, u?.length, h?.length]), (0, o.useEffect)((() => {
            s && p?.length > 0 && e({
              event: "alert_update",
      ...
      const V = "rockstargames-sites-gta-gen9ea4642de554a3d7eb8e92a6c16611e3c",
        ...
        et = () => {
          ...
          const {
            ...
            isTwitchLinked: d,
            linkedAccounts: l
          } = e, p = l?.length > 0, h = (n?.length ?? 0) > 0, u = o?.length > 0, f = u && o.some((t => "pc" === t.platform || "pcalt" === t.platform)), w = s ? !s || !d || _ || !h && !f || _ || u && !f ? s && p ? c ? "canClaim" : "linked" : "general" : "createCharacters" : "loggedOut", g = "createCharacters" === w, m = ["loggedOut", "linked", "general"].includes(w);
          return (0, r.jsxs)("div", {
            className: $.header,
    ...
    78322: (t, e, a) => {
      ...
      var L = "function" == typeof SuppressedError ? SuppressedError : function(t, e, a) {
        var r = new Error(a);
