try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "c0a7de01-49eb-4204-859f-3e9b25c5090a", t._sentryDebugIdIdentifier = "sentry-dbid-c0a7de01-49eb-4204-859f-3e9b25c5090a")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    71635: (t, e, a) => {
      ...
      const s = (0, _.setContextItem)({
        ...
        d = ({
          ...
          const {
            ...
            data: a,
            loading: i
          } = (0, n.useRockstarUser)(), [c, d] = (0, o.useState)(!1), [A, l] = (0, o.useState)(!1), [h, p] = (0, o.useState)(), [g, u] = (0, o.useState)(), [w, f] = (0, o.useState)(), [m, b] = (0, o.useState)(), [v, k] = (0, o.useState)({}), x = a?.linkedAccounts?.some(t => "twitch" === t?.onlineService) ?? !1, y = (0, _.useRockstarTokenPing)(), j = a?.characters?.gtao || [], T = new Set(["xbl", "ps", "np"]), D = new Set(j.map(t => (0, _.findPlatform)(t.platform)).flatMap(t => [t?.onlineService, t?.aliasOnlineService].filter(Boolean)).filter(t => t && T.has(t))), C = {
            activeStreams: h,
            canClaim: w,
            characters: j,
          ...
          return (0, o.useEffect)(() => {
            ...
            void 0 !== x && void 0 !== g && f(x && g || x && a?.characters?.gtao && a?.characters?.gtao.length > 0 || x && C.filteredLinkedAccounts && C.filteredLinkedAccounts.length > 0)
          }, [w, g, x]), A ? null : (0, r.jsx)(s.Provider, {
            value: C,
            children: t
          })
        },
      ...
      const Z = ({
                    ...
                    children: [(0, r.jsxs)("div", {
                      ...
                      children: (0, r.jsx)("div", {
                        ...
                        children: f.map((e, i) => (0, r.jsx)(m.Button, {
                          appearance: "primary",
                          size: "MD",
                          className: u()(S.link, S[e.platform.name]),
                          onPress: () => (async e => {
                            if (a({
        ...
        H = () => {
          const t = (0, i.useIntl)(),
            ...
            [u, w] = (0, o.useState)("default"),
            f = `${a}settings/linkedaccounts`,
            m = p?.length > 0 || g?.length > 0,
            b = () => {
              e({
          ...
          return (0, o.useEffect)(() => {
            w(d && 0 === g?.length ? 0 === h?.length ? "disabled" : "alert" : 0 === g?.length ? 0 === p?.length ? "disabled" : "alert" : h?.length > 0 && g?.length > 0 ? "success" : "disabled")
          }, [d, g?.length, p?.length]), (0, o.useEffect)(() => {
            s && h?.length > 0 && e({
              event: "alert_update",
      ...
      const Q = "rockstargames-sites-gta-gen9ea4642de554a3d7eb8e92a6c16611e3c",
        q = () => {
          ...
          (0, o.useEffect)(() => {
            0 === w.length && p.length > 0 && p.forEach(() => {
              c({
                event: "alert_error",
          ...
          return w.length || p?.length ? (0, r.jsxs)("div", {
                  ...
                  children: [(0, r.jsx)(V.Avatar, {
                    ...
                    children: [(0, r.jsxs)(V.TopRow, {
                      children: [(0, r.jsx)(V.PlatformTag, {
                        tagSize: V.PlatformTagSizes.large,
                        platform: t.platform
                      }), !u[t.platform] && (0, r.jsxs)(m.Tooltip.Root, {
                        children: [(0, r.jsx)(m.Tooltip.Trigger, {
                          children: (0, r.jsx)(v.TriangleAlert, {
                            label: a.formatMessage(D.twitch_drops_character_card_icon_label),
                            color: "#CE8903"
                    ...
                    }), u[t.platform] ? (0, r.jsx)(V.RankContent, {
            ...
            children: (0, r.jsx)("div", {
              ...
              children: _ ? (0, r.jsxs)(r.Fragment, {
                children: [(0, r.jsx)(m.Button, {
                  ...
                  appearance: "primary",
                  allCaps: !0,
                  className: u()(F, "rockstargames-sites-gta-gen9c1d8d9cbb5bf81284c34f752f3b6d561"),
                  asChild: !0,
                  children: (0, r.jsx)("a", {
        ...
        et = () => {
          ...
          const {
            ...
            isTwitchLinked: d,
            linkedAccounts: l
          } = e, h = l?.length > 0, p = (_?.length ?? 0) > 0, g = o?.length > 0, u = g && o.some(t => "pc" === t.platform || "pcalt" === t.platform), w = s ? !s || !d || n || !p && !u || n || g && !u ? s && h ? c ? "canClaim" : "linked" : "general" : "createCharacters" : "loggedOut", f = "createCharacters" === w, m = ["loggedOut", "linked", "general"].includes(w);
          return (0, r.jsxs)("div", {
            className: $.header,
        ...
        rt = ({
          ...
          const e = (0, l.useNavigate)(),
            ...
            y = !0 === f ? !w && null != _ && null != m && null != g && null != u && null != s : !1 === f && !w && null != _ && null != m,
            {
              ref: j
            } = (0, h.useInView)({
              threshold: .6,
