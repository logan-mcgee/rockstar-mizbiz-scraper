      ...
      const k = {
        ...
        y = () => {
          const {
            ...
            navOpen: n,
            setNavOpen: i
          } = (0, r.useRockstarUserState)(), s = (0, g._)(), d = (0, g._)(), l = (0, g._)();
          return (0, t.useEffect)((() => {
            !0 === n && !0 === e && a(!1)
          }), [n]), (0, t.useEffect)((() => {
            s.start(e ? k.open : k.closed), d.start(e ? x.open : x.closed), l.start(e ? N.open : N.closed)
          }), [e]), (0, f.jsxs)("svg", {
        ...
        _ = (0, d.withTranslations)((e => {
          ...
          const {
            ...
            userShouldSeeMore: j
          } = (0, l.useScroll)(), [_, T] = (0, t.useState)(0), M = () => _ > 1023;
          return (0, t.useEffect)((() => {
            c || N && j || v(j)
          }), [N, c, j]), (0, t.useEffect)((() => {
            h(!1)
            ...
            className: [S.gen9Header, d ? S.headerHidden : ""].join(" "),
            ref: g,
            children: (0, f.jsxs)("div", {
              ...
              children: [(0, f.jsxs)("div", {
                ...
                children: [(0, f.jsx)(s.A, {
                  className: S.rockstarLogo,
                  to: "../"
                }), (0, f.jsx)("div", {
                  className: S.logoDivider
                }), M() && (0, f.jsx)("div", {
