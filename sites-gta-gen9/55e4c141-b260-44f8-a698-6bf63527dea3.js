try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "55e4c141-b260-44f8-a698-6bf63527dea3", e._sentryDebugIdIdentifier = "sentry-dbid-55e4c141-b260-44f8-a698-6bf63527dea3")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    19913(e, a, t) {
      ...
      const m = ({
        ...
        g = ({
          ...
          const {
            track: T
          } = (0, n.useGtmTrack)(), A = (0, i.useDataLayer)(), M = g ?? e, L = (0, i.findPlatform)(v)?.friendlyName, R = (0, r.useMemo)(() => {
          ...
          return (0, s.jsx)(o.Link, {
            ...
            className: (0, l.default)(d.cta, "platform" === f && v ? d[v] : "", x && d[x], y ? d.disabled : "", C),
            style: t,
            "data-variant": f,
            "data-size": p,
            onClick: E,
      ...
      const g = {
        ...
        b = ({
          ...
          const y = (0, d.useRockstarTokenPing)(),
            ...
            [O, z] = (0, r.useState)(0),
            D = () => {
              I.current?.blur(), T(!0), C(!1), setTimeout(() => {
                E.current?.focus()
              }, 30)
            },
            B = (0, r.useCallback)(() => {
          ...
          (0, r.useLayoutEffect)(() => {
            S && P.current ? z(P.current.scrollHeight) : z(0)
          }, [S]), (0, r.useEffect)(() => {
            if (!S) return;
            const e = e => {
              const a = e.target;
              R.current && !R.current.contains(a) && document.contains(a) && D()
            };
            ...
            if (R?.current) {
              const e = getComputedStyle(R.current).getPropertyValue("--expandingPlatformButton-expandDuration"),
