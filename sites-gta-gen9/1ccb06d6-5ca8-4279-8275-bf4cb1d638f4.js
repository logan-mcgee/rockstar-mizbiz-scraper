try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    n = (new e.Error).stack;
  n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "1ccb06d6-5ca8-4279-8275-bf4cb1d638f4", e._sentryDebugIdIdentifier = "sentry-dbid-1ccb06d6-5ca8-4279-8275-bf4cb1d638f4")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    74009: (e, n, a) => {
      ...
      function k(e) {
        for (var n = 1; n < arguments.length; n++) {
          ...
          n % 2 ? T(Object(a), !0).forEach(function(n) {
            var t, s, r;
            t = e, s = n, r = a[n], (s = v(s)) in t ? Object.defineProperty(t, s, {
              value: r,
              enumerable: !0,
              configurable: !0,
              writable: !0
      ...
      var w, j, A = (e, n, a) => {
        ...
        y = (w = {
          ...
          for (var t in a) {
            var s, r = null !== (s = a[t]) && void 0 !== s ? s : w.defaultVariants[t];
            if (null != r) {
              var i = r;
              "boolean" == typeof i && (i = !0 === i ? "true" : "false");
              var o = w.variantClassNames[t][i];
              o && (n += " " + o)
            }
          }
      ...
      const U = ({
        ...
        className: h()(O, "_1ow0arsc _1ow0arsb", "onScreen" === r ? P : "", "hidden" === r ? q : "", "visible" === r ? F : ""),
      ...
      const X = "https://media-rockstargames-com.akamaized.net/mfe6/prod/__common/img/cb04fb2acd10f43aa501729b4d7d26a8.jpg",
        ...
        ee = (0, u.withIntl)(({
          ...
          const w = {
            ...
            [j] = (0, r.useSearchParams)(),
            {
              data: A,
              loggedIn: S
            } = (0, c.useRockstarUser)(),
            y = (0, l.useRockstarTokenPing)(),
            N = `https://${Z}.rockstargames.com/settings/linkedaccounts`,
            G = (0, u.useIntl)(),
            {
              track: E
            } = (0, c.useGtmTrack)(),
            ...
            [Q, ee] = (0, s.useState)("hidden"),
            [ne, ae] = (0, s.useState)("hidden"),
            [te, se] = (0, s.useState)("hidden"),
            [re, ie] = (0, s.useState)(!1),
            [oe, le] = (0, s.useState)(K.landing),
            [ce, de] = (0, s.useState)(w.introScreen.image.sources.mobile || X),
            ...
            _e = e => {
              e === K.landing ? (le(K.landing), ee("onScreen"), W("hidden"), se("hidden"), ae("hidden")) : e === K.success ? (le(K.success), ee("offScreen"), W("visible"), setTimeout(() => {
                ee("hidden"), se("hidden")
              }, 300), setTimeout(() => {
                W("onScreen")
              }, 100)) : e === K.error ? (le(K.error), ee("offScreen"), se("visible"), setTimeout(() => {
                ee("hidden")
              }, 300), setTimeout(() => {
                se("onScreen")
              }, 100)) : e === K.unlinked && (le(K.unlinked), ee("offScreen"), ae("visible"), setTimeout(() => {
                ee("hidden"), se("hidden")
              }, 300), setTimeout(() => {
                ae("onScreen")
              }, 100))
          ...
          return (0, s.useEffect)(() => {
            ...
            const e = () => {
                window.innerWidth >= 2560 && "newswire" !== n ? de(w.introScreen.image.sources.mobile || X) : de(w.introScreen.image.sources.desktop || X)
              },
              a = () => {
                window.innerWidth <= L && !F ? (D(!0), _e(oe)) : window.innerWidth > L && F && D(!1), e()
              };
            return D(window.innerWidth <= L), e(), window.addEventListener("resize", a), () => {
              window.removeEventListener("resize", a)
            }
          }, [oe, F]), (0, s.useEffect)(() => {
            const e = A?.characters?.gtao;
            M(e || [])
          }, [A?.characters?.gtao]), (0, s.useEffect)(() => {
            ...
            "boolean" == typeof S ? S ? V(!0) : (V(!1), ee("onScreen")) : V(!0)
          }, [S]), (0, s.useEffect)(() => {
            "boolean" == typeof P && A?.accountSynced && V(!1)
          }, [P, A?.accountSynced, V]), (0, s.useEffect)(() => {
            B || (async () => {
              R.length > 0 && P ? _e(K.success) : _e(P ? K.unlinked : K.landing)
            })()
          }, [B]), (0, s.useEffect)(() => {
            if (C && !re) {
              if (void 0 === S) return;
            ...
            children: (0, t.jsx)("div", {
              ...
              children: (0, t.jsxs)(i.motion.div, {
                ...
                children: [(0, t.jsx)("div", {
                  ...
                  className: h()("_1ow0ars4", B ? "loader" : ""),
                  ref: z,
                  children: B ? (0, t.jsx)("div", {
                    ...
                    children: [oe === K.landing && (0, t.jsx)(U, {
                      content: w,
                      loggedIn: S,
                      addClaim: async () => {
                        const a = {
                      ...
                      linkAccountBtn: G.formatMessage(m.engagement_link_account)
                    }), oe === K.unlinked && (0, t.jsx)(J, {
                      content: w,
                      unlinkedSlide: ne,
                      returnUrl: ue,
                      giftId: e
                    }), oe === K.error && (0, t.jsx)(Y, {
                      errorSlide: te,
                      content: w
                    })]
                  })
