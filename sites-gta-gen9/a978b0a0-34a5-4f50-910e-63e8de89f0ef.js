! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "a978b0a0-34a5-4f50-910e-63e8de89f0ef", e._sentryDebugIdIdentifier = "sentry-dbid-a978b0a0-34a5-4f50-910e-63e8de89f0ef")
  } catch (e) {}
}();
    ...
    76725: (e, a, s) => {
      ...
      const I = "ProgressCounter:currentValue",
        ...
        F = e => {
          ...
          (0, r.useEffect)((() => {
            B.forEach((e => {
              n > e.min && n < e.max && (x(e.show), T(e.peek))
            }))
          }), [n]), (0, r.useEffect)((() => {
            E && !_ ? f(!1) : E && _ && S(!1)
          }), [_]), (0, r.useEffect)((() => {
              ...
              children: [(0, b.jsxs)(h.motion.div, {
                ...
                children: [(0, b.jsx)(ae, {
                  ...
                  children: D.map(((e, a) => (0, b.jsx)(V, {
                    ...
                    setHoveredAwardId: Y,
                    isShowTooltip: a === X,
                    classes: [L.award, a >= P + I ? L.fadeIn : "", a >= P && a < P + I ? L.peek : ""].join(" ")
                  }, e.imageName)))
      ...
      const ne = e => r.createElement("svg", _e({
          ...
          d: "M6.161 9.614c.384.001.768-.024 1.148-.075.339-.04.668-.139.972-.29.276-.141.508-.352.671-.61.17-.261.254-.605.254-1.03 0-.424-.085-.768-.254-1.03a1.724 1.724 0 0 0-.671-.609 2.997 2.997 0 0 0-.972-.29 8.558 8.558 0 0 0-1.148-.075H3.467v4.01H6.16Zm.95-6.295c.985 0 1.824.122 2.517.365.693.244 1.256.565 1.69.965.42.38.745.848.949 1.368a4.377 4.377 0 0 1 0 3.176 3.63 3.63 0 0 1-.95 1.377c-.434.4-.998.721-1.69.965-.691.244-1.53.365-2.516.365H3.467v4.797H0V3.319h7.11ZM24.084 6.888a3.187 3.187 0 0 0-.773-.74 3.795 3.795 0 0 0-1.05-.496 4.197 4.197 0 0 0-1.223-.18c-.781 0-1.444.128-1.988.384a3.6 3.6 0 0 0-1.325 1.03c-.343.44-.594.94-.74 1.471a6.279 6.279 0 0 0-.233 1.706c0 .554.078 1.106.233 1.64a4.12 4.12 0 0 0 .738 1.433c.353.435.807.785 1.325 1.02.545.257 1.208.385 1.988.385 1.06 0 1.887-.275 2.485-.825.598-.55.962-1.274 1.093-2.173h3.358a5.988 5.988 0 0 1-.689 2.27 5.555 5.555 0 0 1-1.457 1.724 6.483 6.483 0 0 1-2.12 1.087 9.014 9.014 0 0 1-2.672.376c-1.209 0-2.295-.179-3.258-.535-.963-.356-1.776-.846-2.44-1.47a6.37 6.37 0 0 1-1.523-2.2 6.984 6.984 0 0 1-.527-2.732 7.222 7.222 0 0 1 .53-2.78 6.523 6.523 0 0 1 1.523-2.24c.665-.637 1.478-1.137 2.44-1.5S19.827 3 21.038 3a9.271 9.271 0 0 1 2.462.319c.74.198 1.44.511 2.075.927.605.4 1.12.913 1.513 1.509.406.625.663 1.329.75 2.061h-3.357a2.188 2.188 0 0 0-.398-.928Z"
      ...
      const he = {
        ...
        Re = e => {
          ...
          const [u, f] = (0, r.useState)(window.innerWidth >= 1280), [R, E] = (0, r.useState)(1), [S, v] = (0, r.useState)("auto"), {
            ...
            setBodyIsLocked: w
          } = (0, l.useBodyScrollable)("Rewards"), [A, P] = (0, r.useState)(!1), x = (0, r.useRef)(), I = u ? pe.RC : "div", T = u ? pe.qr : "li", C = (0, r.useRef)(null), N = (0, r.useRef)(null), O = n.some((e => e.isCompleted && e?.numClaimable > 0)), G = (0, i.useIntl)(), W = (0, r.useMemo)((() => {
            const e = [];
        ...
        Ee = e => {
          ...
          const {
            ...
            track: G
          } = (0, d.useGtmTrack)(), W = p?.[g]?.numCompleted ?? 0, y = p?.[g]?.challenges?.length ?? 0, [z, D] = (0, r.useState)(null), [V, L] = (0, r.useState)(!1), [B, M] = (0, r.useState)("auto"), [H, U] = (0, r.useState)("auto"), F = (0, r.useRef)(null), X = (0, r.useRef)(null);
          (0, r.useEffect)((() => {
            P && !f && (G({
              event: "page_section_impression",
              element_placement: "progress & rewards"
      ...
      const Ie = e => r.createElement("svg", xe({
        xmlns: "http://www.w3.org/2000/svg",
        width: 24,
        height: 24,
        fill: "none"
      ...
      const Ne = e => r.createElement("svg", Ce({
        ...
        Ge = e => {
          ...
          return (0, b.jsxs)("button", {
            ...
            ...r,
            children: ["left" === a && (0, b.jsx)(Ie, {}), "right" === a && (0, b.jsx)(Ne, {})]
          })
        },
      ...
      const Ve = (e, a) => {
        ...
        $e = e => {
          ...
          return (0, l.usePreloadImg)(v), (0, b.jsx)(Se.NavLink, {
            className: [Ue.packCard, o, u ? Ue.packCompleted : ""].join(" "),
            to: s,
            onClick: _,
            children: (0, b.jsxs)("div", {
              className: [Ue.packCardImageBox, p ? Ue.packCardImageLoaded : ""].join(" "),
              style: {
      ...
      const qe = e => {
          let {
            isHeaderVisible: a,
            packListItems: s,
            packCardClassName: o = Ze.packCard,
            packListClassName: c = Ze.packList,
            packGridClassName: _ = Ze.packGrid,
            selectPackCard: n,
            sortFunction: i = Ve
          } = e;
          ...
          return (0, r.useEffect)((() => {
            ...
            className: [c, a ? Ze.headerVisible : ""].join(" "),
      ...
      const {
        ...
        const {
          ...
          loading: w,
          loggedIn: A
        } = (0, d.useRockstarUser)(), [P, x] = (0, r.useState)("unknown"), I = (0, r.useRef)(null), T = (0, r.useRef)(null), {
          formatMessage: C
        } = (0, i.useIntl)(), {
          track: N
      ...
      const fa = e => {
        ...
        ja = (0, i.withIntl)((() => {
          const e = (0, i.useIntl)(),
            ...
            [x, I] = (0, r.useState)(!1),
            [T, C] = (0, r.useState)((s?.characters?.gtao?.length ?? 0) > 0),
            [N, O] = (0, r.useState)(!1),
            [G, W] = (0, r.useState)(0),
            [y, z] = (0, r.useState)([]),
            [D, V] = (0, r.useState)(!1),
            ...
            U = (0, r.useRef)(null),
            F = (0, r.useRef)(null),
            X = `${document.location.pathname}${document.location.search}`,
            {
              signUpUrl: Y,
              signInUrl: $
            } = (0, l.useScAuthLinks)(X),
            Z = (0, l.useScAuthTpaLink)("np", X).href,
            q = (0, l.useScAuthTpaLink)("xbl", X).href,
            {
              data: K,
              allData: J,
              loading: Q
          ...
          (0, r.useEffect)((() => {
            if (Array.isArray(c)) {
              const e = c?.[0];
              I((0, l.getGen9Consoles)().includes(e))
            }
          ...
          const ce = (0, r.useCallback)(((e, s, r, t, o) => {
              ...
              })(o, `Card > ${K[G].title} > ${e}`, r, K[G].title, s, e)
            }), [y, G, a]),
            _e = g((() => {
              U?.current && !D ? (t.gsap.to(U?.current, {
                height: "auto",
                autoAlpha: 1,
                duration: .3,
                ease: t.Power2.easeInOut
              }), V(!D)) : (t.gsap.to(U?.current, {
                height: "0px",
                autoAlpha: 0,
                duration: .3,
                ease: t.Power2.easeInOut
          ...
          return (0, De.useGSAP)((() => {
            H?.current && (L ? (t.gsap.to(H?.current, {
              visibility: "visible",
              autoAlpha: 1,
              y: 10,
              duration: .3,
            ...
            dependencies: [H?.current, L]
          }), (0, r.useEffect)((() => {
            if (o)
              if (C((s?.characters?.gtao ?? [])?.length > 0), T) {
          ...
          }), [o, T, x, e.locale, s?.characters?.gtao?.length]), (0, r.useEffect)((() => {
            u && !N && (a({
              ...te
            }), O(!0))
            ...
            children: [(0, b.jsx)("div", {
              ...
              children: (0, b.jsxs)("div", {
                ...
                children: [(0, b.jsxs)("div", {
                  className: (0, l.classList)(Sa.packPageCPH, o && T && !x ? Sa.gen9PackHeader : ""),
                  children: [(0, b.jsx)("div", {
                    ...
                    children: [T && (0, b.jsxs)(b.Fragment, {
                      children: [(0, b.jsxs)("div", {
