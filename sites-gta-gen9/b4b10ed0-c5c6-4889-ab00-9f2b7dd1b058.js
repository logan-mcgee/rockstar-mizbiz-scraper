try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "b4b10ed0-c5c6-4889-ab00-9f2b7dd1b058", e._sentryDebugIdIdentifier = "sentry-dbid-b4b10ed0-c5c6-4889-ab00-9f2b7dd1b058")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [1432], {
    ...
    17054: (e, a, t) => {
        ...
        B = ({
          ...
          return (0, s.jsxs)(N.motion.div, {
            ...
            children: [(0, s.jsxs)("div", {
              ...
              }), c.length ? (0, s.jsx)(N.motion.div, {
                variants: k,
                children: (0, s.jsx)(j.A, {
                  buttonText: r,
                  platformsAndLinks: c,
                  children: (0, s.jsxs)(s.Fragment, {
                    children: [(0, s.jsxs)(N.motion.div, {
                    ...
                    }), i.length > 0 && (0, s.jsx)(N.motion.div, {
                      variants: k,
      ...
      const W = {
        ...
        U = ({
          ...
          }), m = (0, c.useRef)(null), g = (0, c.useRef)(null), u = X(n), f = X(i), b = (0, _.useTinaComponents)(), p = (0, c.useMemo)(() => ({
            ...b,
            HTMLElement
          }), [b]);
          return ((e, a, t) => {
    ...
    20920: (e, a, t) => {
      ...
      const p = ({
        ...
        const [i, r] = (0, n.useState)(""), [c, p] = (0, n.useState)(void 0), {
          ...
          windowWidth: x
        } = (0, d.useWindowResize)(), y = (0, o.useIntl)(), j = {
          "--promo-background": e ?? "var(--black-200)",
          "--promo-order": "left" === a ? "row" : "row-reverse"
        }, N = t(40844), _ = () => {}, S = (0, u.A)().data, w = !!S?.length, C = (0, n.useMemo)(() => w ? (e => {
          const a = [];
          let t = 0;
    ...
    27754: (e, a, t) => {
      ...
      const f = i.withFadeIn(({
        ...
        const {
          ...
          threshold: .6
        }), [N, _] = (0, n.useState)(!1), S = (0, r.useGetCdnSource)(c?.full_src ?? null) ?? null;
        return (0, n.useEffect)(() => {
          j && !N && (x({
            event: "page_section_impression",
    ...
    77030: (e, a, t) => {
      ...
      const g = ({
        ...
        const {
          track: y
        } = (0, r.useGtmTrack)(), j = (0, n.useRef)(null), [N, _] = (0, n.useState)(!1), S = (0, d.isReducedMotionPreferred)(), w = (0, i.useGetCdnSource)(f?.full_src ?? ""), C = (0, i.useGetCdnSource)(g), T = (0, o.getVideoUrl)(a), {
          formatMessage: I
    ...
    96911: (e, a, t) => {
      ...
      const g = {
        ...
        b = (0, r.A)(({
          ...
          const {
            track: v
          } = (0, c.useGtmTrack)(), [k, h] = (0, n.useState)(r), [x, y] = (0, n.useState)(void 0), [j, N] = (0, n.useState)(!1), _ = (0, n.useRef)(null), S = (0, n.useRef)([]), {
            ref: w
          } = (0, o.useInView)({
            threshold: .6,
            triggerOnce: !0,
    ...
    99803: (e, a, t) => {
      ...
      const u = ({
        ...
        f = (0, g.A)(({
          ...
          const {
            track: N
          } = (0, d.useGtmTrack)(), _ = (0, n.useRef)(null), S = (0, n.useRef)(null), w = (0, n.useRef)(null), [C, T] = (0, n.useState)(null), [I, A] = (0, n.useState)(!1), [B, M] = (0, n.useState)(null), [V, E] = (0, n.useState)(), [L, P] = (0, n.useState)(), {
            ref: R,
            inView: F
          } = (0, r.useInView)({
            threshold: .6
          ...
          (0, n.useEffect)(() => {
            ...
            const e = () => {
              if (_.current) {
                const e = f || Number(window.getComputedStyle(_.current).getPropertyValue("--slides-per-view")),
                  a = f ? 1 : Number(window.getComputedStyle(_.current).getPropertyValue("--slides-per-view-multiplier"));
                M(e * a)
              }
            };
