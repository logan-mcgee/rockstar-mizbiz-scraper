  ...
  [215], {
    ...
    9205: (e, a, t) => {
      ...
      const b = e => {
          ...
          const {
            track: l
          } = (0, i.useGtmTrack)(), [m, v] = (0, s.useState)(!1), h = g().debounce((() => {
            v(!1)
          }), 250), k = (0, s.useCallback)((() => {
            h?.cancel(), v(!0)
          }), [h]), p = () => {
            l({
              event: "nav_click",
          ...
          return (0, f.jsxs)("div", {
            ...
            children: [t ? (0, f.jsx)(r.A, {
              ...
              className: [u.subNav, c ? u.subNavUnder : u.subNavRight, m ? u.subNavOpen : ""].join(" "),
              children: o?.map((e => (0, f.jsx)(b, {
                under: !1,
                ...e,
                t: d
              }, e?.title)))
      ...
      const p = {
        ...
        y = () => {
          const {
            ...
            navOpen: t,
            setNavOpen: n
          } = (0, i.useRockstarUserState)(), r = (0, h._)(), c = (0, h._)(), o = (0, h._)();
          return (0, s.useEffect)((() => {
            !0 === t && !0 === e && a(!1)
          }), [t]), (0, s.useEffect)((() => {
            r.start(e ? p.open : p.closed), c.start(e ? x.open : x.closed), o.start(e ? N.open : N.closed)
          }), [e]), (0, f.jsxs)("svg", {
        ...
        S = (0, c.withTranslations)((e => {
          ...
          const {
            ...
            navOpen: h
          } = (0, i.useRockstarUserState)(), k = (0, s.useRef)(), {
            track: p
          } = (0, i.useGtmTrack)(), [, x] = (0, n.useSearchParams)(), {
            pathname: N
          } = (0, n.useLocation)(), {
            freezeUserShouldSeeMore: j,
            userShouldSeeMore: S
          } = (0, o.useScroll)(), [T, C] = (0, s.useState)(0), E = () => T > 1023;
          return (0, s.useEffect)((() => {
            l || h || j && S || u(S)
          }), [j, l, S, h]), (0, s.useEffect)((() => {
            b(!1)
          }), [N]), (0, s.useEffect)((() => {
            l && u(!1)
          }), [l]), (0, s.useEffect)((() => {
            const e = () => {
              k.current && g(k.current.offsetHeight), C(window.innerWidth)
            };
            return window.addEventListener("resize", e), e(), () => {
              window.removeEventListener("resize", e)
            }
          }), [k]), (0, f.jsx)("header", {
            className: [_.gen9Header, c ? _.headerHidden : ""].join(" "),
            ref: k,
            children: (0, f.jsxs)("div", {
              className: _.content,
              children: [(0, f.jsxs)("div", {
                ...
                "data-brand": t,
                children: [(0, f.jsx)(r.RockstarLogo, {}), (0, f.jsx)("div", {
                ...
                className: _.brandLogo,
                "data-brand": t
              }), (0, f.jsx)(v, {}), (0, f.jsx)("div", {
                className: _.buttonArea,
                children: (0, f.jsxs)("div", {
                  className: _.navBtn,
                  children: [!(T < 1024) && (0, f.jsx)(d.Z, {
                    text: a("Buy Now"),
                    type: "transparentBtn",
                    size: "small",
                    onClick: () => {
      ...
      const N = {
        ...
        _ = e => {
          ...
          const f = (0, p.useGetCdnSource)(t?.mobile?.full_src ?? null),
            ...
            j = (0, p.useGetCdnSource)(r?.desktop?.full_src ?? v),
            _ = {
              visible: {
                opacity: 1,
                transition: {
          ...
          return (0, n.jsxs)(k.E.div, {
            className: (0, p.classList)(N.hero, u),
            style: {
            ...
            children: [(0, n.jsxs)("div", {
              ...
              animate: "visible",
              variants: _,
              children: [(0, n.jsx)(k.E.div, {
                variants: S,
                children: (0, n.jsx)(s.Z, {
                  brands: a
                })
              }), o.length ? (0, n.jsx)(k.E.div, {
                variants: S,
