try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "0d3a5caf-8606-48a5-8778-eeca8d1442bf", e._sentryDebugIdIdentifier = "sentry-dbid-0d3a5caf-8606-48a5-8778-eeca8d1442bf")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [1592, 2295], {
    ...
    6306: e => {
      ...
      var d = {};
      t(d, "NoChoiceTransactionType", (() => m)), t(d, "ConfirmedTransactionType", (() => p)), t(d, "canStoreCookie", (() => g));
      const m = "NO_CHOICE",
        p = "CONFIRMED",
        u = {
    ...
    34458: (e, a, t) => {
      ...
      const O = (e = "") => ({
        ...
        V = (e = "--grid-num-columns", a = "Grid Number of Columns") => ({
          label: a,
          name: e,
      ...
      })("Grid"), V("style.--grid-num-columns-mobile", "Grid Number of Columns (Mobile)"), V("style.--grid-num-columns-desktop", "Grid Number of Columns (Desktop)"), O("Grid");
      var F = t(3514);
      t(24325), t(95966), t(84343), t(43582);
      var H = t(93935);
      const q = ({
          game: e = null,
          parent: a = null
    ...
    43582: (e, a, t) => {
      ...
      const d = {
        ...
        p = ({
          ...
          return delete o?.color, u && b ? (0, l.jsx)("div", {
            className: d.grid,
            style: {
            ...
            children: (0, l.jsx)("ol", {
              className: c()(d.itemList, d.noImg, d[t], d[r]),
            ...
            style: (0, s.safeStyles)(o),
            className: c()(d.itemList, d.custom, p ? d.noImg : "", t ? d[t] : "", r ? d[r] : "", i ?? ""),
    ...
    45440: (e, a, t) => {
      ...
      class i {
        ...
        aliasOnlineService;
        alias;
        constructor(e, a, t, l, n = null, o = null) {
          this.name = e, this.friendlyName = a, this.id = t, this.onlineService = l, this.aliasOnlineService = n, this.alias = o
        }
      }
      ...
      const f = async ({
        ...
        const [{
          ...
          authHost: n,
          clientId: o
        } = (0, b.A)(), i = await t(), s = new URL(`tpa/${e}/link`, `https://${n}.rockstargames.com`);
        return s.searchParams.append("cid", o), s.searchParams.append("lang", l), s.searchParams.append("returnUrl", a ?? window.location.pathname), i && "boolean" != typeof i && "string" == typeof i.bearerToken && s.searchParams.append("accessToken", i.bearerToken), s
      ...
      }, w = () => [s.xbox360.name, s.xboxone.name, s.ps3.name, s.ps4.name, s.pc.name], S = () => [s.xboxsx.name, s.ps5.name, s.pcalt.name], T = e => S().includes(e), I = e => {
        const a = new Map([
      ...
      const l = window?.env?.sc,
        ...
        o = ({
          ...
          const p = l?.apiHost ?? e,
            ...
            g = l?.cdnBase ?? c,
            b = l?.clientId ?? t,
            f = n?.marketingAuthTLD ?? m,
            v = l?.scHost ?? s,
            k = n?.pingBearerEndpoint ?? "auth/ping-bearer.json";
          return {
