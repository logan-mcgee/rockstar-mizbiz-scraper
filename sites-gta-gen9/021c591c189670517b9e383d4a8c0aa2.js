! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      o = (new Error).stack;
    o && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[o] = "3f5527f3-f737-4767-9cb0-b7ebd73e0f37", e._sentryDebugIdIdentifier = "sentry-dbid-3f5527f3-f737-4767-9cb0-b7ebd73e0f37")
  } catch (e) {}
}();
  ...
  [8304], {
    8304: (e, o, s) => {
      ...
      var t = s(3832),
        ...
        f = s(71388),
        m = {};
      for (const e in f)["default", "FormattedMessage", "IntlProvider", "createDevLocaleHook", "createIntl", "defineMessages", "englishLocale", "getCookieValueByName", "getLocale", "localeCookieHandler", "locales", "splitLocale", "useIntl", "withIntl"].indexOf(e) < 0 && (m[e] = () => f[e]);
      s.d(o, m)
    },
    11676: (e, o, s) => {
      "use strict";
    ...
    48787: (e, o, s) => {
      ...
      const i = () => {
        ...
        const c = `rockstarweb_lang.${o.cookieIdentifier}`,
          d = (0, n.M)(c);
        r = o.currentSite?.site === t.U.www ? a.c.find((e => e.subdomaincom === i)) || a.c.find((e => e.subdomaincom === s)) || l : a.c.find((e => e.iso === d)) || l;
        const [u, b] = (0, n.c)(c, r.iso);
        return [r, b]
      }
    },
    36320: (e, o, s) => {
