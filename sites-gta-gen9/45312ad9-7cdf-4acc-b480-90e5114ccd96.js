try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "45312ad9-7cdf-4acc-b480-90e5114ccd96", e._sentryDebugIdIdentifier = "sentry-dbid-45312ad9-7cdf-4acc-b480-90e5114ccd96")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    43920: (e, a, t) => {
      ...
      const It = (0, g.withTranslations)(({
        ...
        Pt = (0, g.withGtmTracking)(({
          ...
          return (0, l.useEffect)(() => {
            ...
            className: [zt.newswireBlocks, a ? zt.noSpecialOrder : "", zt.contextHome].join(" "),
      ...
      const Vs = (0, g.withTranslations)(({
          ...
          return (0, l.useEffect)(() => {
            ...
            const e = Ms()((e, a) => {
              let t = 18;
              if (e?.documentElement && (t = zs(e?.documentElement, "--root-font-size")), re !== a.innerHeight && ie(a.innerHeight), m?.current) {
                Q(zs(m.current, "--eventDeck-marginSm") * t);
                const e = t * zs(m?.current, "--eventDeck-modalGutters"),
                  s = a?.innerWidth,
                  n = s - 2 * e;
                D(n), E.current && c && B(n), F(zs(m.current, "--eventDeck-itemSize") * t), ce(zs(m.current, "--eventDeck-phaseOneTransitionDuration"));
                const r = zs(m?.current, "--eventDeck-itemImageTitleMargins") * t,
                  i = T?.current?.clientHeight,
                  o = i + r;
                Number.isNaN(o) || K(o), ne(zs(m?.current, "--eventDeck-headerHeight") * t)
              }
        ...
        Bs = (0, R.withIntl)(e => {
          const {
            ...
            if (!0 === t && 0 !== e.itemNumber) {
              const t = zs(e?.element?.current, "top");
              let n = t - Q;
          ...
          (0, l.useEffect)(() => {
            ...
            if (S.current) {
              let e = 0;
              e = S?.current?.clientHeight, e += zs(S?.current, "margin-top"), e += zs(S?.current, "margin-bottom"), Te(e)
            }
          }, [S, C]), (0, l.useEffect)(() => {
            ne && (() => {
              const e = j?.getBoundingClientRect().top,
            ...
            if (y.current) {
              w(y.current);
              const e = zs(document.documentElement, "--root-font-size"),
                a = zs(y.current, "--eventDeck-modalGutters") * e,
                t = zs(y.current, "--eventDeck-collapsedMaxWidth");
              be(t);
              let s = oe - 2 * a;
              ...
              let r = 0;
              n < oe && (r = .5 * (oe - n)), _e(r);
              let i = zs(y.current, "--eventDeck-modalBottomGutter");
              i *= e;
              const c = window.innerHeight - (Ce + i);
              J(.5 * s < c ? s / 4 : .5 * c);
              const d = zs(y.current, "--eventDeck-mobileBreakpoint");
              Oe(d);
              let l = zs(y.current, "--eventDeck-itemSize");
              l *= e, R(l);
              let m = zs(y.current, "--eventDeck-modalGutterGap");
              m *= e, Le(m);
              let g = zs(y.current, "--eventDeck-insideMargin");
              g *= e;
              ...
              const h = zs(y.current, "--eventDeck-itemScaleUpAmount");
              ea(h), Qe(zs(y.current, "--eventDeck-cardCloseTransitionDuration")), k(zs(y.current, "--eventDeck-itemImageTitleMargins") * e), null !== p && e !== p && (f(e), ne && gt()), null === p && f(e)
            }
          }, [y, o]), (0, l.useEffect)(() => {
            if (ne && !De) {
              gt();
