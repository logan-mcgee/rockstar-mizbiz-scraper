! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "4627c9bf-5621-4390-874d-7b04100f97e9", e._sentryDebugIdIdentifier = "sentry-dbid-4627c9bf-5621-4390-874d-7b04100f97e9")
  } catch (e) {}
}();
    ...
    42204: (e, a, n) => {
      ...
      const j = {
        ...
        F = e => {
          ...
          const s = n.path.map((e => 1 === n.path.length && "_root" === e.feedback_type.name ? null : (0, m.jsx)(x.NavLink, {
              to: `?step=${e.id_hash}`,
              className: j[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            o = n.next.map((e => "_root" === e.feedback_type.name ? null : (0, m.jsxs)(x.NavLink, {
          ...
          return (0, m.jsxs)("div", {
            className: [j.steps, j[t]].join(" "),
            children: [(0, m.jsx)("div", {
              className: j.stepsPrevious,
              children: s
            }), (0, m.jsx)("div", {
              className: j.stepsNext,
              children: o
            }), o.length ? "" : (0, m.jsx)(E, {
        ...
        V = e => {
          ...
          return (0, l.withTranslations)(T, "rdo" === t ? "rdr2" : t)({
            mutation: a,
            query: n,
            type: t
          })
      ...
      const A = () => (0, m.jsx)("span", {
        ...
        children: (0, m.jsx)(V, {
          query: D.FeedbackSteps,
          mutation: D.SubmitFeedback,
          type: "gtao"
        })
      });
      var M = n(64552),
      ...
      const B = {
        ...
        $ = e => {
          ...
          if ((0, t.useEffect)((() => {
              P().cloneDeepWith(i, ((e, n, t) => {
                a === e && u(t?.children ?? null)
              }))
            }), [a, i, k.get("section")]), (0, t.useEffect)((() => {
              v(null), P().cloneDeepWith(l, ((e, a, n) => {
          ...
          return (0, m.jsx)("div", {
            ...
            children: (0, m.jsxs)("div", {
              ...
              children: [(0, m.jsx)("div", {
                className: [B.sections, s ? B.sectionsOpen : ""].join(" "),
                children: l.map((e => {
                  let {
                    id_hash: a,
                    title: n,
                  ...
                  return (0, m.jsx)(d.A, {
                    className: a === g?.id_hash ? B.activeSection : "",
                    to: t,
                    onClick: b,
                    children: n
                  }, t)
      ...
      var G = n(67284);
      const C = (0, d.withSimpleErrorBoundary)((() => {
        const {
          setBrand: e
        } = (0, c.KM)();
        (0, t.useEffect)((() => {
      ...
      var z = n(56372);
      const L = (0, d.withSimpleErrorBoundary)((e => {
          let {
        ...
        R = e => {
          ...
          return (0, t.useLayoutEffect)((() => (i("gtao"), s("gtao"), () => {
            ...
            children: [(0, m.jsx)(S, {}), (0, m.jsx)(g, {}), (0, m.jsx)(Q, {
              config: a
            })]
          })
        },
