! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "88c988c3-5050-48b2-9b50-ca017d35a1c4", e._sentryDebugIdIdentifier = "sentry-dbid-88c988c3-5050-48b2-9b50-ca017d35a1c4")
  } catch (e) {}
}();
    ...
    56666: (e, t, s) => {
      ...
      const b = e => {
          ...
          const l = i ?? (a.startsWith(document.location.origin) ? "_self" : "_blank"),
            _ = [u.platformButton, u[n]].join(" "),
            d = n ? s(5328)(`./${n}.svg`) : null,
        ...
        f = e => {
          ...
          const [h, w] = (0, a.useState)(!1), [z, j] = (0, a.useState)(!1), [G, E] = (0, a.useState)(200), {
            track: R
          } = (0, l.useGtmTrack)(), N = (0, a.useRef)(null), C = (0, a.useRef)(h), S = (0, a.useRef)(null);
          (0, a.useEffect)((() => {
            C.current = h
          }), [h]), (0, a.useEffect)((() => {
            const e = e => {
          ...
          return (0, m.jsxs)("div", {
            ...
            children: [(0, m.jsx)(n.motion.div, {
              className: u.content,
              animate: h ? "open" : "close",
              variants: _,
              "aria-hidden": !!h,
              children: p
            }), (0, m.jsxs)(n.motion.div, {
              "data-variant": t,
              "data-animating": z,
              className: o()(h ? u.expandedButton : u.unexpandedButton),
              animate: h ? "open" : "closed",
              variants: d,
              initial: !1,
              ref: N,
              children: [(0, m.jsx)(n.motion.button, {
                className: o()(u.buttonText, i),
                "aria-expanded": h,
                onClick: () => {
                  if (j(!0), w(!h), !h) switch (k) {
                ...
                "aria-hidden": !h,
                style: {
                  height: h ? S?.current?.scrollHeight : 0
                },
    ...
    12363: (e, t, s) => {
      ...
      const _ = (0, c.g)((e => {
        ...
        const f = (0, a.useRef)(null),
          ...
          k = /^#/.test(s),
          x = b?.target ?? (d ? "_blank" : "_self"),
          {
            ...y
          } = b;
        let v = "";
        if ("aria-label" in y && y["aria-label"] && (v = "_blank" === x ? `${y["aria-label"]} ${p.formatMessage(n.aria_label_open_new_window)}` : y["aria-label"]), (0, a.useEffect)((() => {
          ...
          return (0, l.jsxs)("a", {
            ...
            "aria-label": v,
            ref: f,
            children: [t, "_blank" === x && !v && (0, l.jsx)("span", {
              className: o,
              children: p.formatMessage(n.aria_label_open_new_window)
            })]
          })
        }
        if (g) return (0, l.jsxs)(i.NavLink, {
          title: _,
          to: s,
          onClick: u,
          ...y,
        ...
        const h = Object.keys(y).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
          ...e,
          [t]: b[t]
        })), {});
