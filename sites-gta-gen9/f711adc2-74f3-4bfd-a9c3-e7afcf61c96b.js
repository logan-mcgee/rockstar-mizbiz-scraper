! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "f711adc2-74f3-4bfd-a9c3-e7afcf61c96b", e._sentryDebugIdIdentifier = "sentry-dbid-f711adc2-74f3-4bfd-a9c3-e7afcf61c96b")
  } catch (e) {}
}();
      ...
      const m = e => {
        ...
        p = (0, o.withTranslations)((e => {
          let {
            ...
            actionFooterLink: h,
            trackingData: y = {},
            actionFooterLinkTrackingData: w = {},
            t: x,
            ...S
          } = e;
          const {
            ...
            track: j
          } = (0, i.useGtmTrack)(), z = `${document.location.origin}/auth/sc-auth-login?returnUrl=${window.location.pathname}`, {
            ref: T,
            inView: D
          } = (0, n.useInView)({
            threshold: .6
          ...
          return (0, d.jsx)("div", {
            className: `${l.calloutContainer} ${_||""}`,
            ref: T,
            children: (0, d.jsxs)("div", {
              className: l.calloutSection,
              children: [(0, d.jsxs)("div", {
                className: [l.calloutHeaders, V ? l.calloutHeaderMargins : ""].join(" "),
