try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "de2a0535-20a0-4865-b939-e04601312fc1", t._sentryDebugIdIdentifier = "sentry-dbid-de2a0535-20a0-4865-b939-e04601312fc1")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    40361: (t, e, a) => {
      ...
      const n = (0, _.setContextItem)({
        ...
        d = ({
          ...
          const {
            ...
            data: a,
            loading: i
          } = (0, s.useRockstarUser)(), [c, d] = (0, o.useState)(!1), [A, l] = (0, o.useState)(!1), [h, p] = (0, o.useState)(), [g, w] = (0, o.useState)(), [u, f] = (0, o.useState)(), [m, b] = (0, o.useState)(), [v, k] = (0, o.useState)({}), x = (0, _.useRockstarTokenPing)(), y = t => a?.linkedAccounts?.some(e => e?.onlineService === t), j = y("twitch"), T = a?.characters?.gtao || [], D = new Set(["xbl", "ps", "np"]), C = new Set(T.map(t => (0, _.findPlatform)(t.platform)).flatMap(t => [t?.onlineService, t?.aliasOnlineService].filter(Boolean)).filter(t => t && D.has(t))), M = {
            activeStreams: h,
            canClaim: u,
            characters: T,
          ...
          return (0, o.useEffect)(() => {
            ...
            void 0 !== j && void 0 !== g && f(j && g || j && a?.characters?.gtao && a?.characters?.gtao.length > 0 || j && M.filteredLinkedAccounts && M.filteredLinkedAccounts.length > 0)
          }, [u, g, j]), A ? null : (0, r.jsx)(n.Provider, {
            value: M,
            children: t
          })
        },
      ...
      const k = (0, o.forwardRef)(function({
        ...
        T = (0, o.forwardRef)(function({
          ...
          const s = (0, f.v6)(o, {
            appearance: e,
            className: w()("rockstargames-sites-gta-gen9c054ca052ed2ce9a96787dea8065b008", c),
            "data-testid": t,
            ref: _,
            allCaps: !0,
            size: "MD",
      ...
      const Z = {
          ...
          return (0, r.jsxs)(G, {
            ...
            children: [(0, r.jsx)(E, {
              ...
              children: [(0, r.jsx)(L, {}), (0, r.jsxs)(O, {
                ...
                tabIndex: -1,
                onOpenAutoFocus: t => {
                  t.preventDefault(), u.current?.focus()
                },
                    ...
                    children: (0, r.jsx)("div", {
                      ...
                      children: f.map((e, i) => {
                        return (0, r.jsx)(m.Button, {
                          appearance: "primary",
                          size: "MD",
                          className: w()(Z.link, Z[e.platform.name]),
        ...
        Y = () => {
          const t = (0, i.useIntl)(),
            ...
            g = (0, o.useMemo)(() => 0 === p?.length ? 0 === l?.length ? "disabled" : "alert" : p?.length > 0 && (l?.length > 0 || p.filter(t => "pcalt" === t.platform || "pc" === t.platform)) ? n ? "success" : "alert" : "disabled", [n, p?.length, h?.length]),
            w = `${a}settings/linkedaccounts`,
            u = h?.length > 0 || p?.length > 0,
            f = () => {
              e({
          ...
          return (0, o.useEffect)(() => {
            ...
            state: g,
            children: ["success" === g && (0, r.jsxs)(r.Fragment, {
              children: [(0, r.jsxs)(x, {
                children: [(0, r.jsx)(y, {
                  icon: "Check",
              ...
              children: [(0, r.jsxs)(x, {
                children: [(0, r.jsx)(y, {
                  ...
                  children: u ? t.formatMessage(D.twitch_drops_gaming_state_action_card_link_valid_character_account) : t.formatMessage(D.twitch_drops_no_gaming_account_linked)
                })]
              }), u ? (0, r.jsx)(T, {
      ...
      const Q = "rockstargames-sites-gta-gen9ea4642de554a3d7eb8e92a6c16611e3c",
        V = () => {
          const [t, e] = (0, o.useState)(null), a = (0, i.useIntl)(), {
            ...
            filteredLinkedAccounts: h,
            trackingParent: p,
            tutorialCompletion: g,
            characters: w,
            hasAllGamingOnlineServices: u
          } = n;
          (0, o.useEffect)(() => {
          ...
          return w.length || h?.length ? (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("h4", {
                  ...
                  children: [(0, r.jsx)(W.Avatar, {
                    ...
                    children: [(0, r.jsxs)(W.TopRow, {
                      children: [(0, r.jsx)(W.PlatformTag, {
                        tagSize: W.PlatformTagSizes.large,
                        platform: t.platform
                      }), !g[t.platform] && (0, r.jsxs)(m.Tooltip.Root, {
                        children: [(0, r.jsx)(m.Tooltip.Trigger, {
                          children: (0, r.jsx)(v.TriangleAlert, {
                            label: a.formatMessage(D.twitch_drops_character_card_icon_label),
                            color: "#CE8903"
                    ...
                    }), g[t.platform] ? (0, r.jsx)(W.RankContent, {
              ...
              }, `${t?.platform}-${t.characterSlot}`)), !u && (0, r.jsx)(H.qr, {
                children: (0, r.jsx)(m.Button, {
                  appearance: "secondary",
                  size: "LG",
                  asChild: !0,
            ...
            children: (0, r.jsx)("div", {
              ...
              children: _ ? (0, r.jsxs)(r.Fragment, {
                children: [(0, r.jsx)(m.Button, {
                  size: "LG",
                  appearance: "primary",
                  className: w()(q, "rockstargames-sites-gta-gen9c1d8d9cbb5bf81284c34f752f3b6d561"),
                  asChild: !0,
                  children: (0, r.jsx)("a", {
        ...
        tt = () => {
          ...
          const {
            ...
            isTwitchLinked: d,
            linkedAccounts: l
          } = e, h = l?.length > 0, p = (_?.length ?? 0) > 0, g = o?.length > 0, w = g && o.some(t => "pc" === t.platform || "pcalt" === t.platform), u = n ? !n || !d || s || !p && !w || s || g && !w ? n && h ? c ? "canClaim" : "linked" : "general" : "createCharacters" : "loggedOut", f = "createCharacters" === u, m = ["loggedOut", "linked", "general"].includes(u);
          return (0, r.jsxs)("div", {
            className: K.header,
            children: [!f && (0, r.jsxs)(r.Fragment, {
              ...
              }), "canClaim" === u && (0, r.jsxs)(r.Fragment, {
                children: [(0, r.jsx)($, {
        ...
        et = ({
          ...
          className: w()([a, "rockstargames-sites-gta-gen9ddd2d5ebaa09dce343d0c1b5abcff346"]),
          width: t,
          height: e,
          viewBox: `0 0 ${t} ${e}`,
          fill: "none",
        ...
        at = ({
          ...
          const e = (0, l.useNavigate)(),
            ...
            y = !0 === f ? !u && null != _ && null != m && null != g && null != w && null != n : !1 === f,
            {
              ref: j
            } = (0, h.useInView)({
              threshold: .6,
          ...
          return (0, o.useEffect)(() => {
            _ !== t && b(t);
            const e = g?.length > 0 || d?.length > 0;
            k !== e && v(e)
          }, [_, t, g, d, b, v, k]), (0, o.useEffect)(() => {
