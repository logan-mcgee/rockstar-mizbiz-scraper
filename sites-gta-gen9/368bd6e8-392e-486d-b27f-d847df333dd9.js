    ...
    50198: (e, a, t) => {
      ...
      const v = {
        ...
        N = e => {
          ...
          }), [i, n] = (0, c.useState)(), [r, o] = (0, c.useState)(), [l, d] = (0, c.useState)(), [m, g] = (0, c.useState)(!1), [u, p] = (0, c.useState)(!1), [_, N] = (0, c.useState)(new HTMLAudioElement), [j, w] = (0, c.useState)({
            current: 0,
            duration: 0
          }), [S, C] = (0, c.useState)(!0);
          return (0, c.useEffect)((() => {
      ...
      const R = (0, t(62748).U1)(),
        ...
        G = e => {
          ...
          const [s, i] = (0, c.useState)(!1), n = (e => {
            const [a] = (0, m.useSearchParams)(), [t, s] = (0, c.useState)(null), i = (0, F.useRockstarUser)(), {
              loggedIn: n
            } = i, {
              currentCharId: r
            } = (0, F.useRockstarUserState)(), o = (0, F.useIsUserGtaPlus)(i?.data, r);
            return (0, c.useEffect)((() => {
      ...
      const le = e => {
        ...
        de = e => {
          ...
          const {
            track: h
          } = (0, F.useGtmTrack)(), x = (0, O.useDataLayer)(), y = i ?? a, N = (0, O.findPlatform)(p)?.friendlyName, j = (0, c.useMemo)((() => {
      ...
      const ye = {
        ...
        je = e => {
          ...
          let c = 100;
          return 2 == r.length && r[1].length < 4 && "off" !== r[1].toLowerCase() && 45, (0, f.jsxs)(Ne, {
            splitter: n,
            role: i,
      ...
      const Te = {
        ...
        Ie = e => {
          ...
          return (0, f.jsx)(Ce.cp, {
            disabled: !i,
            children: (0, f.jsxs)("div", {
              className: [Te.dropdownWrapper, i ? Te.open : "", void 0 !== t ? t : ""].join(" "),
              children: [(0, f.jsx)("button", {
                className: Te.opener,
                onClick: () => n(!i),
                children: s
      ...
      const Pe = {
        ...
        Re = e => {
          ...
          const [u, p] = (0, c.useState)(!1), {
            track: _
          } = (0, F.useGtmTrack)(), k = (0, c.useRef)(null), b = (0, c.useRef)(u);
          (0, c.useEffect)((() => {
            b.current = u
          }), [u]), (0, c.useEffect)((() => {
            const e = e => {
          ...
          return (0, f.jsxs)("div", {
            className: (0, T.classList)(Oe.container, n),
            children: [(0, f.jsx)(Be.motion.div, {
              ...
              children: [(0, f.jsx)(Be.motion.button, {
                ...
                children: [(0, f.jsx)("button", {
                  ...
                  children: o.length ? o.map((e => (0, f.jsx)(Fe, {
      ...
      const Qe = function(e) {
        ...
        Je = Qe((e => {
          ...
          const {
            track: _
          } = (0, F.useGtmTrack)(), k = (0, c.useRef)(null), b = (0, c.useRef)(null), v = (0, c.useRef)(null), [h, x] = (0, c.useState)(null), [y, N] = (0, c.useState)(!1), [j, w] = (0, c.useState)(null), [S, C] = (0, c.useState)(), [I, M] = (0, c.useState)(), {
            ref: L,
            inView: E
          } = (0, W.useInView)({
            threshold: .6
          ...
          (0, c.useEffect)((() => {
            ...
            const e = () => {
              S && !(0, Ke.isEmpty)(S) && S?.height > 0 && S?.height !== O && R(S?.height)
            };
            return e(), window.addEventListener("resize", e), () => {
              window.removeEventListener("resize", e)
            }
          ...
          return (0, f.jsxs)("div", {
            className: (0, T.classList)("rockstargames-sites-gta-gen9d0c3d91603036c852633939015a6cb48", m),
            "data-size": s,
            "data-sm": g?.sm ? g?.sm : s,
            "data-md": g?.md ? g?.md : s,
            "data-lg": g?.lg ? g?.lg : s,
        ...
        ca = e => {
          ...
          return (0, f.jsxs)(Be.motion.div, {
            className: (0, T.classList)(ea.hero, i),
            style: {
      ...
      const da = (0, o.defineMessages)({
        ...
        ga = (0, o.withIntl)((e => {
          ...
          const {
            track: n
          } = (0, F.useGtmTrack)(), r = (0, m.useLocation)(), l = (0, o.useIntl)(), [d, g] = (0, o.getLocale)(), [p, _] = (0, c.useState)(!1), k = (0, c.useMemo)((() => (0, la.c)()), []), b = (0, c.useCallback)((e => {
            let a = r.pathname;
            const t = a.split("/");
            return o.locales.map((e => e.subdomaincom)).includes(t[0]) && (a = t.slice(1).join("/")), k.currentSite?.site === la.U.www ? "en" === e ? `${window.location.origin}${a}${r.search}` : `${window.location.origin}/${e}${a}${r.search}` : `${window.location.origin}${a}${r.search}`
          }), [r]), v = (0, c.useRef)(null), [h, x] = (0, c.useState)(0), y = matchMedia("(hover: none) and (pointer: coarse)").matches, N = e => {
          ...
          return (0, c.useEffect)((() => {
            void 0 !== t && !1 === t && !0 === p && _(!1)
          }), [t]), (0, c.useEffect)((() => {
            v.current && x(v.current.scrollHeight)
          }), [v]), (0, f.jsxs)("div", {
            className: [ma.languageSelector, p ? ma.open : ""].join(" "),
            "data-theme": a,
            children: [y && "sc-menu" === a && (0, f.jsx)("div", {
              ...
              children: (0, f.jsxs)("select", {
                ...
                "aria-label": l.formatMessage(da.language_selector_default),
        ...
        ua = e => {
          ...
          return i && (s["--border-image-source"] = `url(${n})`), (0, f.jsx)("div", {
            className: (0, T.classList)(fa.border, t),
            style: {
              ...s
            }
          })
        ...
        pa = e => e?.images ? (0, f.jsx)("div", {
          className: (0, T.classList)(fa.layeredImage, fa[e?.variantClass], fa[e?.wrapperSizeClass]),
          style: {
            ...e?.style ?? {}
          },
          children: (0, f.jsxs)("div", {
            ...
            children: [e?.images?.map(((e, a) => {
              ...
              return (0, f.jsx)(ue, {
                ...
                imageStyle: d,
                className: (0, T.classList)(l, g, fa.imageLayer, fa[s], fa[i], fa[n], fa[r], fa[c]),
                alt: m
              }, o ?? a + 1)
        ...
        ha = e => {
          ...
          return a?.shouldTrack ? (0, f.jsx)(Na, {
      ...
      const Aa = (e, a) => {
        ...
        Ga = e => {
          ...
          } = (0, F.useRockstarUserState)(), [_, k] = (0, c.useState)(!1), [b, v] = (0, c.useState)(d), [h, x] = (0, c.useState)(!1), y = (0, o.useIntl)(), N = !!n?.length;
          (0, c.useEffect)((() => {
            if (Array.isArray(p)) {
              const e = p?.[0];
          ...
          return (0, O.usePreloadImg)(j, (() => v(!0))), (0, f.jsx)(m.NavLink, {
            className: [Ra.packCard, i, _ ? Ra.packCompleted : ""].join(" "),
            to: t,
            onClick: r,
            children: (0, f.jsxs)("div", {
              className: [Ra.packCardImageBox, b ? Ra.packCardImageLoaded : ""].join(" "),
              style: {
              ...
              children: [_ && (0, f.jsxs)("div", {
                ...
                children: [(0, f.jsx)("div", {
                  ...
                  className: Ra.label,
                  children: y.formatMessage($a.pl_card_badge_content_complete)
                })]
              }), (0, f.jsxs)("div", {
                className: Ra.packCardTextBox,
                children: [(0, f.jsx)("h4", {
                  children: a
                }), u && !_ && h && (0, f.jsx)(Fa, {
                  tiers: N ? n : Ua
      ...
      const Ka = e => {
          ...
          const {
            track: n
          } = (0, F.useGtmTrack)(), [r, o] = (0, c.useState)(0), l = (0, c.useCallback)(((e, s) => {
        ...
        Xa = "rockstargames-sites-gta-gen9c54c374409e11d1429ce99457cbf7441",
        Ya = e => {
          let {
            children: a,
            data: t,
      ...
      const Ja = e => {
        ...
        at = e => {
          ...
          return (0, f.jsx)(Za.qK, {
            scrollAxis: a,
            children: (0, f.jsx)(Ja, {
              children: (0, f.jsx)("div", {
                className: (0, T.classList)(et.parallaxWrapper, et[t]),
                style: s,
        ...
        it = e => {
          ...
          return "horizontal" === s ? (0, f.jsx)(Za.mw, {
            x: [a, t],
      ...
      const St = {
        ...
        Tt = e => {
          ...
          const {
            track: p
          } = (0, F.useGtmTrack)(), _ = (0, la.c)(), k = (0, o.useIntl)();
          let b = s;
        ...
        It = e => {
          ...
          const {
            ...
            navOpen: h
          } = (0, F.useRockstarUserState)(), x = (0, c.useRef)(null), [y, N] = (0, c.useState)(0), [j, w] = (0, c.useState)(0), [S, C] = (0, c.useState)(!0);
          return (0, c.useEffect)((() => {
            m !== a && !1 === S && C(!0), m === a && C(!1)
          }), [m]), (0, c.useEffect)((() => {
            if (!x.current) return;
            ...
            children: [(0, f.jsxs)("button", {
              ...
              onClick: e => {
                e.stopPropagation(), v(r), m === a ? (g(-1), u(0)) : (g(a), u(y + j + j))
              },
              children: [(0, f.jsx)("span", {
              ...
              children: d.map((e => (0, c.createElement)(Tt, {
                ...e,
                isSubLink: !0,
                key: e.text,
                tabIndex: S || !h ? -1 : 0
        ...
        Mt = e => {
          ...
          const {
            ...
            navOpen: _
          } = (0, F.useRockstarUserState)(), k = (0, O.useLocale)(), b = (0, O.toScLocaleString)(k), [v, h] = (0, c.useState)(""), x = (0, m.useLocation)(), y = `${a.login}?returnUrl=${v}&lang=${b}`, N = `${a.signup}&returnUrl=${v}&lang=${b}`, j = (0, c.useMemo)((() => (0, la.c)()), []), w = (0, c.useMemo)((() => {
            const e = ((e, a, t) => [{
            ...
            return e
          }), [i, y, N, j]), [S, C] = (0, c.useState)(0), T = (0, c.createRef)(), I = () => {
            if (T.current) {
              const {
                current: e
          ...
          return (0, c.useEffect)((() => {
            ...
            children: [(0, f.jsx)("nav", {
              ...
              children: (0, f.jsx)("div", {
                ...
                children: w.map((e => (0, c.createElement)(It, {
                  ...e,
                  activeSubNavId: l,
                  setActiveSubNavId: d,
                  setSubNavExtraHeight: u,
        ...
        zt = e => {
          ...
          const {
            ...
            track: n
          } = (0, F.useGtmTrack)(), r = (0, o.useIntl)(), [l, d] = (0, c.useState)([]), [m, g] = (0, c.useState)(null), [u, p] = (0, c.useState)(null), [_, k] = (0, c.useState)(!1), [b, v] = (0, c.useState)(-1), [h, x] = (0, c.useState)([]), [y, N] = (0, c.useState)(0), j = t(71084), [w, S] = (0, c.useState)("0"), [C, T] = (0, c.useState)("0"), I = e => parseInt(e, 10).toLocaleString("en-US", {
        ...
        Dt = (0, O.withTranslations)((e => {
          ...
          const {
            ...
            scNavOpened: j,
            setScNavOpened: w
          } = yt(), [S, C] = (0, c.useState)(""), T = (0, m.useLocation)(), {
            lsSettings: I
          ...
          return (0, c.useEffect)((() => {
            ...
            q(t), H(a), ne.length > 1 ? X(!0) : X(!1), l(ne.length - 1 > 3)
          }), [P, ne]), (0, c.useEffect)((() => {
            ge()
          }), [Z, d, u, ne]), (0, c.useEffect)((() => {
            fe(), jt()((() => {
              setTimeout(fe, 0)
            }), 300)
          }), [u, p]), (0, c.useEffect)((() => {
            ...
            children: [null !== G && "gtao" === B && (0, f.jsxs)("div", {
              ...
              children: [(0, f.jsx)("button", {
                ...
                children: me.map(((e, a) => (0, c.createElement)(It, {
                  ...e,
                  id: a,
                  activeSubNavId: h,
                  setActiveSubNavId: x,
        ...
        Rt = (0, o.withIntl)((e => {
          ...
          return (0, c.useEffect)((() => {
            const e = s?.id ?? !1,
              a = e ? (h?.[n]?.mugshotUrl ?? s?.avatar) || Ot : Ft,
              t = nt(h?.[n]?.platform, "small") ?? null;
            k(t), g(a), p(e), v(!!h?.[n]?.mugshotUrl)
          }), [s, h, n, Ot, Ft]), (0, f.jsxs)("button", {
      ...
      const Xt = Qe((0, o.withIntl)((e => {
          ...
          return (0, f.jsxs)("div", {
            className: [Ht.rating, y ? Ht.withDescriptors : Ht.withOutDescriptors, d || ""].join(" "),
            style: (0, O.safeStyles)(l),
            children: [(0, f.jsx)(u, {
              to: _.ratingUrl,
              target: "_blank",
              children: (0, f.jsx)("img", {
                alt: h.formatMessage(Wt.components_ratings_link_alt, {
              ...
              className: Ht.text,
              children: [(0, f.jsx)("p", {
                className: Ht.descriptors,
                dangerouslySetInnerHTML: {
                  __html: _?.ratingDescriptors?.split(/<br\s?\/?>/).join(", ") || ""
                }
              }), _.ratingFooter && (0, f.jsx)("hr", {}), _.ratingFooter && (0, f.jsx)("p", {
                dangerouslySetInnerHTML: {
        ...
        Qt = e => {
          ...
          return (0, f.jsx)("div", {
            className: [Yt.responsiveFlexBox, void 0 !== t ? t : ""].join(" "),
            style: s,
            children: a
          })
        },
        ...
        as = e => {
          ...
          return void 0 !== t && (r.gridTemplateColumns = `repeat(${t}, 1fr)`), void 0 !== i && (r.gridTemplateRows = `repeat(${i}, 1fr)`), (0, f.jsx)("div", {
            className: [es.responsiveGridBox, void 0 !== s ? s : ""].join(" "),
            style: r,
            children: a
          })
        },
        ...
        cs = e => {
          ...
          return (0, f.jsx)("section", {
            className: [rs.responsiveSection, void 0 !== t ? t : ""].join(" "),
            style: s,
            children: i ? (0, f.jsx)("div", {
              className: rs.maxWidth,
              children: a
            }) : a
          })
        },
        ...
        ms = (0, c.forwardRef)(((e, a) => {
          const {
            ...
            track: r
          } = (0, F.useGtmTrack)(n), [o, l] = (0, c.useState)(a?.current);
          return (0, c.useEffect)((() => {
      ...
      const gs = ms,
        ...
        ps = e => {
          ...
          return a ? (0, f.jsx)("div", {
            className: [us.skeleton, us[a]].join(" ")
          }) : null
        },
        _s = (0, o.defineMessages)({
        ...
        vs = (0, o.withIntl)((e => {
          ...
          return (0, f.jsxs)("div", {
            ...
            children: [(0, f.jsx)("h4", {
              ...
              children: (0, f.jsx)(o.FormattedMessage, {
                ..._s.components_track_list_title
              })
            }), (0, f.jsx)("div", {
        ...
        hs = "rockstargames-sites-gta-gen9eca98eb0b5b84a0c9a2e6d952545a2d5",
        ...
        Ns = e => {
          ...
          const {
            track: l
          } = (0, F.useGtmTrack)(), [d, m] = (0, c.useState)([qe.O4, qe.Hj, qe.eM]), [g, u] = (0, c.useState)(null), [p, _] = (0, c.useState)(null);
          return (0, c.useEffect)((() => {
      ...
      const Is = {
        ...
        Ms = e => {
          ...
          const {
            ...
            refetch: o
          } = (0, k.useQuery)(Ts.UserGetVote, {
            skip: !0
          }), [l] = (0, k.useMutation)(Ts.UserCastVote), [d, m] = (0, c.useState)(null), g = (0, c.useCallback)((async e => {
            n({
        ...
        Es = (0, O.withLocale)((e => {
          ...
          return (0, c.useEffect)((() => {
            ...
            const a = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
              ...
              c = e => {
                d(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !g.current?.classList.contains(Ls.dragging) || a() && n(!0)
              },
              l = () => {
                a() && n(!1), d(0)
              },
              f = e => {
                "press" === e.type && m.current?.classList.add(`${Ls.disableClick}`), "tap" === e.type && (m.current?.classList.remove(`${Ls.disableClick}`), document.elementFromPoint(e.center.x, e.center.y).click())
              },
              u = () => {
                a() && n(!1), m.current && m.current.classList.remove(`${Ls.disableClick}`)
              },
              p = () => {
                a() && n(!1)
              };
            ...
            children: [(0, f.jsx)("div", {
              ...
              ref: m,
              children: (0, f.jsx)("div", {
                className: `${Ls.items} ${0!==l?Ls.dragging:""}`,
                ref: g,
                style: {
              ...
              children: [(0, f.jsx)("div", {
                ...
                children: s.map(((e, s) => {
                  return (0, f.jsx)(u, {
                    ...
                    tabIndex: r === s ? 0 : -1,
                    children: (0, f.jsxs)("div", {
                      className: [Ls.info, s === r ? Ls.active : ""].join(" "),
                      children: [(0, f.jsxs)("div", {
                        className: Ls.title,
                        children: [(0, f.jsx)("div", {
      ...
      const Ps = e => {
          ...
          return (0, f.jsx)("div", {
            role: "img",
            "aria-label": i,
            className: [Bs.img, l ? Bs.startAnimation : "", a ? Bs.wide : ""].join(" "),
            style: {
        ...
        Ds = e => {
          ...
          return (0, f.jsx)(u, {
            ...
            to: t ?? i,
            target: "_self",
            className: [Vs.fobLink, n ? Vs.wide : ""].join(" "),
            children: (0, f.jsx)(Ps, {
              title: a.title,
              titleSlug: s,
              isWideCard: n
      ...
      class Hs extends c.Component {
        ...
        render() {
          return null !== this.state.error.code ? (0, f.jsx)(Fs, {
        ...
        y = e => {
          ...
          const p = (0, r.useIntl)(),
            ...
            z = (0, s.useCallback)(((e, a) => {
              E.current && E.current.slideTo(e), N(e), B(`Career Progress Nav > ${a}`)
            }), [_]),
            B = (e, a) => {
              _({
          ...
          const P = e => {
            e.isEnd ? C(!0) : C(!1), e.isBeginning ? I(!0) : I(!1)
          };
          return (0, s.useEffect)((() => {
            ...
            children: [!T && j && (0, d.jsx)("div", {
              ...
              children: (0, d.jsx)(v, {
                ...
                onClick: () => {
                  E.current && (E.current?.slidePrev(), E.current.isBeginning ? I(!0) : I(!1), _({
                    event: "carousel_previous",
                    event_action: "click",
                    event_category: "carousel",
