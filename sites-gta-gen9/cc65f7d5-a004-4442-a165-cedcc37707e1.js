! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "cc65f7d5-a004-4442-a165-cedcc37707e1", e._sentryDebugIdIdentifier = "sentry-dbid-cc65f7d5-a004-4442-a165-cedcc37707e1")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [8482, 8096], {
    ...
    68482: (e, a, t) => {
      ...
      var F = t(86090);
      t(2942), t(95966), t(84343), t(67306);
      var q = t(89363);
      const X = e => {
          let {
            game: a = null,
    ...
    21207: (e, a, t) => {
      ...
      const p = e => {
        ...
        u = (e, a) => {
          e && void 0 !== a && (0, m.canStoreCookie)(e) && p(e) !== a && (document.cookie = `${e}=${a}; domain=${(()=>{const e=window.location.hostname.split(".");return e.slice(e.length-2).join(".")})()}; path=/;`)
        };
      t(98096);
      const b = e => e.keys().forEach(e),
        ...
        v = function() {
          let e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
          return f.filter((a => a.key === (e ? "prod" : "dev")))[0]?.path ?? null
        },
        k = e => {
          e.preventDefault();
        ...
        h = () => [r.xbox360.name, r.xboxone.name, r.ps3.name, r.ps4.name, r.pc.name],
        y = () => [r.xboxsx.name, r.ps5.name],
        x = e => y().includes(e),
        S = e => {
          const a = new Map([
