! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      e = (new Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "47b36a26-b09c-4619-b4d0-e4dbc22ebc03", t._sentryDebugIdIdentifier = "sentry-dbid-47b36a26-b09c-4619-b4d0-e4dbc22ebc03")
  } catch (t) {}
}();
  ...
  [1774], {
    51774: (t, e, n) => {
      n.r(e), n.d(e, {
        ...
        motion: () => Ls,
        motionValue: () => Qe,
        optimizedAppearDataAttribute: () => On,
        pipe: () => me,
        resolveMotionValue: () => It,
        spring: () => Ro,
        startOptimizedAppearAnimation: () => Xa,
        transform: () => sa,
        ...
        useMotionValue: () => ia,
        useMotionValueEvent: () => Ca,
        usePresence: () => Ae,
        useReducedMotion: () => Ta,
        useReducedMotionConfig: () => Aa,
        useResetProjection: () => Wa,
        useScroll: () => xa,
        useSpring: () => fa,
        useTime: () => Va,
        useTransform: () => la,
      ...
      const m = ["initial", "animate", "exit", "whileHover", "whileDrag", "whileTap", "whileFocus", "whileInView"];
      ...
      function A({
        ...
        t && b(t);
        const y = (0, o.forwardRef)((function(y, b) {
          const P = {
              ...(0, o.useContext)(i),
              ...y,
              layoutId: M(y)
          ...
          const R = function(t) {
            ...
            k = T ? void 0 : w((() => {
              if (E.hasEverUpdated) return V++
            })),
            D = m(y, T);
          if (!T && l) {
            R.visualElement = function(t, e, n, r) {
              const l = s(),
                h = (0, o.useContext)(c),
                d = (0, o.useContext)(a),
                p = (0, o.useContext)(i).reducedMotion,
                m = (0, o.useRef)();
              r = r || h.renderer, !m.current && r && (m.current = r(t, {
                visualState: e,
                parent: l,
                props: n,
              ...
              })), u((() => () => f && f.notify("Unmount")), []), f
            }(g, D, P, e);
            const r = (0, o.useContext)(c).strict,
              l = (0, o.useContext)(C);
            R.visualElement && (A = R.visualElement.loadFeatures(P, r, t, k, n || x.projectionNodeConstructor, l))
          }
          return o.createElement(S, {
            visualElement: R.visualElement,
            props: P
          }, A, o.createElement(r.Provider, {
            value: R
          ...
          }(D, R.visualElement, b), D, T, R.visualElement)))
        }));
        return y[T] = g, y
      }
      ...
      const O = t => !!(null == t ? void 0 : t.getVelocity),
        U = {
          x: "translateX",
          y: "translateY",
          z: "translateZ",
      ...
      function ct(t, e, n) {
        for (const o in e) O(e[o]) || j(o, n) || (t[o] = e[o])
      }
      ...
      function ft(t) {
        t && (mt = e => e.startsWith("on") ? !pt(e) : t(e))
      }
      try {
      ...
      function gt(t, e, n) {
        const o = {};
        for (const i in t)(mt(i) || !0 === n && pt(i) || !e && !pt(i) || t.draggable && i.startsWith("onDrag")) && (o[i] = t[i]);
        return o
      }
      ...
      function bt(t, {
        ...
        }(m, void 0 !== o ? o : .5, void 0 !== i ? i : .5)), void 0 !== e && (d.x = e), void 0 !== n && (d.y = n), void 0 !== r && function(t, e, n = 1, o = 0, i = !0) {
          t.pathLength = 1;
          const r = i ? yt : xt;
      ...
      function At(t, e, n, o) {
        Ct(t, e, void 0, o);
        for (const n in e.attrs) t.setAttribute(Tt.has(n) ? n : St(n), e.attrs[n])
      }
      ...
      function Mt(t) {
        ...
        for (const o in e)(O(e[o]) || j(o, t)) && (n[o] = e[o]);
        return n
      }

      function Rt(t) {
        const e = Mt(t);
        for (const n in t) O(t[n]) && (e["x" === n || "y" === n ? "attr" + n.toUpperCase() : n] = t[n]);
        return e
      }
      ...
      function ce(t, e, n) {
        return (o, i) => {
          Wt(o) && !ue() && (t.animationState && t.animationState.setActive($t.Hover, e), n && n(o, i))
        }
      }
      ...
      const pe = (t, e) => n => e(t(n)),
        me = (...t) => t.reduce(pe);
      var fe = n(90098);
      const ge = (void 0 === fe || fe.env, "production"),
        ve = new Set;
      ...
      function Pe(t, e, n, {
        ...
        (0, o.useEffect)((() => {
          ...
          const o = {
            ...
            rootMargin: r,
            threshold: "number" == typeof s ? s : Ve[s]
          };
      ...
      const Ce = t => e => (t(e), null),
        Te = {
          ...
          tap: Ce((function({
            ...
            function m(t, n) {
              c(), a.current || (a.current = !0, l.current = me(oe(window, "pointerup", d, u), oe(window, "pointercancel", p, u)), r.animationState && r.animationState.setActive($t.Tap, !0), e && e(t, n))
            }
            ie(r, "pointerdown", s ? m : void 0, u), de(c)
          })),
          focus: Ce((function({
            whileFocus: t,
            visualElement: e
      ...
      const Ne = ["read", "update", "preRender", "render", "postRender"],
        ...
        ze = Ne.reduce(((t, e) => {
          const n = $e[e];
          return t[e] = (t, e = !1, o = !1) => (Oe || Ge(), n.schedule(t, e, o)), t
        }), {}),
        Ye = Ne.reduce(((t, e) => (t[e] = $e[e].cancel, t)), {}),
        We = Ne.reduce(((t, e) => (t[e] = () => $e[e].process(Le), t)), {}),
        Xe = t => $e[t].process(Le),
        He = t => {
          Oe = !1, Le.delta = je ? Be : Math.max(Math.min(t - Le.timestamp, 40), 1), Le.timestamp = t, Ue = !0, Ne.forEach(Xe), Ue = !1, Oe && (je = !1, Fe(He))
        },
        Ge = () => {
          Oe = !0, je = !0, Ue || Fe(He)
        };
      ...
      const tn = (t, e) => n => Boolean(J(n) && K.test(n) && n.startsWith(t) || e && Object.prototype.hasOwnProperty.call(n, e)),
        ...
        on = {
          ...
          transform: ({
            ...
            blue: n,
            alpha: o = 1
          }) => "rgba(" + nn.transform(t) + ", " + nn.transform(e) + ", " + nn.transform(n) + ", " + _(H.transform(o)) + ")"
        },
        rn = {
          test: tn("#"),
          parse: function(t) {
        ...
        sn = {
          ...
          transform: ({
            ...
            lightness: n,
            alpha: o = 1
          }) => "hsla(" + Math.round(t) + ", " + et.transform(_(e)) + ", " + et.transform(_(n)) + ", " + _(H.transform(o)) + ")"
        },
        an = {
      ...
      function cn(t) {
        ...
        const r = t.match(q);
        return r && (o = r.length, t = t.replace(q, un), e.push(...r.map(X.parse))), {
          values: e,
          numColors: n,
          numNumbers: o,
          tokenised: t
      ...
      function wn(t, e) {
        var n;
        let o = bn(t);
        return o !== yn && (o = mn), null === (n = o.getAnimatableNone) || void 0 === n ? void 0 : n.call(o, e)
      }
      ...
      function Mn(t, e) {
        ...
        for (const e in r) An(t, e, Bt(r[e]))
      }
        ...
        if (s)
          for (let a = 0; a < s; a++) {
            const s = r[a],
              l = e[s];
            let u = null;
            Array.isArray(l) && (u = l[0]), null === u && (u = null !== (i = null !== (o = n[s]) && void 0 !== o ? o : t.readValue(s)) && void 0 !== i ? i : e[s]), null != u && ("string" == typeof u && (ke(u) || De(u)) ? u = parseFloat(u) : !Cn(u) && mn.test(l) && (u = wn(s, l)), t.addValue(s, Qe(u, {
              owner: t
      ...
      const to = (t, e) => {
        ...
        no = (t, e) => {
          const n = mn.createTransformer(e),
            o = cn(t),
            i = cn(e);
          return o.numColors === i.numColors && o.numNumbers >= i.numNumbers ? me(to(o.values, i.values), n) : ((0, Un.$)(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), n => `${n>0?e:t}`)
        },
        oo = (t, e, n) => {
          const o = e - t;
          return 0 === o ? 1 : (n - t) / o
      ...
      function yo({
        ...
        function l() {
          return ro(a, t, {
            ease: Array.isArray(r) ? r : (e = t, n = r, e.map((() => n || Hn)).splice(0, e.length - 1))
          });
          var e, n
        }
        let u = l();
      ...
      function Ro({
          ...
          },
          {
            ...
            if (!Ao(t, To) && Ao(t, Co)) {
              const n = function({
                ...
                let i, r;
                (0, Un.$)(t <= 1e3 * wo, "Spring duration must be 10 seconds or less");
                let s = 1 - e;
                s = W(Eo, Vo, s), t = W(bo, wo, t / 1e3), s < 1 ? (i = e => {
                  const o = e * s,
                    i = o * t,
                    r = o - n,
                    a = So(e, s),
        ...
        function g() {
          const t = r - i,
            e = Math.sqrt(a / u) / 1e3;
          if (void 0 === n && (n = Math.min(Math.abs(r - i) / 100, .4)), f < 1) {
            const n = So(e, f);
            p = o => {
              const i = Math.exp(-f * e * o);
              return r - i * ((m + f * e * t) / n * Math.sin(n * o) + t * Math.cos(n * o))
            }
          } else if (1 === f) p = n => r - Math.exp(-e * n) * (t + (m + e * t) * n);
          else {
            const n = e * Math.sqrt(f * f - 1);
            p = o => {
              const i = Math.exp(-f * e * o),
                s = Math.min(n * o, 300);
              return r - i * ((m + f * e * t) * Math.sinh(s) + n * t * Math.cosh(s)) / n
            }
          }
        }
        return g(), {
      ...
      function Io({
        ...
        const P = Do[s.length > 2 ? "keyframes" : p],
          S = s[0],
          C = s[s.length - 1];
        (null === (g = (f = P).needsInterpolation) || void 0 === g ? void 0 : g.call(f, S, C)) && (x = ro([0, 100], [S, C], {
          clamp: !1
        }), s = [0, 100]);
        const T = P({
          ...m,
        ...
        return a && (l && l(), v = e((function(t) {
          if (V || (t = -t), n += t, !E) {
            ...
            y = t.value, x && (y = x(y)), E = V ? t.done : n <= 0
          }
          d && d(y), E && (0 === b && (w = void 0 !== w ? w : n), b < o ? function(t, e, n, o) {
            return o ? t >= e + n : t <= -n
          }(n, w, r, V) && (b++, "reverse" === i ? (V = b % 2 == 0, n = function(t, e = 0, n = 0, o = !0) {
            return o ? Lo(e + -t, e, n) : e - (t - e) + n
          }(n, w, r, V)) : (n = Lo(n, w, r), "mirror" === i && T.flipTarget()), E = !1, h && h()) : (v.stop(), c && c()))
        })), v.start()), {
          stop: () => {
            u && u(), v.stop()
          },
      ...
      const zo = () => ({
        ...
        Go = (t, {
          keyframes: e
        }) => e.length > 2 ? Xo : (Ho[t] || Ho.default)(e[1]),
        _o = (t, e) => !("zIndex" === t || "number" != typeof e && !Array.isArray(e) && ("string" != typeof e || !mn.test(e) || e.startsWith("url(")));
      ...
      const ei = new Set(["opacity"]),
        ni = (t, e, n, o = {}) => i => {
          ...
          const l = function(t, e, n, o) {
              ...
              return "none" === r && i && "string" == typeof n ? r = wn(e, n) : qo(r) && "string" == typeof n ? r = Zo(n) : !Array.isArray(n) && qo(n) && "string" == typeof r && (n = Zo(r)), Array.isArray(n) ? (null === n[0] && (n[0] = r), n) : [r, n]
            }(e, t, n, r),
            u = l[0],
            c = l[l.length - 1],
            h = _o(t, u),
          ...
          const m = e.owner,
            f = m && m.current;
          if (ti.waapi() && ei.has(t) && !p.repeatDelay && "mirror" !== p.repeatType && 0 !== p.damping && m && f instanceof HTMLElement && !m.getProps().onUpdate) return function(t, e, {
            onUpdate: n,
            onComplete: o,
            ...i
          }) {
      ...
      function oi(t, e, n = {}) {
        ...
        if (t.notify("AnimationStart", e), Array.isArray(e)) {
          ...
          const i = "function" == typeof e ? Tn(t, e, n.custom) : e;
          o = ri(t, i, n)
        }
              ...
              function r(r, s) {
                ...
                for (let e = 0; e < ci; e++) {
                  const v = ui[e],
                    ...
                    b = d(x),
                    w = v === s ? y.isActive : null;
                  !1 === w && (m = e);
                  let E = x === l[v] && x !== a[v] && b;
                  if (E && o && t.manuallyAnimateOnMount && (E = !1), y.protectedKeys = {
                      ...h
                    }, !y.isActive && null === w || !x && !y.prevProp || p(x) || "boolean" == typeof x) continue;
                  const V = (f = y.prevProp, "string" == typeof(g = x) ? g !== f : !!Array.isArray(g) && !Re(g, f));
                  let P = V || v === s && y.isActive && !E && b || e > m && b;
                  ...
                  for (const t in A) {
                    const e = C[t],
                      n = T[t];
                    h.hasOwnProperty(t) || (e !== n ? Dt(e) && Dt(n) ? !Re(e, n) || V ? M(t) : y.protectedKeys[t] = !0 : void 0 !== e ? M(t) : c.add(t) : void 0 !== e && c.has(t) ? M(t) : y.protectedKeys[t] = !0)
                  }
      ...
      class fi {
        constructor(t, e, {
          ...
          if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.updatePoint = () => {
              ...
              this.lastMoveEvent = t, this.lastMoveEventInfo = gi(e, this.transformPagePoint), Wt(t) && 0 === t.buttons ? this.handlePointerUp(t, e) : ze.update(this.updatePoint, !0)
            ...
            }, Xt(t) && t.touches.length > 1) return;
          ...
          s && s(t, yi(o, this.history)), this.removeListeners = me(oe(window, "pointermove", this.handlePointerMove), oe(window, "pointerup", this.handlePointerUp), oe(window, "pointercancel", this.handlePointerUp))
        }
        updateHandlers(t) {
          this.handlers = t
        }
      ...
      function Vi(t, e = 0, n = .01) {
        return Math.abs(t - e) <= n
      }

      function Pi(t, e, n, o = .5) {
        t.origin = o, t.originPoint = Gn(e.min, e.max, t.origin), t.scale = Ei(n) / Ei(e), (Vi(t.scale, 1, 1e-4) || isNaN(t.scale)) && (t.scale = 1), t.translate = Gn(n.min, n.max, t.origin) - t.originPoint, (Vi(t.translate) || isNaN(t.translate)) && (t.translate = 0)
      }
      ...
      function Ci(t, e, n) {
        t.min = n.min + e.min, t.max = t.min + Ei(e)
      }

      function Ti(t, e, n) {
        t.min = e.min - n.min, t.max = t.min + Ei(e)
      }
      ...
      function Wi(t, e, n, o, i) {
        return void 0 !== i && (t = Yi(t, i, o)), Yi(t, n, o) + e
      }
      ...
      class er {
        ...
        start(t, {
          ...
          !1 !== this.visualElement.isPresent && (this.panSession = new fi(t, {
            onSessionStart: t => {
          ...
          Fi((t => {
            ...
            if (e) {
              ...
              i[t] = function(t, e) {
                ...
                const o = Ei(t),
                  i = Ei(e);
                return i > o ? n = oo(e.min, e.max - o, t.min) : o > i && (n = oo(t.min, t.max - i, e.min)), W(0, 1, n)
              }({
                min: n,
                max: n
              }, this.constraints[t])
          ...
          if (i.forEach((i => {
              ...
              if (Dt(h)) {
                const t = h.length,
                  e = null === h[0] ? 1 : 0;
                u = h[e], c = Pn(u);
                for (let n = e; n < t; n++) d ? (0, Un.V)(Pn(h[n]) === d, "All keyframes must be of the same type") : (d = Pn(h[n]), (0, Un.V)(d === c || cr(c) && cr(d), "Keyframes must be of the same dimension as the current value"))
              } else d = Pn(h);
              if (c !== d)
                if (cr(c) && cr(d)) {
                  const t = l.get();
      ...
      const wr = Object.keys(x),
        Er = wr.length,
        Vr = ["AnimationStart", "AnimationComplete", "Update", "Unmount", "BeforeLayoutMeasure", "LayoutMeasure", "LayoutAnimationStart", "LayoutAnimationComplete"];
      class Pr {
        constructor({
          parent: t,
          props: e,
          ...
          this.latestValues = r, this.baseTarget = {
            ...
            ...r
          } : {}, this.renderState = s, this.parent = t, this.props = e, this.depth = t ? t.depth + 1 : 0, this.reducedMotionConfig = n, this.options = i, this.isControllingVariants = f(e), this.isVariantNode = g(e), this.isVariantNode && (this.variantChildren = new Set), this.manuallyAnimateOnMount = Boolean(t && t.current);
          const {
            willChange: a,
            ...l
          ...
          for (const t in l) {
            const e = l[t];
            void 0 !== r[t] && O(e) && (e.set(r[t], !1), Bn(a) && a.add(t))
          }
        }
        scrapeMotionValuesFromProps(t) {
          return {}
        ...
        setProps(t) {
          ...
          this.prevMotionValues = function(t, e, n) {
            ...
            for (const i in e) {
              const r = e[i],
                s = n[i];
              if (O(r)) t.addValue(i, r), Bn(o) && o.add(i);
              else if (O(s)) t.addValue(i, Qe(r, {
                owner: t
              })), Bn(o) && o.remove(i);
              else if (s !== r)
                if (t.hasValue(i)) {
        ...
        getBaseTarget(t) {
          ...
          return void 0 === i || O(i) ? void 0 !== this.initialValues[t] && void 0 === o ? void 0 : this.baseTarget[t] : i
        }
        on(t, e) {
          return this.events[t] || (this.events[t] = new Ze), this.events[t].add(e)
        }
      ...
      class Mr extends Tr {
        ...
        readValueFromInstance(t, e) {
          var n;
          return F.has(e) ? (null === (n = bn(e)) || void 0 === n ? void 0 : n.default) || 0 : (e = Tt.has(e) ? e : St(e), t.getAttribute(e))
        }
        ...
        build(t, e, n, o) {
          bt(t, e, n, this.isSVGTag, o.transformTemplate)
        }
        renderInstance(t, e, n, o) {
          At(t, e, 0, o)
        }
        ...
        Br = {
          correct: (t, {
            ...
            const o = t,
              i = t.includes("var("),
              r = [];
            i && (t = t.replace(rr, (t => (r.push(t), Lr))));
            const s = mn.parse(t);
            if (s.length > 5) return o;
            const a = mn.createTransformer(t),
      ...
      const Fr = {
        ...
        jr = {
          measureLayout: function(t) {
            const [e, n] = Ae(), i = (0, o.useContext)(P);
      ...
      function qr(t, e, n, o, i) {
        return t = Yi(t -= e, 1 / n, o), void 0 !== i && (t = Yi(t, 1 / i, o)), t
      }
      ...
      function cs({
        ...
        return class {
          ...
          didUpdate() {
            ...
            this.isUpdating && (this.isUpdating = !1, this.potentialNodes.size && (this.potentialNodes.forEach(Cs), this.potentialNodes.clear()), this.nodes.forEach(gs), this.nodes.forEach(hs), this.nodes.forEach(ds), this.clearAllSnapshots(), We.update(), We.preRender(), We.render())
          }
          clearAllSnapshots() {
            this.nodes.forEach(ms), this.sharedNodes.forEach(ws)
          }
          ...
          resolveTargetDelta() {
            ...
            if (this.layout && (n || o)) {
              if (!this.targetDelta && !this.relativeTarget) {
                ...
                t && t.layout ? (this.relativeParent = t, this.relativeTarget = Ii(), this.relativeTargetOrigin = Ii(), Ai(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox), _r(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
              }
              var i, r, s;
              if ((this.relativeTarget || this.targetDelta) && (this.target || (this.target = Ii(), this.targetWithTransforms = Ii()), this.relativeTarget && this.relativeTargetOrigin && (null === (t = this.relativeParent) || void 0 === t ? void 0 : t.target) ? (i = this.target, r = this.relativeTarget, s = this.relativeParent.target, Ci(i.x, r.x, s.x), Ci(i.y, r.y, s.y)) : this.targetDelta ? (Boolean(this.resumingFrom) ? this.target = this.applyTransform(this.layout.layoutBox) : _r(this.target, this.layout.layoutBox), Hi(this.target, this.targetDelta)) : _r(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget)) {
                this.attemptToResolveRelativeTarget = !1;
                const t = this.getClosestProjectingParent();
                t && Boolean(t.resumingFrom) === Boolean(this.resumingFrom) && !t.options.layoutScroll && t.target ? (this.relativeParent = t, this.relativeTarget = Ii(), this.relativeTargetOrigin = Ii(), Ai(this.relativeTargetOrigin, this.target, t.target), _r(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
              }
            }
          }
          ...
          calcProjection() {
            ...
            _r(this.layoutCorrected, this.layout.layoutBox),
              function(t, e, n, o = !1) {
                ...
                for (let u = 0; u < s; u++) a = n[u], l = a.projectionDelta, "contents" !== (null === (r = null === (i = a.instance) || void 0 === i ? void 0 : i.style) || void 0 === r ? void 0 : r.display) && (o && a.options.layoutScroll && a.scroll && a !== a.root && Ji(t, {
                  x: -a.scroll.offset.x,
                  y: -a.scroll.offset.y
                }), l && (e.x *= l.x.scale, e.y *= l.y.scale, Hi(t, l)), o && Ni(a.latestValues) && Ji(t, a.latestValues));
            ...
            if (!l) return;
            this.projectionDelta || (this.projectionDelta = Bi(), this.projectionDeltaWithTransform = Bi());
            const u = this.treeScale.x,
              c = this.treeScale.y,
              h = this.projectionTransform;
            Si(this.projectionDelta, this.layoutCorrected, l, this.latestValues), this.projectionTransform = rs(this.projectionDelta, this.treeScale), this.projectionTransform === h && this.treeScale.x === u && this.treeScale.y === c || (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", l))
          }
          hide() {
            this.isVisible = !1
          }
          ...
          setAnimationOrigin(t, e = !1) {
            ...
            this.animationProgress = 0, this.mixTargetDelta = e => {
              ...
              const o = e / 1e3;
              var i, d, p, m;
              Es(a.x, t.x, o), Es(a.y, t.y, o), this.setTargetDelta(a), this.relativeTarget && this.relativeTargetOrigin && this.layout && (null === (n = this.relativeParent) || void 0 === n ? void 0 : n.layout) && (Ai(l, this.layout.layoutBox, this.relativeParent.layout.layoutBox), i = this.relativeTarget, d = this.relativeTargetOrigin, p = l, m = o, Vs(i.x, d.x, p.x, m), Vs(i.y, d.y, p.y, m)), u && (this.animationValues = s, function(t, e, n, o, i, r) {
                i ? (t.opacity = Gn(0, void 0 !== n.opacity ? n.opacity : 1, Wr(o)), t.opacityExit = Gn(void 0 !== e.opacity ? e.opacity : 1, 0, Xr(o))) : r && (t.opacity = Gn(void 0 !== e.opacity ? e.opacity : 1, void 0 !== n.opacity ? n.opacity : 1, o));
                for (let i = 0; i < Nr; i++) {
                  const r = `border${Ur[i]}Radius`;
                  let s = Yr(e, r),
                    a = Yr(n, r);
                  void 0 === s && void 0 === a || (s || (s = 0), a || (a = 0), 0 === s || 0 === a || zr(s) === zr(a) ? (t[r] = Math.max(Gn($r(s), $r(a), o), 0), (et.test(a) || et.test(s)) && (t[r] += "%")) : t[r] = a)
          ...
          startAnimation(t) {
            ...
            this.notifyListeners("animationStart"), null === (e = this.currentAnimation) || void 0 === e || e.stop(), this.resumingFrom && (null === (n = this.resumingFrom.currentAnimation) || void 0 === n || n.stop()), this.pendingAnimation && (Ye.update(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = ze.update((() => {
              E.hasAnimatedSinceResize = !0, this.currentAnimation = Or(0, 1e3, {
                ...t,
                onUpdate: e => {
                  var n;
          ...
          applyTransformsToTarget() {
            ...
            if (e && n && o) {
              if (this !== t && this.layout && o && As(this.options.animationType, this.layout.layoutBox, o.layoutBox)) {
                n = this.target || Ii();
                const e = Ei(this.layout.layoutBox.x);
                n.x.min = t.target.x.min, n.x.max = n.x.min + e;
                const o = Ei(this.layout.layoutBox.y);
                n.y.min = t.target.y.min, n.y.max = n.y.min + o
              }
              _r(e, n), Ji(e, i), Si(this.projectionDeltaWithTransform, this.layoutCorrected, e, i)
            }
          }
      ...
      function ds(t) {
        ...
        if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
          ...
          Si(s, e, i.layoutBox);
          const a = Bi();
          r ? Si(a, t.applyTransform(n, !0), i.measuredBox) : Si(a, e, i.layoutBox);
          const l = !es(s);
          let u = !1;
          if (!t.resumeFrom) {
            ...
            if (n && !n.resumeFrom) {
              ...
              if (t && o) {
                const n = Ii();
                Ai(n, i.layoutBox, t.layoutBox);
                const r = Ii();
                Ai(r, e, o.layoutBox), ns(n, r) || (u = !0)
              }
            }
          }
      ...
      function As(t, e, n) {
        return "position" === t || "preserve-aspect" === t && !Vi(os(e), os(n), .2)
      }
      const Ms = cs({
      ...
      const zs = t => t.key || "",
        Ys = ({
          ...
          p = [...p];
          const y = f.current.map(zs),
            x = d.map(zs),
            b = y.length;
          for (let t = 0; t < b; t++) {
            const e = y[t]; - 1 === x.indexOf(e) && m.add(e)
          }
          return "wait" === a && m.size && (p = []), m.forEach((t => {
            ...
            p.splice(r, 0, o.createElement(Ns, {
              ...
              onExitComplete: () => {
                ...
                const e = f.current.findIndex((e => e.key === t));
                if (f.current.splice(e, 1), !m.size) {
                  if (f.current = d, !1 === h.current) return;
                  l(), i && i()
                }
              },
              custom: e,
            ...
            const e = t.key;
            return m.has(e) ? t : o.createElement(Ns, {
              key: zs(t),
              isPresent: !0,
              presenceAffectsLayout: s,
              mode: a
            }, t)
          })), "production" !== ge && "wait" === a && p.length > 1 && console.warn('You\'re attempting to animate multiple children within AnimatePresence, but its mode is set to "wait". This will lead to odd visual behaviour.'), o.createElement(o.Fragment, null, m.size ? p : p.map((t => (0, o.cloneElement)(t))))
        },
      ...
      function fa(t, e = {}) {
        const {
          isStatic: n
        } = (0, o.useContext)(i), r = (0, o.useRef)(null), s = ia(O(t) ? t.get() : t);
        return (0, o.useMemo)((() => s.attach(((t, o) => n ? o(t) : (r.current && r.current.stop(), r.current = Io({
          ...
          function(t, e) {
            u((() => {
              if (O(t)) return e(t.get()), t.on("change", e)
            }), [t, e])
      ...
      function La(...t) {
        ...
        return [n, (0, o.useCallback)((n => {
          e.current = "number" != typeof n ? Da(0, t.length, e.current + 1) : n, i(t[e.current])
        }), [t.length, ...t])]
      }
      var Ba = n(79960);
      ...
      function Ia(t, {
        ...
        return (0, o.useEffect)((() => {
          ...
          return (0, Ba.l)(t.current, (() => (a(!0), r ? void 0 : () => a(!1))), o)
        }), [e, t, n, r]), s
      }
      class Fa {
        constructor() {
      ...
      function qa(t) {
        const [e, n] = (0, o.useState)(t), i = _a({}, !1), r = w((() => new Ga({
          props: {},
          visualState: i
        }, {
          initialState: t
      ...
      function Ja(t) {
        let e = ia(1),
          n = ia(1);
        const o = s();
        return (0, Un.V)(!(!t && !o), "If no scale values are provided, useInvertedScale must be used within a child of another motion component."), (0, Un.$)(Ka, "useInvertedScale is deprecated and will be removed in 3.0. Use the layout prop instead."), Ka = !0, t ? (e = t.scaleX || e, n = t.scaleY || n) : o && (e = o.getValue("scaleX", 1), n = o.getValue("scaleY", 1)), {
          scaleX: la(e, Za),
          scaleY: la(n, Za)
        }
      }
