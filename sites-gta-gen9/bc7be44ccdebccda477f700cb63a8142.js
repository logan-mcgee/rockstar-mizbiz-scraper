! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "56f9e57b-d77a-4e14-98db-3f91d641aae7", e._sentryDebugIdIdentifier = "sentry-dbid-56f9e57b-d77a-4e14-98db-3f91d641aae7")
  } catch (e) {}
}();
    ...
    42204: (e, a, n) => {
      ...
      const T = {
        ...
        E = e => {
          ...
          const s = n.path.map((e => 1 === n.path.length && "_root" === e.feedback_type.name ? null : (0, m.jsx)(j.NavLink, {
              to: `?step=${e.id_hash}`,
              className: T[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            o = n.next.map((e => "_root" === e.feedback_type.name ? null : (0, m.jsxs)(j.NavLink, {
        ...
        D = e => {
          ...
          return (0, l.withTranslations)(F, "rdo" === t ? "rdr2" : t)({
            mutation: a,
            query: n,
            type: t
          })
      ...
      const $ = {
        ...
        z = e => {
          ...
          if ((0, t.useEffect)((() => {
              B().cloneDeepWith(i, ((e, n, t) => {
                a === e && u(t?.children ?? null)
              }))
            }), [a, i, k.get("section")]), (0, t.useEffect)((() => {
              v(null), B().cloneDeepWith(l, ((e, a, n) => {
          ...
          return (0, m.jsx)("div", {
            className: $.guideNavMobile,
            children: (0, m.jsxs)("div", {
              className: $.guideNavMobileContent,
              children: [(0, m.jsx)("div", {
                className: [$.sections, s ? $.sectionsOpen : ""].join(" "),
                children: l.map((e => {
                  let {
                    id_hash: a,
                    title: n,
                  ...
                  return (0, m.jsx)(d.A, {
                    className: a === g?.id_hash ? $.activeSection : "",
                    to: t,
                    onClick: b,
                    children: n
                  }, t)
      ...
      var L = n(56372);
      const q = (0, d.withSimpleErrorBoundary)((e => {
          let {
        ...
        Q = (0, d.withSearchbarErrorBoundary)((e => {
          let {
            routeRoot: a
          } = e;
          const n = [{
        ...
        W = e => {
          ...
          return (0, t.useLayoutEffect)((() => (i("gtao"), s("gtao"), () => {
            ...
            children: [(0, m.jsx)(S, {}), (0, m.jsx)(g, {}), (0, m.jsx)(R, {
              config: a
            })]
          })
        },
