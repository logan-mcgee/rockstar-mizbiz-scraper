! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "c3293006-fbdf-482f-a2ca-69e314729de0", e._sentryDebugIdIdentifier = "sentry-dbid-c3293006-fbdf-482f-a2ca-69e314729de0")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [4825], {
    ...
    93665: (e, a, t) => {
      ...
      const m = e => {
          ...
          const {
            ...
            track: M
          } = (0, o.useGtmTrack)(), E = null !== h && (h?.length || 0) > 1 && ("flag_bg" === x || "fob" === j?.size), [A, L] = (0, l.useSearchParams)(), [P, B] = (0, s.useState)(!1), [$, R] = (0, s.useState)(!1), [V, O] = (0, s.useState)(), D = e => {
    ...
    57085: (e, a, t) => {
      "use strict";
      t.r(a), t.d(a, {
        componentsForTinaParser: () => Gn,
        componentsForTinaParserGuide: () => Wn
      });
      var s = {};
      t.r(s), t.d(s, {
        CharacterCard: () => Ft.A,
      ...
      t.r(r), t.d(r, {
        ...
        Wasted: () => rn.A,
        framer: () => Ce,
        useTinaModuleFetchByIds: () => we.X,
        withInViewTracker: () => St.r,
        withSearchbarErrorBoundary: () => cn.A,
        withSimpleErrorBoundary: () => on.A
      });
      var i = t(55430),
        c = t(21450),
        o = t(71403),
      ...
      const A = e => {
        ...
        B = e => {
          ...
          const b = (e => {
            ...
            k = (0, N.useGetCdnSource)(t?.mobile?.full_src ?? null),
            h = (0, N.useGetCdnSource)(t?.desktop?.full_src ?? k),
            v = (0, N.useGetCdnSource)(l?.mobile?.full_src ?? null),
            x = (0, N.useGetCdnSource)(l?.desktop?.full_src ?? v);
          return (0, u.jsxs)(y.motion.div, {
      ...
      const V = e => {
        ...
        return (0, u.jsx)("span", {
          className: (0, N.classList)(s, t?.className, "rockstargames-sites-gta-gen9a7f106a8036d74ed9282a741476c6b5a"),
          id: r,
      ...
      const G = (0, z.defineMessages)({
        ...
        W = {
          SUCCESS: {
            icon: "check",
            heading: G.ns_successfully_subscribed_title,
            bodyText: G.ns_successfully_subscribed_details,
            showManagePreferences: !0
          },
          CHECK_EMAIL: {
            icon: "mail",
            heading: G.ns_check_email_title,
            bodyText: G.ns_check_email_details
          },
          ERROR_PREFERENCES: {
            icon: "error",
            heading: G.ns_error_preferences_title,
            bodyText: G.ns_error_preferences_details,
            showManagePreferences: !0
          },
          ERROR_GENERIC: {
            icon: "error",
            heading: G.ns_error_generic_title,
            bodyText: G.ns_error_generic_details
          },
          ALREADY_SUBSCRIBED: {
            icon: "check",
            heading: G.ns_already_subbed_title,
            bodyText: G.ns_already_subbed_details,
            showManagePreferences: !0
          },
          NEW_ACCOUNT: {
            icon: "mail",
            heading: G.ns_confirm_after_register_title,
            bodyText: G.ns_confirm_after_register_details,
            showManagePreferences: !0
          },
          CONFIRM: {
            icon: "mail",
            heading: G.ns_confirm_title,
            bodyText: G.ns_confirm_details,
            showManagePreferences: !1
          }
        },
        U = {
          0: W.ERROR_PREFERENCES,
          1: W.SUCCESS,
          2: W.ERROR_PREFERENCES,
          3: W.ERROR_PREFERENCES,
          4: W.ERROR_GENERIC
        },
        q = (e, a) => {
          const [t, s] = (0, o.useState)(), [n, r] = (0, o.useState)(!1), [i, c] = (0, o.useState)(!1), [l, g] = (0, o.useState)(!0), [u, f] = (0, o.useState)(!1), [p, b] = (0, o.useState)(null), k = (0, z.useIntl)(), {
            track: h
          } = (0, m.useGtmTrack)(), v = {
            ...
            buttons: [{
              buttonText: k.formatMessage(G.ns_yes_subscribe_text),
              onClick: () => {
                y()
              }
            }, {
              buttonText: k.formatMessage(G.ns_go_back_text),
              onClick: () => {
                s(null), c(!1)
              }
            }]
            ...
            text: "subscribe now"
          }), a.loggedIn || (window.location.href = v.auth), a.loggedIn && a.isAMinor ? (x(W.ERROR_GENERIC), f(!1), void h({
            event: "alert_error",
            text: "error message with no preferences link",
            element_placement: "newsletter subscribe"
          })) : a.loggedIn && !p || a.loggedIn && 3 == p ? void j() : a.loggedIn && p ? (h({
            event: "alert_update",
            text: "alert - user already subscribed",
            element_placement: "newsletter subscribe"
          }), x(W.ALREADY_SUBSCRIBED), void f(!1)) : void 0), N = () => {
            (async () => {
              const {
                error: t = null,
                result: s
              ...
              if (t) b(0);
                ...
                b(t), a.isFromAuth && (t => {
                  ...
                  const s = (() => {
                    const e = new Date(a.token["scAuth.MemberSince"]),
                      t = new Date;
                    return (0, H.M)(t, e) < 12
                  })();
                  switch (t) {
            ...
            (async () => {
              const {
                error: e = null,
                result: t
              } = await (0, d.coreScApiFetch)("marketing/update?subscribe=true", {
                fetchOptions: {
                  method: "POST"
                },
                pingBearer: a.pingBearer
              });
              if (e) b(0), x(W.ERROR_GENERIC), h({
                event: "alert_error",
      ...
      const ee = {
        ...
        ae = e => {
          ...
          return o ? r && (0, u.jsx)("a", {
            className: [ee.dialogButton, ee.link, ee[s], i].join(" "),
            href: l,
            ...m && {
              "data-testid": m
            },
            ...
            className: [ee.dialogButton, ee[s], i].join(" "),
            disabled: c,
            onClick: e => (e => {
        ...
        se = e => {
          ...
          if (r) return (0, u.jsxs)("dialog", {
            ...
            children: [a && (0, u.jsx)("i", {
              ...
              children: n.slice(0, 2).map(((e, a) => (0, u.jsx)(ae, {
      ...
      const ie = {
        ...
        ce = e => {
          ...
          const [f, p] = (0, o.useState)(!1), b = (0, z.useIntl)(), {
            track: k
          } = (0, m.useGtmTrack)(), {
            ref: h,
            inView: v
            ...
            buttonText: b.formatMessage(G.ns_ok_button_text),
            onClick: () => {
              c(!1)
            },
            extraClasses: ie.alertBtnClass,
            ctaClasses: ie.ctaText,
            testId: "ok-btn"
          }, {
            buttonText: d?.showManagePreferences && b.formatMessage(G.ns_manage_prefs_button_text),
            isLink: !0,
            link: s.preferences,
            extraClasses: ie.alertLinkClass,
          ...
          return (0, o.useEffect)((() => {
            ...
            children: [!g && (0, u.jsx)("div", {
              className: re()(ie.newsletterSubscription),
              ...
              children: (0, u.jsx)("section", {
                ...
                children: (0, u.jsx)("div", {
                  className: ie.inner,
                  children: a ? (0, u.jsx)(J.A, {}) : (0, u.jsxs)(u.Fragment, {
                    children: [(0, u.jsx)(Z, {
                      disableLink: !0,
                      className: ie.fadeIn
                    }), (0, u.jsxs)("div", {
                      ...
                      children: [(0, u.jsx)(Y.Heading, {
                        level: 4,
                        className: [ie.heading, ie.fadeIn].join(" "),
                        children: (0, u.jsx)(z.FormattedMessage, {
                          ...G.ns_cta_title
                        })
                      }), (0, u.jsx)(Y.Paragraph, {
                        className: [ie.copy, ie.fadeIn].join(" "),
                        children: (0, u.jsx)(z.FormattedMessage, {
                          ...G.ns_cta_text
                        })
                      })]
                      ...
                      allCaps: !0,
                      onPress: n,
                      className: ie.newsletterSubBtn,
                      isDisabled: r,
                      "data-testid": "sub-btn",
                      children: [(0, u.jsx)(z.FormattedMessage, {
                        ...G.ns_cta_button_text
                      }), r && (0, u.jsx)("div", {
                        className: ie.buttonLoader,
                        children: (0, u.jsx)(J.A, {})
                      })]
                    }) : s?.auth && (0, u.jsx)(l.Link, {
                      className: re()(ie.btnPrimary, ie.newsletterSubBtn),
                      to: s.auth,
      ...
      const ge = e => {
        ...
        ue = "rockstargames-sites-gta-gen9c4aa8e5d29b433c400796d0c493a9a4d",
        fe = e => {
          let {
            minOffset: a = 0,
            maxOffset: t = 0,
          ...
          return "horizontal" === s ? (0, u.jsx)(me.kQ, {
            x: [a, t],
            className: (0, N.classList)(ue, n),
            styleOuter: r,
            children: i
          }) : (0, u.jsx)(me.kQ, {
            y: [a, t],
        ...
        ke = e => {
          ...
          return (0, u.jsx)(me.zE, {
            scrollAxis: a,
            children: (0, u.jsx)(pe, {
              children: (0, u.jsx)("div", {
                className: (0, N.classList)(be.parallaxWrapper, be[t]),
                style: s,
          ...
          return (0, o.useEffect)((() => {
            ...
            children: (0, u.jsx)("div", {
              ...
              children: (0, u.jsxs)(y.motion.div, {
                ...
                ref: b,
                children: [(0, u.jsx)("div", {
                  className: [xe.promoModuleImage, i ? xe.gradient : "", "left" === l ? xe.left : xe.right].join(" ")
                }), (0, u.jsxs)("div", {
                  className: xe.promoModuleContentContainer,
                  children: [(0, u.jsx)(M, {
                    brands: t,
                    className: xe.promoModuleBrands
                  }), (0, u.jsxs)("div", {
      ...
      const je = {
        ...
        Se = e => {
          ...
          const {
            ...
            refetch: c
          } = (0, O.useQuery)(Ne.UserGetVote, {
            skip: !0
          }), [l] = (0, O.useMutation)(Ne.UserCastVote), [d, g] = (0, o.useState)(null), f = (0, o.useCallback)((async e => {
            r({
            ...
            children: (0, u.jsxs)("div", {
              ...
              children: [(0, u.jsxs)("div", {
                ...
                children: [(0, u.jsx)("button", {
                  onClick: () => f(!0),
                  className: [je.upVote, d ? je.voteButtonActive : ""].join(" "),
                  type: "button",
                  "aria-label": "Vote up"
                }), (0, u.jsx)("button", {
                  className: [je.downVote, !1 === d ? je.voteButtonActive : ""].join(" "),
                  onClick: () => f(!1),
                  type: "button",
        ...
        Qe = e => {
          ...
          return (0, u.jsxs)("header", {
            ...
            children: [o.Children.map(r, (e => (0, o.cloneElement)(e, {
              ...
              children: [!0 === d?.hasPlatformOptions && (0, u.jsx)(Ke, {
                title: t,
                platformOptions: d,
                pricingOptions: i,
                setPricingContainerHeight: c,
                expandedView: n
              }), !0 === i?.hasPricingOptions && (0, u.jsx)(De, {
                title: t,
                tag: i?._memoq?.tag,
                ...
                children: [M && (0, u.jsx)(Qe, {
                  ...
                  children: [(0, u.jsxs)("div", {
                    ...
                    children: [(0, u.jsx)(Le, {
                      ...
                      }), !0 === v?.hasPricingOptions && (0, u.jsx)(De, {
                        title: r,
                        showTitle: !1,
                        showBackground: !1,
                        tag: v?._memoq?.tag,
      ...
      const sa = JSON.parse('{"us":{"card_label_platforms":"{title} on {platformList}","card_label_platforms_tag":"{tag} {title} on {platformList}","card_label_tag":"{tag} {title}"},"de":{"card_label_platforms":"{title} auf {platformList}","card_label_platforms_tag":"{tag} {title} auf {platformList}","card_label_tag":"{tag} {title}"},"es":{"card_label_platforms":"{title} para {platformList}","card_label_platforms_tag":"{tag} {title} para {platformList}","card_label_tag":"{tag} {title}"},"mx":{"card_label_platforms":"{title} en {platformList}","card_label_platforms_tag":"{tag} {title} en {platformList}","card_label_tag":"{tag} {title}"},"fr":{"card_label_platforms":"{title} sur {platformList}","card_label_platforms_tag":"{tag} {title} sur {platformList}","card_label_tag":"{tag} {title}"},"it":{"card_label_platforms":"{title} su {platformList}","card_label_platforms_tag":"{tag} {title} su {platformList}","card_label_tag":"{tag} {title}"},"jp":{"card_label_platforms":"{platformList}版{title}","card_label_platforms_tag":"{tag} {platformList}版 {title}","card_label_tag":"{tag} {title}"},"kr":{"card_label_platforms":"{platformList}용 {title}","card_label_platforms_tag":"{tag} {platformList}용 {title}","card_label_tag":"{tag} {title}"},"pl":{"card_label_platforms":"{title} na {platformList}","card_label_platforms_tag":"{tag} {title} na {platformList}","card_label_tag":"{tag} {title}"},"br":{"card_label_platforms":"{title} para {platformList}","card_label_platforms_tag":"{tag} {title} para {platformList}","card_label_tag":"{tag} {title}"},"ru":{"card_label_platforms":"{title} на {platformList}","card_label_platforms_tag":"{title} ({tag}) на {platformList}","card_label_tag":"{title} ({tag})"},"hans":{"card_label_platforms":"{platformList} 上的 {title}","card_label_platforms_tag":"{tag} {platformList} 上的 {title}","card_label_tag":"{tag} {title}"},"tw":{"card_label_platforms":"{platformList} 上的 {title}","card_label_platforms_tag":"{tag} {platformList} 上的 {title}","card_label_tag":"{tag} {title}"}}'),
        ...
        ra = (0, z.withIntl)((e => {
          ...
          const {
            formatMessage: v,
            formatList: x
          } = (0, z.useIntl)(), [_, y] = (0, l.useSearchParams)(), N = (0, o.useRef)(null), [, j] = (0, ta.h)(), {
            track: S
        ...
        ca = e => {
          ...
          const M = (0, N.useTinaComponents)(),
            ...
            L = [ia.card, T ? ia.coverCardWrapper : ""].join(" ");
          return (0, u.jsx)(ra, {
            id: m,
            position: g,
            sectionTitle: f,
        ...
        pa = e => {
          ...
          const l = (0, o.useMemo)((() => a?.length && 0 !== a.length ? a.map((e => (0, u.jsx)(la, {
            className: (0, N.classList)(oa[e?.specialClass] ?? oa.imageMask, oa[e?.sizeClass], e?.className),
          ...
          return (0, u.jsx)(la, {
            className: (0, N.classList)(oa.layeredImageFrame, a.length > 1 ? oa.layered : oa.flat, t),
            style: r,
        ...
        ba = e => {
          ...
          return "linkout" === a && t ? (0, u.jsx)(K.A, {
            to: t,
            style: n,
        ...
        va = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            expandedCardContents: (0, u.jsx)(pa, {
              images: c,
              prod: x,
              expandedView: !0
            }),
        ...
        Na = (0, z.withIntl)((e => {
          ...
          return (0, u.jsxs)("div", {
            ...
            children: [(0, u.jsx)("h4", {
              ...
              children: (0, u.jsx)(z.FormattedMessage, {
                ...xa.components_track_list_title
              })
            }), (0, u.jsx)("div", {
      ...
      const Ia = {
        ...
        Ea = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            textOverlayProps: f,
            modalProps: {
              className: Ia.customModal,
              contentClassName: Ia.customModalContent
            },
            expandedCardContents: (0, u.jsx)(pa, {
              images: p,
              expandedView: !0
            ...
            children: (0, u.jsx)(ba, {
              ...
              children: (0, u.jsxs)("div", {
                ...
                children: [t && (0, u.jsx)("img", {
                  ...
                  to: d || void 0,
                  children: l || _.formatMessage(Ca.card.card_learn_more)
                })]
              })
            })
          })
      ...
      var Aa = t(81902),
        La = t(89269);
      const Pa = "rockstargames-sites-gta-gen9eca98eb0b5b84a0c9a2e6d952545a2d5",
        Ba = "rockstargames-sites-gta-gen9d3d0b4ecd3bddba96c73f49fcca34ed8",
        $a = {
          0: {
            spaceBetween: 8
          },
        ...
        Ra = e => {
          ...
          const {
            track: l
          } = (0, m.useGtmTrack)(), [d, g] = (0, o.useState)([La.U1, La.WO, La.dK]), [f, p] = (0, o.useState)(null), [b, k] = (0, o.useState)(null);
          return (0, o.useEffect)((() => {
            const e = [La.U1, La.WO, La.dK];
            n && e.push(La.Vx), g(e)
          }), [n]), (0, o.useEffect)((() => {
            if (!r) return;
            const e = r.map(((e, a) => (0, u.jsx)(Aa.qr, {
              children: e
            }, Symbol(a).toString())));
            k(e)
        ...
        Va = e => {
          ...
          const i = (0, o.useMemo)((() => a && 0 !== a?.length ? a.map((e => e?.image?.sources ? (0, u.jsx)(ve.A, {
            ...e,
            style: {
        ...
        Fa = e => {
          ...
          const b = (0, N.useTinaPayload)(),
            ...
            [x, _] = (0, o.useState)(l?.size ?? n),
            {
              ...
              main: j,
              thumbs: S
            } = za?.cardWithImageGallery?.gallery ?? {};
          return (0, o.useEffect)((() => {
            _(l?.size ?? n)
          }), [l?.size, n]), (0, u.jsx)(ca, {
            id: a,
            ...
            deckProps: l,
            prod: h,
            variants: za.cardWithImageGallery,
            textOverlayProps: i,
            modalProps: {
              className: Oa.customModal,
              contentClassName: Oa.customModalContent
            },
            expandedCardContents: (0, u.jsx)(Va, {
              images: v,
              title: t,
              navigation: !0,
              thumbsVisible: !0,
      ...
      const Xa = {
        ...
        Ka = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            children: [(0, u.jsx)("div", {
              className: [Xa.controlsCurrentBg, h ? Xa.controlsCurrentBgVisible : ""].join(" ")
            }), (0, u.jsx)("div", {
              className: Xa.controlsTrack,
              ref: f,
              children: (0, u.jsx)("span", {
                className: [Xa.controlsTrackTitle, b ? Xa.controlsTrackAnimating : ""].join(" "),
                ref: p,
                children: c.title
              })
            }), (0, u.jsxs)("div", {
              className: Xa.controlsButtons,
              children: [(0, u.jsx)("div", {
                className: Xa.controlsPrevTrack,
                onClick: () => {
                  d && (l(d[0]), m(!0), n(!0))
                }
              }), (0, u.jsx)("div", {
                className: [Xa.controlsPlayPause, t ? Xa.controlsPlayPausePlaying : ""].join(" "),
                onClick: () => {
                  n(!t)
                }
              }), (0, u.jsx)("div", {
                className: Xa.controlsNextTrack,
                onClick: () => {
                  d && (l(d[1]), m(!0), n(!0))
                }
              })]
              ...
              active: r ? "" : null,
              className: Xa.controlsTrackBurger,
              children: (0, u.jsx)("div", {
                className: Xa.iconBurger,
                onClick: () => {
                  i(!r)
                }
              })
            }), (0, u.jsxs)("div", {
              className: Xa.controlsScrub,
              children: [(0, u.jsx)("span", {
                children: x(a.current)
              }), (0, u.jsx)("div", {
                className: Xa.controlsScrubTrack,
                ref: g
              }), (0, u.jsx)("span", {
        ...
        Qa = e => {
          ...
          return (0, u.jsxs)("div", {
            ...
            children: [(0, u.jsx)("h4", {
              ...
              className: Xa.trackBurger,
              onClick: () => {
                r(!n)
              }
            }), (0, u.jsx)("div", {
              className: Xa.trackList,
              children: a.map(((e, a) => (0, u.jsxs)("a", {
                style: {
                  "--highlight-color": e.color
                },
                className: t === e.id ? Xa.trackActive : "",
                onClick: () => {
                  s(e.id), i(!0), c(!0)
                },
                children: [(0, u.jsx)("span", {
                  className: Xa.trackIndex,
                  children: String(a + 1).padStart(2, "0")
                }), (0, u.jsx)("span", {
                  className: Xa.trackTitle,
                  children: e.title
                }), (0, u.jsx)("span", {
                  className: Xa.trackTime,
                  children: e.duration
                })]
              }, e.id)))
            })]
        ...
        Za = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            className: [Xa.player, Xa[t], m ? Xa.tracksOpen : ""].join(" "),
      ...
      const tt = e => {
          ...
          const [r, i] = (0, o.useState)(""), c = (0, o.useMemo)((() => at()().getData()), []);
          return (0, u.jsx)(Ja.Ay, {
            unstyled: !0,
            value: r,
            isMulti: a,
            allowSelectAll: t,
      ...
      var nt = t(26371),
        rt = t(52328);
      const it = "rockstargames-sites-gta-gen9c63cfb461217f059c8c25eec09602b30",
        ct = e => {
          let {
            color: a
          } = e;
      ...
      const lt = {
        ...
        dt = e => {
          ...
          let i = null;
          return i = ot.Ay, (0, u.jsx)(i, {
            disabled: !n,
            children: (0, u.jsxs)("div", {
              className: [lt.dropdownWrapper, n ? lt.open : "", void 0 !== t ? t : ""].join(" "),
              children: [(0, u.jsx)("button", {
                className: lt.opener,
                onClick: () => r(!n),
                children: s
        ...
        bt = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            "data-game": r,
            className: [pt.gameSiteHeader, i ? pt.headerNavOpen : "", d ? pt.navHidden : "", t.gameSiteHeader, i ? t.headerNavOpen : ""].join(" "),
            children: [(0, u.jsx)("button", {
              className: [pt.headerLogo, t.headerLogo].join(" "),
              onClick: e => {
        ...
        vt = (0, z.withIntl)((e => {
          ...
          const {
            track: i
          } = (0, m.useGtmTrack)(), c = (0, z.useIntl)(), [l, d] = (0, z.getLocale)(), [g, f] = (0, o.useState)(!1), p = (0, o.useMemo)((() => (0, F.A)()), []), b = (0, o.useCallback)((e => {
            let a = n.pathname.replace(/^\/|\/$/g, "");
            const t = a.split("/");
            return z.locales.map((e => e.subdomaincom)).includes(t[0]) && (a = t.slice(1).join("/")), p.currentSite?.site === F.C.www ? "en" === e ? `${window.location.origin}/${a}${n.search}` : `${window.location.origin}/${e}/${a}${n.search}` : `${window.location.origin}/${a}${n.search}`
            ...
            const a = z.locales.find((a => a.subdomaincom === e));
            if (a) {
              const t = b(e);
              i({
                event: "cta_other",
          ...
          return (0, o.useEffect)((() => {
            ...
            className: [ht.languageSelector, g ? ht.open : ""].join(" "),
            "data-theme": a,
            children: [x && "sc-menu" === a && (0, u.jsx)("div", {
              ...
              children: (0, u.jsxs)("select", {
                ...
                "aria-label": c.formatMessage(kt.language_selector_default),
        ...
        _t = e => {
          ...
          return n && (s["--border-image-source"] = `url(${r})`), (0, u.jsx)("div", {
            className: (0, N.classList)(xt.border, t),
            style: {
              ...s
            }
          })
        ...
        yt = e => e?.images ? (0, u.jsx)("div", {
          className: (0, N.classList)(xt.layeredImage, xt[e?.variantClass], xt[e?.wrapperSizeClass]),
          style: {
            ...e?.style ?? {}
          },
          children: (0, u.jsxs)("div", {
            ...
            children: [e?.images?.map(((e, a) => {
              ...
              return (0, u.jsx)(ja.A, {
                ...
                imageStyle: d,
                className: (0, N.classList)(l, g, xt.imageLayer, xt[s], xt[n], xt[r], xt[i], xt[c]),
                alt: m
              }, o ?? a + 1)
            })), e?.borderImage && (0, u.jsx)(_t, {
              style: e?.borderImage,
        ...
        jt = e => {
          ...
          return (0, u.jsxs)("div", {
            ...
            children: [!l && (0, u.jsx)("img", {
              className: [t, Nt.animatePlaceholder].join(" "),
              src: "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTkyMCIgaGVpZ2h0PSIxMDgwIiB2aWV3Qm94PSIwIDAgMTkyMCAxMDgwIiBmaWxsPSJub25lIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPgo8cmVjdCB3aWR0aD0iMTkyMCIgaGVpZ2h0PSIxMDgwIiBmaWxsPSIjMzMzMzMzIi8+Cjwvc3ZnPgo=",
              sizes: "(max-width: 1024px) 100vw, 1024px",
              alt: "Loading...",
              style: n
            }), (0, u.jsx)("img", {
              className: [Nt.multiSourceImage, t].join(" "),
      ...
      const wt = {
        ...
        Ct = e => {
          ...
          const r = (0, u.jsxs)("div", {
            style: n,
            className: [wt.tag, a].join(" "),
            children: [(0, u.jsx)("i", {}), s]
          });
          return void 0 !== t ? (0, u.jsx)(K.A, {
            to: t,
            children: r
          }) : r
        },
        ...
        It = e => {
          ...
          return (0, u.jsx)(K.A, {
            to: s.url,
            className: [Tt.newswireBlock, n ? Tt.newswireBlockNoSpecialOrder : "", null !== p ? Tt.startAnimation : ""].join(" "),
            focused: r,
            onClick: h,
            children: (0, u.jsxs)(u.Fragment, {
              children: [0 !== t || c.get("tag_id") ? (0, u.jsx)("div", {
                ...
                children: [(0, u.jsxs)("div", {
                  className: Tt.top,
                  children: [s.primary_tags.length ? (0, u.jsx)(Ct, {
      ...
      var Mt = t(31955),
        Et = t.n(Mt);
      const At = (0, d.withTranslations)((e => {
          let {
            section: a = "",
            relativeTo: t = "",
            tagId: s = null,
          ...
          const {
            track: i
          } = (0, m.useGtmTrack)(), [c] = (0, l.useSearchParams)(), {
            tagId: d = null
          } = (0, l.useParams)(), [g, f] = (0, o.useState)(d ?? s ?? c.get("tag_id")), [p, b] = (0, o.useState)(1), [k, h] = (0, o.useState)([]), [v, x] = (0, o.useState)(null), {
            data: _
          } = (0, O.useQuery)(Et(), {
            variables: {
              tagId: Number(g),
          ...
          return (0, o.useEffect)((() => {
            b(1), h([]), f(d ?? s ?? c.get("tag_id"))
          }), [c.get("tag_id")]), (0, o.useEffect)((() => {
            _ && _.posts && _.posts.paging && x(_.posts.paging), _ && _.posts && _.posts.results && h(k.concat(_.posts.results))
          }), [_]), k.length ? (0, u.jsxs)(u.Fragment, {
            children: [(0, u.jsx)($t, {
              section: a,
              posts: k,
              relativeTo: t,
              noSpecialOrder: null !== g
            }), null !== v && v.nextPage ? (0, u.jsx)(Ta.A, {
              onClick: e => {
                b(p + 1), i({
                  event: "cta_learn",
                  text: "more stories",
        ...
        Pt = (0, d.withTranslations)((e => {
          let {
            posts: a,
            t
          } = e;
          return (0, u.jsxs)("section", {
            className: Lt.related,
            children: [(0, u.jsx)("h2", {
              children: t("Related Stories")
            }), (0, u.jsx)("div", {
              className: [Lt.posts, 1 === a.length ? Lt.just1post : ""].join(" "),
              children: a.map((e => (0, u.jsx)(It, {
                noSpecialOrder: !0,
                post: e
              }, e.id)))
            })]
        ...
        $t = (0, d.withGtmTracking)((e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            className: [Bt.newswireBlocks, t ? Bt.noSpecialOrder : "", Bt.contextHome].join(" "),
            children: s.map(((e, s) => (0, u.jsx)(It, {
              section: a,
              index: s,
              noSpecialOrder: t,
              post: e,
      ...
      var Rt = t(26889),
        Vt = t(83082);
      const Ot = "rockstargames-sites-gta-gen9c54c374409e11d1429ce99457cbf7441",
        Dt = e => {
          let {
            children: a,
            data: t,
      ...
      var Ft = t(67446),
        Ht = t(90250);
      const Gt = (0, O.makeVarNamespace)("@rockstargames/components/profile-switcher"),
        Wt = Gt("languageSelectorOpenedReactive", !1),
        Ut = e => Wt(e),
        qt = Gt("activeSubNavIdReactive", -1),
        Xt = e => qt(e),
        Yt = Gt("subNavExtraHeightReactive", -1),
        Kt = e => Yt(e),
        Qt = Gt("scNavOpenedReactive", !0),
        Zt = e => Qt(e),
        Jt = Gt("charListHiddenReactive", !0),
        es = e => Jt(e),
        as = () => {
          const e = (0, O.useReactiveVar)(Wt),
            a = (0, O.useReactiveVar)(qt),
            t = (0, O.useReactiveVar)(Yt),
            s = (0, O.useReactiveVar)(Qt),
            n = (0, O.useReactiveVar)(Jt);
          return (0, o.useEffect)((() => {
            n || (e && Ut(!1), s && (Zt(!1), Xt(-1)))
          }), [n]), (0, o.useEffect)((() => {
            !e && n && (s || Zt(!0))
          }), [e, n]), (0, o.useMemo)((() => ({
      ...
      const rs = {
        ...
        is = e => ({
          text: e.formatMessage(ts.A.sc_link_help),
          target: "_self",
          ga: {
            ...rs,
            text: ts.A.sc_link_help.defaultMessage
          },
          dataTestId: "helpButton",
          children: [{
            text: e.formatMessage(ts.A.sc_link_support),
            location: {
              domain: F.C.support,
              path: "/"
            },
            ...
            ga: {
              ...rs,
              text: ts.A.sc_link_support.defaultMessage
            },
            dataTestId: "supportLink"
          }, {
            text: e.formatMessage(ts.A.sc_link_legal),
            location: {
              domain: F.C.www,
              path: "/legal"
            },
            ...
            ga: {
              ...rs,
              text: ts.A.sc_link_legal.defaultMessage
            },
            dataTestId: "legalLink"
          }, {
            text: e.formatMessage(ts.A.sc_link_privacy_policy),
            location: {
              domain: F.C.www,
              path: "/privacy"
            },
            ...
            ga: {
              ...rs,
              text: ts.A.sc_link_privacy_policy.defaultMessage
            },
            dataTestId: "privacyPolicyLink"
          }, {
            text: e.formatMessage(ts.A.sc_link_cookies_policy),
            location: {
              domain: F.C.www,
              path: "/cookies"
            },
            ...
            ga: {
              ...rs,
              text: ts.A.sc_link_cookies_policy.defaultMessage
            },
            dataTestId: "cookiesPolicyLink"
          }, {
            text: e.formatMessage(ts.A.sc_link_cookies_settings),
            onClickCallback: e => {
            ...
            ga: {
              ...rs,
              text: ts.A.sc_link_cookies_settings.defaultMessage
            },
            dataTestId: "cookiesSettingsLink"
          }, {
            text: e.formatMessage(ts.A.sc_link_do_not_sell_my_information),
            location: {
              domain: F.C.www,
              path: "/ccpa"
            },
            ...
            ga: {
              ...rs,
              text: ts.A.sc_link_do_not_sell_my_information.defaultMessage
            },
        ...
        os = e => {
          ...
          const {
            track: p
          } = (0, m.useGtmTrack)(), b = (0, F.A)(), k = (0, z.useIntl)();
          let h = s;
          ...
          return (0, u.jsxs)(cs, {
            ...
            children: [a, o && (0, u.jsx)("div", {
              ...
              children: (0, u.jsx)("span", {
                ...
                children: k.formatMessage(ts.A.nofications_new)
              })
            })]
          })
        },
        ls = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            children: [(0, u.jsxs)("button", {
              ...
              children: g.map((e => (0, o.createElement)(os, {
                ...e,
                isSubLink: !0,
                key: e.text,
                tabIndex: I || !N ? -1 : 0,
        ...
        ds = e => {
          ...
          const {
            windowWidth: n,
            windowHeight: r
          } = (0, d.useWindowResize)(), i = (0, z.useIntl)(), {
            ...
            navOpen: h
          } = (0, m.useRockstarUserState)(), v = (0, d.useLocale)(), x = (0, d.toScLocaleString)(v), [_, y] = (0, o.useState)(""), N = `${a.login}?returnUrl=${_}&lang=${x}`, j = `${a.signup}&returnUrl=${_}&lang=${x}`, S = (0, o.useMemo)((() => (0, F.A)()), []), w = (0, o.useMemo)((() => {
            const e = ((e, a, t) => [{
              text: e.formatMessage(ts.A.sc_link_sign_in),
              href: a,
              ga: {
                event: "cta_login",
                text: ts.A.sc_link_sign_in.defaultMessage,
                element_placement: "Account Menu"
              },
              dataTestId: "loginLink"
            }, {
              text: e.formatMessage(ts.A.sc_link_join_social_club),
              href: t,
              ga: {
                event: "cta_signup",
                text: ts.A.sc_link_join_social_club.defaultMessage,
                element_placement: "Account Menu"
              },
          ...
          return (0, o.useEffect)((() => {
            ...
            children: [(0, u.jsx)("nav", {
              ...
              children: (0, u.jsx)("div", {
                ...
                children: w.map((e => (0, o.createElement)(ls, {
                  ...e,
                  activeSubNavId: g,
                  setActiveSubNavId: f,
                  setSubNavExtraHeight: b,
      ...
      const us = e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            children: [(0, u.jsx)("div", {
              ...
              children: (0, u.jsx)("img", {
                src: k,
                alt: r.formatMessage(ts.A.profile_selector_mugshot, {
                  userName: f
                }),
                onError: () => {
                  h(t(58989))
              ...
              children: [(0, u.jsxs)("div", {
                ...
                children: (0, u.jsxs)("div", {
                  ...
                  children: [(0, u.jsx)("img", {
                    ...
                    src: (0, ms.A)(b.overview.rank.value),
                    alt: r.formatMessage(ts.A.profile_selector_rp_icon)
                  }), (0, u.jsx)("span", {
        ...
        ps = e => {
          ...
          const {
            ...
            track: r
          } = (0, m.useGtmTrack)(), i = (0, z.useIntl)(), [c, l] = (0, o.useState)([]), [d, g] = (0, o.useState)(null), [f, p] = (0, o.useState)(null), [b, k] = (0, o.useState)(!1), [h, v] = (0, o.useState)(-1), [x, _] = (0, o.useState)([]), [y, N] = (0, o.useState)(0), j = t(58989), [S, w] = (0, o.useState)("0"), [C, T] = (0, o.useState)("0"), I = e => parseInt(e, 10).toLocaleString("en-US", {
            minimumFractionDigits: 0
          }), M = () => {
            A((0, u.jsx)("img", {
              src: j,
              alt: i.formatMessage(ts.A.profile_selector_mugshot, {
                userName: n.nickname
              })
            }))
              ...
              children: [(0, u.jsx)("div", {
                ...
                children: [(0, u.jsxs)("div", {
                  ...
                  children: [(0, u.jsx)("img", {
                    ...
                    src: (0, ms.A)(y),
                    alt: i.formatMessage(ts.A.profile_selector_rp_icon)
                  }), (0, u.jsx)("span", {
                    children: a.stats.overview.rank.value
                  })]
                }), (0, u.jsxs)("div", {
        ...
        vs = (0, d.withTranslations)((e => {
          ...
          const {
            windowWidth: b,
            windowHeight: k
          } = (0, d.useWindowResize)(), h = (0, z.useIntl)(), {
            ...
            setUserData: G
          } = (0, m.useRockstarUserState)(), [W, U] = (0, o.useState)(null), [q, X] = (0, o.useState)(null), [Y, K] = (0, o.useState)(!1), [Q, Z] = (0, o.useState)(!1), [J, ee] = (0, o.useState)(0), ae = (0, o.createRef)(), te = bs(ae, !1), se = (0, o.createRef)(), [ne, re] = (0, o.useState)(0), [ie, ce] = (0, o.useState)([]), [oe, le] = (0, o.useState)(244), de = (0, o.useRef)(null), me = (0, o.useMemo)((() => (0, F.A)()), []), ge = (0, o.useMemo)((() => ((e, a, t, s, n) => [{
            text: e.formatMessage(ts.A.sc_link_activity_feed),
            location: {
            ...
            ga: {
              ...rs,
              text: ts.A.sc_link_activity_feed.defaultMessage
            },
            dataTestId: "activityFeedLink"
          }, {
            text: e.formatMessage(ts.A.sc_link_account),
            target: "_self",
            dataTestId: "accountButton",
            children: [{
              text: e.formatMessage(ts.A.sc_link_settings),
              location: {
                domain: F.C.socialClub,
                path: "/settings"
              },
              ...
              ga: {
                ...rs,
                text: ts.A.sc_link_settings.defaultMessage
              },
              dataTestId: "settingsLink"
            }, {
              text: e.formatMessage(ts.A.sc_link_view_my_profile),
              href: t.profile_link,
              target: "_self",
              ga: {
                ...rs,
                text: ts.A.sc_link_view_my_profile.defaultMessage
              },
              dataTestId: "viewMyProfileLink"
            }, {
              text: e.formatMessage(ts.A.sc_link_messages),
              location: {
                domain: F.C.socialClub,
                path: "/message"
              },
              ...
              ga: {
                ...rs,
                text: ts.A.sc_link_messages.defaultMessage
              },
              dataTestId: "messagesLink"
            }, {
              text: e.formatMessage(ts.A.sc_link_game_activation),
              location: {
                domain: F.C.socialClub,
                path: "/activate"
              },
              ...
              ga: {
                ...rs,
                text: ts.A.sc_link_game_activation.defaultMessage
              },
              dataTestId: "gameActivationLink"
            }]
          }, {
            text: e.formatMessage(ts.A.sc_link_notifications),
            location: {
              domain: F.C.socialClub,
              path: "/notifications"
            },
            ...
            ga: {
              ...rs,
              text: ts.A.sc_link_notifications.defaultMessage,
              location: {
                domain: F.C.socialClub,
                path: "/notifications"
              }
            ...
            text: e.formatMessage(ts.A.sc_link_crews),
            location: {
              domain: F.C.socialClub,
            ...
            ga: {
              ...rs,
              text: ts.A.sc_link_crews.defaultMessage
            },
            dataTestId: "crewsLink"
          }, {
            text: e.formatMessage(ts.A.sc_link_friends),
            target: "_self",
            dataTestId: "friendsButton",
            children: [{
              text: e.formatMessage(ts.A.sc_link_my_friends),
              location: {
                domain: F.C.socialClub,
              ...
              ga: {
                ...rs,
                text: ts.A.sc_link_my_friends.defaultMessage
              },
              dataTestId: "myFriendsLink"
            }, {
              text: e.formatMessage(ts.A.sc_link_import_friends),
              location: {
                domain: F.C.socialClub,
                path: "/friends/import"
              },
              ...
              ga: {
                ...rs,
                text: ts.A.sc_link_import_friends.defaultMessage
              },
              dataTestId: "importFriendsLink"
            }, {
              text: e.formatMessage(ts.A.sc_link_find_friends),
              location: {
                domain: F.C.socialClub,
                path: "/members"
              },
            ...
            text: e.formatMessage(ts.A.sc_link_log_out),
            href: `${a.logout}?returnUrl=${n}`,
            target: "_self",
            reloadDocument: !0,
            ga: {
              ...rs,
              text: ts.A.sc_link_log_out.defaultMessage
            },
          ...
          return (0, o.useEffect)((() => {
            ...
            me.currentSite?.site === F.C.socialClub && (e = encodeURIComponent("/")), T(e)
          }), [f]), (0, o.useEffect)((() => {
            ce(A.characters[P] ?? [])
          }), [A, P]), (0, o.useEffect)((() => {
            A && G(A)
            ...
            if (!a) return;
            const t = null !== a ? (0, gs.A)(a.platform, "large") : null;
            ...
            e !== B && V(Math.max(0, Math.min(e, ie.length - 1)))
          }), [ie, I]), (0, u.jsxs)(u.Fragment, {
            children: [null !== W && "gtao" === P && (0, u.jsxs)("div", {
              className: hs.scProfile,
              ref: de,
              tabIndex: -1,
              "aria-label": h.formatMessage(ts.A.profile_selector_profile_card),
              children: [(0, u.jsx)(ps, {
                s: hs,
                character: W,
                platformTag: q
                ...
                children: [(0, u.jsx)("button", {
                  ...
                  children: (0, u.jsx)("span", {
                    children: (0, u.jsx)(z.FormattedMessage, {
                      ...ts.A.profile_selector_switch_character
                    })
                  })
                }), !1 === l && (0, u.jsx)("div", {
                  ...
                  children: (0, u.jsx)(ks, {
                    ...
                    disablePager: Q,
                    disableSwiper: Q,
                    children: ie.filter(((e, a) => a !== B)).map((e => (0, o.createElement)(us, {
                      characterData: e,
                      setMobileCardWidth: le,
                      key: e.mugshotUrl,
                      tabIndex: t ? -1 : 0
              ...
              children: [(0, u.jsx)("button", {
                ...
                children: ge.map(((e, a) => (0, o.createElement)(ls, {
                  ...e,
                  id: a,
                  activeSubNavId: _,
                  setActiveSubNavId: y,
        ...
        _s = (0, z.withIntl)((e => {
          ...
          const {
            windowHeight: n
          } = (0, d.useWindowResize)(), r = (0, z.useIntl)(), {
            ...
            track: S
          } = (0, m.useGtmTrack)(), [w, C] = (0, o.useState)(!1), T = (0, O.useReactiveVar)(m.scConfig), I = (0, o.useRef)(), [M, E] = (0, o.useState)(0), A = (0, o.createRef)(), [L, P] = (0, o.useState)(!1), [B, $] = (0, o.useState)(0), [R, V] = (0, o.useState)(!1), {
            mutateLSSettings: D,
            lsSettings: F
          ...
          return (0, o.useEffect)((() => {
            ...
            g && (i && c(!1), p || H(!0))
          }), [g]), null === x ? null : (0, u.jsxs)(Ht.A, {
            enabled: !!y,
            removeScrollBar: !1,
            children: [(0, u.jsxs)("div", {
              className: [xs.scMenu, y ? xs.navOpen : ""].join(" "),
              "data-logged-in": x,
              "data-mac-browser": R,
              "data-scroll-mode": k,
              ref: A,
              ...
              children: [(0, u.jsx)("button", {
                ...
                children: (0, u.jsx)("img", {
                  ...
                  src: t(68128),
                  alt: r.formatMessage(ts.A.sc_menu_drag_handle)
                })
              }), x ? (0, u.jsx)(vs, {
                sc: T,
                charListHidden: p,
              ...
              className: [xs.scOverlay, y ? xs.navOpen : ""].join(" "),
              "data-logged-in": x
            })]
          })
        }), oe),
        ...
        js = (0, z.withIntl)((e => {
          ...
          return (0, o.useEffect)((() => {
            const e = s?.id ?? !1,
              a = e ? (x?.[r]?.mugshotUrl ?? s?.avatar) || ys : Ns,
              t = (0, gs.A)(x?.[r]?.platform, "small") ?? null;
            k(t), g(a), p(e), v(!!x?.[r]?.mugshotUrl)
          }), [s, x, r, ys, Ns]), (0, u.jsxs)("button", {
            className: "rockstargames-sites-gta-gen9dc519cef2feb621e4715bd3fcdf09791",
            "data-img-set": h,
            "aria-label": t.formatMessage(i ? ts.A.sc_menu_close : ts.A.sc_menu_open),
            "aria-expanded": i,
            type: "button",
            onClick: y,
        ...
        $s = e => {
          ...
          return (0, u.jsx)("section", {
            className: [Bs.responsiveSection, void 0 !== t ? t : ""].join(" "),
            style: s,
            children: n ? (0, u.jsx)("div", {
              className: Bs.maxWidth,
              children: a
            }) : a
          })
        };
      ...
      const Ws = e => {
        ...
        qs = e => {
          ...
          return (0, u.jsx)("div", {
            className: [Us.screencap, n ? Us.screencapLoaded : ""].join(" "),
            style: {
        ...
        Ks = (0, d.withLocale)((e => {
          ...
          return (0, o.useEffect)((() => {
            ...
            const a = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
              ...
              o = e => {
                g(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !p.current?.classList.contains(Ys.dragging) || a() && r(!0)
              },
              l = () => {
                a() && r(!1), g(0)
              },
              d = e => {
                "press" === e.type && f.current?.classList.add(`${Ys.disableClick}`), "tap" === e.type && (f.current?.classList.remove(`${Ys.disableClick}`), document.elementFromPoint(e.center.x, e.center.y).click())
              },
              m = () => {
                a() && r(!1), f.current && f.current.classList.remove(`${Ys.disableClick}`)
              },
              u = () => {
                a() && r(!1)
              };
            ...
            children: [(0, u.jsx)("div", {
              ...
              children: (0, u.jsx)("div", {
                ...
                children: s.map(((e, a) => (0, u.jsx)(K.A, {
                  "data-gtm-category": "Carousel",
                  "data-gtm-action": "Click-through screencap",
                  "data-gtm-label": `/videos/${e.id}`,
                  to: `/videos/${e.id}`,
                  className: i === a ? Ys.active : "",
                  role: "link",
                  title: e.title,
                  tabIndex: i === a ? 0 : -1,
                  children: (0, u.jsx)(qs, {
      ...
      const Js = e => {
        ...
        an = e => {
          ...
          return (0, u.jsx)(K.A, {
            ...
            to: t ?? n,
            target: "_self",
            className: [en.fobLink, r ? en.wide : ""].join(" "),
            children: (0, u.jsx)(Js, {
              title: a.title,
              titleSlug: s,
              isWideCard: r
        ...
        sn = (0, z.withIntl)((e => {
          ...
          return x = "games" === c ? (0, u.jsx)(u.Fragment, {
            children: t.results.map(((e, a) => "775700as" !== e.id && (0, u.jsx)(Aa.qr, {
              className: tn.slide,
              onFocus: () => v(a),
              children: (0, u.jsx)(an, {
                game: e,
            ...
            children: a.map(((e, a) => (0, u.jsx)(Aa.qr, {
              className: tn.slide,
              onFocus: () => v(a),
              children: (0, u.jsx)(Xs, {
                video: e,
            ...
            className: tn.videoList,
            children: [(0, u.jsxs)("h3", {
              className: tn.sectionHeader,
              children: [s, (0, u.jsxs)("div", {
                className: tn.arrowNav,
                children: [(0, u.jsx)("button", {
                  className: [tn.arrow, tn.previous].join(" "),
                  type: "button",
                  ref: k,
                  "aria-label": r.formatMessage(Qs.previous_button_label)
                }), (0, u.jsx)("button", {
                  className: [tn.arrow, tn.next].join(" "),
                  type: "button",
                  ref: h,
              ...
              className: [tn.items, p % 1 != 0 ? tn.partial : ""].join(" "),
              children: (0, u.jsx)("div", {
                className: tn.trackWrapper,
                children: p && (0, u.jsx)(Aa.RC, {
                  className: tn.track,
                  slidesPerView: p,
                  spaceBetween: 24,
                  onInit: e => {
      ...
      const {
        Gen9CoreCarousel: ln,
        framer: dn,
        useTinaModuleFetchByIds: mn,
        withSimpleErrorBoundary: gn
      } = r, un = {
        Card: va,
      ...
      const kn = (e, a) => {
        ...
        vn = e => e.scrollHeight > e.clientHeight;
      ...
      function xn(e, a) {
        ...
        return R().forOwn(e, ((e, s) => {
          ...
          } else R().isObject(e) && !R().isArray(e) ? xn(e, a) : R().isArray(e) && (t[s] = e.map((e => R().isObject(e) ? xn(e, a) : e)))
        })), t
      }
      const _n = (0, d.withTranslations)((e => {
          let {
            active: a,
            styles: t,
            title: s,
          ...
          const S = (0, z.useIntl)(),
            ...
            Le = (0, o.useMemo)((() => we?.foreignId), [we]),
            Pe = (0, o.useMemo)((() => we?.foreignTitle), [we]),
            [Be, $e] = (0, o.useState)(0),
            [Re, Ve] = (0, o.useState)(0),
          ...
          return (0, o.useEffect)((() => {
            ...
            const e = ns()(((e, a) => {
              let t = 18;
              if (e?.documentElement && (t = kn(e?.documentElement, "--root-font-size")), re !== a.innerHeight && ie(a.innerHeight), g?.current) {
                Z(kn(g.current, "--eventDeck-marginSm") * t);
                const e = t * kn(g?.current, "--eventDeck-modalGutters"),
                  s = a?.innerWidth,
                  n = s - 2 * e;
                R(n), M.current && d && O(n), F(kn(g.current, "--eventDeck-itemSize") * t), oe(kn(g.current, "--eventDeck-phaseOneTransitionDuration"));
                const r = kn(g?.current, "--eventDeck-itemImageTitleMargins") * t,
                  i = T?.current?.clientHeight,
                  c = i + r;
                Number.isNaN(c) || X(c), ne(kn(g?.current, "--eventDeck-headerHeight") * t)
              }
            ...
            E.current ? xe(vn(E.current)) : xe(!1), void 0 !== c && c.current ? ye(vn(c.current)) : ye(!1)
            ...
            tabIndex: Je,
            "aria-label": r ? S.formatMessage(Ca.card.events_deck_modal_group_label) : Ie,
            ...
            children: [(0, u.jsxs)("div", {
              ...
              children: [Ee && (0, u.jsx)("img", {
                ...
                alt: Me?.alt,
                style: {
                  width: 0 !== V && d ? `${V}px` : null,
                  height: 0 !== V && d ? `${V}px` : null
                }
              }), (0, u.jsxs)("div", {
        ...
        yn = "rockstargames-sites-gta-gen9bb65eb1ac15ed189c1a9f6700276efc0",
        Nn = e => {
          let {
            prevPage: a,
            prevBtnDisabled: t,
          ...
          return (0, u.jsxs)(u.Fragment, {
            children: [(0, u.jsxs)("div", {
              ...
              children: [(0, u.jsx)("button", {
                ...
                onClick: a,
                disabled: t,
                "aria-label": o ? d.formatMessage(Ca.card.events_deck_modal_previous_aria_label) : d.formatMessage(Ca.card.events_deck_previous_aria_label)
              }), (0, u.jsxs)("span", {
                className: "rockstargames-sites-gta-gen9a94a647e9943db9c97ae87c8c6a162cd",
                "aria-hidden": !o,
                "aria-label": d.formatMessage(Ca.card.events_deck_paging_label, {
                  currentPage: r + 1,
                  totalPages: i.length
                }),
                ...
                onClick: s,
                disabled: n,
                "aria-label": o ? d.formatMessage(Ca.card.events_deck_modal_next_aria_label) : d.formatMessage(Ca.card.events_deck_next_aria_label)
              })]
            }), (0, u.jsx)("button", {
              className: "rockstargames-sites-gta-gen9d43b6cdcbcc07082edacd9a7cb1598c5",
              type: "button",
              onClick: c,
              "aria-label": d.formatMessage(Ca.card.events_deck_modal_close_label),
              "aria-hidden": !o,
              tabIndex: o ? 0 : -1
            })]
          })
      ...
      const Gn = {
          ...
          CardWithImageGallery: Fa,
          ConditionalBlock: b,
          CommunityChallenges: An(),
          CoverCard: Ea,
          Cta: k.A,
          DiscoveryCallout: Ln.A,
          EventsDeck: e => {
            const {
              setBodyIsLocked: a
              ...
              const {
                data: e
              } = (0, O.useQuery)(wa.TinaModulesList, {
                variables: {
              ...
              if (!0 === t && 0 !== e.itemNumber) {
                const t = kn(e?.element?.current, "top");
                let n = t - J;
              ...
              const n = oe * de,
                r = !1 === Ve ? z * Ha() : n;
              return e.inModalMode && Ve ? -1 === a ? za() * (je - e.itemNumber) * -1 - e.styles.left : za() * (e.itemNumber - je) - e.styles.left : -1 === a ? -1 * e.styles.left - r - Pe + s : n - e.styles.left + Pe + s
            }, Xa = (e, a, t) => {
              ...
              function() {
                ...
                s({
                ...
                }), Xa(je + 1, l.length, !0), Ve ? Ve && I(T.map((e => {
                  ...
                  ...e.styles,
                  transform: `translate3d(${qa(e,-1)}px, ${Ua(e)}px, 0) scale(${Ha()})`
                }), e)))), Se(je + 1)
              }(a);
              const n = xe + 1;
              if (!(n > se))
                if (s({
                  ...
                  let e = n * q * -1;
                  e < Me && (e = Me, L(!0), E(!1), _e(se)), _e(n), I(T.map((a => (a.styles = {
                    ...a.styles,
                    transform: `translate3d(${e}px, 0, 0)`
                  }, a))))
                } else {
                  let e = ye - Q;
                  _e(n), e < Me && (e = Me, L(!0), E(!1), _e(se)), Ne(e)
                }
            }, Ka = function(e) {
              let a = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
              if (ga || da) return;
              ...
              function() {
                ...
                s({
                  ...
                  source_content_id: T[je - 1].source_content_id,
                  source_content_name: T[je - 1].source_content_name
                }), Xa(je - 1, l.length, !0), Ve || I(T.map((e => (e.itemNumber === je + 1 ? e.upNext = !1 : e.itemNumber === je - 2 ? e.upNext = !0 : e.itemNumber === je ? (e.upNext = !0, e.active = !1, e.styles = {
                  ...e.styles,
                  transform: `translate3d(${qa(e,1)}px, ${Ua(e)}px, 0) scale(${Ha()})`
              ...
              if (Ca || 0 === ja || re || Ve) return;
              const a = hn(e),
                t = a.x > ja ? 1 : -1;
              let s = Math.abs(ja - a.x) * t;
              (0 === xe && 1 === t || xe === se && -1 === t) && (s *= .35), Ma(!0), Aa(s)
            }, Ja = e => {
              if (Ca || re || Ve) return;
              const a = hn(e),
                t = a.x > ja ? 1 : -1,
              ...
              return e.map(((e, s) => {
                let n = s * q,
                  r = s;
                !1 === Ve && (r = Math.ceil(.5 * s) + 1, s > 0 && (n = 2 === r ? W : W + q * (r - 2)));
                const i = $[s];
              ...
              if (s({
                ...
                let e = je * q * -1;
                e < Me && (e = Me, L(!0), E(!1), _e(se)), _e(je), Xa(je, se, !1), I(tt(l, "cardClose", `translate3d(${e}px, 0, 0)`))
              } else {
                I(tt(l, "cardClose"));
                const e = Math.ceil((T[je].columnNumber + 1) / Y) - 1;
                _e(e);
                let a = e * Q * -1;
                $e < ge ? (a = 0, E(!0), L(!0), _e(0)) : a < Me ? (a = Me, E(!1), L(!0), _e(se)) : Xa(e, se, !1), Ne(a), Se(0)
              }
            ...
            const rt = () => {
              I(T.map(((e, a) => {
                e.active = a === je, e.inModalMode = !0, e.transitionStyle = "cardOpen", Ve && (e.upNext = Ga(e.itemNumber));
                const t = !Ve;
                let s = 0;
                if (Ve) {
                  const e = Ce + 5 * b;
                ...
                return e.itemNumber < je ? e.styles = {
                  ...e.styles,
                  height: Ve ? `${s}px` : null,
                  transform: `translate3d(${qa(e,-1,t)}px, ${ta}px, 0) scale(${Ha()})`
                } : e.itemNumber > je ? e.styles = {
                  ...e.styles,
                  height: Ve ? `${s}px` : null,
                  transform: `translate3d(${qa(e,1,t)}px, ${ta}px, 0) scale(1)`
                } : e.itemNumber === je && (e.styles = Ve ? {
                  ...e.styles,
                  height: `${s}px`,
            ...
            (0, o.useEffect)((() => {
              !1 !== Fe && !0 !== re && (ie(!0), He(!1), Xa(je, T.length, !0), w.current && (w.current.style.transition = "all var(--eventDeck-transitionCardOpen)", w.current.style.transform = `translate(${-1*be}px, ${ta}px)`), rt(), Ve ? (Ne(0), ma(!1), ca(!0)) : Qe(!0))
            }), [Fe]), (0, o.useEffect)((() => {
              ...
              I(T.map((a => {
                if (a.upNext = Ga(a.itemNumber), a.itemNumber !== je) {
                  ...
                  a.itemNumber < je && (e = qa(a, -1)), a.styles = {
                    ...a.styles,
                    transform: `translate3d(${e}px, ${Ua(a)}px, 0) scale(${Ha()})`
                  }
                } else a.itemNumber === je && !Ve && e && (a.styles = {
                  left: 0,
                  top: 0,
                  transform: `translate3d(${Wa()}px, ${ta}px, 0) scale(1)`
                });
            ...
            (0, o.useEffect)((() => {
              ...
              Va(["iPad Simulator", "iPhone Simulator", "iPod Simulator", "iPad", "iPhone", "iPod"].includes(e))
            }), []), (0, o.useEffect)((() => {
              const e = ce !== re;
              re ? (e && a(!0), Ra && Da(!0)) : Ia || re || (e && a(!1), Ra && Oa && Da(!1))
            }), [re, Ia]), (0, o.useEffect)((() => {
              if (!ga) return;
              clearTimeout(fa);
              const e = setTimeout((() => {
              ...
              Ve && (e = T.length - 1), e < 0 && (e = 1), Xa(0, e, !1), re && st()
            }), [Ve]), (0, o.useEffect)((() => {
              w.current && !re && (w.current.style.transform = "")
            }), [w, Ve, re]), (0, o.useEffect)((() => {
              const e = (i ?? []).map((e => {
                let a = null;
              ...
              if (w.current) {
                let e = 0;
                e = w?.current?.clientHeight, e += kn(w?.current, "margin-top"), e += kn(w?.current, "margin-bottom"), Te(e)
              }
            }), [w, C]), (0, o.useEffect)((() => {
              re && (() => {
                const e = j?.getBoundingClientRect().top,
            ...
            }), [Ve, re, ta]), (0, o.useEffect)((() => {
              re || ($e < de * oe && 0 === xe ? (Ne(0), L(!0), E(!0)) : ye < Me ? (L(!0), E(!1), _e(se), Ne(Me)) : ye < 0 && (L(!1), _e(se - 1)), $e > de * oe && A && L(!1))
            }), [Me]), (0, o.useEffect)((() => {
              if (y.current) {
                S(y.current);
                const e = kn(document.documentElement, "--root-font-size"),
                  a = kn(y.current, "--eventDeck-modalGutters") * e,
                  t = kn(y.current, "--eventDeck-collapsedMaxWidth");
                pe(t);
                let s = oe - 2 * a;
                ...
                let r = 0;
                n < oe && (r = .5 * (oe - n)), ke(r);
                let i = kn(y.current, "--eventDeck-modalBottomGutter");
                i *= e;
                const c = window.innerHeight - (Ce + i);
                ee(.5 * s < c ? s / 4 : .5 * c);
                const o = kn(y.current, "--eventDeck-mobileBreakpoint");
                ze(o);
                let d = kn(y.current, "--eventDeck-itemSize");
                d *= e, F(d);
                let m = kn(y.current, "--eventDeck-modalGutterGap");
                m *= e, Be(m);
                let g = kn(y.current, "--eventDeck-insideMargin");
                g *= e;
                const u = !1 === Ve ? 2 * d + g : d + g;
                G(u), U(u + g);
                const b = d + g;
                X(b);
                let h = Math.ceil(.5 * (l.length - 1)) * b + u;
                Ve && (h = l.length * b), Re(h), 0 !== $e && Ee(-1 * $e + s);
                let v = Math.ceil(Math.ceil(h / b) / Y);
                (Ve || re) && (v = T.length - 1), ne(v);
                const x = kn(y.current, "--eventDeck-itemScaleUpAmount");
                aa(x), Je(kn(y.current, "--eventDeck-cardCloseTransitionDuration")), k(kn(y.current, "--eventDeck-itemImageTitleMargins") * e), null !== f && e !== f && (p(e), re && it()), null === f && p(e)
              }
            }), [y, l]), (0, o.useEffect)((() => {
              if (re && !Ve) {
                it();
              ...
              return window.addEventListener("resize", (() => {
                ...
                re && Ve && e(window.innerWidth)
              })), e(window.innerWidth), () => {
                window.removeEventListener("resize", (() => {
                  e(window.innerWidth)
                }))
              }
            }), [q, de, re, Ve]), (0, o.useEffect)((() => {
              !1 !== re && !0 !== x && (Ve ? rt() : it(!0))
            ...
            const ot = (0, N.useTinaComponents)(),
              ...
              dt = (0, o.useMemo)((() => T.map((e => (0, o.createElement)(_n, {
                ...e,
                refDeck: y,
          ...
          Grid: _,
          Hero: B,
          HighlightsItem: bn.HighlightsItem,
          HTMLElement: V,
          NewsletterSubscription: le,
          OrderedList: de.A,
          ParallaxInnerLayer: ge,
          ParallaxOuterLayer: fe,
          ParallaxWrapper: ke,
    ...
    68340: (e, a, t) => {
      ...
      const g = e => {
        ...
        u = (0, d.A)((e => {
          ...
          const {
            track: j
          } = (0, i.useGtmTrack)(), S = (0, s.useRef)(null), w = (0, s.useRef)(null), C = (0, s.useRef)(null), [T, I] = (0, s.useState)(null), [M, E] = (0, s.useState)(!1), [A, L] = (0, s.useState)(null), [P, B] = (0, s.useState)(), [$, R] = (0, s.useState)(), {
            ref: V,
            inView: O
          } = (0, c.useInView)({
            threshold: .6
