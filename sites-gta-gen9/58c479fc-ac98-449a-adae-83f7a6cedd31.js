! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "58c479fc-ac98-449a-adae-83f7a6cedd31", e._sentryDebugIdIdentifier = "sentry-dbid-58c479fc-ac98-449a-adae-83f7a6cedd31")
  } catch (e) {}
}();
  ...
  [1640], {
    ...
    81640: (e, a, t) => {
      ...
      t.r(a), t.d(a, {
        ...
        Wasted: () => _a.A,
        framer: () => Na,
        useTinaModuleFetchByIds: () => ea.X,
        withInViewTracker: () => re.r,
        withSearchbarErrorBoundary: () => xa.A,
        withSimpleErrorBoundary: () => ya.A
      });
      var s = {};
      t.r(s), t.d(s, {
        Art: () => na,
      ...
      const ra = {
        ...
        na = e => {
          ...
          return (0, g.jsx)("div", {
            className: [ra.screencap, r ? ra.screencapLoaded : ""].join(" "),
            style: {
        ...
        oa = (0, ne.withLocale)((e => {
          ...
          return (0, n.useEffect)((() => {
            ...
            const a = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
              ...
              n = e => {
                f(e.isFinal ? 0 : e.deltaX), "panleft" !== e.additionalEvent && "panright" !== e.additionalEvent || !p.current?.classList.contains(ca.dragging) || a() && o(!0)
              },
              i = () => {
                a() && o(!1), f(0)
              },
              g = e => {
                "press" === e.type && u.current?.classList.add(`${ca.disableClick}`), "tap" === e.type && (u.current?.classList.remove(`${ca.disableClick}`), document.elementFromPoint(e.center.x, e.center.y).click())
              },
              m = () => {
                a() && o(!1), u.current && u.current.classList.remove(`${ca.disableClick}`)
              },
              b = () => {
                a() && o(!1)
              };
            ...
            children: [(0, g.jsx)("div", {
              ...
              ref: u,
              children: (0, g.jsx)("div", {
                className: `${ca.items} ${0!==m?ca.dragging:""}`,
                ref: p,
                style: {
              ...
              children: [(0, g.jsx)("div", {
                ...
                children: s.map(((e, s) => {
                  return (0, g.jsx)(r.A, {
                    ...
                    tabIndex: d === s ? 0 : -1,
                    children: (0, g.jsxs)("div", {
                      className: [ca.info, s === d ? ca.active : ""].join(" "),
                      children: [(0, g.jsxs)("div", {
                        className: ca.title,
                        children: [(0, g.jsx)("div", {
                          className: ca.gameTitle,
                          children: `${e.game.title}${"fr_fr"===a?" ":""}`
                        }), (0, g.jsx)("h2", {
                          className: ca.videoTitle,
                          children: `${e.title}`
                        })]
                      }), (0, g.jsx)(h.A, {
                        className: ca.cta,
      ...
      const pa = e => {
        ...
        va = (0, ga.withIntl)((e => {
          ...
          return v = "games" === o ? (0, g.jsx)(g.Fragment, {
            children: t.results.map(((e, a) => "775700as" !== e.id && (0, g.jsx)(da.qr, {
              className: ha.slide,
              onFocus: () => h(a),
              children: (0, g.jsx)(ka, {
                game: e,
            ...
            children: a.map(((e, a) => (0, g.jsx)(da.qr, {
              className: ha.slide,
              onFocus: () => h(a),
              children: (0, g.jsx)(ia, {
                video: e,
            ...
            children: [(0, g.jsxs)("h3", {
              ...
              className: [ha.items, u % 1 != 0 ? ha.partial : ""].join(" "),
              children: (0, g.jsx)("div", {
                className: ha.trackWrapper,
                children: u && (0, g.jsx)(da.RC, {
                  className: ha.track,
                  slidesPerView: u,
                  spaceBetween: 24,
                  onInit: e => {
