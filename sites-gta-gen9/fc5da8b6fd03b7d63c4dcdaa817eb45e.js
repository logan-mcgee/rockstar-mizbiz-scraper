! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      n = (new Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "73a33b5e-a0ab-494a-99d4-36b3b6482021", e._sentryDebugIdIdentifier = "sentry-dbid-73a33b5e-a0ab-494a-99d4-36b3b6482021")
  } catch (e) {}
}();
    ...
    5492: (e, n, a) => {
      ...
      const c = e => {
          ...
          const {
            ...
            left: _,
            top: x
          } = v, [j, E] = (0, i.useState)(null), {
            track: F
          } = (0, l.useGtmTrack)(), T = null !== p && (p?.length || 0) > 1 && ("flag_bg" === h || "fob" === w?.size), [V, D] = (0, d.useSearchParams)(), [I, M] = (0, i.useState)(!1), [B, C] = (0, i.useState)(!1), $ = () => {
            const e = j - 1;
        ...
        u = "modal-context",
        m = [null, () => null],
        v = window?.[u] ?? (window[u] = (0, i.createContext)(m)),
        f = e => {
          let {
            children: n
          } = e;
          const [a, t] = (0, i.useState)(m), s = (0, i.useMemo)((() => a?.content ? (0, r.jsx)(c, {
            modal: a
          }) : null), [a]);
      ...
      const j = {
        ...
        E = () => {
          const {
            ...
            track: n
          } = (0, l.useGtmTrack)(), [a, t] = (0, y.useSearchParams)(), {
            data: s
          } = (0, N.useQuery)(x.BuyNowQ, {
            variables: {
              ids: ["6a84"]
            }
          }), [d, c] = (0, i.useContext)(v);
          return (0, i.useEffect)((() => {
            e(!d)
          }), [d]), (0, i.useEffect)((() => {
      ...
      const A = {
        ...
        O = e => {
          ...
          const {
            track: a
          } = (0, l.useGtmTrack)(), t = (0, k.ye)(), [s, o] = (0, i.useState)(!1), [d, c] = (0, i.useState)(null), [u, m] = (0, i.useState)(null), [v] = (0, y.useSearchParams)();
          if ((0, i.useEffect)((() => {
              $().cloneDeepWith(t, ((e, a, i) => {
                n === e && c(i?.children ?? null)
              }))
            }), [n, t, v.get("section")]), (0, i.useEffect)((() => {
      ...
      const G = (0, g.withSimpleErrorBoundary)((e => {
        ...
        W = e => {
          ...
          return (0, i.useLayoutEffect)((() => (t("gtao"), s("gtao"), () => {
            s(null)
          })), []), (0, r.jsxs)("div", {
