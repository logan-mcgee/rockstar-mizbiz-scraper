! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "7d41720c-0aaa-4bc9-a292-31acc79f2546", e._sentryDebugIdIdentifier = "sentry-dbid-7d41720c-0aaa-4bc9-a292-31acc79f2546")
  } catch (e) {}
}();
  ...
  [6619], {
    ...
    92479: (e, a, t) => {
      ...
      const u = (0, s.forwardRef)(((e, a) => {
        ...
        b = (0, i.A)((e => {
          ...
          const {
            track: v
          } = (0, r.useGtmTrack)(), [k, h] = (0, s.useState)(d), [x, y] = (0, s.useState)(void 0), [j, N] = (0, s.useState)(!1), _ = (0, s.useRef)(null), S = (0, s.useRef)([]), {
            ref: w
          } = (0, c.useInView)({
            threshold: .6,
            triggerOnce: !0,
    ...
    85996: (e, a, t) => {
      ...
      const u = n.withFadeIn((e => {
        ...
        const {
          ...
          threshold: .6
        }), [_, S] = (0, s.useState)(!1), w = (0, i.useGetCdnSource)(f?.full_src ?? null) ?? null;
        return (0, s.useEffect)((() => {
          N && !_ && (y({
            event: "page_section_impression",
    ...
    53829: (e, a, t) => {
      ...
      const S = {
        ...
        T = e => {
          ...
          return (0, n.jsxs)(y.motion.div, {
            className: (0, N.classList)(S.hero, u),
            style: {
          ...
          return ((e, a, t) => {
            ...
            children: (0, n.jsxs)("div", {
              ...
              children: [(0, n.jsx)("div", {
                ...
                ref: u,
                className: G()(z.rightColumn, l ? z.shadow : null, z.borderGrey),
      ...
      const U = {
          ...
          benefitsList: "rockstargames-sites-gta-gen9b4fae8e03314a4b287c70abd6d4b2d3b",
          benefits: "rockstargames-sites-gta-gen9f9a7590c53ef3be64bfc11008fbf1f66",
    ...
    28481: (e, a, t) => {
      ...
      const v = e => {
        ...
        const [i, r] = (0, s.useState)(""), [c, v] = (0, s.useState)(void 0), {
          ...
          windowWidth: y
        } = (0, d.useWindowResize)(), j = (0, o.useIntl)(), N = {
          "--promo-background": a ?? "var(--black-200)",
          "--promo-order": "left" === n ? "row" : "row-reverse"
        }, _ = t(40844), S = () => {}, w = (0, u.A)().data, C = !!w?.length, T = (0, s.useMemo)((() => C ? ((e, a, t) => {
          const s = [];
          let n = 0;
    ...
    88787: (e, a, t) => {
      ...
      const g = e => {
        ...
        const {
          track: j
        } = (0, i.useGtmTrack)(), N = (0, s.useRef)(null), [_, S] = (0, s.useState)(!1), w = (0, o.isReducedMotionPreferred)(), C = (0, n.useGetCdnSource)(b?.full_src ?? ""), T = (0, n.useGetCdnSource)(u), I = (0, c.getVideoUrl)(g), {
          formatMessage: A
            ...
            children: "image" === a || w ? (0, m.jsx)("img", {
              ...
              children: [(0, m.jsxs)("video", {
                ...
                onClick: () => {
                  if (!B && N.current) {
                    let e = "";
                    _ ? (N.current.pause(), e = "toggle pause") : (N.current.play(), e = "toggle play"), j({
                      event: "cta_other",
                      text: e,
    ...
    26002: (e, a, t) => {
      var s = {
        ...
        "./assets/": 72601,
        "./assets/index": 72601,
        "./assets/index.ts": 72601,
        "./assets/videos/default.mp4": 49202,
        "./assets/videos/vinewood-club.mp4": 98897,
        "./components": 92972,
        "./components/": 92972,
        "./components/index": 92972,
        "./components/index.ts": 92972,
        "./components/pause": 13887,
        "./components/pause/": 13887,
        "./components/pause/index": 13887,
        "./components/pause/index.tsx": 13887,
        "./components/pause/types": 68328,
        "./components/pause/types.ts": 68328,
        "./components/play": 62593,
        "./components/play/": 62593,
        "./components/play/index": 62593,
        "./components/play/index.tsx": 62593,
        "./components/play/types": 89174,
        "./components/play/types.ts": 89174,
        "./hero-video": 88787,
        "./hero-video.less": 19435,
        "./hero-video.test": 51369,
        "./hero-video.test.tsx": 51369,
        "./hero-video.tsx": 88787,
        "./hero-video.utils": 57414,
        "./hero-video.utils.ts": 57414,
        "./tina": 88481,
        "./tina.ts": 88481,
        "./utils": 24809,
        "./utils/": 24809,
        "./utils/get-video-url": 47375,
        "./utils/get-video-url.ts": 47375,
        "./utils/index": 24809,
        "./utils/index.ts": 24809,
        "./utils/is-reduced-motion-preferred": 67621,
        "./utils/is-reduced-motion-preferred.ts": 67621,
        "./utils/video-hero.local-messages": 35799,
        "./utils/video-hero.local-messages.ts": 35799
      };
