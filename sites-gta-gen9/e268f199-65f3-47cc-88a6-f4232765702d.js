! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e268f199-65f3-47cc-88a6-f4232765702d", e._sentryDebugIdIdentifier = "sentry-dbid-e268f199-65f3-47cc-88a6-f4232765702d")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [2068], {
      ...
      const b = e => {
        ...
        f = e => {
          ...
          const [h, w] = (0, a.useState)(!1), [z, j] = (0, a.useState)(!1), [G, E] = (0, a.useState)(200), {
            track: N
          } = (0, l.useGtmTrack)(), R = (0, a.useRef)(null), C = (0, a.useRef)(h), S = (0, a.useRef)(null);
          (0, a.useEffect)((() => {
            C.current = h
          }), [h]), (0, a.useEffect)((() => {
            const e = e => {
              C && !R?.current?.contains(e.target) && w(!1)
            };
    ...
    89950: (e, t, s) => {
      ...
      var o = s(9623);
      const c = "rockstargames-sites-gta-gen9ea8cf4797c830e5b5dad68b2ec814e67";
      var l = s(98096);
      const _ = (0, r.withIntl)((e => {
        ...
        let v = "";
        if ("aria-label" in y && y["aria-label"] && (v = "_blank" === x ? `${y["aria-label"]} ${p.formatMessage(i.aria_label_open_new_window)}` : y["aria-label"]), (0, a.useEffect)((() => {
