try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "80c024eb-18c1-4117-9067-30257b26996b", e._sentryDebugIdIdentifier = "sentry-dbid-80c024eb-18c1-4117-9067-30257b26996b")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [3754, 8066], {
      ...
      const _ = ({
        ...
        b = ({
          ...
          return (0, s.jsxs)("div", {
            ...
            }), (p?.title || p?.description) && (0, s.jsx)(m.A, {
              item: p
            })]
          })
        }
    ...
    44293(e, a, t) {
      ...
      const b = (0, l.A)((0, u.g)(({
        ...
        return (0, s.jsxs)("div", {
          className: [m.rating, C ? m.withDescriptors : m.withOutDescriptors, p || ""].join(" "),
        ...
        l = ({
          ...
          return (0, s.jsx)(d, {
            ...
            children: (0, s.jsx)("figure", {
              children: (0, s.jsxs)("div", {
                className: (0, i.default)("rockstargames-sites-gta-gen9d9ac792281efe15bcd4589b028d1c27b", f ? "rockstargames-sites-gta-gen9e430c4662cd185f58259d4a8d8b322de" : "", u?.hiddenMobile ? "hiddenMobile" : "", u?.hiddenLarge ? "hiddenLarge" : "", u?.className, _),
                ...
                children: [(0, s.jsx)(c.A, {
                  ...
                  image: m,
                  className: _
                }), p, m?.caption && (0, s.jsx)("figcaption", {
                  dangerouslySetInnerHTML: {
                    __html: m.caption
                  }
                })]
    ...
    46775(e, a, t) {
      ...
      const g = ({
          ...
          const {
            ...
            left: w,
            top: N
          } = g, S = p?.indexOf(k), [C, T] = (0, r.useState)(p?.length || 0), {
            track: I
          } = (0, l.useGtmTrack)(), E = null !== p && (p?.length || 0) > 1 && ("flag_bg" === v || "fob" === j?.size), z = window.location.href.includes("cms5"), [A, P] = (0, i.useSearchParams)(), [M, L] = (0, r.useState)(!1), [R, D] = (0, r.useState)(!1), [V, O] = (0, r.useState)(), B = e => {
            "number" == typeof e && p && e < p.length && e > -1 && P({
              info: p[e].toString()
            })
          }, $ = () => {
      ...
      const s = window?.env?.sc,
        ...
        n = ({
          ...
          return {
            ...
            login: `https://${u}.rockstargames.com/connect/authorize/${f}`,
            silentCheck: `https://${u}.rockstargames.com/connect/cors/check/${f}`,
            signup: `https://${u}.rockstargames.com/create/?cid=${f}`,
    ...
    99800(e, a, t) {
      ...
      const b = e => e.keys().forEach(e),
        ...
        k = (e = !0) => p.filter(a => a.key === (e ? "prod" : "dev"))[0]?.path ?? null,
        v = e => {
          e.preventDefault();
    ...
    18870(e, a, t) {
      "use strict";
      t.r(a), t.d(a, {
        componentsForTinaParser: () => vn,
        componentsForTinaParserGuide: () => hn
      });
      var s = {};
      t.r(s), t.d(s, {
        Art: () => ls,
      ...
      const B = ({
        ...
        G = ({
          ...
          const {
            breakpoints: k,
            windowWidth: v
          } = (0, u.useWindowResize)(), h = k.xxl.min, x = (e => {
            if (!e) return null;
            const a = {},
              t = new Map([
                ["xsmall", "xs"],
            ...
            return {
              ...s,
              ...v >= h ? (0, u.safeStyles)(t) : (0, u.safeStyles)(e)
            }
      ...
      const Z = ({
        ...
        te = ({
          ...
          const [l, u] = (0, g.useState)(!1), f = (0, q.useIntl)(), {
            track: p
          } = (0, b.useGtmTrack)(), {
            ref: k,
            inView: v
            ...
            buttonText: f.formatMessage(ee.ns_ok_button_text),
            onClick: () => {
              i(!1)
            },
            testId: "ok-btn",
            ...
            buttonText: o?.showManagePreferences ? f.formatMessage(ee.ns_manage_prefs_button_text) : "",
            isLink: !0,
            link: t.preferences,
          ...
          return (0, g.useEffect)(() => {
            ...
            children: [!c && (0, m.jsx)("div", {
              ...
              icon: o.icon,
              title: f.formatMessage(o.heading),
              secondaryText: f.formatMessage(o.bodyText),
        ...
        ie = e => ne(e),
        oe = (e, a) => {
          const [t, s] = (0, g.useState)(), [r, n] = (0, g.useState)(!1), [i, o] = (0, g.useState)(!1), [c, d] = (0, g.useState)(!1), [l, m] = (0, g.useState)(!1), _ = (0, u.useReactiveVar)(ne), f = (0, q.useIntl)(), {
            track: p
          } = (0, b.useGtmTrack)(), k = {
            ...
            buttons: [{
              buttonText: f.formatMessage(ee.ns_yes_subscribe_text),
              style: "monochrome",
              onClick: () => {
                x()
              }
            }, {
              buttonText: f.formatMessage(ee.ns_go_back_text),
              onClick: () => {
                s(null), o(!1)
              }
            }]
            ...
            element_placement: "newsletter subscribe",
            text: "subscribe now"
          }), a.loggedIn || window.location.assign(k.auth), a.loggedIn && a.isAMinor ? (v(se.ERROR_GENERIC), m(!1), void p({
            event: "alert_error",
            text: "error message with no preferences link",
            element_placement: "newsletter subscribe"
          })) : a.loggedIn && !_ || a.loggedIn && 3 == _ ? void await y() : a.loggedIn && _ ? (p({
            event: "alert_update",
            ...
            if (e) ie(0), v(se.ERROR_GENERIC), p({
              event: "alert_error",
      ...
      const ge = ({
        ...
        pe = ({
          ...
          children: (0, m.jsx)(be, {
            children: (0, m.jsx)("div", {
              className: (0, T.default)(fe.parallaxWrapper, fe[a]),
              style: t,
          ...
          return h && (E = null), (0, g.useEffect)(() => {
            ...
            children: (0, m.jsx)(Ae, {
              ...
              children: (0, m.jsxs)(Qe, {
                ...
                className: (0, T.default)("rockstargames-sites-gta-gen9c2289ce1bf0de6ad8a4a8ce7e90a4b66", _),
                "data-type": c,
                "data-size": s,
                "data-product": y,
                "data-covercard": h || !1,
      ...
      const ra = (0, q.defineMessages)({
        ...
        ia = (0, q.withIntl)(({
          ...
          const {
            formatMessage: k,
            formatList: v
          } = (0, q.useIntl)(), [h, x] = (0, _.useSearchParams)(), y = (0, g.useRef)(null), [, j] = (0, sa.h)(), {
            track: w
          ...
          return f || "linkout" === n ? (0, m.jsx)("div", {
            ref: y,
            className: o,
            "data-size": s,
            "data-type": n,
      ...
      const ka = ({
          ...
          return "linkout" === e && a ? (0, m.jsx)(pa.A, {
            to: a,
            style: s,
        ...
        xa = ({
          ...
          const k = (0, z.useTinaPayload)(),
            ...
            [y, j] = (0, g.useState)(0),
            w = void 0 !== b?.hasPricingOptions || void 0 !== p?.hasPlatformOptions;
          return (0, g.useEffect)(() => {
            x(o?.size ?? s)
          }, [o?.size, s]), (0, m.jsx)(ca, {
            id: e,
            ...
            expandedCardContents: (0, m.jsx)(fa, {
              images: i,
              prod: v,
              expandedView: !0
            }),
      ...
      const La = "rockstargames-sites-gta-gen9b7d3d1587271986440f5870d8d02eb3b",
        ...
        Va = ({
          ...
          const {
            track: o
          } = (0, b.useGtmTrack)(), [c, d] = (0, g.useState)([Ma.U1, Ma.WO, Ma.dK]), [l, _] = (0, g.useState)(null), [u, f] = (0, g.useState)(null);
          return (0, g.useEffect)(() => {
            const e = [Ma.U1, Ma.WO, Ma.dK];
            s && e.push(Ma.Vx), d(e)
          }, [s]), (0, g.useEffect)(() => {
            if (!r) return;
            const e = r.map((e, a) => (0, m.jsx)(Pa.qr, {
              children: e
            }, Symbol(a).toString()));
            f(e)
        ...
        Fa = ({
          ...
          const b = (0, z.useTinaPayload)(),
            f = d ?? b,
            p = c?.payload?.meta?.cdn ?? f?.meta?.prod ?? !1,
      ...
      const Xa = {
        ...
        Za = ({
          ...
          return (0, g.useEffect)(() => {
            ...
            const e = () => {
              u.current && _.current && f(u.current.clientWidth > _.current.clientWidth)
            };
            ...
            children: [(0, m.jsx)("div", {
              className: [Xa.controlsCurrentBg, p ? Xa.controlsCurrentBgVisible : ""].join(" ")
            }), (0, m.jsx)("div", {
        ...
        Qa = ({
          ...
          const {
            data: t
          } = (0, u.useQuery)(Ka.GetAudioAlbum, {
            variables: {
              id: e
            }
          }), [s, r] = (0, g.useState)(), [n, i] = (0, g.useState)(), [o, c] = (0, g.useState)(), [d, l] = (0, g.useState)(!1), [_, b] = (0, g.useState)(!1), [f, p] = (0, g.useState)(), [k, v] = (0, g.useState)({
            current: 0,
            duration: 0
          }), [h, x] = (0, g.useState)(!0);
          return (0, g.useEffect)(() => {
            ...
            const e = () => {
                isNaN(f.duration) || v({
                  ...
                  current: f?.currentTime ?? 0
                })
              },
              a = () => {
                h && s && i(s[1])
              };
            return f.addEventListener("loadedmetadata", e), f.addEventListener("timeupdate", e), f.addEventListener("ended", a), () => {
              f.removeEventListener("loadedmetadata", e), f.removeEventListener("timeupdate", e), f.removeEventListener("ended", a)
            }
          }, [f, s, h]), (0, g.useEffect)(() => {
            ...
            f && (_ ? f.play() : f.pause(), l(!1))
          }, [_, f, o?.id]), (0, g.useEffect)(() => {
            if (!n) return;
            const {
              tracks: e
      ...
      const bt = {
          ...
          children: (0, m.jsxs)("div", {
            ...
            children: [e?.images?.map((e, a) => {
              ...
              return (0, m.jsx)(Sa.A, {
                ...
                imageStyle: l,
                className: (0, T.default)(d, _, xt.imageLayer, xt[s], xt[r], xt[n], xt[i], xt[o]),
                alt: g
              }, c ?? a + 1)
        ...
        wt = e => {
          const {
            ...
            isMobile: _
          } = (0, u.useWindowResize)(), b = a?.sources ?? {}, f = s?.image?.sources ?? {}, p = (0, C.C1)(b?.[g] ?? b?.en_us) ?? "", k = (0, C.C1)(f?.[g] ?? f?.en_us) ?? p, v = _ ? i : o, h = _ ? c : d;
          return (0, m.jsx)("div", {
            style: n,
      ...
      const Tt = {
        ...
        zt = ({
          ...
          const {
            track: n
          } = (0, b.useGtmTrack)(), [i] = (0, _.useSearchParams)(), o = t.preview_images_parsed.newswire_block, c = (0, Ct.Ub)(x.breakpoints.mobile), d = {
            default: 0 !== a || s ? o.square || o.d16x9 || o._fallback : o.d16x9 || o.square || o._fallback,
            mobile: o.square || o._fallback
          }, [l] = (0, u.usePreloadImg)(d.default), f = {
            default: {
          ...
          return (0, m.jsx)(pa.A, {
            to: t.url,
            className: [Et.newswireBlock, s ? Et.newswireBlockNoSpecialOrder : "", null !== l ? Et.startAnimation : ""].join(" "),
            focused: r,
            onClick: p,
            children: (0, m.jsxs)(m.Fragment, {
              children: [0 !== a || i.get("tag_id") ? (0, m.jsx)("div", {
                ...
                style: c ? f.mobile : f.default
              }), (0, m.jsxs)("div", {
                className: Et.info,
                children: [(0, m.jsxs)("div", {
                  className: Et.top,
                  children: [t.primary_tags.length ? (0, m.jsx)(It, {
      ...
      const Mt = (0, u.withTranslations)(({
          ...
          const n = (0, u.useLocale)(),
            ...
            [l, f] = (0, g.useState)(d ?? t ?? o.get("tag_id")),
            [p, k] = (0, g.useState)(1),
            [v, h] = (0, g.useState)(20),
            [x, y] = (0, g.useState)([]),
          ...
          return (0, g.useEffect)(() => {
            k(1), y([]), h(20), f(d ?? t ?? o.get("tag_id")), N()
            ...
            }), null !== j && j.nextPage ? (0, m.jsx)(Ia.A, {
      ...
      const cs = ({
        ...
        us = (0, ce.g)(({
          ...
          const _ = e => {
            ...
            return [e?.titleHomepage ?? e?.title, a ? "/VI" : `/videos/${e.id}`, a ? "_blank" : "_self", t(a ? _s.learn_more : _s.watch_more)]
          };
      ...
      const ps = ({
          ...
          return (0, m.jsx)("div", {
            ...
            className: [fs.img, d ? fs.startAnimation : "", e ? fs.wide : ""].join(" ")
          })
        },
        ks = {
        ...
        xs = (0, ce.g)(({
          ...
          return v = "games" === i ? (0, m.jsx)(m.Fragment, {
            children: a.results.filter(e => "775700as" !== e.id).map((e, a) => (0, m.jsx)(Pa.qr, {
              className: hs.slide,
              onFocus: () => k(a),
              children: (0, m.jsx)(vs, {
                game: e,
            ...
            children: e.map((e, a) => (0, m.jsx)(Pa.qr, {
              className: hs.slide,
              onFocus: () => k(a),
              children: (0, m.jsx)(ms, {
                video: e,
            ...
            children: [(0, m.jsxs)("h3", {
              ...
              className: (0, T.default)(hs.items, _ % 1 != 0 ? hs.partial : ""),
              children: (0, m.jsx)("div", {
                className: hs.trackWrapper,
                children: _ && (0, m.jsx)(Pa.RC, {
                  className: hs.track,
                  slidesPerView: _,
                  spaceBetween: 24,
                  onInit: e => {
      ...
      const $s = (0, u.withTranslations)(({
          ...
          const w = (0, q.useIntl)(),
            ...
            [be, fe] = (0, g.useState)(!1),
            [pe, ke] = (0, g.useState)(null),
            ...
            Ie = (0, g.useMemo)(() => Ce.title ?? t ?? Se?.title, [t, Se?.title, Ce.title]),
            Ee = (0, C.S1)({
            ...
            Me = (0, g.useMemo)(() => Se?.foreignTitle, [Se]),
          ...
          return (0, g.useEffect)(() => {
            ...
            const e = Rs()((e, a) => {
              ...
              if (e?.documentElement && (t = Ds(e?.documentElement, "--root-font-size")), ne !== a.innerHeight && ie(a.innerHeight), d?.current) {
                ...
                const e = t * Ds(d?.current, "--eventDeck-modalGutters"),
                  s = a?.innerWidth,
                  r = s - 2 * e;
                D(r), I.current && c && O(r), $(Ds(d.current, "--eventDeck-itemSize") * t), ce(Ds(d.current, "--eventDeck-phaseOneTransitionDuration"));
            ...
            "next" === me ? (f(null, !0), ge("")) : "prev" === me && (u(null, !0), ge(""))
          }, [me]), (0, g.useEffect)(() => {
            Be(0), Ge(0)
          }, [c]), (0, g.useEffect)(() => {
            ...
            E.current ? he(Os(E.current)) : he(!1), void 0 !== i && i.current ? ye(Os(i.current)) : ye(!1)
            ...
            onClick: e => {
              Ze || (r ? r && !c && (s < v ? u(e, !0) : s > v && f(e, !0)) : n(e))
            },
            onMouseEnter: () => ia(!0),
            onMouseLeave: () => ia(!1),
            onFocus: e => (e => {
            ...
            "aria-label": r ? w.formatMessage(ra.events_deck_modal_group_label) : Ie,
        ...
        Fs = ({
          ...
          const u = (0, q.useIntl)(),
            ...
            p = (0, g.createRef)();
          return (0, g.useEffect)(() => {
            d && ("backwards" === l ? p?.current?.focus() : a ? f?.current?.focus() : b?.current?.focus())
        ...
        Hs = (0, q.withIntl)(e => {
          const {
            ...
            const {
              data: e
            } = (0, u.useQuery)(Ta.TinaModulesList, {
              variables: {
            ...
            if (!(r > te))
              if (s({
                ...
                let e = r * q * -1;
                e < Ce && (e = Ce, P(!0), E(!1), he(te)), he(r), T(C.map(a => (a.styles = {
                  ...a.styles,
                  transform: `translate3d(${e}px, 0, 0)`
                }, a)))
              } else {
                let e = xe - Y;
                he(r), e < Ce && (e = Ce, P(!0), E(!1), he(te)), ye(e)
              }
          }, at = (e, a = !1) => {
            if (ma || da) return;
            ...
            if (!(r < 0))
              if (s({
                ...
                let e = r * q * -1;
                e > 0 && (e = 0, E(!0), P(!1), he(0)), he(r), T(C.map(a => (a.styles = {
                  ...a.styles,
                  transform: `translate3d(${e}px, 0, 0)`
                }, a)))
              } else {
                let e = xe + Y;
                he(r), (e > 0 || 0 === e || -1 * e < B) && (e = 0, E(!0), P(!1), he(0)), ye(e)
              }
          }, tt = e => {
            if (Na || re || De) return;
            const a = Vs(e);
            ...
            (0 === pe && 1 === t || pe === te && -1 === t) && (s *= .35), Ia(!0), za(s)
          }, rt = e => {
            if (Na || re || De) return;
            const a = Vs(e),
              t = a.x > ja ? 1 : -1,
              s = Math.abs(ja - a.x);
            ya(s > Ma ? t > 0 ? "prev" : "next" : ""), nt()
          }, nt = () => {
            Sa(!0), wa(0), za(0), Ia(!1)
          }, it = e => {
            Ca && (rt(e), Ia(!1))
            ...
            he(a);
            let t = a * Y * -1;
            Le < me ? (t = 0, E(!0), P(!0), he(0)) : t < Ce ? (t = Ce, E(!1), P(!0), he(te)) : Qa(a, te, !1), ye(t), we(0)
          }, dt = () => {
            ...
            if (De) {
              let e = je * q * -1;
              e < Ce && (e = Ce, P(!0), E(!1), he(te)), he(je), Qa(je, te, !1), T(ot(o, "cardClose", `translate3d(${e}px, 0, 0)`))
            } else ct(je);
          ...
          (0, g.useEffect)(() => {
            ...
            re || (Le < de * oe && 0 === pe ? (ye(0), P(!0), E(!0)) : xe < Ce ? (P(!0), E(!1), he(te), ye(Ce)) : xe < 0 && (P(!1), he(te - 1)), Le > de * oe && A && P(!1))
          }, [Ce]), (0, g.useEffect)(() => {
            if (y.current) {
              w(y.current);
              ...
              const f = m + u;
              W(f);
              let k = Math.ceil(.5 * (o.length - 1)) * f + b;
              De && (k = o.length * f), Re(k), 0 !== Le && Ie(-1 * Le + s);
              let v = Math.ceil(Math.ceil(k / f) / K);
              (De || re) && (v = C.length - 1), se(v);
              const h = Ds(y.current, "--eventDeck-itemScaleUpAmount");
              ea(h), Je(Ds(y.current, "--eventDeck-cardCloseTransitionDuration")), p(Ds(y.current, "--eventDeck-itemImageTitleMargins") * e), null !== d && e !== d && (_(e), re && _t()), null === d && _(e)
            }
          }, [y, o]), (0, g.useEffect)(() => {
            if (re && !De) {
              _t();
            ...
            !1 !== re && !0 !== h && (De ? gt() : _t(!0))
          }, [ee, Y, Pe, V, oe, ze, J, aa]), (0, g.useEffect)(() => {
            const e = () => {
              if (y.current && oa) {
      ...
      const vr = "https://media-rockstargames-com.akamaized.net/mfe6/prod/__common/img/c6affc8b37ec4c75486ab6d12b2de395.svg",
        ...
        Tr = "https://media-rockstargames-com.akamaized.net/mfe6/prod/__common/img/cf1b78cec82c717ea9c2155ce4093736.svg",
        Ir = "https://media-rockstargames-com.akamaized.net/mfe6/prod/__common/img/925d3b2d0b0e784c366e20d3f1a660da.svg",
        ...
        sn = () => {
          const {
          ...
          })(), [d] = (0, _.useSearchParams)(), l = d.has(Jr, e.giftId), m = (() => {
            const {
              state: e,
              dispatch: a
            } = en(), {
            ...
            const {
              ...
              track: t
            } = (0, b.useGtmTrack)(), [s] = (0, _.useSearchParams)(), r = {
              giftUId: e.giftId,
              location: e.location,
          ...
          (0, g.useEffect)(() => {
            "IDLE" !== e.status || !n || "stateful" !== e.variant && "stateful-trigger" !== e.variant || m(), l && (n || (r({
              element_placement: "WOC",
              event: "cta_login",
              link_url: o,
              text: "claim now",
              section_layout: "signed out"
            }), c(o))), l && ("UNCLAIMED" === e.status || "stateful" !== e.variant && "IDLE" === e.status) && (t && i.accountSynced || i.characters ? a({
              type: "USER_SYNCED"
            }) : (s("gtao"), a({
              ...
              type: "LINK_ACCOUNT"
            })), "CLAIMABLE" === e.status && f(), "ERROR" === e.status && (r({
      ...
      const nn = (0, q.defineMessages)({
        ...
        dn = ({
          ...
          const {
            ...
            l("ps")
          }, [l]), p = s.steps.unclaimed.image, {
            alt: k,
            src: v
          } = (0, z.useImageParser)(i ?? p ?? {});
          return (0, m.jsxs)(Zr.Root, {
            view: e,
            children: [(0, m.jsx)(Zr.Image, {
              alt: k ?? "",
        ...
        mn = ({
          ...
          const {
            state: t,
            dispatch: s
          } = en(), [, r] = (0, _.useSearchParams)(), n = (0, g.useCallback)(() => {
            r(`claimOffer=${t.giftId}`);
          ...
          }, [s, r, t.giftId, t.jumpLinkId]), i = (0, x.mergeProps)({
        ...
        _n = () => {
          ...
          return sn(), (0, m.jsx)(lr, {
            jumpLinkId: e.jumpLinkId,
            currentStep: e.currentStep,
            "data-exclude-legacy-typography-css": !0,
            children: "stateful" === e.variant ? (0, m.jsx)(un, {}) : (0, m.jsx)(bn, {})
          })
        },
        un = or(() => (0, m.jsxs)(m.Fragment, {
          children: [(0, m.jsx)(Zr, {
            stepIndex: "loading",
            children: (0, m.jsx)(ln, {})
          }), (0, m.jsx)(Zr, {
        ...
        bn = or(() => {
          ...
          return (0, m.jsxs)(m.Fragment, {
            children: ["static" === a.variant && (0, m.jsx)(gn, {
              view: "default"
