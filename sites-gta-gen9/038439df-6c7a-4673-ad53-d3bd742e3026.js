try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "038439df-6c7a-4673-ad53-d3bd742e3026", e._sentryDebugIdIdentifier = "sentry-dbid-038439df-6c7a-4673-ad53-d3bd742e3026")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [747], {
    2269: (e, a, l) => {
      ...
      const r = ({
        ...
        k = () => ({
          ...
          fields: [(0, t.om)(), {
            ...
            itemProps: e => (0, t.Rv)(e, {
              label: `${e?.[t.Qw]?.title??"New"} [CountDown]`
            })
          }, {
            label: "Rewards",
            name: "rewards",
            ...
            fields: [{
              ...
              fields: [(0, t.z9)({
                ...
                defaultItem: () => (0, t.Q)(),
                itemProps: e => (0, t.Rv)(e, {
                  label: `${e?.[t.Qw]?.title??"New"} [Rewards Card]`
                })
              }]
            }],
            defaultItem: () => (0, t.Q)({
            ...
            itemProps: e => (0, t.Rv)(e, {
              label: `${e?.[t.Qw]?.title??"New"} [Rewards]`
            })
          }, {
            ...
            fields: [(0, t.om)(), (0, t.z9)({
              ...
              defaultItem: () => (0, t.Q)(),
              itemProps: e => (0, t.Rv)(e, {
                label: `${e?.[t.Qw]?.title??"New"} [Milestone]`
              })
            }, (0, t.bY)({
            ...
            defaultItem: () => (0, t.Q)(),
            itemProps: e => (0, t.Rv)(e, {
              label: `${e?.[t.Qw]?.title??"New"} [MilestoneIndicator]`
            })
          }, (0, t.pr)(), (0, t.f6)()],
          defaultItem: () => (0, t.Q)({
            banner: (0, t.Q)(),
            ...
            milestoneIndicator: (0, t.Q)()
          }),
          itemProps: e => (0, t.Rv)(e, {
            label: `${e?.[t.Qw]?.title??"NEW"} [GTAO Community Challenge]`
          })
        }),
        ...
        x = () => ({
          ...
          fields: [{
            ...
            fields: [{
              ...
              defaultItem: () => (0, t.Q)(),
              itemProps: e => (0, t.Rv)(e, {
                label: `${e?.[t.Qw]?.name??e?.name??"New"} [Image]`
              })
            }, {
              name: "style",
        ...
        S = () => ({
          ...
          defaultItem: () => (0, t.Q)(),
          itemProps: e => (0, t.Rv)(e, {
            label: `Disclaimer [${e?.[t.Qw]?.text??null}]`
          })
        }),
        w = () => ({
          label: "FAQ",
          ...
          fields: [(0, t.z9)({
            ...
            itemProps: e => (0, t.Rv)(e, {
              label: `Question [${e?.[t.Qw]?.question??""}]`
            }),
            defaultItem: () => (0, t.Q)()
          }, (0, t.sE)({})],
          defaultItem: () => (0, t.Q)({
        ...
        z = ({
          ...
          defaultItem: () => (0, t.Q)(),
          itemProps: e => (0, t.Rv)(e, {
            label: `Guide Section Content: [${e?.[t.Qw]?.title??"New"}]`
          })
        }),
        D = (e = {}) => ({
          component: "group-list",
        ...
        A = (e = "background") => {
          ...
          return "background" === e && a.push((0, t.sE)({
            filter: "image"
          })), {
            component: "group",
            name: `${e}Img`,
        ...
        P = ({
          ...
          defaultItem: () => (0, t.Q)(),
          itemProps: e => (0, t.Rv)(e, {
            label: `[Elevator Pitch]: ${e?.[t.Qw]?.title??e?.title??"New"}`
          })
        });
      var L = l(76462);
      const Q = "Title Image",
        ...
        B = ({
          ...
          defaultItem: () => (0, t.Q)({}),
          itemProps: e => (0, t.Rv)(e, {
            label: `[Sticky Column]: ${e?.[t.Qw]?.title??e?.title??"New"}`
          })
        }),
        $ = {
      ...
      const _ = "Image w/text",
        q = "Group of Image/Text Groups (gen9)",
        H = () => ({
          label: q,
          name: "content",
          component: "group",
      ...
      const W = ({
        ...
        ee = ({
          ...
          defaultItem: () => (0, t.Q)(),
          itemProps: e => (0, t.Rv)(e, {
            label: `${e?.[t.Qw]?.title??"New"} [Summary Card]`
          })
        }),
        ae = ({
          label: e
        ...
        oe = ({
          ...
          defaultItem: () => (0, t.Q)(),
          itemProps: e => (0, t.Rv)(e, {
            label: `[Tile Item]: ${e?.[t.Qw]?.name??e?.name??"New"}`
          })
        }),
        ie = () => ({
          ...
          fields: [(0, t.om)(), {
            ...
            defaultItem: () => (0, t.Q)({}),
            itemProps: e => (0, t.Rv)(e, {
              label: `[Value Prop Item]: ${e?.[t.Qw]?.title??"New"}`
            })
          }, {
          ...
          defaultItem: () => (0, t.Q)({}),
          itemProps: e => (0, t.Rv)(e, {
            label: `[Value Prop]: ${e?.[t.Qw]?.name??e?.name??"New"}`
          })
        }),
        se = "Linkout Section",
        re = () => ({
    ...
    3514: (e, a, l) => {
      ...
      const o = (e = {
        ...
        itemProps: e => (0, t.Rv)(e, {
          label: (0, n._e)(`${e?.name??e?.[t.Qw]?.content??"New"} [List Item]`)
        })
      })
    },
    12914: (e, a, l) => {
    ...
    43582: (e, a, l) => {
      ...
      const d = {
        ...
        p = ({
          ...
          return delete o?.color, u && b ? (0, t.jsx)("div", {
            className: d.grid,
            style: {
            ...
            children: (0, t.jsx)("ol", {
              className: c()(d.itemList, d.noImg, d[l], d[r]),
              style: (0, s.safeStyles)(o),
              children: b.map(e => (0, t.jsx)("li", {
            ...
            style: (0, s.safeStyles)(o),
            className: c()(d.itemList, d.custom, p ? d.noImg : "", l ? d[l] : "", r ? d[r] : "", i ?? ""),
    ...
    45440: (e, a, l) => {
      ...
      const t = ({
          ...
          const a = setInterval(() => e.scrollIntoView({
            ...
            l = e => {
              e.target === document && (clearInterval(a), document.removeEventListener("scroll", l))
            };
        ...
        n = ({
          ...
          const a = new URLSearchParams(document.location.search),
            l = document.getElementById(a.get(e) || e);
          l && (t({
            element: l
          }), o(l))
        },
        o = e => {
          ...
          if (a.includes(e.nodeName.toLowerCase())) e.focus();
            ...
            const l = e?.querySelectorAll(a.join(", "));
            if (l?.length) {
              const e = [...l].find(e => !e?.hasAttribute("disabled"));
              e?.focus()
            }
          }
        };
      class i {
        ...
        aliasOnlineService;
        alias;
        constructor(e, a, l, t, n = null, o = null) {
          this.name = e, this.friendlyName = a, this.id = l, this.onlineService = t, this.aliasOnlineService = n, this.alias = o
        }
      }
      ...
      function c(e) {
        ...
        return r.find(e => a === e.name || a === e.id.toString() || a === e.friendlyName.toLowerCase() || a === e.onlineService?.toLowerCase() || a === e.aliasOnlineService?.toLowerCase() || a === e.alias?.toLowerCase())
      }
      var d = l(6306),
        m = l(12914);
      const p = e => {
          const a = document.cookie.split("; "),
            l = `${e}=`,
            t = a.find(e => e.startsWith(l)),
            n = t?.substring(l.length, t.length);
          return n
        },
        u = (e, a) => {
          e && void 0 !== a && (0, d.canStoreCookie)(e) && p(e) !== a && (document.cookie = `${e}=${a}; domain=${(0,m.F)()}; path=/;`)
        };
      var g = l(56990),
        b = l(45547);
      const f = async ({
        ...
        const [{
          ...
          authHost: n,
          clientId: o
        } = (0, b.A)(), i = await l(), s = new URL(`tpa/${e}/link`, `https://${n}.rockstargames.com`);
        return s.searchParams.append("cid", o), s.searchParams.append("lang", t), s.searchParams.append("returnUrl", a ?? window.location.pathname), i && "boolean" != typeof i && "string" == typeof i.bearerToken && s.searchParams.append("accessToken", i.bearerToken), s
      }, v = e => e.keys().forEach(e), k = e => e.replace(/(<([^>]+)>)/gi, ""), h = [{
        key: "dev",
        path: "https://media-dev-rockstargames-com.akamaized.net"
      }, {
        key: "prod",
        path: "https://media-rockstargames-com.akamaized.net"
      }], y = (e = !0) => h.filter(a => a.key === (e ? "prod" : "dev"))[0]?.path ?? null, x = e => {
        e.preventDefault();
        ...
        fetch(a, {
          ...
          t.href = a, t.setAttribute("download", l), document.body.appendChild(t), t.click(), document.body.removeChild(t)
        }).catch(e => {
          console.log(e)
        })
      }, S = () => [s.xbox360.name, s.xboxone.name, s.ps3.name, s.ps4.name, s.pc.name], w = () => [s.xboxsx.name, s.ps5.name, s.pcalt.name], T = e => w().includes(e), I = e => {
        const a = new Map([
    ...
    76462: (e, a, l) => {
      ...
      const o = ({
        ...
        s = () => ({
          ...
          defaultItem: () => (0, t.Q)(),
          itemProps: e => (0, t.Rv)(e, {
            label: `[Hero Video]: ${e?.[t.Qw]?.name??e?.name??"New"}`
          })
        })
    },
    84343: e => {
    ...
    93935: (e, a, l) => {
      ...
      const d = {
        ...
        p = ({
          ...
          const [b, f] = (0, n.useState)(null), v = a ? a.split("_#_") : e;
          if ((0, n.useEffect)(() => {
              f(e)
            }, [e]), !a && !e) return null;
          const k = {
