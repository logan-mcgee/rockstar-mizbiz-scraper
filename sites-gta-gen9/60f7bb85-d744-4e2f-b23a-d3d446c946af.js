try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "60f7bb85-d744-4e2f-b23a-d3d446c946af", e._sentryDebugIdIdentifier = "sentry-dbid-60f7bb85-d744-4e2f-b23a-d3d446c946af")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [431], {
    ...
    99047: (e, t, n) => {
      ...
      var S = "top",
        ...
        C = [].concat(B, [T]).reduce((function(e, t) {
      ...
      function Q(e) {
        ...
        if (u) {
          var A = M(n),
            D = "clientHeight",
            T = "clientWidth";
          A === i(n) && "static" !== b(A = g(n)).position && "absolute" === f && (D = "scrollHeight", T = "scrollWidth"), (o === S || (o === P || o === _) && a === W) && (j = L, v -= (d && A === k && k.visualViewport ? k.visualViewport.height : A[D]) - r.height, v *= c ? 1 : -1), o !== P && (o !== S && o !== L || a !== W) || (E = _, h -= (d && A === k && k.visualViewport ? k.visualViewport.width : A[T]) - r.width, h *= c ? 1 : -1)
        }
      ...
      function fe(e, t) {
        ...
        if (w === V && N) {
          ...
          Object.keys(F).forEach((function(e) {
            var t = [_, L].indexOf(e) >= 0 ? 1 : -1,
              n = [S, L].indexOf(e) >= 0 ? "y" : "x";
            F[e] += z[n] * t
          }))
        }
        return F
      ...
      function pe(e) {
        return [S, _, L, P].some((function(t) {
          return e[t] >= 0
        }))
      }
      var le = z({
          defaultModifiers: [{
                ...
                a = C.reduce((function(e, n) {
                  return e[n] = function(e, t, n) {
                    var r = X(e),
                      ...
                      a = i[0],
                      s = i[1];
                    return a = a || 0, s = (s || 0) * o, [P, _].indexOf(r) >= 0 ? {
                      x: s,
                      y: a
                    } : {
                      x: a,
            ...
            fn: function(e) {
              ...
              if (!t.modifiersData[r]._skip) {
                for (var o = n.mainAxis, i = void 0 === o || o, a = n.altAxis, s = void 0 === a || a, f = n.fallbackPlacements, c = n.padding, u = n.boundary, p = n.rootBoundary, l = n.altBoundary, d = n.flipVariations, m = void 0 === d || d, h = n.allowedAutoPlacements, y = t.options.placement, g = X(y), v = f || (g !== y && m ? function(e) {
                  ...
                  var I = ee(q),
                    F = [];
                  if (i && F.push(V[D] <= 0), s && F.push(V[q] <= 0, V[I] <= 0), F.every((function(e) {
                      return e
                    }))) {
                    j = A, E = !1;
                    break
              ...
              if (k) {
                if (i) {
                  var V, U = "y" === E ? S : P,
                    ...
                    te = Z[C],
                    ne = ce(0, A[q], Q[q]),
                    re = x ? A[q] / 2 - z - ne - ee - B.mainAxis : Y - ne - ee - B.mainAxis,
                    oe = x ? -A[q] / 2 + z + ne + te + B.mainAxis : J + ne + te + B.mainAxis,
            ...
            fn: function(e) {
              var t, n = e.state,
                ...
                s = X(n.placement),
                f = G(s),
                c = [P, _].indexOf(s) >= 0 ? "height" : "width";
              if (i && a) {
                var u = function(e, t) {
