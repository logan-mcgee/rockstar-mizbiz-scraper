! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "0567b7d0-55e9-485c-8ee9-5e738a35f13a", e._sentryDebugIdIdentifier = "sentry-dbid-0567b7d0-55e9-485c-8ee9-5e738a35f13a")
  } catch (e) {}
}();
    ...
    42204: (e, a, n) => {
      ...
      const T = {
        ...
        P = e => {
          ...
          const o = n.path.map((e => 1 === n.path.length && "_root" === e.feedback_type.name ? null : (0, _.jsx)(I.NavLink, {
              to: `?step=${e.id_hash}`,
              className: T[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            s = n.next.map((e => "_root" === e.feedback_type.name ? null : (0, _.jsxs)(I.NavLink, {
        ...
        V = e => {
          ...
          const {
            loggedIn: o
          } = (0, s.useRockstarUser)(), r = (0, t.useRef)(), [l, {
            data: c,
            error: d
          }] = (0, b.useMutation)(n);
          return o ? c?.submittal?.id ? (0, _.jsx)("div", {
            className: T.success,
            dangerouslySetInnerHTML: {
      ...
      const O = {
        ...
        C = e => {
          ...
          const {
            track: n
          } = (0, s.useGtmTrack)(), i = (0, l.ye)(), [o, r] = (0, t.useState)(!1), [d, u] = (0, t.useState)(null), [m, b] = (0, t.useState)(null), [g] = (0, v.useSearchParams)();
          if ((0, t.useEffect)((() => {
              M().cloneDeepWith(i, ((e, n, t) => {
                a === e && u(t?.children ?? null)
              }))
            }), [a, i, g.get("section")]), (0, t.useEffect)((() => {
              b(null), M().cloneDeepWith(d, ((e, a, n) => {
                "id_hash" === a && g.get("section") === e && b(n)
              }))
      ...
      var $ = n(67284);
      const X = (0, c.withSimpleErrorBoundary)((() => {
        const {
          setBrand: e
        } = (0, l.KM)();
        (0, t.useEffect)((() => {
        ...
        const {
          guideId: a
        } = (0, v.useParams)(), n = (0, c.useTinaModuleFetchByIds)({
          ids: [a],
      ...
      var G = n(56372);
      const L = (0, c.withSimpleErrorBoundary)((e => {
          let {
        ...
        H = (0, c.withSearchbarErrorBoundary)((e => {
          let {
            routeRoot: a
          } = e;
          const n = [{
