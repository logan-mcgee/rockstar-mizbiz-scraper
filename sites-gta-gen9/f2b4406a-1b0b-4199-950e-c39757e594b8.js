! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      n = (new Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "f2b4406a-1b0b-4199-950e-c39757e594b8", e._sentryDebugIdIdentifier = "sentry-dbid-f2b4406a-1b0b-4199-950e-c39757e594b8")
  } catch (e) {}
}();
    ...
    64205: (e, n, t) => {
        ...
        g = u.forwardRef((function(e, n) {
          var t, r = u.useState(),
            ...
            G = u.useCallback((function() {
              g.current = g.current || document && document.activeElement, l.current && R && R(l.current), m.current = !0
            }), [R]),
      ...
      var O = function(e) {
        ...
        oe = function(e, n) {
          ...
          if (v[0] || (v = l)[0]) {
            var p, m, b, y = V([f], s).map((function(e) {
                return e.node
              })),
              g = (p = y, m = v, b = new Map, m.forEach((function(e) {
              ...
              E = function(e, n, t, r) {
                ...
                if (!(t && e.indexOf(t) >= 0)) {
                  var c, d, f = void 0 !== t ? n.indexOf(t) : -1,
                    ...
                    g = $(e, 0),
                    h = $(e, o - 1);
                  return -1 === f || -1 === l ? ee : !v && l >= 0 ? l : f <= p && a && Math.abs(v) > 1 ? h : f >= m && a && Math.abs(v) > 1 ? g : v && Math.abs(y) > 1 ? l : f <= p ? h : f > m ? g : v ? Math.abs(v) > 1 ? l : (o + l + v) % o : void 0
                }
              }(h, y, c, n);
            if (E === ee) {
        ...
        ye = function() {
          ...
          if (de) {
            var c = de,
              ...
              v = c.crossFrame,
              p = c.focusOptions,
              m = d || se && se.portaledElement,
              b = document && document.activeElement;
            if (m) {
              var y = [m].concat(l.map(me).filter(Boolean));
              if (b && ! function(e) {
      ...
      })), p.assignMedium(he), m.assignMedium((function(e) {
        return e({
          moveFocusInside: ae,
          focusInside: Q
        })
