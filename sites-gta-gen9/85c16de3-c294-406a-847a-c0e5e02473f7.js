try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "85c16de3-c294-406a-847a-c0e5e02473f7", e._sentryDebugIdIdentifier = "sentry-dbid-85c16de3-c294-406a-847a-c0e5e02473f7")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    7545: (e, t, a) => {
      ...
      function o(e) {
        ...
        function m(e) {
          ...
          if (!a) return;
          e.preventDefault();
          const s = (0, i.h)(a) * t.params.slidesPerGroup;
          if (t.params.loop) {
          ...
          "undefined" != typeof window && ("string" == typeof t.params.controller.control || t.params.controller.control instanceof HTMLElement) ? ("string" == typeof t.params.controller.control ? [...document.querySelectorAll(t.params.controller.control)] : [t.params.controller.control]).forEach((e => {
            if (t.controller.control || (t.controller.control = []), e && e.swiper) t.controller.control.push(e.swiper);
              ...
              const a = `${t.params.eventsPrefix}init`,
                s = i => {
                  t.controller.control.push(i.detail[0]), t.update(), e.removeEventListener(a, s)
                };
      ...
      function d(e) {
        ...
        n("beforeInit", (() => {
          ...
          t.params.a11y.enabled && (() => {
            ...
            u = (0, i.m)(u), m = (0, i.m)(m), u && u.forEach((t => w(t, l, e.nextSlideMessage))), m && m.forEach((t => w(t, l, e.prevSlideMessage))), x() && (0, i.m)(t.pagination.el).forEach((e => {
          ...
          t.params.a11y.enabled && function() {
            ...
            E() && t.pagination.bullets.forEach((a => {
              t.params.pagination.clickable && (u(a), t.params.pagination.renderBullet || (g(a, "button"), v(a, e.paginationBulletMessage.replace(/\{\{index\}\}/, (0, i.h)(a) + 1)))), a.matches(r(t.params.pagination.bulletActiveClass)) ? a.setAttribute("aria-current", "true") : a.removeAttribute("aria-current")
            }))
          }()
        })), n("destroy", (() => {
          t.params.a11y.enabled && function() {
            ...
            e = (0, i.m)(e), a = (0, i.m)(a), e && e.forEach((e => e.removeEventListener("keydown", y))), a && a.forEach((e => e.removeEventListener("keydown", y))), x() && (0, i.m)(t.pagination.el).forEach((e => {
              ...
              const a = (0, s.g)(),
                i = () => {
                  ...
                  if (s && s.swiper) e.swiper = s.swiper, c(), d(!0);
                    ...
                    const a = `${t.params.eventsPrefix}init`,
                      i = n => {
                        e.swiper = n.detail[0], s.removeEventListener(a, i), c(), d(!0), e.swiper.update(), t.update()
                      };
            ...
            onTouchEnd: function(e) {
              ...
              if (a < -t.minTranslate()) t.slideTo(t.activeIndex);
                ...
                if (l.freeMode.momentum) {
                  ...
                  l.freeMode.momentumBounce && m ? (t.updateProgress(u), t.setTransition(e), t.setTranslate(p), t.transitionStart(!0, t.swipeDirection), t.animating = !0, (0, i.k)(r, (() => {
                    t && !t.destroyed && d.allowMomentumBounce && (s("momentumBounce"), t.setTransition(l.speed), setTimeout((() => {
                      t.setTranslate(u), (0, i.k)(r, (() => {
                        t && !t.destroyed && t.transitionEnd()
                      }))
                    }), 0))
                  }))) : t.velocity ? (s("_freeModeNoMomentumRelease"), t.updateProgress(p), t.setTransition(e), t.setTranslate(p), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, (0, i.k)(r, (() => {
                    t && !t.destroyed && t.transitionEnd()
