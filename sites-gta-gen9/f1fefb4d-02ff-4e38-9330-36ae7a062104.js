    ...
    18260: (e, n, t) => {
      ...
      const R = "Collapsible",
        ...
        P = (0, o.forwardRef)(((e, n) => {
          const {
            ...
            children: l,
            ...c
          } = e, i = S(x, t), [u, d] = (0, o.useState)(a), f = (0, o.useRef)(null), p = s(n, f), m = (0, o.useRef)(0), g = m.current, b = (0, o.useRef)(0), v = b.current, y = i.open || u, h = (0, o.useRef)(y), w = (0, o.useRef)();
          return (0, o.useEffect)((() => {
            ...
            if (e) {
              ...
              m.current = n.height, b.current = n.width, h.current || (e.style.transitionDuration = w.current.transitionDuration, e.style.animationName = w.current.animationName), d(a)
            }
      ...
      const [J, Q] = K(F), [W, X] = K(F, {
        ...
        const {
          __scopeAccordion: t,
          ...a
        } = e, l = re(F, t), c = ce(ue, t), i = X(ue, t), s = Z(t);
