! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      s = (new Error).stack;
    s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "77710ead-4cb9-459a-8cb5-b2d8f81409b1", e._sentryDebugIdIdentifier = "sentry-dbid-77710ead-4cb9-459a-8cb5-b2d8f81409b1")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [6219], {
    39695: (e, s, i) => {
      ...
      const d = {
        ...
        m = {
          ...
          applestore: "rockstargames-sites-gta-gen9dc4069c520d30eda3239cc1de09917ad",
          googleplay: "rockstargames-sites-gta-gen9e36f6e05f08b4bd9edef1950618493ca",
      ...
      const f = e => {
          ...
          const c = r ?? (t.startsWith(document.location.origin) ? "_self" : "_blank"),
            l = [m.platformButton, m[a]].join(" "),
            d = a ? i(52917)(`./${a}.svg`) : null,
        ...
        k = e => {
          ...
          const [x, z] = (0, t.useState)(!1), [j, C] = (0, t.useState)(!1), [N, R] = (0, t.useState)(200), {
            track: G
          } = (0, l.useGtmTrack)(), P = (0, t.useRef)(null), E = (0, t.useRef)(x), S = (0, t.useRef)(null);
          (0, t.useEffect)((() => {
            E.current = x
          }), [x]), (0, t.useEffect)((() => {
            const e = e => {
              E && !P?.current?.contains(e.target) && z(!1)
            };
            ...
            if (P?.current) {
              const e = 1e3 * Number(getComputedStyle(P.current).getPropertyValue("--expandingPlatformButton-expandDuration").replace("ms", "").replace("s", ""));
              R(isNaN(e) ? 200 : e)
            }
          }), []), (0, t.useEffect)((() => {
            j && setTimeout((() => {
          ...
          return (0, p.jsxs)("div", {
            className: (0, _.classList)(m.container, k),
            children: [(0, p.jsx)(a.motion.div, {
              className: m.content,
              animate: x ? "open" : "close",
              variants: d,
              "aria-hidden": !!x,
              children: g
            }), (0, p.jsxs)(a.motion.div, {
              "data-variant": s,
              "data-animating": j,
              className: o()(x ? m.expandedButton : m.unexpandedButton),
              animate: x ? "open" : "closed",
              variants: u,
              initial: !1,
              ref: P,
              children: [(0, p.jsx)(a.motion.button, {
                className: o()(m.buttonText, r),
                "aria-expanded": x,
                onClick: () => {
                  if (C(!0), z(!x), !x) switch (y) {
                    case "select_platform":
                      G({
                        element_placement: v,
                        event: "select_platform",
                        text: n?.toLowerCase() ?? "subscribe"
                      });
                      break;
                    case "link_account":
                      G({
                ...
                tabIndex: x ? -1 : 0,
                children: "string" == typeof n ? n : "Subscribe"
              }), (0, p.jsx)("div", {
                ...
                "aria-hidden": !x,
                style: {
                  height: x ? S?.current?.scrollHeight : 0
                },
                children: (0, p.jsxs)("div", {
                  children: [(0, p.jsx)("button", {
                    ...
                    children: b.length ? b.map((e => (0, p.jsx)(f, {
    ...
    60285: (e, s, i) => {
      ...
      var o = i(89779);
      const _ = "rockstargames-sites-gta-gen9ff481c537a56a6fcdb1be85dfbc8944e";
      var c = i(46632);
      const l = (0, n.withIntl)((e => {
        let {
          children: s,
          to: i = "#",
          reloadDocument: a = !1,
        ...
        const f = (0, t.useRef)(null),
          k = (0, n.useIntl)(),
          g = !/^(https?|mailto):/i.test(i),
          b = /^#/.test(i),
          y = p?.target ?? (d ? "_blank" : "_self");
        let {
          ...v
        } = p, h = "";
        if ("aria-label" in v && v["aria-label"] && (h = "_blank" === y ? `${v["aria-label"]} ${k.formatMessage(r.aria_label_open_new_window)}` : v["aria-label"]), (0, t.useEffect)((() => {
          ...
          return (0, c.jsxs)("a", {
            ...
            "aria-label": h,
            ref: f,
            children: [s, "_blank" === y && !h && (0, c.jsx)("span", {
              className: _,
        ...
        return "function" == typeof w?.className && delete w.className, (0, c.jsxs)("a", {
          href: i,
          title: l,
          onClick: u,
          target: y,
    ...
    52917: (e, s, i) => {
      ...
      }, n.resolve = a, e.exports = n, n.id = 52917
    },
    4756: e => {
      "use strict";
