    ...
    2352: (t, e, n) => {
      ...
      function Io({
        ...
        return a && (l && l(), v = e((function(t) {
          ...
          }(n, E, r, T)) : (n = Do(n, E, r), "mirror" === i && V.flipTarget()), b = !1, h && h()) : (v.stop(), c && c()))
        })), v.start()), {
          stop: () => {
            u && u(), v.stop()
          },
      ...
      function Vl(t) {
        const [e, n] = (0, o.useState)(t), i = Al({}, !1), r = E((() => new Pl({
          props: {},
          visualState: i
        }, {
          initialState: t
...
//# sourceMappingURL=37cb9431b10e8e280f15924859492d3f.js.map