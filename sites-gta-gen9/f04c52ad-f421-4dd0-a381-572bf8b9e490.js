try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "f04c52ad-f421-4dd0-a381-572bf8b9e490", e._sentryDebugIdIdentifier = "sentry-dbid-f04c52ad-f421-4dd0-a381-572bf8b9e490")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
        ...
        L = ({
          ...
          return (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsxs)(m, {
              ...
              className: [N.award, ...p.isComplete ? [N.completed] : [], ...a ? [N.expanded] : [], ...l ? [N.hovered] : [], ...c ? [c] : []].join(" "),
              ref: s ? I : f,
              tabIndex: d,
              ...s && !a && {
                onClick: () => {
              ...
              children: [(0, r.jsxs)(b.motion.div, {
                ...
                children: [(0, r.jsx)(ee, {
                  ...
                  children: z.map((e, a) => (0, r.jsx)(L, {
                    ...
                    tabIndex: a >= w && !R ? -1 : 0,
                    "aria-hidden": a >= w && !R,
                    classes: [B.award, a >= w + x ? B.fadeIn : "", a >= w && a < w + x ? B.peek : ""].join(" ")
                  }, e.imageName))
      ...
      const be = {
        ...
        ke = ({
          ...
          const [h, u] = (0, t.useState)(window.innerWidth >= 1280), [f, R] = (0, t.useState)(1), [E, S] = (0, t.useState)("auto"), {
            ...
            setBodyIsLocked: j
          } = (0, d.useBodyScrollable)("Rewards"), [A, w] = (0, t.useState)(!1), P = (0, t.useRef)(), x = h ? ge.RC : "div", T = h ? ge.qr : "li", I = (0, t.useRef)(null), C = (0, t.useRef)(null), O = n.some(e => e.isCompleted && e?.numClaimable > 0), N = (0, l.useIntl)(), W = (0, t.useMemo)(() => {
            const e = [];
          ...
          function y() {
            if (a && v({
              ...
              if (a) P.current?.swiper.disable(), R(0), setTimeout(() => {
                ...
                const e = W.findIndex(e => e.id === `reward-${i}-0`);
                ...
                let r = W.findIndex(e => e.id === `reward-${i}-0`);
          ...
          return (0, t.useEffect)(() => (window.addEventListener("resize", G), G(), () => {
      ...
      const Sa = ({
        ...
        xa = (0, l.withIntl)(() => {
          ...
          const oe = (0, t.useCallback)((e, s, r, t, o) => {
            ...
            _e = e => {
              "Escape" === e.code && (ie(), M?.current?.focus())
            };
          ...
          return (0, Ue.useGSAP)(() => {
            ...
            if (c)
              if (C((s?.characters?.gtao ?? [])?.length > 0), I) {
                A(e.formatMessage(Le.pln_career_progress_header_title));
              ...
              } else A(e.formatMessage(Le.pln_career_progress_link_console_account_title)), P(e.formatMessage(Le.pln_career_progress_link_console_account_description));
            else A(e.formatMessage(Le.pln_career_progress_header_title)), P(e.formatMessage(Le.pln_career_progress_header_body_gen9))
            ...
            children: [(0, r.jsx)("div", {
              className: Te()(wa.packPageBanner, x ? "" : wa.gen9PackPageBanner),
              children: (0, r.jsxs)("div", {
                className: wa.packPageContent,
                children: [(0, r.jsxs)("div", {
                  className: Te()(wa.packPageCPH, c && I && !x ? wa.gen9PackHeader : ""),
                  children: [(0, r.jsx)("div", {
                    className: Te()(wa.colLeft, c && !x ? wa.gen8ColLeft : ""),
                    children: (0, r.jsxs)("div", {
                    ...
                    children: [I && (0, r.jsxs)(r.Fragment, {
                      children: [(0, r.jsxs)("div", {
                        ...
                        onClick: ce,
                        children: (0, r.jsx)("div", {
                          className: Te()(wa.progressBtnIcon, D ? wa.expanded : wa.collapsed)
                        })
                      })]
                    }), !I && te.length > 0 && (0, r.jsx)("div", {
                      "data-testid": Pa.LOGGED_IN_NO_CHARACTERS,
                      className: Te()(wa.colRight, i ? wa.authContent : ""),
                      children: (0, r.jsx)("div", {
                        className: wa.signInContent,
                        children: (0, r.jsx)(Ea.A, {
                          variant: "gen9",
                          className: Te()([wa.linkAccountButton]),
                    ...
                    "data-testid": Pa.LOGGED_OUT_SIGN_IN_REQUIRED,
                    className: Te()(wa.colRight, i ? wa.authContent : ""),
                    children: (0, r.jsxs)("div", {
                      className: wa.signInContent,
