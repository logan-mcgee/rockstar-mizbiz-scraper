! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "7d711363-22cb-4881-a5b1-86ec40846ae9", e._sentryDebugIdIdentifier = "sentry-dbid-7d711363-22cb-4881-a5b1-86ec40846ae9")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [9916], {
    99916: (e, t, n) => {
      ...
      function E(e) {
        return ["html", "body", "#document"].indexOf(y(e)) >= 0 ? e.ownerDocument.body : s(e) && w(e) ? e : E(j(e))
      }
      ...
      var _ = "top",
        ...
        C = W.reduce((function(e, t) {
          return e.concat([t + "-" + R, t + "-" + H])
        }), []),
        q = [].concat(W, [B]).reduce((function(e, t) {
          return e.concat([t, t + "-" + R, t + "-" + H])
        }), []),
      ...
      function Q(e) {
        ...
        if (u) {
          var k = M(n),
            D = "clientHeight",
            B = "clientWidth";
          k === i(n) && "static" !== b(k = v(n)).position && "absolute" === f && (D = "scrollHeight", B = "scrollWidth"), (o === _ || (o === P || o === L) && a === H) && (E = S, g -= (d && k === A && A.visualViewport ? A.visualViewport.height : k[D]) - r.height, g *= c ? 1 : -1), o !== P && (o !== _ && o !== S || a !== H) || (j = L, h -= (d && k === A && A.visualViewport ? A.visualViewport.width : k[B]) - r.width, h *= c ? 1 : -1)
        }
        var W, R = Object.assign({
            position: f
          }, u && K),
          T = !0 === l ? function(e, t) {
            var n = e.x,
        ...
        return h = T.x, g = T.y, c ? Object.assign({}, R, ((W = {})[E] = O ? "0" : "", W[j] = x ? "0" : "", W.transform = (A.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + g + "px)" : "translate3d(" + h + "px, " + g + "px, 0)", W)) : Object.assign({}, R, ((t = {})[E] = O ? g + "px" : "", t[j] = x ? h + "px" : "", t.transform = "", t))
      }
      var Z = {
        left: "right",
        right: "left",
      ...
      function fe(e, t) {
        ...
        var n = t,
          ...
          }(a(R) ? R : R.contextElement || v(e.elements.popper), l, h, f),
              ...
              if (A) {
                if (i) {
                  var V, C = "y" === j ? _ : P,
                    ...
                    te = Z[q],
                    ne = ce(0, k[U], Q[U]),
                    re = x ? k[U] / 2 - z - ne - ee - W.mainAxis : Y - ne - ee - W.mainAxis,
                    oe = x ? -k[U] / 2 + z + ne + te + W.mainAxis : J + ne + te + W.mainAxis,
                    ie = t.elements.arrow && M(t.elements.arrow),
                    ae = ie ? "y" === j ? ie.clientTop || 0 : ie.clientLeft || 0 : 0,
                    se = null != (V = null == H ? void 0 : H[j]) ? V : 0,
                    ue = I + oe - se,
                ...
                if (s) {
                  var le, de = "x" === j ? _ : P,
                    ...
                    xe = be ? ve : he - k[ye] - D[ye] - we + W.altAxis,
                    Oe = be ? he + k[ye] + D[ye] - we - W.altAxis : ge,
