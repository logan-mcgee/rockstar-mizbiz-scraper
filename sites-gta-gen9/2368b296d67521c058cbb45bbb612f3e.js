      ...
      const R = "Collapsible",
        ...
        P = (0, o.forwardRef)(((e, n) => {
          const {
            ...
            children: c,
            ...l
          } = e, i = S(x, t), [d, u] = (0, o.useState)(a), f = (0, o.useRef)(null), p = s(n, f), m = (0, o.useRef)(0), b = m.current, g = (0, o.useRef)(0), v = g.current, y = i.open || d, w = (0, o.useRef)(y), _ = (0, o.useRef)();
          return (0, o.useEffect)((() => {
            ...
            if (e) {
              ...
              m.current = n.height, g.current = n.width, w.current || (e.style.transitionDuration = _.current.transitionDuration, e.style.animationName = _.current.animationName), u(a)
            }
