! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      n = (new e.Error).stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "1eec84a7-5166-47d1-8116-73d3cd61e35b", e._sentryDebugIdIdentifier = "sentry-dbid-1eec84a7-5166-47d1-8116-73d3cd61e35b")
  } catch (e) {}
}();
  ...
  [5232], {
    25128: (e, n, a) => {
            ...
            children: [(0, b.jsxs)("div", {
              ...
              children: [(0, b.jsx)("div", {
                ...
                children: (0, b.jsxs)(T.RC, {
                  ...
                  onSlideChange: e => {
                    j(e?.isEnd), w(e?.isBeginning)
                  },
                  children: [r.map((e => (0, b.jsx)(T.qr, {
                    tabIndex: 0,
                    ...
                    children: (0, b.jsx)(A.A, {
                      className: [n.linkMore, r.length > 0 ? n.withIcon : ""].join(" "),
                      to: o,
                      onClick: i,
                      children: (0, b.jsx)("div", {
                        className: n.btnText,
      ...
      const j = e => {
          ...
          const c = (0, i.useScAuthTpaLink)("np", r).href,
            l = (0, i.useScAuthTpaLink)("xbl", r).href;
          return (0, b.jsxs)("div", {
      ...
      const y = {
        ...
        E = (0, d.withIntl)((e => {
          ...
          const A = {
            ...
            [se, re] = (0, t.useState)(w.landing),
            [oe, ie] = (0, t.useState)(A.introScreen.image.sources.mobile || k),
            ce = `${document.location.pathname}${document.location.search}#${h}`,
            le = (0, i.usePrevious)($),
            de = (0, i.usePrevious)(C),
            {
              signInUrl: ge
            } = (0, i.useScAuthLinks)(ce),
            ue = e => {
              e === w.landing ? (re(w.landing), K("onScreen"), J("hidden"), ne("hidden"), Z("hidden")) : e === w.success ? (re(w.success), K("offScreen"), J("visible"), setTimeout((() => {
                K("hidden"), ne("hidden")
              }), 300), setTimeout((() => {
                J("onScreen")
              }), 100)) : e === w.error ? (re(w.error), K("offScreen"), ne("visible"), setTimeout((() => {
                K("hidden")
              }), 300), setTimeout((() => {
                ne("onScreen")
              }), 100)) : e === w.unlinked && (re(w.unlinked), K("offScreen"), Z("visible"), setTimeout((() => {
                K("hidden"), ne("hidden")
              }), 300), setTimeout((() => {
                Z("onScreen")
              }), 100))
          ...
          return (0, t.useEffect)((() => {
            const e = () => {
                window.innerWidth > 2560 && "newswire" !== a ? ie(A.introScreen.image.sources.mobile || k) : ie(A.introScreen.image.sources.desktop || k)
              },
              n = () => {
            ...
            $ || (async () => {
              B.length > 0 && R ? ue(w.success) : ue(R ? w.unlinked : w.landing)
            })()
          }), [$]), (0, t.useEffect)((() => {
            if (z && !ae) {
              if (void 0 === C) return;
              ...
              children: (0, b.jsxs)(r.motion.div, {
                ...
                children: [(0, b.jsx)("div", {
                  ...
                  children: $ ? (0, b.jsx)("div", {
                    ...
                    children: [se === w.landing && (0, b.jsx)(p, {
                      s: y,
                      content: A,
                      loggedIn: C,
                      addClaim: async () => {
