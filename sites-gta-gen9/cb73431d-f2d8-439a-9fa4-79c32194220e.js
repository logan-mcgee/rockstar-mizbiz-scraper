! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "cb73431d-f2d8-439a-9fa4-79c32194220e", e._sentryDebugIdIdentifier = "sentry-dbid-cb73431d-f2d8-439a-9fa4-79c32194220e")
  } catch (e) {}
}();
    ...
    56666: (e, t, s) => {
      ...
      const b = e => {
        ...
        f = e => {
          ...
          const [v, w] = (0, a.useState)(!1), [z, j] = (0, a.useState)(!1), [G, R] = (0, a.useState)(200), {
            track: E
          } = (0, l.useGtmTrack)(), N = (0, a.useRef)(null), C = (0, a.useRef)(v), S = (0, a.useRef)(null);
          (0, a.useEffect)((() => {
            C.current = v
          }), [v]), (0, a.useEffect)((() => {
            const e = e => {
              C && !N?.current?.contains(e.target) && w(!1)
            };
          ...
          return (0, m.jsxs)("div", {
            className: (0, c.classList)(u.container, f),
            children: [(0, m.jsx)(i.motion.div, {
              ...
              "data-variant": t,
              "data-animating": z,
              className: o()(v ? u.expandedButton : u.unexpandedButton),
    ...
    12363: (e, t, s) => {
      ...
      const _ = (0, c.g)((e => {
        ...
        const f = (0, a.useRef)(null),
          ...
          k = /^#/.test(s),
          h = b?.target ?? (d ? "_blank" : "_self"),
          {
            ...x
          } = b;
        let y = "";
        if ("aria-label" in x && x["aria-label"] && (y = "_blank" === h ? `${x["aria-label"]} ${p.formatMessage(i.aria_label_open_new_window)}` : x["aria-label"]), (0, a.useEffect)((() => {
          ...
          return (0, l.jsxs)("a", {
            ...
            "aria-label": y,
            ref: f,
            children: [t, "_blank" === h && !y && (0, l.jsx)("span", {
              className: o,
