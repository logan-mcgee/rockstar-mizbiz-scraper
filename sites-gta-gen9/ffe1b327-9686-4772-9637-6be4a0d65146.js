! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      e = (new t.Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "ffe1b327-9686-4772-9637-6be4a0d65146", t._sentryDebugIdIdentifier = "sentry-dbid-ffe1b327-9686-4772-9637-6be4a0d65146")
  } catch (t) {}
}();
  ...
  [8357], {
    58357: (t, e, n) => {
      ...
      function E() {
        ...
        }(), (0, r.__read)((0, o.useState)(x.current), 1)[0]
      }
      ...
      function xt(t, e, n, r) {
        ...
        c ? i.transform = function(t, e, n, r) {
          ...
          for (var d = !1, f = i.length, p = 0; p < f; p++) {
            var v = i[p];
            c += "".concat(Q[v] || v, "(").concat(o[v], ") "), "z" === v && (d = !0)
          }
      ...
      function Lt(t, e, n, o) {
        var i = e.attrX,
          ...
          f = e.pathOffset,
          p = void 0 === f ? 0 : f;
        xt(t, (0, r.__rest)(e, ["attrX", "attrY", "originX", "originY", "pathLength", "pathSpacing", "pathOffset"]), n, o), t.attrs = t.style, t.style = {};
        var v = t.attrs,
          h = t.style,
          m = t.dimensions;
        ...
        return void 0 === t && (t = !1),
          function(e, n, i, a, s, u) {
            var l = s.latestValues,
              c = (N(e) ? Dt : wt)(n, l, u),
              d = Tt(n, "string" == typeof e, t),
              f = (0, r.__assign)((0, r.__assign)((0, r.__assign)({}, d), c), {
                ref: a
              });
      ...
      var je = function(t) {
        ...
        Fe = {
          ...
          tap: je((function(t) {
            ...
            function f() {
              var t;
              return d(), u.current = !1, null === (t = a.animationState) || void 0 === t || t.setActive(Kt.Tap, !1), !Ee()
            }

            function p(t, n) {
              f() && (Se(a.getInstance(), t.target) ? null == e || e(t, n) : null == r || r(t, n))
            }
            ...
            function h(t, e) {
              var r;
              d(), u.current || (u.current = !0, l.current = Ve(me(window, "pointerup", p, c), me(window, "pointercancel", v, c)), null === (r = a.animationState) || void 0 === r || r.setActive(Kt.Tap, !0), null == n || n(t, e))
            }
            ge(a, "pointerdown", s ? h : void 0, c), Ae(d)
          })),
          focus: je((function(t) {
            var e = t.whileFocus,
              n = t.visualElement;
        ...
        let {
          ...
          if (!en(t, tn) && en(t, Qe)) {
            const n = function({
              ...
              let a = 1 - e;
              a = Ye(qe, Ze, a), t = Ye(Xe, $e, t / 1e3), a < 1 ? (o = e => {
                const r = e * a,
                  o = r * t,
                  i = r - n,
                  s = Je(e, a),
      ...
      const mn = (t, e, n) => {
        ...
        xn = (t, e) => {
          ...
          let o = n.parse(t),
            i = r.parse(e);
          n === pn && (o = hn(o), n = dn), r === pn && (i = hn(i), r = dn);
        ...
        bn = {
          test: t => dn.test(t) || fn.test(t) || pn.test(t),
          parse: t => dn.test(t) ? dn.parse(t) : pn.test(t) ? pn.parse(t) : fn.parse(t),
          transform: t => st(t) ? t : t.hasOwnProperty("red") ? dn.transform(t) : pn.transform(t)
        },
        En = "${c}",
        wn = "${n}";
      ...
      function Mn(t, e) {
        return Cn(t) ? n => an(t, e, n) : bn.test(t) ? xn(t, e) : Dn(t, e)
      }
      const Rn = (t, e) => {
          const n = [...t],
            r = n.length,
      ...
      function In(t, e, {
        ...
        const a = function(t, e, n) {
            const r = [],
              o = n || ("number" == typeof(i = t[0]) ? On : "string" == typeof i ? bn.test(i) ? xn : Dn : Array.isArray(i) ? Rn : "object" == typeof i ? Ln : void 0);
            var i;
            const a = t.length - 1;
            for (let n = 0; n < a; n++) {
              let i = o(t[n], t[n + 1]);
      ...
      const pr = {
        ...
        mr = vr.reduce(((t, e) => {
          const n = hr[e];
          return t[e] = (t, e = !1, r = !1) => (dr || br(), n.schedule(t, e, r)), t
        }), {}),
        gr = vr.reduce(((t, e) => (t[e] = hr[e].cancel, t)), {}),
        yr = vr.reduce(((t, e) => (t[e] = () => hr[e].process(pr), t)), {}),
        _r = t => hr[t].process(pr),
        xr = t => {
          dr = !1, pr.delta = cr ? sr : Math.max(Math.min(t - pr.timestamp, 40), 1), pr.timestamp = t, fr = !0, vr.forEach(_r), fr = !1, dr && (cr = !1, lr(xr))
        },
        br = () => {
          dr = !0, cr = !0, fr || lr(xr)
        },
      ...
      function Pr(t) {
        ...
        (null === (n = (e = A).needsInterpolation) || void 0 === n ? void 0 : n.call(e, o, x)) && (_ = In([0, 100], [o, x], {
          clamp: !1
        }), o = 0, x = 100);
        ...
        return i && (null == d || d(), g = a((function(t) {
          if (S || (t = -t), s += t, !w) {
            const t = P.next(Math.max(0, s));
            y = t.value, _ && (y = _(y)), w = S ? t.done : s <= 0
          }
      ...
      var Zr = (0, r.__assign)((0, r.__assign)({}, _t), {
          color: bn,
          backgroundColor: bn,
          outlineColor: bn,
          fill: bn,
      ...
      function eo(t, e, n, o, i) {
        ...
        var d = Br(t, u);
        return (0, c.$)(d === l, "You are trying to animate ".concat(t, ' from "').concat(u, '" to "').concat(n, '". ').concat(u, " is not an animatable value - to enable this animation set ").concat(u, " to a value animatable to ").concat(n, " via the `style` property.")), d && l && !1 !== s.type ? function() {
          var o = {
            from: u,
            to: n,
          ...
          return "inertia" === s.type || "decay" === s.type ? function({
            ...
            if (h(t)) y({
              ...
              let c, d;
              const f = t => {
                c = d, d = t, e = Vr(t - c, Er().delta), (1 === s && t > a || -1 === s && t < a) && y({
                  from: t,
                  to: a,
                  velocity: e
                })
      ...
      function xo(t, e) {
        ...
        for (var u in s = (0, r.__assign)((0, r.__assign)({}, s), a)) _o(t, u, Gt(s[u]))
      }

      function bo(t, e) {
        (0, r.__spreadArray)([], (0, r.__read)(e), !1).reverse().forEach((function(n) {
          var r, o = t.getVariant(n);
          o && xo(t, o), null === (r = t.variantChildren) || void 0 === r || r.forEach((function(t) {
            bo(t, e)
          }))
        }))
      }
        ...
        if (u)
          for (var l = 0; l < u; l++) {
            var c = s[l],
              d = e[c],
              f = null;
            Array.isArray(d) && (f = d[0]), null === f && (f = null !== (o = null !== (r = n[c]) && void 0 !== r ? r : t.readValue(c)) && void 0 !== o ? o : e[c]), null != f && ("string" == typeof f && (ao(f) || so(f)) ? f = parseFloat(f) : !yo(f) && Tn.test(d) && (f = Jr(c, d)), t.addValue(c, po(f)), null !== (i = (a = n)[c]) && void 0 !== i || (a[c] = f), t.setBaseTarget(c, f))
          }
      }
      ...
      function Po(t, e, n) {
        ...
        var u = i ? function() {
          ...
          c = s.when;
        if (c) {
          var d = (0, r.__read)("beforeChildren" === c ? [u, l] : [l, u], 2),
            f = d[0],
            p = d[1];
          return f().then(p)
        }
      ...
      function Vo(t, e, n) {
        ...
        for (var g in v) {
          var y = t.getValue(g),
            _ = v[g];
          if (!(!y || void 0 === _ || m && Co(m, g))) {
            var x = (0, r.__assign)({
              delay: s
            }, f);
            t.shouldReduceMotion && $(g) && (x = (0, r.__assign)((0, r.__assign)({}, x), {
              type: !1,
              delay: 0
            }));
            var b = io(g, y, _, x);
      ...
      var Do = {
        animation: je((function(t) {
          ...
          e.animationState || (e.animationState = function(t) {
            ...
            function u(e, u) {
              for (var l, c = t.getProps(), d = t.getVariantContext(!0) || {}, f = [], p = new Set, v = {}, h = 1 / 0, m = function(n) {
                  var i = Ro[n],
                    m = o[i],
                  ...
                  !1 === _ && (h = n);
                  var x = g === d[i] && g !== c[i] && y;
                  if (x && a && t.manuallyAnimateOnMount && (x = !1), m.protectedKeys = (0, r.__assign)({}, v), !m.isActive && null === _ || !g && !m.prevProp || Wt(g) || "boolean" == typeof g) return "continue";
                  var b = function(t, e) {
                      return "string" == typeof e ? e !== t : !!A(e) && !He(e, t)
                    }(m.prevProp, g),
                    E = b || i === u && m.isActive && !x && y || n > h && y,
                  ...
                  m.prevProp = g, m.prevResolvedValues = S, m.isActive && (v = (0, r.__assign)((0, r.__assign)({}, v), S)), a && t.blockInitialAnimation && (E = !1), E && !x && f.push.apply(f, (0, r.__spreadArray)([], (0, r.__read)(w.map((function(t) {
                    return {
                      animation: t,
              ...
              var _ = Boolean(f.length);
              return a && !1 === c.initial && !t.manuallyAnimateOnMount && (_ = !1), a = !1, _ ? n(f) : Promise.resolve()
            }
            return {
      ...
      function $o(t, e, n, r) {
        void 0 === r && (r = .5), t.origin = r, t.originPoint = an(e.min, e.max, t.origin), t.scale = Go(n) / Go(e), (Xo(t.scale, 1, 1e-4) || isNaN(t.scale)) && (t.scale = 1), t.translate = an(n.min, n.max, t.origin) - t.originPoint, (Xo(t.translate) || isNaN(t.translate)) && (t.translate = 0)
      }
      ...
      function fi(t, e, n, r, o) {
        return void 0 !== o && (t = di(t, o, r)), di(t, n, r) + e
      }

      function pi(t, e, n, r, o) {
        void 0 === e && (e = 0), void 0 === n && (n = 1), t.min = fi(t.min, e, n, r, o), t.max = fi(t.max, e, n, r, o)
      }
            ...
            var e = this,
              ...
              d = ii((function(n) {
                ...
                if (wi(n, o, e.currentDirection)) {
                  var d = null !== (l = null == c ? void 0 : c[n]) && void 0 !== l ? l : {};
                  u && (d = {
                    min: 0,
                    max: 0
                  });
              ...
              ii((function(t) {
                ...
                if (u) {
                  ...
                  a[t] = (n = {
                    min: l,
                    max: l
                  }, r = e.constraints[t], o = .5, i = Go(n), (s = Go(r)) > i ? o = on(r.min, r.max - i, n.min) : i > s && (o = on(n.min, n.max - s, r.min)), Ye(0, 1, o))
                }
              }));
      ...
      var Si = {
        ...
        Pi = function(t) {
          ...
          return function(t, e) {
            ...
            function L() {
              _ && b && (k(), u(_, w, v.style, N.projection))
            }
            ...
            var B = C(v),
              ...
              N = (0, r.__assign)((0, r.__assign)({
                ...
                mount: function(t) {
                  b = !0, _ = N.current = t, N.projection && N.projection.mount(t), U && p && !B && (x = null == p ? void 0 : p.addVariantChild(N)), A.forEach((function(t, e) {
                    return O(e, t)
                ...
                unmount: function() {
                  ...
                  null === (t = N.projection) || void 0 === t || t.unmount(), gr.update(D), gr.render(L), V.forEach((function(t) {
                    return t()
                  })), null == x || x(), null == p || p.children.delete(N), S.clearAllListeners(), _ = void 0, b = !1
                },
                ...
                readValue: function(t) {
                  var n;
                  return null !== (n = E[t]) && void 0 !== n ? n : l(_, t, e)
                },
              ...
              if (t.hasValue(r)) {
                ...
                if (Ht(p)) {
                  var v = p.length,
                    h = null === p[0] ? 1 : 0;
                  d = p[h], f = mo(d);
                  for (var m = h; m < v; m++) l ? (0, c.V)(mo(p[m]) === l, "All keyframes must be of the same type") : (l = mo(p[m]), (0, c.V)(l === f || Ii(f) && Ii(l), "Keyframes must be of the same dimension as the current value"))
                } else l = mo(p);
                if (f !== l)
                  if (Ii(f) && Ii(l)) {
                    var g = i.get();
                    "string" == typeof g && i.set(parseFloat(g)), "string" == typeof p ? e[r] = parseFloat(p) : Array.isArray(p) && l === dt && (e[r] = p.map(parseFloat))
                  } else(null == f ? void 0 : f.transform) && (null == l ? void 0 : l.transform) && (0 === d || 0 === p) ? 0 === d ? i.set(l.transform(d)) : e[r] = f.transform(p) : (s || (a = function(t) {
                    var e = [];
      ...
      var Wi = {
          ...
          measureViewportBox: function(t, e) {
            return xi(t, e.transformPagePoint)
          },
          ...
          build: function(t, e, n, r, o) {
            void 0 !== t.isVisible && (e.style.visibility = t.isVisible ? "visible" : "hidden"), xt(e, n, r, o.transformTemplate)
          },
          render: Ft
        },
        Hi = Pi(Wi),
      ...
      function da(t, e, n, r, o) {
        return t = di(t -= e, 1 / n, r), void 0 !== o && (t = di(t, 1 / o, r)), t
      }

      function fa(t, e, n, o, i) {
        ...
        ! function(t, e, n, r, o, i, a) {
          if (void 0 === e && (e = 0), void 0 === n && (n = 1), void 0 === r && (r = .5), void 0 === i && (i = t), void 0 === a && (a = t), ct.test(e) && (e = parseFloat(e), e = an(a.min, a.max, e / 100) - a.min), "number" == typeof e) {
            ...
            t === i && (s -= e), t.min = da(t.min, e, n, s, o), t.max = da(t.max, e, n, s, o)
          }
      ...
      function ha(t, e, n, r) {
        fa(t.x, e, pa, null == n ? void 0 : n.x, null == r ? void 0 : r.x), fa(t.y, e, va, null == n ? void 0 : n.y, null == r ? void 0 : r.y)
      }
          ...
          return t.prototype.addEventListener = function(t, e) {
            ...
            if (void 0 === n && (n = !1), !this.instance) {
              ...
              if (l && !l.getInstance() && l.mount(t), this.root.nodes.add(this), null === (o = this.parent) || void 0 === o || o.children.add(this), this.id && this.root.potentialNodes.delete(this.id), n && (u || s) && (this.isLayoutDirty = !0), e) {
                ...
                e(t, (function() {
                  i.root.updateBlockedByResize = !0, clearTimeout(c), c = window.setTimeout(d, 250), k.hasAnimatedSinceResize && (k.hasAnimatedSinceResize = !1, i.nodes.forEach(Ca))
                }))
              }
              s && this.root.registerSharedNode(s, this), !1 !== this.options.animate && l && (s || u) && this.addEventListener("didUpdate", (function(t) {
                ...
                var p = null !== (n = null !== (e = i.options.transition) && void 0 !== e ? e : l.getDefaultTransition()) && void 0 !== n ? n : ja,
                  ...
                  g = !i.targetLayout || !ya(i.targetLayout, f) || d,
                  y = !c && d;
                if ((null === (o = i.resumeFrom) || void 0 === o ? void 0 : o.instance) || y || c && (g || !i.currentAnimation)) {
                  ...
                  var _ = (0, r.__assign)((0, r.__assign)({}, oo(p, "layout")), {
                    onPlay: h,
                    onComplete: m
                  });
            ...
            for (var r = 0; r < this.path.length; r++) {
              var o = this.path[r];
              !e && o.options.layoutScroll && o.scroll && o !== o.root && _i(n, {
                x: -o.scroll.x,
                y: -o.scroll.y
              }), li(o.latestValues) && _i(n, o.latestValues)
            }
            return li(this.latestValues) && _i(n, this.latestValues), n
            ...
            if (this.isTreeAnimating = Boolean((null === (t = this.parent) || void 0 === t ? void 0 : t.isTreeAnimating) || this.currentAnimation || this.pendingAnimation), this.isTreeAnimating || (this.targetDelta = this.relativeTarget = void 0), this.layout && (n || r)) {
              ...
              ca(this.layoutCorrected, this.layout.actual),
                function(t, e, n, r) {
                  ...
                  if (a) {
                    var s, u;
                    e.x = e.y = 1;
                    for (var l = 0; l < a; l++) u = (s = n[l]).projectionDelta, "contents" !== (null === (i = null === (o = s.instance) || void 0 === o ? void 0 : o.style) || void 0 === i ? void 0 : i.display) && (r && s.options.layoutScroll && s.scroll && s !== s.root && _i(t, {
                      x: -s.scroll.x,
                      y: -s.scroll.y
                    }), u && (e.x *= u.x.scale, e.y *= u.y.scale, vi(t, u)), r && li(s.latestValues) && _i(t, s.latestValues))
                  }
              ...
              if (i) {
                ...
                qo(this.projectionDelta, this.layoutCorrected, i, this.latestValues), this.projectionTransform = xa(this.projectionDelta, this.treeScale), this.projectionTransform === u && this.treeScale.x === a && this.treeScale.y === s || (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", i))
              }
            }
            ...
            var l = oi(),
              ...
              f = Boolean(c && !d && !0 === this.options.crossfade && !this.path.some(Ia));
              ...
              Da(u.x, t.x, h), Da(u.y, t.y, h), o.setTargetDelta(u), o.relativeTarget && o.relativeTargetOrigin && o.layout && (null === (n = o.relativeParent) || void 0 === n ? void 0 : n.layout) && (Jo(l, o.layout.actual, o.relativeParent.layout.actual), r = o.relativeTarget, i = o.relativeTargetOrigin, p = l, v = h, Oa(r.x, i.x, p.x, v), Oa(r.y, i.y, p.y, v)), c && (o.animationValues = s, function(t, e, n, r, o, i) {
                ...
                for (var c = 0; c < na; c++) {
                  var d = "border".concat(ea[c], "Radius"),
                    f = ia(e, d),
                    p = ia(n, d);
                  void 0 === f && void 0 === p || (f || (f = 0), p || (p = 0), 0 === f || 0 === p || oa(f) === oa(p) ? (t[d] = Math.max(an(ra(f), ra(p), r), 0), (ct.test(p) || ct.test(f)) && (t[d] += "%")) : t[d] = p)
                }(e.rotate || n.rotate) && (t.rotate = an(e.rotate || 0, n.rotate || 0, r))
              }(s, a, o.latestValues, h, f, d)), o.root.scheduleUpdateProjection(), o.scheduleRender(), o.animationProgress = h
            ...
            var t = this.getLead(),
              ...
              r = t.layout,
              o = t.latestValues;
            e && n && r && (ca(e, n), _i(e, o), qo(this.projectionDeltaWithTransform, this.layoutCorrected, e, o))
          }, t.prototype.registerSharedNode = function(t, e) {
            var n, r, o;
            this.sharedNodes.has(t) || this.sharedNodes.set(t, new _a), this.sharedNodes.get(t).add(e), e.promote({
            ...
            if (!this.projectionDelta || !this.layout || !l.target) {
              var c = {};
              return this.options.layoutId && (c.opacity = null !== (n = this.latestValues.opacity) && void 0 !== n ? n : 1, c.pointerEvents = Xt(t.pointerEvents) || ""), this.hasProjected && !li(this.latestValues) && (c.transform = u ? u({}, "") : "none", this.hasProjected = !1), c
            }
            var d = l.animationValues || l.latestValues;
            this.applyTransformsToTarget(), s.transform = xa(this.projectionDeltaWithTransform, this.treeScale, d), u && (s.transform = u(d, s.transform));
            var f = this.projectionDelta,
              p = f.x,
              v = f.y;
            for (var h in s.transformOrigin = "".concat(100 * p.origin, "% ").concat(100 * v.origin, "% 0"), l.animationValues ? s.opacity = l === this ? null !== (o = null !== (r = d.opacity) && void 0 !== r ? r : this.latestValues.opacity) && void 0 !== o ? o : 1 : this.preserveOpacity ? this.latestValues.opacity : d.opacityExit : s.opacity = l === this ? null !== (i = d.opacity) && void 0 !== i ? i : "" : null !== (a = d.opacityExit) && void 0 !== a ? a : 0, z)
              if (void 0 !== d[h]) {
                var m = z[h],
                  g = m.correct,
                  y = m.applyTo,
                  _ = g(d[h], l);
                if (y)
                  for (var x = y.length, b = 0; b < x; b++) s[y[b]] = _;
                else s[h] = _
      ...
      var ns = function(t) {
        ...
        rs = function(t) {
          ...
          null === y.current && (function(t) {
            ...
            id: a,
            group: ns(l) && null !== (n = null == p ? void 0 : p.group) && void 0 !== n ? n : (c = new Set, d = new WeakMap, f = function() {
              return c.forEach(es)
            }, {
              add: function(t) {
                c.add(t), d.set(t, t.addEventListener("willUpdate", f))
              },
              remove: function(t) {
                var e;
                c.delete(t), null === (e = d.get(t)) || void 0 === e || e(), d.delete(t), f()
              },
              dirty: f
            })
          });
      ...
      var cs = (0, o.forwardRef)((function(t, e) {
        var n = t.children,
          ...
          l = t.onReorder,
          d = t.values,
          f = (0, r.__rest)(t, ["children", "as", "axis", "onReorder", "values"]),
          p = L((function() {
            return Ya(a)
          })),
          v = [],
          h = (0, o.useRef)(!1);
        (0, c.V)(Boolean(d), "Reorder.Group must be provided a values prop");
        var m = {
          axis: u,
          ...
          updateOrder: function(t, e, n) {
            if (!h.current) {
              ...
              v !== o && (h.current = !0, l(o.map(ds).filter((function(t) {
        ...
        return (0, o.useEffect)((function() {
          h.current = !1
        })), o.createElement(p, (0, r.__assign)({}, f, {
          ref: e
      ...
      var xs = (0, o.forwardRef)((function(t, e) {
          var n = t.children,
            i = t.style,
            a = t.value,
            s = t.as,
            ...
            h = (0, o.useContext)(ls),
            m = {
              x: _s(null == i ? void 0 : i.x),
              y: _s(null == i ? void 0 : i.y)
            },
          ...
          return (0, o.useEffect)((function() {
            ...
            onDrag: function(t, e) {
              var n = e.velocity;
              n[x] && E(a, m[x].get(), n[x]), null == l || l(t, e)
            },
      ...
      function Xs(t, e) {
        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
          r = 0;
        if (void 0 !== Gs[t] && (t = Gs[t]), (0, Ys.K)(t)) {
      ...
      function qs(t, e, n, r) {
        let o = Array.isArray(t) ? t : $s,
          i = 0,
          a = 0;
        return (0, Hs.E)(t) ? o = [t, t] : (0, Ys.K)(t) && (o = (t = t.trim()).includes(" ") ? t.split(" ") : [t, Gs[t] ? t : "0"]), i = Xs(o[0], n, r), a = Xs(o[1], e), i - a
      }
      const Zs = {
        x: 0,
        y: 0
        ...
        return {
          ...
          update: e => {
            ! function(t, e, n) {
              ...
              c && (e[i].interpolate = (0, Ns.G)((0, zs.Z)(d), e[i].offset), e[i].interpolatorOffsets = [...e[i].offset]), e[i].progress = e[i].interpolate(e[i].current)
            }(t, n, r)
          },
          notify: "function" == typeof e ? () => e(n) : (i = e, a = n[o], i.pause(), i.forEachNative(((t, e) => {
            ...
            var r, o;
            if (t.updateDuration) n || (t.easing = Us.p), t.updateDuration(1);
            else {
              const e = {
                duration: 1e3
              };
          ...
          o = {
            ...
            set: function(e) {
              return (0, c.V)(t, "controls.set() should only be called after a component has mounted. Consider calling within a useEffect hook."), n.forEach((function(t) {
                ! function(t, e) {
                  Array.isArray(e) ? bo(t, e) : "string" == typeof e ? bo(t, [e]) : xo(t, e)
                }(t, e)
              }))
            },
            stop: function() {
