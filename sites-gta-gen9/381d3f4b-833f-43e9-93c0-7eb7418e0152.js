! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "381d3f4b-833f-43e9-93c0-7eb7418e0152", e._sentryDebugIdIdentifier = "sentry-dbid-381d3f4b-833f-43e9-93c0-7eb7418e0152")
  } catch (e) {}
}();
    ...
    13624: (e, a, t) => {
      ...
      const l = e => {
          ...
          const {
            ...
            track: M
          } = (0, c.useGtmTrack)(), L = null !== v && (v?.length || 0) > 1 && ("flag_bg" === h || "fob" === j?.size), I = window.location.href.includes("cms5"), [, P] = (0, r.useSearchParams)(), [z, A] = (0, s.useState)(!1), [D, $] = (0, s.useState)(!1), [B, V] = (0, s.useState)(), O = e => {
    ...
    22790: (e, a, t) => {
      ...
      const J = {
        ...
        ee = e => {
          ...
          const [u, p] = (0, d.useState)(!1), b = (0, V.useIntl)(), {
            ...
            buttonText: c?.showManagePreferences ? b.formatMessage(Q.ns_manage_prefs_button_text) : "",
            isLink: !0,
            link: s.preferences,
        ...
        ae = {
          SUCCESS: {
            ...
            bodyText: Q.ns_successfully_subscribed_details,
          ...
          ALREADY_SUBSCRIBED: {
            ...
            bodyText: Q.ns_already_subbed_details,
            showManagePreferences: !0
          },
          NEW_ACCOUNT: {
            icon: "mail",
      ...
      const aa = (0, V.defineMessages)({
        ...
        ra = e => {
          ...
          const M = (0, N.useTinaComponents)(),
            ...
            P = [na.card, T ? na.coverCardWrapper : ""].join(" ");
          return (0, f.jsx)(sa, {
            id: m,
            position: g,
            sectionTitle: u,
      ...
      const La = "rockstargames-sites-gta-gen9b7d3d1587271986440f5870d8d02eb3b",
        ...
        Aa = e => {
          ...
          return !i?.length || i?.length < 1 ? null : 1 === i.length ? i : (0, f.jsx)(za, {
            slideChildren: i,
            title: t,
            navigation: s,
            thumbsVisible: s,
        ...
        Va = e => {
          ...
          return (0, d.useEffect)((() => {
            ...
            expandedCardContents: (0, f.jsx)(Aa, {
              images: _,
              title: t,
              navigation: !0,
              thumbsVisible: !0,
      ...
      const zs = (0, m.withTranslations)((e => {
          ...
          const w = (0, V.useIntl)(),
            ...
            Ee = (0, d.useMemo)((() => Ce.title ?? s ?? Se?.title), [s, Se?.title, Ce.title]),
            Le = (0, h.S1)({
        ...
        $s = (0, V.withIntl)((e => {
          const {
          ...
          })(), [o, l] = (0, d.useState)([]), [u, p] = (0, d.useState)(null), [b, k] = (0, d.useState)(0), [v, _] = (0, d.useState)(window.devicePixelRatio || window.screen.availWidth / document.documentElement.clientWidth), [h, x] = (0, d.useState)(!1), y = (0, d.createRef)(), [j, w] = (0, d.useState)(null), S = (0, d.createRef)(), C = (0, d.createRef)(), [T, E] = (0, d.useState)([]), [M, L] = (0, d.useState)(!0), [I, P] = (0, d.useState)(!1), [z, A] = (0, d.useState)(!1), [D, V] = (0, d.useState)([]), [O, R] = (0, d.useState)(404), [F, G] = (0, d.useState)(808), [H, U] = (0, d.useState)(672), [W, q] = (0, d.useState)(336), [Y, K] = (0, d.useState)(0), [Q, X] = (0, d.useState)(0), [Z, J] = (0, d.useState)(0), [ee, ae] = (0, d.useState)(0), [te, se] = (0, d.useState)(0), [ne, re] = (0, d.useState)(!1), ie = !!(0, m.usePrevious)(ne), [oe, ce] = (0, d.useState)(window.innerWidth), [de, le] = (0, d.useState)(0), [me, ge] = (0, d.useState)(0), [ue, fe] = (0, d.useState)(0), [pe, ve] = (0, d.useState)(0), [_e, he] = (0, d.useState)(0), [xe, ye] = (0, d.useState)(0), [Ne, we] = (0, d.useState)(0), [Se, Te] = (0, d.useState)(0), [Ee, Me] = (0, d.useState)(-1e3), [Le, Ie] = (0, d.useState)(0), [Pe, ze] = (0, d.useState)(50), [Ae, De] = (0, d.useState)(0), [$e, Be] = (0, d.useState)(!1), [Ve, Oe] = (0, d.useState)(768), [Re, Fe] = (0, d.useState)(!1), [Ge, He] = (0, d.useState)(!1), [Ue, We] = (0, d.useState)(!1), [qe, Ye] = (0, d.useState)(!1), [Ke, Qe] = (0, d.useState)(!1), [Xe, Ze] = (0, d.useState)(1e3), [Je, ea] = (0, d.useState)(1.2), [aa, ta] = (0, d.useState)(0), [sa, na] = (0, d.useState)(!1), [ra, ia] = (0, d.useState)(!1), [oa, ca] = (0, d.useState)(!0), [da, la] = (0, d.useState)(!1), [ma, ga] = (0, d.useState)(!1), [ua, fa] = (0, d.useState)(null), [pa, ba] = (0, d.useState)(100), [ka, va] = (0, d.useState)(!1), [_a, ha] = (0, d.useState)({}), [xa, ya] = (0, d.useState)(""), [Na, wa] = (0, d.useState)(0), [Sa, Ca] = (0, d.useState)(!1), [Ta, Ea] = (0, d.useState)(!1), [Ma, La] = (0, d.useState)(0), [Ia, Pa] = (0, d.useState)(0), [za, Aa] = (0, d.useState)(100), [Da, $a] = (0, d.useState)(!1), [Ba, Oa] = (0, d.useState)(!1), Ra = () => oe * de + Pe, Fa = () => !1 === $e ? Je : 1, Ga = e => e === Ne - 1 || e === Ne + 1, Ha = () => {
            let e = -1 * xe;
            return e = -1 * xe - pe, e
          }, Ua = function(e) {
            ...
            const n = oe * de,
              r = !1 === $e ? O * Fa() : n;
            return e.inModalMode && $e ? -1 === a ? Ra() * (Ne - e.itemNumber) * -1 - e.styles.left : Ra() * (e.itemNumber - Ne) - e.styles.left : -1 === a ? -1 * e.styles.left - r - Pe + s : n - e.styles.left + Pe + s
          }, qa = (e, a, t) => {
            ...
            function() {
              ...
              }), qa(Ne + 1, o.length, !0), $e ? $e && E(T.map((e => {
            ...
            function() {
              ...
              s({
                ...
                source_content_id: T[Ne - 1].source_content_id,
                source_content_name: T[Ne - 1].source_content_name
              }), qa(Ne - 1, o.length, !0), $e || E(T.map((e => (e.itemNumber === Ne + 1 ? e.upNext = !1 : e.itemNumber === Ne - 2 ? e.upNext = !0 : e.itemNumber === Ne ? (e.upNext = !0, e.active = !1, e.styles = {
                ...e.styles,
                transform: `translate3d(${Wa(e,1)}px, ${Ua(e)}px, 0) scale(${Fa()})`
          ...
          (0, d.useEffect)((() => {
            !1 !== Re && !0 !== ne && (re(!0), Fe(!1), qa(Ne, T.length, !0), S.current && (S.current.style.transition = "all var(--eventDeck-transitionCardOpen)", S.current.style.transform = `translate(${-1*pe}px, ${aa}px)`), nt(), $e ? (ye(0), la(!1), ia(!0)) : Qe(!0))
          }), [Re]), (0, d.useEffect)((() => {
          ...
          (0, d.useEffect)((() => {
            ...
            const e = ie !== ne;
            ne ? (e && a(!0), Da && Oa(!0)) : Ta || ne || (e && a(!1), Da && Ba && Oa(!1))
          }), [ne, Ta]), (0, d.useEffect)((() => {
            if (!ma) return;
            clearTimeout(ua);
            const e = setTimeout((() => {
    ...
    72569: (e, a, t) => {
      ...
      const g = (0, s.forwardRef)((function(e, a) {
        ...
        f = (0, s.forwardRef)((function(e, a) {
          ...
          const d = t ? n.DX : "div",
            l = (0, r.v6)(c, {
              className: o()("rockstargames-sites-gta-gen9f4f3d5f93b2fdeb7f5ec3600010bd78b", i),
              "data-testid": s
            });
          return (0, m.jsx)(d, {
            ref: a,
