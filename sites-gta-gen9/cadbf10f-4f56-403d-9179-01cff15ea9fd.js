      ...
      const R = "Collapsible",
        ...
        D = (0, o.forwardRef)(((e, n) => {
          const {
            ...
            children: l,
            ...c
          } = e, i = O(x, t), [u, d] = (0, o.useState)(a), f = (0, o.useRef)(null), p = s(n, f), m = (0, o.useRef)(0), b = m.current, g = (0, o.useRef)(0), v = g.current, y = i.open || u, A = (0, o.useRef)(y), w = (0, o.useRef)();
          return (0, o.useEffect)((() => {
            ...
            if (e) {
              ...
              m.current = n.height, g.current = n.width, A.current || (e.style.transitionDuration = w.current.transitionDuration, e.style.animationName = w.current.animationName), d(a)
            }
