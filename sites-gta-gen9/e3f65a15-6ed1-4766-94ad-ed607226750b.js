try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    a = (new e.Error).stack;
  a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "e3f65a15-6ed1-4766-94ad-ed607226750b", e._sentryDebugIdIdentifier = "sentry-dbid-e3f65a15-6ed1-4766-94ad-ed607226750b")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    ...
    72538(e, a, t) {
      ...
      const m = ({
        ...
        g = ({
          ...
          const {
            track: N
          } = (0, n.useGtmTrack)(), A = (0, i.useDataLayer)(), M = g ?? e, R = (0, i.findPlatform)(v)?.friendlyName, L = (0, r.useMemo)(() => {
          ...
          return (0, s.jsx)(o.Link, {
            ...
            className: (0, l.default)(d.cta, "platform" === f && v ? d[v] : "", w && d[w], y ? d.disabled : "", C),
            style: t,
            "data-variant": f,
            "data-size": p,
            onClick: E,
            ...
            reloadDocument: S,
            role: T,
            children: "platform" === f && v ? (0, s.jsx)(m, {
              platform: v,
              altText: R || M
            }) : (0, s.jsxs)("div", {
    ...
    11251(e, a, t) {
      ...
      const g = {
        ...
        u = ({
          ...
          const m = n ?? (a.startsWith(document.location.origin) ? "_self" : "_blank"),
            g = [p.platformButton, p[r], d].join(" "),
        ...
        b = ({
          ...
          const y = (0, d.useRockstarTokenPing)(),
            ...
            z = (0, r.useRef)(null),
            B = () => {
              I.current?.blur(), N(!0), C(!1), z.current = window.setTimeout(() => {
                E.current?.focus()
              }, 30)
            },
            H = (0, r.useCallback)(() => {
          ...
          (0, r.useEffect)(() => () => {
            ...
            S && P.current ? D(P.current.scrollHeight) : D(0)
          }, [S]), (0, r.useEffect)(() => {
            if (!S) return;
            const e = e => {
              const a = e.target;
              L.current && !L.current.contains(a) && document.contains(a) && (B(), z?.current && (z.current = window.setTimeout(() => {
                E.current?.blur()
              }, 40)))
            };
          ...
          }, [S]), (0, r.useLayoutEffect)(() => {
            if (L?.current) {
              const e = getComputedStyle(L.current).getPropertyValue("--expandingPlatformButton-expandDuration"),
          ...
          return "string" != typeof a ? null : (0, s.jsxs)("div", {
            className: (0, l.default)(p.container, i),
            children: [(0, s.jsx)(n.motion.div, {
              ...
              "data-variant": e,
              "data-animating": T,
              className: (0, l.default)(S ? p.expandedButton : p.unexpandedButton),
              animate: S ? "open" : "closed",
              variants: f,
              initial: !1,
              ref: L,
              children: [(0, s.jsx)(n.motion.button, {
                className: (0, l.default)(p.buttonText, o),
                "aria-expanded": S,
                onClick: () => {
                ...
                children: (0, s.jsx)(c(), {
                  ...
                  children: (0, s.jsxs)("div", {
                    children: [(0, s.jsx)("button", {
                      ...
                      children: _.length ? _.map(e => (0, s.jsx)(u, {
