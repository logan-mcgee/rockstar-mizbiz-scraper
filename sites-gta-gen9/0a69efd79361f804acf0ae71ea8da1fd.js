! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "b972f8de-6a24-4e0a-8795-bb215d22f3de", e._sentryDebugIdIdentifier = "sentry-dbid-b972f8de-6a24-4e0a-8795-bb215d22f3de")
  } catch (e) {}
}();
    ...
    296: (e, a, l) => {
      ...
      const N = "Title Image",
        ...
        _ = e => {
          ...
          return {
            ...
            defaultItem: () => (0, t.defaultItemUnique)({}),
            itemProps: e => (0, t.itemPropsWithKey)(e, {
              label: `${e?.[t.TINA_MEMOQ_PREFIX]?.title??e?.title??`${N}`}`
            })
          }
        },
        w = e => {
      ...
      const A = function() {
        ...
        return {
          ...
          itemProps: e => (0, t.itemPropsWithKey)(e, {
            label: (0, D.stripHTML)(`${e?.name??e?.[t.TINA_MEMOQ_PREFIX]?.content??"New"} [List Item]`)
          })
        }
      };
      l(33052), l(32104), l(504), l(95240), l(52256);
      var M = l(65419);
      const E = e => {
          let {
            game: a = null,
        ...
        q = () => ({
          ...
          defaultItem: () => (0, t.defaultItemUnique)(),
          itemProps: e => (0, t.itemPropsWithKey)(e, {
            label: `${e?.[t.TINA_MEMOQ_PREFIX]?.title??e?.title??`${L}`}`
          })
        }),
        O = e => {
          let {
        ...
        X = () => ({
          ...
          fields: [(0, t.NameField)(), {
            ...
            itemProps: e => (0, t.itemPropsWithKey)(e, {
              label: `${K} [${e?.[t.TINA_MEMOQ_PREFIX]?.title??null}]`
            })
          }, (0, t.ClassNamesField)({
            filter: "grid"
          }), (0, t.StyleField)({
        ...
        j = () => ({
          ...
          defaultItem: () => (0, t.defaultItemUnique)(),
          itemProps: e => (0, t.itemPropsWithKey)(e, {
            label: `${H} [${e?.[t.TINA_MEMOQ_PREFIX]?.cta??null}]`
          })
        }),
        z = e => {
          let {
