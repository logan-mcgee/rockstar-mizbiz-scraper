! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "3ec9f954-fc18-477f-a6b2-4f2800e77a5c", e._sentryDebugIdIdentifier = "sentry-dbid-3ec9f954-fc18-477f-a6b2-4f2800e77a5c")
  } catch (e) {}
}();
  ...
  [6219], {
    39695: (e, i, n) => {
      ...
      const b = e => {
          ...
          const c = o ?? (s.startsWith(document.location.origin) ? "_self" : "_blank"),
            l = [g.platformButton, g[_]].join(" "),
            r = _ ? n(52917)(`./${_}.svg`) : null,
        ...
        h = e => {
          ...
          const [C, j] = (0, s.useState)(!1), {
            track: N
          } = (0, r.useGtmTrack)(), P = (0, s.useRef)(null), A = (0, s.useRef)(C);
          (0, s.useEffect)((() => {
            A.current = C
          }), [C]), (0, s.useEffect)((() => {
            const e = e => {
              A && !P?.current?.contains(e.target) && j(!1)
            };
          ...
          return (0, u.jsxs)("div", {
            className: (0, c.classList)(g.container, d),
            children: [(0, u.jsx)(_.motion.div, {
              className: g.content,
              animate: C ? "open" : "close",
              variants: m,
              "aria-hidden": !!C,
              children: p
            }), (0, u.jsxs)(_.motion.div, {
              "data-variant": i,
              className: t()(C ? g.expandedButton : g.unexpandedButton),
              animate: C ? "open" : "closed",
              variants: f,
              initial: !1,
              ref: P,
              children: [(0, u.jsx)(_.motion.button, {
                className: t()(g.buttonText, o),
                "aria-expanded": C,
                onClick: () => {
                  if (j(!C), !C) switch (v) {
              ...
              }), (0, u.jsx)(_.motion.div, {
                className: g.expandedArea,
                animate: C ? "open" : "closed",
                variants: k,
                initial: !1,
                "aria-hidden": !C,
                children: (0, u.jsxs)("div", {
                  children: [(0, u.jsx)("button", {
                    ...
                    className: g.platformButtons,
                    children: h.length ? h.map((e => (0, u.jsx)(b, {
    ...
    60285: (e, i, n) => {
      ...
      const r = (0, a.withIntl)((e => {
        ...
        const k = (0, s.useRef)(null),
          f = (0, a.useIntl)(),
          g = !/^(https?|mailto):/i.test(n),
          u = /^#/.test(n),
          b = m?.target ?? (r ? "_blank" : "_self");
        let {
          ...h
        } = m, v = "";
        if ("aria-label" in h && h["aria-label"] && (v = "_blank" === b ? `${h["aria-label"]} ${f.formatMessage(o.aria_label_open_new_window)}` : h["aria-label"]), (0, s.useEffect)((() => {
          ...
          return (0, l.jsxs)("a", {
            ...
            "aria-label": v,
            ref: k,
            children: [i, "_blank" === b && !v && (0, l.jsx)("span", {
              className: c,
              children: f.formatMessage(o.aria_label_open_new_window)
            })]
          })
        }
        if (g) return (0, l.jsxs)(t.NavLink, {
          title: _,
          to: n,
          onClick: d,
          ...h,
        ...
        const y = Object.keys(h).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, i) => ({
          ...e,
          [i]: m[i]
        })), {});
