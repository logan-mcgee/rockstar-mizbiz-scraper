! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "71679a7c-99fb-4439-9444-5dde2561bc76", e._sentryDebugIdIdentifier = "sentry-dbid-71679a7c-99fb-4439-9444-5dde2561bc76")
  } catch (e) {}
}();
  ...
  [8940], {
    48940: (e, a, t) => {
      ...
      const Tt = e => {
        ...
        Vt = (0, ft.defineMessages)({
          cph_progres_counter_label: {
            id: "cph_progres_counter_label",
        ...
        Lt = e => {
          ...
          return (0, jt.jsxs)("div", {
            className: [Mt.progressCounter, ...s ? [s] : []].join(" "),
            ...
            children: [(0, jt.jsx)("span", {
              ...
              className: Mt.visuallyHidden,
              children: o.formatMessage(Vt.cph_progres_counter_label, {
                value: void 0 === a ? 0 : a,
                total: t
              })
            })]
        ...
        $t = e => {
          ...
          const d = function(e) {
              ...
              const t = {
                currentLevel: a.length && a.length > 1 ? Xt : Yt,
                isComplete: !1,
              ...
              if (a.length > 1 && t.progress >= a[a.length - 1] || !a.length && t.progress >= 1) t.isComplete = !0, t.percent = 100, t.levelEnd = a.length ? a[a.length - 1] : 1, t.currentLevel = a.length ? qt[a.length - 1] : t.currentLevel, t.progress = t.levelEnd;
                ...
                if (e < 0 && (e = 0), e >= 0) {
                  const c = 0 === e ? 0 : e - 1;
                  t.currentLevel = qt[e], t.levelEnd = a[e], t.metalLevel = e, t.percent = (r = t.progress, s = c, o = t.levelEnd, Math.floor(100 * (r - s) / (o - s) + 0))
                }
              }
              var r, s, o;
              return t
          ...
          return (0, jt.jsxs)(jt.Fragment, {
            children: [(0, jt.jsxs)(p, {
              ...
              className: [Bt.award, ...d.isComplete ? [Bt.completed] : [], ...t ? [Bt.expanded] : [], ...l ? [Bt.hovered] : [], ...c ? [c] : []].join(" "),
              ref: s ? w : m,
              tabIndex: 0,
              ...s && !t && {
                onClick: () => {
              ...
              children: [(0, jt.jsxs)(xt.motion.div, {
                className: Bt.awardContent,
                children: [(0, jt.jsxs)("div", {
                  className: Bt.awardInfo,
                  children: [(0, jt.jsx)(xt.motion.div, {
                    className: Bt.awardImage,
                    layout: "position",
                    children: (0, jt.jsx)(xt.motion.img, {
                      src: `${Ft}/images/games/GTAV/multiplayer/award/${d.currentLevel}/${a.imageName}.png`,
                      alt: a.name,
                      layout: "position"
                    })
                  }), (0, jt.jsxs)(xt.motion.div, {
                    className: Bt.awardDetails,
                    layout: !0,
                    children: [(0, jt.jsx)("h3", {
                      className: Bt.awardName,
                      children: a.name
                    }), s && (0, jt.jsx)(xt.motion.div, {
                      className: Bt.awardHint,
                      initial: "collapsed",
                      variants: v,
                      ...
                      value: d.progress,
                      total: d.levelEnd,
                      classes: Bt.progressCounter
                    }), a.bonuses && s && (0, jt.jsx)(xt.motion.div, {
                      initial: "collapsed",
                      variants: v,
                      animate: t ? "expanded" : "collapsed",
                      children: (0, jt.jsx)(Ut, {
                ...
                className: Bt.metalLegendContainer,
                children: (0, jt.jsx)(Gt, {
                  metals: a.levels && a.levels.length > 1 ? qt : [Yt],
                  currentLevel: d.currentLevel,
                  currentLevelComplete: d.isComplete,
                  classes: Bt.metalLegend
                })
              })]
            }), !s && (0, jt.jsx)("div", {
              ...
              children: (0, jt.jsxs)("div", {
                ...
                children: [a.hint, a.bonuses && (0, jt.jsx)(Ut, {
                  currentLevelComplete: d.isComplete,
                  bonuses: a.bonuses
                })]
              })
        ...
        Jt = () => {
          ...
          return (0, jt.jsx)("div", {
            ...
            children: (0, jt.jsxs)(B, {
              ...
              className: [Zt.awardsContainer, p && e ? Zt.modalOpen : "", p && !e ? Zt.expanded : "", !p && m ? Zt.isClosed : "", u && !e ? Zt.hovered : ""].join(" "),
              ref: w,
              ...H,
              children: [(0, jt.jsxs)(xt.motion.div, {
                className: Zt.awardCategoryContainer,
                layout: !0,
                children: [(0, jt.jsxs)(xt.motion.div, {
                  className: Zt.awardsTitle,
                  children: [(0, jt.jsxs)("h2", {
                    className: Zt.awardCategoryName,
                    ...
                    children: [(0, jt.jsx)("button", {
                      ...
                      ...V,
                      children: (0, jt.jsxs)("div", {
                        className: Zt.tooltipInner,
                        children: [(0, jt.jsx)(ft.FormattedMessage, {
                          ...Nt.cph_awards_rp_bonus_info
                        }), (0, jt.jsxs)("div", {
                          className: Zt.rpGrid,
                          children: [(0, jt.jsx)("div", {
                            className: Zt.rpGridItem,
                            children: (0, jt.jsx)("span", {
                              className: [Zt.rpBronze, Zt.rpLevel].join(" "),
                              children: (0, jt.jsx)(ft.FormattedMessage, {
                            ...
                            className: Zt.rpGridItem,
                            children: (0, jt.jsx)("span", {
                              className: [Zt.rpSilver, Zt.rpLevel].join(" "),
                              children: (0, jt.jsx)(ft.FormattedMessage, {
                            ...
                            className: Zt.rpGridItem,
                            children: (0, jt.jsx)("span", {
                              className: [Zt.rpGold, Zt.rpLevel].join(" "),
                              children: (0, jt.jsx)(ft.FormattedMessage, {
                                ...Nt.cph_awards_gold
                              })
                            })
                            ...
                            className: Zt.rpGridItem,
                            children: (0, jt.jsx)("span", {
                              className: [Zt.rpPlatinum, Zt.rpLevel].join(" "),
                              children: (0, jt.jsx)(ft.FormattedMessage, {
                  ...
                  children: (0, jt.jsx)(Lt, {
                    ...
                    total: c.length,
                    theme: "platinum",
                    classes: Zt.awardCount
                  })
                })]
              }), (0, jt.jsxs)(B, {
                className: Zt.categoryWrapper,
                children: [(0, jt.jsx)(L, {
                  className: Zt.awardCategory,
                  ref: x,
                  children: c.map(((a, t) => (0, jt.jsx)($t, {
                    position: t,
                    award: a,
                    isExpanded: e && p,
                    isMobile: e,
                    ...
                    setHoveredAwardId: W,
                    isShowTooltip: t === N,
                    classes: [Zt.award, t >= S + k ? Zt.fadeIn : "", t >= S && t < S + k ? Zt.peek : ""].join(" ")
                  }, a.imageName)))
                }), c.length > S && (0, jt.jsx)("div", {
                  className: p ? Zt.showLess : Zt.showMore,
                  children: (0, jt.jsx)("button", {
                    type: "button",
                    onClick: () => z(),
      ...
      const tr = e => r.createElement("svg", ar({
        xmlns: "http://www.w3.org/2000/svg",
        fill: "none",
        viewBox: "0 0 96 21"
      }, e), Qt || (Qt = r.createElement("g", {
        fill: "#fff",
      ...
      }))), er || (er = r.createElement("defs", null, r.createElement("clipPath", {
        id: "ps5_svg__a"
      }, r.createElement("path", {
        fill: "#fff",
      ...
      const cr = e => r.createElement("svg", or({
          xmlns: "http://www.w3.org/2000/svg",
          fill: "none",
          viewBox: "0 0 160 20"
        }, e), rr || (rr = r.createElement("g", {
        ...
        }))), sr || (sr = r.createElement("defs", null, r.createElement("clipPath", {
        ...
        lr = e => {
          ...
          return l = _?.length ? xt.motion.button : xt.motion.div, (0, jt.jsxs)(l, {
            className: [ir.challenge, p && !t ? ir.isComplete : "", r ? ir.open : ir.closed].join(" "),
            onClick: () => {
              s(), d({
            ...
            children: [(0, jt.jsxs)("div", {
              className: ir.challengeInfo,
              children: [g && (0, jt.jsx)("div", {
                className: ir.status,
                children: t ? (0, jt.jsx)(_r, {
                  alt: "Locked",
                  classes: ir.lock
                }) : (0, jt.jsx)(Tt, {
                  alt: p ? "Completed" : "In Progress",
                  classes: [ir.check, p ? ir.isComplete : ""].join(" ")
                })
              }), (0, jt.jsxs)("div", {
                ...
                children: [(0, jt.jsx)("h4", {
                  ...
                  className: ir.progressCounterContainer,
                  children: [(0, jt.jsx)(Lt, {
                    theme: "light",
                    value: g ? i : void 0,
                    total: n,
                    classes: ir.progressCounter
                  }), _?.length && (0, jt.jsx)("div", {
                    className: [ir.chevron, ir.expandedChevron].join(" ")
                  })]
                }), _?.length && (0, jt.jsx)(xt.motion.ul, {
                  className: ir.taskList,
                  ...
                  children: _.map((e => (0, jt.jsxs)("li", {
                    ...
                    children: [(0, jt.jsx)("div", {
                      ...
                      children: (0, jt.jsx)(Tt, {
                        ...
                        classes: [ir.check, e.isComplete ? ir.isComplete : ""].join(" ")
                      })
                    }), (0, jt.jsx)("p", {
                      className: e.isComplete ? ir.taskComplete : "",
                      children: e.hint
                    })]
                  }, e.hint)))
                })]
      ...
      const mr = {
        ...
        hr = e => {
          ...
          return "locked" === a ? (0, jt.jsx)("span", {
            ...
            className: mr.hiddenSpacer,
            "aria-hidden": "true"
          }) : (0, jt.jsxs)("span", {
            className: [mr.badge, mr[a]].join(" "),
        ...
        br = e => {
          ...
          const [d, p] = (0, r.useState)(window.innerWidth >= 1280), [g, m] = (0, r.useState)(1), [h, u] = (0, r.useState)("auto"), {
            ...
            setBodyIsScrollable: b
          } = (0, bt.useBodyScrollable)(), [R, S] = (0, r.useState)(!1), E = (0, r.useRef)(), k = d ? dr.wx : "div", v = d ? dr.Ky : "li", w = (0, r.useRef)(null), x = (0, r.useRef)(null), A = n.some((e => e.isCompleted && e?.numClaimable > 0)), j = (0, ft.useIntl)(), T = (0, r.useMemo)((() => {
            const e = [];
          ...
          return (0, r.useEffect)((() => (window.addEventListener("resize", P), P(), () => {
            ...
            b(!!d || !s)
          }), [d]), (0, r.useMemo)((() => (0, jt.jsx)(pr.cp, {
            disabled: d || !s,
            children: (0, jt.jsxs)(xt.motion.div, {
              layout: "position",
              className: [fr.rewards, s ? fr.isModalOpen : fr.isModalClosed].join(" "),
              ref: w,
              children: [s && (0, jt.jsx)("div", {
                className: fr.btnCloseContainer,
                children: (0, jt.jsx)("button", {
                  type: "button",
                  className: fr.btnClose,
                  onClick: () => I(),
                  children: (0, jt.jsx)("img", {
                    src: t(16188),
                ...
                children: (0, jt.jsxs)(k, {
                  ...
                  children: [!d && A && (0, jt.jsx)("div", {
                    ...
                    return a || R ? (0, jt.jsxs)(v, {
                      className: a ? void 0 : fr.inactiveTier,
                      tabIndex: 0,
        ...
        Sr = e => {
          ...
          return (0, jt.jsxs)("div", {
            className: Rr.progressTracker,
            style: {
              "--rewards-top-offset": "auto" === N ? "auto" : `${N}px`
            },
            ref: h,
            children: [(0, jt.jsxs)("div", {
              className: Rr.progressTrackerHeader,
              children: [(0, jt.jsx)("div", {
                ...
                className: Rr.readyToClaim,
                children: [(0, jt.jsx)(ft.FormattedMessage, {
                  ...Nt.cph_reward_ready_to_claim
                }), (0, jt.jsx)("button", {
                  className: Rr.tooltipIcon,
                  ref: P,
                  type: "button",
                ...
                className: Rr.platformAvailability,
                children: [(0, jt.jsx)("span", {
                  children: (0, jt.jsx)(ft.FormattedMessage, {
                    ...Nt.cph_progress_available_on
                  })
                }), (0, jt.jsxs)("div", {
                  className: Rr.platformIcons,
              ...
              className: [Rr.container, I && Rr.isModalOpen, !1 === I ? Rr.isModalClosed : ""].join(" "),
              style: {
                ...!s && {
                  height: C
                }
              ...
              children: [(0, jt.jsx)("div", {
                  ...
                  children: l && l.map(((e, a) => {
                    ...
                    return (0, jt.jsx)("li", {
                      children: (0, jt.jsxs)("button", {
                        type: "button",
                        className: [Rr.tier, d === a ? Rr.active : "", t ? Rr.isComplete : ""].join(" "),
                        onClick: () => {
                          ! function(e) {
                            x(null), p(e)
                          }(a), E({
                ...
                className: Rr.challenges,
                children: [(0, jt.jsxs)(xt.motion.div, {
                  className: Rr.challengesHeader,
                  children: [(0, jt.jsx)("h3", {
                    children: (0, jt.jsx)(ft.FormattedMessage, {
                      ...Nt.cph_progress_challenges_title
                    })
                  }), (0, jt.jsxs)("div", {
                    className: Rr.challengesProgress,
                    children: [(0, jt.jsx)(Dt, {
                      percentage: b ? k / v * 100 : 0,
                      classes: Rr.progressBar
                    }), (0, jt.jsx)(Lt, {
                      theme: "light",
                      value: b ? k : void 0,
                      total: v
                  ...
                  className: Rr.challengeList,
                  children: M && M.map((e => (0, jt.jsx)(lr, {
                    activeTier: d,
                    challenge: e,
                    isLocked: B || !1,
                    isOpen: e.id === w,
      ...
      const wr = {
        ...
        xr = e => {
          ...
          const o = (0, ft.useIntl)(),
            ...
            i = (0, r.useContext)(jr);
          return (0, jt.jsx)("div", {
            className: wr.dropdownContainer,
            "data-testid": "menu-dropdown",
            children: (0, jt.jsx)("button", {
              type: "button",
              className: wr.dropdownButton,
              onClick: t,
              "aria-label": o.formatMessage(c),
              "data-testid": "menu-dropdown-button",
              children: (0, jt.jsxs)("div", {
                className: wr.dropdownContent,
                children: [(0, jt.jsx)("div", {
                  className: wr.dropdownImage,
                  ...
                  className: wr.dropdownTitle,
                  children: i
                }), (0, jt.jsx)("div", {
                  className: [wr.dropdownArrow, s ? wr.open : ""].join(" "),
                  "data-testid": "chevron"
                })]
              })
            })
        ...
        Pr = e => {
          ...
          const {
            pathname: t
          } = (0, Er.useLocation)(), s = (0, Er.useParams)(), {
            data: o,
            loading: c
          } = function() {
            let {
            ...
            } = (0, Rt.useRockstarUserState)(), t = (0, kt.useRockstarTokenPing)(), [s, o] = (0, r.useState)(), [c, i] = (0, r.useState)([]), n = (0, kr.useGenerateCdnSource)(), {
              data: _,
              loading: l
            } = (0, kt.useQuery)(vr.SecondaryNavContent, {
              variables: {
                branchTags: ["1"]
              }
            });
            ...
            track: u
          } = (0, Rt.useGtmTrack)(), f = (0, r.useContext)(jr), b = !n.navHidden, R = !c && o?.length > 0, S = (0, r.useMemo)((() => s["*"]?.slice(0, s["*"].indexOf("/"))), [o, t]), E = o?.find((e => e.name === S))?.subNavItems?.find((e => e.name.toLowerCase() === s.section));
          return (0, r.useEffect)((() => {
            const e = e => {
              "Escape" === e.key && l(!1)
            };
          ...
          }), [_, d]), R ? (0, jt.jsxs)(jr.Provider, {
            value: a,
            children: [(0, jt.jsx)(xt.motion.div, {
              className: Ar.navOverlay,
              onClick: () => l(!1),
              variants: Tr,
              initial: "initial",
              animate: _ ? "open" : "closed"
            }), (0, jt.jsx)("div", {
              className: [Ar.navContainer, b && h > 0 ? Ar.headerVisible : ""].join(" "),
              children: (0, jt.jsxs)("nav", {
                className: Ar.nav,
                children: [(0, jt.jsx)("div", {
                  className: [Ar.navBar].join(" "),
                  children: (0, jt.jsx)(xr, {
        ...
        yr = e => {
          ...
          const r = (0, kr.useGetCdnSource)(t?.backgroundMobileImage ?? null),
            s = (0, kr.useGetCdnSource)(t?.backgroundDesktopImage ?? null),
            o = (0, kr.useGetCdnSource)(t?.layeredMobileImage ?? null),
            c = (0, kr.useGetCdnSource)(t?.layeredDesktopImage ?? null),
            i = (0, kr.useGetCdnSource)(t?.brandImage ?? null);
          if (!t) return null;
          const n = t?.ctaFields;
          return (0, jt.jsxs)("div", {
        ...
        Nr = e => {
          ...
          return (0, r.useEffect)((() => {
            ...
            ref: l,
            children: [(0, jt.jsxs)("div", {
              className: Or.summary,
              children: [(0, jt.jsx)("h1", {
                children: t
              }), (0, jt.jsx)("h2", {
                children: a
              }), (0, jt.jsx)("p", {
                className: Or.summaryText,
                children: s
              })]
            }), (0, jt.jsxs)("div", {
              className: Or.rightSide,
              children: [(0, jt.jsxs)("div", {
                className: Or.gettingStarted,
                children: [(0, jt.jsx)("h3", {
                  children: p.formatMessage(Nt.cph_intro_getting_started)
                }), (0, jt.jsx)("ol", {
                  className: Or.gettingStartedSteps,
                ...
                className: Or.gettingStartedGuide,
                children: [(0, jt.jsx)("span", {
                  children: p.formatMessage(Nt.cph_intro_guide_instruction, {
                    title: a
                  })
                }), (0, jt.jsxs)(Er.NavLink, {
                  type: "button",
                  to: c,
                  className: Or.guideButton,
                  children: [(0, jt.jsx)("span", {
      ...
      const {
        host: Gr,
        signup: zr
      } = (0, bt.getScConfigForOrigin)(), Dr = (0, ft.withIntl)((e => {
        let {
          heroImages: a,
          awardsKey: t,
          title: o,
        ...
        const {
          ...
          track: A
        } = (0, Rt.useGtmTrack)(), j = (0, bt.useLocale)(), T = (0, bt.toScLocaleString)(j), [P, I] = (0, r.useState)(!1), y = `${document.location.origin}/auth/sc-auth-login?returnUrl=${window.location.pathname}`, C = `${zr}&returnUrl=${window.location.pathname}&lang=${T}`, O = `https://${Gr}.rockstargames.com/settings/linkedaccounts`;
        (0, r.useEffect)((() => {
          t && R(t)
        }), [t]), (0, r.useEffect)((() => {
          l && S(l)
        ...
        return W = (0, jt.jsx)(St.Highlights, {
          ...
          children: [(0, jt.jsx)(Pr, {
            title: o
          }), (0, jt.jsxs)("div", {
            className: Wr[E],
            ref: v,
            children: [(0, jt.jsx)(yr, {
              title: o,
              heroImages: a ?? {}
            }), (0, jt.jsx)(Nr, {
              title: o,
              ...
              link: y,
              className: Wr.calloutLoginPrompt,
              ...
              className: u ? Wr.rewardsTrackerWithData : Wr.rewardsTracker,
              children: (0, jt.jsx)(Sr, {
                lockAllRewards: "gen8" === E
              })
            }), (0, jt.jsx)(Jt, {}), (0, jt.jsx)(ut.CalloutSection, {
