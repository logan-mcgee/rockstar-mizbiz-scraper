try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "1116785c-bbed-4881-9360-2358a7076dce", t._sentryDebugIdIdentifier = "sentry-dbid-1116785c-bbed-4881-9360-2358a7076dce")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      const s = (0, _.setContextItem)({
        ...
        A = ({
          ...
          const {
            ...
            data: a,
            loading: i
          } = (0, n.useRockstarUser)(), [c, A] = (0, o.useState)(!1), [d, l] = (0, o.useState)(!1), [h, p] = (0, o.useState)(), [u, w] = (0, o.useState)(), [g, f] = (0, o.useState)(), [m, b] = (0, o.useState)(), [v, k] = (0, o.useState)({}), y = (0, _.useRockstarTokenPing)(), x = t => a?.linkedAccounts?.some(e => e?.onlineServiceName === t), j = x("twitch"), T = a?.characters?.gtao || [], D = new Set(["xbl", "ps", "np"]), P = new Set(T.map(t => (0, _.findPlatform)(t.platform)).flatMap(t => [t?.onlineService, t?.aliasOnlineService].filter(Boolean)).filter(t => t && D.has(t))), M = {
            activeStreams: h,
            canClaim: g,
            characters: T,
              ...
              if (e && (a?.characters?.gtao ?? []).length > 0) {
                ...
                try {
                  ...
                  if (e.status) {
                    ...
                    w(t), k(e.platforms), A(!1)
                  } else l(!0)
                } catch (t) {
                  console.error("Error fetching data:", t), l(!0)
                }
              } else !i && a?.characters?.gtao && 0 === a.characters.gtao.length && (w(!1), A(!1))
            })()
          ...
          }, [g, u, j]), d ? null : (0, r.jsx)(s.Provider, {
            value: M,
            children: t
          })
        },
      ...
      const v = (0, o.forwardRef)(function({
        ...
        P = () => {
          const t = (0, i.useIntl)(),
            ...
            A = (0, o.useMemo)(() => a?.linkedAccounts?.find(t => "twitch" === t?.onlineServiceName), [a?.linkedAccounts]),
            {
              isTwitchLinked: l,
              trackingParent: h
            } = a;
                    ...
                    children: (0, r.jsx)("div", {
                      ...
                      children: m.map((e, i) => {
                        return (0, r.jsx)(f.Button, {
                          appearance: "primary",
                          size: "LG",
                          className: (0, u.default)(Z.link, Z[e.platform.name]),
      ...
      const Q = "rockstargames-sites-gta-gen9ea4642de554a3d7eb8e92a6c16611e3c",
        V = () => {
          const [t, e] = (0, o.useState)(null), a = (0, i.useIntl)(), {
            ...
            scBase: A
          } = (0, _.getConfigForDomain)(), l = `${A}settings/linkedaccounts`, {
            filteredLinkedAccounts: h,
            trackingParent: p,
              ...
              children: [h.map((t, e) => (0, r.jsx)(Y.qr, {
                ...
                children: (0, r.jsxs)(W.Root, {
                  children: [(0, r.jsx)(W.Avatar, {
                    ...
                    }), u[t.platform] ? (0, r.jsx)(W.RankContent, {
            ...
            children: (0, r.jsx)("div", {
              ...
              children: _ ? (0, r.jsxs)(r.Fragment, {
                children: [(0, r.jsx)(f.Button, {
                  size: "XL",
                  appearance: "primary",
                  className: (0, u.default)(q, "rockstargames-sites-gta-gen9c1d8d9cbb5bf81284c34f752f3b6d561"),
                  asChild: !0,
                  children: (0, r.jsx)("a", {
        ...
        tt = () => {
          ...
          const {
            ...
            isTwitchLinked: A,
            linkedAccounts: l
          } = e, h = l?.length > 0, p = (_?.length ?? 0) > 0, u = o?.length > 0, w = u && o.some(t => "pc" === t.platform || "pcalt" === t.platform), g = s ? !s || !A || n || !p && !w || n || u && !w ? s && h ? c ? "canClaim" : "linked" : "general" : "createCharacters" : "loggedOut", f = "createCharacters" === g, m = ["loggedOut", "linked", "general"].includes(g);
          return (0, r.jsxs)("div", {
            className: K.header,
        ...
        at = ({
          ...
          const e = (0, l.useNavigate)(),
            ...
            x = !0 === f ? !g && null != _ && null != m && null != u && null != w && null != s : !1 === f,
            {
              ref: j
            } = (0, h.useInView)({
              threshold: .6,
          ...
          return (0, o.useEffect)(() => {
            _ !== t && b(t);
            const e = u?.length > 0 || A?.length > 0;
            k !== e && v(e)
          }, [_, t, u, A, b, v, k]), (0, o.useEffect)(() => {
            ...
            children: [(0, r.jsx)(et, {}), (0, r.jsx)(tt, {}), !1 === f && (0, r.jsx)(D, {}), s && (0, r.jsx)(F, {}), f && !1 === s && (0, r.jsxs)("div", {
              className: "rockstargames-sites-gta-gen9dcd2ef1d0cbfb4f6afcc3796e00c7be8",
              children: [(0, r.jsx)(P, {}), (0, r.jsx)(R, {})]
            }), f && k && (0, r.jsx)(V, {})]
          }) : (0, r.jsx)("div", {
