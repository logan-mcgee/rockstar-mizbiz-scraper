  ...
  [133], {
    ...
    5900: (e, a, t) => {
      ...
      const r = e => {
        ...
        o = e => {
          ...
          const g = [s.Z.plusButton, s.Z[l] ?? "", s.Z[f] ?? "", s.Z[m] ?? ""].join(" "),
            p = {
              "--hvr-color": n ?? o,
              "--hvr-bg-color": o ?? n,
              "--hvr-border-color": n ?? o
            },
    ...
    4575: (e, a, t) => {
      ...
      const v = e => {
          ...
          const n = (0, o.useGetCdnSource)(t?.mobile?.full_src ?? null),
            s = (0, o.useGetCdnSource)(t?.desktop?.full_src ?? n);
          return (0, b.jsxs)("div", {
            ...
            children: (0, b.jsxs)("div", {
              ...
              children: [(0, b.jsxs)("div", {
                ...
                children: [(0, b.jsxs)(s.E.div, {
                  ...
                  }), c.length ? (0, b.jsx)("div", {
                    className: u.platforms,
                    children: c.map(((e, a) => (0, b.jsx)("div", {
                  ...
                  children: [(0, b.jsx)(s.E.div, {
                    ...
                    children: [(0, b.jsx)("button", {
                      ...
                      children: c.length ? c.map(((e, a) => (0, b.jsx)(f.Z, {
                        type: "blackBtn",
                        size: "large",
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              children: d.length ? d.slice(0, u).map(((e, a) => {
                let {
                  question: t,
                  answer: n
                } = e;
      ...
      const l = e => {
        ...
        c = e => {
          ...
          const d = i().map(a, "guide_id"),
            ...
            [f, u] = (0, n.useState)(null);
          return (0, n.useEffect)((() => {
            const e = c?.map(((e, a) => (0, o.jsx)(l, {
              guide: e
            }, a)));
            u(e)
          }), [c]), (0, o.jsx)(r.Gen9CoreCarousel, {
            size: "lg",
            slideChildren: f,
            title: t?.[0]?.title ?? s
          })
    ...
    7240: (e, a, t) => {
      ...
      const u = {
        ...
        b = e => {
          ...
          return (0, n.useEffect)((() => d(i !== m ? m === s : i === s)), [m]), (0, f.jsx)(o.A, {
            to: a,
              ...
              children: t?.children?.map(((e, t) => {
                ...
                return (0, f.jsxs)("div", {
                  ...
                  children: [(0, f.jsx)(o.A, {
                    className: [c.guideLink, a === s ? c.guideLinkCurrent : ""].join(" "),
                    to: r,
                    children: i
                  }), t === b && n?.length ? (0, f.jsx)(v, {
                    sections: n
                  }) : ""]
                }, i)
              }))
        ...
        g = e => {
          ...
          return (0, f.jsx)("div", {
            className: [c.guideNav, s ? c.headerHidden : ""].join(" "),
            style: {
              "--header-height": `${n}px`
            },
            children: t?.map((e => (0, f.jsx)(h, {
              currentId: a,
              group: e
            }, e.id_hash)))
          })
    ...
    8110: (e, a, t) => {
      ...
      const v = e => {
          ...
          const {
            track: c
          } = (0, r.useGtmTrack)(), [u, h] = (0, n.useState)(!1), g = f().debounce((() => {
            h(!1)
          ...
          return (0, b.jsxs)("div", {
            ...
            children: [t ? (0, b.jsx)(i.A, {
              ...
              className: [m.subNav, d ? m.subNavUnder : m.subNavRight, u ? m.subNavOpen : ""].join(" "),
              children: o?.map((e => (0, b.jsx)(v, {
                under: !1,
                ...e,
                t: l
              }, e?.title)))
      ...
      const x = {
        ...
        j = () => {
          const {
            ...
            navOpen: t,
            setNavOpen: s
          } = (0, r.useRockstarUserState)(), i = (0, g._)(), d = (0, g._)(), o = (0, g._)();
          return (0, n.useEffect)((() => {
            !0 === t && !0 === e && a(!1)
          }), [t]), (0, n.useEffect)((() => {
            i.start(e ? x.open : x.closed), d.start(e ? _.open : _.closed), o.start(e ? k.open : k.closed)
          }), [e]), (0, b.jsxs)("svg", {
        ...
        S = (0, d.withTranslations)((e => {
          ...
          const {
            ...
            userShouldSeeMore: S
          } = (0, o.useScroll)(), [T, C] = (0, n.useState)(0), E = () => T > 1023;
          return (0, n.useEffect)((() => {
            c || g || N && S || m(S)
          }), [N, c, S, g]), (0, n.useEffect)((() => {
            v(!1)
          }), [k]), (0, n.useEffect)((() => {
            c && m(!1)
          }), [c]), (0, n.useEffect)((() => {
            const e = () => {
              p.current && f(p.current.offsetHeight), C(window.innerWidth)
            };
    ...
    3873: (e, a, t) => {
      ...
      const d = e => {
        ...
        const l = (0, n.useGetCdnSource)(a?.image?.mobile?.full_src ?? null),
          c = (0, n.useGetCdnSource)(a?.image?.desktop?.full_src ?? null) ?? l;
        return t.length ? (0, r.jsxs)("div", {
          className: (0, n.classList)(i.imageTextGroupGroup, o),
          style: {
            ...d
          },
    ...
    5209: (e, a, t) => {
      ...
      const d = e => {
        ...
        return (0, r.jsxs)(n.A, {
          className: (0, s.classList)(i.linkoutSection, l),
          to: o,
          style: c,
    ...
    5133: (e, a, t) => {
      ...
      const m = function(e) {
          ...
          const [t, s] = (0, l.useState)(null), {
            data: i
          } = (0, n.useQuery)(u.TinaModulesTree, {
            variables: {
              id: e
            },
            skip: !e
    ...
    5851: (e, a, t) => {
      ...
      const o = (0, n.createContext)(),
        ...
        c = e => {
          ...
          const [t, l] = (0, n.useState)(null), [c] = (0, s.useSearchParams)(), {
            setActiveSection: f
          } = (0, r.MB)(), {
            pauseUserShouldSeeMore: u
          } = (0, i.useScroll)(), m = (0, n.useCallback)((e => {
            if (e !== c.get("section")) return void f(e);
            const a = document.getElementsByName(c.get("section"))?.[0];
            a && (u(), f(c.get("section")), a.scrollIntoView({
              behavior: "auto"
            }))
          }), [c.get("section"), t]);
          (0, n.useEffect)((() => {
            c.get("section") && m(c.get("section"))
          }), [c.get("section")]);
          const b = (0, n.useMemo)((() => ({
            announcePresence: m,
            section: t,
