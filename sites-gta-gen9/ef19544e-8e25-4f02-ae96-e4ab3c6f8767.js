! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      a = (new Error).stack;
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "ef19544e-8e25-4f02-ae96-e4ab3c6f8767", e._sentryDebugIdIdentifier = "sentry-dbid-ef19544e-8e25-4f02-ae96-e4ab3c6f8767")
  } catch (e) {}
}();
  ...
  [6503], {
    42341: (e, a, t) => {
      ...
      const f = (0, s.withIntl)((e => {
        ...
        const {
          track: u
        } = (0, r.useGtmTrack)(), _ = (0, s.useIntl)(), [p, h] = (0, s.getLocale)(), [k, b] = (0, c.useState)(!1), v = (0, c.useMemo)((() => (0, n.A)()), []), x = (0, c.useCallback)((e => {
          let a = f.pathname;
          const t = a.split("/");
        ...
        return (0, c.useEffect)((() => {
          ...
          className: [d.languageSelector, k ? d.open : ""].join(" "),
          "data-theme": a,
    ...
    86503: (e, a, t) => {
      ...
      const T = {
        ...
        P = e => {
          ...
          const {
            track: h
          } = (0, _.useGtmTrack)(), k = (0, L.A)(), b = (0, c.useIntl)();
          let v = s;
          r && (v = r.domain === k.currentSite?.site ? r.path : `https://${k.sites[r.domain]}.rockstargames.com${r.path}`);
          const x = {
            ...n,
            link_url: v
          };
          return (0, d.jsxs)(O, {
            ...
            children: [a, g && (0, d.jsx)("div", {
              ...
              children: (0, d.jsx)("span", {
                ...
                children: b.formatMessage(o.nofications_new)
              })
            })]
          })
        },
        ...
        D = e => {
          ...
          const {
            ...
            track: l
          } = (0, _.useGtmTrack)(), g = (0, c.useIntl)(), [f, m] = (0, s.useState)([]), [u, p] = (0, s.useState)(null), [h, k] = (0, s.useState)(null), [b, v] = (0, s.useState)(!1), [x, N] = (0, s.useState)(-1), [S, w] = (0, s.useState)([]), [M, C] = (0, s.useState)(0), y = t(58989), [j, I] = (0, s.useState)("0"), [E, L] = (0, s.useState)("0"), T = e => parseInt(e, 10).toLocaleString("en-US", {
          ...
          (0, s.useEffect)((() => {
            ...
            f && f.forEach((e => {
              !0 === e.isPrimary && (p(e.crewTag), k(e.crewColour), N(e.rankOrder), v(!1), !0 === Object.prototype.hasOwnProperty.call(e, "crewType") && "rockstar" === e.crewType && v(!0))
            }))
          }), [f]), (0, s.useEffect)((() => {
            const e = [];
            if (!b && x > -1)
        ...
        F = (0, m.withTranslations)((e => {
          ...
          const {
            ...
            setUserData: se
          } = (0, _.useRockstarUserState)(), [ce, re] = (0, s.useState)(null), [ne, ie] = (0, s.useState)(null), [oe, le] = (0, s.useState)(!1), [de, ge] = (0, s.useState)(!1), [fe, me] = (0, s.useState)(0), ue = (0, s.createRef)(), _e = B(ue, !1), pe = (0, s.createRef)(), [he, ke] = (0, s.useState)(0), [be, ve] = (0, s.useState)([]), [xe, Ne] = (0, s.useState)(244), Se = (0, s.useRef)(null), we = (0, s.useMemo)((() => (0, L.A)()), []), Me = (0, s.useMemo)((() => ((e, a, t, s, c) => [{
          ...
          return (0, s.useEffect)((() => {
            ...
            let e = be.length - 1;
            e < 0 && (e = 0), me(e);
            const a = be.length > 0 ? be[q] ?? be[0] : null;
            if (!a) return;
            const t = null !== a ? n(a.platform, "large") : null;
            ie(t), re(a), be.length > 1 ? le(!0) : le(!1), f(be.length - 1 > 3)
          }), [q, be]), (0, s.useEffect)((() => {
            Ce()
          }), [fe, p, v, be]), (0, s.useEffect)((() => {
            ye(), I()((() => {
              setTimeout(ye, 0)
            }), 300)
          }), [v, x]), (0, s.useEffect)((() => {
            const e = X?.currentCharId ?? 0;
            e !== q && ee(Math.max(0, Math.min(e, be.length - 1)))
          }), [be, X]), (0, d.jsxs)(d.Fragment, {
              ...
              children: [(0, d.jsx)(D, {
                ...
                children: [(0, d.jsx)("button", {
                  ...
                  children: (0, d.jsx)(W, {
                    ...
                    disablePager: de,
                    disableSwiper: de,
                    children: be.filter(((e, a) => a !== q)).map((e => (0, s.createElement)($, {
                      characterData: e,
                      setMobileCardWidth: Ne,
                      key: e.mugshotUrl,
                      tabIndex: t ? -1 : 0
        ...
        G = (0, c.withIntl)((e => {
          ...
          const {
            ...
            track: E
          } = (0, _.useGtmTrack)(), [L, T] = (0, s.useState)(!1), R = (0, u.useReactiveVar)(_.scConfig), O = (0, s.useRef)(), [P, U] = (0, s.useState)(0), $ = (0, s.createRef)(), [A, D] = (0, s.useState)(!1), [B, W] = (0, s.useState)(0), [z, G] = (0, s.useState)(!1), {
            mutateLSSettings: V,
            lsSettings: K
          ...
          return (0, s.useEffect)((() => {
            ...
            O.current && (!1 === b && !1 === L && (O.current.style.height = `${O.current.scrollHeight}px`), !0 === b && (O.current.style.height = null))
          }), [b, O, L]), (0, s.useEffect)((() => {
            const e = () => {
                j(!1), J(!0)
              },
