try {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    e = (new t.Error).stack;
  e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "37a3ba66-b2a3-456e-882f-fbecdb0df537", t._sentryDebugIdIdentifier = "sentry-dbid-37a3ba66-b2a3-456e-882f-fbecdb0df537")
} catch (t) {} {
  let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
  ...
  [4058], {
    ...
    51550(t, e, a) {
      ...
      var r = a(39793),
        ...
        c = a(25932);
      var o = a(81270);
      const _ = t => t < 100 ? "#2d6eb9" : t > 99 && t < 500 ? "#b482619a" : t > 499 && t < 750 ? "#9699a1" : "#D6B563",
        n = {
      ...
      const l = (0, A.defineMessages)({
        ...
        p = (0, i.forwardRef)(function({
          ...
          const {
            ...
            "data-testid": a,
            className: (0, _.default)("rockstargames-sites-gta-gen9d738b88fa09e0960678501900af6dae1", e)
          });
          return (0, r.jsxs)("div", {
            ref: n,
            ...d,
        ...
        g = (0, i.forwardRef)(function({
          ...
          const [s, d] = (0, i.useState)(t), A = (0, o.mergeProps)(_, {
        ...
        w = (0, i.forwardRef)(function({
          ...
          const s = t ? c.DX : "div",
            d = (0, o.mergeProps)(i, {
              className: (0, _.default)("rockstargames-sites-gta-gen9fbe57172570573357e040787d9307835", a),
              "data-testid": e
            });
          return (0, r.jsx)(s, {
            ref: n,
        ...
        b = (0, i.forwardRef)(function({
          ...
          return (0, r.jsxs)("div", {
            ...
            ref: _,
            children: [(0, r.jsx)(c.s6, {
              children: n(l.character_card_a11y_player, {
                player: a
              })
            }), (0, r.jsx)("div", {
              "aria-hidden": !0,
    ...
    67728(t, e, a) {
      ...
      const s = (0, _.setContextItem)({
        ...
        d = ({
          ...
          const {
            ...
            data: a,
            loading: i
          } = (0, n.useRockstarUser)(), [c, d] = (0, o.useState)(!1), [A, l] = (0, o.useState)(!1), [h, p] = (0, o.useState)(), [u, g] = (0, o.useState)(), [w, f] = (0, o.useState)(), [m, b] = (0, o.useState)(), [v, k] = (0, o.useState)({}), y = (0, _.useRockstarTokenPing)(), x = t => a?.linkedAccounts?.some(e => e?.onlineServiceName === t), j = x("twitch"), T = a?.characters?.gtao || [], D = new Set(["xbl", "ps", "np"]), P = new Set(T.map(t => (0, _.findPlatform)(t.platform)).flatMap(t => [t?.onlineService, t?.aliasOnlineService].filter(Boolean)).filter(t => t && D.has(t))), C = {
            activeStreams: h,
            canClaim: w,
            characters: T,
            ...
            filteredLinkedAccounts: a?.linkedAccounts?.filter(t => D.has(t.onlineServiceName) && !P.has(t.onlineServiceName)),
            setActiveStreams: p,
              ...
              if (e && (a?.characters?.gtao ?? []).length > 0) {
                ...
                try {
                  const t = [...new Set(a.characters?.gtao.map(t => t.platform) || [])],
                    e = await (async t => {
                      try {
                        ...
                        return await (0, _.coreScApiFetch)(`/achievements/hasAchievement?title=gtav&achievementId=${e}&${a}`, {
                          pingBearer: y
                        })
                      } catch (t) {
                  ...
                  if (e.status) {
                    ...
                    g(t), k(e.platforms), d(!1)
                  } else l(!0)
                } catch (t) {
                  console.error("Error fetching data:", t), l(!0)
                }
              } else !i && a?.characters?.gtao && 0 === a.characters.gtao.length && (g(!1), d(!1))
            })()
          }, [e, a?.characters?.gtao, i]), (0, o.useEffect)(() => {
            void 0 !== j && void 0 !== u && f(j && u || j && a?.characters?.gtao && a?.characters?.gtao.length > 0 || j && C.filteredLinkedAccounts && C.filteredLinkedAccounts.length > 0)
      ...
      const v = (0, o.forwardRef)(function({
        ...
        P = () => {
          const t = (0, i.useIntl)(),
            ...
            a = A(),
            c = (0, _.useRockstarTokenPing)(),
            s = window.location.pathname,
            d = (0, o.useMemo)(() => a?.linkedAccounts?.find(t => "twitch" === t?.onlineServiceName), [a?.linkedAccounts]),
            {
              isTwitchLinked: l,
              trackingParent: h
            } = a;
          return a ? (0, r.jsxs)(v, {
            ...
            children: [(0, r.jsxs)(k, {
              ...
              onClick: async () => {
                ...
                const t = await (0, _.generateTpaLink)({
                  pingBearer: c,
                  returnUrl: s,
                  service: "twitch"
                });
      ...
      const R = {
        ...
        Z = () => {
          const t = (0, _.useRockstarTokenPing)(),
            e = (0, i.useIntl)(),
            {
              track: a
            } = (0, n.useGtmTrack)(),
            ...
            m = [{
              label: "PlayStation",
              platform: (0, _.findPlatform)("ps")
            }, {
              label: "Xbox",
              platform: (0, _.findPlatform)("xbox")
            }, {
              label: "PC",
              platform: (0, _.findPlatform)("pc")
            }],
            v = () => {
              p("character"), a({
                event: "modal_close",
                    ...
                    children: (0, r.jsx)("div", {
                      ...
                      children: m.map((e, i) => {
                        return (0, r.jsx)(f.Button, {
                          appearance: "primary",
                          size: "LG",
                          className: (0, u.default)(R.link, R[e.platform.name]),
                          onPress: (c = e.platform, async () => {
                            if (a({
                              ...
                              const e = await (0, _.generateTpaLink)({
                                pingBearer: t,
      ...
      const W = "rockstargames-sites-gta-gen9ea4642de554a3d7eb8e92a6c16611e3c",
        Q = () => {
          const [t, e] = (0, o.useState)(null), a = (0, i.useIntl)(), {
            ...
            scBase: d
          } = (0, _.getConfigForDomain)(), l = `${d}settings/linkedaccounts`, {
            filteredLinkedAccounts: h,
            trackingParent: p,
          ...
          (0, o.useEffect)(() => {
            0 === g.length && h.length > 0 && h.forEach(() => {
              c({
                event: "alert_error",
          ...
          return g.length || h?.length ? (0, r.jsxs)("div", {
                  ...
                  children: [(0, r.jsx)(J.Avatar, {}), (0, r.jsxs)(J.Content, {
                    ...
                    children: [(0, r.jsxs)(J.TopRow, {
                      children: [(0, r.jsx)(J.PlatformTag, {
                        ...
                        platform: t.onlineServiceName
                      }), (0, r.jsxs)(f.Tooltip.Root, {
                        children: [(0, r.jsx)(f.Tooltip.Trigger, {
                          children: (0, r.jsx)(b.TriangleAlert, {
                            label: a.formatMessage(T.twitch_drops_character_card_icon_label),
                            color: "#CE8903"
                          })
                        }), (0, r.jsx)(f.Tooltip.Portal, {
                          children: (0, r.jsxs)(f.Tooltip.Content, {
                            side: "right",
                            children: [a.formatMessage(T.twitch_drops_character_card_error_message), (0, r.jsx)(f.Tooltip.Arrow, {})]
                          })
                        })]
                      })]
                    }), (0, r.jsx)(J.UserName, {
                  ...
                  children: [(0, r.jsx)(J.Avatar, {
                    ...
                    children: [(0, r.jsxs)(J.TopRow, {
                      children: [(0, r.jsx)(J.PlatformTag, {
                        tagSize: J.PlatformTagSizes.large,
                        platform: t.platform
                      }), !u[t.platform] && (0, r.jsxs)(f.Tooltip.Root, {
                        children: [(0, r.jsx)(f.Tooltip.Trigger, {
                          children: (0, r.jsx)(b.TriangleAlert, {
                            label: a.formatMessage(T.twitch_drops_character_card_icon_label),
                            color: "#CE8903"
        ...
        q = "rockstargames-sites-gta-gen9d7648ab9f8b9b1ab2e010c482b3727bc",
        U = () => {
          const t = (0, i.useIntl)(),
            {
              track: e
        ...
        $ = () => {
          ...
          const {
            ...
            canClaim: c,
            characters: o,
            filteredLinkedAccounts: _,
            hasValidGamingAccount: n,
            isLoggedIn: s,
            isTwitchLinked: d,
            linkedAccounts: l
          } = e, h = l?.length > 0, p = (_?.length ?? 0) > 0, u = o?.length > 0, g = u && o.some(t => "pc" === t.platform || "pcalt" === t.platform), w = s ? !s || !d || n || !p && !g || n || u && !g ? s && h ? c ? "canClaim" : "linked" : "general" : "createCharacters" : "loggedOut", f = "createCharacters" === w, m = ["loggedOut", "linked", "general"].includes(w);
          return (0, r.jsxs)("div", {
            className: F.header,
        ...
        et = ({
          ...
          const e = (0, l.useNavigate)(),
            ...
            x = !0 === f ? !w && null != _ && null != m && null != u && null != g && null != s : !1 === f,
            {
              ref: j
            } = (0, h.useInView)({
              threshold: .6,
              ...
              onChange: t => {
                t && i({
                  ...
                  section_layout: f ? "signed in" : "signed out",
          ...
          return (0, o.useEffect)(() => {
            ...
            children: [(0, r.jsx)(tt, {}), (0, r.jsx)($, {}), !1 === f && (0, r.jsx)(D, {}), s && (0, r.jsx)(U, {}), f && !1 === s && (0, r.jsxs)("div", {
              className: "rockstargames-sites-gta-gen9dcd2ef1d0cbfb4f6afcc3796e00c7be8",
              children: [(0, r.jsx)(P, {}), (0, r.jsx)(S, {})]
            }), f && k && (0, r.jsx)(Q, {})]
          }) : (0, r.jsx)("div", {
