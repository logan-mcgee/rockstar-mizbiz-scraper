! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      i = (new Error).stack;
    i && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[i] = "c3ea96a9-7ff9-4795-817b-f34d33123ee5", e._sentryDebugIdIdentifier = "sentry-dbid-c3ea96a9-7ff9-4795-817b-f34d33123ee5")
  } catch (e) {}
}();
  ...
  [6219], {
    39695: (e, i, s) => {
      ...
      const f = e => {
          ...
          const c = t ?? (n.startsWith(document.location.origin) ? "_self" : "_blank"),
            l = [p.platformButton, p[_]].join(" "),
            r = _ ? s(52917)(`./${_}.svg`) : null,
            d = (0, k.jsxs)(k.Fragment, {
              children: [r ? (0, k.jsx)("img", {
                src: r,
                alt: i
              }) : "", !r && (0, k.jsx)("div", {
          ...
          return n.startsWith("http") ? (0, k.jsx)("a", {
            href: n,
            className: l,
            target: c,
            onClick: o,
        ...
        g = e => {
          ...
          const [x, C] = (0, n.useState)(!1), [j, N] = (0, n.useState)(!1), [P, A] = (0, n.useState)(200), {
            track: z
          } = (0, r.useGtmTrack)(), S = (0, n.useRef)(null), E = (0, n.useRef)(x), M = (0, n.useRef)(null);
          (0, n.useEffect)((() => {
            E.current = x
          }), [x]), (0, n.useEffect)((() => {
            const e = e => {
              E && !S?.current?.contains(e.target) && C(!1)
            };
          ...
          return (0, k.jsxs)("div", {
            className: (0, c.classList)(p.container, g),
            children: [(0, k.jsx)(_.motion.div, {
              className: p.content,
              animate: x ? "open" : "close",
              variants: d,
              "aria-hidden": !!x,
              children: u
            }), (0, k.jsxs)(_.motion.div, {
              "data-variant": i,
              "data-animating": j,
              className: o()(x ? p.expandedButton : p.unexpandedButton),
              animate: x ? "open" : "closed",
              variants: m,
              initial: !1,
              ref: S,
              children: [(0, k.jsx)(_.motion.button, {
                className: o()(p.buttonText, t),
                "aria-expanded": x,
                onClick: () => {
                  if (N(!0), C(!x), !x) switch (v) {
                ...
                "aria-hidden": !x,
                style: {
                  height: x ? M?.current?.scrollHeight : 0
                },
                children: (0, k.jsxs)("div", {
                  children: [(0, k.jsx)("button", {
                    ...
                    children: b.length ? b.map((e => (0, k.jsx)(f, {
    ...
    60285: (e, i, s) => {
      ...
      var o = s(89779);
      const c = "rockstargames-sites-gta-gen9ff481c537a56a6fcdb1be85dfbc8944e";
      var l = s(46632);
      const r = (0, a.withIntl)((e => {
        let {
          children: i,
          to: s = "#",
          alt: _ = "",
        ...
        const k = (0, n.useRef)(null),
          f = (0, a.useIntl)(),
          g = !/^(https?|mailto):/i.test(s),
          u = /^#/.test(s),
          b = p?.target ?? (r ? "_blank" : "_self");
        let {
          ...v
        } = p, h = "";
        if ("aria-label" in v && v["aria-label"] && (h = "_blank" === b ? `${v["aria-label"]} ${f.formatMessage(t.aria_label_open_new_window)}` : v["aria-label"]), (0, n.useEffect)((() => {
          ...
          return (0, l.jsxs)("a", {
            ...
            "aria-label": h,
            ref: k,
            children: [i, "_blank" === b && !h && (0, l.jsx)("span", {
              className: c,
              children: f.formatMessage(t.aria_label_open_new_window)
            })]
          })
        }
        ...
        const y = Object.keys(v).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, i) => ({
          ...e,
          [i]: p[i]
        })), {});
    ...
    52917: (e, i, s) => {
      ...
      }, a.resolve = _, e.exports = a, a.id = 52917
    },
    4756: e => {
      "use strict";
