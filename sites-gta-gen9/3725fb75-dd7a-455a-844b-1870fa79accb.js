! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "3725fb75-dd7a-455a-844b-1870fa79accb", e._sentryDebugIdIdentifier = "sentry-dbid-3725fb75-dd7a-455a-844b-1870fa79accb")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [3764], {
    ...
    14341: (e, t, s) => {
      ...
      var n = s(9623);
      const o = "rockstargames-sites-gta-gen9ea8cf4797c830e5b5dad68b2ec814e67";
      var c = s(84826),
        l = s(25854);
      const _ = (0, c.g)((e => {
        let {
        ...
        const f = (0, a.useRef)(null),
          ...
          h = /^#/.test(s),
          w = p?.target ?? (d ? "_blank" : "_self"),
          {
            ...x
          } = p;
        let y = "";
        if ("aria-label" in x && x["aria-label"] && (y = "_blank" === w ? `${x["aria-label"]} ${g.formatMessage(i.aria_label_open_new_window)}` : x["aria-label"]), (0, a.useEffect)((() => {
            b && f?.current && f.current.focus()
          }), [f?.current, b]), h) {
          const e = e => {
          ...
          return (0, l.jsxs)("a", {
            ...
            ref: f,
            role: u,
            children: [t, "_blank" === w && !y && (0, l.jsx)("span", {
              className: o,
        ...
        const v = Object.keys(x).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, t) => ({
          ...e,
          [t]: p[t]
        })), {});
    ...
    76782: (e, t, s) => {
      ...
      const b = e => {
          ...
          const l = n ?? (a.startsWith(document.location.origin) ? "_self" : "_blank"),
            _ = [u.platformButton, u[i]].join(" "),
            d = i ? s(5328)(`./${i}.svg`) : null,
            b = (0, m.jsxs)(m.Fragment, {
          ...
          return a.startsWith("http") ? (0, m.jsx)("a", {
            href: a,
            className: _,
            target: l,
            onClick: o,
        ...
        p = e => {
          ...
          const [y, v] = (0, a.useState)(!1), [z, j] = (0, a.useState)(!1), [G, R] = (0, a.useState)(200), {
            track: E
          } = (0, l.useGtmTrack)(), N = (0, a.useRef)(null), C = (0, a.useRef)(y), S = (0, a.useRef)(null);
          (0, a.useEffect)((() => {
            C.current = y
          }), [y]), (0, a.useEffect)((() => {
            const e = e => {
              C && !N?.current?.contains(e.target) && v(!1)
            };
          ...
          return (0, m.jsxs)("div", {
            className: (0, c.classList)(u.container, p),
            children: [(0, m.jsx)(i.motion.div, {
              className: u.content,
              animate: y ? "open" : "close",
              variants: _,
              "aria-hidden": !!y,
              children: f
            }), (0, m.jsxs)(i.motion.div, {
              "data-variant": t,
              "data-animating": z,
              className: o()(y ? u.expandedButton : u.unexpandedButton),
              animate: y ? "open" : "closed",
              variants: d,
              initial: !1,
              ref: N,
              children: [(0, m.jsx)(i.motion.button, {
                className: o()(u.buttonText, n),
                "aria-expanded": y,
                onClick: () => {
                  if (j(!0), v(!y), !y) switch (k) {
                ...
                "aria-hidden": !y,
                style: {
                  height: y ? S?.current?.scrollHeight : 0
                },
                children: (0, m.jsxs)("div", {
                  children: [(0, m.jsx)("button", {
                    ...
                    children: g.length ? g.map((e => (0, m.jsx)(b, {
