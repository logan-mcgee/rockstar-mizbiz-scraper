try {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e68e7a4a-c3a2-4daa-96c9-c402a5d5bc20", e._sentryDebugIdIdentifier = "sentry-dbid-e68e7a4a-c3a2-4daa-96c9-c402a5d5bc20")
} catch (e) {} {
  let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
      ...
      var d = function(e) {
        ...
        p = o.forwardRef(function(e, t) {
          ...
          return o.createElement(o.Fragment, null, g && o.createElement(k, {
            ...
            lockRef: n,
            gapMode: S
          }), p ? o.cloneElement(o.Children.only(v), (0, r.Cl)((0, r.Cl)({}, L), {
            ref: N
          })) : o.createElement(x, (0, r.Cl)({}, L, {
            className: m,
            ref: N
          }), v))
        });
      ...
      const j = (W = function(e) {
        ...
        o.useEffect(function() {
          ...
          if (e.inert) {
            ...
            var t = (0, r.fX)([e.lockRef.current], (e.shards || []).map(A), !0).filter(Boolean);
        ...
        var u = o.useCallback(function(e, t) {
            ...
            var v = k(d, l);
            if (!v) return !0;
            if (v ? r = d : (r = "v" === d ? "h" : "v", v = k(d, l)), !v) return !1;
          ...
          f = o.useCallback(function(e) {
            n.current = M(e), a.current = void 0
          }, []),
          p = o.useCallback(function(t) {
            d(t.type, _(t), t.target, u(t, e.lockRef.current))
          }, []),
        ...
        o.useEffect(function() {
          return I.push(c), e.setCallbacks({
            ...
            }), document.addEventListener("wheel", l, S), document.addEventListener("touchmove", l, S), document.addEventListener("touchstart", f, S),
            function() {
              I = I.filter(function(e) {
                return e !== c
              }), document.removeEventListener("wheel", l, S), document.removeEventListener("touchmove", l, S), document.removeEventListener("touchstart", f, S)
            }
        }, []);
      ...
      var r = n(93082),
        ...
        R = e => {
          const {
            ...
            onOpenChange: i,
            modal: u = !0
          } = e, l = r.useRef(null), d = r.useRef(null), [f, p] = (0, s.i)({
            prop: o,
            defaultProp: a ?? !1,
            onChange: i,
            caller: b
      ...
      var x = "DialogTrigger",
        S = r.forwardRef((e, t) => {
          const {
            __scopeDialog: n,
            ...r
          } = e, i = D(x, n), c = (0, a.s)(t, i.triggerRef);
      ...
      var F = r.forwardRef((e, t) => {
        ...
        W = r.forwardRef((e, t) => {
          const {
            ...
            onCloseAutoFocus: c,
            ...s
          } = e, d = D(P, n), f = r.useRef(null), p = (0, a.s)(t, f);
          return (0, v.Oh)(), (0, y.jsxs)(y.Fragment, {
            children: [(0, y.jsx)(l.n, {
              asChild: !0,
              loop: !0,
              trapped: o,
              onMountAutoFocus: i,
      ...
      var r, o = n(93082),
        ...
        f = o.forwardRef((e, t) => {
          const {
            ...
            onDismiss: y,
            ...b
          } = e, E = o.useContext(d), [w, C] = o.useState(null), D = w?.ownerDocument ?? globalThis?.document, [, R] = o.useState({}), x = (0, c.s)(t, e => C(e)), S = Array.from(E.layers), [T] = [...E.layersWithOutsidePointerEventsDisabled].slice(-1), k = S.indexOf(T), N = w ? S.indexOf(w) : -1, L = E.layersWithOutsidePointerEventsDisabled.size > 0, M = N >= k, _ = function(e, t = globalThis?.document) {
            const n = (0, s.c)(e),
              r = o.useRef(!1),
              a = o.useRef(() => {});
            return o.useEffect(() => {
          ...
          }, D), A = function(e, t = globalThis?.document) {
            const n = (0, s.c)(e),
              r = o.useRef(!1);
            return o.useEffect(() => {
              const e = e => {
          ...
          return function(e, t = globalThis?.document) {
            ...
            if (w) return n && (0 === E.layersWithOutsidePointerEventsDisabled.size && (r = D.body.style.pointerEvents, D.body.style.pointerEvents = "none"), E.layersWithOutsidePointerEventsDisabled.add(w)), E.layers.add(w), v(), () => {
              n && 1 === E.layersWithOutsidePointerEventsDisabled.size && (D.body.style.pointerEvents = r)
            }
          }, [w, D, n, E]), o.useEffect(() => () => {
            ...
            onPointerDownCapture: (0, a.mK)(e.onPointerDownCapture, _.onPointerDownCapture)
          })
        });
      ...
      var r = n(93082),
        ...
        d = r.forwardRef((e, t) => {
          const {
            ...
            ...y
          } = e, [b, E] = r.useState(null), w = (0, i.c)(v), C = (0, i.c)(g), D = r.useRef(null), R = (0, o.s)(t, e => E(e)), x = r.useRef({
            paused: !1,
            pause() {
              this.paused = !0
            },
          ...
          r.useEffect(() => {
            if (d) {
              let e = function(e) {
                  ...
                  const t = e.target;
                  b.contains(t) ? D.current = t : m(D.current, {
                    select: !0
                  })
                },
                t = function(e) {
                  ...
                  null !== t && (b.contains(t) || m(D.current, {
                    select: !0
                  }))
                },
                n = function(e) {
              ...
              return () => {
                b.removeEventListener(s, w), setTimeout(() => {
                  ...
                  b.addEventListener(u, C), b.dispatchEvent(t), t.defaultPrevented || m(e ?? document.body, {
                    select: !0
                  }), b.removeEventListener(u, C), h.remove(x)
                }, 0)
              }
            }
          }, [b, w, C, x]);
