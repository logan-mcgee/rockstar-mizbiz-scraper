! function() {
  try {
    var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
      e = (new t.Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "197d83d2-60ab-4db6-aeaa-b1b168da2a39", t._sentryDebugIdIdentifier = "sentry-dbid-197d83d2-60ab-4db6-aeaa-b1b168da2a39")
  } catch (t) {}
}();
        ...
        M = function(t) {
          ...
          return c(e, t), Object.defineProperty(e.prototype, "parentNode", {
            ...
            if (this.state.isResizing && this.resizable && this.window) {
              ...
              var M = this.calculateNewSizeFromAspectRatio(S, z, {
                width: R.maxWidth,
                height: R.maxHeight
              }, {
                width: n,
              ...
              f && "string" == typeof f && (f.endsWith("%") ? (k = z / g.height * 100, z = "".concat(k, "%")) : f.endsWith("vw") ? (B = z / this.window.innerWidth * 100, z = "".concat(B, "vw")) : f.endsWith("vh") && (H = z / this.window.innerHeight * 100, z = "".concat(H, "vh")));
              var L = {
              ...
              D && (0, r.flushSync)((function() {
                e.setState(L)
              })), this.props.onResize && D && this.props.onResize(t, l, this.resizable, N)
            }
