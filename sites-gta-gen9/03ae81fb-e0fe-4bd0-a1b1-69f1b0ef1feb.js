    ...
    72391: (e, n, t) => {
      ...
      const u = (e, n = o) => {
        ...
        const {
          scope: f,
          revertOnUpdate: s
        } = t, u = (0, d.useRef)(!1), c = (0, d.useRef)(l.context(() => {}, f)), b = (0, d.useRef)(e => c.current.add(null, e)), g = n && n.length && !s;
        return g && r(() => (u.current = !0, () => c.current.revert()), o), r(() => {
          if (e && c.current.add(e, f), !g || !u.current) return () => c.current.revert()
        }, n), {
          context: c.current,
