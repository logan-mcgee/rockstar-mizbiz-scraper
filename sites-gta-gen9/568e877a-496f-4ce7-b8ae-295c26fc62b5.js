! function() {
  try {
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
      t = (new Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "568e877a-496f-4ce7-b8ae-295c26fc62b5", e._sentryDebugIdIdentifier = "sentry-dbid-568e877a-496f-4ce7-b8ae-295c26fc62b5")
  } catch (e) {}
}();
...
_global.SENTRY_RELEASE = {
  ...
  [9985], {
    ...
    93665: (e, t, a) => {
      ...
      const l = e => {
          ...
          const {
            ...
            left: S,
            top: w
          } = u, [C, T] = (0, s.useState)(-1), [A, M] = (0, s.useState)(v?.length || 0), {
            track: E
          } = (0, c.useGtmTrack)(), P = null !== v && (v?.length || 0) > 1 && ("flag_bg" === x || "fob" === j?.size), [I, L] = (0, o.useSearchParams)(), [$, B] = (0, s.useState)(!1), [D, O] = (0, s.useState)(!1), [H, G] = (0, s.useState)(), V = () => {
            const e = C > -1 ? C - 1 : 0;
            T(e), O(e <= 0), B(e >= A - 1), E({
          ...
          (0, s.useEffect)((() => {
            ...
            null !== C && null !== v && v && C < v.length && C > -1 && L({
              info: v[C].toString()
            })
          }), [C, v]), (0, s.useEffect)((() => {
            const e = v?.indexOf(k);
            ...
            if (null !== v && -1 === C && v && v.length > 0) {
              const e = I.get("info");
              v?.forEach(((t, a) => {
                t === e && (T(a), O(a <= 0), B(a >= A - 1))
              }))
            }
          }), [v, C]);
              ...
              if (te?.current?.children) {
                ...
                switch (e.key) {
                  ...
                  case "ArrowUp":
                    t = (e => {
                      let t = null;
                      return H?.queried ? t = H.element : (t = Z(e, 2), G({
                        queried: !0,
                        element: t
                      })), t
            ...
            children: (0, d.jsx)(se, {
              children: (0, d.jsxs)("div", {
                children: [(0, d.jsx)(i.motion.div, {
                  ...
                  style: f,
                  children: (0, d.jsxs)(i.motion.div, {
                    className: (0, r.classList)("rockstargames-sites-gta-gen9b6aa5ebf680af5d95d0e9c76ac36ed82", l),
                    children: [!P && ae, (0, d.jsx)(i.motion.div, {
        ...
        p = e => {
          ...
          const [a, n] = (0, s.useState)(g), i = (0, s.useMemo)((() => a?.content ? (0, d.jsx)(l, {
            modal: a
          }) : null), [a]);
    ...
    10919: (e, t, a) => {
      "use strict";
      a.r(t), a.d(t, {
        componentsForTinaParser: () => vt,
        componentsForTinaParserGuide: () => kt
      });
      var s = a(55430),
        n = a(21450),
        i = a(91318),
      ...
      const Q = {
        ...
        Y = e => {
          ...
          const r = (0, y.createRef)();
          return (0, y.useEffect)((() => {
            const e = () => {
              r.current && null !== i && i(r.current.clientHeight)
            };
            return e(), window.addEventListener("resize", e), () => {
              window.removeEventListener("resize", e)
            }
      ...
      const ne = e => {
          ...
          const [f, p] = (0, te.useSearchParams)(), b = (0, y.useRef)(null), [, h] = (0, ae.h)(), {
            track: v
          } = (0, se.useGtmTrack)(), [k, x] = (0, y.useState)(!1), _ = () => {
            x(!1), h(null), p({}), v({
              event: "trackPageview"
            })
          }, N = () => {
            if (!c?.content || !b.current || !r || "linkout" === r) return;
            const e = b.current,
            ...
            u && "button" !== e.target.type || "linkout" !== r && (e.preventDefault(), e.stopPropagation(), t ? p({
              info: t
            }) : N(), v({
              event: "card_click",
        ...
        re = e => {
          ...
          const I = (0, _.useTinaComponents)(),
            ...
            B = [ie.card, M ? ie.coverCardWrapper : ""].join(" ");
          return (0, E.jsx)(ne, {
            id: m,
            position: g,
            sectionTitle: u,
      ...
      const oe = {
        ...
        pe = e => {
          ...
          const o = (0, y.useMemo)((() => t?.length && 0 !== t.length ? t.map((e => (0, E.jsx)(de, {
            className: (0, _.classList)(oe[e?.specialClass] ?? oe.imageMask, oe[e?.sizeClass], e?.className),
            variants: me(e?.specialClass ?? "imageMask", n ? "expanded" : "collapsed"),
            initial: "initial",
            animate: "animate",
            transition: ue.cardOpen,
            children: (0, E.jsx)(fe, {
              image: e,
              prod: s
            })
          ...
          return (0, E.jsx)(de, {
            className: (0, _.classList)(oe.layeredImageFrame, t.length > 1 ? oe.layered : oe.flat, a),
            style: i,
            initial: ge.fade.in.initial,
            animate: ge.fade.in.animate,
            transition: ue.instantFade,
            "data-expanded-view": n,
            children: o
          })
        };
      ...
      const he = e => {
          ...
          const {
            track: d
          } = (0, se.useGtmTrack)(), l = (0, y.useCallback)((() => {
            d({
              event: "card_click",
              link_url: a,
              card_id: r,
          ...
          return "linkout" === t && a ? (0, E.jsx)(be.A, {
            to: a,
            style: n,
      ...
      const we = {
        ...
        Te = e => {
          ...
          const v = (0, _.useTinaPayload)(),
            k = p?.payload?.meta?.cdn ?? v?.meta?.prod ?? !1,
            [x, N] = (0, y.useState)(u?.size ?? d),
            j = (0, _.useGetCdnSource)(a ?? null);
          let S = null;
          v.content && (S = v?.content[0]?._memoq ? v?.content[0]?._memoq?.body : null), (0, y.useEffect)((() => {
            N(u?.size ?? d)
          }), [u?.size, d]);
          const w = () => o ? {
            id: "card_learn_more",
            ...
            children: (0, E.jsx)(he, {
              ...
              children: (0, E.jsxs)("div", {
                ...
                children: [a && (0, E.jsx)("img", {
                  ...
                  href: "",
                  target: "_blank",
                  children: (0, E.jsx)(je.FormattedMessage, {
                    ...w()
                  })
                }) : (0, E.jsx)("button", {
                  type: "button",
      ...
      const Me = e => {
          ...
          return !r?.length || r?.length < 1 ? null : 1 === r.length ? r : (0, E.jsx)(Ae.A, {
            slideChildren: r,
            title: a,
            navigation: s,
            thumbsVisible: s,
        ...
        Le = e => {
          ...
          const f = (0, _.useTinaPayload)(),
            ...
            [v, k] = (0, y.useState)(o?.size ?? n),
            {
              ...
              main: N,
              thumbs: j
            } = Ie?.cardWithImageGallery?.gallery ?? {};
          return (0, y.useEffect)((() => {
            k(o?.size ?? n)
          }), [o?.size, n]), (0, E.jsx)(re, {
            id: t,
            ...
            deckProps: o,
            prod: b,
            variants: Ie.cardWithImageGallery,
            textOverlayProps: r,
            modalProps: {
              className: Ee.customModal,
              contentClassName: Ee.customModalContent
            },
            expandedCardContents: (0, E.jsx)(Me, {
              images: h,
              title: a,
              navigation: !0,
              thumbsVisible: !0,
      ...
      const {
        ...
        Card: xe,
        CardWithImageGallery: Le,
        TextCard: Be,
        ...De
      }, Re = He.withFadeIn(Ve((e => {
        let {
          cards: t = [],
          size: a,
          name: s,
        ...
        const m = (0, y.useRef)(null),
          ...
          [f, p] = (0, y.useState)(r),
          [b] = (0, te.useSearchParams)(),
          [h, v] = (0, y.useState)(!1);
        (0, y.useEffect)((() => {
          if ("fob" === a) {
            const e = b.get("section");
            if (e && "games" === e && !h && (v(!0), m.current)) {
              const e = 100;
              window.scrollTo(0, m.current.offsetTop - e)
            }
          }
        }), []), (0, y.useEffect)((() => {
          if (!m.current) return;
          const e = () => {
            const e = r || window.getComputedStyle(m.current).getPropertyValue("--slides-per-view");
            p(e)
          };
        ...
        const k = (0, y.useMemo)((() => {
          let e = 0;
          return u ? u.reduce(((t, s) => {
            if (s) {
              const {
                id: i,
                tina: r
              } = s, o = C().clone(r);
              C().set(o, "payload.meta.id", i), t.push((0, E.jsx)(_.TinaParser, {
                components: ze,
                tina: o,
                componentProps: {
                  deckProps: {
      ...
      const Ue = (e, t) => {
        ...
        Ye = e => e.scrollHeight > e.clientHeight;
      ...
      function Ke(e, t) {
        ...
        return C().forOwn(e, ((e, s) => {
          ...
          } else C().isObject(e) && !C().isArray(e) ? Ke(e, t) : C().isArray(e) && (a[s] = e.map((e => C().isObject(e) ? Ke(e, t) : e)))
        })), a
      }
      const Xe = (0, A.withTranslations)((e => {
          let {
            active: t,
            styles: a,
            title: s,
          ...
          const x = (0, je.useIntl)(),
            ...
            [J, ee] = (0, y.useState)(-1),
            [te, ae] = (0, y.useState)(0),
            [ne, ie] = (0, y.useState)(0),
            [re, oe] = (0, y.useState)(0),
            [de, le] = (0, y.useState)(!1),
            [me, ge] = (0, y.useState)(""),
            [ue, fe] = (0, y.useState)(null),
            [pe, be] = (0, y.useState)(!1),
            [he, ve] = (0, y.useState)(null),
            [ke, xe] = (0, y.useState)(!1),
            [ye, _e] = (0, y.useState)(!1),
            Ne = (0, _.useTinaPayload)(),
            ...
            ct = e => {
              if (!0 === R || 0 === Be || !i && !d || pe) return;
              const t = Qe(e),
                a = t.x > Be ? 1 : -1,
                s = Math.abs(Be - t.x);
              i && !d && s > Je ? (nt(!0), ge(a > 0 ? "prev" : "next"), dt()) : (We(!0), Ze(s * a), k(s * a))
            },
            ot = e => {
              if (!0 === R || !i && !d || pe) return;
              const t = Qe(e),
                ...
                s = Math.abs(Be - t.x),
                n = Math.abs(Oe - t.y);
              i && !d ? (dt(), ge("")) : s > Je && n < 25 ? (nt(!0), ge(a > 0 ? "prev" : "next"), dt()) : dt()
            },
            dt = () => {
              F(!0), De(0), He(0), We(!1), Ze(0), k(0)
            };
          return (0, y.useEffect)((() => {
            let e = W;
            A ? e = 0 : i && !d && (e = W), L(e)
            ...
            const e = qe()(((e, t) => {
              let a = 18;
              if (e?.documentElement && (a = Ue(e?.documentElement, "--root-font-size")), ne !== t.innerHeight && ie(t.innerHeight), l?.current) {
                K(Ue(l.current, "--eventDeck-marginSm") * a);
                const e = a * Ue(l?.current, "--eventDeck-modalGutters"),
                  s = t?.innerWidth,
                  n = s - 2 * e;
                B(n), C.current && d && O(n), G(Ue(l.current, "--eventDeck-itemSize") * a), oe(Ue(l.current, "--eventDeck-phaseOneTransitionDuration"));
                const i = Ue(l?.current, "--eventDeck-itemImageTitleMargins") * a,
                  r = S?.current?.clientHeight,
                  c = r + i;
                Number.isNaN(c) || q(c), ae(Ue(l?.current, "--eventDeck-headerHeight") * a)
              }
            ...
            T.current ? xe(Ye(T.current)) : xe(!1), void 0 !== c && c.current ? _e(Ye(c.current)) : _e(!1)
          }), [c, T, t, i, de]), Ae ? (0, E.jsxs)("div", {
            ...
            style: {
              ...a,
              transform: i && t && !d ? `translate3d(${Ge+Xe}px, ${ze}px, 0)` : d && !i ? `translate3d(${Ge+v}px, ${ze}px, 0)` : a?.transform
            },
            onClick: e => {
            ...
            tabIndex: i ? -1 : 0,
            "aria-label": i ? x.formatMessage(Se.card.events_deck_modal_group_label) : "",
        ...
        Ze = "rockstargames-sites-gta-gen9bb65eb1ac15ed189c1a9f6700276efc0",
        Je = e => {
          let {
            prevPage: t,
            prevBtnDisabled: a,
          ...
          return (0, E.jsxs)(E.Fragment, {
            children: [(0, E.jsxs)("div", {
              ...
              children: [(0, E.jsx)("button", {
                ...
                onClick: t,
                disabled: a,
                "aria-label": o ? l.formatMessage(Se.card.events_deck_modal_previous_aria_label) : l.formatMessage(Se.card.events_deck_previous_aria_label)
              }), (0, E.jsxs)("span", {
                className: "rockstargames-sites-gta-gen9a94a647e9943db9c97ae87c8c6a162cd",
                "aria-hidden": !o,
                "aria-label": l.formatMessage(Se.card.events_deck_paging_label, {
                  currentPage: i + 1,
                  totalPages: r.length
                }),
                ...
                onClick: s,
                disabled: n,
                "aria-label": o ? l.formatMessage(Se.card.events_deck_modal_next_aria_label) : l.formatMessage(Se.card.events_deck_next_aria_label)
              })]
            }), (0, E.jsx)("button", {
              className: "rockstargames-sites-gta-gen9d43b6cdcbcc07082edacd9a7cb1598c5",
              type: "button",
              onClick: c,
              "aria-label": l.formatMessage(Se.card.events_deck_modal_close_label),
              "aria-hidden": !o,
              tabIndex: o ? 0 : -1
            })]
          })
      ...
      const vt = {
          ...
          EventsDeck: e => {
            const {
              ...
              track: s
            } = (0, se.useGtmTrack)(), [i, r] = (0, y.useState)(!1), c = (() => {
              const {
                data: e
              } = (0, _e.useQuery)(Ne.TinaModulesList, {
                variables: {
              ...
              if (!0 === a && 0 !== e.itemNumber) {
                const a = Ue(e?.element?.current, "top");
                let n = a - te;
              ...
              const n = me * ue,
                i = !1 === Ge ? R * Qt() : n;
              return e.inModalMode && Ge ? -1 === t ? Ut() * (Ce - e.itemNumber) * -1 - e.styles.left : Ut() * (e.itemNumber - Ce) - e.styles.left : -1 === t ? -1 * e.styles.left - i - Be + s : n - e.styles.left + Be + s
            }, Jt = (e, t, a) => {
              ...
              if (!(n > re))
                if (s({
                  ...
                  let e = n * Y * -1;
                  e < Ee && (e = Ee, O(!0), B(!1), je(re)), je(n), L(I.map((t => (t.styles = {
                    ...t.styles,
                    transform: `translate3d(${e}px, 0, 0)`
                  }, t))))
                } else {
                  let e = Se - J;
                  je(n), e < Ee && (e = Ee, O(!0), B(!1), je(re)), we(e)
                }
            }, ta = function(e) {
              let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
              if (kt || ht) return;
              ...
              if (!(n < 0))
                if (s({
                  ...
                  let e = n * Y * -1;
                  e > 0 && (e = 0, B(!0), O(!1), je(0)), je(n), L(I.map((t => (t.styles = {
                    ...t.styles,
                    transform: `translate3d(${e}px, 0, 0)`
                  }, t))))
                } else {
                  let e = Se + J;
                  je(n), (e > 0 || 0 === e || -1 * e < W) && (e = 0, B(!0), O(!1), je(0)), we(e)
                }
            }, aa = e => {
              if (It || oe || Ge) return;
              const t = Qe(e);
              ...
              if (s({
                ...
                let e = Ce * Y * -1;
                e < Ee && (e = Ee, O(!0), B(!1), je(re)), je(Ce), Jt(Ce, re, !1), L(ca(o, "cardClose", `translate3d(${e}px, 0, 0)`))
              } else {
                L(ca(o, "cardClose"));
                const e = Math.ceil((I[Ce].columnNumber + 1) / X) - 1;
                je(e);
                let t = e * J * -1;
                Oe < pe ? (t = 0, B(!0), O(!0), je(0)) : t < Ee ? (t = Ee, B(!1), O(!0), je(re)) : Jt(e, re, !1), we(t), Te(0)
              }
              M.current.style.transform = "translate(0px, 0px)", M.current.style.transition = "all var(--eventDeck-transitionCardClose)", gt(!1), at(!1), de(!1), Ke(!1), We(!1), nt(!1), setTimeout((() => {
                et(!0)
              }), it)
            };
            (0, y.useEffect)((() => {
              !1 !== Ze && (et(!1), gt(!1), w.style.zIndex = null, L(I.map((e => (e.transitionStyle = "", e)))))
            }), [Ze]);
            const da = e => {
              setTimeout((() => {
                Tt(e), wt(!0)
            ...
            (0, y.useEffect)((() => {
              if (!St) return;
              if (wt(!1), kt) return;
              Te(Number(Ct.target.dataset.itemPosition)), Ke(!0), vt(!0), pt && bt(!1);
            ...
            (0, y.useEffect)((() => {
              ...
              if (M.current) {
                let e = 0;
                e = M?.current?.clientHeight, e += Ue(M?.current, "margin-top"), e += Ue(M?.current, "margin-bottom"), Me(e)
              }
            }), [M, P]), (0, y.useEffect)((() => {
              oe && (() => {
                const e = w?.getBoundingClientRect().top,
              ...
              oe || (Oe < ue * me && 0 === ye ? (we(0), O(!0), B(!0)) : Se < Ee ? (O(!0), B(!1), je(re), we(Ee)) : Se < 0 && (O(!1), je(re - 1)), Oe > ue * me && D && O(!1))
            }), [Ee]), (0, y.useEffect)((() => {
              if (j.current) {
                T(j.current);
                const e = Ue(document.documentElement, "--root-font-size"),
                  t = Ue(j.current, "--eventDeck-modalGutters") * e,
                  a = Ue(j.current, "--eventDeck-collapsedMaxWidth");
                ve(a);
                let s = me - 2 * t;
                ...
                let i = 0;
                n < me && (i = .5 * (me - n)), xe(i);
                let r = Ue(j.current, "--eventDeck-modalBottomGutter");
                r *= e;
                const c = window.innerHeight - (Ae + r);
                ae(.5 * s < c ? s / 4 : .5 * c);
                const d = Ue(j.current, "--eventDeck-mobileBreakpoint");
                Re(d);
                let l = Ue(j.current, "--eventDeck-itemSize");
                l *= e, F(l);
                let u = Ue(j.current, "--eventDeck-modalGutterGap");
                u *= e, De(u);
                let p = Ue(j.current, "--eventDeck-insideMargin");
                p *= e;
                ...
                const x = Ue(j.current, "--eventDeck-itemScaleUpAmount");
                ot(x), rt(Ue(j.current, "--eventDeck-cardCloseTransitionDuration")), f(Ue(j.current, "--eventDeck-itemImageTitleMargins") * e), null !== m && e !== m && (g(e), oe && ma()), null === m && g(e)
              }
            }), [j, o]), (0, y.useEffect)((() => {
              if (oe && !Ge) {
                ma();
              ...
              !1 !== oe && !0 !== k && (Ge ? la() : ma(!0))
            }), [ne, J, Be, R, me, Ie, te, dt]), (0, y.useEffect)((() => {
              const e = () => {
                if (j.current && pt) {
            ...
            const ua = (0, _.useTinaComponents)(),
              ...
              pa = (0, y.useMemo)((() => I.map((e => (0, y.createElement)(Xe, {
                ...e,
                refDeck: j,
            ...
            return !pa?.length || pa.length <= 0 ? null : (0, E.jsxs)(E.Fragment, {
              children: [(0, E.jsx)("div", {
                ...
                children: [(0, E.jsx)("div", {
                  ...
                  "data-is-dragging": $t,
                  style: {
                    transform: `translate3d(${Se+Dt}px, 0, 0)`,
                    width: `${Oe}px`
                  },
                  ref: P,
                  children: pa
          ...
          Grid: o.A,
          Hero: d.A,
          HighlightsItem: Fe.HighlightsItem,
          HTMLElement: l.A,
          OrderedList: m.A,
