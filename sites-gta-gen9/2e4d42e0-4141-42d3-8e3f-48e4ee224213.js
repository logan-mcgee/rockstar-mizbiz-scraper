    ...
    92252: (e, a, n) => {
      ...
      const y = "rockstargames-sites-gta-gen9dba59499dbf2e8e419dd99a9fc7d6076",
        ...
        N = () => {
          const {
            ...
            track: a
          } = (0, s.useGtmTrack)(), [n, o] = (0, b.useSearchParams)(), {
            data: r
      ...
      const P = (0, o.defineMessages)({
        ...
        A = e => {
          ...
          const o = n.path.map((e => 1 === n.path.length && "_root" === e.feedback_type.name ? null : (0, _.jsx)(F.NavLink, {
              to: `?step=${e.id_hash}`,
              className: V[`stepIcon${e.feedback_type.name}`],
              children: e.feedback_type.title
            }, e.id_hash))),
            s = n.next.map((e => "_root" === e.feedback_type.name ? null : (0, _.jsxs)(F.NavLink, {
        ...
        D = e => {
          ...
          const {
            ...
            loggedIn: l
          } = (0, s.useRockstarUser)(), c = (0, t.useRef)(), [d, {
            data: u,
            error: m
          }] = (0, v.useMutation)(n);
          ...
          }) : r(P.gtao_feedback_login_cta_text)
        },
        z = e => {
          let {
            mutation: a,
          ...
          return (0, d.withTranslations)(E, "rdo" === t ? "rdr2" : t)({
            mutation: a,
            query: n,
            type: t
          })
      ...
      const L = {
        ...
        q = e => {
          ...
          const {
            track: n
          } = (0, s.useGtmTrack)(), i = (0, l.hY)(), [o, r] = (0, t.useState)(!1), [d, u] = (0, t.useState)(null), [m, v] = (0, t.useState)(null), [g] = (0, b.useSearchParams)();
          if ((0, t.useEffect)((() => {
              G().cloneDeepWith(i, ((e, n, t) => {
                a === e && u(t?.children ?? null)
              }))
            }), [a, i, g.get("section")]), (0, t.useEffect)((() => {
              v(null), G().cloneDeepWith(d, ((e, a, n) => {
                "id_hash" === a && g.get("section") === e && v(n)
              }))
          ...
          return (0, _.jsx)("div", {
            className: L.guideNavMobile,
            children: (0, _.jsxs)("div", {
              className: L.guideNavMobileContent,
              children: [(0, _.jsx)("div", {
                className: [L.sections, o ? L.sectionsOpen : ""].join(" "),
                children: d.map((e => {
                  let {
                    id_hash: a,
                    title: n,
      ...
      const R = (0, O.A)((e => {
        ...
        Z = e => {
          ...
          return (0, t.useLayoutEffect)((() => (n("gtao"), i("gtao"), () => {
            i(null)
          })), []), (0, _.jsxs)("div", {
