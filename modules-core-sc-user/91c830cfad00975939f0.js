/*! For license information please see 91c830cfad00975939f0.js.LICENSE.txt */
    ...
    580: (e, t, a) => {
      ...
      const l = a(483),
        ...
        h = () => {
          const {
            mutateLSSettings: e
          } = (0, n.useRockstarWebLSSettings)(), t = (0, r.useReactiveVar)(c), [a, h] = (0, i.useState)(null), [u, g] = (0, i.useState)(null), p = (0, r.useReactiveVar)(s.Z), m = (0, r.useReactiveVar)(r.userBearerToken), [f, S] = (0, i.useState)(!1), {
            data: x
          } = (0, r.useQuery)(o.UserData, {
            skip: "string" != typeof m
          }), [T, v] = (0, i.useState)(null), [E, y] = (0, i.useState)(null), [M, A] = (0, i.useState)(null), [w, C] = (0, i.useState)(null), [b, B] = (0, i.useState)(!1), [R, _] = (0, i.useState)(null), O = (e => {
            const [t, a] = (0, i.useState)([]), [o, s] = (0, i.useState)([]), [l, c] = (0, i.useState)(e), d = (0, r.useUserBearerToken)();
              ...
              void 0 !== l && (async () => {
                ...
                e && a.length > 0 && a.forEach((e => {
                  ...
                  if (a?.rockstarId === l?.user?.id) {
                    ...
                    let a = "",
                      r = "";
                    i?.map((e => ("xbl" === e?.onlineService ? a = e.userName : "np" === e?.onlineService && (r = e.userName), e))), s(t.map((t => ("ps4" === t.platform || "ps5" === t.platform ? t.platformUsername = "" === r ? e : r : "xboxone" === t.platform || "xboxsx" === t.platform ? t.platformUsername = "" === a ? e : a : t.platformUsername = e, t))))
                  }
                }))
              })()
            }), [t, l]), {
          ...
          })(x)?.gtaoCharacters?.filter((e => !0 === e.activeCharacter)) ?? [], P = async e => {
            let {
              forceUpdate: t
            } = e;
            const {
              tokenExpiresIn: a = null
            } = await (0, r.pingBearer)(p.pingBearer, t);
            null !== a && setTimeout((() => {
              P({
                forceUpdate: !0
              })
          ...
          return (0, i.useEffect)((() => {
            x && (A(x.user.id ?? null), x.user.bearer_token_expired && (0, r.pingBearer)(p.pingBearer))
          }), [x]), (0, i.useEffect)((() => {
            m && M && (async () => {
              const {
                crews: e
            ...
            g(e?.platform ? [e.platform, e.characterSlot] : null)
          }), [T, JSON.stringify(O)]), {
            data: x,
            charactersNeeded: a,
            characters: {
